...
- Type-safe APIs for accessing entities and attributes
- Flexible decoding/encoding pipeline with error handling
- Integration with standard Swift and Apple frameworks
- Designed for performance and interoperability
...
### Name space for the application protocol schema definition
