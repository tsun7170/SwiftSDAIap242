/* file: extremal_position_check.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_FUNCTION; -- extremal_position_check (line:40623 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  ...
  func EXTREMAL_POSITION_CHECK(_ FUN: eLINEARIZED_TABLE_FUNCTION? ) 
    ...
    let _TEMP8 = SDAI.aggregate(_TEMP7, contains: SDAI.STRING(/*SDAI.INTEGER*/_TEMP6))
    ...
    let _TEMP12 = SDAI.aggregate(_TEMP11, contains: SDAI.STRING(/*SDAI.INTEGER*/_TEMP10))
    let _TEMP13 =  !_TEMP12
    ...
    let _TEMP20 = SDAI.aggregate(_TEMP19, contains: SDAI.STRING(/*SDAI.INTEGER*/_TEMP18))
    ...
    let _TEMP34 = SDAI.aggregate(_TEMP33, contains: SDAI.STRING(/*SDAI.INTEGER*/_TEMP32))
