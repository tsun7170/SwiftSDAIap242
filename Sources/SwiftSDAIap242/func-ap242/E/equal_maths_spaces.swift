/* file: equal_maths_spaces.swift 	 generated: Fri Sep 26 17:24:11 2025 */
  ...
  func EQUAL_MATHS_SPACES(SPC1: eMATHS_SPACE? , SPC2: eMATHS_SPACE? ) 
    ...
    if SDAI.IS_TRUE( _TEMP2 ) {
      ...
      if SDAI.IS_TRUE( _TEMP17 ) {
        ...
        let _TEMP18 = SDAI.SET<sMATHS_VALUE>(SDAI.EMPTY_AGGREGATE)
        SET2 = _TEMP18
    ...
    if SDAI.IS_TRUE( _TEMP25 ) {
      ...
      let _TEMP26 = SDAI.SET<sMATHS_VALUE>(SDAI.EMPTY_AGGREGATE)
      SET1 = _TEMP26
