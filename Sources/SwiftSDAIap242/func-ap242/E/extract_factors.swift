/* file: extract_factors.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```express
  ...
  END_FUNCTION; -- extract_factors (line:41087 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
*/
  ...
  func EXTRACT_FACTORS( 
    ...
    //LOCAL
    var TSP: sTUPLE_SPACE?  = sTUPLE_SPACE(/*eLISTED_PRODUCT_SPACE.PRef*/THE_ZERO_TUPLE_SPACE); SDAI.TOUCH(var: &TSP)
    //END_LOCAL
    ...
    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/M, TO:/*SDAI.INTEGER*/N) {
      for I in incrementControl {
        ...
        let _TEMP1 /* eMATHS_SPACE.PRef? */ = FACTOR_SPACE( 
            TSPACE: TSPACE, 
            IDX: tPOSITIVE_INTEGER(/*SDAI.INTEGER*/I) )
        let _TEMP2 /* sTUPLE_SPACE? */ = ASSOC_PRODUCT_SPACE( 
            TS1: TSP, 
            TS2: sTUPLE_SPACE(/*eMATHS_SPACE.PRef*/_TEMP1) )
        TSP = _TEMP2
      }
    }
...
private let _extract_factors__cache = SDAI.FunctionResultCache(
  label: "EXTRACT_FACTORS",
