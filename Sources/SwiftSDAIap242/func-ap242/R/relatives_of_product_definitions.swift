/* file: relatives_of_product_definitions.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  func RELATIVES_OF_PRODUCT_DEFINITIONS(
    ...
    func LOCAL_RELATIVES_OF_PRODUCT_DEFINITIONS(
      ...
      //LOCAL
      var LOCAL_DEF: SDAI.SET<ePRODUCT_DEFINITION>?  = SDAI.SET<ePRODUCT_DEFINITION>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &LOCAL_DEF)
      var LOCAL_PDR: SDAI.SET<ePRODUCT_DEFINITION_RELATIONSHIP>?  = SDAI.SET<ePRODUCT_DEFINITION_RELATIONSHIP>(
                                                                    SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &LOCAL_PDR)
      var LOCAL_TOTAL: SDAI.SET<ePRODUCT_DEFINITION>?  = SDAI.SET<ePRODUCT_DEFINITION>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &LOCAL_TOTAL)
      //END_LOCAL
