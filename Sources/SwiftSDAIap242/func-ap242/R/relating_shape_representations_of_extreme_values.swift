/* file: relating_shape_representations_of_extreme_values.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  func RELATING_SHAPE_REPRESENTATIONS_OF_EXTREME_VALUES(
    ...
    //LOCAL
    var RESULTS: SDAI.SET<eSHAPE_REPRESENTATION>?  = SDAI.SET<eSHAPE_REPRESENTATION>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &RESULTS)
    var EXTI: SDAI.SET<eEXTREME_INSTANCE>?  = SDAI.SET<eEXTREME_INSTANCE>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &EXTI)
    var II_EI: SDAI.SET<eINSTANCE_REPORT_ITEM_WITH_EXTREME_INSTANCES>?  = 
      SDAI.SET<eINSTANCE_REPORT_ITEM_WITH_EXTREME_INSTANCES>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &II_EI)
    var SDIIR: SDAI.SET<eSHAPE_DATA_QUALITY_INSPECTION_INSTANCE_REPORT>?  = 
      SDAI.SET<eSHAPE_DATA_QUALITY_INSPECTION_INSTANCE_REPORT>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &SDIIR)
    var SDQR: SDAI.SET<eSHAPE_DATA_QUALITY_INSPECTION_RESULT_REPRESENTATION>?  = 
      SDAI.SET<eSHAPE_DATA_QUALITY_INSPECTION_RESULT_REPRESENTATION>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &SDQR)
    var SDISR: SDAI.SET<eSHAPE_DATA_QUALITY_INSPECTED_SHAPE_AND_RESULT_RELATIONSHIP>?  = 
      SDAI.SET<eSHAPE_DATA_QUALITY_INSPECTED_SHAPE_AND_RESULT_RELATIONSHIP>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &SDISR)
    //END_LOCAL
