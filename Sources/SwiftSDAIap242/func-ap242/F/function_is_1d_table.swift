/* file: function_is_1d_table.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_FUNCTION; -- function_is_1d_table (line:41075 file:ap242ed2_mim_lf_v1.101.TY.exp)

*/

  public static 
  func FUNCTION_IS_1D_TABLE(_ FUNC: eMATHS_FUNCTION? ) 
    -> SDAI.BOOLEAN? {
    ...
    if SDAI.IS_TRUE( _TEMP16 ) {
      ITVL = eFINITE_INTEGER_INTERVAL(/*eMATHS_SPACE*/TEMP)
      
      let _TEMP17 = ITVL?.MIN
      let _TEMP18 = _TEMP17 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(0))
      let _TEMP19 = ITVL?.MIN
      let _TEMP20 = _TEMP19 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
      let _TEMP21 = _TEMP18 || _TEMP20
      let _TEMP22 = BOOL(SDAI.LOGICAL(_TEMP21))
...
private var _function_is_1d_table__cache = SDAI.FunctionResultCache(
