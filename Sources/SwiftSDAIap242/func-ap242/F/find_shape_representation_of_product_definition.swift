/* file: find_shape_representation_of_product_definition.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_FUNCTION; -- find_shape_representation_of_product_definition (line:40858 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  ...
  func FIND_SHAPE_REPRESENTATION_OF_PRODUCT_DEFINITION(
    ...
    let _TEMP2 = _TEMP1?.QUERY{ PD in 
        ...
        return _TEMP1 }
    let _TEMP3 = SDAI.BAG<SDAI.GENERIC_ENTITY>(/*SDAI.BAG<ePRODUCT_DEFINITION_SHAPE>*/LOCAL_P_D_S2) + _TEMP2
