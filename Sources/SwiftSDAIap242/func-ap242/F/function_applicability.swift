/* file: function_applicability.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  func FUNCTION_APPLICABILITY(FUNC: sMATHS_FUNCTION_SELECT? , ARGUMENTS: (SDAI.LIST<sMATHS_VALUE>/*[1:nil]*/ )? ) 
    ...
    let _TEMP2 = SDAI.aggregate(DOMAIN_TYPES, contains: _TEMP1)
    if SDAI.IS_TRUE( _TEMP2 ) {
      ...
      let _TEMP6 = SDAI.aggregate(DOMAIN_TYPES, contains: _TEMP5)
