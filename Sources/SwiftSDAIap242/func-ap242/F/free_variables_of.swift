/* file: free_variables_of.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  func FREE_VARIABLES_OF(_ EXPR: eGENERIC_EXPRESSION? ) 
    ...
    var RESULT: SDAI.SET<eGENERIC_VARIABLE>?  = SDAI.SET<eGENERIC_VARIABLE>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &RESULT)
    var EXPRS: SDAI.LIST<eGENERIC_EXPRESSION>?  = SDAI.LIST<eGENERIC_EXPRESSION>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &EXPRS)
    //END_LOCAL
