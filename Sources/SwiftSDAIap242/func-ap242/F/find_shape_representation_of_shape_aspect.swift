/* file: find_shape_representation_of_shape_aspect.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  func FIND_SHAPE_REPRESENTATION_OF_SHAPE_ASPECT(
    ...
    //LOCAL
    var LOCAL_P_D: SDAI.SET<ePROPERTY_DEFINITION>?  = SDAI.SET<ePROPERTY_DEFINITION>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &LOCAL_P_D)
    var LOCAL_S_D_R: SDAI.SET<eSHAPE_DEFINITION_REPRESENTATION>?  = SDAI.SET<eSHAPE_DEFINITION_REPRESENTATION>(
                                                                    SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &LOCAL_S_D_R)
    var LOCAL_S_D_R2: SDAI.BAG<eSHAPE_DEFINITION_REPRESENTATION>?  = SDAI.BAG<
                                                                     eSHAPE_DEFINITION_REPRESENTATION>(
                                                                     SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &LOCAL_S_D_R2)
