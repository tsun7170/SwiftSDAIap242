/* file: find_assembly_root.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  func FIND_ASSEMBLY_ROOT(_ CONSTITUENT: SDAI.SET<ePRODUCT_DEFINITION>? ) 
    ...
    var LOCAL_PARENT: SDAI.SET<ePRODUCT_DEFINITION>?  = SDAI.SET<ePRODUCT_DEFINITION>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &LOCAL_PARENT)
    ...
    if SDAI.IS_TRUE( _TEMP5 ) {
      ...
      if SDAI.IS_TRUE( _TEMP9 ) {
        ...
        let _TEMP10 = SDAI.SET<ePRODUCT_DEFINITION>(SDAI.EMPTY_AGGREGATE)
        ...
        if SDAI.IS_TRUE( _TEMP17 ) {
          ...
          if SDAI.IS_TRUE( _TEMP19 ) {
            ...
            let _TEMP22 = SDAI.SET<ePRODUCT_DEFINITION>(SDAI.EMPTY_AGGREGATE)
          ...
          if SDAI.IS_TRUE( _TEMP34 ) {
            ...
            if SDAI.IS_TRUE( _TEMP38 ) {
              ...
              let _TEMP39 = SDAI.SET<ePRODUCT_DEFINITION>(SDAI.EMPTY_AGGREGATE)
              ...
              if SDAI.IS_TRUE( _TEMP42 ) {
                ...
                if SDAI.IS_TRUE( _TEMP44 ) {
                  ...
                  let _TEMP45 = SDAI.SET<ePRODUCT_DEFINITION>(SDAI.EMPTY_AGGREGATE)
    ...
    let _TEMP46 = SDAI.SET<ePRODUCT_DEFINITION>(SDAI.EMPTY_AGGREGATE)
