/* file: inspected_product_definition.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  func INSPECTED_PRODUCT_DEFINITION(
    ...
    var DQDR: SDAI.BAG<eDATA_QUALITY_DEFINITION_REPRESENTATION_RELATIONSHIP>?  = 
      SDAI.BAG<eDATA_QUALITY_DEFINITION_REPRESENTATION_RELATIONSHIP>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &DQDR)
    var PDQDR: SDAI.BAG<ePRODUCT_DATA_AND_DATA_QUALITY_RELATIONSHIP>?  = 
      SDAI.BAG<ePRODUCT_DATA_AND_DATA_QUALITY_RELATIONSHIP>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &PDQDR)
    var PD: SDAI.BAG<ePRODUCT_DEFINITION>?  = SDAI.BAG<ePRODUCT_DEFINITION>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &PD)
    //END_LOCAL
