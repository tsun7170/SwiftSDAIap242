/* file: msf_surface_check.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_FUNCTION; -- msf_surface_check (line:43438 file:ap242ed2_mim_lf_v1.101.TY.exp)

*/

  public static 
  func MSF_SURFACE_CHECK(_ SURF: eSURFACE? ) 
    -> SDAI.BOOLEAN? {
    ...
    if SDAI.IS_TRUE( _TEMP1 ) {
      ...
      if SDAI.IS_TRUE( _TEMP2 ) {
        ...
        let _TEMP5 = MSF_CURVE_CHECK(eREPRESENTATION_ITEM(/*eCURVE*/_TEMP4))
        ...
        if SDAI.IS_TRUE( _TEMP14 ) {
          ...
          let _TEMP17 = MSF_SURFACE_CHECK(_TEMP16)
          ...
          if SDAI.IS_TRUE( _TEMP18 ) {
            ...
            let _TEMP21 = MSF_SURFACE_CHECK(_TEMP20)
...
private var _msf_surface_check__cache = SDAI.FunctionResultCache(
