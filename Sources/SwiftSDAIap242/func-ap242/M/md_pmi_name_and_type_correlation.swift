/* file: md_pmi_name_and_type_correlation.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
```express
  ...
  END_FUNCTION; -- md_pmi_name_and_type_correlation (line:43221 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
*/
  ...
  public static 
  func MD_PMI_NAME_AND_TYPE_CORRELATION( _ INPUT: eANNOTATION_PLACEHOLDER_OCCURRENCE.PRef?  ) 
    -> SDAI.BOOLEAN? {
    ...
    //LOCAL
    var PMI_ROLE: SDAI.STRING?  = SDAI.STRING(/*tLABEL*/(((INPUT?.GROUP_REF(
      eANNOTATION_PLACEHOLDER_OCCURRENCE.self))?.ITEM)?.GROUP_REF(eREPRESENTATION_ITEM.self))?.NAME); SDAI.TOUCH(var: &PMI_ROLE)
    var DMIAWPS: SDAI.SET<eDRAUGHTING_MODEL_ITEM_ASSOCIATION_WITH_PLACEHOLDER.PRef>?  = 
      SDAI.SET<eDRAUGHTING_MODEL_ITEM_ASSOCIATION_WITH_PLACEHOLDER.PRef>(/*SDAI.SET<
      eDRAUGHTING_MODEL_ITEM_ASSOCIATION_WITH_PLACEHOLDER.PRef>[0:1] */(INPUT?.GROUP_REF(
      eANNOTATION_PLACEHOLDER_OCCURRENCE.self))?.THE_DRAUGHTING_MODEL_ITEM_ASSOCIATION_WITH_PLACEHOLDERS); SDAI.TOUCH(var: &DMIAWPS)
    var V: SDAI.SET<SDAI.STRING>?  = SDAI.SET<SDAI.STRING>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &V)
    //END_LOCAL

    //BODY
    //
    let _TEMP1 /* SDAI.INTEGER? */ = SDAI.SIZEOF( DMIAWPS )
    let _TEMP2 /* SDAI.LOGICAL */ = _TEMP1 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
    if SDAI.IS_TRUE( _TEMP2 ) {
      //
      let _TEMP3 /* eDRAUGHTING_MODEL_ITEM_ASSOCIATION_WITH_PLACEHOLDER.PRef? */ = DMIAWPS?[1]
      let _TEMP4 /* eDRAUGHTING_MODEL_ITEM_ASSOCIATION_WITH_PLACEHOLDER.PRef? */ = _TEMP3?.GROUP_REF(
        eDRAUGHTING_MODEL_ITEM_ASSOCIATION_WITH_PLACEHOLDER.self)
      let _TEMP5 /* sDRAUGHTING_MODEL_ITEM_DEFINITION? */ = _TEMP4?.DEFINITION
    ...
    let _TEMP7 /* SDAI.AGGREGATE<SDAI.STRING> */ =  ([ 
        SDAI.AIE(SDAI.STRING("angular dimension")), 
    ...
    let _TEMP8 /* SDAI.LOGICAL */ = SDAI.aggregate( _TEMP7, contains: PMI_ROLE )
    ...
    switch PMI_ROLE {
      case .some("angular dimension"):
        //
        let _TEMP10 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
      ...
      case .some("angularity"):
        //
        let _TEMP11 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
      ...
      case .some("circular runout"):
        //
        let _TEMP12 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
      ...
      case .some("circularity"):
        //
        let _TEMP13 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
      ...
      case .some("coaxiality"):
        //
        let _TEMP14 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
      ...
      case .some("concentricity"):
        //
        let _TEMP15 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
      ...
      case .some("curve dimension"):
        //
        let _TEMP16 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
      ...
      case .some("cylindricity"):
        //
        let _TEMP17 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
      ...
      case .some("datum"):
        //
        let _TEMP18 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
      ...
      case .some("datum target"):
        //
        let _TEMP19 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
      ...
      case .some("diameter dimension"):
        //
        let _TEMP20 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
          "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.DIMENSIONAL_SIZE") )
      ...
      case .some("flatness"):
        //
        let _TEMP21 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
      ...
      case .some("general dimension"):
        //
        let _TEMP22 /* SDAI.AGGREGATE<SDAI.STRING> */ =  ([ 
        ...
        let _TEMP23 /* SDAI.SET<SDAI.STRING>? */ = SDAI.FORCE_OPTIONAL(_TEMP22) * V
        let _TEMP24 /* SDAI.INTEGER? */ = SDAI.SIZEOF( _TEMP23 )
      ...
      case .some("general note"):
        //
        let _TEMP26 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
      ...
      case .some("general tolerance"):
        //
        let _TEMP27 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
      ...
      case .some("label"):
        //
        let _TEMP28 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
          "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PROPERTY_DEFINITION") )
      ...
      case .some("linear dimension"):
        //
        let _TEMP29 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
          "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.DIMENSIONAL_SIZE") )
      ...
      case .some("note"):
        //
        let _TEMP30 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
          "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PROPERTY_DEFINITION") )
      ...
      case .some("ordinate dimension"):
        //
        let _TEMP31 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
          "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.DIMENSIONAL_SIZE") )
      ...
      case .some("parallelism"):
        //
        let _TEMP32 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
      ...
      case .some("perpendicularity"):
        //
        let _TEMP33 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
      ...
      case .some("position"):
        //
        let _TEMP34 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
      ...
      case .some("profile of line"):
        //
        let _TEMP35 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
      ...
      case .some("profile of surface"):
        //
        let _TEMP36 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
      ...
      case .some("radial dimension"):
        //
        let _TEMP37 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
          "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.DIMENSIONAL_SIZE") )
      ...
      case .some("roundness"):
        //
        let _TEMP38 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
          "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ROUNDNESS_TOLERANCE") )
      ...
      case .some("runout"):
        //
        let _TEMP39 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
      ...
      case .some("straightness"):
        //
        let _TEMP40 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
      ...
      case .some("surface roughness"):
        //
        let _TEMP41 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
          "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PROPERTY_DEFINITION") )
      ...
      case .some("symmetry"):
        //
        let _TEMP42 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
      ...
      case .some("total runout"):
        //
        let _TEMP43 /* SDAI.LOGICAL */ = SDAI.aggregate( V, contains: SDAI.STRING(
          "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TOTAL_RUNOUT_TOLERANCE") )
...
private let _md_pmi_name_and_type_correlation__cache = SDAI.FunctionResultCache(
  label: "MD_PMI_NAME_AND_TYPE_CORRELATION",
