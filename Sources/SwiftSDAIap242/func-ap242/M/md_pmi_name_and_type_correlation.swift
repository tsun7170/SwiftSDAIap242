/* file: md_pmi_name_and_type_correlation.swift 	 generated: Tue Jan 20 19:20:51 2026 */
...
*/
  ...
  func MD_PMI_NAME_AND_TYPE_CORRELATION( _ INPUT: eANNOTATION_PLACEHOLDER_OCCURRENCE.PRef?  ) 
    ...
    var PMI_ROLE: SDAI.STRING?  = SDAI.STRING(/*tLABEL*/(((INPUT?.GROUP_REF(
                                  eANNOTATION_PLACEHOLDER_OCCURRENCE.self))?.ITEM)?.GROUP_REF(
                                  eREPRESENTATION_ITEM.self))?.NAME); SDAI.TOUCH(var: &PMI_ROLE)
