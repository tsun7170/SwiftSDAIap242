/* file: member_of.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
*/
  ...
  func MEMBER_OF<gG: SDAIGenericType>(
    ...
    if SDAI.IS_TRUE( _TEMP2 ) {
      return _member_of__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.FALSE))
    }
    ...
    if SDAI.IS_TRUE( _TEMP4 ) {
      ...
      return _member_of__cache.updateCache(params: _params, value: _TEMP5)
    }
    ...
    if SDAI.IS_TRUE( _TEMP15 ) {
      ...
      if SDAI.IS_TRUE( _TEMP16 ) {
        ...
        if SDAI.IS_TRUE( _TEMP18 ) {
          return _member_of__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.TRUE))
        }
        ...
        return _member_of__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.UNKNOWN))
      }
      return _member_of__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.UNKNOWN))
    }
    ...
    if SDAI.IS_TRUE( _TEMP21 ) {
      ...
      if let selector = _TEMP23 {
        ...
        case ES_NUMBERS:
          ...
          return _member_of__cache.updateCache(params: _params, value: _TEMP26)

        case ES_COMPLEX_NUMBERS:
          
          let _TEMP27 = SDAI.aggregate(VTYPES, contains: SDAI.STRING("COMPLEX_NUMBER_LITERAL"))
          return _member_of__cache.updateCache(params: _params, value: _TEMP27)
        ...
        case ES_REALS:
          ...
          return _member_of__cache.updateCache(params: _params, value: _TEMP31)

        case ES_INTEGERS:
          
          let _TEMP32 = SDAI.aggregate(VTYPES, contains: SDAI.STRING("INTEGER"))
          return _member_of__cache.updateCache(params: _params, value: _TEMP32)

        case ES_LOGICALS:
          
          let _TEMP33 = SDAI.aggregate(VTYPES, contains: SDAI.STRING("LOGICAL"))
          return _member_of__cache.updateCache(params: _params, value: _TEMP33)

        case ES_BOOLEANS:
          
          let _TEMP34 = SDAI.aggregate(VTYPES, contains: SDAI.STRING("BOOLEAN"))
          return _member_of__cache.updateCache(params: _params, value: _TEMP34)

        case ES_STRINGS:
          
          let _TEMP35 = SDAI.aggregate(VTYPES, contains: SDAI.STRING("STRING"))
          return _member_of__cache.updateCache(params: _params, value: _TEMP35)

        case ES_BINARYS:
          
          let _TEMP36 = SDAI.aggregate(VTYPES, contains: SDAI.STRING("BINARY"))
          return _member_of__cache.updateCache(params: _params, value: _TEMP36)

        case ES_MATHS_SPACES:
          
          let _TEMP37 = SDAI.aggregate(VTYPES, contains: SDAI.STRING("MATHS_SPACE"))
          return _member_of__cache.updateCache(params: _params, value: _TEMP37)

        case ES_MATHS_FUNCTIONS:
          
          let _TEMP38 = SDAI.aggregate(VTYPES, contains: SDAI.STRING("MATHS_FUNCTION"))
          return _member_of__cache.updateCache(params: _params, value: _TEMP38)
    ...
    if SDAI.IS_TRUE( _TEMP39 ) {
      ...
      if SDAI.IS_TRUE( _TEMP40 ) {
        ...
        return _member_of__cache.updateCache(params: _params, value: _TEMP47)
      }
      return _member_of__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.FALSE))
    }
    ...
    if SDAI.IS_TRUE( _TEMP48 ) {
      ...
      if SDAI.IS_TRUE( _TEMP49 ) {
        ...
        return _member_of__cache.updateCache(params: _params, value: _TEMP52)
      }
      return _member_of__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.FALSE))
    }
    ...
    if SDAI.IS_TRUE( _TEMP53 ) {
      ...
      if SDAI.IS_TRUE( _TEMP54 ) {
        ...
        return _member_of__cache.updateCache(params: _params, value: _TEMP57)
      }
      return _member_of__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.FALSE))
    }
      ...
      if SDAI.IS_TRUE( _TEMP62 ) {
        ...
        if SDAI.IS_TRUE( _TEMP65 ) {
          ...
          if SDAI.IS_TRUE( _TEMP68 ) {
            ...
            return _member_of__cache.updateCache(params: _params, value: _TEMP75)
          }
          else {
            ...
            return _member_of__cache.updateCache(params: _params, value: _TEMP82)
          }
        }
        else {
          ...
          if SDAI.IS_TRUE( _TEMP85 ) {
            ...
            return _member_of__cache.updateCache(params: _params, value: _TEMP92)
          }
          else {
            ...
            return _member_of__cache.updateCache(params: _params, value: _TEMP99)
          }
        }
      }
      return _member_of__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.FALSE))
    ...
    if SDAI.IS_TRUE( _TEMP100 ) {
      ...
      if SDAI.IS_TRUE( _TEMP104 ) {
        ...
        if SDAI.IS_TRUE( _TEMP107 ) {
          ...
          return _member_of__cache.updateCache(params: _params, value: _TEMP110)
        }
        else {
          ...
          return _member_of__cache.updateCache(params: _params, value: _TEMP113)
        }
      }
      return _member_of__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.FALSE))
    }
    ...
    if SDAI.IS_TRUE( _TEMP114 ) {
      ...
      if SDAI.IS_TRUE( _TEMP118 ) {
        ...
        if SDAI.IS_TRUE( _TEMP121 ) {
          ...
          return _member_of__cache.updateCache(params: _params, value: _TEMP124)
        }
        else {
          ...
          return _member_of__cache.updateCache(params: _params, value: _TEMP127)
        }
      }
      return _member_of__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.FALSE))
    }
    ...
    if SDAI.IS_TRUE( _TEMP128 ) {
      ...
      if SDAI.IS_TRUE( _TEMP129 ) {
        ...
        return _member_of__cache.updateCache(params: _params, value: _TEMP140)
      }
      return _member_of__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.FALSE))
    }
    ...
    if SDAI.IS_TRUE( _TEMP141 ) {
      ...
      if SDAI.IS_TRUE( _TEMP142 ) {
        ...
        return _member_of__cache.updateCache(params: _params, value: _TEMP175)
      }
      return _member_of__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.FALSE))
    }
    ...
    if SDAI.IS_TRUE( _TEMP176 ) {
      ...
      return _member_of__cache.updateCache(params: _params, value: CUM)
    }
