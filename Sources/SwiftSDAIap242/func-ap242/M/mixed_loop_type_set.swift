/* file: mixed_loop_type_set.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
*/
  ...
  func MIXED_LOOP_TYPE_SET(_ L: (SDAI.SET<eLOOP>/*[0:nil]*/ )? ) 
    ...
    if SDAI.IS_TRUE( _TEMP2 ) {
      return _mixed_loop_type_set__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.FALSE))
    }
    ...
    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/2, TO:/*SDAI.INTEGER*/SDAI.SIZEOF(
      ...
      for I in incrementControl {
        ...
        if SDAI.IS_TRUE( _TEMP5 ) {
          return _mixed_loop_type_set__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.TRUE))
        }
      }
    }
    return _mixed_loop_type_set__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.FALSE))
