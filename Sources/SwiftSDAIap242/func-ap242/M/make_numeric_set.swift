/* file: make_numeric_set.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
*/
  ...
  func MAKE_NUMERIC_SET( 
   ...
   ) -> (SDAI.SET<tMATHS_NUMBER>/*[2:(nil as SDAI.INTEGER?)]*/ )? {
    ...
    //LOCAL
    var NUMERIC_SET: (SDAI.SET<tMATHS_NUMBER>/*[2:(nil as SDAI.INTEGER?)]*/ )?  = 
      SDAI.SET<tMATHS_NUMBER>(bound1: SDAI.UNWRAP(SDAI.INTEGER(2)), bound2: (nil as SDAI.INTEGER?),  ([ 
        SDAI.AIE(START), 
