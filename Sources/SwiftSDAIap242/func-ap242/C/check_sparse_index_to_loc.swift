/* file: check_sparse_index_to_loc.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_FUNCTION; -- check_sparse_index_to_loc (line:36020 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  ...
  func CHECK_SPARSE_INDEX_TO_LOC(INDEX_RANGE: sTUPLE_SPACE? , LOC_DOMAIN: sTUPLE_SPACE? ) 
    ...
    let _TEMP4 = SDAI.aggregate(_TEMP3, contains: SDAI.STRING(/*SDAI.INTEGER*/_TEMP2))
    ...
    let _TEMP13 = SDAI.aggregate(_TEMP12, contains: SDAI.STRING(/*SDAI.INTEGER*/_TEMP11))
