/* file: compute_total_depth.swift 	 generated: Thu Dec 25 18:13:23 2025 */
...
```express
  ...
  END_FUNCTION; -- compute_total_depth (line:37113 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
*/
  ...
  public static 
  func COMPUTE_TOTAL_DEPTH( _ SWSRH: eSOLID_WITH_STEPPED_ROUND_HOLE.PRef?  ) 
    ...
    let _TEMP1 /* SDAI.LOGICAL */ = N .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
    if SDAI.IS_TRUE( _TEMP1 ) {
      ...
      if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/2, TO:/*tPOSITIVE_INTEGER*/N) {
        for I in incrementControl {
          ...
          let _TEMP2 /* SDAI.LIST<tPOSITIVE_LENGTH_MEASURE>[1:SEGMENTS] ? */ = SWSRH?.SEGMENT_DEPTHS
          let _TEMP3 /* tPOSITIVE_LENGTH_MEASURE? */ = _TEMP2?[I]
          let _TEMP4 /* SDAI.REAL? */ = TD + _TEMP3
...
private let _compute_total_depth__cache = SDAI.FunctionResultCache(
  label: "COMPUTE_TOTAL_DEPTH",
