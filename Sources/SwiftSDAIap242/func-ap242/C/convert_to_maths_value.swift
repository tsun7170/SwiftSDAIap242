/* file: convert_to_maths_value.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```express
  ...
  END_FUNCTION; -- convert_to_maths_value (line:37588 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
*/
  ...
  public static 
  func CONVERT_TO_MATHS_VALUE<gG: SDAI.GenericType>( _ VAL: gG?  ) 
    -> sMATHS_VALUE? {
    ...
    let _TEMP3 /* SDAI.LOGICAL */ = SDAI.aggregate( TYPES, contains: SDAI.STRING("INTEGER") )
    ...
    let _TEMP4 /* SDAI.LOGICAL */ = SDAI.aggregate( TYPES, contains: SDAI.STRING("REAL") )
    ...
    let _TEMP5 /* SDAI.LOGICAL */ = SDAI.aggregate( TYPES, contains: SDAI.STRING("NUMBER") )
    ...
    let _TEMP6 /* SDAI.LOGICAL */ = SDAI.aggregate( TYPES, contains: SDAI.STRING("BOOLEAN") )
    ...
    let _TEMP7 /* SDAI.LOGICAL */ = SDAI.aggregate( TYPES, contains: SDAI.STRING("LOGICAL") )
    ...
    let _TEMP8 /* SDAI.LOGICAL */ = SDAI.aggregate( TYPES, contains: SDAI.STRING("STRING") )
    ...
    let _TEMP9 /* SDAI.LOGICAL */ = SDAI.aggregate( TYPES, contains: SDAI.STRING("BINARY") )
    ...
    let _TEMP10 /* SDAI.LOGICAL */ = SDAI.aggregate( TYPES, contains: SDAI.STRING("LIST") )
    if SDAI.IS_TRUE( _TEMP10 ) {
      ...
      if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/SDAI.SIZEOF( 
        ...
        for I in incrementControl {
          ...
          let _TEMP11 /* SDAI.GENERIC? */ = VAL_LIST?[I]
          let _TEMP12 /* sMATHS_VALUE? */ = CONVERT_TO_MATHS_VALUE( _TEMP11 )
          MVAL = _TEMP12
          
          let _TEMP13 /* SDAI.BOOLEAN */ = SDAI.EXISTS( MVAL )
...
private let _convert_to_maths_value__cache = SDAI.FunctionResultCache(
  label: "CONVERT_TO_MATHS_VALUE",
