/* file: class_assignment_is_valid.swift 	 generated: Sat Aug 14 13:46:02 2021 */
    ...
    if SDAI.IS_TRUE( _TEMP3 ) {
      ...
      if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/SDAI.LOINDEX(
        ...
        for I in incrementControl {
          ...
          let _TEMP12 = SDAI.FORCE_OPTIONAL(_TEMP10) * _TEMP11
    ...
    if SDAI.IS_TRUE( _TEMP15 ) {
      ...
      if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/SDAI.LOINDEX(
        ...
        for I in incrementControl {
          ...
          let _TEMP26 = SDAI.FORCE_OPTIONAL(_TEMP24) * _TEMP25
