/* file: convert_to_operands_prcmfn.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  func CONVERT_TO_OPERANDS_PRCMFN(SRCDOM: sMATHS_SPACE_OR_FUNCTION? , PREPFUN: SDAI.LIST<eMATHS_FUNCTION>? , 
    ...
    //LOCAL
    var OPERANDS: SDAI.LIST<eGENERIC_EXPRESSION>?  = SDAI.LIST<eGENERIC_EXPRESSION>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &OPERANDS)
