/* file: check_curve_planarity.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```express
  ...
  END_FUNCTION; -- check_curve_planarity (line:36292 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
*/
  ...
  public static 
  func CHECK_CURVE_PLANARITY( _ CHECKED_CURVE: eCURVE.PRef?  ) 
    -> SDAI.BOOLEAN? {
    ...
    //LOCAL
    var CRV: eCURVE.PRef?  = CHECKED_CURVE; SDAI.TOUCH(var: &CRV)
    ...
    if SDAI.IS_TRUE( _TEMP5 ) {
      ...
      let _TEMP7 /* eTRIMMED_CURVE.PRef? */ = CRV?.GROUP_REF(eTRIMMED_CURVE.self)
      let _TEMP8 /* eCURVE.PRef? */ = _TEMP7?.BASIS_CURVE
      let _TEMP9 /* SDAI.BOOLEAN? */ = CHECK_CURVE_PLANARITY( _TEMP8 )
      ...
      if SDAI.IS_TRUE( _TEMP10 ) {
        ...
        let _TEMP11 /* SDAI.LOGICAL */ = SDAI.TYPEOF( CRV, IS: ePCURVE.self )
        let _TEMP12 /* SDAI.LOGICAL */ = SDAI.TYPEOF( (CRV?.GROUP_REF(ePCURVE.self))?.BASIS_SURFACE, 
          IS: ePLANE.self )
        ...
        if SDAI.IS_TRUE( _TEMP13 ) {
          ...
          let _TEMP14 /* SDAI.LOGICAL */ = SDAI.TYPEOF( CRV, IS: eSURFACE_CURVE.self )
          if SDAI.IS_TRUE( _TEMP14 ) {
            ...
            if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/
              ...
              for J in incrementControl {
                ...
                let _TEMP15 /* SDAI.LOGICAL */ = SDAI.TYPEOF( (CRV?.GROUP_REF(eSURFACE_CURVE.self))?.BASIS_SURFACE?[
                  J], IS: ePLANE.self )
...
private let _check_curve_planarity__cache = SDAI.FunctionResultCache(
  label: "CHECK_CURVE_PLANARITY",
