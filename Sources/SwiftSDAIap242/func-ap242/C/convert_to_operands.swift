/* file: convert_to_operands.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
```express
  ...
  END_FUNCTION; -- convert_to_operands (line:37680 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
*/
  ...
  public static 
  func CONVERT_TO_OPERANDS<g_AGG1: SDAI.AggregationType>( _ VALUES: g_AGG1?  ) 
  ...
  where g_AGG1.ELEMENT == sMATHS_VALUE {
    ...
    let _TEMP1 /* SDAI.BOOLEAN */ = SDAI.EXISTS( VALUES )
    ...
    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/SDAI.LOINDEX( 
      ...
      for I in incrementControl {
        ...
        let _TEMP3 /* SDAI.INTEGER? */ = LOC + SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
        LOC = _TEMP3
      }
    }
...
private let _convert_to_operands__cache = SDAI.FunctionResultCache(
  label: "CONVERT_TO_OPERANDS",
