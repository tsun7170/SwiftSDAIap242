/* file: consistent_sizes.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  func CONSISTENT_SIZES( 
    ...
    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/NDATASETS - SDAI.FORCE_OPTIONAL(
      ...
      for I in incrementControl {
        ...
        let _TEMP2 /* SDAI.LIST<SDAI.LIST<SDAI.REAL>[3:3] >[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP1?.POINT_COORDINATES
    ...
    let _TEMP6 /* SDAI.LIST<SDAI.LIST<SDAI.REAL>[3:3] >[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP5?.POINT_COORDINATES
