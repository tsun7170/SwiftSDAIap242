/* file: surface_condition_correlation.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
```express
  ...
  END_FUNCTION; -- surface_condition_correlation (line:47589 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
*/
  ...
  func SURFACE_CONDITION_CORRELATION( 
    ...
    switch _TEMP1 {
      case .some("visual appearance"), .some("tactile appearance"), .some("contact ratio"), .some("hardness"), .some(
        "treatment result"), .some("surface texture"):
        //
        let _TEMP2 /* tLABEL? */ = PD?.NAME
        let _TEMP3 /* tLABEL? */ = REP?.NAME
...
private let _surface_condition_correlation__cache = SDAI.FunctionResultCache(
  label: "SURFACE_CONDITION_CORRELATION",
