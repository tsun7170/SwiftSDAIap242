/* file: surface_condition_correlation.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  func SURFACE_CONDITION_CORRELATION(
    ...
    if let selector = _TEMP1 {
      ...
      case "visual appearance", "tactile appearance", "contact ratio", "hardness", "treatment result", 
        ...
        return _surface_condition_correlation__cache.updateCache(params: _params, value: _TEMP4)

      default:
        return _surface_condition_correlation__cache.updateCache(params: _params, value: SDAI.LOGICAL(
          SDAI.UNKNOWN))
      } //end switch
    }
    else {
