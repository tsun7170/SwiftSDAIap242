/* file: simplify_function_application.swift 	 generated: Fri Sep 26 17:24:11 2025 */
    ...
    if SDAI.IS_TRUE( IS_ELEMENTARY ) {
      if let selector = EF_VAL {
            ...
            for I in incrementControl {
              ...
              if SDAI.IS_TRUE( _TEMP19 ) {
                ...
                if SDAI.IS_TRUE( _TEMP22 ) {
                  ...
                  let _TEMP23 = CTMV(SDAI.LOGICAL.FundamentalType(SDAI.FALSE))
            ...
            for I in incrementControl {
              ...
              if SDAI.IS_TRUE( _TEMP31 ) {
                ...
                if SDAI.IS_TRUE( _TEMP34 ) {
                  ...
                  let _TEMP35 = CTMV(SDAI.LOGICAL.FundamentalType(SDAI.TRUE))
            ...
            if SDAI.IS_TRUE( _TEMP46 ) {
              ...
              if SDAI.IS_TRUE( _TEMP49 ) {
                ...
                if SDAI.IS_TRUE( _TEMP51 ) {
                  ...
                  let _TEMP52 = CTMV(SDAI.LOGICAL.FundamentalType(SDAI.UNKNOWN))
            ...
            if SDAI.IS_TRUE( _TEMP55 ) {
              ...
              if SDAI.IS_TRUE( _TEMP56 ) {
                ...
                if SDAI.IS_TRUE( _TEMP58 ) {
                  ...
                  let _TEMP59 = CTMV(SDAI.LOGICAL.FundamentalType(SDAI.UNKNOWN))
        ...
        case EF_ADD_C:
          ...
          if SDAI.IS_TRUE( _TEMP342 ) {
            SDAI.INSERT( L: &VLIST, E: MAKEC(
              X: P, Y: Q), P: SDAI.INTEGER.FundamentalType(0) )
          }
        ...
        case EF_CONCAT_T:
          ...
          let _TEMP682 = SDAI.LIST<sMATHS_VALUE>(SDAI.EMPTY_AGGREGATE)
          TPL = _TEMP682
          if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/SDAI.SIZEOF(
            VLIST), TO:/*SDAI.INTEGER*/1, BY:/*SDAI.INTEGER*/ -1) {
            for I in incrementControl {
              ...
              if SDAI.IS_TRUE( _TEMP683 ) {
                ...
                if SDAI.IS_TRUE( _TEMP687 ) {
                  ...
                  let _TEMP688 = SDAI.LIST<sMATHS_VALUE>(SDAI.EMPTY_AGGREGATE)
                  TPL = _TEMP688
                }
              }
            }
        ...
        case EF_MEMBER_OF:
          ...
          let _TEMP898 = SDAI.aggregate(_TEMP897, contains: _TEMP896)
