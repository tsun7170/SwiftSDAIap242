/* file: simplify_generic_expression.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  func SIMPLIFY_GENERIC_EXPRESSION(_ EXPR: eGENERIC_EXPRESSION? ) 
    ...
    var OPLIST: SDAI.LIST<eGENERIC_EXPRESSION>?  = SDAI.LIST<eGENERIC_EXPRESSION>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &OPLIST)
    ...
    if SDAI.IS_TRUE( _TEMP84 ) {
        ...
        for I in incrementControl {
          ...
          if SDAI.IS_TRUE( _TEMP85 ) {
            ...
            if SDAI.IS_TRUE( (  !BOO ) ) {
              ...
              let _TEMP87 = CONVERT_TO_MATHS_VALUE(SDAI.LOGICAL.FundamentalType(SDAI.FALSE))
      ...
      if SDAI.IS_TRUE( _TEMP89 ) {
        ...
        let _TEMP90 = CONVERT_TO_MATHS_VALUE(SDAI.LOGICAL.FundamentalType(SDAI.TRUE))
    ...
    if SDAI.IS_TRUE( _TEMP292 ) {
        ...
        for I in incrementControl {
          ...
          if SDAI.IS_TRUE( _TEMP293 ) {
            ...
            if SDAI.IS_TRUE( BOO ) {
              ...
              let _TEMP295 = CONVERT_TO_MATHS_VALUE(SDAI.LOGICAL.FundamentalType(SDAI.TRUE))
      ...
      if SDAI.IS_TRUE( _TEMP297 ) {
        ...
        let _TEMP298 = CONVERT_TO_MATHS_VALUE(SDAI.LOGICAL.FundamentalType(SDAI.FALSE))
