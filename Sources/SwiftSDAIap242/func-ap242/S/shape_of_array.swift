/* file: shape_of_array.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_FUNCTION; -- shape_of_array (line:44279 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  ...
  func SHAPE_OF_ARRAY(_ FUNC: eMATHS_FUNCTION? ) 
    ...
    let _TEMP12 = SDAI.aggregate(_TEMP11, contains: SDAI.STRING(/*SDAI.INTEGER*/_TEMP9))
    ...
    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*tNONNEGATIVE_INTEGER*/
      ...
      for I in incrementControl {
        ...
        let _TEMP18 = SDAI.aggregate(_TEMP17, contains: SDAI.STRING(/*SDAI.INTEGER*/_TEMP16))
        let _TEMP19 =  !_TEMP18
