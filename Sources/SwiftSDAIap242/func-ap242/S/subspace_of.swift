/* file: subspace_of.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_FUNCTION; -- subspace_of (line:46522 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  ...
  func SUBSPACE_OF(SPACE1: eMATHS_SPACE? , SPACE2: eMATHS_SPACE? ) 
    ...
    if SDAI.IS_TRUE( _TEMP5 ) {
      return _subspace_of__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.FALSE))
    }
    
    let _TEMP6 = SPC2 .==. SDAI.FORCE_OPTIONAL(THE_GENERICS)
    if SDAI.IS_TRUE( _TEMP6 ) {
      return _subspace_of__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.TRUE))
    }
    ...
    if SDAI.IS_TRUE( _TEMP7 ) {
      ...
      if let selector = _TEMP16 {
        ...
        case ES_COMPLEX_NUMBERS:
          ...
          return _subspace_of__cache.updateCache(params: _params, value: _TEMP17)

        case ES_REALS:
          
          let _TEMP18 = ES_VAL .==. SDAI.FORCE_OPTIONAL(ES_NUMBERS)
          return _subspace_of__cache.updateCache(params: _params, value: _TEMP18)

        case ES_INTEGERS:
          
          let _TEMP19 = ES_VAL .==. SDAI.FORCE_OPTIONAL(ES_NUMBERS)
          return _subspace_of__cache.updateCache(params: _params, value: _TEMP19)
        ...
        case ES_BOOLEANS:
          ...
          return _subspace_of__cache.updateCache(params: _params, value: _TEMP20)
      ...
      return _subspace_of__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.UNKNOWN))
    }
    ...
    if SDAI.IS_TRUE( _TEMP21 ) {
      ...
      return _subspace_of__cache.updateCache(params: _params, value: CUM)
    }
    ...
    if SDAI.IS_TRUE( _TEMP25 ) {
      ...
      if SDAI.IS_TRUE( _TEMP26 ) {
        ...
        return _subspace_of__cache.updateCache(params: _params, value: _TEMP31)
      }
      ...
      if SDAI.IS_TRUE( _TEMP32 ) {
        ...
        return _subspace_of__cache.updateCache(params: _params, value: _TEMP37)
      }
      return _subspace_of__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.FALSE))
    }
    ...
    if SDAI.IS_TRUE( _TEMP38 ) {
      ...
      if SDAI.IS_TRUE( _TEMP39 ) {
        ...
        return _subspace_of__cache.updateCache(params: _params, value: _TEMP44)
      }
      ...
      if SDAI.IS_TRUE( _TEMP45 ) {
        ...
        return _subspace_of__cache.updateCache(params: _params, value: _TEMP50)
      }
      return _subspace_of__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.FALSE))
    }
    ...
    if SDAI.IS_TRUE( _TEMP51 ) {
      ...
      if SDAI.IS_TRUE( _TEMP52 ) {
        ...
        return _subspace_of__cache.updateCache(params: _params, value: _TEMP57)
      }
    ...
    if SDAI.IS_TRUE( _TEMP87 ) {
      ...
      if SDAI.IS_TRUE( _TEMP88 ) {
        ...
        return _subspace_of__cache.updateCache(params: _params, value: _TEMP93)
      }
      ...
      if SDAI.IS_TRUE( _TEMP94 ) {
        ...
        return _subspace_of__cache.updateCache(params: _params, value: _TEMP106)
      }
      return _subspace_of__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.FALSE))
    }
    ...
    if SDAI.IS_TRUE( _TEMP107 ) {
      ...
      if SDAI.IS_TRUE( _TEMP108 ) {
        ...
        return _subspace_of__cache.updateCache(params: _params, value: _TEMP113)
      }
      ...
      if SDAI.IS_TRUE( _TEMP114 ) {
        ...
        return _subspace_of__cache.updateCache(params: _params, value: _TEMP126)
      }
      return _subspace_of__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.FALSE))
    }
    ...
    if SDAI.IS_TRUE( _TEMP127 ) {
      ...
      if SDAI.IS_TRUE( _TEMP128 ) {
        ...
        return _subspace_of__cache.updateCache(params: _params, value: _TEMP133)
      }
      ...
      if SDAI.IS_TRUE( _TEMP134 ) {
        ...
        return _subspace_of__cache.updateCache(params: _params, value: _TEMP145)
      }
      ...
      if SDAI.IS_TRUE( _TEMP146 ) {
        ...
        let _TEMP150 = SUBSPACE_OF(SPACE1: eMATHS_SPACE(/*ePOLAR_COMPLEX_NUMBER_REGION*/_TEMP149), 
                                   SPACE2: SPC2)
        return _subspace_of__cache.updateCache(params: _params, value: _TEMP150)
      }
      return _subspace_of__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.FALSE))
    }
    ...
    if SDAI.IS_TRUE( _TEMP151 ) {
      ...
      if SDAI.IS_TRUE( _TEMP152 ) {
        ...
        return _subspace_of__cache.updateCache(params: _params, value: _TEMP157)
      }
      ...
      if SDAI.IS_TRUE( _TEMP158 ) {
        ...
        let _TEMP160 = SUBSPACE_OF(SPACE1: eMATHS_SPACE(/*eCARTESIAN_COMPLEX_NUMBER_REGION*/_TEMP159), 
                                   SPACE2: SPC2)
        return _subspace_of__cache.updateCache(params: _params, value: _TEMP160)
      }
      ...
      if SDAI.IS_TRUE( _TEMP161 ) {
        ...
        if SDAI.IS_TRUE( _TEMP164 ) {
          ...
          if SDAI.IS_TRUE( _TEMP167 ) {
            ...
            return _subspace_of__cache.updateCache(params: _params, value: _TEMP184)
          }
          else {
            ...
            return _subspace_of__cache.updateCache(params: _params, value: _TEMP191)
          }
        }
        ...
        return _subspace_of__cache.updateCache(params: _params, value: _TEMP194)
      }
      return _subspace_of__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.FALSE))
    }
    ...
    if SDAI.IS_TRUE( _TEMP232 ) {
      ...
      if SDAI.IS_TRUE( _TEMP233 ) {
        ...
        return _subspace_of__cache.updateCache(params: _params, value: _TEMP236)
      }
