/* file: simplify_maths_value.swift 	 generated: Thu Dec 25 18:13:23 2025 */
...
```express
  ...
  END_FUNCTION; -- simplify_maths_value (line:46921 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
*/
  ...
  func SIMPLIFY_MATHS_VALUE( _ VAL: sMATHS_VALUE?  ) 
    ...
    var NLIST: SDAI.LIST<sMATHS_VALUE>?  = SDAI.LIST<sMATHS_VALUE>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &NLIST)
    //END_LOCAL

    //BODY
    
    let _TEMP1 /* SDAI.LOGICAL */ = SDAI.aggregate( VTYPES, contains: SDAI.STRING("GENERIC_EXPRESSION") )
    if SDAI.IS_TRUE( _TEMP1 ) {
      
      let _TEMP2 /* sMATHS_VALUE? */ = SIMPLIFY_GENERIC_EXPRESSION( eGENERIC_EXPRESSION.PRef(/*sMATHS_VALUE*/
          VAL) )
      return _simplify_maths_value__cache.updateCache(params: _params, value: _TEMP2)
    }
    
    let _TEMP3 /* SDAI.LOGICAL */ = SDAI.aggregate( VTYPES, contains: SDAI.STRING("LIST") )
    if SDAI.IS_TRUE( _TEMP3 ) {
      ...
      let _TEMP4 /* sMATHS_VALUE? */ = CONVERT_TO_MATHS_VALUE( NLIST )
...
private let _simplify_maths_value__cache = SDAI.FunctionResultCache(
  label: "SIMPLIFY_MATHS_VALUE",
