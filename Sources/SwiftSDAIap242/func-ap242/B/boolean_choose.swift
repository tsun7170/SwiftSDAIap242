/* file: boolean_choose.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```express
  ...
  END_FUNCTION; -- boolean_choose (line:36121 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
*/
  ...
  public static 
  func BOOLEAN_CHOOSE<gITEM: SDAI.GenericType>( 
    B: SDAI.BOOLEAN? , 
    CHOICE1: gITEM? , 
    CHOICE2: gITEM? 
   ) -> gITEM? {
...
private let _boolean_choose__cache = SDAI.FunctionResultCache(
  label: "BOOLEAN_CHOOSE",
