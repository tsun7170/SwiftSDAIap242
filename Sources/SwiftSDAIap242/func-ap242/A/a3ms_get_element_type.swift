/* file: a3ms_get_element_type.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```express
  ...
  END_FUNCTION; -- a3ms_get_element_type (line:34725 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
*/
  ...
  public static 
  func A3MS_GET_ELEMENT_TYPE( _ EI: (SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>/*[1:(nil as SDAI.INTEGER?)]*/ )?  ) 
    ...
    let _TEMP1 /* sINSPECTED_EQUIVALENCE_ELEMENT_SELECT? */ = EI?[1]
...
private let _a3ms_get_element_type__cache = SDAI.FunctionResultCache(
  label: "A3MS_GET_ELEMENT_TYPE",
