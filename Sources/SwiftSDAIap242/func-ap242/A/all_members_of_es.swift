/* file: all_members_of_es.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
```express
  ...
  END_FUNCTION; -- all_members_of_es (line:35724 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
*/
  ...
  public static 
  func ALL_MEMBERS_OF_ES( 
    SV: SDAI.SET<sMATHS_VALUE>? , 
    ...
    var GE: eGENERIC_EXPRESSION.PRef? 
    ...
    //BODY
    //
    let _TEMP1 /* SDAI.BOOLEAN */ = SDAI.EXISTS( SV )
    ...
    if SDAI.IS_TRUE( _TEMP5 ) {
      return _all_members_of_es__cache.updateCache(params: _params, value: SDAI.UNWRAP(SDAI.LOGICAL(
        SDAI.FALSE)))
    }
    switch ES {
    ...
    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/SDAI.SIZEOF( 
      ...
      for I in incrementControl {
        //
        let _TEMP6 /* sMATHS_VALUE? */ = SV?[I]
        let _TEMP7 /* SDAI.BOOLEAN */ = SDAI.EXISTS( _TEMP6 )
        ...
        //
        let _TEMP9 /* sMATHS_VALUE? */ = SV?[I]
        let _TEMP10 /* sMATHS_VALUE? */ = SIMPLIFY_MATHS_VALUE( _TEMP9 )
        V = _TEMP10
        //
        let _TEMP11 /* SDAI.SET<SDAI.STRING>? */ = STRIPPED_TYPEOF( V )
        TYPES = _TEMP11
        //
        let _TEMP12 /* SDAI.LOGICAL */ = SDAI.aggregate( TYPES, contains: KEY_TYPE )
        if SDAI.IS_TRUE( _TEMP12 ) {
          continue
        }
        //
        let _TEMP13 /* SDAI.LOGICAL */ = ES .==. SDAI.FORCE_OPTIONAL(ES_NUMBERS)
        let _TEMP14 /* SDAI.LOGICAL */ = SDAI.aggregate( TYPES, contains: SDAI.STRING("COMPLEX_NUMBER_LITERAL") )
        let _TEMP15 /* SDAI.LOGICAL */ = _TEMP13 && _TEMP14
        if SDAI.IS_TRUE( _TEMP15 ) {
          continue
        }
        //
        let _TEMP16 /* SDAI.SET<SDAI.STRING>? */ = SDAI.FORCE_OPTIONAL(BASE_TYPES) * TYPES
        ...
        GE = eGENERIC_EXPRESSION.PRef(/*sMATHS_VALUE*/V)
        //
        let _TEMP19 /* SDAI.BOOLEAN? */ = HAS_VALUES_SPACE( GE )
        if SDAI.IS_TRUE( _TEMP19 ) {
          //
          let _TEMP20 /* eMATHS_SPACE.PRef? */ = VALUES_SPACE_OF( GE )
          VSPC = _TEMP20
          //
          let _TEMP21 /* SDAI.LOGICAL */ = SUBSPACE_OF_ES( 
              SPC: VSPC, 
              ES: ES )
          let _TEMP22 /* SDAI.LOGICAL */ =  !_TEMP21
          if SDAI.IS_TRUE( _TEMP22 ) {
            //
            let _TEMP23 /* eELEMENTARY_SPACE.PRef? */ = MAKE_ELEMENTARY_SPACE( 
                ES )
            let _TEMP24 /* SDAI.BOOLEAN? */ = COMPATIBLE_SPACES( 
                SP1: VSPC, 
                SP2: eMATHS_SPACE.PRef(/*eELEMENTARY_SPACE.PRef*/_TEMP23) )
            let _TEMP25 /* SDAI.LOGICAL */ =  !_TEMP24
        ...
        //
        let _TEMP26 /* SDAI.LOGICAL */ = SDAI.FORCE_OPTIONAL(CUM) .==. SDAI.FORCE_OPTIONAL(SDAI.LOGICAL(
          SDAI.FALSE))
    ...
    return _all_members_of_es__cache.updateCache(params: _params, value: SDAI.UNWRAP(CUM))
  }

}

//MARK: - function result cache
private let _all_members_of_es__cache = SDAI.FunctionResultCache(
  label: "ALL_MEMBERS_OF_ES",
