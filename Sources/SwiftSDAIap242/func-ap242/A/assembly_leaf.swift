/* file: assembly_leaf.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_FUNCTION; -- assembly_leaf (line:35424 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  ...
  func ASSEMBLY_LEAF(_ ITEM: ePRODUCT_DEFINITION? ) 
    ...
    let _TEMP2 = _TEMP1?.QUERY{ PDR in 
        ...
        return _TEMP1 }
    let _TEMP3 = SDAI.BAG<SDAI.GENERIC_ENTITY>(/*SDAI.BAG<eASSEMBLY_COMPONENT_USAGE>*/LOCAL_RELATION2) + 
      _TEMP2
