/* file: acyclic_mapped_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  func ACYCLIC_MAPPED_REPRESENTATION(
    ...
    let _TEMP2 = SDAI.SET<eREPRESENTATION>(SDAI.EMPTY_AGGREGATE)
    RS2 = _TEMP2
    while !SDAI.IS_TRUE(( SDAI.SIZEOF(RS1) > SDAI.FORCE_OPTIONAL(SDAI.INTEGER(0)) )) {
      ...
      let _TEMP18 = SDAI.SET<eREPRESENTATION>(SDAI.EMPTY_AGGREGATE)
      RS2 = _TEMP18
    }
