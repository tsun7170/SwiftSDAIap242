/* file: a3ma_validate_detected_difference_types.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_FUNCTION; -- a3ma_validate_detected_difference_types (line:34124 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  ...
  func A3MA_VALIDATE_DETECTED_DIFFERENCE_TYPES(
            ...
            if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/
              ...
              for J in incrementControl {
                ...
                if SDAI.IS_TRUE( _TEMP11 ) {
                  return _a3ma_validate_detected_difference_types__cache.updateCache(params: _params, value: 
    ...
    return _a3ma_validate_detected_difference_types__cache.updateCache(params: _params, value: SDAI.LOGICAL(
      SDAI.TRUE))
  }
