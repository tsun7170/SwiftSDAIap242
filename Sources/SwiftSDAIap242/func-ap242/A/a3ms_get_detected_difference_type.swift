/* file: a3ms_get_detected_difference_type.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```express
  ...
  END_FUNCTION; -- a3ms_get_detected_difference_type (line:34589 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
*/
  ...
  public static 
  func A3MS_GET_DETECTED_DIFFERENCE_TYPE( _ EI: (SDAI.LIST<sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT>/*[0:nil]*/ )?  ) 
    ...
    let _TEMP2 /* SDAI.LOGICAL */ = SIZEEI .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(0))
    if SDAI.IS_TRUE( _TEMP2 ) {
      ...
      let _TEMP3 /* sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT? */ = EI?[1]
      ...
      if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/2, TO:/*SDAI.INTEGER*/SIZEEI) {
        for I in incrementControl {
          ...
          let _TEMP5 /* sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT? */ = EI?[I]
          let _TEMP6 /* SDAI.SET<SDAI.STRING> */ = SDAI.TYPEOF( _TEMP5 )
          let _TEMP7 /* SDAI.LOGICAL */ = SDAI.FORCE_OPTIONAL(_TEMP6) .!=. TYPE_OUT
      ...
      if SDAI.IS_TRUE( _TEMP8 ) {
        ...
        let _TEMP9 /* SDAI.LOGICAL */ = SIZEEI .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
      ...
      if SDAI.IS_TRUE( _TEMP10 ) {
        ...
        let _TEMP11 /* SDAI.LOGICAL */ = SIZEEI .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
        if SDAI.IS_TRUE( _TEMP11 ) {
          ...
          let _TEMP12 /* SDAI.LOGICAL */ = SIZEEI .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(2))
      ...
      if SDAI.IS_TRUE( _TEMP13 ) {
        ...
        let _TEMP14 /* SDAI.LOGICAL */ = SIZEEI .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
      ...
      if SDAI.IS_TRUE( _TEMP15 ) {
        ...
        let _TEMP16 /* SDAI.LOGICAL */ = SIZEEI .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
        if SDAI.IS_TRUE( _TEMP16 ) {
          ...
          let _TEMP17 /* SDAI.LOGICAL */ = SIZEEI .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(2))
          if SDAI.IS_TRUE( _TEMP17 ) {
            ...
            let _TEMP18 /* SDAI.LOGICAL */ = SIZEEI .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(3))
            if SDAI.IS_TRUE( _TEMP18 ) {
              ...
              let _TEMP19 /* SDAI.LOGICAL */ = SIZEEI .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(4))
              if SDAI.IS_TRUE( _TEMP19 ) {
                ...
                let _TEMP20 /* SDAI.LOGICAL */ = SIZEEI .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(5))
      ...
      if SDAI.IS_TRUE( _TEMP21 ) {
        ...
        let _TEMP22 /* SDAI.LOGICAL */ = SIZEEI .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
      ...
      if SDAI.IS_TRUE( _TEMP23 ) {
        ...
        let _TEMP24 /* SDAI.LOGICAL */ = SIZEEI .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
      ...
      let _TEMP25 /* SDAI.LOGICAL */ = SDAI.aggregate( TYPE_OUT, contains: SDAI.STRING(
        "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.LENGTH_MEASURE") )
      if SDAI.IS_TRUE( _TEMP25 ) {
        
        let _TEMP26 /* SDAI.LOGICAL */ = SIZEEI .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
      ...
      let _TEMP27 /* SDAI.LOGICAL */ = SDAI.aggregate( TYPE_OUT, contains: SDAI.STRING(
        "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.POINT_ON_CURVE") )
      if SDAI.IS_TRUE( _TEMP27 ) {
        
        let _TEMP28 /* SDAI.LOGICAL */ = SIZEEI .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
      ...
      let _TEMP29 /* SDAI.LOGICAL */ = SDAI.aggregate( TYPE_OUT, contains: SDAI.STRING(
        "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.POINT_ON_SURFACE") )
      if SDAI.IS_TRUE( _TEMP29 ) {
        
        let _TEMP30 /* SDAI.LOGICAL */ = SIZEEI .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
      ...
      let _TEMP31 /* SDAI.LOGICAL */ = SDAI.aggregate( TYPE_OUT, contains: SDAI.STRING(
        "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.VOLUME_MEASURE") )
      if SDAI.IS_TRUE( _TEMP31 ) {
        
        let _TEMP32 /* SDAI.LOGICAL */ = SIZEEI .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
...
private let _a3ms_get_detected_difference_type__cache = SDAI.FunctionResultCache(
  label: "A3MS_GET_DETECTED_DIFFERENCE_TYPE",
