/* file: acyclic_action_relationship.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  public static 
  func ACYCLIC_ACTION_RELATIONSHIP(RELATION: eACTION_RELATIONSHIP? , RELATIVES: (SDAI.SET<eACTION>/*[1:nil]*/ )? , 
    ...
    //LOCAL
    var X: SDAI.SET<eACTION_RELATIONSHIP>? 

    
    let _TEMP1 = RELATION?.RELATING_ACTION
    ...
    let _TEMP3 = RELATION?.RELATING_ACTION
    ...
    let _TEMP6 = _TEMP5?.QUERY{ ACTN in 

        let _TEMP1 = SDAI.TYPEOF(ACTN)
        let _TEMP2 = SDAI.aggregate(_TEMP1, contains: SPECIFIC_RELATION)
        return _TEMP2 }
    X = SDAI.SET<eACTION_RELATIONSHIP>(generic: /*SDAI.SET<gINTYPE>*/_TEMP6)
    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/SDAI.HIINDEX(
      X)) {
      for I in incrementControl {
        
        let _TEMP7 = X?[I]
        let _TEMP8 = RELATION?.RELATING_ACTION
        let _TEMP9 = RELATIVES + _TEMP8
        let _TEMP10 = ACYCLIC_ACTION_RELATIONSHIP(
          RELATION: _TEMP7, RELATIVES: SDAI.SET<eACTION>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as 
          SDAI.INTEGER?), /*SDAI.SET<eACTION>*/_TEMP9), 
