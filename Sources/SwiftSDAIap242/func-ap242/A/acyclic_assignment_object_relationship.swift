/* file: acyclic_assignment_object_relationship.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_FUNCTION; -- acyclic_assignment_object_relationship (line:34850 file:ap242ed2_mim_lf_v1.101.TY.exp)

*/

  public static 
  func ACYCLIC_ASSIGNMENT_OBJECT_RELATIONSHIP(
    RELATION: eASSIGNMENT_OBJECT_RELATIONSHIP? , RELATIVES: (SDAI.SET<sASSIGNMENT_OBJECT_SELECT>/*[1:nil]*/ )? , 
    ...
    //LOCAL
    var X: SDAI.SET<eASSIGNMENT_OBJECT_RELATIONSHIP>? 
    ...
    let _TEMP4 = SDAI.USEDIN(T: _TEMP3, ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
      .eASSIGNMENT_OBJECT_RELATIONSHIP.RELATED)
    let _TEMP5 = BAG_TO_SET(_TEMP4)
    let _TEMP6 = _TEMP5?.QUERY{ AOR in 

        let _TEMP1 = SDAI.TYPEOF(AOR)
        let _TEMP2 = SDAI.aggregate(_TEMP1, contains: SPECIFIC_RELATION)
        return _TEMP2 }
    X = SDAI.SET<eASSIGNMENT_OBJECT_RELATIONSHIP>(generic: /*SDAI.SET<gINTYPE>*/_TEMP6)
    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/SDAI.HIINDEX(
      ...
      for I in incrementControl {
        ...
        let _TEMP10 = ACYCLIC_ASSIGNMENT_OBJECT_RELATIONSHIP(
          RELATION: _TEMP7, RELATIVES: SDAI.SET<sASSIGNMENT_OBJECT_SELECT>(
          bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as SDAI.INTEGER?), 
          /*SDAI.SET<sASSIGNMENT_OBJECT_SELECT>*/_TEMP9), 
...
private var _acyclic_assignment_object_relationship__cache = SDAI.FunctionResultCache(
