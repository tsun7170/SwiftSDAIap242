/* file: acyclic_product_definition_relationship.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_FUNCTION; -- acyclic_product_definition_relationship (line:35142 file:ap242ed2_mim_lf_v1.101.TY.exp)

*/

  public static 
  func ACYCLIC_PRODUCT_DEFINITION_RELATIONSHIP(
    RELATION: ePRODUCT_DEFINITION_RELATIONSHIP? , RELATIVES: (SDAI.SET<sPRODUCT_DEFINITION_OR_REFERENCE>/*[1:
    ...
    //LOCAL
    var X: SDAI.SET<ePRODUCT_DEFINITION_RELATIONSHIP>? 

    
    let _TEMP1 = RELATION?.RELATING_PRODUCT_DEFINITION
    ...
    let _TEMP3 = RELATION?.RELATING_PRODUCT_DEFINITION
    ...
    let _TEMP6 = _TEMP5?.QUERY{ PD in 
        ...
        return _TEMP2 }
    X = SDAI.SET<ePRODUCT_DEFINITION_RELATIONSHIP>(generic: /*SDAI.SET<gINTYPE>*/_TEMP6)
    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/SDAI.HIINDEX(
      X)) {
      for I in incrementControl {
        
        let _TEMP7 = X?[I]
        let _TEMP8 = RELATION?.RELATING_PRODUCT_DEFINITION
        let _TEMP9 = RELATIVES + _TEMP8
        let _TEMP10 = ACYCLIC_PRODUCT_DEFINITION_RELATIONSHIP(
          RELATION: _TEMP7, RELATIVES: SDAI.SET<sPRODUCT_DEFINITION_OR_REFERENCE>(
...
private var _acyclic_product_definition_relationship__cache = SDAI.FunctionResultCache(
