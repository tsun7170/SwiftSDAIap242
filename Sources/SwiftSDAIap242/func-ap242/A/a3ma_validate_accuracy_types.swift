/* file: a3ma_validate_accuracy_types.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_FUNCTION; -- a3ma_validate_accuracy_types (line:34075 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  ...
  func A3MA_VALIDATE_ACCURACY_TYPES(
    ...
    if SDAI.IS_TRUE( _TEMP5 ) {
      ...
      if SDAI.IS_TRUE( _TEMP10 ) {
        ...
        if SDAI.IS_TRUE( _TEMP12 ) {
          return _a3ma_validate_accuracy_types__cache.updateCache(params: _params, value: SDAI.LOGICAL(
            SDAI.TRUE))
        }
        else {
          return _a3ma_validate_accuracy_types__cache.updateCache(params: _params, value: SDAI.LOGICAL(
    ...
    if SDAI.IS_TRUE( _TEMP26 ) {
      return _a3ma_validate_accuracy_types__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.TRUE))
    }
    return _a3ma_validate_accuracy_types__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.FALSE))
  }
