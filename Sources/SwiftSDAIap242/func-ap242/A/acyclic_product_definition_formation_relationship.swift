/* file: acyclic_product_definition_formation_relationship.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  func ACYCLIC_PRODUCT_DEFINITION_FORMATION_RELATIONSHIP(
    RELATION: ePRODUCT_DEFINITION_FORMATION_RELATIONSHIP? , RELATIVES: (SDAI.SET<
    ePRODUCT_DEFINITION_FORMATION>/*[1:nil]*/ )? , SPECIFIC_RELATION: SDAI.STRING? ) 
    -> SDAI.BOOLEAN? {
    ...
    //LOCAL
    var X: SDAI.SET<ePRODUCT_DEFINITION_FORMATION_RELATIONSHIP>? 
    ...
    let _TEMP4 = SDAI.USEDIN(T: _TEMP3, ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
      .ePRODUCT_DEFINITION_FORMATION_RELATIONSHIP.RELATED_PRODUCT_DEFINITION_FORMATION)
    let _TEMP5 = BAG_TO_SET(_TEMP4)
    let _TEMP6 = _TEMP5?.QUERY{ PDF in 

        let _TEMP1 = SDAI.TYPEOF(PDF)
        let _TEMP2 = SDAI.aggregate(_TEMP1, contains: SPECIFIC_RELATION)
        return _TEMP2 }
    X = SDAI.SET<ePRODUCT_DEFINITION_FORMATION_RELATIONSHIP>(generic: /*SDAI.SET<gINTYPE>*/_TEMP6)
    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/SDAI.HIINDEX(
      ...
      for I in incrementControl {
        ...
        let _TEMP10 = ACYCLIC_PRODUCT_DEFINITION_FORMATION_RELATIONSHIP(
