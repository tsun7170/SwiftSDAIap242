/* file: acyclic_external_identification_assignment_relationship.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_FUNCTION; -- acyclic_external_identification_assignment_relationship (line:34978 file:ap242ed2_mim_lf_v1.101.TY.exp)

*/

  public static 
  func ACYCLIC_EXTERNAL_IDENTIFICATION_ASSIGNMENT_RELATIONSHIP(
    RELATION: eEXTERNAL_IDENTIFICATION_ASSIGNMENT_RELATIONSHIP? , RELATIVES: (SDAI.SET<
    eEXTERNAL_IDENTIFICATION_ASSIGNMENT>/*[1:nil]*/ )? , SPECIFIC_RELATION: SDAI.STRING? ) 
    -> SDAI.BOOLEAN? {
    ...
    //LOCAL
    var X: SDAI.SET<eEXTERNAL_IDENTIFICATION_ASSIGNMENT_RELATIONSHIP>? 
    ...
    let _TEMP4 = SDAI.USEDIN(T: _TEMP3, ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
      .eEXTERNAL_IDENTIFICATION_ASSIGNMENT_RELATIONSHIP.RELATED)
    let _TEMP5 = BAG_TO_SET(_TEMP4)
    let _TEMP6 = _TEMP5?.QUERY{ EIAR in 

        let _TEMP1 = SDAI.TYPEOF(EIAR)
        let _TEMP2 = SDAI.aggregate(_TEMP1, contains: SPECIFIC_RELATION)
        return _TEMP2 }
    X = SDAI.SET<eEXTERNAL_IDENTIFICATION_ASSIGNMENT_RELATIONSHIP>(generic: /*SDAI.SET<gINTYPE>*/_TEMP6)
    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/SDAI.HIINDEX(
      ...
      for I in incrementControl {
        ...
        let _TEMP10 = ACYCLIC_EXTERNAL_IDENTIFICATION_ASSIGNMENT_RELATIONSHIP(
          RELATION: _TEMP7, RELATIVES: SDAI.SET<eEXTERNAL_IDENTIFICATION_ASSIGNMENT>(
          bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as SDAI.INTEGER?), 
          /*SDAI.SET<eEXTERNAL_IDENTIFICATION_ASSIGNMENT>*/_TEMP9), 
...
private var _acyclic_external_identification_assignment_relationship__cache = SDAI.FunctionResultCache(
