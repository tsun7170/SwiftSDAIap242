/* file: a3ma_get_detected_difference_type.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```express
  ...
  END_FUNCTION; -- a3ma_get_detected_difference_type (line:34260 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
*/
  ...
  public static 
  func A3MA_GET_DETECTED_DIFFERENCE_TYPE( _ EI: (SDAI.LIST<sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT>/*[0:nil]*/ )?  ) 
    ...
    let _TEMP5 /* SDAI.INTEGER? */ = SDAI.SIZEOF( EI )
    ...
    let _TEMP7 /* SDAI.LOGICAL */ = SDAI.aggregate( TYPE_OUT, contains: SDAI.STRING(
...
private let _a3ma_get_detected_difference_type__cache = SDAI.FunctionResultCache(
  label: "A3MA_GET_DETECTED_DIFFERENCE_TYPE",
