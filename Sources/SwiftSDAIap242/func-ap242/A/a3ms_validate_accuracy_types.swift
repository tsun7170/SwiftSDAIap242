/* file: a3ms_validate_accuracy_types.swift 	 generated: Fri Sep 26 17:24:11 2025 */
  ...
  func A3MS_VALIDATE_ACCURACY_TYPES(
    ...
    if SDAI.IS_TRUE( _TEMP5 ) {
      ...
      if SDAI.IS_TRUE( _TEMP17 ) {
        ...
        let _TEMP19 = SDAI.SET<eREPRESENTATION>(SDAI.EMPTY_AGGREGATE)
        RP = _TEMP19
      }
    }
    
    let _TEMP20 = SDAI.SET<eA3M_EQUIVALENCE_ACCURACY_ASSOCIATION>(SDAI.EMPTY_AGGREGATE)
    AEAA = _TEMP20
    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/SDAI.SIZEOF(
      RP)) {
      for I in incrementControl {
