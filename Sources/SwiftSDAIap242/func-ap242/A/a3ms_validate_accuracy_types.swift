/* file: a3ms_validate_accuracy_types.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
*/
  ...
  func A3MS_VALIDATE_ACCURACY_TYPES(
    ...
    if SDAI.IS_TRUE( _TEMP5 ) {
      ...
      if SDAI.IS_TRUE( _TEMP10 ) {
        ...
        if SDAI.IS_TRUE( _TEMP12 ) {
          return _a3ms_validate_accuracy_types__cache.updateCache(params: _params, value: SDAI.LOGICAL(
            SDAI.TRUE))
        }
        else {
          return _a3ms_validate_accuracy_types__cache.updateCache(params: _params, value: SDAI.LOGICAL(
    ...
    if SDAI.IS_TRUE( _TEMP26 ) {
      return _a3ms_validate_accuracy_types__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.TRUE))
    }
    return _a3ms_validate_accuracy_types__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.FALSE))
  }
