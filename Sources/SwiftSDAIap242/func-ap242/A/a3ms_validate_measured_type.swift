/* file: a3ms_validate_measured_type.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_FUNCTION; -- a3ms_validate_measured_type (line:34675 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  ...
  func A3MS_VALIDATE_MEASURED_TYPE(EI: eDATA_EQUIVALENCE_INSPECTION_REPORT? , 
        ...
        for I in incrementControl {
          ...
          if SDAI.IS_TRUE( _TEMP3 ) {
            ...
            if SDAI.IS_TRUE( _TEMP8 ) {
              return _a3ms_validate_measured_type__cache.updateCache(params: _params, value: SDAI.LOGICAL(
                SDAI.FALSE))
            }
          }
        }
    ...
    return _a3ms_validate_measured_type__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.TRUE))
  }
