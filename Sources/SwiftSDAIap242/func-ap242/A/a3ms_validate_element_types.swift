/* file: a3ms_validate_element_types.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_FUNCTION; -- a3ms_validate_element_types (line:34627 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  ...
  func A3MS_VALIDATE_ELEMENT_TYPES(EI: eDATA_EQUIVALENCE_INSPECTION_REPORT? , 
        ...
        for I in incrementControl {
          ...
          if SDAI.IS_TRUE( _TEMP2 ) {
            ...
            if SDAI.IS_TRUE( _TEMP20 ) {
              return _a3ms_validate_element_types__cache.updateCache(params: _params, value: SDAI.LOGICAL(
                SDAI.FALSE))
            }
    ...
    return _a3ms_validate_element_types__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.TRUE))
  }
