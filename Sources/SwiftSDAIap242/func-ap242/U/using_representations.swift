/* file: using_representations.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  func USING_REPRESENTATIONS(_ ITEM: sFOUNDED_ITEM_SELECT? ) 
    ...
    let _TEMP1 = SDAI.SET<eREPRESENTATION>(SDAI.EMPTY_AGGREGATE)
    RESULTS = _TEMP1
    ...
    let _TEMP7 = SDAI.SET<sFOUNDED_ITEM_SELECT>(SDAI.EMPTY_AGGREGATE)
