/* file: using_items.swift 	 generated: Tue Oct 14 17:54:07 2025 */
...
```express
  ...
  END_FUNCTION; -- using_items (line:47239 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  ...
  func USING_ITEMS( 
    ...
    let _TEMP1 /* SDAI.LOGICAL */ = SDAI.aggregate( CHECKED_ITEMS, contains: ITEM )
    if SDAI.IS_TRUE( _TEMP1 ) {
      
      let _TEMP2 /* SDAI.AGGREGATE<runtime> */ = SDAI.SET<sFOUNDED_ITEM_SELECT>(SDAI.EMPTY_AGGREGATE)
      return _using_items__cache.updateCache(params: _params, value: _TEMP2)
    }
    
    let _TEMP3 /* SDAI.SET<sFOUNDED_ITEM_SELECT>? */ = CHECKED_ITEMS + ITEM
    CHECKED_ITEMS = _TEMP3
    
    let _TEMP4 /* SDAI.BAG<SDAI.GENERIC_ENTITY> */ = SDAI.USEDIN(T: ITEM)
    ...
    let _TEMP7 /* SDAI.SET<sFOUNDED_ITEM_SELECT>? */ = RESULT_ITEMS - CHECKED_ITEMS
    NEXT_ITEMS = _TEMP7
    
    let _TEMP8 /* SDAI.INTEGER? */ = SDAI.SIZEOF( NEXT_ITEMS )
    NUMBER_OF_NEXT_ITEMS = _TEMP8
    
    let _TEMP9 /* SDAI.LOGICAL */ = NUMBER_OF_NEXT_ITEMS .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(0))
    ...
    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/
      ...
      for I in incrementControl {
        ...
        let _TEMP10 /* sFOUNDED_ITEM_SELECT? */ = NEXT_ITEMS?[I]
        NEXT_ITEM = _TEMP10
        
        let _TEMP11 /* SDAI.SET<sFOUNDED_ITEM_SELECT>? */ = NEXT_ITEMS - NEXT_ITEM
        let _TEMP12 /* SDAI.SET<sFOUNDED_ITEM_SELECT>? */ = CHECKED_ITEMS + _TEMP11
        NEW_CHECK_ITEMS = _TEMP12
        
        let _TEMP13 /* SDAI.SET<sFOUNDED_ITEM_SELECT>? */ = USING_ITEMS( 
            ITEM: NEXT_ITEM, 
            CHECKED_ITEMS: NEW_CHECK_ITEMS )
        DESCENDANTS = _TEMP13
        
        let _TEMP14 /* SDAI.SET<sFOUNDED_ITEM_SELECT>? */ = RESULT_ITEMS + DESCENDANTS
        RESULT_ITEMS = _TEMP14
        
        let _TEMP15 /* SDAI.SET<sFOUNDED_ITEM_SELECT>? */ = CHECKED_ITEMS + NEXT_ITEM
        let _TEMP16 /* SDAI.SET<sFOUNDED_ITEM_SELECT>? */ = _TEMP15 + DESCENDANTS
