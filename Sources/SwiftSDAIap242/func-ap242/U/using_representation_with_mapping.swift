/* file: using_representation_with_mapping.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  func USING_REPRESENTATION_WITH_MAPPING(
    ...
    //LOCAL
    var RESULTS: SDAI.SET<eREPRESENTATION>?  = SDAI.SET<eREPRESENTATION>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &RESULTS)
    var LOCAL_RESULTS: SDAI.SET<eREPRESENTATION>?  = SDAI.SET<eREPRESENTATION>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &LOCAL_RESULTS)
    var LOCAL_REPRESENTATION_MAP: SDAI.SET<eREPRESENTATION_MAP>?  = SDAI.SET<eREPRESENTATION_MAP>(
                                                                    SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &LOCAL_REPRESENTATION_MAP)
    ...
    if SDAI.IS_TRUE( _TEMP4 ) {
      ...
      let _TEMP5 = SDAI.SET<eREPRESENTATION>(SDAI.EMPTY_AGGREGATE)
