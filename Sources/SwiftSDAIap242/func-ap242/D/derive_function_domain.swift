/* file: derive_function_domain.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  func DERIVE_FUNCTION_DOMAIN(_ FUNC: eMATHS_FUNCTION? ) 
    ...
    var TSPACE: sTUPLE_SPACE?  = sTUPLE_SPACE(/*eLISTED_PRODUCT_SPACE*/MAKE_LISTED_PRODUCT_SPACE(
                                 SDAI.LIST<eMATHS_SPACE>(SDAI.EMPTY_AGGREGATE))); SDAI.TOUCH(var: &TSPACE)
    ...
    if SDAI.IS_TRUE( _TEMP161 ) {
      ...
      let _TEMP162 = SDAI.LIST<eMATHS_SPACE>(SDAI.EMPTY_AGGREGATE)
