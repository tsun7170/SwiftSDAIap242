/* file: default_b_spline_knots.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
*/
  ...
  func DEFAULT_B_SPLINE_KNOTS( 
    ...
    UNIFORM: nKNOT_TYPE? 
   ) -> (SDAI.LIST<tPARAMETER_VALUE>/*[2:(nil as SDAI.INTEGER?)]*/ )? {
    ...
    var KNOTS: (SDAI.LIST<tPARAMETER_VALUE>/*[1:UP_KNOTS]*/ )?  = SDAI.LIST<tPARAMETER_VALUE>(
      bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: UP_KNOTS,  ([ SDAI.AIE(tPARAMETER_VALUE(0), repeat: 
        UP_KNOTS) ] as [SDAI.AggregationInitializerElement<tPARAMETER_VALUE>]) ); SDAI.TOUCH(var: &KNOTS)
