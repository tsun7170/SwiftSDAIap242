/* file: default_tolerance_table_cell_wr3.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_FUNCTION; -- default_tolerance_table_cell_wr3 (line:37347 file:ap242ed2_mim_lf_v1.101.TY.exp)

*/

  public static 
  func DEFAULT_TOLERANCE_TABLE_CELL_WR3(
    ...
    let _TEMP1 = AGG?.QUERY{ I in 
        ...
        let _TEMP4 = _TEMP3 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("significant number of digits"))
    ...
    let _TEMP4 = AGG?.QUERY{ I in 
        ...
        let _TEMP2 = I.GROUP_REF(eREPRESENTATION_ITEM.self)
        let _TEMP3 = _TEMP2?.NAME
        let _TEMP4 = _TEMP3 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("lower limit"))
        let _TEMP5 = _TEMP1 && _TEMP4
        return _TEMP5 }
    ...
    let _TEMP7 = AGG?.QUERY{ I in 
        ...
        let _TEMP2 = I.GROUP_REF(eREPRESENTATION_ITEM.self)
        let _TEMP3 = _TEMP2?.NAME
        let _TEMP4 = _TEMP3 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("upper limit"))
        let _TEMP5 = _TEMP1 && _TEMP4
        return _TEMP5 }
...
private var _default_tolerance_table_cell_wr3__cache = SDAI.FunctionResultCache(
