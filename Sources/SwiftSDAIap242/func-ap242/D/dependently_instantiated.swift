/* file: dependently_instantiated.swift 	 generated: Fri Sep 26 17:24:11 2025 */
  ...
  func DEPENDENTLY_INSTANTIATED<gIGEN: SDAIGenericType, gCGEN: SDAIGenericType>(
    ...
    func IS_REFERENCED_BY_OUTER_WORLD(
      ...
      if SDAI.IS_TRUE( _TEMP6 ) {
        ...
        let _TEMP7 = DEAD_ENDS + SDAI.GENERIC(SUBJECT)
        DEAD_ENDS = _TEMP7
        return SDAI.BOOLEAN(SDAI.FALSE)
      }
      ...
      if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/
        ...
        for J in incrementControl {
          ...
          if SDAI.IS_TRUE( _TEMP14 ) {
            ...
            let _TEMP16 = _TEMP15 + SDAI.GENERIC(SUBJECT)
            let _TEMP17 = _TEMP16 + SDAI.GENERIC(CHILD)
            SUCCEEDEDS = _TEMP17
            return SDAI.BOOLEAN(SDAI.TRUE)
          }
          
          let _TEMP18 = IN_CHAIN + SDAI.GENERIC(SUBJECT)
      ...
      let _TEMP20 = DEAD_ENDS + SDAI.GENERIC(SUBJECT)
      DEAD_ENDS = _TEMP20
      return SDAI.BOOLEAN(SDAI.FALSE)
