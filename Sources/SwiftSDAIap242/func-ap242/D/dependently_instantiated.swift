/* file: dependently_instantiated.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```express
  ...
  FUNCTION dependently_instantiated(
    ...
    END_FUNCTION; -- is_referenced_by_outer_world (line:37974 file:ap242ed2_mim_lf_v1.101_TY.exp)
  ...
  END_FUNCTION; -- dependently_instantiated (line:37960 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
*/
  ...
  public static 
  func DEPENDENTLY_INSTANTIATED<gIGEN: SDAI.GenericType, gCGEN: SDAI.GenericType>( 
    SET_OF_INPUT_INSTANCES: SDAI.SET<gIGEN>? , 
    SET_OF_INPUT_TYPES: SDAI.SET<SDAI.STRING>? , 
    ...
    func IS_REFERENCED_BY_OUTER_WORLD( 
      ...
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.aggregate( SUCCEEDEDS, contains: SUBJECT )
      if SDAI.IS_TRUE( _TEMP1 ) {
        return SDAI.BOOLEAN(SDAI.TRUE)
      }
      
      let _TEMP2 /* SDAI.LOGICAL */ = SDAI.aggregate( DEAD_ENDS, contains: SUBJECT )
      if SDAI.IS_TRUE( _TEMP2 ) {
        return SDAI.BOOLEAN(SDAI.FALSE)
      }
      
      let _TEMP3 /* SDAI.BAG<SDAI.GENERIC_ENTITY> */ = SDAI.USEDIN(T: SUBJECT)
      let _TEMP4 /* SDAI.SET<gINTYPE>? */ = BAG_TO_SET( _TEMP3 )
      SET_OF_REFERRING_INSTANCES = SDAI.SET<gCGEN>(generic: /*SDAI.SET<gINTYPE>*/_TEMP4)
      
      let _TEMP5 /* SDAI.BOOLEAN */ = SDAI.EXISTS( SET_OF_REFERRING_INSTANCES )
      let _TEMP6 /* SDAI.LOGICAL */ =  !_TEMP5
      if SDAI.IS_TRUE( _TEMP6 ) {
        
        let _TEMP7 /* SDAI.SET<gCGEN>? */ = DEAD_ENDS + SDAI.GENERIC(SUBJECT)
        DEAD_ENDS = _TEMP7
        return SDAI.BOOLEAN(SDAI.FALSE)
      }
      
      let _TEMP8 /* SDAI.SET<gCGEN>? */ = DEAD_ENDS + IN_CHAIN
      let _TEMP9 /* SDAI.SET<gCGEN>? */ = SET_OF_REFERRING_INSTANCES - _TEMP8
      SET_OF_REFERRING_INSTANCES = _TEMP9
      
      let _TEMP10 /* SDAI.INTEGER? */ = SDAI.SIZEOF( SET_OF_REFERRING_INSTANCES )
      ...
      if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/
        ...
        for J in incrementControl {
          ...
          let _TEMP11 /* gCGEN? */ = SET_OF_REFERRING_INSTANCES?[J]
          CHILD = _TEMP11
          
          let _TEMP12 /* SDAI.SET<SDAI.STRING> */ = SDAI.TYPEOF( CHILD )
          SET_OF_TYPES = _TEMP12
          
          let _TEMP13 /* SDAI.LOGICAL */ = SET_OF_TYPES <= SET_OF_INPUT_TYPES
          let _TEMP14 /* SDAI.LOGICAL */ =  !_TEMP13
          if SDAI.IS_TRUE( _TEMP14 ) {
            
            let _TEMP15 /* SDAI.SET<gCGEN>? */ = SUCCEEDEDS + IN_CHAIN
            let _TEMP16 /* SDAI.SET<gCGEN>? */ = _TEMP15 + SDAI.GENERIC(SUBJECT)
            let _TEMP17 /* SDAI.SET<gCGEN>? */ = _TEMP16 + SDAI.GENERIC(CHILD)
            SUCCEEDEDS = _TEMP17
            return SDAI.BOOLEAN(SDAI.TRUE)
          }
          
          let _TEMP18 /* SDAI.LIST<gCGEN>? */ = IN_CHAIN + SDAI.GENERIC(SUBJECT)
          let _TEMP19 /* SDAI.BOOLEAN? */ = IS_REFERENCED_BY_OUTER_WORLD( 
              SUBJECT: CHILD, 
              IN_CHAIN: _TEMP18 )
      ...
      let _TEMP20 /* SDAI.SET<gCGEN>? */ = DEAD_ENDS + SDAI.GENERIC(SUBJECT)
      DEAD_ENDS = _TEMP20
      return SDAI.BOOLEAN(SDAI.FALSE)
    } //END FUNCTION IS_REFERENCED_BY_OUTER_WORLD

    //LOCAL
    var SUCCEEDEDS: SDAI.SET<gCGEN>?  = SDAI.SET<gCGEN>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &SUCCEEDEDS)
    var DEAD_ENDS: SDAI.SET<gCGEN>?  = SDAI.SET<gCGEN>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &DEAD_ENDS)
    ...
    let _TEMP1 /* SDAI.BOOLEAN */ = SDAI.EXISTS( SET_OF_INPUT_INSTANCES )
    ...
    let _TEMP3 /* SDAI.INTEGER? */ = SDAI.SIZEOF( SET_OF_INPUT_INSTANCES )
    NUMBER_OF_INPUT_INSTANCES = _TEMP3
    
    let _TEMP4 /* SDAI.SET<SDAI.STRING>? */ = SET_OF_INPUT_TYPES + SDAI.FORCE_OPTIONAL(SDAI.STRING("GENERIC"))
    SET_OF_INPUT_TYPES = _TEMP4
    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/
      NUMBER_OF_INPUT_INSTANCES) {
      for I in incrementControl {
        
        let _TEMP5 /* gIGEN? */ = SET_OF_INPUT_INSTANCES?[I]
        INPUT_INSTANCE_CGEN = gCGEN(fromGeneric: /*gIGEN*/_TEMP5)
        
        let _TEMP6 /* SDAI.BOOLEAN? */ = IS_REFERENCED_BY_OUTER_WORLD( 
...
private let _dependently_instantiated__cache = SDAI.FunctionResultCache(
  label: "DEPENDENTLY_INSTANTIATED",
