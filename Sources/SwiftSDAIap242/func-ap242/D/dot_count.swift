/* file: dot_count.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
```express
  ...
  END_FUNCTION; -- dot_count (line:39039 file:ap242ed2_mim_lf_v1.101_TY.exp)
  ...
  func DOT_COUNT( _ STR: SDAI.STRING?  ) 
    ...
    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/SDAI.LENGTH( 
      ...
      for I in incrementControl {
        ...
        let _TEMP1 /* SDAI.STRING? */ = STR?[I]
        let _TEMP2 /* SDAI.LOGICAL */ = _TEMP1 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("."))
        if SDAI.IS_TRUE( _TEMP2 ) {
          
          let _TEMP3 /* SDAI.INTEGER? */ = N + SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
          N = _TEMP3
        }
      }
    }
...
private let _dot_count__cache = SDAI.FunctionResultCache(
  label: "DOT_COUNT",
