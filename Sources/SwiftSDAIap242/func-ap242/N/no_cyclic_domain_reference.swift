/* file: no_cyclic_domain_reference.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  func NO_CYCLIC_DOMAIN_REFERENCE(REF: sMATHS_SPACE_OR_FUNCTION? , USED: SDAI.SET<eMATHS_FUNCTION>? ) 
    ...
    let _TEMP7 = SDAI.aggregate(TYPENAMES, contains: _TEMP6)
    ...
    let _TEMP10 = SDAI.aggregate(TYPENAMES, contains: _TEMP9)
    ...
    let _TEMP17 = SDAI.aggregate(TYPENAMES, contains: _TEMP16)
