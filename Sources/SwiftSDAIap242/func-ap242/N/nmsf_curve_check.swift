/* file: nmsf_curve_check.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_FUNCTION; -- nmsf_curve_check (line:43480 file:ap242ed2_mim_lf_v1.101.TY.exp)

*/

  public static 
  func NMSF_CURVE_CHECK(_ CV: eREPRESENTATION_ITEM? ) 
    -> SDAI.BOOLEAN? {
    ...
    if SDAI.IS_TRUE( _TEMP5 ) {
      ...
      if SDAI.IS_TRUE( _TEMP14 ) {
        ...
        let _TEMP17 = SDAI.FORCE_OPTIONAL(_TEMP15) * _TEMP16
        ...
        if SDAI.IS_TRUE( _TEMP19 ) {
          ...
          if SDAI.IS_TRUE( _TEMP20 ) {
            ...
            let _TEMP23 = NMSF_CURVE_CHECK(eREPRESENTATION_ITEM(/*eCURVE*/_TEMP22))
            ...
            if SDAI.IS_TRUE( _TEMP35 ) {
              ...
              let _TEMP38 = NMSF_CURVE_CHECK(eREPRESENTATION_ITEM(/*eCURVE*/_TEMP37))
              ...
              if SDAI.IS_TRUE( _TEMP39 ) {
                ...
                let _TEMP45 = NMSF_CURVE_CHECK(_TEMP44)
                let _TEMP46 = CV?.GROUP_REF(ePCURVE.self)
                let _TEMP47 = _TEMP46?.BASIS_SURFACE
                let _TEMP48 = NMSF_SURFACE_CHECK(_TEMP47)
                ...
                if SDAI.IS_TRUE( _TEMP50 ) {
                  ...
                  let _TEMP53 = NMSF_CURVE_CHECK(eREPRESENTATION_ITEM(/*eCURVE*/_TEMP52))
                    ...
                    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/
                      ...
                      for I in incrementControl {
                        ...
                        if SDAI.IS_TRUE( _TEMP54 ) {
                          ...
                          let _TEMP58 = NMSF_SURFACE_CHECK(eSURFACE(/*sPCURVE_OR_SURFACE*/_TEMP57))
                          let _TEMP59 =  !_TEMP58
                          ...
                          if SDAI.IS_TRUE( _TEMP60 ) {
                            ...
                            let _TEMP64 = NMSF_CURVE_CHECK(eREPRESENTATION_ITEM(/*sPCURVE_OR_SURFACE*/_TEMP63))
                            let _TEMP65 =  !_TEMP64
...
private var _nmsf_curve_check__cache = SDAI.FunctionResultCache(
