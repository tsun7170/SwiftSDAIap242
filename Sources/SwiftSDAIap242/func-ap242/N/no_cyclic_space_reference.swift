/* file: no_cyclic_space_reference.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  func NO_CYCLIC_SPACE_REFERENCE(SPC: eMATHS_SPACE? , REFS: SDAI.SET<eMATHS_SPACE>? ) 
    ...
    let _TEMP5 = SDAI.aggregate(TYPES, contains: _TEMP4)
    ...
    let _TEMP14 = SDAI.aggregate(TYPES, contains: _TEMP13)
    ...
    let _TEMP19 = SDAI.aggregate(TYPES, contains: _TEMP18)
    ...
    let _TEMP27 = SDAI.aggregate(TYPES, contains: _TEMP26)
