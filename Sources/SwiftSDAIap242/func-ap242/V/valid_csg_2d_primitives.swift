/* file: valid_csg_2d_primitives.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
  ...
  func VALID_CSG_2D_PRIMITIVES( _ INPUT: eCSG_SOLID_2D.PRef?  ) 
    ...
    switch SDAI.FORCE_OPTIONAL(SDAI.TRUE) {
      case .some(SDAI.TYPEOF( (INPUT?.GROUP_REF(eCSG_SOLID_2D.self))?.TREE_ROOT_EXPRESSION, 
        IS: ePRIMITIVE_2D.self )):
        //BEGIN
        //
