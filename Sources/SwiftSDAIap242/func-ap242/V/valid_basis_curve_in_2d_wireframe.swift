/* file: valid_basis_curve_in_2d_wireframe.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```express
  ...
  END_FUNCTION; -- valid_basis_curve_in_2d_wireframe (line:47996 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
*/
  ...
  public static 
  func VALID_BASIS_CURVE_IN_2D_WIREFRAME( _ CRV: eCURVE.PRef?  ) 
    -> SDAI.BOOLEAN? {
    ...
    if SDAI.IS_TRUE( _TEMP5 ) {
      ...
      if SDAI.IS_TRUE( _TEMP6 ) {
        ...
        if SDAI.IS_TRUE( _TEMP13 ) {
          ...
          let _TEMP16 /* SDAI.BOOLEAN? */ = VALID_BASIS_CURVE_IN_2D_WIREFRAME( 
              _TEMP15 )
        ...
        let _TEMP17 /* SDAI.LOGICAL */ = SDAI.TYPEOF( CRV, IS: eOFFSET_CURVE_2D.self )
        if SDAI.IS_TRUE( _TEMP17 ) {
          
          let _TEMP18 /* eOFFSET_CURVE_2D.PRef? */ = CRV?.GROUP_REF(eOFFSET_CURVE_2D.self)
          let _TEMP19 /* eCURVE.PRef? */ = _TEMP18?.BASIS_CURVE
          let _TEMP20 /* SDAI.BOOLEAN? */ = VALID_BASIS_CURVE_IN_2D_WIREFRAME( 
              _TEMP19 )
          ...
          if SDAI.IS_TRUE( _TEMP21 ) {
            ...
            let _TEMP24 /* SDAI.BOOLEAN? */ = VALID_BASIS_CURVE_IN_2D_WIREFRAME( 
                _TEMP23 )
            ...
            if SDAI.IS_TRUE( _TEMP25 ) {
              ...
              let _TEMP28 /* SDAI.LIST<eCOMPOSITE_CURVE_SEGMENT.PRef>[1:(nil as SDAI.INTEGER?)] ? */ = 
                ...
                .QUERY{ CCS in 
                  ...
                  let _TEMP2 /* SDAI.BOOLEAN? */ = VALID_BASIS_CURVE_IN_2D_WIREFRAME( 
                      _TEMP1 )
...
private let _valid_basis_curve_in_2d_wireframe__cache = SDAI.FunctionResultCache(
  label: "VALID_BASIS_CURVE_IN_2D_WIREFRAME",
