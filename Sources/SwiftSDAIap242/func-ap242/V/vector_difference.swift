/* file: vector_difference.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_FUNCTION; -- vector_difference (line:48724 file:ap242ed2_mim_lf_v1.101.TY.exp)

*/

  public static 
  func VECTOR_DIFFERENCE(ARG1: sVECTOR_OR_DIRECTION? , ARG2: sVECTOR_OR_DIRECTION? ) 
    -> eVECTOR? {
    ...
    if SDAI.IS_TRUE( _TEMP9 ) {
      return _vector_difference__cache.updateCache(params: _params, value: (nil as eVECTOR?))
    }
    else {
      //BEGIN
...
private var _vector_difference__cache = SDAI.FunctionResultCache(
