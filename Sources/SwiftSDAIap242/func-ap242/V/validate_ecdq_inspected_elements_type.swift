/* file: validate_ecdq_inspected_elements_type.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_FUNCTION; -- validate_ecdq_inspected_elements_type (line:48253 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  ...
  func VALIDATE_ECDQ_INSPECTED_ELEMENTS_TYPE(
    ...
    var SDQIR: SDAI.SET<eEXTERNALLY_CONDITIONED_DATA_QUALITY_INSPECTION_RESULT>?  = 
      SDAI.SET<eEXTERNALLY_CONDITIONED_DATA_QUALITY_INSPECTION_RESULT>(SDAI.EMPLY_AGGREGATE); SDAI.TOUCH(var: &SDQIR)
    var DIR: SDAI.SET<eDATA_QUALITY_INSPECTION_INSTANCE_REPORT>?  = SDAI.SET<
                                                                    eDATA_QUALITY_INSPECTION_INSTANCE_REPORT>(
                                                                    SDAI.EMPLY_AGGREGATE); SDAI.TOUCH(var: &DIR)
    var SDIRI: SDAI.SET<eEXTERNALLY_CONDITIONED_DATA_QUALITY_INSPECTION_INSTANCE_REPORT_ITEM>?  = 
      SDAI.SET<eEXTERNALLY_CONDITIONED_DATA_QUALITY_INSPECTION_INSTANCE_REPORT_ITEM>(SDAI.EMPLY_AGGREGATE); SDAI.TOUCH(var: &SDIRI)
    ...
    if SDAI.IS_TRUE( _TEMP5 ) {
      return _validate_ecdq_inspected_elements_type__cache.updateCache(params: _params, value: SDAI.LOGICAL(
        SDAI.TRUE))
    }
...
private var _validate_ecdq_inspected_elements_type__cache = SDAI.FunctionResultCache(
