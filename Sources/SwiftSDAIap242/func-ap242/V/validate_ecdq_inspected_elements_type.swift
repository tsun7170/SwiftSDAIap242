/* file: validate_ecdq_inspected_elements_type.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  func VALIDATE_ECDQ_INSPECTED_ELEMENTS_TYPE(
    EI: eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERION? , TYPE_LIST: SDAI.BAG<SDAI.STRING>? ) 
    -> SDAI.LOGICAL {
    ...
    //LOCAL
    var SDQIR: SDAI.SET<eEXTERNALLY_CONDITIONED_DATA_QUALITY_INSPECTION_RESULT>?  = 
      SDAI.SET<eEXTERNALLY_CONDITIONED_DATA_QUALITY_INSPECTION_RESULT>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &SDQIR)
    var DIR: SDAI.SET<eDATA_QUALITY_INSPECTION_INSTANCE_REPORT>?  = SDAI.SET<
                                                                    eDATA_QUALITY_INSPECTION_INSTANCE_REPORT>(
                                                                    SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &DIR)
    var SDIRI: SDAI.SET<eEXTERNALLY_CONDITIONED_DATA_QUALITY_INSPECTION_INSTANCE_REPORT_ITEM>?  = 
      SDAI.SET<eEXTERNALLY_CONDITIONED_DATA_QUALITY_INSPECTION_INSTANCE_REPORT_ITEM>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &SDIRI)
    ...
    let _TEMP3 = _TEMP2?.QUERY{ Q in 
        ...
        return _TEMP1 }
    SDQIR = SDAI.SET<eEXTERNALLY_CONDITIONED_DATA_QUALITY_INSPECTION_RESULT>(generic: /*SDAI.SET<gINTYPE>*/
      _TEMP3)
    ...
    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/SDAI.SIZEOF(
      ...
      for I in incrementControl {
        ...
        let _TEMP9 = _TEMP8?.QUERY{ Q in 
            ...
            let _TEMP1 = SDAI.TYPEOF(Q, IS: eDATA_QUALITY_INSPECTION_INSTANCE_REPORT.self)
            return _TEMP1 }
        let _TEMP10 = DIR + _TEMP9
        DIR = SDAI.SET<eDATA_QUALITY_INSPECTION_INSTANCE_REPORT>(generic: /*SDAI.SET<runtime>*/_TEMP10)
      }
    }
    ...
    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/SDAI.SIZEOF(
      ...
      for I in incrementControl {
        ...
        let _TEMP15 = _TEMP14?.QUERY{ Q in 
            ...
            return _TEMP1 }
        let _TEMP16 = SDAI.SET<SDAI.GENERIC_ENTITY>(/*SDAI.SET<
          eEXTERNALLY_CONDITIONED_DATA_QUALITY_INSPECTION_INSTANCE_REPORT_ITEM>*/SDIRI) + SDAI.LIST<
          SDAI.GENERIC_ENTITY>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as SDAI.INTEGER?), 
          /*SDAI.LIST<eDATA_QUALITY_INSPECTION_INSTANCE_REPORT_ITEM>[1:nil] */_TEMP15)
        SDIRI = SDAI.SET<eEXTERNALLY_CONDITIONED_DATA_QUALITY_INSPECTION_INSTANCE_REPORT_ITEM>(/*SDAI.SET<
