/* file: valid_geometrically_bounded_wf_curve.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_FUNCTION; -- valid_geometrically_bounded_wf_curve (line:47607 file:ap242ed2_mim_lf_v1.101.TY.exp)

*/

  public static 
  func VALID_GEOMETRICALLY_BOUNDED_WF_CURVE(
    ...
    if SDAI.IS_TRUE( _TEMP5 ) {
      ...
      if SDAI.IS_TRUE( _TEMP6 ) {
        ...
        let _TEMP11 = SDAI.FORCE_OPTIONAL(_TEMP7) * _TEMP10
        ...
        if SDAI.IS_TRUE( _TEMP13 ) {
          ...
          let _TEMP16 = VALID_GEOMETRICALLY_BOUNDED_WF_CURVE(_TEMP15)
          return _valid_geometrically_bounded_wf_curve__cache.updateCache(params: _params, value: _TEMP16)
        }
      }
      else {
        
        let _TEMP17 = SDAI.TYPEOF(CRV, IS: eOFFSET_CURVE_3D.self)
        if SDAI.IS_TRUE( _TEMP17 ) {
          
          let _TEMP18 = CRV?.GROUP_REF(eOFFSET_CURVE_3D.self)
          let _TEMP19 = _TEMP18?.BASIS_CURVE
          let _TEMP20 = VALID_GEOMETRICALLY_BOUNDED_WF_CURVE(_TEMP19)
          ...
          if SDAI.IS_TRUE( _TEMP21 ) {
            ...
            let _TEMP24 = VALID_GEOMETRICALLY_BOUNDED_WF_CURVE(_TEMP23)
            ...
            if SDAI.IS_TRUE( _TEMP25 ) {
              ...
              let _TEMP28 = _TEMP27?
                .QUERY{ CCS in 
                  ...
                  let _TEMP2 = VALID_GEOMETRICALLY_BOUNDED_WF_CURVE(_TEMP1)
                  let _TEMP3 =  !_TEMP2
                  return _TEMP3 }
...
private var _valid_geometrically_bounded_wf_curve__cache = SDAI.FunctionResultCache(
