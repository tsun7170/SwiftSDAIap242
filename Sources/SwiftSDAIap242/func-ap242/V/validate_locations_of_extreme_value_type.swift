/* file: validate_locations_of_extreme_value_type.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_FUNCTION; -- validate_locations_of_extreme_value_type (line:48378 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  ...
  func VALIDATE_LOCATIONS_OF_EXTREME_VALUE_TYPE(
    ...
    var SDEI: SDAI.SET<eINSTANCE_REPORT_ITEM_WITH_EXTREME_INSTANCES>?  = 
      SDAI.SET<eINSTANCE_REPORT_ITEM_WITH_EXTREME_INSTANCES>(SDAI.EMPLY_AGGREGATE); SDAI.TOUCH(var: &SDEI)
    ...
    if SDAI.IS_TRUE( _TEMP5 ) {
      return _validate_locations_of_extreme_value_type__cache.updateCache(params: _params, value: SDAI.LOGICAL(
        SDAI.TRUE))
    }
        ...
        if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/
          ...
          for J in incrementControl {
            ...
            if SDAI.IS_TRUE( _TEMP28 ) {
              return _validate_locations_of_extreme_value_type__cache.updateCache(params: _params, value: 
...
private var _validate_locations_of_extreme_value_type__cache = SDAI.FunctionResultCache(
