/* file: validate_locations_of_extreme_value_type.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  func VALIDATE_LOCATIONS_OF_EXTREME_VALUE_TYPE(
    ...
    var SDIR: SDAI.SET<eSHAPE_DATA_QUALITY_INSPECTION_INSTANCE_REPORT>?  = 
      SDAI.SET<eSHAPE_DATA_QUALITY_INSPECTION_INSTANCE_REPORT>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &SDIR)
    var SDEI: SDAI.SET<eINSTANCE_REPORT_ITEM_WITH_EXTREME_INSTANCES>?  = 
      SDAI.SET<eINSTANCE_REPORT_ITEM_WITH_EXTREME_INSTANCES>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &SDEI)
    ...
    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/SDAI.SIZEOF(
      ...
      for I in incrementControl {
        ...
        let _TEMP11 = SDIR?[I]
        let _TEMP12 = _TEMP11?.INSPECTED_INSTANCES
        let _TEMP13 = _TEMP12?.QUERY{ Q in 

            let _TEMP1 = SDAI.TYPEOF(Q, IS: eINSTANCE_REPORT_ITEM_WITH_EXTREME_INSTANCES.self)
            return _TEMP1 }
        let _TEMP14 = SDAI.SET<SDAI.GENERIC_ENTITY>(/*SDAI.SET<eINSTANCE_REPORT_ITEM_WITH_EXTREME_INSTANCES>*/
          SDEI) + SDAI.LIST<SDAI.GENERIC_ENTITY>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as SDAI.INTEGER?), 
          /*SDAI.LIST<eSHAPE_DATA_QUALITY_INSPECTION_INSTANCE_REPORT_ITEM>[1:nil] */_TEMP13)
        SDEI = SDAI.SET<eINSTANCE_REPORT_ITEM_WITH_EXTREME_INSTANCES>(/*SDAI.SET<SDAI.GENERIC_ENTITY>*/
          _TEMP14)
      }
    }
    
    let _TEMP15 = SDAI.SIZEOF(SDEI)
    ...
    let _TEMP17 = SDAI.SIZEOF(TYPE_LIST)
    let _TEMP18 = _TEMP17 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(0))
    let _TEMP19 = SDAI.SIZEOF(SDEI)
      ...
      for I in incrementControl {
        if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/
          ...
          for J in incrementControl {
            ...
            let _TEMP22 = SDEI?[I]
            let _TEMP23 = _TEMP22?.EXTREME_INSTANCES
            let _TEMP24 = _TEMP23?[J]
            let _TEMP25 = _TEMP24?.LOCATIONS_OF_EXTREME_VALUE
            let _TEMP26 = SDAI.SIZEOF(_TEMP25)
            let _TEMP27 = SDAI.SIZEOF(TYPE_LIST)
              ...
              for K in incrementControl {
                if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/
                  ...
                  for L in incrementControl {
                    ...
                    let _TEMP29 = T_TYPE_LIST?[L]
                    let _TEMP30 = SDEI?[I]
                    let _TEMP31 = _TEMP30?.EXTREME_INSTANCES
                    let _TEMP32 = _TEMP31?[J]
                    let _TEMP33 = _TEMP32?.LOCATIONS_OF_EXTREME_VALUE
                    let _TEMP34 = _TEMP33?[K]
                    let _TEMP35 = SDAI.TYPEOF(_TEMP34)
                    let _TEMP36 = SDAI.aggregate(_TEMP35, contains: _TEMP29)
                    if SDAI.IS_TRUE( _TEMP36 ) {
                      
                      let _TEMP37 = T_TYPE_LIST?[L]
                      let _TEMP38 = T_TYPE_LIST - _TEMP37
                      T_TYPE_LIST = 
                        _TEMP38
                      break
                    }
            ...
            let _TEMP39 = SDAI.SIZEOF(T_TYPE_LIST)
            let _TEMP40 = _TEMP39 > SDAI.FORCE_OPTIONAL(SDAI.INTEGER(0))
