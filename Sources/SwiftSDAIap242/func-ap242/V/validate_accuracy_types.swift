/* file: validate_accuracy_types.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  func VALIDATE_ACCURACY_TYPES(EI: eSHAPE_DATA_QUALITY_CRITERION? , TYPE_LIST: SDAI.BAG<SDAI.STRING>? ) 
    ...
    var SDQCA: SDAI.BAG<eSHAPE_DATA_QUALITY_CRITERION_AND_ACCURACY_ASSOCIATION>?  = 
      SDAI.BAG<eSHAPE_DATA_QUALITY_CRITERION_AND_ACCURACY_ASSOCIATION>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &SDQCA)
    ...
    var SCRAA: SDAI.BAG<eSHAPE_INSPECTION_RESULT_ACCURACY_ASSOCIATION>?  = 
      SDAI.BAG<eSHAPE_INSPECTION_RESULT_ACCURACY_ASSOCIATION>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &SCRAA)
    ...
    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/SDAI.SIZEOF(
      ...
      for I in incrementControl {
        ...
        if SDAI.IS_TRUE( _TEMP23 ) {
          ...
          let _TEMP24 = SDAI.BAG<eSHAPE_MEASUREMENT_ACCURACY>(SDAI.EMPTY_AGGREGATE)
          SMA = _TEMP24
          if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/
            SDAI.SIZEOF(SCRAA)) {
            for J in incrementControl {
