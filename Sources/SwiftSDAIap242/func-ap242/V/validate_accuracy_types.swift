/* file: validate_accuracy_types.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_FUNCTION; -- validate_accuracy_types (line:48046 file:ap242ed2_mim_lf_v1.101.TY.exp)
  ...
  func VALIDATE_ACCURACY_TYPES(EI: eSHAPE_DATA_QUALITY_CRITERION? , TYPE_LIST: SDAI.BAG<SDAI.STRING>? ) 
    ...
    if SDAI.IS_TRUE( _TEMP3 ) {
      ...
      if SDAI.IS_TRUE( _TEMP9 ) {
        return _validate_accuracy_types__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.FALSE))
      }
      if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/SDAI.SIZEOF(
        SMA)) {
        for I in incrementControl {
          ...
          if SDAI.IS_TRUE( (  !T_LOGIC ) ) {
            return _validate_accuracy_types__cache.updateCache(params: _params, value: SDAI.LOGICAL(
              SDAI.FALSE))
          }
        }
      }
    ...
    if SDAI.IS_TRUE( _TEMP19 ) {
      return _validate_accuracy_types__cache.updateCache(params: _params, value: SDAI.LOGICAL(SDAI.TRUE))
    }
    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/SDAI.SIZEOF(
      SDQIR)) {
      for I in incrementControl {
