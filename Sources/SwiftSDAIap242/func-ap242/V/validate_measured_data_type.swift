/* file: validate_measured_data_type.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  func VALIDATE_MEASURED_DATA_TYPE(EI: eSHAPE_DATA_QUALITY_CRITERION? , TYPE_STRING: SDAI.STRING? ) 
    ...
    var SDCR: SDAI.SET<eSHAPE_DATA_QUALITY_INSPECTION_CRITERION_REPORT>?  = 
      SDAI.SET<eSHAPE_DATA_QUALITY_INSPECTION_CRITERION_REPORT>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &SDCR)
    ...
    var SDII: SDAI.SET<eSHAPE_DATA_QUALITY_INSPECTION_INSTANCE_REPORT_ITEM>?  = 
      SDAI.SET<eSHAPE_DATA_QUALITY_INSPECTION_INSTANCE_REPORT_ITEM>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &SDII)
    var SDEI: SDAI.BAG<eINSTANCE_REPORT_ITEM_WITH_EXTREME_INSTANCES>?  = 
      SDAI.BAG<eINSTANCE_REPORT_ITEM_WITH_EXTREME_INSTANCES>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &SDEI)
    //END_LOCAL
