/* file: tolerance_zone_form_name_constraint.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
```express
  ...
  END_RULE; -- tolerance_zone_form_name_constraint (line:50441 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
*/
  ...
  func TOLERANCE_ZONE_FORM_NAME_CONSTRAINT( 
    ...
    var NAMES: SDAI.SET<SDAI.STRING>?  = SDAI.SET<SDAI.STRING>( ([ 
        ...
        SDAI.AIE(SDAI.STRING("between two equidistant complex lines or two parallel straight lines")), 
        ...
        SDAI.AIE(SDAI.STRING("between two parallel circles on a conical surface")), 
        SDAI.AIE(SDAI.STRING("between two parallel circles of the same diameter")), 
        SDAI.AIE(SDAI.STRING("non uniform")), 
        SDAI.AIE(SDAI.STRING("cylindrical or circular")), 
        SDAI.AIE(SDAI.STRING("spherical")), 
        SDAI.AIE(SDAI.STRING("unknown")) ] as [SDAI.AggregationInitializerElement<SDAI.STRING>]) ); SDAI.TOUCH(var: &NAMES)
    ...
    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/1, TO:/*SDAI.INTEGER*/SDAI.SIZEOF( 
      ...
      for I in incrementControl {
        ...
        //
        let _TEMP1 /* eTOLERANCE_ZONE_FORM.PRef? */ = TOLERANCE_ZONE_FORM[I]
        let _TEMP2 /* tLABEL? */ = _TEMP1?.NAME
        let _TEMP3 /* SDAI.LOGICAL */ = SDAI.aggregate( NAMES, contains: SDAI.STRING(/*tLABEL*/_TEMP2) )
