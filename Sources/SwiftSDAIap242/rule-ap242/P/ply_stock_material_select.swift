/* file: ply_stock_material_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
              ...
              if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/SDAI.LOINDEX( 
                ...
                for J in incrementControl {
                  ...
                  let _TEMP8 /* ePRODUCT_RELATED_PRODUCT_CATEGORY.PRef? */ = PRODUCT_RELATED_PRODUCT_CATEGORY[
                    KP]
                  let _TEMP9 /* SDAI.SET<ePRODUCT.PRef>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP8?.PRODUCTS
                  ...
                  if SDAI.IS_TRUE( _TEMP11 ) {
                    if let incrementControl/*SDAI.INTEGER*/ = SDAI.FROM(/*SDAI.INTEGER*/SDAI.LOINDEX( 
                      ...
                      for K in incrementControl {
                        ...
                        let _TEMP13 /* SDAI.SET<ePRODUCT.PRef>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP12?.PRODUCTS
