/* file: dimensioning_data_requires_document.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  ...
  func DIMENSIONING_DATA_REQUIRES_DOCUMENT( 
    ...
    var RA1: SDAI.SET<eROLE_ASSOCIATION>?  = SDAI.SET<eROLE_ASSOCIATION>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &RA1)
    var PDPDCA: SDAI.SET<ePRODUCT_DEFINITION>?  = SDAI.SET<ePRODUCT_DEFINITION>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &PDPDCA)
    var PDADR: SDAI.SET<ePRODUCT_DEFINITION>?  = SDAI.SET<ePRODUCT_DEFINITION>(SDAI.EMPTY_AGGREGATE); SDAI.TOUCH(var: &PDADR)
