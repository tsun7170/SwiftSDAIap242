...
*/
  ...
  func VALID_PRODUCT_AND_MANUFACTURING_INFORMATION_VIEW_CONTEXTS( 
    ...
    var ADDITIONAL_VIEW_CONTEXTS: SDAI.SET<ePRODUCT_DEFINITION_CONTEXT>?  = GDT_REPRESENTATION_VIEW_CONTEXTS
			ADDITIONAL_VIEW_CONTEXTS = ADDITIONAL_VIEW_CONTEXTS + MACHINING_FEATURE_VIEW_CONTEXTS
			ADDITIONAL_VIEW_CONTEXTS = ADDITIONAL_VIEW_CONTEXTS + MATERIAL_SPECIFICATION_VIEW_CONTEXTS
			ADDITIONAL_VIEW_CONTEXTS = ADDITIONAL_VIEW_CONTEXTS + MODEL_BASED_3D_ANNOTATION_PRESENTATION_VIEW_CONTEXTS
			ADDITIONAL_VIEW_CONTEXTS = ADDITIONAL_VIEW_CONTEXTS + PROCESS_STATE_VIEW_CONTEXTS
			ADDITIONAL_VIEW_CONTEXTS = ADDITIONAL_VIEW_CONTEXTS + SURFACE_FINISH_VIEW_CONTEXTS//; SDAI.TOUCH(var: &ADDITIONAL_VIEW_CONTEXTS)
