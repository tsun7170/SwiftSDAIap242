/* file: restrict_configuration_design_for_design_constraint.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_RULE; -- restrict_configuration_design_for_design_constraint (line:49494 file:ap242ed2_mim_lf_v1.101.TY.exp)
  ...
  func RESTRICT_CONFIGURATION_DESIGN_FOR_DESIGN_CONSTRAINT( 
    ...
    let _TEMP1 = CONFIGURATION_DESIGN
      .QUERY{ CD in 
        ...
        let _TEMP1 = CD.NAME
        let _TEMP2 = _TEMP1 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("design constraint usage"))
        ...
        let _TEMP9 = _TEMP8 .!=. SDAI.FORCE_OPTIONAL(SDAI.STRING("design constraint definition"))
