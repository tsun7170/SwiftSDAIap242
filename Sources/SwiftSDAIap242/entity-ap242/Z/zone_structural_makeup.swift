/* file: zone_structural_makeup.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- zone_structural_makeup (line:33929 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _zone_structural_makeup : SDAI.PartialEntity {
...
```
*/
  public final class eZONE_STRUCTURAL_MAKEUP : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "ZONE_STRUCTURAL_MAKEUP", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eZONE_STRUCTURAL_MAKEUP.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ID", keyPath: \eZONE_STRUCTURAL_MAKEUP.ID, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "FRAME_OF_REFERENCE", keyPath: \eZONE_STRUCTURAL_MAKEUP.FRAME_OF_REFERENCE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eZONE_STRUCTURAL_MAKEUP.NAME, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "FORMATION", keyPath: \eZONE_STRUCTURAL_MAKEUP.FORMATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
