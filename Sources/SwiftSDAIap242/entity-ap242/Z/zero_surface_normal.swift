/* file: zero_surface_normal.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY zero_surface_normal
    ...
    WHERE
      ...
      wr5: validate_accuracy_types( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               + 'PLANE_ANGLE_MEASURE' ] );
  END_ENTITY; -- zero_surface_normal (line:33906 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _zero_surface_normal : SDAI.PartialEntity {
...
```
*/
  public final class eZERO_SURFACE_NORMAL : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eZERO_SURFACE_NORMAL`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "ZERO_SURFACE_NORMAL", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eZERO_SURFACE_NORMAL.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eZERO_SURFACE_NORMAL.NAME, 
