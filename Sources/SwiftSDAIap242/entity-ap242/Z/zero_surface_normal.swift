/* file: zero_surface_normal.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eZERO_SURFACE_NORMAL : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eZERO_SURFACE_NORMAL.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eZERO_SURFACE_NORMAL.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eZERO_SURFACE_NORMAL.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eZERO_SURFACE_NORMAL.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = eZERO_SURFACE_NORMAL.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
