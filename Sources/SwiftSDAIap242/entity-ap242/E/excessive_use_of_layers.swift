/* file: excessive_use_of_layers.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _excessive_use_of_layers : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eEXCESSIVE_USE_OF_LAYERS?) -> SDAI.LOGICAL {
      ...
      let _TEMP2 = VALIDATE_ECDQ_INSPECTED_ELEMENTS_TYPE(
        EI: eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERION(/*eEXCESSIVE_USE_OF_LAYERS*/SELF), 
        TYPE_LIST: _TEMP1)
      return _TEMP2
    }
...
```
*/
  public final class eEXCESSIVE_USE_OF_LAYERS : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _excessive_use_of_layers.WHERE_wr1(SELF: instance)
      return result
    }
