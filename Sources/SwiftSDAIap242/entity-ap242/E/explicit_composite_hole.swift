/* file: explicit_composite_hole.swift 	 generated: Tue Jan 20 19:20:51 2026 */
...
*/
  public final class eEXPLICIT_COMPOSITE_HOLE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eEXPLICIT_COMPOSITE_HOLE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eEXPLICIT_COMPOSITE_HOLE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
