/* file: excessive_use_of_groups.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY excessive_use_of_groups
    ...
    WHERE
      wr1: validate_ecdq_inspected_elements_type( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               + 'GROUP' ] );
  END_ENTITY; -- excessive_use_of_groups (line:14070 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _excessive_use_of_groups : SDAI.PartialEntity {
...
```
*/
  public final class eEXCESSIVE_USE_OF_GROUPS : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "EXCESSIVE_USE_OF_GROUPS", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "NAME", keyPath: \eEXCESSIVE_USE_OF_GROUPS.NAME, 
