/* file: erroneous_topology.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- erroneous_topology (line:14000 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	erroneous_topology
    (no local attributes)

  SUB- ENTITY(7)	open_closed_shell
  ...
  SUB- ENTITY(8)	disconnected_face_set
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(9)	inconsistent_adjacent_face_normals
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(10)	open_edge_loop
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eOPEN_CLOSED_SHELL``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDISCONNECTED_FACE_SET``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCONSISTENT_ADJACENT_FACE_NORMALS``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eOPEN_EDGE_LOOP``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eERRONEOUS_TOPOLOGY/PartialEntity``
*/
  public final class eERRONEOUS_TOPOLOGY : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eERRONEOUS_TOPOLOGY>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eERRONEOUS_TOPOLOGY.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eERRONEOUS_TOPOLOGY.PartialEntity
    ...
    public var super_eERRONEOUS_TOPOLOGY: eERRONEOUS_TOPOLOGY { return self } 	// [6]

    //MARK: SUBTYPES
    public var sub_eOPEN_CLOSED_SHELL: eOPEN_CLOSED_SHELL? {	// [7]
      return self.complexEntity.entityReference(eOPEN_CLOSED_SHELL.self)
    }

    public var sub_eDISCONNECTED_FACE_SET: eDISCONNECTED_FACE_SET? {	// [8]
      return self.complexEntity.entityReference(eDISCONNECTED_FACE_SET.self)
    }

    public var sub_eINCONSISTENT_ADJACENT_FACE_NORMALS: eINCONSISTENT_ADJACENT_FACE_NORMALS? {	// [9]
      return self.complexEntity.entityReference(eINCONSISTENT_ADJACENT_FACE_NORMALS.self)
    }

    public var sub_eOPEN_EDGE_LOOP: eOPEN_EDGE_LOOP? {	// [10]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eERRONEOUS_TOPOLOGY.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eERRONEOUS_TOPOLOGY.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eERRONEOUS_TOPOLOGY.NAME, 
