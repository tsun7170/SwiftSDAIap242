/* file: erroneous_manifold_solid_brep.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- erroneous_manifold_solid_brep (line:13994 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	erroneous_manifold_solid_brep
    (no local attributes)

  SUB- ENTITY(7)	wrongly_placed_void
  ...
  SUB- ENTITY(8)	solid_with_wrong_number_of_voids
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(9)	wrongly_oriented_void
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(10)	intersecting_shells_in_solid
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eWRONGLY_PLACED_VOID``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSOLID_WITH_WRONG_NUMBER_OF_VOIDS``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eWRONGLY_ORIENTED_VOID``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERSECTING_SHELLS_IN_SOLID``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eERRONEOUS_MANIFOLD_SOLID_BREP/PartialEntity``
*/
  public final class eERRONEOUS_MANIFOLD_SOLID_BREP : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eERRONEOUS_MANIFOLD_SOLID_BREP>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eERRONEOUS_MANIFOLD_SOLID_BREP.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eERRONEOUS_MANIFOLD_SOLID_BREP.PartialEntity
    ...
    public var super_eERRONEOUS_MANIFOLD_SOLID_BREP: eERRONEOUS_MANIFOLD_SOLID_BREP { return self } 	// [6]

    //MARK: SUBTYPES
    public var sub_eWRONGLY_PLACED_VOID: eWRONGLY_PLACED_VOID? {	// [7]
      return self.complexEntity.entityReference(eWRONGLY_PLACED_VOID.self)
    }

    public var sub_eSOLID_WITH_WRONG_NUMBER_OF_VOIDS: eSOLID_WITH_WRONG_NUMBER_OF_VOIDS? {	// [8]
      return self.complexEntity.entityReference(eSOLID_WITH_WRONG_NUMBER_OF_VOIDS.self)
    }

    public var sub_eWRONGLY_ORIENTED_VOID: eWRONGLY_ORIENTED_VOID? {	// [9]
      return self.complexEntity.entityReference(eWRONGLY_ORIENTED_VOID.self)
    }

    public var sub_eINTERSECTING_SHELLS_IN_SOLID: eINTERSECTING_SHELLS_IN_SOLID? {	// [10]
    ...
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERSECTING_SHELLS_IN_SOLID`` )
    public var INTERFERENCE_TOLERANCE: tLENGTH_MEASURE?  {
      get {
        let originalValue = sub_eINTERSECTING_SHELLS_IN_SOLID?.partialEntity._interference_tolerance
        let value = tLENGTH_MEASURE( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eINTERSECTING_SHELLS_IN_SOLID?.partialEntity
          else { return }
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eERRONEOUS_MANIFOLD_SOLID_BREP.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "ERRONEOUS_MANIFOLD_SOLID_BREP", 
      ...
      entityDef.addAttribute(name: "INTERFERENCE_TOLERANCE", 
        keyPath: \eERRONEOUS_MANIFOLD_SOLID_BREP.INTERFERENCE_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eERRONEOUS_MANIFOLD_SOLID_BREP.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eERRONEOUS_MANIFOLD_SOLID_BREP.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eERRONEOUS_MANIFOLD_SOLID_BREP``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eERRONEOUS_MANIFOLD_SOLID_BREP.self
      }
