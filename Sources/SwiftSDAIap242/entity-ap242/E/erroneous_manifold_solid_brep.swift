/* file: erroneous_manifold_solid_brep.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- erroneous_manifold_solid_brep (line:14001 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _erroneous_manifold_solid_brep : SDAI.PartialEntity {
...
```
*/
  public final class eERRONEOUS_MANIFOLD_SOLID_BREP : SDAI.EntityReference {
    ...
    /// - origin: SUB( ``eINTERSECTING_SHELLS_IN_SOLID`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "ERRONEOUS_MANIFOLD_SOLID_BREP", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "INTERFERENCE_TOLERANCE", keyPath: \eERRONEOUS_MANIFOLD_SOLID_BREP.INTERFERENCE_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eERRONEOUS_MANIFOLD_SOLID_BREP.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eERRONEOUS_MANIFOLD_SOLID_BREP.NAME, 
