/* file: explicit_round_hole.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _explicit_round_hole : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr2(SELF: eEXPLICIT_ROUND_HOLE.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( (SELF.DEPTH_TOLERANCE?.GROUP_REF(eTOLERANCE_VALUE.self))?.LOWER_BOUND, 
    ...
    public static func WHERE_wr3(SELF: eEXPLICIT_ROUND_HOLE.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( (SELF.DEPTH_TOLERANCE?.GROUP_REF(eTOLERANCE_VALUE.self))?.UPPER_BOUND, 
        IS: eLENGTH_MEASURE_WITH_UNIT.self )
      return _TEMP1
    }
    ...
    public required convenience init?(
      ...
      guard case .success(let p4) = exchangeStructure.recoverRequiredParameter(as: eSHAPE_REPRESENTATION.PRef.self, from: parameters[4])
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_explicit_round_hole``
*/
  public final class eEXPLICIT_ROUND_HOLE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _explicit_round_hole.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _explicit_round_hole.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _explicit_round_hole.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _explicit_round_hole.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _explicit_round_hole.WHERE_wr5(SELF: instance.pRef)
      return result
    }
