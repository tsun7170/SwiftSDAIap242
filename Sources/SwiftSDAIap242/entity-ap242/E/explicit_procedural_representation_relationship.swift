/* file: explicit_procedural_representation_relationship.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _explicit_procedural_representation_relationship : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _rep_1: ePROCEDURAL_REPRESENTATION	//EXPLICIT REDEFINITION(eREPRESENTATION_RELATIONSHIP) */
    ...
    public static func WHERE_wr1(SELF: eEXPLICIT_PROCEDURAL_REPRESENTATION_RELATIONSHIP?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.TYPEOF(SELF.GROUP_REF(eREPRESENTATION_RELATIONSHIP.self)?.REP_2, 
        IS: ePROCEDURAL_REPRESENTATION.self)
      let _TEMP2 =  !_TEMP1
      let _TEMP3 = SDAI.TYPEOF(SELF.GROUP_REF(eREPRESENTATION_RELATIONSHIP.self)?.REP_2, 
        IS: eVARIATIONAL_REPRESENTATION.self)
      let _TEMP4 =  !_TEMP3
      let _TEMP5 = _TEMP2 && _TEMP4
      return _TEMP5
    }
    public static func WHERE_wr2(SELF: eEXPLICIT_PROCEDURAL_REPRESENTATION_RELATIONSHIP?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eEXPLICIT_PROCEDURAL_REPRESENTATION_RELATIONSHIP : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var REP_1: ePROCEDURAL_REPRESENTATION {
      get {
        return SDAI.UNWRAP( ePROCEDURAL_REPRESENTATION( super_eREPRESENTATION_RELATIONSHIP.partialEntity
          ._rep_1 ) )
      }
      set(newValue) {
        let partial = super_eREPRESENTATION_RELATIONSHIP.partialEntity
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _explicit_procedural_representation_relationship.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _explicit_procedural_representation_relationship.WHERE_wr2(SELF: instance)
      return result
    }
