/* file: explicit_procedural_representation_relationship.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- explicit_procedural_representation_relationship (line:14179 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eEXPLICIT_PROCEDURAL_REPRESENTATION_RELATIONSHIP : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eEXPLICIT_PROCEDURAL_REPRESENTATION_RELATIONSHIP`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "EXPLICIT_PROCEDURAL_REPRESENTATION_RELATIONSHIP", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eEXPLICIT_PROCEDURAL_REPRESENTATION_RELATIONSHIP.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "REP_1", keyPath: \eEXPLICIT_PROCEDURAL_REPRESENTATION_RELATIONSHIP.REP_1, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_2", keyPath: \eEXPLICIT_PROCEDURAL_REPRESENTATION_RELATIONSHIP.REP_2, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eEXPLICIT_PROCEDURAL_REPRESENTATION_RELATIONSHIP.NAME, 
