/* file: evidence.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- evidence (line:14065 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _evidence : SDAI.PartialEntity {
...
```
*/
  public final class eEVIDENCE : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "EVIDENCE", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "ROLE", keyPath: \eEVIDENCE.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eEVIDENCE.ITEMS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_GROUP", keyPath: \eEVIDENCE.ASSIGNED_GROUP, 
