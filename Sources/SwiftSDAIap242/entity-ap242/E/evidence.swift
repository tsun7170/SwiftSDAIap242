/* file: evidence.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- evidence (line:14058 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	evidence
    ATTR:  items,	TYPE: SET [1 : ?] OF evidence_item -- EXPLICIT
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEVIDENCE/PartialEntity``
*/
  public final class eEVIDENCE : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eEVIDENCE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eEVIDENCE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eEVIDENCE.PartialEntity

    //MARK: SUPERTYPES
    public let super_eGROUP_ASSIGNMENT: eGROUP_ASSIGNMENT 	// [1]
    public var super_eEVIDENCE: eEVIDENCE { return self } 	// [2]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEVIDENCE`` )
    public var ITEMS: SDAI.SET<sEVIDENCE_ITEM>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = self.partialEntity._items
        let value = SDAI.UNWRAP( SDAI.SET<sEVIDENCE_ITEM>( originalValue ) )
        return value
      }
      set(newValue) {
        let partial = self.partialEntity
        let SELF = self; SDAI.TOUCH(let:SELF)
        partial._items = SDAI.UNWRAP(SDAI.SET<sEVIDENCE_ITEM>(
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eEVIDENCE.PartialEntity.self) else { return nil }
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEVIDENCE``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _items: SDAI.SET<sEVIDENCE_ITEM>/*[1:(nil as SDAI.INTEGER?)]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(ITEMS: SDAI.SET<sEVIDENCE_ITEM>/*[1:(nil as SDAI.INTEGER?)]*/ ) {

        self._items = 
        SDAI.SET<sEVIDENCE_ITEM>(
      ...
      public required convenience init?(
        ...
        guard case .success(let p0) = exchangeStructure.recoverRequiredParameter(as: SDAI.SET<sEVIDENCE_ITEM>.self, from: parameters[0])
