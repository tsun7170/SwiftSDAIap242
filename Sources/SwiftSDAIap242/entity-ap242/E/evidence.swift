/* file: evidence.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _evidence : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_evidence``
*/
  public final class eEVIDENCE : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public let partialEntity: _evidence
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_evidence.self) else { return nil }
