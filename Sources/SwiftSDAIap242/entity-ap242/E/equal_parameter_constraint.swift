/* file: equal_parameter_constraint.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _equal_parameter_constraint : SDAI.PartialEntity, @unchecked Sendable {
    ...
    /* override var _reference_elements: SDAI.SET<eVARIATIONAL_PARAMETER>[0:1] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */
    ...
    public static func WHERE_wr1(SELF: eEQUAL_PARAMETER_CONSTRAINT?) -> SDAI.LOGICAL {
...
```
*/
  public final class eEQUAL_PARAMETER_CONSTRAINT : SDAI.EntityReference, @unchecked Sendable {
    ...
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEQUAL_PARAMETER_CONSTRAINT`` )
    public var REFERENCE_ELEMENTS: SDAI.SET<eVARIATIONAL_PARAMETER>/*[0:1]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eVARIATIONAL_PARAMETER>( super_eEXPLICIT_CONSTRAINT.partialEntity
          ._reference_elements ) )
      }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _equal_parameter_constraint.WHERE_wr1(SELF: instance)
      return result
    }
