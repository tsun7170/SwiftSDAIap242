/* file: erroneous_topology_and_geometry_relationship.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- erroneous_topology_and_geometry_relationship (line:14006 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	erroneous_topology_and_geometry_relationship
    (no local attributes)

  SUB- ENTITY(7)	inconsistent_edge_and_curve_directions
  ...
  SUB- ENTITY(8)	inconsistent_face_and_surface_normals
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(9)	inconsistent_face_and_closed_shell_normals
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(10)	intersecting_loops_in_face
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion
  ...
  SUB- ENTITY(11)	wrongly_placed_loop
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP/PartialEntity``
*/
  public final class eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.PartialEntity
    ...
    public var super_eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP: eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP { return self } 	// [6]

    //MARK: SUBTYPES
    public var sub_eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS: eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS? {	// [7]
      return self.complexEntity.entityReference(eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.self)
    }

    public var sub_eINCONSISTENT_FACE_AND_SURFACE_NORMALS: eINCONSISTENT_FACE_AND_SURFACE_NORMALS? {	// [8]
      return self.complexEntity.entityReference(eINCONSISTENT_FACE_AND_SURFACE_NORMALS.self)
    }

    public var sub_eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS: eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS? {	// [9]
      return self.complexEntity.entityReference(eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS.self)
    }

    public var sub_eINTERSECTING_LOOPS_IN_FACE: eINTERSECTING_LOOPS_IN_FACE? {	// [10]
      return self.complexEntity.entityReference(eINTERSECTING_LOOPS_IN_FACE.self)
    }

    public var sub_eWRONGLY_PLACED_LOOP: eWRONGLY_PLACED_LOOP? {	// [11]
    ...
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS`` )
    public var DISTANCE_TOLERANCE: tLENGTH_MEASURE?  {
      get {
        let originalValue = sub_eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS?.partialEntity._distance_tolerance
        let value = tLENGTH_MEASURE( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS?.partialEntity
          else { return }
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERSECTING_LOOPS_IN_FACE`` )
    public var INTERFERENCE_TOLERANCE: tLENGTH_MEASURE?  {
      get {
        let originalValue = sub_eINTERSECTING_LOOPS_IN_FACE?.partialEntity._interference_tolerance
        let value = tLENGTH_MEASURE( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eINTERSECTING_LOOPS_IN_FACE?.partialEntity
          else { return }
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "ERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP", 
      ...
      entityDef.addAttribute(name: "DISTANCE_TOLERANCE", 
        keyPath: \eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.DISTANCE_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "INTERFERENCE_TOLERANCE", 
        keyPath: \eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.INTERFERENCE_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.self
      }
