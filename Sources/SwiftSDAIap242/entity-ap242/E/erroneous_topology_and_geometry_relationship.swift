/* file: erroneous_topology_and_geometry_relationship.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- erroneous_topology_and_geometry_relationship (line:13999 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP : SDAI.EntityReference {
    ...
    /// - origin: SUB( ``eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS`` )
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUB( ``eINTERSECTING_LOOPS_IN_FACE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "ERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DISTANCE_TOLERANCE", keyPath: \eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.DISTANCE_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "INTERFERENCE_TOLERANCE", keyPath: \eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.INTERFERENCE_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.NAME, 
