/* file: erroneous_topology_and_geometry_relationship.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var DISTANCE_TOLERANCE: tLENGTH_MEASURE?  {
      get {
        return sub_eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS?.partialEntity._distance_tolerance
      }
      set(newValue) {
        guard let partial = sub_eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS?.super_eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS
    ...
    public var INTERFERENCE_TOLERANCE: tLENGTH_MEASURE?  {
      get {
        return sub_eINTERSECTING_LOOPS_IN_FACE?.partialEntity._interference_tolerance
      }
      set(newValue) {
        guard let partial = sub_eINTERSECTING_LOOPS_IN_FACE?.super_eINTERSECTING_LOOPS_IN_FACE.partialEntity
          else { return }
