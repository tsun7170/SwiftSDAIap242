/* file: excessively_high_degree_surface.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- excessively_high_degree_surface (line:14097 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _excessively_high_degree_surface : SDAI.PartialEntity {
...
```
*/
  public final class eEXCESSIVELY_HIGH_DEGREE_SURFACE : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eEXCESSIVELY_HIGH_DEGREE_SURFACE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "EXCESSIVELY_HIGH_DEGREE_SURFACE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eEXCESSIVELY_HIGH_DEGREE_SURFACE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eEXCESSIVELY_HIGH_DEGREE_SURFACE.NAME, 
