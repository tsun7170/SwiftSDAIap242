/* file: excessively_high_degree_surface.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- excessively_high_degree_surface (line:14090 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	excessively_high_degree_surface
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXCESSIVELY_HIGH_DEGREE_SURFACE/PartialEntity``
*/
  public final class eEXCESSIVELY_HIGH_DEGREE_SURFACE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eEXCESSIVELY_HIGH_DEGREE_SURFACE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eEXCESSIVELY_HIGH_DEGREE_SURFACE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eEXCESSIVELY_HIGH_DEGREE_SURFACE.PartialEntity
    ...
    public var super_eEXCESSIVELY_HIGH_DEGREE_SURFACE: eEXCESSIVELY_HIGH_DEGREE_SURFACE { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXCESSIVELY_HIGH_DEGREE_SURFACE`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eEXCESSIVELY_HIGH_DEGREE_SURFACE.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eEXCESSIVELY_HIGH_DEGREE_SURFACE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eEXCESSIVELY_HIGH_DEGREE_SURFACE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eEXCESSIVELY_HIGH_DEGREE_SURFACE.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eEXCESSIVELY_HIGH_DEGREE_SURFACE.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = eEXCESSIVELY_HIGH_DEGREE_SURFACE.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "EXCESSIVELY_HIGH_DEGREE_SURFACE", 
      ...
      entityDef.add(supertype: eEXCESSIVELY_HIGH_DEGREE_SURFACE.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eEXCESSIVELY_HIGH_DEGREE_SURFACE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eEXCESSIVELY_HIGH_DEGREE_SURFACE.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXCESSIVELY_HIGH_DEGREE_SURFACE``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eEXCESSIVELY_HIGH_DEGREE_SURFACE.self
      }
      ...
      public static func WHERE_wr1(SELF: eEXCESSIVELY_HIGH_DEGREE_SURFACE.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eEXCESSIVELY_HIGH_DEGREE_SURFACE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eEXCESSIVELY_HIGH_DEGREE_SURFACE.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.COUNT_MEASURE") )
        return _TEMP1
      }
      public static func WHERE_wr3(SELF: eEXCESSIVELY_HIGH_DEGREE_SURFACE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr4(SELF: eEXCESSIVELY_HIGH_DEGREE_SURFACE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr5(SELF: eEXCESSIVELY_HIGH_DEGREE_SURFACE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
