/* file: excessively_high_degree_surface.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _excessively_high_degree_surface : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_excessively_high_degree_surface``
*/
  public final class eEXCESSIVELY_HIGH_DEGREE_SURFACE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _excessively_high_degree_surface.self
    }
    /// partial entity reference
    public let partialEntity: _excessively_high_degree_surface
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_excessively_high_degree_surface.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _excessively_high_degree_surface.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _excessively_high_degree_surface.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _excessively_high_degree_surface.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _excessively_high_degree_surface.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _excessively_high_degree_surface.WHERE_wr5(SELF: instance.pRef)
      return result
    }
