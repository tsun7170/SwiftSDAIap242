/* file: erroneous_geometry.swift 	 generated: Mon Dec 15 17:41:04 2025 */
...
*/
  ...
  public final class _erroneous_geometry : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_erroneous_geometry``
*/
  public final class eERRONEOUS_GEOMETRY : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _erroneous_geometry.self
    }
    /// partial entity reference
    public let partialEntity: _erroneous_geometry
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_erroneous_geometry.self) else { return nil }
