/* file: explicit_procedural_geometric_representation_item_relationship.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _explicit_procedural_geometric_representation_item_relationship : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _relating_representation_item: ePROCEDURAL_SHAPE_REPRESENTATION_SEQUENCE	//EXPLICIT REDEFINITION(eREPRESENTATION_ITEM_RELATIONSHIP) */
    ...
    public static func WHERE_wr1(SELF: eEXPLICIT_PROCEDURAL_GEOMETRIC_REPRESENTATION_ITEM_RELATIONSHIP?) -> SDAI.LOGICAL {
...
```
*/
  public final class eEXPLICIT_PROCEDURAL_GEOMETRIC_REPRESENTATION_ITEM_RELATIONSHIP : SDAI.EntityReference, @unchecked Sendable {
    ...
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXPLICIT_PROCEDURAL_GEOMETRIC_REPRESENTATION_ITEM_RELATIONSHIP`` )
    public var RELATING_REPRESENTATION_ITEM: ePROCEDURAL_SHAPE_REPRESENTATION_SEQUENCE {
      get {
        return SDAI.UNWRAP( ePROCEDURAL_SHAPE_REPRESENTATION_SEQUENCE( super_eREPRESENTATION_ITEM_RELATIONSHIP
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _explicit_procedural_geometric_representation_item_relationship.WHERE_wr1(SELF: instance)
      return result
    }
