/* file: edge_based_wireframe_shape_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _edge_based_wireframe_shape_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eEDGE_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eEDGE_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eEDGE_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.ITEMS
      let _TEMP2 = _TEMP1.QUERY{ IT in 

          let _TEMP1 = SDAI.TYPEOF(IT, IS: eEDGE_BASED_WIREFRAME_MODEL.self)
          return _TEMP1 }
      let _TEMP3 = _TEMP2.QUERY{ EBWM in 

          let _TEMP1 = EBWM.GROUP_REF(eEDGE_BASED_WIREFRAME_MODEL.self)
          let _TEMP2 = _TEMP1?.EBWM_BOUNDARY
          let _TEMP3 = _TEMP2?.QUERY{ EB in 

              let _TEMP1 = EB.CES_EDGES
              let _TEMP2 = _TEMP1.QUERY{ EDGES in 

                  let _TEMP1 = SDAI.TYPEOF(EDGES, IS: eEDGE_CURVE.self)
                  let _TEMP2 =  !_TEMP1
                  return _TEMP2 }
              let _TEMP3 = SDAI.SIZEOF(_TEMP2)
              let _TEMP4 = _TEMP3 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(0))
    ...
    public static func WHERE_wr4(SELF: eEDGE_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ EBWM in 
          ...
          let _TEMP3 = _TEMP2?.QUERY{ EB in 
              ...
              let _TEMP2 = _TEMP1.QUERY{ EDGES in 
                  ...
                  let _TEMP1 = SDAI.TYPEOF(EDGES.GROUP_REF(eEDGE_CURVE.self)?.EDGE_GEOMETRY, 
                    IS: ePOLYLINE.self)
                  return _TEMP1 }
              let _TEMP3 = _TEMP2.QUERY{ PLINE_EDGES in 

                  let _TEMP1 = PLINE_EDGES.GROUP_REF(eEDGE_CURVE.self)
                  let _TEMP2 = _TEMP1?.EDGE_GEOMETRY
                  let _TEMP3 = _TEMP2?.GROUP_REF(ePOLYLINE.self)
                  let _TEMP4 = _TEMP3?.POINTS
    ...
    public static func WHERE_wr5(SELF: eEDGE_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ EBWM in 
          ...
          let _TEMP3 = _TEMP2?.QUERY{ EB in 
              ...
              let _TEMP2 = _TEMP1.QUERY{ EDGES in 
                  ...
                  let _TEMP1 = SDAI.TYPEOF(EDGES.EDGE_START, IS: eVERTEX_POINT.self)
                  let _TEMP2 = SDAI.TYPEOF(EDGES.EDGE_END, IS: eVERTEX_POINT.self)
    ...
    public static func WHERE_wr6(SELF: eEDGE_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ EBWM in 
          ...
          let _TEMP3 = _TEMP2?.QUERY{ EB in 
              ...
              let _TEMP2 = _TEMP1.QUERY{ EDGES in 
                  ...
                  let _TEMP1 = EDGES.GROUP_REF(eEDGE_CURVE.self)
                  let _TEMP2 = _TEMP1?.EDGE_GEOMETRY
                  let _TEMP3 = VALID_WIREFRAME_EDGE_CURVE(_TEMP2)
                  let _TEMP4 =  !_TEMP3
                  return _TEMP4 }
              let _TEMP3 = SDAI.SIZEOF(_TEMP2)
              let _TEMP4 = _TEMP3 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(0))
    ...
    public static func WHERE_wr7(SELF: eEDGE_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ EBWM in 
          ...
          let _TEMP3 = _TEMP2?.QUERY{ EB in 
              ...
              let _TEMP2 = _TEMP1.QUERY{ EDGES in 
                  ...
                  let _TEMP1 = EDGES.EDGE_START
                  let _TEMP2 = _TEMP1.GROUP_REF(eVERTEX_POINT.self)
                  let _TEMP3 = _TEMP2?.VERTEX_GEOMETRY
                  let _TEMP4 = VALID_WIREFRAME_VERTEX_POINT(_TEMP3)
                  let _TEMP5 = EDGES.EDGE_END
                  let _TEMP6 = _TEMP5.GROUP_REF(eVERTEX_POINT.self)
                  let _TEMP7 = _TEMP6?.VERTEX_GEOMETRY
                  let _TEMP8 = VALID_WIREFRAME_VERTEX_POINT(_TEMP7)
    ...
    public static func WHERE_wr8(SELF: eEDGE_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr9(SELF: eEDGE_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eEDGE_BASED_WIREFRAME_SHAPE_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _edge_based_wireframe_shape_representation.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _edge_based_wireframe_shape_representation.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _edge_based_wireframe_shape_representation.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _edge_based_wireframe_shape_representation.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _edge_based_wireframe_shape_representation.WHERE_wr5(SELF: instance)
      result[prefix2 + " .WHERE_wr6"] = _edge_based_wireframe_shape_representation.WHERE_wr6(SELF: instance)
      result[prefix2 + " .WHERE_wr7"] = _edge_based_wireframe_shape_representation.WHERE_wr7(SELF: instance)
      result[prefix2 + " .WHERE_wr8"] = _edge_based_wireframe_shape_representation.WHERE_wr8(SELF: instance)
      result[prefix2 + " .WHERE_wr9"] = _edge_based_wireframe_shape_representation.WHERE_wr9(SELF: instance)
      return result
    }
