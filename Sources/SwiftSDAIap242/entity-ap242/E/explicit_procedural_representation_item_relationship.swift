/* file: explicit_procedural_representation_item_relationship.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eEXPLICIT_PROCEDURAL_REPRESENTATION_ITEM_RELATIONSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var RELATING_REPRESENTATION_ITEM: ePROCEDURAL_REPRESENTATION_SEQUENCE.PRef {
      get {
        return SDAI.UNWRAP( ePROCEDURAL_REPRESENTATION_SEQUENCE.PRef( super_eREPRESENTATION_ITEM_RELATIONSHIP
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eEXPLICIT_PROCEDURAL_REPRESENTATION_ITEM_RELATIONSHIP.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eEXPLICIT_PROCEDURAL_REPRESENTATION_ITEM_RELATIONSHIP.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
