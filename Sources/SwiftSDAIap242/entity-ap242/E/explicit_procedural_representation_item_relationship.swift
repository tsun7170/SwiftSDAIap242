/* file: explicit_procedural_representation_item_relationship.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_explicit_procedural_representation_item_relationship``
*/
  public final class eEXPLICIT_PROCEDURAL_REPRESENTATION_ITEM_RELATIONSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _explicit_procedural_representation_item_relationship.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _explicit_procedural_representation_item_relationship.WHERE_wr2(SELF: instance.pRef)
      return result
    }
