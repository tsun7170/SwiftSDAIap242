/* file: extreme_patch_width_variation.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eEXTREME_PATCH_WIDTH_VARIATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eEXTREME_PATCH_WIDTH_VARIATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eEXTREME_PATCH_WIDTH_VARIATION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eEXTREME_PATCH_WIDTH_VARIATION.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eEXTREME_PATCH_WIDTH_VARIATION.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = eEXTREME_PATCH_WIDTH_VARIATION.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
