/* file: extreme_patch_width_variation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _extreme_patch_width_variation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eEXTREME_PATCH_WIDTH_VARIATION?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eEXTREME_PATCH_WIDTH_VARIATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = VALIDATE_MEASURED_DATA_TYPE(
        EI: eSHAPE_DATA_QUALITY_CRITERION(/*eEXTREME_PATCH_WIDTH_VARIATION*/SELF), 
        TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.RATIO_MEASURE"))
      return _TEMP1
    }
    public static func WHERE_wr3(SELF: eEXTREME_PATCH_WIDTH_VARIATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eEXTREME_PATCH_WIDTH_VARIATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr5(SELF: eEXTREME_PATCH_WIDTH_VARIATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eEXTREME_PATCH_WIDTH_VARIATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _extreme_patch_width_variation.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _extreme_patch_width_variation.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _extreme_patch_width_variation.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _extreme_patch_width_variation.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _extreme_patch_width_variation.WHERE_wr5(SELF: instance)
      return result
    }
