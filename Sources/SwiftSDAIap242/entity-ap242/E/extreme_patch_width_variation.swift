/* file: extreme_patch_width_variation.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- extreme_patch_width_variation (line:14994 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _extreme_patch_width_variation : SDAI.PartialEntity {
...
```
*/
  public final class eEXTREME_PATCH_WIDTH_VARIATION : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eEXTREME_PATCH_WIDTH_VARIATION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "EXTREME_PATCH_WIDTH_VARIATION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eEXTREME_PATCH_WIDTH_VARIATION.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eEXTREME_PATCH_WIDTH_VARIATION.NAME, 
