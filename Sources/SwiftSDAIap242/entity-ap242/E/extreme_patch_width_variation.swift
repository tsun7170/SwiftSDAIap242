/* file: extreme_patch_width_variation.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _extreme_patch_width_variation : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_extreme_patch_width_variation``
*/
  public final class eEXTREME_PATCH_WIDTH_VARIATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _extreme_patch_width_variation.self
    }
    /// partial entity reference
    public let partialEntity: _extreme_patch_width_variation
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_extreme_patch_width_variation.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _extreme_patch_width_variation.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _extreme_patch_width_variation.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _extreme_patch_width_variation.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _extreme_patch_width_variation.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _extreme_patch_width_variation.WHERE_wr5(SELF: instance.pRef)
      return result
    }
