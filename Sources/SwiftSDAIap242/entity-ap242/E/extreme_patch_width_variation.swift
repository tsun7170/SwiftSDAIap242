/* file: extreme_patch_width_variation.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ENTITY extreme_patch_width_variation
    ...
    WHERE
      wr1: ( ( 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.SHAPE_DATA_QUALITY_LOWER_VALUE_LIMIT' IN 
               ...
               'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.RATIO_MEASURE'  IN value_limit_type( SELF\
  ...
  END_ENTITY; -- extreme_patch_width_variation (line:15072 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	extreme_patch_width_variation
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTREME_PATCH_WIDTH_VARIATION/PartialEntity``
*/
  public final class eEXTREME_PATCH_WIDTH_VARIATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eEXTREME_PATCH_WIDTH_VARIATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eEXTREME_PATCH_WIDTH_VARIATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eEXTREME_PATCH_WIDTH_VARIATION.PartialEntity
    ...
    public var super_eEXTREME_PATCH_WIDTH_VARIATION: eEXTREME_PATCH_WIDTH_VARIATION { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTREME_PATCH_WIDTH_VARIATION`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eEXTREME_PATCH_WIDTH_VARIATION.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eEXTREME_PATCH_WIDTH_VARIATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eEXTREME_PATCH_WIDTH_VARIATION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eEXTREME_PATCH_WIDTH_VARIATION.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eEXTREME_PATCH_WIDTH_VARIATION.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = eEXTREME_PATCH_WIDTH_VARIATION.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "EXTREME_PATCH_WIDTH_VARIATION", 
      ...
      entityDef.add(supertype: eEXTREME_PATCH_WIDTH_VARIATION.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eEXTREME_PATCH_WIDTH_VARIATION.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eEXTREME_PATCH_WIDTH_VARIATION.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTREME_PATCH_WIDTH_VARIATION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eEXTREME_PATCH_WIDTH_VARIATION.self
      }
      ...
      public static func WHERE_wr1(SELF: eEXTREME_PATCH_WIDTH_VARIATION.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eEXTREME_PATCH_WIDTH_VARIATION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eEXTREME_PATCH_WIDTH_VARIATION.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.RATIO_MEASURE") )
        return _TEMP1
      }
      public static func WHERE_wr3(SELF: eEXTREME_PATCH_WIDTH_VARIATION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
      ...
      public static func WHERE_wr4(SELF: eEXTREME_PATCH_WIDTH_VARIATION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
      ...
      public static func WHERE_wr5(SELF: eEXTREME_PATCH_WIDTH_VARIATION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
