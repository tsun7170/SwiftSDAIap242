/* file: externally_conditioned_data_quality_criterion.swift 	 generated: Mon Dec 15 17:41:04 2025 */
...
*/
  ...
  public final class _externally_conditioned_data_quality_criterion : SDAI.PartialEntity, InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_externally_conditioned_data_quality_criterion``
*/
  public final class eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERION : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _externally_conditioned_data_quality_criterion.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _externally_conditioned_data_quality_criterion.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _externally_conditioned_data_quality_criterion.WHERE_wr3(SELF: instance.pRef)
      return result
    }
