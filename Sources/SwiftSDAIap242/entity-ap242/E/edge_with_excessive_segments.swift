/* file: edge_with_excessive_segments.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- edge_with_excessive_segments (line:13537 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	edge_with_excessive_segments
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEDGE_WITH_EXCESSIVE_SEGMENTS/PartialEntity``
*/
  public final class eEDGE_WITH_EXCESSIVE_SEGMENTS : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eEDGE_WITH_EXCESSIVE_SEGMENTS>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eEDGE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eEDGE_WITH_EXCESSIVE_SEGMENTS.PartialEntity
    ...
    public var super_eEDGE_WITH_EXCESSIVE_SEGMENTS: eEDGE_WITH_EXCESSIVE_SEGMENTS { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEDGE_WITH_EXCESSIVE_SEGMENTS`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eEDGE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eEDGE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eEDGE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eEDGE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eEDGE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = eEDGE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "EDGE_WITH_EXCESSIVE_SEGMENTS", 
      ...
      entityDef.add(supertype: eEDGE_WITH_EXCESSIVE_SEGMENTS.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eEDGE_WITH_EXCESSIVE_SEGMENTS.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eEDGE_WITH_EXCESSIVE_SEGMENTS.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEDGE_WITH_EXCESSIVE_SEGMENTS``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eEDGE_WITH_EXCESSIVE_SEGMENTS.self
      }
      ...
      public static func WHERE_wr1(SELF: eEDGE_WITH_EXCESSIVE_SEGMENTS.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eEDGE_WITH_EXCESSIVE_SEGMENTS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eEDGE_WITH_EXCESSIVE_SEGMENTS.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.COUNT_MEASURE") )
        return _TEMP1
      }
      public static func WHERE_wr3(SELF: eEDGE_WITH_EXCESSIVE_SEGMENTS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr4(SELF: eEDGE_WITH_EXCESSIVE_SEGMENTS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr5(SELF: eEDGE_WITH_EXCESSIVE_SEGMENTS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
