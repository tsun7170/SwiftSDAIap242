/* file: edge_with_excessive_segments.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _edge_with_excessive_segments : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_edge_with_excessive_segments``
*/
  public final class eEDGE_WITH_EXCESSIVE_SEGMENTS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _edge_with_excessive_segments.self
    }
    /// partial entity reference
    public let partialEntity: _edge_with_excessive_segments
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_edge_with_excessive_segments.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _edge_with_excessive_segments.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _edge_with_excessive_segments.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _edge_with_excessive_segments.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _edge_with_excessive_segments.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _edge_with_excessive_segments.WHERE_wr5(SELF: instance.pRef)
      return result
    }
