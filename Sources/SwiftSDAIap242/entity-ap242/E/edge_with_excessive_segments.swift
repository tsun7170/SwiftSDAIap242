/* file: edge_with_excessive_segments.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eEDGE_WITH_EXCESSIVE_SEGMENTS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eEDGE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eEDGE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eEDGE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eEDGE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = eEDGE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
