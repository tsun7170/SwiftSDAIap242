/* file: evaluated_characteristic.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- evaluated_characteristic (line:14013 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	evaluated_characteristic
    (no local attributes)

  SUB- ENTITY(4)	evaluated_characteristic_of_product_as_individual_test_result
    (no local attributes)
...
- SUPERTYPES:
	...
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREPRESENTATION_RELATIONSHIP``

- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEVALUATED_CHARACTERISTIC_OF_PRODUCT_AS_INDIVIDUAL_TEST_RESULT``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEVALUATED_CHARACTERISTIC/PartialEntity``
*/
  public final class eEVALUATED_CHARACTERISTIC : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eEVALUATED_CHARACTERISTIC>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eEVALUATED_CHARACTERISTIC.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eEVALUATED_CHARACTERISTIC.PartialEntity
    ...
    public var super_eEVALUATED_CHARACTERISTIC: eEVALUATED_CHARACTERISTIC { return self } 	// [3]

    //MARK: SUBTYPES
    public var sub_eEVALUATED_CHARACTERISTIC_OF_PRODUCT_AS_INDIVIDUAL_TEST_RESULT: eEVALUATED_CHARACTERISTIC_OF_PRODUCT_AS_INDIVIDUAL_TEST_RESULT? {	// [4]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eEVALUATED_CHARACTERISTIC.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eEVALUATED_CHARACTERISTIC.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eEVALUATED_CHARACTERISTIC.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eEVALUATED_CHARACTERISTIC.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eEVALUATED_CHARACTERISTIC.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_1", 
        keyPath: \eEVALUATED_CHARACTERISTIC.REP_1, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_2", 
        keyPath: \eEVALUATED_CHARACTERISTIC.REP_2, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)

      //MARK: UNIQUENESS RULE REGISTRATIONS
      entityDef.addUniquenessRule(label:"UNIQUE_ur1", rule: eEVALUATED_CHARACTERISTIC.PartialEntity.UNIQUE_ur1)
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: eEVALUATED_CHARACTERISTIC.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP3 /* eREPRESENTATION_RELATIONSHIP.PRef? */ = SELF.GROUP_REF(eREPRESENTATION_RELATIONSHIP.self)
        let _TEMP4 /* sREPRESENTATION_OR_REPRESENTATION_REFERENCE? */ = _TEMP3?.REP_2
      ...
      public static func UNIQUE_ur1(SELF: SDAI.EntityReference) -> AnyHashable? {
        guard let SELF = (SELF as? eEVALUATED_CHARACTERISTIC)?.pRef else { return nil }
        //JOINT UNIQUE RULE

        var attributes: Array<AnyHashable> = []

        guard let attr1 = (SELF.GROUP_REF(eREPRESENTATION_RELATIONSHIP.self))?.REP_1 else { return nil }
        attributes.append( AnyHashable(attr1) )

        guard let attr2 = (SELF.GROUP_REF(eREPRESENTATION_RELATIONSHIP.self))?.REP_2 else { return nil }
