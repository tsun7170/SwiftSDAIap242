/* file: evaluated_characteristic.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _evaluated_characteristic : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_evaluated_characteristic``
*/
  public final class eEVALUATED_CHARACTERISTIC : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _evaluated_characteristic.self
    }
    /// partial entity reference
    public let partialEntity: _evaluated_characteristic
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_evaluated_characteristic.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _evaluated_characteristic.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addUniquenessRule(label:"UNIQUE_ur1", rule: _evaluated_characteristic.UNIQUE_ur1)
