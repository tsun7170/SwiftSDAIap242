/* file: evaluated_characteristic.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _evaluated_characteristic : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eEVALUATED_CHARACTERISTIC?) -> SDAI.LOGICAL {
    ...
    public static func UNIQUE_ur1(SELF: SDAI.EntityReference) -> AnyHashable? {
      guard let SELF = SELF as? eEVALUATED_CHARACTERISTIC else { return nil }
      //JOINT UNIQUE RULE
...
```
*/
  public final class eEVALUATED_CHARACTERISTIC : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _evaluated_characteristic.WHERE_wr1(SELF: instance)
      return result
    }
