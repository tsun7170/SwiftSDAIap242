/* file: evaluated_characteristic.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- evaluated_characteristic (line:14020 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _evaluated_characteristic : SDAI.PartialEntity {
...
```
*/
  public final class eEVALUATED_CHARACTERISTIC : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "EVALUATED_CHARACTERISTIC", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ITEMS", keyPath: \eEVALUATED_CHARACTERISTIC.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eEVALUATED_CHARACTERISTIC.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eEVALUATED_CHARACTERISTIC.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_1", keyPath: \eEVALUATED_CHARACTERISTIC.REP_1, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_2", keyPath: \eEVALUATED_CHARACTERISTIC.REP_2, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)

      //MARK: UNIQUENESS RULE REGISTRATIONS
      entityDef.addUniqunessRule(label:"UNIQUE_ur1", rule: _evaluated_characteristic.UNIQUE_ur1)
