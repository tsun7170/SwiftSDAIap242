/* file: externally_conditioned_data_quality_criteria_representation.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  ENTITY externally_conditioned_data_quality_criteria_representation
    ...
    WHERE
      wr1: ( SIZEOF( QUERY ( q <* SELF\representation.items | ( 
               'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.EXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERION'  
               IN TYPEOF( q ) ) ) ) > 0 );
  END_ENTITY; -- externally_conditioned_data_quality_criteria_representation (line:14325 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	externally_conditioned_data_quality_criteria_representation
    (no local attributes)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION/PartialEntity``
*/
  public final class eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION.PartialEntity
    ...
    public var super_eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION: eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION { return self } 	// [3]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "EXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION", 
      ...
      entityDef.add(supertype: eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION.self
      }
      ...
      public static func WHERE_wr1(SELF: eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
