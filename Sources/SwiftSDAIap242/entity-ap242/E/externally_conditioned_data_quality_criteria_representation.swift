/* file: externally_conditioned_data_quality_criteria_representation.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY externally_conditioned_data_quality_criteria_representation
    ...
    WHERE
      wr1: ( SIZEOF( QUERY ( q <* SELF\representation.items | ( 
               ...
               IN TYPEOF( q ) ) ) ) > 0 );
  END_ENTITY; -- externally_conditioned_data_quality_criteria_representation (line:14318 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "EXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERIA_REPRESENTATION.NAME, 
