/* file: entirely_narrow_solid.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _entirely_narrow_solid : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_entirely_narrow_solid``
*/
  public final class eENTIRELY_NARROW_SOLID : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _entirely_narrow_solid.self
    }
    /// partial entity reference
    public let partialEntity: _entirely_narrow_solid
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_entirely_narrow_solid.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _entirely_narrow_solid.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _entirely_narrow_solid.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _entirely_narrow_solid.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _entirely_narrow_solid.WHERE_wr4(SELF: instance.pRef)
      return result
    }
