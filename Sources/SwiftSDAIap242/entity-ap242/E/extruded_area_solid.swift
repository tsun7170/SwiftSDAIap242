/* file: extruded_area_solid.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- extruded_area_solid (line:15009 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _extruded_area_solid : SDAI.PartialEntity {
...
```
*/
  public final class eEXTRUDED_AREA_SOLID : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eEXTRUDED_AREA_SOLID`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "EXTRUDED_AREA_SOLID", type: self, explicitAttributeCount: 2)
      ...
      entityDef.addAttribute(name: "EXTRUDED_DIRECTION", keyPath: \eEXTRUDED_AREA_SOLID.EXTRUDED_DIRECTION, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "SWEPT_AREA", keyPath: \eEXTRUDED_AREA_SOLID.SWEPT_AREA, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eEXTRUDED_AREA_SOLID.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DEPTH", keyPath: \eEXTRUDED_AREA_SOLID.DEPTH, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", keyPath: \eEXTRUDED_AREA_SOLID.DIM, 
