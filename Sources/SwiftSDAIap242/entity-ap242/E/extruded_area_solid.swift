/* file: extruded_area_solid.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _extruded_area_solid : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eEXTRUDED_AREA_SOLID?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.GROUP_REF(eSWEPT_AREA_SOLID.self)
      let _TEMP2 = _TEMP1?.SWEPT_AREA
...
```
*/
  public final class eEXTRUDED_AREA_SOLID : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _extruded_area_solid.WHERE_wr1(SELF: instance)
      return result
    }
