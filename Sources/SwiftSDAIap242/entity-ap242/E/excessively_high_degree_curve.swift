/* file: excessively_high_degree_curve.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _excessively_high_degree_curve : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eEXCESSIVELY_HIGH_DEGREE_CURVE?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eEXCESSIVELY_HIGH_DEGREE_CURVE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = VALIDATE_MEASURED_DATA_TYPE(
        EI: eSHAPE_DATA_QUALITY_CRITERION(/*eEXCESSIVELY_HIGH_DEGREE_CURVE*/SELF), 
        TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.COUNT_MEASURE"))
      return _TEMP1
    }
    public static func WHERE_wr3(SELF: eEXCESSIVELY_HIGH_DEGREE_CURVE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eEXCESSIVELY_HIGH_DEGREE_CURVE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr5(SELF: eEXCESSIVELY_HIGH_DEGREE_CURVE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eEXCESSIVELY_HIGH_DEGREE_CURVE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _excessively_high_degree_curve.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _excessively_high_degree_curve.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _excessively_high_degree_curve.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _excessively_high_degree_curve.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _excessively_high_degree_curve.WHERE_wr5(SELF: instance)
      return result
    }
