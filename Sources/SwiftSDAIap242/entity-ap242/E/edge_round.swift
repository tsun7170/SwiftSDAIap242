/* file: edge_round.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _edge_round : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eEDGE_ROUND?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.GROUP_REF(eSHAPE_ASPECT.self)
      let _TEMP2 = _TEMP1?.DESCRIPTION
      let _TEMP3 = _TEMP2 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("constant radius"))
      let _TEMP4 =  !_TEMP3
    ...
    public static func WHERE_wr2(SELF: eEDGE_ROUND?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eEDGE_ROUND?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.DESCRIPTION
      let _TEMP2 = _TEMP1 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("constant radius"))
      let _TEMP3 =  !_TEMP2
    ...
    public static func WHERE_wr4(SELF: eEDGE_ROUND?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr5(SELF: eEDGE_ROUND?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr6(SELF: eEDGE_ROUND?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr7(SELF: eEDGE_ROUND?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr8(SELF: eEDGE_ROUND?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eEDGE_ROUND : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _edge_round.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _edge_round.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _edge_round.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _edge_round.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _edge_round.WHERE_wr5(SELF: instance)
      result[prefix2 + " .WHERE_wr6"] = _edge_round.WHERE_wr6(SELF: instance)
      result[prefix2 + " .WHERE_wr7"] = _edge_round.WHERE_wr7(SELF: instance)
      result[prefix2 + " .WHERE_wr8"] = _edge_round.WHERE_wr8(SELF: instance)
      return result
    }
