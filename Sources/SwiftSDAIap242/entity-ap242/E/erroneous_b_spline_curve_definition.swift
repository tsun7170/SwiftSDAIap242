/* file: erroneous_b_spline_curve_definition.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eERRONEOUS_B_SPLINE_CURVE_DEFINITION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eERRONEOUS_B_SPLINE_CURVE_DEFINITION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eERRONEOUS_B_SPLINE_CURVE_DEFINITION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eERRONEOUS_B_SPLINE_CURVE_DEFINITION.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eERRONEOUS_B_SPLINE_CURVE_DEFINITION.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
