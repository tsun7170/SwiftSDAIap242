/* file: erroneous_b_spline_curve_definition.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- erroneous_b_spline_curve_definition (line:13967 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _erroneous_b_spline_curve_definition : SDAI.PartialEntity {
...
```
*/
  public final class eERRONEOUS_B_SPLINE_CURVE_DEFINITION : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eERRONEOUS_B_SPLINE_CURVE_DEFINITION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "ERRONEOUS_B_SPLINE_CURVE_DEFINITION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eERRONEOUS_B_SPLINE_CURVE_DEFINITION.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eERRONEOUS_B_SPLINE_CURVE_DEFINITION.NAME, 
