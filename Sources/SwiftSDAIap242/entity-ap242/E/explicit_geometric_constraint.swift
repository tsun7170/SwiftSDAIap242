/* file: explicit_geometric_constraint.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eEXPLICIT_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var CONSTRAINED_ELEMENTS: SDAI.SET<eGEOMETRIC_REPRESENTATION_ITEM.PRef>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eGEOMETRIC_REPRESENTATION_ITEM.PRef>( super_eEXPLICIT_CONSTRAINT
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _constrained_elements: SDAI.SET<eGEOMETRIC_REPRESENTATION_ITEM.PRef>[1:nil] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */

      /* override var _reference_elements: SDAI.SET<eGEOMETRIC_REPRESENTATION_ITEM.PRef>[0:nil] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */
