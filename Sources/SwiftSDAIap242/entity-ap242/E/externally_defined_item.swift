/* file: externally_defined_item.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTERNALLY_DEFINED_ITEM/PartialEntity``
*/
  public final class eEXTERNALLY_DEFINED_ITEM : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eEXTERNALLY_DEFINED_ITEM.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eEXTERNALLY_DEFINED_ITEM.PartialEntity
    ...
    public var ITEM_ID: sSOURCE_ITEM {
      get {
        let originalValue = self.partialEntity._item_id
    ...
    public var VALUE_RANGE: eMATHS_SPACE.PRef?  {
      get {
        let originalValue = sub_eEXTERNALLY_LISTED_DATA?.partialEntity._value_range
        let value = eMATHS_SPACE.PRef( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eEXTERNALLY_LISTED_DATA?.partialEntity
          else { return }
    ...
    public var ITEMS: (SDAI.SET<eEXTERNALLY_DEFINED_REPRESENTATION_ITEM.PRef>/*[1:(nil as SDAI.INTEGER?)]*/ )?  {
      get {
        let originalValue = sub_eEXTERNALLY_DEFINED_REPRESENTATION?
          .super_eREPRESENTATION.partialEntity._items
        guard let SELF = sub_eEXTERNALLY_DEFINED_REPRESENTATION?
          .super_eREPRESENTATION
          else { return nil }; SDAI.TOUCH(let:SELF)
        let value =         SDAI.SET<eEXTERNALLY_DEFINED_REPRESENTATION_ITEM.PRef>(
      ...
      set(newValue) {
        guard let partial = 
          sub_eEXTERNALLY_DEFINED_REPRESENTATION?
          .super_eREPRESENTATION.partialEntity
          else { return }
        guard let SELF = sub_eEXTERNALLY_DEFINED_REPRESENTATION?
          .super_eREPRESENTATION
    ...
    public var REFERENCES: (SDAI.LIST_UNIQUE<sSOURCE_ITEM>/*[1:(nil as SDAI.INTEGER?)]*/ )?  {
      get {
        let originalValue = sub_eEXTERNALLY_DEFINED_ITEM_WITH_MULTIPLE_REFERENCES?.partialEntity._references
        let value = SDAI.LIST_UNIQUE<sSOURCE_ITEM>( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eEXTERNALLY_DEFINED_ITEM_WITH_MULTIPLE_REFERENCES?.partialEntity
          else { return }
        guard let SELF = sub_eEXTERNALLY_DEFINED_ITEM_WITH_MULTIPLE_REFERENCES
           else { return }; SDAI.TOUCH(let:SELF)
        partial._references = SDAI.UNWRAP(SDAI.LIST_UNIQUE<sSOURCE_ITEM>(
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?),
          newValue))
      }
    }
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eEXTERNALLY_DEFINED_ITEM.PartialEntity.self) else { return nil }
