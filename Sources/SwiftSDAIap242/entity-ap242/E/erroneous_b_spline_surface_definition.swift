/* file: erroneous_b_spline_surface_definition.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _erroneous_b_spline_surface_definition : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_erroneous_b_spline_surface_definition``
*/
  public final class eERRONEOUS_B_SPLINE_SURFACE_DEFINITION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _erroneous_b_spline_surface_definition.self
    }
    /// partial entity reference
    public let partialEntity: _erroneous_b_spline_surface_definition
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_erroneous_b_spline_surface_definition.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _erroneous_b_spline_surface_definition.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _erroneous_b_spline_surface_definition.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _erroneous_b_spline_surface_definition.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _erroneous_b_spline_surface_definition.WHERE_wr4(SELF: instance.pRef)
      return result
    }
