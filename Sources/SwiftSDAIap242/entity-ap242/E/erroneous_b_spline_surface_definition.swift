/* file: erroneous_b_spline_surface_definition.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- erroneous_b_spline_surface_definition (line:13964 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _erroneous_b_spline_surface_definition : SDAI.PartialEntity {
...
```
*/
  public final class eERRONEOUS_B_SPLINE_SURFACE_DEFINITION : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eERRONEOUS_B_SPLINE_SURFACE_DEFINITION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "ERRONEOUS_B_SPLINE_SURFACE_DEFINITION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eERRONEOUS_B_SPLINE_SURFACE_DEFINITION.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eERRONEOUS_B_SPLINE_SURFACE_DEFINITION.NAME, 
