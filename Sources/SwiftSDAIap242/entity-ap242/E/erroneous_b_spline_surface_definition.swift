/* file: erroneous_b_spline_surface_definition.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- erroneous_b_spline_surface_definition (line:13971 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	erroneous_b_spline_surface_definition
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eERRONEOUS_B_SPLINE_SURFACE_DEFINITION/PartialEntity``
*/
  public final class eERRONEOUS_B_SPLINE_SURFACE_DEFINITION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eERRONEOUS_B_SPLINE_SURFACE_DEFINITION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eERRONEOUS_B_SPLINE_SURFACE_DEFINITION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eERRONEOUS_B_SPLINE_SURFACE_DEFINITION.PartialEntity
    ...
    public var super_eERRONEOUS_B_SPLINE_SURFACE_DEFINITION: eERRONEOUS_B_SPLINE_SURFACE_DEFINITION { return self } 	// [7]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eERRONEOUS_B_SPLINE_SURFACE_DEFINITION`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eERRONEOUS_B_SPLINE_SURFACE_DEFINITION.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eERRONEOUS_B_SPLINE_SURFACE_DEFINITION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eERRONEOUS_B_SPLINE_SURFACE_DEFINITION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eERRONEOUS_B_SPLINE_SURFACE_DEFINITION.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eERRONEOUS_B_SPLINE_SURFACE_DEFINITION.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "ERRONEOUS_B_SPLINE_SURFACE_DEFINITION", 
      ...
      entityDef.add(supertype: eERRONEOUS_B_SPLINE_SURFACE_DEFINITION.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eERRONEOUS_B_SPLINE_SURFACE_DEFINITION.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eERRONEOUS_B_SPLINE_SURFACE_DEFINITION.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eERRONEOUS_B_SPLINE_SURFACE_DEFINITION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eERRONEOUS_B_SPLINE_SURFACE_DEFINITION.self
      }
      ...
      public static func WHERE_wr1(SELF: eERRONEOUS_B_SPLINE_SURFACE_DEFINITION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eERRONEOUS_B_SPLINE_SURFACE_DEFINITION.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOOLEAN_VALUE") )
        return _TEMP1
      }
      public static func WHERE_wr2(SELF: eERRONEOUS_B_SPLINE_SURFACE_DEFINITION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
      ...
      public static func WHERE_wr3(SELF: eERRONEOUS_B_SPLINE_SURFACE_DEFINITION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
      ...
      public static func WHERE_wr4(SELF: eERRONEOUS_B_SPLINE_SURFACE_DEFINITION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.AGGREGATE<runtime> */ = SDAI.BAG<SDAI.STRING>(SDAI.EMPTY_AGGREGATE)
