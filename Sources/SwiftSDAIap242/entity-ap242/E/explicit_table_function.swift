/* file: explicit_table_function.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eEXPLICIT_TABLE_FUNCTION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var OPERANDS: (SDAI.LIST<eMATHS_FUNCTION.PRef>/*[3:3]*/ )?  {
      get {
        if let resolved = eMULTIPLE_ARITY_GENERIC_EXPRESSION.PartialEntity._operands__provider(complex: self.complexEntity) {
          ...
          return SDAI.LIST<eMATHS_FUNCTION.PRef>(sub_eBASIC_SPARSE_MATRIX?.super_eMULTIPLE_ARITY_GENERIC_EXPRESSION
    ...
    public var OPERAND: eMATHS_FUNCTION.PRef?  {
      get {
        return eMATHS_FUNCTION.PRef( sub_eLINEARIZED_TABLE_FUNCTION?.super_eUNARY_GENERIC_EXPRESSION
          .partialEntity._operand )
      }
      set(newValue) {
