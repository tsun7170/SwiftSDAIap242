/* file: electric_current_unit.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _electric_current_unit : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eELECTRIC_CURRENT_UNIT?) -> SDAI.LOGICAL {
      ...
      let _TEMP18 = _TEMP17 .==. SDAI.FORCE_OPTIONAL(SDAI.REAL(1.0000000000e+00))
...
```
*/
  public final class eELECTRIC_CURRENT_UNIT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _electric_current_unit.WHERE_wr1(SELF: instance)
      return result
    }
