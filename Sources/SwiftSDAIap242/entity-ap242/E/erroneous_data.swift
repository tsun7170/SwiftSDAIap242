/* file: erroneous_data.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- erroneous_data (line:13982 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eERRONEOUS_DATA/PartialEntity``
*/
  public final class eERRONEOUS_DATA : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eERRONEOUS_DATA>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eERRONEOUS_DATA.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eERRONEOUS_DATA.PartialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eERRONEOUS_DATA.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eERRONEOUS_DATA.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eERRONEOUS_DATA.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eERRONEOUS_DATA``
*/
