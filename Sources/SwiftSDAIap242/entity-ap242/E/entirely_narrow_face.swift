/* file: entirely_narrow_face.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- entirely_narrow_face (line:13888 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _entirely_narrow_face : SDAI.PartialEntity {
...
```
*/
  public final class eENTIRELY_NARROW_FACE : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eENTIRELY_NARROW_FACE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "ENTIRELY_NARROW_FACE", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "WIDTH_TOLERANCE", keyPath: \eENTIRELY_NARROW_FACE.WIDTH_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eENTIRELY_NARROW_FACE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eENTIRELY_NARROW_FACE.NAME, 
