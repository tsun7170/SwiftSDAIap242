/* file: entirely_narrow_face.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eENTIRELY_NARROW_FACE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eENTIRELY_NARROW_FACE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eENTIRELY_NARROW_FACE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eENTIRELY_NARROW_FACE.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eENTIRELY_NARROW_FACE.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
