/* file: entirely_narrow_face.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _entirely_narrow_face : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eENTIRELY_NARROW_FACE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = VALIDATE_MEASURED_DATA_TYPE(
        EI: eSHAPE_DATA_QUALITY_CRITERION(/*eENTIRELY_NARROW_FACE*/SELF), 
        TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOOLEAN_VALUE"))
      return _TEMP1
    }
    public static func WHERE_wr2(SELF: eENTIRELY_NARROW_FACE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eENTIRELY_NARROW_FACE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eENTIRELY_NARROW_FACE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eENTIRELY_NARROW_FACE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _entirely_narrow_face.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _entirely_narrow_face.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _entirely_narrow_face.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _entirely_narrow_face.WHERE_wr4(SELF: instance)
      return result
    }
