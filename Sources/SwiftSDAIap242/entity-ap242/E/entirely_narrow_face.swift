/* file: entirely_narrow_face.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _entirely_narrow_face : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_entirely_narrow_face``
*/
  public final class eENTIRELY_NARROW_FACE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _entirely_narrow_face.self
    }
    /// partial entity reference
    public let partialEntity: _entirely_narrow_face
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_entirely_narrow_face.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _entirely_narrow_face.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _entirely_narrow_face.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _entirely_narrow_face.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _entirely_narrow_face.WHERE_wr4(SELF: instance.pRef)
      return result
    }
