/* file: explicit_constraint.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _constrained_elements: SDAI.SET<eREPRESENTATION_ITEM.PRef>/*[1:?]*/  // PLAIN EXPLICIT ATTRIBUTE

      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _reference_elements: SDAI.SET<eREPRESENTATION_ITEM.PRef>/*[0:?]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(
        DESCRIPTION: tTEXT? , 
        CONSTRAINED_ELEMENTS: SDAI.SET<eREPRESENTATION_ITEM.PRef>/*[1:?]*/ , 
        REFERENCE_ELEMENTS: SDAI.SET<eREPRESENTATION_ITEM.PRef>/*[0:?]*/ 
      ) {

        self._description = DESCRIPTION
        self._constrained_elements = 
        SDAI.SET<eREPRESENTATION_ITEM.PRef>(from: CONSTRAINED_ELEMENTS.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
        self._reference_elements = 
        SDAI.SET<eREPRESENTATION_ITEM.PRef>(from: REFERENCE_ELEMENTS.asSwiftType, 
          bound1:SDAI.UNWRAP(0), bound2:(nil as SDAI.INTEGER?))
