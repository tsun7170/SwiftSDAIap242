/* file: explicit_constraint.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- explicit_constraint (line:14138 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	...
	11.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eASSEMBLY_GEOMETRIC_CONSTRAINT``
	12.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFREE_FORM_RELATION``
	13.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFREE_FORM_ASSIGNMENT``
	14.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFREE_FORM_CONSTRAINT``
	15.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEQUAL_PARAMETER_CONSTRAINT``
	16.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSYMMETRY_GEOMETRIC_CONSTRAINT``
	17.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSWEPT_POINT_CURVE_GEOMETRIC_CONSTRAINT``
	18.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOAXIAL_GEOMETRIC_CONSTRAINT``
	19.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT``
	20.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCIDENCE_GEOMETRIC_CONSTRAINT``
	21.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCLGC_WITH_DIMENSION``
	22.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_LENGTH_GEOMETRIC_CONSTRAINT``
	23.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE_SMOOTHNESS_GEOMETRIC_CONSTRAINT``
	24.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT``
	25.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAGC_WITH_DIMENSION``
	26.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANGLE_GEOMETRIC_CONSTRAINT``
	27.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePERPENDICULAR_GEOMETRIC_CONSTRAINT``
	28.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOGC_WITH_DIMENSION``
	29.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARALLEL_OFFSET_GEOMETRIC_CONSTRAINT``
	30.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSDGC_WITH_DIMENSION``
	31.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT``
	32.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePGC_WITH_DIMENSION``
	33.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARALLEL_GEOMETRIC_CONSTRAINT``
	34.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePDGC_WITH_DIMENSION``
	35.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT``
	36.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRGC_WITH_DIMENSION``
	37.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRADIUS_GEOMETRIC_CONSTRAINT``
	38.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSKEW_LINE_DISTANCE_GEOMETRIC_CONSTRAINT``
	39.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCDGC_WITH_DIMENSION``
	40.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_DISTANCE_GEOMETRIC_CONSTRAINT``
	41.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTANGENT_GEOMETRIC_CONSTRAINT``
	42.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSWEPT_CURVE_SURFACE_GEOMETRIC_CONSTRAINT``
	43.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXPLICIT_GEOMETRIC_CONSTRAINT``
	44.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDEFINED_CONSTRAINT``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXPLICIT_CONSTRAINT/PartialEntity``
*/
  public final class eEXPLICIT_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eEXPLICIT_CONSTRAINT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eEXPLICIT_CONSTRAINT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eEXPLICIT_CONSTRAINT.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXPLICIT_CONSTRAINT`` )
    ...
    public var CONSTRAINED_ELEMENTS: SDAI.SET<eREPRESENTATION_ITEM.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = self.partialEntity._constrained_elements
    ...
    public var REFERENCE_ELEMENTS: SDAI.SET<eREPRESENTATION_ITEM.PRef>/*[0:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = self.partialEntity._reference_elements
        let value = SDAI.UNWRAP( SDAI.SET<eREPRESENTATION_ITEM.PRef>( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eEXPLICIT_CONSTRAINT.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eEXPLICIT_CONSTRAINT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXPLICIT_CONSTRAINT``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _constrained_elements: SDAI.SET<eREPRESENTATION_ITEM.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  // PLAIN EXPLICIT ATTRIBUTE

      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _reference_elements: SDAI.SET<eREPRESENTATION_ITEM.PRef>/*[0:(nil as SDAI.INTEGER?)]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public static func WHERE_wr1(SELF: eEXPLICIT_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>? */ = SELF.CONSTRAINED_ELEMENTS * SELF.REFERENCE_ELEMENTS
      ...
      public init(
        DESCRIPTION: tTEXT? , 
        CONSTRAINED_ELEMENTS: SDAI.SET<eREPRESENTATION_ITEM.PRef>/*[1:(nil as SDAI.INTEGER?)]*/ , 
        REFERENCE_ELEMENTS: SDAI.SET<eREPRESENTATION_ITEM.PRef>/*[0:(nil as SDAI.INTEGER?)]*/ 
      ) {

        self._description = DESCRIPTION
        self._constrained_elements = 
        SDAI.SET<eREPRESENTATION_ITEM.PRef>(
          from: CONSTRAINED_ELEMENTS.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
        self._reference_elements = 
        SDAI.SET<eREPRESENTATION_ITEM.PRef>(
          from: REFERENCE_ELEMENTS.asSwiftType, 
          bound1:SDAI.UNWRAP(0), bound2:(nil as SDAI.INTEGER?))
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( DESCRIPTION: original._description, CONSTRAINED_ELEMENTS: original._constrained_elements, REFERENCE_ELEMENTS: original._reference_elements )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [1]CONSTRAINED_ELEMENTS for partial entity(\(Self.entityName)) constructor"); return nil }
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [2]REFERENCE_ELEMENTS for partial entity(\(Self.entityName)) constructor"); return nil }
