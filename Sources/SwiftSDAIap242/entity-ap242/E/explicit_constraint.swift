/* file: explicit_constraint.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eEXPLICIT_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eEXPLICIT_CONSTRAINT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _constrained_elements: SDAI.SET<eREPRESENTATION_ITEM.PRef>/*[1:nil]*/  // PLAIN EXPLICIT ATTRIBUTE

      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _reference_elements: SDAI.SET<eREPRESENTATION_ITEM.PRef>/*[0:nil]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(
        DESCRIPTION: tTEXT? , 
        CONSTRAINED_ELEMENTS: SDAI.SET<eREPRESENTATION_ITEM.PRef>/*[1:nil]*/ , 
        REFERENCE_ELEMENTS: SDAI.SET<eREPRESENTATION_ITEM.PRef>/*[0:nil]*/ 
      ) {
