/* file: entirely_narrow_surface.swift 	 generated: Tue Jan 20 19:20:51 2026 */
...
*/
  public final class eENTIRELY_NARROW_SURFACE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var WIDTH_TOLERANCE: tLENGTH_MEASURE {
      get {
        return SDAI.UNWRAP( self.partialEntity._width_tolerance )
      }
      set(newValue) {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eENTIRELY_NARROW_SURFACE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eENTIRELY_NARROW_SURFACE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eENTIRELY_NARROW_SURFACE.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eENTIRELY_NARROW_SURFACE.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
