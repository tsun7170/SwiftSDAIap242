/* file: entirely_narrow_surface.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- entirely_narrow_surface (line:13896 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _entirely_narrow_surface : SDAI.PartialEntity {
...
```
*/
  public final class eENTIRELY_NARROW_SURFACE : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eENTIRELY_NARROW_SURFACE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "ENTIRELY_NARROW_SURFACE", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "WIDTH_TOLERANCE", keyPath: \eENTIRELY_NARROW_SURFACE.WIDTH_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eENTIRELY_NARROW_SURFACE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eENTIRELY_NARROW_SURFACE.NAME, 
