/* file: entirely_narrow_surface.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- entirely_narrow_surface (line:13903 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(7)	nearly_degenerate_geometry
    (no local attributes)

  ENTITY(SELF)	entirely_narrow_surface
...
- SUPERTYPES:
	...
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNEARLY_DEGENERATE_GEOMETRY``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eENTIRELY_NARROW_SURFACE/PartialEntity``
*/
  public final class eENTIRELY_NARROW_SURFACE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eENTIRELY_NARROW_SURFACE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eENTIRELY_NARROW_SURFACE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eENTIRELY_NARROW_SURFACE.PartialEntity
    ...
    public let super_eNEARLY_DEGENERATE_GEOMETRY: eNEARLY_DEGENERATE_GEOMETRY 	// [7]
    public var super_eENTIRELY_NARROW_SURFACE: eENTIRELY_NARROW_SURFACE { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eENTIRELY_NARROW_SURFACE`` )
    public var WIDTH_TOLERANCE: tLENGTH_MEASURE {
      get {
        let originalValue = self.partialEntity._width_tolerance
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eENTIRELY_NARROW_SURFACE.PartialEntity.self) else { return nil }
      ...
      guard let super7 = complexEntity?.entityReference(eNEARLY_DEGENERATE_GEOMETRY.self) else { return nil }
      self.super_eNEARLY_DEGENERATE_GEOMETRY = super7
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eENTIRELY_NARROW_SURFACE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eENTIRELY_NARROW_SURFACE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eENTIRELY_NARROW_SURFACE.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eENTIRELY_NARROW_SURFACE.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eNEARLY_DEGENERATE_GEOMETRY.self)
      entityDef.add(supertype: eENTIRELY_NARROW_SURFACE.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "WIDTH_TOLERANCE", 
        keyPath: \eENTIRELY_NARROW_SURFACE.WIDTH_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eENTIRELY_NARROW_SURFACE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eENTIRELY_NARROW_SURFACE.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eENTIRELY_NARROW_SURFACE``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eENTIRELY_NARROW_SURFACE.self
      }
      ...
      public internal(set) var _width_tolerance: tLENGTH_MEASURE // PLAIN EXPLICIT ATTRIBUTE
      ...
      public override func hashAsValue(into hasher: inout Hasher, visited complexEntities: inout Set<SDAI.ComplexEntity>) {
        ...
        self._width_tolerance.value.hashAsValue(into: &hasher, visited: &complexEntities)
      }

      public override func isValueEqual(to rhs: SDAI.PartialEntity, visited comppairs: inout Set<SDAI.ComplexPair>) -> Bool {
        guard let rhs = rhs as? Self else { return false }
        if !super.isValueEqual(to: rhs, visited: &comppairs) { return false }
        if let comp = self._width_tolerance.value.isValueEqualOptionally(to: rhs._width_tolerance.value, visited: &comppairs)	{
      ...
      public static func WHERE_wr1(SELF: eENTIRELY_NARROW_SURFACE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eENTIRELY_NARROW_SURFACE.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOOLEAN_VALUE") )
        return _TEMP1
      }
      public static func WHERE_wr2(SELF: eENTIRELY_NARROW_SURFACE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
            SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOUNDED_SURFACE")) ] 
      ...
      public static func WHERE_wr3(SELF: eENTIRELY_NARROW_SURFACE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr4(SELF: eENTIRELY_NARROW_SURFACE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public init(WIDTH_TOLERANCE: tLENGTH_MEASURE) {
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( WIDTH_TOLERANCE: original._width_tolerance )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]WIDTH_TOLERANCE for partial entity(\(Self.entityName)) constructor"); return nil }

        self.init( WIDTH_TOLERANCE: p0 )
      }
    }
  }
}
