/* file: extent.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _extent : SDAI.PartialEntity, SDAI.InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_extent``
*/
  public final class eEXTENT : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public let partialEntity: _extent
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_extent.self) else { return nil }
