/* file: multiply_defined_geometry.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- multiply_defined_geometry (line:21996 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	multiply_defined_geometry
    (no local attributes)

  SUB- ENTITY(8)	multiply_defined_placements
  ...
  SUB- ENTITY(9)	multiply_defined_directions
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(10)	multiply_defined_cartesian_points
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(11)	multiply_defined_surfaces
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(12)	multiply_defined_curves
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTIPLY_DEFINED_PLACEMENTS``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTIPLY_DEFINED_DIRECTIONS``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTIPLY_DEFINED_CARTESIAN_POINTS``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTIPLY_DEFINED_SURFACES``
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTIPLY_DEFINED_CURVES``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTIPLY_DEFINED_GEOMETRY/PartialEntity``
*/
  public final class eMULTIPLY_DEFINED_GEOMETRY : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eMULTIPLY_DEFINED_GEOMETRY>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eMULTIPLY_DEFINED_GEOMETRY.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eMULTIPLY_DEFINED_GEOMETRY.PartialEntity
    ...
    public var super_eMULTIPLY_DEFINED_GEOMETRY: eMULTIPLY_DEFINED_GEOMETRY { return self } 	// [7]

    //MARK: SUBTYPES
    public var sub_eMULTIPLY_DEFINED_PLACEMENTS: eMULTIPLY_DEFINED_PLACEMENTS? {	// [8]
      return self.complexEntity.entityReference(eMULTIPLY_DEFINED_PLACEMENTS.self)
    }

    public var sub_eMULTIPLY_DEFINED_DIRECTIONS: eMULTIPLY_DEFINED_DIRECTIONS? {	// [9]
      return self.complexEntity.entityReference(eMULTIPLY_DEFINED_DIRECTIONS.self)
    }

    public var sub_eMULTIPLY_DEFINED_CARTESIAN_POINTS: eMULTIPLY_DEFINED_CARTESIAN_POINTS? {	// [10]
      return self.complexEntity.entityReference(eMULTIPLY_DEFINED_CARTESIAN_POINTS.self)
    }

    public var sub_eMULTIPLY_DEFINED_SURFACES: eMULTIPLY_DEFINED_SURFACES? {	// [11]
      return self.complexEntity.entityReference(eMULTIPLY_DEFINED_SURFACES.self)
    }

    public var sub_eMULTIPLY_DEFINED_CURVES: eMULTIPLY_DEFINED_CURVES? {	// [12]
    ...
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTIPLY_DEFINED_PLACEMENTS`` )
    public var ASSESSMENT_SPECIFICATION_2: eSHAPE_DATA_QUALITY_ASSESSMENT_BY_NUMERICAL_TEST.PRef?  {
      get {
        let originalValue = sub_eMULTIPLY_DEFINED_PLACEMENTS?.partialEntity._assessment_specification_2
        let value = eSHAPE_DATA_QUALITY_ASSESSMENT_BY_NUMERICAL_TEST.PRef( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eMULTIPLY_DEFINED_PLACEMENTS?.partialEntity
          else { return }
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eMULTIPLY_DEFINED_GEOMETRY.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "MULTIPLY_DEFINED_GEOMETRY", 
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION_2", 
        keyPath: \eMULTIPLY_DEFINED_GEOMETRY.ASSESSMENT_SPECIFICATION_2, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eMULTIPLY_DEFINED_GEOMETRY.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eMULTIPLY_DEFINED_GEOMETRY.NAME, 
