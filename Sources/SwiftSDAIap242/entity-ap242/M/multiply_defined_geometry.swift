/* file: multiply_defined_geometry.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- multiply_defined_geometry (line:21801 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _multiply_defined_geometry : SDAI.PartialEntity {
...
```
*/
  public final class eMULTIPLY_DEFINED_GEOMETRY : SDAI.EntityReference {
    ...
    /// - origin: SUB( ``eMULTIPLY_DEFINED_PLACEMENTS`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "MULTIPLY_DEFINED_GEOMETRY", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION_2", keyPath: \eMULTIPLY_DEFINED_GEOMETRY.ASSESSMENT_SPECIFICATION_2, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eMULTIPLY_DEFINED_GEOMETRY.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eMULTIPLY_DEFINED_GEOMETRY.NAME, 
