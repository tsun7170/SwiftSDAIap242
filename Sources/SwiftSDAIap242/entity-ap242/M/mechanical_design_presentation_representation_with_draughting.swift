/* file: mechanical_design_presentation_representation_with_draughting.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var ITEMS: SDAI.SET<eCAMERA_MODEL_D3.PRef>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eCAMERA_MODEL_D3.PRef>( super_eREPRESENTATION.partialEntity._items ) )
      }
      set(newValue) {
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _items: SDAI.SET<eCAMERA_MODEL_D3.PRef>[1:nil] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
