/* file: mechanical_design_presentation_representation_with_draughting.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _mechanical_design_presentation_representation_with_draughting : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _items: SDAI.SET<eCAMERA_MODEL_D3>[1:nil] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
...
```
*/
  public final class eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var ITEMS: SDAI.SET<eCAMERA_MODEL_D3>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eCAMERA_MODEL_D3>( super_eREPRESENTATION.partialEntity._items ) )
      }
      set(newValue) {
