/* file: mechanical_design_presentation_representation_with_draughting.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- mechanical_design_presentation_representation_with_draughting (line:20994 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	mechanical_design_presentation_representation_with_draughting
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING/PartialEntity``
*/
  public final class eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING.PartialEntity

    //MARK: SUPERTYPES
    public let super_eREPRESENTATION: eREPRESENTATION 	// [1]
    public var super_eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING: eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING { return self } 	// [2]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING`` )
    public var ITEMS: SDAI.SET<eCAMERA_MODEL_D3.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = super_eREPRESENTATION.partialEntity._items
        let SELF = super_eREPRESENTATION; SDAI.TOUCH(let:SELF)
        let value =         SDAI.SET<eCAMERA_MODEL_D3.PRef>(
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "MECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING", 
        type: self, explicitAttributeCount: 0)

      //MARK: SUPERTYPE REGISTRATIONS
      entityDef.add(supertype: eREPRESENTATION.self)
      entityDef.add(supertype: eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING.self
      }

      //ATTRIBUTES
      /* override var _items: SDAI.SET<eCAMERA_MODEL_D3.PRef>[1:(nil as SDAI.INTEGER?)] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
