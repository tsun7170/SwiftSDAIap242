/* file: mechanical_design_presentation_representation_with_draughting.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- mechanical_design_presentation_representation_with_draughting (line:20813 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "MECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eMECHANICAL_DESIGN_PRESENTATION_REPRESENTATION_WITH_DRAUGHTING.NAME, 
