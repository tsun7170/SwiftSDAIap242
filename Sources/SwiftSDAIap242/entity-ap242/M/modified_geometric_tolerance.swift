/* file: modified_geometric_tolerance.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- modified_geometric_tolerance (line:21570 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _modified_geometric_tolerance : SDAI.PartialEntity {
...
```
*/
  public final class eMODIFIED_GEOMETRIC_TOLERANCE : SDAI.EntityReference {
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``eMODIFIED_GEOMETRIC_TOLERANCE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "MODIFIED_GEOMETRIC_TOLERANCE", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eMODIFIED_GEOMETRIC_TOLERANCE.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "TOLERANCE_RELATIONSHIP", keyPath: \eMODIFIED_GEOMETRIC_TOLERANCE.TOLERANCE_RELATIONSHIP, 
        kind: .inverse, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "AUXILIARY_CLASSIFICATION", keyPath: \eMODIFIED_GEOMETRIC_TOLERANCE.AUXILIARY_CLASSIFICATION, 
        kind: .inverse, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "MODIFIER", keyPath: \eMODIFIED_GEOMETRIC_TOLERANCE.MODIFIER, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MAGNITUDE", keyPath: \eMODIFIED_GEOMETRIC_TOLERANCE.MAGNITUDE, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eMODIFIED_GEOMETRIC_TOLERANCE.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTROLLING_SHAPE", keyPath: \eMODIFIED_GEOMETRIC_TOLERANCE.CONTROLLING_SHAPE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eMODIFIED_GEOMETRIC_TOLERANCE.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "TOLERANCED_SHAPE_ASPECT", keyPath: \eMODIFIED_GEOMETRIC_TOLERANCE.TOLERANCED_SHAPE_ASPECT, 
