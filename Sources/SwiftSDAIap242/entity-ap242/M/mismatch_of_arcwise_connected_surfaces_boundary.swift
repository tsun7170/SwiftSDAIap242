/* file: mismatch_of_arcwise_connected_surfaces_boundary.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- mismatch_of_arcwise_connected_surfaces_boundary (line:21397 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "MISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ACCURACY_TYPES", keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.ACCURACY_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.DETECTED_DIFFERENCE_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.COMPARED_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.MEASURED_DATA_TYPE, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.COMPARING_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "APPLIED_VALUES", keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.APPLIED_VALUES, 
