/* file: mismatch_of_arcwise_connected_surfaces_boundary.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _mismatch_of_arcwise_connected_surfaces_boundary : SDAI.PartialEntity
    ...
    internal func _detected_difference_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.PRef) -> 
      ...
      let _TEMP1 /* SDAI.AGGREGATE<nA3M_DETECTED_DIFFERENCE_TYPE_NAME> */ = SDAI.LIST<
        nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(2)), bound2: SDAI.INTEGER(2),  ([ 
          ...
          SDAI.AIE(nA3MS_DETECTED_DIFFERENCE_TYPE_NAME(/*nA3M_DETECTED_DIFFERENCE_TYPE_NAME*/
          DDNS_POINT_ON_CURVE)) ] as [SDAI.AggregationInitializerElement<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>]) )
      let value = _TEMP1
      return SDAI.UNWRAP( value )
    }
    ...
    public static func WHERE_wr2(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP3 /* SDAI.SET<eMEASURE_REPRESENTATION_ITEM.PRef>[1:nil] ? */ = _TEMP2?.APPLIED_VALUES
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_mismatch_of_arcwise_connected_surfaces_boundary``
*/
  public final class eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _mismatch_of_arcwise_connected_surfaces_boundary.self
    }
    /// partial entity reference
    public let partialEntity: _mismatch_of_arcwise_connected_surfaces_boundary
    ...
    public var ASSESSMENT_SPECIFICATION: eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST.PRef {
      get {
        return SDAI.UNWRAP( eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST.PRef( super_eA3M_EQUIVALENCE_CRITERION
      ...
      set(newValue) {
        ...
        partial._assessment_specification = SDAI.UNWRAP(
          sA3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT(fromGeneric: newValue))
      }
    }
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_mismatch_of_arcwise_connected_surfaces_boundary.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _mismatch_of_arcwise_connected_surfaces_boundary.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _mismatch_of_arcwise_connected_surfaces_boundary.WHERE_wr2(SELF: instance.pRef)
      return result
    }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF._mismatch_of_arcwise_connected_surfaces_boundary :
