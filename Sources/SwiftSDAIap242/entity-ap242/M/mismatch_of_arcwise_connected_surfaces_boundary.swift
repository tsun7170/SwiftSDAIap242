/* file: mismatch_of_arcwise_connected_surfaces_boundary.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  ENTITY mismatch_of_arcwise_connected_surfaces_boundary
    ...
    DERIVE
      SELF\a3m_equivalence_criterion.comparing_element_types : LIST [1 : 1] OF a3ms_element_type_name := [
      ...
      SELF\a3m_equivalence_criterion.detected_difference_types : LIST [2 : 2] OF
                                          a3ms_detected_difference_type_name := [ddns_cartesian_point, 
                                          ddns_point_on_curve];
  ...
  END_ENTITY; -- mismatch_of_arcwise_connected_surfaces_boundary (line:21592 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(6)	a3m_equivalence_criterion_of_detailed_shape_data_content
    (no local attributes)
  ...
  ENTITY(SELF)	mismatch_of_arcwise_connected_surfaces_boundary
...
- SUPERTYPES:
	...
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_SHAPE_DATA_CONTENT``
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY/PartialEntity``
*/
  public final class eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.PartialEntity
    ...
    public let super_eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_SHAPE_DATA_CONTENT: eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_SHAPE_DATA_CONTENT 	// [6]
    ...
    public var super_eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY`` )
    ...
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY`` )
    public var DETECTED_DIFFERENCE_TYPES: SDAI.LIST<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>/*[2:2]*/  {
      get {
        if let cached = cachedValue(derivedAttributeName:"DETECTED_DIFFERENCE_TYPES") {
          return cached.value as! SDAI.LIST<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>/*[2:2]*/ 
        }
        let origin = self
        let value = SDAI.UNWRAP( origin.partialEntity._detected_difference_types__getter(SELF: origin.pRef) )
    ...
    public var COMPARED_ELEMENT_TYPES: SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>/*[1:1]*/  {
      get {
        ...
        let origin = self
        let value = SDAI.UNWRAP( origin.partialEntity._compared_element_types__getter(SELF: origin.pRef) )
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY`` )
    public var ASSESSMENT_SPECIFICATION: eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST.PRef {
      get {
        let originalValue = super_eA3M_EQUIVALENCE_CRITERION.partialEntity._assessment_specification
        let value = SDAI.UNWRAP( eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST.PRef( originalValue ) )
        return value
      }
      set(newValue) {
        let partial = super_eA3M_EQUIVALENCE_CRITERION.partialEntity
        partial._assessment_specification = SDAI.UNWRAP(sA3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT(fromGeneric: newValue))
      }
    }
    ...
    public var COMPARING_ELEMENT_TYPES: SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>/*[1:1]*/  {
      get {
        ...
        let origin = self
        let value = SDAI.UNWRAP( origin.partialEntity._comparing_element_types__getter(SELF: origin.pRef) )
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES`` )
    public var APPLIED_VALUES: SDAI.SET<eMEASURE_REPRESENTATION_ITEM.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = super_eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES.partialEntity
          ._applied_values
        let value = SDAI.UNWRAP( SDAI.SET<eMEASURE_REPRESENTATION_ITEM.PRef>( originalValue ) )
        return value
      }
      set(newValue) {
        let partial = super_eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES.partialEntity
        let SELF = super_eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES; SDAI.TOUCH(let:SELF)
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.PartialEntity.self) else { return nil }
      ...
      guard let super6 = complexEntity?.entityReference(eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_SHAPE_DATA_CONTENT.self) else { return nil }
      self.super_eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_SHAPE_DATA_CONTENT = super6
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "MISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY", 
      ...
      entityDef.add(supertype: eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_SHAPE_DATA_CONTENT.self)
      entityDef.add(supertype: eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES.self)
      entityDef.add(supertype: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ACCURACY_TYPES", 
        keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.ACCURACY_TYPES, 
      ...
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", 
        keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.DETECTED_DIFFERENCE_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", 
        keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.COMPARED_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", 
        keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.MEASURED_DATA_TYPE, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", 
        keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.COMPARING_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "APPLIED_VALUES", 
        keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.APPLIED_VALUES, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.self
      }

      //ATTRIBUTES
      /* override var _assessment_specification: eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST.PRef	//EXPLICIT REDEFINITION(eA3M_EQUIVALENCE_CRITERION) */
      ...
      internal func _comparing_element_types__getter(complex: SDAI.ComplexEntity) -> SDAI.LIST<
        nA3M_ELEMENT_TYPE_NAME>/*[1:(nil as SDAI.INTEGER?)]*/  {
        let SELF = complex.entityReference( eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.self )!
        return SDAI.UNWRAP( SDAI.LIST<nA3M_ELEMENT_TYPE_NAME>(SELF.COMPARING_ELEMENT_TYPES) )
      }
      /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _comparing_element_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.PRef) -> 
        SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>/*[1:1]*/  {

        let _TEMP1 /* SDAI.AGGREGATE<nA3M_ELEMENT_TYPE_NAME> */ = SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>(
          bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: SDAI.INTEGER(1),  ([ 
            SDAI.AIE(nA3MS_ELEMENT_TYPE_NAME(/*nA3M_ELEMENT_TYPE_NAME*/ETNS_CONNECTED_FACE_SET)) ] 
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _compared_element_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.PRef) -> 
        SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>/*[1:1]*/  {
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _measured_data_type__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.PRef) -> 
        nA3MS_MEASURED_DATA_TYPE_NAME {
        let value = nA3MS_MEASURED_DATA_TYPE_NAME(/*nA3M_MEASURED_DATA_TYPE_NAME*/MDNS_LENGTH_MEASURE)
        return SDAI.UNWRAP( value )
      }
      ...
      internal func _detected_difference_types__getter(complex: SDAI.ComplexEntity) -> SDAI.LIST<
        nA3M_DETECTED_DIFFERENCE_TYPE_NAME>/*[0:(nil as SDAI.INTEGER?)]*/  {
        let SELF = complex.entityReference( eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.self )!
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _detected_difference_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.PRef) -> 
        SDAI.LIST<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>/*[2:2]*/  {

        let _TEMP1 /* SDAI.AGGREGATE<nA3M_DETECTED_DIFFERENCE_TYPE_NAME> */ = SDAI.LIST<
          nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(2)), bound2: SDAI.INTEGER(2),  ([ 
            SDAI.AIE(nA3MS_DETECTED_DIFFERENCE_TYPE_NAME(/*nA3M_DETECTED_DIFFERENCE_TYPE_NAME*/
            DDNS_CARTESIAN_POINT)), 
            SDAI.AIE(nA3MS_DETECTED_DIFFERENCE_TYPE_NAME(/*nA3M_DETECTED_DIFFERENCE_TYPE_NAME*/
            DDNS_POINT_ON_CURVE)) ] as [SDAI.AggregationInitializerElement<
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _accuracy_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.PRef) -> 
        SDAI.LIST<nA3MS_ACCURACY_TYPE_NAME>/*[1:1]*/  {

        let _TEMP1 /* SDAI.AGGREGATE<nA3M_ACCURACY_TYPE_NAME> */ = SDAI.LIST<nA3MS_ACCURACY_TYPE_NAME>(
          bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: SDAI.INTEGER(1),  ([ 
            SDAI.AIE(nA3MS_ACCURACY_TYPE_NAME(/*nA3M_ACCURACY_TYPE_NAME*/ATNS_LENGTH_MEASURE)) ] 
      ...
      public static func WHERE_wr1(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( (((SELF.GROUP_REF(eA3M_EQUIVALENCE_CRITERION.self))?.ASSESSMENT_SPECIFICATION)?
          .GROUP_REF(eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST.self))?.THRESHOLD, 
          IS: eSHAPE_DATA_QUALITY_LOWER_VALUE_LIMIT.self )
        let _TEMP2 /* eA3M_EQUIVALENCE_CRITERION.PRef? */ = SELF.GROUP_REF(eA3M_EQUIVALENCE_CRITERION.self)
        let _TEMP3 /* sA3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT? */ = _TEMP2?.ASSESSMENT_SPECIFICATION
        let _TEMP4 /* eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST.PRef? */ = _TEMP3?.GROUP_REF(
          eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST.self)
        let _TEMP5 /* sSHAPE_DATA_QUALITY_VALUE_LIMIT_TYPE_SELECT? */ = _TEMP4?.THRESHOLD
        let _TEMP6 /* nA3MS_MEASURED_DATA_TYPE_NAME? */ = A3MS_GET_VALUE_LIMIT_TYPE( 
            _TEMP5 )
        let _TEMP7 /* nA3MS_MEASURED_DATA_TYPE_NAME? */ = SELF.MEASURED_DATA_TYPE
        let _TEMP8 /* SDAI.LOGICAL */ = _TEMP6 .==. _TEMP7
        let _TEMP9 /* SDAI.LOGICAL */ = _TEMP1 && _TEMP8
        return _TEMP9
      }
      public static func WHERE_wr2(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( (SELF.GROUP_REF(
          eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES.self))?.APPLIED_VALUES?[1], 
          IS: eLENGTH_MEASURE_WITH_UNIT.self )
        let _TEMP2 /* eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES.PRef? */ = SELF.GROUP_REF(
          eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES.self)
        let _TEMP3 /* SDAI.SET<eMEASURE_REPRESENTATION_ITEM.PRef>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP2?.APPLIED_VALUES
        let _TEMP4 /* eMEASURE_REPRESENTATION_ITEM.PRef? */ = _TEMP3?[1]
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
  .eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.PartialEntity :
