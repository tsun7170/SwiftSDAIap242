/* file: mismatch_of_arcwise_connected_surfaces_boundary.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _mismatch_of_arcwise_connected_surfaces_boundary : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _comparing_element_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY) -> 
      ...
      let _TEMP1 = SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: SDAI.INTEGER(
        1), ([SDAI.AIE(nA3MS_ELEMENT_TYPE_NAME(/*nA3M_ELEMENT_TYPE_NAME*/ETNS_CONNECTED_FACE_SET))] 
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _compared_element_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY) -> 
      SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>/*[1:1]*/  {
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _measured_data_type__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY) -> 
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _detected_difference_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY) -> 
      SDAI.LIST<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>/*[2:2]*/  {

      let _TEMP1 = SDAI.LIST<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(2)), 
        bound2: SDAI.INTEGER(2), ([SDAI.AIE(nA3MS_DETECTED_DIFFERENCE_TYPE_NAME(/*
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _accuracy_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY) -> SDAI.LIST<
      ...
      let _TEMP1 = SDAI.LIST<nA3MS_ACCURACY_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: SDAI.INTEGER(
        1), ([SDAI.AIE(nA3MS_ACCURACY_TYPE_NAME(/*nA3M_ACCURACY_TYPE_NAME*/ATNS_LENGTH_MEASURE))] 
    ...
    public static func WHERE_wr1(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP6 = _TEMP5 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("discretization_distance_tolerance"))
...
```
*/
  public final class eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _mismatch_of_arcwise_connected_surfaces_boundary.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _mismatch_of_arcwise_connected_surfaces_boundary.WHERE_wr2(SELF: instance)
      return result
    }
