/* file: mismatch_of_arcwise_connected_surfaces_boundary.swift 	 generated: Thu Mar  5 17:54:18 2026 */
    ...
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      internal func _comparing_element_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.PRef) -> 
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_ELEMENT_TYPE_NAME> */ = SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>(
          bound1:SDAI.UNWRAP(1), bound2:1,  ([ SDAI.AIE(nA3MS_ELEMENT_TYPE_NAME(/*nA3M_ELEMENT_TYPE_NAME*/
            ETNS_CONNECTED_FACE_SET)) ] as [SDAI.AggregationInitializerElement<nA3MS_ELEMENT_TYPE_NAME>]) )
        let value = _TEMP1
      ...
      internal func _detected_difference_types__getter(complex: SDAI.ComplexEntity) -> SDAI.LIST<
        nA3M_DETECTED_DIFFERENCE_TYPE_NAME>/*[0:?]*/  {
        let SELF = complex.entityReference( eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.self )!
      ...
      internal func _accuracy_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.PRef) -> 
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_ACCURACY_TYPE_NAME> */ = SDAI.LIST<nA3MS_ACCURACY_TYPE_NAME>(
          bound1:SDAI.UNWRAP(1), bound2:1,  ([ SDAI.AIE(nA3MS_ACCURACY_TYPE_NAME(/*nA3M_ACCURACY_TYPE_NAME*/
            ATNS_LENGTH_MEASURE)) ] as [SDAI.AggregationInitializerElement<nA3MS_ACCURACY_TYPE_NAME>]) )
        let value = _TEMP1
        return SDAI.UNWRAP( value )
      }
      ...
      public static func WHERE_wr2(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP3 /* SDAI.SET<eMEASURE_REPRESENTATION_ITEM.PRef>[1:?] ? */ = _TEMP2?.APPLIED_VALUES
