/* file: missing_assembly_constraint.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _missing_assembly_constraint : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _measured_data_type__getter(SELF: eMISSING_ASSEMBLY_CONSTRAINT) -> 
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _detected_difference_types__getter(SELF: eMISSING_ASSEMBLY_CONSTRAINT) -> SDAI.LIST<
      nA3MA_DETECTED_DIFFERENCE_TYPE_NAME>/*[2:2]*/  {

      let _TEMP1 = SDAI.LIST<nA3MA_DETECTED_DIFFERENCE_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(2)), 
        bound2: SDAI.INTEGER(2), ([SDAI.AIE(nA3MA_DETECTED_DIFFERENCE_TYPE_NAME(/*
        nA3M_DETECTED_DIFFERENCE_TYPE_NAME*/DDNA_NO_ELEMENT)), 
...
```
*/
  public final class eMISSING_ASSEMBLY_CONSTRAINT : SDAI.EntityReference, @unchecked Sendable {
