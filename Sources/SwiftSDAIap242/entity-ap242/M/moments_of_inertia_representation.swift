/* file: moments_of_inertia_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _moments_of_inertia_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eMOMENTS_OF_INERTIA_REPRESENTATION?) -> SDAI.LOGICAL {
      ...
      let _TEMP5 = _TEMP4.QUERY{ I in 
          ...
          let _TEMP1 = SDAI.TYPEOF(I, IS: eCOMPOUND_REPRESENTATION_ITEM.self)
          let _TEMP2 = I.NAME
    ...
    public static func WHERE_wr2(SELF: eMOMENTS_OF_INERTIA_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP2 = _TEMP1.QUERY{ I in 
          ...
          let _TEMP1 = SDAI.TYPEOF(I, IS: eCOMPOUND_REPRESENTATION_ITEM.self)
          let _TEMP2 = SDAI.TYPEOF(I.GROUP_REF(eCOMPOUND_REPRESENTATION_ITEM.self)?.ITEM_ELEMENT, 
            IS: tLIST_REPRESENTATION_ITEM.self)
          let _TEMP3 = _TEMP1 && _TEMP2
          let _TEMP4 = I.GROUP_REF(eCOMPOUND_REPRESENTATION_ITEM.self)
          let _TEMP5 = _TEMP4?.ITEM_ELEMENT
          let _TEMP6 = VALUE_RANGE_AGGREGATE_REP_ITEM(SDAI.AGGREGATE<eREPRESENTATION_ITEM>(/*
            sCOMPOUND_ITEM_DEFINITION*/_TEMP5))
...
```
*/
  public final class eMOMENTS_OF_INERTIA_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _moments_of_inertia_representation.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _moments_of_inertia_representation.WHERE_wr2(SELF: instance)
      return result
    }
