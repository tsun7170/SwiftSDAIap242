/* file: missing_face.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _missing_face : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _compared_element_types__getter(SELF: eMISSING_FACE) -> SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>
      /*[1:1]*/  {
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _measured_data_type__getter(SELF: eMISSING_FACE) -> nA3MS_MEASURED_DATA_TYPE_NAME {
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _detected_difference_types__getter(SELF: eMISSING_FACE) -> SDAI.LIST<
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _accuracy_types__getter(SELF: eMISSING_FACE) -> SDAI.LIST<nA3MS_ACCURACY_TYPE_NAME>/*[0:0]*/  {
...
```
*/
  public final class eMISSING_FACE : SDAI.EntityReference, @unchecked Sendable {
