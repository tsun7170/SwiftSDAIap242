/* file: mismatch_of_point_cloud_and_related_geometry.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _mismatch_of_point_cloud_and_related_geometry : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _comparing_element_types__getter(SELF: eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY) -> 
      SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>/*[2:2]*/  {

      let _TEMP1 = SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(2)), bound2: SDAI.INTEGER(
        2), ([SDAI.AIE(nA3MS_ELEMENT_TYPE_NAME(/*nA3M_ELEMENT_TYPE_NAME*/ETNS_CONNECTED_EDGE_SET)), 
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _compared_element_types__getter(SELF: eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY) -> 
      ...
      let _TEMP1 = SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: SDAI.INTEGER(
        1), ([SDAI.AIE(nA3MS_ELEMENT_TYPE_NAME(/*nA3M_ELEMENT_TYPE_NAME*/ETNS_POINT_CLOUD_DATASET))] 
        as [SDAI.AggregationInitializerElement<nA3MS_ELEMENT_TYPE_NAME>]))
      let value = _TEMP1
      return SDAI.UNWRAP( value )
    }
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _measured_data_type__getter(SELF: eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY) -> 
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _detected_difference_types__getter(SELF: eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY) -> 
      SDAI.LIST<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>/*[3:3]*/  {

      let _TEMP1 = SDAI.LIST<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(3)), 
        bound2: SDAI.INTEGER(3), ([SDAI.AIE(nA3MS_DETECTED_DIFFERENCE_TYPE_NAME(/*
        ...
        DDNS_POINT_ON_CURVE)), SDAI.AIE(nA3MS_DETECTED_DIFFERENCE_TYPE_NAME(/*
        nA3M_DETECTED_DIFFERENCE_TYPE_NAME*/DDNS_POINT_ON_SURFACE))] as [SDAI.AggregationInitializerElement<
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _accuracy_types__getter(SELF: eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY) -> SDAI.LIST<
    ...
    public static func WHERE_wr1(SELF: eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY?) -> SDAI.LOGICAL {
...
```
*/
  public final class eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _mismatch_of_point_cloud_and_related_geometry.WHERE_wr1(SELF: instance)
      return result
    }
