/* file: mismatch_of_point_cloud_and_related_geometry.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  ENTITY mismatch_of_point_cloud_and_related_geometry
    ...
    DERIVE
      ...
      SELF\a3m_equivalence_criterion.detected_difference_types : LIST [3 : 3] OF
                                          a3ms_detected_difference_type_name := [ddns_cartesian_point, 
                                          ddns_point_on_curve, ddns_point_on_surface];
  ...
  END_ENTITY; -- mismatch_of_point_cloud_and_related_geometry (line:21644 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	mismatch_of_point_cloud_and_related_geometry
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY/PartialEntity``
*/
  public final class eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.PartialEntity
    ...
    public var super_eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY: eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY { return self } 	// [7]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY`` )
    ...
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY`` )
    public var DETECTED_DIFFERENCE_TYPES: SDAI.LIST<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>/*[3:3]*/  {
      get {
        if let cached = cachedValue(derivedAttributeName:"DETECTED_DIFFERENCE_TYPES") {
          return cached.value as! SDAI.LIST<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>/*[3:3]*/ 
        }
        let origin = self
    ...
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY`` )
    public var COMPARING_ELEMENT_TYPES: SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>/*[2:2]*/  {
      get {
        if let cached = cachedValue(derivedAttributeName:"COMPARING_ELEMENT_TYPES") {
          return cached.value as! SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>/*[2:2]*/ 
        }
        let origin = self
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "MISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY", 
      ...
      entityDef.add(supertype: eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ACCURACY_TYPES", 
        keyPath: \eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.ACCURACY_TYPES, 
      ...
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", 
        keyPath: \eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.DETECTED_DIFFERENCE_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", 
        keyPath: \eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.COMPARED_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", 
        keyPath: \eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.MEASURED_DATA_TYPE, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", 
        keyPath: \eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.COMPARING_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.self
      }
      ...
      internal func _comparing_element_types__getter(complex: SDAI.ComplexEntity) -> SDAI.LIST<
        ...
        let SELF = complex.entityReference( eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.self )!
        return SDAI.UNWRAP( SDAI.LIST<nA3M_ELEMENT_TYPE_NAME>(SELF.COMPARING_ELEMENT_TYPES) )
      }
      /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _comparing_element_types__getter(SELF: eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.PRef) -> 
        SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>/*[2:2]*/  {
        //
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _compared_element_types__getter(SELF: eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.PRef) -> 
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_ELEMENT_TYPE_NAME> */ = SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>(
          bound1:SDAI.UNWRAP(1), bound2:1,  ([ SDAI.AIE(nA3MS_ELEMENT_TYPE_NAME(/*nA3M_ELEMENT_TYPE_NAME*/
            ETNS_POINT_CLOUD_DATASET)) ] as [SDAI.AggregationInitializerElement<nA3MS_ELEMENT_TYPE_NAME>]) )
        let value = _TEMP1
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _measured_data_type__getter(SELF: eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.PRef) -> 
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _detected_difference_types__getter(SELF: eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.PRef) -> 
        SDAI.LIST<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>/*[3:3]*/  {
        //
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _accuracy_types__getter(SELF: eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.PRef) -> 
      ...
      public static func WHERE_wr1(SELF: eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.PRef?) -> SDAI.LOGICAL {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
  .eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.PartialEntity :
