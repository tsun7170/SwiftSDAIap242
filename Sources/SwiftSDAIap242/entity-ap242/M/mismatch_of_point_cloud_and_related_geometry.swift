/* file: mismatch_of_point_cloud_and_related_geometry.swift 	 generated: Fri Feb  6 16:23:46 2026 */
    ...
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      internal func _compared_element_types__getter(SELF: eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.PRef) -> 
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_ELEMENT_TYPE_NAME> */ = SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>(
          bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: SDAI.INTEGER(1),  ([ 
            SDAI.AIE(nA3MS_ELEMENT_TYPE_NAME(/*nA3M_ELEMENT_TYPE_NAME*/ETNS_POINT_CLOUD_DATASET)) ] 
            as [SDAI.AggregationInitializerElement<nA3MS_ELEMENT_TYPE_NAME>]) )
        let value = _TEMP1
        return SDAI.UNWRAP( value )
      }
      ...
      internal func _detected_difference_types__getter(SELF: eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.PRef) -> 
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_DETECTED_DIFFERENCE_TYPE_NAME> */ = SDAI.LIST<
          nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(3)), bound2: SDAI.INTEGER(3),  ([ 
