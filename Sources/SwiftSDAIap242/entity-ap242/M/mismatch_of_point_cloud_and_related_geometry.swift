/* file: mismatch_of_point_cloud_and_related_geometry.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- mismatch_of_point_cloud_and_related_geometry (line:21449 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "MISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ACCURACY_TYPES", keyPath: \eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.ACCURACY_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", keyPath: \eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.DETECTED_DIFFERENCE_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", keyPath: \eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.COMPARED_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", keyPath: \eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.MEASURED_DATA_TYPE, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", keyPath: \eMISMATCH_OF_POINT_CLOUD_AND_RELATED_GEOMETRY.COMPARING_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
