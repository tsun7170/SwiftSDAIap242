/* file: mechanical_design_geometric_presentation_area.swift 	 generated: Mon Dec 15 17:41:04 2025 */
...
*/
  ...
  public final class _mechanical_design_geometric_presentation_area : SDAI.PartialEntity, InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_mechanical_design_geometric_presentation_area``
*/
  public final class eMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _mechanical_design_geometric_presentation_area.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _mechanical_design_geometric_presentation_area.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _mechanical_design_geometric_presentation_area.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _mechanical_design_geometric_presentation_area.WHERE_wr4(SELF: instance.pRef)
      return result
    }
