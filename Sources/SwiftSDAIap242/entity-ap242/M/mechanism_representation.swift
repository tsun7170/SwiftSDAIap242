/* file: mechanism_representation.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
  public final class eMECHANISM_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var ITEMS: SDAI.SET<ePAIR_REPRESENTATION_RELATIONSHIP.PRef>/*[1:?]*/  {
      get {
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      /* override var _items: SDAI.SET<ePAIR_REPRESENTATION_RELATIONSHIP.PRef>[1:?] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
      ...
      internal func _represented_joints__getter(SELF: eMECHANISM_REPRESENTATION.PRef) -> (SDAI.SET<
        eKINEMATIC_JOINT.PRef>/*[1:?]*/ )?  {
        //
        let _TEMP1 /* SDAI.SET<eKINEMATIC_JOINT.PRef>? */ = COLLECT_JOINTS( 
            SELF.ITEMS )
        return SDAI.SET<eKINEMATIC_JOINT.PRef>(
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?), /*SDAI.SET<eKINEMATIC_JOINT.PRef>*/_TEMP1)
      }
