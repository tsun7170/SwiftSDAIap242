/* file: mechanism_representation.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- mechanism_representation (line:21479 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMECHANISM_REPRESENTATION/PartialEntity``
*/
  public final class eMECHANISM_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eMECHANISM_REPRESENTATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eMECHANISM_REPRESENTATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eMECHANISM_REPRESENTATION.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMECHANISM_REPRESENTATION`` )
    public var ITEMS: SDAI.SET<ePAIR_REPRESENTATION_RELATIONSHIP.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = super_eREPRESENTATION.partialEntity._items
        let SELF = super_eREPRESENTATION; SDAI.TOUCH(let:SELF)
        let value =         SDAI.SET<ePAIR_REPRESENTATION_RELATIONSHIP.PRef>(
    ...
    public var REPRESENTED_JOINTS: (SDAI.SET<eKINEMATIC_JOINT.PRef>/*[1:(nil as SDAI.INTEGER?)]*/ )?  {
      get {
        ...
        let origin = self
        let value = origin.partialEntity._represented_joints__getter(SELF: origin.pRef)
    ...
    public var REPRESENTED_TOPOLOGY: sKINEMATIC_TOPOLOGY_REPRESENTATION_SELECT {
      get {
        let originalValue = self.partialEntity._represented_topology
        let value = SDAI.UNWRAP( sKINEMATIC_TOPOLOGY_REPRESENTATION_SELECT( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eMECHANISM_REPRESENTATION.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eMECHANISM_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMECHANISM_REPRESENTATION``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      /* override var _items: SDAI.SET<ePAIR_REPRESENTATION_RELATIONSHIP.PRef>[1:(nil as SDAI.INTEGER?)] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
      ...
      /// DERIVE ATTRIBUTE
      @_documentation(visibility:public)
      internal func _represented_joints__getter(SELF: eMECHANISM_REPRESENTATION.PRef) -> (SDAI.SET<
        eKINEMATIC_JOINT.PRef>/*[1:(nil as SDAI.INTEGER?)]*/ )?  {

        let _TEMP1 /* SDAI.SET<eKINEMATIC_JOINT.PRef>? */ = COLLECT_JOINTS( 
            SELF.ITEMS )
        return SDAI.SET<eKINEMATIC_JOINT.PRef>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as SDAI.INTEGER?), 
          /*SDAI.SET<eKINEMATIC_JOINT.PRef>*/_TEMP1)
      }
      ...
      public static func WHERE_wr1(SELF: eMECHANISM_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF.REPRESENTED_TOPOLOGY, 
          IS: eKINEMATIC_TOPOLOGY_STRUCTURE.self )
        let _TEMP2 /* runtime? */ = /*runtime*/SELF.REPRESENTED_TOPOLOGY?.ITEMS
        let _TEMP3 /* SDAI.LOGICAL */ = SELF.REPRESENTED_JOINTS .===. /*runtime*/_TEMP2
        let _TEMP4 /* SDAI.LOGICAL */ = _TEMP1 && _TEMP3
        let _TEMP5 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF.REPRESENTED_TOPOLOGY, 
          IS: eKINEMATIC_TOPOLOGY_DIRECTED_STRUCTURE.self )
        let _TEMP6 /* runtime? */ = /*runtime*/SELF.REPRESENTED_TOPOLOGY?.ITEMS
        let _TEMP7 /* SDAI.SET<eKINEMATIC_JOINT.PRef>? */ = GET_KINEMATIC_JOINTS_FROM_ORIENTED_JOINTS( 
            SDAI.SET<eORIENTED_JOINT.PRef>(/*runtime*/_TEMP6) )
        let _TEMP8 /* SDAI.LOGICAL */ = SELF.REPRESENTED_JOINTS .===. _TEMP7
        let _TEMP9 /* SDAI.LOGICAL */ = _TEMP5 && _TEMP8
        let _TEMP10 /* SDAI.LOGICAL */ = _TEMP4 || _TEMP9
        let _TEMP11 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF.REPRESENTED_TOPOLOGY, 
          IS: eKINEMATIC_TOPOLOGY_NETWORK_STRUCTURE.self )
        let _TEMP12 /* runtime? */ = /*runtime*/SELF.REPRESENTED_TOPOLOGY?.ITEMS
        let _TEMP13 /* SDAI.SET<eKINEMATIC_JOINT.PRef>? */ = GET_KINEMATIC_JOINTS_FROM_KINEMATIC_LOOPS( 
            SDAI.SET<eKINEMATIC_LOOP.PRef>(/*runtime*/_TEMP12) )
        let _TEMP14 /* SDAI.LOGICAL */ = SELF.REPRESENTED_JOINTS .===. _TEMP13
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( REPRESENTED_TOPOLOGY: original._represented_topology )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]REPRESENTED_TOPOLOGY for partial entity(\(Self.entityName)) constructor"); return nil }
