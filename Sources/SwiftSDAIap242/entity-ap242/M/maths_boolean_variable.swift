/* file: maths_boolean_variable.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- maths_boolean_variable (line:20269 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _maths_boolean_variable : SDAI.PartialEntity {
...
```
*/
  public final class eMATHS_BOOLEAN_VARIABLE : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "MATHS_BOOLEAN_VARIABLE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "INTERPRETATION", keyPath: \eMATHS_BOOLEAN_VARIABLE.INTERPRETATION, 
        kind: .inverse, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "VALUES_SPACE", keyPath: \eMATHS_BOOLEAN_VARIABLE.VALUES_SPACE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eMATHS_BOOLEAN_VARIABLE.NAME, 
