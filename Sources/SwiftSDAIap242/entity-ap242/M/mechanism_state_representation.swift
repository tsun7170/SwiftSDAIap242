/* file: mechanism_state_representation.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eMECHANISM_STATE_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var ITEMS: SDAI.SET<ePAIR_VALUE.PRef>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<ePAIR_VALUE.PRef>( super_eREPRESENTATION.partialEntity._items ) )
      }
      set(newValue) {
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _items: SDAI.SET<ePAIR_VALUE.PRef>[1:nil] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
