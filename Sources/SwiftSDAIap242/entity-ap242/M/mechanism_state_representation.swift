/* file: mechanism_state_representation.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  ENTITY mechanism_state_representation
    ...
    DERIVE
      SELF\representation.context_of_items : geometric_representation_context := represented_mechanism.
                                          context_of_items;
  END_ENTITY; -- mechanism_state_representation (line:21498 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMECHANISM_STATE_REPRESENTATION/PartialEntity``
*/
  public final class eMECHANISM_STATE_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eMECHANISM_STATE_REPRESENTATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eMECHANISM_STATE_REPRESENTATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eMECHANISM_STATE_REPRESENTATION.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMECHANISM_STATE_REPRESENTATION`` )
    public var ITEMS: SDAI.SET<ePAIR_VALUE.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = super_eREPRESENTATION.partialEntity._items
        let SELF = super_eREPRESENTATION; SDAI.TOUCH(let:SELF)
        let value =         SDAI.SET<ePAIR_VALUE.PRef>(
    ...
    public var CONTEXT_OF_ITEMS: eGEOMETRIC_REPRESENTATION_CONTEXT.PRef {
      get {
        if let cached = cachedValue(derivedAttributeName:"CONTEXT_OF_ITEMS") {
          return cached.value as! eGEOMETRIC_REPRESENTATION_CONTEXT.PRef
        }
        let origin = self
        let value = SDAI.UNWRAP( origin.partialEntity._context_of_items__getter(SELF: origin.pRef) )
    ...
    public var REPRESENTED_MECHANISM: eMECHANISM_REPRESENTATION.PRef {
      get {
        let originalValue = self.partialEntity._represented_mechanism
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eMECHANISM_STATE_REPRESENTATION.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "MECHANISM_STATE_REPRESENTATION", 
      ...
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eMECHANISM_STATE_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eMECHANISM_STATE_REPRESENTATION.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eMECHANISM_STATE_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eMECHANISM_STATE_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eMECHANISM_STATE_REPRESENTATION.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "REPRESENTED_MECHANISM", 
        keyPath: \eMECHANISM_STATE_REPRESENTATION.REPRESENTED_MECHANISM, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMECHANISM_STATE_REPRESENTATION``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _items: SDAI.SET<ePAIR_VALUE.PRef>[1:(nil as SDAI.INTEGER?)] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */

      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _represented_mechanism: eMECHANISM_REPRESENTATION.PRef // PLAIN EXPLICIT ATTRIBUTE

      /// DERIVE ATTRIBUTE REDEFINITION(origin: eREPRESENTATION)
      /// - attribute value provider protocol conformance wrapper
      @_documentation(visibility:public)
      internal func _context_of_items__getter(complex: SDAI.ComplexEntity) -> eREPRESENTATION_CONTEXT.PRef {
        let SELF = complex.entityReference( eMECHANISM_STATE_REPRESENTATION.self )!
        return SDAI.UNWRAP( eREPRESENTATION_CONTEXT.PRef(SELF.CONTEXT_OF_ITEMS) )
      }
      /// DERIVE ATTRIBUTE REDEFINITION(origin: eREPRESENTATION)
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _context_of_items__getter(SELF: eMECHANISM_STATE_REPRESENTATION.PRef) -> 
        eGEOMETRIC_REPRESENTATION_CONTEXT.PRef {

        let _TEMP1 /* eGEOMETRIC_REPRESENTATION_CONTEXT.PRef? */ = SELF.REPRESENTED_MECHANISM?.CONTEXT_OF_ITEMS
        let value = _TEMP1
        return SDAI.UNWRAP( value )
      }
      ...
      public init(REPRESENTED_MECHANISM: eMECHANISM_REPRESENTATION.PRef) {
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( REPRESENTED_MECHANISM: original._represented_mechanism )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]REPRESENTED_MECHANISM for partial entity(\(Self.entityName)) constructor"); return nil }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eMECHANISM_STATE_REPRESENTATION.PartialEntity :
