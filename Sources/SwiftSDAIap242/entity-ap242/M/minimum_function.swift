/* file: minimum_function.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMINIMUM_FUNCTION/PartialEntity``
*/
  public final class eMINIMUM_FUNCTION : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eMINIMUM_FUNCTION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eMINIMUM_FUNCTION.PartialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eMINIMUM_FUNCTION.PartialEntity.self) else { return nil }
