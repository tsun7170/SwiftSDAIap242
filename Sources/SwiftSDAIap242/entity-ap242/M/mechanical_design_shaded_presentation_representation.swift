/* file: mechanical_design_shaded_presentation_representation.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY mechanical_design_shaded_presentation_representation
    ...
    WHERE
      ...
      wr15: ( SIZEOF( QUERY ( si <* QUERY ( it <* SELF.items | ( 
                ...
                = 0 );
  END_ENTITY; -- mechanical_design_shaded_presentation_representation (line:20897 file:ap242ed2_mim_lf_v1.101.TY.exp)
      ...
      let _TEMP3 = _TEMP2.QUERY{ SI in 
          ...
          let _TEMP3 = _TEMP2?.QUERY{ PSA in 
              ...
              let _TEMP3 = _TEMP2.QUERY{ PS in 
                  ...
                  let _TEMP8 = SDAI.FORCE_OPTIONAL(_TEMP4) * _TEMP7
              ...
              let _TEMP3 = _TEMP2.QUERY{ SSU in 
                  ...
                  let _TEMP6 = _TEMP5?
                    .QUERY{ SSPL in 
                      ...
                      let _TEMP32 = SDAI.FORCE_OPTIONAL(_TEMP25) * _TEMP31
