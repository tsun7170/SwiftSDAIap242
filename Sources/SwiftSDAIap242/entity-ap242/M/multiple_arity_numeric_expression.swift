/* file: multiple_arity_numeric_expression.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- multiple_arity_numeric_expression (line:21729 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _multiple_arity_numeric_expression : SDAI.PartialEntity {
...
```
*/
  public final class eMULTIPLE_ARITY_NUMERIC_EXPRESSION : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eMULTIPLE_ARITY_NUMERIC_EXPRESSION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "MULTIPLE_ARITY_NUMERIC_EXPRESSION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "IS_INT", keyPath: \eMULTIPLE_ARITY_NUMERIC_EXPRESSION.IS_INT, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OPERANDS", keyPath: \eMULTIPLE_ARITY_NUMERIC_EXPRESSION.OPERANDS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "SQL_MAPPABLE", keyPath: \eMULTIPLE_ARITY_NUMERIC_EXPRESSION.SQL_MAPPABLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
