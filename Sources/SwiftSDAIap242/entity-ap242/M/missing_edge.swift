/* file: missing_edge.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  ENTITY missing_edge
    ...
    DERIVE
      ...
      SELF\a3m_equivalence_criterion.detected_difference_types : LIST [2 : 2] OF
                                          a3ms_detected_difference_type_name := [ddns_no_element, ddns_edge];
      SELF\a3m_equivalence_criterion.accuracy_types : LIST [0 : 0] OF a3ms_accuracy_type_name := [];
  END_ENTITY; -- missing_edge (line:21719 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISSING_EDGE/PartialEntity``
*/
  public final class eMISSING_EDGE : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eMISSING_EDGE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eMISSING_EDGE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eMISSING_EDGE.PartialEntity
    ...
    public var super_eMISSING_EDGE: eMISSING_EDGE { return self } 	// [7]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISSING_EDGE`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eMISSING_EDGE.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eMISSING_EDGE.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ACCURACY_TYPES", 
        keyPath: \eMISSING_EDGE.ACCURACY_TYPES, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISSING_EDGE``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      internal func _compared_element_types__getter(complex: SDAI.ComplexEntity) -> SDAI.LIST<
        ...
        let SELF = complex.entityReference( eMISSING_EDGE.self )!
        return SDAI.UNWRAP( SDAI.LIST<nA3M_ELEMENT_TYPE_NAME>(SELF.COMPARED_ELEMENT_TYPES) )
      }
      /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _compared_element_types__getter(SELF: eMISSING_EDGE.PRef) -> SDAI.LIST<
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _measured_data_type__getter(SELF: eMISSING_EDGE.PRef) -> nA3MS_MEASURED_DATA_TYPE_NAME {
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _detected_difference_types__getter(SELF: eMISSING_EDGE.PRef) -> SDAI.LIST<
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _accuracy_types__getter(SELF: eMISSING_EDGE.PRef) -> SDAI.LIST<nA3MS_ACCURACY_TYPE_NAME>
        /*[0:0]*/  {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eMISSING_EDGE.PartialEntity :
