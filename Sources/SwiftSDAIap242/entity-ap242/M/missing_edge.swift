/* file: missing_edge.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _missing_edge : SDAI.PartialEntity, SDAI.InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_missing_edge``
*/
  public final class eMISSING_EDGE : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public let partialEntity: _missing_edge
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_missing_edge.self) else { return nil }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF._missing_edge :
