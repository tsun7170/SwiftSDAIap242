/* file: maximum_function.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _maximum_function : SDAI.PartialEntity, SDAI.InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_maximum_function``
*/
  public final class eMAXIMUM_FUNCTION : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _maximum_function.self
    }
    /// partial entity reference
    public let partialEntity: _maximum_function
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_maximum_function.self) else { return nil }
