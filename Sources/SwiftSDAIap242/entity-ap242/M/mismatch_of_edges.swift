/* file: mismatch_of_edges.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _mismatch_of_edges : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _compared_element_types__getter(SELF: eMISMATCH_OF_EDGES) -> SDAI.LIST<
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _measured_data_type__getter(SELF: eMISMATCH_OF_EDGES) -> nA3MS_MEASURED_DATA_TYPE_NAME {
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _detected_difference_types__getter(SELF: eMISMATCH_OF_EDGES) -> SDAI.LIST<
      ...
      let _TEMP1 = SDAI.LIST<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(2)), 
        ...
        nA3M_DETECTED_DIFFERENCE_TYPE_NAME*/DDNS_EDGE)), 
        SDAI.AIE(nA3MS_DETECTED_DIFFERENCE_TYPE_NAME(/*nA3M_DETECTED_DIFFERENCE_TYPE_NAME*/DDNS_SEVERAL_EDGES))] 
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _accuracy_types__getter(SELF: eMISMATCH_OF_EDGES) -> SDAI.LIST<nA3MS_ACCURACY_TYPE_NAME>/*[
      0:0]*/  {
...
```
*/
  public final class eMISMATCH_OF_EDGES : SDAI.EntityReference, @unchecked Sendable {
