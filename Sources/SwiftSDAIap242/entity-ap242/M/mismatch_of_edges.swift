/* file: mismatch_of_edges.swift 	 generated: Mon Dec 15 17:41:04 2025 */
...
*/
  ...
  public final class _mismatch_of_edges : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
    ...
    /// - gut of derived attribute logic
    @_documentation(visibility:public)
    internal func _measured_data_type__getter(SELF: eMISMATCH_OF_EDGES.PRef) -> nA3MS_MEASURED_DATA_TYPE_NAME {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_mismatch_of_edges``
*/
  public final class eMISMATCH_OF_EDGES : SDAI.EntityReference, SDAIDualModeReference, @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _mismatch_of_edges.self
    }
    /// partial entity reference
    public let partialEntity: _mismatch_of_edges
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_mismatch_of_edges.self) else { return nil }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF._mismatch_of_edges :
