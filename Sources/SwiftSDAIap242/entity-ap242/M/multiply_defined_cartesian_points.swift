/* file: multiply_defined_cartesian_points.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- multiply_defined_cartesian_points (line:21735 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _multiply_defined_cartesian_points : SDAI.PartialEntity {
...
```
*/
  public final class eMULTIPLY_DEFINED_CARTESIAN_POINTS : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eMULTIPLY_DEFINED_CARTESIAN_POINTS`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "MULTIPLY_DEFINED_CARTESIAN_POINTS", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eMULTIPLY_DEFINED_CARTESIAN_POINTS.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eMULTIPLY_DEFINED_CARTESIAN_POINTS.NAME, 
