/* file: multiply_defined_cartesian_points.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eMULTIPLY_DEFINED_CARTESIAN_POINTS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eMULTIPLY_DEFINED_CARTESIAN_POINTS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eMULTIPLY_DEFINED_CARTESIAN_POINTS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eMULTIPLY_DEFINED_CARTESIAN_POINTS.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eMULTIPLY_DEFINED_CARTESIAN_POINTS.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = eMULTIPLY_DEFINED_CARTESIAN_POINTS.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
