/* file: mismatch_of_underlying_face_geometry.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _mismatch_of_underlying_face_geometry : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _comparing_element_types__getter(SELF: eMISMATCH_OF_UNDERLYING_FACE_GEOMETRY) -> SDAI.LIST<
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _compared_element_types__getter(SELF: eMISMATCH_OF_UNDERLYING_FACE_GEOMETRY) -> SDAI.LIST<
      nA3MS_ELEMENT_TYPE_NAME>/*[1:1]*/  {
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _measured_data_type__getter(SELF: eMISMATCH_OF_UNDERLYING_FACE_GEOMETRY) -> 
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _detected_difference_types__getter(SELF: eMISMATCH_OF_UNDERLYING_FACE_GEOMETRY) -> SDAI.LIST<
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _accuracy_types__getter(SELF: eMISMATCH_OF_UNDERLYING_FACE_GEOMETRY) -> SDAI.LIST<
...
```
*/
  public final class eMISMATCH_OF_UNDERLYING_FACE_GEOMETRY : SDAI.EntityReference, @unchecked Sendable {
