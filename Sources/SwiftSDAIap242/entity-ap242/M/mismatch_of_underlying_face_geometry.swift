/* file: mismatch_of_underlying_face_geometry.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- mismatch_of_underlying_face_geometry (line:21509 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _mismatch_of_underlying_face_geometry : SDAI.PartialEntity {
...
```
*/
  public final class eMISMATCH_OF_UNDERLYING_FACE_GEOMETRY : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eMISMATCH_OF_UNDERLYING_FACE_GEOMETRY`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "MISMATCH_OF_UNDERLYING_FACE_GEOMETRY", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ACCURACY_TYPES", keyPath: \eMISMATCH_OF_UNDERLYING_FACE_GEOMETRY.ACCURACY_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", keyPath: \eMISMATCH_OF_UNDERLYING_FACE_GEOMETRY.DETECTED_DIFFERENCE_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", keyPath: \eMISMATCH_OF_UNDERLYING_FACE_GEOMETRY.COMPARED_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", keyPath: \eMISMATCH_OF_UNDERLYING_FACE_GEOMETRY.MEASURED_DATA_TYPE, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eMISMATCH_OF_UNDERLYING_FACE_GEOMETRY.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eMISMATCH_OF_UNDERLYING_FACE_GEOMETRY.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", keyPath: \eMISMATCH_OF_UNDERLYING_FACE_GEOMETRY.COMPARING_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
