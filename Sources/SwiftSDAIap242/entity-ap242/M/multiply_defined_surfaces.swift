/* file: multiply_defined_surfaces.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- multiply_defined_surfaces (line:22056 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	multiply_defined_surfaces
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTIPLY_DEFINED_SURFACES/PartialEntity``
*/
  public final class eMULTIPLY_DEFINED_SURFACES : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eMULTIPLY_DEFINED_SURFACES>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eMULTIPLY_DEFINED_SURFACES.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eMULTIPLY_DEFINED_SURFACES.PartialEntity
    ...
    public var super_eMULTIPLY_DEFINED_SURFACES: eMULTIPLY_DEFINED_SURFACES { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTIPLY_DEFINED_SURFACES`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eMULTIPLY_DEFINED_SURFACES.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eMULTIPLY_DEFINED_SURFACES.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eMULTIPLY_DEFINED_SURFACES.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eMULTIPLY_DEFINED_SURFACES.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eMULTIPLY_DEFINED_SURFACES.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = eMULTIPLY_DEFINED_SURFACES.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "MULTIPLY_DEFINED_SURFACES", 
      ...
      entityDef.add(supertype: eMULTIPLY_DEFINED_SURFACES.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eMULTIPLY_DEFINED_SURFACES.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eMULTIPLY_DEFINED_SURFACES.NAME, 
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: eMULTIPLY_DEFINED_SURFACES.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eMULTIPLY_DEFINED_SURFACES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eMULTIPLY_DEFINED_SURFACES.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.LENGTH_MEASURE") )
        return _TEMP1
      }
      public static func WHERE_wr3(SELF: eMULTIPLY_DEFINED_SURFACES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
      ...
      public static func WHERE_wr4(SELF: eMULTIPLY_DEFINED_SURFACES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
      ...
      public static func WHERE_wr5(SELF: eMULTIPLY_DEFINED_SURFACES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
