/* file: multiply_defined_vertices.swift 	 generated: Thu Mar  5 17:54:18 2026 */
  ...
  ENTITY multiply_defined_vertices
    ...
    WHERE
      ...
      wr3: validate_inspected_elements_type( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               + 'VERTEX_POINT' , 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.VERTEX_POINT'] );
      wr4: validate_locations_of_extreme_value_type( SELF, [] );
      wr5: validate_accuracy_types( SELF, [] );
  END_ENTITY; -- multiply_defined_vertices (line:22072 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(7)	topology_related_to_multiply_defined_geometry
    (no local attributes)

  ENTITY(SELF)	multiply_defined_vertices
...
- SUPERTYPES:
	...
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTOPOLOGY_RELATED_TO_MULTIPLY_DEFINED_GEOMETRY``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTIPLY_DEFINED_VERTICES/PartialEntity``
*/
  public final class eMULTIPLY_DEFINED_VERTICES : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eMULTIPLY_DEFINED_VERTICES>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eMULTIPLY_DEFINED_VERTICES.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eMULTIPLY_DEFINED_VERTICES.PartialEntity
    ...
    public let super_eTOPOLOGY_RELATED_TO_MULTIPLY_DEFINED_GEOMETRY: eTOPOLOGY_RELATED_TO_MULTIPLY_DEFINED_GEOMETRY 	// [7]
    public var super_eMULTIPLY_DEFINED_VERTICES: eMULTIPLY_DEFINED_VERTICES { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTIPLY_DEFINED_VERTICES`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eMULTIPLY_DEFINED_VERTICES.PartialEntity.self) else { return nil }
      ...
      guard let super7 = complexEntity?.entityReference(eTOPOLOGY_RELATED_TO_MULTIPLY_DEFINED_GEOMETRY.self) else { return nil }
      self.super_eTOPOLOGY_RELATED_TO_MULTIPLY_DEFINED_GEOMETRY = super7
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eMULTIPLY_DEFINED_VERTICES.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eMULTIPLY_DEFINED_VERTICES.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eMULTIPLY_DEFINED_VERTICES.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eMULTIPLY_DEFINED_VERTICES.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = eMULTIPLY_DEFINED_VERTICES.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "MULTIPLY_DEFINED_VERTICES", 
      ...
      entityDef.add(supertype: eTOPOLOGY_RELATED_TO_MULTIPLY_DEFINED_GEOMETRY.self)
      entityDef.add(supertype: eMULTIPLY_DEFINED_VERTICES.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eMULTIPLY_DEFINED_VERTICES.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eMULTIPLY_DEFINED_VERTICES.NAME, 
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: eMULTIPLY_DEFINED_VERTICES.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eMULTIPLY_DEFINED_VERTICES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eMULTIPLY_DEFINED_VERTICES.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.LENGTH_MEASURE") )
        return _TEMP1
      }
      public static func WHERE_wr3(SELF: eMULTIPLY_DEFINED_VERTICES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
      ...
      public static func WHERE_wr4(SELF: eMULTIPLY_DEFINED_VERTICES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
      ...
      public static func WHERE_wr5(SELF: eMULTIPLY_DEFINED_VERTICES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.AGGREGATE<runtime> */ = SDAI.BAG<SDAI.STRING>(SDAI.EMPTY_AGGREGATE)
