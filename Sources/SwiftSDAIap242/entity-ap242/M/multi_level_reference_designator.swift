/* file: multi_level_reference_designator.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public final class eMULTI_LEVEL_REFERENCE_DESIGNATOR : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eMULTI_LEVEL_REFERENCE_DESIGNATOR.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eMULTI_LEVEL_REFERENCE_DESIGNATOR.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _location: SDAI.LIST_UNIQUE<eNEXT_ASSEMBLY_USAGE_OCCURRENCE.PRef>/*[1:nil]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public static func WHERE_wr1(SELF: eMULTI_LEVEL_REFERENCE_DESIGNATOR.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP1 /* SDAI.BOOLEAN? */ = UNAMBIGUOUSLY_SPECIFIED_MULTI_LEVEL_REFERENCE_DESIGNATOR( 
            ...
            SDAI.INTEGER?), /*SDAI.LIST_UNIQUE<eNEXT_ASSEMBLY_USAGE_OCCURRENCE.PRef>[1:nil] */SELF.LOCATION) )
        return SDAI.LOGICAL(_TEMP1)
      }
      public static func WHERE_wr2(SELF: eMULTI_LEVEL_REFERENCE_DESIGNATOR.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LIST_UNIQUE<eNEXT_ASSEMBLY_USAGE_OCCURRENCE.PRef>[1:nil] ? */ = SELF.LOCATION?
          .QUERY{ CP in 
            // QUERY BODY
      ...
      public init(LOCATION: SDAI.LIST_UNIQUE<eNEXT_ASSEMBLY_USAGE_OCCURRENCE.PRef>/*[1:nil]*/ ) {
