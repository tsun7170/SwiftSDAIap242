/* file: multi_level_reference_designator.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _multi_level_reference_designator : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_multi_level_reference_designator``
*/
  public final class eMULTI_LEVEL_REFERENCE_DESIGNATOR : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _multi_level_reference_designator.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _multi_level_reference_designator.WHERE_wr2(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addUniquenessRule(label:"UNIQUE_ur1", rule: _multi_level_reference_designator.UNIQUE_ur1)
