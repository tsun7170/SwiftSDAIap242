/* file: multi_level_reference_designator.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY multi_level_reference_designator
    ...
    WHERE
      ...
      wr2: ( SIZEOF( QUERY ( cp <* location | ( NOT EXISTS( cp\assembly_component_usage.reference_designator ) ) ) ) 
               = 0 );
  END_ENTITY; -- multi_level_reference_designator (line:21697 file:ap242ed2_mim_lf_v1.101.TY.exp)
