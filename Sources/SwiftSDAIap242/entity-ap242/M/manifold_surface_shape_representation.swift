/* file: manifold_surface_shape_representation.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY manifold_surface_shape_representation
    ...
    WHERE
      ...
      wr14: ( SIZEOF( QUERY ( sbsm <* QUERY ( it <* SELF.items | ( 
                ...
                = 0 ) ) ) ) = 0 );
  END_ENTITY; -- manifold_surface_shape_representation (line:19784 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _manifold_surface_shape_representation : SDAI.PartialEntity {
                    ...
                    .QUERY{ ELP_FBNDS in 
                      ...
                      let _TEMP3 = _TEMP2?
                        .QUERY{ OE in 
                          ...
                          let _TEMP7 = SDAI.FORCE_OPTIONAL(_TEMP1) * _TEMP6
                          ...
                          let _TEMP16 = SDAI.FORCE_OPTIONAL(_TEMP10) * _TEMP15
...
```
*/
  public final class eMANIFOLD_SURFACE_SHAPE_REPRESENTATION : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "MANIFOLD_SURFACE_SHAPE_REPRESENTATION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eMANIFOLD_SURFACE_SHAPE_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eMANIFOLD_SURFACE_SHAPE_REPRESENTATION.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eMANIFOLD_SURFACE_SHAPE_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eMANIFOLD_SURFACE_SHAPE_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eMANIFOLD_SURFACE_SHAPE_REPRESENTATION.NAME, 
