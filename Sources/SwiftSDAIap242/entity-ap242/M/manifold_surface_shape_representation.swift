/* file: manifold_surface_shape_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _manifold_surface_shape_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eMANIFOLD_SURFACE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eMANIFOLD_SURFACE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eMANIFOLD_SURFACE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ MI in 
          ...
          let _TEMP6 = _TEMP5?.QUERY{ MR_IT in 
              ...
              let _TEMP1 = SDAI.TYPEOF(MR_IT, IS: eSHELL_BASED_SURFACE_MODEL.self)
              return _TEMP1 }
    ...
    public static func WHERE_wr4(SELF: eMANIFOLD_SURFACE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.ITEMS
      let _TEMP2 = _TEMP1.QUERY{ IT in 

          let _TEMP1 = SDAI.TYPEOF(IT, IS: eSHELL_BASED_SURFACE_MODEL.self)
          return _TEMP1 }
      let _TEMP3 = _TEMP2.QUERY{ SBSM in 

          let _TEMP1 = SBSM.GROUP_REF(eSHELL_BASED_SURFACE_MODEL.self)
          let _TEMP2 = _TEMP1?.SBSM_BOUNDARY
          let _TEMP3 = _TEMP2?.QUERY{ SH in 

              let _TEMP1 = ([SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.OPEN_SHELL")), 
    ...
    public static func WHERE_wr5(SELF: eMANIFOLD_SURFACE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ SBSM in 
          ...
          let _TEMP3 = _TEMP2?.QUERY{ CFS in 
              ...
              let _TEMP1 = CFS.GROUP_REF(eCONNECTED_FACE_SET.self)
              let _TEMP2 = _TEMP1?.CFS_FACES
              let _TEMP3 = _TEMP2?.QUERY{ FA in 
    ...
    public static func WHERE_wr6(SELF: eMANIFOLD_SURFACE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ SBSM in 
          ...
          let _TEMP3 = _TEMP2?.QUERY{ CFS in 
              ...
              let _TEMP3 = _TEMP2?.QUERY{ FA in 
                  ...
                  let _TEMP2 = FA.GROUP_REF(eFACE_SURFACE.self)
                  let _TEMP3 = _TEMP2?.FACE_GEOMETRY
                  let _TEMP4 = MSF_SURFACE_CHECK(_TEMP3)
    ...
    public static func WHERE_wr7(SELF: eMANIFOLD_SURFACE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr8(SELF: eMANIFOLD_SURFACE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr9(SELF: eMANIFOLD_SURFACE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr10(SELF: eMANIFOLD_SURFACE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
                    ...
                    .QUERY{ ELP_FBNDS in 
                      ...
                      let _TEMP3 = _TEMP2?
                        .QUERY{ OE in 
                          ...
                          let _TEMP4 = MSF_CURVE_CHECK(eREPRESENTATION_ITEM(/*eCURVE*/_TEMP3))
                          let _TEMP5 =  !_TEMP4
                          return _TEMP5 }
                      let _TEMP4 = SDAI.SIZEOF(_TEMP3)
                      let _TEMP5 = _TEMP4 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(0))
    ...
    public static func WHERE_wr11(SELF: eMANIFOLD_SURFACE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr12(SELF: eMANIFOLD_SURFACE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr13(SELF: eMANIFOLD_SURFACE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr14(SELF: eMANIFOLD_SURFACE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eMANIFOLD_SURFACE_SHAPE_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _manifold_surface_shape_representation.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _manifold_surface_shape_representation.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _manifold_surface_shape_representation.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _manifold_surface_shape_representation.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _manifold_surface_shape_representation.WHERE_wr5(SELF: instance)
      result[prefix2 + " .WHERE_wr6"] = _manifold_surface_shape_representation.WHERE_wr6(SELF: instance)
      result[prefix2 + " .WHERE_wr7"] = _manifold_surface_shape_representation.WHERE_wr7(SELF: instance)
      result[prefix2 + " .WHERE_wr8"] = _manifold_surface_shape_representation.WHERE_wr8(SELF: instance)
      result[prefix2 + " .WHERE_wr9"] = _manifold_surface_shape_representation.WHERE_wr9(SELF: instance)
      result[prefix2 + " .WHERE_wr10"] = _manifold_surface_shape_representation.WHERE_wr10(SELF: instance)
      result[prefix2 + " .WHERE_wr11"] = _manifold_surface_shape_representation.WHERE_wr11(SELF: instance)
      result[prefix2 + " .WHERE_wr12"] = _manifold_surface_shape_representation.WHERE_wr12(SELF: instance)
      result[prefix2 + " .WHERE_wr13"] = _manifold_surface_shape_representation.WHERE_wr13(SELF: instance)
      result[prefix2 + " .WHERE_wr14"] = _manifold_surface_shape_representation.WHERE_wr14(SELF: instance)
      return result
    }
