/* file: mismatch_of_faces.swift 	 generated: Thu Dec 25 18:13:23 2025 */
...
*/
  ...
  public final class _mismatch_of_faces : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
    ...
    /// - gut of derived attribute logic
    @_documentation(visibility:public)
    internal func _measured_data_type__getter(SELF: eMISMATCH_OF_FACES.PRef) -> nA3MS_MEASURED_DATA_TYPE_NAME {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_mismatch_of_faces``
*/
  public final class eMISMATCH_OF_FACES : SDAI.EntityReference, SDAIDualModeReference, @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _mismatch_of_faces.self
    }
    /// partial entity reference
    public let partialEntity: _mismatch_of_faces
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_mismatch_of_faces.self) else { return nil }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF._mismatch_of_faces :
