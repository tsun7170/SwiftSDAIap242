/* file: mismatch_of_faces.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- mismatch_of_faces (line:21633 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(6)	a3m_equivalence_criterion_of_shape_data_structure
...
- SUPERTYPES:
	...
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_SHAPE_DATA_STRUCTURE``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISMATCH_OF_FACES/PartialEntity``
*/
  public final class eMISMATCH_OF_FACES : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eMISMATCH_OF_FACES>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eMISMATCH_OF_FACES.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eMISMATCH_OF_FACES.PartialEntity
    ...
    public let super_eA3M_EQUIVALENCE_CRITERION_OF_SHAPE_DATA_STRUCTURE: eA3M_EQUIVALENCE_CRITERION_OF_SHAPE_DATA_STRUCTURE 	// [6]
    public var super_eMISMATCH_OF_FACES: eMISMATCH_OF_FACES { return self } 	// [7]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISMATCH_OF_FACES`` )
    ...
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_SHAPE_DATA_STRUCTURE`` )
    public var COMPARING_ELEMENT_TYPES: SDAI.LIST<nA3M_ELEMENT_TYPE_NAME>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        ...
        let origin = super_eA3M_EQUIVALENCE_CRITERION_OF_SHAPE_DATA_STRUCTURE
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eMISMATCH_OF_FACES.PartialEntity.self) else { return nil }
      ...
      guard let super6 = complexEntity?.entityReference(eA3M_EQUIVALENCE_CRITERION_OF_SHAPE_DATA_STRUCTURE.self) else { return nil }
      self.super_eA3M_EQUIVALENCE_CRITERION_OF_SHAPE_DATA_STRUCTURE = super6
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eMISMATCH_OF_FACES.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ACCURACY_TYPES", 
        keyPath: \eMISMATCH_OF_FACES.ACCURACY_TYPES, 
      ...
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", 
        keyPath: \eMISMATCH_OF_FACES.DETECTED_DIFFERENCE_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", 
        keyPath: \eMISMATCH_OF_FACES.COMPARED_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", 
        keyPath: \eMISMATCH_OF_FACES.MEASURED_DATA_TYPE, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eMISMATCH_OF_FACES.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eMISMATCH_OF_FACES.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", 
        keyPath: \eMISMATCH_OF_FACES.COMPARING_ELEMENT_TYPES, 
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      internal func _compared_element_types__getter(complex: SDAI.ComplexEntity) -> SDAI.LIST<
        ...
        let SELF = complex.entityReference( eMISMATCH_OF_FACES.self )!
        return SDAI.UNWRAP( SDAI.LIST<nA3M_ELEMENT_TYPE_NAME>(SELF.COMPARED_ELEMENT_TYPES) )
      }
      /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _compared_element_types__getter(SELF: eMISMATCH_OF_FACES.PRef) -> SDAI.LIST<
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _measured_data_type__getter(SELF: eMISMATCH_OF_FACES.PRef) -> 
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _detected_difference_types__getter(SELF: eMISMATCH_OF_FACES.PRef) -> SDAI.LIST<
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_DETECTED_DIFFERENCE_TYPE_NAME> */ = SDAI.LIST<
          nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(2)), bound2: SDAI.INTEGER(2),  ([ 
            ...
            DDNS_SEVERAL_FACES)) ] as [SDAI.AggregationInitializerElement<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>]) )
        let value = _TEMP1
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _accuracy_types__getter(SELF: eMISMATCH_OF_FACES.PRef) -> SDAI.LIST<
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eMISMATCH_OF_FACES.PartialEntity :
