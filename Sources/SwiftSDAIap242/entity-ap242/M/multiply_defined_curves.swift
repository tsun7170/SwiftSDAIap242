/* file: multiply_defined_curves.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _multiply_defined_curves : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_multiply_defined_curves``
*/
  public final class eMULTIPLY_DEFINED_CURVES : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _multiply_defined_curves.self
    }
    /// partial entity reference
    public let partialEntity: _multiply_defined_curves
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_multiply_defined_curves.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _multiply_defined_curves.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _multiply_defined_curves.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _multiply_defined_curves.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _multiply_defined_curves.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _multiply_defined_curves.WHERE_wr5(SELF: instance.pRef)
      return result
    }
