/* file: mismatch_of_underlying_edge_geometry.swift 	 generated: Thu Mar  5 17:54:18 2026 */
      ...
      internal func _detected_difference_types__getter(SELF: eMISMATCH_OF_UNDERLYING_EDGE_GEOMETRY.PRef) -> 
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_DETECTED_DIFFERENCE_TYPE_NAME> */ = SDAI.LIST<
          ...
          bound1:SDAI.UNWRAP(1), bound2:1,  ([ SDAI.AIE(nA3MS_DETECTED_DIFFERENCE_TYPE_NAME(/*
            nA3M_DETECTED_DIFFERENCE_TYPE_NAME*/DDNS_EDGE)) ] as [SDAI.AggregationInitializerElement<
            nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>]) )
        let value = _TEMP1
        return SDAI.UNWRAP( value )
      }
