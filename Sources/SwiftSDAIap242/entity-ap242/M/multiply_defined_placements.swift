/* file: multiply_defined_placements.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _multiply_defined_placements : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eMULTIPLY_DEFINED_PLACEMENTS?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eMULTIPLY_DEFINED_PLACEMENTS?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eMULTIPLY_DEFINED_PLACEMENTS?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = VALIDATE_MEASURED_DATA_TYPE(
        EI: eSHAPE_DATA_QUALITY_CRITERION(/*eMULTIPLY_DEFINED_PLACEMENTS*/SELF), 
        TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PLANE_ANGLE_AND_LENGTH_PAIR"))
      return _TEMP1
    }
    public static func WHERE_wr4(SELF: eMULTIPLY_DEFINED_PLACEMENTS?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr5(SELF: eMULTIPLY_DEFINED_PLACEMENTS?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr6(SELF: eMULTIPLY_DEFINED_PLACEMENTS?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr7(SELF: eMULTIPLY_DEFINED_PLACEMENTS?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2?.QUERY{ SDQR in 

          let _TEMP1 = SDAI.TYPEOF(SDQR, IS: eSHAPE_DATA_QUALITY_INSPECTION_RESULT.self)
          let _TEMP2 = SDAI.USEDIN(T: SDQR, ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
            .eDATA_QUALITY_INSPECTION_REPORT.INSPECTION_RESULT)
          let _TEMP3 = BAG_TO_SET(_TEMP2)
          let _TEMP4 = _TEMP3?.QUERY{ SDQIIR in 

              let _TEMP1 = SDAI.TYPEOF(SDQIIR, IS: eSHAPE_DATA_QUALITY_INSPECTION_INSTANCE_REPORT.self)
              let _TEMP2 = /*runtime*/SDQIIR.INSPECTED_INSTANCES
              let _TEMP3 = /*runtime*/SDAI.FORCE_OPTIONAL(_TEMP2)?
                .QUERY{ SDQIRI in 

                  let _TEMP1 = /*runtime*/SDQIRI.INSPECTED_ELEMENTS
                  let _TEMP2 = /*runtime*/SDAI.FORCE_OPTIONAL(_TEMP1)?[1]
                  let _TEMP3 = SDAI.TYPEOF(_TEMP2)
                  let _TEMP4 = /*runtime*/SDQIRI.INSPECTED_ELEMENTS
                  let _TEMP5 = /*runtime*/SDAI.FORCE_OPTIONAL(_TEMP4)?[2]
...
```
*/
  public final class eMULTIPLY_DEFINED_PLACEMENTS : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _multiply_defined_placements.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _multiply_defined_placements.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _multiply_defined_placements.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _multiply_defined_placements.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _multiply_defined_placements.WHERE_wr5(SELF: instance)
      result[prefix2 + " .WHERE_wr6"] = _multiply_defined_placements.WHERE_wr6(SELF: instance)
      result[prefix2 + " .WHERE_wr7"] = _multiply_defined_placements.WHERE_wr7(SELF: instance)
      return result
    }
