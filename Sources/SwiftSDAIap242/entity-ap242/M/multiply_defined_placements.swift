/* file: multiply_defined_placements.swift 	 generated: Tue Jan 20 19:20:51 2026 */
...
*/
  public final class eMULTIPLY_DEFINED_PLACEMENTS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var ASSESSMENT_SPECIFICATION: eSHAPE_DATA_QUALITY_ASSESSMENT_BY_NUMERICAL_TEST.PRef {
      get {
        return SDAI.UNWRAP( eSHAPE_DATA_QUALITY_ASSESSMENT_BY_NUMERICAL_TEST.PRef( super_eSHAPE_DATA_QUALITY_CRITERION
      ...
      set(newValue) {
        ...
        partial._assessment_specification = SDAI.UNWRAP(
          sSHAPE_DATA_QUALITY_ASSESSMENT_SPECIFICATION_SELECT(fromGeneric: newValue))
      }
    }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eMULTIPLY_DEFINED_PLACEMENTS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eMULTIPLY_DEFINED_PLACEMENTS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eMULTIPLY_DEFINED_PLACEMENTS.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eMULTIPLY_DEFINED_PLACEMENTS.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = eMULTIPLY_DEFINED_PLACEMENTS.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr6"] = eMULTIPLY_DEFINED_PLACEMENTS.PartialEntity.WHERE_wr6(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr7"] = eMULTIPLY_DEFINED_PLACEMENTS.PartialEntity.WHERE_wr7(SELF: instance.pRef)
      return result
    }
