/* file: modified_pattern.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _modified_pattern : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eMODIFIED_PATTERN?) -> SDAI.LOGICAL {
      ...
      let _TEMP3 = _TEMP2.QUERY{ FCR in 
          ...
          let _TEMP9 = /*runtime*/FCR.DESCRIPTION
    ...
    public static func WHERE_wr2(SELF: eMODIFIED_PATTERN?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eMODIFIED_PATTERN?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP2 = _TEMP1.QUERY{ SAR in 
          ...
          let _TEMP1 = /*runtime*/SAR.RELATED_SHAPE_ASPECT
          ...
          let _TEMP3 = _TEMP2.QUERY{ MSAR in 

              let _TEMP1 = ([SDAI.AIE(SDAI.STRING(
                "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PATTERN_OFFSET_MEMBERSHIP")), 
                SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PATTERN_OMIT_MEMBERSHIP"))] 
                as [SDAI.AggregationInitializerElement<SDAI.STRING>])
              let _TEMP2 = SDAI.TYPEOF(SAR)
              let _TEMP3 = SDAI.FORCE_OPTIONAL(_TEMP1) * SDAI.FORCE_OPTIONAL(_TEMP2)
              let _TEMP4 = SDAI.SIZEOF(_TEMP3)
              let _TEMP5 = _TEMP4 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
              let _TEMP6 = /*runtime*/SAR.DESCRIPTION
              let _TEMP7 = SDAI.FORCE_OPTIONAL(/*runtime*/_TEMP6) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING(
                "modified pattern"))
              let _TEMP8 = _TEMP5 && _TEMP7
              let _TEMP9 = SDAI.FORCE_OPTIONAL(SAR) .!==. SDAI.FORCE_OPTIONAL(MSAR)
...
```
*/
  public final class eMODIFIED_PATTERN : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _modified_pattern.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _modified_pattern.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _modified_pattern.WHERE_wr3(SELF: instance)
      return result
    }
