/* file: multiple_arity_generic_expression.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _operands: (SDAI.LIST<eGENERIC_EXPRESSION.PRef>/*[2:nil]*/ )?  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(OPERANDS: (SDAI.LIST<eGENERIC_EXPRESSION.PRef>/*[2:nil]*/ )? ) {
...
internal protocol eMULTIPLE_ARITY_GENERIC_EXPRESSION__OPERANDS__provider {
  ...
  func _operands__getter(complex: SDAI.ComplexEntity) -> SDAI.LIST<
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eGENERIC_EXPRESSION.PRef>/*[2:nil]*/ 
}
