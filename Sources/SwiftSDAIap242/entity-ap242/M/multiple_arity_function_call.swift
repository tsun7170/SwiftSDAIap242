/* file: multiple_arity_function_call.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _multiple_arity_function_call : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_multiple_arity_function_call``
*/
  public final class eMULTIPLE_ARITY_FUNCTION_CALL : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _multiple_arity_function_call.self
    }
    /// partial entity reference
    public let partialEntity: _multiple_arity_function_call
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_multiple_arity_function_call.self) else { return nil }
