/* file: mismatch_of_arcwise_connected_curves.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _mismatch_of_arcwise_connected_curves : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
    ...
    @_documentation(visibility:public)
    internal func _comparing_element_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.PRef) -> SDAI.LIST<
    ...
    /// - gut of derived attribute logic
    @_documentation(visibility:public)
    internal func _compared_element_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.PRef) -> SDAI.LIST<
      nA3MS_ELEMENT_TYPE_NAME>/*[1:1]*/  {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_mismatch_of_arcwise_connected_curves``
*/
  public final class eMISMATCH_OF_ARCWISE_CONNECTED_CURVES : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _mismatch_of_arcwise_connected_curves.self
    }
    /// partial entity reference
    public let partialEntity: _mismatch_of_arcwise_connected_curves
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_mismatch_of_arcwise_connected_curves.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _mismatch_of_arcwise_connected_curves.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _mismatch_of_arcwise_connected_curves.WHERE_wr2(SELF: instance.pRef)
      return result
    }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF._mismatch_of_arcwise_connected_curves :
