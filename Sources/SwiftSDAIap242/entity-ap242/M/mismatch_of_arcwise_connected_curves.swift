/* file: mismatch_of_arcwise_connected_curves.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eMISMATCH_OF_ARCWISE_CONNECTED_CURVES : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
