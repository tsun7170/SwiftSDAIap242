/* file: mismatch_of_arcwise_connected_curves.swift 	 generated: Thu Mar  5 17:54:18 2026 */
      ...
      internal func _comparing_element_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.PRef) -> 
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_ELEMENT_TYPE_NAME> */ = SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>(
          bound1:SDAI.UNWRAP(1), bound2:1,  ([ SDAI.AIE(nA3MS_ELEMENT_TYPE_NAME(/*nA3M_ELEMENT_TYPE_NAME*/
            ETNS_CONNECTED_EDGE_SET)) ] as [SDAI.AggregationInitializerElement<nA3MS_ELEMENT_TYPE_NAME>]) )
        let value = _TEMP1
