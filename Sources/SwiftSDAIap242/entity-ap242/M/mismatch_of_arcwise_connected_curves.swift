/* file: mismatch_of_arcwise_connected_curves.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- mismatch_of_arcwise_connected_curves (line:21548 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	mismatch_of_arcwise_connected_curves
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISMATCH_OF_ARCWISE_CONNECTED_CURVES/PartialEntity``
*/
  public final class eMISMATCH_OF_ARCWISE_CONNECTED_CURVES : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eMISMATCH_OF_ARCWISE_CONNECTED_CURVES>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.PartialEntity
    ...
    public var super_eMISMATCH_OF_ARCWISE_CONNECTED_CURVES: eMISMATCH_OF_ARCWISE_CONNECTED_CURVES { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISMATCH_OF_ARCWISE_CONNECTED_CURVES`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "MISMATCH_OF_ARCWISE_CONNECTED_CURVES", 
      ...
      entityDef.add(supertype: eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ACCURACY_TYPES", 
        keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.ACCURACY_TYPES, 
      ...
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", 
        keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.DETECTED_DIFFERENCE_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", 
        keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.COMPARED_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", 
        keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.MEASURED_DATA_TYPE, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", 
        keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.COMPARING_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "APPLIED_VALUES", 
        keyPath: \eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.APPLIED_VALUES, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISMATCH_OF_ARCWISE_CONNECTED_CURVES``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.self
      }
      ...
      internal func _comparing_element_types__getter(complex: SDAI.ComplexEntity) -> SDAI.LIST<
        ...
        let SELF = complex.entityReference( eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.self )!
        return SDAI.UNWRAP( SDAI.LIST<nA3M_ELEMENT_TYPE_NAME>(SELF.COMPARING_ELEMENT_TYPES) )
      }
      /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _comparing_element_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.PRef) -> 
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_ELEMENT_TYPE_NAME> */ = SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>(
          bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: SDAI.INTEGER(1),  ([ 
            SDAI.AIE(nA3MS_ELEMENT_TYPE_NAME(/*nA3M_ELEMENT_TYPE_NAME*/ETNS_CONNECTED_EDGE_SET)) ] 
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _compared_element_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.PRef) -> 
        SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>/*[1:1]*/  {
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _measured_data_type__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.PRef) -> 
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _detected_difference_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.PRef) -> 
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _accuracy_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.PRef) -> SDAI.LIST<
      ...
      public static func WHERE_wr1(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
  .eMISMATCH_OF_ARCWISE_CONNECTED_CURVES.PartialEntity :
