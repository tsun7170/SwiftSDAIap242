/* file: mated_part_relationship.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _items: SDAI.SET<ePRODUCT_DEFINITION.PRef>/*[0:?]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(ITEMS: SDAI.SET<ePRODUCT_DEFINITION.PRef>/*[0:?]*/ ) {

        self._items = 
        SDAI.SET<ePRODUCT_DEFINITION.PRef>(from: ITEMS.asSwiftType, 
          bound1:SDAI.UNWRAP(0), bound2:(nil as SDAI.INTEGER?))
