/* file: mated_part_relationship.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- mated_part_relationship (line:20415 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUPERTYPES:
	...
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGROUP_ASSIGNMENT``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROPERTY_DEFINITION``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_SHAPE``
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_RELATIONSHIP``
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_ASPECT``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMATED_PART_RELATIONSHIP/PartialEntity``
*/
  public final class eMATED_PART_RELATIONSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eMATED_PART_RELATIONSHIP>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eMATED_PART_RELATIONSHIP.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eMATED_PART_RELATIONSHIP.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMATED_PART_RELATIONSHIP`` )
    public var ITEMS: SDAI.SET<ePRODUCT_DEFINITION.PRef>/*[0:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = self.partialEntity._items
        let value = SDAI.UNWRAP( SDAI.SET<ePRODUCT_DEFINITION.PRef>( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public var ASSIGNED_GROUP: eMATED_PART_RELATIONSHIP.PRef {
      get {
        ...
        let origin = self
        let value = SDAI.UNWRAP( origin.partialEntity._assigned_group__getter(SELF: origin.pRef) )
    ...
    public var DEFINITION: eMATED_PART_RELATIONSHIP.PRef {
      get {
        ...
        let origin = self
        let value = SDAI.UNWRAP( origin.partialEntity._definition__getter(SELF: origin.pRef) )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eMATED_PART_RELATIONSHIP.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "PRODUCT_DEFINITIONAL", 
        keyPath: \eMATED_PART_RELATIONSHIP.PRODUCT_DEFINITIONAL, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ROLE", 
        keyPath: \eMATED_PART_RELATIONSHIP.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eMATED_PART_RELATIONSHIP.ITEMS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "OF_SHAPE", 
        keyPath: \eMATED_PART_RELATIONSHIP.OF_SHAPE, 
      ...
      entityDef.addAttribute(name: "RELATING_PRODUCT_DEFINITION", 
        keyPath: \eMATED_PART_RELATIONSHIP.RELATING_PRODUCT_DEFINITION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_GROUP", 
        keyPath: \eMATED_PART_RELATIONSHIP.ASSIGNED_GROUP, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DEFINITION", 
        keyPath: \eMATED_PART_RELATIONSHIP.DEFINITION, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "RELATED_PRODUCT_DEFINITION", 
        keyPath: \eMATED_PART_RELATIONSHIP.RELATED_PRODUCT_DEFINITION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMATED_PART_RELATIONSHIP``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _items: SDAI.SET<ePRODUCT_DEFINITION.PRef>/*[0:(nil as SDAI.INTEGER?)]*/  // PLAIN EXPLICIT ATTRIBUTE

      /// DERIVE ATTRIBUTE REDEFINITION(origin: eGROUP_ASSIGNMENT)
      /// - attribute value provider protocol conformance wrapper
      @_documentation(visibility:public)
      internal func _assigned_group__getter(complex: SDAI.ComplexEntity) -> eGROUP.PRef {
        let SELF = complex.entityReference( eMATED_PART_RELATIONSHIP.self )!
        return SDAI.UNWRAP( eGROUP.PRef(SELF.ASSIGNED_GROUP) )
      }
      /// DERIVE ATTRIBUTE REDEFINITION(origin: eGROUP_ASSIGNMENT)
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _assigned_group__getter(SELF: eMATED_PART_RELATIONSHIP.PRef) -> 
        eMATED_PART_RELATIONSHIP.PRef {
        let value = SELF
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _definition__getter(SELF: eMATED_PART_RELATIONSHIP.PRef) -> eMATED_PART_RELATIONSHIP.PRef {
        let value = SELF
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _of_shape__getter(SELF: eMATED_PART_RELATIONSHIP.PRef) -> eMATED_PART_RELATIONSHIP.PRef {
        let value = SELF
        return SDAI.UNWRAP( value )
      }
      ...
      public init(ITEMS: SDAI.SET<ePRODUCT_DEFINITION.PRef>/*[0:(nil as SDAI.INTEGER?)]*/ ) {
      ...
      public required convenience init?(
        ...
        guard case .success(let p0) = exchangeStructure.recoverRequiredParameter(as: SDAI.SET<
          ePRODUCT_DEFINITION.PRef>.self, from: parameters[0])
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eMATED_PART_RELATIONSHIP.PartialEntity :
