/* file: marking.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _marking : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eMARKING?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eMARKING?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eMARKING?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eMARKING?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr5(SELF: eMARKING?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr6(SELF: eMARKING?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr7(SELF: eMARKING?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eMARKING : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _marking.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _marking.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _marking.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _marking.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _marking.WHERE_wr5(SELF: instance)
      result[prefix2 + " .WHERE_wr6"] = _marking.WHERE_wr6(SELF: instance)
      result[prefix2 + " .WHERE_wr7"] = _marking.WHERE_wr7(SELF: instance)
      return result
    }
