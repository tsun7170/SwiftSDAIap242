/* file: mismatch_of_arcwise_connected_surfaces.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _mismatch_of_arcwise_connected_surfaces : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _comparing_element_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES) -> SDAI.LIST<
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _compared_element_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES) -> SDAI.LIST<
      nA3MS_ELEMENT_TYPE_NAME>/*[1:1]*/  {
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _measured_data_type__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES) -> 
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _detected_difference_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES) -> SDAI.LIST<
      ...
      let _TEMP1 = SDAI.LIST<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(2)), 
        ...
        DDNS_POINT_ON_SURFACE))] as [SDAI.AggregationInitializerElement<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>]))
      let value = _TEMP1
      return SDAI.UNWRAP( value )
    }
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _accuracy_types__getter(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES) -> SDAI.LIST<
    ...
    public static func WHERE_wr1(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _mismatch_of_arcwise_connected_surfaces.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _mismatch_of_arcwise_connected_surfaces.WHERE_wr2(SELF: instance)
      return result
    }
