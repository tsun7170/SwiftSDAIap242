/* file: mass_unit.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _mass_unit : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eMASS_UNIT?) -> SDAI.LOGICAL {
      ...
      let _TEMP8 = _TEMP7 .==. SDAI.FORCE_OPTIONAL(SDAI.REAL(1.0000000000e+00))
...
```
*/
  public final class eMASS_UNIT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _mass_unit.WHERE_wr1(SELF: instance)
      return result
    }
