/* file: mechanical_design_shaded_presentation_area.swift 	 generated: Thu Dec 25 18:13:23 2025 */
...
*/
  ...
  public final class _mechanical_design_shaded_presentation_area : SDAI.PartialEntity, InitializableByVoid
    , @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eMECHANICAL_DESIGN_SHADED_PRESENTATION_AREA.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP2 /* SDAI.SET<sMECHANICAL_DESIGN_SHADED_PRESENTATION_AREA_ITEMS>[1:nil] ? */ = _TEMP1?
        .QUERY{ IT1 in 
          ...
          let _TEMP3 /* SDAI.LOGICAL */ = SDAI.TYPEOF( ((IT1.GROUP_REF(eMAPPED_ITEM.self))?.MAPPING_SOURCE)?.MAPPED_REPRESENTATION, 
    ...
    public static func WHERE_wr2(SELF: eMECHANICAL_DESIGN_SHADED_PRESENTATION_AREA.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP3 /* SDAI.SET<sMECHANICAL_DESIGN_SHADED_PRESENTATION_AREA_ITEMS>[1:nil] ? */ = _TEMP2?
        .QUERY{ MI1 in 
          ...
          let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( ((MI1.GROUP_REF(eMAPPED_ITEM.self))?.MAPPING_SOURCE)?.MAPPED_REPRESENTATION, 
            IS: ePRESENTATION_VIEW.self )
          return _TEMP1
          // END QUERY BODY
         }
    ...
    public static func WHERE_wr4(SELF: eMECHANICAL_DESIGN_SHADED_PRESENTATION_AREA.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP2 /* SDAI.BAG<SDAI.GENERIC_ENTITY> */ = _TEMP1
        .QUERY{ PSIZE in 
          ...
          let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( (PSIZE.SIZE)?.PLACEMENT, IS: eAXIS2_PLACEMENT_2D.self )
          return _TEMP1
          // END QUERY BODY
         }
      let _TEMP3 /* SDAI.INTEGER? */ = SDAI.SIZEOF( _TEMP2 )
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_mechanical_design_shaded_presentation_area``
*/
  public final class eMECHANICAL_DESIGN_SHADED_PRESENTATION_AREA : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _mechanical_design_shaded_presentation_area.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _mechanical_design_shaded_presentation_area.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _mechanical_design_shaded_presentation_area.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _mechanical_design_shaded_presentation_area.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _mechanical_design_shaded_presentation_area.WHERE_wr5(SELF: instance.pRef)
      return result
    }
