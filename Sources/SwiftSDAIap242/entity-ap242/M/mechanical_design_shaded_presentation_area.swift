/* file: mechanical_design_shaded_presentation_area.swift 	 generated: Fri Sep 26 17:24:11 2025 */
    ...
    public static func WHERE_wr5(SELF: eMECHANICAL_DESIGN_SHADED_PRESENTATION_AREA?) -> SDAI.LOGICAL {
      ...
      let _TEMP4 = _TEMP3.QUERY{ PV in 
          ...
          let _TEMP6 = _TEMP5?.QUERY{ CI in 
              ...
              let _TEMP7 = SDAI.FORCE_OPTIONAL(_TEMP2) * SDAI.FORCE_OPTIONAL(_TEMP6)
              let _TEMP8 = SDAI.SIZEOF(_TEMP7)
...
```
*/
  public final class eMECHANICAL_DESIGN_SHADED_PRESENTATION_AREA : SDAI.EntityReference, @unchecked Sendable {
