/* file: mapped_item.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMAPPED_ITEM/PartialEntity``
*/
  public final class eMAPPED_ITEM : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eMAPPED_ITEM.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eMAPPED_ITEM.PartialEntity
    ...
    public var MAPPING_SOURCE: eREPRESENTATION_MAP.PRef {
      get {
        let originalValue = self.partialEntity._mapping_source
    ...
    public var MAPPING_TARGET: eREPRESENTATION_ITEM.PRef {
      get {
        let originalValue = self.partialEntity._mapping_target
    ...
    public var ALIGNMENT: tTEXT_ALIGNMENT?  {
      get {
        let originalValue = sub_eANNOTATION_TEXT_CHARACTER?.partialEntity._alignment
        let value = tTEXT_ALIGNMENT( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eANNOTATION_TEXT_CHARACTER?.partialEntity
          else { return }
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eMAPPED_ITEM.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eMAPPED_ITEM.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
