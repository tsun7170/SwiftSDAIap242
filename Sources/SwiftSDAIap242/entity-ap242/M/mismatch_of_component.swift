/* file: mismatch_of_component.swift 	 generated: Thu Dec 25 18:13:23 2025 */
...
*/
  ...
  public final class _mismatch_of_component : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_mismatch_of_component``
*/
  public final class eMISMATCH_OF_COMPONENT : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _mismatch_of_component.self
    }
    /// partial entity reference
    public let partialEntity: _mismatch_of_component
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_mismatch_of_component.self) else { return nil }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF._mismatch_of_component :
