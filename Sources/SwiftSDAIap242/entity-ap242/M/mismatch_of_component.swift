/* file: mismatch_of_component.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _mismatch_of_component : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _measured_data_type__getter(SELF: eMISMATCH_OF_COMPONENT) -> nA3MA_MEASURED_DATA_TYPE_NAME {
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _detected_difference_types__getter(SELF: eMISMATCH_OF_COMPONENT) -> SDAI.LIST<
...
```
*/
  public final class eMISMATCH_OF_COMPONENT : SDAI.EntityReference, @unchecked Sendable {
