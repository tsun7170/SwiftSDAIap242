/* file: mismatch_of_points.swift 	 generated: Thu Mar  5 17:54:18 2026 */
      ...
      internal func _comparing_element_types__getter(SELF: eMISMATCH_OF_POINTS.PRef) -> SDAI.LIST<
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_ELEMENT_TYPE_NAME> */ = SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>(
          bound1:SDAI.UNWRAP(1), bound2:1,  ([ SDAI.AIE(nA3MS_ELEMENT_TYPE_NAME(/*nA3M_ELEMENT_TYPE_NAME*/
            ETNS_VERTEX_POINT)) ] as [SDAI.AggregationInitializerElement<nA3MS_ELEMENT_TYPE_NAME>]) )
        let value = _TEMP1
      ...
      internal func _detected_difference_types__getter(SELF: eMISMATCH_OF_POINTS.PRef) -> SDAI.LIST<
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_DETECTED_DIFFERENCE_TYPE_NAME> */ = SDAI.LIST<
          ...
          bound1:SDAI.UNWRAP(1), bound2:1,  ([ SDAI.AIE(nA3MS_DETECTED_DIFFERENCE_TYPE_NAME(/*
            nA3M_DETECTED_DIFFERENCE_TYPE_NAME*/DDNS_NO_ELEMENT)) ] as [SDAI.AggregationInitializerElement<
            nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>]) )
        let value = _TEMP1
        return SDAI.UNWRAP( value )
      }
