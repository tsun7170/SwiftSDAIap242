/* file: mismatch_of_points.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _mismatch_of_points : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _comparing_element_types__getter(SELF: eMISMATCH_OF_POINTS) -> SDAI.LIST<
      ...
      let _TEMP1 = SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: SDAI.INTEGER(
        1), ([SDAI.AIE(nA3MS_ELEMENT_TYPE_NAME(/*nA3M_ELEMENT_TYPE_NAME*/ETNS_VERTEX_POINT))] 
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _compared_element_types__getter(SELF: eMISMATCH_OF_POINTS) -> SDAI.LIST<
      nA3MS_ELEMENT_TYPE_NAME>/*[1:1]*/  {
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _measured_data_type__getter(SELF: eMISMATCH_OF_POINTS) -> nA3MS_MEASURED_DATA_TYPE_NAME {
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _detected_difference_types__getter(SELF: eMISMATCH_OF_POINTS) -> SDAI.LIST<
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _accuracy_types__getter(SELF: eMISMATCH_OF_POINTS) -> SDAI.LIST<nA3MS_ACCURACY_TYPE_NAME>
      /*[0:0]*/  {
    ...
    public static func WHERE_wr1(SELF: eMISMATCH_OF_POINTS?) -> SDAI.LOGICAL {
...
```
*/
  public final class eMISMATCH_OF_POINTS : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _mismatch_of_points.WHERE_wr1(SELF: instance)
      return result
    }
