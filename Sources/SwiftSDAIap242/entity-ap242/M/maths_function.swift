/* file: maths_function.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eMATHS_FUNCTION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var OPERANDS: (SDAI.LIST<eMATHS_FUNCTION.PRef>/*[2:nil]*/ )?  {
      get {
        if let resolved = eMULTIPLE_ARITY_GENERIC_EXPRESSION.PartialEntity._operands__provider(complex: self.complexEntity) {
          let value = SDAI.LIST<eMATHS_FUNCTION.PRef>(resolved._operands__getter(
            complex: self.complexEntity))
          return value
        }
        else {
          return SDAI.LIST<eMATHS_FUNCTION.PRef>(sub_eSERIES_COMPOSED_FUNCTION?.super_eMULTIPLE_ARITY_GENERIC_EXPRESSION
    ...
    public var OPERAND: eMATHS_SPACE.PRef?  {
      get {
        return eMATHS_SPACE.PRef( sub_eRESTRICTION_FUNCTION?.super_eUNARY_GENERIC_EXPRESSION.partialEntity
          ._operand )
      }
      set(newValue) {
