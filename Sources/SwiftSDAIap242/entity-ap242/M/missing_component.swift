/* file: missing_component.swift 	 generated: Mon Dec 15 17:41:04 2025 */
...
*/
  ...
  public final class _missing_component : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
    ...
    @_documentation(visibility:public)
    internal func _measured_data_type__getter(SELF: eMISSING_COMPONENT.PRef) -> nA3MA_MEASURED_DATA_TYPE_NAME {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_missing_component``
*/
  public final class eMISSING_COMPONENT : SDAI.EntityReference, SDAIDualModeReference, @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _missing_component.self
    }
    /// partial entity reference
    public let partialEntity: _missing_component
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_missing_component.self) else { return nil }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF._missing_component :
