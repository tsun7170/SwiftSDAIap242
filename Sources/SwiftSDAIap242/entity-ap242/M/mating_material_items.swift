/* file: mating_material_items.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- mating_material_items (line:20346 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _mating_material_items : SDAI.PartialEntity {
...
```
*/
  public final class eMATING_MATERIAL_ITEMS : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eMATING_MATERIAL_ITEMS`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "MATING_MATERIAL_ITEMS", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "ROLE", keyPath: \eMATING_MATERIAL_ITEMS.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eMATING_MATERIAL_ITEMS.ITEMS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_GROUP", keyPath: \eMATING_MATERIAL_ITEMS.ASSIGNED_GROUP, 
