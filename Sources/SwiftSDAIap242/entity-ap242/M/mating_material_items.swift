/* file: mating_material_items.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _mating_material_items : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _assigned_group: eMATING_MATERIAL	//EXPLICIT REDEFINITION(eGROUP_ASSIGNMENT) */

    /// EXPLICIT ATTRIBUTE 
    public internal(set) var _items: SDAI.SET<ePRODUCT_DEFINITION>/*[1:nil]*/  // PLAIN EXPLICIT ATTRIBUTE
    ...
    public init(ITEMS: SDAI.SET<ePRODUCT_DEFINITION>/*[1:nil]*/ ) {
      self._items = ITEMS
...
```
*/
  public final class eMATING_MATERIAL_ITEMS : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var ITEMS: SDAI.SET<ePRODUCT_DEFINITION>/*[1:nil]*/  {
      get {
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMATING_MATERIAL_ITEMS`` )
    public var ASSIGNED_GROUP: eMATING_MATERIAL {
      get {
        if let resolved = _group_assignment._assigned_group__provider(complex: self.complexEntity) {
          let value = SDAI.UNWRAP( eMATING_MATERIAL(resolved._assigned_group__getter(
            complex: self.complexEntity)) )
          return value
        }
        else {
          return SDAI.UNWRAP( eMATING_MATERIAL(super_eGROUP_ASSIGNMENT.partialEntity._assigned_group) )
        }
      }
      set(newValue) {
