/* file: definitional_product_definition_usage.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _definitional_product_definition_usage : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func UNIQUE_ur1(SELF: SDAI.EntityReference) -> AnyHashable? {
      guard let SELF = SELF as? eDEFINITIONAL_PRODUCT_DEFINITION_USAGE else { return nil }
      //JOINT UNIQUE RULE

      var attributes: Array<AnyHashable> = []

      let attr1 = SELF.RELATING_PRODUCT_DEFINITION
      attributes.append( AnyHashable(attr1) )
      let attr2 = SELF.RELATED_PRODUCT_DEFINITION
...
```
*/
  public final class eDEFINITIONAL_PRODUCT_DEFINITION_USAGE : SDAI.EntityReference, @unchecked Sendable {
