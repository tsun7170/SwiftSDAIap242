/* file: different_component_identification_via_multi_level_reference.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _different_component_identification_via_multi_level_reference : SDAI.PartialEntity
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_different_component_identification_via_multi_level_reference``
*/
  public final class eDIFFERENT_COMPONENT_IDENTIFICATION_VIA_MULTI_LEVEL_REFERENCE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _different_component_identification_via_multi_level_reference.self
    }
    /// partial entity reference
    public let partialEntity: _different_component_identification_via_multi_level_reference
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_different_component_identification_via_multi_level_reference.self) else { return nil }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
  ._different_component_identification_via_multi_level_reference :
