/* file: data_quality_criterion_measurement_association.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
/*
  ...
  END_ENTITY; -- data_quality_criterion_measurement_association (line:11486 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_QUALITY_CRITERION_MEASUREMENT_ASSOCIATION/PartialEntity``
*/
  public final class eDATA_QUALITY_CRITERION_MEASUREMENT_ASSOCIATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eDATA_QUALITY_CRITERION_MEASUREMENT_ASSOCIATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eDATA_QUALITY_CRITERION_MEASUREMENT_ASSOCIATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eDATA_QUALITY_CRITERION_MEASUREMENT_ASSOCIATION.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_QUALITY_CRITERION_MEASUREMENT_ASSOCIATION`` )
    public var RELATED_REPRESENTATION_ITEM: eDATA_QUALITY_MEASUREMENT_REQUIREMENT.PRef {
      get {
    ...
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_QUALITY_CRITERION_MEASUREMENT_ASSOCIATION`` )
    public var RELATING_REPRESENTATION_ITEM: eDATA_QUALITY_CRITERION.PRef {
      get {
        return SDAI.UNWRAP( eDATA_QUALITY_CRITERION.PRef( super_eREPRESENTATION_ITEM_RELATIONSHIP
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eDATA_QUALITY_CRITERION_MEASUREMENT_ASSOCIATION.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "DATA_QUALITY_CRITERION_MEASUREMENT_ASSOCIATION", 
      ...
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eDATA_QUALITY_CRITERION_MEASUREMENT_ASSOCIATION.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATED_REPRESENTATION_ITEM", 
        keyPath: \eDATA_QUALITY_CRITERION_MEASUREMENT_ASSOCIATION.RELATED_REPRESENTATION_ITEM, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eDATA_QUALITY_CRITERION_MEASUREMENT_ASSOCIATION.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATING_REPRESENTATION_ITEM", 
        keyPath: \eDATA_QUALITY_CRITERION_MEASUREMENT_ASSOCIATION.RELATING_REPRESENTATION_ITEM, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_QUALITY_CRITERION_MEASUREMENT_ASSOCIATION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _relating_representation_item: eDATA_QUALITY_CRITERION.PRef	//EXPLICIT REDEFINITION(eREPRESENTATION_ITEM_RELATIONSHIP) */

      /* override var _related_representation_item: eDATA_QUALITY_MEASUREMENT_REQUIREMENT.PRef	//EXPLICIT REDEFINITION(eREPRESENTATION_ITEM_RELATIONSHIP) */
