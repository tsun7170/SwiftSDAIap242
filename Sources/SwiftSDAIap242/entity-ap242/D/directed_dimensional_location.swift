/* file: directed_dimensional_location.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _directed_dimensional_location : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_directed_dimensional_location``
*/
  public final class eDIRECTED_DIMENSIONAL_LOCATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _directed_dimensional_location.self
    }
    /// partial entity reference
    public let partialEntity: _directed_dimensional_location
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_directed_dimensional_location.self) else { return nil }
