/* file: different_volume.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eDIFFERENT_VOLUME : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eDIFFERENT_VOLUME.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eDIFFERENT_VOLUME.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
