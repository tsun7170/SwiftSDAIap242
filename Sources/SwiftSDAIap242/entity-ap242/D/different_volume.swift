/* file: different_volume.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _different_volume : SDAI.PartialEntity, SDAI.InitializableByVoid, @unchecked Sendable {
    ...
    /// - gut of derived attribute logic
    @_documentation(visibility:public)
    internal func _measured_data_type__getter(SELF: eDIFFERENT_VOLUME.PRef) -> nA3MS_MEASURED_DATA_TYPE_NAME {
    ...
    internal func _detected_difference_types__getter(SELF: eDIFFERENT_VOLUME.PRef) -> SDAI.LIST<
      ...
      let _TEMP1 /* SDAI.AGGREGATE<nA3M_DETECTED_DIFFERENCE_TYPE_NAME> */ = SDAI.LIST<
        nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: SDAI.INTEGER(1),  ([ 
          ...
          DDNS_VOLUME_MEASURE)) ] as [SDAI.AggregationInitializerElement<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>]) )
      let value = _TEMP1
      return SDAI.UNWRAP( value )
    }
    ...
    /// - gut of derived attribute logic
    @_documentation(visibility:public)
    internal func _accuracy_types__getter(SELF: eDIFFERENT_VOLUME.PRef) -> SDAI.LIST<nA3MS_ACCURACY_TYPE_NAME>
      /*[1:1]*/  {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_different_volume``
*/
  public final class eDIFFERENT_VOLUME : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _different_volume.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _different_volume.WHERE_wr2(SELF: instance.pRef)
      return result
    }
