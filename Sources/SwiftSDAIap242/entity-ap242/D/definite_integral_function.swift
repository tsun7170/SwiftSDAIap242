/* file: definite_integral_function.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- definite_integral_function (line:11855 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDEFINITE_INTEGRAL_FUNCTION/PartialEntity``
*/
  public final class eDEFINITE_INTEGRAL_FUNCTION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eDEFINITE_INTEGRAL_FUNCTION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eDEFINITE_INTEGRAL_FUNCTION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eDEFINITE_INTEGRAL_FUNCTION.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDEFINITE_INTEGRAL_FUNCTION`` )
    public var VARIABLE_OF_INTEGRATION: tINPUT_SELECTOR {
      get {
        let originalValue = self.partialEntity._variable_of_integration
        let value = SDAI.UNWRAP( tINPUT_SELECTOR( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eDEFINITE_INTEGRAL_FUNCTION.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eDEFINITE_INTEGRAL_FUNCTION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eDEFINITE_INTEGRAL_FUNCTION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "VARIABLE_OF_INTEGRATION", 
        keyPath: \eDEFINITE_INTEGRAL_FUNCTION.VARIABLE_OF_INTEGRATION, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "INTEGRAND", 
        keyPath: \eDEFINITE_INTEGRAL_FUNCTION.INTEGRAND, 
        kind: .derived, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "UPPER_LIMIT_POS_INFINITY", 
        keyPath: \eDEFINITE_INTEGRAL_FUNCTION.UPPER_LIMIT_POS_INFINITY, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OPERAND", 
        keyPath: \eDEFINITE_INTEGRAL_FUNCTION.OPERAND, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "LOWER_LIMIT_NEG_INFINITY", 
        keyPath: \eDEFINITE_INTEGRAL_FUNCTION.LOWER_LIMIT_NEG_INFINITY, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DOMAIN", 
        keyPath: \eDEFINITE_INTEGRAL_FUNCTION.DOMAIN, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "RANGE", 
        keyPath: \eDEFINITE_INTEGRAL_FUNCTION.RANGE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDEFINITE_INTEGRAL_FUNCTION``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      /// DERIVE ATTRIBUTE
      @_documentation(visibility:public)
      internal func _integrand__getter(SELF: eDEFINITE_INTEGRAL_FUNCTION.PRef) -> eMATHS_FUNCTION.PRef?  {
      ...
      public static func WHERE_wr1(SELF: eDEFINITE_INTEGRAL_FUNCTION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* sTUPLE_SPACE? */ = SELF.INTEGRAND?.RANGE
        let _TEMP2 /* SDAI.BOOLEAN? */ = SPACE_IS_CONTINUUM( eMATHS_SPACE.PRef(/*sTUPLE_SPACE*/_TEMP1) )
        return SDAI.LOGICAL(_TEMP2)
      }
      public static func WHERE_wr2(SELF: eDEFINITE_INTEGRAL_FUNCTION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* sTUPLE_SPACE? */ = SELF.INTEGRAND?.DOMAIN
        let _TEMP2 /* SDAI.BOOLEAN? */ = 
            DEFINITE_INTEGRAL_CHECK( 
            DOMAIN: _TEMP1, 
            VRBLINT: SELF.VARIABLE_OF_INTEGRATION, 
      ...
      public init(
        VARIABLE_OF_INTEGRATION: tINPUT_SELECTOR, 
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( VARIABLE_OF_INTEGRATION: original._variable_of_integration, LOWER_LIMIT_NEG_INFINITY: original._lower_limit_neg_infinity, UPPER_LIMIT_POS_INFINITY: original._upper_limit_pos_infinity )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]VARIABLE_OF_INTEGRATION for partial entity(\(Self.entityName)) constructor"); return nil }

        guard case .success(let p1) = exchangeStructure.recoverRequiredParameter(as: SDAI.BOOLEAN.self, from: parameters[1])
        else { exchangeStructure.add(errorContext: "while recovering parameter [1]LOWER_LIMIT_NEG_INFINITY for partial entity(\(Self.entityName)) constructor"); return nil }

        guard case .success(let p2) = exchangeStructure.recoverRequiredParameter(as: SDAI.BOOLEAN.self, from: parameters[2])
        else { exchangeStructure.add(errorContext: "while recovering parameter [2]UPPER_LIMIT_POS_INFINITY for partial entity(\(Self.entityName)) constructor"); return nil }
