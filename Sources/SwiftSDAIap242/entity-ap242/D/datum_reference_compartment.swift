/* file: datum_reference_compartment.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- datum_reference_compartment (line:11715 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _datum_reference_compartment : SDAI.PartialEntity {
    ...
    internal private(set) weak var _owner: eDATUM_SYSTEM?
    /// INVERSE SIMPLE ATTR SUPPORT(ADDER)
    internal func _owner__observeAddedReference(in complex: SDAI.ComplexEntity) {
      guard let newSource = complex.entityReference(eDATUM_SYSTEM.self) else { return }
    ...
    internal func _owner__observeRemovedReference(in complex: SDAI.ComplexEntity) {
      guard let _ = complex.entityReference(eDATUM_SYSTEM.self) else { return }
      self._owner = nil
    }
...
```
*/
  public final class eDATUM_REFERENCE_COMPARTMENT : SDAI.EntityReference {
    ...
    /// observing eDATUM_SYSTEM .CONSTITUENTS
    /// - origin: SELF( ``eDATUM_REFERENCE_COMPARTMENT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "DATUM_REFERENCE_COMPARTMENT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "PRODUCT_DEFINITIONAL", keyPath: \eDATUM_REFERENCE_COMPARTMENT.PRODUCT_DEFINITIONAL, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OWNER", keyPath: \eDATUM_REFERENCE_COMPARTMENT.OWNER, 
        kind: .inverse, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eDATUM_REFERENCE_COMPARTMENT.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OF_SHAPE", keyPath: \eDATUM_REFERENCE_COMPARTMENT.OF_SHAPE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "MODIFIERS", keyPath: \eDATUM_REFERENCE_COMPARTMENT.MODIFIERS, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "BASE", keyPath: \eDATUM_REFERENCE_COMPARTMENT.BASE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "BASE_COMMON_DATUM_LIST", keyPath: \eDATUM_REFERENCE_COMPARTMENT.BASE_COMMON_DATUM_LIST, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eDATUM_REFERENCE_COMPARTMENT.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eDATUM_REFERENCE_COMPARTMENT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
