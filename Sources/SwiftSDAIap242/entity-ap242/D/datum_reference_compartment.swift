/* file: datum_reference_compartment.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _datum_reference_compartment : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //internal private(set) weak var _owner: eDATUM_SYSTEM? 	(SEE CORRESPONDING ENTITY REFERENCE DEFINITION)
...
```
*/
  public final class eDATUM_REFERENCE_COMPARTMENT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var OWNER: eDATUM_SYSTEM?  {
    get {
      if let cached = cachedValue(derivedAttributeName:"OWNER") {
        return cached.value as! eDATUM_SYSTEM? 
      }
