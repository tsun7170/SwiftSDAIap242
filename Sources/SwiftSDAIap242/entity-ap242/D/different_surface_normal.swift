/* file: different_surface_normal.swift 	 generated: Thu Mar  5 17:54:18 2026 */
      ...
      internal func _accuracy_types__getter(SELF: eDIFFERENT_SURFACE_NORMAL.PRef) -> SDAI.LIST<
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_ACCURACY_TYPE_NAME> */ = SDAI.LIST<nA3MS_ACCURACY_TYPE_NAME>(
          bound1:SDAI.UNWRAP(1), bound2:1,  ([ SDAI.AIE(nA3MS_ACCURACY_TYPE_NAME(/*nA3M_ACCURACY_TYPE_NAME*/
            ATNS_PLANE_ANGLE_MEASURE)) ] as [SDAI.AggregationInitializerElement<nA3MS_ACCURACY_TYPE_NAME>]) )
        let value = _TEMP1
        return SDAI.UNWRAP( value )
      }
