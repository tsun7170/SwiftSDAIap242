/* file: different_surface_normal.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- different_surface_normal (line:12283 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	different_surface_normal
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_SURFACE_NORMAL/PartialEntity``
*/
  public final class eDIFFERENT_SURFACE_NORMAL : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eDIFFERENT_SURFACE_NORMAL>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eDIFFERENT_SURFACE_NORMAL.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eDIFFERENT_SURFACE_NORMAL.PartialEntity
    ...
    public var super_eDIFFERENT_SURFACE_NORMAL: eDIFFERENT_SURFACE_NORMAL { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_SURFACE_NORMAL`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eDIFFERENT_SURFACE_NORMAL.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eDIFFERENT_SURFACE_NORMAL.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eDIFFERENT_SURFACE_NORMAL.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eDIFFERENT_SURFACE_NORMAL.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ACCURACY_TYPES", 
        keyPath: \eDIFFERENT_SURFACE_NORMAL.ACCURACY_TYPES, 
      ...
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", 
        keyPath: \eDIFFERENT_SURFACE_NORMAL.DETECTED_DIFFERENCE_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", 
        keyPath: \eDIFFERENT_SURFACE_NORMAL.COMPARED_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", 
        keyPath: \eDIFFERENT_SURFACE_NORMAL.MEASURED_DATA_TYPE, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eDIFFERENT_SURFACE_NORMAL.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eDIFFERENT_SURFACE_NORMAL.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", 
        keyPath: \eDIFFERENT_SURFACE_NORMAL.COMPARING_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "APPLIED_VALUES", 
        keyPath: \eDIFFERENT_SURFACE_NORMAL.APPLIED_VALUES, 
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      internal func _comparing_element_types__getter(complex: SDAI.ComplexEntity) -> SDAI.LIST<
        ...
        let SELF = complex.entityReference( eDIFFERENT_SURFACE_NORMAL.self )!
        return SDAI.UNWRAP( SDAI.LIST<nA3M_ELEMENT_TYPE_NAME>(SELF.COMPARING_ELEMENT_TYPES) )
      }
      /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _comparing_element_types__getter(SELF: eDIFFERENT_SURFACE_NORMAL.PRef) -> SDAI.LIST<
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _compared_element_types__getter(SELF: eDIFFERENT_SURFACE_NORMAL.PRef) -> SDAI.LIST<
        nA3MS_ELEMENT_TYPE_NAME>/*[1:1]*/  {
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _measured_data_type__getter(SELF: eDIFFERENT_SURFACE_NORMAL.PRef) -> 
        nA3MS_MEASURED_DATA_TYPE_NAME {
        let value = nA3MS_MEASURED_DATA_TYPE_NAME(/*nA3M_MEASURED_DATA_TYPE_NAME*/MDNS_PLANE_ANGLE_MEASURE)
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _detected_difference_types__getter(SELF: eDIFFERENT_SURFACE_NORMAL.PRef) -> SDAI.LIST<
        nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>/*[2:2]*/  {
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _accuracy_types__getter(SELF: eDIFFERENT_SURFACE_NORMAL.PRef) -> SDAI.LIST<
        nA3MS_ACCURACY_TYPE_NAME>/*[1:1]*/  {

        let _TEMP1 /* SDAI.AGGREGATE<nA3M_ACCURACY_TYPE_NAME> */ = SDAI.LIST<nA3MS_ACCURACY_TYPE_NAME>(
          bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: SDAI.INTEGER(1),  ([ 
            SDAI.AIE(nA3MS_ACCURACY_TYPE_NAME(/*nA3M_ACCURACY_TYPE_NAME*/ATNS_PLANE_ANGLE_MEASURE)) ] 
      ...
      public static func WHERE_wr1(SELF: eDIFFERENT_SURFACE_NORMAL.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eDIFFERENT_SURFACE_NORMAL.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDIFFERENT_SURFACE_NORMAL.PartialEntity :
