/* file: different_surface_normal.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _different_surface_normal : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _comparing_element_types__getter(SELF: eDIFFERENT_SURFACE_NORMAL) -> SDAI.LIST<
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _compared_element_types__getter(SELF: eDIFFERENT_SURFACE_NORMAL) -> SDAI.LIST<
      nA3MS_ELEMENT_TYPE_NAME>/*[1:1]*/  {
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _measured_data_type__getter(SELF: eDIFFERENT_SURFACE_NORMAL) -> 
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _detected_difference_types__getter(SELF: eDIFFERENT_SURFACE_NORMAL) -> SDAI.LIST<
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _accuracy_types__getter(SELF: eDIFFERENT_SURFACE_NORMAL) -> SDAI.LIST<
      ...
      let _TEMP1 = SDAI.LIST<nA3MS_ACCURACY_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: SDAI.INTEGER(
        1), ([SDAI.AIE(nA3MS_ACCURACY_TYPE_NAME(/*nA3M_ACCURACY_TYPE_NAME*/ATNS_PLANE_ANGLE_MEASURE))] 
    ...
    public static func WHERE_wr1(SELF: eDIFFERENT_SURFACE_NORMAL?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eDIFFERENT_SURFACE_NORMAL?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eDIFFERENT_SURFACE_NORMAL : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _different_surface_normal.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _different_surface_normal.WHERE_wr2(SELF: instance)
      return result
    }
