/* file: different_number_of_topological_elements.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _different_number_of_topological_elements : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_different_number_of_topological_elements``
*/
  public final class eDIFFERENT_NUMBER_OF_TOPOLOGICAL_ELEMENTS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _different_number_of_topological_elements.self
    }
    /// partial entity reference
    public let partialEntity: _different_number_of_topological_elements
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_different_number_of_topological_elements.self) else { return nil }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF._different_number_of_topological_elements :
