/* file: different_number_of_topological_elements.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _different_number_of_topological_elements : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _compared_element_types__getter(SELF: eDIFFERENT_NUMBER_OF_TOPOLOGICAL_ELEMENTS) -> SDAI.LIST<
      nA3MS_ELEMENT_TYPE_NAME>/*[2:2]*/  {

      let _TEMP1 = SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(2)), bound2: SDAI.INTEGER(
        2), ([SDAI.AIE(nA3MS_ELEMENT_TYPE_NAME(/*nA3M_ELEMENT_TYPE_NAME*/ETNS_MANIFOLD_SOLID_BREP)), 
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _measured_data_type__getter(SELF: eDIFFERENT_NUMBER_OF_TOPOLOGICAL_ELEMENTS) -> 
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _detected_difference_types__getter(SELF: eDIFFERENT_NUMBER_OF_TOPOLOGICAL_ELEMENTS) -> 
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _accuracy_types__getter(SELF: eDIFFERENT_NUMBER_OF_TOPOLOGICAL_ELEMENTS) -> SDAI.LIST<
...
```
*/
  public final class eDIFFERENT_NUMBER_OF_TOPOLOGICAL_ELEMENTS : SDAI.EntityReference, @unchecked Sendable {
