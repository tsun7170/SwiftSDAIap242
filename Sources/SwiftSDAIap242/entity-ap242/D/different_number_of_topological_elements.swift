/* file: different_number_of_topological_elements.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- different_number_of_topological_elements (line:12217 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _different_number_of_topological_elements : SDAI.PartialEntity {
...
```
*/
  public final class eDIFFERENT_NUMBER_OF_TOPOLOGICAL_ELEMENTS : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eDIFFERENT_NUMBER_OF_TOPOLOGICAL_ELEMENTS`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "DIFFERENT_NUMBER_OF_TOPOLOGICAL_ELEMENTS", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ACCURACY_TYPES", keyPath: \eDIFFERENT_NUMBER_OF_TOPOLOGICAL_ELEMENTS.ACCURACY_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", keyPath: \eDIFFERENT_NUMBER_OF_TOPOLOGICAL_ELEMENTS.DETECTED_DIFFERENCE_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", keyPath: \eDIFFERENT_NUMBER_OF_TOPOLOGICAL_ELEMENTS.COMPARED_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", keyPath: \eDIFFERENT_NUMBER_OF_TOPOLOGICAL_ELEMENTS.MEASURED_DATA_TYPE, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eDIFFERENT_NUMBER_OF_TOPOLOGICAL_ELEMENTS.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eDIFFERENT_NUMBER_OF_TOPOLOGICAL_ELEMENTS.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", keyPath: \eDIFFERENT_NUMBER_OF_TOPOLOGICAL_ELEMENTS.COMPARING_ELEMENT_TYPES, 
