/* file: drawing_sheet_layout.swift 	 generated: Mon Dec 15 17:41:04 2025 */
...
*/
  ...
  public final class _drawing_sheet_layout : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_drawing_sheet_layout``
*/
  public final class eDRAWING_SHEET_LAYOUT : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _drawing_sheet_layout.self
    }
    /// partial entity reference
    public let partialEntity: _drawing_sheet_layout
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_drawing_sheet_layout.self) else { return nil }
