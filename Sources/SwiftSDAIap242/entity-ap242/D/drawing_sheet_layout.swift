/* file: drawing_sheet_layout.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- drawing_sheet_layout (line:13216 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDRAWING_SHEET_LAYOUT/PartialEntity``
*/
  public final class eDRAWING_SHEET_LAYOUT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eDRAWING_SHEET_LAYOUT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eDRAWING_SHEET_LAYOUT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eDRAWING_SHEET_LAYOUT.PartialEntity

    //MARK: SUPERTYPES
    public let super_eREPRESENTATION: eREPRESENTATION 	// [1]
    public let super_eSYMBOL_REPRESENTATION: eSYMBOL_REPRESENTATION 	// [2]
    public let super_eDRAUGHTING_SYMBOL_REPRESENTATION: eDRAUGHTING_SYMBOL_REPRESENTATION 	// [3]
    public var super_eDRAWING_SHEET_LAYOUT: eDRAWING_SHEET_LAYOUT { return self } 	// [4]
    ...
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDRAUGHTING_SYMBOL_REPRESENTATION`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eDRAWING_SHEET_LAYOUT.PartialEntity.self) else { return nil }
      ...
      guard let super3 = complexEntity?.entityReference(eDRAUGHTING_SYMBOL_REPRESENTATION.self) else { return nil }
      self.super_eDRAUGHTING_SYMBOL_REPRESENTATION = super3
