/* file: data_quality_inspection_result_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _data_quality_inspection_result_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /// EXPLICIT ATTRIBUTE 
    public internal(set) var _criteria_inspected: eDATA_QUALITY_CRITERIA_REPRESENTATION // PLAIN EXPLICIT ATTRIBUTE
    ...
    public static func WHERE_wr1(SELF: eDATA_QUALITY_INSPECTION_RESULT_REPRESENTATION?) -> SDAI.LOGICAL {
      ...
      let _TEMP3 = _TEMP2?.QUERY{ Q in 
          ...
          let _TEMP1 = SDAI.TYPEOF(Q, IS: eDATA_QUALITY_INSPECTION_RESULT.self)
          return _TEMP1 }
      let _TEMP4 = SDAI.SIZEOF(_TEMP3)
      let _TEMP5 = _TEMP4 > SDAI.FORCE_OPTIONAL(SDAI.INTEGER(0))
      return _TEMP5
    }
    public static func WHERE_wr2(SELF: eDATA_QUALITY_INSPECTION_RESULT_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = INSPECTED_PRODUCT_DEFINITION(SELF)
    ...
    public init(CRITERIA_INSPECTED: eDATA_QUALITY_CRITERIA_REPRESENTATION) {
    ...
    public required convenience init?(parameters: [P21Decode.ExchangeStructure.Parameter], exchangeStructure: P21Decode.ExchangeStructure) {
      ...
      guard case .success(let p0) = exchangeStructure.recoverRequiredParameter(as: 
        eDATA_QUALITY_CRITERIA_REPRESENTATION.self, from: parameters[0])
...
```
*/
  public final class eDATA_QUALITY_INSPECTION_RESULT_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _data_quality_inspection_result_representation.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _data_quality_inspection_result_representation.WHERE_wr2(SELF: instance)
      return result
    }
