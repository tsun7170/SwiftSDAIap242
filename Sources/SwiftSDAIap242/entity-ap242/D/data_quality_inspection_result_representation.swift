/* file: data_quality_inspection_result_representation.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- data_quality_inspection_result_representation (line:11571 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eDATA_QUALITY_INSPECTION_RESULT_REPRESENTATION : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eDATA_QUALITY_INSPECTION_RESULT_REPRESENTATION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "DATA_QUALITY_INSPECTION_RESULT_REPRESENTATION", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "CRITERIA_INSPECTED", keyPath: \eDATA_QUALITY_INSPECTION_RESULT_REPRESENTATION.CRITERIA_INSPECTED, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eDATA_QUALITY_INSPECTION_RESULT_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eDATA_QUALITY_INSPECTION_RESULT_REPRESENTATION.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eDATA_QUALITY_INSPECTION_RESULT_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "APPLIED_GENERAL_ACCURACY", keyPath: \eDATA_QUALITY_INSPECTION_RESULT_REPRESENTATION.APPLIED_GENERAL_ACCURACY, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eDATA_QUALITY_INSPECTION_RESULT_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eDATA_QUALITY_INSPECTION_RESULT_REPRESENTATION.NAME, 
