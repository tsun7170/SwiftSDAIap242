/* file: directed_angle.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _directed_angle : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eDIRECTED_ANGLE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.TYPEOF(SELF.OF_SHAPE.DEFINITION, IS: eFEATURE_COMPONENT_DEFINITION.self)
      return _TEMP1
    }
    public static func WHERE_wr2(SELF: eDIRECTED_ANGLE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = GET_SHAPE_ASPECT_PROPERTY_DEFINITION_REPRESENTATIONS(eSHAPE_ASPECT(/*eDIRECTED_ANGLE*/SELF))
    ...
    public static func WHERE_wr3(SELF: eDIRECTED_ANGLE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eDIRECTED_ANGLE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.DESCRIPTION
      let _TEMP2 = ([SDAI.AIE(SDAI.STRING("punch direction")), 
    ...
    public static func WHERE_wr5(SELF: eDIRECTED_ANGLE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eDIRECTED_ANGLE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _directed_angle.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _directed_angle.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _directed_angle.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _directed_angle.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _directed_angle.WHERE_wr5(SELF: instance)
      return result
    }
