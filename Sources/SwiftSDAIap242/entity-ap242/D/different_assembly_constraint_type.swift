/* file: different_assembly_constraint_type.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _different_assembly_constraint_type : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _measured_data_type__getter(SELF: eDIFFERENT_ASSEMBLY_CONSTRAINT_TYPE) -> 
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _detected_difference_types__getter(SELF: eDIFFERENT_ASSEMBLY_CONSTRAINT_TYPE) -> SDAI.LIST<
...
```
*/
  public final class eDIFFERENT_ASSEMBLY_CONSTRAINT_TYPE : SDAI.EntityReference, @unchecked Sendable {
