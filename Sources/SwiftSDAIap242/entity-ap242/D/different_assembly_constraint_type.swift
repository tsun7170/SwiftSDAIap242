/* file: different_assembly_constraint_type.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _different_assembly_constraint_type : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
    ...
    /// - gut of derived attribute logic
    @_documentation(visibility:public)
    internal func _detected_difference_types__getter(SELF: eDIFFERENT_ASSEMBLY_CONSTRAINT_TYPE.PRef) -> SDAI.LIST<
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_different_assembly_constraint_type``
*/
  public final class eDIFFERENT_ASSEMBLY_CONSTRAINT_TYPE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _different_assembly_constraint_type.self
    }
    /// partial entity reference
    public let partialEntity: _different_assembly_constraint_type
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_different_assembly_constraint_type.self) else { return nil }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF._different_assembly_constraint_type :
