/* file: definitional_representation_relationship_with_same_context.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- definitional_representation_relationship_with_same_context (line:11889 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDEFINITIONAL_REPRESENTATION_RELATIONSHIP_WITH_SAME_CONTEXT/PartialEntity``
*/
  public final class eDEFINITIONAL_REPRESENTATION_RELATIONSHIP_WITH_SAME_CONTEXT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eDEFINITIONAL_REPRESENTATION_RELATIONSHIP_WITH_SAME_CONTEXT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eDEFINITIONAL_REPRESENTATION_RELATIONSHIP_WITH_SAME_CONTEXT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eDEFINITIONAL_REPRESENTATION_RELATIONSHIP_WITH_SAME_CONTEXT.PartialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eDEFINITIONAL_REPRESENTATION_RELATIONSHIP_WITH_SAME_CONTEXT.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eDEFINITIONAL_REPRESENTATION_RELATIONSHIP_WITH_SAME_CONTEXT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "DEFINITIONAL_REPRESENTATION_RELATIONSHIP_WITH_SAME_CONTEXT", 
      ...
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eDEFINITIONAL_REPRESENTATION_RELATIONSHIP_WITH_SAME_CONTEXT.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "REP_1", 
        keyPath: \eDEFINITIONAL_REPRESENTATION_RELATIONSHIP_WITH_SAME_CONTEXT.REP_1, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_2", 
        keyPath: \eDEFINITIONAL_REPRESENTATION_RELATIONSHIP_WITH_SAME_CONTEXT.REP_2, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eDEFINITIONAL_REPRESENTATION_RELATIONSHIP_WITH_SAME_CONTEXT.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDEFINITIONAL_REPRESENTATION_RELATIONSHIP_WITH_SAME_CONTEXT``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: eDEFINITIONAL_REPRESENTATION_RELATIONSHIP_WITH_SAME_CONTEXT.PRef?) -> SDAI.LOGICAL {
