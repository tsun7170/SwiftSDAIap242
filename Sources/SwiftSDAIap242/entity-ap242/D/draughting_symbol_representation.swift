/* file: draughting_symbol_representation.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eDRAUGHTING_SYMBOL_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var ITEMS: SDAI.SET<sDRAUGHTING_SYMBOL_REPRESENTATION_ITEM>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<sDRAUGHTING_SYMBOL_REPRESENTATION_ITEM>( super_eREPRESENTATION
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eDRAUGHTING_SYMBOL_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eDRAUGHTING_SYMBOL_REPRESENTATION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eDRAUGHTING_SYMBOL_REPRESENTATION.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eDRAUGHTING_SYMBOL_REPRESENTATION.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _items: SDAI.SET<sDRAUGHTING_SYMBOL_REPRESENTATION_ITEM>[1:nil] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
