/* file: draughting_symbol_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _draughting_symbol_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eDRAUGHTING_SYMBOL_REPRESENTATION?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eDRAUGHTING_SYMBOL_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2?.QUERY{ ITEM in 
          ...
          let _TEMP1 = SDAI.TYPEOF(ITEM, IS: eANNOTATION_SUBFIGURE_OCCURRENCE.self)
          return _TEMP1 }
      let _TEMP4 = SDAI.SIZEOF(_TEMP3)
      let _TEMP5 = _TEMP4 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(0))
      return _TEMP5
    }
    public static func WHERE_wr3(SELF: eDRAUGHTING_SYMBOL_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eDRAUGHTING_SYMBOL_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func UNIQUE_ur1(SELF: SDAI.EntityReference) -> AnyHashable? {
      guard let SELF = SELF as? eDRAUGHTING_SYMBOL_REPRESENTATION else { return nil }
      //SIMPLE UNIQUE RULE
...
```
*/
  public final class eDRAUGHTING_SYMBOL_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _draughting_symbol_representation.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _draughting_symbol_representation.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _draughting_symbol_representation.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _draughting_symbol_representation.WHERE_wr4(SELF: instance)
      return result
    }
