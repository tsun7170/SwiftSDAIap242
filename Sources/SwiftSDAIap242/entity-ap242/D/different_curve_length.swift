/* file: different_curve_length.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _different_curve_length : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _compared_element_types__getter(SELF: eDIFFERENT_CURVE_LENGTH) -> SDAI.LIST<
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _measured_data_type__getter(SELF: eDIFFERENT_CURVE_LENGTH) -> nA3MS_MEASURED_DATA_TYPE_NAME {
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _detected_difference_types__getter(SELF: eDIFFERENT_CURVE_LENGTH) -> SDAI.LIST<
      ...
      let _TEMP1 = SDAI.LIST<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), 
        ...
        nA3M_DETECTED_DIFFERENCE_TYPE_NAME*/DDNS_LENGTH_MEASURE))] as [SDAI.AggregationInitializerElement<
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _accuracy_types__getter(SELF: eDIFFERENT_CURVE_LENGTH) -> SDAI.LIST<
    ...
    public static func WHERE_wr1(SELF: eDIFFERENT_CURVE_LENGTH?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eDIFFERENT_CURVE_LENGTH?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eDIFFERENT_CURVE_LENGTH : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _different_curve_length.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _different_curve_length.WHERE_wr2(SELF: instance)
      return result
    }
