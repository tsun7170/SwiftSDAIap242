/* file: different_angle_of_assembly_constraint.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- different_angle_of_assembly_constraint (line:12018 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _different_angle_of_assembly_constraint : SDAI.PartialEntity {
...
```
*/
  public final class eDIFFERENT_ANGLE_OF_ASSEMBLY_CONSTRAINT : SDAI.EntityReference {
    ...
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``eDIFFERENT_ANGLE_OF_ASSEMBLY_CONSTRAINT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "DIFFERENT_ANGLE_OF_ASSEMBLY_CONSTRAINT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ACCURACY_TYPES", keyPath: \eDIFFERENT_ANGLE_OF_ASSEMBLY_CONSTRAINT.ACCURACY_TYPES, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", keyPath: \eDIFFERENT_ANGLE_OF_ASSEMBLY_CONSTRAINT.DETECTED_DIFFERENCE_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", keyPath: \eDIFFERENT_ANGLE_OF_ASSEMBLY_CONSTRAINT.COMPARED_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", keyPath: \eDIFFERENT_ANGLE_OF_ASSEMBLY_CONSTRAINT.MEASURED_DATA_TYPE, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eDIFFERENT_ANGLE_OF_ASSEMBLY_CONSTRAINT.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eDIFFERENT_ANGLE_OF_ASSEMBLY_CONSTRAINT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", keyPath: \eDIFFERENT_ANGLE_OF_ASSEMBLY_CONSTRAINT.COMPARING_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: false)
