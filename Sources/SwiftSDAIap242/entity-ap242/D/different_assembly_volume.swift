/* file: different_assembly_volume.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ENTITY different_assembly_volume
    ...
    DERIVE
      ...
      SELF\a3m_equivalence_criterion.detected_difference_types : LIST [1 : 1] OF
                                          a3ma_detected_difference_type_name := [ddna_volume_measure];
    WHERE
  ...
  END_ENTITY; -- different_assembly_volume (line:12072 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	different_assembly_volume
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_ASSEMBLY_VOLUME/PartialEntity``
*/
  public final class eDIFFERENT_ASSEMBLY_VOLUME : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eDIFFERENT_ASSEMBLY_VOLUME>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eDIFFERENT_ASSEMBLY_VOLUME.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eDIFFERENT_ASSEMBLY_VOLUME.PartialEntity
    ...
    public var super_eDIFFERENT_ASSEMBLY_VOLUME: eDIFFERENT_ASSEMBLY_VOLUME { return self } 	// [7]
    ...
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_ASSEMBLY_VOLUME`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eDIFFERENT_ASSEMBLY_VOLUME.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eDIFFERENT_ASSEMBLY_VOLUME.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "DIFFERENT_ASSEMBLY_VOLUME", 
      ...
      entityDef.add(supertype: eDIFFERENT_ASSEMBLY_VOLUME.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ACCURACY_TYPES", 
        keyPath: \eDIFFERENT_ASSEMBLY_VOLUME.ACCURACY_TYPES, 
      ...
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", 
        keyPath: \eDIFFERENT_ASSEMBLY_VOLUME.DETECTED_DIFFERENCE_TYPES, 
      ...
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", 
        keyPath: \eDIFFERENT_ASSEMBLY_VOLUME.COMPARED_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", 
        keyPath: \eDIFFERENT_ASSEMBLY_VOLUME.MEASURED_DATA_TYPE, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eDIFFERENT_ASSEMBLY_VOLUME.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eDIFFERENT_ASSEMBLY_VOLUME.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", 
        keyPath: \eDIFFERENT_ASSEMBLY_VOLUME.COMPARING_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: false)
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      internal func _measured_data_type__getter(complex: SDAI.ComplexEntity) -> nA3M_MEASURED_DATA_TYPE_NAME {
        let SELF = complex.entityReference( eDIFFERENT_ASSEMBLY_VOLUME.self )!
        return SDAI.UNWRAP( nA3M_MEASURED_DATA_TYPE_NAME(SELF.MEASURED_DATA_TYPE) )
      }
      /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _measured_data_type__getter(SELF: eDIFFERENT_ASSEMBLY_VOLUME.PRef) -> 
        nA3MA_MEASURED_DATA_TYPE_NAME {
        let value = nA3MA_MEASURED_DATA_TYPE_NAME(/*nA3M_MEASURED_DATA_TYPE_NAME*/MDNA_VOLUME_MEASURE)
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _detected_difference_types__getter(SELF: eDIFFERENT_ASSEMBLY_VOLUME.PRef) -> SDAI.LIST<
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_DETECTED_DIFFERENCE_TYPE_NAME> */ = SDAI.LIST<
          nA3MA_DETECTED_DIFFERENCE_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: SDAI.INTEGER(1),  ([ 
            ...
            DDNA_VOLUME_MEASURE)) ] as [SDAI.AggregationInitializerElement<
      ...
      public static func WHERE_wr1(SELF: eDIFFERENT_ASSEMBLY_VOLUME.PRef?) -> SDAI.LOGICAL {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDIFFERENT_ASSEMBLY_VOLUME.PartialEntity :
