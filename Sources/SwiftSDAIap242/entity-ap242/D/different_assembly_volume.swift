/* file: different_assembly_volume.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _different_assembly_volume : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _measured_data_type__getter(SELF: eDIFFERENT_ASSEMBLY_VOLUME) -> 
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _detected_difference_types__getter(SELF: eDIFFERENT_ASSEMBLY_VOLUME) -> SDAI.LIST<
      ...
      let _TEMP1 = SDAI.LIST<nA3MA_DETECTED_DIFFERENCE_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), 
        ...
        nA3M_DETECTED_DIFFERENCE_TYPE_NAME*/DDNA_VOLUME_MEASURE))] as [SDAI.AggregationInitializerElement<
    ...
    public static func WHERE_wr1(SELF: eDIFFERENT_ASSEMBLY_VOLUME?) -> SDAI.LOGICAL {
...
```
*/
  public final class eDIFFERENT_ASSEMBLY_VOLUME : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _different_assembly_volume.WHERE_wr1(SELF: instance)
      return result
    }
