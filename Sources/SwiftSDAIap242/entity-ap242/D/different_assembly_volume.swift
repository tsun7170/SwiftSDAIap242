/* file: different_assembly_volume.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- different_assembly_volume (line:12065 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _different_assembly_volume : SDAI.PartialEntity {
...
```
*/
  public final class eDIFFERENT_ASSEMBLY_VOLUME : SDAI.EntityReference {
    ...
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``eDIFFERENT_ASSEMBLY_VOLUME`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "DIFFERENT_ASSEMBLY_VOLUME", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ACCURACY_TYPES", keyPath: \eDIFFERENT_ASSEMBLY_VOLUME.ACCURACY_TYPES, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", keyPath: \eDIFFERENT_ASSEMBLY_VOLUME.DETECTED_DIFFERENCE_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", keyPath: \eDIFFERENT_ASSEMBLY_VOLUME.COMPARED_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", keyPath: \eDIFFERENT_ASSEMBLY_VOLUME.MEASURED_DATA_TYPE, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eDIFFERENT_ASSEMBLY_VOLUME.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eDIFFERENT_ASSEMBLY_VOLUME.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", keyPath: \eDIFFERENT_ASSEMBLY_VOLUME.COMPARING_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: false)
