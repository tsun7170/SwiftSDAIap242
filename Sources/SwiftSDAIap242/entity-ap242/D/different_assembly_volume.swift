/* file: different_assembly_volume.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _different_assembly_volume : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
    ...
    internal func _detected_difference_types__getter(SELF: eDIFFERENT_ASSEMBLY_VOLUME.PRef) -> SDAI.LIST<
      ...
      let _TEMP1 /* SDAI.AGGREGATE<nA3M_DETECTED_DIFFERENCE_TYPE_NAME> */ = SDAI.LIST<
        nA3MA_DETECTED_DIFFERENCE_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: SDAI.INTEGER(1),  ([ 
          ...
          DDNA_VOLUME_MEASURE)) ] as [SDAI.AggregationInitializerElement<nA3MA_DETECTED_DIFFERENCE_TYPE_NAME>]) )
      let value = _TEMP1
      return SDAI.UNWRAP( value )
    }
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_different_assembly_volume``
*/
  public final class eDIFFERENT_ASSEMBLY_VOLUME : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _different_assembly_volume.self
    }
    /// partial entity reference
    public let partialEntity: _different_assembly_volume
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_different_assembly_volume.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _different_assembly_volume.WHERE_wr1(SELF: instance.pRef)
      return result
    }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF._different_assembly_volume :
