/* file: dimension_curve_terminator.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- dimension_curve_terminator (line:12431 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _dimension_curve_terminator : SDAI.PartialEntity {
...
```
*/
  public final class eDIMENSION_CURVE_TERMINATOR : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eDIMENSION_CURVE_TERMINATOR`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "DIMENSION_CURVE_TERMINATOR", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "ITEM", keyPath: \eDIMENSION_CURVE_TERMINATOR.ITEM, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ROLE", keyPath: \eDIMENSION_CURVE_TERMINATOR.ROLE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ANNOTATED_CURVE", keyPath: \eDIMENSION_CURVE_TERMINATOR.ANNOTATED_CURVE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "STYLES", keyPath: \eDIMENSION_CURVE_TERMINATOR.STYLES, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eDIMENSION_CURVE_TERMINATOR.NAME, 
