/* file: dimension_curve_terminator.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _dimension_curve_terminator : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eDIMENSION_CURVE_TERMINATOR?) -> SDAI.LOGICAL {
...
```
*/
  public final class eDIMENSION_CURVE_TERMINATOR : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _dimension_curve_terminator.WHERE_wr1(SELF: instance)
      return result
    }
