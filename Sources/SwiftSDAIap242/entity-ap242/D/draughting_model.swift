/* file: draughting_model.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eDRAUGHTING_MODEL : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eDRAUGHTING_MODEL.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eDRAUGHTING_MODEL.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: eDRAUGHTING_MODEL.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP1 /* SDAI.SET<sDRAUGHTING_MODEL_ITEM_SELECT>[1:nil] ? */ = SELF.ITEMS
        let _TEMP2 /* SDAI.SET<sDRAUGHTING_MODEL_ITEM_SELECT>[1:nil] ? */ = _TEMP1?
          .QUERY{ IT in 
            // QUERY BODY
        ...
        let _TEMP3 /* SDAI.SET<sDRAUGHTING_MODEL_ITEM_SELECT>[1:nil] ? */ = _TEMP2?
          .QUERY{ MI in 
            // QUERY BODY
      ...
      public static func WHERE_wr2(SELF: eDRAUGHTING_MODEL.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP4 /* SDAI.SET<sDRAUGHTING_MODEL_ITEM_SELECT>[1:nil] ? */ = _TEMP3?
          .QUERY{ SMI in 
            // QUERY BODY
            ...
            let _TEMP3 /* SDAI.SET<ePRESENTATION_STYLE_ASSIGNMENT.PRef>[0:nil] ? */ = _TEMP2?.STYLES
