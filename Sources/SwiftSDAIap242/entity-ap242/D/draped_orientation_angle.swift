/* file: draped_orientation_angle.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- draped_orientation_angle (line:12793 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDRAPED_ORIENTATION_ANGLE/PartialEntity``
*/
  public final class eDRAPED_ORIENTATION_ANGLE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eDRAPED_ORIENTATION_ANGLE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eDRAPED_ORIENTATION_ANGLE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eDRAPED_ORIENTATION_ANGLE.PartialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eDRAPED_ORIENTATION_ANGLE.PartialEntity.self) else { return nil }
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDRAPED_ORIENTATION_ANGLE``
*/
