/* file: different_component_shape.swift 	 generated: Thu Mar  5 17:54:18 2026 */
  ...
  public final class eDIFFERENT_COMPONENT_SHAPE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"SHAPE_CRITERIA") {
        return cached.value as! SDAI.SET<eA3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP.PRef>/*[1:?]*/ 
      }
      ...
      let swiftValue = SDAI.SET<eA3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP.PRef>/*[1:?]*/ .SwiftType( entities )
      let value = SDAI.SET<eA3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP.PRef>/*[1:?]*/ (from: swiftValue, 
      ...
      internal func _comparing_element_types__getter(SELF: eDIFFERENT_COMPONENT_SHAPE.PRef) -> SDAI.LIST<
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_ELEMENT_TYPE_NAME> */ = SDAI.LIST<nA3MA_ELEMENT_TYPE_NAME>(
          bound1:SDAI.UNWRAP(1), bound2:1,  ([ SDAI.AIE(nA3MA_ELEMENT_TYPE_NAME(/*nA3M_ELEMENT_TYPE_NAME*/
            ETNA_SHAPE_REPRESENTATION)) ] as [SDAI.AggregationInitializerElement<nA3MA_ELEMENT_TYPE_NAME>]) )
        let value = _TEMP1
