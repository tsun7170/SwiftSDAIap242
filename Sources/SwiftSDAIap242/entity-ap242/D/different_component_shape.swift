/* file: different_component_shape.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- different_component_shape (line:12135 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUPERTYPES:
	...
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_COMPONENT_SHAPE/PartialEntity``
*/
  public final class eDIFFERENT_COMPONENT_SHAPE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eDIFFERENT_COMPONENT_SHAPE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eDIFFERENT_COMPONENT_SHAPE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eDIFFERENT_COMPONENT_SHAPE.PartialEntity
    ...
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_COMPONENT_SHAPE`` )
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"SHAPE_CRITERIA") {
        return cached.value as! SDAI.SET<eA3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP.PRef>/*[1:(nil as 
          SDAI.INTEGER?)]*/ 
      }
      ...
      let swiftValue = SDAI.SET<eA3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP.PRef>/*[1:(nil as SDAI.INTEGER?)]*/ .SwiftType( entities )
      let value = SDAI.SET<eA3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP.PRef>/*[1:(nil as SDAI.INTEGER?)]*/ (
    ...
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE`` )
    public var MEASURED_DATA_TYPE: nA3MA_MEASURED_DATA_TYPE_NAME {
      get {
        ...
        let value = SDAI.UNWRAP( nA3MA_MEASURED_DATA_TYPE_NAME(
          origin.partialEntity._measured_data_type__getter(SELF: origin.pRef)) )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eDIFFERENT_COMPONENT_SHAPE.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "DIFFERENT_COMPONENT_SHAPE", 
      ...
      entityDef.addAttribute(name: "ACCURACY_TYPES", 
        keyPath: \eDIFFERENT_COMPONENT_SHAPE.ACCURACY_TYPES, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_COMPONENT_SHAPE``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      @_documentation(visibility:public)
      internal func _comparing_element_types__getter(SELF: eDIFFERENT_COMPONENT_SHAPE.PRef) -> SDAI.LIST<
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_ELEMENT_TYPE_NAME> */ = SDAI.LIST<nA3MA_ELEMENT_TYPE_NAME>(
          bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: SDAI.INTEGER(1),  ([ 
            SDAI.AIE(nA3MA_ELEMENT_TYPE_NAME(/*nA3M_ELEMENT_TYPE_NAME*/ETNA_SHAPE_REPRESENTATION)) ] 
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _compared_element_types__getter(SELF: eDIFFERENT_COMPONENT_SHAPE.PRef) -> SDAI.LIST<
        nA3MA_ELEMENT_TYPE_NAME>/*[1:1]*/  {
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _detected_difference_types__getter(SELF: eDIFFERENT_COMPONENT_SHAPE.PRef) -> SDAI.LIST<
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_DETECTED_DIFFERENCE_TYPE_NAME> */ = SDAI.LIST<
          nA3MA_DETECTED_DIFFERENCE_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: SDAI.INTEGER(1),  ([ 
            ...
            DDNA_A3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT)) ] as [SDAI.AggregationInitializerElement<
      ...
      // observing eA3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP.PartialEntity ._relating_representation_item
      //internal var _shape_criteria: SDAI.SET<eA3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP.PRef> 	(SEE CORRESPONDING ENTITY REFERENCE DEFINITION)
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDIFFERENT_COMPONENT_SHAPE.PartialEntity :
