/* file: different_placement_of_component.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  ENTITY different_placement_of_component
    ...
    INVERSE
      assessment_threshold_2 : a3ma_equivalence_criterion_assessment_threshold_relationship FOR 
                                  relating_representation_item -- defined in ENTITY: a3ma_equivalence_criterion_assessment_threshold_relationship;
    WHERE
      wr1: ( ( 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.SHAPE_DATA_QUALITY_LOWER_VALUE_LIMIT' IN 
               ...
               a3m_equivalence_assessment_by_numerical_test.threshold ) ) AND ( a3ma_get_value_limit_type( 
               SELF\a3m_equivalence_criterion.assessment_specification\
               a3m_equivalence_assessment_by_numerical_test.threshold ) = mdna_length_measure ) );
      wr2: ( ( a3ma_get_value_limit_type( SELF.assessment_threshold_2\representation_item_relationship.
               related_representation_item ) = mdna_context_dependent_measure ) AND ( 
               'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.CONTEXT_DEPENDENT_UNIT'  IN TYPEOF( SELF.
               assessment_threshold_2\representation_item_relationship.related_representation_item\
               measure_with_unit.unit_component ) ) );
  END_ENTITY; -- different_placement_of_component (line:12245 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(6)	a3m_equivalence_criterion_of_detailed_assembly_data_content
  ...
  ENTITY(SELF)	different_placement_of_component
...
- SUPERTYPES:
	...
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY``
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_PLACEMENT_OF_COMPONENT/PartialEntity``
*/
  public final class eDIFFERENT_PLACEMENT_OF_COMPONENT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eDIFFERENT_PLACEMENT_OF_COMPONENT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eDIFFERENT_PLACEMENT_OF_COMPONENT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eDIFFERENT_PLACEMENT_OF_COMPONENT.PartialEntity
    ...
    public let super_eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT: eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT 	// [6]
    public var super_eDIFFERENT_PLACEMENT_OF_COMPONENT: eDIFFERENT_PLACEMENT_OF_COMPONENT { return self } 	// [7]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY`` )
    ...
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_PLACEMENT_OF_COMPONENT`` )
    ...
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT`` )
    public var COMPARED_ELEMENT_TYPES: SDAI.LIST<nA3MA_ELEMENT_TYPE_NAME>/*[1:1]*/  {
      get {
        ...
        let origin = super_eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT
        let value = SDAI.UNWRAP( SDAI.LIST<nA3MA_ELEMENT_TYPE_NAME>(
          origin.partialEntity._compared_element_types__getter(SELF: origin.pRef)) )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eDIFFERENT_PLACEMENT_OF_COMPONENT.PartialEntity.self) else { return nil }
      ...
      guard let super6 = complexEntity?.entityReference(eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT.self) else { return nil }
      self.super_eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT = super6
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eDIFFERENT_PLACEMENT_OF_COMPONENT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eDIFFERENT_PLACEMENT_OF_COMPONENT.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "DIFFERENT_PLACEMENT_OF_COMPONENT", 
      ...
      entityDef.add(supertype: eDIFFERENT_PLACEMENT_OF_COMPONENT.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ACCURACY_TYPES", 
        keyPath: \eDIFFERENT_PLACEMENT_OF_COMPONENT.ACCURACY_TYPES, 
      ...
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", 
        keyPath: \eDIFFERENT_PLACEMENT_OF_COMPONENT.DETECTED_DIFFERENCE_TYPES, 
      ...
      entityDef.addAttribute(name: "ASSESSMENT_THRESHOLD_2", 
        keyPath: \eDIFFERENT_PLACEMENT_OF_COMPONENT.ASSESSMENT_THRESHOLD_2, 
        kind: .inverse, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", 
        keyPath: \eDIFFERENT_PLACEMENT_OF_COMPONENT.COMPARED_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", 
        keyPath: \eDIFFERENT_PLACEMENT_OF_COMPONENT.MEASURED_DATA_TYPE, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eDIFFERENT_PLACEMENT_OF_COMPONENT.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eDIFFERENT_PLACEMENT_OF_COMPONENT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", 
        keyPath: \eDIFFERENT_PLACEMENT_OF_COMPONENT.COMPARING_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: false)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_PLACEMENT_OF_COMPONENT``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eDIFFERENT_PLACEMENT_OF_COMPONENT.self
      }
      ...
      internal func _measured_data_type__getter(complex: SDAI.ComplexEntity) -> nA3M_MEASURED_DATA_TYPE_NAME {
        let SELF = complex.entityReference( eDIFFERENT_PLACEMENT_OF_COMPONENT.self )!
        return SDAI.UNWRAP( nA3M_MEASURED_DATA_TYPE_NAME(SELF.MEASURED_DATA_TYPE) )
      }
      /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _measured_data_type__getter(SELF: eDIFFERENT_PLACEMENT_OF_COMPONENT.PRef) -> 
        nA3MA_MEASURED_DATA_TYPE_NAME {
        let value = nA3MA_MEASURED_DATA_TYPE_NAME(/*nA3M_MEASURED_DATA_TYPE_NAME*/
          MDNA_LENGTH_MEASURE_AND_CONTEXT_DEPENDENT_MEASURE)
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _detected_difference_types__getter(SELF: eDIFFERENT_PLACEMENT_OF_COMPONENT.PRef) -> SDAI.LIST<
        nA3MA_DETECTED_DIFFERENCE_TYPE_NAME>/*[1:1]*/  {

        let _TEMP1 /* SDAI.AGGREGATE<nA3M_DETECTED_DIFFERENCE_TYPE_NAME> */ = SDAI.LIST<
          nA3MA_DETECTED_DIFFERENCE_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: SDAI.INTEGER(1),  ([ 
            SDAI.AIE(nA3MA_DETECTED_DIFFERENCE_TYPE_NAME(/*nA3M_DETECTED_DIFFERENCE_TYPE_NAME*/
            DDNA_CONTEXT_DEPENDENT_SHAPE_REPRESENTATION)) ] as [SDAI.AggregationInitializerElement<
      ...
      // observing eA3MA_EQUIVALENCE_CRITERION_ASSESSMENT_THRESHOLD_RELATIONSHIP.PartialEntity ._relating_representation_item
      //internal private(set) weak var _assessment_threshold_2: eA3MA_EQUIVALENCE_CRITERION_ASSESSMENT_THRESHOLD_RELATIONSHIP.PRef? 	(SEE CORRESPONDING ENTITY REFERENCE DEFINITION)
      ...
      public static func WHERE_wr1(SELF: eDIFFERENT_PLACEMENT_OF_COMPONENT.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP6 /* nA3MA_MEASURED_DATA_TYPE_NAME? */ = A3MA_GET_VALUE_LIMIT_TYPE( 
            _TEMP5 )
        let _TEMP7 /* SDAI.LOGICAL */ = _TEMP6 .==. SDAI.FORCE_OPTIONAL(MDNA_LENGTH_MEASURE)
        let _TEMP8 /* SDAI.LOGICAL */ = _TEMP1 && _TEMP7
        return _TEMP8
      }
      public static func WHERE_wr2(SELF: eDIFFERENT_PLACEMENT_OF_COMPONENT.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* eA3MA_EQUIVALENCE_CRITERION_ASSESSMENT_THRESHOLD_RELATIONSHIP.PRef? */ = SELF.ASSESSMENT_THRESHOLD_2
        let _TEMP2 /* eREPRESENTATION_ITEM_RELATIONSHIP.PRef? */ = _TEMP1?.GROUP_REF(
          eREPRESENTATION_ITEM_RELATIONSHIP.self)
        let _TEMP3 /* eREPRESENTATION_ITEM.PRef? */ = _TEMP2?.RELATED_REPRESENTATION_ITEM
        let _TEMP4 /* nA3MA_MEASURED_DATA_TYPE_NAME? */ = A3MA_GET_VALUE_LIMIT_TYPE( 
            sSHAPE_DATA_QUALITY_VALUE_LIMIT_TYPE_SELECT(/*eREPRESENTATION_ITEM.PRef*/_TEMP3) )
        let _TEMP5 /* SDAI.LOGICAL */ = _TEMP4 .==. SDAI.FORCE_OPTIONAL(MDNA_CONTEXT_DEPENDENT_MEASURE)
        let _TEMP6 /* SDAI.LOGICAL */ = SDAI.TYPEOF( ((((SELF.ASSESSMENT_THRESHOLD_2)?.GROUP_REF(
          eREPRESENTATION_ITEM_RELATIONSHIP.self))?.RELATED_REPRESENTATION_ITEM)?.GROUP_REF(
          eMEASURE_WITH_UNIT.self))?.UNIT_COMPONENT, IS: eCONTEXT_DEPENDENT_UNIT.self )
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDIFFERENT_PLACEMENT_OF_COMPONENT.PartialEntity :
