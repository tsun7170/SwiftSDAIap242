/* file: different_placement_of_component.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _different_placement_of_component : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _measured_data_type__getter(SELF: eDIFFERENT_PLACEMENT_OF_COMPONENT) -> 
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _detected_difference_types__getter(SELF: eDIFFERENT_PLACEMENT_OF_COMPONENT) -> SDAI.LIST<
    ...
    //internal private(set) weak var _assessment_threshold_2: eA3MA_EQUIVALENCE_CRITERION_ASSESSMENT_THRESHOLD_RELATIONSHIP? 	(SEE CORRESPONDING ENTITY REFERENCE DEFINITION)
    ...
    public static func WHERE_wr1(SELF: eDIFFERENT_PLACEMENT_OF_COMPONENT?) -> SDAI.LOGICAL {
      ...
      let _TEMP6 = A3MA_GET_VALUE_LIMIT_TYPE(_TEMP5)
      let _TEMP7 = _TEMP6 .==. SDAI.FORCE_OPTIONAL(MDNA_LENGTH_MEASURE)
      let _TEMP8 = _TEMP1 && _TEMP7
      return _TEMP8
    }
    public static func WHERE_wr2(SELF: eDIFFERENT_PLACEMENT_OF_COMPONENT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.ASSESSMENT_THRESHOLD_2
      let _TEMP2 = _TEMP1?.GROUP_REF(eREPRESENTATION_ITEM_RELATIONSHIP.self)
      let _TEMP3 = _TEMP2?.RELATED_REPRESENTATION_ITEM
      let _TEMP4 = A3MA_GET_VALUE_LIMIT_TYPE(sSHAPE_DATA_QUALITY_VALUE_LIMIT_TYPE_SELECT(/*
        eREPRESENTATION_ITEM*/_TEMP3))
      let _TEMP5 = _TEMP4 .==. SDAI.FORCE_OPTIONAL(MDNA_CONTEXT_DEPENDENT_MEASURE)
      let _TEMP6 = SDAI.TYPEOF(SELF.ASSESSMENT_THRESHOLD_2?.GROUP_REF(eREPRESENTATION_ITEM_RELATIONSHIP.self)?
        .RELATED_REPRESENTATION_ITEM.GROUP_REF(eMEASURE_WITH_UNIT.self)?.UNIT_COMPONENT, 
        IS: eCONTEXT_DEPENDENT_UNIT.self)
...
```
*/
  public final class eDIFFERENT_PLACEMENT_OF_COMPONENT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _different_placement_of_component.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _different_placement_of_component.WHERE_wr2(SELF: instance)
      return result
    }
