/* file: different_placement_of_component.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _different_placement_of_component : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
    ...
    // observing _a3ma_equivalence_criterion_assessment_threshold_relationship ._relating_representation_item
    ...
    public static func WHERE_wr2(SELF: eDIFFERENT_PLACEMENT_OF_COMPONENT.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP6 /* SDAI.LOGICAL */ = SDAI.TYPEOF( ((((SELF.ASSESSMENT_THRESHOLD_2)?.GROUP_REF(
        eREPRESENTATION_ITEM_RELATIONSHIP.self))?.RELATED_REPRESENTATION_ITEM)?.GROUP_REF(eMEASURE_WITH_UNIT.self))?
        .UNIT_COMPONENT, IS: eCONTEXT_DEPENDENT_UNIT.self )
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_different_placement_of_component``
*/
  public final class eDIFFERENT_PLACEMENT_OF_COMPONENT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _different_placement_of_component.self
    }
    /// partial entity reference
    public let partialEntity: _different_placement_of_component
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_different_placement_of_component.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _different_placement_of_component.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _different_placement_of_component.WHERE_wr2(SELF: instance.pRef)
      return result
    }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF._different_placement_of_component :
