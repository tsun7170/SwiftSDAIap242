/* file: disconnected_face_set.swift 	 generated: Thu Dec 25 18:13:23 2025 */
...
*/
  ...
  public final class _disconnected_face_set : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_disconnected_face_set``
*/
  public final class eDISCONNECTED_FACE_SET : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _disconnected_face_set.self
    }
    /// partial entity reference
    public let partialEntity: _disconnected_face_set
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_disconnected_face_set.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _disconnected_face_set.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _disconnected_face_set.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _disconnected_face_set.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _disconnected_face_set.WHERE_wr4(SELF: instance.pRef)
      return result
    }
