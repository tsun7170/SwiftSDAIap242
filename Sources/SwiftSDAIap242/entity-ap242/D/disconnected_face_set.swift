/* file: disconnected_face_set.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- disconnected_face_set (line:12644 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _disconnected_face_set : SDAI.PartialEntity {
...
```
*/
  public final class eDISCONNECTED_FACE_SET : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eDISCONNECTED_FACE_SET`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "DISCONNECTED_FACE_SET", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eDISCONNECTED_FACE_SET.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eDISCONNECTED_FACE_SET.NAME, 
