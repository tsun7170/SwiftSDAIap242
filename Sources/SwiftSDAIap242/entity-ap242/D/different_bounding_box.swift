/* file: different_bounding_box.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ENTITY different_bounding_box
    ...
    DERIVE
      ...
      SELF\a3m_equivalence_criterion.detected_difference_types : LIST [1 : 1] OF
                                          a3ms_detected_difference_type_name := [ddns_two_cartesian_points];
  ...
  END_ENTITY; -- different_bounding_box (line:12085 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	different_bounding_box
...
- SUPERTYPES:
	...
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_REPRESENTATIVE_SHAPE_PROPERTY_VALUE``
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_BOUNDING_BOX/PartialEntity``
*/
  public final class eDIFFERENT_BOUNDING_BOX : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eDIFFERENT_BOUNDING_BOX>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eDIFFERENT_BOUNDING_BOX.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eDIFFERENT_BOUNDING_BOX.PartialEntity
    ...
    public var super_eDIFFERENT_BOUNDING_BOX: eDIFFERENT_BOUNDING_BOX { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_BOUNDING_BOX`` )
    public var ACCURACY_TYPES: SDAI.LIST<nA3MS_ACCURACY_TYPE_NAME>/*[0:0]*/  {
      get {
        if let cached = cachedValue(derivedAttributeName:"ACCURACY_TYPES") {
          return cached.value as! SDAI.LIST<nA3MS_ACCURACY_TYPE_NAME>/*[0:0]*/ 
        }
        let origin = self
    ...
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_BOUNDING_BOX`` )
    public var COMPARED_ELEMENT_TYPES: SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>/*[3:3]*/  {
      get {
        if let cached = cachedValue(derivedAttributeName:"COMPARED_ELEMENT_TYPES") {
          return cached.value as! SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>/*[3:3]*/ 
        }
        let origin = self
    ...
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_REPRESENTATIVE_SHAPE_PROPERTY_VALUE`` )
    public var COMPARING_ELEMENT_TYPES: SDAI.LIST<nA3M_ELEMENT_TYPE_NAME>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        if let cached = cachedValue(derivedAttributeName:"COMPARING_ELEMENT_TYPES") {
          return cached.value as! SDAI.LIST<nA3M_ELEMENT_TYPE_NAME>/*[1:(nil as SDAI.INTEGER?)]*/ 
        }
        ...
        let value = SDAI.UNWRAP( SDAI.LIST<nA3M_ELEMENT_TYPE_NAME>(
          origin.partialEntity._comparing_element_types__getter(SELF: origin.pRef)) )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eDIFFERENT_BOUNDING_BOX.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eDIFFERENT_BOUNDING_BOX.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eDIFFERENT_BOUNDING_BOX.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eDIFFERENT_BOUNDING_BOX.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ACCURACY_TYPES", 
        keyPath: \eDIFFERENT_BOUNDING_BOX.ACCURACY_TYPES, 
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      internal func _compared_element_types__getter(complex: SDAI.ComplexEntity) -> SDAI.LIST<
        ...
        let SELF = complex.entityReference( eDIFFERENT_BOUNDING_BOX.self )!
        return SDAI.UNWRAP( SDAI.LIST<nA3M_ELEMENT_TYPE_NAME>(SELF.COMPARED_ELEMENT_TYPES) )
      }
      /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _compared_element_types__getter(SELF: eDIFFERENT_BOUNDING_BOX.PRef) -> SDAI.LIST<
        nA3MS_ELEMENT_TYPE_NAME>/*[3:3]*/  {
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_ELEMENT_TYPE_NAME> */ = SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>(
          bound1: SDAI.UNWRAP(SDAI.INTEGER(3)), bound2: SDAI.INTEGER(3),  ([ 
            SDAI.AIE(nA3MS_ELEMENT_TYPE_NAME(/*nA3M_ELEMENT_TYPE_NAME*/ETNS_MANIFOLD_SOLID_BREP)), 
            SDAI.AIE(nA3MS_ELEMENT_TYPE_NAME(/*nA3M_ELEMENT_TYPE_NAME*/ETNS_SHELL_BASED_SURFACE_MODEL)), 
            SDAI.AIE(nA3MS_ELEMENT_TYPE_NAME(/*nA3M_ELEMENT_TYPE_NAME*/ETNS_SHELL_BASED_WIREFRAME_MODEL)) ] 
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _measured_data_type__getter(SELF: eDIFFERENT_BOUNDING_BOX.PRef) -> 
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _detected_difference_types__getter(SELF: eDIFFERENT_BOUNDING_BOX.PRef) -> SDAI.LIST<
        nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>/*[1:1]*/  {

        let _TEMP1 /* SDAI.AGGREGATE<nA3M_DETECTED_DIFFERENCE_TYPE_NAME> */ = SDAI.LIST<
          nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: SDAI.INTEGER(1),  ([ 
            SDAI.AIE(nA3MS_DETECTED_DIFFERENCE_TYPE_NAME(/*nA3M_DETECTED_DIFFERENCE_TYPE_NAME*/
            DDNS_TWO_CARTESIAN_POINTS)) ] as [SDAI.AggregationInitializerElement<
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _accuracy_types__getter(SELF: eDIFFERENT_BOUNDING_BOX.PRef) -> SDAI.LIST<
        nA3MS_ACCURACY_TYPE_NAME>/*[0:0]*/  {

        let _TEMP1 /* SDAI.AGGREGATE<runtime> */ = SDAI.LIST<nA3MS_ACCURACY_TYPE_NAME>(
      ...
      public static func WHERE_wr1(SELF: eDIFFERENT_BOUNDING_BOX.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eDIFFERENT_BOUNDING_BOX.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        ...
        let _TEMP6 /* SDAI.LOGICAL */ = _TEMP5 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("approximation_tolerance"))
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDIFFERENT_BOUNDING_BOX.PartialEntity :
