/* file: different_bounding_box.swift 	 generated: Thu Mar  5 17:54:18 2026 */
    ...
    public var COMPARING_ELEMENT_TYPES: SDAI.LIST<nA3M_ELEMENT_TYPE_NAME>/*[1:?]*/  {
      get {
        if let cached = cachedValue(derivedAttributeName:"COMPARING_ELEMENT_TYPES") {
          return cached.value as! SDAI.LIST<nA3M_ELEMENT_TYPE_NAME>/*[1:?]*/ 
        }
    ...
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      internal func _detected_difference_types__getter(SELF: eDIFFERENT_BOUNDING_BOX.PRef) -> SDAI.LIST<
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_DETECTED_DIFFERENCE_TYPE_NAME> */ = SDAI.LIST<
          ...
          bound1:SDAI.UNWRAP(1), bound2:1,  ([ SDAI.AIE(nA3MS_DETECTED_DIFFERENCE_TYPE_NAME(/*
            nA3M_DETECTED_DIFFERENCE_TYPE_NAME*/DDNS_TWO_CARTESIAN_POINTS)) ] 
            as [SDAI.AggregationInitializerElement<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>]) )
        let value = _TEMP1
        return SDAI.UNWRAP( value )
      }
