/* file: different_bounding_box.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _different_bounding_box : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _compared_element_types__getter(SELF: eDIFFERENT_BOUNDING_BOX) -> SDAI.LIST<
      nA3MS_ELEMENT_TYPE_NAME>/*[3:3]*/  {

      let _TEMP1 = SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(3)), bound2: SDAI.INTEGER(
        3), ([SDAI.AIE(nA3MS_ELEMENT_TYPE_NAME(/*nA3M_ELEMENT_TYPE_NAME*/ETNS_MANIFOLD_SOLID_BREP)), 
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _measured_data_type__getter(SELF: eDIFFERENT_BOUNDING_BOX) -> nA3MS_MEASURED_DATA_TYPE_NAME {
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _detected_difference_types__getter(SELF: eDIFFERENT_BOUNDING_BOX) -> SDAI.LIST<
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _accuracy_types__getter(SELF: eDIFFERENT_BOUNDING_BOX) -> SDAI.LIST<
      nA3MS_ACCURACY_TYPE_NAME>/*[0:0]*/  {

      let _TEMP1 = SDAI.LIST<nA3MS_ACCURACY_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(0)), bound2: SDAI.INTEGER(
    ...
    public static func WHERE_wr1(SELF: eDIFFERENT_BOUNDING_BOX?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eDIFFERENT_BOUNDING_BOX?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eDIFFERENT_BOUNDING_BOX : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _different_bounding_box.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _different_bounding_box.WHERE_wr2(SELF: instance)
      return result
    }
