/* file: data_equivalence_criteria_representation.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  ENTITY data_equivalence_criteria_representation
    ...
    WHERE
      wr1: ( SIZEOF( QUERY ( q <* SELF\representation.items | ( 
               ...
               > 0 );
  END_ENTITY; -- data_equivalence_criteria_representation (line:11303 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	data_equivalence_criteria_representation
    (no local attributes)

  SUB- ENTITY(3)	a3m_equivalence_criteria_representation
    (no local attributes)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERIA_REPRESENTATION``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION/PartialEntity``
*/
  public final class eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION.PartialEntity

    //MARK: SUPERTYPES
    public let super_eREPRESENTATION: eREPRESENTATION 	// [1]
    public var super_eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION: eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION { return self } 	// [2]

    //MARK: SUBTYPES
    public var sub_eA3M_EQUIVALENCE_CRITERIA_REPRESENTATION: eA3M_EQUIVALENCE_CRITERIA_REPRESENTATION? {	// [3]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "DATA_EQUIVALENCE_CRITERIA_REPRESENTATION", 
      ...
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION.self
      }
      ...
      public static func WHERE_wr1(SELF: eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP3 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP2?
          .QUERY{ Q in 
            ...
            let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( Q, IS: eDATA_EQUIVALENCE_CRITERION.self )
            return _TEMP1
            // END QUERY BODY
          }
