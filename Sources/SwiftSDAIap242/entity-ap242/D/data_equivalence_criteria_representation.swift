/* file: data_equivalence_criteria_representation.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY data_equivalence_criteria_representation
    ...
    WHERE
      wr1: ( SIZEOF( QUERY ( q <* SELF\representation.items | ( 
               ...
               > 0 );
  END_ENTITY; -- data_equivalence_criteria_representation (line:11296 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _data_equivalence_criteria_representation : SDAI.PartialEntity {
...
```
*/
  public final class eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "DATA_EQUIVALENCE_CRITERIA_REPRESENTATION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION.NAME, 
