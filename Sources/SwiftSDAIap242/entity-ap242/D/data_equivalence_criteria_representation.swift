/* file: data_equivalence_criteria_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _data_equivalence_criteria_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION?) -> SDAI.LOGICAL {
      ...
      let _TEMP3 = _TEMP2?.QUERY{ Q in 
          ...
          let _TEMP1 = SDAI.TYPEOF(Q, IS: eDATA_EQUIVALENCE_CRITERION.self)
          return _TEMP1 }
...
```
*/
  public final class eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _data_equivalence_criteria_representation.WHERE_wr1(SELF: instance)
      return result
    }
