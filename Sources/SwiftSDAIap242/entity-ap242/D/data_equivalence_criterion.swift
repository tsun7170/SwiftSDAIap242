/* file: data_equivalence_criterion.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _data_equivalence_criterion : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_data_equivalence_criterion``
*/
  public final class eDATA_EQUIVALENCE_CRITERION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _data_equivalence_criterion.self
    }
    /// partial entity reference
    public let partialEntity: _data_equivalence_criterion
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_data_equivalence_criterion.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _data_equivalence_criterion.WHERE_wr1(SELF: instance.pRef)
      return result
    }
