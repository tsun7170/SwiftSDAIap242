/* file: data_equivalence_criterion.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- data_equivalence_criterion (line:11312 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	data_equivalence_criterion
    (no local attributes)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_EQUIVALENCE_CRITERION/PartialEntity``
*/
  public final class eDATA_EQUIVALENCE_CRITERION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eDATA_EQUIVALENCE_CRITERION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eDATA_EQUIVALENCE_CRITERION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eDATA_EQUIVALENCE_CRITERION.PartialEntity

    //MARK: SUPERTYPES
    public let super_eREPRESENTATION_ITEM: eREPRESENTATION_ITEM 	// [1]
    public var super_eDATA_EQUIVALENCE_CRITERION: eDATA_EQUIVALENCE_CRITERION { return self } 	// [2]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eDATA_EQUIVALENCE_CRITERION.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eDATA_EQUIVALENCE_CRITERION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "DATA_EQUIVALENCE_CRITERION", 
      ...
      entityDef.addAttribute(name: "ACCURACY_TYPES", 
        keyPath: \eDATA_EQUIVALENCE_CRITERION.ACCURACY_TYPES, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", 
        keyPath: \eDATA_EQUIVALENCE_CRITERION.DETECTED_DIFFERENCE_TYPES, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_SPECIFIED_ELEMENTS", 
        keyPath: \eDATA_EQUIVALENCE_CRITERION.COMPARING_SPECIFIED_ELEMENTS, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "SHAPE_CRITERIA", 
        keyPath: \eDATA_EQUIVALENCE_CRITERION.SHAPE_CRITERIA, 
        kind: .inverse, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "COMPARED_SPECIFIED_ELEMENTS", 
        keyPath: \eDATA_EQUIVALENCE_CRITERION.COMPARED_SPECIFIED_ELEMENTS, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSESSMENT_THRESHOLD_2", 
        keyPath: \eDATA_EQUIVALENCE_CRITERION.ASSESSMENT_THRESHOLD_2, 
        kind: .inverse, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", 
        keyPath: \eDATA_EQUIVALENCE_CRITERION.COMPARED_ELEMENT_TYPES, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", 
        keyPath: \eDATA_EQUIVALENCE_CRITERION.MEASURED_DATA_TYPE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eDATA_EQUIVALENCE_CRITERION.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eDATA_EQUIVALENCE_CRITERION.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", 
        keyPath: \eDATA_EQUIVALENCE_CRITERION.COMPARING_ELEMENT_TYPES, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: eDATA_EQUIVALENCE_CRITERION.PRef?) -> SDAI.LOGICAL {
