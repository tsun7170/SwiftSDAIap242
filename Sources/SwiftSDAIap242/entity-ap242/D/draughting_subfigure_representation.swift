/* file: draughting_subfigure_representation.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _draughting_subfigure_representation : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
            ...
            .QUERY{ A_S in 
              ...
              let _TEMP2 /* SDAI.BAG<SDAI.GENERIC_ENTITY> */ = _TEMP1
                .QUERY{ ASO in 
                  ...
                  let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( ASO, IS: eANNOTATION_SUBFIGURE_OCCURRENCE.self )
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_draughting_subfigure_representation``
*/
  public final class eDRAUGHTING_SUBFIGURE_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _draughting_subfigure_representation.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _draughting_subfigure_representation.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _draughting_subfigure_representation.WHERE_wr3(SELF: instance.pRef)
      return result
    }
