/* file: data_equivalence_inspection_requirement.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- data_equivalence_inspection_requirement (line:11406 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	...
	48.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION``
	49.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT/PartialEntity``
*/
  public final class eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.PartialEntity
    ...
    public var ASSESSMENT_SPECIFICATION: sA3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT?  {
      get {
        let originalValue = sub_eA3M_EQUIVALENCE_CRITERION?.partialEntity._assessment_specification
        let value = sA3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "DATA_EQUIVALENCE_INSPECTION_REQUIREMENT", 
      ...
      entityDef.addAttribute(name: "ACCURACY_TYPES", 
        keyPath: \eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.ACCURACY_TYPES, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", 
        keyPath: \eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.DETECTED_DIFFERENCE_TYPES, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_SPECIFIED_ELEMENTS", 
        keyPath: \eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.COMPARING_SPECIFIED_ELEMENTS, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "SHAPE_CRITERIA", 
        keyPath: \eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.SHAPE_CRITERIA, 
        kind: .inverse, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "COMPARED_SPECIFIED_ELEMENTS", 
        keyPath: \eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.COMPARED_SPECIFIED_ELEMENTS, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSESSMENT_THRESHOLD_2", 
        keyPath: \eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.ASSESSMENT_THRESHOLD_2, 
        kind: .inverse, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", 
        keyPath: \eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.COMPARED_ELEMENT_TYPES, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", 
        keyPath: \eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.MEASURED_DATA_TYPE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", 
        keyPath: \eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.COMPARING_ELEMENT_TYPES, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "APPLIED_VALUES", 
        keyPath: \eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.APPLIED_VALUES, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP3 /* SDAI.SET<gINTYPE>? */ = _TEMP2?
          .QUERY{ Q in 
            ...
            let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( Q, 
              IS: eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.self )
            return _TEMP1
            // END QUERY BODY
          }
