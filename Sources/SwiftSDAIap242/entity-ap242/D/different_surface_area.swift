/* file: different_surface_area.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _different_surface_area : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _compared_element_types__getter(SELF: eDIFFERENT_SURFACE_AREA) -> SDAI.LIST<
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _measured_data_type__getter(SELF: eDIFFERENT_SURFACE_AREA) -> nA3MS_MEASURED_DATA_TYPE_NAME {
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _detected_difference_types__getter(SELF: eDIFFERENT_SURFACE_AREA) -> SDAI.LIST<
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _accuracy_types__getter(SELF: eDIFFERENT_SURFACE_AREA) -> SDAI.LIST<
      ...
      let _TEMP1 = SDAI.LIST<nA3MS_ACCURACY_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: SDAI.INTEGER(
        1), ([SDAI.AIE(nA3MS_ACCURACY_TYPE_NAME(/*nA3M_ACCURACY_TYPE_NAME*/ATNS_AREA_MEASURE))] 
    ...
    public static func WHERE_wr1(SELF: eDIFFERENT_SURFACE_AREA?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eDIFFERENT_SURFACE_AREA?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eDIFFERENT_SURFACE_AREA : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _different_surface_area.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _different_surface_area.WHERE_wr2(SELF: instance)
      return result
    }
