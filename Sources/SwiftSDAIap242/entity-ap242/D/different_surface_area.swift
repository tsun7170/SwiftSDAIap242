/* file: different_surface_area.swift 	 generated: Thu Mar  5 17:54:18 2026 */
      ...
      internal func _detected_difference_types__getter(SELF: eDIFFERENT_SURFACE_AREA.PRef) -> SDAI.LIST<
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_DETECTED_DIFFERENCE_TYPE_NAME> */ = SDAI.LIST<
          ...
          bound1:SDAI.UNWRAP(1), bound2:1,  ([ SDAI.AIE(nA3MS_DETECTED_DIFFERENCE_TYPE_NAME(/*
            nA3M_DETECTED_DIFFERENCE_TYPE_NAME*/DDNS_AREA_MEASURE)) ] as [SDAI.AggregationInitializerElement<
            nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>]) )
        let value = _TEMP1
        return SDAI.UNWRAP( value )
      }
      ...
      internal func _accuracy_types__getter(SELF: eDIFFERENT_SURFACE_AREA.PRef) -> SDAI.LIST<
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_ACCURACY_TYPE_NAME> */ = SDAI.LIST<nA3MS_ACCURACY_TYPE_NAME>(
          bound1:SDAI.UNWRAP(1), bound2:1,  ([ SDAI.AIE(nA3MS_ACCURACY_TYPE_NAME(/*nA3M_ACCURACY_TYPE_NAME*/
            ATNS_AREA_MEASURE)) ] as [SDAI.AggregationInitializerElement<nA3MS_ACCURACY_TYPE_NAME>]) )
        let value = _TEMP1
        return SDAI.UNWRAP( value )
      }
