/* file: document.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _document : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //internal var _representation_types: SDAI.SET<eDOCUMENT_REPRESENTATION_TYPE> 	(SEE CORRESPONDING ENTITY REFERENCE DEFINITION)
...
```
*/
  public final class eDOCUMENT : SDAI.EntityReference, @unchecked Sendable {
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"REPRESENTATION_TYPES") {
        return cached.value as! SDAI.SET<eDOCUMENT_REPRESENTATION_TYPE>/*[0:nil]*/ 
      }
      let swiftValue = SDAI.SET<eDOCUMENT_REPRESENTATION_TYPE>/*[0:nil]*/ .SwiftType( self.referencingEntities(for: \eDOCUMENT_REPRESENTATION_TYPE.REPRESENTED_DOCUMENT) )
      let value = SDAI.SET<eDOCUMENT_REPRESENTATION_TYPE>/*[0:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
