/* file: drawing_revision.swift 	 generated: Tue Oct 14 17:54:07 2025 */
...
/*
  ...
  END_ENTITY; -- drawing_revision (line:13202 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  public final class eDRAWING_REVISION : SDAI.EntityReference, SDAIDualModeReference, @unchecked Sendable {
    ...
    get {
      ...
      let swiftValue = SDAI.SET<eAREA_IN_SET.PRef>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \eAREA_IN_SET.IN_SET) )
      let value = SDAI.SET<eAREA_IN_SET.PRef>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as 
        SDAI.INTEGER?))
