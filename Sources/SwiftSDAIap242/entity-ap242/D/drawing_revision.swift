/* file: drawing_revision.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
```
*/
  public final class eDRAWING_REVISION : SDAI.EntityReference, @unchecked Sendable {
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"AREAS") {
        return cached.value as! SDAI.SET<eAREA_IN_SET>/*[1:nil]*/ 
      }
      let swiftValue = SDAI.SET<eAREA_IN_SET>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \eAREA_IN_SET.IN_SET) )
      let value = SDAI.SET<eAREA_IN_SET>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as 
        SDAI.INTEGER?))
