/* file: drawing_revision.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
/*
  ...
  END_ENTITY; -- drawing_revision (line:13200 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUPERTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESENTATION_SET``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDRAWING_REVISION/PartialEntity``
*/
  public final class eDRAWING_REVISION : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eDRAWING_REVISION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eDRAWING_REVISION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eDRAWING_REVISION.PartialEntity
    ...
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESENTATION_SET`` )
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDRAWING_REVISION`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eDRAWING_REVISION.PartialEntity.self) else { return nil }
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDRAWING_REVISION``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _drawing_identifier: eDRAWING_DEFINITION.PRef // PLAIN EXPLICIT ATTRIBUTE
      ...
      public static func UNIQUE_ur1(SELF: SDAI.EntityReference) -> AnyHashable? {
        guard let SELF = (SELF as? eDRAWING_REVISION)?.pRef else { return nil }
        //JOINT UNIQUE RULE

        var attributes: Array<AnyHashable> = []

        guard let attr1 = SELF.REVISION_IDENTIFIER else { return nil }
        attributes.append( AnyHashable(attr1) )

        guard let attr2 = SELF.DRAWING_IDENTIFIER else { return nil }
      ...
      public init(
        REVISION_IDENTIFIER: tIDENTIFIER, 
        DRAWING_IDENTIFIER: eDRAWING_DEFINITION.PRef, 
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( REVISION_IDENTIFIER: original._revision_identifier, DRAWING_IDENTIFIER: original._drawing_identifier, INTENDED_SCALE: original._intended_scale )
      }
      ...
      public required convenience init?(
        ...
        guard case .success(let p1) = exchangeStructure.recoverRequiredParameter(as: eDRAWING_DEFINITION.PRef.self, from: parameters[1])
        else { exchangeStructure.add(errorContext: "while recovering parameter [1]DRAWING_IDENTIFIER for partial entity(\(Self.entityName)) constructor"); return nil }

        guard case .success(let p2) = exchangeStructure.recoverOptionalParameter(as: tTEXT.self, from: parameters[2])
        else { exchangeStructure.add(errorContext: "while recovering parameter [2]INTENDED_SCALE for partial entity(\(Self.entityName)) constructor"); return nil }
