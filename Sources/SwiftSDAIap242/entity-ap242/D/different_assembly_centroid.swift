/* file: different_assembly_centroid.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _different_assembly_centroid : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _measured_data_type__getter(SELF: eDIFFERENT_ASSEMBLY_CENTROID) -> 
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _detected_difference_types__getter(SELF: eDIFFERENT_ASSEMBLY_CENTROID) -> SDAI.LIST<
    ...
    public static func WHERE_wr1(SELF: eDIFFERENT_ASSEMBLY_CENTROID?) -> SDAI.LOGICAL {
...
```
*/
  public final class eDIFFERENT_ASSEMBLY_CENTROID : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _different_assembly_centroid.WHERE_wr1(SELF: instance)
      return result
    }
