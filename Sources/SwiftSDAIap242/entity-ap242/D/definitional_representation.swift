/* file: definitional_representation.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ENTITY definitional_representation
    ...
    WHERE
      wr1: ( 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PARAMETRIC_REPRESENTATION_CONTEXT' IN TYPEOF( 
               SELF\representation.context_of_items ) );
  END_ENTITY; -- definitional_representation (line:11875 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	definitional_representation
    (no local attributes)

  SUB- ENTITY(3)	path_parameter_representation
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePATH_PARAMETER_REPRESENTATION``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDEFINITIONAL_REPRESENTATION/PartialEntity``
*/
  public final class eDEFINITIONAL_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eDEFINITIONAL_REPRESENTATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eDEFINITIONAL_REPRESENTATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eDEFINITIONAL_REPRESENTATION.PartialEntity

    //MARK: SUPERTYPES
    public let super_eREPRESENTATION: eREPRESENTATION 	// [1]
    public var super_eDEFINITIONAL_REPRESENTATION: eDEFINITIONAL_REPRESENTATION { return self } 	// [2]

    //MARK: SUBTYPES
    public var sub_ePATH_PARAMETER_REPRESENTATION: ePATH_PARAMETER_REPRESENTATION? {	// [3]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eDEFINITIONAL_REPRESENTATION.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eDEFINITIONAL_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eDEFINITIONAL_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eDEFINITIONAL_REPRESENTATION.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eDEFINITIONAL_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eDEFINITIONAL_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eDEFINITIONAL_REPRESENTATION.NAME, 
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: eDEFINITIONAL_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( (SELF.GROUP_REF(eREPRESENTATION.self))?.CONTEXT_OF_ITEMS, 
          IS: ePARAMETRIC_REPRESENTATION_CONTEXT.self )
        return _TEMP1
      }
