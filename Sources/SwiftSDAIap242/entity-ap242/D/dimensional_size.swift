/* file: dimensional_size.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _dimensional_size : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_dimensional_size``
*/
  public final class eDIMENSIONAL_SIZE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _dimensional_size.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _dimensional_size.WHERE_wr2(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addUniquenessRule(label:"UNIQUE_ur1", rule: _dimensional_size.UNIQUE_ur1)
