/* file: document_identifier_assignment.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _document_identifier_assignment : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _assigned_group: eDOCUMENT_IDENTIFIER	//EXPLICIT REDEFINITION(eGROUP_ASSIGNMENT) */
...
```
*/
  public final class eDOCUMENT_IDENTIFIER_ASSIGNMENT : SDAI.EntityReference, @unchecked Sendable {
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDOCUMENT_IDENTIFIER_ASSIGNMENT`` )
    public var ASSIGNED_GROUP: eDOCUMENT_IDENTIFIER {
      get {
        if let resolved = _group_assignment._assigned_group__provider(complex: self.complexEntity) {
          let value = SDAI.UNWRAP( eDOCUMENT_IDENTIFIER(resolved._assigned_group__getter(
            complex: self.complexEntity)) )
          return value
        }
        else {
          return SDAI.UNWRAP( eDOCUMENT_IDENTIFIER(super_eGROUP_ASSIGNMENT.partialEntity._assigned_group) )
        }
      }
      set(newValue) {
