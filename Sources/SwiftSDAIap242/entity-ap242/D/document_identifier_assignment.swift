/* file: document_identifier_assignment.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- document_identifier_assignment (line:12687 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _document_identifier_assignment : SDAI.PartialEntity {
...
```
*/
  public final class eDOCUMENT_IDENTIFIER_ASSIGNMENT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eDOCUMENT_IDENTIFIER_ASSIGNMENT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "DOCUMENT_IDENTIFIER_ASSIGNMENT", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "ROLE", keyPath: \eDOCUMENT_IDENTIFIER_ASSIGNMENT.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eDOCUMENT_IDENTIFIER_ASSIGNMENT.ITEMS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_GROUP", keyPath: \eDOCUMENT_IDENTIFIER_ASSIGNMENT.ASSIGNED_GROUP, 
