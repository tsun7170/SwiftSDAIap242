/* file: defined_constraint.swift 	 generated: Thu Dec 25 18:13:23 2025 */
...
*/
  ...
  public final class _defined_constraint : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_defined_constraint``
*/
  public final class eDEFINED_CONSTRAINT : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _defined_constraint.self
    }
    /// partial entity reference
    public let partialEntity: _defined_constraint
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_defined_constraint.self) else { return nil }
