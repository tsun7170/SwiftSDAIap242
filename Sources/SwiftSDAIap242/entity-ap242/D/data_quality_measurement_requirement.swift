/* file: data_quality_measurement_requirement.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- data_quality_measurement_requirement (line:11601 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _data_quality_measurement_requirement : SDAI.PartialEntity {
...
```
*/
  public final class eDATA_QUALITY_MEASUREMENT_REQUIREMENT : SDAI.EntityReference {
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUB( ``eSHAPE_DATA_QUALITY_CRITERION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "DATA_QUALITY_MEASUREMENT_REQUIREMENT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ARC_LENGTH_DISTANCE_FACTOR", keyPath: \eDATA_QUALITY_MEASUREMENT_REQUIREMENT.ARC_LENGTH_DISTANCE_FACTOR, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "TEST_POINT_DISTANCE_TOLERANCE", keyPath: \eDATA_QUALITY_MEASUREMENT_REQUIREMENT.TEST_POINT_DISTANCE_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ARC_LENGTH_SEPARATION_FACTOR", keyPath: \eDATA_QUALITY_MEASUREMENT_REQUIREMENT.ARC_LENGTH_SEPARATION_FACTOR, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eDATA_QUALITY_MEASUREMENT_REQUIREMENT.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eDATA_QUALITY_MEASUREMENT_REQUIREMENT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "SMALL_VECTOR_TOLERANCE", keyPath: \eDATA_QUALITY_MEASUREMENT_REQUIREMENT.SMALL_VECTOR_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
