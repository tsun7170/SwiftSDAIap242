/* file: different_length_of_assembly_constraint.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- different_length_of_assembly_constraint (line:12172 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	different_length_of_assembly_constraint
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT/PartialEntity``
*/
  public final class eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT.PartialEntity
    ...
    public var super_eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT: eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT { return self } 	// [7]
    ...
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "DIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT", 
      ...
      entityDef.add(supertype: eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ACCURACY_TYPES", 
        keyPath: \eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT.ACCURACY_TYPES, 
      ...
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", 
        keyPath: \eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT.DETECTED_DIFFERENCE_TYPES, 
      ...
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", 
        keyPath: \eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT.COMPARED_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", 
        keyPath: \eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT.MEASURED_DATA_TYPE, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", 
        keyPath: \eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT.COMPARING_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: false)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT.self
      }
      ...
      internal func _measured_data_type__getter(complex: SDAI.ComplexEntity) -> nA3M_MEASURED_DATA_TYPE_NAME {
        let SELF = complex.entityReference( eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT.self )!
        return SDAI.UNWRAP( nA3M_MEASURED_DATA_TYPE_NAME(SELF.MEASURED_DATA_TYPE) )
      }
      /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _measured_data_type__getter(SELF: eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT.PRef) -> 
        nA3MA_MEASURED_DATA_TYPE_NAME {
        let value = nA3MA_MEASURED_DATA_TYPE_NAME(/*nA3M_MEASURED_DATA_TYPE_NAME*/MDNA_LENGTH_MEASURE)
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _detected_difference_types__getter(SELF: eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT.PRef) -> 
        SDAI.LIST<nA3MA_DETECTED_DIFFERENCE_TYPE_NAME>/*[1:1]*/  {
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_DETECTED_DIFFERENCE_TYPE_NAME> */ = SDAI.LIST<
          nA3MA_DETECTED_DIFFERENCE_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: SDAI.INTEGER(1),  ([ 
            ...
            DDNA_BINARY_ASSEMBLY_CONSTRAINT)) ] as [SDAI.AggregationInitializerElement<
      ...
      public static func WHERE_wr1(SELF: eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP6 /* nA3MA_MEASURED_DATA_TYPE_NAME? */ = A3MA_GET_VALUE_LIMIT_TYPE( 
            _TEMP5 )
        let _TEMP7 /* nA3MA_MEASURED_DATA_TYPE_NAME? */ = SELF.MEASURED_DATA_TYPE
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
  .eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT.PartialEntity :
