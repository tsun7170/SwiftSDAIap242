/* file: different_length_of_assembly_constraint.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _different_length_of_assembly_constraint : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _measured_data_type__getter(SELF: eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT) -> 
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _detected_difference_types__getter(SELF: eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT) -> SDAI.LIST<
    ...
    public static func WHERE_wr1(SELF: eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT?) -> SDAI.LOGICAL {
...
```
*/
  public final class eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _different_length_of_assembly_constraint.WHERE_wr1(SELF: instance)
      return result
    }
