/* file: dimensional_exponents.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
  public final class eDIMENSIONAL_EXPONENTS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var LENGTH_EXPONENT: SDAI.REAL {
      get {
        let originalValue = self.partialEntity._length_exponent
    ...
    public var MASS_EXPONENT: SDAI.REAL {
      get {
        let originalValue = self.partialEntity._mass_exponent
        let value = SDAI.UNWRAP( SDAI.REAL( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public var ELECTRIC_CURRENT_EXPONENT: SDAI.REAL {
      get {
        let originalValue = self.partialEntity._electric_current_exponent
        let value = SDAI.UNWRAP( SDAI.REAL( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public var TIME_EXPONENT: SDAI.REAL {
      get {
        let originalValue = self.partialEntity._time_exponent
        let value = SDAI.UNWRAP( SDAI.REAL( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public var THERMODYNAMIC_TEMPERATURE_EXPONENT: SDAI.REAL {
      get {
        let originalValue = self.partialEntity._thermodynamic_temperature_exponent
        let value = SDAI.UNWRAP( SDAI.REAL( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public var LUMINOUS_INTENSITY_EXPONENT: SDAI.REAL {
      get {
        let originalValue = self.partialEntity._luminous_intensity_exponent
        let value = SDAI.UNWRAP( SDAI.REAL( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public var AMOUNT_OF_SUBSTANCE_EXPONENT: SDAI.REAL {
      get {
        let originalValue = self.partialEntity._amount_of_substance_exponent
        let value = SDAI.UNWRAP( SDAI.REAL( originalValue ) )
        return value
      }
      set(newValue) {
