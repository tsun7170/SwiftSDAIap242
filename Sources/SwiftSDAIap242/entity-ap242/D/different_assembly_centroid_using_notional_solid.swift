/* file: different_assembly_centroid_using_notional_solid.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _different_assembly_centroid_using_notional_solid : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _measured_data_type__getter(SELF: eDIFFERENT_ASSEMBLY_CENTROID_USING_NOTIONAL_SOLID) -> 
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _detected_difference_types__getter(SELF: eDIFFERENT_ASSEMBLY_CENTROID_USING_NOTIONAL_SOLID) -> 
      ...
      let _TEMP1 = SDAI.LIST<nA3MA_DETECTED_DIFFERENCE_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), 
        ...
        nA3M_DETECTED_DIFFERENCE_TYPE_NAME*/DDNA_CARTESIAN_POINT))] as [SDAI.AggregationInitializerElement<
    ...
    public static func WHERE_wr1(SELF: eDIFFERENT_ASSEMBLY_CENTROID_USING_NOTIONAL_SOLID?) -> SDAI.LOGICAL {
...
```
*/
  public final class eDIFFERENT_ASSEMBLY_CENTROID_USING_NOTIONAL_SOLID : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _different_assembly_centroid_using_notional_solid.WHERE_wr1(SELF: instance)
      return result
    }
