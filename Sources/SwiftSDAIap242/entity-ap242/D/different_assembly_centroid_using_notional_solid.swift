/* file: different_assembly_centroid_using_notional_solid.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _different_assembly_centroid_using_notional_solid : SDAI.PartialEntity
    ...
    internal func _detected_difference_types__getter(SELF: eDIFFERENT_ASSEMBLY_CENTROID_USING_NOTIONAL_SOLID.PRef) -> 
      ...
      let _TEMP1 /* SDAI.AGGREGATE<nA3M_DETECTED_DIFFERENCE_TYPE_NAME> */ = SDAI.LIST<
        nA3MA_DETECTED_DIFFERENCE_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: SDAI.INTEGER(1),  ([ 
          ...
          DDNA_CARTESIAN_POINT)) ] as [SDAI.AggregationInitializerElement<nA3MA_DETECTED_DIFFERENCE_TYPE_NAME>]) )
      let value = _TEMP1
      return SDAI.UNWRAP( value )
    }
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_different_assembly_centroid_using_notional_solid``
*/
  public final class eDIFFERENT_ASSEMBLY_CENTROID_USING_NOTIONAL_SOLID : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _different_assembly_centroid_using_notional_solid.self
    }
    /// partial entity reference
    public let partialEntity: _different_assembly_centroid_using_notional_solid
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_different_assembly_centroid_using_notional_solid.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _different_assembly_centroid_using_notional_solid.WHERE_wr1(SELF: instance.pRef)
      return result
    }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF._different_assembly_centroid_using_notional_solid :
