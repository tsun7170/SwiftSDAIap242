/* file: discontinuous_geometry.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- discontinuous_geometry (line:12647 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	discontinuous_geometry
    (no local attributes)

  SUB- ENTITY(8)	g1_discontinuous_surface
  ...
  SUB- ENTITY(9)	g2_discontinuous_curve
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion
  ...
  SUB- ENTITY(10)	g2_discontinuous_surface
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion
  ...
  SUB- ENTITY(11)	g1_discontinuous_curve
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eG1_DISCONTINUOUS_SURFACE``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eG2_DISCONTINUOUS_CURVE``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eG2_DISCONTINUOUS_SURFACE``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eG1_DISCONTINUOUS_CURVE``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDISCONTINUOUS_GEOMETRY/PartialEntity``
*/
  public final class eDISCONTINUOUS_GEOMETRY : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eDISCONTINUOUS_GEOMETRY>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eDISCONTINUOUS_GEOMETRY.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eDISCONTINUOUS_GEOMETRY.PartialEntity
    ...
    public var super_eDISCONTINUOUS_GEOMETRY: eDISCONTINUOUS_GEOMETRY { return self } 	// [7]

    //MARK: SUBTYPES
    public var sub_eG1_DISCONTINUOUS_SURFACE: eG1_DISCONTINUOUS_SURFACE? {	// [8]
      return self.complexEntity.entityReference(eG1_DISCONTINUOUS_SURFACE.self)
    }

    public var sub_eG2_DISCONTINUOUS_CURVE: eG2_DISCONTINUOUS_CURVE? {	// [9]
      return self.complexEntity.entityReference(eG2_DISCONTINUOUS_CURVE.self)
    }

    public var sub_eG2_DISCONTINUOUS_SURFACE: eG2_DISCONTINUOUS_SURFACE? {	// [10]
      return self.complexEntity.entityReference(eG2_DISCONTINUOUS_SURFACE.self)
    }

    public var sub_eG1_DISCONTINUOUS_CURVE: eG1_DISCONTINUOUS_CURVE? {	// [11]
    ...
    // ASSESSMENT_SPECIFICATION_2: (2 AMBIGUOUS REFs)
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eDISCONTINUOUS_GEOMETRY.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eDISCONTINUOUS_GEOMETRY.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eDISCONTINUOUS_GEOMETRY.NAME, 
