/* file: discontinuous_geometry.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _discontinuous_geometry : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_discontinuous_geometry``
*/
  public final class eDISCONTINUOUS_GEOMETRY : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _discontinuous_geometry.self
    }
    /// partial entity reference
    public let partialEntity: _discontinuous_geometry
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_discontinuous_geometry.self) else { return nil }
