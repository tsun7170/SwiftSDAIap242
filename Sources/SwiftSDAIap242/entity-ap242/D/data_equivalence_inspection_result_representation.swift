/* file: data_equivalence_inspection_result_representation.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  ENTITY data_equivalence_inspection_result_representation
    ...
    WHERE
      wr1: ( SIZEOF( QUERY ( q <* SELF\representation.items | ( 
               ...
               TYPEOF( q ) ) ) ) > 0 );
  END_ENTITY; -- data_equivalence_inspection_result_representation (line:11427 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION/PartialEntity``
*/
  public final class eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "DATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION", 
      ...
      entityDef.addAttribute(name: "CRITERIA_INSPECTED", 
        keyPath: \eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.CRITERIA_INSPECTED, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _criteria_inspected: eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION.PRef // PLAIN EXPLICIT ATTRIBUTE
      ...
      public static func WHERE_wr1(SELF: eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP3 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP2?
          .QUERY{ Q in 
            ...
            let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( Q, IS: eDATA_EQUIVALENCE_INSPECTION_RESULT.self )
            return _TEMP1
            // END QUERY BODY
          }
      ...
      public init(CRITERIA_INSPECTED: eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION.PRef) {
      ...
      public required convenience init?(
        ...
        guard case .success(let p0) = exchangeStructure.recoverRequiredParameter(as: 
          eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION.PRef.self, from: parameters[0])
