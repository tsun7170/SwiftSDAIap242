/* file: derived_unit.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  ENTITY derived_unit
    ...
    WHERE
      ...
      wr2: ( SIZEOF( USEDIN( SELF, 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.NAME_ATTRIBUTE.NAMED_ITEM' ) ) 
               <= 1 );
  END_ENTITY; -- derived_unit (line:11931 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_ELECTRIC_CHARGE_UNIT``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eELECTRIC_CHARGE_UNIT``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_MAGNETIC_FLUX_DENSITY_UNIT``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMAGNETIC_FLUX_DENSITY_UNIT``
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_ELECTRIC_POTENTIAL_UNIT``
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eELECTRIC_POTENTIAL_UNIT``
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_MAGNETIC_FLUX_UNIT``
	8.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMAGNETIC_FLUX_UNIT``
	9.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_RESISTANCE_UNIT``
	10.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRESISTANCE_UNIT``
	11.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_CAPACITANCE_UNIT``
	12.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCAPACITANCE_UNIT``
	13.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACCELERATION_UNIT``
	14.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_PRESSURE_UNIT``
	15.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESSURE_UNIT``
	16.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_ABSORBED_DOSE_UNIT``
	17.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eABSORBED_DOSE_UNIT``
	18.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_RADIOACTIVITY_UNIT``
	19.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRADIOACTIVITY_UNIT``
	20.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAREA_UNIT``
	21.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_DOSE_EQUIVALENT_UNIT``
	22.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDOSE_EQUIVALENT_UNIT``
	23.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_CONDUCTANCE_UNIT``
	24.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONDUCTANCE_UNIT``
	25.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_ENERGY_UNIT``
	26.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eENERGY_UNIT``
	27.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_FORCE_UNIT``
	28.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFORCE_UNIT``
	29.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_FREQUENCY_UNIT``
	30.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFREQUENCY_UNIT``
	31.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_ILLUMINANCE_UNIT``
	32.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eILLUMINANCE_UNIT``
	33.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_INDUCTANCE_UNIT``
	34.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINDUCTANCE_UNIT``
	35.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_POWER_UNIT``
	36.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOWER_UNIT``
	37.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eVELOCITY_UNIT``
	38.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eVOLUME_UNIT``
	39.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTHERMAL_RESISTANCE_UNIT``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDERIVED_UNIT/PartialEntity``
*/
  public final class eDERIVED_UNIT : SDAI.EntityReference, SDAI.DualModeReference, SDAI.SimpleEntityType, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eDERIVED_UNIT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eDERIVED_UNIT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eDERIVED_UNIT.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDERIVED_UNIT`` )
    public var ELEMENTS: SDAI.SET<eDERIVED_UNIT_ELEMENT.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        ...
        let value = SDAI.UNWRAP( SDAI.SET<eDERIVED_UNIT_ELEMENT.PRef>( originalValue ) )
        return value
      }
      set(newValue) {
        let partial = self.partialEntity
        let SELF = self; SDAI.TOUCH(let:SELF)
        partial._elements = SDAI.UNWRAP(SDAI.SET<eDERIVED_UNIT_ELEMENT.PRef>(
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eDERIVED_UNIT.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eDERIVED_UNIT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eDERIVED_UNIT.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "ELEMENTS", 
        keyPath: \eDERIVED_UNIT.ELEMENTS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eDERIVED_UNIT.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDERIVED_UNIT``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _elements: SDAI.SET<eDERIVED_UNIT_ELEMENT.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  // PLAIN EXPLICIT ATTRIBUTE

      /// DERIVE ATTRIBUTE
      @_documentation(visibility:public)
      internal func _name__getter(SELF: eDERIVED_UNIT.PRef) -> tLABEL?  {

        let _TEMP1 /* tLABEL? */ = GET_NAME_VALUE( sNAME_ATTRIBUTE_SELECT(/*eDERIVED_UNIT.PRef*/SELF) )
        return _TEMP1
      }
      ...
      public static func WHERE_wr1(SELF: eDERIVED_UNIT.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.INTEGER? */ = SDAI.SIZEOF( SELF.ELEMENTS )
        let _TEMP2 /* SDAI.LOGICAL */ = _TEMP1 > SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
        let _TEMP3 /* SDAI.INTEGER? */ = SDAI.SIZEOF( SELF.ELEMENTS )
        let _TEMP4 /* SDAI.LOGICAL */ = _TEMP3 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
        let _TEMP5 /* eDERIVED_UNIT_ELEMENT.PRef? */ = SELF.ELEMENTS?[1]
        let _TEMP6 /* SDAI.REAL? */ = _TEMP5?.EXPONENT
        let _TEMP7 /* SDAI.LOGICAL */ = _TEMP6 .!=. SDAI.FORCE_OPTIONAL(SDAI.REAL(1.0000000000e+00))
        let _TEMP8 /* SDAI.LOGICAL */ = _TEMP4 && _TEMP7
        let _TEMP9 /* SDAI.LOGICAL */ = _TEMP2 || _TEMP8
        return _TEMP9
      }
      public static func WHERE_wr2(SELF: eDERIVED_UNIT.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public init(ELEMENTS: SDAI.SET<eDERIVED_UNIT_ELEMENT.PRef>/*[1:(nil as SDAI.INTEGER?)]*/ ) {

        self._elements = 
        SDAI.SET<eDERIVED_UNIT_ELEMENT.PRef>(
          from: ELEMENTS.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
      ...
      public required convenience init?(
        ...
        guard case .success(let p0) = exchangeStructure.recoverRequiredParameter(as: SDAI.SET<
          eDERIVED_UNIT_ELEMENT.PRef>.self, from: parameters[0])
