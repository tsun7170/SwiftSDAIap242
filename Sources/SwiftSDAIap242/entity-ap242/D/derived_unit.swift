/* file: derived_unit.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public final class eDERIVED_UNIT : SDAI.EntityReference, SDAI.DualModeReference, SDAI.SimpleEntityType, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eDERIVED_UNIT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eDERIVED_UNIT.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _elements: SDAI.SET<eDERIVED_UNIT_ELEMENT.PRef>/*[1:nil]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(ELEMENTS: SDAI.SET<eDERIVED_UNIT_ELEMENT.PRef>/*[1:nil]*/ ) {
