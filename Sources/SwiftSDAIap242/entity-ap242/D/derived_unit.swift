/* file: derived_unit.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _elements: SDAI.SET<eDERIVED_UNIT_ELEMENT.PRef>/*[1:?]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(ELEMENTS: SDAI.SET<eDERIVED_UNIT_ELEMENT.PRef>/*[1:?]*/ ) {

        self._elements = 
        SDAI.SET<eDERIVED_UNIT_ELEMENT.PRef>(from: ELEMENTS.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
