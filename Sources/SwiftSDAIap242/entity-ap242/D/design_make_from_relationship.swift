/* file: design_make_from_relationship.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _design_make_from_relationship : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_design_make_from_relationship``
*/
  public final class eDESIGN_MAKE_FROM_RELATIONSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _design_make_from_relationship.self
    }
    /// partial entity reference
    public let partialEntity: _design_make_from_relationship
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_design_make_from_relationship.self) else { return nil }
