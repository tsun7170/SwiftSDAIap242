/* file: different_number_of_components.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- different_number_of_components (line:12195 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_NUMBER_OF_COMPONENTS/PartialEntity``
*/
  public final class eDIFFERENT_NUMBER_OF_COMPONENTS : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eDIFFERENT_NUMBER_OF_COMPONENTS>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eDIFFERENT_NUMBER_OF_COMPONENTS.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eDIFFERENT_NUMBER_OF_COMPONENTS.PartialEntity
    ...
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_NUMBER_OF_COMPONENTS`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eDIFFERENT_NUMBER_OF_COMPONENTS.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "DIFFERENT_NUMBER_OF_COMPONENTS", 
      ...
      entityDef.addAttribute(name: "ACCURACY_TYPES", 
        keyPath: \eDIFFERENT_NUMBER_OF_COMPONENTS.ACCURACY_TYPES, 
      ...
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", 
        keyPath: \eDIFFERENT_NUMBER_OF_COMPONENTS.DETECTED_DIFFERENCE_TYPES, 
      ...
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", 
        keyPath: \eDIFFERENT_NUMBER_OF_COMPONENTS.COMPARED_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", 
        keyPath: \eDIFFERENT_NUMBER_OF_COMPONENTS.MEASURED_DATA_TYPE, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eDIFFERENT_NUMBER_OF_COMPONENTS.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eDIFFERENT_NUMBER_OF_COMPONENTS.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", 
        keyPath: \eDIFFERENT_NUMBER_OF_COMPONENTS.COMPARING_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: false)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_NUMBER_OF_COMPONENTS``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      @_documentation(visibility:public)
      internal func _measured_data_type__getter(SELF: eDIFFERENT_NUMBER_OF_COMPONENTS.PRef) -> 
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _detected_difference_types__getter(SELF: eDIFFERENT_NUMBER_OF_COMPONENTS.PRef) -> SDAI.LIST<
        ...
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_DETECTED_DIFFERENCE_TYPE_NAME> */ = SDAI.LIST<
          nA3MA_DETECTED_DIFFERENCE_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: SDAI.INTEGER(1),  ([ 
            ...
            DDNA_COUNT_MEASURE)) ] as [SDAI.AggregationInitializerElement<nA3MA_DETECTED_DIFFERENCE_TYPE_NAME>]) )
        let value = _TEMP1
        return SDAI.UNWRAP( value )
      }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDIFFERENT_NUMBER_OF_COMPONENTS.PartialEntity :
