/* file: dimension_callout_component_relationship.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY dimension_callout_component_relationship
    ...
    WHERE
      ...
      wr6: ( ( SELF.name = 'suffix' ) AND ( SIZEOF( QUERY ( ato <* QUERY ( con <* SELF.
               ...
               = 0 ) );
  END_ENTITY; -- dimension_callout_component_relationship (line:12351 file:ap242ed2_mim_lf_v1.101.TY.exp)
