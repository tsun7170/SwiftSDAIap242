/* file: dimension_callout_component_relationship.swift 	 generated: Mon Jan  3 16:32:52 2022 */
  ...
  ENTITY dimension_callout_component_relationship
    ...
    WHERE
      ...
      wr6: ( ( SELF.name = 'suffix' ) AND ( SIZEOF( QUERY ( ato <* QUERY ( con <* SELF.
               ...
               = 0 ) );
  END_ENTITY; -- dimension_callout_component_relationship (line:12352 file:ap242ed2_mim_lf_v1.101.TY.exp)
