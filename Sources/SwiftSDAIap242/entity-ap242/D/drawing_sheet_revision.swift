/* file: drawing_sheet_revision.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- drawing_sheet_revision (line:13220 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDRAWING_SHEET_REVISION/PartialEntity``
*/
  public final class eDRAWING_SHEET_REVISION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eDRAWING_SHEET_REVISION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eDRAWING_SHEET_REVISION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eDRAWING_SHEET_REVISION.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDRAWING_SHEET_REVISION`` )
    public var REVISION_IDENTIFIER: tIDENTIFIER {
      get {
        let originalValue = self.partialEntity._revision_identifier
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eDRAWING_SHEET_REVISION.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eDRAWING_SHEET_REVISION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDRAWING_SHEET_REVISION``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: eDRAWING_SHEET_REVISION.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP3 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP2?
          .QUERY{ ITEM in 
            ...
            let _TEMP2 /* SDAI.LOGICAL */ = SDAI.TYPEOF( ((ITEM.GROUP_REF(eMAPPED_ITEM.self))?.MAPPING_SOURCE)?
              .MAPPED_REPRESENTATION, IS: eDRAWING_SHEET_REVISION.self )
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( REVISION_IDENTIFIER: original._revision_identifier )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]REVISION_IDENTIFIER for partial entity(\(Self.entityName)) constructor"); return nil }
