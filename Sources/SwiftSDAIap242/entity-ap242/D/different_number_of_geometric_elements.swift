/* file: different_number_of_geometric_elements.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- different_number_of_geometric_elements (line:12210 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _different_number_of_geometric_elements : SDAI.PartialEntity {
...
```
*/
  public final class eDIFFERENT_NUMBER_OF_GEOMETRIC_ELEMENTS : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eDIFFERENT_NUMBER_OF_GEOMETRIC_ELEMENTS`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "DIFFERENT_NUMBER_OF_GEOMETRIC_ELEMENTS", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ACCURACY_TYPES", keyPath: \eDIFFERENT_NUMBER_OF_GEOMETRIC_ELEMENTS.ACCURACY_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", keyPath: \eDIFFERENT_NUMBER_OF_GEOMETRIC_ELEMENTS.DETECTED_DIFFERENCE_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", keyPath: \eDIFFERENT_NUMBER_OF_GEOMETRIC_ELEMENTS.COMPARED_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", keyPath: \eDIFFERENT_NUMBER_OF_GEOMETRIC_ELEMENTS.MEASURED_DATA_TYPE, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eDIFFERENT_NUMBER_OF_GEOMETRIC_ELEMENTS.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eDIFFERENT_NUMBER_OF_GEOMETRIC_ELEMENTS.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", keyPath: \eDIFFERENT_NUMBER_OF_GEOMETRIC_ELEMENTS.COMPARING_ELEMENT_TYPES, 
