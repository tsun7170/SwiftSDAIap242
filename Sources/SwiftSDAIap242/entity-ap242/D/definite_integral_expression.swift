/* file: definite_integral_expression.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _definite_integral_expression : SDAI.PartialEntity, @unchecked Sendable {
    ...
    @_documentation(visibility:public)
    internal func _variables__getter(complex: SDAI.ComplexEntity) -> SDAI.LIST_UNIQUE<eGENERIC_VARIABLE.PRef>
      /*[1:nil]*/  {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_definite_integral_expression``
*/
  public final class eDEFINITE_INTEGRAL_EXPRESSION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _definite_integral_expression.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _definite_integral_expression.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _definite_integral_expression.WHERE_wr3(SELF: instance.pRef)
      return result
    }
