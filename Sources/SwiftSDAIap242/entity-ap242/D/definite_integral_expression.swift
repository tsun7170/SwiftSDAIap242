/* file: definite_integral_expression.swift 	 generated: Tue Jan 20 19:20:51 2026 */
...
*/
  public final class eDEFINITE_INTEGRAL_EXPRESSION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eDEFINITE_INTEGRAL_EXPRESSION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eDEFINITE_INTEGRAL_EXPRESSION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eDEFINITE_INTEGRAL_EXPRESSION.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      return result
    }
