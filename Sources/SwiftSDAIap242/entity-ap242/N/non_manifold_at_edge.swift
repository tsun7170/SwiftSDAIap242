/* file: non_manifold_at_edge.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eNON_MANIFOLD_AT_EDGE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eNON_MANIFOLD_AT_EDGE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eNON_MANIFOLD_AT_EDGE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eNON_MANIFOLD_AT_EDGE.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eNON_MANIFOLD_AT_EDGE.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
