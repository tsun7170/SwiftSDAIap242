/* file: non_manifold_at_edge.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- non_manifold_at_edge (line:22129 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _non_manifold_at_edge : SDAI.PartialEntity {
...
```
*/
  public final class eNON_MANIFOLD_AT_EDGE : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eNON_MANIFOLD_AT_EDGE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "NON_MANIFOLD_AT_EDGE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eNON_MANIFOLD_AT_EDGE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eNON_MANIFOLD_AT_EDGE.NAME, 
