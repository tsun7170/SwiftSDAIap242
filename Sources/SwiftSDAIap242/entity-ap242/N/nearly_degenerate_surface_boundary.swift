/* file: nearly_degenerate_surface_boundary.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  ENTITY nearly_degenerate_surface_boundary
    ...
    WHERE
      wr1: ( ( 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.SHAPE_DATA_QUALITY_VALUE_RANGE' IN TYPEOF( 
               SELF\shape_data_quality_criterion.assessment_specification\
  ...
  END_ENTITY; -- nearly_degenerate_surface_boundary (line:22133 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(7)	geometry_with_local_near_degeneracy
    (no local attributes)

  ENTITY(SELF)	nearly_degenerate_surface_boundary
...
- SUPERTYPES:
	...
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNEARLY_DEGENERATE_SURFACE_BOUNDARY/PartialEntity``
*/
  public final class eNEARLY_DEGENERATE_SURFACE_BOUNDARY : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eNEARLY_DEGENERATE_SURFACE_BOUNDARY>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eNEARLY_DEGENERATE_SURFACE_BOUNDARY.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eNEARLY_DEGENERATE_SURFACE_BOUNDARY.PartialEntity
    ...
    public let super_eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY: eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY 	// [7]
    public var super_eNEARLY_DEGENERATE_SURFACE_BOUNDARY: eNEARLY_DEGENERATE_SURFACE_BOUNDARY { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNEARLY_DEGENERATE_SURFACE_BOUNDARY`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eNEARLY_DEGENERATE_SURFACE_BOUNDARY.PartialEntity.self) else { return nil }
      ...
      guard let super7 = complexEntity?.entityReference(eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY.self) else { return nil }
      self.super_eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY = super7
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eNEARLY_DEGENERATE_SURFACE_BOUNDARY.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eNEARLY_DEGENERATE_SURFACE_BOUNDARY.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eNEARLY_DEGENERATE_SURFACE_BOUNDARY.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eNEARLY_DEGENERATE_SURFACE_BOUNDARY.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = eNEARLY_DEGENERATE_SURFACE_BOUNDARY.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "NEARLY_DEGENERATE_SURFACE_BOUNDARY", 
      ...
      entityDef.add(supertype: eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY.self)
      entityDef.add(supertype: eNEARLY_DEGENERATE_SURFACE_BOUNDARY.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eNEARLY_DEGENERATE_SURFACE_BOUNDARY.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eNEARLY_DEGENERATE_SURFACE_BOUNDARY.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNEARLY_DEGENERATE_SURFACE_BOUNDARY``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eNEARLY_DEGENERATE_SURFACE_BOUNDARY.self
      }
      ...
      public static func WHERE_wr1(SELF: eNEARLY_DEGENERATE_SURFACE_BOUNDARY.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( (((SELF.GROUP_REF(eSHAPE_DATA_QUALITY_CRITERION.self))?.ASSESSMENT_SPECIFICATION)?
          ...
          IS: eSHAPE_DATA_QUALITY_VALUE_RANGE.self )
      ...
      public static func WHERE_wr2(SELF: eNEARLY_DEGENERATE_SURFACE_BOUNDARY.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eNEARLY_DEGENERATE_SURFACE_BOUNDARY.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.LENGTH_MEASURE") )
        return _TEMP1
      }
      public static func WHERE_wr3(SELF: eNEARLY_DEGENERATE_SURFACE_BOUNDARY.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
      ...
      public static func WHERE_wr4(SELF: eNEARLY_DEGENERATE_SURFACE_BOUNDARY.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
            SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOUNDARY_CURVE_OF_B_SPLINE_OR_RECTANGULAR_COMPOSITE_SURFACE")) ] 
            as [SDAI.AggregationInitializerElement<SDAI.STRING>]) )
      ...
      public static func WHERE_wr5(SELF: eNEARLY_DEGENERATE_SURFACE_BOUNDARY.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
