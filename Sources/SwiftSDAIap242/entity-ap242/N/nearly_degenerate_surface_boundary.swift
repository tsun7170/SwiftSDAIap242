/* file: nearly_degenerate_surface_boundary.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- nearly_degenerate_surface_boundary (line:21938 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _nearly_degenerate_surface_boundary : SDAI.PartialEntity {
...
```
*/
  public final class eNEARLY_DEGENERATE_SURFACE_BOUNDARY : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eNEARLY_DEGENERATE_SURFACE_BOUNDARY`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "NEARLY_DEGENERATE_SURFACE_BOUNDARY", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eNEARLY_DEGENERATE_SURFACE_BOUNDARY.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eNEARLY_DEGENERATE_SURFACE_BOUNDARY.NAME, 
