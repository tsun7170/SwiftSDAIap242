/* file: nearly_degenerate_geometry.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- nearly_degenerate_geometry (line:21933 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _nearly_degenerate_geometry : SDAI.PartialEntity {
...
```
*/
  public final class eNEARLY_DEGENERATE_GEOMETRY : SDAI.EntityReference {
    ...
    /// - origin: SUB( ``eENTIRELY_NARROW_SURFACE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "NEARLY_DEGENERATE_GEOMETRY", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "WIDTH_TOLERANCE", keyPath: \eNEARLY_DEGENERATE_GEOMETRY.WIDTH_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eNEARLY_DEGENERATE_GEOMETRY.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eNEARLY_DEGENERATE_GEOMETRY.NAME, 
