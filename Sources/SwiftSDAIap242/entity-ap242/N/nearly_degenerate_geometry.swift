/* file: nearly_degenerate_geometry.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- nearly_degenerate_geometry (line:22128 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	nearly_degenerate_geometry
    (no local attributes)

  SUB- ENTITY(8)	short_length_curve
  ...
  SUB- ENTITY(9)	small_area_surface
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(10)	entirely_narrow_surface
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNEARLY_DEGENERATE_GEOMETRY/PartialEntity``
*/
  public final class eNEARLY_DEGENERATE_GEOMETRY : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eNEARLY_DEGENERATE_GEOMETRY>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eNEARLY_DEGENERATE_GEOMETRY.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eNEARLY_DEGENERATE_GEOMETRY.PartialEntity
    ...
    public var super_eNEARLY_DEGENERATE_GEOMETRY: eNEARLY_DEGENERATE_GEOMETRY { return self } 	// [7]

    //MARK: SUBTYPES
    public var sub_eSHORT_LENGTH_CURVE: eSHORT_LENGTH_CURVE? {	// [8]
      return self.complexEntity.entityReference(eSHORT_LENGTH_CURVE.self)
    }

    public var sub_eSMALL_AREA_SURFACE: eSMALL_AREA_SURFACE? {	// [9]
      return self.complexEntity.entityReference(eSMALL_AREA_SURFACE.self)
    }

    public var sub_eENTIRELY_NARROW_SURFACE: eENTIRELY_NARROW_SURFACE? {	// [10]
    ...
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eENTIRELY_NARROW_SURFACE`` )
    public var WIDTH_TOLERANCE: tLENGTH_MEASURE?  {
      get {
        let originalValue = sub_eENTIRELY_NARROW_SURFACE?.partialEntity._width_tolerance
        let value = tLENGTH_MEASURE( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eENTIRELY_NARROW_SURFACE?.partialEntity
          else { return }
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eNEARLY_DEGENERATE_GEOMETRY.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "NEARLY_DEGENERATE_GEOMETRY", 
      ...
      entityDef.addAttribute(name: "WIDTH_TOLERANCE", 
        keyPath: \eNEARLY_DEGENERATE_GEOMETRY.WIDTH_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eNEARLY_DEGENERATE_GEOMETRY.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eNEARLY_DEGENERATE_GEOMETRY.NAME, 
