/* file: nearly_degenerate_geometry.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eNEARLY_DEGENERATE_GEOMETRY : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var WIDTH_TOLERANCE: tLENGTH_MEASURE?  {
      get {
        return sub_eENTIRELY_NARROW_SURFACE?.partialEntity._width_tolerance
      }
      set(newValue) {
        guard let partial = sub_eENTIRELY_NARROW_SURFACE?.super_eENTIRELY_NARROW_SURFACE.partialEntity
          else { return }
