/* file: numeric_expression.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
*/
  public final class eNUMERIC_EXPRESSION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var THE_VALUE: SDAI.NUMBER?  {
      get {
        let originalValue = sub_eLITERAL_NUMBER?.partialEntity._the_value
        let value = SDAI.NUMBER( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eLITERAL_NUMBER?.partialEntity
          else { return }
    ...
    public var OPERAND: eSTRING_EXPRESSION.PRef?  {
      get {
        let originalValue = sub_eVALUE_FUNCTION?
          .super_eUNARY_GENERIC_EXPRESSION.partialEntity._operand
        let value = eSTRING_EXPRESSION.PRef( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
