/* file: not_expression.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- not_expression (line:22660 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNOT_EXPRESSION/PartialEntity``
*/
  public final class eNOT_EXPRESSION : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eNOT_EXPRESSION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eNOT_EXPRESSION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eNOT_EXPRESSION.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNOT_EXPRESSION`` )
    public var OPERAND: eBOOLEAN_EXPRESSION.PRef {
      get {
        let originalValue = super_eUNARY_GENERIC_EXPRESSION.partialEntity._operand
        let value = SDAI.UNWRAP( eBOOLEAN_EXPRESSION.PRef( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eNOT_EXPRESSION.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "OPERAND", 
        keyPath: \eNOT_EXPRESSION.OPERAND, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNOT_EXPRESSION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _operand: eBOOLEAN_EXPRESSION.PRef	//EXPLICIT REDEFINITION(eUNARY_GENERIC_EXPRESSION) */
