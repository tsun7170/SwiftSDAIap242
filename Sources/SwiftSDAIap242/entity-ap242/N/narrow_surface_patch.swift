/* file: narrow_surface_patch.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _narrow_surface_patch : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eNARROW_SURFACE_PATCH?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = VALIDATE_MEASURED_DATA_TYPE(
        EI: eSHAPE_DATA_QUALITY_CRITERION(/*eNARROW_SURFACE_PATCH*/SELF), 
        TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOOLEAN_VALUE"))
      return _TEMP1
    }
    public static func WHERE_wr2(SELF: eNARROW_SURFACE_PATCH?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eNARROW_SURFACE_PATCH?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eNARROW_SURFACE_PATCH?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eNARROW_SURFACE_PATCH : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _narrow_surface_patch.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _narrow_surface_patch.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _narrow_surface_patch.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _narrow_surface_patch.WHERE_wr4(SELF: instance)
      return result
    }
