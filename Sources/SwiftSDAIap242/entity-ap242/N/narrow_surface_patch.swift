/* file: narrow_surface_patch.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- narrow_surface_patch (line:21915 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _narrow_surface_patch : SDAI.PartialEntity {
...
```
*/
  public final class eNARROW_SURFACE_PATCH : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eNARROW_SURFACE_PATCH`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "NARROW_SURFACE_PATCH", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "WIDTH_TOLERANCE", keyPath: \eNARROW_SURFACE_PATCH.WIDTH_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eNARROW_SURFACE_PATCH.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eNARROW_SURFACE_PATCH.NAME, 
