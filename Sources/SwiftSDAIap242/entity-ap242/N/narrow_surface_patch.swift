/* file: narrow_surface_patch.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _narrow_surface_patch : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_narrow_surface_patch``
*/
  public final class eNARROW_SURFACE_PATCH : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _narrow_surface_patch.self
    }
    /// partial entity reference
    public let partialEntity: _narrow_surface_patch
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_narrow_surface_patch.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _narrow_surface_patch.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _narrow_surface_patch.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _narrow_surface_patch.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _narrow_surface_patch.WHERE_wr4(SELF: instance.pRef)
      return result
    }
