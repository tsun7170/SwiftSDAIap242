/* file: non_smooth_geometry_transition_across_edge.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- non_smooth_geometry_transition_across_edge (line:22470 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "NON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "FLAT_CURVATURE_RADIUS_TOLERANCE", keyPath: \eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE.FLAT_CURVATURE_RADIUS_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION_2", keyPath: \eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE.ASSESSMENT_SPECIFICATION_2, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE.NAME, 
