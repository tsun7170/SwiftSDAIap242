/* file: non_smooth_geometry_transition_across_edge.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- non_smooth_geometry_transition_across_edge (line:22651 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	non_smooth_geometry_transition_across_edge
    (no local attributes)

  SUB- ENTITY(8)	g2_discontinuity_between_adjacent_faces
  ...
  SUB- ENTITY(9)	g1_discontinuity_between_adjacent_faces
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE/PartialEntity``
*/
  public final class eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE.PartialEntity
    ...
    public var super_eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE: eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE { return self } 	// [7]

    //MARK: SUBTYPES
    public var sub_eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES: eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES? {	// [8]
      return self.complexEntity.entityReference(eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.self)
    }

    public var sub_eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES: eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES? {	// [9]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "NON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE", 
      ...
      entityDef.addAttribute(name: "FLAT_CURVATURE_RADIUS_TOLERANCE", 
        keyPath: \eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE.FLAT_CURVATURE_RADIUS_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION_2", 
        keyPath: \eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE.ASSESSMENT_SPECIFICATION_2, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE.self
      }
