/* file: named_unit.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- named_unit (line:22102 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMASS_UNIT``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAMOUNT_OF_SUBSTANCE_UNIT``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eELECTRIC_CURRENT_UNIT``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSOLID_ANGLE_UNIT``
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTERNALLY_DEFINED_CURRENCY``
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eISO4217_CURRENCY``
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURRENCY``
	8.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXPRESSION_CONVERSION_BASED_UNIT``
	9.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTERNALLY_DEFINED_CONTEXT_DEPENDENT_UNIT``
	10.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONTEXT_DEPENDENT_UNIT``
	11.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRATIO_UNIT``
	12.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLANE_ANGLE_UNIT``
	13.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLUMINOUS_INTENSITY_UNIT``
	14.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLUMINOUS_FLUX_UNIT``
	15.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTHERMODYNAMIC_TEMPERATURE_UNIT``
	16.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLENGTH_UNIT``
	17.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTIME_UNIT``
	18.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTERNALLY_DEFINED_CONVERSION_BASED_UNIT``
	19.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONVERSION_BASED_UNIT``
	20.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_RESISTANCE_UNIT``
	21.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_ENERGY_UNIT``
	22.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_ILLUMINANCE_UNIT``
	23.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_ABSORBED_DOSE_UNIT``
	24.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_FREQUENCY_UNIT``
	25.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_RADIOACTIVITY_UNIT``
	26.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_INDUCTANCE_UNIT``
	27.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_MAGNETIC_FLUX_DENSITY_UNIT``
	28.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_POWER_UNIT``
	29.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_PRESSURE_UNIT``
	30.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_MAGNETIC_FLUX_UNIT``
	31.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_ELECTRIC_POTENTIAL_UNIT``
	32.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_DOSE_EQUIVALENT_UNIT``
	33.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_ELECTRIC_CHARGE_UNIT``
	34.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_CONDUCTANCE_UNIT``
	35.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_FORCE_UNIT``
	36.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_CAPACITANCE_UNIT``
	37.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_UNIT``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNAMED_UNIT/PartialEntity``
*/
  public final class eNAMED_UNIT : SDAI.EntityReference, SDAI.DualModeReference, SDAI.SimpleEntityType, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eNAMED_UNIT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eNAMED_UNIT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eNAMED_UNIT.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNAMED_UNIT`` )
    public var DIMENSIONS: eDIMENSIONAL_EXPONENTS.PRef {
      get {
        if let resolved = eNAMED_UNIT.PartialEntity._dimensions__provider(complex: self.complexEntity) {
          ...
          let originalValue = self.partialEntity._dimensions
    ...
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONVERSION_BASED_UNIT`` )
    public var CONVERSION_FACTOR: eMEASURE_WITH_UNIT.PRef?  {
      get {
        let originalValue = sub_eCONVERSION_BASED_UNIT?.partialEntity._conversion_factor
        let value = eMEASURE_WITH_UNIT.PRef( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eCONVERSION_BASED_UNIT?.partialEntity
          else { return }
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_UNIT`` )
    public var PREFIX: nSI_PREFIX?  {
      get {
        let originalValue = sub_eSI_UNIT?.partialEntity._prefix
        let value = nSI_PREFIX( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eSI_UNIT?.partialEntity
          else { return }
    ...
    get {
      let value = sub_eEXPRESSION_CONVERSION_BASED_UNIT?.ASSOCIATED_VARIABLE_ENVIRONMENT
      return value
    }
    }
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eNAMED_UNIT.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "ASSOCIATED_VARIABLE_ENVIRONMENT", 
        keyPath: \eNAMED_UNIT.ASSOCIATED_VARIABLE_ENVIRONMENT, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNAMED_UNIT``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _dimensions: eDIMENSIONAL_EXPONENTS.PRef?  // PLAIN EXPLICIT ATTRIBUTE

      internal static func _dimensions__provider(complex: SDAI.ComplexEntity) -> eNAMED_UNIT__DIMENSIONS__provider? {
        let resolved = complex.resolvePartialEntityInstance(from: [eSI_UNIT.PartialEntity.typeIdentity])
      ...
      final public override class func fixupPartialComplexEntityAttributes(partialComplex: SDAI.ComplexEntity, baseComplex: SDAI.ComplexEntity) {
        guard let pe = partialComplex.partialEntityInstance(eNAMED_UNIT.PartialEntity.self) else { return }
      ...
      public init(DIMENSIONS: eDIMENSIONAL_EXPONENTS.PRef? ) {
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( DIMENSIONS: original._dimensions )
      }
      ...
      public required convenience init?(
        ...
        guard case .success(let p0) = exchangeStructure.recoverOmittableParameter(as: 
          eDIMENSIONAL_EXPONENTS.PRef.self, from: parameters[0])
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]DIMENSIONS for partial entity(\(Self.entityName)) constructor"); return nil }
...
internal protocol eNAMED_UNIT__DIMENSIONS__provider {
  ...
  func _dimensions__getter(complex: SDAI.ComplexEntity) -> 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDIMENSIONAL_EXPONENTS.PRef
}
