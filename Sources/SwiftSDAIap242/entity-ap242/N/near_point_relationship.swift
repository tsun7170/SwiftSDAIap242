/* file: near_point_relationship.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
/*
  ...
  END_ENTITY; -- near_point_relationship (line:22122 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	near_point_relationship
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNEAR_POINT_RELATIONSHIP/PartialEntity``
*/
  public final class eNEAR_POINT_RELATIONSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eNEAR_POINT_RELATIONSHIP>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eNEAR_POINT_RELATIONSHIP.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eNEAR_POINT_RELATIONSHIP.PartialEntity

    //MARK: SUPERTYPES
    public let super_eREPRESENTATION_ITEM_RELATIONSHIP: eREPRESENTATION_ITEM_RELATIONSHIP 	// [1]
    public var super_eNEAR_POINT_RELATIONSHIP: eNEAR_POINT_RELATIONSHIP { return self } 	// [2]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNEAR_POINT_RELATIONSHIP`` )
    public var RELATED_REPRESENTATION_ITEM: ePOINT.PRef {
      get {
        return SDAI.UNWRAP( ePOINT.PRef( super_eREPRESENTATION_ITEM_RELATIONSHIP.partialEntity
    ...
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNEAR_POINT_RELATIONSHIP`` )
    public var RELATING_REPRESENTATION_ITEM: sCURVE_OR_SURFACE_CONSTRAINT_ELEMENT {
      get {
        return SDAI.UNWRAP( sCURVE_OR_SURFACE_CONSTRAINT_ELEMENT( super_eREPRESENTATION_ITEM_RELATIONSHIP
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eNEAR_POINT_RELATIONSHIP.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eNEAR_POINT_RELATIONSHIP.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eNEAR_POINT_RELATIONSHIP.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATED_REPRESENTATION_ITEM", 
        keyPath: \eNEAR_POINT_RELATIONSHIP.RELATED_REPRESENTATION_ITEM, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eNEAR_POINT_RELATIONSHIP.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATING_REPRESENTATION_ITEM", 
        keyPath: \eNEAR_POINT_RELATIONSHIP.RELATING_REPRESENTATION_ITEM, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNEAR_POINT_RELATIONSHIP``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eNEAR_POINT_RELATIONSHIP.self
      }

      //ATTRIBUTES
      /* override var _relating_representation_item: sCURVE_OR_SURFACE_CONSTRAINT_ELEMENT	//EXPLICIT REDEFINITION(eREPRESENTATION_ITEM_RELATIONSHIP) */

      /* override var _related_representation_item: ePOINT.PRef	//EXPLICIT REDEFINITION(eREPRESENTATION_ITEM_RELATIONSHIP) */
