/* file: near_point_relationship.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _near_point_relationship : SDAI.PartialEntity, @unchecked Sendable {
    ...
    /* override var _related_representation_item: ePOINT	//EXPLICIT REDEFINITION(eREPRESENTATION_ITEM_RELATIONSHIP) */
...
```
*/
  public final class eNEAR_POINT_RELATIONSHIP : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var RELATED_REPRESENTATION_ITEM: ePOINT {
      get {
        return SDAI.UNWRAP( ePOINT( super_eREPRESENTATION_ITEM_RELATIONSHIP.partialEntity
