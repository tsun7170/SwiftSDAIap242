/* file: nearly_degenerate_surface_patch.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- nearly_degenerate_surface_patch (line:21968 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _nearly_degenerate_surface_patch : SDAI.PartialEntity {
...
```
*/
  public final class eNEARLY_DEGENERATE_SURFACE_PATCH : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eNEARLY_DEGENERATE_SURFACE_PATCH`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "NEARLY_DEGENERATE_SURFACE_PATCH", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eNEARLY_DEGENERATE_SURFACE_PATCH.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eNEARLY_DEGENERATE_SURFACE_PATCH.NAME, 
