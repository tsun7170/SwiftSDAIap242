/* file: neutral_sketch_representation.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _neutral_sketch_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eNEUTRAL_SKETCH_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP1 /* SDAI.SET<sSKETCH_ELEMENT_SELECT>[1:nil] ? */ = SELF.ITEMS?
        .QUERY{ Q in 
          ...
          let _TEMP2 /* eGEOMETRIC_REPRESENTATION_ITEM.PRef? */ = Q.GROUP_REF(eGEOMETRIC_REPRESENTATION_ITEM.self)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_neutral_sketch_representation``
*/
  public final class eNEUTRAL_SKETCH_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _neutral_sketch_representation.self
    }
    /// partial entity reference
    public let partialEntity: _neutral_sketch_representation
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_neutral_sketch_representation.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _neutral_sketch_representation.WHERE_wr1(SELF: instance.pRef)
      return result
    }
