/* file: neutral_sketch_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _neutral_sketch_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eNEUTRAL_SKETCH_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.ITEMS.QUERY{ Q in 

          let _TEMP1 = SDAI.TYPEOF(Q, IS: eGEOMETRIC_REPRESENTATION_ITEM.self)
          let _TEMP2 = Q.GROUP_REF(eGEOMETRIC_REPRESENTATION_ITEM.self)
...
```
*/
  public final class eNEUTRAL_SKETCH_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _neutral_sketch_representation.WHERE_wr1(SELF: instance)
      return result
    }
