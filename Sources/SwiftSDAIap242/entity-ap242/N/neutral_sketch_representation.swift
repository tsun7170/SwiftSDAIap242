/* file: neutral_sketch_representation.swift 	 generated: Mon Jan  3 16:32:52 2022 */
  ...
  ENTITY neutral_sketch_representation
    ...
    WHERE
      wr1: ( SIZEOF( QUERY ( q <* items | ( NOT ( ( 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               ...
               = 3 ) ) ) ) ) = 0 );
  END_ENTITY; -- neutral_sketch_representation (line:21984 file:ap242ed2_mim_lf_v1.101.TY.exp)
