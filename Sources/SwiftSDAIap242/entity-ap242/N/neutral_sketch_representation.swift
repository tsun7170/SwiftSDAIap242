/* file: neutral_sketch_representation.swift 	 generated: Sun Oct 31 15:32:10 2021 */
  ...
  ENTITY neutral_sketch_representation
    ...
    WHERE
      wr1: ( SIZEOF( QUERY ( q <* items | ( NOT ( ( 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               ...
               = 3 ) ) ) ) ) = 0 );
  END_ENTITY; -- neutral_sketch_representation (line:21969 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _neutral_sketch_representation : SDAI.PartialEntity {
...
```
*/
  public final class eNEUTRAL_SKETCH_REPRESENTATION : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eNEUTRAL_SKETCH_REPRESENTATION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "NEUTRAL_SKETCH_REPRESENTATION", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eNEUTRAL_SKETCH_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eNEUTRAL_SKETCH_REPRESENTATION.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eNEUTRAL_SKETCH_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eNEUTRAL_SKETCH_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NEUTRAL_SKETCH_SEMANTICS", keyPath: \eNEUTRAL_SKETCH_REPRESENTATION.NEUTRAL_SKETCH_SEMANTICS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eNEUTRAL_SKETCH_REPRESENTATION.NAME, 
