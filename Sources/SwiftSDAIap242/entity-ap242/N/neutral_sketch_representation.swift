/* file: neutral_sketch_representation.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eNEUTRAL_SKETCH_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var ITEMS: SDAI.SET<sSKETCH_ELEMENT_SELECT>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<sSKETCH_ELEMENT_SELECT>( super_eREPRESENTATION.partialEntity._items ) )
      }
      set(newValue) {
    ...
    public var NEUTRAL_SKETCH_SEMANTICS: nCURVES_OR_AREA {
      get {
        return SDAI.UNWRAP( self.partialEntity._neutral_sketch_semantics )
      }
      set(newValue) {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eNEUTRAL_SKETCH_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      /* override var _items: SDAI.SET<sSKETCH_ELEMENT_SELECT>[1:nil] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
      ...
      public static func WHERE_wr1(SELF: eNEUTRAL_SKETCH_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP1 /* SDAI.SET<sSKETCH_ELEMENT_SELECT>[1:nil] ? */ = SELF.ITEMS?
          .QUERY{ Q in 
            // QUERY BODY
