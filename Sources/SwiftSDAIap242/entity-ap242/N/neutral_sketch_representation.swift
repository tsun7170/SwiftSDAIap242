/* file: neutral_sketch_representation.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      /* override var _items: SDAI.SET<sSKETCH_ELEMENT_SELECT>[1:?] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
      ...
      public static func WHERE_wr1(SELF: eNEUTRAL_SKETCH_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        ...
        //
        let _TEMP1 /* SDAI.SET<sSKETCH_ELEMENT_SELECT>[1:?] ? */ = SELF.ITEMS?
          .QUERY{ Q in 
            // QUERY BODY
            //
