/* file: non_manifold_surface_shape_representation.swift 	 generated: Thu Dec 25 18:13:23 2025 */
...
*/
  ...
  public final class _non_manifold_surface_shape_representation : SDAI.PartialEntity, InitializableByVoid
    , @unchecked Sendable {
              ...
              let _TEMP2 /* SDAI.SET<eFACE.PRef>[1:nil] ? */ = _TEMP1?
                .QUERY{ FA in 
                  ...
                  let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ =  ([ 
                      ...
                      as [SDAI.AggregationInitializerElement<SDAI.STRING>]) 
                  let _TEMP2 /* SDAI.SET<SDAI.STRING> */ = SDAI.TYPEOF( FA )
            ...
            .QUERY{ CFS in 
              ...
              let _TEMP3 /* SDAI.SET<eFACE.PRef>[1:nil] ? */ = _TEMP2?
                .QUERY{ F_SF in 
                  ...
                  let _TEMP4 /* SDAI.BOOLEAN? */ = NMSF_SURFACE_CHECK( _TEMP3 )
            ...
            .QUERY{ CFS in 
              ...
              let _TEMP3 /* SDAI.SET<eFACE.PRef>[1:nil] ? */ = _TEMP2?
                .QUERY{ O_FA in 
                  ...
                  let _TEMP6 /* SDAI.BOOLEAN? */ = NMSF_SURFACE_CHECK( _TEMP5 )
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_non_manifold_surface_shape_representation``
*/
  public final class eNON_MANIFOLD_SURFACE_SHAPE_REPRESENTATION : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _non_manifold_surface_shape_representation.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _non_manifold_surface_shape_representation.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _non_manifold_surface_shape_representation.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _non_manifold_surface_shape_representation.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _non_manifold_surface_shape_representation.WHERE_wr5(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr6"] = _non_manifold_surface_shape_representation.WHERE_wr6(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr7"] = _non_manifold_surface_shape_representation.WHERE_wr7(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr8"] = _non_manifold_surface_shape_representation.WHERE_wr8(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr9"] = _non_manifold_surface_shape_representation.WHERE_wr9(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr10"] = _non_manifold_surface_shape_representation.WHERE_wr10(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr11"] = _non_manifold_surface_shape_representation.WHERE_wr11(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr12"] = _non_manifold_surface_shape_representation.WHERE_wr12(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr13"] = _non_manifold_surface_shape_representation.WHERE_wr13(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr14"] = _non_manifold_surface_shape_representation.WHERE_wr14(SELF: instance.pRef)
      return result
    }
