/* file: non_manifold_at_vertex.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _non_manifold_at_vertex : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_non_manifold_at_vertex``
*/
  public final class eNON_MANIFOLD_AT_VERTEX : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _non_manifold_at_vertex.self
    }
    /// partial entity reference
    public let partialEntity: _non_manifold_at_vertex
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_non_manifold_at_vertex.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _non_manifold_at_vertex.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _non_manifold_at_vertex.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _non_manifold_at_vertex.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _non_manifold_at_vertex.WHERE_wr4(SELF: instance.pRef)
      return result
    }
