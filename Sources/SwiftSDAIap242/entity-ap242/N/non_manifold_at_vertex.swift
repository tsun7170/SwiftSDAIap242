/* file: non_manifold_at_vertex.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- non_manifold_at_vertex (line:22139 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _non_manifold_at_vertex : SDAI.PartialEntity {
...
```
*/
  public final class eNON_MANIFOLD_AT_VERTEX : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eNON_MANIFOLD_AT_VERTEX`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "NON_MANIFOLD_AT_VERTEX", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eNON_MANIFOLD_AT_VERTEX.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eNON_MANIFOLD_AT_VERTEX.NAME, 
