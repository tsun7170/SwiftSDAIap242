/* file: curve_length_geometric_constraint.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _curve_length_geometric_constraint : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _constrained_elements: SDAI.SET<eBOUNDED_CURVE>[1:nil] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */
    ...
    public static func WHERE_wr1(SELF: eCURVE_LENGTH_GEOMETRIC_CONSTRAINT?) -> SDAI.LOGICAL {
...
```
*/
  public final class eCURVE_LENGTH_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _curve_length_geometric_constraint.WHERE_wr1(SELF: instance)
      return result
    }
