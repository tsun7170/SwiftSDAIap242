/* file: curve_length_geometric_constraint.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _curve_length_geometric_constraint : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_curve_length_geometric_constraint``
*/
  public final class eCURVE_LENGTH_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _curve_length_geometric_constraint.self
    }
    /// partial entity reference
    public let partialEntity: _curve_length_geometric_constraint
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_curve_length_geometric_constraint.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _curve_length_geometric_constraint.WHERE_wr1(SELF: instance.pRef)
      return result
    }
