/* file: curve_distance_geometric_constraint.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public final class eCURVE_DISTANCE_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var CONSTRAINED_ELEMENTS: SDAI.SET<eCURVE.PRef>/*[1:2]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eCURVE.PRef>( super_eEXPLICIT_CONSTRAINT.partialEntity
    ...
    public var DISTANCE_VALUE: tNON_NEGATIVE_LENGTH_MEASURE?  {
      get {
        return sub_eCDGC_WITH_DIMENSION?.partialEntity._distance_value
      }
      set(newValue) {
        guard let partial = sub_eCDGC_WITH_DIMENSION?.super_eCDGC_WITH_DIMENSION.partialEntity
          else { return }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eCURVE_DISTANCE_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eCURVE_DISTANCE_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eCURVE_DISTANCE_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: eCURVE_DISTANCE_GEOMETRIC_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP7 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:nil] ? */ = _TEMP6?.CONSTRAINED_ELEMENTS
      ...
      public static func WHERE_wr2(SELF: eCURVE_DISTANCE_GEOMETRIC_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP3 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[0:nil] ? */ = _TEMP2?.REFERENCE_ELEMENTS
