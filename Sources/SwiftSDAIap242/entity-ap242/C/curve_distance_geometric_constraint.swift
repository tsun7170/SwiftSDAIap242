/* file: curve_distance_geometric_constraint.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _curve_distance_geometric_constraint : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _constrained_elements: SDAI.SET<eCURVE>[1:2] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */
    ...
    public static func WHERE_wr1(SELF: eCURVE_DISTANCE_GEOMETRIC_CONSTRAINT?) -> SDAI.LOGICAL {
      ...
      let _TEMP5 = SDAI.TYPEOF(SELF, IS: eCDGC_WITH_DIMENSION.self)
    ...
    public static func WHERE_wr2(SELF: eCURVE_DISTANCE_GEOMETRIC_CONSTRAINT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eCURVE_DISTANCE_GEOMETRIC_CONSTRAINT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eCURVE_DISTANCE_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _curve_distance_geometric_constraint.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _curve_distance_geometric_constraint.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _curve_distance_geometric_constraint.WHERE_wr3(SELF: instance)
      return result
    }
