/* file: complex_number_literal.swift 	 generated: Fri Feb  6 16:23:46 2026 */
    ...
    public var IMAG_PART: SDAI.REAL {
      get {
        if let resolved = eCOMPLEX_NUMBER_LITERAL.PartialEntity._imag_part__provider(complex: self.complexEntity) {
          ...
          let originalValue = self.partialEntity._imag_part
    ...
    public var REAL_PART: SDAI.REAL {
      get {
        if let resolved = eCOMPLEX_NUMBER_LITERAL.PartialEntity._real_part__provider(complex: self.complexEntity) {
          ...
          let originalValue = self.partialEntity._real_part
          let value = SDAI.UNWRAP( SDAI.REAL( originalValue ) )
          return value
        }
      }
