/* file: curve_smoothness_geometric_constraint.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- curve_smoothness_geometric_constraint (line:11091 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _curve_smoothness_geometric_constraint : SDAI.PartialEntity {
...
```
*/
  public final class eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "CURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", keyPath: \eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", keyPath: \eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT.REFERENCE_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "SMOOTHNESS", keyPath: \eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT.SMOOTHNESS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", keyPath: \eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT.DIM, 
