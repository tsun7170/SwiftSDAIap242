/* file: curve_smoothness_geometric_constraint.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- curve_smoothness_geometric_constraint (line:11098 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	curve_smoothness_geometric_constraint
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT/PartialEntity``
*/
  public final class eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT.PartialEntity
    ...
    public var super_eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT: eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT { return self } 	// [7]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT`` )
    public var CONSTRAINED_ELEMENTS: SDAI.SET<eCURVE_SEGMENT_SET.PRef>/*[1:1]*/  {
      get {
        ...
        let value =         SDAI.SET<eCURVE_SEGMENT_SET.PRef>(
    ...
    public var SMOOTHNESS: nTRANSITION_CODE {
      get {
        let originalValue = self.partialEntity._smoothness
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", 
        keyPath: \eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", 
        keyPath: \eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT.REFERENCE_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "SMOOTHNESS", 
        keyPath: \eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT.SMOOTHNESS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", 
        keyPath: \eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT.DIM, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT.self
      }

      //ATTRIBUTES
      /* override var _constrained_elements: SDAI.SET<eCURVE_SEGMENT_SET.PRef>[1:1] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */

      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _smoothness: nTRANSITION_CODE // PLAIN EXPLICIT ATTRIBUTE
      ...
      public override func hashAsValue(into hasher: inout Hasher, visited complexEntities: inout Set<SDAI.ComplexEntity>) {
        ...
        self._smoothness.value.hashAsValue(into: &hasher, visited: &complexEntities)
      }

      public override func isValueEqual(to rhs: SDAI.PartialEntity, visited comppairs: inout Set<SDAI.ComplexPair>) -> Bool {
        guard let rhs = rhs as? Self else { return false }
        if !super.isValueEqual(to: rhs, visited: &comppairs) { return false }
        if let comp = self._smoothness.value.isValueEqualOptionally(to: rhs._smoothness.value, visited: &comppairs)	{
      ...
      public static func WHERE_wr1(SELF: eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
      ...
      public init(SMOOTHNESS: nTRANSITION_CODE) {
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( SMOOTHNESS: original._smoothness )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]SMOOTHNESS for partial entity(\(Self.entityName)) constructor"); return nil }

        self.init( SMOOTHNESS: p0 )
      }
    }
  }
}
