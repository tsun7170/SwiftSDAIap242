/* file: curve_smoothness_geometric_constraint.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var CONSTRAINED_ELEMENTS: SDAI.SET<eCURVE_SEGMENT_SET.PRef>/*[1:1]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eCURVE_SEGMENT_SET.PRef>( super_eEXPLICIT_CONSTRAINT.partialEntity
    ...
    public var SMOOTHNESS: nTRANSITION_CODE {
      get {
        return SDAI.UNWRAP( self.partialEntity._smoothness )
      }
      set(newValue) {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eCURVE_SMOOTHNESS_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
