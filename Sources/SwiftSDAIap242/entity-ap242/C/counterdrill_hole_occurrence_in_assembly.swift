/* file: counterdrill_hole_occurrence_in_assembly.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- counterdrill_hole_occurrence_in_assembly (line:10790 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _counterdrill_hole_occurrence_in_assembly : SDAI.PartialEntity {
...
```
*/
  public final class eCOUNTERDRILL_HOLE_OCCURRENCE_IN_ASSEMBLY : SDAI.EntityReference {
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``eCOUNTERDRILL_HOLE_OCCURRENCE_IN_ASSEMBLY`` )
    ...
    /// - origin: SUPER( ``eCOUNTERDRILL_HOLE_OCCURRENCE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "COUNTERDRILL_HOLE_OCCURRENCE_IN_ASSEMBLY", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "PRODUCT_DEFINITIONAL", keyPath: \eCOUNTERDRILL_HOLE_OCCURRENCE_IN_ASSEMBLY.PRODUCT_DEFINITIONAL, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eCOUNTERDRILL_HOLE_OCCURRENCE_IN_ASSEMBLY.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OF_SHAPE", keyPath: \eCOUNTERDRILL_HOLE_OCCURRENCE_IN_ASSEMBLY.OF_SHAPE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "MODIFIED_COMPONENTS", keyPath: \eCOUNTERDRILL_HOLE_OCCURRENCE_IN_ASSEMBLY.MODIFIED_COMPONENTS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eCOUNTERDRILL_HOLE_OCCURRENCE_IN_ASSEMBLY.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DEFINITION", keyPath: \eCOUNTERDRILL_HOLE_OCCURRENCE_IN_ASSEMBLY.DEFINITION, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eCOUNTERDRILL_HOLE_OCCURRENCE_IN_ASSEMBLY.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
