/* file: coaxial_geometric_constraint.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- coaxial_geometric_constraint (line:9638 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	coaxial_geometric_constraint
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOAXIAL_ASSEMBLY_CONSTRAINT``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOAXIAL_GEOMETRIC_CONSTRAINT/PartialEntity``
*/
  public final class eCOAXIAL_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eCOAXIAL_GEOMETRIC_CONSTRAINT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eCOAXIAL_GEOMETRIC_CONSTRAINT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eCOAXIAL_GEOMETRIC_CONSTRAINT.PartialEntity
    ...
    public var super_eCOAXIAL_GEOMETRIC_CONSTRAINT: eCOAXIAL_GEOMETRIC_CONSTRAINT { return self } 	// [7]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOAXIAL_GEOMETRIC_CONSTRAINT`` )
    public var CONSTRAINED_ELEMENTS: SDAI.SET<sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        ...
        let value =         SDAI.SET<sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT>(
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eCOAXIAL_GEOMETRIC_CONSTRAINT.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eCOAXIAL_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eCOAXIAL_GEOMETRIC_CONSTRAINT.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", 
        keyPath: \eCOAXIAL_GEOMETRIC_CONSTRAINT.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", 
        keyPath: \eCOAXIAL_GEOMETRIC_CONSTRAINT.REFERENCE_ELEMENTS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eCOAXIAL_GEOMETRIC_CONSTRAINT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", 
        keyPath: \eCOAXIAL_GEOMETRIC_CONSTRAINT.DIM, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOAXIAL_GEOMETRIC_CONSTRAINT``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eCOAXIAL_GEOMETRIC_CONSTRAINT.self
      }

      //ATTRIBUTES
      /* override var _constrained_elements: SDAI.SET<sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT>[1:(nil as SDAI.INTEGER?)] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */

      /* override var _reference_elements: SDAI.SET<sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT>[0:1] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */
      ...
      public static func WHERE_wr1(SELF: eCOAXIAL_GEOMETRIC_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP3 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[0:(nil as SDAI.INTEGER?)] ? */ = _TEMP2?
          .QUERY{ Q in 
            // QUERY BODY
            ...
            let _TEMP2 /* SDAI.AGGREGATE<SDAI.STRING> */ =  ([ 
                ...
                SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.SPHERE")) ] 
