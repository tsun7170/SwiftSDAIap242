/* file: coaxial_geometric_constraint.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
  public final class eCOAXIAL_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var CONSTRAINED_ELEMENTS: SDAI.SET<sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT>/*[1:?]*/  {
      get {
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _constrained_elements: SDAI.SET<sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT>[1:?] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */
      ...
      public static func WHERE_wr1(SELF: eCOAXIAL_GEOMETRIC_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP3 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[0:?] ? */ = _TEMP2?
          .QUERY{ Q in 
            // QUERY BODY
            //
