/* file: countersink_hole_definition.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _countersink_hole_definition : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_countersink_hole_definition``
*/
  public final class eCOUNTERSINK_HOLE_DEFINITION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _countersink_hole_definition.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _countersink_hole_definition.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _countersink_hole_definition.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _countersink_hole_definition.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _countersink_hole_definition.WHERE_wr5(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr6"] = _countersink_hole_definition.WHERE_wr6(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr7"] = _countersink_hole_definition.WHERE_wr7(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr8"] = _countersink_hole_definition.WHERE_wr8(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr9"] = _countersink_hole_definition.WHERE_wr9(SELF: instance.pRef)
      return result
    }
