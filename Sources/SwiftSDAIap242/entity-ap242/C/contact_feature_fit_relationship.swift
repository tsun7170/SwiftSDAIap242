/* file: contact_feature_fit_relationship.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- contact_feature_fit_relationship (line:10515 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUPERTYPES:
	...
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_FEATURE_FIT_RELATIONSHIP``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONTACT_FEATURE_FIT_RELATIONSHIP/PartialEntity``
*/
  public final class eCONTACT_FEATURE_FIT_RELATIONSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eCONTACT_FEATURE_FIT_RELATIONSHIP>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eCONTACT_FEATURE_FIT_RELATIONSHIP.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eCONTACT_FEATURE_FIT_RELATIONSHIP.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONTACT_FEATURE_FIT_RELATIONSHIP`` )
    public var RELATED_SHAPE_ASPECT: eCONTACT_FEATURE.PRef {
      get {
        ...
        let value = SDAI.UNWRAP( eCONTACT_FEATURE.PRef( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eCONTACT_FEATURE_FIT_RELATIONSHIP.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "CONTACT_FEATURE_FIT_RELATIONSHIP", 
      ...
      entityDef.addAttribute(name: "ID", 
        keyPath: \eCONTACT_FEATURE_FIT_RELATIONSHIP.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATED_SHAPE_ASPECT", 
        keyPath: \eCONTACT_FEATURE_FIT_RELATIONSHIP.RELATED_SHAPE_ASPECT, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "RELATING_SHAPE_ASPECT", 
        keyPath: \eCONTACT_FEATURE_FIT_RELATIONSHIP.RELATING_SHAPE_ASPECT, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONTACT_FEATURE_FIT_RELATIONSHIP``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _relating_shape_aspect: eCONTACT_FEATURE.PRef	//EXPLICIT REDEFINITION(eSHAPE_ASPECT_RELATIONSHIP) */

      /* override var _related_shape_aspect: eCONTACT_FEATURE.PRef	//EXPLICIT REDEFINITION(eSHAPE_ASPECT_RELATIONSHIP) */
