/* file: cylindrical_pair.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _cylindrical_pair : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _t_x__getter(SELF: eCYLINDRICAL_PAIR) -> SDAI.BOOLEAN {
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eLOW_ORDER_KINEMATIC_PAIR)
    /// - gut of derived attribute logic
    internal func _t_y__getter(SELF: eCYLINDRICAL_PAIR) -> SDAI.BOOLEAN {
      let value = SDAI.BOOLEAN(SDAI.FALSE)
      return SDAI.UNWRAP( value )
    }
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eLOW_ORDER_KINEMATIC_PAIR)
    /// - gut of derived attribute logic
    internal func _t_z__getter(SELF: eCYLINDRICAL_PAIR) -> SDAI.BOOLEAN {
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eLOW_ORDER_KINEMATIC_PAIR)
    /// - gut of derived attribute logic
    internal func _r_x__getter(SELF: eCYLINDRICAL_PAIR) -> SDAI.BOOLEAN {
      let value = SDAI.BOOLEAN(SDAI.FALSE)
      return SDAI.UNWRAP( value )
    }
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eLOW_ORDER_KINEMATIC_PAIR)
    /// - gut of derived attribute logic
    internal func _r_y__getter(SELF: eCYLINDRICAL_PAIR) -> SDAI.BOOLEAN {
      let value = SDAI.BOOLEAN(SDAI.FALSE)
      return SDAI.UNWRAP( value )
    }
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eLOW_ORDER_KINEMATIC_PAIR)
    /// - gut of derived attribute logic
    internal func _r_z__getter(SELF: eCYLINDRICAL_PAIR) -> SDAI.BOOLEAN {
      let value = SDAI.BOOLEAN(SDAI.TRUE)
      return SDAI.UNWRAP( value )
    }
...
```
*/
  public final class eCYLINDRICAL_PAIR : SDAI.EntityReference, @unchecked Sendable {
