/* file: curve_with_excessive_segments.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- curve_with_excessive_segments (line:11178 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _curve_with_excessive_segments : SDAI.PartialEntity {
...
```
*/
  public final class eCURVE_WITH_EXCESSIVE_SEGMENTS : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eCURVE_WITH_EXCESSIVE_SEGMENTS`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "CURVE_WITH_EXCESSIVE_SEGMENTS", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eCURVE_WITH_EXCESSIVE_SEGMENTS.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eCURVE_WITH_EXCESSIVE_SEGMENTS.NAME, 
