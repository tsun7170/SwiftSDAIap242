/* file: curve_with_excessive_segments.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eCURVE_WITH_EXCESSIVE_SEGMENTS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eCURVE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eCURVE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eCURVE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eCURVE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = eCURVE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
