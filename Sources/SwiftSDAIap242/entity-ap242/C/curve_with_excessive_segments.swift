/* file: curve_with_excessive_segments.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- curve_with_excessive_segments (line:11185 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	curve_with_excessive_segments
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_WITH_EXCESSIVE_SEGMENTS/PartialEntity``
*/
  public final class eCURVE_WITH_EXCESSIVE_SEGMENTS : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eCURVE_WITH_EXCESSIVE_SEGMENTS>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eCURVE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eCURVE_WITH_EXCESSIVE_SEGMENTS.PartialEntity
    ...
    public var super_eCURVE_WITH_EXCESSIVE_SEGMENTS: eCURVE_WITH_EXCESSIVE_SEGMENTS { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_WITH_EXCESSIVE_SEGMENTS`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eCURVE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eCURVE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eCURVE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eCURVE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eCURVE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = eCURVE_WITH_EXCESSIVE_SEGMENTS.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "CURVE_WITH_EXCESSIVE_SEGMENTS", 
      ...
      entityDef.add(supertype: eCURVE_WITH_EXCESSIVE_SEGMENTS.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eCURVE_WITH_EXCESSIVE_SEGMENTS.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eCURVE_WITH_EXCESSIVE_SEGMENTS.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_WITH_EXCESSIVE_SEGMENTS``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eCURVE_WITH_EXCESSIVE_SEGMENTS.self
      }
      ...
      public static func WHERE_wr1(SELF: eCURVE_WITH_EXCESSIVE_SEGMENTS.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eCURVE_WITH_EXCESSIVE_SEGMENTS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eCURVE_WITH_EXCESSIVE_SEGMENTS.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.COUNT_MEASURE") )
        return _TEMP1
      }
      public static func WHERE_wr3(SELF: eCURVE_WITH_EXCESSIVE_SEGMENTS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr4(SELF: eCURVE_WITH_EXCESSIVE_SEGMENTS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr5(SELF: eCURVE_WITH_EXCESSIVE_SEGMENTS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
