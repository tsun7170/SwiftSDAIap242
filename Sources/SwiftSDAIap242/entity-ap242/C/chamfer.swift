/* file: chamfer.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY chamfer
    ...
    WHERE
      ...
      wr3: ( SIZEOF( QUERY ( fcr <* QUERY ( sar <* USEDIN( SELF, 
               ...
               TYPEOF( fcr.relating_shape_aspect ) ) AND ( fcr.related_shape_aspect.description = 
               'second offset'  ) ) ) ) = 1 );
  END_ENTITY; -- chamfer (line:8989 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _chamfer : SDAI.PartialEntity {
...
```
*/
  public final class eCHAMFER : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "CHAMFER", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "PRODUCT_DEFINITIONAL", keyPath: \eCHAMFER.PRODUCT_DEFINITIONAL, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eCHAMFER.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OF_SHAPE", keyPath: \eCHAMFER.OF_SHAPE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eCHAMFER.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eCHAMFER.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
