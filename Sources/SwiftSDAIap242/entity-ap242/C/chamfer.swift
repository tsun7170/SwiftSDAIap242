/* file: chamfer.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _chamfer : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eCHAMFER?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eCHAMFER?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ FCR in 
          ...
          let _TEMP1 = SDAI.TYPEOF(FCR.RELATED_SHAPE_ASPECT, IS: eCHAMFER_OFFSET.self)
          let _TEMP2 = SDAI.TYPEOF(FCR.RELATING_SHAPE_ASPECT, IS: eCHAMFER.self)
    ...
    public static func WHERE_wr3(SELF: eCHAMFER?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eCHAMFER : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _chamfer.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _chamfer.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _chamfer.WHERE_wr3(SELF: instance)
      return result
    }
