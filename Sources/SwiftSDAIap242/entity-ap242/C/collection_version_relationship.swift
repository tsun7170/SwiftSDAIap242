/* file: collection_version_relationship.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _collection_version_relationship : SDAI.PartialEntity, @unchecked Sendable {
    ...
    /// DERIVE ATTRIBUTE
    internal func _related_version__getter(SELF: eCOLLECTION_VERSION_RELATIONSHIP) -> eCOLLECTION_VERSION?  {
    ...
    /// DERIVE ATTRIBUTE
    internal func _relating_version__getter(SELF: eCOLLECTION_VERSION_RELATIONSHIP) -> eCOLLECTION_VERSION?  {
...
```
*/
  public final class eCOLLECTION_VERSION_RELATIONSHIP : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var RELATING_VERSION: eCOLLECTION_VERSION?  {
      get {
        ...
        let origin = self
        let value = origin.partialEntity._relating_version__getter(SELF: origin)
    ...
    public var RELATED_VERSION: eCOLLECTION_VERSION?  {
      get {
        ...
        let origin = self
        let value = origin.partialEntity._related_version__getter(SELF: origin)
