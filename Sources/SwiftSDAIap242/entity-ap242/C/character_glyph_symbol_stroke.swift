/* file: character_glyph_symbol_stroke.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _strokes: SDAI.SET<eCURVE.PRef>/*[1:?]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(STROKES: SDAI.SET<eCURVE.PRef>/*[1:?]*/ ) {

        self._strokes = 
        SDAI.SET<eCURVE.PRef>(from: STROKES.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
