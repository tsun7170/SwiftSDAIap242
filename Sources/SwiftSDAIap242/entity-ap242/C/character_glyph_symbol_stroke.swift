/* file: character_glyph_symbol_stroke.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- character_glyph_symbol_stroke (line:9200 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCHARACTER_GLYPH_SYMBOL_STROKE/PartialEntity``
*/
  public final class eCHARACTER_GLYPH_SYMBOL_STROKE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eCHARACTER_GLYPH_SYMBOL_STROKE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eCHARACTER_GLYPH_SYMBOL_STROKE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eCHARACTER_GLYPH_SYMBOL_STROKE.PartialEntity
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCHARACTER_GLYPH_SYMBOL_STROKE`` )
    public var STROKES: SDAI.SET<eCURVE.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = self.partialEntity._strokes
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eCHARACTER_GLYPH_SYMBOL_STROKE.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eCHARACTER_GLYPH_SYMBOL_STROKE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eCHARACTER_GLYPH_SYMBOL_STROKE.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CHARACTER_BOX", 
        keyPath: \eCHARACTER_GLYPH_SYMBOL_STROKE.CHARACTER_BOX, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eCHARACTER_GLYPH_SYMBOL_STROKE.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "BASELINE_RATIO", 
        keyPath: \eCHARACTER_GLYPH_SYMBOL_STROKE.BASELINE_RATIO, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "BOX_HEIGHT", 
        keyPath: \eCHARACTER_GLYPH_SYMBOL_STROKE.BOX_HEIGHT, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "STROKES", 
        keyPath: \eCHARACTER_GLYPH_SYMBOL_STROKE.STROKES, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eCHARACTER_GLYPH_SYMBOL_STROKE.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eCHARACTER_GLYPH_SYMBOL_STROKE.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eCHARACTER_GLYPH_SYMBOL_STROKE.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCHARACTER_GLYPH_SYMBOL_STROKE``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _strokes: SDAI.SET<eCURVE.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public static func WHERE_wr1(SELF: eCHARACTER_GLYPH_SYMBOL_STROKE.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP3 /* SDAI.LOGICAL */ = SELF.STROKES <= _TEMP2
        return _TEMP3
      }

      //EXPRESS IMPLICIT PARTIAL ENTITY CONSTRUCTOR
      /// initialize from explicit attribute values
      public init(STROKES: SDAI.SET<eCURVE.PRef>/*[1:(nil as SDAI.INTEGER?)]*/ ) {

        self._strokes = 
        SDAI.SET<eCURVE.PRef>(
          from: STROKES.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( STROKES: original._strokes )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]STROKES for partial entity(\(Self.entityName)) constructor"); return nil }
