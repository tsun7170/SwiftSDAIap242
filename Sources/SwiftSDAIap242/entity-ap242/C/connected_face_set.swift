/* file: connected_face_set.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _cfs_faces: (SDAI.SET<eFACE.PRef>/*[1:nil]*/ )?  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(CFS_FACES: (SDAI.SET<eFACE.PRef>/*[1:nil]*/ )? ) {
...
internal protocol eCONNECTED_FACE_SET__CFS_FACES__provider {
  ...
  func _cfs_faces__getter(complex: SDAI.ComplexEntity) -> SDAI.SET<
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eFACE.PRef>/*[1:nil]*/ 
}
