/* file: curve_with_small_curvature_radius.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _curve_with_small_curvature_radius : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_curve_with_small_curvature_radius``
*/
  public final class eCURVE_WITH_SMALL_CURVATURE_RADIUS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _curve_with_small_curvature_radius.self
    }
    /// partial entity reference
    public let partialEntity: _curve_with_small_curvature_radius
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_curve_with_small_curvature_radius.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _curve_with_small_curvature_radius.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _curve_with_small_curvature_radius.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _curve_with_small_curvature_radius.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _curve_with_small_curvature_radius.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _curve_with_small_curvature_radius.WHERE_wr5(SELF: instance.pRef)
      return result
    }
