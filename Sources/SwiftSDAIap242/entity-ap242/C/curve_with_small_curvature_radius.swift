/* file: curve_with_small_curvature_radius.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eCURVE_WITH_SMALL_CURVATURE_RADIUS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eCURVE_WITH_SMALL_CURVATURE_RADIUS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eCURVE_WITH_SMALL_CURVATURE_RADIUS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eCURVE_WITH_SMALL_CURVATURE_RADIUS.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eCURVE_WITH_SMALL_CURVATURE_RADIUS.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = eCURVE_WITH_SMALL_CURVATURE_RADIUS.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
