/* file: curve_with_small_curvature_radius.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- curve_with_small_curvature_radius (line:11193 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _curve_with_small_curvature_radius : SDAI.PartialEntity {
...
```
*/
  public final class eCURVE_WITH_SMALL_CURVATURE_RADIUS : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eCURVE_WITH_SMALL_CURVATURE_RADIUS`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "CURVE_WITH_SMALL_CURVATURE_RADIUS", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eCURVE_WITH_SMALL_CURVATURE_RADIUS.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eCURVE_WITH_SMALL_CURVATURE_RADIUS.NAME, 
