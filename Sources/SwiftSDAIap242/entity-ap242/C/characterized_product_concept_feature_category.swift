/* file: characterized_product_concept_feature_category.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
/*
  ...
  END_ENTITY; -- characterized_product_concept_feature_category (line:9273 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY/PartialEntity``
*/
  public final class eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY.PartialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "CHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY", 
      ...
      entityDef.addAttribute(name: "ID", 
        keyPath: \eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY.ID, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY``
*/
