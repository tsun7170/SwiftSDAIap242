/* file: counterdrill_hole_occurrence.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- counterdrill_hole_occurrence (line:10781 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _counterdrill_hole_occurrence : SDAI.PartialEntity {
...
```
*/
  public final class eCOUNTERDRILL_HOLE_OCCURRENCE : SDAI.EntityReference {
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUB( ``eCOUNTERDRILL_HOLE_OCCURRENCE_IN_ASSEMBLY`` )
    ...
    /// - origin: SELF( ``eCOUNTERDRILL_HOLE_OCCURRENCE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "COUNTERDRILL_HOLE_OCCURRENCE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "PRODUCT_DEFINITIONAL", keyPath: \eCOUNTERDRILL_HOLE_OCCURRENCE.PRODUCT_DEFINITIONAL, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eCOUNTERDRILL_HOLE_OCCURRENCE.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OF_SHAPE", keyPath: \eCOUNTERDRILL_HOLE_OCCURRENCE.OF_SHAPE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "MODIFIED_COMPONENTS", keyPath: \eCOUNTERDRILL_HOLE_OCCURRENCE.MODIFIED_COMPONENTS, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eCOUNTERDRILL_HOLE_OCCURRENCE.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DEFINITION", keyPath: \eCOUNTERDRILL_HOLE_OCCURRENCE.DEFINITION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eCOUNTERDRILL_HOLE_OCCURRENCE.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
