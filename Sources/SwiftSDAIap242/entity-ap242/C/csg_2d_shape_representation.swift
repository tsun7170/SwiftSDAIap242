/* file: csg_2d_shape_representation.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _csg_2d_shape_representation : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
    ...
    public static func WHERE_wr2(SELF: eCSG_2D_SHAPE_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP2 /* SDAI.SET<sCSG_2D_SHAPE_SELECT>[1:nil] ? */ = _TEMP1?
        .QUERY{ IT in 
          ...
          let _TEMP7 /* SDAI.LOGICAL */ = SDAI.TYPEOF( ((IT.GROUP_REF(eMAPPED_ITEM.self))?.MAPPING_SOURCE)?.MAPPED_REPRESENTATION, 
    ...
    public static func WHERE_wr3(SELF: eCSG_2D_SHAPE_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP2 /* SDAI.SET<sCSG_2D_SHAPE_SELECT>[1:nil] ? */ = _TEMP1?
        .QUERY{ IT in 
          ...
          let _TEMP2 /* SDAI.LOGICAL */ = SDAI.TYPEOF( ((IT.GROUP_REF(eMAPPED_ITEM.self))?.MAPPING_SOURCE)?.MAPPED_REPRESENTATION, 
            IS: eCSG_2D_SHAPE_REPRESENTATION.self )
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_csg_2d_shape_representation``
*/
  public final class eCSG_2D_SHAPE_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _csg_2d_shape_representation.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _csg_2d_shape_representation.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _csg_2d_shape_representation.WHERE_wr3(SELF: instance.pRef)
      return result
    }
