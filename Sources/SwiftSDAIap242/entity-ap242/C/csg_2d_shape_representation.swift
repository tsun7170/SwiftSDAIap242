/* file: csg_2d_shape_representation.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eCSG_2D_SHAPE_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eCSG_2D_SHAPE_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eCSG_2D_SHAPE_REPRESENTATION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eCSG_2D_SHAPE_REPRESENTATION.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      public static func WHERE_wr2(SELF: eCSG_2D_SHAPE_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP1 /* SDAI.SET<sCSG_2D_SHAPE_SELECT>[1:nil] ? */ = SELF.ITEMS
        let _TEMP2 /* SDAI.SET<sCSG_2D_SHAPE_SELECT>[1:nil] ? */ = _TEMP1?
          .QUERY{ IT in 
            // QUERY BODY
