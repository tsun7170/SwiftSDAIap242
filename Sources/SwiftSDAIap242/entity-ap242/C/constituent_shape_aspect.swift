/* file: constituent_shape_aspect.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _constituent_shape_aspect : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /// EXPLICIT ATTRIBUTE 
    public internal(set) var _parent: eSHAPE_ASPECT // PLAIN EXPLICIT ATTRIBUTE
    ...
    internal func _of_shape__getter(SELF: eCONSTITUENT_SHAPE_ASPECT) -> ePRODUCT_DEFINITION_SHAPE {

      let _TEMP1 = GET_ROOT_SHAPE_ASPECT(eSHAPE_ASPECT(/*eCONSTITUENT_SHAPE_ASPECT*/SELF))
      let value = _TEMP1
    ...
    public init(PARENT: eSHAPE_ASPECT) {
      self._parent = PARENT
...
```
*/
  public final class eCONSTITUENT_SHAPE_ASPECT : SDAI.EntityReference, @unchecked Sendable {
