/* file: concat_expression.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _concat_expression : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _operands: SDAI.LIST<eSTRING_EXPRESSION>[2:nil] 	//EXPLICIT REDEFINITION(eMULTIPLE_ARITY_GENERIC_EXPRESSION) */
...
```
*/
  public final class eCONCAT_EXPRESSION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var OPERANDS: SDAI.LIST<eSTRING_EXPRESSION>/*[2:nil]*/  {
      get {
        if let resolved = _multiple_arity_generic_expression._operands__provider(complex: self.complexEntity) {
          let value = SDAI.UNWRAP( SDAI.LIST<eSTRING_EXPRESSION>(resolved._operands__getter(
            complex: self.complexEntity)) )
          return value
        }
        else {
          return SDAI.UNWRAP( SDAI.LIST<eSTRING_EXPRESSION>(super_eMULTIPLE_ARITY_GENERIC_EXPRESSION
