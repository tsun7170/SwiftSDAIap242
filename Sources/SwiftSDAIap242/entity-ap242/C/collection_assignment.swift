/* file: collection_assignment.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- collection_assignment (line:9655 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _collection_assignment : SDAI.PartialEntity {
...
```
*/
  public final class eCOLLECTION_ASSIGNMENT : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "COLLECTION_ASSIGNMENT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ROLE", keyPath: \eCOLLECTION_ASSIGNMENT.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eCOLLECTION_ASSIGNMENT.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_GROUP", keyPath: \eCOLLECTION_ASSIGNMENT.ASSIGNED_GROUP, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
