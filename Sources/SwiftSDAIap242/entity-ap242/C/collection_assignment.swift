/* file: collection_assignment.swift 	 generated: Mon Dec 15 17:41:04 2025 */
...
*/
  ...
  public final class _collection_assignment : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_collection_assignment``
*/
  public final class eCOLLECTION_ASSIGNMENT : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _collection_assignment.self
    }
    /// partial entity reference
    public let partialEntity: _collection_assignment
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_collection_assignment.self) else { return nil }
