/* file: connected_edge_with_length_set_representation.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- connected_edge_with_length_set_representation (line:10381 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	connected_edge_with_length_set_representation
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION/PartialEntity``
*/
  public final class eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION.PartialEntity

    //MARK: SUPERTYPES
    public let super_eREPRESENTATION: eREPRESENTATION 	// [1]
    public var super_eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION: eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION { return self } 	// [2]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION`` )
    public var ITEMS: SDAI.SET<sCONNECTED_EDGE_WITH_LENGTH_SET_ITEMS>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = super_eREPRESENTATION.partialEntity._items
        let SELF = super_eREPRESENTATION; SDAI.TOUCH(let:SELF)
        let value =         SDAI.SET<sCONNECTED_EDGE_WITH_LENGTH_SET_ITEMS>(
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "CONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION", 
        type: self, explicitAttributeCount: 0)

      //MARK: SUPERTYPE REGISTRATIONS
      entityDef.add(supertype: eREPRESENTATION.self)
      entityDef.add(supertype: eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION.self
      }

      //ATTRIBUTES
      /* override var _items: SDAI.SET<sCONNECTED_EDGE_WITH_LENGTH_SET_ITEMS>[1:(nil as SDAI.INTEGER?)] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
      ...
      public static func WHERE_wr1(SELF: eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.SET<sCONNECTED_EDGE_WITH_LENGTH_SET_ITEMS>[1:(nil as SDAI.INTEGER?)] ? */ = SELF.ITEMS
        let _TEMP2 /* SDAI.SET<sCONNECTED_EDGE_WITH_LENGTH_SET_ITEMS>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP1?
          .QUERY{ IT in 
            // QUERY BODY
