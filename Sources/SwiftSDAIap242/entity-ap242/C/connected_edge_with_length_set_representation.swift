/* file: connected_edge_with_length_set_representation.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _connected_edge_with_length_set_representation : SDAI.PartialEntity
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_connected_edge_with_length_set_representation``
*/
  public final class eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _connected_edge_with_length_set_representation.self
    }
    /// partial entity reference
    public let partialEntity: _connected_edge_with_length_set_representation
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_connected_edge_with_length_set_representation.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _connected_edge_with_length_set_representation.WHERE_wr1(SELF: instance.pRef)
      return result
    }
