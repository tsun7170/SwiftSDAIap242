/* file: connected_edge_with_length_set_representation.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- connected_edge_with_length_set_representation (line:10374 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "CONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION.NAME, 
