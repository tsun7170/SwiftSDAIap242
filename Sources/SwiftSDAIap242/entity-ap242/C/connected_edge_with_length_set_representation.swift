/* file: connected_edge_with_length_set_representation.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
  public final class eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var ITEMS: SDAI.SET<sCONNECTED_EDGE_WITH_LENGTH_SET_ITEMS>/*[1:?]*/  {
      get {
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _items: SDAI.SET<sCONNECTED_EDGE_WITH_LENGTH_SET_ITEMS>[1:?] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
      ...
      public static func WHERE_wr1(SELF: eCONNECTED_EDGE_WITH_LENGTH_SET_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        ...
        //
        let _TEMP1 /* SDAI.SET<sCONNECTED_EDGE_WITH_LENGTH_SET_ITEMS>[1:?] ? */ = SELF.ITEMS
        let _TEMP2 /* SDAI.SET<sCONNECTED_EDGE_WITH_LENGTH_SET_ITEMS>[1:?] ? */ = _TEMP1?
          .QUERY{ IT in 
            // QUERY BODY
            //
