/* file: clgc_with_dimension.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
```
*/
  public final class eCLGC_WITH_DIMENSION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var CONSTRAINED_ELEMENTS: SDAI.SET<eBOUNDED_CURVE>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eBOUNDED_CURVE>( super_eEXPLICIT_CONSTRAINT.partialEntity
