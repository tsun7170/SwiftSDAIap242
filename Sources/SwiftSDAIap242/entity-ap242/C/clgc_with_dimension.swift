/* file: clgc_with_dimension.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public final class eCLGC_WITH_DIMENSION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var CONSTRAINED_ELEMENTS: SDAI.SET<eBOUNDED_CURVE.PRef>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eBOUNDED_CURVE.PRef>( super_eEXPLICIT_CONSTRAINT.partialEntity
    ...
    public var LENGTH_VALUE: tPOSITIVE_LENGTH_MEASURE {
      get {
        return SDAI.UNWRAP( self.partialEntity._length_value )
      }
      set(newValue) {
