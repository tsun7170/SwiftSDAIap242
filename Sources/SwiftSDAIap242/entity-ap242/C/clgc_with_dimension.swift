/* file: clgc_with_dimension.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- clgc_with_dimension (line:9563 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(7)	curve_length_geometric_constraint
    REDCR: constrained_elements,	TYPE: SET [1 : ?] OF bounded_curve -- EXPLICIT
      -- OVERRIDING ENTITY: explicit_constraint


  ENTITY(SELF)	clgc_with_dimension
...
- SUPERTYPES:
	...
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_LENGTH_GEOMETRIC_CONSTRAINT``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCLGC_WITH_DIMENSION/PartialEntity``
*/
  public final class eCLGC_WITH_DIMENSION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eCLGC_WITH_DIMENSION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eCLGC_WITH_DIMENSION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eCLGC_WITH_DIMENSION.PartialEntity
    ...
    public let super_eCURVE_LENGTH_GEOMETRIC_CONSTRAINT: eCURVE_LENGTH_GEOMETRIC_CONSTRAINT 	// [7]
    public var super_eCLGC_WITH_DIMENSION: eCLGC_WITH_DIMENSION { return self } 	// [8]
    ...
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_LENGTH_GEOMETRIC_CONSTRAINT`` )
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCLGC_WITH_DIMENSION`` )
    public var LENGTH_VALUE: tPOSITIVE_LENGTH_MEASURE {
      get {
        let originalValue = self.partialEntity._length_value
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eCLGC_WITH_DIMENSION.PartialEntity.self) else { return nil }
      ...
      guard let super7 = complexEntity?.entityReference(eCURVE_LENGTH_GEOMETRIC_CONSTRAINT.self) else { return nil }
      self.super_eCURVE_LENGTH_GEOMETRIC_CONSTRAINT = super7
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCLGC_WITH_DIMENSION``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eCLGC_WITH_DIMENSION.self
      }

      //ATTRIBUTES
      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _length_value: tPOSITIVE_LENGTH_MEASURE // PLAIN EXPLICIT ATTRIBUTE
      ...
      public override func hashAsValue(into hasher: inout Hasher, visited complexEntities: inout Set<SDAI.ComplexEntity>) {
        ...
        self._length_value.value.hashAsValue(into: &hasher, visited: &complexEntities)
      }

      public override func isValueEqual(to rhs: SDAI.PartialEntity, visited comppairs: inout Set<SDAI.ComplexPair>) -> Bool {
        guard let rhs = rhs as? Self else { return false }
        if !super.isValueEqual(to: rhs, visited: &comppairs) { return false }
        if let comp = self._length_value.value.isValueEqualOptionally(to: rhs._length_value.value, visited: &comppairs)	{
      ...
      public init(LENGTH_VALUE: tPOSITIVE_LENGTH_MEASURE) {
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( LENGTH_VALUE: original._length_value )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]LENGTH_VALUE for partial entity(\(Self.entityName)) constructor"); return nil }

        self.init( LENGTH_VALUE: p0 )
      }
    }
  }
}
