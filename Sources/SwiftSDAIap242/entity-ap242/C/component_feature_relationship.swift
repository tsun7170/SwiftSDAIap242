/* file: component_feature_relationship.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- component_feature_relationship (line:9869 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _component_feature_relationship : SDAI.PartialEntity {
...
```
*/
  public final class eCOMPONENT_FEATURE_RELATIONSHIP : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eCOMPONENT_FEATURE_RELATIONSHIP`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "COMPONENT_FEATURE_RELATIONSHIP", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eCOMPONENT_FEATURE_RELATIONSHIP.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ID", keyPath: \eCOMPONENT_FEATURE_RELATIONSHIP.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATED_SHAPE_ASPECT", keyPath: \eCOMPONENT_FEATURE_RELATIONSHIP.RELATED_SHAPE_ASPECT, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eCOMPONENT_FEATURE_RELATIONSHIP.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATING_SHAPE_ASPECT", keyPath: \eCOMPONENT_FEATURE_RELATIONSHIP.RELATING_SHAPE_ASPECT, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
