/* file: compound_shape_representation.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _compound_shape_representation : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
    ...
    public static func WHERE_wr4(SELF: eCOMPOUND_SHAPE_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP2 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:nil] ? */ = _TEMP1?
        .QUERY{ CBSR_I in 
          ...
          let _TEMP6 /* SDAI.SET<SDAI.STRING>? */ = SDAI.FORCE_OPTIONAL(_TEMP2) * SDAI.FORCE_OPTIONAL(_TEMP5)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_compound_shape_representation``
*/
  public final class eCOMPOUND_SHAPE_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _compound_shape_representation.self
    }
    /// partial entity reference
    public let partialEntity: _compound_shape_representation
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_compound_shape_representation.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _compound_shape_representation.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _compound_shape_representation.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _compound_shape_representation.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _compound_shape_representation.WHERE_wr4(SELF: instance.pRef)
      return result
    }
