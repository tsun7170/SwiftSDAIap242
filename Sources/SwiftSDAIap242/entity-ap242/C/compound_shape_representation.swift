/* file: compound_shape_representation.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eCOMPOUND_SHAPE_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eCOMPOUND_SHAPE_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eCOMPOUND_SHAPE_REPRESENTATION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eCOMPOUND_SHAPE_REPRESENTATION.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eCOMPOUND_SHAPE_REPRESENTATION.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
