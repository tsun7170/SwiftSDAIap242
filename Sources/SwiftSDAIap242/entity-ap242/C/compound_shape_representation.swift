/* file: compound_shape_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _compound_shape_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eCOMPOUND_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.TYPEOF(SELF.CONTEXT_OF_ITEMS, IS: eGEOMETRIC_REPRESENTATION_CONTEXT.self)
      let _TEMP2 = SELF.CONTEXT_OF_ITEMS
    ...
    public static func WHERE_wr2(SELF: eCOMPOUND_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.ITEMS
      let _TEMP2 = _TEMP1.QUERY{ CBSR_I in 
    ...
    public static func WHERE_wr3(SELF: eCOMPOUND_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eCOMPOUND_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.ITEMS
      let _TEMP2 = _TEMP1.QUERY{ CBSR_I in 

          let _TEMP1 = SDAI.TYPEOF(CBSR_I, IS: eMAPPED_ITEM.self)
          let _TEMP2 = ([SDAI.AIE(SDAI.STRING(
            ...
            "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.NON_MANIFOLD_SURFACE_SHAPE_REPRESENTATION"))] 
            as [SDAI.AggregationInitializerElement<SDAI.STRING>])
          let _TEMP3 = CBSR_I.GROUP_REF(eMAPPED_ITEM.self)
...
```
*/
  public final class eCOMPOUND_SHAPE_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _compound_shape_representation.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _compound_shape_representation.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _compound_shape_representation.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _compound_shape_representation.WHERE_wr4(SELF: instance)
      return result
    }
