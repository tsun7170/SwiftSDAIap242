/* file: countersink_hole_occurrence_in_assembly.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- countersink_hole_occurrence_in_assembly (line:10829 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _countersink_hole_occurrence_in_assembly : SDAI.PartialEntity {
...
```
*/
  public final class eCOUNTERSINK_HOLE_OCCURRENCE_IN_ASSEMBLY : SDAI.EntityReference {
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``eCOUNTERSINK_HOLE_OCCURRENCE_IN_ASSEMBLY`` )
    ...
    /// - origin: SUPER( ``eCOUNTERSINK_HOLE_OCCURRENCE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "COUNTERSINK_HOLE_OCCURRENCE_IN_ASSEMBLY", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "PRODUCT_DEFINITIONAL", keyPath: \eCOUNTERSINK_HOLE_OCCURRENCE_IN_ASSEMBLY.PRODUCT_DEFINITIONAL, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eCOUNTERSINK_HOLE_OCCURRENCE_IN_ASSEMBLY.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OF_SHAPE", keyPath: \eCOUNTERSINK_HOLE_OCCURRENCE_IN_ASSEMBLY.OF_SHAPE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "MODIFIED_COMPONENTS", keyPath: \eCOUNTERSINK_HOLE_OCCURRENCE_IN_ASSEMBLY.MODIFIED_COMPONENTS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eCOUNTERSINK_HOLE_OCCURRENCE_IN_ASSEMBLY.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DEFINITION", keyPath: \eCOUNTERSINK_HOLE_OCCURRENCE_IN_ASSEMBLY.DEFINITION, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eCOUNTERSINK_HOLE_OCCURRENCE_IN_ASSEMBLY.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
