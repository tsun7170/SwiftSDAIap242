/* file: cdgc_with_dimension.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- cdgc_with_dimension (line:8931 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUPERTYPES:
	...
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_DISTANCE_GEOMETRIC_CONSTRAINT``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCDGC_WITH_DIMENSION/PartialEntity``
*/
  public final class eCDGC_WITH_DIMENSION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eCDGC_WITH_DIMENSION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eCDGC_WITH_DIMENSION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eCDGC_WITH_DIMENSION.PartialEntity
    ...
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_DISTANCE_GEOMETRIC_CONSTRAINT`` )
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCDGC_WITH_DIMENSION`` )
    ...
    public var NEAR_POINTS: SDAI.SET<eNEAR_POINT_RELATIONSHIP.PRef>/*[0:4]*/  {
      get {
        let originalValue = super_eCURVE_DISTANCE_GEOMETRIC_CONSTRAINT.partialEntity._near_points
      ...
      set(newValue) {
        ...
        let SELF = super_eCURVE_DISTANCE_GEOMETRIC_CONSTRAINT; SDAI.TOUCH(let:SELF)
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eCDGC_WITH_DIMENSION.PartialEntity.self) else { return nil }
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCDGC_WITH_DIMENSION``
*/
