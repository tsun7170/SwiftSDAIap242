/* file: cross_sectional_group_shape_element_with_tubular_cover.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- cross_sectional_group_shape_element_with_tubular_cover (line:10868 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eCROSS_SECTIONAL_GROUP_SHAPE_ELEMENT_WITH_TUBULAR_COVER : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "CROSS_SECTIONAL_GROUP_SHAPE_ELEMENT_WITH_TUBULAR_COVER", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "PRODUCT_DEFINITIONAL", keyPath: \eCROSS_SECTIONAL_GROUP_SHAPE_ELEMENT_WITH_TUBULAR_COVER.PRODUCT_DEFINITIONAL, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eCROSS_SECTIONAL_GROUP_SHAPE_ELEMENT_WITH_TUBULAR_COVER.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eCROSS_SECTIONAL_GROUP_SHAPE_ELEMENT_WITH_TUBULAR_COVER.ITEMS, 
        kind: .inverse, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "OF_SHAPE", keyPath: \eCROSS_SECTIONAL_GROUP_SHAPE_ELEMENT_WITH_TUBULAR_COVER.OF_SHAPE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eCROSS_SECTIONAL_GROUP_SHAPE_ELEMENT_WITH_TUBULAR_COVER.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eCROSS_SECTIONAL_GROUP_SHAPE_ELEMENT_WITH_TUBULAR_COVER.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
