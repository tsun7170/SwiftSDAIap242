/* file: component_definition.swift 	 generated: Mon Dec 15 17:41:04 2025 */
...
*/
  ...
  public final class _component_definition : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_component_definition``
*/
  public final class eCOMPONENT_DEFINITION : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _component_definition.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _component_definition.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _component_definition.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _component_definition.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _component_definition.WHERE_wr5(SELF: instance.pRef)
      return result
    }
