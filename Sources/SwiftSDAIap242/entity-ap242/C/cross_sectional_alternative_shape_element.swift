/* file: cross_sectional_alternative_shape_element.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- cross_sectional_alternative_shape_element (line:10850 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _cross_sectional_alternative_shape_element : SDAI.PartialEntity {
    ...
    internal var _items: SDAI.SET<eSHAPE_ASPECT_RELATIONSHIP> {
      return __items.map{ $0.reference }
    }
    private var __items = SDAI.SET<SDAI.UnownedWrap<eSHAPE_ASPECT_RELATIONSHIP>>(
    ...
    internal func _items__observeAddedReference(in complex: SDAI.ComplexEntity) {
      guard let newSource = complex.entityReference(eSHAPE_ASPECT_RELATIONSHIP.self) else { return }
      self.__items.add(member: SDAI.UnownedWrap(newSource) )
    }
    /// INVERSE AGGREGATE ATTR SUPPORT(REMOVER)
    internal func _items__observeRemovedReference(in complex: SDAI.ComplexEntity) {
      guard let oldSource = complex.entityReference(eSHAPE_ASPECT_RELATIONSHIP.self) else { return }
      let success = self.__items.remove(member: SDAI.UnownedWrap(oldSource) )
      assert(success, "failed to remove inverse attribute element")
    }
    /// INVERSE AGGREGATE ATTR SUPPORT(LEAVING REFERENCE OWNER)
    internal func _items__observe(leavingReferencerOwner complex: SDAI.ComplexEntity) {
      guard let oldSource = complex.entityReference(eSHAPE_ASPECT_RELATIONSHIP.self) else { return }
      let success = self.__items.removeAll(member: SDAI.UnownedWrap(oldSource) )
...
```
*/
  public final class eCROSS_SECTIONAL_ALTERNATIVE_SHAPE_ELEMENT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eCROSS_SECTIONAL_ALTERNATIVE_SHAPE_ELEMENT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "CROSS_SECTIONAL_ALTERNATIVE_SHAPE_ELEMENT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "PRODUCT_DEFINITIONAL", keyPath: \eCROSS_SECTIONAL_ALTERNATIVE_SHAPE_ELEMENT.PRODUCT_DEFINITIONAL, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eCROSS_SECTIONAL_ALTERNATIVE_SHAPE_ELEMENT.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eCROSS_SECTIONAL_ALTERNATIVE_SHAPE_ELEMENT.ITEMS, 
        kind: .inverse, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "OF_SHAPE", keyPath: \eCROSS_SECTIONAL_ALTERNATIVE_SHAPE_ELEMENT.OF_SHAPE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eCROSS_SECTIONAL_ALTERNATIVE_SHAPE_ELEMENT.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eCROSS_SECTIONAL_ALTERNATIVE_SHAPE_ELEMENT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
