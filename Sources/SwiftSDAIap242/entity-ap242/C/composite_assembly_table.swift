/* file: composite_assembly_table.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- composite_assembly_table (line:9900 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _composite_assembly_table : SDAI.PartialEntity {
...
```
*/
  public final class eCOMPOSITE_ASSEMBLY_TABLE : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "COMPOSITE_ASSEMBLY_TABLE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eCOMPOSITE_ASSEMBLY_TABLE.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ID", keyPath: \eCOMPOSITE_ASSEMBLY_TABLE.ID, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "FRAME_OF_REFERENCE", keyPath: \eCOMPOSITE_ASSEMBLY_TABLE.FRAME_OF_REFERENCE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eCOMPOSITE_ASSEMBLY_TABLE.NAME, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "FORMATION", keyPath: \eCOMPOSITE_ASSEMBLY_TABLE.FORMATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
