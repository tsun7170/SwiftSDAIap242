/* file: counterbore_hole_occurrence.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- counterbore_hole_occurrence (line:10723 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _counterbore_hole_occurrence : SDAI.PartialEntity {
...
```
*/
  public final class eCOUNTERBORE_HOLE_OCCURRENCE : SDAI.EntityReference {
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUB( ``eCOUNTERBORE_HOLE_OCCURRENCE_IN_ASSEMBLY`` )
    ...
    /// - origin: SELF( ``eCOUNTERBORE_HOLE_OCCURRENCE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "COUNTERBORE_HOLE_OCCURRENCE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "PRODUCT_DEFINITIONAL", keyPath: \eCOUNTERBORE_HOLE_OCCURRENCE.PRODUCT_DEFINITIONAL, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eCOUNTERBORE_HOLE_OCCURRENCE.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OF_SHAPE", keyPath: \eCOUNTERBORE_HOLE_OCCURRENCE.OF_SHAPE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "MODIFIED_COMPONENTS", keyPath: \eCOUNTERBORE_HOLE_OCCURRENCE.MODIFIED_COMPONENTS, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eCOUNTERBORE_HOLE_OCCURRENCE.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DEFINITION", keyPath: \eCOUNTERBORE_HOLE_OCCURRENCE.DEFINITION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eCOUNTERBORE_HOLE_OCCURRENCE.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
