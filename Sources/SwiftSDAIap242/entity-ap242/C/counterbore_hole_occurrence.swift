/* file: counterbore_hole_occurrence.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _counterbore_hole_occurrence : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _definition: eCOUNTERBORE_HOLE_DEFINITION	//EXPLICIT REDEFINITION(eSHAPE_ASPECT_OCCURRENCE) */
    ...
    public static func WHERE_wr1(SELF: eCOUNTERBORE_HOLE_OCCURRENCE?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eCOUNTERBORE_HOLE_OCCURRENCE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eCOUNTERBORE_HOLE_OCCURRENCE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _counterbore_hole_occurrence.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _counterbore_hole_occurrence.WHERE_wr2(SELF: instance)
      return result
    }
