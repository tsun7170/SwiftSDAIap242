/* file: complex_clause.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- complex_clause (line:9785 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _complex_clause : SDAI.PartialEntity {
...
```
*/
  public final class eCOMPLEX_CLAUSE : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "COMPLEX_CLAUSE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ITEM_ELEMENT", keyPath: \eCOMPLEX_CLAUSE.ITEM_ELEMENT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eCOMPLEX_CLAUSE.NAME, 
