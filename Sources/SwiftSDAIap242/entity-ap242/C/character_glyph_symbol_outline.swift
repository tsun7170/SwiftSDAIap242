/* file: character_glyph_symbol_outline.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _character_glyph_symbol_outline : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_character_glyph_symbol_outline``
*/
  public final class eCHARACTER_GLYPH_SYMBOL_OUTLINE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _character_glyph_symbol_outline.self
    }
    /// partial entity reference
    public let partialEntity: _character_glyph_symbol_outline
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_character_glyph_symbol_outline.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _character_glyph_symbol_outline.WHERE_wr1(SELF: instance.pRef)
      return result
    }
