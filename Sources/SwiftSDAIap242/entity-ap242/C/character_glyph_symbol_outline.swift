/* file: character_glyph_symbol_outline.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- character_glyph_symbol_outline (line:9193 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	character_glyph_symbol_outline
...
- SUPERTYPES:
	...
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCHARACTER_GLYPH_SYMBOL``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCHARACTER_GLYPH_SYMBOL_OUTLINE/PartialEntity``
*/
  public final class eCHARACTER_GLYPH_SYMBOL_OUTLINE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eCHARACTER_GLYPH_SYMBOL_OUTLINE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eCHARACTER_GLYPH_SYMBOL_OUTLINE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eCHARACTER_GLYPH_SYMBOL_OUTLINE.PartialEntity
    ...
    public var super_eCHARACTER_GLYPH_SYMBOL_OUTLINE: eCHARACTER_GLYPH_SYMBOL_OUTLINE { return self } 	// [5]
    ...
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCHARACTER_GLYPH_SYMBOL`` )
    public var CHARACTER_BOX: ePLANAR_EXTENT.PRef {
      get {
        let originalValue = super_eCHARACTER_GLYPH_SYMBOL.partialEntity._character_box
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCHARACTER_GLYPH_SYMBOL_OUTLINE`` )
    public var OUTLINES: SDAI.SET<eANNOTATION_FILL_AREA.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = self.partialEntity._outlines
        let value = SDAI.UNWRAP( SDAI.SET<eANNOTATION_FILL_AREA.PRef>( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public var BASELINE_RATIO: tRATIO_MEASURE {
      get {
        let originalValue = super_eCHARACTER_GLYPH_SYMBOL.partialEntity._baseline_ratio
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eCHARACTER_GLYPH_SYMBOL_OUTLINE.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eCHARACTER_GLYPH_SYMBOL_OUTLINE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eCHARACTER_GLYPH_SYMBOL_OUTLINE.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eCHARACTER_GLYPH_SYMBOL_OUTLINE.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CHARACTER_BOX", 
        keyPath: \eCHARACTER_GLYPH_SYMBOL_OUTLINE.CHARACTER_BOX, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eCHARACTER_GLYPH_SYMBOL_OUTLINE.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "OUTLINES", 
        keyPath: \eCHARACTER_GLYPH_SYMBOL_OUTLINE.OUTLINES, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "BASELINE_RATIO", 
        keyPath: \eCHARACTER_GLYPH_SYMBOL_OUTLINE.BASELINE_RATIO, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "BOX_HEIGHT", 
        keyPath: \eCHARACTER_GLYPH_SYMBOL_OUTLINE.BOX_HEIGHT, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eCHARACTER_GLYPH_SYMBOL_OUTLINE.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eCHARACTER_GLYPH_SYMBOL_OUTLINE.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eCHARACTER_GLYPH_SYMBOL_OUTLINE.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCHARACTER_GLYPH_SYMBOL_OUTLINE``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eCHARACTER_GLYPH_SYMBOL_OUTLINE.self
      }

      //ATTRIBUTES
      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _outlines: SDAI.SET<eANNOTATION_FILL_AREA.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public override func hashAsValue(into hasher: inout Hasher, visited complexEntities: inout Set<SDAI.ComplexEntity>) {
        ...
        self._outlines.value.hashAsValue(into: &hasher, visited: &complexEntities)
      }

      public override func isValueEqual(to rhs: SDAI.PartialEntity, visited comppairs: inout Set<SDAI.ComplexPair>) -> Bool {
        guard let rhs = rhs as? Self else { return false }
        if !super.isValueEqual(to: rhs, visited: &comppairs) { return false }
        if let comp = self._outlines.value.isValueEqualOptionally(to: rhs._outlines.value, visited: &comppairs)	{
      ...
      public static func WHERE_wr1(SELF: eCHARACTER_GLYPH_SYMBOL_OUTLINE.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP3 /* SDAI.LOGICAL */ = SELF.OUTLINES <= _TEMP2
        return _TEMP3
      }

      //EXPRESS IMPLICIT PARTIAL ENTITY CONSTRUCTOR
      /// initialize from explicit attribute values
      public init(OUTLINES: SDAI.SET<eANNOTATION_FILL_AREA.PRef>/*[1:(nil as SDAI.INTEGER?)]*/ ) {

        self._outlines = 
        SDAI.SET<eANNOTATION_FILL_AREA.PRef>(
          from: OUTLINES.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( OUTLINES: original._outlines )
      }
      ...
      public required convenience init?(
        ...
        guard case .success(let p0) = exchangeStructure.recoverRequiredParameter(as: SDAI.SET<
          eANNOTATION_FILL_AREA.PRef>.self, from: parameters[0])
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]OUTLINES for partial entity(\(Self.entityName)) constructor"); return nil }

        self.init( OUTLINES: p0 )
      }
    }
  }
}
