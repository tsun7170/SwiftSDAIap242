/* file: character_glyph_symbol_outline.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- character_glyph_symbol_outline (line:9200 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _character_glyph_symbol_outline : SDAI.PartialEntity {
...
```
*/
  public final class eCHARACTER_GLYPH_SYMBOL_OUTLINE : SDAI.EntityReference {
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``eCHARACTER_GLYPH_SYMBOL_OUTLINE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "CHARACTER_GLYPH_SYMBOL_OUTLINE", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eCHARACTER_GLYPH_SYMBOL_OUTLINE.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CHARACTER_BOX", keyPath: \eCHARACTER_GLYPH_SYMBOL_OUTLINE.CHARACTER_BOX, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eCHARACTER_GLYPH_SYMBOL_OUTLINE.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "OUTLINES", keyPath: \eCHARACTER_GLYPH_SYMBOL_OUTLINE.OUTLINES, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "BASELINE_RATIO", keyPath: \eCHARACTER_GLYPH_SYMBOL_OUTLINE.BASELINE_RATIO, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "BOX_HEIGHT", keyPath: \eCHARACTER_GLYPH_SYMBOL_OUTLINE.BOX_HEIGHT, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ID", keyPath: \eCHARACTER_GLYPH_SYMBOL_OUTLINE.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eCHARACTER_GLYPH_SYMBOL_OUTLINE.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eCHARACTER_GLYPH_SYMBOL_OUTLINE.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
