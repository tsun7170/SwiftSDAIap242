/* file: character_glyph_symbol_outline.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _character_glyph_symbol_outline : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /// EXPLICIT ATTRIBUTE 
    public internal(set) var _outlines: SDAI.SET<eANNOTATION_FILL_AREA>/*[1:nil]*/  // PLAIN EXPLICIT ATTRIBUTE
    ...
    public static func WHERE_wr1(SELF: eCHARACTER_GLYPH_SYMBOL_OUTLINE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.GROUP_REF(eREPRESENTATION.self)
      let _TEMP2 = _TEMP1?.ITEMS
      let _TEMP3 = SDAI.FORCE_OPTIONAL(SELF.OUTLINES) <= _TEMP2
      return _TEMP3
    }

    //EXPRESS IMPLICIT PARTIAL ENTITY CONSTRUCTOR
    public init(OUTLINES: SDAI.SET<eANNOTATION_FILL_AREA>/*[1:nil]*/ ) {
    ...
    public required convenience init?(parameters: [P21Decode.ExchangeStructure.Parameter], exchangeStructure: P21Decode.ExchangeStructure) {
      ...
      guard case .success(let p0) = exchangeStructure.recoverRequiredParameter(as: SDAI.SET<
        eANNOTATION_FILL_AREA>.self, from: parameters[0])
...
```
*/
  public final class eCHARACTER_GLYPH_SYMBOL_OUTLINE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _character_glyph_symbol_outline.WHERE_wr1(SELF: instance)
      return result
    }
