/* file: character_glyph_symbol_outline.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _outlines: SDAI.SET<eANNOTATION_FILL_AREA.PRef>/*[1:?]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(OUTLINES: SDAI.SET<eANNOTATION_FILL_AREA.PRef>/*[1:?]*/ ) {

        self._outlines = 
        SDAI.SET<eANNOTATION_FILL_AREA.PRef>(from: OUTLINES.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
