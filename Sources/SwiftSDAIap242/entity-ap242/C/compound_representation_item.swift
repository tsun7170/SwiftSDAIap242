/* file: compound_representation_item.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- compound_representation_item (line:10163 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRIMITIVE_2D_WITH_INNER_BOUNDARY``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eROW_VALUE``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eROW_REPRESENTATION_ITEM``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eVALUE_RANGE``
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTABLE_REPRESENTATION_ITEM``
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTRUCTURED_TEXT_COMPOSITION``
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFUNC``
	8.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT_AND_VECTOR``
	9.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT_PATH``
	10.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3MA_LENGTH_MEASURE_AND_CONTEXT_DEPENDENT_MEASURE_PAIR``
	11.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGROUND_FACT``
	12.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRULE_CONDITION``
	13.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eATOMIC_FORMULA``
	14.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLITERAL_DISJUNCTION``
	15.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLITERAL_CONJUNCTION``
	16.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSIMPLE_CLAUSE``
	17.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPLEX_CONJUNCTIVE_CLAUSE``
	18.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPLEX_DISJUNCTIVE_CLAUSE``
	19.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPLEX_CLAUSE``
	20.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDEFAULT_TOLERANCE_TABLE_CELL``
	21.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT_ARRAY``
	22.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLOCATION_IN_AGGREGATE_REPRESENTATION_ITEM``
	23.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_DATA_QUALITY_VALUE_RANGE``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPOUND_REPRESENTATION_ITEM/PartialEntity``
*/
  public final class eCOMPOUND_REPRESENTATION_ITEM : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eCOMPOUND_REPRESENTATION_ITEM>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eCOMPOUND_REPRESENTATION_ITEM.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eCOMPOUND_REPRESENTATION_ITEM.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPOUND_REPRESENTATION_ITEM`` )
    public var ITEM_ELEMENT: sCOMPOUND_ITEM_DEFINITION {
      get {
        let originalValue = self.partialEntity._item_element
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eCOMPOUND_REPRESENTATION_ITEM.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "INNER_BOUNDARY", 
        keyPath: \eCOMPOUND_REPRESENTATION_ITEM.INNER_BOUNDARY, 
        kind: .derived, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEM_ELEMENT", 
        keyPath: \eCOMPOUND_REPRESENTATION_ITEM.ITEM_ELEMENT, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eCOMPOUND_REPRESENTATION_ITEM.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPOUND_REPRESENTATION_ITEM``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( ITEM_ELEMENT: original._item_element )
      }
      ...
      public required convenience init?(
        ...
        guard case .success(let p0) = exchangeStructure.recoverRequiredParameter(as: 
          sCOMPOUND_ITEM_DEFINITION.self, from: parameters[0])
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]ITEM_ELEMENT for partial entity(\(Self.entityName)) constructor"); return nil }
