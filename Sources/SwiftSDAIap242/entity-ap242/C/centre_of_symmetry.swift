/* file: centre_of_symmetry.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- centre_of_symmetry (line:8936 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _centre_of_symmetry : SDAI.PartialEntity {
...
```
*/
  public final class eCENTRE_OF_SYMMETRY : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "CENTRE_OF_SYMMETRY", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DERIVING_RELATIONSHIPS", keyPath: \eCENTRE_OF_SYMMETRY.DERIVING_RELATIONSHIPS, 
        kind: .inverse, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "PRODUCT_DEFINITIONAL", keyPath: \eCENTRE_OF_SYMMETRY.PRODUCT_DEFINITIONAL, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eCENTRE_OF_SYMMETRY.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OF_SHAPE", keyPath: \eCENTRE_OF_SYMMETRY.OF_SHAPE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eCENTRE_OF_SYMMETRY.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eCENTRE_OF_SYMMETRY.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
