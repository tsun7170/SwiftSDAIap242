/* file: containing_message.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- containing_message (line:10561 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _containing_message : SDAI.PartialEntity {
...
```
*/
  public final class eCONTAINING_MESSAGE : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eCONTAINING_MESSAGE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "CONTAINING_MESSAGE", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "ROLE", keyPath: \eCONTAINING_MESSAGE.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eCONTAINING_MESSAGE.ITEMS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_GROUP", keyPath: \eCONTAINING_MESSAGE.ASSIGNED_GROUP, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "MESSAGE_CONTENTS_GROUP", keyPath: \eCONTAINING_MESSAGE.MESSAGE_CONTENTS_GROUP, 
