/* file: containing_message.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _containing_message : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /// EXPLICIT ATTRIBUTE 
    public internal(set) var _items: SDAI.SET<eSTRUCTURED_MESSAGE>/*[1:1]*/  // PLAIN EXPLICIT ATTRIBUTE

    /* override var _assigned_group: eMESSAGE_CONTENTS_GROUP	//EXPLICIT REDEFINITION(eGROUP_ASSIGNMENT) */

    /// DERIVE ATTRIBUTE
    internal func _message_contents_group__getter(SELF: eCONTAINING_MESSAGE) -> eMESSAGE_CONTENTS_GROUP?  {
    ...
    public init(ITEMS: SDAI.SET<eSTRUCTURED_MESSAGE>/*[1:1]*/ ) {
      self._items = ITEMS
    ...
    public required convenience init?(parameters: [P21Decode.ExchangeStructure.Parameter], exchangeStructure: P21Decode.ExchangeStructure) {
      ...
      guard case .success(let p0) = exchangeStructure.recoverRequiredParameter(as: SDAI.SET<
        eSTRUCTURED_MESSAGE>.self, from: parameters[0])
...
```
*/
  public final class eCONTAINING_MESSAGE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var ITEMS: SDAI.SET<eSTRUCTURED_MESSAGE>/*[1:1]*/  {
      get {
