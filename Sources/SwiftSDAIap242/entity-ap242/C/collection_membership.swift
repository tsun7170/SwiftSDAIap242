/* file: collection_membership.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- collection_membership (line:9666 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOLLECTION_MEMBERSHIP/PartialEntity``
*/
  public final class eCOLLECTION_MEMBERSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eCOLLECTION_MEMBERSHIP>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eCOLLECTION_MEMBERSHIP.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eCOLLECTION_MEMBERSHIP.PartialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eCOLLECTION_MEMBERSHIP.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "ROLE", 
        keyPath: \eCOLLECTION_MEMBERSHIP.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eCOLLECTION_MEMBERSHIP.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_GROUP", 
        keyPath: \eCOLLECTION_MEMBERSHIP.ASSIGNED_GROUP, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOLLECTION_MEMBERSHIP``
*/
