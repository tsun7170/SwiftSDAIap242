/* file: curve_swept_solid_shape_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _curve_swept_solid_shape_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eCURVE_SWEPT_SOLID_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eCURVE_SWEPT_SOLID_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eCURVE_SWEPT_SOLID_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eCURVE_SWEPT_SOLID_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.ITEMS
      let _TEMP2 = _TEMP1.QUERY{ IT in 

          let _TEMP1 = SDAI.TYPEOF(IT, IS: eSURFACE_CURVE_SWEPT_AREA_SOLID.self)
          return _TEMP1 }
      let _TEMP3 = _TEMP2.QUERY{ SCSAS in 

          let _TEMP1 = SDAI.TYPEOF(SCSAS.GROUP_REF(eSURFACE_CURVE_SWEPT_AREA_SOLID.self)?.DIRECTRIX, 
            IS: eSURFACE_CURVE.self)
          let _TEMP2 = SDAI.TYPEOF(SCSAS.GROUP_REF(eSURFACE_CURVE_SWEPT_AREA_SOLID.self)?.DIRECTRIX, 
            IS: ePCURVE.self)
...
```
*/
  public final class eCURVE_SWEPT_SOLID_SHAPE_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _curve_swept_solid_shape_representation.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _curve_swept_solid_shape_representation.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _curve_swept_solid_shape_representation.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _curve_swept_solid_shape_representation.WHERE_wr4(SELF: instance)
      return result
    }
