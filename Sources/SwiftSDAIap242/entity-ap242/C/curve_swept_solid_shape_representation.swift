/* file: curve_swept_solid_shape_representation.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eCURVE_SWEPT_SOLID_SHAPE_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eCURVE_SWEPT_SOLID_SHAPE_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eCURVE_SWEPT_SOLID_SHAPE_REPRESENTATION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eCURVE_SWEPT_SOLID_SHAPE_REPRESENTATION.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eCURVE_SWEPT_SOLID_SHAPE_REPRESENTATION.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
