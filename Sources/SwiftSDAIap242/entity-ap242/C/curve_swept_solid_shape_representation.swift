/* file: curve_swept_solid_shape_representation.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _curve_swept_solid_shape_representation : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
      ...
      let _TEMP2 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:nil] ? */ = _TEMP1?
        .QUERY{ MI in 
          ...
          let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( ((MI.GROUP_REF(eMAPPED_ITEM.self))?.MAPPING_SOURCE)?.MAPPED_REPRESENTATION, 
            IS: eCURVE_SWEPT_SOLID_SHAPE_REPRESENTATION.self )
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_curve_swept_solid_shape_representation``
*/
  public final class eCURVE_SWEPT_SOLID_SHAPE_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _curve_swept_solid_shape_representation.self
    }
    /// partial entity reference
    public let partialEntity: _curve_swept_solid_shape_representation
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_curve_swept_solid_shape_representation.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _curve_swept_solid_shape_representation.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _curve_swept_solid_shape_representation.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _curve_swept_solid_shape_representation.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _curve_swept_solid_shape_representation.WHERE_wr4(SELF: instance.pRef)
      return result
    }
