/* file: curve_style_parameters_with_ends.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- curve_style_parameters_with_ends (line:11139 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(2)	curve_style_parameters_representation
    (no local attributes)

  ENTITY(SELF)	curve_style_parameters_with_ends
    (no local attributes)
...
- SUPERTYPES:
	...
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_STYLE_PARAMETERS_REPRESENTATION``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_STYLE_PARAMETERS_WITH_ENDS/PartialEntity``
*/
  public final class eCURVE_STYLE_PARAMETERS_WITH_ENDS : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eCURVE_STYLE_PARAMETERS_WITH_ENDS>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eCURVE_STYLE_PARAMETERS_WITH_ENDS.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eCURVE_STYLE_PARAMETERS_WITH_ENDS.PartialEntity

    //MARK: SUPERTYPES
    public let super_eREPRESENTATION: eREPRESENTATION 	// [1]
    public let super_eCURVE_STYLE_PARAMETERS_REPRESENTATION: eCURVE_STYLE_PARAMETERS_REPRESENTATION 	// [2]
    public var super_eCURVE_STYLE_PARAMETERS_WITH_ENDS: eCURVE_STYLE_PARAMETERS_WITH_ENDS { return self } 	// [3]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eCURVE_STYLE_PARAMETERS_WITH_ENDS.PartialEntity.self) else { return nil }
      ...
      guard let super2 = complexEntity?.entityReference(eCURVE_STYLE_PARAMETERS_REPRESENTATION.self) else { return nil }
      self.super_eCURVE_STYLE_PARAMETERS_REPRESENTATION = super2
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "CURVE_STYLE_PARAMETERS_WITH_ENDS", 
      ...
      entityDef.add(supertype: eCURVE_STYLE_PARAMETERS_WITH_ENDS.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eCURVE_STYLE_PARAMETERS_WITH_ENDS.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eCURVE_STYLE_PARAMETERS_WITH_ENDS.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eCURVE_STYLE_PARAMETERS_WITH_ENDS.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eCURVE_STYLE_PARAMETERS_WITH_ENDS.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eCURVE_STYLE_PARAMETERS_WITH_ENDS.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_STYLE_PARAMETERS_WITH_ENDS``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eCURVE_STYLE_PARAMETERS_WITH_ENDS.self
      }
