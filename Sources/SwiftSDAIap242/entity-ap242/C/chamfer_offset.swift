/* file: chamfer_offset.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _chamfer_offset : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eCHAMFER_OFFSET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.DESCRIPTION
      let _TEMP2 = ([SDAI.AIE(SDAI.STRING("first offset")), 
    ...
    public static func WHERE_wr2(SELF: eCHAMFER_OFFSET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eCHAMFER_OFFSET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eCHAMFER_OFFSET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.DESCRIPTION
      let _TEMP2 = _TEMP1 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("first offset"))
      let _TEMP3 =  !_TEMP2
    ...
    public static func WHERE_wr5(SELF: eCHAMFER_OFFSET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr6(SELF: eCHAMFER_OFFSET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.DESCRIPTION
      let _TEMP2 = _TEMP1 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("second offset"))
      let _TEMP3 =  !_TEMP2
      let _TEMP4 = SDAI.USEDIN(T: SELF, ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
        .ePROPERTY_DEFINITION.DEFINITION)
      let _TEMP5 = _TEMP4.QUERY{ PD in 
              ...
              let _TEMP3 = /*runtime*/SDAI.FORCE_OPTIONAL(_TEMP2)?
                .QUERY{ IT in 
                  ...
                  let _TEMP7 = SDAI.FORCE_OPTIONAL(/*runtime*/_TEMP6) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING(
                    "offset amount"))
                  let _TEMP8 = _TEMP5 && _TEMP7
                  let _TEMP9 = ([SDAI.AIE(SDAI.STRING(
                    "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.MEASURE_REPRESENTATION_ITEM")), 
                    SDAI.AIE(SDAI.STRING(
                    "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PLANE_ANGLE_MEASURE_WITH_UNIT"))] 
                    as [SDAI.AggregationInitializerElement<SDAI.STRING>])
                  let _TEMP10 = SDAI.TYPEOF(IT)
                  let _TEMP11 = SDAI.FORCE_OPTIONAL(_TEMP9) * SDAI.FORCE_OPTIONAL(_TEMP10)
                  let _TEMP12 = SDAI.SIZEOF(_TEMP11)
                  let _TEMP13 = _TEMP12 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(2))
                  let _TEMP14 = /*runtime*/IT.NAME
                  let _TEMP15 = SDAI.FORCE_OPTIONAL(/*runtime*/_TEMP14) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING(
                    "offset angle"))
    ...
    public static func WHERE_wr7(SELF: eCHAMFER_OFFSET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr8(SELF: eCHAMFER_OFFSET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ SDR in 
          ...
          let _TEMP1 = SDAI.TYPEOF(SDR.RELATING_SHAPE_ASPECT, IS: eCHAMFER.self)
          let _TEMP2 = SDAI.TYPEOF(SDR.RELATED_SHAPE_ASPECT, IS: eCHAMFER_OFFSET.self)
...
```
*/
  public final class eCHAMFER_OFFSET : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _chamfer_offset.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _chamfer_offset.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _chamfer_offset.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _chamfer_offset.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _chamfer_offset.WHERE_wr5(SELF: instance)
      result[prefix2 + " .WHERE_wr6"] = _chamfer_offset.WHERE_wr6(SELF: instance)
      result[prefix2 + " .WHERE_wr7"] = _chamfer_offset.WHERE_wr7(SELF: instance)
      result[prefix2 + " .WHERE_wr8"] = _chamfer_offset.WHERE_wr8(SELF: instance)
      return result
    }
