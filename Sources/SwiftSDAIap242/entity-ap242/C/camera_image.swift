/* file: camera_image.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- camera_image (line:8716 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _camera_image : SDAI.PartialEntity {
...
```
*/
  public final class eCAMERA_IMAGE : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "CAMERA_IMAGE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "MAPPING_SOURCE", keyPath: \eCAMERA_IMAGE.MAPPING_SOURCE, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "MAPPING_TARGET", keyPath: \eCAMERA_IMAGE.MAPPING_TARGET, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eCAMERA_IMAGE.NAME, 
