/* file: camera_image.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _camera_image : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _mapping_source: eCAMERA_USAGE	//EXPLICIT REDEFINITION(eMAPPED_ITEM) */

    /* override var _mapping_target: ePLANAR_BOX	//EXPLICIT REDEFINITION(eMAPPED_ITEM) */
    ...
    public static func WHERE_wr1(SELF: eCAMERA_IMAGE?) -> SDAI.LOGICAL {
...
```
*/
  public final class eCAMERA_IMAGE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _camera_image.WHERE_wr1(SELF: instance)
      return result
    }
