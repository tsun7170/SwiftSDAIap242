/* file: characterized_object.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public final class eCHARACTERIZED_OBJECT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var RELATED_OBJECT: eSHAPE_FEATURE_DEFINITION.PRef?  {
      get {
        return eSHAPE_FEATURE_DEFINITION.PRef( sub_eSHAPE_FEATURE_DEFINITION_RELATIONSHIP?.super_eCHARACTERIZED_OBJECT_RELATIONSHIP
    ...
    public var ITEM_CONCEPT: ePRODUCT_CLASS.PRef?  {
      get {
        return ePRODUCT_CLASS.PRef( sub_ePRODUCT_IDENTIFICATION?.super_eCONFIGURATION_ITEM.partialEntity
          ._item_concept )
      }
      set(newValue) {
    ...
    public var RELATED_SHAPE_ASPECT: eCONTACT_FEATURE.PRef?  {
      get {
        return eCONTACT_FEATURE.PRef( sub_eCONTACT_FEATURE_FIT_RELATIONSHIP?.super_eSHAPE_ASPECT_RELATIONSHIP
