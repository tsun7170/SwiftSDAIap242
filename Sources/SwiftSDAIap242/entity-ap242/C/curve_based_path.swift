/* file: curve_based_path.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  ENTITY curve_based_path
    SUBTYPE OF ( path_node );
      path_curve  : curve;
  END_ENTITY; -- curve_based_path (line:11011 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _curve_based_path : SDAI.PartialEntity {
...
```
*/
  public final class eCURVE_BASED_PATH : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "CURVE_BASED_PATH", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "USERS", keyPath: \eCURVE_BASED_PATH.USERS, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "T_END", keyPath: \eCURVE_BASED_PATH.T_END, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "TRANSITION", keyPath: \eCURVE_BASED_PATH.TRANSITION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "PATH_CURVE", keyPath: \eCURVE_BASED_PATH.PATH_CURVE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "PLACEMENT_END", keyPath: \eCURVE_BASED_PATH.PLACEMENT_END, 
