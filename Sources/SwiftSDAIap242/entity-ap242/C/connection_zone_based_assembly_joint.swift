/* file: connection_zone_based_assembly_joint.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _connection_zone_based_assembly_joint : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_connection_zone_based_assembly_joint``
*/
  public final class eCONNECTION_ZONE_BASED_ASSEMBLY_JOINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _connection_zone_based_assembly_joint.self
    }
    /// partial entity reference
    public let partialEntity: _connection_zone_based_assembly_joint
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_connection_zone_based_assembly_joint.self) else { return nil }
