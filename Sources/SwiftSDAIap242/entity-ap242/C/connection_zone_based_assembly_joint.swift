/* file: connection_zone_based_assembly_joint.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- connection_zone_based_assembly_joint (line:7458 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _connection_zone_based_assembly_joint : SDAI.PartialEntity {
...
```
*/
  public final class eCONNECTION_ZONE_BASED_ASSEMBLY_JOINT : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "CONNECTION_ZONE_BASED_ASSEMBLY_JOINT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "PRODUCT_DEFINITIONAL", keyPath: \eCONNECTION_ZONE_BASED_ASSEMBLY_JOINT.PRODUCT_DEFINITIONAL, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OF_SHAPE", keyPath: \eCONNECTION_ZONE_BASED_ASSEMBLY_JOINT.OF_SHAPE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "RELATED_SHAPE_ASPECT", keyPath: \eCONNECTION_ZONE_BASED_ASSEMBLY_JOINT.RELATED_SHAPE_ASPECT, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "RELATING_SHAPE_ASPECT", keyPath: \eCONNECTION_ZONE_BASED_ASSEMBLY_JOINT.RELATING_SHAPE_ASPECT, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
