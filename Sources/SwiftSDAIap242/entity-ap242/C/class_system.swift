/* file: class_system.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  ENTITY class_system
    SUBTYPE OF ( group );
  END_ENTITY; -- class_system (line:9510 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _class_system : SDAI.PartialEntity {
...
```
*/
  public final class eCLASS_SYSTEM : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "CLASS_SYSTEM", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eCLASS_SYSTEM.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ID", keyPath: \eCLASS_SYSTEM.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eCLASS_SYSTEM.NAME, 
