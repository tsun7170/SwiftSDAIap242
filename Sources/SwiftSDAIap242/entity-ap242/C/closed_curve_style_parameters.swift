/* file: closed_curve_style_parameters.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _closed_curve_style_parameters : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_closed_curve_style_parameters``
*/
  public final class eCLOSED_CURVE_STYLE_PARAMETERS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _closed_curve_style_parameters.self
    }
    /// partial entity reference
    public let partialEntity: _closed_curve_style_parameters
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_closed_curve_style_parameters.self) else { return nil }
