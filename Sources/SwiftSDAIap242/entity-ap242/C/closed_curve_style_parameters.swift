/* file: closed_curve_style_parameters.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- closed_curve_style_parameters (line:9568 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	closed_curve_style_parameters
    (no local attributes)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCLOSED_CURVE_STYLE_PARAMETERS/PartialEntity``
*/
  public final class eCLOSED_CURVE_STYLE_PARAMETERS : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eCLOSED_CURVE_STYLE_PARAMETERS>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eCLOSED_CURVE_STYLE_PARAMETERS.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eCLOSED_CURVE_STYLE_PARAMETERS.PartialEntity
    ...
    public var super_eCLOSED_CURVE_STYLE_PARAMETERS: eCLOSED_CURVE_STYLE_PARAMETERS { return self } 	// [3]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eCLOSED_CURVE_STYLE_PARAMETERS.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "CLOSED_CURVE_STYLE_PARAMETERS", 
      ...
      entityDef.add(supertype: eCLOSED_CURVE_STYLE_PARAMETERS.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eCLOSED_CURVE_STYLE_PARAMETERS.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eCLOSED_CURVE_STYLE_PARAMETERS.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eCLOSED_CURVE_STYLE_PARAMETERS.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eCLOSED_CURVE_STYLE_PARAMETERS.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eCLOSED_CURVE_STYLE_PARAMETERS.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCLOSED_CURVE_STYLE_PARAMETERS``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eCLOSED_CURVE_STYLE_PARAMETERS.self
      }
