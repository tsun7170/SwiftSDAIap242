/* file: closed_curve_style_parameters.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- closed_curve_style_parameters (line:9575 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _closed_curve_style_parameters : SDAI.PartialEntity {
...
```
*/
  public final class eCLOSED_CURVE_STYLE_PARAMETERS : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "CLOSED_CURVE_STYLE_PARAMETERS", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eCLOSED_CURVE_STYLE_PARAMETERS.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eCLOSED_CURVE_STYLE_PARAMETERS.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eCLOSED_CURVE_STYLE_PARAMETERS.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eCLOSED_CURVE_STYLE_PARAMETERS.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eCLOSED_CURVE_STYLE_PARAMETERS.NAME, 
