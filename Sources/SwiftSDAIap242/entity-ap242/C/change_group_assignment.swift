/* file: change_group_assignment.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- change_group_assignment (line:9162 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _change_group_assignment : SDAI.PartialEntity {
...
```
*/
  public final class eCHANGE_GROUP_ASSIGNMENT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eCHANGE_GROUP_ASSIGNMENT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "CHANGE_GROUP_ASSIGNMENT", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "ITEM", keyPath: \eCHANGE_GROUP_ASSIGNMENT.ITEM, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ROLE", keyPath: \eCHANGE_GROUP_ASSIGNMENT.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_GROUP", keyPath: \eCHANGE_GROUP_ASSIGNMENT.ASSIGNED_GROUP, 
