/* file: change_group_assignment.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _change_group_assignment : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _assigned_group: eCHANGE_GROUP	//EXPLICIT REDEFINITION(eGROUP_ASSIGNMENT) */
...
```
*/
  public final class eCHANGE_GROUP_ASSIGNMENT : SDAI.EntityReference, @unchecked Sendable {
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCHANGE_GROUP_ASSIGNMENT`` )
    public var ASSIGNED_GROUP: eCHANGE_GROUP {
      get {
        if let resolved = _group_assignment._assigned_group__provider(complex: self.complexEntity) {
          let value = SDAI.UNWRAP( eCHANGE_GROUP(resolved._assigned_group__getter(
            complex: self.complexEntity)) )
          return value
        }
        else {
          return SDAI.UNWRAP( eCHANGE_GROUP(super_eGROUP_ASSIGNMENT.partialEntity._assigned_group) )
        }
      }
      set(newValue) {
