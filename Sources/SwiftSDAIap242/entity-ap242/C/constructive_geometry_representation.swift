/* file: constructive_geometry_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _constructive_geometry_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eCONSTRUCTIVE_GEOMETRY_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.TYPEOF(SELF.GROUP_REF(eREPRESENTATION.self)?.CONTEXT_OF_ITEMS, 
        IS: eGEOMETRIC_REPRESENTATION_CONTEXT.self)
      let _TEMP2 = SELF.GROUP_REF(eREPRESENTATION.self)
      ...
      let _TEMP6 = SDAI.FORCE_OPTIONAL(SDAI.INTEGER(2)) <= _TEMP5
      let _TEMP7 = SELF.GROUP_REF(eREPRESENTATION.self)
      let _TEMP8 = _TEMP7?.CONTEXT_OF_ITEMS
      let _TEMP9 = _TEMP8?.GROUP_REF(eGEOMETRIC_REPRESENTATION_CONTEXT.self)
      let _TEMP10 = _TEMP9?.COORDINATE_SPACE_DIMENSION
      let _TEMP11 = _TEMP10 <= SDAI.FORCE_OPTIONAL(SDAI.INTEGER(3))
      let _TEMP12 = _TEMP6 && _TEMP11
      let _TEMP13 = _TEMP1 && _TEMP12
      return _TEMP13
    }
    public static func WHERE_wr2(SELF: eCONSTRUCTIVE_GEOMETRY_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.ITEMS
      let _TEMP2 = _TEMP1.QUERY{ CGR_I in 

          let _TEMP1 = ([SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PLACEMENT")), 
    ...
    public static func WHERE_wr3(SELF: eCONSTRUCTIVE_GEOMETRY_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eCONSTRUCTIVE_GEOMETRY_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _constructive_geometry_representation.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _constructive_geometry_representation.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _constructive_geometry_representation.WHERE_wr3(SELF: instance)
      return result
    }
