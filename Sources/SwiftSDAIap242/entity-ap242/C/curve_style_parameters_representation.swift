/* file: curve_style_parameters_representation.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _curve_style_parameters_representation : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_curve_style_parameters_representation``
*/
  public final class eCURVE_STYLE_PARAMETERS_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _curve_style_parameters_representation.self
    }
    /// partial entity reference
    public let partialEntity: _curve_style_parameters_representation
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_curve_style_parameters_representation.self) else { return nil }
