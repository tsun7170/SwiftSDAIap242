/* file: curve_style_parameters_representation.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- curve_style_parameters_representation (line:11135 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	curve_style_parameters_representation
    (no local attributes)

  SUB- ENTITY(3)	curve_style_parameters_with_ends
    (no local attributes)

  SUB- ENTITY(4)	closed_curve_style_parameters
    (no local attributes)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_STYLE_PARAMETERS_WITH_ENDS``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCLOSED_CURVE_STYLE_PARAMETERS``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_STYLE_PARAMETERS_REPRESENTATION/PartialEntity``
*/
  public final class eCURVE_STYLE_PARAMETERS_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eCURVE_STYLE_PARAMETERS_REPRESENTATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eCURVE_STYLE_PARAMETERS_REPRESENTATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eCURVE_STYLE_PARAMETERS_REPRESENTATION.PartialEntity

    //MARK: SUPERTYPES
    public let super_eREPRESENTATION: eREPRESENTATION 	// [1]
    public var super_eCURVE_STYLE_PARAMETERS_REPRESENTATION: eCURVE_STYLE_PARAMETERS_REPRESENTATION { return self } 	// [2]

    //MARK: SUBTYPES
    public var sub_eCURVE_STYLE_PARAMETERS_WITH_ENDS: eCURVE_STYLE_PARAMETERS_WITH_ENDS? {	// [3]
      return self.complexEntity.entityReference(eCURVE_STYLE_PARAMETERS_WITH_ENDS.self)
    }

    public var sub_eCLOSED_CURVE_STYLE_PARAMETERS: eCLOSED_CURVE_STYLE_PARAMETERS? {	// [4]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eCURVE_STYLE_PARAMETERS_REPRESENTATION.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "CURVE_STYLE_PARAMETERS_REPRESENTATION", 
        type: self, explicitAttributeCount: 0)

      //MARK: SUPERTYPE REGISTRATIONS
      entityDef.add(supertype: eREPRESENTATION.self)
      entityDef.add(supertype: eCURVE_STYLE_PARAMETERS_REPRESENTATION.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eCURVE_STYLE_PARAMETERS_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eCURVE_STYLE_PARAMETERS_REPRESENTATION.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eCURVE_STYLE_PARAMETERS_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eCURVE_STYLE_PARAMETERS_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eCURVE_STYLE_PARAMETERS_REPRESENTATION.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_STYLE_PARAMETERS_REPRESENTATION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eCURVE_STYLE_PARAMETERS_REPRESENTATION.self
      }
