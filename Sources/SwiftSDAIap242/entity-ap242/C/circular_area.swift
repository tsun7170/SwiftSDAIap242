/* file: circular_area.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _circular_area : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /// EXPLICIT ATTRIBUTE 
    public internal(set) var _centre: eCARTESIAN_POINT // PLAIN EXPLICIT ATTRIBUTE
    ...
    public init(CENTRE: eCARTESIAN_POINT, RADIUS: tPOSITIVE_LENGTH_MEASURE) {
      self._centre = CENTRE
      self._radius = RADIUS
...
```
*/
  public final class eCIRCULAR_AREA : SDAI.EntityReference, @unchecked Sendable {
