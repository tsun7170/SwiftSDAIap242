/* file: composite_hole.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eCOMPOSITE_HOLE : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eCOMPOSITE_HOLE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eCOMPOSITE_HOLE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eCOMPOSITE_HOLE.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      return result
    }
