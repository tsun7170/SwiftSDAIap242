/* file: composite_hole.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _composite_hole : SDAI.PartialEntity, SDAI.InitializableByVoid, @unchecked Sendable {
            ...
            .QUERY{ CSA in 
              ...
              let _TEMP3 /* runtime? */ = /*runtime*/_TEMP2?
                .QUERY{ SAR in 
                  ...
                  let _TEMP2 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SAR.RELATED_SHAPE_ASPECT, IS: eROUND_HOLE.self )
            ...
            .QUERY{ CSA in 
              ...
              let _TEMP3 /* runtime? */ = /*runtime*/_TEMP2?
                .QUERY{ SAR in 
                  ...
                  let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SAR.RELATED_SHAPE_ASPECT, IS: eROUND_HOLE.self )
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_composite_hole``
*/
  public final class eCOMPOSITE_HOLE : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _composite_hole.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _composite_hole.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _composite_hole.WHERE_wr3(SELF: instance.pRef)
      return result
    }
