/* file: character_glyph_symbol.swift 	 generated: Tue Jan 20 19:20:51 2026 */
...
*/
  public final class eCHARACTER_GLYPH_SYMBOL : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eCHARACTER_GLYPH_SYMBOL.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eCHARACTER_GLYPH_SYMBOL.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eCHARACTER_GLYPH_SYMBOL.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      return result
    }
