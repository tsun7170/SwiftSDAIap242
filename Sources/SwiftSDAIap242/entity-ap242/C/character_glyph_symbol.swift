/* file: character_glyph_symbol.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _character_glyph_symbol : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_character_glyph_symbol``
*/
  public final class eCHARACTER_GLYPH_SYMBOL : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _character_glyph_symbol.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _character_glyph_symbol.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _character_glyph_symbol.WHERE_wr3(SELF: instance.pRef)
      return result
    }
