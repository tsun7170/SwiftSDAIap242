/* file: compound_feature.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _compound_feature : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eCOMPOUND_FEATURE?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eCOMPOUND_FEATURE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eCOMPOUND_FEATURE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
          ...
          let _TEMP3 = _TEMP2.QUERY{ CSA in 
              ...
              let _TEMP3 = /*runtime*/SDAI.FORCE_OPTIONAL(_TEMP2)?
                .QUERY{ FCR in 
                  ...
                  let _TEMP1 = SDAI.TYPEOF(FCR, IS: eFEATURE_COMPONENT_RELATIONSHIP.self)
                  let _TEMP2 =  !_TEMP1
                  return _TEMP2 }
    ...
    public static func WHERE_wr4(SELF: eCOMPOUND_FEATURE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr5(SELF: eCOMPOUND_FEATURE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
          ...
          let _TEMP3 = _TEMP2.QUERY{ CSA in 
              ...
              let _TEMP3 = /*runtime*/SDAI.FORCE_OPTIONAL(_TEMP2)?
                .QUERY{ SAR in 
                  ...
                  let _TEMP1 = SDAI.TYPEOF(SAR.RELATED_SHAPE_ASPECT, IS: eTHREAD.self)
                  return _TEMP1 }
              let _TEMP4 = SDAI.SIZEOF(SDAI.AGGREGATE<SDAI.GENERIC>(/*runtime*/_TEMP3))
              let _TEMP5 = _TEMP4 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(0))
              let _TEMP6 = _TEMP1 && _TEMP5
    ...
    public static func WHERE_wr6(SELF: eCOMPOUND_FEATURE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
          ...
          let _TEMP3 = _TEMP2.QUERY{ CSA in 
              ...
              let _TEMP3 = /*runtime*/SDAI.FORCE_OPTIONAL(_TEMP2)?
                .QUERY{ SAR in 
                  ...
                  let _TEMP1 = SDAI.TYPEOF(SAR.RELATED_SHAPE_ASPECT, IS: eCOMPOUND_FEATURE.self)
                  let _TEMP2 = /*runtime*/SAR.RELATED_SHAPE_ASPECT
                  let _TEMP3 = /*runtime*/SDAI.FORCE_OPTIONAL(_TEMP2)?.GROUP_REF(eCHARACTERIZED_OBJECT.self)
                  let _TEMP4 = /*runtime*/_TEMP3?.NAME
                  let _TEMP5 = SELF.GROUP_REF(eCHARACTERIZED_OBJECT.self)
                  let _TEMP6 = _TEMP5?.NAME
                  let _TEMP7 = /*runtime*/_TEMP4 .!=. _TEMP6
...
```
*/
  public final class eCOMPOUND_FEATURE : SDAI.EntityReference, @unchecked Sendable {
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"EXPLICIT_SHAPE") {
        return cached.value as! (SDAI.SET<eITEM_IDENTIFIED_REPRESENTATION_USAGE>/*[0:nil]*/ )? 
      }
      let swiftValue = SDAI.SET<eITEM_IDENTIFIED_REPRESENTATION_USAGE>/*[0:nil]*/ .SwiftType( self.referencingEntities(for: \eITEM_IDENTIFIED_REPRESENTATION_USAGE.DEFINITION) )
      let value = SDAI.SET<eITEM_IDENTIFIED_REPRESENTATION_USAGE>/*[0:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _compound_feature.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _compound_feature.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _compound_feature.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _compound_feature.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _compound_feature.WHERE_wr5(SELF: instance)
      result[prefix2 + " .WHERE_wr6"] = _compound_feature.WHERE_wr6(SELF: instance)
      return result
    }
