/* file: connectivity_definition_item_relationship.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- connectivity_definition_item_relationship (line:10415 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eCONNECTIVITY_DEFINITION_ITEM_RELATIONSHIP : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eCONNECTIVITY_DEFINITION_ITEM_RELATIONSHIP`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "CONNECTIVITY_DEFINITION_ITEM_RELATIONSHIP", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eCONNECTIVITY_DEFINITION_ITEM_RELATIONSHIP.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ID", keyPath: \eCONNECTIVITY_DEFINITION_ITEM_RELATIONSHIP.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATED_SHAPE_ASPECT", keyPath: \eCONNECTIVITY_DEFINITION_ITEM_RELATIONSHIP.RELATED_SHAPE_ASPECT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eCONNECTIVITY_DEFINITION_ITEM_RELATIONSHIP.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATING_SHAPE_ASPECT", keyPath: \eCONNECTIVITY_DEFINITION_ITEM_RELATIONSHIP.RELATING_SHAPE_ASPECT, 
