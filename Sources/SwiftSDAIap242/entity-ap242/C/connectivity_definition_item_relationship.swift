/* file: connectivity_definition_item_relationship.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _connectivity_definition_item_relationship : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _relating_shape_aspect: eCONNECTIVITY_DEFINITION	//EXPLICIT REDEFINITION(eSHAPE_ASPECT_RELATIONSHIP) */
...
```
*/
  public final class eCONNECTIVITY_DEFINITION_ITEM_RELATIONSHIP : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var RELATING_SHAPE_ASPECT: eCONNECTIVITY_DEFINITION {
      get {
        return SDAI.UNWRAP( eCONNECTIVITY_DEFINITION( super_eSHAPE_ASPECT_RELATIONSHIP.partialEntity
