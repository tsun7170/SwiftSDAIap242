/* file: contact_ratio_representation.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eCONTACT_RATIO_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eCONTACT_RATIO_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eCONTACT_RATIO_REPRESENTATION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eCONTACT_RATIO_REPRESENTATION.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      return result
    }
