/* file: contact_ratio_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _contact_ratio_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eCONTACT_RATIO_REPRESENTATION?) -> SDAI.LOGICAL {
      ...
      let _TEMP5 = _TEMP4.QUERY{ I in 
          ...
          let _TEMP6 = I.NAME
          let _TEMP7 = SDAI.FORCE_OPTIONAL(_TEMP6) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("ratio value"))
    ...
    public static func WHERE_wr2(SELF: eCONTACT_RATIO_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP2 = _TEMP1.QUERY{ PDR in 
          ...
          let _TEMP1 = /*runtime*/PDR.GROUP_REF(ePROPERTY_DEFINITION_REPRESENTATION.self)
          let _TEMP2 = /*runtime*/_TEMP1?.NAME
          let _TEMP3 = /*runtime*/_TEMP2 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("contact ratio reference"))
          return _TEMP3 }
      ...
      let _TEMP6 = _TEMP5.QUERY{ PDR in 
          ...
          let _TEMP2 = /*runtime*/_TEMP1?.NAME
          let _TEMP3 = /*runtime*/_TEMP2 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("contact ratio reference"))
          let _TEMP4 = SDAI.TYPEOF(SDAI.FORCE_OPTIONAL(PDR.GROUP_REF(ePROPERTY_DEFINITION_REPRESENTATION.self)?
            .DEFINITION)?.GROUP_REF(ePROPERTY_DEFINITION.self)?.DEFINITION, IS: ePRODUCT_DEFINITION.self)
    ...
    public static func WHERE_wr3(SELF: eCONTACT_RATIO_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP5 = _TEMP4.QUERY{ PDR in 
          ...
          let _TEMP3 = _TEMP2.QUERY{ GPA in 
              ...
              let _TEMP1 = SDAI.TYPEOF(GPA.GROUP_REF(eGENERAL_PROPERTY_ASSOCIATION.self)?.BASE_DEFINITION, 
                IS: eGENERAL_PROPERTY.self)
...
```
*/
  public final class eCONTACT_RATIO_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _contact_ratio_representation.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _contact_ratio_representation.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _contact_ratio_representation.WHERE_wr3(SELF: instance)
      return result
    }
