/* file: free_form_assignment.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _free_form_assignment : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eFREE_FORM_ASSIGNMENT?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eFREE_FORM_ASSIGNMENT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eFREE_FORM_ASSIGNMENT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eFREE_FORM_ASSIGNMENT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2?.QUERY{ Q in 
          ...
          let _TEMP1 = SELF.GROUP_REF(eFREE_FORM_CONSTRAINT.self)
          let _TEMP2 = _TEMP1?.CONSTRAINING_EXPRESSION
          let _TEMP3 = VALUES_SPACE_OF(eGENERIC_EXPRESSION(/*eEXPRESSION*/_TEMP2))
          let _TEMP4 = Q.GROUP_REF(eMATHS_VARIABLE.self)
          let _TEMP5 = _TEMP4?.VALUES_SPACE
          let _TEMP6 = COMPATIBLE_SPACES(
            SP1: _TEMP3, SP2: _TEMP5)
          let _TEMP7 =  !_TEMP6
          return _TEMP7 }
      let _TEMP4 = SDAI.SIZEOF(_TEMP3)
      let _TEMP5 = _TEMP4 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(0))
...
```
*/
  public final class eFREE_FORM_ASSIGNMENT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _free_form_assignment.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _free_form_assignment.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _free_form_assignment.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _free_form_assignment.WHERE_wr4(SELF: instance)
      return result
    }
