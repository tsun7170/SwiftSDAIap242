/* file: free_form_assignment.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY free_form_assignment
    ...
    WHERE
      ...
      wr4: ( SIZEOF( QUERY ( q <* SELF\free_form_constraint.constrained_elements | ( NOT compatible_spaces( 
               ...
               values_space ) ) ) ) = 0 );
  END_ENTITY; -- free_form_assignment (line:15938 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _free_form_assignment : SDAI.PartialEntity {
...
```
*/
  public final class eFREE_FORM_ASSIGNMENT : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "FREE_FORM_ASSIGNMENT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eFREE_FORM_ASSIGNMENT.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", keyPath: \eFREE_FORM_ASSIGNMENT.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", keyPath: \eFREE_FORM_ASSIGNMENT.REFERENCE_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CONSTRAINING_EXPRESSION", keyPath: \eFREE_FORM_ASSIGNMENT.CONSTRAINING_EXPRESSION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eFREE_FORM_ASSIGNMENT.NAME, 
