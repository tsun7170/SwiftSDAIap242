/* file: free_form_assignment.swift 	 generated: Mon Dec 15 17:41:04 2025 */
...
*/
  ...
  public final class _free_form_assignment : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
    ...
    public static func WHERE_wr4(SELF: eFREE_FORM_ASSIGNMENT.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP3 /* SDAI.SET<eVARIATIONAL_PARAMETER.PRef>[1:nil] ? */ = _TEMP2?
        .QUERY{ Q in 
          ...
          let _TEMP1 /* eFREE_FORM_CONSTRAINT.PRef? */ = SELF.GROUP_REF(eFREE_FORM_CONSTRAINT.self)
          let _TEMP2 /* eEXPRESSION.PRef? */ = _TEMP1?.CONSTRAINING_EXPRESSION
          let _TEMP3 /* eMATHS_SPACE.PRef? */ = VALUES_SPACE_OF( eGENERIC_EXPRESSION.PRef(/*eEXPRESSION.PRef*/
              _TEMP2) )
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_free_form_assignment``
*/
  public final class eFREE_FORM_ASSIGNMENT : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _free_form_assignment.self
    }
    /// partial entity reference
    public let partialEntity: _free_form_assignment
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_free_form_assignment.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _free_form_assignment.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _free_form_assignment.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _free_form_assignment.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _free_form_assignment.WHERE_wr4(SELF: instance.pRef)
      return result
    }
