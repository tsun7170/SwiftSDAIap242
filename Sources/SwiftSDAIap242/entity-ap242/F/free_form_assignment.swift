/* file: free_form_assignment.swift 	 generated: Tue Oct 14 17:54:07 2025 */
  ...
  ENTITY free_form_assignment
    ...
    WHERE
      ...
      wr4: ( SIZEOF( QUERY ( q <* SELF\free_form_constraint.constrained_elements | ( NOT compatible_spaces( 
               ...
               values_space ) ) ) ) = 0 );
  END_ENTITY; -- free_form_assignment (line:15933 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  ...
  public final class _free_form_assignment : SDAI.PartialEntity, @unchecked Sendable {
