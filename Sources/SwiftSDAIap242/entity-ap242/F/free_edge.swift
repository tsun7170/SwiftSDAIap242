/* file: free_edge.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _free_edge : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eFREE_EDGE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = VALIDATE_MEASURED_DATA_TYPE(
        EI: eSHAPE_DATA_QUALITY_CRITERION(/*eFREE_EDGE*/SELF), 
        TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOOLEAN_VALUE"))
      return _TEMP1
    }
    public static func WHERE_wr2(SELF: eFREE_EDGE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eFREE_EDGE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eFREE_EDGE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr5(SELF: eFREE_EDGE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
          ...
          let _TEMP4 = _TEMP3?.QUERY{ SDQIIR in 
              ...
              let _TEMP3 = /*runtime*/SDAI.FORCE_OPTIONAL(_TEMP2)?
                .QUERY{ SDQIRI in 
                  ...
                  let _TEMP1 = SDAI.TYPEOF(SDAI.FORCE_OPTIONAL(SDQIRI.INSPECTED_ELEMENTS)?[1], 
                    IS: eCLOSED_SHELL.self)
                  return _TEMP1 }
...
```
*/
  public final class eFREE_EDGE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _free_edge.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _free_edge.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _free_edge.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _free_edge.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _free_edge.WHERE_wr5(SELF: instance)
      return result
    }
