/* file: free_edge.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  ENTITY free_edge
    ...
    WHERE
      ...
      wr5: ( SIZEOF( QUERY ( sdqr <* bag_to_set( USEDIN( SELF, 
               ...
               IN TYPEOF( sdqiir ) ) AND ( SIZEOF( QUERY ( sdqiri <* sdqiir.inspected_instances | ( 
               'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.CLOSED_SHELL'  IN TYPEOF( sdqiri.
               inspected_elements[1] ) ) ) ) = 0 ) ) ) ) = 0 ) ) ) ) = 0 );
  END_ENTITY; -- free_edge (line:15975 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(6)	inapt_topology
    (no local attributes)

  ENTITY(SELF)	free_edge
...
- SUPERTYPES:
	...
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINAPT_TOPOLOGY``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFREE_EDGE/PartialEntity``
*/
  public final class eFREE_EDGE : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eFREE_EDGE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eFREE_EDGE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eFREE_EDGE.PartialEntity
    ...
    public let super_eINAPT_TOPOLOGY: eINAPT_TOPOLOGY 	// [6]
    public var super_eFREE_EDGE: eFREE_EDGE { return self } 	// [7]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFREE_EDGE`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eFREE_EDGE.PartialEntity.self) else { return nil }
      ...
      guard let super6 = complexEntity?.entityReference(eINAPT_TOPOLOGY.self) else { return nil }
      self.super_eINAPT_TOPOLOGY = super6
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eFREE_EDGE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eFREE_EDGE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eFREE_EDGE.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eFREE_EDGE.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = eFREE_EDGE.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eINAPT_TOPOLOGY.self)
      entityDef.add(supertype: eFREE_EDGE.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eFREE_EDGE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eFREE_EDGE.NAME, 
    ...
    ENTITY free_edge
      ...
      WHERE
        ...
        wr5: ( SIZEOF( QUERY ( sdqr <* bag_to_set( USEDIN( SELF, 
                 ...
                 QUERY ( sdqiri <* sdqiir.inspected_instances | ( 
                 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.CLOSED_SHELL'  IN TYPEOF( sdqiri.
                 inspected_elements[1] ) ) ) ) = 0 ) ) ) ) = 0 ) ) ) ) = 0 );
    END_ENTITY; -- free_edge (line:15975 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFREE_EDGE``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: eFREE_EDGE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eFREE_EDGE.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOOLEAN_VALUE") )
        return _TEMP1
      }
      public static func WHERE_wr2(SELF: eFREE_EDGE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr3(SELF: eFREE_EDGE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr4(SELF: eFREE_EDGE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr5(SELF: eFREE_EDGE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
              ...
              .QUERY{ SDQIIR in 
                ...
                let _TEMP3 /* runtime?? */ = /*runtime*/SDAI.FORCE_OPTIONAL(_TEMP2)?
                  .QUERY{ SDQIRI in 
                    ...
                    let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SDAI.FORCE_OPTIONAL(SDQIRI.INSPECTED_ELEMENTS)?[
                      1], IS: eCLOSED_SHELL.self )
                    return _TEMP1
                    // END QUERY BODY
                  }
