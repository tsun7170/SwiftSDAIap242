/* file: free_form_relation.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFREE_FORM_RELATION/PartialEntity``
*/
  public final class eFREE_FORM_RELATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eFREE_FORM_RELATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eFREE_FORM_RELATION.PartialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eFREE_FORM_RELATION.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eFREE_FORM_RELATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eFREE_FORM_RELATION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      public static func WHERE_wr2(SELF: eFREE_FORM_RELATION.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP4 /* SDAI.SET<eVARIATIONAL_PARAMETER.PRef>[0:(nil as SDAI.INTEGER?)] ? */ = _TEMP3?.REFERENCE_ELEMENTS
