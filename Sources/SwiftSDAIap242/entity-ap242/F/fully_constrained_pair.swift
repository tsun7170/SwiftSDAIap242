/* file: fully_constrained_pair.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- fully_constrained_pair (line:16086 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	fully_constrained_pair
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFULLY_CONSTRAINED_PAIR/PartialEntity``
*/
  public final class eFULLY_CONSTRAINED_PAIR : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eFULLY_CONSTRAINED_PAIR>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eFULLY_CONSTRAINED_PAIR.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eFULLY_CONSTRAINED_PAIR.PartialEntity
    ...
    public var super_eFULLY_CONSTRAINED_PAIR: eFULLY_CONSTRAINED_PAIR { return self } 	// [6]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFULLY_CONSTRAINED_PAIR`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eFULLY_CONSTRAINED_PAIR.PartialEntity.self) else { return nil }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      internal func _t_x__getter(complex: SDAI.ComplexEntity) -> SDAI.BOOLEAN {
        let SELF = complex.entityReference( eFULLY_CONSTRAINED_PAIR.self )!
        return SDAI.UNWRAP( SDAI.BOOLEAN(SELF.T_X) )
      }
      /// DERIVE ATTRIBUTE REDEFINITION(origin: eLOW_ORDER_KINEMATIC_PAIR)
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _t_x__getter(SELF: eFULLY_CONSTRAINED_PAIR.PRef) -> SDAI.BOOLEAN {
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _t_y__getter(SELF: eFULLY_CONSTRAINED_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.FALSE)
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _t_z__getter(SELF: eFULLY_CONSTRAINED_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.FALSE)
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _r_x__getter(SELF: eFULLY_CONSTRAINED_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.FALSE)
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _r_y__getter(SELF: eFULLY_CONSTRAINED_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.FALSE)
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _r_z__getter(SELF: eFULLY_CONSTRAINED_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.FALSE)
        return SDAI.UNWRAP( value )
      }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eFULLY_CONSTRAINED_PAIR.PartialEntity :
