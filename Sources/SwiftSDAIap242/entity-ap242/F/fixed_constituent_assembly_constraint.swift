/* file: fixed_constituent_assembly_constraint.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- fixed_constituent_assembly_constraint (line:15730 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUPERTYPES:
	...
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDEFINED_CONSTRAINT``
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGEOMETRIC_REPRESENTATION_ITEM``
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXPLICIT_GEOMETRIC_CONSTRAINT``
	8.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT/PartialEntity``
*/
  public final class eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT.PartialEntity
    ...
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT`` )
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT`` )
    public var FIXED_CONSTITUENT: eREPRESENTATIVE_SHAPE_REPRESENTATION.PRef {
      get {
        let originalValue = self.partialEntity._fixed_constituent
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", 
        keyPath: \eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", 
        keyPath: \eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT.REFERENCE_ELEMENTS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "FIXED_CONSTITUENT", 
        keyPath: \eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT.FIXED_CONSTITUENT, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", 
        keyPath: \eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT.DIM, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _fixed_constituent: eREPRESENTATIVE_SHAPE_REPRESENTATION.PRef // PLAIN EXPLICIT ATTRIBUTE
      ...
      public static func WHERE_wr1(SELF: eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.SET<ePRODUCT_DEFINITION.PRef>? */ = 
            USING_PRODUCT_DEFINITION_OF_SHAPE_REPRESENTATION( eSHAPE_REPRESENTATION.PRef(/*
            eREPRESENTATIVE_SHAPE_REPRESENTATION.PRef*/SELF.FIXED_CONSTITUENT) )
        let _TEMP2 /* ePRODUCT_DEFINITION.PRef? */ = _TEMP1?[1]
        let _TEMP3 /* SDAI.BOOLEAN? */ = ASSEMBLY_LEAF( _TEMP2 )
        return SDAI.LOGICAL(_TEMP3)
      }
      public static func WHERE_wr3(SELF: eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr4(SELF: eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        ...
        let _TEMP4 /* SDAI.SET<eREPRESENTATION.PRef>? */ = USING_REPRESENTATIONS( 
            sFOUNDED_ITEM_SELECT(/*eREPRESENTATION_ITEM.PRef*/_TEMP3) )
        let _TEMP5 /* eEXPLICIT_CONSTRAINT.PRef? */ = SELF.GROUP_REF(eEXPLICIT_CONSTRAINT.self)
        ...
        let _TEMP8 /* SDAI.SET<eREPRESENTATION.PRef>? */ = USING_REPRESENTATION_WITH_MAPPING( 
            _TEMP7 )
        let _TEMP9 /* SDAI.SET<eREPRESENTATION.PRef>? */ = _TEMP4 + _TEMP8
        let _TEMP10 /* SDAI.LOGICAL */ = SDAI.aggregate( _TEMP9, contains: eREPRESENTATION.PRef(/*
          eREPRESENTATIVE_SHAPE_REPRESENTATION.PRef*/SELF.FIXED_CONSTITUENT) )
        return _TEMP10
      }
      ...
      public init(FIXED_CONSTITUENT: eREPRESENTATIVE_SHAPE_REPRESENTATION.PRef) {
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( FIXED_CONSTITUENT: original._fixed_constituent )
      }
      ...
      public required convenience init?(
        ...
        guard case .success(let p0) = exchangeStructure.recoverRequiredParameter(as: 
          eREPRESENTATIVE_SHAPE_REPRESENTATION.PRef.self, from: parameters[0])
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]FIXED_CONSTITUENT for partial entity(\(Self.entityName)) constructor"); return nil }
