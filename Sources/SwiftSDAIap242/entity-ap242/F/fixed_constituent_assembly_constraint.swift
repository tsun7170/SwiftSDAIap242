/* file: fixed_constituent_assembly_constraint.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _fixed_constituent_assembly_constraint : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_fixed_constituent_assembly_constraint``
*/
  public final class eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _fixed_constituent_assembly_constraint.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _fixed_constituent_assembly_constraint.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _fixed_constituent_assembly_constraint.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _fixed_constituent_assembly_constraint.WHERE_wr4(SELF: instance.pRef)
      return result
    }
