/* file: fixed_constituent_assembly_constraint.swift 	 generated: Tue Jan 20 19:20:51 2026 */
...
*/
  public final class eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
