/* file: finite_function.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _finite_function : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eFINITE_FUNCTION?) -> SDAI.LOGICAL {
      ...
      let _TEMP2 = SDAI.VALUE_UNIQUE(_TEMP1)
      return _TEMP2
    }
...
```
*/
  public final class eFINITE_FUNCTION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _finite_function.WHERE_wr1(SELF: instance)
      return result
    }
