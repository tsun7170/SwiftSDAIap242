/* file: face.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _face : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public required convenience init?(
      ...
      guard case .success(let p0) = exchangeStructure.recoverOmittableParameter(as: SDAI.SET<eFACE_BOUND.PRef>.self, from: parameters[0])
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_face``
*/
  public final class eFACE : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _face.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _face.WHERE_wr2(SELF: instance.pRef)
      return result
    }
