/* file: face_shape_representation_relationship.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _face_shape_representation_relationship : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eFACE_SHAPE_REPRESENTATION_RELATIONSHIP?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.TYPEOF(SELF.REP_1, IS: eFACE_SHAPE_REPRESENTATION.self)
      return _TEMP1
    }
    public static func WHERE_wr2(SELF: eFACE_SHAPE_REPRESENTATION_RELATIONSHIP?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.TYPEOF(SELF.REP_2, IS: eFACE_SHAPE_REPRESENTATION.self)
      return _TEMP1
    }
...
```
*/
  public final class eFACE_SHAPE_REPRESENTATION_RELATIONSHIP : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _face_shape_representation_relationship.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _face_shape_representation_relationship.WHERE_wr2(SELF: instance)
      return result
    }
