/* file: face_shape_representation_relationship.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY face_shape_representation_relationship
    ...
    WHERE
      ...
      wr2: ( 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.FACE_SHAPE_REPRESENTATION' IN TYPEOF( SELF.
               rep_2 ) );
  END_ENTITY; -- face_shape_representation_relationship (line:15118 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _face_shape_representation_relationship : SDAI.PartialEntity {
...
```
*/
  public final class eFACE_SHAPE_REPRESENTATION_RELATIONSHIP : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "FACE_SHAPE_REPRESENTATION_RELATIONSHIP", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eFACE_SHAPE_REPRESENTATION_RELATIONSHIP.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "REP_1", keyPath: \eFACE_SHAPE_REPRESENTATION_RELATIONSHIP.REP_1, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_2", keyPath: \eFACE_SHAPE_REPRESENTATION_RELATIONSHIP.REP_2, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eFACE_SHAPE_REPRESENTATION_RELATIONSHIP.NAME, 
