/* file: free_kinematic_motion_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _free_kinematic_motion_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    /// EXPLICIT ATTRIBUTE 
    public internal(set) var _motion: eKINEMATIC_PATH // PLAIN EXPLICIT ATTRIBUTE
    ...
    public static func WHERE_wr1(SELF: eFREE_KINEMATIC_MOTION_REPRESENTATION?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eFREE_KINEMATIC_MOTION_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.TYPEOF(SELF.GROUP_REF(eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION.self)?.TRANSFORMATION_OPERATOR
        .GROUP_REF(eITEM_DEFINED_TRANSFORMATION.self)?.TRANSFORM_ITEM_1, 
        IS: eGEOMETRIC_REPRESENTATION_ITEM.self)
      let _TEMP2 = SDAI.TYPEOF(SELF.GROUP_REF(eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION.self)?.TRANSFORMATION_OPERATOR
        .GROUP_REF(eITEM_DEFINED_TRANSFORMATION.self)?.TRANSFORM_ITEM_2, 
        IS: eGEOMETRIC_REPRESENTATION_ITEM.self)
      let _TEMP3 = _TEMP1 && _TEMP2
      return _TEMP3
    }
    public static func WHERE_wr3(SELF: eFREE_KINEMATIC_MOTION_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eFREE_KINEMATIC_MOTION_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public init(MOTION: eKINEMATIC_PATH) {
      self._motion = MOTION
    ...
    public required convenience init?(parameters: [P21Decode.ExchangeStructure.Parameter], exchangeStructure: P21Decode.ExchangeStructure) {
      ...
      guard case .success(let p0) = exchangeStructure.recoverRequiredParameter(as: eKINEMATIC_PATH.self, from: parameters[0])
...
```
*/
  public final class eFREE_KINEMATIC_MOTION_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _free_kinematic_motion_representation.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _free_kinematic_motion_representation.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _free_kinematic_motion_representation.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _free_kinematic_motion_representation.WHERE_wr4(SELF: instance)
      return result
    }
