/* file: free_kinematic_motion_representation.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY free_kinematic_motion_representation
    ...
    WHERE
      ...
      wr4: ( ( SELF\representation_relationship.rep_1 IN ( using_representations( SELF\
               ...
               transformation_operator\item_defined_transformation.transform_item_2 ) ) ) );
  END_ENTITY; -- free_kinematic_motion_representation (line:15962 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _free_kinematic_motion_representation : SDAI.PartialEntity {
...
```
*/
  public final class eFREE_KINEMATIC_MOTION_REPRESENTATION : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eFREE_KINEMATIC_MOTION_REPRESENTATION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "FREE_KINEMATIC_MOTION_REPRESENTATION", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eFREE_KINEMATIC_MOTION_REPRESENTATION.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "TRANSFORMATION_OPERATOR", keyPath: \eFREE_KINEMATIC_MOTION_REPRESENTATION.TRANSFORMATION_OPERATOR, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_1", keyPath: \eFREE_KINEMATIC_MOTION_REPRESENTATION.REP_1, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_2", keyPath: \eFREE_KINEMATIC_MOTION_REPRESENTATION.REP_2, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eFREE_KINEMATIC_MOTION_REPRESENTATION.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MOTION", keyPath: \eFREE_KINEMATIC_MOTION_REPRESENTATION.MOTION, 
