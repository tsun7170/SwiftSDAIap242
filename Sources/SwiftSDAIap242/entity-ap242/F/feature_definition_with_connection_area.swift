/* file: feature_definition_with_connection_area.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _feature_definition_with_connection_area : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_feature_definition_with_connection_area``
*/
  public final class eFEATURE_DEFINITION_WITH_CONNECTION_AREA : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _feature_definition_with_connection_area.self
    }
    /// partial entity reference
    public let partialEntity: _feature_definition_with_connection_area
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_feature_definition_with_connection_area.self) else { return nil }
