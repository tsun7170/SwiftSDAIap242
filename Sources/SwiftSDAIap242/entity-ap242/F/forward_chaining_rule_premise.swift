/* file: forward_chaining_rule_premise.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _forward_chaining_rule_premise : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_forward_chaining_rule_premise``
*/
  public final class eFORWARD_CHAINING_RULE_PREMISE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _forward_chaining_rule_premise.self
    }
    /// partial entity reference
    public let partialEntity: _forward_chaining_rule_premise
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_forward_chaining_rule_premise.self) else { return nil }
