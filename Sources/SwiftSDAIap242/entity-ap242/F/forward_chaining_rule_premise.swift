/* file: forward_chaining_rule_premise.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- forward_chaining_rule_premise (line:15945 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	forward_chaining_rule_premise
    (no local attributes)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFORWARD_CHAINING_RULE_PREMISE/PartialEntity``
*/
  public final class eFORWARD_CHAINING_RULE_PREMISE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eFORWARD_CHAINING_RULE_PREMISE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eFORWARD_CHAINING_RULE_PREMISE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eFORWARD_CHAINING_RULE_PREMISE.PartialEntity
    ...
    public var super_eFORWARD_CHAINING_RULE_PREMISE: eFORWARD_CHAINING_RULE_PREMISE { return self } 	// [4]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eFORWARD_CHAINING_RULE_PREMISE.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "FORWARD_CHAINING_RULE_PREMISE", 
      ...
      entityDef.add(supertype: eFORWARD_CHAINING_RULE_PREMISE.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eFORWARD_CHAINING_RULE_PREMISE.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "USED_REPRESENTATION", 
        keyPath: \eFORWARD_CHAINING_RULE_PREMISE.USED_REPRESENTATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eFORWARD_CHAINING_RULE_PREMISE.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFORWARD_CHAINING_RULE_PREMISE``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eFORWARD_CHAINING_RULE_PREMISE.self
      }
