/* file: forward_chaining_rule_premise.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- forward_chaining_rule_premise (line:15867 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _forward_chaining_rule_premise : SDAI.PartialEntity {
...
```
*/
  public final class eFORWARD_CHAINING_RULE_PREMISE : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "FORWARD_CHAINING_RULE_PREMISE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ITEMS", keyPath: \eFORWARD_CHAINING_RULE_PREMISE.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "USED_REPRESENTATION", keyPath: \eFORWARD_CHAINING_RULE_PREMISE.USED_REPRESENTATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eFORWARD_CHAINING_RULE_PREMISE.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
