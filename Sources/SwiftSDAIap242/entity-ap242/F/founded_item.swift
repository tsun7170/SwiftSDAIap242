/* file: founded_item.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _founded_item : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _users__getter(SELF: eFOUNDED_ITEM) -> (SDAI.SET<sFOUNDED_ITEM_SELECT>/*[0:nil]*/ )?  {
      ...
      let _TEMP1 = SDAI.SET<sFOUNDED_ITEM_SELECT>(SDAI.EMPTY_AGGREGATE)
...
```
*/
  public final class eFOUNDED_ITEM : SDAI.EntityReference, @unchecked Sendable {
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"USING_CURVES") {
        return cached.value as! (SDAI.BAG<eCOMPOSITE_CURVE>/*[1:nil]*/ )? 
      }
      let swiftValue = SDAI.BAG<eCOMPOSITE_CURVE>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \eCOMPOSITE_CURVE.SEGMENTS) )
      let value = SDAI.BAG<eCOMPOSITE_CURVE>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as 
        SDAI.INTEGER?))
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"CAMERA_USAGES") {
        return cached.value as! (SDAI.SET<eCAMERA_MODEL_D3>/*[1:nil]*/ )? 
      }
      let swiftValue = SDAI.SET<eCAMERA_MODEL_D3>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \eCAMERA_MODEL_D3.PERSPECTIVE_OF_VOLUME) )
      let value = SDAI.SET<eCAMERA_MODEL_D3>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as 
        SDAI.INTEGER?))
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"USING_SURFACES") {
        return cached.value as! (SDAI.BAG<eRECTANGULAR_COMPOSITE_SURFACE>/*[1:nil]*/ )? 
      }
      let swiftValue = SDAI.BAG<eRECTANGULAR_COMPOSITE_SURFACE>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \eRECTANGULAR_COMPOSITE_SURFACE.SEGMENTS) )
      let value = SDAI.BAG<eRECTANGULAR_COMPOSITE_SURFACE>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
