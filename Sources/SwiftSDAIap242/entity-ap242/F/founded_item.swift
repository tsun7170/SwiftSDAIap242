/* file: founded_item.swift 	 generated: Tue Oct 14 17:54:07 2025 */
...
/*
  ...
  END_ENTITY; -- founded_item (line:15880 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  ...
  public final class _founded_item : SDAI.PartialEntity, @unchecked Sendable {
...
*/
  public final class eFOUNDED_ITEM : SDAI.EntityReference, SDAIDualModeReference, SDAISimpleEntityType, 
    ...
    get {
      ...
      let swiftValue = SDAI.BAG<eCOMPOSITE_CURVE.PRef>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \eCOMPOSITE_CURVE.SEGMENTS) )
      let value = SDAI.BAG<eCOMPOSITE_CURVE.PRef>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as 
        SDAI.INTEGER?))
    ...
    get {
      ...
      let swiftValue = SDAI.SET<eCAMERA_MODEL_D3.PRef>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \eCAMERA_MODEL_D3.PERSPECTIVE_OF_VOLUME) )
      let value = SDAI.SET<eCAMERA_MODEL_D3.PRef>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as 
        SDAI.INTEGER?))
    ...
    get {
      ...
      let swiftValue = SDAI.BAG<eRECTANGULAR_COMPOSITE_SURFACE.PRef>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \eRECTANGULAR_COMPOSITE_SURFACE.SEGMENTS) )
      let value = SDAI.BAG<eRECTANGULAR_COMPOSITE_SURFACE.PRef>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
