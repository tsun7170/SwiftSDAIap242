/* file: founded_item.swift 	 generated: Wed Jan 21 18:03:37 2026 */
  ...
  public final class eFOUNDED_ITEM : SDAI.EntityReference, SDAI.DualModeReference, SDAI.SimpleEntityType, 
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"USING_CURVES") {
        return cached.value as! (SDAI.BAG<eCOMPOSITE_CURVE.PRef>/*[1:nil]*/ )? 
      }
      let keypath = \eCOMPOSITE_CURVE.SEGMENTS
      let entities = self.referencingEntities(for: keypath)
      let swiftValue = SDAI.BAG<eCOMPOSITE_CURVE.PRef>/*[1:nil]*/ .SwiftType( entities )
      let value = SDAI.BAG<eCOMPOSITE_CURVE.PRef>/*[1:nil]*/ (
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eFOUNDED_ITEM.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eFOUNDED_ITEM.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      internal func _users__getter(SELF: eFOUNDED_ITEM.PRef) -> (SDAI.SET<sFOUNDED_ITEM_SELECT>/*[0:nil]*/ )?  {
