/* file: flat_face.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY flat_face
    ...
    WHERE
      ...
      wr7: ( SIZEOF( QUERY ( pd <* USEDIN( SELF, 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               ...
               <= 1 ) ) ) ) = 0 ) ) ) ) = 0 );
  END_ENTITY; -- flat_face (line:15692 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _flat_face : SDAI.PartialEntity {
...
```
*/
  public final class eFLAT_FACE : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "FLAT_FACE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eFLAT_FACE.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eFLAT_FACE.NAME, 
