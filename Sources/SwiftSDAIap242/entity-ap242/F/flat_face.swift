/* file: flat_face.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _flat_face : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eFLAT_FACE?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eFLAT_FACE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eFLAT_FACE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eFLAT_FACE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr5(SELF: eFLAT_FACE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = GET_PROPERTY_DEFINITION_REPRESENTATIONS(sCHARACTERIZED_DEFINITION(/*eFLAT_FACE*/SELF))
      let _TEMP2 = _TEMP1?.QUERY{ PDR in 
    ...
    public static func WHERE_wr6(SELF: eFLAT_FACE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.USEDIN(T: SELF, ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
        .ePROPERTY_DEFINITION.DEFINITION)
      let _TEMP2 = _TEMP1.QUERY{ PDS in 
    ...
    public static func WHERE_wr7(SELF: eFLAT_FACE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eFLAT_FACE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _flat_face.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _flat_face.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _flat_face.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _flat_face.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _flat_face.WHERE_wr5(SELF: instance)
      result[prefix2 + " .WHERE_wr6"] = _flat_face.WHERE_wr6(SELF: instance)
      result[prefix2 + " .WHERE_wr7"] = _flat_face.WHERE_wr7(SELF: instance)
      return result
    }
