/* file: functional_breakdown_context.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _functional_breakdown_context : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_functional_breakdown_context``
*/
  public final class eFUNCTIONAL_BREAKDOWN_CONTEXT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _functional_breakdown_context.self
    }
    /// partial entity reference
    public let partialEntity: _functional_breakdown_context
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_functional_breakdown_context.self) else { return nil }
