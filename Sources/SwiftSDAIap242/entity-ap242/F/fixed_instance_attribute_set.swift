/* file: fixed_instance_attribute_set.swift 	 generated: Mon Jan  3 16:32:52 2022 */
  ...
  ENTITY fixed_instance_attribute_set
    ...
    WHERE
      wr1: ( SIZEOF( QUERY ( q <* using_representations( SELF ) | ( SIZEOF( QUERY ( r <* q.items | ( 
               ...
               > 1 ) ) ) = 0 );
  END_ENTITY; -- fixed_instance_attribute_set (line:15687 file:ap242ed2_mim_lf_v1.101.TY.exp)
