/* file: fixed_element_geometric_constraint.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- fixed_element_geometric_constraint (line:15743 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	fixed_element_geometric_constraint
    REDCR: constrained_elements,	TYPE: SET [1 : ?] OF geometric_constraint_element -- EXPLICIT
      -- OVERRIDING ENTITY: explicit_constraint


  SUB- ENTITY(8)	fixed_constituent_assembly_constraint
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT/PartialEntity``
*/
  public final class eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT.PartialEntity
    ...
    public var super_eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT: eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT { return self } 	// [7]

    //MARK: SUBTYPES
    public var sub_eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT: eFIXED_CONSTITUENT_ASSEMBLY_CONSTRAINT? {	// [8]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", 
        keyPath: \eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", 
        keyPath: \eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT.REFERENCE_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "FIXED_CONSTITUENT", 
        keyPath: \eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT.FIXED_CONSTITUENT, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", 
        keyPath: \eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT.DIM, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT.self
      }
      ...
      public static func WHERE_wr1(SELF: eFIXED_ELEMENT_GEOMETRIC_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
