/* file: face_surface_with_excessive_patches_in_one_direction.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _face_surface_with_excessive_patches_in_one_direction : SDAI.PartialEntity
    ...
    public static func WHERE_wr2(SELF: eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
          EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.PRef*/
          SELF), 
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_face_surface_with_excessive_patches_in_one_direction``
*/
  public final class eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _face_surface_with_excessive_patches_in_one_direction.self
    }
    /// partial entity reference
    public let partialEntity: _face_surface_with_excessive_patches_in_one_direction
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_face_surface_with_excessive_patches_in_one_direction.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _face_surface_with_excessive_patches_in_one_direction.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _face_surface_with_excessive_patches_in_one_direction.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _face_surface_with_excessive_patches_in_one_direction.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _face_surface_with_excessive_patches_in_one_direction.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _face_surface_with_excessive_patches_in_one_direction.WHERE_wr5(SELF: instance.pRef)
      return result
    }
