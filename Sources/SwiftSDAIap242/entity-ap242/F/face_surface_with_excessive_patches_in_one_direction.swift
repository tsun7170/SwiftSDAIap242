/* file: face_surface_with_excessive_patches_in_one_direction.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- face_surface_with_excessive_patches_in_one_direction (line:15211 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	face_surface_with_excessive_patches_in_one_direction
...
- SUPERTYPES:
	...
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eOVERCOMPLEX_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION/PartialEntity``
*/
  public final class eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.PartialEntity
    ...
    public var super_eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION: eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "FACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION", 
      ...
      entityDef.add(supertype: eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.self
      }
      ...
      public static func WHERE_wr1(SELF: eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*
            eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.COUNT_MEASURE") )
        return _TEMP1
      }
      public static func WHERE_wr3(SELF: eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
      ...
      public static func WHERE_wr4(SELF: eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
      ...
      public static func WHERE_wr5(SELF: eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.AGGREGATE<runtime> */ = SDAI.BAG<SDAI.STRING>(SDAI.EMPTY_AGGREGATE)
