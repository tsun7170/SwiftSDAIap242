/* file: face_surface_with_excessive_patches_in_one_direction.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- face_surface_with_excessive_patches_in_one_direction (line:15133 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "FACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.NAME, 
