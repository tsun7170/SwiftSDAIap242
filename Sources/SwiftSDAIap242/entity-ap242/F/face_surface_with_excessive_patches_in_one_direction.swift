/* file: face_surface_with_excessive_patches_in_one_direction.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
