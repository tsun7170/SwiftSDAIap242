/* file: feature_pattern.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _feature_pattern : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eFEATURE_PATTERN?) -> SDAI.LOGICAL {
          ...
          let _TEMP2 = _TEMP1.QUERY{ PDR in 
              ...
              let _TEMP4 = /*runtime*/SDAI.FORCE_OPTIONAL(_TEMP3)?
                .QUERY{ SRWP_I in 
                  ...
                  let _TEMP1 = SDAI.TYPEOF(SRWP_I, IS: ePLACEMENT.self)
                  let _TEMP2 =  !_TEMP1
                  return _TEMP2 }
    ...
    public static func WHERE_wr2(SELF: eFEATURE_PATTERN?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eFEATURE_PATTERN : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _feature_pattern.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _feature_pattern.WHERE_wr2(SELF: instance)
      return result
    }
