/* file: feature_for_datum_target_relationship.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _feature_for_datum_target_relationship : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _related_shape_aspect: eDATUM_TARGET	//EXPLICIT REDEFINITION(eSHAPE_ASPECT_RELATIONSHIP) */
    ...
    public static func WHERE_wr1(SELF: eFEATURE_FOR_DATUM_TARGET_RELATIONSHIP?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.RELATING_SHAPE_ASPECT.OF_SHAPE
      let _TEMP2 = SELF.RELATED_SHAPE_ASPECT.OF_SHAPE
      let _TEMP3 = SDAI.FORCE_OPTIONAL(_TEMP1) .===. SDAI.FORCE_OPTIONAL(_TEMP2)
      return _TEMP3
    }
    public static func WHERE_wr2(SELF: eFEATURE_FOR_DATUM_TARGET_RELATIONSHIP?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.RELATING_SHAPE_ASPECT.GROUP_REF(eSHAPE_ASPECT.self)
    ...
    public static func UNIQUE_ur1(SELF: SDAI.EntityReference) -> AnyHashable? {
      guard let SELF = SELF as? eFEATURE_FOR_DATUM_TARGET_RELATIONSHIP else { return nil }
      //SIMPLE UNIQUE RULE

      let attr = SELF.RELATED_SHAPE_ASPECT
...
```
*/
  public final class eFEATURE_FOR_DATUM_TARGET_RELATIONSHIP : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var RELATED_SHAPE_ASPECT: eDATUM_TARGET {
      get {
        return SDAI.UNWRAP( eDATUM_TARGET( super_eSHAPE_ASPECT_RELATIONSHIP.partialEntity
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _feature_for_datum_target_relationship.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _feature_for_datum_target_relationship.WHERE_wr2(SELF: instance)
      return result
    }
