/* file: feature_for_datum_target_relationship.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- feature_for_datum_target_relationship (line:15276 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _feature_for_datum_target_relationship : SDAI.PartialEntity {
...
```
*/
  public final class eFEATURE_FOR_DATUM_TARGET_RELATIONSHIP : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eFEATURE_FOR_DATUM_TARGET_RELATIONSHIP`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "FEATURE_FOR_DATUM_TARGET_RELATIONSHIP", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eFEATURE_FOR_DATUM_TARGET_RELATIONSHIP.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ID", keyPath: \eFEATURE_FOR_DATUM_TARGET_RELATIONSHIP.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATED_SHAPE_ASPECT", keyPath: \eFEATURE_FOR_DATUM_TARGET_RELATIONSHIP.RELATED_SHAPE_ASPECT, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eFEATURE_FOR_DATUM_TARGET_RELATIONSHIP.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATING_SHAPE_ASPECT", keyPath: \eFEATURE_FOR_DATUM_TARGET_RELATIONSHIP.RELATING_SHAPE_ASPECT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)

      //MARK: UNIQUENESS RULE REGISTRATIONS
      entityDef.addUniqunessRule(label:"UNIQUE_ur1", rule: _feature_for_datum_target_relationship.UNIQUE_ur1)
