/* file: variational_representation.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- variational_representation (line:33462 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _variational_representation : SDAI.PartialEntity {
    ...
    internal private(set) weak var _cm_link: eVARIATIONAL_CURRENT_REPRESENTATION_RELATIONSHIP?
    /// INVERSE SIMPLE ATTR SUPPORT(ADDER)
    internal func _cm_link__observeAddedReference(in complex: SDAI.ComplexEntity) {
      guard let newSource = complex.entityReference(eVARIATIONAL_CURRENT_REPRESENTATION_RELATIONSHIP.self) else { return }
      self._cm_link = newSource
    }
    /// INVERSE SIMPLE ATTR SUPPORT(REMOVER)
    internal func _cm_link__observeRemovedReference(in complex: SDAI.ComplexEntity) {
      guard let _ = complex.entityReference(eVARIATIONAL_CURRENT_REPRESENTATION_RELATIONSHIP.self) else { return }
      self._cm_link = nil
    }
    /// INVERSE SIMPLE ATTR SUPPORT(LEAVING REFERENCE OWNER)
    internal func _cm_link__observe(leavingReferencerOwner complex: SDAI.ComplexEntity) {
      guard let _ = complex.entityReference(eVARIATIONAL_CURRENT_REPRESENTATION_RELATIONSHIP.self) else { return }
      self._cm_link = nil
    }
    ...
    public static func WHERE_wr1(SELF: eVARIATIONAL_REPRESENTATION?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eVARIATIONAL_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.GROUP_REF(eREPRESENTATION.self)
      let _TEMP2 = _TEMP1?.ITEMS
      let _TEMP3 = SELF.CM_LINK?.REP_2
      let _TEMP4 = _TEMP3?.ITEMS
      let _TEMP5 = _TEMP2 - _TEMP4
      let _TEMP6 = _TEMP5?.QUERY{ Q in 

          let _TEMP1 = INVALIDATE_VREP_ITEM(eVARIATIONAL_REPRESENTATION_ITEM(/*eREPRESENTATION_ITEM*/Q))
...
```
*/
  public final class eVARIATIONAL_REPRESENTATION : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eVARIATIONAL_REPRESENTATION`` )
    public var CM_LINK: eVARIATIONAL_CURRENT_REPRESENTATION_RELATIONSHIP?  {
      get {
        return self.partialEntity._cm_link
      }
    }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _variational_representation.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _variational_representation.WHERE_wr2(SELF: instance)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "VARIATIONAL_REPRESENTATION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eVARIATIONAL_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CM_LINK", keyPath: \eVARIATIONAL_REPRESENTATION.CM_LINK, 
        kind: .inverse, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eVARIATIONAL_REPRESENTATION.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eVARIATIONAL_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eVARIATIONAL_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eVARIATIONAL_REPRESENTATION.NAME, 
