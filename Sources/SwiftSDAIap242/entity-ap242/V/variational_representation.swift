/* file: variational_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _variational_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //internal private(set) weak var _cm_link: eVARIATIONAL_CURRENT_REPRESENTATION_RELATIONSHIP? 	(SEE CORRESPONDING ENTITY REFERENCE DEFINITION)
...
```
*/
  public final class eVARIATIONAL_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"CM_LINK") {
        return cached.value as! eVARIATIONAL_CURRENT_REPRESENTATION_RELATIONSHIP? 
      }
