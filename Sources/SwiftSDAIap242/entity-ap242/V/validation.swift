/* file: validation.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  ENTITY validation
    SUBTYPE OF ( group );
  END_ENTITY; -- validation (line:33372 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _validation : SDAI.PartialEntity {
...
```
*/
  public final class eVALIDATION : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "VALIDATION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eVALIDATION.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ID", keyPath: \eVALIDATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eVALIDATION.NAME, 
