/* file: verification.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  ENTITY verification
    SUBTYPE OF ( group );
  END_ENTITY; -- verification (line:33672 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _verification : SDAI.PartialEntity {
...
```
*/
  public final class eVERIFICATION : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "VERIFICATION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eVERIFICATION.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ID", keyPath: \eVERIFICATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eVERIFICATION.NAME, 
