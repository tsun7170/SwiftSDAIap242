/* file: view_volume.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _view_volume : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eVIEW_VOLUME.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP2 /* _representation_item */ = _representation_item( NAME: SDAI.UNWRAP(tLABEL(" ")) )
      let _TEMP3 /* _geometric_representation_item */ = _geometric_representation_item(  )
      let _TEMP4 /* SDAI.GENERIC_ENTITY */ = _TEMP2 .||. _TEMP3
      let _TEMP5 /* SDAI.AGGREGATE<SDAI.REAL> */ = SDAI.LIST<SDAI.REAL>(bound1: SDAI.UNWRAP(SDAI.INTEGER(2)), 
      ...
      let _TEMP6 /* _direction */ = _direction( DIRECTION_RATIOS: SDAI.UNWRAP(_TEMP5) )
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_view_volume``
*/
  public final class eVIEW_VOLUME : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _view_volume.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _view_volume.WHERE_wr2(SELF: instance.pRef)
      return result
    }
