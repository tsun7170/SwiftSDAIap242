/* file: volume_unit.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- volume_unit (line:33808 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _volume_unit : SDAI.PartialEntity {
...
```
*/
  public final class eVOLUME_UNIT : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "VOLUME_UNIT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ELEMENTS", keyPath: \eVOLUME_UNIT.ELEMENTS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eVOLUME_UNIT.NAME, 
