/* file: visual_appearance_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _visual_appearance_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eVISUAL_APPEARANCE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.ITEMS
      let _TEMP2 = SDAI.SIZEOF(_TEMP1)
      let _TEMP3 = SDAI.FORCE_OPTIONAL(SDAI.INTEGER(3)) <= _TEMP2
      let _TEMP4 = SELF.ITEMS
      let _TEMP5 = SDAI.SIZEOF(_TEMP4)
      let _TEMP6 = _TEMP5 <= SDAI.FORCE_OPTIONAL(SDAI.INTEGER(9))
      let _TEMP7 = _TEMP3 && _TEMP6
      let _TEMP8 = SELF.ITEMS.QUERY{ I in 

          let _TEMP1 = SDAI.TYPEOF(I, IS: eDESCRIPTIVE_REPRESENTATION_ITEM.self)
          let _TEMP2 = I.NAME
          let _TEMP3 = ([SDAI.AIE(SDAI.STRING("colour id")), 
      ...
      let _TEMP10 = SELF.ITEMS.QUERY{ I in 
          ...
          let _TEMP6 = I.NAME
          let _TEMP7 = ([SDAI.AIE(SDAI.STRING("refraction index")), 
            SDAI.AIE(SDAI.STRING("opacity"))] as [SDAI.AggregationInitializerElement<SDAI.STRING>])
          let _TEMP8 = SDAI.aggregate(_TEMP7, contains: SDAI.STRING(/*tLABEL*/_TEMP6))
          let _TEMP9 = _TEMP5 && _TEMP8
          return _TEMP9 }
      let _TEMP11 = SDAI.SIZEOF(_TEMP10)
      let _TEMP12 = _TEMP9 + _TEMP11
      let _TEMP13 = SELF.ITEMS.QUERY{ I in 

          let _TEMP1 = SDAI.TYPEOF(I, IS: eDOCUMENT_FILE.self)
          let _TEMP2 = I.NAME
          let _TEMP3 = ([SDAI.AIE(SDAI.STRING("texture map"))] as [SDAI.AggregationInitializerElement<SDAI.STRING>])
          let _TEMP4 = SDAI.aggregate(_TEMP3, contains: SDAI.STRING(/*tLABEL*/_TEMP2))
          let _TEMP5 = _TEMP1 && _TEMP4
          return _TEMP5 }
      let _TEMP14 = SDAI.SIZEOF(_TEMP13)
      let _TEMP15 = _TEMP12 + _TEMP14
      let _TEMP16 = SELF.ITEMS
      let _TEMP17 = SDAI.SIZEOF(_TEMP16)
      let _TEMP18 = _TEMP15 .==. _TEMP17
      let _TEMP19 = _TEMP7 && _TEMP18
      return _TEMP19
    }
    public static func WHERE_wr2(SELF: eVISUAL_APPEARANCE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP2 = _TEMP1.QUERY{ I in 
          ...
          let _TEMP1 = I.NAME
          let _TEMP2 = SDAI.FORCE_OPTIONAL(_TEMP1) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("colour id"))
          return _TEMP2 }
      let _TEMP3 = SDAI.SIZEOF(_TEMP2)
      let _TEMP4 = _TEMP3 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
      return _TEMP4
    }
    public static func WHERE_wr3(SELF: eVISUAL_APPEARANCE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP2 = _TEMP1.QUERY{ I in 
          ...
          let _TEMP1 = I.NAME
          let _TEMP2 = SDAI.FORCE_OPTIONAL(_TEMP1) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("lustre"))
          return _TEMP2 }
      let _TEMP3 = SDAI.SIZEOF(_TEMP2)
      let _TEMP4 = _TEMP3 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
      return _TEMP4
    }
    public static func WHERE_wr4(SELF: eVISUAL_APPEARANCE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP2 = _TEMP1.QUERY{ I in 
          ...
          let _TEMP1 = I.NAME
          let _TEMP2 = SDAI.FORCE_OPTIONAL(_TEMP1) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("colour name"))
          return _TEMP2 }
      let _TEMP3 = SDAI.SIZEOF(_TEMP2)
      let _TEMP4 = _TEMP3 <= SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
      return _TEMP4
    }
    public static func WHERE_wr5(SELF: eVISUAL_APPEARANCE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP2 = _TEMP1.QUERY{ I in 
          ...
          let _TEMP1 = I.NAME
          let _TEMP2 = SDAI.FORCE_OPTIONAL(_TEMP1) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("pattern"))
          return _TEMP2 }
      let _TEMP3 = SDAI.SIZEOF(_TEMP2)
      let _TEMP4 = _TEMP3 <= SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
      return _TEMP4
    }
    public static func WHERE_wr6(SELF: eVISUAL_APPEARANCE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP2 = _TEMP1.QUERY{ I in 
          ...
          let _TEMP1 = I.NAME
          let _TEMP2 = SDAI.FORCE_OPTIONAL(_TEMP1) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("transparency"))
          return _TEMP2 }
      let _TEMP3 = SDAI.SIZEOF(_TEMP2)
      let _TEMP4 = _TEMP3 <= SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
      return _TEMP4
    }
    public static func WHERE_wr7(SELF: eVISUAL_APPEARANCE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP2 = _TEMP1.QUERY{ I in 
          ...
          let _TEMP1 = I.NAME
          let _TEMP2 = SDAI.FORCE_OPTIONAL(_TEMP1) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("texture map"))
          return _TEMP2 }
      let _TEMP3 = SDAI.SIZEOF(_TEMP2)
      let _TEMP4 = _TEMP3 <= SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
      return _TEMP4
    }
    public static func WHERE_wr8(SELF: eVISUAL_APPEARANCE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP2 = _TEMP1.QUERY{ I in 
          ...
          let _TEMP1 = I.NAME
          let _TEMP2 = SDAI.FORCE_OPTIONAL(_TEMP1) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("refraction index"))
          return _TEMP2 }
      let _TEMP3 = SDAI.SIZEOF(_TEMP2)
      let _TEMP4 = _TEMP3 <= SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
      return _TEMP4
    }
    public static func WHERE_wr9(SELF: eVISUAL_APPEARANCE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP2 = _TEMP1.QUERY{ I in 
          ...
          let _TEMP1 = I.NAME
          let _TEMP2 = SDAI.FORCE_OPTIONAL(_TEMP1) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("opacity"))
          return _TEMP2 }
      let _TEMP3 = SDAI.SIZEOF(_TEMP2)
      let _TEMP4 = _TEMP3 <= SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
      return _TEMP4
    }
    public static func WHERE_wr10(SELF: eVISUAL_APPEARANCE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr11(SELF: eVISUAL_APPEARANCE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eVISUAL_APPEARANCE_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _visual_appearance_representation.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _visual_appearance_representation.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _visual_appearance_representation.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _visual_appearance_representation.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _visual_appearance_representation.WHERE_wr5(SELF: instance)
      result[prefix2 + " .WHERE_wr6"] = _visual_appearance_representation.WHERE_wr6(SELF: instance)
      result[prefix2 + " .WHERE_wr7"] = _visual_appearance_representation.WHERE_wr7(SELF: instance)
      result[prefix2 + " .WHERE_wr8"] = _visual_appearance_representation.WHERE_wr8(SELF: instance)
      result[prefix2 + " .WHERE_wr9"] = _visual_appearance_representation.WHERE_wr9(SELF: instance)
      result[prefix2 + " .WHERE_wr10"] = _visual_appearance_representation.WHERE_wr10(SELF: instance)
      result[prefix2 + " .WHERE_wr11"] = _visual_appearance_representation.WHERE_wr11(SELF: instance)
      return result
    }
