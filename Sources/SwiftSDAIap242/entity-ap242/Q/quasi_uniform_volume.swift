/* file: quasi_uniform_volume.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- quasi_uniform_volume (line:26720 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _quasi_uniform_volume : SDAI.PartialEntity {
...
```
*/
  public final class eQUASI_UNIFORM_VOLUME : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "QUASI_UNIFORM_VOLUME", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "CONTROL_POINTS_LIST", keyPath: \eQUASI_UNIFORM_VOLUME.CONTROL_POINTS_LIST, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "V_DEGREE", keyPath: \eQUASI_UNIFORM_VOLUME.V_DEGREE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "V_UPPER", keyPath: \eQUASI_UNIFORM_VOLUME.V_UPPER, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "W_UPPER", keyPath: \eQUASI_UNIFORM_VOLUME.W_UPPER, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "W_DEGREE", keyPath: \eQUASI_UNIFORM_VOLUME.W_DEGREE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTROL_POINTS", keyPath: \eQUASI_UNIFORM_VOLUME.CONTROL_POINTS, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "U_DEGREE", keyPath: \eQUASI_UNIFORM_VOLUME.U_DEGREE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "U_UPPER", keyPath: \eQUASI_UNIFORM_VOLUME.U_UPPER, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eQUASI_UNIFORM_VOLUME.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", keyPath: \eQUASI_UNIFORM_VOLUME.DIM, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
