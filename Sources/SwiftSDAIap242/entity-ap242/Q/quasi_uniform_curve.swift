/* file: quasi_uniform_curve.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- quasi_uniform_curve (line:26712 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _quasi_uniform_curve : SDAI.PartialEntity {
...
```
*/
  public final class eQUASI_UNIFORM_CURVE : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "QUASI_UNIFORM_CURVE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "CURVE_FORM", keyPath: \eQUASI_UNIFORM_CURVE.CURVE_FORM, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTROL_POINTS_LIST", keyPath: \eQUASI_UNIFORM_CURVE.CONTROL_POINTS_LIST, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DEGREE", keyPath: \eQUASI_UNIFORM_CURVE.DEGREE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "UPPER_INDEX_ON_CONTROL_POINTS", keyPath: \eQUASI_UNIFORM_CURVE.UPPER_INDEX_ON_CONTROL_POINTS, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "SELF_INTERSECT", keyPath: \eQUASI_UNIFORM_CURVE.SELF_INTERSECT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTROL_POINTS", keyPath: \eQUASI_UNIFORM_CURVE.CONTROL_POINTS, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CLOSED_CURVE", keyPath: \eQUASI_UNIFORM_CURVE.CLOSED_CURVE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eQUASI_UNIFORM_CURVE.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", keyPath: \eQUASI_UNIFORM_CURVE.DIM, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
