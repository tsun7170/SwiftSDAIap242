/* file: quasi_uniform_surface.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- quasi_uniform_surface (line:26730 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _quasi_uniform_surface : SDAI.PartialEntity {
...
```
*/
  public final class eQUASI_UNIFORM_SURFACE : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "QUASI_UNIFORM_SURFACE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "CONTROL_POINTS_LIST", keyPath: \eQUASI_UNIFORM_SURFACE.CONTROL_POINTS_LIST, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "V_DEGREE", keyPath: \eQUASI_UNIFORM_SURFACE.V_DEGREE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "V_UPPER", keyPath: \eQUASI_UNIFORM_SURFACE.V_UPPER, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "V_CLOSED", keyPath: \eQUASI_UNIFORM_SURFACE.V_CLOSED, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "SURFACE_FORM", keyPath: \eQUASI_UNIFORM_SURFACE.SURFACE_FORM, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "U_CLOSED", keyPath: \eQUASI_UNIFORM_SURFACE.U_CLOSED, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "SELF_INTERSECT", keyPath: \eQUASI_UNIFORM_SURFACE.SELF_INTERSECT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTROL_POINTS", keyPath: \eQUASI_UNIFORM_SURFACE.CONTROL_POINTS, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "U_DEGREE", keyPath: \eQUASI_UNIFORM_SURFACE.U_DEGREE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "U_UPPER", keyPath: \eQUASI_UNIFORM_SURFACE.U_UPPER, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eQUASI_UNIFORM_SURFACE.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", keyPath: \eQUASI_UNIFORM_SURFACE.DIM, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
