/* file: g2_discontinuity_between_adjacent_faces.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- g2_discontinuity_between_adjacent_faces (line:16185 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(7)	non_smooth_geometry_transition_across_edge
    (no local attributes)

  ENTITY(SELF)	g2_discontinuity_between_adjacent_faces
...
- SUPERTYPES:
	...
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINAPT_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP``
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES/PartialEntity``
*/
  public final class eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity
    ...
    public let super_eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE: eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE 	// [7]
    public var super_eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES: eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity.self) else { return nil }
      ...
      guard let super7 = complexEntity?.entityReference(eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE.self) else { return nil }
      self.super_eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE = super7
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      result[prefix + " .WHERE_wr6"] = eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr6(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "G2_DISCONTINUITY_BETWEEN_ADJACENT_FACES", 
      ...
      entityDef.add(supertype: eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE.self)
      entityDef.add(supertype: eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "FLAT_CURVATURE_RADIUS_TOLERANCE", 
        keyPath: \eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.FLAT_CURVATURE_RADIUS_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION_2", 
        keyPath: \eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.ASSESSMENT_SPECIFICATION_2, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.self
      }
      ...
      public static func WHERE_wr1(SELF: eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr3(SELF: eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING(
            "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PLANE_ANGLE_AND_RATIO_PAIR") )
        return _TEMP1
      }
      public static func WHERE_wr4(SELF: eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
            SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.CONNECTED_FACE_SET")) ] 
      ...
      public static func WHERE_wr5(SELF: eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
            SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.POINT_ON_EDGE_CURVE")) ] 
            as [SDAI.AggregationInitializerElement<SDAI.STRING>]) )
      ...
      public static func WHERE_wr6(SELF: eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public init(
        ASSESSMENT_SPECIFICATION_2: eSHAPE_DATA_QUALITY_ASSESSMENT_BY_NUMERICAL_TEST.PRef, 
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( ASSESSMENT_SPECIFICATION_2: original._assessment_specification_2, FLAT_CURVATURE_RADIUS_TOLERANCE: original._flat_curvature_radius_tolerance )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [1]FLAT_CURVATURE_RADIUS_TOLERANCE for partial entity(\(Self.entityName)) constructor"); return nil }
