/* file: g2_discontinuity_between_adjacent_faces.swift 	 generated: Tue Jan 20 19:20:51 2026 */
...
*/
  public final class eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr6"] = eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr6(SELF: instance.pRef)
      return result
    }
