/* file: g2_discontinuity_between_adjacent_faces.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- g2_discontinuity_between_adjacent_faces (line:16107 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _g2_discontinuity_between_adjacent_faces : SDAI.PartialEntity {
...
```
*/
  public final class eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "G2_DISCONTINUITY_BETWEEN_ADJACENT_FACES", type: self, explicitAttributeCount: 2)
      ...
      entityDef.addAttribute(name: "FLAT_CURVATURE_RADIUS_TOLERANCE", keyPath: \eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.FLAT_CURVATURE_RADIUS_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION_2", keyPath: \eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.ASSESSMENT_SPECIFICATION_2, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES.NAME, 
