/* file: group.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  ENTITY group
    ...
    WHERE
      wr1: ( SIZEOF( USEDIN( SELF, 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ID_ATTRIBUTE.'
               + 'IDENTIFIED_ITEM'  ) ) <= 1 );
  END_ENTITY; -- group (line:17526 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMATING_MATERIAL``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREQUIREMENT_SOURCE``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_GROUP_RULES``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCHANGE_GROUP``
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREP_ITEM_GROUP``
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_GROUP_ATTRIBUTES``
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eVALIDATION``
	8.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDELETE_ELEMENT``
	9.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eADD_ELEMENT``
	10.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMODIFY_ELEMENT``
	11.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCHANGE_ELEMENT``
	12.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCHARACTERIZED_CLASS``
	13.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCLASS_BY_INTENSION``
	14.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCLASS_BY_EXTENSION``
	15.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTERNALLY_DEFINED_CLASS``
	16.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCLASS``
	17.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANALYSIS_ASSIGNMENT``
	18.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMATED_PART_RELATIONSHIP``
	19.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_GROUP``
	20.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eHIERARCHICAL_INTERFACE_CONNECTION``
	21.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACE_CONNECTION``
	22.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eIN_ZONE``
	23.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCHARACTERISTIC_TYPE``
	24.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eVERIFICATION``
	25.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDOCUMENT_IDENTIFIER``
	26.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSATISFIES_REQUIREMENT``
	27.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCLASS_SYSTEM``
	28.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLANGUAGE``
	29.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXCLUSIVE_PRODUCT_CONCEPT_FEATURE_CATEGORY``
	30.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY``
	31.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_CONCEPT_FEATURE_CATEGORY``
	32.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBREAKDOWN_ELEMENT_REALIZATION``
	33.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_ELEMENT_RELATIONSHIP``
	34.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMESSAGE_CONTENTS_GROUP``
	35.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACE_CONNECTOR_OCCURRENCE``
	36.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREQUIREMENT_ASSIGNMENT``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGROUP/PartialEntity``
*/
  public final class eGROUP : SDAI.EntityReference, SDAI.DualModeReference, SDAI.SimpleEntityType, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eGROUP>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eGROUP.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eGROUP.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGROUP`` )
    ...
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMATING_MATERIAL`` )
    public var DEFINITION: ePRODUCT_DEFINITION_USAGE_RELATIONSHIP.PRef?  {
      get {
        if let resolved = ePROPERTY_DEFINITION.PartialEntity._definition__provider(complex: self.complexEntity) {
          ...
          let value = ePRODUCT_DEFINITION_USAGE_RELATIONSHIP.PRef( originalValue )
          return value
        }
        else {
          let originalValue = sub_eMATING_MATERIAL?
            .super_ePROPERTY_DEFINITION.partialEntity._definition
          let value = ePRODUCT_DEFINITION_USAGE_RELATIONSHIP.PRef( originalValue )
          return value
        }
      }
      set(newValue) {
        ...
        guard let partial = 
          sub_eMATING_MATERIAL?
          .super_ePROPERTY_DEFINITION.partialEntity
          else { return }
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eGROUP.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eGROUP.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "ASSIGNED_GROUP", 
        keyPath: \eGROUP.ASSIGNED_GROUP, 
        kind: .derivedRedeclaring, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DEFINITION", 
        keyPath: \eGROUP.DEFINITION, 
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      /// DERIVE ATTRIBUTE
      @_documentation(visibility:public)
      internal func _id__getter(SELF: eGROUP.PRef) -> tIDENTIFIER?  {

        let _TEMP1 /* tIDENTIFIER? */ = GET_ID_VALUE( sID_ATTRIBUTE_SELECT(/*eGROUP.PRef*/SELF) )
        return _TEMP1
      }
      ...
      public static func WHERE_wr1(SELF: eGROUP.PRef?) -> SDAI.LOGICAL {
