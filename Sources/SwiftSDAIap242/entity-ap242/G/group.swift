/* file: group.swift 	 generated: Tue Jan 20 19:20:51 2026 */
...
*/
  public final class eGROUP : SDAI.EntityReference, SDAI.DualModeReference, SDAI.SimpleEntityType, 
    ...
    public var DEFINITION: ePRODUCT_DEFINITION_USAGE_RELATIONSHIP.PRef?  {
      get {
        if let resolved = ePROPERTY_DEFINITION.PartialEntity._definition__provider(complex: self.complexEntity) {
          let value = ePRODUCT_DEFINITION_USAGE_RELATIONSHIP.PRef(resolved._definition__getter(
            complex: self.complexEntity))
          return value
        }
        else {
          return ePRODUCT_DEFINITION_USAGE_RELATIONSHIP.PRef(sub_eMATING_MATERIAL?.super_ePROPERTY_DEFINITION
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eGROUP.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
