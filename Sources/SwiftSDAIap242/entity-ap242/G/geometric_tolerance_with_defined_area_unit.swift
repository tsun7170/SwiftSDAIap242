/* file: geometric_tolerance_with_defined_area_unit.swift 	 generated: Sun Oct 31 15:32:10 2021 */
  ...
  ENTITY geometric_tolerance_with_defined_area_unit
    ...
    WHERE
      ...
      wr5: ( ( NOT ( area_type = area_unit_type.spherical ) ) OR ( SIZEOF( QUERY ( tz <* USEDIN( SELF, 
               ...
               <> 0 ) );
  END_ENTITY; -- geometric_tolerance_with_defined_area_unit (line:16981 file:ap242ed2_mim_lf_v1.101.TY.exp)
