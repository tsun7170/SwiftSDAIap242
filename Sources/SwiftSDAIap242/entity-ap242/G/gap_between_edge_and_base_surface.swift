/* file: gap_between_edge_and_base_surface.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- gap_between_edge_and_base_surface (line:16199 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _gap_between_edge_and_base_surface : SDAI.PartialEntity {
...
```
*/
  public final class eGAP_BETWEEN_EDGE_AND_BASE_SURFACE : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eGAP_BETWEEN_EDGE_AND_BASE_SURFACE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "GAP_BETWEEN_EDGE_AND_BASE_SURFACE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eGAP_BETWEEN_EDGE_AND_BASE_SURFACE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eGAP_BETWEEN_EDGE_AND_BASE_SURFACE.NAME, 
