/* file: gap_between_vertex_and_edge.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _gap_between_vertex_and_edge : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_gap_between_vertex_and_edge``
*/
  public final class eGAP_BETWEEN_VERTEX_AND_EDGE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _gap_between_vertex_and_edge.self
    }
    /// partial entity reference
    public let partialEntity: _gap_between_vertex_and_edge
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_gap_between_vertex_and_edge.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _gap_between_vertex_and_edge.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _gap_between_vertex_and_edge.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _gap_between_vertex_and_edge.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _gap_between_vertex_and_edge.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _gap_between_vertex_and_edge.WHERE_wr5(SELF: instance.pRef)
      return result
    }
