/* file: gap_between_vertex_and_edge.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  ENTITY gap_between_vertex_and_edge
    ...
    WHERE
      ...
      wr4: validate_locations_of_extreme_value_type( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               + 'VERTEX_POINT' , 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.POINT_ON_EDGE_CURVE'] );
      wr5: validate_accuracy_types( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.LENGTH_MEASURE'] );
  END_ENTITY; -- gap_between_vertex_and_edge (line:16326 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	gap_between_vertex_and_edge
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGAP_BETWEEN_VERTEX_AND_EDGE/PartialEntity``
*/
  public final class eGAP_BETWEEN_VERTEX_AND_EDGE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eGAP_BETWEEN_VERTEX_AND_EDGE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eGAP_BETWEEN_VERTEX_AND_EDGE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eGAP_BETWEEN_VERTEX_AND_EDGE.PartialEntity
    ...
    public var super_eGAP_BETWEEN_VERTEX_AND_EDGE: eGAP_BETWEEN_VERTEX_AND_EDGE { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGAP_BETWEEN_VERTEX_AND_EDGE`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eGAP_BETWEEN_VERTEX_AND_EDGE.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eGAP_BETWEEN_VERTEX_AND_EDGE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eGAP_BETWEEN_VERTEX_AND_EDGE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eGAP_BETWEEN_VERTEX_AND_EDGE.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eGAP_BETWEEN_VERTEX_AND_EDGE.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = eGAP_BETWEEN_VERTEX_AND_EDGE.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "GAP_BETWEEN_VERTEX_AND_EDGE", 
      ...
      entityDef.add(supertype: eGAP_BETWEEN_VERTEX_AND_EDGE.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eGAP_BETWEEN_VERTEX_AND_EDGE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eGAP_BETWEEN_VERTEX_AND_EDGE.NAME, 
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: eGAP_BETWEEN_VERTEX_AND_EDGE.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eGAP_BETWEEN_VERTEX_AND_EDGE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eGAP_BETWEEN_VERTEX_AND_EDGE.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.LENGTH_MEASURE") )
        return _TEMP1
      }
      public static func WHERE_wr3(SELF: eGAP_BETWEEN_VERTEX_AND_EDGE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr4(SELF: eGAP_BETWEEN_VERTEX_AND_EDGE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr5(SELF: eGAP_BETWEEN_VERTEX_AND_EDGE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
