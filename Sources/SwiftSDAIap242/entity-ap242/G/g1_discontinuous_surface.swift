/* file: g1_discontinuous_surface.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY g1_discontinuous_surface
    ...
    WHERE
      ...
      wr5: validate_accuracy_types( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               + 'PLANE_ANGLE_MEASURE' ] );
  END_ENTITY; -- g1_discontinuous_surface (line:16106 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _g1_discontinuous_surface : SDAI.PartialEntity {
...
```
*/
  public final class eG1_DISCONTINUOUS_SURFACE : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eG1_DISCONTINUOUS_SURFACE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "G1_DISCONTINUOUS_SURFACE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eG1_DISCONTINUOUS_SURFACE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eG1_DISCONTINUOUS_SURFACE.NAME, 
