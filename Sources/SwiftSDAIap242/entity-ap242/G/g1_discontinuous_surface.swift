/* file: g1_discontinuous_surface.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _g1_discontinuous_surface : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_g1_discontinuous_surface``
*/
  public final class eG1_DISCONTINUOUS_SURFACE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _g1_discontinuous_surface.self
    }
    /// partial entity reference
    public let partialEntity: _g1_discontinuous_surface
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_g1_discontinuous_surface.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _g1_discontinuous_surface.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _g1_discontinuous_surface.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _g1_discontinuous_surface.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _g1_discontinuous_surface.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _g1_discontinuous_surface.WHERE_wr5(SELF: instance.pRef)
      return result
    }
