/* file: gap_between_vertex_and_base_surface.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eGAP_BETWEEN_VERTEX_AND_BASE_SURFACE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eGAP_BETWEEN_VERTEX_AND_BASE_SURFACE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eGAP_BETWEEN_VERTEX_AND_BASE_SURFACE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eGAP_BETWEEN_VERTEX_AND_BASE_SURFACE.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eGAP_BETWEEN_VERTEX_AND_BASE_SURFACE.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = eGAP_BETWEEN_VERTEX_AND_BASE_SURFACE.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
