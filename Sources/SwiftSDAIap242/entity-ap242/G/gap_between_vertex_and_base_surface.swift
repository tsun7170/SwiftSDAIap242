/* file: gap_between_vertex_and_base_surface.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _gap_between_vertex_and_base_surface : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eGAP_BETWEEN_VERTEX_AND_BASE_SURFACE?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eGAP_BETWEEN_VERTEX_AND_BASE_SURFACE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = VALIDATE_MEASURED_DATA_TYPE(
        EI: eSHAPE_DATA_QUALITY_CRITERION(/*eGAP_BETWEEN_VERTEX_AND_BASE_SURFACE*/SELF), 
        TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.LENGTH_MEASURE"))
      return _TEMP1
    }
    public static func WHERE_wr3(SELF: eGAP_BETWEEN_VERTEX_AND_BASE_SURFACE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eGAP_BETWEEN_VERTEX_AND_BASE_SURFACE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr5(SELF: eGAP_BETWEEN_VERTEX_AND_BASE_SURFACE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eGAP_BETWEEN_VERTEX_AND_BASE_SURFACE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _gap_between_vertex_and_base_surface.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _gap_between_vertex_and_base_surface.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _gap_between_vertex_and_base_surface.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _gap_between_vertex_and_base_surface.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _gap_between_vertex_and_base_surface.WHERE_wr5(SELF: instance)
      return result
    }
