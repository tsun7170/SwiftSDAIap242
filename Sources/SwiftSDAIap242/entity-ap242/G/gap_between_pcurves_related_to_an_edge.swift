/* file: gap_between_pcurves_related_to_an_edge.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- gap_between_pcurves_related_to_an_edge (line:16216 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _gap_between_pcurves_related_to_an_edge : SDAI.PartialEntity {
...
```
*/
  public final class eGAP_BETWEEN_PCURVES_RELATED_TO_AN_EDGE : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eGAP_BETWEEN_PCURVES_RELATED_TO_AN_EDGE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "GAP_BETWEEN_PCURVES_RELATED_TO_AN_EDGE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eGAP_BETWEEN_PCURVES_RELATED_TO_AN_EDGE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eGAP_BETWEEN_PCURVES_RELATED_TO_AN_EDGE.NAME, 
