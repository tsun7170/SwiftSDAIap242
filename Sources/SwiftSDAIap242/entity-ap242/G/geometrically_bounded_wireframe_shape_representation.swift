/* file: geometrically_bounded_wireframe_shape_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _geometrically_bounded_wireframe_shape_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eGEOMETRICALLY_BOUNDED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.ITEMS
      let _TEMP2 = _TEMP1.QUERY{ IT in 

          let _TEMP1 = SDAI.TYPEOF(IT)
    ...
    public static func WHERE_wr2(SELF: eGEOMETRICALLY_BOUNDED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eGEOMETRICALLY_BOUNDED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.ITEMS
      let _TEMP2 = _TEMP1.QUERY{ IT in 

          let _TEMP1 = SDAI.TYPEOF(IT, IS: eGEOMETRIC_CURVE_SET.self)
          return _TEMP1 }
      let _TEMP3 = _TEMP2.QUERY{ GCS in 
          ...
          let _TEMP4 = _TEMP3?.QUERY{ CRV in 
              ...
              let _TEMP1 = VALID_GEOMETRICALLY_BOUNDED_WF_CURVE(eCURVE(/*sGEOMETRIC_SET_SELECT*/CRV))
              let _TEMP2 =  !_TEMP1
              return _TEMP2 }
    ...
    public static func WHERE_wr4(SELF: eGEOMETRICALLY_BOUNDED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ GCS in 
          ...
          let _TEMP3 = _TEMP2?.QUERY{ ELEM in 
              ...
              return _TEMP1 }
          let _TEMP4 = _TEMP3?.QUERY{ PNTS in 

              let _TEMP1 = VALID_GEOMETRICALLY_BOUNDED_WF_POINT(ePOINT(/*sGEOMETRIC_SET_SELECT*/PNTS))
              let _TEMP2 =  !_TEMP1
              return _TEMP2 }
          let _TEMP5 = SDAI.SIZEOF(_TEMP4)
          let _TEMP6 = _TEMP5 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(0))
    ...
    public static func WHERE_wr5(SELF: eGEOMETRICALLY_BOUNDED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ GCS in 
          ...
          let _TEMP3 = _TEMP2?.QUERY{ ELEM in 
              ...
              let _TEMP1 = SDAI.TYPEOF(ELEM, IS: eCONIC.self)
              return _TEMP1 }
          let _TEMP4 = _TEMP3?.QUERY{ CNC in 

              let _TEMP1 = SDAI.TYPEOF(CNC.GROUP_REF(eCONIC.self)?.POSITION, IS: eAXIS2_PLACEMENT_3D.self)
              let _TEMP2 =  !_TEMP1
              return _TEMP2 }
          let _TEMP5 = SDAI.SIZEOF(_TEMP4)
          let _TEMP6 = _TEMP5 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(0))
    ...
    public static func WHERE_wr6(SELF: eGEOMETRICALLY_BOUNDED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ GCS in 
          ...
          let _TEMP3 = _TEMP2?.QUERY{ ELEM in 
              ...
              let _TEMP1 = SDAI.TYPEOF(ELEM, IS: ePOLYLINE.self)
              return _TEMP1 }
          let _TEMP4 = _TEMP3?.QUERY{ PLINE in 

              let _TEMP1 = PLINE.GROUP_REF(ePOLYLINE.self)
              let _TEMP2 = _TEMP1?.POINTS
              let _TEMP3 = SDAI.SIZEOF(_TEMP2)
    ...
    public static func WHERE_wr7(SELF: eGEOMETRICALLY_BOUNDED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eGEOMETRICALLY_BOUNDED_WIREFRAME_SHAPE_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _geometrically_bounded_wireframe_shape_representation.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _geometrically_bounded_wireframe_shape_representation.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _geometrically_bounded_wireframe_shape_representation.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _geometrically_bounded_wireframe_shape_representation.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _geometrically_bounded_wireframe_shape_representation.WHERE_wr5(SELF: instance)
      result[prefix2 + " .WHERE_wr6"] = _geometrically_bounded_wireframe_shape_representation.WHERE_wr6(SELF: instance)
      result[prefix2 + " .WHERE_wr7"] = _geometrically_bounded_wireframe_shape_representation.WHERE_wr7(SELF: instance)
      return result
    }
