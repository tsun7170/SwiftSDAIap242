/* file: generic_expression.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
```
*/
  public final class eGENERIC_EXPRESSION : SDAI.EntityReference, @unchecked Sendable {
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"INTERPRETATION") {
        return cached.value as! eENVIRONMENT? 
      }
