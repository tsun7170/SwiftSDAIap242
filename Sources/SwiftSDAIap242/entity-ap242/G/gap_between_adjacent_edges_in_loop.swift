/* file: gap_between_adjacent_edges_in_loop.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- gap_between_adjacent_edges_in_loop (line:16170 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _gap_between_adjacent_edges_in_loop : SDAI.PartialEntity {
...
```
*/
  public final class eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "GAP_BETWEEN_ADJACENT_EDGES_IN_LOOP", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP.NAME, 
