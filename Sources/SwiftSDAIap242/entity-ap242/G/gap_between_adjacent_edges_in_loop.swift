/* file: gap_between_adjacent_edges_in_loop.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- gap_between_adjacent_edges_in_loop (line:16248 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	gap_between_adjacent_edges_in_loop
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP/PartialEntity``
*/
  public final class eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP.PartialEntity
    ...
    public var super_eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP: eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "GAP_BETWEEN_ADJACENT_EDGES_IN_LOOP", 
      ...
      entityDef.add(supertype: eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP.self
      }
      ...
      public static func WHERE_wr1(SELF: eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.LENGTH_MEASURE") )
        return _TEMP1
      }
      public static func WHERE_wr3(SELF: eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
      ...
      public static func WHERE_wr4(SELF: eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
      ...
      public static func WHERE_wr5(SELF: eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
