/* file: generated_finite_numeric_space.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- generated_finite_numeric_space (line:16955 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUPERTYPES:
	...
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFINITE_SPACE``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGENERATED_FINITE_NUMERIC_SPACE/PartialEntity``
*/
  public final class eGENERATED_FINITE_NUMERIC_SPACE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eGENERATED_FINITE_NUMERIC_SPACE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eGENERATED_FINITE_NUMERIC_SPACE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eGENERATED_FINITE_NUMERIC_SPACE.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGENERATED_FINITE_NUMERIC_SPACE`` )
    public var START_VALUE: tMATHS_NUMBER {
      get {
        let originalValue = self.partialEntity._start_value
        let value = SDAI.UNWRAP( tMATHS_NUMBER( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGENERATED_FINITE_NUMERIC_SPACE`` )
    public var MEMBERS: SDAI.SET<tMATHS_NUMBER>/*[2:(nil as SDAI.INTEGER?)]*/  {
      get {
        if let cached = cachedValue(derivedAttributeName:"MEMBERS") {
          return cached.value as! SDAI.SET<tMATHS_NUMBER>/*[2:(nil as SDAI.INTEGER?)]*/ 
        }
        let origin = self
        let value = SDAI.UNWRAP( origin.partialEntity._members__getter(SELF: origin.pRef) )
    ...
    public var INCREMENT_NUMBER: tPOSITIVE_INTEGER {
      get {
        let originalValue = self.partialEntity._increment_number
    ...
    public var INCREMENT_VALUE: tMATHS_NUMBER {
      get {
        let originalValue = self.partialEntity._increment_value
        let value = SDAI.UNWRAP( tMATHS_NUMBER( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eGENERATED_FINITE_NUMERIC_SPACE.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eGENERATED_FINITE_NUMERIC_SPACE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "START_VALUE", 
        keyPath: \eGENERATED_FINITE_NUMERIC_SPACE.START_VALUE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEMBERS", 
        keyPath: \eGENERATED_FINITE_NUMERIC_SPACE.MEMBERS, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "INCREMENT_NUMBER", 
        keyPath: \eGENERATED_FINITE_NUMERIC_SPACE.INCREMENT_NUMBER, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "INCREMENT_VALUE", 
        keyPath: \eGENERATED_FINITE_NUMERIC_SPACE.INCREMENT_VALUE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGENERATED_FINITE_NUMERIC_SPACE``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      @_documentation(visibility:public)
      internal func _members__getter(SELF: eGENERATED_FINITE_NUMERIC_SPACE.PRef) -> SDAI.SET<tMATHS_NUMBER>
        /*[2:(nil as SDAI.INTEGER?)]*/  {

        let _TEMP1 /* SDAI.SET<tMATHS_NUMBER>[2:(nil as SDAI.INTEGER?)] ? */ = 
            MAKE_NUMERIC_SET( 
            START: SELF.START_VALUE, 
            DELTA: SELF.INCREMENT_VALUE, 
      ...
      public static func WHERE_wr1(SELF: eGENERATED_FINITE_NUMERIC_SPACE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = SELF.INCREMENT_VALUE .!=. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(0))
        return _TEMP1
      }
      ...
      public init(
        START_VALUE: tMATHS_NUMBER, 
        INCREMENT_VALUE: tMATHS_NUMBER, 
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( START_VALUE: original._start_value, INCREMENT_VALUE: original._increment_value, INCREMENT_NUMBER: original._increment_number )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]START_VALUE for partial entity(\(Self.entityName)) constructor"); return nil }

        guard case .success(let p1) = exchangeStructure.recoverRequiredParameter(as: tMATHS_NUMBER.self, from: parameters[1])
        else { exchangeStructure.add(errorContext: "while recovering parameter [1]INCREMENT_VALUE for partial entity(\(Self.entityName)) constructor"); return nil }

        guard case .success(let p2) = exchangeStructure.recoverRequiredParameter(as: tPOSITIVE_INTEGER.self, from: parameters[2])
        else { exchangeStructure.add(errorContext: "while recovering parameter [2]INCREMENT_NUMBER for partial entity(\(Self.entityName)) constructor"); return nil }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eGENERATED_FINITE_NUMERIC_SPACE.PartialEntity :
