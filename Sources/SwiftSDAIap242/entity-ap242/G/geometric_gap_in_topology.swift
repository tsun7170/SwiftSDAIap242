/* file: geometric_gap_in_topology.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _geometric_gap_in_topology : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_geometric_gap_in_topology``
*/
  public final class eGEOMETRIC_GAP_IN_TOPOLOGY : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _geometric_gap_in_topology.self
    }
    /// partial entity reference
    public let partialEntity: _geometric_gap_in_topology
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_geometric_gap_in_topology.self) else { return nil }
