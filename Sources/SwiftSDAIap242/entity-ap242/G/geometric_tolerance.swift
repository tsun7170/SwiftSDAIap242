/* file: geometric_tolerance.swift 	 generated: Tue Oct 14 17:54:07 2025 */
...
/*
  ...
  END_ENTITY; -- geometric_tolerance (line:16917 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  public final class eGEOMETRIC_TOLERANCE : SDAI.EntityReference, SDAIDualModeReference, 
    ...
    get {
      ...
      let swiftValue = SDAI.SET<eGEOMETRIC_TOLERANCE_RELATIONSHIP.PRef>/*[0:nil]*/ .SwiftType( self.referencingEntities(for: \eGEOMETRIC_TOLERANCE_RELATIONSHIP.RELATING_GEOMETRIC_TOLERANCE) )
      let value = SDAI.SET<eGEOMETRIC_TOLERANCE_RELATIONSHIP.PRef>/*[0:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
    ...
    get {
      ...
      let swiftValue = SDAI.SET<eGEOMETRIC_TOLERANCE_AUXILIARY_CLASSIFICATION.PRef>/*[0:nil]*/ .SwiftType( self.referencingEntities(for: \eGEOMETRIC_TOLERANCE_AUXILIARY_CLASSIFICATION.DESCRIBED_ITEM) )
      let value = SDAI.SET<eGEOMETRIC_TOLERANCE_AUXILIARY_CLASSIFICATION.PRef>/*[0:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
        SDAI.INTEGER(0)), bound2: (nil as SDAI.INTEGER?))
