/* file: geometric_tolerance.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _geometric_tolerance : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //internal var _auxiliary_classification: SDAI.SET<eGEOMETRIC_TOLERANCE_AUXILIARY_CLASSIFICATION> 	(SEE CORRESPONDING ENTITY REFERENCE DEFINITION)

    // INVERSE AGGREGATE ATTRIBUTE
    // observing _geometric_tolerance_relationship ._relating_geometric_tolerance
    //internal var _tolerance_relationship: SDAI.SET<eGEOMETRIC_TOLERANCE_RELATIONSHIP> 	(SEE CORRESPONDING ENTITY REFERENCE DEFINITION)
...
```
*/
  public final class eGEOMETRIC_TOLERANCE : SDAI.EntityReference, @unchecked Sendable {
