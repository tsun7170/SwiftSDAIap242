/* file: geometric_contact.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _geometric_contact : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eGEOMETRIC_CONTACT?) -> SDAI.LOGICAL {
...
```
*/
  public final class eGEOMETRIC_CONTACT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _geometric_contact.WHERE_wr1(SELF: instance)
      return result
    }
