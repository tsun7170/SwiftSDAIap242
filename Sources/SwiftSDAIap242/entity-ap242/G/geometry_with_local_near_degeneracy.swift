/* file: geometry_with_local_near_degeneracy.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- geometry_with_local_near_degeneracy (line:17276 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _geometry_with_local_near_degeneracy : SDAI.PartialEntity {
...
```
*/
  public final class eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY : SDAI.EntityReference {
    ...
    /// - origin: SUB( ``eNARROW_SURFACE_PATCH`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "GEOMETRY_WITH_LOCAL_NEAR_DEGENERACY", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "WIDTH_TOLERANCE", keyPath: \eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY.WIDTH_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY.NAME, 
