/* file: geometry_with_local_near_degeneracy.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- geometry_with_local_near_degeneracy (line:17471 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	geometry_with_local_near_degeneracy
    (no local attributes)

  SUB- ENTITY(8)	indistinct_surface_knots
  ...
  SUB- ENTITY(9)	curve_with_small_curvature_radius
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(10)	indistinct_curve_knots
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(11)	short_length_curve_segment
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(12)	surface_with_small_curvature_radius
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(13)	small_area_surface_patch
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(14)	narrow_surface_patch
  ...
  SUB- ENTITY(15)	nearly_degenerate_surface_boundary
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(16)	nearly_degenerate_surface_patch
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINDISTINCT_SURFACE_KNOTS``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_WITH_SMALL_CURVATURE_RADIUS``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINDISTINCT_CURVE_KNOTS``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHORT_LENGTH_CURVE_SEGMENT``
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE_WITH_SMALL_CURVATURE_RADIUS``
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSMALL_AREA_SURFACE_PATCH``
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNARROW_SURFACE_PATCH``
	8.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNEARLY_DEGENERATE_SURFACE_BOUNDARY``
	9.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNEARLY_DEGENERATE_SURFACE_PATCH``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY/PartialEntity``
*/
  public final class eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY.PartialEntity
    ...
    public var super_eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY: eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY { return self } 	// [7]

    //MARK: SUBTYPES
    public var sub_eINDISTINCT_SURFACE_KNOTS: eINDISTINCT_SURFACE_KNOTS? {	// [8]
      return self.complexEntity.entityReference(eINDISTINCT_SURFACE_KNOTS.self)
    }

    public var sub_eCURVE_WITH_SMALL_CURVATURE_RADIUS: eCURVE_WITH_SMALL_CURVATURE_RADIUS? {	// [9]
      return self.complexEntity.entityReference(eCURVE_WITH_SMALL_CURVATURE_RADIUS.self)
    }

    public var sub_eINDISTINCT_CURVE_KNOTS: eINDISTINCT_CURVE_KNOTS? {	// [10]
      return self.complexEntity.entityReference(eINDISTINCT_CURVE_KNOTS.self)
    }

    public var sub_eSHORT_LENGTH_CURVE_SEGMENT: eSHORT_LENGTH_CURVE_SEGMENT? {	// [11]
      return self.complexEntity.entityReference(eSHORT_LENGTH_CURVE_SEGMENT.self)
    }

    public var sub_eSURFACE_WITH_SMALL_CURVATURE_RADIUS: eSURFACE_WITH_SMALL_CURVATURE_RADIUS? {	// [12]
      return self.complexEntity.entityReference(eSURFACE_WITH_SMALL_CURVATURE_RADIUS.self)
    }

    public var sub_eSMALL_AREA_SURFACE_PATCH: eSMALL_AREA_SURFACE_PATCH? {	// [13]
      return self.complexEntity.entityReference(eSMALL_AREA_SURFACE_PATCH.self)
    }

    public var sub_eNARROW_SURFACE_PATCH: eNARROW_SURFACE_PATCH? {	// [14]
      return self.complexEntity.entityReference(eNARROW_SURFACE_PATCH.self)
    }

    public var sub_eNEARLY_DEGENERATE_SURFACE_BOUNDARY: eNEARLY_DEGENERATE_SURFACE_BOUNDARY? {	// [15]
      return self.complexEntity.entityReference(eNEARLY_DEGENERATE_SURFACE_BOUNDARY.self)
    }

    public var sub_eNEARLY_DEGENERATE_SURFACE_PATCH: eNEARLY_DEGENERATE_SURFACE_PATCH? {	// [16]
    ...
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNARROW_SURFACE_PATCH`` )
    public var WIDTH_TOLERANCE: tLENGTH_MEASURE?  {
      get {
        let originalValue = sub_eNARROW_SURFACE_PATCH?.partialEntity._width_tolerance
        let value = tLENGTH_MEASURE( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eNARROW_SURFACE_PATCH?.partialEntity
          else { return }
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "GEOMETRY_WITH_LOCAL_NEAR_DEGENERACY", 
      ...
      entityDef.addAttribute(name: "WIDTH_TOLERANCE", 
        keyPath: \eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY.WIDTH_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY.self
      }
