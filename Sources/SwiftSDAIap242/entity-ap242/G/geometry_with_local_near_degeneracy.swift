/* file: geometry_with_local_near_degeneracy.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eGEOMETRY_WITH_LOCAL_NEAR_DEGENERACY : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var WIDTH_TOLERANCE: tLENGTH_MEASURE?  {
      get {
        return sub_eNARROW_SURFACE_PATCH?.partialEntity._width_tolerance
      }
      set(newValue) {
        guard let partial = sub_eNARROW_SURFACE_PATCH?.super_eNARROW_SURFACE_PATCH.partialEntity
          else { return }
