/* file: generic_character_glyph_symbol.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- generic_character_glyph_symbol (line:16967 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	...
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCHARACTER_GLYPH_SYMBOL``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGENERIC_CHARACTER_GLYPH_SYMBOL/PartialEntity``
*/
  public final class eGENERIC_CHARACTER_GLYPH_SYMBOL : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eGENERIC_CHARACTER_GLYPH_SYMBOL>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eGENERIC_CHARACTER_GLYPH_SYMBOL.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eGENERIC_CHARACTER_GLYPH_SYMBOL.PartialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eGENERIC_CHARACTER_GLYPH_SYMBOL.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eGENERIC_CHARACTER_GLYPH_SYMBOL.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CHARACTER_BOX", 
        keyPath: \eGENERIC_CHARACTER_GLYPH_SYMBOL.CHARACTER_BOX, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eGENERIC_CHARACTER_GLYPH_SYMBOL.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "OUTLINES", 
        keyPath: \eGENERIC_CHARACTER_GLYPH_SYMBOL.OUTLINES, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "BASELINE_RATIO", 
        keyPath: \eGENERIC_CHARACTER_GLYPH_SYMBOL.BASELINE_RATIO, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "BOX_HEIGHT", 
        keyPath: \eGENERIC_CHARACTER_GLYPH_SYMBOL.BOX_HEIGHT, 
        kind: .derived, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "STROKES", 
        keyPath: \eGENERIC_CHARACTER_GLYPH_SYMBOL.STROKES, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eGENERIC_CHARACTER_GLYPH_SYMBOL.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eGENERIC_CHARACTER_GLYPH_SYMBOL.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eGENERIC_CHARACTER_GLYPH_SYMBOL.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGENERIC_CHARACTER_GLYPH_SYMBOL``
*/
