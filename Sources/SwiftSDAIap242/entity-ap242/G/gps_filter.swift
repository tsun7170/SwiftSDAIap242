/* file: gps_filter.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _gps_filter : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //internal private(set) weak var _owner: eGPS_FILTRATION_SPECIFICATION? 	(SEE CORRESPONDING ENTITY REFERENCE DEFINITION)
...
```
*/
  public final class eGPS_FILTER : SDAI.EntityReference, @unchecked Sendable {
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"OWNER") {
        return cached.value as! eGPS_FILTRATION_SPECIFICATION? 
      }
