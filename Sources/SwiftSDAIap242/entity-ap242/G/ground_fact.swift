/* file: ground_fact.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- ground_fact (line:17341 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _ground_fact : SDAI.PartialEntity {
...
```
*/
  public final class eGROUND_FACT : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "GROUND_FACT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ITEM_ELEMENT", keyPath: \eGROUND_FACT.ITEM_ELEMENT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eGROUND_FACT.NAME, 
