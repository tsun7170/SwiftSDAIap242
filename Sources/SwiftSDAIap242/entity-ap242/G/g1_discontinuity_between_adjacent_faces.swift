/* file: g1_discontinuity_between_adjacent_faces.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  ENTITY g1_discontinuity_between_adjacent_faces
    ...
    WHERE
      ...
      wr5: validate_accuracy_types( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               + 'PLANE_ANGLE_MEASURE' ] );
  END_ENTITY; -- g1_discontinuity_between_adjacent_faces (line:16140 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	g1_discontinuity_between_adjacent_faces
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES/PartialEntity``
*/
  public final class eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity
    ...
    public var super_eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES: eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "G1_DISCONTINUITY_BETWEEN_ADJACENT_FACES", 
      ...
      entityDef.add(supertype: eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES.self
      }
      ...
      public static func WHERE_wr1(SELF: eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PLANE_ANGLE_MEASURE") )
        return _TEMP1
      }
      public static func WHERE_wr3(SELF: eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr4(SELF: eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr5(SELF: eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
            SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PLANE_ANGLE_MEASURE")) ] 
            as [SDAI.AggregationInitializerElement<SDAI.STRING>]) )
