/* file: g1_discontinuity_between_adjacent_faces.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _g1_discontinuity_between_adjacent_faces : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = VALIDATE_MEASURED_DATA_TYPE(
        EI: eSHAPE_DATA_QUALITY_CRITERION(/*eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES*/SELF), 
        TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PLANE_ANGLE_MEASURE"))
      return _TEMP1
    }
    public static func WHERE_wr3(SELF: eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr5(SELF: eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _g1_discontinuity_between_adjacent_faces.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _g1_discontinuity_between_adjacent_faces.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _g1_discontinuity_between_adjacent_faces.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _g1_discontinuity_between_adjacent_faces.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _g1_discontinuity_between_adjacent_faces.WHERE_wr5(SELF: instance)
      return result
    }
