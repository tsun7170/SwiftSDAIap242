/* file: g1_discontinuity_between_adjacent_faces.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY g1_discontinuity_between_adjacent_faces
    ...
    WHERE
      ...
      wr5: validate_accuracy_types( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               + 'PLANE_ANGLE_MEASURE' ] );
  END_ENTITY; -- g1_discontinuity_between_adjacent_faces (line:16062 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _g1_discontinuity_between_adjacent_faces : SDAI.PartialEntity {
...
```
*/
  public final class eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "G1_DISCONTINUITY_BETWEEN_ADJACENT_FACES", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES.NAME, 
