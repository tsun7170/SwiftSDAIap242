/* file: g2_discontinuous_surface.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _g2_discontinuous_surface : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_g2_discontinuous_surface``
*/
  public final class eG2_DISCONTINUOUS_SURFACE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _g2_discontinuous_surface.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _g2_discontinuous_surface.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _g2_discontinuous_surface.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _g2_discontinuous_surface.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _g2_discontinuous_surface.WHERE_wr5(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr6"] = _g2_discontinuous_surface.WHERE_wr6(SELF: instance.pRef)
      return result
    }
