/* file: geometry_with_local_irregularity.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _geometry_with_local_irregularity : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_geometry_with_local_irregularity``
*/
  public final class eGEOMETRY_WITH_LOCAL_IRREGULARITY : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _geometry_with_local_irregularity.self
    }
    /// partial entity reference
    public let partialEntity: _geometry_with_local_irregularity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_geometry_with_local_irregularity.self) else { return nil }
