/* file: geometry_with_local_irregularity.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- geometry_with_local_irregularity (line:17466 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	geometry_with_local_irregularity
    (no local attributes)

  SUB- ENTITY(8)	extreme_patch_width_variation
  ...
  SUB- ENTITY(9)	zero_surface_normal
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(10)	abrupt_change_of_surface_normal
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTREME_PATCH_WIDTH_VARIATION``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eZERO_SURFACE_NORMAL``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eABRUPT_CHANGE_OF_SURFACE_NORMAL``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGEOMETRY_WITH_LOCAL_IRREGULARITY/PartialEntity``
*/
  public final class eGEOMETRY_WITH_LOCAL_IRREGULARITY : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eGEOMETRY_WITH_LOCAL_IRREGULARITY>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eGEOMETRY_WITH_LOCAL_IRREGULARITY.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eGEOMETRY_WITH_LOCAL_IRREGULARITY.PartialEntity
    ...
    public var super_eGEOMETRY_WITH_LOCAL_IRREGULARITY: eGEOMETRY_WITH_LOCAL_IRREGULARITY { return self } 	// [7]

    //MARK: SUBTYPES
    public var sub_eEXTREME_PATCH_WIDTH_VARIATION: eEXTREME_PATCH_WIDTH_VARIATION? {	// [8]
      return self.complexEntity.entityReference(eEXTREME_PATCH_WIDTH_VARIATION.self)
    }

    public var sub_eZERO_SURFACE_NORMAL: eZERO_SURFACE_NORMAL? {	// [9]
      return self.complexEntity.entityReference(eZERO_SURFACE_NORMAL.self)
    }

    public var sub_eABRUPT_CHANGE_OF_SURFACE_NORMAL: eABRUPT_CHANGE_OF_SURFACE_NORMAL? {	// [10]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eGEOMETRY_WITH_LOCAL_IRREGULARITY.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "GEOMETRY_WITH_LOCAL_IRREGULARITY", 
      ...
      entityDef.addAttribute(name: "TEST_POINT_DISTANCE_TOLERANCE", 
        keyPath: \eGEOMETRY_WITH_LOCAL_IRREGULARITY.TEST_POINT_DISTANCE_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eGEOMETRY_WITH_LOCAL_IRREGULARITY.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eGEOMETRY_WITH_LOCAL_IRREGULARITY.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "SMALL_VECTOR_TOLERANCE", 
        keyPath: \eGEOMETRY_WITH_LOCAL_IRREGULARITY.SMALL_VECTOR_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGEOMETRY_WITH_LOCAL_IRREGULARITY``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eGEOMETRY_WITH_LOCAL_IRREGULARITY.self
      }
