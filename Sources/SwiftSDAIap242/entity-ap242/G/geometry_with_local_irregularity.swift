/* file: geometry_with_local_irregularity.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- geometry_with_local_irregularity (line:17271 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _geometry_with_local_irregularity : SDAI.PartialEntity {
...
```
*/
  public final class eGEOMETRY_WITH_LOCAL_IRREGULARITY : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "GEOMETRY_WITH_LOCAL_IRREGULARITY", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "TEST_POINT_DISTANCE_TOLERANCE", keyPath: \eGEOMETRY_WITH_LOCAL_IRREGULARITY.TEST_POINT_DISTANCE_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eGEOMETRY_WITH_LOCAL_IRREGULARITY.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eGEOMETRY_WITH_LOCAL_IRREGULARITY.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "SMALL_VECTOR_TOLERANCE", keyPath: \eGEOMETRY_WITH_LOCAL_IRREGULARITY.SMALL_VECTOR_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
