/* file: geometrically_bounded_2d_wireframe_representation.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  ENTITY geometrically_bounded_2d_wireframe_representation
    ...
    WHERE
      ...
      wr7: ( SIZEOF( QUERY ( gcs <* QUERY ( item <* SELF.items | ( 
               ...
               0 );
  END_ENTITY; -- geometrically_bounded_2d_wireframe_representation (line:17240 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION/PartialEntity``
*/
  public final class eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PartialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      result[prefix + " .WHERE_wr6"] = eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PartialEntity.WHERE_wr6(SELF: instance.pRef)
      result[prefix + " .WHERE_wr7"] = eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PartialEntity.WHERE_wr7(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        ...
        let _TEMP2 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP1?
          .QUERY{ ITEM in 
            ...
            let _TEMP1 /* SDAI.SET<SDAI.STRING> */ = SDAI.TYPEOF( ITEM )
      ...
      public static func WHERE_wr3(SELF: eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr4(SELF: eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        ...
        let _TEMP2 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP1?
          .QUERY{ ITEM in 
            ...
            let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( ITEM, IS: eMAPPED_ITEM.self )
            return _TEMP1
            // END QUERY BODY
          }
        let _TEMP3 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP2?
          .QUERY{ MI in 
            ...
            let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( ((MI.GROUP_REF(eMAPPED_ITEM.self))?.MAPPING_SOURCE)?
              .MAPPED_REPRESENTATION, IS: eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.self )
      ...
      public static func WHERE_wr5(SELF: eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        ...
        let _TEMP2 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP1?
          .QUERY{ ITEM in 
            ...
            let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( ITEM, IS: eGEOMETRIC_CURVE_SET.self )
            return _TEMP1
            // END QUERY BODY
          }
        let _TEMP3 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP2?
          .QUERY{ GCS in 
            ...
            let _TEMP3 /* SDAI.SET<sGEOMETRIC_SET_SELECT>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP2?
              .QUERY{ ELEM in 
                ...
                let _TEMP1 /* SDAI.SET<SDAI.STRING> */ = SDAI.TYPEOF( ELEM )
                let _TEMP2 /* SDAI.AGGREGATE<SDAI.STRING> */ =  ([ 
      ...
      public static func WHERE_wr6(SELF: eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
          ...
          .QUERY{ GCS in 
            ...
            let _TEMP4 /* SDAI.SET<sGEOMETRIC_SET_SELECT>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP3?
              .QUERY{ CRV in 
                ...
                let _TEMP1 /* SDAI.BOOLEAN? */ = VALID_BASIS_CURVE_IN_2D_WIREFRAME( 
      ...
      public static func WHERE_wr7(SELF: eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
          ...
          .QUERY{ GCS in 
            ...
            let _TEMP4 /* SDAI.SET<sGEOMETRIC_SET_SELECT>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP3?
              .QUERY{ PNT in 
                ...
                let _TEMP1 /* SDAI.SET<SDAI.STRING> */ = SDAI.TYPEOF( PNT )
                let _TEMP2 /* SDAI.AGGREGATE<SDAI.STRING> */ =  ([ 
