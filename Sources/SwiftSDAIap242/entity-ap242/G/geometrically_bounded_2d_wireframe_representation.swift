/* file: geometrically_bounded_2d_wireframe_representation.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr6"] = eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PartialEntity.WHERE_wr6(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr7"] = eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION.PartialEntity.WHERE_wr7(SELF: instance.pRef)
      return result
    }
