/* file: geometrically_bounded_2d_wireframe_representation.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_geometrically_bounded_2d_wireframe_representation``
*/
  public final class eGEOMETRICALLY_BOUNDED_2D_WIREFRAME_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _geometrically_bounded_2d_wireframe_representation.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _geometrically_bounded_2d_wireframe_representation.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _geometrically_bounded_2d_wireframe_representation.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _geometrically_bounded_2d_wireframe_representation.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _geometrically_bounded_2d_wireframe_representation.WHERE_wr5(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr6"] = _geometrically_bounded_2d_wireframe_representation.WHERE_wr6(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr7"] = _geometrically_bounded_2d_wireframe_representation.WHERE_wr7(SELF: instance.pRef)
      return result
    }
