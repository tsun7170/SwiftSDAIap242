/* file: g1_discontinuous_curve.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- g1_discontinuous_curve (line:16091 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _g1_discontinuous_curve : SDAI.PartialEntity {
...
```
*/
  public final class eG1_DISCONTINUOUS_CURVE : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eG1_DISCONTINUOUS_CURVE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "G1_DISCONTINUOUS_CURVE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eG1_DISCONTINUOUS_CURVE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eG1_DISCONTINUOUS_CURVE.NAME, 
