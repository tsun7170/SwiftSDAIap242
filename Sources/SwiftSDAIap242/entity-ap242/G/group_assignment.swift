/* file: group_assignment.swift 	 generated: Thu Mar  5 17:54:18 2026 */
  ...
  ENTITY group_assignment
    ...
    WHERE
      wr1: ( SIZEOF( USEDIN( SELF, 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ROLE_ASSOCIATION.'
               + 'ITEM_WITH_ROLE'  ) ) <= 1 );
  END_ENTITY; -- group_assignment (line:17536 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_GROUP_ASSIGNMENT``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eASSIGNED_REQUIREMENT``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURRENT_CHANGE_ELEMENT_ASSIGNMENT``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOLLECTION_ASSIGNMENT``
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOLLECTION_MEMBERSHIP``
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_GROUP_ASSIGNMENT``
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMATING_MATERIAL_ITEMS``
	8.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePREVIOUS_CHANGE_ELEMENT_ASSIGNMENT``
	9.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCHANGE_GROUP_ASSIGNMENT``
	10.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDOCUMENT_IDENTIFIER_ASSIGNMENT``
	11.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_GROUP_MEMBERSHIP_RULES``
	12.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMATED_PART_RELATIONSHIP``
	13.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eASSIGNED_ANALYSIS``
	14.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_GROUP_MEMBERSHIP``
	15.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_CONCEPT_FEATURE_CATEGORY_USAGE``
	16.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEVIDENCE``
	17.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSOURCE_FOR_REQUIREMENT``
	18.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSOURCED_REQUIREMENT``
	19.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONTAINING_MESSAGE``
	20.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_GROUP_ATTRIBUTE_SET``
	21.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSATISFIED_REQUIREMENT``
	22.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMESSAGE_CONTENTS_ASSIGNMENT``
	23.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBREAKDOWN_ELEMENT_GROUP_ASSIGNMENT``
	24.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSATISFYING_ITEM``
	25.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANALYSIS_ITEM``
	26.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_GROUP_RULE_ASSIGNMENT``
	27.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_GROUP_ATTRIBUTE_ASSIGNMENT``
	28.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREQUIREMENT_ASSIGNED_OBJECT``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGROUP_ASSIGNMENT/PartialEntity``
*/
  public final class eGROUP_ASSIGNMENT : SDAI.EntityReference, SDAI.DualModeReference, 
    SDAI.SimpleEntityType, @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eGROUP_ASSIGNMENT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eGROUP_ASSIGNMENT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eGROUP_ASSIGNMENT.PartialEntity
    ...
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCHANGE_GROUP_ASSIGNMENT`` )
    public var ITEM: sCHANGE_RELATIONSHIP_SELECT?  {
      get {
        let originalValue = sub_eCHANGE_GROUP_ASSIGNMENT?.partialEntity._item
        let value = sCHANGE_RELATIONSHIP_SELECT( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eCHANGE_GROUP_ASSIGNMENT?.partialEntity
          else { return }
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGROUP_ASSIGNMENT`` )
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_GROUP_ATTRIBUTE_SET`` )
    public var PRODUCT_GROUP_ATTRIBUTES: (SDAI.SET<ePRODUCT_GROUP_ATTRIBUTES.PRef>/*[1:1]*/ )?  {
      get {
        let originalValue = sub_ePRODUCT_GROUP_ATTRIBUTE_SET?.partialEntity._product_group_attributes
        let value = SDAI.SET<ePRODUCT_GROUP_ATTRIBUTES.PRef>( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_ePRODUCT_GROUP_ATTRIBUTE_SET?.partialEntity
          else { return }
        guard let SELF = sub_ePRODUCT_GROUP_ATTRIBUTE_SET
           else { return }; SDAI.TOUCH(let:SELF)
        partial._product_group_attributes = SDAI.UNWRAP(SDAI.SET<ePRODUCT_GROUP_ATTRIBUTES.PRef>(
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_GROUP_ATTRIBUTE_ASSIGNMENT`` )
    public var ATTRIBUTES: (SDAI.SET<sATTRIBUTE_SELECT>/*[1:1]*/ )?  {
      get {
        let originalValue = sub_ePRODUCT_GROUP_ATTRIBUTE_ASSIGNMENT?.partialEntity._attributes
        let value = SDAI.SET<sATTRIBUTE_SELECT>( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_ePRODUCT_GROUP_ATTRIBUTE_ASSIGNMENT?.partialEntity
          else { return }
        guard let SELF = sub_ePRODUCT_GROUP_ATTRIBUTE_ASSIGNMENT
           else { return }; SDAI.TOUCH(let:SELF)
        partial._attributes = SDAI.UNWRAP(SDAI.SET<sATTRIBUTE_SELECT>(
          bound1:SDAI.UNWRAP(1), bound2:1, 
          newValue))
      }
    }
    ...
    public var ASSIGNED_GROUP: eGROUP.PRef {
      get {
        if let resolved = eGROUP_ASSIGNMENT.PartialEntity._assigned_group__provider(complex: self.complexEntity) {
          ...
          let originalValue = self.partialEntity._assigned_group
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eGROUP_ASSIGNMENT.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eGROUP_ASSIGNMENT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "ITEM", 
        keyPath: \eGROUP_ASSIGNMENT.ITEM, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ROLE", 
        keyPath: \eGROUP_ASSIGNMENT.ROLE, 
        kind: .derived, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "PRODUCT_GROUP_ATTRIBUTES", 
        keyPath: \eGROUP_ASSIGNMENT.PRODUCT_GROUP_ATTRIBUTES, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "OF_SHAPE", 
        keyPath: \eGROUP_ASSIGNMENT.OF_SHAPE, 
        kind: .derivedRedeclaring, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ATTRIBUTES", 
        keyPath: \eGROUP_ASSIGNMENT.ATTRIBUTES, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "MEMBER", 
        keyPath: \eGROUP_ASSIGNMENT.MEMBER, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_GROUP", 
        keyPath: \eGROUP_ASSIGNMENT.ASSIGNED_GROUP, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DEFINITION", 
        keyPath: \eGROUP_ASSIGNMENT.DEFINITION, 
        kind: .derivedRedeclaring, source: .subEntity, mayYieldEntityReference: true)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGROUP_ASSIGNMENT``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _assigned_group: eGROUP.PRef?  // PLAIN EXPLICIT ATTRIBUTE
      ...
      /// DERIVE ATTRIBUTE
      @_documentation(visibility:public)
      internal func _role__getter(SELF: eGROUP_ASSIGNMENT.PRef) -> eOBJECT_ROLE.PRef?  {
        //
        let _TEMP1 /* eOBJECT_ROLE.PRef? */ = GET_ROLE( sROLE_SELECT(/*eGROUP_ASSIGNMENT.PRef*/SELF) )
        return _TEMP1
      }
      ...
      final public override class func fixupPartialComplexEntityAttributes(partialComplex: SDAI.ComplexEntity, baseComplex: SDAI.ComplexEntity) {
        guard let pe = partialComplex.partialEntityInstance(eGROUP_ASSIGNMENT.PartialEntity.self) else { return }
      ...
      public static func WHERE_wr1(SELF: eGROUP_ASSIGNMENT.PRef?) -> SDAI.LOGICAL {
      ...
      public init(ASSIGNED_GROUP: eGROUP.PRef? ) {
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( ASSIGNED_GROUP: original._assigned_group )
      }
      ...
      public required convenience init?(
        ...
        guard case .success(let p0) = exchangeStructure.recoverOmittableParameter(as: eGROUP.PRef.self, from: parameters[0])
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]ASSIGNED_GROUP for partial entity(\(Self.entityName)) constructor"); return nil }
...
internal protocol eGROUP_ASSIGNMENT__ASSIGNED_GROUP__provider {
  ...
  func _assigned_group__getter(complex: SDAI.ComplexEntity) -> 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eGROUP.PRef
}
