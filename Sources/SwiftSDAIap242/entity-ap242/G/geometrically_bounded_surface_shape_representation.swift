/* file: geometrically_bounded_surface_shape_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _geometrically_bounded_surface_shape_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eGEOMETRICALLY_BOUNDED_SURFACE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.ITEMS
      let _TEMP2 = _TEMP1.QUERY{ IT in 

          let _TEMP1 = ([SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.GEOMETRIC_SET")), 
    ...
    public static func WHERE_wr2(SELF: eGEOMETRICALLY_BOUNDED_SURFACE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eGEOMETRICALLY_BOUNDED_SURFACE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ MI in 
          ...
          let _TEMP6 = _TEMP5?.QUERY{ MR_IT in 
              ...
              let _TEMP1 = SDAI.TYPEOF(MR_IT, IS: eGEOMETRIC_SET.self)
              return _TEMP1 }
    ...
    public static func WHERE_wr4(SELF: eGEOMETRICALLY_BOUNDED_SURFACE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.ITEMS
      let _TEMP2 = _TEMP1.QUERY{ IT in 

          let _TEMP1 = SDAI.TYPEOF(IT, IS: eGEOMETRIC_SET.self)
          return _TEMP1 }
      let _TEMP3 = _TEMP2.QUERY{ GS in 

          let _TEMP1 = GS.GROUP_REF(eGEOMETRIC_SET.self)
          let _TEMP2 = _TEMP1?.ELEMENTS
          let _TEMP3 = _TEMP2?.QUERY{ GSEL in 

              let _TEMP1 = SDAI.TYPEOF(GSEL, IS: ePOINT.self)
              return _TEMP1 }
          let _TEMP4 = _TEMP3?.QUERY{ PNT in 

              let _TEMP1 = GBSF_CHECK_POINT(ePOINT(/*sGEOMETRIC_SET_SELECT*/PNT))
              let _TEMP2 =  !_TEMP1
              return _TEMP2 }
    ...
    public static func WHERE_wr5(SELF: eGEOMETRICALLY_BOUNDED_SURFACE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ GS in 
          ...
          let _TEMP3 = _TEMP2?.QUERY{ GSEL in 
              ...
              let _TEMP1 = SDAI.TYPEOF(GSEL, IS: eCURVE.self)
              return _TEMP1 }
          let _TEMP4 = _TEMP3?.QUERY{ CV in 

              let _TEMP1 = GBSF_CHECK_CURVE(eREPRESENTATION_ITEM(/*sGEOMETRIC_SET_SELECT*/CV))
              let _TEMP2 =  !_TEMP1
              return _TEMP2 }
          let _TEMP5 = SDAI.SIZEOF(_TEMP4)
          let _TEMP6 = _TEMP5 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(0))
    ...
    public static func WHERE_wr6(SELF: eGEOMETRICALLY_BOUNDED_SURFACE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ GS in 
          ...
          let _TEMP3 = _TEMP2?.QUERY{ GSEL in 
              ...
              let _TEMP1 = SDAI.TYPEOF(GSEL, IS: eSURFACE.self)
              return _TEMP1 }
          let _TEMP4 = _TEMP3?.QUERY{ SF in 

              let _TEMP1 = GBSF_CHECK_SURFACE(eSURFACE(/*sGEOMETRIC_SET_SELECT*/SF))
              let _TEMP2 =  !_TEMP1
              return _TEMP2 }
          let _TEMP5 = SDAI.SIZEOF(_TEMP4)
          let _TEMP6 = _TEMP5 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(0))
    ...
    public static func WHERE_wr7(SELF: eGEOMETRICALLY_BOUNDED_SURFACE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eGEOMETRICALLY_BOUNDED_SURFACE_SHAPE_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _geometrically_bounded_surface_shape_representation.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _geometrically_bounded_surface_shape_representation.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _geometrically_bounded_surface_shape_representation.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _geometrically_bounded_surface_shape_representation.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _geometrically_bounded_surface_shape_representation.WHERE_wr5(SELF: instance)
      result[prefix2 + " .WHERE_wr6"] = _geometrically_bounded_surface_shape_representation.WHERE_wr6(SELF: instance)
      result[prefix2 + " .WHERE_wr7"] = _geometrically_bounded_surface_shape_representation.WHERE_wr7(SELF: instance)
      return result
    }
