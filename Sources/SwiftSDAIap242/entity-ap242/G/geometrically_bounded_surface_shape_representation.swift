/* file: geometrically_bounded_surface_shape_representation.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY geometrically_bounded_surface_shape_representation
    ...
    WHERE
      ...
      wr7: ( SIZEOF( QUERY ( gs <* QUERY ( it <* SELF.items | ( 
               ...
               0 );
  END_ENTITY; -- geometrically_bounded_surface_shape_representation (line:17118 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eGEOMETRICALLY_BOUNDED_SURFACE_SHAPE_REPRESENTATION : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "GEOMETRICALLY_BOUNDED_SURFACE_SHAPE_REPRESENTATION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eGEOMETRICALLY_BOUNDED_SURFACE_SHAPE_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eGEOMETRICALLY_BOUNDED_SURFACE_SHAPE_REPRESENTATION.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eGEOMETRICALLY_BOUNDED_SURFACE_SHAPE_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eGEOMETRICALLY_BOUNDED_SURFACE_SHAPE_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eGEOMETRICALLY_BOUNDED_SURFACE_SHAPE_REPRESENTATION.NAME, 
