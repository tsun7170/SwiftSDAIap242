/* file: gear.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _gear : SDAI.PartialEntity, SDAI.InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_gear``
*/
  public final class eGEAR : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _gear.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _gear.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _gear.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _gear.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _gear.WHERE_wr5(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr6"] = _gear.WHERE_wr6(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr7"] = _gear.WHERE_wr7(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr8"] = _gear.WHERE_wr8(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr9"] = _gear.WHERE_wr9(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr10"] = _gear.WHERE_wr10(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr11"] = _gear.WHERE_wr11(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr12"] = _gear.WHERE_wr12(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr13"] = _gear.WHERE_wr13(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr14"] = _gear.WHERE_wr14(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr15"] = _gear.WHERE_wr15(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr16"] = _gear.WHERE_wr16(SELF: instance.pRef)
      return result
    }
