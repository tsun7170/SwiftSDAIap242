/* file: g2_discontinuous_curve.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- g2_discontinuous_curve (line:16128 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _g2_discontinuous_curve : SDAI.PartialEntity {
...
```
*/
  public final class eG2_DISCONTINUOUS_CURVE : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eG2_DISCONTINUOUS_CURVE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "G2_DISCONTINUOUS_CURVE", type: self, explicitAttributeCount: 2)
      ...
      entityDef.addAttribute(name: "FLAT_CURVATURE_RADIUS_TOLERANCE", keyPath: \eG2_DISCONTINUOUS_CURVE.FLAT_CURVATURE_RADIUS_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION_2", keyPath: \eG2_DISCONTINUOUS_CURVE.ASSESSMENT_SPECIFICATION_2, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eG2_DISCONTINUOUS_CURVE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eG2_DISCONTINUOUS_CURVE.NAME, 
