/* file: g2_discontinuous_curve.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _g2_discontinuous_curve : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_g2_discontinuous_curve``
*/
  public final class eG2_DISCONTINUOUS_CURVE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _g2_discontinuous_curve.self
    }
    /// partial entity reference
    public let partialEntity: _g2_discontinuous_curve
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_g2_discontinuous_curve.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _g2_discontinuous_curve.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _g2_discontinuous_curve.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _g2_discontinuous_curve.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _g2_discontinuous_curve.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _g2_discontinuous_curve.WHERE_wr5(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr6"] = _g2_discontinuous_curve.WHERE_wr6(SELF: instance.pRef)
      return result
    }
