/* file: g2_discontinuous_curve.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- g2_discontinuous_curve (line:16206 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	g2_discontinuous_curve
...
- SUPERTYPES:
	...
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDISCONTINUOUS_GEOMETRY``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eG2_DISCONTINUOUS_CURVE/PartialEntity``
*/
  public final class eG2_DISCONTINUOUS_CURVE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eG2_DISCONTINUOUS_CURVE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eG2_DISCONTINUOUS_CURVE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eG2_DISCONTINUOUS_CURVE.PartialEntity
    ...
    public var super_eG2_DISCONTINUOUS_CURVE: eG2_DISCONTINUOUS_CURVE { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eG2_DISCONTINUOUS_CURVE`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eG2_DISCONTINUOUS_CURVE.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eG2_DISCONTINUOUS_CURVE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eG2_DISCONTINUOUS_CURVE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eG2_DISCONTINUOUS_CURVE.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eG2_DISCONTINUOUS_CURVE.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = eG2_DISCONTINUOUS_CURVE.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      result[prefix + " .WHERE_wr6"] = eG2_DISCONTINUOUS_CURVE.PartialEntity.WHERE_wr6(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eG2_DISCONTINUOUS_CURVE.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "FLAT_CURVATURE_RADIUS_TOLERANCE", 
        keyPath: \eG2_DISCONTINUOUS_CURVE.FLAT_CURVATURE_RADIUS_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION_2", 
        keyPath: \eG2_DISCONTINUOUS_CURVE.ASSESSMENT_SPECIFICATION_2, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eG2_DISCONTINUOUS_CURVE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eG2_DISCONTINUOUS_CURVE.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eG2_DISCONTINUOUS_CURVE``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eG2_DISCONTINUOUS_CURVE.self
      }
      ...
      public static func WHERE_wr1(SELF: eG2_DISCONTINUOUS_CURVE.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eG2_DISCONTINUOUS_CURVE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr3(SELF: eG2_DISCONTINUOUS_CURVE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eG2_DISCONTINUOUS_CURVE.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING(
            "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PLANE_ANGLE_AND_RATIO_PAIR") )
        return _TEMP1
      }
      public static func WHERE_wr4(SELF: eG2_DISCONTINUOUS_CURVE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr5(SELF: eG2_DISCONTINUOUS_CURVE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
            SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.B_SPLINE_CURVE_KNOT_LOCATOR")) ] 
            as [SDAI.AggregationInitializerElement<SDAI.STRING>]) )
      ...
      public static func WHERE_wr6(SELF: eG2_DISCONTINUOUS_CURVE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
