/* file: general_linear_function.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _general_linear_function : SDAI.PartialEntity, @unchecked Sendable {
    ...
    /// DERIVE ATTRIBUTE
    internal func _mat__getter(SELF: eGENERAL_LINEAR_FUNCTION) -> eMATHS_FUNCTION?  {
    ...
    public static func WHERE_wr1(SELF: eGENERAL_LINEAR_FUNCTION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = FUNCTION_IS_2D_TABLE(SELF.MAT)
      return SDAI.LOGICAL(_TEMP1)
    }
    public static func WHERE_wr2(SELF: eGENERAL_LINEAR_FUNCTION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eGENERAL_LINEAR_FUNCTION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _general_linear_function.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _general_linear_function.WHERE_wr2(SELF: instance)
      return result
    }
