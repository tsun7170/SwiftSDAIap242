/* file: instanced_feature.swift 	 generated: Thu Dec 25 18:13:23 2025 */
...
*/
  ...
  public final class _instanced_feature : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eINSTANCED_FEATURE.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( (SELF.OF_SHAPE)?.DEFINITION, IS: ePRODUCT_DEFINITION.self )
      return _TEMP1
    }
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_instanced_feature``
*/
  public final class eINSTANCED_FEATURE : SDAI.EntityReference, SDAIDualModeReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _instanced_feature.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _instanced_feature.WHERE_wr2(SELF: instance.pRef)
      return result
    }
