/* file: interface_connection.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  ENTITY interface_connection
    SUBTYPE OF ( group );
  END_ENTITY; -- interface_connection (line:18248 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _interface_connection : SDAI.PartialEntity {
...
```
*/
  public final class eINTERFACE_CONNECTION : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "INTERFACE_CONNECTION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eINTERFACE_CONNECTION.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ID", keyPath: \eINTERFACE_CONNECTION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eINTERFACE_CONNECTION.NAME, 
