/* file: inapt_data.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- inapt_data (line:18147 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	...
	45.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINAPT_GEOMETRY``
	46.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSELF_INTERSECTING_SHELL``
	47.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERSECTING_CONNECTED_FACE_SETS``
	48.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSELF_INTERSECTING_LOOP``
	49.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY``
	50.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHORT_LENGTH_EDGE``
	51.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSMALL_AREA_FACE``
	52.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eENTIRELY_NARROW_FACE``
	53.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTOPOLOGY_RELATED_TO_NEARLY_DEGENERATE_GEOMETRY``
	54.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTIPLY_DEFINED_FACES``
	55.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTIPLY_DEFINED_EDGES``
	56.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTIPLY_DEFINED_VERTICES``
	57.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTOPOLOGY_RELATED_TO_MULTIPLY_DEFINED_GEOMETRY``
	58.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGAP_BETWEEN_PCURVES_RELATED_TO_AN_EDGE``
	59.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGAP_BETWEEN_EDGE_AND_BASE_SURFACE``
	60.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGAP_BETWEEN_VERTEX_AND_EDGE``
	61.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP``
	62.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGAP_BETWEEN_FACES_RELATED_TO_AN_EDGE``
	63.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGAP_BETWEEN_VERTEX_AND_BASE_SURFACE``
	64.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGEOMETRIC_GAP_IN_TOPOLOGY``
	65.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES``
	66.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES``
	67.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE``
	68.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES``
	69.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES``
	70.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTEEP_GEOMETRY_TRANSITION_ACROSS_EDGE``
	71.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARTLY_OVERLAPPING_EDGES``
	72.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARTLY_OVERLAPPING_FACES``
	73.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTOPOLOGY_RELATED_TO_OVERLAPPING_GEOMETRY``
	74.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eUNUSED_PATCHES``
	75.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEDGE_WITH_EXCESSIVE_SEGMENTS``
	76.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION``
	77.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eOVERCOMPLEX_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP``
	78.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINAPT_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP``
	79.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNON_MANIFOLD_AT_EDGE``
	80.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNON_MANIFOLD_AT_VERTEX``
	81.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFREE_EDGE``
	82.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eOVER_USED_VERTEX``
	83.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINAPT_TOPOLOGY``
	84.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eENTIRELY_NARROW_SOLID``
	85.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSOLID_WITH_EXCESSIVE_NUMBER_OF_VOIDS``
	86.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARTLY_OVERLAPPING_SOLIDS``
	87.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTIPLY_DEFINED_SOLIDS``
	88.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSMALL_VOLUME_SOLID``
	89.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINAPT_MANIFOLD_SOLID_BREP``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINAPT_DATA/PartialEntity``
*/
  public final class eINAPT_DATA : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eINAPT_DATA>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eINAPT_DATA.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eINAPT_DATA.PartialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eINAPT_DATA.PartialEntity.self) else { return nil }
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINAPT_DATA``
*/
