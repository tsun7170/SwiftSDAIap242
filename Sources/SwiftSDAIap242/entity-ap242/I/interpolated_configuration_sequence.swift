/* file: interpolated_configuration_sequence.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY interpolated_configuration_sequence
    ...
    WHERE
      wr1: ( SIZEOF( QUERY ( ics <* segments | ( ics.state.represented_mechanism :<>: configured_mechanism ) ) ) 
               = 0 );
  END_ENTITY; -- interpolated_configuration_sequence (line:18347 file:ap242ed2_mim_lf_v1.101.TY.exp)
