/* file: interface_connector_as_realized.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- interface_connector_as_realized (line:18256 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _interface_connector_as_realized : SDAI.PartialEntity {
...
```
*/
  public final class eINTERFACE_CONNECTOR_AS_REALIZED : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "INTERFACE_CONNECTOR_AS_REALIZED", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eINTERFACE_CONNECTOR_AS_REALIZED.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ID", keyPath: \eINTERFACE_CONNECTOR_AS_REALIZED.ID, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OF_PRODUCT", keyPath: \eINTERFACE_CONNECTOR_AS_REALIZED.OF_PRODUCT, 
