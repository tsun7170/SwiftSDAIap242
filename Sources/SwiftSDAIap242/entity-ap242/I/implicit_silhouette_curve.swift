/* file: implicit_silhouette_curve.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- implicit_silhouette_curve (line:17900 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _implicit_silhouette_curve : SDAI.PartialEntity {
...
```
*/
  public final class eIMPLICIT_SILHOUETTE_CURVE : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eIMPLICIT_SILHOUETTE_CURVE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "IMPLICIT_SILHOUETTE_CURVE", type: self, explicitAttributeCount: 2)
      ...
      entityDef.addAttribute(name: "SILHOUETTED_MODEL", keyPath: \eIMPLICIT_SILHOUETTE_CURVE.SILHOUETTED_MODEL, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "USING_SKETCH", keyPath: \eIMPLICIT_SILHOUETTE_CURVE.USING_SKETCH, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CURVE_PLANE", keyPath: \eIMPLICIT_SILHOUETTE_CURVE.CURVE_PLANE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "COMPUTED_REPRESENTATION", keyPath: \eIMPLICIT_SILHOUETTE_CURVE.COMPUTED_REPRESENTATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eIMPLICIT_SILHOUETTE_CURVE.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "VIEW_DIRECTION", keyPath: \eIMPLICIT_SILHOUETTE_CURVE.VIEW_DIRECTION, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DIM", keyPath: \eIMPLICIT_SILHOUETTE_CURVE.DIM, 
