/* file: inconsistent_element_reference.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY inconsistent_element_reference
    ...
    WHERE
      wr1: validate_ecdq_inspected_elements_type( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               + 'REPRESENTATION_ITEM' ] );
  END_ENTITY; -- inconsistent_element_reference (line:18081 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _inconsistent_element_reference : SDAI.PartialEntity {
...
```
*/
  public final class eINCONSISTENT_ELEMENT_REFERENCE : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "INCONSISTENT_ELEMENT_REFERENCE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "NAME", keyPath: \eINCONSISTENT_ELEMENT_REFERENCE.NAME, 
