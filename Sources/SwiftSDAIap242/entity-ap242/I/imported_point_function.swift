/* file: imported_point_function.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  ENTITY imported_point_function
    SUBTYPE OF ( maths_function, generic_literal );
      geometry  : point;
  END_ENTITY; -- imported_point_function (line:17928 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _imported_point_function : SDAI.PartialEntity {
...
```
*/
  public final class eIMPORTED_POINT_FUNCTION : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eIMPORTED_POINT_FUNCTION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "IMPORTED_POINT_FUNCTION", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "GEOMETRY", keyPath: \eIMPORTED_POINT_FUNCTION.GEOMETRY, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DOMAIN", keyPath: \eIMPORTED_POINT_FUNCTION.DOMAIN, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "RANGE", keyPath: \eIMPORTED_POINT_FUNCTION.RANGE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
