/* file: interface_connector_as_planned.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- interface_connector_as_planned (line:18252 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _interface_connector_as_planned : SDAI.PartialEntity {
...
```
*/
  public final class eINTERFACE_CONNECTOR_AS_PLANNED : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "INTERFACE_CONNECTOR_AS_PLANNED", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eINTERFACE_CONNECTOR_AS_PLANNED.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ID", keyPath: \eINTERFACE_CONNECTOR_AS_PLANNED.ID, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OF_PRODUCT", keyPath: \eINTERFACE_CONNECTOR_AS_PLANNED.OF_PRODUCT, 
