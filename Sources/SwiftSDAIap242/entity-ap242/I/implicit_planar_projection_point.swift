/* file: implicit_planar_projection_point.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- implicit_planar_projection_point (line:17883 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _implicit_planar_projection_point : SDAI.PartialEntity {
...
```
*/
  public final class eIMPLICIT_PLANAR_PROJECTION_POINT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eIMPLICIT_PLANAR_PROJECTION_POINT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "IMPLICIT_PLANAR_PROJECTION_POINT", type: self, explicitAttributeCount: 2)
      ...
      entityDef.addAttribute(name: "EXTERNAL_POINT", keyPath: \eIMPLICIT_PLANAR_PROJECTION_POINT.EXTERNAL_POINT, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "USING_SKETCH", keyPath: \eIMPLICIT_PLANAR_PROJECTION_POINT.USING_SKETCH, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "PLANE_OF_POINT", keyPath: \eIMPLICIT_PLANAR_PROJECTION_POINT.PLANE_OF_POINT, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "COMPUTED_REPRESENTATION", keyPath: \eIMPLICIT_PLANAR_PROJECTION_POINT.COMPUTED_REPRESENTATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "PROJECTION_DIRECTION", keyPath: \eIMPLICIT_PLANAR_PROJECTION_POINT.PROJECTION_DIRECTION, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eIMPLICIT_PLANAR_PROJECTION_POINT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", keyPath: \eIMPLICIT_PLANAR_PROJECTION_POINT.DIM, 
