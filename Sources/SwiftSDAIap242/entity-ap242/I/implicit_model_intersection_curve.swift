/* file: implicit_model_intersection_curve.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- implicit_model_intersection_curve (line:17844 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _implicit_model_intersection_curve : SDAI.PartialEntity {
...
```
*/
  public final class eIMPLICIT_MODEL_INTERSECTION_CURVE : SDAI.EntityReference {
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``eIMPLICIT_MODEL_INTERSECTION_CURVE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "IMPLICIT_MODEL_INTERSECTION_CURVE", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "USING_SKETCH", keyPath: \eIMPLICIT_MODEL_INTERSECTION_CURVE.USING_SKETCH, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CURVE_PLANE", keyPath: \eIMPLICIT_MODEL_INTERSECTION_CURVE.CURVE_PLANE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "COMPUTED_REPRESENTATION", keyPath: \eIMPLICIT_MODEL_INTERSECTION_CURVE.COMPUTED_REPRESENTATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "INTERSECTED_MODEL", keyPath: \eIMPLICIT_MODEL_INTERSECTION_CURVE.INTERSECTED_MODEL, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eIMPLICIT_MODEL_INTERSECTION_CURVE.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", keyPath: \eIMPLICIT_MODEL_INTERSECTION_CURVE.DIM, 
