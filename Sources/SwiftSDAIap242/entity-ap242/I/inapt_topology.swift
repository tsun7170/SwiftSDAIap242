/* file: inapt_topology.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _inapt_topology : SDAI.PartialEntity, SDAI.InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_inapt_topology``
*/
  public final class eINAPT_TOPOLOGY : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _inapt_topology.self
    }
    /// partial entity reference
    public let partialEntity: _inapt_topology
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_inapt_topology.self) else { return nil }
