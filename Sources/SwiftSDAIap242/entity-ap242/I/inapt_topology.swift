/* file: inapt_topology.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- inapt_topology (line:18166 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	inapt_topology
    (no local attributes)

  SUB- ENTITY(7)	non_manifold_at_edge
  ...
  SUB- ENTITY(8)	non_manifold_at_vertex
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(9)	free_edge
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(10)	over_used_vertex
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNON_MANIFOLD_AT_EDGE``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNON_MANIFOLD_AT_VERTEX``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFREE_EDGE``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eOVER_USED_VERTEX``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINAPT_TOPOLOGY/PartialEntity``
*/
  public final class eINAPT_TOPOLOGY : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eINAPT_TOPOLOGY>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eINAPT_TOPOLOGY.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eINAPT_TOPOLOGY.PartialEntity
    ...
    public var super_eINAPT_TOPOLOGY: eINAPT_TOPOLOGY { return self } 	// [6]

    //MARK: SUBTYPES
    public var sub_eNON_MANIFOLD_AT_EDGE: eNON_MANIFOLD_AT_EDGE? {	// [7]
      return self.complexEntity.entityReference(eNON_MANIFOLD_AT_EDGE.self)
    }

    public var sub_eNON_MANIFOLD_AT_VERTEX: eNON_MANIFOLD_AT_VERTEX? {	// [8]
      return self.complexEntity.entityReference(eNON_MANIFOLD_AT_VERTEX.self)
    }

    public var sub_eFREE_EDGE: eFREE_EDGE? {	// [9]
      return self.complexEntity.entityReference(eFREE_EDGE.self)
    }

    public var sub_eOVER_USED_VERTEX: eOVER_USED_VERTEX? {	// [10]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eINAPT_TOPOLOGY.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eINAPT_TOPOLOGY.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eINAPT_TOPOLOGY.NAME, 
