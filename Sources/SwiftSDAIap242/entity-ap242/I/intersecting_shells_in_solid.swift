/* file: intersecting_shells_in_solid.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- intersecting_shells_in_solid (line:18373 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _intersecting_shells_in_solid : SDAI.PartialEntity {
...
```
*/
  public final class eINTERSECTING_SHELLS_IN_SOLID : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eINTERSECTING_SHELLS_IN_SOLID`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "INTERSECTING_SHELLS_IN_SOLID", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "INTERFERENCE_TOLERANCE", keyPath: \eINTERSECTING_SHELLS_IN_SOLID.INTERFERENCE_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eINTERSECTING_SHELLS_IN_SOLID.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eINTERSECTING_SHELLS_IN_SOLID.NAME, 
