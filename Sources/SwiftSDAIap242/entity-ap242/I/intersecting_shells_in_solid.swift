/* file: intersecting_shells_in_solid.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- intersecting_shells_in_solid (line:18568 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(6)	erroneous_manifold_solid_brep
    (no local attributes)

  ENTITY(SELF)	intersecting_shells_in_solid
...
- SUPERTYPES:
	...
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eERRONEOUS_MANIFOLD_SOLID_BREP``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERSECTING_SHELLS_IN_SOLID/PartialEntity``
*/
  public final class eINTERSECTING_SHELLS_IN_SOLID : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eINTERSECTING_SHELLS_IN_SOLID>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eINTERSECTING_SHELLS_IN_SOLID.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eINTERSECTING_SHELLS_IN_SOLID.PartialEntity
    ...
    public let super_eERRONEOUS_MANIFOLD_SOLID_BREP: eERRONEOUS_MANIFOLD_SOLID_BREP 	// [6]
    public var super_eINTERSECTING_SHELLS_IN_SOLID: eINTERSECTING_SHELLS_IN_SOLID { return self } 	// [7]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERSECTING_SHELLS_IN_SOLID`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eINTERSECTING_SHELLS_IN_SOLID.PartialEntity.self) else { return nil }
      ...
      guard let super6 = complexEntity?.entityReference(eERRONEOUS_MANIFOLD_SOLID_BREP.self) else { return nil }
      self.super_eERRONEOUS_MANIFOLD_SOLID_BREP = super6
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eINTERSECTING_SHELLS_IN_SOLID.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eINTERSECTING_SHELLS_IN_SOLID.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eINTERSECTING_SHELLS_IN_SOLID.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eINTERSECTING_SHELLS_IN_SOLID.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "INTERSECTING_SHELLS_IN_SOLID", 
      ...
      entityDef.add(supertype: eERRONEOUS_MANIFOLD_SOLID_BREP.self)
      entityDef.add(supertype: eINTERSECTING_SHELLS_IN_SOLID.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "INTERFERENCE_TOLERANCE", 
        keyPath: \eINTERSECTING_SHELLS_IN_SOLID.INTERFERENCE_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eINTERSECTING_SHELLS_IN_SOLID.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eINTERSECTING_SHELLS_IN_SOLID.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERSECTING_SHELLS_IN_SOLID``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eINTERSECTING_SHELLS_IN_SOLID.self
      }
      ...
      public static func WHERE_wr1(SELF: eINTERSECTING_SHELLS_IN_SOLID.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eINTERSECTING_SHELLS_IN_SOLID.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOOLEAN_VALUE") )
        return _TEMP1
      }
      public static func WHERE_wr2(SELF: eINTERSECTING_SHELLS_IN_SOLID.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
            SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BREP_WITH_VOIDS")) ] 
      ...
      public static func WHERE_wr3(SELF: eINTERSECTING_SHELLS_IN_SOLID.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr4(SELF: eINTERSECTING_SHELLS_IN_SOLID.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
