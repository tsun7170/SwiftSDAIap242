/* file: imported_surface_function.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- imported_surface_function (line:17919 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _imported_surface_function : SDAI.PartialEntity {
...
```
*/
  public final class eIMPORTED_SURFACE_FUNCTION : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eIMPORTED_SURFACE_FUNCTION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "IMPORTED_SURFACE_FUNCTION", type: self, explicitAttributeCount: 2)
      ...
      entityDef.addAttribute(name: "GEOMETRY", keyPath: \eIMPORTED_SURFACE_FUNCTION.GEOMETRY, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "PARAMETRIC_DOMAIN", keyPath: \eIMPORTED_SURFACE_FUNCTION.PARAMETRIC_DOMAIN, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DOMAIN", keyPath: \eIMPORTED_SURFACE_FUNCTION.DOMAIN, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "RANGE", keyPath: \eIMPORTED_SURFACE_FUNCTION.RANGE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
