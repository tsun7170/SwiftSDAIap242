/* file: imported_surface_function.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _imported_surface_function : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /// EXPLICIT ATTRIBUTE 
    public internal(set) var _geometry: eSURFACE // PLAIN EXPLICIT ATTRIBUTE
    ...
    public static func WHERE_wr1(SELF: eIMPORTED_SURFACE_FUNCTION?) -> SDAI.LOGICAL {
    ...
    public init(GEOMETRY: eSURFACE, PARAMETRIC_DOMAIN: sTUPLE_SPACE) {
...
```
*/
  public final class eIMPORTED_SURFACE_FUNCTION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _imported_surface_function.WHERE_wr1(SELF: instance)
      return result
    }
