/* file: item_link_motion_relationship.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eITEM_LINK_MOTION_RELATIONSHIP/PartialEntity``
*/
  public final class eITEM_LINK_MOTION_RELATIONSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eITEM_LINK_MOTION_RELATIONSHIP.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eITEM_LINK_MOTION_RELATIONSHIP.PartialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eITEM_LINK_MOTION_RELATIONSHIP.PartialEntity.self) else { return nil }
