/* file: inappropriate_use_of_layer.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _inappropriate_use_of_layer : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eINAPPROPRIATE_USE_OF_LAYER?) -> SDAI.LOGICAL {
      ...
      let _TEMP2 = VALIDATE_ECDQ_INSPECTED_ELEMENTS_TYPE(
        EI: eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERION(/*eINAPPROPRIATE_USE_OF_LAYER*/SELF), 
        TYPE_LIST: _TEMP1)
      return _TEMP2
    }
...
```
*/
  public final class eINAPPROPRIATE_USE_OF_LAYER : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _inappropriate_use_of_layer.WHERE_wr1(SELF: instance)
      return result
    }
