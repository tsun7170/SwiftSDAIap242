/* file: indistinct_surface_knots.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eINDISTINCT_SURFACE_KNOTS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eINDISTINCT_SURFACE_KNOTS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eINDISTINCT_SURFACE_KNOTS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eINDISTINCT_SURFACE_KNOTS.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eINDISTINCT_SURFACE_KNOTS.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = eINDISTINCT_SURFACE_KNOTS.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
