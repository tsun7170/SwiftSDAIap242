/* file: inconsistent_curve_transition_code.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public final class eINCONSISTENT_CURVE_TRANSITION_CODE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eINCONSISTENT_CURVE_TRANSITION_CODE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eINCONSISTENT_CURVE_TRANSITION_CODE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eINCONSISTENT_CURVE_TRANSITION_CODE.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eINCONSISTENT_CURVE_TRANSITION_CODE.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
