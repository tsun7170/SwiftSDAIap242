/* file: inconsistent_curve_transition_code.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- inconsistent_curve_transition_code (line:18236 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	inconsistent_curve_transition_code
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCONSISTENT_CURVE_TRANSITION_CODE/PartialEntity``
*/
  public final class eINCONSISTENT_CURVE_TRANSITION_CODE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eINCONSISTENT_CURVE_TRANSITION_CODE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eINCONSISTENT_CURVE_TRANSITION_CODE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eINCONSISTENT_CURVE_TRANSITION_CODE.PartialEntity
    ...
    public var super_eINCONSISTENT_CURVE_TRANSITION_CODE: eINCONSISTENT_CURVE_TRANSITION_CODE { return self } 	// [7]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCONSISTENT_CURVE_TRANSITION_CODE`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eINCONSISTENT_CURVE_TRANSITION_CODE.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eINCONSISTENT_CURVE_TRANSITION_CODE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eINCONSISTENT_CURVE_TRANSITION_CODE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eINCONSISTENT_CURVE_TRANSITION_CODE.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eINCONSISTENT_CURVE_TRANSITION_CODE.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "INCONSISTENT_CURVE_TRANSITION_CODE", 
      ...
      entityDef.add(supertype: eINCONSISTENT_CURVE_TRANSITION_CODE.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "FLAT_CURVATURE_RADIUS_TOLERANCE", 
        keyPath: \eINCONSISTENT_CURVE_TRANSITION_CODE.FLAT_CURVATURE_RADIUS_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ANGLE_TOLERANCE", 
        keyPath: \eINCONSISTENT_CURVE_TRANSITION_CODE.ANGLE_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DISTANCE_TOLERANCE", 
        keyPath: \eINCONSISTENT_CURVE_TRANSITION_CODE.DISTANCE_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CURVATURE_RATIO_TOLERANCE", 
        keyPath: \eINCONSISTENT_CURVE_TRANSITION_CODE.CURVATURE_RATIO_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eINCONSISTENT_CURVE_TRANSITION_CODE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eINCONSISTENT_CURVE_TRANSITION_CODE.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCONSISTENT_CURVE_TRANSITION_CODE``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eINCONSISTENT_CURVE_TRANSITION_CODE.self
      }
      ...
      public static func WHERE_wr1(SELF: eINCONSISTENT_CURVE_TRANSITION_CODE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eINCONSISTENT_CURVE_TRANSITION_CODE.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOOLEAN_VALUE") )
        return _TEMP1
      }
      public static func WHERE_wr2(SELF: eINCONSISTENT_CURVE_TRANSITION_CODE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr3(SELF: eINCONSISTENT_CURVE_TRANSITION_CODE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr4(SELF: eINCONSISTENT_CURVE_TRANSITION_CODE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
