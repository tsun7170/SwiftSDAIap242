/* file: interpolated_configuration_representation.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eINTERPOLATED_CONFIGURATION_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var ITEMS: SDAI.SET<eINTERPOLATED_CONFIGURATION_SEQUENCE.PRef>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eINTERPOLATED_CONFIGURATION_SEQUENCE.PRef>( super_eREPRESENTATION
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      /* override var _items: SDAI.SET<eINTERPOLATED_CONFIGURATION_SEQUENCE.PRef>[1:nil] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
