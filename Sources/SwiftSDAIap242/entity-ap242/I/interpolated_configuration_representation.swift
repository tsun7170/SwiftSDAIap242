/* file: interpolated_configuration_representation.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- interpolated_configuration_representation (line:18515 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERPOLATED_CONFIGURATION_REPRESENTATION/PartialEntity``
*/
  public final class eINTERPOLATED_CONFIGURATION_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eINTERPOLATED_CONFIGURATION_REPRESENTATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eINTERPOLATED_CONFIGURATION_REPRESENTATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eINTERPOLATED_CONFIGURATION_REPRESENTATION.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERPOLATED_CONFIGURATION_REPRESENTATION`` )
    public var ITEMS: SDAI.SET<eINTERPOLATED_CONFIGURATION_SEQUENCE.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = super_eREPRESENTATION.partialEntity._items
        let SELF = super_eREPRESENTATION; SDAI.TOUCH(let:SELF)
        let value =         SDAI.SET<eINTERPOLATED_CONFIGURATION_SEQUENCE.PRef>(
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eINTERPOLATED_CONFIGURATION_REPRESENTATION.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "INTERPOLATED_CONFIGURATION_REPRESENTATION", 
      ...
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eINTERPOLATED_CONFIGURATION_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eINTERPOLATED_CONFIGURATION_REPRESENTATION.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eINTERPOLATED_CONFIGURATION_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eINTERPOLATED_CONFIGURATION_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eINTERPOLATED_CONFIGURATION_REPRESENTATION.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERPOLATED_CONFIGURATION_REPRESENTATION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _context_of_items: eGEOMETRIC_REPRESENTATION_CONTEXT_WITH_PARAMETER.PRef	//EXPLICIT REDEFINITION(eREPRESENTATION) */

      /* override var _items: SDAI.SET<eINTERPOLATED_CONFIGURATION_SEQUENCE.PRef>[1:(nil as SDAI.INTEGER?)] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
