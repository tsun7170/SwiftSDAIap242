/* file: inconsistent_edge_and_curve_directions.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
