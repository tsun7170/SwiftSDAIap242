/* file: inconsistent_edge_and_curve_directions.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _inconsistent_edge_and_curve_directions : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_inconsistent_edge_and_curve_directions``
*/
  public final class eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _inconsistent_edge_and_curve_directions.self
    }
    /// partial entity reference
    public let partialEntity: _inconsistent_edge_and_curve_directions
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_inconsistent_edge_and_curve_directions.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _inconsistent_edge_and_curve_directions.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _inconsistent_edge_and_curve_directions.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _inconsistent_edge_and_curve_directions.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _inconsistent_edge_and_curve_directions.WHERE_wr4(SELF: instance.pRef)
      return result
    }
