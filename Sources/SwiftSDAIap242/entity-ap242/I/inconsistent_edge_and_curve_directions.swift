/* file: inconsistent_edge_and_curve_directions.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- inconsistent_edge_and_curve_directions (line:18056 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _inconsistent_edge_and_curve_directions : SDAI.PartialEntity {
...
```
*/
  public final class eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "INCONSISTENT_EDGE_AND_CURVE_DIRECTIONS", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "DISTANCE_TOLERANCE", keyPath: \eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.DISTANCE_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.NAME, 
