/* file: inconsistent_edge_and_curve_directions.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- inconsistent_edge_and_curve_directions (line:18251 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(6)	erroneous_topology_and_geometry_relationship
    (no local attributes)

  ENTITY(SELF)	inconsistent_edge_and_curve_directions
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS/PartialEntity``
*/
  public final class eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.PartialEntity
    ...
    public let super_eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP: eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP 	// [6]
    public var super_eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS: eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS { return self } 	// [7]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.PartialEntity.self) else { return nil }
      ...
      guard let super6 = complexEntity?.entityReference(eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.self) else { return nil }
      self.super_eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP = super6
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "INCONSISTENT_EDGE_AND_CURVE_DIRECTIONS", 
      ...
      entityDef.add(supertype: eERRONEOUS_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.self)
      entityDef.add(supertype: eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DISTANCE_TOLERANCE", 
        keyPath: \eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.DISTANCE_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.self
      }
      ...
      public static func WHERE_wr1(SELF: eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOOLEAN_VALUE") )
        return _TEMP1
      }
      public static func WHERE_wr2(SELF: eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
            SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.EDGE_CURVE")) ] 
      ...
      public static func WHERE_wr3(SELF: eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
      ...
      public static func WHERE_wr4(SELF: eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.AGGREGATE<runtime> */ = SDAI.BAG<SDAI.STRING>(SDAI.EMPTY_AGGREGATE)
      ...
      public init(DISTANCE_TOLERANCE: tLENGTH_MEASURE) {
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( DISTANCE_TOLERANCE: original._distance_tolerance )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]DISTANCE_TOLERANCE for partial entity(\(Self.entityName)) constructor"); return nil }

        self.init( DISTANCE_TOLERANCE: p0 )
      }
    }
  }
}
