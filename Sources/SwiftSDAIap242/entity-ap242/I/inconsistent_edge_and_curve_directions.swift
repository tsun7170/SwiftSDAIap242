/* file: inconsistent_edge_and_curve_directions.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _inconsistent_edge_and_curve_directions : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = VALIDATE_MEASURED_DATA_TYPE(
        EI: eSHAPE_DATA_QUALITY_CRITERION(/*eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS*/SELF), 
        TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOOLEAN_VALUE"))
      return _TEMP1
    }
    public static func WHERE_wr2(SELF: eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eINCONSISTENT_EDGE_AND_CURVE_DIRECTIONS : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _inconsistent_edge_and_curve_directions.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _inconsistent_edge_and_curve_directions.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _inconsistent_edge_and_curve_directions.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _inconsistent_edge_and_curve_directions.WHERE_wr4(SELF: instance)
      return result
    }
