/* file: inconsistent_face_and_surface_normals.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- inconsistent_face_and_surface_normals (line:18098 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _inconsistent_face_and_surface_normals : SDAI.PartialEntity {
...
```
*/
  public final class eINCONSISTENT_FACE_AND_SURFACE_NORMALS : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eINCONSISTENT_FACE_AND_SURFACE_NORMALS`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "INCONSISTENT_FACE_AND_SURFACE_NORMALS", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eINCONSISTENT_FACE_AND_SURFACE_NORMALS.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eINCONSISTENT_FACE_AND_SURFACE_NORMALS.NAME, 
