/* file: inconsistent_face_and_surface_normals.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eINCONSISTENT_FACE_AND_SURFACE_NORMALS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eINCONSISTENT_FACE_AND_SURFACE_NORMALS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eINCONSISTENT_FACE_AND_SURFACE_NORMALS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eINCONSISTENT_FACE_AND_SURFACE_NORMALS.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eINCONSISTENT_FACE_AND_SURFACE_NORMALS.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
