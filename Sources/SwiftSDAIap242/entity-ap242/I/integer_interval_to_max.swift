/* file: integer_interval_to_max.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  ENTITY integer_interval_to_max
    SUBTYPE OF ( maths_space, generic_literal );
      max  : INTEGER;
  END_ENTITY; -- integer_interval_to_max (line:18230 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _integer_interval_to_max : SDAI.PartialEntity {
...
```
*/
  public final class eINTEGER_INTERVAL_TO_MAX : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eINTEGER_INTERVAL_TO_MAX`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "INTEGER_INTERVAL_TO_MAX", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "MAX", keyPath: \eINTEGER_INTERVAL_TO_MAX.MAX, 
