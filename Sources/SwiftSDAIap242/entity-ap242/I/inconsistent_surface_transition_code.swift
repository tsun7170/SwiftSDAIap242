/* file: inconsistent_surface_transition_code.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- inconsistent_surface_transition_code (line:18289 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(5)	erroneous_data
    (no local attributes)

  SUPER- ENTITY(6)	erroneous_geometry
    (no local attributes)

  ENTITY(SELF)	inconsistent_surface_transition_code
    ...
    ATTR:  angle_tolerance,	TYPE: plane_angle_measure -- EXPLICIT

    ATTR:  curvature_ratio_tolerance,	TYPE: ratio_measure -- EXPLICIT

    ATTR:  distance_tolerance,	TYPE: length_measure -- EXPLICIT
...
- SUPERTYPES:
	...
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eERRONEOUS_DATA``
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eERRONEOUS_GEOMETRY``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCONSISTENT_SURFACE_TRANSITION_CODE/PartialEntity``
*/
  public final class eINCONSISTENT_SURFACE_TRANSITION_CODE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eINCONSISTENT_SURFACE_TRANSITION_CODE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eINCONSISTENT_SURFACE_TRANSITION_CODE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eINCONSISTENT_SURFACE_TRANSITION_CODE.PartialEntity
    ...
    public let super_eERRONEOUS_DATA: eERRONEOUS_DATA 	// [5]
    public let super_eERRONEOUS_GEOMETRY: eERRONEOUS_GEOMETRY 	// [6]
    public var super_eINCONSISTENT_SURFACE_TRANSITION_CODE: eINCONSISTENT_SURFACE_TRANSITION_CODE { return self } 	// [7]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCONSISTENT_SURFACE_TRANSITION_CODE`` )
    public var FLAT_CURVATURE_RADIUS_TOLERANCE: tLENGTH_MEASURE {
      get {
        let originalValue = self.partialEntity._flat_curvature_radius_tolerance
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCONSISTENT_SURFACE_TRANSITION_CODE`` )
    public var ANGLE_TOLERANCE: tPLANE_ANGLE_MEASURE {
      get {
        let originalValue = self.partialEntity._angle_tolerance
        let value = SDAI.UNWRAP( tPLANE_ANGLE_MEASURE( originalValue ) )
        return value
      }
      set(newValue) {
        let partial = self.partialEntity
        partial._angle_tolerance = SDAI.UNWRAP(newValue)
      }
    }

    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCONSISTENT_SURFACE_TRANSITION_CODE`` )
    public var DISTANCE_TOLERANCE: tLENGTH_MEASURE {
      get {
        let originalValue = self.partialEntity._distance_tolerance
        let value = SDAI.UNWRAP( tLENGTH_MEASURE( originalValue ) )
        return value
      }
      set(newValue) {
        let partial = self.partialEntity
        partial._distance_tolerance = SDAI.UNWRAP(newValue)
      }
    }

    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCONSISTENT_SURFACE_TRANSITION_CODE`` )
    public var CURVATURE_RATIO_TOLERANCE: tRATIO_MEASURE {
      get {
        let originalValue = self.partialEntity._curvature_ratio_tolerance
        let value = SDAI.UNWRAP( tRATIO_MEASURE( originalValue ) )
        return value
      }
      set(newValue) {
        let partial = self.partialEntity
        partial._curvature_ratio_tolerance = SDAI.UNWRAP(newValue)
      }
    }

    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCONSISTENT_SURFACE_TRANSITION_CODE`` )
    public var ASSESSMENT_SPECIFICATION: eSHAPE_DATA_QUALITY_ASSESSMENT_BY_LOGICAL_TEST.PRef {
      get {
        let originalValue = super_eSHAPE_DATA_QUALITY_CRITERION.partialEntity._assessment_specification
        let value = SDAI.UNWRAP( eSHAPE_DATA_QUALITY_ASSESSMENT_BY_LOGICAL_TEST.PRef( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eINCONSISTENT_SURFACE_TRANSITION_CODE.PartialEntity.self) else { return nil }
      ...
      guard let super5 = complexEntity?.entityReference(eERRONEOUS_DATA.self) else { return nil }
      self.super_eERRONEOUS_DATA = super5

      guard let super6 = complexEntity?.entityReference(eERRONEOUS_GEOMETRY.self) else { return nil }
      self.super_eERRONEOUS_GEOMETRY = super6
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eINCONSISTENT_SURFACE_TRANSITION_CODE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eINCONSISTENT_SURFACE_TRANSITION_CODE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eINCONSISTENT_SURFACE_TRANSITION_CODE.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eINCONSISTENT_SURFACE_TRANSITION_CODE.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "INCONSISTENT_SURFACE_TRANSITION_CODE", 
      ...
      entityDef.add(supertype: eERRONEOUS_GEOMETRY.self)
      entityDef.add(supertype: eINCONSISTENT_SURFACE_TRANSITION_CODE.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "FLAT_CURVATURE_RADIUS_TOLERANCE", 
        keyPath: \eINCONSISTENT_SURFACE_TRANSITION_CODE.FLAT_CURVATURE_RADIUS_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ANGLE_TOLERANCE", 
        keyPath: \eINCONSISTENT_SURFACE_TRANSITION_CODE.ANGLE_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DISTANCE_TOLERANCE", 
        keyPath: \eINCONSISTENT_SURFACE_TRANSITION_CODE.DISTANCE_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CURVATURE_RATIO_TOLERANCE", 
        keyPath: \eINCONSISTENT_SURFACE_TRANSITION_CODE.CURVATURE_RATIO_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eINCONSISTENT_SURFACE_TRANSITION_CODE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eINCONSISTENT_SURFACE_TRANSITION_CODE.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCONSISTENT_SURFACE_TRANSITION_CODE``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eINCONSISTENT_SURFACE_TRANSITION_CODE.self
      }

      //ATTRIBUTES
      /* override var _assessment_specification: eSHAPE_DATA_QUALITY_ASSESSMENT_BY_LOGICAL_TEST.PRef	//EXPLICIT REDEFINITION(eSHAPE_DATA_QUALITY_CRITERION) */

      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _angle_tolerance: tPLANE_ANGLE_MEASURE // PLAIN EXPLICIT ATTRIBUTE

      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _curvature_ratio_tolerance: tRATIO_MEASURE // PLAIN EXPLICIT ATTRIBUTE

      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _distance_tolerance: tLENGTH_MEASURE // PLAIN EXPLICIT ATTRIBUTE
      ...
      public override func hashAsValue(into hasher: inout Hasher, visited complexEntities: inout Set<SDAI.ComplexEntity>) {
        ...
        self._angle_tolerance.value.hashAsValue(into: &hasher, visited: &complexEntities)
        self._curvature_ratio_tolerance.value.hashAsValue(into: &hasher, visited: &complexEntities)
        self._distance_tolerance.value.hashAsValue(into: &hasher, visited: &complexEntities)
      ...
      public override func isValueEqual(to rhs: SDAI.PartialEntity, visited comppairs: inout Set<SDAI.ComplexPair>) -> Bool {
        ...
        if let comp = self._angle_tolerance.value.isValueEqualOptionally(to: rhs._angle_tolerance.value, visited: &comppairs)	{
          if !comp { return false }
        }
        else { return false }
        if let comp = self._curvature_ratio_tolerance.value.isValueEqualOptionally(to: rhs._curvature_ratio_tolerance.value, visited: &comppairs)	{
          if !comp { return false }
        }
        else { return false }
        if let comp = self._distance_tolerance.value.isValueEqualOptionally(to: rhs._distance_tolerance.value, visited: &comppairs)	{
          if !comp { return false }
        }
        else { return false }
      ...
      public static func WHERE_wr1(SELF: eINCONSISTENT_SURFACE_TRANSITION_CODE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eINCONSISTENT_SURFACE_TRANSITION_CODE.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOOLEAN_VALUE") )
        return _TEMP1
      }
      public static func WHERE_wr2(SELF: eINCONSISTENT_SURFACE_TRANSITION_CODE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr3(SELF: eINCONSISTENT_SURFACE_TRANSITION_CODE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr4(SELF: eINCONSISTENT_SURFACE_TRANSITION_CODE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public init(
        ANGLE_TOLERANCE: tPLANE_ANGLE_MEASURE, 
        CURVATURE_RATIO_TOLERANCE: tRATIO_MEASURE, 
        DISTANCE_TOLERANCE: tLENGTH_MEASURE, 
        FLAT_CURVATURE_RADIUS_TOLERANCE: tLENGTH_MEASURE
      ) {

        self._angle_tolerance = ANGLE_TOLERANCE
        self._curvature_ratio_tolerance = CURVATURE_RATIO_TOLERANCE
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( ANGLE_TOLERANCE: original._angle_tolerance, CURVATURE_RATIO_TOLERANCE: original._curvature_ratio_tolerance, DISTANCE_TOLERANCE: original._distance_tolerance, FLAT_CURVATURE_RADIUS_TOLERANCE: original._flat_curvature_radius_tolerance )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]ANGLE_TOLERANCE for partial entity(\(Self.entityName)) constructor"); return nil }

        guard case .success(let p1) = exchangeStructure.recoverRequiredParameter(as: tRATIO_MEASURE.self, from: parameters[1])
        else { exchangeStructure.add(errorContext: "while recovering parameter [1]CURVATURE_RATIO_TOLERANCE for partial entity(\(Self.entityName)) constructor"); return nil }

        guard case .success(let p2) = exchangeStructure.recoverRequiredParameter(as: tLENGTH_MEASURE.self, from: parameters[2])
        else { exchangeStructure.add(errorContext: "while recovering parameter [2]DISTANCE_TOLERANCE for partial entity(\(Self.entityName)) constructor"); return nil }

        guard case .success(let p3) = exchangeStructure.recoverRequiredParameter(as: tLENGTH_MEASURE.self, from: parameters[3])
        else { exchangeStructure.add(errorContext: "while recovering parameter [3]FLAT_CURVATURE_RADIUS_TOLERANCE for partial entity(\(Self.entityName)) constructor"); return nil }

        self.init( ANGLE_TOLERANCE: p0, CURVATURE_RATIO_TOLERANCE: p1, DISTANCE_TOLERANCE: p2, FLAT_CURVATURE_RADIUS_TOLERANCE: p3 )
      }
    }
  }
}
