/* file: inconsistent_surface_transition_code.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _inconsistent_surface_transition_code : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr2(SELF: eINCONSISTENT_SURFACE_TRANSITION_CODE.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
          SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.RECTANGULAR_COMPOSITE_SURFACE")) ] 
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_inconsistent_surface_transition_code``
*/
  public final class eINCONSISTENT_SURFACE_TRANSITION_CODE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _inconsistent_surface_transition_code.self
    }
    /// partial entity reference
    public let partialEntity: _inconsistent_surface_transition_code
    ...
    public var ANGLE_TOLERANCE: tPLANE_ANGLE_MEASURE {
      get {
        return SDAI.UNWRAP( self.partialEntity._angle_tolerance )
      }
      set(newValue) {
        let partial = self.partialEntity
    ...
    public var DISTANCE_TOLERANCE: tLENGTH_MEASURE {
      get {
        return SDAI.UNWRAP( self.partialEntity._distance_tolerance )
      }
      set(newValue) {
        let partial = self.partialEntity
    ...
    public var CURVATURE_RATIO_TOLERANCE: tRATIO_MEASURE {
      get {
        return SDAI.UNWRAP( self.partialEntity._curvature_ratio_tolerance )
      }
      set(newValue) {
        let partial = self.partialEntity
    ...
    public var ASSESSMENT_SPECIFICATION: eSHAPE_DATA_QUALITY_ASSESSMENT_BY_LOGICAL_TEST.PRef {
      get {
        return SDAI.UNWRAP( eSHAPE_DATA_QUALITY_ASSESSMENT_BY_LOGICAL_TEST.PRef( super_eSHAPE_DATA_QUALITY_CRITERION
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_inconsistent_surface_transition_code.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _inconsistent_surface_transition_code.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _inconsistent_surface_transition_code.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _inconsistent_surface_transition_code.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _inconsistent_surface_transition_code.WHERE_wr4(SELF: instance.pRef)
      return result
    }
