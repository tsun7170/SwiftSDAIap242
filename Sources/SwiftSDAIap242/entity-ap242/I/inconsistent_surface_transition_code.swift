/* file: inconsistent_surface_transition_code.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _inconsistent_surface_transition_code : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eINCONSISTENT_SURFACE_TRANSITION_CODE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = VALIDATE_MEASURED_DATA_TYPE(
        EI: eSHAPE_DATA_QUALITY_CRITERION(/*eINCONSISTENT_SURFACE_TRANSITION_CODE*/SELF), 
        TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOOLEAN_VALUE"))
      return _TEMP1
    }
    public static func WHERE_wr2(SELF: eINCONSISTENT_SURFACE_TRANSITION_CODE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eINCONSISTENT_SURFACE_TRANSITION_CODE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eINCONSISTENT_SURFACE_TRANSITION_CODE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.BAG<SDAI.STRING>(SDAI.EMPTY_AGGREGATE)
    ...
    public init(ANGLE_TOLERANCE: tPLANE_ANGLE_MEASURE, CURVATURE_RATIO_TOLERANCE: tRATIO_MEASURE, 
                DISTANCE_TOLERANCE: tLENGTH_MEASURE, FLAT_CURVATURE_RADIUS_TOLERANCE: tLENGTH_MEASURE) {
...
```
*/
  public final class eINCONSISTENT_SURFACE_TRANSITION_CODE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _inconsistent_surface_transition_code.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _inconsistent_surface_transition_code.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _inconsistent_surface_transition_code.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _inconsistent_surface_transition_code.WHERE_wr4(SELF: instance)
      return result
    }
