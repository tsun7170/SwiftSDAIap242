/* file: incidence_geometric_constraint.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public final class eINCIDENCE_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCIDENCE_GEOMETRIC_CONSTRAINT`` )
    public var REFERENCE_ELEMENTS: SDAI.SET<sGEOMETRIC_CONSTRAINT_ELEMENT>/*[0:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<sGEOMETRIC_CONSTRAINT_ELEMENT>( super_eEXPLICIT_CONSTRAINT.partialEntity
          ._reference_elements ) )
      }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eINCIDENCE_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eINCIDENCE_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eINCIDENCE_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _constrained_elements: SDAI.SET<sGEOMETRIC_CONSTRAINT_ELEMENT>[1:nil] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */

      /* override var _reference_elements: SDAI.SET<sGEOMETRIC_CONSTRAINT_ELEMENT>[0:nil] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */
      ...
      public init(NEAR_POINTS: SDAI.SET<eNEAR_POINT_RELATIONSHIP.PRef>/*[0:nil]*/ ) {
