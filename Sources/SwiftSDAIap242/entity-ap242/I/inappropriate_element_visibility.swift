/* file: inappropriate_element_visibility.swift 	 generated: Sun Oct 31 15:32:10 2021 */
  ...
  ENTITY inappropriate_element_visibility
    ...
    WHERE
      wr1: validate_ecdq_inspected_elements_type( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               + 'STYLED_ITEM' ] );
  END_ENTITY; -- inappropriate_element_visibility (line:17939 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _inappropriate_element_visibility : SDAI.PartialEntity {
...
```
*/
  public final class eINAPPROPRIATE_ELEMENT_VISIBILITY : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "INAPPROPRIATE_ELEMENT_VISIBILITY", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "NAME", keyPath: \eINAPPROPRIATE_ELEMENT_VISIBILITY.NAME, 
