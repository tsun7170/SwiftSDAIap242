/* file: inappropriate_element_visibility.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _inappropriate_element_visibility : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eINAPPROPRIATE_ELEMENT_VISIBILITY?) -> SDAI.LOGICAL {
      ...
      let _TEMP2 = VALIDATE_ECDQ_INSPECTED_ELEMENTS_TYPE(
        EI: eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERION(/*eINAPPROPRIATE_ELEMENT_VISIBILITY*/SELF), 
        TYPE_LIST: _TEMP1)
      return _TEMP2
    }
...
```
*/
  public final class eINAPPROPRIATE_ELEMENT_VISIBILITY : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _inappropriate_element_visibility.WHERE_wr1(SELF: instance)
      return result
    }
