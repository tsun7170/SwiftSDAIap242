/* file: inconsistent_face_and_closed_shell_normals.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- inconsistent_face_and_closed_shell_normals (line:18269 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	inconsistent_face_and_closed_shell_normals
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS/PartialEntity``
*/
  public final class eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS.PartialEntity
    ...
    public var super_eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS: eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS { return self } 	// [7]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "INCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS", 
      ...
      entityDef.add(supertype: eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS.self
      }
      ...
      public static func WHERE_wr1(SELF: eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOOLEAN_VALUE") )
        return _TEMP1
      }
      public static func WHERE_wr2(SELF: eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr3(SELF: eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr4(SELF: eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
