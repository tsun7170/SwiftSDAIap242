/* file: inconsistent_face_and_closed_shell_normals.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _inconsistent_face_and_closed_shell_normals : SDAI.PartialEntity
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_inconsistent_face_and_closed_shell_normals``
*/
  public final class eINCONSISTENT_FACE_AND_CLOSED_SHELL_NORMALS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _inconsistent_face_and_closed_shell_normals.self
    }
    /// partial entity reference
    public let partialEntity: _inconsistent_face_and_closed_shell_normals
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_inconsistent_face_and_closed_shell_normals.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _inconsistent_face_and_closed_shell_normals.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _inconsistent_face_and_closed_shell_normals.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _inconsistent_face_and_closed_shell_normals.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _inconsistent_face_and_closed_shell_normals.WHERE_wr4(SELF: instance.pRef)
      return result
    }
