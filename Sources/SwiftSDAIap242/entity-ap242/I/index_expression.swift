/* file: index_expression.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- index_expression (line:18110 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _index_expression : SDAI.PartialEntity {
...
```
*/
  public final class eINDEX_EXPRESSION : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "INDEX_EXPRESSION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "OPERANDS", keyPath: \eINDEX_EXPRESSION.OPERANDS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "INDEX", keyPath: \eINDEX_EXPRESSION.INDEX, 
        kind: .derived, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "OPERAND", keyPath: \eINDEX_EXPRESSION.OPERAND, 
        kind: .derived, source: .thisEntity, mayYieldEntityReference: true)
