/* file: index_expression.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _index_expression : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /// DERIVE ATTRIBUTE
    internal func _operand__getter(SELF: eINDEX_EXPRESSION) -> eGENERIC_EXPRESSION?  {
    ...
    /// DERIVE ATTRIBUTE
    internal func _index__getter(SELF: eINDEX_EXPRESSION) -> eGENERIC_EXPRESSION?  {
    ...
    public static func WHERE_wr1(SELF: eINDEX_EXPRESSION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.TYPEOF(SELF.OPERAND, IS: eSTRING_EXPRESSION.self)
      let _TEMP2 = SDAI.TYPEOF(SELF.INDEX, IS: eNUMERIC_EXPRESSION.self)
      let _TEMP3 = _TEMP1 && _TEMP2
      return _TEMP3
    }
    public static func WHERE_wr2(SELF: eINDEX_EXPRESSION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = IS_INT_EXPR(eNUMERIC_EXPRESSION(/*eGENERIC_EXPRESSION*/SELF.INDEX))
...
```
*/
  public final class eINDEX_EXPRESSION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _index_expression.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _index_expression.WHERE_wr2(SELF: instance)
      return result
    }
