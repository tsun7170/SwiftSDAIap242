/* file: intersecting_connected_face_sets.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eINTERSECTING_CONNECTED_FACE_SETS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eINTERSECTING_CONNECTED_FACE_SETS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eINTERSECTING_CONNECTED_FACE_SETS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eINTERSECTING_CONNECTED_FACE_SETS.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eINTERSECTING_CONNECTED_FACE_SETS.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
