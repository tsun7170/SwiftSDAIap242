/* file: intersecting_connected_face_sets.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- intersecting_connected_face_sets (line:18359 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _intersecting_connected_face_sets : SDAI.PartialEntity {
...
```
*/
  public final class eINTERSECTING_CONNECTED_FACE_SETS : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eINTERSECTING_CONNECTED_FACE_SETS`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "INTERSECTING_CONNECTED_FACE_SETS", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "INTERFERENCE_TOLERANCE", keyPath: \eINTERSECTING_CONNECTED_FACE_SETS.INTERFERENCE_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eINTERSECTING_CONNECTED_FACE_SETS.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eINTERSECTING_CONNECTED_FACE_SETS.NAME, 
