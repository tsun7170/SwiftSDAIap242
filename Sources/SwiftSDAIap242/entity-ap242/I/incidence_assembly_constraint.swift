/* file: incidence_assembly_constraint.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- incidence_assembly_constraint (line:18180 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(11)	incidence_geometric_constraint
  ...
  ENTITY(SELF)	incidence_assembly_constraint
    (no local attributes)
...
- SUPERTYPES:
	...
	11.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCIDENCE_GEOMETRIC_CONSTRAINT``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCIDENCE_ASSEMBLY_CONSTRAINT/PartialEntity``
*/
  public final class eINCIDENCE_ASSEMBLY_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eINCIDENCE_ASSEMBLY_CONSTRAINT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eINCIDENCE_ASSEMBLY_CONSTRAINT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eINCIDENCE_ASSEMBLY_CONSTRAINT.PartialEntity
    ...
    public let super_eINCIDENCE_GEOMETRIC_CONSTRAINT: eINCIDENCE_GEOMETRIC_CONSTRAINT 	// [11]
    public var super_eINCIDENCE_ASSEMBLY_CONSTRAINT: eINCIDENCE_ASSEMBLY_CONSTRAINT { return self } 	// [12]
    ...
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCIDENCE_GEOMETRIC_CONSTRAINT`` )
    ...
    public var NEAR_POINTS: SDAI.SET<eNEAR_POINT_RELATIONSHIP.PRef>/*[0:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = super_eINCIDENCE_GEOMETRIC_CONSTRAINT.partialEntity._near_points
        let value = SDAI.UNWRAP( SDAI.SET<eNEAR_POINT_RELATIONSHIP.PRef>( originalValue ) )
        return value
      }
      set(newValue) {
        let partial = super_eINCIDENCE_GEOMETRIC_CONSTRAINT.partialEntity
        let SELF = super_eINCIDENCE_GEOMETRIC_CONSTRAINT; SDAI.TOUCH(let:SELF)
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eINCIDENCE_ASSEMBLY_CONSTRAINT.PartialEntity.self) else { return nil }
      ...
      guard let super11 = complexEntity?.entityReference(eINCIDENCE_GEOMETRIC_CONSTRAINT.self) else { return nil }
      self.super_eINCIDENCE_GEOMETRIC_CONSTRAINT = super11
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eINCIDENCE_ASSEMBLY_CONSTRAINT.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "TRANSFORMATION_OPERATOR", 
        keyPath: \eINCIDENCE_ASSEMBLY_CONSTRAINT.TRANSFORMATION_OPERATOR, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", 
        keyPath: \eINCIDENCE_ASSEMBLY_CONSTRAINT.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", 
        keyPath: \eINCIDENCE_ASSEMBLY_CONSTRAINT.REFERENCE_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_1", 
        keyPath: \eINCIDENCE_ASSEMBLY_CONSTRAINT.REP_1, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_2", 
        keyPath: \eINCIDENCE_ASSEMBLY_CONSTRAINT.REP_2, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NEAR_POINTS", 
        keyPath: \eINCIDENCE_ASSEMBLY_CONSTRAINT.NEAR_POINTS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DIM", 
        keyPath: \eINCIDENCE_ASSEMBLY_CONSTRAINT.DIM, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCIDENCE_ASSEMBLY_CONSTRAINT``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eINCIDENCE_ASSEMBLY_CONSTRAINT.self
      }
