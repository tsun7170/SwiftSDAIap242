/* file: indistinct_curve_knots.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _indistinct_curve_knots : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_indistinct_curve_knots``
*/
  public final class eINDISTINCT_CURVE_KNOTS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _indistinct_curve_knots.self
    }
    /// partial entity reference
    public let partialEntity: _indistinct_curve_knots
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_indistinct_curve_knots.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _indistinct_curve_knots.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _indistinct_curve_knots.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _indistinct_curve_knots.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _indistinct_curve_knots.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _indistinct_curve_knots.WHERE_wr5(SELF: instance.pRef)
      return result
    }
