/* file: indistinct_curve_knots.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _indistinct_curve_knots : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eINDISTINCT_CURVE_KNOTS?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eINDISTINCT_CURVE_KNOTS?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = VALIDATE_MEASURED_DATA_TYPE(
        EI: eSHAPE_DATA_QUALITY_CRITERION(/*eINDISTINCT_CURVE_KNOTS*/SELF), 
        TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PARAMETER_VALUE"))
      return _TEMP1
    }
    public static func WHERE_wr3(SELF: eINDISTINCT_CURVE_KNOTS?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eINDISTINCT_CURVE_KNOTS?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr5(SELF: eINDISTINCT_CURVE_KNOTS?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eINDISTINCT_CURVE_KNOTS : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _indistinct_curve_knots.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _indistinct_curve_knots.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _indistinct_curve_knots.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _indistinct_curve_knots.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _indistinct_curve_knots.WHERE_wr5(SELF: instance)
      return result
    }
