/* file: inapt_topology_and_geometry_relationship.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- inapt_topology_and_geometry_relationship (line:18171 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSELF_INTERSECTING_SHELL``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERSECTING_CONNECTED_FACE_SETS``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSELF_INTERSECTING_LOOP``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY``
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHORT_LENGTH_EDGE``
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSMALL_AREA_FACE``
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eENTIRELY_NARROW_FACE``
	8.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTOPOLOGY_RELATED_TO_NEARLY_DEGENERATE_GEOMETRY``
	9.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTIPLY_DEFINED_FACES``
	10.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTIPLY_DEFINED_EDGES``
	11.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTIPLY_DEFINED_VERTICES``
	12.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTOPOLOGY_RELATED_TO_MULTIPLY_DEFINED_GEOMETRY``
	13.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGAP_BETWEEN_PCURVES_RELATED_TO_AN_EDGE``
	14.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGAP_BETWEEN_EDGE_AND_BASE_SURFACE``
	15.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGAP_BETWEEN_VERTEX_AND_EDGE``
	16.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGAP_BETWEEN_ADJACENT_EDGES_IN_LOOP``
	17.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGAP_BETWEEN_FACES_RELATED_TO_AN_EDGE``
	18.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGAP_BETWEEN_VERTEX_AND_BASE_SURFACE``
	19.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGEOMETRIC_GAP_IN_TOPOLOGY``
	20.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES``
	21.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eG1_DISCONTINUITY_BETWEEN_ADJACENT_FACES``
	22.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNON_SMOOTH_GEOMETRY_TRANSITION_ACROSS_EDGE``
	23.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES``
	24.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES``
	25.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTEEP_GEOMETRY_TRANSITION_ACROSS_EDGE``
	26.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARTLY_OVERLAPPING_EDGES``
	27.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARTLY_OVERLAPPING_FACES``
	28.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTOPOLOGY_RELATED_TO_OVERLAPPING_GEOMETRY``
	29.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eUNUSED_PATCHES``
	30.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEDGE_WITH_EXCESSIVE_SEGMENTS``
	31.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION``
	32.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eOVERCOMPLEX_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINAPT_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP/PartialEntity``
*/
  public final class eINAPT_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eINAPT_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eINAPT_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eINAPT_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.PartialEntity
    ...
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES`` )
    public var FLAT_CURVATURE_RADIUS_TOLERANCE: tLENGTH_MEASURE?  {
      get {
        let originalValue = sub_eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES?.partialEntity
          ._flat_curvature_radius_tolerance
        let value = tLENGTH_MEASURE( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES?.partialEntity
          else { return }
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eENTIRELY_NARROW_FACE`` )
    public var WIDTH_TOLERANCE: tLENGTH_MEASURE?  {
      get {
        let originalValue = sub_eENTIRELY_NARROW_FACE?.partialEntity._width_tolerance
        let value = tLENGTH_MEASURE( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eENTIRELY_NARROW_FACE?.partialEntity
          else { return }
    ...
    public var ASSESSMENT_SPECIFICATION_2: eSHAPE_DATA_QUALITY_ASSESSMENT_BY_NUMERICAL_TEST.PRef?  {
      get {
        let originalValue = sub_eG2_DISCONTINUITY_BETWEEN_ADJACENT_FACES?.partialEntity
          ._assessment_specification_2
        let value = eSHAPE_DATA_QUALITY_ASSESSMENT_BY_NUMERICAL_TEST.PRef( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSELF_INTERSECTING_SHELL`` )
    public var GEODESIC_SEPARATION_FACTOR: SDAI.REAL?  {
      get {
        let originalValue = sub_eSELF_INTERSECTING_SHELL?.partialEntity._geodesic_separation_factor
        let value = SDAI.REAL( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eSELF_INTERSECTING_SHELL?.partialEntity
          else { return }
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eINAPT_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "INAPT_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP", 
      ...
      entityDef.addAttribute(name: "FLAT_CURVATURE_RADIUS_TOLERANCE", 
        keyPath: \eINAPT_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.FLAT_CURVATURE_RADIUS_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ARC_LENGTH_DISTANCE_FACTOR", 
        keyPath: \eINAPT_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.ARC_LENGTH_DISTANCE_FACTOR, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "WIDTH_TOLERANCE", 
        keyPath: \eINAPT_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.WIDTH_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION_2", 
        keyPath: \eINAPT_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.ASSESSMENT_SPECIFICATION_2, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eINAPT_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "GEODESIC_SEPARATION_FACTOR", 
        keyPath: \eINAPT_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.GEODESIC_SEPARATION_FACTOR, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eINAPT_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINAPT_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP``
*/
