/* file: intersecting_loops_in_face.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- intersecting_loops_in_face (line:18360 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _intersecting_loops_in_face : SDAI.PartialEntity {
...
```
*/
  public final class eINTERSECTING_LOOPS_IN_FACE : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eINTERSECTING_LOOPS_IN_FACE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "INTERSECTING_LOOPS_IN_FACE", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "INTERFERENCE_TOLERANCE", keyPath: \eINTERSECTING_LOOPS_IN_FACE.INTERFERENCE_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eINTERSECTING_LOOPS_IN_FACE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eINTERSECTING_LOOPS_IN_FACE.NAME, 
