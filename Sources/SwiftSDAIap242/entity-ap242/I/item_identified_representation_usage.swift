/* file: item_identified_representation_usage.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _item_identified_representation_usage : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_item_identified_representation_usage``
*/
  public final class eITEM_IDENTIFIED_REPRESENTATION_USAGE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _item_identified_representation_usage.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _item_identified_representation_usage.WHERE_wr2(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addUniquenessRule(label:"UNIQUE_ur1", rule: _item_identified_representation_usage.UNIQUE_ur1)
      entityDef.addUniquenessRule(label:"UNIQUE_ur2", rule: _item_identified_representation_usage.UNIQUE_ur2)
