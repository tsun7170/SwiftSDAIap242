/* file: inconsistent_adjacent_face_normals.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- inconsistent_adjacent_face_normals (line:18225 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(6)	erroneous_topology
    (no local attributes)

  ENTITY(SELF)	inconsistent_adjacent_face_normals
...
- SUPERTYPES:
	...
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eERRONEOUS_TOPOLOGY``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCONSISTENT_ADJACENT_FACE_NORMALS/PartialEntity``
*/
  public final class eINCONSISTENT_ADJACENT_FACE_NORMALS : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eINCONSISTENT_ADJACENT_FACE_NORMALS>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eINCONSISTENT_ADJACENT_FACE_NORMALS.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eINCONSISTENT_ADJACENT_FACE_NORMALS.PartialEntity
    ...
    public let super_eERRONEOUS_TOPOLOGY: eERRONEOUS_TOPOLOGY 	// [6]
    public var super_eINCONSISTENT_ADJACENT_FACE_NORMALS: eINCONSISTENT_ADJACENT_FACE_NORMALS { return self } 	// [7]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCONSISTENT_ADJACENT_FACE_NORMALS`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eINCONSISTENT_ADJACENT_FACE_NORMALS.PartialEntity.self) else { return nil }
      ...
      guard let super6 = complexEntity?.entityReference(eERRONEOUS_TOPOLOGY.self) else { return nil }
      self.super_eERRONEOUS_TOPOLOGY = super6
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eINCONSISTENT_ADJACENT_FACE_NORMALS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eINCONSISTENT_ADJACENT_FACE_NORMALS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eINCONSISTENT_ADJACENT_FACE_NORMALS.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eINCONSISTENT_ADJACENT_FACE_NORMALS.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "INCONSISTENT_ADJACENT_FACE_NORMALS", 
      ...
      entityDef.add(supertype: eERRONEOUS_TOPOLOGY.self)
      entityDef.add(supertype: eINCONSISTENT_ADJACENT_FACE_NORMALS.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eINCONSISTENT_ADJACENT_FACE_NORMALS.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eINCONSISTENT_ADJACENT_FACE_NORMALS.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINCONSISTENT_ADJACENT_FACE_NORMALS``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eINCONSISTENT_ADJACENT_FACE_NORMALS.self
      }
      ...
      public static func WHERE_wr1(SELF: eINCONSISTENT_ADJACENT_FACE_NORMALS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eINCONSISTENT_ADJACENT_FACE_NORMALS.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOOLEAN_VALUE") )
        return _TEMP1
      }
      public static func WHERE_wr2(SELF: eINCONSISTENT_ADJACENT_FACE_NORMALS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
            SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.CLOSED_OR_OPEN_SHELL_SELECT")) ] 
      ...
      public static func WHERE_wr3(SELF: eINCONSISTENT_ADJACENT_FACE_NORMALS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr4(SELF: eINCONSISTENT_ADJACENT_FACE_NORMALS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
