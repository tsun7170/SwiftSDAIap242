/* file: inconsistent_adjacent_face_normals.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eINCONSISTENT_ADJACENT_FACE_NORMALS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eINCONSISTENT_ADJACENT_FACE_NORMALS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eINCONSISTENT_ADJACENT_FACE_NORMALS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eINCONSISTENT_ADJACENT_FACE_NORMALS.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eINCONSISTENT_ADJACENT_FACE_NORMALS.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
