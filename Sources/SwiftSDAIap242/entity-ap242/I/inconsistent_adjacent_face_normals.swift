/* file: inconsistent_adjacent_face_normals.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- inconsistent_adjacent_face_normals (line:18030 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _inconsistent_adjacent_face_normals : SDAI.PartialEntity {
...
```
*/
  public final class eINCONSISTENT_ADJACENT_FACE_NORMALS : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eINCONSISTENT_ADJACENT_FACE_NORMALS`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "INCONSISTENT_ADJACENT_FACE_NORMALS", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eINCONSISTENT_ADJACENT_FACE_NORMALS.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eINCONSISTENT_ADJACENT_FACE_NORMALS.NAME, 
