/* file: interface_connector_design_to_realized.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- interface_connector_design_to_realized (line:18290 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _interface_connector_design_to_realized : SDAI.PartialEntity {
...
```
*/
  public final class eINTERFACE_CONNECTOR_DESIGN_TO_REALIZED : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eINTERFACE_CONNECTOR_DESIGN_TO_REALIZED`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "INTERFACE_CONNECTOR_DESIGN_TO_REALIZED", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eINTERFACE_CONNECTOR_DESIGN_TO_REALIZED.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATED_PRODUCT_DEFINITION_FORMATION", keyPath: \eINTERFACE_CONNECTOR_DESIGN_TO_REALIZED.RELATED_PRODUCT_DEFINITION_FORMATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "RELATING_PRODUCT_DEFINITION_FORMATION", keyPath: \eINTERFACE_CONNECTOR_DESIGN_TO_REALIZED.RELATING_PRODUCT_DEFINITION_FORMATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eINTERFACE_CONNECTOR_DESIGN_TO_REALIZED.ID, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eINTERFACE_CONNECTOR_DESIGN_TO_REALIZED.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
