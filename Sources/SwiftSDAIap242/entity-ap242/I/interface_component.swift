/* file: interface_component.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- interface_component (line:18439 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(7)	physical_component
    (no local attributes)

  ENTITY(SELF)	interface_component
    (no local attributes)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACE_COMPONENT/PartialEntity``
*/
  public final class eINTERFACE_COMPONENT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eINTERFACE_COMPONENT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eINTERFACE_COMPONENT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eINTERFACE_COMPONENT.PartialEntity
    ...
    public let super_ePHYSICAL_COMPONENT: ePHYSICAL_COMPONENT 	// [7]
    public var super_eINTERFACE_COMPONENT: eINTERFACE_COMPONENT { return self } 	// [8]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eINTERFACE_COMPONENT.PartialEntity.self) else { return nil }
      ...
      guard let super7 = complexEntity?.entityReference(ePHYSICAL_COMPONENT.self) else { return nil }
      self.super_ePHYSICAL_COMPONENT = super7
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: ePHYSICAL_COMPONENT.self)
      entityDef.add(supertype: eINTERFACE_COMPONENT.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "RELATING_PRODUCT_DEFINITION", 
        keyPath: \eINTERFACE_COMPONENT.RELATING_PRODUCT_DEFINITION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "FRAME_OF_REFERENCE", 
        keyPath: \eINTERFACE_COMPONENT.FRAME_OF_REFERENCE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DEFINITION", 
        keyPath: \eINTERFACE_COMPONENT.DEFINITION, 
      ...
      entityDef.addAttribute(name: "RELATED_PRODUCT_DEFINITION", 
        keyPath: \eINTERFACE_COMPONENT.RELATED_PRODUCT_DEFINITION, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "FORMATION", 
        keyPath: \eINTERFACE_COMPONENT.FORMATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
