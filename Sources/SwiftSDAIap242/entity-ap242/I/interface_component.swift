/* file: interface_component.swift 	 generated: Mon Dec 15 17:41:04 2025 */
...
*/
  ...
  public final class _interface_component : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_interface_component``
*/
  public final class eINTERFACE_COMPONENT : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _interface_component.self
    }
    /// partial entity reference
    public let partialEntity: _interface_component
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_interface_component.self) else { return nil }
