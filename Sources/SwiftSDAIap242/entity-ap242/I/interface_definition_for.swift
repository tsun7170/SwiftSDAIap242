/* file: interface_definition_for.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _interface_definition_for : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_interface_definition_for``
*/
  public final class eINTERFACE_DEFINITION_FOR : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _interface_definition_for.self
    }
    /// partial entity reference
    public let partialEntity: _interface_definition_for
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_interface_definition_for.self) else { return nil }
