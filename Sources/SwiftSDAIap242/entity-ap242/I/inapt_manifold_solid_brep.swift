/* file: inapt_manifold_solid_brep.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eINAPT_MANIFOLD_SOLID_BREP : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var INTERFERENCE_TOLERANCE: tLENGTH_MEASURE?  {
      get {
        return sub_ePARTLY_OVERLAPPING_SOLIDS?.partialEntity._interference_tolerance
      }
      set(newValue) {
        guard let partial = sub_ePARTLY_OVERLAPPING_SOLIDS?.super_ePARTLY_OVERLAPPING_SOLIDS.partialEntity
          else { return }
    ...
    public var WIDTH_TOLERANCE: tLENGTH_MEASURE?  {
      get {
        return sub_eENTIRELY_NARROW_SOLID?.partialEntity._width_tolerance
      }
      set(newValue) {
        guard let partial = sub_eENTIRELY_NARROW_SOLID?.super_eENTIRELY_NARROW_SOLID.partialEntity
          else { return }
