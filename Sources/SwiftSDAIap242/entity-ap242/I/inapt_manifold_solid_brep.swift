/* file: inapt_manifold_solid_brep.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- inapt_manifold_solid_brep (line:17965 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _inapt_manifold_solid_brep : SDAI.PartialEntity {
...
```
*/
  public final class eINAPT_MANIFOLD_SOLID_BREP : SDAI.EntityReference {
    ...
    /// - origin: SUB( ``ePARTLY_OVERLAPPING_SOLIDS`` )
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUB( ``eENTIRELY_NARROW_SOLID`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "INAPT_MANIFOLD_SOLID_BREP", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "INTERFERENCE_TOLERANCE", keyPath: \eINAPT_MANIFOLD_SOLID_BREP.INTERFERENCE_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "WIDTH_TOLERANCE", keyPath: \eINAPT_MANIFOLD_SOLID_BREP.WIDTH_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eINAPT_MANIFOLD_SOLID_BREP.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eINAPT_MANIFOLD_SOLID_BREP.NAME, 
