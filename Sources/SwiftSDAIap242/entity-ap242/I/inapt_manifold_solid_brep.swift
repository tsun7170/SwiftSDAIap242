/* file: inapt_manifold_solid_brep.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- inapt_manifold_solid_brep (line:18160 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	inapt_manifold_solid_brep
    (no local attributes)

  SUB- ENTITY(7)	entirely_narrow_solid
  ...
  SUB- ENTITY(10)	multiply_defined_solids
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(11)	small_volume_solid
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eENTIRELY_NARROW_SOLID``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSOLID_WITH_EXCESSIVE_NUMBER_OF_VOIDS``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARTLY_OVERLAPPING_SOLIDS``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTIPLY_DEFINED_SOLIDS``
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSMALL_VOLUME_SOLID``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINAPT_MANIFOLD_SOLID_BREP/PartialEntity``
*/
  public final class eINAPT_MANIFOLD_SOLID_BREP : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eINAPT_MANIFOLD_SOLID_BREP>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eINAPT_MANIFOLD_SOLID_BREP.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eINAPT_MANIFOLD_SOLID_BREP.PartialEntity
    ...
    public var super_eINAPT_MANIFOLD_SOLID_BREP: eINAPT_MANIFOLD_SOLID_BREP { return self } 	// [6]

    //MARK: SUBTYPES
    public var sub_eENTIRELY_NARROW_SOLID: eENTIRELY_NARROW_SOLID? {	// [7]
      return self.complexEntity.entityReference(eENTIRELY_NARROW_SOLID.self)
    }

    public var sub_eSOLID_WITH_EXCESSIVE_NUMBER_OF_VOIDS: eSOLID_WITH_EXCESSIVE_NUMBER_OF_VOIDS? {	// [8]
      return self.complexEntity.entityReference(eSOLID_WITH_EXCESSIVE_NUMBER_OF_VOIDS.self)
    }

    public var sub_ePARTLY_OVERLAPPING_SOLIDS: ePARTLY_OVERLAPPING_SOLIDS? {	// [9]
      return self.complexEntity.entityReference(ePARTLY_OVERLAPPING_SOLIDS.self)
    }

    public var sub_eMULTIPLY_DEFINED_SOLIDS: eMULTIPLY_DEFINED_SOLIDS? {	// [10]
      return self.complexEntity.entityReference(eMULTIPLY_DEFINED_SOLIDS.self)
    }

    public var sub_eSMALL_VOLUME_SOLID: eSMALL_VOLUME_SOLID? {	// [11]
    ...
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARTLY_OVERLAPPING_SOLIDS`` )
    public var INTERFERENCE_TOLERANCE: tLENGTH_MEASURE?  {
      get {
        let originalValue = sub_ePARTLY_OVERLAPPING_SOLIDS?.partialEntity._interference_tolerance
        let value = tLENGTH_MEASURE( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_ePARTLY_OVERLAPPING_SOLIDS?.partialEntity
          else { return }
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eENTIRELY_NARROW_SOLID`` )
    public var WIDTH_TOLERANCE: tLENGTH_MEASURE?  {
      get {
        let originalValue = sub_eENTIRELY_NARROW_SOLID?.partialEntity._width_tolerance
        let value = tLENGTH_MEASURE( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eENTIRELY_NARROW_SOLID?.partialEntity
          else { return }
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eINAPT_MANIFOLD_SOLID_BREP.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "INAPT_MANIFOLD_SOLID_BREP", 
      ...
      entityDef.addAttribute(name: "INTERFERENCE_TOLERANCE", 
        keyPath: \eINAPT_MANIFOLD_SOLID_BREP.INTERFERENCE_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "WIDTH_TOLERANCE", 
        keyPath: \eINAPT_MANIFOLD_SOLID_BREP.WIDTH_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eINAPT_MANIFOLD_SOLID_BREP.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eINAPT_MANIFOLD_SOLID_BREP.NAME, 
