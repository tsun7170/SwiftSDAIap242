/* file: inapt_manifold_solid_brep.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _inapt_manifold_solid_brep : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_inapt_manifold_solid_brep``
*/
  public final class eINAPT_MANIFOLD_SOLID_BREP : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _inapt_manifold_solid_brep.self
    }
    /// partial entity reference
    public let partialEntity: _inapt_manifold_solid_brep
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_inapt_manifold_solid_brep.self) else { return nil }
