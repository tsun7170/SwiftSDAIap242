/* file: item_defined_transformation.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _item_defined_transformation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public required convenience init?(
      ...
      guard case .success(let p2) = exchangeStructure.recoverRequiredParameter(as: eREPRESENTATION_ITEM.PRef.self, from: parameters[2])
      ...
      guard case .success(let p3) = exchangeStructure.recoverRequiredParameter(as: eREPRESENTATION_ITEM.PRef.self, from: parameters[3])
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_item_defined_transformation``
*/
