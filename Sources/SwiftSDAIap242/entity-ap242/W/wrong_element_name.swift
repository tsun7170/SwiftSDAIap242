/* file: wrong_element_name.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY wrong_element_name
    ...
    WHERE
      wr1: validate_ecdq_inspected_elements_type( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               + 'REPRESENTATION_ITEM' ] );
  END_ENTITY; -- wrong_element_name (line:33871 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _wrong_element_name : SDAI.PartialEntity {
...
```
*/
  public final class eWRONG_ELEMENT_NAME : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "WRONG_ELEMENT_NAME", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "NAME", keyPath: \eWRONG_ELEMENT_NAME.NAME, 
