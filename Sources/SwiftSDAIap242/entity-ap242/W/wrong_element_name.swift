/* file: wrong_element_name.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _wrong_element_name : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eWRONG_ELEMENT_NAME?) -> SDAI.LOGICAL {
      ...
      let _TEMP2 = VALIDATE_ECDQ_INSPECTED_ELEMENTS_TYPE(
        EI: eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERION(/*eWRONG_ELEMENT_NAME*/SELF), 
        TYPE_LIST: _TEMP1)
      return _TEMP2
    }
...
```
*/
  public final class eWRONG_ELEMENT_NAME : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _wrong_element_name.WHERE_wr1(SELF: instance)
      return result
    }
