/* file: wrongly_oriented_void.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- wrongly_oriented_void (line:33864 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _wrongly_oriented_void : SDAI.PartialEntity {
...
```
*/
  public final class eWRONGLY_ORIENTED_VOID : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eWRONGLY_ORIENTED_VOID`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "WRONGLY_ORIENTED_VOID", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eWRONGLY_ORIENTED_VOID.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eWRONGLY_ORIENTED_VOID.NAME, 
