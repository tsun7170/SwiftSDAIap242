/* file: wrongly_placed_void.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- wrongly_placed_void (line:33899 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _wrongly_placed_void : SDAI.PartialEntity {
...
```
*/
  public final class eWRONGLY_PLACED_VOID : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eWRONGLY_PLACED_VOID`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "WRONGLY_PLACED_VOID", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eWRONGLY_PLACED_VOID.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eWRONGLY_PLACED_VOID.NAME, 
