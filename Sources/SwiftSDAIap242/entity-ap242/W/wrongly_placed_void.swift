/* file: wrongly_placed_void.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eWRONGLY_PLACED_VOID : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eWRONGLY_PLACED_VOID.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eWRONGLY_PLACED_VOID.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eWRONGLY_PLACED_VOID.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eWRONGLY_PLACED_VOID.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
