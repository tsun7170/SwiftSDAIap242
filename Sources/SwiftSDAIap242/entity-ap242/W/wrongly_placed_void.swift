/* file: wrongly_placed_void.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- wrongly_placed_void (line:34197 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	wrongly_placed_void
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eWRONGLY_PLACED_VOID/PartialEntity``
*/
  public final class eWRONGLY_PLACED_VOID : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eWRONGLY_PLACED_VOID>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eWRONGLY_PLACED_VOID.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eWRONGLY_PLACED_VOID.PartialEntity
    ...
    public var super_eWRONGLY_PLACED_VOID: eWRONGLY_PLACED_VOID { return self } 	// [7]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eWRONGLY_PLACED_VOID`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eWRONGLY_PLACED_VOID.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eWRONGLY_PLACED_VOID.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eWRONGLY_PLACED_VOID.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eWRONGLY_PLACED_VOID.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eWRONGLY_PLACED_VOID.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eWRONGLY_PLACED_VOID.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eWRONGLY_PLACED_VOID.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eWRONGLY_PLACED_VOID.NAME, 
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: eWRONGLY_PLACED_VOID.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eWRONGLY_PLACED_VOID.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOOLEAN_VALUE") )
        return _TEMP1
      }
      public static func WHERE_wr2(SELF: eWRONGLY_PLACED_VOID.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
      ...
      public static func WHERE_wr3(SELF: eWRONGLY_PLACED_VOID.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
      ...
      public static func WHERE_wr4(SELF: eWRONGLY_PLACED_VOID.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
