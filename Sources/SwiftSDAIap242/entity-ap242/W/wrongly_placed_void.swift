/* file: wrongly_placed_void.swift 	 generated: Thu Dec 25 18:13:23 2025 */
...
*/
  ...
  public final class _wrongly_placed_void : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_wrongly_placed_void``
*/
  public final class eWRONGLY_PLACED_VOID : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _wrongly_placed_void.self
    }
    /// partial entity reference
    public let partialEntity: _wrongly_placed_void
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_wrongly_placed_void.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _wrongly_placed_void.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _wrongly_placed_void.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _wrongly_placed_void.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _wrongly_placed_void.WHERE_wr4(SELF: instance.pRef)
      return result
    }
