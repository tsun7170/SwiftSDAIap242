/* file: high_degree_planar_surface.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _high_degree_planar_surface : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_high_degree_planar_surface``
*/
  public final class eHIGH_DEGREE_PLANAR_SURFACE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _high_degree_planar_surface.self
    }
    /// partial entity reference
    public let partialEntity: _high_degree_planar_surface
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_high_degree_planar_surface.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _high_degree_planar_surface.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _high_degree_planar_surface.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _high_degree_planar_surface.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _high_degree_planar_surface.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _high_degree_planar_surface.WHERE_wr5(SELF: instance.pRef)
      return result
    }
