/* file: high_degree_planar_surface.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- high_degree_planar_surface (line:17509 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _high_degree_planar_surface : SDAI.PartialEntity {
...
```
*/
  public final class eHIGH_DEGREE_PLANAR_SURFACE : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eHIGH_DEGREE_PLANAR_SURFACE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "HIGH_DEGREE_PLANAR_SURFACE", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "APPROXIMATION_TOLERANCE", keyPath: \eHIGH_DEGREE_PLANAR_SURFACE.APPROXIMATION_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eHIGH_DEGREE_PLANAR_SURFACE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eHIGH_DEGREE_PLANAR_SURFACE.NAME, 
