/* file: hole_bottom.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _hole_bottom : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eHOLE_BOTTOM?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.TYPEOF(SELF.OF_SHAPE.DEFINITION, IS: eFEATURE_COMPONENT_DEFINITION.self)
      return _TEMP1
    }
    public static func WHERE_wr2(SELF: eHOLE_BOTTOM?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.DESCRIPTION
      let _TEMP2 = ([SDAI.AIE(SDAI.STRING("through")), 
    ...
    public static func WHERE_wr3(SELF: eHOLE_BOTTOM?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eHOLE_BOTTOM?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.DESCRIPTION
      let _TEMP2 = ([SDAI.AIE(SDAI.STRING("flat with radius")), 
        SDAI.AIE(SDAI.STRING("flat with taper")), 
        SDAI.AIE(SDAI.STRING("spherical")), 
        SDAI.AIE(SDAI.STRING("conical"))] as [SDAI.AggregationInitializerElement<SDAI.STRING>])
      let _TEMP3 = SDAI.aggregate(_TEMP2, contains: SDAI.STRING(/*tTEXT*/_TEMP1))
    ...
    public static func WHERE_wr5(SELF: eHOLE_BOTTOM?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr6(SELF: eHOLE_BOTTOM?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr7(SELF: eHOLE_BOTTOM?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.DESCRIPTION
      let _TEMP2 = _TEMP1 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("flat with taper"))
      let _TEMP3 =  !_TEMP2
      let _TEMP4 = SDAI.USEDIN(T: SELF, ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
        .ePROPERTY_DEFINITION.DEFINITION)
      let _TEMP5 = _TEMP4.QUERY{ PD in 
    ...
    public static func WHERE_wr8(SELF: eHOLE_BOTTOM?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.DESCRIPTION
      let _TEMP2 = _TEMP1 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("conical"))
      let _TEMP3 =  !_TEMP2
      let _TEMP4 = SDAI.USEDIN(T: SELF, ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
        .ePROPERTY_DEFINITION.DEFINITION)
      let _TEMP5 = _TEMP4.QUERY{ PD in 
    ...
    public static func WHERE_wr9(SELF: eHOLE_BOTTOM?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP5 = _TEMP4.QUERY{ FCR in 
          ...
          let _TEMP1 = /*runtime*/FCR.NAME
          let _TEMP2 = ([SDAI.AIE(SDAI.STRING("hole depth start")), 
    ...
    public static func WHERE_wr10(SELF: eHOLE_BOTTOM?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.DESCRIPTION
      let _TEMP2 = _TEMP1 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("flat with radius"))
      let _TEMP3 =  !_TEMP2
      let _TEMP4 = SDAI.USEDIN(T: SELF, ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
        .ePROPERTY_DEFINITION.DEFINITION)
      let _TEMP5 = _TEMP4.QUERY{ PD in 
    ...
    public static func WHERE_wr11(SELF: eHOLE_BOTTOM?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.DESCRIPTION
      let _TEMP2 = _TEMP1 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("spherical"))
      let _TEMP3 =  !_TEMP2
      let _TEMP4 = SDAI.USEDIN(T: SELF, ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
        .ePROPERTY_DEFINITION.DEFINITION)
      let _TEMP5 = _TEMP4.QUERY{ PD in 
    ...
    public static func WHERE_wr12(SELF: eHOLE_BOTTOM?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr13(SELF: eHOLE_BOTTOM?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr14(SELF: eHOLE_BOTTOM?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ FCR in 
          ...
          let _TEMP6 = SDAI.TYPEOF(FCR.RELATING_SHAPE_ASPECT, IS: eHOLE_BOTTOM.self)
    ...
    public static func WHERE_wr15(SELF: eHOLE_BOTTOM?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr16(SELF: eHOLE_BOTTOM?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eHOLE_BOTTOM : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _hole_bottom.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _hole_bottom.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _hole_bottom.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _hole_bottom.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _hole_bottom.WHERE_wr5(SELF: instance)
      result[prefix2 + " .WHERE_wr6"] = _hole_bottom.WHERE_wr6(SELF: instance)
      result[prefix2 + " .WHERE_wr7"] = _hole_bottom.WHERE_wr7(SELF: instance)
      result[prefix2 + " .WHERE_wr8"] = _hole_bottom.WHERE_wr8(SELF: instance)
      result[prefix2 + " .WHERE_wr9"] = _hole_bottom.WHERE_wr9(SELF: instance)
      result[prefix2 + " .WHERE_wr10"] = _hole_bottom.WHERE_wr10(SELF: instance)
      result[prefix2 + " .WHERE_wr11"] = _hole_bottom.WHERE_wr11(SELF: instance)
      result[prefix2 + " .WHERE_wr12"] = _hole_bottom.WHERE_wr12(SELF: instance)
      result[prefix2 + " .WHERE_wr13"] = _hole_bottom.WHERE_wr13(SELF: instance)
      result[prefix2 + " .WHERE_wr14"] = _hole_bottom.WHERE_wr14(SELF: instance)
      result[prefix2 + " .WHERE_wr15"] = _hole_bottom.WHERE_wr15(SELF: instance)
      result[prefix2 + " .WHERE_wr16"] = _hole_bottom.WHERE_wr16(SELF: instance)
      return result
    }
