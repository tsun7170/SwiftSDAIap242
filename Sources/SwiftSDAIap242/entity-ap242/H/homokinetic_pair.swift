/* file: homokinetic_pair.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _homokinetic_pair : SDAI.PartialEntity, SDAI.InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_homokinetic_pair``
*/
  public final class eHOMOKINETIC_PAIR : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _homokinetic_pair.self
    }
    /// partial entity reference
    public let partialEntity: _homokinetic_pair
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_homokinetic_pair.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _homokinetic_pair.WHERE_wr1(SELF: instance.pRef)
      return result
    }
