/* file: high_degree_axi_symmetric_surface.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- high_degree_axi_symmetric_surface (line:17450 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _high_degree_axi_symmetric_surface : SDAI.PartialEntity {
...
```
*/
  public final class eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "HIGH_DEGREE_AXI_SYMMETRIC_SURFACE", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "APPROXIMATION_TOLERANCE", keyPath: \eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.APPROXIMATION_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.NAME, 
