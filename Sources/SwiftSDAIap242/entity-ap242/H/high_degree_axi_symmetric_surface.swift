/* file: high_degree_axi_symmetric_surface.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public final class eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var APPROXIMATION_TOLERANCE: tLENGTH_MEASURE {
      get {
        return SDAI.UNWRAP( self.partialEntity._approximation_tolerance )
      }
      set(newValue) {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
