/* file: high_degree_axi_symmetric_surface.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- high_degree_axi_symmetric_surface (line:17645 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(7)	overcomplex_geometry
    (no local attributes)

  ENTITY(SELF)	high_degree_axi_symmetric_surface
    ...
    ATTR:  approximation_tolerance,	TYPE: length_measure -- EXPLICIT
...
- SUPERTYPES:
	...
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eOVERCOMPLEX_GEOMETRY``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE/PartialEntity``
*/
  public final class eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.PartialEntity
    ...
    public let super_eOVERCOMPLEX_GEOMETRY: eOVERCOMPLEX_GEOMETRY 	// [7]
    public var super_eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE: eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE`` )
    public var APPROXIMATION_TOLERANCE: tLENGTH_MEASURE {
      get {
        let originalValue = self.partialEntity._approximation_tolerance
        let value = SDAI.UNWRAP( tLENGTH_MEASURE( originalValue ) )
        return value
      }
      set(newValue) {
        let partial = self.partialEntity
        partial._approximation_tolerance = SDAI.UNWRAP(newValue)
      }
    }
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.PartialEntity.self) else { return nil }
      ...
      guard let super7 = complexEntity?.entityReference(eOVERCOMPLEX_GEOMETRY.self) else { return nil }
      self.super_eOVERCOMPLEX_GEOMETRY = super7
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "HIGH_DEGREE_AXI_SYMMETRIC_SURFACE", 
      ...
      entityDef.add(supertype: eOVERCOMPLEX_GEOMETRY.self)
      entityDef.add(supertype: eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "APPROXIMATION_TOLERANCE", 
        keyPath: \eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.APPROXIMATION_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.NAME, 
    ...
    ENTITY high_degree_axi_symmetric_surface
      ...
      WHERE
        wr1: ( ( 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.SHAPE_DATA_QUALITY_LOWER_VALUE_LIMIT' IN 
                 ...
                 shape_data_quality_criterion.assessment_specification\
                 shape_data_quality_assessment_by_numerical_test.threshold ) ) );
        wr2: validate_measured_data_type( SELF, 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
                 + 'COUNT_MEASURE'  );
        wr3: validate_inspected_elements_type( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
                 + 'B_SPLINE_SURFACE' ] );
        wr4: validate_locations_of_extreme_value_type( SELF, [] );
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.self
      }
      ...
      public internal(set) var _approximation_tolerance: tLENGTH_MEASURE // PLAIN EXPLICIT ATTRIBUTE
      ...
      public override func hashAsValue(into hasher: inout Hasher, visited complexEntities: inout Set<SDAI.ComplexEntity>) {
        ...
        self._approximation_tolerance.value.hashAsValue(into: &hasher, visited: &complexEntities)
      }

      public override func isValueEqual(to rhs: SDAI.PartialEntity, visited comppairs: inout Set<SDAI.ComplexPair>) -> Bool {
        guard let rhs = rhs as? Self else { return false }
        if !super.isValueEqual(to: rhs, visited: &comppairs) { return false }
        if let comp = self._approximation_tolerance.value.isValueEqualOptionally(to: rhs._approximation_tolerance.value, visited: &comppairs)	{
      ...
      public static func WHERE_wr1(SELF: eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.COUNT_MEASURE") )
        return _TEMP1
      }
      public static func WHERE_wr3(SELF: eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr4(SELF: eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr5(SELF: eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public init(APPROXIMATION_TOLERANCE: tLENGTH_MEASURE) {

        self._approximation_tolerance = APPROXIMATION_TOLERANCE
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( APPROXIMATION_TOLERANCE: original._approximation_tolerance )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]APPROXIMATION_TOLERANCE for partial entity(\(Self.entityName)) constructor"); return nil }

        self.init( APPROXIMATION_TOLERANCE: p0 )
      }
    }
  }
}
