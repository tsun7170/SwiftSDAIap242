/* file: high_degree_linear_curve.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- high_degree_linear_curve (line:17675 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	high_degree_linear_curve
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eHIGH_DEGREE_LINEAR_CURVE/PartialEntity``
*/
  public final class eHIGH_DEGREE_LINEAR_CURVE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eHIGH_DEGREE_LINEAR_CURVE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eHIGH_DEGREE_LINEAR_CURVE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eHIGH_DEGREE_LINEAR_CURVE.PartialEntity
    ...
    public var super_eHIGH_DEGREE_LINEAR_CURVE: eHIGH_DEGREE_LINEAR_CURVE { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eHIGH_DEGREE_LINEAR_CURVE`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eHIGH_DEGREE_LINEAR_CURVE.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eHIGH_DEGREE_LINEAR_CURVE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eHIGH_DEGREE_LINEAR_CURVE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eHIGH_DEGREE_LINEAR_CURVE.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eHIGH_DEGREE_LINEAR_CURVE.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = eHIGH_DEGREE_LINEAR_CURVE.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eHIGH_DEGREE_LINEAR_CURVE.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "APPROXIMATION_TOLERANCE", 
        keyPath: \eHIGH_DEGREE_LINEAR_CURVE.APPROXIMATION_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eHIGH_DEGREE_LINEAR_CURVE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eHIGH_DEGREE_LINEAR_CURVE.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eHIGH_DEGREE_LINEAR_CURVE``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eHIGH_DEGREE_LINEAR_CURVE.self
      }
      ...
      public static func WHERE_wr1(SELF: eHIGH_DEGREE_LINEAR_CURVE.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eHIGH_DEGREE_LINEAR_CURVE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eHIGH_DEGREE_LINEAR_CURVE.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.COUNT_MEASURE") )
        return _TEMP1
      }
      public static func WHERE_wr3(SELF: eHIGH_DEGREE_LINEAR_CURVE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
      ...
      public static func WHERE_wr4(SELF: eHIGH_DEGREE_LINEAR_CURVE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
      ...
      public static func WHERE_wr5(SELF: eHIGH_DEGREE_LINEAR_CURVE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
