/* file: high_degree_linear_curve.swift 	 generated: Tue Jan 20 19:20:51 2026 */
...
*/
  public final class eHIGH_DEGREE_LINEAR_CURVE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eHIGH_DEGREE_LINEAR_CURVE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eHIGH_DEGREE_LINEAR_CURVE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eHIGH_DEGREE_LINEAR_CURVE.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eHIGH_DEGREE_LINEAR_CURVE.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = eHIGH_DEGREE_LINEAR_CURVE.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
