/* file: user_defined_terminator_symbol.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- user_defined_terminator_symbol (line:33358 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _user_defined_terminator_symbol : SDAI.PartialEntity {
...
```
*/
  public final class eUSER_DEFINED_TERMINATOR_SYMBOL : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "USER_DEFINED_TERMINATOR_SYMBOL", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "MAPPING_SOURCE", keyPath: \eUSER_DEFINED_TERMINATOR_SYMBOL.MAPPING_SOURCE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "MAPPING_TARGET", keyPath: \eUSER_DEFINED_TERMINATOR_SYMBOL.MAPPING_TARGET, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
