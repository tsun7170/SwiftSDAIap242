/* file: uncertainty_assigned_representation.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- uncertainty_assigned_representation (line:33523 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	uncertainty_assigned_representation
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eUNCERTAINTY_ASSIGNED_REPRESENTATION/PartialEntity``
*/
  public final class eUNCERTAINTY_ASSIGNED_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eUNCERTAINTY_ASSIGNED_REPRESENTATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eUNCERTAINTY_ASSIGNED_REPRESENTATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eUNCERTAINTY_ASSIGNED_REPRESENTATION.PartialEntity

    //MARK: SUPERTYPES
    public let super_eREPRESENTATION: eREPRESENTATION 	// [1]
    public var super_eUNCERTAINTY_ASSIGNED_REPRESENTATION: eUNCERTAINTY_ASSIGNED_REPRESENTATION { return self } 	// [2]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eUNCERTAINTY_ASSIGNED_REPRESENTATION`` )
    public var UNCERTAINTY: SDAI.SET<eUNCERTAINTY_MEASURE_WITH_UNIT.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = self.partialEntity._uncertainty
        let value = SDAI.UNWRAP( SDAI.SET<eUNCERTAINTY_MEASURE_WITH_UNIT.PRef>( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eUNCERTAINTY_ASSIGNED_REPRESENTATION.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eUNCERTAINTY_ASSIGNED_REPRESENTATION.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eUNCERTAINTY_ASSIGNED_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eUNCERTAINTY_ASSIGNED_REPRESENTATION.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eUNCERTAINTY_ASSIGNED_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eUNCERTAINTY_ASSIGNED_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "UNCERTAINTY", 
        keyPath: \eUNCERTAINTY_ASSIGNED_REPRESENTATION.UNCERTAINTY, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eUNCERTAINTY_ASSIGNED_REPRESENTATION.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eUNCERTAINTY_ASSIGNED_REPRESENTATION``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eUNCERTAINTY_ASSIGNED_REPRESENTATION.self
      }

      //ATTRIBUTES
      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _uncertainty: SDAI.SET<eUNCERTAINTY_MEASURE_WITH_UNIT.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(UNCERTAINTY: SDAI.SET<eUNCERTAINTY_MEASURE_WITH_UNIT.PRef>/*[1:(nil as SDAI.INTEGER?)]*/ ) {

        self._uncertainty = 
        SDAI.SET<eUNCERTAINTY_MEASURE_WITH_UNIT.PRef>(
          from: UNCERTAINTY.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( UNCERTAINTY: original._uncertainty )
      }
      ...
      public required convenience init?(
        ...
        guard case .success(let p0) = exchangeStructure.recoverRequiredParameter(as: SDAI.SET<
          eUNCERTAINTY_MEASURE_WITH_UNIT.PRef>.self, from: parameters[0])
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]UNCERTAINTY for partial entity(\(Self.entityName)) constructor"); return nil }
