/* file: uncertainty_assigned_representation.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- uncertainty_assigned_representation (line:33225 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _uncertainty_assigned_representation : SDAI.PartialEntity {
...
```
*/
  public final class eUNCERTAINTY_ASSIGNED_REPRESENTATION : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eUNCERTAINTY_ASSIGNED_REPRESENTATION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "UNCERTAINTY_ASSIGNED_REPRESENTATION", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eUNCERTAINTY_ASSIGNED_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eUNCERTAINTY_ASSIGNED_REPRESENTATION.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eUNCERTAINTY_ASSIGNED_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eUNCERTAINTY_ASSIGNED_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "UNCERTAINTY", keyPath: \eUNCERTAINTY_ASSIGNED_REPRESENTATION.UNCERTAINTY, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eUNCERTAINTY_ASSIGNED_REPRESENTATION.NAME, 
