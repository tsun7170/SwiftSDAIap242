/* file: uncertainty_assigned_representation.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _uncertainty: SDAI.SET<eUNCERTAINTY_MEASURE_WITH_UNIT.PRef>/*[1:?]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(UNCERTAINTY: SDAI.SET<eUNCERTAINTY_MEASURE_WITH_UNIT.PRef>/*[1:?]*/ ) {

        self._uncertainty = 
        SDAI.SET<eUNCERTAINTY_MEASURE_WITH_UNIT.PRef>(from: UNCERTAINTY.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
