/* file: uncertainty_assigned_representation.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _uncertainty_assigned_representation : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_uncertainty_assigned_representation``
*/
  public final class eUNCERTAINTY_ASSIGNED_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _uncertainty_assigned_representation.self
    }
    /// partial entity reference
    public let partialEntity: _uncertainty_assigned_representation
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_uncertainty_assigned_representation.self) else { return nil }
