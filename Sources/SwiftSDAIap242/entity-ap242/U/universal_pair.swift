/* file: universal_pair.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- universal_pair (line:33592 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eHOMOKINETIC_PAIR``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eUNIVERSAL_PAIR_WITH_RANGE``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eUNIVERSAL_PAIR/PartialEntity``
*/
  public final class eUNIVERSAL_PAIR : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eUNIVERSAL_PAIR>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eUNIVERSAL_PAIR.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eUNIVERSAL_PAIR.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eUNIVERSAL_PAIR`` )
    ...
    public var INPUT_SKEW_ANGLE: tPLANE_ANGLE_MEASURE?  {
      get {
        let originalValue = self.partialEntity._input_skew_angle
        let value = tPLANE_ANGLE_MEASURE( originalValue )
        return value
      }
      set(newValue) {
    ...
    public var SKEW_ANGLE: tPLANE_ANGLE_MEASURE?  {
      get {
        ...
        let origin = self
        let value = origin.partialEntity._skew_angle__getter(SELF: origin.pRef)
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eUNIVERSAL_PAIR.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eUNIVERSAL_PAIR.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eUNIVERSAL_PAIR``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      @_documentation(visibility:public)
      internal func _t_x__getter(SELF: eUNIVERSAL_PAIR.PRef) -> SDAI.BOOLEAN {
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _t_y__getter(SELF: eUNIVERSAL_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.FALSE)
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _t_z__getter(SELF: eUNIVERSAL_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.FALSE)
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _r_x__getter(SELF: eUNIVERSAL_PAIR.PRef) -> SDAI.BOOLEAN {
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _r_y__getter(SELF: eUNIVERSAL_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.FALSE)
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _r_z__getter(SELF: eUNIVERSAL_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.TRUE)
        return SDAI.UNWRAP( value )
      }
      ...
      /// DERIVE ATTRIBUTE
      @_documentation(visibility:public)
      internal func _skew_angle__getter(SELF: eUNIVERSAL_PAIR.PRef) -> tPLANE_ANGLE_MEASURE?  {

        let _TEMP1 /* tPLANE_ANGLE_MEASURE */ = SDAI.NVL( 
            V: SELF.INPUT_SKEW_ANGLE, 
            SUBSTITUTE: tPLANE_ANGLE_MEASURE.FundamentalType(0) )
        return _TEMP1
      }
      ...
      public static func WHERE_wr1(SELF: eUNIVERSAL_PAIR.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* tPLANE_ANGLE_MEASURE? */ = PLANE_ANGLE_FOR_PAIR_IN_RADIAN( 
            PAIR: eKINEMATIC_PAIR.PRef(/*eUNIVERSAL_PAIR.PRef*/SELF), 
            ANGLE: SELF.SKEW_ANGLE )
        let _TEMP2 /* SDAI.REAL? */ = SDAI.COS( _TEMP1 )
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( INPUT_SKEW_ANGLE: original._input_skew_angle )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]INPUT_SKEW_ANGLE for partial entity(\(Self.entityName)) constructor"); return nil }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eUNIVERSAL_PAIR.PartialEntity :
