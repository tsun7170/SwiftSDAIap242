/* file: unconstrained_pair.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- unconstrained_pair (line:33542 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eUNCONSTRAINED_PAIR/PartialEntity``
*/
  public final class eUNCONSTRAINED_PAIR : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eUNCONSTRAINED_PAIR>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eUNCONSTRAINED_PAIR.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eUNCONSTRAINED_PAIR.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eUNCONSTRAINED_PAIR`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eUNCONSTRAINED_PAIR.PartialEntity.self) else { return nil }
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eUNCONSTRAINED_PAIR``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      @_documentation(visibility:public)
      internal func _t_x__getter(SELF: eUNCONSTRAINED_PAIR.PRef) -> SDAI.BOOLEAN {
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _t_y__getter(SELF: eUNCONSTRAINED_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.TRUE)
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _t_z__getter(SELF: eUNCONSTRAINED_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.TRUE)
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _r_x__getter(SELF: eUNCONSTRAINED_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.TRUE)
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _r_y__getter(SELF: eUNCONSTRAINED_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.TRUE)
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _r_z__getter(SELF: eUNCONSTRAINED_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.TRUE)
        return SDAI.UNWRAP( value )
      }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eUNCONSTRAINED_PAIR.PartialEntity :
