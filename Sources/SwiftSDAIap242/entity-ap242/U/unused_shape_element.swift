/* file: unused_shape_element.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _unused_shape_element : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eUNUSED_SHAPE_ELEMENT?) -> SDAI.LOGICAL {
      ...
      let _TEMP2 = VALIDATE_ECDQ_INSPECTED_ELEMENTS_TYPE(
        EI: eEXTERNALLY_CONDITIONED_DATA_QUALITY_CRITERION(/*eUNUSED_SHAPE_ELEMENT*/SELF), 
        TYPE_LIST: _TEMP1)
      return _TEMP2
    }
...
```
*/
  public final class eUNUSED_SHAPE_ELEMENT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _unused_shape_element.WHERE_wr1(SELF: instance)
      return result
    }
