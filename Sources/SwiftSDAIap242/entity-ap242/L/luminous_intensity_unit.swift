/* file: luminous_intensity_unit.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _luminous_intensity_unit : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eLUMINOUS_INTENSITY_UNIT?) -> SDAI.LOGICAL {
      ...
      let _TEMP33 = _TEMP32 .==. SDAI.FORCE_OPTIONAL(SDAI.REAL(1.0000000000e+00))
...
```
*/
  public final class eLUMINOUS_INTENSITY_UNIT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _luminous_intensity_unit.WHERE_wr1(SELF: instance)
      return result
    }
