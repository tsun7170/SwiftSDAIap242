/* file: linear_array_placement_group_component.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- linear_array_placement_group_component (line:19201 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	linear_array_placement_group_component
    (no local attributes)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT/PartialEntity``
*/
  public final class eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT.PartialEntity
    ...
    public var super_eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT: eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT { return self } 	// [9]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "LINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT", 
      ...
      entityDef.add(supertype: eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "RELATING_PRODUCT_DEFINITION", 
        keyPath: \eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT.RELATING_PRODUCT_DEFINITION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "FRAME_OF_REFERENCE", 
        keyPath: \eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT.FRAME_OF_REFERENCE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DEFINITION", 
        keyPath: \eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT.DEFINITION, 
      ...
      entityDef.addAttribute(name: "RELATED_PRODUCT_DEFINITION", 
        keyPath: \eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT.RELATED_PRODUCT_DEFINITION, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "FORMATION", 
        keyPath: \eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT.FORMATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT.self
      }
