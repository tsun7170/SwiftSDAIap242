/* file: linear_array_placement_group_component.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- linear_array_placement_group_component (line:19020 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _linear_array_placement_group_component : SDAI.PartialEntity {
...
```
*/
  public final class eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "LINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "RELATING_PRODUCT_DEFINITION", keyPath: \eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT.RELATING_PRODUCT_DEFINITION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "FRAME_OF_REFERENCE", keyPath: \eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT.FRAME_OF_REFERENCE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DEFINITION", keyPath: \eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT.DEFINITION, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "RELATED_PRODUCT_DEFINITION", keyPath: \eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT.RELATED_PRODUCT_DEFINITION, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "FORMATION", keyPath: \eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT.FORMATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
