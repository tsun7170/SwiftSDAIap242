/* file: linear_array_placement_group_component.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _linear_array_placement_group_component : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_linear_array_placement_group_component``
*/
  public final class eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _linear_array_placement_group_component.self
    }
    /// partial entity reference
    public let partialEntity: _linear_array_placement_group_component
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_linear_array_placement_group_component.self) else { return nil }
