/* file: laid_orientation_angle.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _laid_orientation_angle : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_laid_orientation_angle``
*/
  public final class eLAID_ORIENTATION_ANGLE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _laid_orientation_angle.self
    }
    /// partial entity reference
    public let partialEntity: _laid_orientation_angle
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_laid_orientation_angle.self) else { return nil }
