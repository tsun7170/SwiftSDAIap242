/* file: laid_orientation_angle.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- laid_orientation_angle (line:19057 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	laid_orientation_angle
    (no local attributes)
...
- SUPERTYPES:
	...
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLY_ORIENTATION_ANGLE``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLAID_ORIENTATION_ANGLE/PartialEntity``
*/
  public final class eLAID_ORIENTATION_ANGLE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eLAID_ORIENTATION_ANGLE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eLAID_ORIENTATION_ANGLE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eLAID_ORIENTATION_ANGLE.PartialEntity
    ...
    public var super_eLAID_ORIENTATION_ANGLE: eLAID_ORIENTATION_ANGLE { return self } 	// [3]
    ...
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLY_ORIENTATION_ANGLE`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eLAID_ORIENTATION_ANGLE.PartialEntity.self) else { return nil }
