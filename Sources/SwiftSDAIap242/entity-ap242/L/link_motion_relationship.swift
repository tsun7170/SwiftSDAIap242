/* file: link_motion_relationship.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eLINK_MOTION_RELATIONSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eLINK_MOTION_RELATIONSHIP.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eLINK_MOTION_RELATIONSHIP.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      public static func WHERE_wr2(SELF: eLINK_MOTION_RELATIONSHIP.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP3 /* SDAI.SET<eKINEMATIC_PATH.PRef>[1:nil] ? */ = SELF.REP_2?.ITEMS
