/* file: listed_logical_data.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eLISTED_LOGICAL_DATA : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLISTED_LOGICAL_DATA`` )
    public var VALUES: SDAI.LIST<SDAI.LOGICAL>/*[1:nil]*/  {
      get {
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _values: SDAI.LIST<SDAI.LOGICAL>/*[1:nil]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      @_documentation(visibility:public)
      internal func _shape__getter(SELF: eLISTED_LOGICAL_DATA.PRef) -> SDAI.LIST<tPOSITIVE_INTEGER>/*[1:nil]*/  {
      ...
      public init(VALUES: SDAI.LIST<SDAI.LOGICAL>/*[1:nil]*/ ) {
