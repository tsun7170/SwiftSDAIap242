/* file: listed_logical_data.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- listed_logical_data (line:19186 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _listed_logical_data : SDAI.PartialEntity {
...
```
*/
  public final class eLISTED_LOGICAL_DATA : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eLISTED_LOGICAL_DATA`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "LISTED_LOGICAL_DATA", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "SHAPE", keyPath: \eLISTED_LOGICAL_DATA.SHAPE, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "INDEX_BASE", keyPath: \eLISTED_LOGICAL_DATA.INDEX_BASE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "VALUES", keyPath: \eLISTED_LOGICAL_DATA.VALUES, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DOMAIN", keyPath: \eLISTED_LOGICAL_DATA.DOMAIN, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "RANGE", keyPath: \eLISTED_LOGICAL_DATA.RANGE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
