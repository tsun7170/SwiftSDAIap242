/* file: listed_integer_data.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
*/
  public final class eLISTED_INTEGER_DATA : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLISTED_INTEGER_DATA`` )
    public var VALUES: SDAI.LIST<SDAI.INTEGER>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _values: SDAI.LIST<SDAI.INTEGER>/*[1:(nil as SDAI.INTEGER?)]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(VALUES: SDAI.LIST<SDAI.INTEGER>/*[1:(nil as SDAI.INTEGER?)]*/ ) {
