/* file: listed_complex_number_data.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _listed_complex_number_data : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _shape__getter(SELF: eLISTED_COMPLEX_NUMBER_DATA) -> SDAI.LIST<tPOSITIVE_INTEGER>/*[1:nil]*/  {
    ...
    public static func WHERE_wr1(SELF: eLISTED_COMPLEX_NUMBER_DATA?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.SIZEOF(SELF.VALUES)
      let _TEMP2 = SDAI.ODD(_TEMP1)
      let _TEMP3 =  !_TEMP2
      return _TEMP3
    }
...
```
*/
  public final class eLISTED_COMPLEX_NUMBER_DATA : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _listed_complex_number_data.WHERE_wr1(SELF: instance)
      return result
    }
