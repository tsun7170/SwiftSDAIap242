/* file: listed_complex_number_data.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _listed_complex_number_data : SDAI.PartialEntity, @unchecked Sendable {
    ...
    @_documentation(visibility:public)
    internal func _shape__getter(SELF: eLISTED_COMPLEX_NUMBER_DATA.PRef) -> SDAI.LIST<tPOSITIVE_INTEGER>/*[1:
      nil]*/  {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_listed_complex_number_data``
*/
  public final class eLISTED_COMPLEX_NUMBER_DATA : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _listed_complex_number_data.self
    }
    /// partial entity reference
    public let partialEntity: _listed_complex_number_data
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_listed_complex_number_data.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _listed_complex_number_data.WHERE_wr1(SELF: instance.pRef)
      return result
    }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF._listed_complex_number_data :
