/* file: linear_flexible_and_planar_curve_pair.swift 	 generated: Mon Jan  3 16:32:52 2022 */
  ...
  ENTITY linear_flexible_and_planar_curve_pair
    ...
    WHERE
      ...
      wr2: ( SIZEOF( QUERY ( lr <* SELF\kinematic_pair.associated_link_representations_1 | ( NOT ( 
               ...
               TYPEOF( lr ) ) ) ) ) = 0 );
  END_ENTITY; -- linear_flexible_and_planar_curve_pair (line:19040 file:ap242ed2_mim_lf_v1.101.TY.exp)
