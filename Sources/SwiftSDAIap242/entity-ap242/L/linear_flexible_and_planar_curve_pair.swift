/* file: linear_flexible_and_planar_curve_pair.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY linear_flexible_and_planar_curve_pair
    ...
    WHERE
      ...
      wr2: ( SIZEOF( QUERY ( lr <* SELF\kinematic_pair.associated_link_representations_1 | ( NOT ( 
               ...
               TYPEOF( lr ) ) ) ) ) = 0 );
  END_ENTITY; -- linear_flexible_and_planar_curve_pair (line:19039 file:ap242ed2_mim_lf_v1.101.TY.exp)
