/* file: linear_flexible_and_planar_curve_pair.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _linear_flexible_and_planar_curve_pair : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eLINEAR_FLEXIBLE_AND_PLANAR_CURVE_PAIR?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eLINEAR_FLEXIBLE_AND_PLANAR_CURVE_PAIR?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2?.QUERY{ LR in 
          ...
          let _TEMP1 = SDAI.TYPEOF(LR, IS: eLINEAR_FLEXIBLE_LINK_REPRESENTATION.self)
          let _TEMP2 =  !_TEMP1
          return _TEMP2 }
      let _TEMP4 = SDAI.SIZEOF(_TEMP3)
      let _TEMP5 = _TEMP4 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(0))
...
```
*/
  public final class eLINEAR_FLEXIBLE_AND_PLANAR_CURVE_PAIR : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _linear_flexible_and_planar_curve_pair.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _linear_flexible_and_planar_curve_pair.WHERE_wr2(SELF: instance)
      return result
    }
