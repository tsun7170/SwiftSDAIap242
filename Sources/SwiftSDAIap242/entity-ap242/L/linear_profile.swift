/* file: linear_profile.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY linear_profile
    ...
    WHERE
      ...
      wr5: ( SIZEOF( QUERY ( pd <* USEDIN( SELF, 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               ...
               = 1 ) ) ) ) = 0 ) ) ) ) = 0 );
  END_ENTITY; -- linear_profile (line:19048 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _linear_profile : SDAI.PartialEntity {
...
```
*/
  public final class eLINEAR_PROFILE : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "LINEAR_PROFILE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "PRODUCT_DEFINITIONAL", keyPath: \eLINEAR_PROFILE.PRODUCT_DEFINITIONAL, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eLINEAR_PROFILE.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OF_SHAPE", keyPath: \eLINEAR_PROFILE.OF_SHAPE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eLINEAR_PROFILE.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eLINEAR_PROFILE.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
