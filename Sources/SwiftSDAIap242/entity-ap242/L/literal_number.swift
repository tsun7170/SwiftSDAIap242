/* file: literal_number.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  ENTITY literal_number
    ...
    SUBTYPE OF ( simple_numeric_expression, generic_literal );
      the_value  : NUMBER;
  END_ENTITY; -- literal_number (line:19405 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUPERTYPES:
	...
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGENERIC_LITERAL``
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLITERAL_NUMBER/PartialEntity``
*/
  public final class eLITERAL_NUMBER : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eLITERAL_NUMBER>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eLITERAL_NUMBER.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eLITERAL_NUMBER.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLITERAL_NUMBER`` )
    public var THE_VALUE: SDAI.NUMBER {
      get {
        let originalValue = self.partialEntity._the_value
        let value = SDAI.UNWRAP( SDAI.NUMBER( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eLITERAL_NUMBER.PartialEntity.self) else { return nil }
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLITERAL_NUMBER``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( THE_VALUE: original._the_value )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]THE_VALUE for partial entity(\(Self.entityName)) constructor"); return nil }
