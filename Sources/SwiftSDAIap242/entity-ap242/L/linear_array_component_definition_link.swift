/* file: linear_array_component_definition_link.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _linear_array_component_definition_link : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_linear_array_component_definition_link``
*/
  public final class eLINEAR_ARRAY_COMPONENT_DEFINITION_LINK : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _linear_array_component_definition_link.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _linear_array_component_definition_link.WHERE_wr2(SELF: instance.pRef)
      return result
    }
