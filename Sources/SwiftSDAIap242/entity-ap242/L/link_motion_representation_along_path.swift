/* file: link_motion_representation_along_path.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- link_motion_representation_along_path (line:19327 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESCRIBED_PATH``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRESULTING_PATH``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLINK_MOTION_REPRESENTATION_ALONG_PATH/PartialEntity``
*/
  public final class eLINK_MOTION_REPRESENTATION_ALONG_PATH : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eLINK_MOTION_REPRESENTATION_ALONG_PATH>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eLINK_MOTION_REPRESENTATION_ALONG_PATH.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eLINK_MOTION_REPRESENTATION_ALONG_PATH.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLINK_MOTION_REPRESENTATION_ALONG_PATH`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eLINK_MOTION_REPRESENTATION_ALONG_PATH.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "LINK_MOTION_REPRESENTATION_ALONG_PATH", 
      ...
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eLINK_MOTION_REPRESENTATION_ALONG_PATH.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eLINK_MOTION_REPRESENTATION_ALONG_PATH.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eLINK_MOTION_REPRESENTATION_ALONG_PATH.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eLINK_MOTION_REPRESENTATION_ALONG_PATH.CONTEXT_OF_ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eLINK_MOTION_REPRESENTATION_ALONG_PATH.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLINK_MOTION_REPRESENTATION_ALONG_PATH``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _items: SDAI.SET<eKINEMATIC_PATH.PRef>[1:(nil as SDAI.INTEGER?)] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
