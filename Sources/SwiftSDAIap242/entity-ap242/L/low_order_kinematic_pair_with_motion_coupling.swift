/* file: low_order_kinematic_pair_with_motion_coupling.swift 	 generated: Thu Dec 25 18:13:23 2025 */
...
*/
  ...
  public final class _low_order_kinematic_pair_with_motion_coupling : SDAI.PartialEntity, InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_low_order_kinematic_pair_with_motion_coupling``
*/
  public final class eLOW_ORDER_KINEMATIC_PAIR_WITH_MOTION_COUPLING : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _low_order_kinematic_pair_with_motion_coupling.WHERE_wr1(SELF: instance.pRef)
      return result
    }
