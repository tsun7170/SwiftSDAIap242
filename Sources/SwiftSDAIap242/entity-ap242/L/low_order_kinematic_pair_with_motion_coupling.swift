/* file: low_order_kinematic_pair_with_motion_coupling.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY low_order_kinematic_pair_with_motion_coupling
    ...
    WHERE
      wr1: ( SIZEOF( QUERY ( lr <* SELF\kinematic_pair.associated_link_representations_2 | ( NOT ( 
               ...
               = 0 );
  END_ENTITY; -- low_order_kinematic_pair_with_motion_coupling (line:19486 file:ap242ed2_mim_lf_v1.101.TY.exp)
