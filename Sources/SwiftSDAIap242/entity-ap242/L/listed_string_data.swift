/* file: listed_string_data.swift 	 generated: Tue Jan 20 19:20:51 2026 */
...
*/
  public final class eLISTED_STRING_DATA : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLISTED_STRING_DATA`` )
    public var VALUES: SDAI.LIST<SDAI.STRING>/*[1:nil]*/  {
      get {
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      @_documentation(visibility:public)
      internal func _shape__getter(SELF: eLISTED_STRING_DATA.PRef) -> SDAI.LIST<tPOSITIVE_INTEGER>/*[1:nil]*/  {
      ...
      public init(VALUES: SDAI.LIST<SDAI.STRING>/*[1:nil]*/ ) {
