/* file: listed_string_data.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- listed_string_data (line:19209 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _listed_string_data : SDAI.PartialEntity {
...
```
*/
  public final class eLISTED_STRING_DATA : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eLISTED_STRING_DATA`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "LISTED_STRING_DATA", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "SHAPE", keyPath: \eLISTED_STRING_DATA.SHAPE, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "INDEX_BASE", keyPath: \eLISTED_STRING_DATA.INDEX_BASE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "VALUES", keyPath: \eLISTED_STRING_DATA.VALUES, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DOMAIN", keyPath: \eLISTED_STRING_DATA.DOMAIN, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "RANGE", keyPath: \eLISTED_STRING_DATA.RANGE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
