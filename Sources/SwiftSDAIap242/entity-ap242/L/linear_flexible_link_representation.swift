/* file: linear_flexible_link_representation.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
/*
  ...
  END_ENTITY; -- linear_flexible_link_representation (line:19233 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(2)	kinematic_link_representation
  ...
  ENTITY(SELF)	linear_flexible_link_representation
    (no local attributes)
...
- SUPERTYPES:
	...
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eKINEMATIC_LINK_REPRESENTATION``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLINEAR_FLEXIBLE_LINK_REPRESENTATION/PartialEntity``
*/
  public final class eLINEAR_FLEXIBLE_LINK_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eLINEAR_FLEXIBLE_LINK_REPRESENTATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eLINEAR_FLEXIBLE_LINK_REPRESENTATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eLINEAR_FLEXIBLE_LINK_REPRESENTATION.PartialEntity

    //MARK: SUPERTYPES
    public let super_eREPRESENTATION: eREPRESENTATION 	// [1]
    public let super_eKINEMATIC_LINK_REPRESENTATION: eKINEMATIC_LINK_REPRESENTATION 	// [2]
    public var super_eLINEAR_FLEXIBLE_LINK_REPRESENTATION: eLINEAR_FLEXIBLE_LINK_REPRESENTATION { return self } 	// [3]
    ...
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eKINEMATIC_LINK_REPRESENTATION`` )
    ...
    public var REPRESENTED_LINK: eKINEMATIC_LINK.PRef {
      get {
        return SDAI.UNWRAP( super_eKINEMATIC_LINK_REPRESENTATION.partialEntity._represented_link )
      }
      set(newValue) {
        let partial = super_eKINEMATIC_LINK_REPRESENTATION.partialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eLINEAR_FLEXIBLE_LINK_REPRESENTATION.PartialEntity.self) else { return nil }
      ...
      guard let super2 = complexEntity?.entityReference(eKINEMATIC_LINK_REPRESENTATION.self) else { return nil }
      self.super_eKINEMATIC_LINK_REPRESENTATION = super2
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "LINEAR_FLEXIBLE_LINK_REPRESENTATION", 
      ...
      entityDef.add(supertype: eLINEAR_FLEXIBLE_LINK_REPRESENTATION.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eLINEAR_FLEXIBLE_LINK_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eLINEAR_FLEXIBLE_LINK_REPRESENTATION.ITEMS, 
      ...
      entityDef.addAttribute(name: "ASSOCIATED_SHAPE_REPRESENTATION", 
        keyPath: \eLINEAR_FLEXIBLE_LINK_REPRESENTATION.ASSOCIATED_SHAPE_REPRESENTATION, 
        kind: .inverse, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eLINEAR_FLEXIBLE_LINK_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eLINEAR_FLEXIBLE_LINK_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REPRESENTED_LINK", 
        keyPath: \eLINEAR_FLEXIBLE_LINK_REPRESENTATION.REPRESENTED_LINK, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eLINEAR_FLEXIBLE_LINK_REPRESENTATION.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLINEAR_FLEXIBLE_LINK_REPRESENTATION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eLINEAR_FLEXIBLE_LINK_REPRESENTATION.self
      }
