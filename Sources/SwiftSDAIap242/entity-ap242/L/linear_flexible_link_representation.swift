/* file: linear_flexible_link_representation.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _linear_flexible_link_representation : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_linear_flexible_link_representation``
*/
  public final class eLINEAR_FLEXIBLE_LINK_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _linear_flexible_link_representation.self
    }
    /// partial entity reference
    public let partialEntity: _linear_flexible_link_representation
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_linear_flexible_link_representation.self) else { return nil }
