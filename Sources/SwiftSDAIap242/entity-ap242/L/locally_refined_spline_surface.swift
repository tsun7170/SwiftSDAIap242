/* file: locally_refined_spline_surface.swift 	 generated: Tue Jan 20 19:20:51 2026 */
...
*/
  public final class eLOCALLY_REFINED_SPLINE_SURFACE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLOCALLY_REFINED_SPLINE_SURFACE`` )
    public var CONTROL_POINTS_LIST: SDAI.LIST<eCARTESIAN_POINT.PRef>/*[4:nil]*/  {
      get {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eLOCALLY_REFINED_SPLINE_SURFACE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eLOCALLY_REFINED_SPLINE_SURFACE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eLOCALLY_REFINED_SPLINE_SURFACE.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eLOCALLY_REFINED_SPLINE_SURFACE.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _u_b_splines: SDAI.LIST<eLOCAL_B_SPLINE.PRef>/*[4:nil]*/  // PLAIN EXPLICIT ATTRIBUTE

      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _v_b_splines: SDAI.LIST<eLOCAL_B_SPLINE.PRef>/*[4:nil]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _control_points_list: SDAI.LIST<eCARTESIAN_POINT.PRef>/*[4:nil]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public static func WHERE_wr4(SELF: eLOCALLY_REFINED_SPLINE_SURFACE.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP1 /* SDAI.LIST<SDAI.REAL>[4:nil] ? */ = SELF.SCALING_FACTORS
      ...
      public init(
        U_B_SPLINES: SDAI.LIST<eLOCAL_B_SPLINE.PRef>/*[4:nil]*/ , 
        V_B_SPLINES: SDAI.LIST<eLOCAL_B_SPLINE.PRef>/*[4:nil]*/ , 
        U_KNOTS: tSPLINE_KNOT_VALUES, 
        V_KNOTS: tSPLINE_KNOT_VALUES, 
        CONTROL_POINTS_LIST: SDAI.LIST<eCARTESIAN_POINT.PRef>/*[4:nil]*/ , 
        SCALING_FACTORS: SDAI.LIST<SDAI.REAL>/*[4:nil]*/ , 
