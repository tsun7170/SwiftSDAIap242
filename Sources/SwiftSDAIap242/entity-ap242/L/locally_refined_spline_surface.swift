/* file: locally_refined_spline_surface.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _locally_refined_spline_surface : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr4(SELF: eLOCALLY_REFINED_SPLINE_SURFACE.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP2 /* SDAI.BOOLEAN? */ = CONSTRAINTS_SCALING( SDAI.LIST<SDAI.REAL>(/*SDAI.LIST<SDAI.REAL>[4:nil] */
          _TEMP1) )
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_locally_refined_spline_surface``
*/
  public final class eLOCALLY_REFINED_SPLINE_SURFACE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _locally_refined_spline_surface.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _locally_refined_spline_surface.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _locally_refined_spline_surface.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _locally_refined_spline_surface.WHERE_wr4(SELF: instance.pRef)
      return result
    }
