/* file: linear_flexible_and_pinion_pair.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY linear_flexible_and_pinion_pair
    ...
    WHERE
      wr1: ( SIZEOF( QUERY ( lr <* SELF\kinematic_pair.associated_link_representations_1 | ( NOT ( 
               ...
               TYPEOF( lr ) ) ) ) ) = 0 );
  END_ENTITY; -- linear_flexible_and_pinion_pair (line:19028 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _linear_flexible_and_pinion_pair : SDAI.PartialEntity {
...
```
*/
  public final class eLINEAR_FLEXIBLE_AND_PINION_PAIR : SDAI.EntityReference {
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``eLINEAR_FLEXIBLE_AND_PINION_PAIR`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "LINEAR_FLEXIBLE_AND_PINION_PAIR", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eLINEAR_FLEXIBLE_AND_PINION_PAIR.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "PINION_RADIUS", keyPath: \eLINEAR_FLEXIBLE_AND_PINION_PAIR.PINION_RADIUS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "LINK_REPRESENTATION_ASSOCIATIONS", keyPath: \eLINEAR_FLEXIBLE_AND_PINION_PAIR.LINK_REPRESENTATION_ASSOCIATIONS, 
        kind: .inverse, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "TRANSFORM_ITEM_1", keyPath: \eLINEAR_FLEXIBLE_AND_PINION_PAIR.TRANSFORM_ITEM_1, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "TRANSFORM_ITEM_2", keyPath: \eLINEAR_FLEXIBLE_AND_PINION_PAIR.TRANSFORM_ITEM_2, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "JOINT", keyPath: \eLINEAR_FLEXIBLE_AND_PINION_PAIR.JOINT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSOCIATED_LINK_REPRESENTATIONS_1", keyPath: \eLINEAR_FLEXIBLE_AND_PINION_PAIR.ASSOCIATED_LINK_REPRESENTATIONS_1, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSOCIATED_LINK_REPRESENTATIONS_2", keyPath: \eLINEAR_FLEXIBLE_AND_PINION_PAIR.ASSOCIATED_LINK_REPRESENTATIONS_2, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DIM", keyPath: \eLINEAR_FLEXIBLE_AND_PINION_PAIR.DIM, 
