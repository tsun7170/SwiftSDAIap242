/* file: linear_flexible_and_pinion_pair.swift 	 generated: Mon Jan  3 16:32:52 2022 */
  ...
  ENTITY linear_flexible_and_pinion_pair
    ...
    WHERE
      wr1: ( SIZEOF( QUERY ( lr <* SELF\kinematic_pair.associated_link_representations_1 | ( NOT ( 
               ...
               TYPEOF( lr ) ) ) ) ) = 0 );
  END_ENTITY; -- linear_flexible_and_pinion_pair (line:19029 file:ap242ed2_mim_lf_v1.101.TY.exp)
