/* file: linear_flexible_and_pinion_pair.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY linear_flexible_and_pinion_pair
    ...
    WHERE
      wr1: ( SIZEOF( QUERY ( lr <* SELF\kinematic_pair.associated_link_representations_1 | ( NOT ( 
               ...
               TYPEOF( lr ) ) ) ) ) = 0 );
  END_ENTITY; -- linear_flexible_and_pinion_pair (line:19014 file:ap242ed2_mim_lf_v1.101.TY.exp)
