/* file: low_order_kinematic_pair.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public static func WHERE_wr2(SELF: eLOW_ORDER_KINEMATIC_PAIR.PRef?) -> SDAI.LOGICAL {
        ...
        //
        let _TEMP1 /* eKINEMATIC_PAIR.PRef? */ = SELF.GROUP_REF(eKINEMATIC_PAIR.self)
        let _TEMP2 /* SDAI.SET<eKINEMATIC_LINK_REPRESENTATION.PRef>[1:?] ? */ = _TEMP1?.ASSOCIATED_LINK_REPRESENTATIONS_2
        let _TEMP3 /* SDAI.SET<eKINEMATIC_LINK_REPRESENTATION.PRef>[1:?] ? */ = _TEMP2?
          .QUERY{ LR in 
            // QUERY BODY
            //
