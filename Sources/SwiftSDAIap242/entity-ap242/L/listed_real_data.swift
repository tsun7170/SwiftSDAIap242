/* file: listed_real_data.swift 	 generated: Tue Jan 20 19:20:51 2026 */
...
*/
  public final class eLISTED_REAL_DATA : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLISTED_REAL_DATA`` )
    public var VALUES: SDAI.LIST<SDAI.REAL>/*[1:nil]*/  {
      get {
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _values: SDAI.LIST<SDAI.REAL>/*[1:nil]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      @_documentation(visibility:public)
      internal func _shape__getter(SELF: eLISTED_REAL_DATA.PRef) -> SDAI.LIST<tPOSITIVE_INTEGER>/*[1:nil]*/  {
      ...
      public init(VALUES: SDAI.LIST<SDAI.REAL>/*[1:nil]*/ ) {
