/* file: kinematic_topology_structure.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _kinematic_topology_structure : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_kinematic_topology_structure``
*/
  public final class eKINEMATIC_TOPOLOGY_STRUCTURE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _kinematic_topology_structure.self
    }
    /// partial entity reference
    public let partialEntity: _kinematic_topology_structure
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_kinematic_topology_structure.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _kinematic_topology_structure.WHERE_wr1(SELF: instance.pRef)
      return result
    }
