/* file: kinematic_topology_structure.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _kinematic_topology_structure : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _items: SDAI.SET<eKINEMATIC_JOINT>[1:nil] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
    ...
    public static func WHERE_wr1(SELF: eKINEMATIC_TOPOLOGY_STRUCTURE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.ITEMS.QUERY{ ITEM in 

          let _TEMP1 = SDAI.TYPEOF(ITEM, IS: eORIENTED_EDGE.self)
          return _TEMP1 }
...
```
*/
  public final class eKINEMATIC_TOPOLOGY_STRUCTURE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _kinematic_topology_structure.WHERE_wr1(SELF: instance)
      return result
    }
