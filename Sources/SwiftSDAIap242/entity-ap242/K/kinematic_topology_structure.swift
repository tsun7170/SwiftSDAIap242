/* file: kinematic_topology_structure.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY kinematic_topology_structure
    ...
    WHERE
      wr1: ( SIZEOF( QUERY ( item <* items | ( 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ORIENTED_EDGE' 
               IN TYPEOF( item ) ) ) ) = 0 );
  END_ENTITY; -- kinematic_topology_structure (line:18834 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _kinematic_topology_structure : SDAI.PartialEntity {
...
```
*/
  public final class eKINEMATIC_TOPOLOGY_STRUCTURE : SDAI.EntityReference {
    ...
    /// - origin: SUB( ``eKINEMATIC_TOPOLOGY_SUBSTRUCTURE`` )
    ...
    /// - origin: SELF( ``eKINEMATIC_TOPOLOGY_STRUCTURE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "KINEMATIC_TOPOLOGY_STRUCTURE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eKINEMATIC_TOPOLOGY_STRUCTURE.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "PARENT", keyPath: \eKINEMATIC_TOPOLOGY_STRUCTURE.PARENT, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eKINEMATIC_TOPOLOGY_STRUCTURE.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eKINEMATIC_TOPOLOGY_STRUCTURE.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eKINEMATIC_TOPOLOGY_STRUCTURE.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eKINEMATIC_TOPOLOGY_STRUCTURE.NAME, 
