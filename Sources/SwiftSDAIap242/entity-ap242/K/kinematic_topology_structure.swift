/* file: kinematic_topology_structure.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY kinematic_topology_structure
    ...
    WHERE
      wr1: ( SIZEOF( QUERY ( item <* items | ( 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ORIENTED_EDGE' 
               IN TYPEOF( item ) ) ) ) = 0 );
  END_ENTITY; -- kinematic_topology_structure (line:18848 file:ap242ed2_mim_lf_v1.101.TY.exp)
