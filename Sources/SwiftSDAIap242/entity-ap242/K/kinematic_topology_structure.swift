/* file: kinematic_topology_structure.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eKINEMATIC_TOPOLOGY_STRUCTURE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var PARENT: eKINEMATIC_TOPOLOGY_STRUCTURE.PRef?  {
      get {
        return sub_eKINEMATIC_TOPOLOGY_SUBSTRUCTURE?.partialEntity._parent
      }
      set(newValue) {
        guard let partial = sub_eKINEMATIC_TOPOLOGY_SUBSTRUCTURE?.super_eKINEMATIC_TOPOLOGY_SUBSTRUCTURE
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eKINEMATIC_TOPOLOGY_STRUCTURE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _items: SDAI.SET<eKINEMATIC_JOINT.PRef>[1:nil] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
      ...
      public static func WHERE_wr1(SELF: eKINEMATIC_TOPOLOGY_STRUCTURE.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP1 /* SDAI.SET<eKINEMATIC_JOINT.PRef>[1:nil] ? */ = SELF.ITEMS?
          .QUERY{ ITEM in 
            // QUERY BODY
