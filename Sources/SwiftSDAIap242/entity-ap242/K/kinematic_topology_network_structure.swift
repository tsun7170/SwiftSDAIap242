/* file: kinematic_topology_network_structure.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public final class eKINEMATIC_TOPOLOGY_NETWORK_STRUCTURE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eKINEMATIC_TOPOLOGY_NETWORK_STRUCTURE`` )
    public var ITEMS: SDAI.SET<eKINEMATIC_LOOP.PRef>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eKINEMATIC_LOOP.PRef>( super_eREPRESENTATION.partialEntity._items ) )
      }
      set(newValue) {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eKINEMATIC_TOPOLOGY_NETWORK_STRUCTURE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eKINEMATIC_TOPOLOGY_NETWORK_STRUCTURE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _items: SDAI.SET<eKINEMATIC_LOOP.PRef>[1:nil] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
      ...
      public static func WHERE_wr2(SELF: eKINEMATIC_TOPOLOGY_NETWORK_STRUCTURE.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP1 /* SDAI.SET<eKINEMATIC_JOINT.PRef>? */ = GET_KINEMATIC_JOINTS_FROM_KINEMATIC_LOOPS( 
            SDAI.SET<eKINEMATIC_LOOP.PRef>(/*SDAI.SET<eKINEMATIC_LOOP.PRef>[1:nil] */SELF.ITEMS) )
