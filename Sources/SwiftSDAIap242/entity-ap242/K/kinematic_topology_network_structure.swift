/* file: kinematic_topology_network_structure.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _kinematic_topology_network_structure : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _items: SDAI.SET<eKINEMATIC_LOOP>[1:nil] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
    ...
    public static func WHERE_wr1(SELF: eKINEMATIC_TOPOLOGY_NETWORK_STRUCTURE?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eKINEMATIC_TOPOLOGY_NETWORK_STRUCTURE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = GET_KINEMATIC_JOINTS_FROM_KINEMATIC_LOOPS(SDAI.SET<eKINEMATIC_LOOP>(/*SDAI.SET<
        eKINEMATIC_LOOP>[1:nil] */SELF.ITEMS))
...
```
*/
  public final class eKINEMATIC_TOPOLOGY_NETWORK_STRUCTURE : SDAI.EntityReference, @unchecked Sendable {
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eKINEMATIC_TOPOLOGY_NETWORK_STRUCTURE`` )
    public var ITEMS: SDAI.SET<eKINEMATIC_LOOP>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eKINEMATIC_LOOP>( super_eREPRESENTATION.partialEntity._items ) )
      }
      set(newValue) {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _kinematic_topology_network_structure.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _kinematic_topology_network_structure.WHERE_wr2(SELF: instance)
      return result
    }
