/* file: kinematic_link_representation_association.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _kinematic_link_representation_association : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _rep_1: eKINEMATIC_LINK_REPRESENTATION	//EXPLICIT REDEFINITION(eREPRESENTATION_RELATIONSHIP) //OBSERVED */
    ...
    public static func WHERE_wr1(SELF: eKINEMATIC_LINK_REPRESENTATION_ASSOCIATION?) -> SDAI.LOGICAL {
      ...
      let _TEMP5 = _TEMP4?.REP_1
      let _TEMP6 = /*runtime*/_TEMP5?.CONTEXT_OF_ITEMS
      let _TEMP7 = /*runtime*/_TEMP3 .===. /*runtime*/_TEMP6
      let _TEMP8 = SDAI.TYPEOF(SELF, IS: eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION.self)
...
```
*/
  public final class eKINEMATIC_LINK_REPRESENTATION_ASSOCIATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _kinematic_link_representation_association.WHERE_wr1(SELF: instance)
      return result
    }
