/* file: kinematic_link_representation_association.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- kinematic_link_representation_association (line:18722 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eKINEMATIC_LINK_REPRESENTATION_ASSOCIATION : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eKINEMATIC_LINK_REPRESENTATION_ASSOCIATION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "KINEMATIC_LINK_REPRESENTATION_ASSOCIATION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eKINEMATIC_LINK_REPRESENTATION_ASSOCIATION.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "REP_1", keyPath: \eKINEMATIC_LINK_REPRESENTATION_ASSOCIATION.REP_1, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_2", keyPath: \eKINEMATIC_LINK_REPRESENTATION_ASSOCIATION.REP_2, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eKINEMATIC_LINK_REPRESENTATION_ASSOCIATION.NAME, 
