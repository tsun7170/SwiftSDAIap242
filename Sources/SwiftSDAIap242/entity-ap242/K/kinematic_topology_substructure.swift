/* file: kinematic_topology_substructure.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _kinematic_topology_substructure : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eKINEMATIC_TOPOLOGY_SUBSTRUCTURE?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eKINEMATIC_TOPOLOGY_SUBSTRUCTURE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.GROUP_REF(eKINEMATIC_TOPOLOGY_STRUCTURE.self)
      let _TEMP2 = _TEMP1?.ITEMS
      let _TEMP3 = SELF.PARENT.GROUP_REF(eKINEMATIC_TOPOLOGY_STRUCTURE.self)
...
```
*/
  public final class eKINEMATIC_TOPOLOGY_SUBSTRUCTURE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var ITEMS: SDAI.SET<eKINEMATIC_JOINT>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eKINEMATIC_JOINT>( super_eREPRESENTATION.partialEntity._items ) )
      }
      set(newValue) {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _kinematic_topology_substructure.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _kinematic_topology_substructure.WHERE_wr2(SELF: instance)
      return result
    }
