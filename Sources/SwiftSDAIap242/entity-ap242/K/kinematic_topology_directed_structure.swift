/* file: kinematic_topology_directed_structure.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public final class eKINEMATIC_TOPOLOGY_DIRECTED_STRUCTURE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eKINEMATIC_TOPOLOGY_DIRECTED_STRUCTURE`` )
    public var ITEMS: SDAI.SET<eORIENTED_JOINT.PRef>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eORIENTED_JOINT.PRef>( super_eREPRESENTATION.partialEntity._items ) )
      }
      set(newValue) {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eKINEMATIC_TOPOLOGY_DIRECTED_STRUCTURE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eKINEMATIC_TOPOLOGY_DIRECTED_STRUCTURE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _items: SDAI.SET<eORIENTED_JOINT.PRef>[1:nil] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
      ...
      public static func WHERE_wr2(SELF: eKINEMATIC_TOPOLOGY_DIRECTED_STRUCTURE.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP1 /* SDAI.SET<eKINEMATIC_JOINT.PRef>? */ = GET_KINEMATIC_JOINTS_FROM_ORIENTED_JOINTS( 
            SDAI.SET<eORIENTED_JOINT.PRef>(/*SDAI.SET<eORIENTED_JOINT.PRef>[1:nil] */SELF.ITEMS) )
        let _TEMP2 /* SDAI.SET<eKINEMATIC_JOINT.PRef>[1:nil] ? */ = SELF.PARENT?.ITEMS
