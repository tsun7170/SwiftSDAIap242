/* file: kinematic_link_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _kinematic_link_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //internal var _associated_shape_representation: SDAI.SET<eKINEMATIC_LINK_REPRESENTATION_ASSOCIATION> 	(SEE CORRESPONDING ENTITY REFERENCE DEFINITION)
...
```
*/
  public final class eKINEMATIC_LINK_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"ASSOCIATED_SHAPE_REPRESENTATION") {
        return cached.value as! SDAI.SET<eKINEMATIC_LINK_REPRESENTATION_ASSOCIATION>/*[0:1]*/ 
      }
      let swiftValue = SDAI.SET<eKINEMATIC_LINK_REPRESENTATION_ASSOCIATION>/*[0:1]*/ .SwiftType( self.referencingEntities(for: \eKINEMATIC_LINK_REPRESENTATION_ASSOCIATION.REP_1) )
      let value = SDAI.SET<eKINEMATIC_LINK_REPRESENTATION_ASSOCIATION>/*[0:1]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
