/* file: kinematic_topology_tree_structure.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- kinematic_topology_tree_structure (line:19045 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(2)	kinematic_topology_directed_structure
  ...
  ENTITY(SELF)	kinematic_topology_tree_structure
    (no local attributes)
...
- SUPERTYPES:
	...
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eKINEMATIC_TOPOLOGY_DIRECTED_STRUCTURE``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eKINEMATIC_TOPOLOGY_TREE_STRUCTURE/PartialEntity``
*/
  public final class eKINEMATIC_TOPOLOGY_TREE_STRUCTURE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eKINEMATIC_TOPOLOGY_TREE_STRUCTURE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eKINEMATIC_TOPOLOGY_TREE_STRUCTURE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eKINEMATIC_TOPOLOGY_TREE_STRUCTURE.PartialEntity

    //MARK: SUPERTYPES
    public let super_eREPRESENTATION: eREPRESENTATION 	// [1]
    public let super_eKINEMATIC_TOPOLOGY_DIRECTED_STRUCTURE: eKINEMATIC_TOPOLOGY_DIRECTED_STRUCTURE 	// [2]
    public var super_eKINEMATIC_TOPOLOGY_TREE_STRUCTURE: eKINEMATIC_TOPOLOGY_TREE_STRUCTURE { return self } 	// [3]
    ...
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eKINEMATIC_TOPOLOGY_DIRECTED_STRUCTURE`` )
    public var PARENT: eKINEMATIC_TOPOLOGY_STRUCTURE.PRef {
      get {
        let originalValue = super_eKINEMATIC_TOPOLOGY_DIRECTED_STRUCTURE.partialEntity._parent
        let value = SDAI.UNWRAP( eKINEMATIC_TOPOLOGY_STRUCTURE.PRef( originalValue ) )
        return value
      }
      set(newValue) {
        let partial = super_eKINEMATIC_TOPOLOGY_DIRECTED_STRUCTURE.partialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eKINEMATIC_TOPOLOGY_TREE_STRUCTURE.PartialEntity.self) else { return nil }
      ...
      guard let super2 = complexEntity?.entityReference(eKINEMATIC_TOPOLOGY_DIRECTED_STRUCTURE.self) else { return nil }
      self.super_eKINEMATIC_TOPOLOGY_DIRECTED_STRUCTURE = super2
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "KINEMATIC_TOPOLOGY_TREE_STRUCTURE", 
      ...
      entityDef.add(supertype: eKINEMATIC_TOPOLOGY_TREE_STRUCTURE.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eKINEMATIC_TOPOLOGY_TREE_STRUCTURE.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "PARENT", 
        keyPath: \eKINEMATIC_TOPOLOGY_TREE_STRUCTURE.PARENT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eKINEMATIC_TOPOLOGY_TREE_STRUCTURE.ITEMS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eKINEMATIC_TOPOLOGY_TREE_STRUCTURE.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eKINEMATIC_TOPOLOGY_TREE_STRUCTURE.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eKINEMATIC_TOPOLOGY_TREE_STRUCTURE.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eKINEMATIC_TOPOLOGY_TREE_STRUCTURE``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eKINEMATIC_TOPOLOGY_TREE_STRUCTURE.self
      }
