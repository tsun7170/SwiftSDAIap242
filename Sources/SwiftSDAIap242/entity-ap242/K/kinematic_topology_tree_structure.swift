/* file: kinematic_topology_tree_structure.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- kinematic_topology_tree_structure (line:18850 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _kinematic_topology_tree_structure : SDAI.PartialEntity {
...
```
*/
  public final class eKINEMATIC_TOPOLOGY_TREE_STRUCTURE : SDAI.EntityReference {
    ...
    /// - origin: SUPER( ``eKINEMATIC_TOPOLOGY_DIRECTED_STRUCTURE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "KINEMATIC_TOPOLOGY_TREE_STRUCTURE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eKINEMATIC_TOPOLOGY_TREE_STRUCTURE.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "PARENT", keyPath: \eKINEMATIC_TOPOLOGY_TREE_STRUCTURE.PARENT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eKINEMATIC_TOPOLOGY_TREE_STRUCTURE.ITEMS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eKINEMATIC_TOPOLOGY_TREE_STRUCTURE.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eKINEMATIC_TOPOLOGY_TREE_STRUCTURE.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eKINEMATIC_TOPOLOGY_TREE_STRUCTURE.NAME, 
