/* file: banded_matrix.swift 	 generated: Tue Jan 20 19:20:51 2026 */
...
*/
  public final class eBANDED_MATRIX : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public var BELOW: SDAI.INTEGER {
      get {
        return SDAI.UNWRAP( self.partialEntity._below )
      }
      set(newValue) {
        let partial = self.partialEntity
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eBANDED_MATRIX.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eBANDED_MATRIX.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eBANDED_MATRIX.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      return result
    }
