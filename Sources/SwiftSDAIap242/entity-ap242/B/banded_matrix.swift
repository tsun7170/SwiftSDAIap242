/* file: banded_matrix.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _banded_matrix : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_banded_matrix``
*/
  public final class eBANDED_MATRIX : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public let partialEntity: _banded_matrix
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_banded_matrix.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _banded_matrix.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _banded_matrix.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _banded_matrix.WHERE_wr3(SELF: instance.pRef)
      return result
    }
