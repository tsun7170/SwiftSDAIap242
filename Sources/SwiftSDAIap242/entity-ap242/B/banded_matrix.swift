/* file: banded_matrix.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _banded_matrix : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eBANDED_MATRIX?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eBANDED_MATRIX?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = (  -SELF.BELOW ) <= SDAI.FORCE_OPTIONAL(SELF.ABOVE)
      return _TEMP1
    }
    public static func WHERE_wr3(SELF: eBANDED_MATRIX?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public init(DEFAULT_ENTRY: sMATHS_VALUE, BELOW: SDAI.INTEGER, ABOVE: SDAI.INTEGER, 
...
```
*/
  public final class eBANDED_MATRIX : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _banded_matrix.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _banded_matrix.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _banded_matrix.WHERE_wr3(SELF: instance)
      return result
    }
