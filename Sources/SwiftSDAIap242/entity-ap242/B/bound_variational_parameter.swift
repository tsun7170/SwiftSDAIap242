/* file: bound_variational_parameter.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- bound_variational_parameter (line:8614 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBOUND_VARIATIONAL_PARAMETER/PartialEntity``
*/
  public final class eBOUND_VARIATIONAL_PARAMETER : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eBOUND_VARIATIONAL_PARAMETER>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eBOUND_VARIATIONAL_PARAMETER.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eBOUND_VARIATIONAL_PARAMETER.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBOUND_VARIATIONAL_PARAMETER`` )
    public var PARAMETER_CURRENT_VALUE: sMATHS_VALUE {
      get {
        ...
        let origin = self
        let value = SDAI.UNWRAP( origin.partialEntity._parameter_current_value__getter(SELF: origin.pRef) )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eBOUND_VARIATIONAL_PARAMETER.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eBOUND_VARIATIONAL_PARAMETER.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "BOUND_VARIATIONAL_PARAMETER", 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBOUND_VARIATIONAL_PARAMETER``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      @_documentation(visibility:public)
      internal func _parameter_current_value__getter(SELF: eBOUND_VARIATIONAL_PARAMETER.PRef) -> sMATHS_VALUE {
      ...
      public static func WHERE_wr1(SELF: eBOUND_VARIATIONAL_PARAMETER.PRef?) -> SDAI.LOGICAL {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eBOUND_VARIATIONAL_PARAMETER.PartialEntity :
