/* file: b_spline_basis.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _b_spline_basis : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_b_spline_basis``
*/
  public final class eB_SPLINE_BASIS : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _b_spline_basis.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _b_spline_basis.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _b_spline_basis.WHERE_wr3(SELF: instance.pRef)
      return result
    }
