/* file: binary_generic_expression.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- binary_generic_expression (line:8210 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	...
	10.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINDEX_EXPRESSION``
	11.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFORMAT_FUNCTION``
	12.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEQUALS_EXPRESSION``
	13.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eXOR_EXPRESSION``
	14.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBINARY_BOOLEAN_EXPRESSION``
	15.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPARISON_NOT_EQUAL``
	16.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPARISON_GREATER``
	17.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPARISON_GREATER_EQUAL``
	18.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPARISON_LESS_EQUAL``
	19.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLIKE_EXPRESSION``
	20.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPARISON_EQUAL``
	21.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPARISON_LESS``
	22.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPARISON_EXPRESSION``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBINARY_GENERIC_EXPRESSION/PartialEntity``
*/
  public final class eBINARY_GENERIC_EXPRESSION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eBINARY_GENERIC_EXPRESSION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eBINARY_GENERIC_EXPRESSION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eBINARY_GENERIC_EXPRESSION.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBINARY_GENERIC_EXPRESSION`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eBINARY_GENERIC_EXPRESSION.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "FORMAT_STRING", 
        keyPath: \eBINARY_GENERIC_EXPRESSION.FORMAT_STRING, 
        kind: .derived, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "VALUE_TO_FORMAT", 
        keyPath: \eBINARY_GENERIC_EXPRESSION.VALUE_TO_FORMAT, 
        kind: .derived, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "OPERANDS", 
        keyPath: \eBINARY_GENERIC_EXPRESSION.OPERANDS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "INDEX", 
        keyPath: \eBINARY_GENERIC_EXPRESSION.INDEX, 
        kind: .derived, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "OPERAND", 
        keyPath: \eBINARY_GENERIC_EXPRESSION.OPERAND, 
        kind: .derived, source: .subEntity, mayYieldEntityReference: true)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBINARY_GENERIC_EXPRESSION``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _operands: SDAI.LIST<eGENERIC_EXPRESSION.PRef>/*[2:2]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(OPERANDS: SDAI.LIST<eGENERIC_EXPRESSION.PRef>/*[2:2]*/ ) {
