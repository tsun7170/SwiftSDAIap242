/* file: boolean_expression.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- boolean_expression (line:8254 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERVAL_EXPRESSION``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNOT_EXPRESSION``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eODD_FUNCTION``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eUNARY_BOOLEAN_EXPRESSION``
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBOOLEAN_DEFINED_FUNCTION``
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBOOLEAN_REPRESENTATION_ITEM``
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBOOLEAN_LITERAL``
	8.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMATHS_BOOLEAN_VARIABLE``
	9.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBOOLEAN_VARIABLE``
	10.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSIMPLE_BOOLEAN_EXPRESSION``
	11.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEQUALS_EXPRESSION``
	12.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eXOR_EXPRESSION``
	13.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBINARY_BOOLEAN_EXPRESSION``
	...
	17.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPARISON_NOT_EQUAL``
	18.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPARISON_GREATER``
	19.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPARISON_GREATER_EQUAL``
	20.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPARISON_LESS_EQUAL``
	21.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLIKE_EXPRESSION``
	22.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPARISON_EQUAL``
	23.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPARISON_LESS``
	24.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPARISON_EXPRESSION``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBOOLEAN_EXPRESSION/PartialEntity``
*/
  public final class eBOOLEAN_EXPRESSION : SDAI.EntityReference, SDAI.DualModeReference, 
    SDAI.Initializable.ByVoid, @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eBOOLEAN_EXPRESSION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eBOOLEAN_EXPRESSION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eBOOLEAN_EXPRESSION.PartialEntity
    ...
    public var THE_VALUE: SDAI.BOOLEAN?  {
      get {
        let originalValue = sub_eBOOLEAN_LITERAL?.partialEntity._the_value
        let value = SDAI.BOOLEAN( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eBOOLEAN_LITERAL?.partialEntity
          else { return }
    ...
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNOT_EXPRESSION`` )
    public var OPERAND: eBOOLEAN_EXPRESSION.PRef?  {
      get {
        let originalValue = sub_eNOT_EXPRESSION?
          .super_eUNARY_GENERIC_EXPRESSION.partialEntity._operand
        let value = eBOOLEAN_EXPRESSION.PRef( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eBOOLEAN_EXPRESSION.PartialEntity.self) else { return nil }
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBOOLEAN_EXPRESSION``
*/
