/* file: b_spline_volume.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _b_spline_volume : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _control_points__getter(SELF: eB_SPLINE_VOLUME.PRef) -> (SDAI.ARRAY<SDAI.ARRAY<SDAI.ARRAY<
      ...
      let _TEMP1 /* SDAI.ARRAY<SDAI.ARRAY<SDAI.ARRAY<gT>[LOW3:U3] >[LOW2:U2] >[LOW1:U1] ? */ = 
          ...
          LOW3: SDAI.INTEGER(0), 
          U3: SELF.W_UPPER )
      return SDAI.ARRAY<SDAI.ARRAY<SDAI.ARRAY<eCARTESIAN_POINT.PRef>>>(bound1: SDAI.UNWRAP(SDAI.INTEGER(0)), 
    ...
    public init(
      ...
      CONTROL_POINTS_LIST: SDAI.LIST<SDAI.LIST<SDAI.LIST<eCARTESIAN_POINT.PRef>/*[2:nil]*/ >/*[2:nil]*/ >/*[2:
      nil]*/ 
    ) {
    ...
    public required convenience init?(
      ...
      guard case .success(let p3) = exchangeStructure.recoverRequiredParameter(as: SDAI.LIST<SDAI.LIST<SDAI.LIST<
        eCARTESIAN_POINT.PRef>>>.self, from: parameters[3])
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_b_spline_volume``
*/
  public final class eB_SPLINE_VOLUME : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _b_spline_volume.WHERE_wr1(SELF: instance.pRef)
      return result
    }
