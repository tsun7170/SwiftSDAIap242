/* file: binary_assembly_constraint.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
*/
  public final class eBINARY_ASSEMBLY_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eBINARY_ASSEMBLY_CONSTRAINT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eBINARY_ASSEMBLY_CONSTRAINT.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eBINARY_ASSEMBLY_CONSTRAINT.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eBINARY_ASSEMBLY_CONSTRAINT.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: eBINARY_ASSEMBLY_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP2 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP1?.CONSTRAINED_ELEMENTS
        ...
        let _TEMP8 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[0:(nil as SDAI.INTEGER?)] ? */ = _TEMP7?.REFERENCE_ELEMENTS
      ...
      public static func WHERE_wr3(SELF: eBINARY_ASSEMBLY_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP6 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[0:(nil as SDAI.INTEGER?)] ? */ = _TEMP5?.REFERENCE_ELEMENTS
      ...
      public static func WHERE_wr4(SELF: eBINARY_ASSEMBLY_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP14 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP13?.CONSTRAINED_ELEMENTS
