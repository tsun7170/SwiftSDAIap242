/* file: binary_assembly_constraint.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _binary_assembly_constraint : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
    ...
    public static func WHERE_wr2(SELF: eBINARY_ASSEMBLY_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP19 /* eITEM_DEFINED_TRANSFORMATION.PRef? */ = _TEMP18?.GROUP_REF(eITEM_DEFINED_TRANSFORMATION.self)
      ...
      let _TEMP24 /* eITEM_DEFINED_TRANSFORMATION.PRef? */ = _TEMP23?.GROUP_REF(eITEM_DEFINED_TRANSFORMATION.self)
    ...
    public static func WHERE_wr4(SELF: eBINARY_ASSEMBLY_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP11 /* eITEM_DEFINED_TRANSFORMATION.PRef? */ = _TEMP10?.GROUP_REF(eITEM_DEFINED_TRANSFORMATION.self)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_binary_assembly_constraint``
*/
  public final class eBINARY_ASSEMBLY_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _binary_assembly_constraint.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _binary_assembly_constraint.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _binary_assembly_constraint.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _binary_assembly_constraint.WHERE_wr4(SELF: instance.pRef)
      return result
    }
