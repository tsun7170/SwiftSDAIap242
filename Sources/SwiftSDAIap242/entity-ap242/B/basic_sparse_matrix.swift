/* file: basic_sparse_matrix.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _basic_sparse_matrix : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_basic_sparse_matrix``
*/
  public final class eBASIC_SPARSE_MATRIX : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _basic_sparse_matrix.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _basic_sparse_matrix.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _basic_sparse_matrix.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _basic_sparse_matrix.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _basic_sparse_matrix.WHERE_wr5(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr6"] = _basic_sparse_matrix.WHERE_wr6(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr7"] = _basic_sparse_matrix.WHERE_wr7(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr8"] = _basic_sparse_matrix.WHERE_wr8(SELF: instance.pRef)
      return result
    }
