/* file: boolean_literal.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  ENTITY boolean_literal
    SUBTYPE OF ( simple_boolean_expression, generic_literal );
      the_value  : BOOLEAN;
  END_ENTITY; -- boolean_literal (line:8261 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBOOLEAN_LITERAL/PartialEntity``
*/
  public final class eBOOLEAN_LITERAL : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eBOOLEAN_LITERAL>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eBOOLEAN_LITERAL.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eBOOLEAN_LITERAL.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBOOLEAN_LITERAL`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eBOOLEAN_LITERAL.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "THE_VALUE", 
        keyPath: \eBOOLEAN_LITERAL.THE_VALUE, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBOOLEAN_LITERAL``
*/
