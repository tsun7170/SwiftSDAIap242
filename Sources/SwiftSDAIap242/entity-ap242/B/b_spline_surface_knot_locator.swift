/* file: b_spline_surface_knot_locator.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _b_spline_surface_knot_locator : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eB_SPLINE_SURFACE_KNOT_LOCATOR?) -> SDAI.LOGICAL {
    ...
    public init(BASIS_SURFACE: eB_SPLINE_SURFACE, KNOT_INDEX: SDAI.INTEGER, 
...
```
*/
  public final class eB_SPLINE_SURFACE_KNOT_LOCATOR : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _b_spline_surface_knot_locator.WHERE_wr1(SELF: instance)
      return result
    }
