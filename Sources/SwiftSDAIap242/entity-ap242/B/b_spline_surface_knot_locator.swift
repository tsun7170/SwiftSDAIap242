/* file: b_spline_surface_knot_locator.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- b_spline_surface_knot_locator (line:7786 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _b_spline_surface_knot_locator : SDAI.PartialEntity {
...
```
*/
  public final class eB_SPLINE_SURFACE_KNOT_LOCATOR : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eB_SPLINE_SURFACE_KNOT_LOCATOR`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "B_SPLINE_SURFACE_KNOT_LOCATOR", type: self, explicitAttributeCount: 3)
      ...
      entityDef.addAttribute(name: "SURFACE_PARAMETER", keyPath: \eB_SPLINE_SURFACE_KNOT_LOCATOR.SURFACE_PARAMETER, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "USERS", keyPath: \eB_SPLINE_SURFACE_KNOT_LOCATOR.USERS, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "KNOT_INDEX", keyPath: \eB_SPLINE_SURFACE_KNOT_LOCATOR.KNOT_INDEX, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "BASIS_SURFACE", keyPath: \eB_SPLINE_SURFACE_KNOT_LOCATOR.BASIS_SURFACE, 
