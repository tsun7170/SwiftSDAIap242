/* file: boundary_curve.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- boundary_curve (line:8616 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _boundary_curve : SDAI.PartialEntity {
...
```
*/
  public final class eBOUNDARY_CURVE : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "BOUNDARY_CURVE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "N_SEGMENTS", keyPath: \eBOUNDARY_CURVE.N_SEGMENTS, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "SELF_INTERSECT", keyPath: \eBOUNDARY_CURVE.SELF_INTERSECT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "SEGMENTS", keyPath: \eBOUNDARY_CURVE.SEGMENTS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "BASIS_SURFACE", keyPath: \eBOUNDARY_CURVE.BASIS_SURFACE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CLOSED_CURVE", keyPath: \eBOUNDARY_CURVE.CLOSED_CURVE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eBOUNDARY_CURVE.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", keyPath: \eBOUNDARY_CURVE.DIM, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
