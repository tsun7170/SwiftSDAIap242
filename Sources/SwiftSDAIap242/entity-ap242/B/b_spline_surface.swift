/* file: b_spline_surface.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public final class eB_SPLINE_SURFACE : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eB_SPLINE_SURFACE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _control_points_list: SDAI.LIST<SDAI.LIST<eCARTESIAN_POINT.PRef>/*[2:nil]*/ >
      ...
      internal func _v_upper__getter(SELF: eB_SPLINE_SURFACE.PRef) -> SDAI.INTEGER?  {
        ...
        let _TEMP1 /* SDAI.LIST<eCARTESIAN_POINT.PRef>[2:nil] ? */ = SELF.CONTROL_POINTS_LIST?[1]
      ...
      internal func _control_points__getter(SELF: eB_SPLINE_SURFACE.PRef) -> (SDAI.ARRAY<SDAI.ARRAY<
        ...
        let _TEMP1 /* SDAI.ARRAY<SDAI.ARRAY<gT>[LOW2:U2] >[LOW1:U1] ? */ = 
            ...
            SDAI.INTEGER?), /*SDAI.LIST<SDAI.LIST<eCARTESIAN_POINT.PRef>[2:nil] >[2:nil] */SELF.CONTROL_POINTS_LIST), 
            LOW1: SDAI.INTEGER(0), 
            U1: SELF.U_UPPER, 
            LOW2: SDAI.INTEGER(0), 
            U2: SELF.V_UPPER )
        return SDAI.ARRAY<SDAI.ARRAY<eCARTESIAN_POINT.PRef>>(bound1: SDAI.UNWRAP(SDAI.INTEGER(0)), 
      ...
      public init(
        ...
        CONTROL_POINTS_LIST: SDAI.LIST<SDAI.LIST<eCARTESIAN_POINT.PRef>/*[2:nil]*/ >/*[2:nil]*/ , 
