/* file: back_chaining_rule_body.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _back_chaining_rule_body : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_back_chaining_rule_body``
*/
  public final class eBACK_CHAINING_RULE_BODY : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _back_chaining_rule_body.self
    }
    /// partial entity reference
    public let partialEntity: _back_chaining_rule_body
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_back_chaining_rule_body.self) else { return nil }
