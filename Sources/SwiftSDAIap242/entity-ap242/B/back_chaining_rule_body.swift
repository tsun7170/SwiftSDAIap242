/* file: back_chaining_rule_body.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- back_chaining_rule_body (line:7882 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	back_chaining_rule_body
    (no local attributes)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBACK_CHAINING_RULE_BODY/PartialEntity``
*/
  public final class eBACK_CHAINING_RULE_BODY : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eBACK_CHAINING_RULE_BODY>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eBACK_CHAINING_RULE_BODY.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eBACK_CHAINING_RULE_BODY.PartialEntity
    ...
    public var super_eBACK_CHAINING_RULE_BODY: eBACK_CHAINING_RULE_BODY { return self } 	// [4]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eBACK_CHAINING_RULE_BODY.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eBACK_CHAINING_RULE_BODY.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eBACK_CHAINING_RULE_BODY.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "USED_REPRESENTATION", 
        keyPath: \eBACK_CHAINING_RULE_BODY.USED_REPRESENTATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eBACK_CHAINING_RULE_BODY.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
