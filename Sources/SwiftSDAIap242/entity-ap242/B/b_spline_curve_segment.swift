/* file: b_spline_curve_segment.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- b_spline_curve_segment (line:7714 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _b_spline_curve_segment : SDAI.PartialEntity {
...
```
*/
  public final class eB_SPLINE_CURVE_SEGMENT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eB_SPLINE_CURVE_SEGMENT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "B_SPLINE_CURVE_SEGMENT", type: self, explicitAttributeCount: 2)
      ...
      entityDef.addAttribute(name: "BASIS_CURVE", keyPath: \eB_SPLINE_CURVE_SEGMENT.BASIS_CURVE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "USERS", keyPath: \eB_SPLINE_CURVE_SEGMENT.USERS, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "START_KNOT_INDEX", keyPath: \eB_SPLINE_CURVE_SEGMENT.START_KNOT_INDEX, 
