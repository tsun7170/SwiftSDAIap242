/* file: b_spline_curve_segment.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _b_spline_curve_segment : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eB_SPLINE_CURVE_SEGMENT?) -> SDAI.LOGICAL {
    ...
    public init(BASIS_CURVE: eB_SPLINE_CURVE, START_KNOT_INDEX: SDAI.INTEGER) {
...
```
*/
  public final class eB_SPLINE_CURVE_SEGMENT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _b_spline_curve_segment.WHERE_wr1(SELF: instance)
      return result
    }
