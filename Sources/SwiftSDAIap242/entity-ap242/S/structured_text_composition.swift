/* file: structured_text_composition.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- structured_text_composition (line:30966 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _structured_text_composition : SDAI.PartialEntity {
...
```
*/
  public final class eSTRUCTURED_TEXT_COMPOSITION : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "STRUCTURED_TEXT_COMPOSITION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ITEM_ELEMENT", keyPath: \eSTRUCTURED_TEXT_COMPOSITION.ITEM_ELEMENT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSTRUCTURED_TEXT_COMPOSITION.NAME, 
