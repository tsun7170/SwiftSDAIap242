/* file: surface_distance_geometric_constraint.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _surface_distance_geometric_constraint : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_surface_distance_geometric_constraint``
*/
  public final class eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _surface_distance_geometric_constraint.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _surface_distance_geometric_constraint.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _surface_distance_geometric_constraint.WHERE_wr3(SELF: instance.pRef)
      return result
    }
