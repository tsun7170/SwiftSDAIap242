/* file: surface_distance_geometric_constraint.swift 	 generated: Tue Jan 20 19:20:51 2026 */
...
*/
  public final class eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var CONSTRAINED_ELEMENTS: SDAI.SET<eSURFACE.PRef>/*[1:2]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eSURFACE.PRef>( super_eEXPLICIT_CONSTRAINT.partialEntity
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      return result
    }
