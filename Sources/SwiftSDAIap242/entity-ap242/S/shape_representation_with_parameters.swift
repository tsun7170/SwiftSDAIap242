/* file: shape_representation_with_parameters.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _shape_representation_with_parameters : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_shape_representation_with_parameters``
*/
  public final class eSHAPE_REPRESENTATION_WITH_PARAMETERS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _shape_representation_with_parameters.self
    }
    /// partial entity reference
    public let partialEntity: _shape_representation_with_parameters
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_shape_representation_with_parameters.self) else { return nil }
