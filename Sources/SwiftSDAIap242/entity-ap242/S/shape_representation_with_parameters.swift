/* file: shape_representation_with_parameters.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- shape_representation_with_parameters (line:29164 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	shape_representation_with_parameters
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_REPRESENTATION_WITH_PARAMETERS/PartialEntity``
*/
  public final class eSHAPE_REPRESENTATION_WITH_PARAMETERS : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eSHAPE_REPRESENTATION_WITH_PARAMETERS>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eSHAPE_REPRESENTATION_WITH_PARAMETERS.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eSHAPE_REPRESENTATION_WITH_PARAMETERS.PartialEntity

    //MARK: SUPERTYPES
    public let super_eREPRESENTATION: eREPRESENTATION 	// [1]
    public let super_eSHAPE_REPRESENTATION: eSHAPE_REPRESENTATION 	// [2]
    public var super_eSHAPE_REPRESENTATION_WITH_PARAMETERS: eSHAPE_REPRESENTATION_WITH_PARAMETERS { return self } 	// [3]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_REPRESENTATION_WITH_PARAMETERS`` )
    public var ITEMS: SDAI.SET<sSHAPE_REPRESENTATION_WITH_PARAMETERS_ITEMS>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = super_eREPRESENTATION.partialEntity._items
        let SELF = super_eREPRESENTATION; SDAI.TOUCH(let:SELF)
        let value =         SDAI.SET<sSHAPE_REPRESENTATION_WITH_PARAMETERS_ITEMS>(
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eSHAPE_REPRESENTATION_WITH_PARAMETERS.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eSHAPE_REPRESENTATION_WITH_PARAMETERS.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eSHAPE_REPRESENTATION_WITH_PARAMETERS.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eSHAPE_REPRESENTATION_WITH_PARAMETERS.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eSHAPE_REPRESENTATION_WITH_PARAMETERS.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eSHAPE_REPRESENTATION_WITH_PARAMETERS.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eSHAPE_REPRESENTATION_WITH_PARAMETERS.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_REPRESENTATION_WITH_PARAMETERS``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _items: SDAI.SET<sSHAPE_REPRESENTATION_WITH_PARAMETERS_ITEMS>[1:(nil as SDAI.INTEGER?)] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
