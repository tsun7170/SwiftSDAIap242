/* file: shape_representation_with_parameters.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- shape_representation_with_parameters (line:28946 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _shape_representation_with_parameters : SDAI.PartialEntity {
...
```
*/
  public final class eSHAPE_REPRESENTATION_WITH_PARAMETERS : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eSHAPE_REPRESENTATION_WITH_PARAMETERS`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SHAPE_REPRESENTATION_WITH_PARAMETERS", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eSHAPE_REPRESENTATION_WITH_PARAMETERS.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eSHAPE_REPRESENTATION_WITH_PARAMETERS.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eSHAPE_REPRESENTATION_WITH_PARAMETERS.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eSHAPE_REPRESENTATION_WITH_PARAMETERS.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSHAPE_REPRESENTATION_WITH_PARAMETERS.NAME, 
