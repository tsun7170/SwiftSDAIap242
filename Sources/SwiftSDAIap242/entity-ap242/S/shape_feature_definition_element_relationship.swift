/* file: shape_feature_definition_element_relationship.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- shape_feature_definition_element_relationship (line:29105 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	shape_feature_definition_element_relationship
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP/PartialEntity``
*/
  public final class eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP.PartialEntity
    ...
    public var super_eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP: eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP { return self } 	// [3]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "SHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP", 
      ...
      entityDef.add(supertype: eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP.DESCRIPTION, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATED_SHAPE_ASPECT", 
        keyPath: \eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP.RELATED_SHAPE_ASPECT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP.NAME, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATING_SHAPE_ASPECT", 
        keyPath: \eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP.RELATING_SHAPE_ASPECT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP.self
      }
      ...
      internal func _name__getter(complex: SDAI.ComplexEntity) -> tLABEL {
        let SELF = complex.entityReference( eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP.self )!
        return SDAI.UNWRAP( tLABEL(SELF.NAME) )
      }
      /// DERIVE ATTRIBUTE REDEFINITION(origin: eCHARACTERIZED_OBJECT)
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _name__getter(SELF: eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP.PRef) -> tLABEL {
        //
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _description__getter(SELF: eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP.PRef) -> tTEXT {
        //
        let _TEMP1 /* eSHAPE_ASPECT_RELATIONSHIP.PRef? */ = SELF.GROUP_REF(eSHAPE_ASPECT_RELATIONSHIP.self)
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
  .eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP.PartialEntity :eCHARACTERIZED_OBJECT__NAME__provider, 
  eCHARACTERIZED_OBJECT__DESCRIPTION__provider {}
