/* file: shape_feature_definition_element_relationship.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- shape_feature_definition_element_relationship (line:28887 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP.DESCRIPTION, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ID", keyPath: \eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATED_SHAPE_ASPECT", keyPath: \eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP.RELATED_SHAPE_ASPECT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP.NAME, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATING_SHAPE_ASPECT", keyPath: \eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP.RELATING_SHAPE_ASPECT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
