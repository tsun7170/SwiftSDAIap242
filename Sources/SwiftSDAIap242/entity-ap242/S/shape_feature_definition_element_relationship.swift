/* file: shape_feature_definition_element_relationship.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _shape_feature_definition_element_relationship : SDAI.PartialEntity
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_shape_feature_definition_element_relationship``
*/
  public final class eSHAPE_FEATURE_DEFINITION_ELEMENT_RELATIONSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _shape_feature_definition_element_relationship.self
    }
    /// partial entity reference
    public let partialEntity: _shape_feature_definition_element_relationship
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_shape_feature_definition_element_relationship.self) else { return nil }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF._shape_feature_definition_element_relationship :
