/* file: solid_with_wrong_number_of_voids.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- solid_with_wrong_number_of_voids (line:30448 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	solid_with_wrong_number_of_voids
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSOLID_WITH_WRONG_NUMBER_OF_VOIDS/PartialEntity``
*/
  public final class eSOLID_WITH_WRONG_NUMBER_OF_VOIDS : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eSOLID_WITH_WRONG_NUMBER_OF_VOIDS>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eSOLID_WITH_WRONG_NUMBER_OF_VOIDS.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eSOLID_WITH_WRONG_NUMBER_OF_VOIDS.PartialEntity
    ...
    public var super_eSOLID_WITH_WRONG_NUMBER_OF_VOIDS: eSOLID_WITH_WRONG_NUMBER_OF_VOIDS { return self } 	// [7]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSOLID_WITH_WRONG_NUMBER_OF_VOIDS`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eSOLID_WITH_WRONG_NUMBER_OF_VOIDS.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eSOLID_WITH_WRONG_NUMBER_OF_VOIDS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eSOLID_WITH_WRONG_NUMBER_OF_VOIDS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eSOLID_WITH_WRONG_NUMBER_OF_VOIDS.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eSOLID_WITH_WRONG_NUMBER_OF_VOIDS.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "SOLID_WITH_WRONG_NUMBER_OF_VOIDS", 
      ...
      entityDef.add(supertype: eSOLID_WITH_WRONG_NUMBER_OF_VOIDS.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eSOLID_WITH_WRONG_NUMBER_OF_VOIDS.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eSOLID_WITH_WRONG_NUMBER_OF_VOIDS.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSOLID_WITH_WRONG_NUMBER_OF_VOIDS``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eSOLID_WITH_WRONG_NUMBER_OF_VOIDS.self
      }
      ...
      public static func WHERE_wr1(SELF: eSOLID_WITH_WRONG_NUMBER_OF_VOIDS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eSOLID_WITH_WRONG_NUMBER_OF_VOIDS.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOOLEAN_VALUE") )
        return _TEMP1
      }
      public static func WHERE_wr2(SELF: eSOLID_WITH_WRONG_NUMBER_OF_VOIDS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr3(SELF: eSOLID_WITH_WRONG_NUMBER_OF_VOIDS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr4(SELF: eSOLID_WITH_WRONG_NUMBER_OF_VOIDS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
