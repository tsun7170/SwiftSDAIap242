/* file: solid_with_wrong_number_of_voids.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _solid_with_wrong_number_of_voids : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_solid_with_wrong_number_of_voids``
*/
  public final class eSOLID_WITH_WRONG_NUMBER_OF_VOIDS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _solid_with_wrong_number_of_voids.self
    }
    /// partial entity reference
    public let partialEntity: _solid_with_wrong_number_of_voids
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_solid_with_wrong_number_of_voids.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _solid_with_wrong_number_of_voids.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _solid_with_wrong_number_of_voids.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _solid_with_wrong_number_of_voids.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _solid_with_wrong_number_of_voids.WHERE_wr4(SELF: instance.pRef)
      return result
    }
