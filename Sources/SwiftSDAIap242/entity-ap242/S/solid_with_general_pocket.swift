/* file: solid_with_general_pocket.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _solid_with_general_pocket : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /// EXPLICIT ATTRIBUTE 
    public internal(set) var _profile: ePOSITIONED_SKETCH // PLAIN EXPLICIT ATTRIBUTE
    ...
    public static func WHERE_wr1(SELF: eSOLID_WITH_GENERAL_POCKET?) -> SDAI.LOGICAL {
      ...
      let _TEMP2 = SELF.PROFILE.SKETCH_BASIS
    ...
    public static func WHERE_wr2(SELF: eSOLID_WITH_GENERAL_POCKET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.SET<sFOUNDED_ITEM_SELECT>(SDAI.EMPTY_AGGREGATE)
      let _TEMP2 = USING_ITEMS(ITEM: sFOUNDED_ITEM_SELECT(/*ePOINT*/SELF.REFERENCE_POINT), 
                               CHECKED_ITEMS: _TEMP1)
      let _TEMP3 = SDAI.aggregate(_TEMP2, contains: sFOUNDED_ITEM_SELECT(/*ePOSITIONED_SKETCH*/SELF.PROFILE))
      return _TEMP3
    }

    //EXPRESS IMPLICIT PARTIAL ENTITY CONSTRUCTOR
    public init(PROFILE: ePOSITIONED_SKETCH, REFERENCE_POINT: ePOINT) {
...
```
*/
  public final class eSOLID_WITH_GENERAL_POCKET : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _solid_with_general_pocket.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _solid_with_general_pocket.WHERE_wr2(SELF: instance)
      return result
    }
