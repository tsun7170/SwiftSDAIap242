/* file: screw_pair_value.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _screw_pair_value : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _applies_to_pair: eSCREW_PAIR	//EXPLICIT REDEFINITION(ePAIR_VALUE) */

    /// EXPLICIT ATTRIBUTE 
    public internal(set) var _actual_rotation: tPLANE_ANGLE_MEASURE // PLAIN EXPLICIT ATTRIBUTE

    /// DERIVE ATTRIBUTE
    internal func _actual_translation__getter(SELF: eSCREW_PAIR_VALUE) -> tLENGTH_MEASURE?  {

      let _TEMP1 = SELF.GROUP_REF(ePAIR_VALUE.self)
      let _TEMP2 = _TEMP1?.APPLIES_TO_PAIR
      let _TEMP3 = _TEMP2?.GROUP_REF(eSCREW_PAIR.self)
      let _TEMP4 = _TEMP3?.PITCH
      let _TEMP5 = SELF.GROUP_REF(ePAIR_VALUE.self)
      let _TEMP6 = _TEMP5?.APPLIES_TO_PAIR
      let _TEMP7 = PLANE_ANGLE_FOR_PAIR_IN_RADIAN(
        PAIR: _TEMP6, ANGLE: SELF.ACTUAL_ROTATION)
      let _TEMP8 = _TEMP4 * _TEMP7
      let _TEMP9 = SDAI.INTEGER(2) * SDAI.REAL(SDAI.PI)
      let _TEMP10 = _TEMP8 / SDAI.FORCE_OPTIONAL(_TEMP9)
...
```
*/
  public final class eSCREW_PAIR_VALUE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var APPLIES_TO_PAIR: eSCREW_PAIR {
      get {
        return SDAI.UNWRAP( eSCREW_PAIR( super_ePAIR_VALUE.partialEntity._applies_to_pair ) )
      }
      set(newValue) {
    ...
    public var ACTUAL_TRANSLATION: tLENGTH_MEASURE?  {
      get {
        ...
        let origin = self
        let value = origin.partialEntity._actual_translation__getter(SELF: origin)
