/* file: surface_smoothness_geometric_constraint.swift 	 generated: Tue Jan 20 19:20:51 2026 */
...
*/
  public final class eSURFACE_SMOOTHNESS_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var CONSTRAINED_ELEMENTS: SDAI.SET<eSURFACE_PATCH_SET.PRef>/*[1:1]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eSURFACE_PATCH_SET.PRef>( super_eEXPLICIT_CONSTRAINT.partialEntity
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eSURFACE_SMOOTHNESS_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
