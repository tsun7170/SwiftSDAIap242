/* file: scalar_variable.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _scalar_variable : SDAI.PartialEntity, SDAI.InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_scalar_variable``
*/
  public final class eSCALAR_VARIABLE : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _scalar_variable.self
    }
    /// partial entity reference
    public let partialEntity: _scalar_variable
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_scalar_variable.self) else { return nil }
