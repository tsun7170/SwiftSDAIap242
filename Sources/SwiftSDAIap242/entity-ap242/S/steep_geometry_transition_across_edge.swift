/* file: steep_geometry_transition_across_edge.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- steep_geometry_transition_across_edge (line:30986 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	steep_geometry_transition_across_edge
    (no local attributes)

  SUB- ENTITY(8)	steep_angle_between_adjacent_edges
  ...
  SUB- ENTITY(9)	steep_angle_between_adjacent_faces
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTEEP_GEOMETRY_TRANSITION_ACROSS_EDGE/PartialEntity``
*/
  public final class eSTEEP_GEOMETRY_TRANSITION_ACROSS_EDGE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eSTEEP_GEOMETRY_TRANSITION_ACROSS_EDGE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eSTEEP_GEOMETRY_TRANSITION_ACROSS_EDGE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eSTEEP_GEOMETRY_TRANSITION_ACROSS_EDGE.PartialEntity
    ...
    public var super_eSTEEP_GEOMETRY_TRANSITION_ACROSS_EDGE: eSTEEP_GEOMETRY_TRANSITION_ACROSS_EDGE { return self } 	// [7]

    //MARK: SUBTYPES
    public var sub_eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES: eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES? {	// [8]
      return self.complexEntity.entityReference(eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.self)
    }

    public var sub_eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES: eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES? {	// [9]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eSTEEP_GEOMETRY_TRANSITION_ACROSS_EDGE.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "STEEP_GEOMETRY_TRANSITION_ACROSS_EDGE", 
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eSTEEP_GEOMETRY_TRANSITION_ACROSS_EDGE.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eSTEEP_GEOMETRY_TRANSITION_ACROSS_EDGE.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTEEP_GEOMETRY_TRANSITION_ACROSS_EDGE``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eSTEEP_GEOMETRY_TRANSITION_ACROSS_EDGE.self
      }
