/* file: steep_geometry_transition_across_edge.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _steep_geometry_transition_across_edge : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_steep_geometry_transition_across_edge``
*/
  public final class eSTEEP_GEOMETRY_TRANSITION_ACROSS_EDGE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _steep_geometry_transition_across_edge.self
    }
    /// partial entity reference
    public let partialEntity: _steep_geometry_transition_across_edge
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_steep_geometry_transition_across_edge.self) else { return nil }
