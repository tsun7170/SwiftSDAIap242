/* file: steep_angle_between_adjacent_faces.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  ENTITY steep_angle_between_adjacent_faces
    ...
    WHERE
      ...
      wr5: validate_accuracy_types( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               + 'PLANE_ANGLE_MEASURE' ] );
  END_ENTITY; -- steep_angle_between_adjacent_faces (line:30971 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(7)	steep_geometry_transition_across_edge
    (no local attributes)

  ENTITY(SELF)	steep_angle_between_adjacent_faces
...
- SUPERTYPES:
	...
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTEEP_GEOMETRY_TRANSITION_ACROSS_EDGE``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES/PartialEntity``
*/
  public final class eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES.PartialEntity
    ...
    public let super_eSTEEP_GEOMETRY_TRANSITION_ACROSS_EDGE: eSTEEP_GEOMETRY_TRANSITION_ACROSS_EDGE 	// [7]
    public var super_eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES: eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES.PartialEntity.self) else { return nil }
      ...
      guard let super7 = complexEntity?.entityReference(eSTEEP_GEOMETRY_TRANSITION_ACROSS_EDGE.self) else { return nil }
      self.super_eSTEEP_GEOMETRY_TRANSITION_ACROSS_EDGE = super7
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "STEEP_ANGLE_BETWEEN_ADJACENT_FACES", 
      ...
      entityDef.add(supertype: eSTEEP_GEOMETRY_TRANSITION_ACROSS_EDGE.self)
      entityDef.add(supertype: eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES.self
      }
      ...
      public static func WHERE_wr1(SELF: eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PLANE_ANGLE_MEASURE") )
        return _TEMP1
      }
      public static func WHERE_wr3(SELF: eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr4(SELF: eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr5(SELF: eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
