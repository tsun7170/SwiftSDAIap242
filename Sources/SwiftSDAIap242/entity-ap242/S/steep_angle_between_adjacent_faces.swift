/* file: steep_angle_between_adjacent_faces.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _steep_angle_between_adjacent_faces : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = VALIDATE_MEASURED_DATA_TYPE(
        EI: eSHAPE_DATA_QUALITY_CRITERION(/*eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES*/SELF), 
        TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PLANE_ANGLE_MEASURE"))
      return _TEMP1
    }
    public static func WHERE_wr3(SELF: eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr5(SELF: eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _steep_angle_between_adjacent_faces.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _steep_angle_between_adjacent_faces.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _steep_angle_between_adjacent_faces.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _steep_angle_between_adjacent_faces.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _steep_angle_between_adjacent_faces.WHERE_wr5(SELF: instance)
      return result
    }
