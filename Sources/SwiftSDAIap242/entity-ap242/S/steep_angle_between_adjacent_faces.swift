/* file: steep_angle_between_adjacent_faces.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _steep_angle_between_adjacent_faces : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_steep_angle_between_adjacent_faces``
*/
  public final class eSTEEP_ANGLE_BETWEEN_ADJACENT_FACES : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _steep_angle_between_adjacent_faces.self
    }
    /// partial entity reference
    public let partialEntity: _steep_angle_between_adjacent_faces
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_steep_angle_between_adjacent_faces.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _steep_angle_between_adjacent_faces.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _steep_angle_between_adjacent_faces.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _steep_angle_between_adjacent_faces.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _steep_angle_between_adjacent_faces.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _steep_angle_between_adjacent_faces.WHERE_wr5(SELF: instance.pRef)
      return result
    }
