/* file: short_length_curve_segment.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- short_length_curve_segment (line:29219 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _short_length_curve_segment : SDAI.PartialEntity {
...
```
*/
  public final class eSHORT_LENGTH_CURVE_SEGMENT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eSHORT_LENGTH_CURVE_SEGMENT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SHORT_LENGTH_CURVE_SEGMENT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eSHORT_LENGTH_CURVE_SEGMENT.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSHORT_LENGTH_CURVE_SEGMENT.NAME, 
