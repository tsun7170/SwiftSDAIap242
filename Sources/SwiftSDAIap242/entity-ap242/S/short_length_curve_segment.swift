/* file: short_length_curve_segment.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- short_length_curve_segment (line:29423 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	short_length_curve_segment
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHORT_LENGTH_CURVE_SEGMENT/PartialEntity``
*/
  public final class eSHORT_LENGTH_CURVE_SEGMENT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eSHORT_LENGTH_CURVE_SEGMENT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eSHORT_LENGTH_CURVE_SEGMENT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eSHORT_LENGTH_CURVE_SEGMENT.PartialEntity
    ...
    public var super_eSHORT_LENGTH_CURVE_SEGMENT: eSHORT_LENGTH_CURVE_SEGMENT { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHORT_LENGTH_CURVE_SEGMENT`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eSHORT_LENGTH_CURVE_SEGMENT.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eSHORT_LENGTH_CURVE_SEGMENT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eSHORT_LENGTH_CURVE_SEGMENT.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eSHORT_LENGTH_CURVE_SEGMENT.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eSHORT_LENGTH_CURVE_SEGMENT.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = eSHORT_LENGTH_CURVE_SEGMENT.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "SHORT_LENGTH_CURVE_SEGMENT", 
      ...
      entityDef.add(supertype: eSHORT_LENGTH_CURVE_SEGMENT.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eSHORT_LENGTH_CURVE_SEGMENT.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eSHORT_LENGTH_CURVE_SEGMENT.NAME, 
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: eSHORT_LENGTH_CURVE_SEGMENT.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eSHORT_LENGTH_CURVE_SEGMENT.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eSHORT_LENGTH_CURVE_SEGMENT.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.LENGTH_MEASURE") )
        return _TEMP1
      }
      public static func WHERE_wr3(SELF: eSHORT_LENGTH_CURVE_SEGMENT.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
      ...
      public static func WHERE_wr4(SELF: eSHORT_LENGTH_CURVE_SEGMENT.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
            SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.B_SPLINE_CURVE_SEGMENT")) ] 
            as [SDAI.AggregationInitializerElement<SDAI.STRING>]) )
      ...
      public static func WHERE_wr5(SELF: eSHORT_LENGTH_CURVE_SEGMENT.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
