/* file: short_length_curve_segment.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _short_length_curve_segment : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_short_length_curve_segment``
*/
  public final class eSHORT_LENGTH_CURVE_SEGMENT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _short_length_curve_segment.self
    }
    /// partial entity reference
    public let partialEntity: _short_length_curve_segment
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_short_length_curve_segment.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _short_length_curve_segment.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _short_length_curve_segment.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _short_length_curve_segment.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _short_length_curve_segment.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _short_length_curve_segment.WHERE_wr5(SELF: instance.pRef)
      return result
    }
