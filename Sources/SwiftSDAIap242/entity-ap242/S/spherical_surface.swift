/* file: spherical_surface.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- spherical_surface (line:30405 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _spherical_surface : SDAI.PartialEntity {
...
```
*/
  public final class eSPHERICAL_SURFACE : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eSPHERICAL_SURFACE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SPHERICAL_SURFACE", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "RADIUS", keyPath: \eSPHERICAL_SURFACE.RADIUS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "POSITION", keyPath: \eSPHERICAL_SURFACE.POSITION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSPHERICAL_SURFACE.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", keyPath: \eSPHERICAL_SURFACE.DIM, 
