/* file: si_power_unit.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _si_power_unit : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eSI_POWER_UNIT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.GROUP_REF(eSI_UNIT.self)
      let _TEMP2 = _TEMP1?.NAME
      let _TEMP3 = nSI_UNIT_NAME.WATT
      let _TEMP4 = _TEMP2 .==. SDAI.FORCE_OPTIONAL(_TEMP3)
      return _TEMP4
    }
    public static func WHERE_wr2(SELF: eSI_POWER_UNIT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eSI_POWER_UNIT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _si_power_unit.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _si_power_unit.WHERE_wr2(SELF: instance)
      return result
    }
