/* file: symmetric_shape_aspect.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- symmetric_shape_aspect (line:31549 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _symmetric_shape_aspect : SDAI.PartialEntity {
    ...
    internal var _basis_relationships: SDAI.SET<eSHAPE_ASPECT_DERIVING_RELATIONSHIP> {
      return __basis_relationships.map{ $0.reference }
    }
    private var __basis_relationships = SDAI.SET<SDAI.UnownedWrap<eSHAPE_ASPECT_DERIVING_RELATIONSHIP>>(
    ...
    internal func _basis_relationships__observeAddedReference(in complex: SDAI.ComplexEntity) {
      guard let newSource = complex.entityReference(eSHAPE_ASPECT_DERIVING_RELATIONSHIP.self) else { return }
      self.__basis_relationships.add(member: SDAI.UnownedWrap(newSource) )
    }
    /// INVERSE AGGREGATE ATTR SUPPORT(REMOVER)
    internal func _basis_relationships__observeRemovedReference(in complex: SDAI.ComplexEntity) {
      guard let oldSource = complex.entityReference(eSHAPE_ASPECT_DERIVING_RELATIONSHIP.self) else { return }
      let success = self.__basis_relationships.remove(member: SDAI.UnownedWrap(oldSource) )
      assert(success, "failed to remove inverse attribute element")
    }
    /// INVERSE AGGREGATE ATTR SUPPORT(LEAVING REFERENCE OWNER)
    internal func _basis_relationships__observe(leavingReferencerOwner complex: SDAI.ComplexEntity) {
      guard let oldSource = complex.entityReference(eSHAPE_ASPECT_DERIVING_RELATIONSHIP.self) else { return }
      let success = self.__basis_relationships.removeAll(member: SDAI.UnownedWrap(oldSource) )
...
```
*/
  public final class eSYMMETRIC_SHAPE_ASPECT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eSYMMETRIC_SHAPE_ASPECT`` )
    public var BASIS_RELATIONSHIPS: SDAI.SET<eSHAPE_ASPECT_DERIVING_RELATIONSHIP>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( self.partialEntity._basis_relationships )
      }
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SYMMETRIC_SHAPE_ASPECT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "PRODUCT_DEFINITIONAL", keyPath: \eSYMMETRIC_SHAPE_ASPECT.PRODUCT_DEFINITIONAL, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eSYMMETRIC_SHAPE_ASPECT.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OF_SHAPE", keyPath: \eSYMMETRIC_SHAPE_ASPECT.OF_SHAPE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eSYMMETRIC_SHAPE_ASPECT.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eSYMMETRIC_SHAPE_ASPECT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "BASIS_RELATIONSHIPS", keyPath: \eSYMMETRIC_SHAPE_ASPECT.BASIS_RELATIONSHIPS, 
