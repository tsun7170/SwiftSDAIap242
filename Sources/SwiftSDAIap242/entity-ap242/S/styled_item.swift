/* file: styled_item.swift 	 generated: Tue Jan 20 19:20:51 2026 */
...
*/
  public final class eSTYLED_ITEM : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eSTYLED_ITEM.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eSTYLED_ITEM.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eSTYLED_ITEM.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _styles: SDAI.SET<ePRESENTATION_STYLE_ASSIGNMENT.PRef>/*[0:nil]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public static func WHERE_wr1(SELF: eSTYLED_ITEM.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP10 /* SDAI.SET<ePRESENTATION_STYLE_ASSIGNMENT.PRef>[0:nil] ? */ = SELF.STYLES?
          .QUERY{ PRES_STYLE in 
            // QUERY BODY
      ...
      public init(
        STYLES: SDAI.SET<ePRESENTATION_STYLE_ASSIGNMENT.PRef>/*[0:nil]*/ , 
