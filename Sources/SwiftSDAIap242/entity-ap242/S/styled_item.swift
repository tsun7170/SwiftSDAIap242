/* file: styled_item.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _styled_item : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr3(SELF: eSTYLED_ITEM.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP4 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: eCONTEXT_DEPENDENT_OVER_RIDING_STYLED_ITEM.self )
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_styled_item``
*/
  public final class eSTYLED_ITEM : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _styled_item.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _styled_item.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _styled_item.WHERE_wr3(SELF: instance.pRef)
      return result
    }
