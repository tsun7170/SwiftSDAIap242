/* file: self_intersecting_curve.swift 	 generated: Thu Mar  5 17:54:18 2026 */
  ...
  ENTITY self_intersecting_curve
    ...
    WHERE
      ...
      wr3: validate_locations_of_extreme_value_type( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               + 'POINT_ON_CURVE' , 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.POINT_ON_CURVE'] );
      wr4: validate_accuracy_types( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.LENGTH_MEASURE'] );
  END_ENTITY; -- self_intersecting_curve (line:28776 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	self_intersecting_curve
...
- SUPERTYPES:
	...
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSELF_INTERSECTING_GEOMETRY``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSELF_INTERSECTING_CURVE/PartialEntity``
*/
  public final class eSELF_INTERSECTING_CURVE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eSELF_INTERSECTING_CURVE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eSELF_INTERSECTING_CURVE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eSELF_INTERSECTING_CURVE.PartialEntity
    ...
    public var super_eSELF_INTERSECTING_CURVE: eSELF_INTERSECTING_CURVE { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSELF_INTERSECTING_CURVE`` )
    ...
    public var ARC_LENGTH_SEPARATION_FACTOR: SDAI.REAL {
      get {
        let originalValue = self.partialEntity._arc_length_separation_factor
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eSELF_INTERSECTING_CURVE.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eSELF_INTERSECTING_CURVE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eSELF_INTERSECTING_CURVE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eSELF_INTERSECTING_CURVE.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eSELF_INTERSECTING_CURVE.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eSELF_INTERSECTING_CURVE.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "INTERFERENCE_TOLERANCE", 
        keyPath: \eSELF_INTERSECTING_CURVE.INTERFERENCE_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ARC_LENGTH_SEPARATION_FACTOR", 
        keyPath: \eSELF_INTERSECTING_CURVE.ARC_LENGTH_SEPARATION_FACTOR, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eSELF_INTERSECTING_CURVE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eSELF_INTERSECTING_CURVE.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSELF_INTERSECTING_CURVE``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eSELF_INTERSECTING_CURVE.self
      }
      ...
      public internal(set) var _arc_length_separation_factor: SDAI.REAL // PLAIN EXPLICIT ATTRIBUTE
      ...
      public override func hashAsValue(into hasher: inout Hasher, visited complexEntities: inout Set<SDAI.ComplexEntity>) {
        ...
        self._arc_length_separation_factor.value.hashAsValue(into: &hasher, visited: &complexEntities)
      ...
      public override func isValueEqual(to rhs: SDAI.PartialEntity, visited comppairs: inout Set<SDAI.ComplexPair>) -> Bool {
        ...
        if let comp = self._arc_length_separation_factor.value.isValueEqualOptionally(to: rhs._arc_length_separation_factor.value, visited: &comppairs)	{
      ...
      public static func WHERE_wr1(SELF: eSELF_INTERSECTING_CURVE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eSELF_INTERSECTING_CURVE.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOOLEAN_VALUE") )
        return _TEMP1
      }
      public static func WHERE_wr2(SELF: eSELF_INTERSECTING_CURVE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
      ...
      public static func WHERE_wr3(SELF: eSELF_INTERSECTING_CURVE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
      ...
      public static func WHERE_wr4(SELF: eSELF_INTERSECTING_CURVE.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
      ...
      public init(
        ARC_LENGTH_SEPARATION_FACTOR: SDAI.REAL, 
        INTERFERENCE_TOLERANCE: tLENGTH_MEASURE
      ) {

        self._arc_length_separation_factor = ARC_LENGTH_SEPARATION_FACTOR
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( ARC_LENGTH_SEPARATION_FACTOR: original._arc_length_separation_factor, INTERFERENCE_TOLERANCE: original._interference_tolerance )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]ARC_LENGTH_SEPARATION_FACTOR for partial entity(\(Self.entityName)) constructor"); return nil }
        ...
        self.init( ARC_LENGTH_SEPARATION_FACTOR: p0, INTERFERENCE_TOLERANCE: p1 )
      }
    }
  }
}
