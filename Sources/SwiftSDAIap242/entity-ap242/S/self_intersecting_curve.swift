/* file: self_intersecting_curve.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eSELF_INTERSECTING_CURVE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var ARC_LENGTH_SEPARATION_FACTOR: SDAI.REAL {
      get {
        return SDAI.UNWRAP( self.partialEntity._arc_length_separation_factor )
      }
      set(newValue) {
        let partial = self.partialEntity
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eSELF_INTERSECTING_CURVE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eSELF_INTERSECTING_CURVE.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eSELF_INTERSECTING_CURVE.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eSELF_INTERSECTING_CURVE.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
