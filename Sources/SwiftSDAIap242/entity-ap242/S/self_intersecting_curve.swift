/* file: self_intersecting_curve.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- self_intersecting_curve (line:28572 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _self_intersecting_curve : SDAI.PartialEntity {
...
```
*/
  public final class eSELF_INTERSECTING_CURVE : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eSELF_INTERSECTING_CURVE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SELF_INTERSECTING_CURVE", type: self, explicitAttributeCount: 2)
      ...
      entityDef.addAttribute(name: "INTERFERENCE_TOLERANCE", keyPath: \eSELF_INTERSECTING_CURVE.INTERFERENCE_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ARC_LENGTH_SEPARATION_FACTOR", keyPath: \eSELF_INTERSECTING_CURVE.ARC_LENGTH_SEPARATION_FACTOR, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eSELF_INTERSECTING_CURVE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSELF_INTERSECTING_CURVE.NAME, 
