/* file: self_intersecting_curve.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _self_intersecting_curve : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_self_intersecting_curve``
*/
  public final class eSELF_INTERSECTING_CURVE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _self_intersecting_curve.self
    }
    /// partial entity reference
    public let partialEntity: _self_intersecting_curve
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_self_intersecting_curve.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _self_intersecting_curve.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _self_intersecting_curve.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _self_intersecting_curve.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _self_intersecting_curve.WHERE_wr4(SELF: instance.pRef)
      return result
    }
