/* file: structured_text_representation.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eSTRUCTURED_TEXT_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var ITEMS: SDAI.SET<sSTRING_REPRESENTATION_ITEM_SELECT>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<sSTRING_REPRESENTATION_ITEM_SELECT>( super_eREPRESENTATION.partialEntity
          ._items ) )
      }
      set(newValue) {
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _items: SDAI.SET<sSTRING_REPRESENTATION_ITEM_SELECT>[1:nil] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
