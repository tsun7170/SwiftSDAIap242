/* file: solid_with_rectangular_pocket.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _solid_with_rectangular_pocket : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eSOLID_WITH_RECTANGULAR_POCKET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.FORCE_OPTIONAL(SELF.POCKET_WIDTH) / SDAI.FORCE_OPTIONAL(SDAI.INTEGER(2))
      let _TEMP2 = SDAI.FORCE_OPTIONAL(SELF.CORNER_RADIUS) < _TEMP1
      let _TEMP3 = SDAI.FORCE_OPTIONAL(SELF.POCKET_LENGTH) / SDAI.FORCE_OPTIONAL(SDAI.INTEGER(2))
      let _TEMP4 = SDAI.FORCE_OPTIONAL(SELF.CORNER_RADIUS) < _TEMP3
      let _TEMP5 = _TEMP2 && _TEMP4
      return _TEMP5
    }

    //EXPRESS IMPLICIT PARTIAL ENTITY CONSTRUCTOR
    public init(POCKET_LENGTH: tPOSITIVE_LENGTH_MEASURE, POCKET_WIDTH: tPOSITIVE_LENGTH_MEASURE, 
...
```
*/
  public final class eSOLID_WITH_RECTANGULAR_POCKET : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _solid_with_rectangular_pocket.WHERE_wr1(SELF: instance)
      return result
    }
