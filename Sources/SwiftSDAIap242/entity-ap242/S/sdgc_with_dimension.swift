/* file: sdgc_with_dimension.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- sdgc_with_dimension (line:28724 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(7)	surface_distance_geometric_constraint
  ...
  ENTITY(SELF)	sdgc_with_dimension
    ATTR:  distance_value,	TYPE: non_negative_length_measure -- EXPLICIT


  SUB- ENTITY(9)	surface_distance_assembly_constraint_with_dimension
    (no local attributes)
...
- SUPERTYPES:
	...
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT``

- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSDGC_WITH_DIMENSION/PartialEntity``
*/
  public final class eSDGC_WITH_DIMENSION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eSDGC_WITH_DIMENSION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eSDGC_WITH_DIMENSION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eSDGC_WITH_DIMENSION.PartialEntity
    ...
    public let super_eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT: eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT 	// [7]
    public var super_eSDGC_WITH_DIMENSION: eSDGC_WITH_DIMENSION { return self } 	// [8]

    //MARK: SUBTYPES
    public var sub_eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION: eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION? {	// [9]
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSDGC_WITH_DIMENSION`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eSDGC_WITH_DIMENSION.PartialEntity.self) else { return nil }
      ...
      guard let super7 = complexEntity?.entityReference(eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT.self) else { return nil }
      self.super_eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT = super7
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSDGC_WITH_DIMENSION``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eSDGC_WITH_DIMENSION.self
      }
