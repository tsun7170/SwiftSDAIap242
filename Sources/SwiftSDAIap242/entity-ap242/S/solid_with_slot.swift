/* file: solid_with_slot.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public final class eSOLID_WITH_SLOT : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eSOLID_WITH_SLOT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eSOLID_WITH_SLOT.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _end_exit_faces: SDAI.LIST<SDAI.SET<eFACE_SURFACE.PRef>/*[0:nil]*/ >/*[2:2]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public static func WHERE_wr2(SELF: eSOLID_WITH_SLOT.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP3 /* SDAI.SET<eFACE_SURFACE.PRef>[0:nil] ? */ = SELF.END_EXIT_FACES?[1]
        ...
        let _TEMP9 /* SDAI.SET<eFACE_SURFACE.PRef>[0:nil] ? */ = SELF.END_EXIT_FACES?[2]
      ...
      public init(
        ...
        END_EXIT_FACES: SDAI.LIST<SDAI.SET<eFACE_SURFACE.PRef>/*[0:nil]*/ >/*[2:2]*/ 
      ) {
