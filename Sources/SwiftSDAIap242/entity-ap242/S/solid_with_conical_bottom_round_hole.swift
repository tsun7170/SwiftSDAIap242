/* file: solid_with_conical_bottom_round_hole.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- solid_with_conical_bottom_round_hole (line:29968 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _solid_with_conical_bottom_round_hole : SDAI.PartialEntity {
...
```
*/
  public final class eSOLID_WITH_CONICAL_BOTTOM_ROUND_HOLE : SDAI.EntityReference {
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``eSOLID_WITH_CONICAL_BOTTOM_ROUND_HOLE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SOLID_WITH_CONICAL_BOTTOM_ROUND_HOLE", type: self, explicitAttributeCount: 2)
      ...
      entityDef.addAttribute(name: "SEGMENT_RADII", keyPath: \eSOLID_WITH_CONICAL_BOTTOM_ROUND_HOLE.SEGMENT_RADII, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "TIP_RADIUS", keyPath: \eSOLID_WITH_CONICAL_BOTTOM_ROUND_HOLE.TIP_RADIUS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RATIONALE", keyPath: \eSOLID_WITH_CONICAL_BOTTOM_ROUND_HOLE.RATIONALE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "BASE_SOLID", keyPath: \eSOLID_WITH_CONICAL_BOTTOM_ROUND_HOLE.BASE_SOLID, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "SEGMENT_DEPTHS", keyPath: \eSOLID_WITH_CONICAL_BOTTOM_ROUND_HOLE.SEGMENT_DEPTHS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "SEGMENTS", keyPath: \eSOLID_WITH_CONICAL_BOTTOM_ROUND_HOLE.SEGMENTS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "SEMI_APEX_ANGLE", keyPath: \eSOLID_WITH_CONICAL_BOTTOM_ROUND_HOLE.SEMI_APEX_ANGLE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "PLACING", keyPath: \eSOLID_WITH_CONICAL_BOTTOM_ROUND_HOLE.PLACING, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSOLID_WITH_CONICAL_BOTTOM_ROUND_HOLE.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DEPTH", keyPath: \eSOLID_WITH_CONICAL_BOTTOM_ROUND_HOLE.DEPTH, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", keyPath: \eSOLID_WITH_CONICAL_BOTTOM_ROUND_HOLE.DIM, 
