/* file: solid_with_conical_bottom_round_hole.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _solid_with_conical_bottom_round_hole : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eSOLID_WITH_CONICAL_BOTTOM_ROUND_HOLE?) -> SDAI.LOGICAL {
      ...
      let _TEMP4 = SDAI.FORCE_OPTIONAL(SELF.TIP_RADIUS) < _TEMP3
      return _TEMP4
    }

    //EXPRESS IMPLICIT PARTIAL ENTITY CONSTRUCTOR
    public init(SEMI_APEX_ANGLE: tPOSITIVE_PLANE_ANGLE_MEASURE, TIP_RADIUS: tNON_NEGATIVE_LENGTH_MEASURE) {
...
```
*/
  public final class eSOLID_WITH_CONICAL_BOTTOM_ROUND_HOLE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _solid_with_conical_bottom_round_hole.WHERE_wr1(SELF: instance)
      return result
    }
