/* file: self_intersecting_geometry.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- self_intersecting_geometry (line:28790 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	self_intersecting_geometry
    (no local attributes)

  SUB- ENTITY(8)	self_intersecting_surface
  ...
  SUB- ENTITY(9)	self_intersecting_curve
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSELF_INTERSECTING_SURFACE``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSELF_INTERSECTING_CURVE``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSELF_INTERSECTING_GEOMETRY/PartialEntity``
*/
  public final class eSELF_INTERSECTING_GEOMETRY : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eSELF_INTERSECTING_GEOMETRY>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eSELF_INTERSECTING_GEOMETRY.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eSELF_INTERSECTING_GEOMETRY.PartialEntity
    ...
    public var super_eSELF_INTERSECTING_GEOMETRY: eSELF_INTERSECTING_GEOMETRY { return self } 	// [7]

    //MARK: SUBTYPES
    public var sub_eSELF_INTERSECTING_SURFACE: eSELF_INTERSECTING_SURFACE? {	// [8]
      return self.complexEntity.entityReference(eSELF_INTERSECTING_SURFACE.self)
    }

    public var sub_eSELF_INTERSECTING_CURVE: eSELF_INTERSECTING_CURVE? {	// [9]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eSELF_INTERSECTING_GEOMETRY.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "SELF_INTERSECTING_GEOMETRY", 
      ...
      entityDef.addAttribute(name: "ARC_LENGTH_SEPARATION_FACTOR", 
        keyPath: \eSELF_INTERSECTING_GEOMETRY.ARC_LENGTH_SEPARATION_FACTOR, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eSELF_INTERSECTING_GEOMETRY.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "GEODESIC_SEPARATION_FACTOR", 
        keyPath: \eSELF_INTERSECTING_GEOMETRY.GEODESIC_SEPARATION_FACTOR, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eSELF_INTERSECTING_GEOMETRY.NAME, 
