/* file: self_intersecting_geometry.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _self_intersecting_geometry : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_self_intersecting_geometry``
*/
  public final class eSELF_INTERSECTING_GEOMETRY : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _self_intersecting_geometry.self
    }
    /// partial entity reference
    public let partialEntity: _self_intersecting_geometry
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_self_intersecting_geometry.self) else { return nil }
