/* file: spherical_pair.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- spherical_pair (line:30554 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUB- ENTITY(7)	spherical_pair_with_range
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSPHERICAL_PAIR_WITH_RANGE``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSPHERICAL_PAIR/PartialEntity``
*/
  public final class eSPHERICAL_PAIR : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eSPHERICAL_PAIR>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eSPHERICAL_PAIR.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eSPHERICAL_PAIR.PartialEntity
    ...
    public var super_eSPHERICAL_PAIR: eSPHERICAL_PAIR { return self } 	// [6]

    //MARK: SUBTYPES
    public var sub_eSPHERICAL_PAIR_WITH_RANGE: eSPHERICAL_PAIR_WITH_RANGE? {	// [7]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSPHERICAL_PAIR`` )
    ...
    public var UPPER_LIMIT_ROLL: tPLANE_ANGLE_MEASURE?  {
      get {
        let originalValue = sub_eSPHERICAL_PAIR_WITH_RANGE?.partialEntity._upper_limit_roll
        let value = tPLANE_ANGLE_MEASURE( originalValue )
        return value
      }
      set(newValue) {
    ...
    public var LOWER_LIMIT_YAW: tPLANE_ANGLE_MEASURE?  {
      get {
        let originalValue = sub_eSPHERICAL_PAIR_WITH_RANGE?.partialEntity._lower_limit_yaw
        let value = tPLANE_ANGLE_MEASURE( originalValue )
        return value
      }
      set(newValue) {
    ...
    public var UPPER_LIMIT_YAW: tPLANE_ANGLE_MEASURE?  {
      get {
        let originalValue = sub_eSPHERICAL_PAIR_WITH_RANGE?.partialEntity._upper_limit_yaw
        let value = tPLANE_ANGLE_MEASURE( originalValue )
        return value
      }
      set(newValue) {
    ...
    public var LOWER_LIMIT_ROLL: tPLANE_ANGLE_MEASURE?  {
      get {
        let originalValue = sub_eSPHERICAL_PAIR_WITH_RANGE?.partialEntity._lower_limit_roll
        let value = tPLANE_ANGLE_MEASURE( originalValue )
        return value
      }
      set(newValue) {
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eSPHERICAL_PAIR.PartialEntity.self) else { return nil }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      internal func _t_x__getter(complex: SDAI.ComplexEntity) -> SDAI.BOOLEAN {
        let SELF = complex.entityReference( eSPHERICAL_PAIR.self )!
        return SDAI.UNWRAP( SDAI.BOOLEAN(SELF.T_X) )
      }
      /// DERIVE ATTRIBUTE REDEFINITION(origin: eLOW_ORDER_KINEMATIC_PAIR)
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _t_x__getter(SELF: eSPHERICAL_PAIR.PRef) -> SDAI.BOOLEAN {
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _t_y__getter(SELF: eSPHERICAL_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.FALSE)
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _t_z__getter(SELF: eSPHERICAL_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.FALSE)
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _r_x__getter(SELF: eSPHERICAL_PAIR.PRef) -> SDAI.BOOLEAN {
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _r_y__getter(SELF: eSPHERICAL_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.TRUE)
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _r_z__getter(SELF: eSPHERICAL_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.TRUE)
        return SDAI.UNWRAP( value )
      }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eSPHERICAL_PAIR.PartialEntity :
