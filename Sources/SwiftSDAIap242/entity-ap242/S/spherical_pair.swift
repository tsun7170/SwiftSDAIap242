/* file: spherical_pair.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _spherical_pair : SDAI.PartialEntity, SDAI.InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_spherical_pair``
*/
  public final class eSPHERICAL_PAIR : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _spherical_pair.self
    }
    /// partial entity reference
    public let partialEntity: _spherical_pair
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_spherical_pair.self) else { return nil }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF._spherical_pair :
