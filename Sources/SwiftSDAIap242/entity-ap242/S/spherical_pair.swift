/* file: spherical_pair.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eSPHERICAL_PAIR : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public var UPPER_LIMIT_ROLL: tPLANE_ANGLE_MEASURE?  {
      get {
        return sub_eSPHERICAL_PAIR_WITH_RANGE?.partialEntity._upper_limit_roll
      }
      set(newValue) {
        guard let partial = sub_eSPHERICAL_PAIR_WITH_RANGE?.super_eSPHERICAL_PAIR_WITH_RANGE.partialEntity
          else { return }
    ...
    public var LOWER_LIMIT_YAW: tPLANE_ANGLE_MEASURE?  {
      get {
        return sub_eSPHERICAL_PAIR_WITH_RANGE?.partialEntity._lower_limit_yaw
      }
      set(newValue) {
        guard let partial = sub_eSPHERICAL_PAIR_WITH_RANGE?.super_eSPHERICAL_PAIR_WITH_RANGE.partialEntity
          else { return }
    ...
    public var UPPER_LIMIT_YAW: tPLANE_ANGLE_MEASURE?  {
      get {
        return sub_eSPHERICAL_PAIR_WITH_RANGE?.partialEntity._upper_limit_yaw
      }
      set(newValue) {
        guard let partial = sub_eSPHERICAL_PAIR_WITH_RANGE?.super_eSPHERICAL_PAIR_WITH_RANGE.partialEntity
          else { return }
    ...
    public var LOWER_LIMIT_ROLL: tPLANE_ANGLE_MEASURE?  {
      get {
        return sub_eSPHERICAL_PAIR_WITH_RANGE?.partialEntity._lower_limit_roll
      }
      set(newValue) {
        guard let partial = sub_eSPHERICAL_PAIR_WITH_RANGE?.super_eSPHERICAL_PAIR_WITH_RANGE.partialEntity
          else { return }
