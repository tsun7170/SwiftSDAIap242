/* file: shape_criteria_representation_with_accuracy.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_CRITERIA_REPRESENTATION_WITH_ACCURACY/PartialEntity``
*/
  public final class eSHAPE_CRITERIA_REPRESENTATION_WITH_ACCURACY : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eSHAPE_CRITERIA_REPRESENTATION_WITH_ACCURACY.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eSHAPE_CRITERIA_REPRESENTATION_WITH_ACCURACY.PartialEntity
    ...
    public var REQUIRED_GENERAL_ACCURACY: SDAI.SET<eSHAPE_MEASUREMENT_ACCURACY.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = self.partialEntity._required_general_accuracy
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eSHAPE_CRITERIA_REPRESENTATION_WITH_ACCURACY.PartialEntity.self) else { return nil }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _required_general_accuracy: SDAI.SET<eSHAPE_MEASUREMENT_ACCURACY.PRef>/*[1:
      ...
      public init(REQUIRED_GENERAL_ACCURACY: SDAI.SET<eSHAPE_MEASUREMENT_ACCURACY.PRef>/*[1:(nil as SDAI.INTEGER?)]*/ ) {

        self._required_general_accuracy = 
        SDAI.SET<eSHAPE_MEASUREMENT_ACCURACY.PRef>(
          from: REQUIRED_GENERAL_ACCURACY.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
