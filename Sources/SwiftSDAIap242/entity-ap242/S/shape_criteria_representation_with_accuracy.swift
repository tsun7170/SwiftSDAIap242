/* file: shape_criteria_representation_with_accuracy.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _required_general_accuracy: SDAI.SET<eSHAPE_MEASUREMENT_ACCURACY.PRef>/*[1:?]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(REQUIRED_GENERAL_ACCURACY: SDAI.SET<eSHAPE_MEASUREMENT_ACCURACY.PRef>/*[1:?]*/ ) {

        self._required_general_accuracy = 
        SDAI.SET<eSHAPE_MEASUREMENT_ACCURACY.PRef>(from: REQUIRED_GENERAL_ACCURACY.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
