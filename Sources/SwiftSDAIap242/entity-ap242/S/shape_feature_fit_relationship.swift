/* file: shape_feature_fit_relationship.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _shape_feature_fit_relationship : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _name__getter(SELF: eSHAPE_FEATURE_FIT_RELATIONSHIP) -> tLABEL {
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eCHARACTERIZED_OBJECT)
    /// - gut of derived attribute logic
    internal func _description__getter(SELF: eSHAPE_FEATURE_FIT_RELATIONSHIP) -> tTEXT {
...
```
*/
  public final class eSHAPE_FEATURE_FIT_RELATIONSHIP : SDAI.EntityReference, @unchecked Sendable {
