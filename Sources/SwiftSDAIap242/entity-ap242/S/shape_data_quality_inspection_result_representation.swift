/* file: shape_data_quality_inspection_result_representation.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _shape_data_quality_inspection_result_representation : SDAI.PartialEntity
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_shape_data_quality_inspection_result_representation``
*/
  public final class eSHAPE_DATA_QUALITY_INSPECTION_RESULT_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _shape_data_quality_inspection_result_representation.self
    }
    /// partial entity reference
    public let partialEntity: _shape_data_quality_inspection_result_representation
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_shape_data_quality_inspection_result_representation.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _shape_data_quality_inspection_result_representation.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _shape_data_quality_inspection_result_representation.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _shape_data_quality_inspection_result_representation.WHERE_wr3(SELF: instance.pRef)
      return result
    }
