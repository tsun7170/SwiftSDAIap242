/* file: shape_data_quality_inspection_result_representation.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eSHAPE_DATA_QUALITY_INSPECTION_RESULT_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eSHAPE_DATA_QUALITY_INSPECTION_RESULT_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eSHAPE_DATA_QUALITY_INSPECTION_RESULT_REPRESENTATION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eSHAPE_DATA_QUALITY_INSPECTION_RESULT_REPRESENTATION.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      return result
    }
