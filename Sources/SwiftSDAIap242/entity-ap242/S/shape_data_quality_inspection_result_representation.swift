/* file: shape_data_quality_inspection_result_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _shape_data_quality_inspection_result_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eSHAPE_DATA_QUALITY_INSPECTION_RESULT_REPRESENTATION?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eSHAPE_DATA_QUALITY_INSPECTION_RESULT_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eSHAPE_DATA_QUALITY_INSPECTION_RESULT_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eSHAPE_DATA_QUALITY_INSPECTION_RESULT_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _shape_data_quality_inspection_result_representation.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _shape_data_quality_inspection_result_representation.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _shape_data_quality_inspection_result_representation.WHERE_wr3(SELF: instance)
      return result
    }
