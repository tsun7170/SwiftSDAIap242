/* file: step.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _step : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eSTEP?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eSTEP?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eSTEP?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eSTEP?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = GET_PROPERTY_DEFINITION_REPRESENTATIONS(sCHARACTERIZED_DEFINITION(/*eSTEP*/SELF))
      let _TEMP2 = _TEMP1?.QUERY{ PDR in 
    ...
    public static func WHERE_wr5(SELF: eSTEP?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eSTEP : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _step.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _step.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _step.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _step.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _step.WHERE_wr5(SELF: instance)
      return result
    }
