/* file: short_length_edge.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- short_length_edge (line:29220 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _short_length_edge : SDAI.PartialEntity {
...
```
*/
  public final class eSHORT_LENGTH_EDGE : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eSHORT_LENGTH_EDGE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SHORT_LENGTH_EDGE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eSHORT_LENGTH_EDGE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSHORT_LENGTH_EDGE.NAME, 
