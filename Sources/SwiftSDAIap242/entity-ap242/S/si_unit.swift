/* file: si_unit.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- si_unit (line:29571 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_RESISTANCE_UNIT``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_ENERGY_UNIT``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_ILLUMINANCE_UNIT``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_ABSORBED_DOSE_UNIT``
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_FREQUENCY_UNIT``
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_RADIOACTIVITY_UNIT``
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_INDUCTANCE_UNIT``
	8.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_MAGNETIC_FLUX_DENSITY_UNIT``
	9.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_POWER_UNIT``
	10.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_PRESSURE_UNIT``
	11.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_MAGNETIC_FLUX_UNIT``
	12.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_ELECTRIC_POTENTIAL_UNIT``
	13.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_DOSE_EQUIVALENT_UNIT``
	14.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_ELECTRIC_CHARGE_UNIT``
	15.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_CONDUCTANCE_UNIT``
	16.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_FORCE_UNIT``
	17.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_CAPACITANCE_UNIT``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_UNIT/PartialEntity``
*/
  public final class eSI_UNIT : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eSI_UNIT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eSI_UNIT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eSI_UNIT.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_UNIT`` )
    public var DIMENSIONS: eDIMENSIONAL_EXPONENTS.PRef {
      get {
        ...
        let origin = self
        let value = SDAI.UNWRAP( origin.partialEntity._dimensions__getter(SELF: origin.pRef) )
    ...
    public var PREFIX: nSI_PREFIX?  {
      get {
        let originalValue = self.partialEntity._prefix
    ...
    public var NAME: nSI_UNIT_NAME {
      get {
        ...
        let value = SDAI.UNWRAP( nSI_UNIT_NAME( originalValue ) )
        return value
      }
      set(newValue) {
        let partial = self.partialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eSI_UNIT.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eSI_UNIT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    ENTITY si_unit
      ...
      WHERE
        wr1: ( ( NOT ( ( 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.MASS_UNIT' IN TYPEOF( SELF ) ) AND 
                 ...
                 + 'DERIVED_UNIT_ELEMENT.UNIT'  ) ) > 0 ) ) ) OR ( prefix = si_prefix.kilo ) );
    END_ENTITY; -- si_unit (line:29571 file:ap242ed2_mim_lf_v1.101_TY.exp)

```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSI_UNIT``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      @_documentation(visibility:public)
      internal func _dimensions__getter(complex: SDAI.ComplexEntity) -> eDIMENSIONAL_EXPONENTS.PRef {
        let SELF = complex.entityReference( eSI_UNIT.self )!
        return SDAI.UNWRAP( eDIMENSIONAL_EXPONENTS.PRef(SELF.DIMENSIONS) )
      }
      /// DERIVE ATTRIBUTE REDEFINITION(origin: eNAMED_UNIT)
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _dimensions__getter(SELF: eSI_UNIT.PRef) -> eDIMENSIONAL_EXPONENTS.PRef {
        //
        let _TEMP1 /* eDIMENSIONAL_EXPONENTS.PRef? */ = DIMENSIONS_FOR_SI_UNIT( 
            SELF.NAME )
        let value = _TEMP1
      ...
      public static func WHERE_wr1(SELF: eSI_UNIT.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: eMASS_UNIT.self )
        let _TEMP2 /* SDAI.BAG<SDAI.GENERIC_ENTITY> */ = SDAI.USEDIN(T: SELF, 
          ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDERIVED_UNIT_ELEMENT.UNIT)
        ...
        let _TEMP7 /* nSI_PREFIX?? */ = nSI_PREFIX.KILO
        let _TEMP8 /* SDAI.LOGICAL */ = SELF.PREFIX .==. SDAI.FORCE_OPTIONAL(_TEMP7)
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( PREFIX: original._prefix, NAME: original._name )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]PREFIX for partial entity(\(Self.entityName)) constructor"); return nil }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eSI_UNIT.PartialEntity :
  eNAMED_UNIT__DIMENSIONS__provider {}
