/* file: shape_feature_definition_relationship.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_FEATURE_DEFINITION_RELATIONSHIP/PartialEntity``
*/
  public final class eSHAPE_FEATURE_DEFINITION_RELATIONSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eSHAPE_FEATURE_DEFINITION_RELATIONSHIP.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eSHAPE_FEATURE_DEFINITION_RELATIONSHIP.PartialEntity
    ...
    public var RELATED_OBJECT: eSHAPE_FEATURE_DEFINITION.PRef {
      get {
        let originalValue = super_eCHARACTERIZED_OBJECT_RELATIONSHIP.partialEntity._related_object
        let value = SDAI.UNWRAP( eSHAPE_FEATURE_DEFINITION.PRef( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public var RELATING_OBJECT: eSHAPE_FEATURE_DEFINITION.PRef {
      get {
        let originalValue = super_eCHARACTERIZED_OBJECT_RELATIONSHIP.partialEntity._relating_object
        let value = SDAI.UNWRAP( eSHAPE_FEATURE_DEFINITION.PRef( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eSHAPE_FEATURE_DEFINITION_RELATIONSHIP.PartialEntity.self) else { return nil }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
  .eSHAPE_FEATURE_DEFINITION_RELATIONSHIP.PartialEntity :eCHARACTERIZED_OBJECT__NAME__provider, 
