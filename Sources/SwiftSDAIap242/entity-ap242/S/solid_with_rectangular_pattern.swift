/* file: solid_with_rectangular_pattern.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- solid_with_rectangular_pattern (line:30097 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _solid_with_rectangular_pattern : SDAI.PartialEntity {
...
```
*/
  public final class eSOLID_WITH_RECTANGULAR_PATTERN : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eSOLID_WITH_RECTANGULAR_PATTERN`` )
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUB( ``eSOLID_WITH_INCOMPLETE_RECTANGULAR_PATTERN`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SOLID_WITH_RECTANGULAR_PATTERN", type: self, explicitAttributeCount: 4)
      ...
      entityDef.addAttribute(name: "ROW_SPACING", keyPath: \eSOLID_WITH_RECTANGULAR_PATTERN.ROW_SPACING, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ROW_COUNT", keyPath: \eSOLID_WITH_RECTANGULAR_PATTERN.ROW_COUNT, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "REPLICATED_ELEMENT", keyPath: \eSOLID_WITH_RECTANGULAR_PATTERN.REPLICATED_ELEMENT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "OMITTED_INSTANCES", keyPath: \eSOLID_WITH_RECTANGULAR_PATTERN.OMITTED_INSTANCES, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RATIONALE", keyPath: \eSOLID_WITH_RECTANGULAR_PATTERN.RATIONALE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "BASE_SOLID", keyPath: \eSOLID_WITH_RECTANGULAR_PATTERN.BASE_SOLID, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "COLUMN_COUNT", keyPath: \eSOLID_WITH_RECTANGULAR_PATTERN.COLUMN_COUNT, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COLUMN_SPACING", keyPath: \eSOLID_WITH_RECTANGULAR_PATTERN.COLUMN_SPACING, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "PLACING", keyPath: \eSOLID_WITH_RECTANGULAR_PATTERN.PLACING, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSOLID_WITH_RECTANGULAR_PATTERN.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", keyPath: \eSOLID_WITH_RECTANGULAR_PATTERN.DIM, 
