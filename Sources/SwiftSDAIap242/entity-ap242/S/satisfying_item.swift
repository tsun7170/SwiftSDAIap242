/* file: satisfying_item.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _satisfying_item : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_satisfying_item``
*/
  public final class eSATISFYING_ITEM : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _satisfying_item.self
    }
    /// partial entity reference
    public let partialEntity: _satisfying_item
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_satisfying_item.self) else { return nil }
