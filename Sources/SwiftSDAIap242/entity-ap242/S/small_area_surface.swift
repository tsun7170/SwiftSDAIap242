/* file: small_area_surface.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- small_area_surface (line:29843 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _small_area_surface : SDAI.PartialEntity {
...
```
*/
  public final class eSMALL_AREA_SURFACE : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eSMALL_AREA_SURFACE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SMALL_AREA_SURFACE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eSMALL_AREA_SURFACE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSMALL_AREA_SURFACE.NAME, 
