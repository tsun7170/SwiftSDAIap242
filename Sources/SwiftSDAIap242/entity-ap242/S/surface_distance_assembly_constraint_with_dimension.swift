/* file: surface_distance_assembly_constraint_with_dimension.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- surface_distance_assembly_constraint_with_dimension (line:31349 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(11)	surface_distance_geometric_constraint
  ...
  SUPER- ENTITY(12)	sdgc_with_dimension
    ATTR:  distance_value,	TYPE: non_negative_length_measure -- EXPLICIT


  ENTITY(SELF)	surface_distance_assembly_constraint_with_dimension
    (no local attributes)
...
- SUPERTYPES:
	...
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBINARY_ASSEMBLY_CONSTRAINT``
	8.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDEFINED_CONSTRAINT``
	9.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGEOMETRIC_REPRESENTATION_ITEM``
	10.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXPLICIT_GEOMETRIC_CONSTRAINT``
	11.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT``
	12.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSDGC_WITH_DIMENSION``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION/PartialEntity``
*/
  public final class eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.PartialEntity
    ...
    public let super_eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT: eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT 	// [11]
    public let super_eSDGC_WITH_DIMENSION: eSDGC_WITH_DIMENSION 	// [12]
    public var super_eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION: eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION { return self } 	// [13]
    ...
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT`` )
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSDGC_WITH_DIMENSION`` )
    public var DISTANCE_VALUE: tNON_NEGATIVE_LENGTH_MEASURE {
      get {
        let originalValue = super_eSDGC_WITH_DIMENSION.partialEntity._distance_value
        let value = SDAI.UNWRAP( tNON_NEGATIVE_LENGTH_MEASURE( originalValue ) )
        return value
      }
      set(newValue) {
        let partial = super_eSDGC_WITH_DIMENSION.partialEntity
        partial._distance_value = SDAI.UNWRAP(newValue)
      }
    }

    /// __EXPLICIT REDEF__ attribute
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBINARY_ASSEMBLY_CONSTRAINT`` )
    ...
    public var NEAR_POINTS: SDAI.SET<eNEAR_POINT_RELATIONSHIP.PRef>/*[0:4]*/  {
      get {
        let originalValue = super_eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT.partialEntity._near_points
        let value = SDAI.UNWRAP( SDAI.SET<eNEAR_POINT_RELATIONSHIP.PRef>( originalValue ) )
        return value
      }
      set(newValue) {
        let partial = super_eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT.partialEntity
        let SELF = super_eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT; SDAI.TOUCH(let:SELF)
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.PartialEntity.self) else { return nil }
      ...
      guard let super11 = complexEntity?.entityReference(eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT.self) else { return nil }
      self.super_eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT = super11

      guard let super12 = complexEntity?.entityReference(eSDGC_WITH_DIMENSION.self) else { return nil }
      self.super_eSDGC_WITH_DIMENSION = super12
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eSDGC_WITH_DIMENSION.self)
      entityDef.add(supertype: eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "TRANSFORMATION_OPERATOR", 
        keyPath: \eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.TRANSFORMATION_OPERATOR, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", 
        keyPath: \eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", 
        keyPath: \eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.REFERENCE_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DISTANCE_VALUE", 
        keyPath: \eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.DISTANCE_VALUE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "REP_1", 
        keyPath: \eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.REP_1, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_2", 
        keyPath: \eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.REP_2, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NEAR_POINTS", 
        keyPath: \eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.NEAR_POINTS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DIM", 
        keyPath: \eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.DIM, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.self
      }
