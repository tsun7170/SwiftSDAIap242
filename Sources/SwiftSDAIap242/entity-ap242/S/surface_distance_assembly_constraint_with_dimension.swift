/* file: surface_distance_assembly_constraint_with_dimension.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var DISTANCE_VALUE: tNON_NEGATIVE_LENGTH_MEASURE {
      get {
        return SDAI.UNWRAP( super_eSDGC_WITH_DIMENSION.partialEntity._distance_value )
      }
      set(newValue) {
    ...
    public var NEAR_POINTS: SDAI.SET<eNEAR_POINT_RELATIONSHIP.PRef>/*[0:4]*/  {
      get {
        return SDAI.UNWRAP( super_eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT.partialEntity._near_points )
      }
      set(newValue) {
