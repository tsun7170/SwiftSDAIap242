/* file: surface_distance_assembly_constraint_with_dimension.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- surface_distance_assembly_constraint_with_dimension (line:31145 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION : SDAI.EntityReference {
    ...
    /// - origin: SUPER( ``eSURFACE_DISTANCE_GEOMETRIC_CONSTRAINT`` )
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUPER( ``eSDGC_WITH_DIMENSION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "TRANSFORMATION_OPERATOR", keyPath: \eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.TRANSFORMATION_OPERATOR, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", keyPath: \eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", keyPath: \eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.REFERENCE_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DISTANCE_VALUE", keyPath: \eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.DISTANCE_VALUE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "REP_1", keyPath: \eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.REP_1, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_2", keyPath: \eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.REP_2, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NEAR_POINTS", keyPath: \eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.NEAR_POINTS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DIM", keyPath: \eSURFACE_DISTANCE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.DIM, 
