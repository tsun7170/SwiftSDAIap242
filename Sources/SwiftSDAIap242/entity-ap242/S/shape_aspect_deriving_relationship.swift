/* file: shape_aspect_deriving_relationship.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _shape_aspect_deriving_relationship : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _relating_shape_aspect: eDERIVED_SHAPE_ASPECT	//EXPLICIT REDEFINITION(eSHAPE_ASPECT_RELATIONSHIP) //OBSERVED */
...
```
*/
  public final class eSHAPE_ASPECT_DERIVING_RELATIONSHIP : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var RELATING_SHAPE_ASPECT: eDERIVED_SHAPE_ASPECT {
      get {
        return SDAI.UNWRAP( eDERIVED_SHAPE_ASPECT( super_eSHAPE_ASPECT_RELATIONSHIP.partialEntity
