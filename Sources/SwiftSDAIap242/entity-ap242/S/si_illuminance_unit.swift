/* file: si_illuminance_unit.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- si_illuminance_unit (line:29297 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _si_illuminance_unit : SDAI.PartialEntity {
...
```
*/
  public final class eSI_ILLUMINANCE_UNIT : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SI_ILLUMINANCE_UNIT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ELEMENTS", keyPath: \eSI_ILLUMINANCE_UNIT.ELEMENTS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DIMENSIONS", keyPath: \eSI_ILLUMINANCE_UNIT.DIMENSIONS, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "PREFIX", keyPath: \eSI_ILLUMINANCE_UNIT.PREFIX, 
