/* file: surface_with_excessive_patches_in_one_direction.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _surface_with_excessive_patches_in_one_direction : SDAI.PartialEntity
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_surface_with_excessive_patches_in_one_direction``
*/
  public final class eSURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _surface_with_excessive_patches_in_one_direction.self
    }
    /// partial entity reference
    public let partialEntity: _surface_with_excessive_patches_in_one_direction
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_surface_with_excessive_patches_in_one_direction.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _surface_with_excessive_patches_in_one_direction.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _surface_with_excessive_patches_in_one_direction.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _surface_with_excessive_patches_in_one_direction.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _surface_with_excessive_patches_in_one_direction.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _surface_with_excessive_patches_in_one_direction.WHERE_wr5(SELF: instance.pRef)
      return result
    }
