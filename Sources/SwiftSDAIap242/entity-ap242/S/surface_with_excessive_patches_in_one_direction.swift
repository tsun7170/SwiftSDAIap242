/* file: surface_with_excessive_patches_in_one_direction.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- surface_with_excessive_patches_in_one_direction (line:31389 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eSURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eSURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eSURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.NAME, 
