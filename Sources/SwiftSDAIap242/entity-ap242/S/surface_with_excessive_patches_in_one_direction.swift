/* file: surface_with_excessive_patches_in_one_direction.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _surface_with_excessive_patches_in_one_direction : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eSURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eSURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = VALIDATE_MEASURED_DATA_TYPE(
        EI: eSHAPE_DATA_QUALITY_CRITERION(/*eSURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION*/SELF), 
        TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.COUNT_MEASURE"))
      return _TEMP1
    }
    public static func WHERE_wr3(SELF: eSURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eSURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr5(SELF: eSURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eSURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _surface_with_excessive_patches_in_one_direction.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _surface_with_excessive_patches_in_one_direction.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _surface_with_excessive_patches_in_one_direction.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _surface_with_excessive_patches_in_one_direction.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _surface_with_excessive_patches_in_one_direction.WHERE_wr5(SELF: instance)
      return result
    }
