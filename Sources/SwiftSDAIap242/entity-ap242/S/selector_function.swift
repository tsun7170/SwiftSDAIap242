/* file: selector_function.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _selector_function : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eSELECTOR_FUNCTION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.SET<eMATHS_FUNCTION>(([
        SDAI.AIE(eMATHS_FUNCTION(/*eSELECTOR_FUNCTION*/SELF))] as [SDAI.AggregationInitializerElement<
        eMATHS_FUNCTION>]))
    ...
    public static func WHERE_wr2(SELF: eSELECTOR_FUNCTION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public init(SELECTOR: tINPUT_SELECTOR, SOURCE_OF_DOMAIN: sMATHS_SPACE_OR_FUNCTION) {
...
```
*/
  public final class eSELECTOR_FUNCTION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _selector_function.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _selector_function.WHERE_wr2(SELF: instance)
      return result
    }
