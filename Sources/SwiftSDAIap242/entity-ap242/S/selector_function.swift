/* file: selector_function.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- selector_function (line:28549 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _selector_function : SDAI.PartialEntity {
...
```
*/
  public final class eSELECTOR_FUNCTION : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eSELECTOR_FUNCTION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SELECTOR_FUNCTION", type: self, explicitAttributeCount: 2)
      ...
      entityDef.addAttribute(name: "SOURCE_OF_DOMAIN", keyPath: \eSELECTOR_FUNCTION.SOURCE_OF_DOMAIN, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "SELECTOR", keyPath: \eSELECTOR_FUNCTION.SELECTOR, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DOMAIN", keyPath: \eSELECTOR_FUNCTION.DOMAIN, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "RANGE", keyPath: \eSELECTOR_FUNCTION.RANGE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
