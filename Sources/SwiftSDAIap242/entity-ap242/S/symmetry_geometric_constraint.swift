/* file: symmetry_geometric_constraint.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public final class eSYMMETRY_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var MIRROR_ELEMENT: sLINEAR_GEOMETRY_CONSTRAINT_ELEMENT {
      get {
        return SDAI.UNWRAP( self.partialEntity._mirror_element )
      }
      set(newValue) {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eSYMMETRY_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eSYMMETRY_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eSYMMETRY_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      return result
    }
