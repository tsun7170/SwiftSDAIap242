/* file: symmetry_geometric_constraint.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _symmetry_geometric_constraint : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _constrained_elements: SDAI.SET<eGEOMETRIC_REPRESENTATION_ITEM>[2:2] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */
    ...
    public static func WHERE_wr1(SELF: eSYMMETRY_GEOMETRIC_CONSTRAINT?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eSYMMETRY_GEOMETRIC_CONSTRAINT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.TYPEOF(SELF.MIRROR_ELEMENT)
    ...
    public static func WHERE_wr3(SELF: eSYMMETRY_GEOMETRIC_CONSTRAINT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP4 = SDAI.TYPEOF(SELF.MIRROR_ELEMENT, IS: ePLANE.self)
...
```
*/
  public final class eSYMMETRY_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var CONSTRAINED_ELEMENTS: SDAI.SET<eGEOMETRIC_REPRESENTATION_ITEM>/*[2:2]*/  {
      get {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _symmetry_geometric_constraint.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _symmetry_geometric_constraint.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _symmetry_geometric_constraint.WHERE_wr3(SELF: instance)
      return result
    }
