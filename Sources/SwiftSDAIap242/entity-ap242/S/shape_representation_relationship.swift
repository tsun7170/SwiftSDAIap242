/* file: shape_representation_relationship.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_REPRESENTATION_RELATIONSHIP/PartialEntity``
*/
  public final class eSHAPE_REPRESENTATION_RELATIONSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eSHAPE_REPRESENTATION_RELATIONSHIP.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eSHAPE_REPRESENTATION_RELATIONSHIP.PartialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eSHAPE_REPRESENTATION_RELATIONSHIP.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eSHAPE_REPRESENTATION_RELATIONSHIP.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
