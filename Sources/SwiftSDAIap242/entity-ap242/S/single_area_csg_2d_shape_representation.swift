/* file: single_area_csg_2d_shape_representation.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eSINGLE_AREA_CSG_2D_SHAPE_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var ITEMS: SDAI.SET<sCSG_2D_AREA_SELECT>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<sCSG_2D_AREA_SELECT>( super_eREPRESENTATION.partialEntity._items ) )
      }
      set(newValue) {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eSINGLE_AREA_CSG_2D_SHAPE_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eSINGLE_AREA_CSG_2D_SHAPE_REPRESENTATION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _items: SDAI.SET<sCSG_2D_AREA_SELECT>[1:nil] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
      ...
      public static func WHERE_wr1(SELF: eSINGLE_AREA_CSG_2D_SHAPE_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP1 /* SDAI.SET<sCSG_2D_AREA_SELECT>[1:nil] ? */ = SELF.ITEMS
        let _TEMP2 /* SDAI.SET<sCSG_2D_AREA_SELECT>[1:nil] ? */ = _TEMP1?
          .QUERY{ IT in 
            // QUERY BODY
