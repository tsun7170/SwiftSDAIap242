/* file: satisfied_requirement.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _satisfied_requirement : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_satisfied_requirement``
*/
  public final class eSATISFIED_REQUIREMENT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _satisfied_requirement.self
    }
    /// partial entity reference
    public let partialEntity: _satisfied_requirement
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_satisfied_requirement.self) else { return nil }
