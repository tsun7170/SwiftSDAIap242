/* file: satisfied_requirement.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- satisfied_requirement (line:28421 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _satisfied_requirement : SDAI.PartialEntity {
...
```
*/
  public final class eSATISFIED_REQUIREMENT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eSATISFIED_REQUIREMENT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SATISFIED_REQUIREMENT", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "ROLE", keyPath: \eSATISFIED_REQUIREMENT.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eSATISFIED_REQUIREMENT.ITEMS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_GROUP", keyPath: \eSATISFIED_REQUIREMENT.ASSIGNED_GROUP, 
