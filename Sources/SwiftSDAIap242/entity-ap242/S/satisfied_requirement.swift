/* file: satisfied_requirement.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _satisfied_requirement : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _assigned_group: eSATISFIES_REQUIREMENT	//EXPLICIT REDEFINITION(eGROUP_ASSIGNMENT) */

    /// EXPLICIT ATTRIBUTE 
    public internal(set) var _items: SDAI.SET<ePRODUCT_DEFINITION>/*[1:1]*/  // PLAIN EXPLICIT ATTRIBUTE
    ...
    public init(ITEMS: SDAI.SET<ePRODUCT_DEFINITION>/*[1:1]*/ ) {
      self._items = ITEMS
...
```
*/
  public final class eSATISFIED_REQUIREMENT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var ITEMS: SDAI.SET<ePRODUCT_DEFINITION>/*[1:1]*/  {
      get {
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSATISFIED_REQUIREMENT`` )
    public var ASSIGNED_GROUP: eSATISFIES_REQUIREMENT {
      get {
        if let resolved = _group_assignment._assigned_group__provider(complex: self.complexEntity) {
          let value = SDAI.UNWRAP( eSATISFIES_REQUIREMENT(resolved._assigned_group__getter(
            complex: self.complexEntity)) )
          return value
        }
        else {
          return SDAI.UNWRAP( eSATISFIES_REQUIREMENT(super_eGROUP_ASSIGNMENT.partialEntity._assigned_group) )
        }
      }
      set(newValue) {
