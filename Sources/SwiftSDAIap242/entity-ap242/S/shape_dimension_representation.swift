/* file: shape_dimension_representation.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- shape_dimension_representation (line:28878 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _shape_dimension_representation : SDAI.PartialEntity {
...
```
*/
  public final class eSHAPE_DIMENSION_REPRESENTATION : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eSHAPE_DIMENSION_REPRESENTATION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SHAPE_DIMENSION_REPRESENTATION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eSHAPE_DIMENSION_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eSHAPE_DIMENSION_REPRESENTATION.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eSHAPE_DIMENSION_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eSHAPE_DIMENSION_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSHAPE_DIMENSION_REPRESENTATION.NAME, 
