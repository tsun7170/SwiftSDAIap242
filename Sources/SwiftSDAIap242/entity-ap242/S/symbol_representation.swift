/* file: symbol_representation.swift 	 generated: Mon Dec 15 17:41:04 2025 */
...
*/
  ...
  public final class _symbol_representation : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_symbol_representation``
*/
  public final class eSYMBOL_REPRESENTATION : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _symbol_representation.self
    }
    /// partial entity reference
    public let partialEntity: _symbol_representation
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_symbol_representation.self) else { return nil }
