/* file: spherical_volume.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- spherical_volume (line:30410 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _spherical_volume : SDAI.PartialEntity {
...
```
*/
  public final class eSPHERICAL_VOLUME : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SPHERICAL_VOLUME", type: self, explicitAttributeCount: 2)
      ...
      entityDef.addAttribute(name: "RADIUS", keyPath: \eSPHERICAL_VOLUME.RADIUS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "POSITION", keyPath: \eSPHERICAL_VOLUME.POSITION, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSPHERICAL_VOLUME.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", keyPath: \eSPHERICAL_VOLUME.DIM, 
