/* file: source_for_requirement.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- source_for_requirement (line:30254 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _source_for_requirement : SDAI.PartialEntity {
...
```
*/
  public final class eSOURCE_FOR_REQUIREMENT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eSOURCE_FOR_REQUIREMENT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SOURCE_FOR_REQUIREMENT", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "ROLE", keyPath: \eSOURCE_FOR_REQUIREMENT.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eSOURCE_FOR_REQUIREMENT.ITEMS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_GROUP", keyPath: \eSOURCE_FOR_REQUIREMENT.ASSIGNED_GROUP, 
