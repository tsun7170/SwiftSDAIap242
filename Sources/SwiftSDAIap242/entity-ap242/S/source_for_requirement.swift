/* file: source_for_requirement.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _source_for_requirement : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _assigned_group: eREQUIREMENT_SOURCE	//EXPLICIT REDEFINITION(eGROUP_ASSIGNMENT) */
...
```
*/
  public final class eSOURCE_FOR_REQUIREMENT : SDAI.EntityReference, @unchecked Sendable {
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSOURCE_FOR_REQUIREMENT`` )
    public var ASSIGNED_GROUP: eREQUIREMENT_SOURCE {
      get {
        if let resolved = _group_assignment._assigned_group__provider(complex: self.complexEntity) {
          let value = SDAI.UNWRAP( eREQUIREMENT_SOURCE(resolved._assigned_group__getter(
            complex: self.complexEntity)) )
          return value
        }
        else {
          return SDAI.UNWRAP( eREQUIREMENT_SOURCE(super_eGROUP_ASSIGNMENT.partialEntity._assigned_group) )
        }
      }
      set(newValue) {
