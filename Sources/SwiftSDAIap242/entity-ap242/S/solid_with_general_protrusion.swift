/* file: solid_with_general_protrusion.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _solid_with_general_protrusion : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eSOLID_WITH_GENERAL_PROTRUSION?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eSOLID_WITH_GENERAL_PROTRUSION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eSOLID_WITH_GENERAL_PROTRUSION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _solid_with_general_protrusion.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _solid_with_general_protrusion.WHERE_wr2(SELF: instance)
      return result
    }
