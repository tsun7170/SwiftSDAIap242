/* file: solid_with_general_protrusion.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- solid_with_general_protrusion (line:30032 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _solid_with_general_protrusion : SDAI.PartialEntity {
...
```
*/
  public final class eSOLID_WITH_GENERAL_PROTRUSION : SDAI.EntityReference {
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``eSOLID_WITH_GENERAL_PROTRUSION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SOLID_WITH_GENERAL_PROTRUSION", type: self, explicitAttributeCount: 2)
      ...
      entityDef.addAttribute(name: "PROTRUSION_HEIGHT", keyPath: \eSOLID_WITH_GENERAL_PROTRUSION.PROTRUSION_HEIGHT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "PROTRUSION_DRAFT_ANGLE", keyPath: \eSOLID_WITH_GENERAL_PROTRUSION.PROTRUSION_DRAFT_ANGLE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RATIONALE", keyPath: \eSOLID_WITH_GENERAL_PROTRUSION.RATIONALE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "BASE_SOLID", keyPath: \eSOLID_WITH_GENERAL_PROTRUSION.BASE_SOLID, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REFERENCE_POINT", keyPath: \eSOLID_WITH_GENERAL_PROTRUSION.REFERENCE_POINT, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "PROFILE", keyPath: \eSOLID_WITH_GENERAL_PROTRUSION.PROFILE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "PLACING", keyPath: \eSOLID_WITH_GENERAL_PROTRUSION.PLACING, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSOLID_WITH_GENERAL_PROTRUSION.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", keyPath: \eSOLID_WITH_GENERAL_PROTRUSION.DIM, 
