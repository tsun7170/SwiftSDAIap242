/* file: solid_with_excessive_number_of_voids.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eSOLID_WITH_EXCESSIVE_NUMBER_OF_VOIDS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eSOLID_WITH_EXCESSIVE_NUMBER_OF_VOIDS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eSOLID_WITH_EXCESSIVE_NUMBER_OF_VOIDS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eSOLID_WITH_EXCESSIVE_NUMBER_OF_VOIDS.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eSOLID_WITH_EXCESSIVE_NUMBER_OF_VOIDS.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = eSOLID_WITH_EXCESSIVE_NUMBER_OF_VOIDS.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
