/* file: solid_with_excessive_number_of_voids.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- solid_with_excessive_number_of_voids (line:29999 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _solid_with_excessive_number_of_voids : SDAI.PartialEntity {
...
```
*/
  public final class eSOLID_WITH_EXCESSIVE_NUMBER_OF_VOIDS : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eSOLID_WITH_EXCESSIVE_NUMBER_OF_VOIDS`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SOLID_WITH_EXCESSIVE_NUMBER_OF_VOIDS", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eSOLID_WITH_EXCESSIVE_NUMBER_OF_VOIDS.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSOLID_WITH_EXCESSIVE_NUMBER_OF_VOIDS.NAME, 
