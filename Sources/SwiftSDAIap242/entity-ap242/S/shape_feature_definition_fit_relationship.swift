/* file: shape_feature_definition_fit_relationship.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- shape_feature_definition_fit_relationship (line:29112 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_FEATURE_DEFINITION_FIT_RELATIONSHIP/PartialEntity``
*/
  public final class eSHAPE_FEATURE_DEFINITION_FIT_RELATIONSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eSHAPE_FEATURE_DEFINITION_FIT_RELATIONSHIP>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eSHAPE_FEATURE_DEFINITION_FIT_RELATIONSHIP.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eSHAPE_FEATURE_DEFINITION_FIT_RELATIONSHIP.PartialEntity
    ...
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_FEATURE_DEFINITION_RELATIONSHIP`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eSHAPE_FEATURE_DEFINITION_FIT_RELATIONSHIP.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "SHAPE_FEATURE_DEFINITION_FIT_RELATIONSHIP", 
      ...
      entityDef.addAttribute(name: "RELATED_OBJECT", 
        keyPath: \eSHAPE_FEATURE_DEFINITION_FIT_RELATIONSHIP.RELATED_OBJECT, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "RELATING_OBJECT", 
        keyPath: \eSHAPE_FEATURE_DEFINITION_FIT_RELATIONSHIP.RELATING_OBJECT, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_FEATURE_DEFINITION_FIT_RELATIONSHIP``
*/
