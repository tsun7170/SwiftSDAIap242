/* file: self_intersecting_loop.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public final class eSELF_INTERSECTING_LOOP : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var ARC_LENGTH_DISTANCE_FACTOR: SDAI.REAL {
      get {
        return SDAI.UNWRAP( self.partialEntity._arc_length_distance_factor )
      }
      set(newValue) {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eSELF_INTERSECTING_LOOP.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eSELF_INTERSECTING_LOOP.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eSELF_INTERSECTING_LOOP.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eSELF_INTERSECTING_LOOP.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
