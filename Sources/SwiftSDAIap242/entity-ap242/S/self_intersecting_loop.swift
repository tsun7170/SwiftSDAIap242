/* file: self_intersecting_loop.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- self_intersecting_loop (line:28577 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _self_intersecting_loop : SDAI.PartialEntity {
...
```
*/
  public final class eSELF_INTERSECTING_LOOP : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eSELF_INTERSECTING_LOOP`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SELF_INTERSECTING_LOOP", type: self, explicitAttributeCount: 2)
      ...
      entityDef.addAttribute(name: "ARC_LENGTH_DISTANCE_FACTOR", keyPath: \eSELF_INTERSECTING_LOOP.ARC_LENGTH_DISTANCE_FACTOR, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "INTERFERENCE_TOLERANCE", keyPath: \eSELF_INTERSECTING_LOOP.INTERFERENCE_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eSELF_INTERSECTING_LOOP.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSELF_INTERSECTING_LOOP.NAME, 
