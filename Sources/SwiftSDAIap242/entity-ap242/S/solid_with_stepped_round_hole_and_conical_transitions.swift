/* file: solid_with_stepped_round_hole_and_conical_transitions.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_solid_with_stepped_round_hole_and_conical_transitions``
*/
  public final class eSOLID_WITH_STEPPED_ROUND_HOLE_AND_CONICAL_TRANSITIONS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _solid_with_stepped_round_hole_and_conical_transitions.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _solid_with_stepped_round_hole_and_conical_transitions.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _solid_with_stepped_round_hole_and_conical_transitions.WHERE_wr3(SELF: instance.pRef)
      return result
    }
