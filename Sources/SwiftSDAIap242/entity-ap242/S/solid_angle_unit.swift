/* file: solid_angle_unit.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _solid_angle_unit : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eSOLID_ANGLE_UNIT?) -> SDAI.LOGICAL {
...
```
*/
  public final class eSOLID_ANGLE_UNIT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _solid_angle_unit.WHERE_wr1(SELF: instance)
      return result
    }
