/* file: square_root_function.swift 	 generated: Mon Dec 15 17:41:04 2025 */
...
*/
  ...
  public final class _square_root_function : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_square_root_function``
*/
  public final class eSQUARE_ROOT_FUNCTION : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _square_root_function.self
    }
    /// partial entity reference
    public let partialEntity: _square_root_function
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_square_root_function.self) else { return nil }
