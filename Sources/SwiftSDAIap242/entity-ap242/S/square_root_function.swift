/* file: square_root_function.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- square_root_function (line:30667 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	square_root_function
    (no local attributes)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSQUARE_ROOT_FUNCTION/PartialEntity``
*/
  public final class eSQUARE_ROOT_FUNCTION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eSQUARE_ROOT_FUNCTION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eSQUARE_ROOT_FUNCTION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eSQUARE_ROOT_FUNCTION.PartialEntity
    ...
    public var super_eSQUARE_ROOT_FUNCTION: eSQUARE_ROOT_FUNCTION { return self } 	// [7]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eSQUARE_ROOT_FUNCTION.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eSQUARE_ROOT_FUNCTION.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "IS_INT", 
        keyPath: \eSQUARE_ROOT_FUNCTION.IS_INT, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "SQL_MAPPABLE", 
        keyPath: \eSQUARE_ROOT_FUNCTION.SQL_MAPPABLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OPERAND", 
        keyPath: \eSQUARE_ROOT_FUNCTION.OPERAND, 
