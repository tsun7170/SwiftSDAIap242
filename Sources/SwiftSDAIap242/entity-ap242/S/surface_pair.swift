/* file: surface_pair.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _surface_pair : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /// EXPLICIT ATTRIBUTE 
    public internal(set) var _surface_1: eSURFACE // PLAIN EXPLICIT ATTRIBUTE

    /// EXPLICIT ATTRIBUTE 
    public internal(set) var _surface_2: eSURFACE // PLAIN EXPLICIT ATTRIBUTE
    ...
    public static func WHERE_wr1(SELF: eSURFACE_PAIR?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eSURFACE_PAIR?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eSURFACE_PAIR?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public init(SURFACE_1: eSURFACE, SURFACE_2: eSURFACE, ORIENTATION: SDAI.BOOLEAN) {
...
```
*/
  public final class eSURFACE_PAIR : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _surface_pair.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _surface_pair.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _surface_pair.WHERE_wr3(SELF: instance)
      return result
    }
