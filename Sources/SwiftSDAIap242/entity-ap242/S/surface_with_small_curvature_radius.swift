/* file: surface_with_small_curvature_radius.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- surface_with_small_curvature_radius (line:31630 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	surface_with_small_curvature_radius
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE_WITH_SMALL_CURVATURE_RADIUS/PartialEntity``
*/
  public final class eSURFACE_WITH_SMALL_CURVATURE_RADIUS : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eSURFACE_WITH_SMALL_CURVATURE_RADIUS>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eSURFACE_WITH_SMALL_CURVATURE_RADIUS.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eSURFACE_WITH_SMALL_CURVATURE_RADIUS.PartialEntity
    ...
    public var super_eSURFACE_WITH_SMALL_CURVATURE_RADIUS: eSURFACE_WITH_SMALL_CURVATURE_RADIUS { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE_WITH_SMALL_CURVATURE_RADIUS`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eSURFACE_WITH_SMALL_CURVATURE_RADIUS.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eSURFACE_WITH_SMALL_CURVATURE_RADIUS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eSURFACE_WITH_SMALL_CURVATURE_RADIUS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eSURFACE_WITH_SMALL_CURVATURE_RADIUS.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eSURFACE_WITH_SMALL_CURVATURE_RADIUS.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = eSURFACE_WITH_SMALL_CURVATURE_RADIUS.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "SURFACE_WITH_SMALL_CURVATURE_RADIUS", 
      ...
      entityDef.add(supertype: eSURFACE_WITH_SMALL_CURVATURE_RADIUS.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eSURFACE_WITH_SMALL_CURVATURE_RADIUS.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eSURFACE_WITH_SMALL_CURVATURE_RADIUS.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE_WITH_SMALL_CURVATURE_RADIUS``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eSURFACE_WITH_SMALL_CURVATURE_RADIUS.self
      }
      ...
      public static func WHERE_wr1(SELF: eSURFACE_WITH_SMALL_CURVATURE_RADIUS.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eSURFACE_WITH_SMALL_CURVATURE_RADIUS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eSURFACE_WITH_SMALL_CURVATURE_RADIUS.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.LENGTH_MEASURE") )
        return _TEMP1
      }
      public static func WHERE_wr3(SELF: eSURFACE_WITH_SMALL_CURVATURE_RADIUS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
      ...
      public static func WHERE_wr4(SELF: eSURFACE_WITH_SMALL_CURVATURE_RADIUS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
      ...
      public static func WHERE_wr5(SELF: eSURFACE_WITH_SMALL_CURVATURE_RADIUS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
