/* file: surface_with_small_curvature_radius.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eSURFACE_WITH_SMALL_CURVATURE_RADIUS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eSURFACE_WITH_SMALL_CURVATURE_RADIUS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eSURFACE_WITH_SMALL_CURVATURE_RADIUS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eSURFACE_WITH_SMALL_CURVATURE_RADIUS.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eSURFACE_WITH_SMALL_CURVATURE_RADIUS.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = eSURFACE_WITH_SMALL_CURVATURE_RADIUS.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
