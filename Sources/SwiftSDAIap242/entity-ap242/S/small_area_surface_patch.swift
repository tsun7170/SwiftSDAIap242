/* file: small_area_surface_patch.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- small_area_surface_patch (line:29871 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _small_area_surface_patch : SDAI.PartialEntity {
...
```
*/
  public final class eSMALL_AREA_SURFACE_PATCH : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eSMALL_AREA_SURFACE_PATCH`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SMALL_AREA_SURFACE_PATCH", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eSMALL_AREA_SURFACE_PATCH.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSMALL_AREA_SURFACE_PATCH.NAME, 
