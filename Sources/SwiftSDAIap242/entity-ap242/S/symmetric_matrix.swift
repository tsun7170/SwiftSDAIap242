/* file: symmetric_matrix.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _symmetric_matrix : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_symmetric_matrix``
*/
  public final class eSYMMETRIC_MATRIX : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _symmetric_matrix.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _symmetric_matrix.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _symmetric_matrix.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _symmetric_matrix.WHERE_wr4(SELF: instance.pRef)
      return result
    }
