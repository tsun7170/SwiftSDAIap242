/* file: symmetric_matrix.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eSYMMETRIC_MATRIX : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eSYMMETRIC_MATRIX.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eSYMMETRIC_MATRIX.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eSYMMETRIC_MATRIX.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eSYMMETRIC_MATRIX.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: eSYMMETRIC_MATRIX.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP2 /* SDAI.LIST<tPOSITIVE_INTEGER>[1:nil] ? */ = _TEMP1?.SHAPE
