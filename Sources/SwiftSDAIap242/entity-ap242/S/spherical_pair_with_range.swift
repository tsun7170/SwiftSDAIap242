/* file: spherical_pair_with_range.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _spherical_pair_with_range : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eSPHERICAL_PAIR_WITH_RANGE?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eSPHERICAL_PAIR_WITH_RANGE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eSPHERICAL_PAIR_WITH_RANGE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public init(LOWER_LIMIT_YAW: tPLANE_ANGLE_MEASURE? , UPPER_LIMIT_YAW: tPLANE_ANGLE_MEASURE? , 
                LOWER_LIMIT_PITCH: tPLANE_ANGLE_MEASURE? , UPPER_LIMIT_PITCH: tPLANE_ANGLE_MEASURE? , 
...
```
*/
  public final class eSPHERICAL_PAIR_WITH_RANGE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _spherical_pair_with_range.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _spherical_pair_with_range.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _spherical_pair_with_range.WHERE_wr3(SELF: instance)
      return result
    }
