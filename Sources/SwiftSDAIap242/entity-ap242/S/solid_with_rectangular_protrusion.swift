/* file: solid_with_rectangular_protrusion.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY solid_with_rectangular_protrusion
    ...
    WHERE
      wr1: ( ( protrusion_corner_radius <= ( protrusion_width / 2 ) ) AND ( protrusion_corner_radius <= ( 
               protrusion_length / 2 ) ) );
  END_ENTITY; -- solid_with_rectangular_protrusion (line:30131 file:ap242ed2_mim_lf_v1.101.TY.exp)
