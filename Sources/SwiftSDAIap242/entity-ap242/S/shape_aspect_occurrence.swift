/* file: shape_aspect_occurrence.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _shape_aspect_occurrence : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eSHAPE_ASPECT_OCCURRENCE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = ACYCLIC_SHAPE_ASPECT_OCCURRENCE(
        SAO: SELF, DEFINITION: SELF.DEFINITION)
...
```
*/
  public final class eSHAPE_ASPECT_OCCURRENCE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _shape_aspect_occurrence.WHERE_wr1(SELF: instance)
      return result
    }
