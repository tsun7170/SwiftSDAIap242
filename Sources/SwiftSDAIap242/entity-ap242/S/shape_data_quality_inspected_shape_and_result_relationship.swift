/* file: shape_data_quality_inspected_shape_and_result_relationship.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_shape_data_quality_inspected_shape_and_result_relationship``
*/
  public final class eSHAPE_DATA_QUALITY_INSPECTED_SHAPE_AND_RESULT_RELATIONSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _shape_data_quality_inspected_shape_and_result_relationship.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _shape_data_quality_inspected_shape_and_result_relationship.WHERE_wr2(SELF: instance.pRef)
      return result
    }
