/* file: shape_data_quality_criteria_representation.swift 	 generated: Sun Oct 31 15:32:10 2021 */
  ...
  ENTITY shape_data_quality_criteria_representation
    ...
    WHERE
      wr1: ( SIZEOF( QUERY ( q <* SELF\representation.items | ( 
               ...
               > 0 );
  END_ENTITY; -- shape_data_quality_criteria_representation (line:28719 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eSHAPE_DATA_QUALITY_CRITERIA_REPRESENTATION : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SHAPE_DATA_QUALITY_CRITERIA_REPRESENTATION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eSHAPE_DATA_QUALITY_CRITERIA_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eSHAPE_DATA_QUALITY_CRITERIA_REPRESENTATION.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REQUIRED_GENERAL_ACCURACY", keyPath: \eSHAPE_DATA_QUALITY_CRITERIA_REPRESENTATION.REQUIRED_GENERAL_ACCURACY, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eSHAPE_DATA_QUALITY_CRITERIA_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eSHAPE_DATA_QUALITY_CRITERIA_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSHAPE_DATA_QUALITY_CRITERIA_REPRESENTATION.NAME, 
