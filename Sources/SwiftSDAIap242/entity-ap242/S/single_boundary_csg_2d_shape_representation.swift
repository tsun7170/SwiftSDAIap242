/* file: single_boundary_csg_2d_shape_representation.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _single_boundary_csg_2d_shape_representation : SDAI.PartialEntity
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_single_boundary_csg_2d_shape_representation``
*/
  public final class eSINGLE_BOUNDARY_CSG_2D_SHAPE_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _single_boundary_csg_2d_shape_representation.self
    }
    /// partial entity reference
    public let partialEntity: _single_boundary_csg_2d_shape_representation
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_single_boundary_csg_2d_shape_representation.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _single_boundary_csg_2d_shape_representation.WHERE_wr1(SELF: instance.pRef)
      return result
    }
