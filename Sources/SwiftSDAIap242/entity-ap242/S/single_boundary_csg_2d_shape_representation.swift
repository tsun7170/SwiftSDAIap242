/* file: single_boundary_csg_2d_shape_representation.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- single_boundary_csg_2d_shape_representation (line:29475 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eSINGLE_BOUNDARY_CSG_2D_SHAPE_REPRESENTATION : SDAI.EntityReference {
    ...
    /// - origin: SUPER( ``eSINGLE_AREA_CSG_2D_SHAPE_REPRESENTATION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SINGLE_BOUNDARY_CSG_2D_SHAPE_REPRESENTATION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eSINGLE_BOUNDARY_CSG_2D_SHAPE_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eSINGLE_BOUNDARY_CSG_2D_SHAPE_REPRESENTATION.ITEMS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eSINGLE_BOUNDARY_CSG_2D_SHAPE_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eSINGLE_BOUNDARY_CSG_2D_SHAPE_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSINGLE_BOUNDARY_CSG_2D_SHAPE_REPRESENTATION.NAME, 
