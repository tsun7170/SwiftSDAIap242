/* file: steep_angle_between_adjacent_edges.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY steep_angle_between_adjacent_edges
    ...
    WHERE
      ...
      wr5: validate_accuracy_types( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               + 'PLANE_ANGLE_MEASURE' ] );
  END_ENTITY; -- steep_angle_between_adjacent_edges (line:30738 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _steep_angle_between_adjacent_edges : SDAI.PartialEntity {
...
```
*/
  public final class eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "STEEP_ANGLE_BETWEEN_ADJACENT_EDGES", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.NAME, 
