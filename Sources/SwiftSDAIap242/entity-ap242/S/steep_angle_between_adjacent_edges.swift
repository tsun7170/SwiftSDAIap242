/* file: steep_angle_between_adjacent_edges.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
