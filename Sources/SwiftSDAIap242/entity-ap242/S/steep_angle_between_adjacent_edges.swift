/* file: steep_angle_between_adjacent_edges.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  ENTITY steep_angle_between_adjacent_edges
    ...
    WHERE
      ...
      wr5: validate_accuracy_types( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               + 'PLANE_ANGLE_MEASURE' ] );
  END_ENTITY; -- steep_angle_between_adjacent_edges (line:30956 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	steep_angle_between_adjacent_edges
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES/PartialEntity``
*/
  public final class eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.PartialEntity
    ...
    public var super_eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES: eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "STEEP_ANGLE_BETWEEN_ADJACENT_EDGES", 
      ...
      entityDef.add(supertype: eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.self
      }
      ...
      public static func WHERE_wr1(SELF: eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PLANE_ANGLE_MEASURE") )
        return _TEMP1
      }
      public static func WHERE_wr3(SELF: eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr4(SELF: eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
            SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ORIENTED_EDGE")) ] 
            as [SDAI.AggregationInitializerElement<SDAI.STRING>]) )
      ...
      public static func WHERE_wr5(SELF: eSTEEP_ANGLE_BETWEEN_ADJACENT_EDGES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
