/* file: scan_data_shape_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _scan_data_shape_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _items: SDAI.SET<eSCANNED_DATA_ITEM>[1:nil] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
    ...
    public static func WHERE_wr1(SELF: eSCAN_DATA_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
...
```
*/
  public final class eSCAN_DATA_SHAPE_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var ITEMS: SDAI.SET<eSCANNED_DATA_ITEM>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eSCANNED_DATA_ITEM>( super_eREPRESENTATION.partialEntity._items ) )
      }
      set(newValue) {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _scan_data_shape_representation.WHERE_wr1(SELF: instance)
      return result
    }
