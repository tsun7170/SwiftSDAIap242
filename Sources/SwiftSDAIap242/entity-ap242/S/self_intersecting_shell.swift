/* file: self_intersecting_shell.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- self_intersecting_shell (line:28605 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _self_intersecting_shell : SDAI.PartialEntity {
...
```
*/
  public final class eSELF_INTERSECTING_SHELL : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eSELF_INTERSECTING_SHELL`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SELF_INTERSECTING_SHELL", type: self, explicitAttributeCount: 2)
      ...
      entityDef.addAttribute(name: "INTERFERENCE_TOLERANCE", keyPath: \eSELF_INTERSECTING_SHELL.INTERFERENCE_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eSELF_INTERSECTING_SHELL.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "GEODESIC_SEPARATION_FACTOR", keyPath: \eSELF_INTERSECTING_SHELL.GEODESIC_SEPARATION_FACTOR, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eSELF_INTERSECTING_SHELL.NAME, 
