/* file: skew_line_distance_geometric_constraint.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _skew_line_distance_geometric_constraint : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _constrained_elements: SDAI.SET<eLINE>[1:2] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */

    /* override var _reference_elements: SDAI.SET<eLINE>[0:1] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */
    ...
    public static func WHERE_wr1(SELF: eSKEW_LINE_DISTANCE_GEOMETRIC_CONSTRAINT?) -> SDAI.LOGICAL {
...
```
*/
  public final class eSKEW_LINE_DISTANCE_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var CONSTRAINED_ELEMENTS: SDAI.SET<eLINE>/*[1:2]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eLINE>( super_eEXPLICIT_CONSTRAINT.partialEntity._constrained_elements ) )
      }
      set(newValue) {
        let partial = super_eEXPLICIT_CONSTRAINT.partialEntity
    ...
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSKEW_LINE_DISTANCE_GEOMETRIC_CONSTRAINT`` )
    public var REFERENCE_ELEMENTS: SDAI.SET<eLINE>/*[0:1]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eLINE>( super_eEXPLICIT_CONSTRAINT.partialEntity._reference_elements ) )
      }
      set(newValue) {
        let partial = super_eEXPLICIT_CONSTRAINT.partialEntity
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _skew_line_distance_geometric_constraint.WHERE_wr1(SELF: instance)
      return result
    }
