/* file: solid_with_straight_slot.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- solid_with_straight_slot (line:30187 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _solid_with_straight_slot : SDAI.PartialEntity {
...
```
*/
  public final class eSOLID_WITH_STRAIGHT_SLOT : SDAI.EntityReference {
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``eSOLID_WITH_STRAIGHT_SLOT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SOLID_WITH_STRAIGHT_SLOT", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "SLOT_WIDTH", keyPath: \eSOLID_WITH_STRAIGHT_SLOT.SLOT_WIDTH, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "END_EXIT_FACES", keyPath: \eSOLID_WITH_STRAIGHT_SLOT.END_EXIT_FACES, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "SLOT_LENGTH", keyPath: \eSOLID_WITH_STRAIGHT_SLOT.SLOT_LENGTH, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RATIONALE", keyPath: \eSOLID_WITH_STRAIGHT_SLOT.RATIONALE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "BASE_SOLID", keyPath: \eSOLID_WITH_STRAIGHT_SLOT.BASE_SOLID, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CLOSED_ENDS", keyPath: \eSOLID_WITH_STRAIGHT_SLOT.CLOSED_ENDS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "PLACING", keyPath: \eSOLID_WITH_STRAIGHT_SLOT.PLACING, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSOLID_WITH_STRAIGHT_SLOT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DEPTH", keyPath: \eSOLID_WITH_STRAIGHT_SLOT.DEPTH, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", keyPath: \eSOLID_WITH_STRAIGHT_SLOT.DIM, 
