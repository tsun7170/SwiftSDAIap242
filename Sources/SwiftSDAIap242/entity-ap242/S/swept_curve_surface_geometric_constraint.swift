/* file: swept_curve_surface_geometric_constraint.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eSWEPT_CURVE_SURFACE_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var CONSTRAINED_ELEMENTS: SDAI.SET<eSURFACE.PRef>/*[1:nil]*/  {
      get {
    ...
    public var REFERENCE_ELEMENTS: SDAI.SET<sSWEPT_SURFACE_OR_SOLID>/*[1:1]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<sSWEPT_SURFACE_OR_SOLID>( super_eEXPLICIT_CONSTRAINT.partialEntity
          ._reference_elements ) )
      }
      set(newValue) {
        let partial = super_eEXPLICIT_CONSTRAINT.partialEntity
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _constrained_elements: SDAI.SET<eSURFACE.PRef>[1:nil] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */
