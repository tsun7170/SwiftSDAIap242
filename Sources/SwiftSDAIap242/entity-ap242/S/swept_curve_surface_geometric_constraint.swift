/* file: swept_curve_surface_geometric_constraint.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- swept_curve_surface_geometric_constraint (line:31436 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _swept_curve_surface_geometric_constraint : SDAI.PartialEntity {
...
```
*/
  public final class eSWEPT_CURVE_SURFACE_GEOMETRIC_CONSTRAINT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eSWEPT_CURVE_SURFACE_GEOMETRIC_CONSTRAINT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SWEPT_CURVE_SURFACE_GEOMETRIC_CONSTRAINT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eSWEPT_CURVE_SURFACE_GEOMETRIC_CONSTRAINT.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", keyPath: \eSWEPT_CURVE_SURFACE_GEOMETRIC_CONSTRAINT.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", keyPath: \eSWEPT_CURVE_SURFACE_GEOMETRIC_CONSTRAINT.REFERENCE_ELEMENTS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eSWEPT_CURVE_SURFACE_GEOMETRIC_CONSTRAINT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", keyPath: \eSWEPT_CURVE_SURFACE_GEOMETRIC_CONSTRAINT.DIM, 
