/* file: swept_curve_surface_geometric_constraint.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _swept_curve_surface_geometric_constraint : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _constrained_elements: SDAI.SET<eSURFACE>[1:nil] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */
...
```
*/
  public final class eSWEPT_CURVE_SURFACE_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var CONSTRAINED_ELEMENTS: SDAI.SET<eSURFACE>/*[1:nil]*/  {
      get {
