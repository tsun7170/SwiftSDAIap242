/* file: shell_based_wireframe_shape_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _shell_based_wireframe_shape_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eSHELL_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eSHELL_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eSHELL_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.ITEMS
      let _TEMP2 = _TEMP1.QUERY{ IT in 

          let _TEMP1 = SDAI.TYPEOF(IT, IS: eSHELL_BASED_WIREFRAME_MODEL.self)
          return _TEMP1 }
      let _TEMP3 = _TEMP2.QUERY{ SBWM in 

          let _TEMP1 = SBWM.GROUP_REF(eSHELL_BASED_WIREFRAME_MODEL.self)
          let _TEMP2 = _TEMP1?.SBWM_BOUNDARY
          let _TEMP3 = _TEMP2?.QUERY{ SB in 

              let _TEMP1 = SDAI.TYPEOF(SB, IS: eWIRE_SHELL.self)
              return _TEMP1 }
          let _TEMP4 = _TEMP3?.QUERY{ WS in 

              let _TEMP1 = WS.GROUP_REF(eWIRE_SHELL.self)
              let _TEMP2 = _TEMP1?.WIRE_SHELL_EXTENT
              let _TEMP3 = _TEMP2?.QUERY{ WSB in 

                  let _TEMP1 = SDAI.TYPEOF(WSB, IS: eEDGE_LOOP.self)
                  return _TEMP1 }
              let _TEMP4 = _TEMP3?.QUERY{ ELOOP in 

                  let _TEMP1 = ELOOP.GROUP_REF(ePATH.self)
                  let _TEMP2 = _TEMP1?.EDGE_LIST
                  let _TEMP3 = _TEMP2?
                    .QUERY{ EL in 

                      let _TEMP1 = SDAI.TYPEOF(EL.EDGE_ELEMENT, IS: eEDGE_CURVE.self)
                      let _TEMP2 =  !_TEMP1
                      return _TEMP2 }
                  let _TEMP4 = SDAI.SIZEOF(_TEMP3)
    ...
    public static func WHERE_wr4(SELF: eSHELL_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
              ...
              let _TEMP4 = _TEMP3?.QUERY{ ELOOP in 
                  ...
                  let _TEMP3 = _TEMP2?
                    .QUERY{ EL in 
                      ...
                      let _TEMP1 = SDAI.TYPEOF(EL.EDGE_ELEMENT.GROUP_REF(eEDGE_CURVE.self)?.EDGE_GEOMETRY, 
                        IS: ePOLYLINE.self)
                      return _TEMP1 }
                  let _TEMP4 = _TEMP3?
                    .QUERY{ PLINE_EL in 

                      let _TEMP1 = PLINE_EL.EDGE_ELEMENT
                      let _TEMP2 = _TEMP1.GROUP_REF(eEDGE_CURVE.self)
                      let _TEMP3 = _TEMP2?.EDGE_GEOMETRY
                      let _TEMP4 = _TEMP3?.GROUP_REF(ePOLYLINE.self)
                      let _TEMP5 = _TEMP4?.POINTS
    ...
    public static func WHERE_wr5(SELF: eSHELL_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
              ...
              let _TEMP4 = _TEMP3?.QUERY{ ELOOP in 
                  ...
                  let _TEMP3 = _TEMP2?
                    .QUERY{ EL in 
                      ...
                      let _TEMP1 = EL.EDGE_ELEMENT
                      let _TEMP2 = _TEMP1.GROUP_REF(eEDGE_CURVE.self)
                      let _TEMP3 = _TEMP2?.EDGE_GEOMETRY
                      let _TEMP4 = VALID_WIREFRAME_EDGE_CURVE(_TEMP3)
                      let _TEMP5 =  !_TEMP4
                      return _TEMP5 }
                  let _TEMP4 = SDAI.SIZEOF(_TEMP3)
                  let _TEMP5 = _TEMP4 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(0))
    ...
    public static func WHERE_wr6(SELF: eSHELL_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
              ...
              let _TEMP4 = _TEMP3?.QUERY{ ELOOP in 
                  ...
                  let _TEMP3 = _TEMP2?
                    .QUERY{ EL in 
                      ...
                      let _TEMP1 = SDAI.TYPEOF(EL.EDGE_ELEMENT.EDGE_START, IS: eVERTEX_POINT.self)
                      let _TEMP2 = SDAI.TYPEOF(EL.EDGE_ELEMENT.EDGE_END, IS: eVERTEX_POINT.self)
    ...
    public static func WHERE_wr7(SELF: eSHELL_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
              ...
              let _TEMP4 = _TEMP3?.QUERY{ ELOOP in 
                  ...
                  let _TEMP3 = _TEMP2?
                    .QUERY{ EL in 
                      ...
                      let _TEMP1 = EL.EDGE_ELEMENT
                      let _TEMP2 = _TEMP1.EDGE_START
                      let _TEMP3 = _TEMP2.GROUP_REF(eVERTEX_POINT.self)
                      let _TEMP4 = _TEMP3?.VERTEX_GEOMETRY
                      let _TEMP5 = VALID_WIREFRAME_VERTEX_POINT(_TEMP4)
                      let _TEMP6 = EL.EDGE_ELEMENT
                      let _TEMP7 = _TEMP6.EDGE_END
                      let _TEMP8 = _TEMP7.GROUP_REF(eVERTEX_POINT.self)
                      let _TEMP9 = _TEMP8?.VERTEX_GEOMETRY
                      let _TEMP10 = VALID_WIREFRAME_VERTEX_POINT(_TEMP9)
    ...
    public static func WHERE_wr8(SELF: eSHELL_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ SBWM in 
          ...
          let _TEMP4 = _TEMP3?.QUERY{ WS in 
              ...
              let _TEMP3 = _TEMP2?.QUERY{ WSB in 
                  ...
                  let _TEMP1 = SDAI.TYPEOF(WSB, IS: eVERTEX_LOOP.self)
                  return _TEMP1 }
              let _TEMP4 = _TEMP3?.QUERY{ VLOOP in 

                  let _TEMP1 = SDAI.TYPEOF(VLOOP.GROUP_REF(eVERTEX_LOOP.self)?.LOOP_VERTEX, 
    ...
    public static func WHERE_wr9(SELF: eSHELL_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ SBWM in 
          ...
          let _TEMP4 = _TEMP3?.QUERY{ WS in 
              ...
              let _TEMP4 = _TEMP3?.QUERY{ VLOOP in 
                  ...
                  let _TEMP1 = VLOOP.GROUP_REF(eVERTEX_LOOP.self)
                  let _TEMP2 = _TEMP1?.LOOP_VERTEX
                  let _TEMP3 = _TEMP2?.GROUP_REF(eVERTEX_POINT.self)
                  let _TEMP4 = _TEMP3?.VERTEX_GEOMETRY
                  let _TEMP5 = VALID_WIREFRAME_VERTEX_POINT(_TEMP4)
                  let _TEMP6 =  !_TEMP5
    ...
    public static func WHERE_wr10(SELF: eSHELL_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ SBWM in 
          ...
          let _TEMP3 = _TEMP2?.QUERY{ SB in 
              ...
              let _TEMP1 = SDAI.TYPEOF(SB, IS: eVERTEX_SHELL.self)
              return _TEMP1 }
          let _TEMP4 = _TEMP3?.QUERY{ VS in 

              let _TEMP1 = SDAI.TYPEOF(VS.GROUP_REF(eVERTEX_SHELL.self)?.VERTEX_SHELL_EXTENT.LOOP_VERTEX, 
                IS: eVERTEX_POINT.self)
              let _TEMP2 =  !_TEMP1
              return _TEMP2 }
          let _TEMP5 = SDAI.SIZEOF(_TEMP4)
    ...
    public static func WHERE_wr11(SELF: eSHELL_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ SBWM in 
          ...
          let _TEMP4 = _TEMP3?.QUERY{ VS in 
              ...
              let _TEMP1 = VS.GROUP_REF(eVERTEX_SHELL.self)
              let _TEMP2 = _TEMP1?.VERTEX_SHELL_EXTENT
              let _TEMP3 = _TEMP2?.LOOP_VERTEX
              let _TEMP4 = _TEMP3?.GROUP_REF(eVERTEX_POINT.self)
              let _TEMP5 = _TEMP4?.VERTEX_GEOMETRY
              let _TEMP6 = VALID_WIREFRAME_VERTEX_POINT(_TEMP5)
              let _TEMP7 =  !_TEMP6
              return _TEMP7 }
          let _TEMP5 = SDAI.SIZEOF(_TEMP4)
          let _TEMP6 = _TEMP5 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(0))
    ...
    public static func WHERE_wr12(SELF: eSHELL_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr13(SELF: eSHELL_BASED_WIREFRAME_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eSHELL_BASED_WIREFRAME_SHAPE_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _shell_based_wireframe_shape_representation.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _shell_based_wireframe_shape_representation.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _shell_based_wireframe_shape_representation.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _shell_based_wireframe_shape_representation.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _shell_based_wireframe_shape_representation.WHERE_wr5(SELF: instance)
      result[prefix2 + " .WHERE_wr6"] = _shell_based_wireframe_shape_representation.WHERE_wr6(SELF: instance)
      result[prefix2 + " .WHERE_wr7"] = _shell_based_wireframe_shape_representation.WHERE_wr7(SELF: instance)
      result[prefix2 + " .WHERE_wr8"] = _shell_based_wireframe_shape_representation.WHERE_wr8(SELF: instance)
      result[prefix2 + " .WHERE_wr9"] = _shell_based_wireframe_shape_representation.WHERE_wr9(SELF: instance)
      result[prefix2 + " .WHERE_wr10"] = _shell_based_wireframe_shape_representation.WHERE_wr10(SELF: instance)
      result[prefix2 + " .WHERE_wr11"] = _shell_based_wireframe_shape_representation.WHERE_wr11(SELF: instance)
      result[prefix2 + " .WHERE_wr12"] = _shell_based_wireframe_shape_representation.WHERE_wr12(SELF: instance)
      result[prefix2 + " .WHERE_wr13"] = _shell_based_wireframe_shape_representation.WHERE_wr13(SELF: instance)
      return result
    }
