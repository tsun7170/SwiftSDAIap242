/* file: scanned_data_item.swift 	 generated: Tue Oct 14 17:54:07 2025 */
  ...
  ENTITY scanned_data_item
    ...
    WHERE
      wr1: ( SIZEOF( QUERY ( using_rep <* using_representations( SELF ) | ( NOT ( 
               ...
               using_rep ) ) ) ) ) = 0 );
  END_ENTITY; -- scanned_data_item (line:28455 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  ...
  public final class _scanned_data_item : SDAI.PartialEntity, @unchecked Sendable {
