/* file: swept_point_curve_geometric_constraint.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _swept_point_curve_geometric_constraint : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_swept_point_curve_geometric_constraint``
*/
  public final class eSWEPT_POINT_CURVE_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _swept_point_curve_geometric_constraint.self
    }
    /// partial entity reference
    public let partialEntity: _swept_point_curve_geometric_constraint
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_swept_point_curve_geometric_constraint.self) else { return nil }
