/* file: swept_point_curve_geometric_constraint.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eSWEPT_POINT_CURVE_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var CONSTRAINED_ELEMENTS: SDAI.SET<eCURVE.PRef>/*[1:nil]*/  {
      get {
    ...
    public var REFERENCE_ELEMENTS: SDAI.SET<eSWEPT_FACE_SOLID.PRef>/*[1:1]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eSWEPT_FACE_SOLID.PRef>( super_eEXPLICIT_CONSTRAINT.partialEntity
          ._reference_elements ) )
      }
      set(newValue) {
        let partial = super_eEXPLICIT_CONSTRAINT.partialEntity
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _constrained_elements: SDAI.SET<eCURVE.PRef>[1:nil] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */
