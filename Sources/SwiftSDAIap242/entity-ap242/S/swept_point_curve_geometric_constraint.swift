/* file: swept_point_curve_geometric_constraint.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- swept_point_curve_geometric_constraint (line:31688 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	swept_point_curve_geometric_constraint
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSWEPT_POINT_CURVE_GEOMETRIC_CONSTRAINT/PartialEntity``
*/
  public final class eSWEPT_POINT_CURVE_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eSWEPT_POINT_CURVE_GEOMETRIC_CONSTRAINT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eSWEPT_POINT_CURVE_GEOMETRIC_CONSTRAINT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eSWEPT_POINT_CURVE_GEOMETRIC_CONSTRAINT.PartialEntity
    ...
    public var super_eSWEPT_POINT_CURVE_GEOMETRIC_CONSTRAINT: eSWEPT_POINT_CURVE_GEOMETRIC_CONSTRAINT { return self } 	// [7]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSWEPT_POINT_CURVE_GEOMETRIC_CONSTRAINT`` )
    public var CONSTRAINED_ELEMENTS: SDAI.SET<eCURVE.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
    ...
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSWEPT_POINT_CURVE_GEOMETRIC_CONSTRAINT`` )
    public var REFERENCE_ELEMENTS: SDAI.SET<eSWEPT_FACE_SOLID.PRef>/*[1:1]*/  {
      get {
        let originalValue = super_eEXPLICIT_CONSTRAINT.partialEntity._reference_elements
        let SELF = super_eEXPLICIT_CONSTRAINT; SDAI.TOUCH(let:SELF)
        let value =         SDAI.SET<eSWEPT_FACE_SOLID.PRef>(
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eSWEPT_POINT_CURVE_GEOMETRIC_CONSTRAINT.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eSWEPT_POINT_CURVE_GEOMETRIC_CONSTRAINT.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eSWEPT_POINT_CURVE_GEOMETRIC_CONSTRAINT.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", 
        keyPath: \eSWEPT_POINT_CURVE_GEOMETRIC_CONSTRAINT.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", 
        keyPath: \eSWEPT_POINT_CURVE_GEOMETRIC_CONSTRAINT.REFERENCE_ELEMENTS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eSWEPT_POINT_CURVE_GEOMETRIC_CONSTRAINT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", 
        keyPath: \eSWEPT_POINT_CURVE_GEOMETRIC_CONSTRAINT.DIM, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSWEPT_POINT_CURVE_GEOMETRIC_CONSTRAINT``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eSWEPT_POINT_CURVE_GEOMETRIC_CONSTRAINT.self
      }

      //ATTRIBUTES
      /* override var _constrained_elements: SDAI.SET<eCURVE.PRef>[1:(nil as SDAI.INTEGER?)] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */

      /* override var _reference_elements: SDAI.SET<eSWEPT_FACE_SOLID.PRef>[1:1] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */
