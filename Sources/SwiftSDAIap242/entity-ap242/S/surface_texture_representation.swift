/* file: surface_texture_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _surface_texture_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eSURFACE_TEXTURE_REPRESENTATION?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eSURFACE_TEXTURE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP5 = SELF.ITEMS
      let _TEMP6 = _TEMP5.QUERY{ I in 

          let _TEMP1 = SDAI.TYPEOF(I, IS: eDESCRIPTIVE_REPRESENTATION_ITEM.self)
          let _TEMP2 = I.NAME
          let _TEMP3 = SDAI.FORCE_OPTIONAL(_TEMP2) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("measuring method"))
    ...
    public static func WHERE_wr3(SELF: eSURFACE_TEXTURE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eSURFACE_TEXTURE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP8 = SDAI.USEDIN(T: SELF, ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
        .eREPRESENTATION_RELATIONSHIP.REP_1)
      let _TEMP9 = _TEMP8.QUERY{ RR in 

          let _TEMP1 = /*runtime*/RR.REP_2
      ...
      let _TEMP11 = SDAI.USEDIN(T: SELF, ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
        .eREPRESENTATION_RELATIONSHIP.REP_1)
    ...
    public static func WHERE_wr5(SELF: eSURFACE_TEXTURE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eSURFACE_TEXTURE_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _surface_texture_representation.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _surface_texture_representation.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _surface_texture_representation.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _surface_texture_representation.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _surface_texture_representation.WHERE_wr5(SELF: instance)
      return result
    }
