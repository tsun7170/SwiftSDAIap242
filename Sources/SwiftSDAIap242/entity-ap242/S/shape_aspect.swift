/* file: shape_aspect.swift 	 generated: Tue Oct 14 17:54:07 2025 */
  ...
  ENTITY shape_aspect
    ...
    WHERE
      wr1: ( SIZEOF( USEDIN( SELF, 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ID_ATTRIBUTE.'
               + 'IDENTIFIED_ITEM'  ) ) <= 1 );
  END_ENTITY; -- shape_aspect (line:28641 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  public final class eSHAPE_ASPECT : SDAI.EntityReference, SDAIDualModeReference, SDAISimpleEntityType, 
    ...
    get {
      ...
      let swiftValue = SDAI.SET<eSHAPE_ASPECT_DERIVING_RELATIONSHIP.PRef>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \eSHAPE_ASPECT_DERIVING_RELATIONSHIP.RELATING_SHAPE_ASPECT) )
      let value = SDAI.SET<eSHAPE_ASPECT_DERIVING_RELATIONSHIP.PRef>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
    ...
    get {
      ...
      let swiftValue = SDAI.SET<eSHAPE_ASPECT_RELATIONSHIP.PRef>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \eSHAPE_ASPECT_RELATIONSHIP.RELATED_SHAPE_ASPECT) )
      let value = SDAI.SET<eSHAPE_ASPECT_RELATIONSHIP.PRef>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
        SDAI.INTEGER(1)), bound2: (nil as SDAI.INTEGER?))
    ...
    get {
      ...
      let swiftValue = SDAI.SET<eSHAPE_ASPECT_RELATIONSHIP.PRef>/*[2:nil]*/ .SwiftType( self.referencingEntities(for: \eSHAPE_ASPECT_RELATIONSHIP.RELATING_SHAPE_ASPECT) )
      let value = SDAI.SET<eSHAPE_ASPECT_RELATIONSHIP.PRef>/*[2:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
        SDAI.INTEGER(2)), bound2: (nil as SDAI.INTEGER?))
    ...
    get {
      ...
      let swiftValue = SDAI.SET<eSHAPE_ASPECT_RELATIONSHIP.PRef>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \eSHAPE_ASPECT_RELATIONSHIP.RELATING_SHAPE_ASPECT) )
      let value = SDAI.SET<eSHAPE_ASPECT_RELATIONSHIP.PRef>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
        SDAI.INTEGER(1)), bound2: (nil as SDAI.INTEGER?))
    ...
    get {
      ...
      let swiftValue = SDAI.SET<eSHAPE_ASPECT_DERIVING_RELATIONSHIP.PRef>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \eSHAPE_ASPECT_DERIVING_RELATIONSHIP.RELATED_SHAPE_ASPECT) )
      let value = SDAI.SET<eSHAPE_ASPECT_DERIVING_RELATIONSHIP.PRef>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
        SDAI.INTEGER(1)), bound2: (nil as SDAI.INTEGER?))
