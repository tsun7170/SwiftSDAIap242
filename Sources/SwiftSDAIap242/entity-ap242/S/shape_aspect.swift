/* file: shape_aspect.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eSHAPE_ASPECT : SDAI.EntityReference, SDAI.DualModeReference, SDAI.SimpleEntityType, 
    ...
    public var RELATED_SHAPE_ASPECT: eCOMPONENT_FEATURE.PRef?  {
      get {
        return eCOMPONENT_FEATURE.PRef( sub_eCOMPONENT_FEATURE_JOINT?.super_eSHAPE_ASPECT_RELATIONSHIP
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"BASIS_RELATIONSHIPS") {
        return cached.value as! (SDAI.SET<eSHAPE_ASPECT_DERIVING_RELATIONSHIP.PRef>/*[1:nil]*/ )? 
      }
      let keypath = \eSHAPE_ASPECT_DERIVING_RELATIONSHIP.RELATED_SHAPE_ASPECT
      let entities = self.referencingEntities(for: keypath)
      let swiftValue = SDAI.SET<eSHAPE_ASPECT_DERIVING_RELATIONSHIP.PRef>/*[1:nil]*/ .SwiftType( entities )
      let value = SDAI.SET<eSHAPE_ASPECT_DERIVING_RELATIONSHIP.PRef>/*[1:nil]*/ (
        from: swiftValue, bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as SDAI.INTEGER?))
      updateCache(derivedAttributeName:"BASIS_RELATIONSHIPS", value:value)
      return value
    }
    }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eSHAPE_ASPECT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
