/* file: shape_aspect.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
```
*/
  public final class eSHAPE_ASPECT : SDAI.EntityReference, @unchecked Sendable {
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"DERIVING_RELATIONSHIPS") {
        return cached.value as! (SDAI.SET<eSHAPE_ASPECT_DERIVING_RELATIONSHIP>/*[1:nil]*/ )? 
      }
      let swiftValue = SDAI.SET<eSHAPE_ASPECT_DERIVING_RELATIONSHIP>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \eSHAPE_ASPECT_DERIVING_RELATIONSHIP.RELATING_SHAPE_ASPECT) )
      let value = SDAI.SET<eSHAPE_ASPECT_DERIVING_RELATIONSHIP>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"ESTABLISHED_BY_RELATIONSHIPS") {
        return cached.value as! (SDAI.SET<eSHAPE_ASPECT_RELATIONSHIP>/*[1:nil]*/ )? 
      }
      let swiftValue = SDAI.SET<eSHAPE_ASPECT_RELATIONSHIP>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \eSHAPE_ASPECT_RELATIONSHIP.RELATED_SHAPE_ASPECT) )
      let value = SDAI.SET<eSHAPE_ASPECT_RELATIONSHIP>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
        SDAI.INTEGER(1)), bound2: (nil as SDAI.INTEGER?))
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"COMPONENT_RELATIONSHIPS") {
        return cached.value as! (SDAI.SET<eSHAPE_ASPECT_RELATIONSHIP>/*[2:nil]*/ )? 
      }
      let swiftValue = SDAI.SET<eSHAPE_ASPECT_RELATIONSHIP>/*[2:nil]*/ .SwiftType( self.referencingEntities(for: \eSHAPE_ASPECT_RELATIONSHIP.RELATING_SHAPE_ASPECT) )
      let value = SDAI.SET<eSHAPE_ASPECT_RELATIONSHIP>/*[2:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
    ...
    get {
      ...
      let swiftValue = SDAI.SET<eSHAPE_ASPECT_RELATIONSHIP>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \eSHAPE_ASPECT_RELATIONSHIP.RELATING_SHAPE_ASPECT) )
      let value = SDAI.SET<eSHAPE_ASPECT_RELATIONSHIP>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
        SDAI.INTEGER(1)), bound2: (nil as SDAI.INTEGER?))
    ...
    get {
      ...
      let swiftValue = SDAI.SET<eSHAPE_ASPECT_DERIVING_RELATIONSHIP>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \eSHAPE_ASPECT_DERIVING_RELATIONSHIP.RELATED_SHAPE_ASPECT) )
      let value = SDAI.SET<eSHAPE_ASPECT_DERIVING_RELATIONSHIP>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
        SDAI.INTEGER(1)), bound2: (nil as SDAI.INTEGER?))
