/* file: simple_numeric_expression.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSIMPLE_NUMERIC_EXPRESSION/PartialEntity``
*/
  public final class eSIMPLE_NUMERIC_EXPRESSION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eSIMPLE_NUMERIC_EXPRESSION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eSIMPLE_NUMERIC_EXPRESSION.PartialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eSIMPLE_NUMERIC_EXPRESSION.PartialEntity.self) else { return nil }
