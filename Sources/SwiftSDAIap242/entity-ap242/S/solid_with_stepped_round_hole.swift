/* file: solid_with_stepped_round_hole.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _solid_with_stepped_round_hole : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _depth__getter(SELF: eSOLID_WITH_STEPPED_ROUND_HOLE.PRef) -> tPOSITIVE_LENGTH_MEASURE {
      ...
      let _TEMP1 /* tPOSITIVE_LENGTH_MEASURE? */ = COMPUTE_TOTAL_DEPTH( SELF )
      let value = _TEMP1
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_solid_with_stepped_round_hole``
*/
  public final class eSOLID_WITH_STEPPED_ROUND_HOLE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _solid_with_stepped_round_hole.WHERE_wr1(SELF: instance.pRef)
      return result
    }
