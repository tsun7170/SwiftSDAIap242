/* file: sourced_requirement.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _sourced_requirement : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_sourced_requirement``
*/
  public final class eSOURCED_REQUIREMENT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _sourced_requirement.self
    }
    /// partial entity reference
    public let partialEntity: _sourced_requirement
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_sourced_requirement.self) else { return nil }
