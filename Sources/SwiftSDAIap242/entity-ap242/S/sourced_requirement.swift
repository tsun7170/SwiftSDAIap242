/* file: sourced_requirement.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- sourced_requirement (line:30246 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _sourced_requirement : SDAI.PartialEntity {
...
```
*/
  public final class eSOURCED_REQUIREMENT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eSOURCED_REQUIREMENT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "SOURCED_REQUIREMENT", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "ROLE", keyPath: \eSOURCED_REQUIREMENT.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eSOURCED_REQUIREMENT.ITEMS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_GROUP", keyPath: \eSOURCED_REQUIREMENT.ASSIGNED_GROUP, 
