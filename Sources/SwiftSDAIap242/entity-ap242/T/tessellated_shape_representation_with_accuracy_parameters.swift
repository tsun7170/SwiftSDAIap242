/* file: tessellated_shape_representation_with_accuracy_parameters.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _tessellation_accuracy_parameters: SDAI.SET<
        sTESSELLATION_ACCURACY_PARAMETER_ITEM>/*[1:?]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(TESSELLATION_ACCURACY_PARAMETERS: SDAI.SET<sTESSELLATION_ACCURACY_PARAMETER_ITEM>/*[1:?]*/ ) {
        ...
        SDAI.SET<sTESSELLATION_ACCURACY_PARAMETER_ITEM>(from: TESSELLATION_ACCURACY_PARAMETERS.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
