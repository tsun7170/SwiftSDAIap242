/* file: tessellated_shape_representation_with_accuracy_parameters.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- tessellated_shape_representation_with_accuracy_parameters (line:32293 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUPERTYPES:
	...
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTESSELLATED_SHAPE_REPRESENTATION``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTESSELLATED_SHAPE_REPRESENTATION_WITH_ACCURACY_PARAMETERS/PartialEntity``
*/
  public final class eTESSELLATED_SHAPE_REPRESENTATION_WITH_ACCURACY_PARAMETERS : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eTESSELLATED_SHAPE_REPRESENTATION_WITH_ACCURACY_PARAMETERS>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eTESSELLATED_SHAPE_REPRESENTATION_WITH_ACCURACY_PARAMETERS.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eTESSELLATED_SHAPE_REPRESENTATION_WITH_ACCURACY_PARAMETERS.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTESSELLATED_SHAPE_REPRESENTATION_WITH_ACCURACY_PARAMETERS`` )
    public var TESSELLATION_ACCURACY_PARAMETERS: SDAI.SET<sTESSELLATION_ACCURACY_PARAMETER_ITEM>/*[1:(nil as 
      SDAI.INTEGER?)]*/  {
      get {
        let originalValue = self.partialEntity._tessellation_accuracy_parameters
        let value = SDAI.UNWRAP( SDAI.SET<sTESSELLATION_ACCURACY_PARAMETER_ITEM>( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eTESSELLATED_SHAPE_REPRESENTATION_WITH_ACCURACY_PARAMETERS.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eTESSELLATED_SHAPE_REPRESENTATION_WITH_ACCURACY_PARAMETERS.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eTESSELLATED_SHAPE_REPRESENTATION_WITH_ACCURACY_PARAMETERS.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "TESSELLATION_ACCURACY_PARAMETERS", 
        keyPath: \eTESSELLATED_SHAPE_REPRESENTATION_WITH_ACCURACY_PARAMETERS.TESSELLATION_ACCURACY_PARAMETERS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eTESSELLATED_SHAPE_REPRESENTATION_WITH_ACCURACY_PARAMETERS.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eTESSELLATED_SHAPE_REPRESENTATION_WITH_ACCURACY_PARAMETERS.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eTESSELLATED_SHAPE_REPRESENTATION_WITH_ACCURACY_PARAMETERS.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTESSELLATED_SHAPE_REPRESENTATION_WITH_ACCURACY_PARAMETERS``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _tessellation_accuracy_parameters: SDAI.SET<
        sTESSELLATION_ACCURACY_PARAMETER_ITEM>/*[1:(nil as SDAI.INTEGER?)]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(TESSELLATION_ACCURACY_PARAMETERS: SDAI.SET<sTESSELLATION_ACCURACY_PARAMETER_ITEM>/*[1:
        (nil as SDAI.INTEGER?)]*/ ) {

        self._tessellation_accuracy_parameters = 
        SDAI.SET<sTESSELLATION_ACCURACY_PARAMETER_ITEM>(
          from: TESSELLATION_ACCURACY_PARAMETERS.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( TESSELLATION_ACCURACY_PARAMETERS: original._tessellation_accuracy_parameters )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]TESSELLATION_ACCURACY_PARAMETERS for partial entity(\(Self.entityName)) constructor"); return nil }
