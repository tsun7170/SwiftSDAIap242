/* file: twisted_cross_sectional_group_shape_element.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- twisted_cross_sectional_group_shape_element (line:33168 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eTWISTED_CROSS_SECTIONAL_GROUP_SHAPE_ELEMENT : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "TWISTED_CROSS_SECTIONAL_GROUP_SHAPE_ELEMENT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "PRODUCT_DEFINITIONAL", keyPath: \eTWISTED_CROSS_SECTIONAL_GROUP_SHAPE_ELEMENT.PRODUCT_DEFINITIONAL, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eTWISTED_CROSS_SECTIONAL_GROUP_SHAPE_ELEMENT.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eTWISTED_CROSS_SECTIONAL_GROUP_SHAPE_ELEMENT.ITEMS, 
        kind: .inverse, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "OF_SHAPE", keyPath: \eTWISTED_CROSS_SECTIONAL_GROUP_SHAPE_ELEMENT.OF_SHAPE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eTWISTED_CROSS_SECTIONAL_GROUP_SHAPE_ELEMENT.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eTWISTED_CROSS_SECTIONAL_GROUP_SHAPE_ELEMENT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
