/* file: text_literal_with_delineation.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- text_literal_with_delineation (line:32184 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _text_literal_with_delineation : SDAI.PartialEntity {
...
```
*/
  public final class eTEXT_LITERAL_WITH_DELINEATION : SDAI.EntityReference {
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``eTEXT_LITERAL_WITH_DELINEATION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "TEXT_LITERAL_WITH_DELINEATION", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "PATH", keyPath: \eTEXT_LITERAL_WITH_DELINEATION.PATH, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "LITERAL", keyPath: \eTEXT_LITERAL_WITH_DELINEATION.LITERAL, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DELINEATION", keyPath: \eTEXT_LITERAL_WITH_DELINEATION.DELINEATION, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "PLACEMENT", keyPath: \eTEXT_LITERAL_WITH_DELINEATION.PLACEMENT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eTEXT_LITERAL_WITH_DELINEATION.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ALIGNMENT", keyPath: \eTEXT_LITERAL_WITH_DELINEATION.ALIGNMENT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", keyPath: \eTEXT_LITERAL_WITH_DELINEATION.DIM, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "FONT", keyPath: \eTEXT_LITERAL_WITH_DELINEATION.FONT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
