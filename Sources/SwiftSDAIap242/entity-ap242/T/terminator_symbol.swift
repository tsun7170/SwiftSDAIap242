/* file: terminator_symbol.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _terminator_symbol : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /// EXPLICIT ATTRIBUTE 
    public internal(set) var _annotated_curve: eANNOTATION_CURVE_OCCURRENCE // PLAIN EXPLICIT ATTRIBUTE
    ...
    public init(ANNOTATED_CURVE: eANNOTATION_CURVE_OCCURRENCE) {
    ...
    public required convenience init?(parameters: [P21Decode.ExchangeStructure.Parameter], exchangeStructure: P21Decode.ExchangeStructure) {
      ...
      guard case .success(let p0) = exchangeStructure.recoverRequiredParameter(as: 
        eANNOTATION_CURVE_OCCURRENCE.self, from: parameters[0])
...
```
*/
  public final class eTERMINATOR_SYMBOL : SDAI.EntityReference, @unchecked Sendable {
