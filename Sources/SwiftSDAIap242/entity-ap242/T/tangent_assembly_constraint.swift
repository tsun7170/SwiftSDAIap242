/* file: tangent_assembly_constraint.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- tangent_assembly_constraint (line:31637 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _tangent_assembly_constraint : SDAI.PartialEntity {
...
```
*/
  public final class eTANGENT_ASSEMBLY_CONSTRAINT : SDAI.EntityReference {
    ...
    /// - origin: SUPER( ``eTANGENT_GEOMETRIC_CONSTRAINT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "TANGENT_ASSEMBLY_CONSTRAINT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "TRANSFORMATION_OPERATOR", keyPath: \eTANGENT_ASSEMBLY_CONSTRAINT.TRANSFORMATION_OPERATOR, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", keyPath: \eTANGENT_ASSEMBLY_CONSTRAINT.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "TANGENT_CONTACT", keyPath: \eTANGENT_ASSEMBLY_CONSTRAINT.TANGENT_CONTACT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", keyPath: \eTANGENT_ASSEMBLY_CONSTRAINT.REFERENCE_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_1", keyPath: \eTANGENT_ASSEMBLY_CONSTRAINT.REP_1, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_2", keyPath: \eTANGENT_ASSEMBLY_CONSTRAINT.REP_2, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NEAR_POINTS", keyPath: \eTANGENT_ASSEMBLY_CONSTRAINT.NEAR_POINTS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DIM", keyPath: \eTANGENT_ASSEMBLY_CONSTRAINT.DIM, 
