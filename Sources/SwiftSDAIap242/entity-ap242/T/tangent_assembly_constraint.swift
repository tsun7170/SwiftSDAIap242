/* file: tangent_assembly_constraint.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eTANGENT_ASSEMBLY_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var TANGENT_CONTACT: nTANGENT_CONTACT_TYPE {
      get {
        return SDAI.UNWRAP( super_eTANGENT_GEOMETRIC_CONSTRAINT.partialEntity._tangent_contact )
      }
      set(newValue) {
    ...
    public var NEAR_POINTS: SDAI.SET<eNEAR_POINT_RELATIONSHIP.PRef>/*[0:nil]*/  {
      get {
        return SDAI.UNWRAP( super_eTANGENT_GEOMETRIC_CONSTRAINT.partialEntity._near_points )
      }
      set(newValue) {
        let partial = super_eTANGENT_GEOMETRIC_CONSTRAINT.partialEntity
