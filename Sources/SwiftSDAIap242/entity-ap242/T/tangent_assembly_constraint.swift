/* file: tangent_assembly_constraint.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- tangent_assembly_constraint (line:31849 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(11)	tangent_geometric_constraint
  ...
  ENTITY(SELF)	tangent_assembly_constraint
    (no local attributes)
...
- SUPERTYPES:
	...
	11.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTANGENT_GEOMETRIC_CONSTRAINT``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTANGENT_ASSEMBLY_CONSTRAINT/PartialEntity``
*/
  public final class eTANGENT_ASSEMBLY_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eTANGENT_ASSEMBLY_CONSTRAINT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eTANGENT_ASSEMBLY_CONSTRAINT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eTANGENT_ASSEMBLY_CONSTRAINT.PartialEntity
    ...
    public let super_eTANGENT_GEOMETRIC_CONSTRAINT: eTANGENT_GEOMETRIC_CONSTRAINT 	// [11]
    public var super_eTANGENT_ASSEMBLY_CONSTRAINT: eTANGENT_ASSEMBLY_CONSTRAINT { return self } 	// [12]
    ...
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTANGENT_GEOMETRIC_CONSTRAINT`` )
    ...
    public var TANGENT_CONTACT: nTANGENT_CONTACT_TYPE {
      get {
        let originalValue = super_eTANGENT_GEOMETRIC_CONSTRAINT.partialEntity._tangent_contact
        let value = SDAI.UNWRAP( nTANGENT_CONTACT_TYPE( originalValue ) )
        return value
      }
      set(newValue) {
        let partial = super_eTANGENT_GEOMETRIC_CONSTRAINT.partialEntity
    ...
    public var NEAR_POINTS: SDAI.SET<eNEAR_POINT_RELATIONSHIP.PRef>/*[0:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = super_eTANGENT_GEOMETRIC_CONSTRAINT.partialEntity._near_points
        let value = SDAI.UNWRAP( SDAI.SET<eNEAR_POINT_RELATIONSHIP.PRef>( originalValue ) )
        return value
      }
      set(newValue) {
        let partial = super_eTANGENT_GEOMETRIC_CONSTRAINT.partialEntity
        let SELF = super_eTANGENT_GEOMETRIC_CONSTRAINT; SDAI.TOUCH(let:SELF)
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eTANGENT_ASSEMBLY_CONSTRAINT.PartialEntity.self) else { return nil }
      ...
      guard let super11 = complexEntity?.entityReference(eTANGENT_GEOMETRIC_CONSTRAINT.self) else { return nil }
      self.super_eTANGENT_GEOMETRIC_CONSTRAINT = super11
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eTANGENT_ASSEMBLY_CONSTRAINT.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "TRANSFORMATION_OPERATOR", 
        keyPath: \eTANGENT_ASSEMBLY_CONSTRAINT.TRANSFORMATION_OPERATOR, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", 
        keyPath: \eTANGENT_ASSEMBLY_CONSTRAINT.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "TANGENT_CONTACT", 
        keyPath: \eTANGENT_ASSEMBLY_CONSTRAINT.TANGENT_CONTACT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", 
        keyPath: \eTANGENT_ASSEMBLY_CONSTRAINT.REFERENCE_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_1", 
        keyPath: \eTANGENT_ASSEMBLY_CONSTRAINT.REP_1, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_2", 
        keyPath: \eTANGENT_ASSEMBLY_CONSTRAINT.REP_2, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NEAR_POINTS", 
        keyPath: \eTANGENT_ASSEMBLY_CONSTRAINT.NEAR_POINTS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DIM", 
        keyPath: \eTANGENT_ASSEMBLY_CONSTRAINT.DIM, 
