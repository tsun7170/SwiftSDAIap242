/* file: text_font.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _text_font : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //internal var _glyphs: SDAI.SET<eCHARACTER_GLYPH_FONT_USAGE> 	(SEE CORRESPONDING ENTITY REFERENCE DEFINITION)
...
```
*/
  public final class eTEXT_FONT : SDAI.EntityReference, @unchecked Sendable {
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"GLYPHS") {
        return cached.value as! SDAI.SET<eCHARACTER_GLYPH_FONT_USAGE>/*[1:nil]*/ 
      }
      let swiftValue = SDAI.SET<eCHARACTER_GLYPH_FONT_USAGE>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \eCHARACTER_GLYPH_FONT_USAGE.FONT) )
      let value = SDAI.SET<eCHARACTER_GLYPH_FONT_USAGE>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
