/* file: triangular_matrix.swift 	 generated: Mon Dec 15 17:41:04 2025 */
...
*/
  ...
  public final class _triangular_matrix : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_triangular_matrix``
*/
  public final class eTRIANGULAR_MATRIX : SDAI.EntityReference, SDAIDualModeReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _triangular_matrix.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _triangular_matrix.WHERE_wr2(SELF: instance.pRef)
      return result
    }
