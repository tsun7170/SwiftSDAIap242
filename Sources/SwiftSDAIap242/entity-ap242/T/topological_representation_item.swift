/* file: topological_representation_item.swift 	 generated: Mon Dec 15 17:41:04 2025 */
...
*/
  ...
  public final class _topological_representation_item : SDAI.PartialEntity, InitializableByVoid
    , @unchecked Sendable {
    ...
    /// DERIVE ATTRIBUTE
    @_documentation(visibility:public)
    internal func _permanent_aggregate_id__getter(SELF: eTOPOLOGICAL_REPRESENTATION_ITEM.PRef) -> tIDENTIFIER?  {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_topological_representation_item``
*/
  public final class eTOPOLOGICAL_REPRESENTATION_ITEM : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _topological_representation_item.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _topological_representation_item.WHERE_wr2(SELF: instance.pRef)
      return result
    }
