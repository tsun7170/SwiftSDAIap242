/* file: tee_profile.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _tee_profile : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eTEE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.TYPEOF(SELF.OF_SHAPE.DEFINITION, IS: eFEATURE_COMPONENT_DEFINITION.self)
      return _TEMP1
    }
    public static func WHERE_wr2(SELF: eTEE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eTEE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP2 = _TEMP1.QUERY{ PD in 
          ...
          let _TEMP3 = _TEMP2.QUERY{ IMPL_REP in 
              ...
              let _TEMP4 = _TEMP3 >= SDAI.FORCE_OPTIONAL(SDAI.INTEGER(9))
              let _TEMP5 =  !_TEMP4
    ...
    public static func WHERE_wr4(SELF: eTEE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
          ...
          let _TEMP2 = _TEMP1.QUERY{ PDR in 
              ...
              let _TEMP4 = /*runtime*/SDAI.FORCE_OPTIONAL(_TEMP3)?
                .QUERY{ SRWP_I in 
                  ...
                  let _TEMP15 = /*runtime*/SRWP_I.NAME
                  let _TEMP16 = SDAI.FORCE_OPTIONAL(/*runtime*/_TEMP15) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING(
                    "first offset"))
                  let _TEMP17 = _TEMP14 || _TEMP16
                  let _TEMP18 = /*runtime*/SRWP_I.NAME
                  let _TEMP19 = SDAI.FORCE_OPTIONAL(/*runtime*/_TEMP18) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING(
                    "second offset"))
                  let _TEMP20 = _TEMP17 || _TEMP19
                  let _TEMP21 = /*runtime*/SRWP_I.NAME
                  let _TEMP22 = SDAI.FORCE_OPTIONAL(/*runtime*/_TEMP21) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING(
                    "first angle"))
                  let _TEMP23 = _TEMP20 || _TEMP22
                  let _TEMP24 = /*runtime*/SRWP_I.NAME
                  let _TEMP25 = SDAI.FORCE_OPTIONAL(/*runtime*/_TEMP24) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING(
                    "second angle"))
                  let _TEMP26 = _TEMP23 || _TEMP25
                  let _TEMP27 = /*runtime*/SRWP_I.NAME
                  let _TEMP28 = SDAI.FORCE_OPTIONAL(/*runtime*/_TEMP27) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING(
                    "radius"))
                  let _TEMP29 = _TEMP26 || _TEMP28
                  return _TEMP29 }
    ...
    public static func WHERE_wr5(SELF: eTEE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr6(SELF: eTEE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr7(SELF: eTEE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr8(SELF: eTEE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr9(SELF: eTEE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr10(SELF: eTEE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr11(SELF: eTEE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr12(SELF: eTEE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr13(SELF: eTEE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr14(SELF: eTEE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr15(SELF: eTEE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eTEE_PROFILE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _tee_profile.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _tee_profile.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _tee_profile.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _tee_profile.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _tee_profile.WHERE_wr5(SELF: instance)
      result[prefix2 + " .WHERE_wr6"] = _tee_profile.WHERE_wr6(SELF: instance)
      result[prefix2 + " .WHERE_wr7"] = _tee_profile.WHERE_wr7(SELF: instance)
      result[prefix2 + " .WHERE_wr8"] = _tee_profile.WHERE_wr8(SELF: instance)
      result[prefix2 + " .WHERE_wr9"] = _tee_profile.WHERE_wr9(SELF: instance)
      result[prefix2 + " .WHERE_wr10"] = _tee_profile.WHERE_wr10(SELF: instance)
      result[prefix2 + " .WHERE_wr11"] = _tee_profile.WHERE_wr11(SELF: instance)
      result[prefix2 + " .WHERE_wr12"] = _tee_profile.WHERE_wr12(SELF: instance)
      result[prefix2 + " .WHERE_wr13"] = _tee_profile.WHERE_wr13(SELF: instance)
      result[prefix2 + " .WHERE_wr14"] = _tee_profile.WHERE_wr14(SELF: instance)
      result[prefix2 + " .WHERE_wr15"] = _tee_profile.WHERE_wr15(SELF: instance)
      return result
    }
