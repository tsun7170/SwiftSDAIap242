/* file: thermal_component.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- thermal_component (line:32479 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTHERMAL_COMPONENT/PartialEntity``
*/
  public final class eTHERMAL_COMPONENT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eTHERMAL_COMPONENT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eTHERMAL_COMPONENT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eTHERMAL_COMPONENT.PartialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eTHERMAL_COMPONENT.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "RELATING_PRODUCT_DEFINITION", 
        keyPath: \eTHERMAL_COMPONENT.RELATING_PRODUCT_DEFINITION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "FRAME_OF_REFERENCE", 
        keyPath: \eTHERMAL_COMPONENT.FRAME_OF_REFERENCE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DEFINITION", 
        keyPath: \eTHERMAL_COMPONENT.DEFINITION, 
      ...
      entityDef.addAttribute(name: "RELATED_PRODUCT_DEFINITION", 
        keyPath: \eTHERMAL_COMPONENT.RELATED_PRODUCT_DEFINITION, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "FORMATION", 
        keyPath: \eTHERMAL_COMPONENT.FORMATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTHERMAL_COMPONENT``
*/
