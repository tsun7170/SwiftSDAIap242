/* file: topology_related_to_overlapping_geometry.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- topology_related_to_overlapping_geometry (line:33114 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARTLY_OVERLAPPING_EDGES``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARTLY_OVERLAPPING_FACES``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTOPOLOGY_RELATED_TO_OVERLAPPING_GEOMETRY/PartialEntity``
*/
  public final class eTOPOLOGY_RELATED_TO_OVERLAPPING_GEOMETRY : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eTOPOLOGY_RELATED_TO_OVERLAPPING_GEOMETRY>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eTOPOLOGY_RELATED_TO_OVERLAPPING_GEOMETRY.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eTOPOLOGY_RELATED_TO_OVERLAPPING_GEOMETRY.PartialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eTOPOLOGY_RELATED_TO_OVERLAPPING_GEOMETRY.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "TOPOLOGY_RELATED_TO_OVERLAPPING_GEOMETRY", 
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eTOPOLOGY_RELATED_TO_OVERLAPPING_GEOMETRY.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eTOPOLOGY_RELATED_TO_OVERLAPPING_GEOMETRY.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTOPOLOGY_RELATED_TO_OVERLAPPING_GEOMETRY``
*/
