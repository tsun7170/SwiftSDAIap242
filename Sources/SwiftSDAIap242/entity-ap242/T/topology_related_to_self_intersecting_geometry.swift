/* file: topology_related_to_self_intersecting_geometry.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- topology_related_to_self_intersecting_geometry (line:33119 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	topology_related_to_self_intersecting_geometry
    (no local attributes)

  SUB- ENTITY(8)	self_intersecting_shell
  ...
  SUB- ENTITY(9)	intersecting_connected_face_sets
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion
  ...
  SUB- ENTITY(10)	self_intersecting_loop
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY/PartialEntity``
*/
  public final class eTOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eTOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eTOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eTOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY.PartialEntity
    ...
    public var super_eTOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY: eTOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY { return self } 	// [7]

    //MARK: SUBTYPES
    public var sub_eSELF_INTERSECTING_SHELL: eSELF_INTERSECTING_SHELL? {	// [8]
      return self.complexEntity.entityReference(eSELF_INTERSECTING_SHELL.self)
    }

    public var sub_eINTERSECTING_CONNECTED_FACE_SETS: eINTERSECTING_CONNECTED_FACE_SETS? {	// [9]
      return self.complexEntity.entityReference(eINTERSECTING_CONNECTED_FACE_SETS.self)
    }

    public var sub_eSELF_INTERSECTING_LOOP: eSELF_INTERSECTING_LOOP? {	// [10]
      return self.complexEntity.entityReference(eSELF_INTERSECTING_LOOP.self)
    }


    //MARK: ATTRIBUTES
    // INTERFERENCE_TOLERANCE: (3 AMBIGUOUS REFs)
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eTOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "TOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY", 
      ...
      entityDef.addAttribute(name: "ARC_LENGTH_DISTANCE_FACTOR", 
        keyPath: \eTOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY.ARC_LENGTH_DISTANCE_FACTOR, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eTOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "GEODESIC_SEPARATION_FACTOR", 
        keyPath: \eTOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY.GEODESIC_SEPARATION_FACTOR, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eTOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eTOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY.self
      }
