/* file: topology_related_to_self_intersecting_geometry.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- topology_related_to_self_intersecting_geometry (line:32821 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eTOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "TOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ARC_LENGTH_DISTANCE_FACTOR", keyPath: \eTOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY.ARC_LENGTH_DISTANCE_FACTOR, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eTOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "GEODESIC_SEPARATION_FACTOR", keyPath: \eTOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY.GEODESIC_SEPARATION_FACTOR, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eTOPOLOGY_RELATED_TO_SELF_INTERSECTING_GEOMETRY.NAME, 
