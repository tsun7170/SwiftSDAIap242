/* file: taper.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _taper : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eTAPER?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.TYPEOF(SELF.OF_SHAPE.DEFINITION, IS: eFEATURE_COMPONENT_DEFINITION.self)
      return _TEMP1
    }
    public static func WHERE_wr2(SELF: eTAPER?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.DESCRIPTION
      let _TEMP2 = ([SDAI.AIE(SDAI.STRING("angle taper")), 
    ...
    public static func WHERE_wr3(SELF: eTAPER?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eTAPER?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr5(SELF: eTAPER?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.DESCRIPTION
      let _TEMP2 = _TEMP1 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("angle taper"))
      let _TEMP3 =  !_TEMP2
    ...
    public static func WHERE_wr6(SELF: eTAPER?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.DESCRIPTION
      let _TEMP2 = _TEMP1 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("diameter taper"))
      let _TEMP3 =  !_TEMP2
      let _TEMP4 = SDAI.USEDIN(T: SELF, ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
        .ePROPERTY_DEFINITION.DEFINITION)
      let _TEMP5 = _TEMP4.QUERY{ PD in 
    ...
    public static func WHERE_wr7(SELF: eTAPER?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.DESCRIPTION
      let _TEMP2 = _TEMP1 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("directed taper"))
      let _TEMP3 =  !_TEMP2
      let _TEMP4 = SDAI.USEDIN(T: SELF, ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
        .ePROPERTY_DEFINITION.DEFINITION)
      let _TEMP5 = _TEMP4.QUERY{ PD in 
    ...
    public static func WHERE_wr8(SELF: eTAPER?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eTAPER : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _taper.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _taper.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _taper.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _taper.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _taper.WHERE_wr5(SELF: instance)
      result[prefix2 + " .WHERE_wr6"] = _taper.WHERE_wr6(SELF: instance)
      result[prefix2 + " .WHERE_wr7"] = _taper.WHERE_wr7(SELF: instance)
      result[prefix2 + " .WHERE_wr8"] = _taper.WHERE_wr8(SELF: instance)
      return result
    }
