/* file: taper.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY taper
    ...
    WHERE
      ...
      wr8: ( ( NOT ( SELF.description = 'directed taper' ) ) OR ( SIZEOF( QUERY ( pd <* USEDIN( SELF, 
               ...
               = 0 ) );
  END_ENTITY; -- taper (line:31644 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _taper : SDAI.PartialEntity {
...
```
*/
  public final class eTAPER : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "TAPER", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "PRODUCT_DEFINITIONAL", keyPath: \eTAPER.PRODUCT_DEFINITIONAL, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eTAPER.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OF_SHAPE", keyPath: \eTAPER.OF_SHAPE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eTAPER.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eTAPER.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
