/* file: text_string_representation.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _text_string_representation : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
      ...
      let _TEMP3 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:nil] ? */ = _TEMP2?
        .QUERY{ ITEM in 
          ...
          let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ =  ([ 
              ...
              SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ANNOTATION_TEXT_CHARACTER")), 
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_text_string_representation``
*/
  public final class eTEXT_STRING_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _text_string_representation.self
    }
    /// partial entity reference
    public let partialEntity: _text_string_representation
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_text_string_representation.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _text_string_representation.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _text_string_representation.WHERE_wr2(SELF: instance.pRef)
      return result
    }
