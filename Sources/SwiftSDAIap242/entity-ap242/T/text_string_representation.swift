/* file: text_string_representation.swift 	 generated: Sun Oct 31 15:32:10 2021 */
  ...
  ENTITY text_string_representation
    ...
    WHERE
      ...
      wr2: ( SIZEOF( QUERY ( a2p <* QUERY ( item <* SELF\representation.items | ( 
               ...
               a2p ) ) ) >= 1 ) ) ) ) ) = 0 );
  END_ENTITY; -- text_string_representation (line:32180 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _text_string_representation : SDAI.PartialEntity {
...
```
*/
  public final class eTEXT_STRING_REPRESENTATION : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eTEXT_STRING_REPRESENTATION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "TEXT_STRING_REPRESENTATION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eTEXT_STRING_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eTEXT_STRING_REPRESENTATION.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eTEXT_STRING_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eTEXT_STRING_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eTEXT_STRING_REPRESENTATION.NAME, 
