/* file: text_string_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _text_string_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eTEXT_STRING_REPRESENTATION?) -> SDAI.LOGICAL {
      ...
      let _TEMP3 = _TEMP2?.QUERY{ ITEM in 
          ...
          let _TEMP1 = ([SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TEXT_LITERAL")), 
    ...
    public static func WHERE_wr2(SELF: eTEXT_STRING_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2?.QUERY{ ITEM in 
          ...
          let _TEMP1 = SDAI.TYPEOF(ITEM, IS: sAXIS2_PLACEMENT.self)
          return _TEMP1 }
      let _TEMP4 = _TEMP3?.QUERY{ A2P in 

          let _TEMP1 = SELF.GROUP_REF(eREPRESENTATION.self)
          let _TEMP2 = _TEMP1?.ITEMS
          let _TEMP3 = _TEMP2?.QUERY{ ITEM in 

              let _TEMP1 = SDAI.TYPEOF(ITEM, IS: eANNOTATION_TEXT.self)
              return _TEMP1 }
          let _TEMP4 = _TEMP3?.QUERY{ AT in 

              let _TEMP1 = AT.GROUP_REF(eMAPPED_ITEM.self)
              let _TEMP2 = _TEMP1?.MAPPING_TARGET
              let _TEMP3 = _TEMP2 .===. SDAI.FORCE_OPTIONAL(A2P)
              return _TEMP3 }
          ...
          let _TEMP9 = _TEMP8?.QUERY{ ITEM in 

              let _TEMP1 = SDAI.TYPEOF(ITEM, IS: eANNOTATION_TEXT_CHARACTER.self)
              return _TEMP1 }
          let _TEMP10 = _TEMP9?.QUERY{ ATC in 

              let _TEMP1 = ATC.GROUP_REF(eMAPPED_ITEM.self)
              let _TEMP2 = _TEMP1?.MAPPING_TARGET
              let _TEMP3 = _TEMP2 .===. SDAI.FORCE_OPTIONAL(A2P)
              return _TEMP3 }
...
```
*/
  public final class eTEXT_STRING_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _text_string_representation.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _text_string_representation.WHERE_wr2(SELF: instance)
      return result
    }
