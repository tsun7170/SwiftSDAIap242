/* file: text_string_representation.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eTEXT_STRING_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var ITEMS: SDAI.SET<sTEXT_STRING_REPRESENTATION_ITEM>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<sTEXT_STRING_REPRESENTATION_ITEM>( super_eREPRESENTATION.partialEntity
          ._items ) )
      }
      set(newValue) {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eTEXT_STRING_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eTEXT_STRING_REPRESENTATION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _items: SDAI.SET<sTEXT_STRING_REPRESENTATION_ITEM>[1:nil] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
      ...
      public static func WHERE_wr2(SELF: eTEXT_STRING_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP4 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:nil] ? */ = _TEMP3?
          .QUERY{ A2P in 
            ...
            let _TEMP8 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:nil] ? */ = _TEMP7?.ITEMS
            let _TEMP9 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:nil] ? */ = _TEMP8?
              .QUERY{ ITEM in 
                // QUERY BODY
            ...
            let _TEMP10 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:nil] ? */ = _TEMP9?
              .QUERY{ ATC in 
                // QUERY BODY
