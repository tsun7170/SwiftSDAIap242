/* file: thermodynamic_temperature_unit.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _thermodynamic_temperature_unit : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eTHERMODYNAMIC_TEMPERATURE_UNIT?) -> SDAI.LOGICAL {
      ...
      let _TEMP23 = _TEMP22 .==. SDAI.FORCE_OPTIONAL(SDAI.REAL(1.0000000000e+00))
...
```
*/
  public final class eTHERMODYNAMIC_TEMPERATURE_UNIT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _thermodynamic_temperature_unit.WHERE_wr1(SELF: instance)
      return result
    }
