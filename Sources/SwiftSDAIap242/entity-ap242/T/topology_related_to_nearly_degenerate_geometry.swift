/* file: topology_related_to_nearly_degenerate_geometry.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- topology_related_to_nearly_degenerate_geometry (line:33109 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	topology_related_to_nearly_degenerate_geometry
    (no local attributes)

  SUB- ENTITY(8)	short_length_edge
  ...
  SUB- ENTITY(9)	small_area_face
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(10)	entirely_narrow_face
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHORT_LENGTH_EDGE``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSMALL_AREA_FACE``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eENTIRELY_NARROW_FACE``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTOPOLOGY_RELATED_TO_NEARLY_DEGENERATE_GEOMETRY/PartialEntity``
*/
  public final class eTOPOLOGY_RELATED_TO_NEARLY_DEGENERATE_GEOMETRY : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eTOPOLOGY_RELATED_TO_NEARLY_DEGENERATE_GEOMETRY>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eTOPOLOGY_RELATED_TO_NEARLY_DEGENERATE_GEOMETRY.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eTOPOLOGY_RELATED_TO_NEARLY_DEGENERATE_GEOMETRY.PartialEntity
    ...
    public var super_eTOPOLOGY_RELATED_TO_NEARLY_DEGENERATE_GEOMETRY: eTOPOLOGY_RELATED_TO_NEARLY_DEGENERATE_GEOMETRY { return self } 	// [7]

    //MARK: SUBTYPES
    public var sub_eSHORT_LENGTH_EDGE: eSHORT_LENGTH_EDGE? {	// [8]
      return self.complexEntity.entityReference(eSHORT_LENGTH_EDGE.self)
    }

    public var sub_eSMALL_AREA_FACE: eSMALL_AREA_FACE? {	// [9]
      return self.complexEntity.entityReference(eSMALL_AREA_FACE.self)
    }

    public var sub_eENTIRELY_NARROW_FACE: eENTIRELY_NARROW_FACE? {	// [10]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eTOPOLOGY_RELATED_TO_NEARLY_DEGENERATE_GEOMETRY.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "TOPOLOGY_RELATED_TO_NEARLY_DEGENERATE_GEOMETRY", 
      ...
      entityDef.addAttribute(name: "WIDTH_TOLERANCE", 
        keyPath: \eTOPOLOGY_RELATED_TO_NEARLY_DEGENERATE_GEOMETRY.WIDTH_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eTOPOLOGY_RELATED_TO_NEARLY_DEGENERATE_GEOMETRY.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eTOPOLOGY_RELATED_TO_NEARLY_DEGENERATE_GEOMETRY.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTOPOLOGY_RELATED_TO_NEARLY_DEGENERATE_GEOMETRY``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eTOPOLOGY_RELATED_TO_NEARLY_DEGENERATE_GEOMETRY.self
      }
