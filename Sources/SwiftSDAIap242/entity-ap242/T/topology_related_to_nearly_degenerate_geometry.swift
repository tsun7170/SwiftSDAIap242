/* file: topology_related_to_nearly_degenerate_geometry.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- topology_related_to_nearly_degenerate_geometry (line:32811 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eTOPOLOGY_RELATED_TO_NEARLY_DEGENERATE_GEOMETRY : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "TOPOLOGY_RELATED_TO_NEARLY_DEGENERATE_GEOMETRY", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "WIDTH_TOLERANCE", keyPath: \eTOPOLOGY_RELATED_TO_NEARLY_DEGENERATE_GEOMETRY.WIDTH_TOLERANCE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eTOPOLOGY_RELATED_TO_NEARLY_DEGENERATE_GEOMETRY.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eTOPOLOGY_RELATED_TO_NEARLY_DEGENERATE_GEOMETRY.NAME, 
