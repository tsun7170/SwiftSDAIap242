/* file: thread_runout.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY thread_runout
    ...
    WHERE
      ...
      wr7: ( SIZEOF( QUERY ( pd <* USEDIN( SELF, 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               ...
               = 1 ) ) ) ) = 0 ) ) ) ) = 0 );
  END_ENTITY; -- thread_runout (line:32605 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _thread_runout : SDAI.PartialEntity {
...
```
*/
  public final class eTHREAD_RUNOUT : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "THREAD_RUNOUT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "PRODUCT_DEFINITIONAL", keyPath: \eTHREAD_RUNOUT.PRODUCT_DEFINITIONAL, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eTHREAD_RUNOUT.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OF_SHAPE", keyPath: \eTHREAD_RUNOUT.OF_SHAPE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eTHREAD_RUNOUT.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eTHREAD_RUNOUT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
