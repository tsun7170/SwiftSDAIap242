/* file: thread_runout.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _thread_runout : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eTHREAD_RUNOUT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.TYPEOF(SELF.OF_SHAPE, IS: ePRODUCT_DEFINITION_SHAPE.self)
      return _TEMP1
    }
    public static func WHERE_wr2(SELF: eTHREAD_RUNOUT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eTHREAD_RUNOUT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eTHREAD_RUNOUT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
          ...
          let _TEMP2 = _TEMP1.QUERY{ PDR in 
              ...
              let _TEMP4 = /*runtime*/SDAI.FORCE_OPTIONAL(_TEMP3)?
                .QUERY{ SRWP_I in 
                  ...
                  let _TEMP2 = ([SDAI.AIE(SDAI.STRING("length of runout")), 
                    SDAI.AIE(SDAI.STRING("pitch or dimension")), 
                    SDAI.AIE(SDAI.STRING("included or extra"))] as [SDAI.AggregationInitializerElement<SDAI.STRING>])
    ...
    public static func WHERE_wr5(SELF: eTHREAD_RUNOUT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr6(SELF: eTHREAD_RUNOUT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
          ...
          let _TEMP3 = _TEMP2.QUERY{ IMPL_REP in 
              ...
              let _TEMP4 = /*runtime*/_TEMP3?
                .QUERY{ IT in 
                  ...
                  let _TEMP6 = ([SDAI.AIE(SDAI.STRING("pitch")), 
                    SDAI.AIE(SDAI.STRING("pitch or dimension"))] as [SDAI.AggregationInitializerElement<SDAI.STRING>])
    ...
    public static func WHERE_wr7(SELF: eTHREAD_RUNOUT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
          ...
          let _TEMP3 = _TEMP2.QUERY{ IMPL_REP in 
              ...
              let _TEMP4 = /*runtime*/_TEMP3?
                .QUERY{ IT in 
                  ...
                  let _TEMP4 = _TEMP1 && _TEMP3
                  let _TEMP5 = /*runtime*/IT.DESCRIPTION
                  let _TEMP6 = ([SDAI.AIE(SDAI.STRING("included")), 
...
```
*/
  public final class eTHREAD_RUNOUT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _thread_runout.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _thread_runout.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _thread_runout.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _thread_runout.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _thread_runout.WHERE_wr5(SELF: instance)
      result[prefix2 + " .WHERE_wr6"] = _thread_runout.WHERE_wr6(SELF: instance)
      result[prefix2 + " .WHERE_wr7"] = _thread_runout.WHERE_wr7(SELF: instance)
      return result
    }
