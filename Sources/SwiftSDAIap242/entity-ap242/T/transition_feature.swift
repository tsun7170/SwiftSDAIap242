/* file: transition_feature.swift 	 generated: Mon Dec 15 17:41:04 2025 */
...
*/
  ...
  public final class _transition_feature : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_transition_feature``
*/
  public final class eTRANSITION_FEATURE : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _transition_feature.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _transition_feature.WHERE_wr2(SELF: instance.pRef)
      return result
    }
