/* file: tan_function.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _tan_function : SDAI.PartialEntity, SDAI.InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_tan_function``
*/
  public final class eTAN_FUNCTION : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public let partialEntity: _tan_function
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_tan_function.self) else { return nil }
