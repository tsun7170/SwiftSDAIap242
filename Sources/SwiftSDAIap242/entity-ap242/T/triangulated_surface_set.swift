/* file: triangulated_surface_set.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _triangulated_surface_set : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eTRIANGULATED_SURFACE_SET?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eTRIANGULATED_SURFACE_SET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eTRIANGULATED_SURFACE_SET : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _triangulated_surface_set.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _triangulated_surface_set.WHERE_wr2(SELF: instance)
      return result
    }
