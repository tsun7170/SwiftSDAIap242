/* file: tessellated_item.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _tessellated_item : SDAI.PartialEntity, SDAI.InitializableByVoid, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eTESSELLATED_ITEM.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP2 /* SDAI.SET<eREPRESENTATION.PRef>? */ = _TEMP1?
        .QUERY{ USING_REP in 
          ...
          let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( USING_REP, IS: eTESSELLATED_SHAPE_REPRESENTATION.self )
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_tessellated_item``
*/
  public final class eTESSELLATED_ITEM : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _tessellated_item.WHERE_wr1(SELF: instance.pRef)
      return result
    }
