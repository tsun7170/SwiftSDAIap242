/* file: tessellated_item.swift 	 generated: Tue Oct 14 17:54:07 2025 */
  ...
  ENTITY tessellated_item
    ...
    WHERE
      wr1: ( SIZEOF( QUERY ( using_rep <* using_representations( SELF ) | ( NOT ( 
               ...
               TYPEOF( using_rep ) ) ) ) ) = 0 );
  END_ENTITY; -- tessellated_item (line:32046 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  ...
  public final class _tessellated_item : SDAI.PartialEntity, @unchecked Sendable {
