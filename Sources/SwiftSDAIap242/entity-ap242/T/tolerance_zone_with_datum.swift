/* file: tolerance_zone_with_datum.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _tolerance_zone_with_datum : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /// EXPLICIT ATTRIBUTE 
    public internal(set) var _datum_reference: eDATUM_SYSTEM // PLAIN EXPLICIT ATTRIBUTE
    ...
    public init(DATUM_REFERENCE: eDATUM_SYSTEM) {
    ...
    public required convenience init?(parameters: [P21Decode.ExchangeStructure.Parameter], exchangeStructure: P21Decode.ExchangeStructure) {
      ...
      guard case .success(let p0) = exchangeStructure.recoverRequiredParameter(as: eDATUM_SYSTEM.self, from: parameters[0])
...
```
*/
  public final class eTOLERANCE_ZONE_WITH_DATUM : SDAI.EntityReference, @unchecked Sendable {
