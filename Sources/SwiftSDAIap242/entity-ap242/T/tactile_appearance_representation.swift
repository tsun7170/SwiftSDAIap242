/* file: tactile_appearance_representation.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eTACTILE_APPEARANCE_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eTACTILE_APPEARANCE_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eTACTILE_APPEARANCE_REPRESENTATION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eTACTILE_APPEARANCE_REPRESENTATION.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      return result
    }
