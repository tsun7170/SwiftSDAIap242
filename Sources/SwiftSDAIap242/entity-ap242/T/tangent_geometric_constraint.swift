/* file: tangent_geometric_constraint.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _tangent_geometric_constraint : SDAI.PartialEntity, @unchecked Sendable {
    ...
    /// EXPLICIT ATTRIBUTE 
    public internal(set) var _near_points: SDAI.SET<eNEAR_POINT_RELATIONSHIP>/*[0:nil]*/  // PLAIN EXPLICIT ATTRIBUTE
    ...
    public static func WHERE_wr1(SELF: eTANGENT_GEOMETRIC_CONSTRAINT?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eTANGENT_GEOMETRIC_CONSTRAINT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP4 = SDAI.FORCE_OPTIONAL(SELF.TANGENT_CONTACT) .==. SDAI.FORCE_OPTIONAL(SURFACE_CONTACT)
      let _TEMP5 = _TEMP3 && _TEMP4
      let _TEMP6 =  !_TEMP5
      return _TEMP6
    }
    public static func WHERE_wr3(SELF: eTANGENT_GEOMETRIC_CONSTRAINT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public init(NEAR_POINTS: SDAI.SET<eNEAR_POINT_RELATIONSHIP>/*[0:nil]*/ , 
...
```
*/
  public final class eTANGENT_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, @unchecked Sendable {
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTANGENT_GEOMETRIC_CONSTRAINT`` )
    public var NEAR_POINTS: SDAI.SET<eNEAR_POINT_RELATIONSHIP>/*[0:nil]*/  {
      get {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _tangent_geometric_constraint.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _tangent_geometric_constraint.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _tangent_geometric_constraint.WHERE_wr3(SELF: instance)
      return result
    }
