/* file: tangent_geometric_constraint.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eTANGENT_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var TANGENT_CONTACT: nTANGENT_CONTACT_TYPE {
      get {
        return SDAI.UNWRAP( self.partialEntity._tangent_contact )
      }
      set(newValue) {
    ...
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTANGENT_GEOMETRIC_CONSTRAINT`` )
    public var REFERENCE_ELEMENTS: SDAI.SET<sCURVE_OR_SURFACE_CONSTRAINT_ELEMENT>/*[0:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<sCURVE_OR_SURFACE_CONSTRAINT_ELEMENT>( super_eEXPLICIT_CONSTRAINT
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTANGENT_GEOMETRIC_CONSTRAINT`` )
    public var NEAR_POINTS: SDAI.SET<eNEAR_POINT_RELATIONSHIP.PRef>/*[0:nil]*/  {
      get {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eTANGENT_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eTANGENT_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eTANGENT_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      /* override var _reference_elements: SDAI.SET<sCURVE_OR_SURFACE_CONSTRAINT_ELEMENT>[0:nil] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */

      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _near_points: SDAI.SET<eNEAR_POINT_RELATIONSHIP.PRef>/*[0:nil]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public static func WHERE_wr3(SELF: eTANGENT_GEOMETRIC_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP1 /* SDAI.SET<eNEAR_POINT_RELATIONSHIP.PRef>[0:nil] ? */ = SELF.NEAR_POINTS?
          .QUERY{ Q in 
            // QUERY BODY
      ...
      public init(
        NEAR_POINTS: SDAI.SET<eNEAR_POINT_RELATIONSHIP.PRef>/*[0:nil]*/ , 
