/* file: revolute_pair.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _revolute_pair : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _t_x__getter(SELF: eREVOLUTE_PAIR) -> SDAI.BOOLEAN {
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eLOW_ORDER_KINEMATIC_PAIR)
    /// - gut of derived attribute logic
    internal func _t_y__getter(SELF: eREVOLUTE_PAIR) -> SDAI.BOOLEAN {
      let value = SDAI.BOOLEAN(SDAI.FALSE)
      return SDAI.UNWRAP( value )
    }
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eLOW_ORDER_KINEMATIC_PAIR)
    /// - gut of derived attribute logic
    internal func _t_z__getter(SELF: eREVOLUTE_PAIR) -> SDAI.BOOLEAN {
      let value = SDAI.BOOLEAN(SDAI.FALSE)
      return SDAI.UNWRAP( value )
    }
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eLOW_ORDER_KINEMATIC_PAIR)
    /// - gut of derived attribute logic
    internal func _r_x__getter(SELF: eREVOLUTE_PAIR) -> SDAI.BOOLEAN {
      let value = SDAI.BOOLEAN(SDAI.FALSE)
      return SDAI.UNWRAP( value )
    }
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eLOW_ORDER_KINEMATIC_PAIR)
    /// - gut of derived attribute logic
    internal func _r_y__getter(SELF: eREVOLUTE_PAIR) -> SDAI.BOOLEAN {
      let value = SDAI.BOOLEAN(SDAI.FALSE)
      return SDAI.UNWRAP( value )
    }
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eLOW_ORDER_KINEMATIC_PAIR)
    /// - gut of derived attribute logic
    internal func _r_z__getter(SELF: eREVOLUTE_PAIR) -> SDAI.BOOLEAN {
...
```
*/
  public final class eREVOLUTE_PAIR : SDAI.EntityReference, @unchecked Sendable {
