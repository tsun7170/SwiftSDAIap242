/* file: revolute_pair.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- revolute_pair (line:27859 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUB- ENTITY(7)	revolute_pair_with_range
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREVOLUTE_PAIR_WITH_RANGE``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREVOLUTE_PAIR/PartialEntity``
*/
  public final class eREVOLUTE_PAIR : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eREVOLUTE_PAIR>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eREVOLUTE_PAIR.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eREVOLUTE_PAIR.PartialEntity
    ...
    public var super_eREVOLUTE_PAIR: eREVOLUTE_PAIR { return self } 	// [6]

    //MARK: SUBTYPES
    public var sub_eREVOLUTE_PAIR_WITH_RANGE: eREVOLUTE_PAIR_WITH_RANGE? {	// [7]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREVOLUTE_PAIR`` )
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREVOLUTE_PAIR_WITH_RANGE`` )
    public var LOWER_LIMIT_ACTUAL_ROTATION: tPLANE_ANGLE_MEASURE?  {
      get {
        let originalValue = sub_eREVOLUTE_PAIR_WITH_RANGE?.partialEntity._lower_limit_actual_rotation
        let value = tPLANE_ANGLE_MEASURE( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eREVOLUTE_PAIR_WITH_RANGE?.partialEntity
          else { return }
    ...
    public var UPPER_LIMIT_ACTUAL_ROTATION: tPLANE_ANGLE_MEASURE?  {
      get {
        let originalValue = sub_eREVOLUTE_PAIR_WITH_RANGE?.partialEntity._upper_limit_actual_rotation
        let value = tPLANE_ANGLE_MEASURE( originalValue )
        return value
      }
      set(newValue) {
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eREVOLUTE_PAIR.PartialEntity.self) else { return nil }
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREVOLUTE_PAIR``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      internal func _t_x__getter(complex: SDAI.ComplexEntity) -> SDAI.BOOLEAN {
        let SELF = complex.entityReference( eREVOLUTE_PAIR.self )!
        return SDAI.UNWRAP( SDAI.BOOLEAN(SELF.T_X) )
      }
      /// DERIVE ATTRIBUTE REDEFINITION(origin: eLOW_ORDER_KINEMATIC_PAIR)
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _t_x__getter(SELF: eREVOLUTE_PAIR.PRef) -> SDAI.BOOLEAN {
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _t_y__getter(SELF: eREVOLUTE_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.FALSE)
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _t_z__getter(SELF: eREVOLUTE_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.FALSE)
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _r_x__getter(SELF: eREVOLUTE_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.FALSE)
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _r_y__getter(SELF: eREVOLUTE_PAIR.PRef) -> SDAI.BOOLEAN {
        let value = SDAI.BOOLEAN(SDAI.FALSE)
        return SDAI.UNWRAP( value )
      }
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _r_z__getter(SELF: eREVOLUTE_PAIR.PRef) -> SDAI.BOOLEAN {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eREVOLUTE_PAIR.PartialEntity :
