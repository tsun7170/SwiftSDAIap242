/* file: right_circular_cone.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  ENTITY right_circular_cone
    ...
    WHERE
      wr1: ( radius >= 0 );
  END_ENTITY; -- right_circular_cone (line:27986 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _right_circular_cone : SDAI.PartialEntity {
...
```
*/
  public final class eRIGHT_CIRCULAR_CONE : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eRIGHT_CIRCULAR_CONE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "RIGHT_CIRCULAR_CONE", type: self, explicitAttributeCount: 4)
      ...
      entityDef.addAttribute(name: "RADIUS", keyPath: \eRIGHT_CIRCULAR_CONE.RADIUS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "POSITION", keyPath: \eRIGHT_CIRCULAR_CONE.POSITION, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "SEMI_ANGLE", keyPath: \eRIGHT_CIRCULAR_CONE.SEMI_ANGLE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "HEIGHT", keyPath: \eRIGHT_CIRCULAR_CONE.HEIGHT, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eRIGHT_CIRCULAR_CONE.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", keyPath: \eRIGHT_CIRCULAR_CONE.DIM, 
