/* file: real_interval_to_max.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- real_interval_to_max (line:26907 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _real_interval_to_max : SDAI.PartialEntity {
...
```
*/
  public final class eREAL_INTERVAL_TO_MAX : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eREAL_INTERVAL_TO_MAX`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "REAL_INTERVAL_TO_MAX", type: self, explicitAttributeCount: 2)
      ...
      entityDef.addAttribute(name: "MAX", keyPath: \eREAL_INTERVAL_TO_MAX.MAX, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MAX_CLOSURE", keyPath: \eREAL_INTERVAL_TO_MAX.MAX_CLOSURE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
