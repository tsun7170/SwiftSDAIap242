/* file: real_interval_to_max.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _real_interval_to_max : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public init(MAX: SDAI.REAL, MAX_CLOSURE: nOPEN_CLOSED) {
      self._max = MAX
...
```
*/
  public final class eREAL_INTERVAL_TO_MAX : SDAI.EntityReference, @unchecked Sendable {
