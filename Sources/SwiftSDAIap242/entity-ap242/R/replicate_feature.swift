/* file: replicate_feature.swift 	 generated: Thu Dec 25 18:13:23 2025 */
...
*/
  ...
  public final class _replicate_feature : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_replicate_feature``
*/
  public final class eREPLICATE_FEATURE : SDAI.EntityReference, SDAIDualModeReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _replicate_feature.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _replicate_feature.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _replicate_feature.WHERE_wr3(SELF: instance.pRef)
      return result
    }
