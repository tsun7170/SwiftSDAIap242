/* file: representation.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public final class eREPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, SDAI.SimpleEntityType, 
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"CM_LINK") {
        return cached.value as! eVARIATIONAL_CURRENT_REPRESENTATION_RELATIONSHIP.PRef? 
      }
      let value = self.referencingEntity(for: \eVARIATIONAL_CURRENT_REPRESENTATION_RELATIONSHIP.REP_1)
      updateCache(derivedAttributeName:"CM_LINK", value:value)
      return value
    }
    }
    ...
    public var ASSOCIATED_SHAPE_REPRESENTATION: (SDAI.SET<eKINEMATIC_LINK_REPRESENTATION_ASSOCIATION.PRef>/*[
      0:1]*/ )?  {
    get {
      if let cached = cachedValue(derivedAttributeName:"ASSOCIATED_SHAPE_REPRESENTATION") {
        return cached.value as! (SDAI.SET<eKINEMATIC_LINK_REPRESENTATION_ASSOCIATION.PRef>/*[0:1]*/ )? 
      }
      let keypath = \eKINEMATIC_LINK_REPRESENTATION_ASSOCIATION.REP_1
      let entities = self.referencingEntities(for: keypath)
      let swiftValue = SDAI.SET<eKINEMATIC_LINK_REPRESENTATION_ASSOCIATION.PRef>/*[0:1]*/ .SwiftType( entities )
      let value = SDAI.SET<eKINEMATIC_LINK_REPRESENTATION_ASSOCIATION.PRef>/*[0:1]*/ (
        from: swiftValue, bound1: SDAI.UNWRAP(SDAI.INTEGER(0)), bound2: SDAI.INTEGER(1))
      updateCache(derivedAttributeName:"ASSOCIATED_SHAPE_REPRESENTATION", value:value)
      return value
    }
    }
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"SIZE") {
        return cached.value as! ePRESENTATION_SIZE.PRef? 
      }
      let value = self.referencingEntity(for: \ePRESENTATION_SIZE.UNIT)
    ...
    public var REPRESENTED_JOINTS: (SDAI.SET<eKINEMATIC_JOINT.PRef>/*[1:nil]*/ )?  {
      get {
        if let cached = cachedValue(derivedAttributeName:"REPRESENTED_JOINTS") {
          return cached.value as! (SDAI.SET<eKINEMATIC_JOINT.PRef>/*[1:nil]*/ )? 
        }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eREPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eREPRESENTATION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      @_documentation(visibility:public)
      public internal(set) var _items: SDAI.SET<eREPRESENTATION_ITEM.PRef>/*[1:nil]*/  // OBSERVED EXPLICIT ATTRIBUTE
      ...
      public init(
        NAME: tLABEL, 
        ITEMS: SDAI.SET<eREPRESENTATION_ITEM.PRef>/*[1:nil]*/ , 
