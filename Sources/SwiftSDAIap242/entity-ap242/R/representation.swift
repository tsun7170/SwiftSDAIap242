/* file: representation.swift 	 generated: Tue Oct 14 17:54:07 2025 */
  ...
  ENTITY representation
    ...
    WHERE
      ...
      wr2: ( SIZEOF( USEDIN( SELF, 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.DESCRIPTION_ATTRIBUTE.'
               + 'DESCRIBED_ITEM'  ) ) <= 1 );
  END_ENTITY; -- representation (line:27444 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  public final class eREPRESENTATION : SDAI.EntityReference, SDAIDualModeReference, SDAISimpleEntityType, 
    ...
    get {
      ...
      let swiftValue = SDAI.SET<eKINEMATIC_LINK_REPRESENTATION_ASSOCIATION.PRef>/*[0:1]*/ .SwiftType( self.referencingEntities(for: \eKINEMATIC_LINK_REPRESENTATION_ASSOCIATION.REP_1) )
      let value = SDAI.SET<eKINEMATIC_LINK_REPRESENTATION_ASSOCIATION.PRef>/*[0:1]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
