/* file: restriction_function.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- restriction_function (line:27805 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRESTRICTION_FUNCTION/PartialEntity``
*/
  public final class eRESTRICTION_FUNCTION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eRESTRICTION_FUNCTION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eRESTRICTION_FUNCTION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eRESTRICTION_FUNCTION.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRESTRICTION_FUNCTION`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eRESTRICTION_FUNCTION.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "OPERAND", 
        keyPath: \eRESTRICTION_FUNCTION.OPERAND, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DOMAIN", 
        keyPath: \eRESTRICTION_FUNCTION.DOMAIN, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "RANGE", 
        keyPath: \eRESTRICTION_FUNCTION.RANGE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRESTRICTION_FUNCTION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _operand: eMATHS_SPACE.PRef	//EXPLICIT REDEFINITION(eUNARY_GENERIC_EXPRESSION) */
