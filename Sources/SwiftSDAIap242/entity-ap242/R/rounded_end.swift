/* file: rounded_end.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY rounded_end
    ...
    WHERE
      ...
      wr4: ( SIZEOF( QUERY ( pdr <* get_property_definition_representations( SELF ) | ( ( 
               ...
               >= 0 );
  END_ENTITY; -- rounded_end (line:28169 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _rounded_end : SDAI.PartialEntity {
...
```
*/
  public final class eROUNDED_END : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "ROUNDED_END", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eROUNDED_END.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eROUNDED_END.NAME, 
