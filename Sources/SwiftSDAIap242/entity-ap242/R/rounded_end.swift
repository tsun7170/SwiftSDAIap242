/* file: rounded_end.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _rounded_end : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eROUNDED_END?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eROUNDED_END?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eROUNDED_END?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eROUNDED_END?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = GET_PROPERTY_DEFINITION_REPRESENTATIONS(sCHARACTERIZED_DEFINITION(/*eROUNDED_END*/SELF))
      let _TEMP2 = _TEMP1?.QUERY{ PDR in 
...
```
*/
  public final class eROUNDED_END : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _rounded_end.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _rounded_end.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _rounded_end.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _rounded_end.WHERE_wr4(SELF: instance)
      return result
    }
