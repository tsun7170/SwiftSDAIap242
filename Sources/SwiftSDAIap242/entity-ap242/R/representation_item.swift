/* file: representation_item.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
```
*/
  public final class eREPRESENTATION_ITEM : SDAI.EntityReference, @unchecked Sendable {
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"CONTAINER") {
        return cached.value as! (SDAI.SET<ePRESENTATION_VIEW>/*[1:nil]*/ )? 
      }
      let swiftValue = SDAI.SET<ePRESENTATION_VIEW>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \ePRESENTATION_VIEW.ITEMS) )
      let value = SDAI.SET<ePRESENTATION_VIEW>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as 
        SDAI.INTEGER?))
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"SHAPE_CRITERIA") {
        return cached.value as! (SDAI.SET<eA3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP>/*[1:nil]*/ )? 
      }
      let swiftValue = SDAI.SET<eA3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \eA3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP.RELATING_REPRESENTATION_ITEM) )
      let value = SDAI.SET<eA3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"LINK_REPRESENTATION_ASSOCIATIONS") {
        return cached.value as! (SDAI.SET<ePAIR_REPRESENTATION_RELATIONSHIP>/*[1:nil]*/ )? 
      }
      let swiftValue = SDAI.SET<ePAIR_REPRESENTATION_RELATIONSHIP>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \ePAIR_REPRESENTATION_RELATIONSHIP.TRANSFORMATION_OPERATOR) )
      let value = SDAI.SET<ePAIR_REPRESENTATION_RELATIONSHIP>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
        SDAI.INTEGER(1)), bound2: (nil as SDAI.INTEGER?))
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"CRITERION_REPORT") {
        return cached.value as! eDATA_EQUIVALENCE_INSPECTION_CRITERION_REPORT? 
      }
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"THE_CALLOUT") {
        return cached.value as! eDRAUGHTING_CALLOUT? 
      }
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"ASSESSMENT_THRESHOLD_2") {
        return cached.value as! eA3MA_EQUIVALENCE_CRITERION_ASSESSMENT_THRESHOLD_RELATIONSHIP? 
      }
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"THE_DRAUGHTING_MODEL_ITEM_ASSOCIATION_WITH_PLACEHOLDERS") {
        return cached.value as! (SDAI.SET<eDRAUGHTING_MODEL_ITEM_ASSOCIATION_WITH_PLACEHOLDER>/*[0:1]*/ )? 
      }
      let swiftValue = SDAI.SET<eDRAUGHTING_MODEL_ITEM_ASSOCIATION_WITH_PLACEHOLDER>/*[0:1]*/ .SwiftType( self.referencingEntities(for: \eDRAUGHTING_MODEL_ITEM_ASSOCIATION_WITH_PLACEHOLDER.ANNOTATION_PLACEHOLDER) )
      let value = SDAI.SET<eDRAUGHTING_MODEL_ITEM_ASSOCIATION_WITH_PLACEHOLDER>/*[0:1]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"SOURCE") {
        return cached.value as! eAPPLIED_EXTERNAL_IDENTIFICATION_ASSIGNMENT? 
      }
