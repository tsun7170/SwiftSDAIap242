/* file: repackaging_function.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public final class eREPACKAGING_FUNCTION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eREPACKAGING_FUNCTION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eREPACKAGING_FUNCTION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eREPACKAGING_FUNCTION.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      return result
    }
