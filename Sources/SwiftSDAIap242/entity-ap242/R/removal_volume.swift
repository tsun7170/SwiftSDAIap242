/* file: removal_volume.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _removal_volume : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eREMOVAL_VOLUME?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eREMOVAL_VOLUME?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eREMOVAL_VOLUME : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _removal_volume.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _removal_volume.WHERE_wr2(SELF: instance)
      return result
    }
