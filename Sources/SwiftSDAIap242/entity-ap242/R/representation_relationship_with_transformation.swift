/* file: representation_relationship_with_transformation.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_representation_relationship_with_transformation``
*/
  public final class eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _representation_relationship_with_transformation.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _representation_relationship_with_transformation.WHERE_wr2(SELF: instance.pRef)
      return result
    }
