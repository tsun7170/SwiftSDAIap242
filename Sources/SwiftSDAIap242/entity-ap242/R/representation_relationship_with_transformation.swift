/* file: representation_relationship_with_transformation.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- representation_relationship_with_transformation (line:27731 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	...
	10.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eITEM_LINK_MOTION_RELATIONSHIP``
	11.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLINK_MOTION_RELATIONSHIP``
	12.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePAIR_REPRESENTATION_RELATIONSHIP``
	13.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONSTRAINED_KINEMATIC_MOTION_REPRESENTATION``
	14.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFREE_KINEMATIC_MOTION_REPRESENTATION``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION/PartialEntity``
*/
  public final class eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION.PartialEntity
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION`` )
    public var TRANSFORMATION_OPERATOR: sTRANSFORMATION {
      get {
        let originalValue = self.partialEntity._transformation_operator
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "TRANSFORMATION_OPERATOR", 
        keyPath: \eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION.TRANSFORMATION_OPERATOR, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEM", 
        keyPath: \eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION.ITEM, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_1", 
        keyPath: \eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION.REP_1, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_2", 
        keyPath: \eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION.REP_2, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MOTION", 
        keyPath: \eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION.MOTION, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: eREPRESENTATION_RELATIONSHIP_WITH_TRANSFORMATION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF.TRANSFORMATION_OPERATOR, 
          IS: eITEM_DEFINED_TRANSFORMATION.self )
        let _TEMP2 /* SDAI.LOGICAL */ =  !_TEMP1
        let _TEMP3 /* eITEM_DEFINED_TRANSFORMATION.PRef? */ = SELF.TRANSFORMATION_OPERATOR?.GROUP_REF(
        ...
        let _TEMP6 /* sREPRESENTATION_OR_REPRESENTATION_REFERENCE? */ = _TEMP5?.REP_1
        let _TEMP7 /* runtime? */ = /*runtime*/_TEMP6?.CONTEXT_OF_ITEMS
        let _TEMP8 /* SDAI.BOOLEAN? */ = ITEM_IN_CONTEXT( 
            ITEM: _TEMP4, 
            CNTXT: eREPRESENTATION_CONTEXT.PRef(fromGeneric: /*/*runtime*/SDAI.GENERIC*/_TEMP7) )
        let _TEMP9 /* eITEM_DEFINED_TRANSFORMATION.PRef? */ = SELF.TRANSFORMATION_OPERATOR?.GROUP_REF(
          eITEM_DEFINED_TRANSFORMATION.self)
        let _TEMP10 /* eREPRESENTATION_ITEM.PRef? */ = _TEMP9?.TRANSFORM_ITEM_2
        let _TEMP11 /* eREPRESENTATION_RELATIONSHIP.PRef? */ = SELF.GROUP_REF(eREPRESENTATION_RELATIONSHIP.self)
        let _TEMP12 /* sREPRESENTATION_OR_REPRESENTATION_REFERENCE? */ = _TEMP11?.REP_2
        let _TEMP13 /* runtime? */ = /*runtime*/_TEMP12?.CONTEXT_OF_ITEMS
        let _TEMP14 /* SDAI.BOOLEAN? */ = ITEM_IN_CONTEXT( 
            ITEM: _TEMP10, 
            CNTXT: eREPRESENTATION_CONTEXT.PRef(fromGeneric: /*/*runtime*/SDAI.GENERIC*/_TEMP13) )
        let _TEMP15 /* SDAI.LOGICAL */ = _TEMP8 && _TEMP14
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( TRANSFORMATION_OPERATOR: original._transformation_operator )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]TRANSFORMATION_OPERATOR for partial entity(\(Self.entityName)) constructor"); return nil }
