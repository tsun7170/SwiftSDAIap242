/* file: rational_b_spline_surface.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _rational_b_spline_surface : SDAI.PartialEntity, @unchecked Sendable {
    ...
    /// DERIVE ATTRIBUTE
    internal func _weights__getter(SELF: eRATIONAL_B_SPLINE_SURFACE) -> (SDAI.ARRAY<SDAI.ARRAY<SDAI.REAL>/*[0:
      V_UPPER]*/ >/*[0:U_UPPER]*/ )?  {
    ...
    public static func WHERE_wr1(SELF: eRATIONAL_B_SPLINE_SURFACE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.SIZEOF(SELF.WEIGHTS_DATA)
      let _TEMP2 = SELF.GROUP_REF(eB_SPLINE_SURFACE.self)
      ...
      let _TEMP8 = SELF.GROUP_REF(eB_SPLINE_SURFACE.self)
    ...
    public static func WHERE_wr2(SELF: eRATIONAL_B_SPLINE_SURFACE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SURFACE_WEIGHTS_POSITIVE(SELF)
...
```
*/
  public final class eRATIONAL_B_SPLINE_SURFACE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _rational_b_spline_surface.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _rational_b_spline_surface.WHERE_wr2(SELF: instance)
      return result
    }
