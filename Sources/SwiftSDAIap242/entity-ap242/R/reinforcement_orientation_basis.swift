/* file: reinforcement_orientation_basis.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _reinforcement_orientation_basis : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_reinforcement_orientation_basis``
*/
  public final class eREINFORCEMENT_ORIENTATION_BASIS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _reinforcement_orientation_basis.self
    }
    /// partial entity reference
    public let partialEntity: _reinforcement_orientation_basis
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_reinforcement_orientation_basis.self) else { return nil }
