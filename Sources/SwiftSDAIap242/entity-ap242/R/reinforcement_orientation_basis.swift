/* file: reinforcement_orientation_basis.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- reinforcement_orientation_basis (line:27497 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	reinforcement_orientation_basis
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREINFORCEMENT_ORIENTATION_BASIS/PartialEntity``
*/
  public final class eREINFORCEMENT_ORIENTATION_BASIS : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eREINFORCEMENT_ORIENTATION_BASIS>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eREINFORCEMENT_ORIENTATION_BASIS.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eREINFORCEMENT_ORIENTATION_BASIS.PartialEntity

    //MARK: SUPERTYPES
    public let super_eREPRESENTATION: eREPRESENTATION 	// [1]
    public var super_eREINFORCEMENT_ORIENTATION_BASIS: eREINFORCEMENT_ORIENTATION_BASIS { return self } 	// [2]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREINFORCEMENT_ORIENTATION_BASIS`` )
    public var ITEMS: SDAI.SET<sBASIS_11_DIRECTION_MEMBER>/*[1:1]*/  {
      get {
        let originalValue = super_eREPRESENTATION.partialEntity._items
        let SELF = super_eREPRESENTATION; SDAI.TOUCH(let:SELF)
        let value =         SDAI.SET<sBASIS_11_DIRECTION_MEMBER>(
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eREINFORCEMENT_ORIENTATION_BASIS.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "REINFORCEMENT_ORIENTATION_BASIS", 
        type: self, explicitAttributeCount: 0)

      //MARK: SUPERTYPE REGISTRATIONS
      entityDef.add(supertype: eREPRESENTATION.self)
      entityDef.add(supertype: eREINFORCEMENT_ORIENTATION_BASIS.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eREINFORCEMENT_ORIENTATION_BASIS.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eREINFORCEMENT_ORIENTATION_BASIS.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eREINFORCEMENT_ORIENTATION_BASIS.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eREINFORCEMENT_ORIENTATION_BASIS.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eREINFORCEMENT_ORIENTATION_BASIS.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREINFORCEMENT_ORIENTATION_BASIS``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eREINFORCEMENT_ORIENTATION_BASIS.self
      }

      //ATTRIBUTES
      /* override var _items: SDAI.SET<sBASIS_11_DIRECTION_MEMBER>[1:1] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
