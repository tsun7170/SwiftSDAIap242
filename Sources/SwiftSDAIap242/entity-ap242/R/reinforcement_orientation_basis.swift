/* file: reinforcement_orientation_basis.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- reinforcement_orientation_basis (line:27293 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _reinforcement_orientation_basis : SDAI.PartialEntity {
...
```
*/
  public final class eREINFORCEMENT_ORIENTATION_BASIS : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eREINFORCEMENT_ORIENTATION_BASIS`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "REINFORCEMENT_ORIENTATION_BASIS", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eREINFORCEMENT_ORIENTATION_BASIS.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eREINFORCEMENT_ORIENTATION_BASIS.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eREINFORCEMENT_ORIENTATION_BASIS.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eREINFORCEMENT_ORIENTATION_BASIS.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eREINFORCEMENT_ORIENTATION_BASIS.NAME, 
