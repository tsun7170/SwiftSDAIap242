/* file: requirement_source.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  ENTITY requirement_source
    SUBTYPE OF ( group );
  END_ENTITY; -- requirement_source (line:27548 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _requirement_source : SDAI.PartialEntity {
...
```
*/
  public final class eREQUIREMENT_SOURCE : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "REQUIREMENT_SOURCE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eREQUIREMENT_SOURCE.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ID", keyPath: \eREQUIREMENT_SOURCE.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eREQUIREMENT_SOURCE.NAME, 
