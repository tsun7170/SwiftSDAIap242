/* file: representation_item_relationship.swift 	 generated: Tue Oct 14 17:54:07 2025 */
...
/*
  ...
  END_ENTITY; -- representation_item_relationship (line:27489 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
- SUBTYPES:
	...
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANGLE_DIRECTION_REFERENCE``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGEOMETRIC_MODEL_ELEMENT_RELATIONSHIP``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3MA_EQUIVALENCE_CRITERION_ASSESSMENT_THRESHOLD_RELATIONSHIP``
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP``
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_QUALITY_CRITERION_MEASUREMENT_ASSOCIATION``
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_QUALITY_REPORT_MEASUREMENT_ASSOCIATION``
	8.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGLOBAL_ASSIGNMENT``
	9.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNEAR_POINT_RELATIONSHIP``
	10.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXPLICIT_PROCEDURAL_GEOMETRIC_REPRESENTATION_ITEM_RELATIONSHIP``
	11.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXPLICIT_PROCEDURAL_REPRESENTATION_ITEM_RELATIONSHIP``
	12.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMIN_AND_MAJOR_PLY_ORIENTATION_BASIS``
