/* file: reindexed_array_function.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _reindexed_array_function : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr2(SELF: eREINDEXED_ARRAY_FUNCTION.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP4 /* SDAI.LIST<tPOSITIVE_INTEGER>? */ = SHAPE_OF_ARRAY( eMATHS_FUNCTION.PRef(/*
          eGENERIC_EXPRESSION.PRef*/_TEMP3) )
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_reindexed_array_function``
*/
  public final class eREINDEXED_ARRAY_FUNCTION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _reindexed_array_function.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _reindexed_array_function.WHERE_wr2(SELF: instance.pRef)
      return result
    }
