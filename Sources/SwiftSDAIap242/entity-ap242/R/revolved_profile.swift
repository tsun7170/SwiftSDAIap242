/* file: revolved_profile.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _revolved_profile : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eREVOLVED_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.GROUP_REF(eCHARACTERIZED_OBJECT.self)
      let _TEMP2 = _TEMP1?.DESCRIPTION
      let _TEMP3 = ([SDAI.AIE(SDAI.STRING("groove")), 
    ...
    public static func WHERE_wr2(SELF: eREVOLVED_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eREVOLVED_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eREVOLVED_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = GET_PROPERTY_DEFINITION_REPRESENTATIONS(sCHARACTERIZED_DEFINITION(/*eREVOLVED_PROFILE*/
        SELF))
      let _TEMP2 = _TEMP1?.QUERY{ PDR in 
          ...
          let _TEMP4 = SDAI.FORCE_OPTIONAL(_TEMP3) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("removal direction"))
    ...
    public static func WHERE_wr5(SELF: eREVOLVED_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.GROUP_REF(eCHARACTERIZED_OBJECT.self)
      let _TEMP2 = _TEMP1?.DESCRIPTION
      let _TEMP3 = _TEMP2 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("open profile"))
      let _TEMP4 =  !_TEMP3
      ...
      let _TEMP7 = _TEMP6.QUERY{ PDS in 
          ...
          let _TEMP2 = _TEMP1.QUERY{ SA_OCC in 
              ...
              let _TEMP5 = _TEMP4.QUERY{ SDR in 
                  ...
                  let _TEMP1 = SDAI.TYPEOF(SDR.RELATING_SHAPE_ASPECT, IS: eOPEN_PATH_PROFILE.self)
    ...
    public static func WHERE_wr6(SELF: eREVOLVED_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.GROUP_REF(eCHARACTERIZED_OBJECT.self)
      let _TEMP2 = _TEMP1?.DESCRIPTION
      let _TEMP3 = _TEMP2 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("flat"))
      let _TEMP4 =  !_TEMP3
      let _TEMP5 = SDAI.USEDIN(T: SELF, ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
        .ePROPERTY_DEFINITION.DEFINITION)
      let _TEMP6 = _TEMP5.QUERY{ PD in 
      ...
      let _TEMP7 = _TEMP6.QUERY{ PDS in 
          ...
          let _TEMP2 = _TEMP1.QUERY{ SA_OCC in 
              ...
              let _TEMP5 = _TEMP4.QUERY{ SDR in 
                  ...
                  let _TEMP1 = SDAI.TYPEOF(SDR.RELATING_SHAPE_ASPECT, IS: eLINEAR_PROFILE.self)
                  let _TEMP2 = /*runtime*/SDR.RELATING_SHAPE_ASPECT
                  let _TEMP3 = /*runtime*/SDAI.FORCE_OPTIONAL(_TEMP2)?.DESCRIPTION
                  let _TEMP4 = SDAI.FORCE_OPTIONAL(/*runtime*/_TEMP3) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING(
                    "flat edge shape"))
    ...
    public static func WHERE_wr7(SELF: eREVOLVED_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.GROUP_REF(eCHARACTERIZED_OBJECT.self)
      let _TEMP2 = _TEMP1?.DESCRIPTION
      let _TEMP3 = _TEMP2 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("round"))
      let _TEMP4 =  !_TEMP3
      let _TEMP5 = SDAI.USEDIN(T: SELF, ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
        .ePROPERTY_DEFINITION.DEFINITION)
      let _TEMP6 = _TEMP5.QUERY{ PD in 
    ...
    public static func WHERE_wr8(SELF: eREVOLVED_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.GROUP_REF(eCHARACTERIZED_OBJECT.self)
      let _TEMP2 = _TEMP1?.DESCRIPTION
      let _TEMP3 = _TEMP2 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("groove"))
      let _TEMP4 =  !_TEMP3
      let _TEMP5 = SDAI.USEDIN(T: SELF, ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
        .ePROPERTY_DEFINITION.DEFINITION)
      let _TEMP6 = _TEMP5.QUERY{ PD in 
    ...
    public static func WHERE_wr9(SELF: eREVOLVED_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eREVOLVED_PROFILE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _revolved_profile.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _revolved_profile.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _revolved_profile.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _revolved_profile.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _revolved_profile.WHERE_wr5(SELF: instance)
      result[prefix2 + " .WHERE_wr6"] = _revolved_profile.WHERE_wr6(SELF: instance)
      result[prefix2 + " .WHERE_wr7"] = _revolved_profile.WHERE_wr7(SELF: instance)
      result[prefix2 + " .WHERE_wr8"] = _revolved_profile.WHERE_wr8(SELF: instance)
      result[prefix2 + " .WHERE_wr9"] = _revolved_profile.WHERE_wr9(SELF: instance)
      return result
    }
