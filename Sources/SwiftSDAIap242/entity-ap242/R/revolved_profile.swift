/* file: revolved_profile.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY revolved_profile
    ...
    WHERE
      ...
      wr9: ( SIZEOF( QUERY ( pdr <* get_property_definition_representations( SELF ) | ( ( 
               ...
               >= 0 );
  END_ENTITY; -- revolved_profile (line:27701 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _revolved_profile : SDAI.PartialEntity {
...
```
*/
  public final class eREVOLVED_PROFILE : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "REVOLVED_PROFILE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eREVOLVED_PROFILE.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eREVOLVED_PROFILE.NAME, 
