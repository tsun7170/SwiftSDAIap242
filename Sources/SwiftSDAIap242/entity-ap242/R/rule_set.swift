/* file: rule_set.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- rule_set (line:28355 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _rule_set : SDAI.PartialEntity {
...
```
*/
  public final class eRULE_SET : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "RULE_SET", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eRULE_SET.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ID", keyPath: \eRULE_SET.ID, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "FRAME_OF_REFERENCE", keyPath: \eRULE_SET.FRAME_OF_REFERENCE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eRULE_SET.NAME, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "FORMATION", keyPath: \eRULE_SET.FORMATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
