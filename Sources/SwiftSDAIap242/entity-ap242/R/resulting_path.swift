/* file: resulting_path.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- resulting_path (line:27810 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRESULTING_PATH/PartialEntity``
*/
  public final class eRESULTING_PATH : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eRESULTING_PATH>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eRESULTING_PATH.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eRESULTING_PATH.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRESULTING_PATH`` )
    public var CONTROLLING_JOINTS: SDAI.SET<eKINEMATIC_JOINT.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        ...
        let value = SDAI.UNWRAP( SDAI.SET<eKINEMATIC_JOINT.PRef>( originalValue ) )
        return value
      }
      set(newValue) {
        let partial = self.partialEntity
        let SELF = self; SDAI.TOUCH(let:SELF)
        partial._controlling_joints = SDAI.UNWRAP(SDAI.SET<eKINEMATIC_JOINT.PRef>(
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eRESULTING_PATH.PartialEntity.self) else { return nil }
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRESULTING_PATH``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _controlling_joints: SDAI.SET<eKINEMATIC_JOINT.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(CONTROLLING_JOINTS: SDAI.SET<eKINEMATIC_JOINT.PRef>/*[1:(nil as SDAI.INTEGER?)]*/ ) {
