/* file: rigid_link_representation.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
/*
  ...
  END_ENTITY; -- rigid_link_representation (line:28230 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	rigid_link_representation
    (no local attributes)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRIGID_LINK_REPRESENTATION/PartialEntity``
*/
  public final class eRIGID_LINK_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eRIGID_LINK_REPRESENTATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eRIGID_LINK_REPRESENTATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eRIGID_LINK_REPRESENTATION.PartialEntity
    ...
    public var super_eRIGID_LINK_REPRESENTATION: eRIGID_LINK_REPRESENTATION { return self } 	// [3]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eRIGID_LINK_REPRESENTATION.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "RIGID_LINK_REPRESENTATION", 
      ...
      entityDef.add(supertype: eRIGID_LINK_REPRESENTATION.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \eRIGID_LINK_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eRIGID_LINK_REPRESENTATION.ITEMS, 
      ...
      entityDef.addAttribute(name: "ASSOCIATED_SHAPE_REPRESENTATION", 
        keyPath: \eRIGID_LINK_REPRESENTATION.ASSOCIATED_SHAPE_REPRESENTATION, 
        kind: .inverse, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \eRIGID_LINK_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eRIGID_LINK_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REPRESENTED_LINK", 
        keyPath: \eRIGID_LINK_REPRESENTATION.REPRESENTED_LINK, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eRIGID_LINK_REPRESENTATION.NAME, 
