/* file: requirement_assignment.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
/*
  ...
  END_ENTITY; -- requirement_assignment (line:27757 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	requirement_assignment
    (no local attributes)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREQUIREMENT_ASSIGNMENT/PartialEntity``
*/
  public final class eREQUIREMENT_ASSIGNMENT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eREQUIREMENT_ASSIGNMENT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eREQUIREMENT_ASSIGNMENT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eREQUIREMENT_ASSIGNMENT.PartialEntity

    //MARK: SUPERTYPES
    public let super_eCHARACTERIZED_OBJECT: eCHARACTERIZED_OBJECT 	// [1]
    public let super_eGROUP: eGROUP 	// [2]
    public var super_eREQUIREMENT_ASSIGNMENT: eREQUIREMENT_ASSIGNMENT { return self } 	// [3]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eREQUIREMENT_ASSIGNMENT.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eREQUIREMENT_ASSIGNMENT.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ID", 
        keyPath: \eREQUIREMENT_ASSIGNMENT.ID, 
