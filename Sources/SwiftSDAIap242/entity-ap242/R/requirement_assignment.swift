/* file: requirement_assignment.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _requirement_assignment : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_requirement_assignment``
*/
  public final class eREQUIREMENT_ASSIGNMENT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _requirement_assignment.self
    }
    /// partial entity reference
    public let partialEntity: _requirement_assignment
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_requirement_assignment.self) else { return nil }
