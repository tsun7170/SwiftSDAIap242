/* file: rgc_with_dimension.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eRGC_WITH_DIMENSION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var CONSTRAINED_ELEMENTS: SDAI.SET<sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT>( super_eEXPLICIT_CONSTRAINT
    ...
    public var RADIUS_VALUE: tPOSITIVE_LENGTH_MEASURE {
      get {
        return SDAI.UNWRAP( self.partialEntity._radius_value )
      }
      set(newValue) {
