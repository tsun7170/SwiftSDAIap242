/* file: rgc_with_dimension.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _rgc_with_dimension : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_rgc_with_dimension``
*/
  public final class eRGC_WITH_DIMENSION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _rgc_with_dimension.self
    }
    /// partial entity reference
    public let partialEntity: _rgc_with_dimension
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_rgc_with_dimension.self) else { return nil }
