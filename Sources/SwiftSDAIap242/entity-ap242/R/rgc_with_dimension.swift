/* file: rgc_with_dimension.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- rgc_with_dimension (line:28071 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUPERTYPES:
	...
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRADIUS_GEOMETRIC_CONSTRAINT``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRGC_WITH_DIMENSION/PartialEntity``
*/
  public final class eRGC_WITH_DIMENSION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eRGC_WITH_DIMENSION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eRGC_WITH_DIMENSION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eRGC_WITH_DIMENSION.PartialEntity
    ...
    public let super_eRADIUS_GEOMETRIC_CONSTRAINT: eRADIUS_GEOMETRIC_CONSTRAINT 	// [7]
    public var super_eRGC_WITH_DIMENSION: eRGC_WITH_DIMENSION { return self } 	// [8]
    ...
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRADIUS_GEOMETRIC_CONSTRAINT`` )
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRGC_WITH_DIMENSION`` )
    public var RADIUS_VALUE: tPOSITIVE_LENGTH_MEASURE {
      get {
        let originalValue = self.partialEntity._radius_value
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eRGC_WITH_DIMENSION.PartialEntity.self) else { return nil }
      ...
      guard let super7 = complexEntity?.entityReference(eRADIUS_GEOMETRIC_CONSTRAINT.self) else { return nil }
      self.super_eRADIUS_GEOMETRIC_CONSTRAINT = super7
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRGC_WITH_DIMENSION``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eRGC_WITH_DIMENSION.self
      }

      //ATTRIBUTES
      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _radius_value: tPOSITIVE_LENGTH_MEASURE // PLAIN EXPLICIT ATTRIBUTE
      ...
      public override func hashAsValue(into hasher: inout Hasher, visited complexEntities: inout Set<SDAI.ComplexEntity>) {
        ...
        self._radius_value.value.hashAsValue(into: &hasher, visited: &complexEntities)
      }

      public override func isValueEqual(to rhs: SDAI.PartialEntity, visited comppairs: inout Set<SDAI.ComplexPair>) -> Bool {
        guard let rhs = rhs as? Self else { return false }
        if !super.isValueEqual(to: rhs, visited: &comppairs) { return false }
        if let comp = self._radius_value.value.isValueEqualOptionally(to: rhs._radius_value.value, visited: &comppairs)	{
      ...
      public init(RADIUS_VALUE: tPOSITIVE_LENGTH_MEASURE) {

        self._radius_value = RADIUS_VALUE
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( RADIUS_VALUE: original._radius_value )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]RADIUS_VALUE for partial entity(\(Self.entityName)) constructor"); return nil }

        self.init( RADIUS_VALUE: p0 )
      }
    }
  }
}
