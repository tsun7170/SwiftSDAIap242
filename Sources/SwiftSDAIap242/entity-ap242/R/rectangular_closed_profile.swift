/* file: rectangular_closed_profile.swift 	 generated: Mon Jan  3 16:32:52 2022 */
  ...
  ENTITY rectangular_closed_profile
    ...
    WHERE
      ...
      wr8: ( SIZEOF( QUERY ( pd <* USEDIN( SELF, 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               ...
               <= 1 ) ) ) ) = 0 ) ) ) ) = 0 );
  END_ENTITY; -- rectangular_closed_profile (line:26957 file:ap242ed2_mim_lf_v1.101.TY.exp)
