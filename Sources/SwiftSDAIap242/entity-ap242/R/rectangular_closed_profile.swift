/* file: rectangular_closed_profile.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY rectangular_closed_profile
    ...
    WHERE
      ...
      wr8: ( SIZEOF( QUERY ( pd <* USEDIN( SELF, 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               ...
               <= 1 ) ) ) ) = 0 ) ) ) ) = 0 );
  END_ENTITY; -- rectangular_closed_profile (line:26956 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _rectangular_closed_profile : SDAI.PartialEntity {
...
```
*/
  public final class eRECTANGULAR_CLOSED_PROFILE : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "RECTANGULAR_CLOSED_PROFILE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "PRODUCT_DEFINITIONAL", keyPath: \eRECTANGULAR_CLOSED_PROFILE.PRODUCT_DEFINITIONAL, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eRECTANGULAR_CLOSED_PROFILE.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OF_SHAPE", keyPath: \eRECTANGULAR_CLOSED_PROFILE.OF_SHAPE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eRECTANGULAR_CLOSED_PROFILE.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eRECTANGULAR_CLOSED_PROFILE.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
