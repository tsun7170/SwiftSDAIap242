/* file: requirement_assigned_object.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- requirement_assigned_object (line:27533 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _requirement_assigned_object : SDAI.PartialEntity {
...
```
*/
  public final class eREQUIREMENT_ASSIGNED_OBJECT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eREQUIREMENT_ASSIGNED_OBJECT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "REQUIREMENT_ASSIGNED_OBJECT", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "ROLE", keyPath: \eREQUIREMENT_ASSIGNED_OBJECT.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eREQUIREMENT_ASSIGNED_OBJECT.ITEMS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_GROUP", keyPath: \eREQUIREMENT_ASSIGNED_OBJECT.ASSIGNED_GROUP, 
