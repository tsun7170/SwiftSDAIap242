/* file: requirement_assigned_object.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _requirement_assigned_object : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _assigned_group: eREQUIREMENT_ASSIGNMENT	//EXPLICIT REDEFINITION(eGROUP_ASSIGNMENT) */
...
```
*/
  public final class eREQUIREMENT_ASSIGNED_OBJECT : SDAI.EntityReference, @unchecked Sendable {
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREQUIREMENT_ASSIGNED_OBJECT`` )
    public var ASSIGNED_GROUP: eREQUIREMENT_ASSIGNMENT {
      get {
        if let resolved = _group_assignment._assigned_group__provider(complex: self.complexEntity) {
          let value = SDAI.UNWRAP( eREQUIREMENT_ASSIGNMENT(resolved._assigned_group__getter(
            complex: self.complexEntity)) )
          return value
        }
        else {
          return SDAI.UNWRAP( eREQUIREMENT_ASSIGNMENT(super_eGROUP_ASSIGNMENT.partialEntity._assigned_group) )
        }
      }
      set(newValue) {
