/* file: rule_condition.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- rule_condition (line:28347 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _rule_condition : SDAI.PartialEntity {
...
```
*/
  public final class eRULE_CONDITION : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "RULE_CONDITION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ITEM_ELEMENT", keyPath: \eRULE_CONDITION.ITEM_ELEMENT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eRULE_CONDITION.NAME, 
