/* file: representative_shape_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _representative_shape_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eREPRESENTATIVE_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = UNIQUE_IN_PRODUCT_DEFINITION(SELF)
      let _TEMP2 = UNIQUE_IN_SHAPE_ASPECT(SELF)
...
```
*/
  public final class eREPRESENTATIVE_SHAPE_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _representative_shape_representation.WHERE_wr1(SELF: instance)
      return result
    }
