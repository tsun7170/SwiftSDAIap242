/* file: radius_geometric_constraint.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- radius_geometric_constraint (line:26992 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRGC_WITH_DIMENSION``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRADIUS_GEOMETRIC_CONSTRAINT/PartialEntity``
*/
  public final class eRADIUS_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eRADIUS_GEOMETRIC_CONSTRAINT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eRADIUS_GEOMETRIC_CONSTRAINT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eRADIUS_GEOMETRIC_CONSTRAINT.PartialEntity
    ...
    public var super_eRADIUS_GEOMETRIC_CONSTRAINT: eRADIUS_GEOMETRIC_CONSTRAINT { return self } 	// [7]

    //MARK: SUBTYPES
    public var sub_eRGC_WITH_DIMENSION: eRGC_WITH_DIMENSION? {	// [8]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRADIUS_GEOMETRIC_CONSTRAINT`` )
    public var CONSTRAINED_ELEMENTS: SDAI.SET<sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        ...
        let value =         SDAI.SET<sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT>(
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eRADIUS_GEOMETRIC_CONSTRAINT.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eRADIUS_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRADIUS_GEOMETRIC_CONSTRAINT``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eRADIUS_GEOMETRIC_CONSTRAINT.self
      }

      //ATTRIBUTES
      /* override var _constrained_elements: SDAI.SET<sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT>[1:(nil as SDAI.INTEGER?)] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */
      ...
      public static func WHERE_wr1(SELF: eRADIUS_GEOMETRIC_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
