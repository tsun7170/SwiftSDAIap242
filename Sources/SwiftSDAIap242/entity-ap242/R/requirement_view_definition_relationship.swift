/* file: requirement_view_definition_relationship.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _requirement_view_definition_relationship : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_requirement_view_definition_relationship``
*/
  public final class eREQUIREMENT_VIEW_DEFINITION_RELATIONSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _requirement_view_definition_relationship.self
    }
    /// partial entity reference
    public let partialEntity: _requirement_view_definition_relationship
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_requirement_view_definition_relationship.self) else { return nil }
