/* file: rectangular_array_placement_group_component.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- rectangular_array_placement_group_component (line:26952 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eRECTANGULAR_ARRAY_PLACEMENT_GROUP_COMPONENT : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "RECTANGULAR_ARRAY_PLACEMENT_GROUP_COMPONENT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "RELATING_PRODUCT_DEFINITION", keyPath: \eRECTANGULAR_ARRAY_PLACEMENT_GROUP_COMPONENT.RELATING_PRODUCT_DEFINITION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "FRAME_OF_REFERENCE", keyPath: \eRECTANGULAR_ARRAY_PLACEMENT_GROUP_COMPONENT.FRAME_OF_REFERENCE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DEFINITION", keyPath: \eRECTANGULAR_ARRAY_PLACEMENT_GROUP_COMPONENT.DEFINITION, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "RELATED_PRODUCT_DEFINITION", keyPath: \eRECTANGULAR_ARRAY_PLACEMENT_GROUP_COMPONENT.RELATED_PRODUCT_DEFINITION, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "FORMATION", keyPath: \eRECTANGULAR_ARRAY_PLACEMENT_GROUP_COMPONENT.FORMATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
