/* file: applied_group_assignment.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
  public final class eAPPLIED_GROUP_ASSIGNMENT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var ITEMS: SDAI.SET<sGROUPABLE_ITEM>/*[1:?]*/  {
      get {
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _items: SDAI.SET<sGROUPABLE_ITEM>/*[1:?]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(ITEMS: SDAI.SET<sGROUPABLE_ITEM>/*[1:?]*/ ) {

        self._items = 
        SDAI.SET<sGROUPABLE_ITEM>(from: ITEMS.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
