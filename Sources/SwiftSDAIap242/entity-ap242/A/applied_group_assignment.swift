/* file: applied_group_assignment.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- applied_group_assignment (line:7260 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOLLECTION_ASSIGNMENT``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOLLECTION_MEMBERSHIP``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_GROUP_ASSIGNMENT/PartialEntity``
*/
  public final class eAPPLIED_GROUP_ASSIGNMENT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eAPPLIED_GROUP_ASSIGNMENT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eAPPLIED_GROUP_ASSIGNMENT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eAPPLIED_GROUP_ASSIGNMENT.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_GROUP_ASSIGNMENT`` )
    public var ITEMS: SDAI.SET<sGROUPABLE_ITEM>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = self.partialEntity._items
        let value = SDAI.UNWRAP( SDAI.SET<sGROUPABLE_ITEM>( originalValue ) )
        return value
      }
      set(newValue) {
        let partial = self.partialEntity
        let SELF = self; SDAI.TOUCH(let:SELF)
        partial._items = SDAI.UNWRAP(SDAI.SET<sGROUPABLE_ITEM>(
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eAPPLIED_GROUP_ASSIGNMENT.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "ROLE", 
        keyPath: \eAPPLIED_GROUP_ASSIGNMENT.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eAPPLIED_GROUP_ASSIGNMENT.ITEMS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_GROUP", 
        keyPath: \eAPPLIED_GROUP_ASSIGNMENT.ASSIGNED_GROUP, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_GROUP_ASSIGNMENT``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _items: SDAI.SET<sGROUPABLE_ITEM>/*[1:(nil as SDAI.INTEGER?)]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(ITEMS: SDAI.SET<sGROUPABLE_ITEM>/*[1:(nil as SDAI.INTEGER?)]*/ ) {

        self._items = 
        SDAI.SET<sGROUPABLE_ITEM>(
