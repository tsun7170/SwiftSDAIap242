/* file: asin_function.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- asin_function (line:7442 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eASIN_FUNCTION/PartialEntity``
*/
  public final class eASIN_FUNCTION : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eASIN_FUNCTION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eASIN_FUNCTION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eASIN_FUNCTION.PartialEntity
    ...
    public var super_eASIN_FUNCTION: eASIN_FUNCTION { return self } 	// [7]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eASIN_FUNCTION.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eASIN_FUNCTION.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "IS_INT", 
        keyPath: \eASIN_FUNCTION.IS_INT, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "SQL_MAPPABLE", 
        keyPath: \eASIN_FUNCTION.SQL_MAPPABLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OPERAND", 
        keyPath: \eASIN_FUNCTION.OPERAND, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eASIN_FUNCTION``
*/
