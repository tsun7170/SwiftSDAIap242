/* file: attribute_assertion.swift 	 generated: Thu Dec 25 18:13:23 2025 */
...
*/
  ...
  public final class _attribute_assertion : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_attribute_assertion``
*/
  public final class eATTRIBUTE_ASSERTION : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _attribute_assertion.self
    }
    /// partial entity reference
    public let partialEntity: _attribute_assertion
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_attribute_assertion.self) else { return nil }
