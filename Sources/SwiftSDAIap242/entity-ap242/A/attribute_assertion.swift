/* file: attribute_assertion.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- attribute_assertion (line:7611 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(3)	property_definition_representation
  ...
  ENTITY(SELF)	attribute_assertion
    (no local attributes)
...
- SUPERTYPES:
	...
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFACT_TYPE``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROPERTY_DEFINITION_REPRESENTATION``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREPRESENTATION``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eATTRIBUTE_ASSERTION/PartialEntity``
*/
  public final class eATTRIBUTE_ASSERTION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eATTRIBUTE_ASSERTION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eATTRIBUTE_ASSERTION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eATTRIBUTE_ASSERTION.PartialEntity

    //MARK: SUPERTYPES
    public let super_ePROPERTY_DEFINITION: ePROPERTY_DEFINITION 	// [1]
    public let super_eFACT_TYPE: eFACT_TYPE 	// [2]
    public let super_ePROPERTY_DEFINITION_REPRESENTATION: ePROPERTY_DEFINITION_REPRESENTATION 	// [3]
    public let super_eREPRESENTATION: eREPRESENTATION 	// [4]
    public var super_eATTRIBUTE_ASSERTION: eATTRIBUTE_ASSERTION { return self } 	// [5]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eATTRIBUTE_ASSERTION.PartialEntity.self) else { return nil }
      ...
      guard let super3 = complexEntity?.entityReference(ePROPERTY_DEFINITION_REPRESENTATION.self) else { return nil }
      self.super_ePROPERTY_DEFINITION_REPRESENTATION = super3

      guard let super4 = complexEntity?.entityReference(eREPRESENTATION.self) else { return nil }
      self.super_eREPRESENTATION = super4
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eATTRIBUTE_ASSERTION.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \eATTRIBUTE_ASSERTION.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "USED_REPRESENTATION", 
        keyPath: \eATTRIBUTE_ASSERTION.USED_REPRESENTATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \eATTRIBUTE_ASSERTION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
