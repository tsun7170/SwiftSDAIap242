/* file: a3m_equivalence_criterion_of_detailed_assembly_data_content.swift 	 generated: Thu Mar  5 17:54:18 2026 */
  ...
  ENTITY a3m_equivalence_criterion_of_detailed_assembly_data_content
    ...
    DERIVE
      ...
      SELF\a3m_equivalence_criterion.compared_element_types : LIST [1 : 1] OF a3ma_element_type_name := [
                                          etna_product_definition_or_reference];
  END_ENTITY; -- a3m_equivalence_criterion_of_detailed_assembly_data_content (line:6110 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT/PartialEntity``
*/
  public final class eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT.PartialEntity
    ...
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "A3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT", 
      ...
      entityDef.addAttribute(name: "ACCURACY_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT.ACCURACY_TYPES, 
      ...
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT.DETECTED_DIFFERENCE_TYPES, 
      ...
      entityDef.addAttribute(name: "ASSESSMENT_THRESHOLD_2", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT.ASSESSMENT_THRESHOLD_2, 
        kind: .inverse, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT.COMPARED_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT.MEASURED_DATA_TYPE, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT.COMPARING_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      @_documentation(visibility:public)
      internal func _comparing_element_types__getter(SELF: eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT.PRef) -> 
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _compared_element_types__getter(SELF: eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT.PRef) -> 
        SDAI.LIST<nA3MA_ELEMENT_TYPE_NAME>/*[1:1]*/  {
        //
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_ELEMENT_TYPE_NAME> */ = SDAI.LIST<nA3MA_ELEMENT_TYPE_NAME>(
          bound1:SDAI.UNWRAP(1), bound2:1,  ([ SDAI.AIE(nA3MA_ELEMENT_TYPE_NAME(/*nA3M_ELEMENT_TYPE_NAME*/
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
  .eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT.PartialEntity :
