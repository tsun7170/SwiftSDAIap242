/* file: assigned_analysis.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- assigned_analysis (line:7528 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _assigned_analysis : SDAI.PartialEntity {
...
```
*/
  public final class eASSIGNED_ANALYSIS : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eASSIGNED_ANALYSIS`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "ASSIGNED_ANALYSIS", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "ROLE", keyPath: \eASSIGNED_ANALYSIS.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eASSIGNED_ANALYSIS.ITEMS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_GROUP", keyPath: \eASSIGNED_ANALYSIS.ASSIGNED_GROUP, 
