/* file: assigned_analysis.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _assigned_analysis : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /// EXPLICIT ATTRIBUTE 
    public internal(set) var _items: SDAI.SET<ePRODUCT_DEFINITION_FORMATION>/*[1:1]*/  // PLAIN EXPLICIT ATTRIBUTE
    ...
    public init(ITEMS: SDAI.SET<ePRODUCT_DEFINITION_FORMATION>/*[1:1]*/ ) {
      self._items = ITEMS
    ...
    public required convenience init?(parameters: [P21Decode.ExchangeStructure.Parameter], exchangeStructure: P21Decode.ExchangeStructure) {
      ...
      guard case .success(let p0) = exchangeStructure.recoverRequiredParameter(as: SDAI.SET<
        ePRODUCT_DEFINITION_FORMATION>.self, from: parameters[0])
...
```
*/
  public final class eASSIGNED_ANALYSIS : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var ITEMS: SDAI.SET<ePRODUCT_DEFINITION_FORMATION>/*[1:1]*/  {
      get {
