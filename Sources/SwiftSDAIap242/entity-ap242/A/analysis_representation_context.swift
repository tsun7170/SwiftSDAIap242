/* file: analysis_representation_context.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- analysis_representation_context (line:6806 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _analysis_representation_context : SDAI.PartialEntity {
...
```
*/
  public final class eANALYSIS_REPRESENTATION_CONTEXT : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "ANALYSIS_REPRESENTATION_CONTEXT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "CONTEXT_IDENTIFIER", keyPath: \eANALYSIS_REPRESENTATION_CONTEXT.CONTEXT_IDENTIFIER, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "REPRESENTATIONS_IN_CONTEXT", keyPath: \eANALYSIS_REPRESENTATION_CONTEXT.REPRESENTATIONS_IN_CONTEXT, 
        kind: .inverse, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CONTEXT_TYPE", keyPath: \eANALYSIS_REPRESENTATION_CONTEXT.CONTEXT_TYPE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
