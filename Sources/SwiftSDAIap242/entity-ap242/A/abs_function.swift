/* file: abs_function.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- abs_function (line:6326 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eABS_FUNCTION/PartialEntity``
*/
  public final class eABS_FUNCTION : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eABS_FUNCTION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eABS_FUNCTION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eABS_FUNCTION.PartialEntity
    ...
    public var super_eABS_FUNCTION: eABS_FUNCTION { return self } 	// [7]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eABS_FUNCTION.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eABS_FUNCTION.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "IS_INT", 
        keyPath: \eABS_FUNCTION.IS_INT, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "SQL_MAPPABLE", 
        keyPath: \eABS_FUNCTION.SQL_MAPPABLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OPERAND", 
        keyPath: \eABS_FUNCTION.OPERAND, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eABS_FUNCTION``
*/
