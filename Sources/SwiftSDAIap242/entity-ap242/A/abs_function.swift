/* file: abs_function.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- abs_function (line:6319 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _abs_function : SDAI.PartialEntity {
...
```
*/
  public final class eABS_FUNCTION : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "ABS_FUNCTION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "IS_INT", keyPath: \eABS_FUNCTION.IS_INT, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "SQL_MAPPABLE", keyPath: \eABS_FUNCTION.SQL_MAPPABLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OPERAND", keyPath: \eABS_FUNCTION.OPERAND, 
