/* file: abs_function.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _abs_function : SDAI.PartialEntity, SDAI.InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_abs_function``
*/
  public final class eABS_FUNCTION : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public let partialEntity: _abs_function
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_abs_function.self) else { return nil }
