/* file: a3ma_length_measure_and_context_dependent_measure_pair.swift 	 generated: Sun Oct 31 15:32:10 2021 */
  ...
  ENTITY a3ma_length_measure_and_context_dependent_measure_pair
    ...
    WHERE
      ...
      wr6: ( SIZEOF( QUERY ( vri <* [SELF\compound_representation_item.item_element[2]] | ( 
               ...
               value_component ) ) ) ) = 1 );
  END_ENTITY; -- a3ma_length_measure_and_context_dependent_measure_pair (line:6245 file:ap242ed2_mim_lf_v1.101.TY.exp)
