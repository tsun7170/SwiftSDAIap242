/* file: a3m_equivalence_criterion_of_representative_shape_property_value.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      internal func _comparing_element_types__getter(SELF: eA3M_EQUIVALENCE_CRITERION_OF_REPRESENTATIVE_SHAPE_PROPERTY_VALUE.PRef) -> 
        ...
        let _TEMP2 /* SDAI.LIST<nA3M_ELEMENT_TYPE_NAME>[1:nil] ? */ = _TEMP1?.COMPARED_ELEMENT_TYPES
        let value = _TEMP2
