/* file: a3m_equivalence_criterion_of_representative_shape_property_value.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      internal func _comparing_element_types__getter(SELF: eA3M_EQUIVALENCE_CRITERION_OF_REPRESENTATIVE_SHAPE_PROPERTY_VALUE.PRef) -> 
        SDAI.LIST<nA3M_ELEMENT_TYPE_NAME>/*[1:?]*/  {
        //
        let _TEMP1 /* eA3M_EQUIVALENCE_CRITERION.PRef? */ = SELF.GROUP_REF(eA3M_EQUIVALENCE_CRITERION.self)
        let _TEMP2 /* SDAI.LIST<nA3M_ELEMENT_TYPE_NAME>[1:?] ? */ = _TEMP1?.COMPARED_ELEMENT_TYPES
        let value = _TEMP2
        return SDAI.UNWRAP( value )
      }
