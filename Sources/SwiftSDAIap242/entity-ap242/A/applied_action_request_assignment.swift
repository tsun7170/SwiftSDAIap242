/* file: applied_action_request_assignment.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- applied_action_request_assignment (line:7067 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _applied_action_request_assignment : SDAI.PartialEntity {
...
```
*/
  public final class eAPPLIED_ACTION_REQUEST_ASSIGNMENT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eAPPLIED_ACTION_REQUEST_ASSIGNMENT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "APPLIED_ACTION_REQUEST_ASSIGNMENT", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "ROLE", keyPath: \eAPPLIED_ACTION_REQUEST_ASSIGNMENT.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eAPPLIED_ACTION_REQUEST_ASSIGNMENT.ITEMS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_ACTION_REQUEST", keyPath: \eAPPLIED_ACTION_REQUEST_ASSIGNMENT.ASSIGNED_ACTION_REQUEST, 
