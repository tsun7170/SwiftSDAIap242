/* file: applied_effectivity_assignment.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- applied_effectivity_assignment (line:7232 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _applied_effectivity_assignment : SDAI.PartialEntity {
...
```
*/
  public final class eAPPLIED_EFFECTIVITY_ASSIGNMENT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eAPPLIED_EFFECTIVITY_ASSIGNMENT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "APPLIED_EFFECTIVITY_ASSIGNMENT", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "ROLE", keyPath: \eAPPLIED_EFFECTIVITY_ASSIGNMENT.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eAPPLIED_EFFECTIVITY_ASSIGNMENT.ITEMS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_EFFECTIVITY", keyPath: \eAPPLIED_EFFECTIVITY_ASSIGNMENT.ASSIGNED_EFFECTIVITY, 
