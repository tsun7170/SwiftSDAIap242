/* file: a3m_equivalence_inspection_requirement_with_values.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _applied_values: SDAI.SET<eMEASURE_REPRESENTATION_ITEM.PRef>/*[1:?]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(APPLIED_VALUES: SDAI.SET<eMEASURE_REPRESENTATION_ITEM.PRef>/*[1:?]*/ ) {

        self._applied_values = 
        SDAI.SET<eMEASURE_REPRESENTATION_ITEM.PRef>(from: APPLIED_VALUES.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
