/* file: a3m_equivalence_inspection_requirement_with_values.swift 	 generated: Tue Jan 20 19:20:51 2026 */
...
*/
  public final class eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var ASSESSMENT_SPECIFICATION: eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST.PRef?  {
      get {
        return eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST.PRef( sub_eDIFFERENT_CURVE_LENGTH?.super_eA3M_EQUIVALENCE_CRITERION
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _applied_values: SDAI.SET<eMEASURE_REPRESENTATION_ITEM.PRef>/*[1:nil]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(APPLIED_VALUES: SDAI.SET<eMEASURE_REPRESENTATION_ITEM.PRef>/*[1:nil]*/ ) {
