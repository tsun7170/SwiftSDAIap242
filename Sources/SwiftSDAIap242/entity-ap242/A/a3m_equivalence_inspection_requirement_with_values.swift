/* file: a3m_equivalence_inspection_requirement_with_values.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- a3m_equivalence_inspection_requirement_with_values (line:6175 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUPERTYPES:
	...
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT``

- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_CURVE_LENGTH``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_VOLUME``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_SURFACE_AREA``
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_CENTROID``
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_BOUNDING_BOX``
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES``
	8.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_SURFACE_NORMAL``
	9.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISMATCH_OF_ARCWISE_CONNECTED_CURVES``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES/PartialEntity``
*/
  public final class eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES.PartialEntity
    ...
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_CURVE_LENGTH`` )
    ...
    public var DETECTED_DIFFERENCE_TYPES: (SDAI.LIST<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>/*[1:1]*/ )?  {
      get {
        ...
        let value = SDAI.LIST<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>(
          origin.partialEntity._detected_difference_types__getter(SELF: origin.pRef))
    ...
    public var ASSESSMENT_SPECIFICATION: eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST.PRef?  {
      get {
        let originalValue = sub_eDIFFERENT_CURVE_LENGTH?
          .super_eA3M_EQUIVALENCE_CRITERION.partialEntity._assessment_specification
        let value = eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST.PRef( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eDIFFERENT_CURVE_LENGTH?
          .super_eA3M_EQUIVALENCE_CRITERION.partialEntity
          else { return }
    ...
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISMATCH_OF_ARCWISE_CONNECTED_SURFACES_BOUNDARY`` )
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES`` )
    public var APPLIED_VALUES: SDAI.SET<eMEASURE_REPRESENTATION_ITEM.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = self.partialEntity._applied_values
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "A3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES", 
      ...
      entityDef.addAttribute(name: "ACCURACY_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES.ACCURACY_TYPES, 
      ...
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES.DETECTED_DIFFERENCE_TYPES, 
        kind: .derivedRedeclaring, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES.COMPARED_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", 
        keyPath: \eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES.MEASURED_DATA_TYPE, 
        kind: .derivedRedeclaring, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES.COMPARING_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "APPLIED_VALUES", 
        keyPath: \eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES.APPLIED_VALUES, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_INSPECTION_REQUIREMENT_WITH_VALUES``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _applied_values: SDAI.SET<eMEASURE_REPRESENTATION_ITEM.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(APPLIED_VALUES: SDAI.SET<eMEASURE_REPRESENTATION_ITEM.PRef>/*[1:(nil as SDAI.INTEGER?)]*/ ) {

        self._applied_values = 
        SDAI.SET<eMEASURE_REPRESENTATION_ITEM.PRef>(
          from: APPLIED_VALUES.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( APPLIED_VALUES: original._applied_values )
      }
      ...
      public required convenience init?(
        ...
        guard case .success(let p0) = exchangeStructure.recoverRequiredParameter(as: SDAI.SET<
          eMEASURE_REPRESENTATION_ITEM.PRef>.self, from: parameters[0])
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]APPLIED_VALUES for partial entity(\(Self.entityName)) constructor"); return nil }
