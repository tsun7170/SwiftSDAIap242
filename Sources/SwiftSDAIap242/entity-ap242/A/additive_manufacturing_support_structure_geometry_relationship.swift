/* file: additive_manufacturing_support_structure_geometry_relationship.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _additive_manufacturing_support_structure_geometry_relationship : SDAI.PartialEntity
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_additive_manufacturing_support_structure_geometry_relationship``
*/
  public final class eADDITIVE_MANUFACTURING_SUPPORT_STRUCTURE_GEOMETRY_RELATIONSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _additive_manufacturing_support_structure_geometry_relationship.self
    }
    /// partial entity reference
    public let partialEntity: _additive_manufacturing_support_structure_geometry_relationship
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_additive_manufacturing_support_structure_geometry_relationship.self) else { return nil }
