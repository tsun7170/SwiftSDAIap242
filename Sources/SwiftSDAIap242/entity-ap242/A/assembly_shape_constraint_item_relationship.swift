/* file: assembly_shape_constraint_item_relationship.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _assembly_shape_constraint_item_relationship : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _relating_shape_aspect: eASSEMBLY_SHAPE_CONSTRAINT	//EXPLICIT REDEFINITION(eSHAPE_ASPECT_RELATIONSHIP) */
...
```
*/
  public final class eASSEMBLY_SHAPE_CONSTRAINT_ITEM_RELATIONSHIP : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var RELATING_SHAPE_ASPECT: eASSEMBLY_SHAPE_CONSTRAINT {
      get {
        return SDAI.UNWRAP( eASSEMBLY_SHAPE_CONSTRAINT( super_eSHAPE_ASPECT_RELATIONSHIP.partialEntity
