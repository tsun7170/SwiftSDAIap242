/* file: a3m_equivalence_inspection_result_representation_for_assembly.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _a3m_equivalence_inspection_result_representation_for_assembly : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION_FOR_ASSEMBLY?) -> SDAI.LOGICAL {
      ...
      let _TEMP3 = _TEMP2?.QUERY{ Q in 
          ...
          let _TEMP1 = SDAI.TYPEOF(Q, IS: eA3MS_EQUIVALENCE_INSPECTION_RESULT.self)
          return _TEMP1 }
...
```
*/
  public final class eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION_FOR_ASSEMBLY : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _a3m_equivalence_inspection_result_representation_for_assembly.WHERE_wr1(SELF: instance)
      return result
    }
