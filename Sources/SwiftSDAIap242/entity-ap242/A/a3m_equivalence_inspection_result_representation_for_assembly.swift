/* file: a3m_equivalence_inspection_result_representation_for_assembly.swift 	 generated: Sun Oct 31 15:32:10 2021 */
  ...
  ENTITY a3m_equivalence_inspection_result_representation_for_assembly
    ...
    WHERE
      wr1: ( SIZEOF( QUERY ( q <* SELF\representation.items | ( 
               ...
               TYPEOF( q ) ) ) ) = 0 );
  END_ENTITY; -- a3m_equivalence_inspection_result_representation_for_assembly (line:6178 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION_FOR_ASSEMBLY : SDAI.EntityReference {
    ...
    /// - origin: SUPER( ``eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "A3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION_FOR_ASSEMBLY", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "CRITERIA_INSPECTED", keyPath: \eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION_FOR_ASSEMBLY.CRITERIA_INSPECTED, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION_FOR_ASSEMBLY.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION_FOR_ASSEMBLY.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION_FOR_ASSEMBLY.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION_FOR_ASSEMBLY.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION_FOR_ASSEMBLY.NAME, 
