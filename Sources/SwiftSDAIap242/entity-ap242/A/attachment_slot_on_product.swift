/* file: attachment_slot_on_product.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _attachment_slot_on_product : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_attachment_slot_on_product``
*/
  public final class eATTACHMENT_SLOT_ON_PRODUCT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _attachment_slot_on_product.self
    }
    /// partial entity reference
    public let partialEntity: _attachment_slot_on_product
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_attachment_slot_on_product.self) else { return nil }
