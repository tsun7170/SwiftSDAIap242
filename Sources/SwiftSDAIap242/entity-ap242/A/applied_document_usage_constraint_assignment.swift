/* file: applied_document_usage_constraint_assignment.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- applied_document_usage_constraint_assignment (line:7227 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eAPPLIED_DOCUMENT_USAGE_CONSTRAINT_ASSIGNMENT : SDAI.EntityReference {
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``eAPPLIED_DOCUMENT_USAGE_CONSTRAINT_ASSIGNMENT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "APPLIED_DOCUMENT_USAGE_CONSTRAINT_ASSIGNMENT", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "ASSIGNED_DOCUMENT_USAGE", keyPath: \eAPPLIED_DOCUMENT_USAGE_CONSTRAINT_ASSIGNMENT.ASSIGNED_DOCUMENT_USAGE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ROLE", keyPath: \eAPPLIED_DOCUMENT_USAGE_CONSTRAINT_ASSIGNMENT.ROLE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eAPPLIED_DOCUMENT_USAGE_CONSTRAINT_ASSIGNMENT.ITEMS, 
