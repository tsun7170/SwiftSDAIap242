/* file: a3ms_equivalence_criterion_with_specified_elements.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _a3ms_equivalence_criterion_with_specified_elements : SDAI.PartialEntity
    ...
    //ATTRIBUTES
    /* override var _comparing_specified_elements: SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:nil] 	//EXPLICIT REDEFINITION(eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS) */

    /* override var _compared_specified_elements: SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:nil] 	//EXPLICIT REDEFINITION(eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS) */
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_a3ms_equivalence_criterion_with_specified_elements``
*/
  public final class eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _a3ms_equivalence_criterion_with_specified_elements.self
    }
    /// partial entity reference
    public let partialEntity: _a3ms_equivalence_criterion_with_specified_elements
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_a3ms_equivalence_criterion_with_specified_elements.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _a3ms_equivalence_criterion_with_specified_elements.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _a3ms_equivalence_criterion_with_specified_elements.WHERE_wr2(SELF: instance.pRef)
      return result
    }
