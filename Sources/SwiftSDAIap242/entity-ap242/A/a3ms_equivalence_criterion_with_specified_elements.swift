/* file: a3ms_equivalence_criterion_with_specified_elements.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var COMPARING_SPECIFIED_ELEMENTS: SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>( super_eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      /* override var _comparing_specified_elements: SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:
        nil] 	//EXPLICIT REDEFINITION(eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS) */
      ...
      public static func WHERE_wr1(SELF: eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP1 /* SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:nil] ? */ = SELF.COMPARING_SPECIFIED_ELEMENTS
        let _TEMP2 /* nA3MS_ELEMENT_TYPE_NAME? */ = A3MS_GET_ELEMENT_TYPE( 
            ...
            SDAI.INTEGER?), /*SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:nil] */_TEMP1) )
        let _TEMP3 /* SDAI.LOGICAL */ = _TEMP2 .==. SDAI.FORCE_OPTIONAL(ETNS_EXTERNAL_REPRESENTATION_ITEM)
        let _TEMP4 /* SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:nil] ? */ = SELF.COMPARING_SPECIFIED_ELEMENTS
        let _TEMP5 /* nA3MS_ELEMENT_TYPE_NAME? */ = A3MS_GET_ELEMENT_TYPE( 
            SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as 
            SDAI.INTEGER?), /*SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:nil] */_TEMP4) )
        let _TEMP6 /* eA3M_EQUIVALENCE_CRITERION_FOR_SHAPE.PRef? */ = SELF.GROUP_REF(
          eA3M_EQUIVALENCE_CRITERION_FOR_SHAPE.self)
        let _TEMP7 /* SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>[1:nil] ? */ = _TEMP6?.COMPARING_ELEMENT_TYPES
      ...
      public static func WHERE_wr2(SELF: eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP1 /* SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:nil] ? */ = SELF.COMPARED_SPECIFIED_ELEMENTS
        let _TEMP2 /* nA3MS_ELEMENT_TYPE_NAME? */ = A3MS_GET_ELEMENT_TYPE( 
            SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as 
            SDAI.INTEGER?), /*SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:nil] */_TEMP1) )
        let _TEMP3 /* SDAI.LOGICAL */ = _TEMP2 .==. SDAI.FORCE_OPTIONAL(ETNS_EXTERNAL_REPRESENTATION_ITEM)
        let _TEMP4 /* SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:nil] ? */ = SELF.COMPARED_SPECIFIED_ELEMENTS
        let _TEMP5 /* nA3MS_ELEMENT_TYPE_NAME? */ = A3MS_GET_ELEMENT_TYPE( 
            SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as 
            SDAI.INTEGER?), /*SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:nil] */_TEMP4) )
        let _TEMP6 /* eA3M_EQUIVALENCE_CRITERION_FOR_SHAPE.PRef? */ = SELF.GROUP_REF(
          eA3M_EQUIVALENCE_CRITERION_FOR_SHAPE.self)
        let _TEMP7 /* SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>[1:nil] ? */ = _TEMP6?.COMPARED_ELEMENT_TYPES
        let _TEMP8 /* SDAI.LOGICAL */ = SDAI.aggregate( _TEMP7, contains: _TEMP5 )
        let _TEMP9 /* SDAI.LOGICAL */ = _TEMP3 || _TEMP8
        return _TEMP9
      }
