/* file: a3ms_equivalence_criterion_with_specified_elements.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ENTITY a3ms_equivalence_criterion_with_specified_elements
    SUBTYPE OF ( a3m_equivalence_criterion_for_shape, a3m_equivalence_criterion_with_specified_elements );
      SELF\a3m_equivalence_criterion_with_specified_elements.comparing_specified_elements : SET [1 : ?] OF
                                          a3ms_inspected_equivalence_element_select;
      SELF\a3m_equivalence_criterion_with_specified_elements.compared_specified_elements : SET [1 : ?] OF
                                          a3ms_inspected_equivalence_element_select;
    WHERE
      wr1: ( ( a3ms_get_element_type( SELF.comparing_specified_elements ) = etns_external_representation_item ) 
               OR ( a3ms_get_element_type( SELF.comparing_specified_elements ) IN SELF\
               a3m_equivalence_criterion_for_shape.comparing_element_types ) );
      wr2: ( ( a3ms_get_element_type( SELF.compared_specified_elements ) = etns_external_representation_item ) 
               OR ( a3ms_get_element_type( SELF.compared_specified_elements ) IN SELF\
               a3m_equivalence_criterion_for_shape.compared_element_types ) );
  END_ENTITY; -- a3ms_equivalence_criterion_with_specified_elements (line:6274 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(6)	a3m_equivalence_criterion_with_specified_elements
  ...
  ENTITY(SELF)	a3ms_equivalence_criterion_with_specified_elements
...
- SUPERTYPES:
	...
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_FOR_SHAPE``
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS/PartialEntity``
*/
  public final class eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.PartialEntity
    ...
    public let super_eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS: eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS 	// [6]
    public var super_eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS: eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS { return self } 	// [7]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT REDEF(DYNAMIC)__ attribute
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_FOR_SHAPE`` )
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS`` )
    public var COMPARING_SPECIFIED_ELEMENTS: SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>/*[1:?]*/  {
      get {
        let originalValue = super_eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.partialEntity
          ._comparing_specified_elements
        let SELF = super_eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS; SDAI.TOUCH(let:SELF)
      ...
      set(newValue) {
        let partial = super_eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.partialEntity
        let SELF = super_eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS; SDAI.TOUCH(let:SELF)
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.PartialEntity.self) else { return nil }
      ...
      guard let super6 = complexEntity?.entityReference(eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.self) else { return nil }
      self.super_eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS = super6
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "A3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS", 
      ...
      entityDef.add(supertype: eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ACCURACY_TYPES", 
        keyPath: \eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.ACCURACY_TYPES, 
      ...
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", 
        keyPath: \eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.DETECTED_DIFFERENCE_TYPES, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_SPECIFIED_ELEMENTS", 
        keyPath: \eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.COMPARING_SPECIFIED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "COMPARED_SPECIFIED_ELEMENTS", 
        keyPath: \eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.COMPARED_SPECIFIED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", 
        keyPath: \eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.COMPARED_ELEMENT_TYPES, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", 
        keyPath: \eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.MEASURED_DATA_TYPE, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", 
        keyPath: \eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.COMPARING_ELEMENT_TYPES, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: false)
    ...
    ENTITY a3ms_equivalence_criterion_with_specified_elements
      SUBTYPE OF ( a3m_equivalence_criterion_for_shape, a3m_equivalence_criterion_with_specified_elements );
        ...
        SELF\a3m_equivalence_criterion_with_specified_elements.compared_specified_elements : SET [1 : ?] OF
                                          a3ms_inspected_equivalence_element_select;
      WHERE
        wr1: ( ( a3ms_get_element_type( SELF.comparing_specified_elements ) = 
                 etns_external_representation_item ) OR ( a3ms_get_element_type( SELF.
                 comparing_specified_elements ) IN SELF\a3m_equivalence_criterion_for_shape.
                 comparing_element_types ) );
        wr2: ( ( a3ms_get_element_type( SELF.compared_specified_elements ) = 
                 etns_external_representation_item ) OR ( a3ms_get_element_type( SELF.
                 compared_specified_elements ) IN SELF\a3m_equivalence_criterion_for_shape.
                 compared_element_types ) );
    END_ENTITY; -- a3ms_equivalence_criterion_with_specified_elements (line:6274 file:ap242ed2_mim_lf_v1.101_TY.exp)

```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.self
      }

      //ATTRIBUTES
      /* override var _comparing_specified_elements: SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:?] 	//EXPLICIT REDEFINITION(eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS) */

      /* override var _compared_specified_elements: SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:?] 	//EXPLICIT REDEFINITION(eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS) */
      ...
      public static func WHERE_wr1(SELF: eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:?] ? */ = SELF.COMPARING_SPECIFIED_ELEMENTS
        let _TEMP2 /* nA3MS_ELEMENT_TYPE_NAME? */ = A3MS_GET_ELEMENT_TYPE( 
            SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>(
            bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?), /*SDAI.SET<
            sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:?] */_TEMP1) )
        let _TEMP3 /* SDAI.LOGICAL */ = _TEMP2 .==. SDAI.FORCE_OPTIONAL(ETNS_EXTERNAL_REPRESENTATION_ITEM)
        let _TEMP4 /* SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:?] ? */ = SELF.COMPARING_SPECIFIED_ELEMENTS
        let _TEMP5 /* nA3MS_ELEMENT_TYPE_NAME? */ = A3MS_GET_ELEMENT_TYPE( 
            SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>(
            bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?), /*SDAI.SET<
            sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:?] */_TEMP4) )
        let _TEMP6 /* eA3M_EQUIVALENCE_CRITERION_FOR_SHAPE.PRef? */ = SELF.GROUP_REF(
          eA3M_EQUIVALENCE_CRITERION_FOR_SHAPE.self)
        let _TEMP7 /* SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>[1:?] ? */ = _TEMP6?.COMPARING_ELEMENT_TYPES
        let _TEMP8 /* SDAI.LOGICAL */ = SDAI.aggregate( _TEMP7, contains: _TEMP5 )
        let _TEMP9 /* SDAI.LOGICAL */ = _TEMP3 || _TEMP8
        return _TEMP9
      }
      public static func WHERE_wr2(SELF: eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:?] ? */ = SELF.COMPARED_SPECIFIED_ELEMENTS
        let _TEMP2 /* nA3MS_ELEMENT_TYPE_NAME? */ = A3MS_GET_ELEMENT_TYPE( 
            SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>(
            bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?), /*SDAI.SET<
            sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:?] */_TEMP1) )
        let _TEMP3 /* SDAI.LOGICAL */ = _TEMP2 .==. SDAI.FORCE_OPTIONAL(ETNS_EXTERNAL_REPRESENTATION_ITEM)
        let _TEMP4 /* SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:?] ? */ = SELF.COMPARED_SPECIFIED_ELEMENTS
        let _TEMP5 /* nA3MS_ELEMENT_TYPE_NAME? */ = A3MS_GET_ELEMENT_TYPE( 
            SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>(
            bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?), /*SDAI.SET<
            sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:?] */_TEMP4) )
        let _TEMP6 /* eA3M_EQUIVALENCE_CRITERION_FOR_SHAPE.PRef? */ = SELF.GROUP_REF(
          eA3M_EQUIVALENCE_CRITERION_FOR_SHAPE.self)
        let _TEMP7 /* SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>[1:?] ? */ = _TEMP6?.COMPARED_ELEMENT_TYPES
        let _TEMP8 /* SDAI.LOGICAL */ = SDAI.aggregate( _TEMP7, contains: _TEMP5 )
        let _TEMP9 /* SDAI.LOGICAL */ = _TEMP3 || _TEMP8
        return _TEMP9
      }
