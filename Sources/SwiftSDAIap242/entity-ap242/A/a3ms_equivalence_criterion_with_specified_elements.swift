/* file: a3ms_equivalence_criterion_with_specified_elements.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _a3ms_equivalence_criterion_with_specified_elements : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.COMPARING_SPECIFIED_ELEMENTS
      let _TEMP2 = A3MS_GET_ELEMENT_TYPE(SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>(
        bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as SDAI.INTEGER?), 
        /*SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:nil] */_TEMP1))
      let _TEMP3 = _TEMP2 .==. SDAI.FORCE_OPTIONAL(ETNS_EXTERNAL_REPRESENTATION_ITEM)
      let _TEMP4 = SELF.COMPARING_SPECIFIED_ELEMENTS
      let _TEMP5 = A3MS_GET_ELEMENT_TYPE(SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>(
        bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as SDAI.INTEGER?), 
        /*SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:nil] */_TEMP4))
      let _TEMP6 = SELF.GROUP_REF(eA3M_EQUIVALENCE_CRITERION_FOR_SHAPE.self)
      let _TEMP7 = _TEMP6?.COMPARING_ELEMENT_TYPES
      let _TEMP8 = SDAI.aggregate(_TEMP7, contains: _TEMP5)
      let _TEMP9 = _TEMP3 || _TEMP8
      return _TEMP9
    }
    public static func WHERE_wr2(SELF: eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.COMPARED_SPECIFIED_ELEMENTS
      let _TEMP2 = A3MS_GET_ELEMENT_TYPE(SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>(
        bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as SDAI.INTEGER?), 
        /*SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:nil] */_TEMP1))
      let _TEMP3 = _TEMP2 .==. SDAI.FORCE_OPTIONAL(ETNS_EXTERNAL_REPRESENTATION_ITEM)
      let _TEMP4 = SELF.COMPARED_SPECIFIED_ELEMENTS
      let _TEMP5 = A3MS_GET_ELEMENT_TYPE(SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>(
        bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as SDAI.INTEGER?), 
        /*SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:nil] */_TEMP4))
      let _TEMP6 = SELF.GROUP_REF(eA3M_EQUIVALENCE_CRITERION_FOR_SHAPE.self)
      let _TEMP7 = _TEMP6?.COMPARED_ELEMENT_TYPES
      let _TEMP8 = SDAI.aggregate(_TEMP7, contains: _TEMP5)
      let _TEMP9 = _TEMP3 || _TEMP8
      return _TEMP9
    }
...
```
*/
  public final class eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _a3ms_equivalence_criterion_with_specified_elements.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _a3ms_equivalence_criterion_with_specified_elements.WHERE_wr2(SELF: instance)
      return result
    }
