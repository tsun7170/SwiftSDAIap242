/* file: a3ms_equivalence_criterion_with_specified_elements.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
*/
  public final class eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS`` )
    public var COMPARED_SPECIFIED_ELEMENTS: SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>/*[1:(nil as 
      SDAI.INTEGER?)]*/  {
      get {
        let originalValue = super_eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.partialEntity
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _comparing_specified_elements: SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:
        (nil as SDAI.INTEGER?)] 	//EXPLICIT REDEFINITION(eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS) */

      /* override var _compared_specified_elements: SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:
        (nil as SDAI.INTEGER?)] 	//EXPLICIT REDEFINITION(eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS) */
      ...
      public static func WHERE_wr1(SELF: eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP1 /* SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:(nil as SDAI.INTEGER?)] ? */ = 
          SELF.COMPARING_SPECIFIED_ELEMENTS
        let _TEMP2 /* nA3MS_ELEMENT_TYPE_NAME? */ = A3MS_GET_ELEMENT_TYPE( 
            SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as 
            SDAI.INTEGER?), /*SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:(nil as SDAI.INTEGER?)] */
            _TEMP1) )
        let _TEMP3 /* SDAI.LOGICAL */ = _TEMP2 .==. SDAI.FORCE_OPTIONAL(ETNS_EXTERNAL_REPRESENTATION_ITEM)
        let _TEMP4 /* SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:(nil as SDAI.INTEGER?)] ? */ = 
          SELF.COMPARING_SPECIFIED_ELEMENTS
        ...
        let _TEMP7 /* SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP6?.COMPARING_ELEMENT_TYPES
      ...
      public static func WHERE_wr2(SELF: eA3MS_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP1 /* SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:(nil as SDAI.INTEGER?)] ? */ = 
          SELF.COMPARED_SPECIFIED_ELEMENTS
        let _TEMP2 /* nA3MS_ELEMENT_TYPE_NAME? */ = A3MS_GET_ELEMENT_TYPE( 
            SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>(bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as 
            SDAI.INTEGER?), /*SDAI.SET<sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT>[1:(nil as SDAI.INTEGER?)] */
            _TEMP1) )
        ...
        let _TEMP6 /* eA3M_EQUIVALENCE_CRITERION_FOR_SHAPE.PRef? */ = SELF.GROUP_REF(
          eA3M_EQUIVALENCE_CRITERION_FOR_SHAPE.self)
        let _TEMP7 /* SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP6?.COMPARED_ELEMENT_TYPES
        let _TEMP8 /* SDAI.LOGICAL */ = SDAI.aggregate( _TEMP7, contains: _TEMP5 )
        let _TEMP9 /* SDAI.LOGICAL */ = _TEMP3 || _TEMP8
        return _TEMP9
      }
