/* file: applied_action_assignment.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- applied_action_assignment (line:7057 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _applied_action_assignment : SDAI.PartialEntity {
...
```
*/
  public final class eAPPLIED_ACTION_ASSIGNMENT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eAPPLIED_ACTION_ASSIGNMENT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "APPLIED_ACTION_ASSIGNMENT", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "ROLE", keyPath: \eAPPLIED_ACTION_ASSIGNMENT.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eAPPLIED_ACTION_ASSIGNMENT.ITEMS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_ACTION", keyPath: \eAPPLIED_ACTION_ASSIGNMENT.ASSIGNED_ACTION, 
