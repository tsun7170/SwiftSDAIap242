/* file: assembly_component_usage.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- assembly_component_usage (line:7477 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSPECIFIED_HIGHER_USAGE_OCCURRENCE``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eQUANTIFIED_ASSEMBLY_COMPONENT_USAGE``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eADDITIVE_MANUFACTURING_BUILD_PLATE_RELATIONSHIP``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eADDITIVE_MANUFACTURING_SUPPORT_STRUCTURE_GEOMETRY_RELATIONSHIP``
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eADDITIVE_MANUFACTURING_SETUP_WORKPIECE_RELATIONSHIP``
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eADDITIVE_MANUFACTURING_SETUP_RELATIONSHIP``
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNEXT_ASSEMBLY_USAGE_OCCURRENCE``
	8.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTI_LEVEL_REFERENCE_DESIGNATOR``
	9.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROMISSORY_USAGE_OCCURRENCE``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eASSEMBLY_COMPONENT_USAGE/PartialEntity``
*/
  public final class eASSEMBLY_COMPONENT_USAGE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eASSEMBLY_COMPONENT_USAGE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eASSEMBLY_COMPONENT_USAGE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eASSEMBLY_COMPONENT_USAGE.PartialEntity
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eASSEMBLY_COMPONENT_USAGE`` )
    public var REFERENCE_DESIGNATOR: tIDENTIFIER?  {
      get {
        let originalValue = self.partialEntity._reference_designator
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eQUANTIFIED_ASSEMBLY_COMPONENT_USAGE`` )
    public var QUANTITY: eMEASURE_WITH_UNIT.PRef?  {
      get {
        let originalValue = sub_eQUANTIFIED_ASSEMBLY_COMPONENT_USAGE?.partialEntity._quantity
        let value = eMEASURE_WITH_UNIT.PRef( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eQUANTIFIED_ASSEMBLY_COMPONENT_USAGE?.partialEntity
          else { return }
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eASSEMBLY_COMPONENT_USAGE.PartialEntity.self) else { return nil }
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eASSEMBLY_COMPONENT_USAGE``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( REFERENCE_DESIGNATOR: original._reference_designator )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]REFERENCE_DESIGNATOR for partial entity(\(Self.entityName)) constructor"); return nil }
