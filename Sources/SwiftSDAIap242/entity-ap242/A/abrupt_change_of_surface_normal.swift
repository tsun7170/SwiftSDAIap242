/* file: abrupt_change_of_surface_normal.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _abrupt_change_of_surface_normal : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eABRUPT_CHANGE_OF_SURFACE_NORMAL?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = VALIDATE_MEASURED_DATA_TYPE(
        EI: eSHAPE_DATA_QUALITY_CRITERION(/*eABRUPT_CHANGE_OF_SURFACE_NORMAL*/SELF), 
        TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOOLEAN_VALUE"))
      return _TEMP1
    }
    public static func WHERE_wr2(SELF: eABRUPT_CHANGE_OF_SURFACE_NORMAL?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eABRUPT_CHANGE_OF_SURFACE_NORMAL?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eABRUPT_CHANGE_OF_SURFACE_NORMAL?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public init(SMALL_VECTOR_TOLERANCE: tLENGTH_MEASURE, TEST_POINT_DISTANCE_TOLERANCE: tLENGTH_MEASURE) {
...
```
*/
  public final class eABRUPT_CHANGE_OF_SURFACE_NORMAL : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _abrupt_change_of_surface_normal.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _abrupt_change_of_surface_normal.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _abrupt_change_of_surface_normal.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _abrupt_change_of_surface_normal.WHERE_wr4(SELF: instance)
      return result
    }
