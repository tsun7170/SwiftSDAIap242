/* file: abrupt_change_of_surface_normal.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- abrupt_change_of_surface_normal (line:6312 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(7)	geometry_with_local_irregularity
    (no local attributes)

  ENTITY(SELF)	abrupt_change_of_surface_normal
...
- SUPERTYPES:
	...
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGEOMETRY_WITH_LOCAL_IRREGULARITY``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eABRUPT_CHANGE_OF_SURFACE_NORMAL/PartialEntity``
*/
  public final class eABRUPT_CHANGE_OF_SURFACE_NORMAL : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eABRUPT_CHANGE_OF_SURFACE_NORMAL>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eABRUPT_CHANGE_OF_SURFACE_NORMAL.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eABRUPT_CHANGE_OF_SURFACE_NORMAL.PartialEntity
    ...
    public let super_eGEOMETRY_WITH_LOCAL_IRREGULARITY: eGEOMETRY_WITH_LOCAL_IRREGULARITY 	// [7]
    public var super_eABRUPT_CHANGE_OF_SURFACE_NORMAL: eABRUPT_CHANGE_OF_SURFACE_NORMAL { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eABRUPT_CHANGE_OF_SURFACE_NORMAL`` )
    public var TEST_POINT_DISTANCE_TOLERANCE: tLENGTH_MEASURE {
      get {
        let originalValue = self.partialEntity._test_point_distance_tolerance
    ...
    public var SMALL_VECTOR_TOLERANCE: tLENGTH_MEASURE {
      get {
        let originalValue = self.partialEntity._small_vector_tolerance
        let value = SDAI.UNWRAP( tLENGTH_MEASURE( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eABRUPT_CHANGE_OF_SURFACE_NORMAL.PartialEntity.self) else { return nil }
      ...
      guard let super7 = complexEntity?.entityReference(eGEOMETRY_WITH_LOCAL_IRREGULARITY.self) else { return nil }
      self.super_eGEOMETRY_WITH_LOCAL_IRREGULARITY = super7
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eABRUPT_CHANGE_OF_SURFACE_NORMAL.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = eABRUPT_CHANGE_OF_SURFACE_NORMAL.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = eABRUPT_CHANGE_OF_SURFACE_NORMAL.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = eABRUPT_CHANGE_OF_SURFACE_NORMAL.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "ABRUPT_CHANGE_OF_SURFACE_NORMAL", 
      ...
      entityDef.add(supertype: eGEOMETRY_WITH_LOCAL_IRREGULARITY.self)
      entityDef.add(supertype: eABRUPT_CHANGE_OF_SURFACE_NORMAL.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "TEST_POINT_DISTANCE_TOLERANCE", 
        keyPath: \eABRUPT_CHANGE_OF_SURFACE_NORMAL.TEST_POINT_DISTANCE_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eABRUPT_CHANGE_OF_SURFACE_NORMAL.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eABRUPT_CHANGE_OF_SURFACE_NORMAL.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "SMALL_VECTOR_TOLERANCE", 
        keyPath: \eABRUPT_CHANGE_OF_SURFACE_NORMAL.SMALL_VECTOR_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eABRUPT_CHANGE_OF_SURFACE_NORMAL``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eABRUPT_CHANGE_OF_SURFACE_NORMAL.self
      }
      ...
      public internal(set) var _small_vector_tolerance: tLENGTH_MEASURE // PLAIN EXPLICIT ATTRIBUTE

      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _test_point_distance_tolerance: tLENGTH_MEASURE // PLAIN EXPLICIT ATTRIBUTE
      ...
      public override func hashAsValue(into hasher: inout Hasher, visited complexEntities: inout Set<SDAI.ComplexEntity>) {
        ...
        self._small_vector_tolerance.value.hashAsValue(into: &hasher, visited: &complexEntities)
        self._test_point_distance_tolerance.value.hashAsValue(into: &hasher, visited: &complexEntities)
      }

      public override func isValueEqual(to rhs: SDAI.PartialEntity, visited comppairs: inout Set<SDAI.ComplexPair>) -> Bool {
        guard let rhs = rhs as? Self else { return false }
        if !super.isValueEqual(to: rhs, visited: &comppairs) { return false }
        if let comp = self._small_vector_tolerance.value.isValueEqualOptionally(to: rhs._small_vector_tolerance.value, visited: &comppairs)	{
          if !comp { return false }
        }
        else { return false }
        if let comp = self._test_point_distance_tolerance.value.isValueEqualOptionally(to: rhs._test_point_distance_tolerance.value, visited: &comppairs)	{
          if !comp { return false }
        }
        else { return false }
        return true
      ...
      public static func WHERE_wr1(SELF: eABRUPT_CHANGE_OF_SURFACE_NORMAL.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*eABRUPT_CHANGE_OF_SURFACE_NORMAL.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOOLEAN_VALUE") )
        return _TEMP1
      }
      public static func WHERE_wr2(SELF: eABRUPT_CHANGE_OF_SURFACE_NORMAL.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
      ...
      public static func WHERE_wr3(SELF: eABRUPT_CHANGE_OF_SURFACE_NORMAL.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
      ...
      public static func WHERE_wr4(SELF: eABRUPT_CHANGE_OF_SURFACE_NORMAL.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        //
      ...
      public init(
        SMALL_VECTOR_TOLERANCE: tLENGTH_MEASURE, 
        TEST_POINT_DISTANCE_TOLERANCE: tLENGTH_MEASURE
      ) {

        self._small_vector_tolerance = SMALL_VECTOR_TOLERANCE
        self._test_point_distance_tolerance = TEST_POINT_DISTANCE_TOLERANCE
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( SMALL_VECTOR_TOLERANCE: original._small_vector_tolerance, TEST_POINT_DISTANCE_TOLERANCE: original._test_point_distance_tolerance )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]SMALL_VECTOR_TOLERANCE for partial entity(\(Self.entityName)) constructor"); return nil }

        guard case .success(let p1) = exchangeStructure.recoverRequiredParameter(as: tLENGTH_MEASURE.self, from: parameters[1])
        else { exchangeStructure.add(errorContext: "while recovering parameter [1]TEST_POINT_DISTANCE_TOLERANCE for partial entity(\(Self.entityName)) constructor"); return nil }

        self.init( SMALL_VECTOR_TOLERANCE: p0, TEST_POINT_DISTANCE_TOLERANCE: p1 )
      }
    }
  }
}
