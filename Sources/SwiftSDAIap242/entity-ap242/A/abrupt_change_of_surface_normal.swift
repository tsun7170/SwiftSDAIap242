/* file: abrupt_change_of_surface_normal.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _abrupt_change_of_surface_normal : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_abrupt_change_of_surface_normal``
*/
  public final class eABRUPT_CHANGE_OF_SURFACE_NORMAL : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _abrupt_change_of_surface_normal.self
    }
    /// partial entity reference
    public let partialEntity: _abrupt_change_of_surface_normal
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_abrupt_change_of_surface_normal.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _abrupt_change_of_surface_normal.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _abrupt_change_of_surface_normal.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _abrupt_change_of_surface_normal.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _abrupt_change_of_surface_normal.WHERE_wr4(SELF: instance.pRef)
      return result
    }
