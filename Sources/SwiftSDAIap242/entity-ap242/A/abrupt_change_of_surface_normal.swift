/* file: abrupt_change_of_surface_normal.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public final class eABRUPT_CHANGE_OF_SURFACE_NORMAL : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var TEST_POINT_DISTANCE_TOLERANCE: tLENGTH_MEASURE {
      get {
        return SDAI.UNWRAP( self.partialEntity._test_point_distance_tolerance )
      }
      set(newValue) {
    ...
    public var SMALL_VECTOR_TOLERANCE: tLENGTH_MEASURE {
      get {
        return SDAI.UNWRAP( self.partialEntity._small_vector_tolerance )
      }
      set(newValue) {
        let partial = self.partialEntity
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eABRUPT_CHANGE_OF_SURFACE_NORMAL.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eABRUPT_CHANGE_OF_SURFACE_NORMAL.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eABRUPT_CHANGE_OF_SURFACE_NORMAL.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eABRUPT_CHANGE_OF_SURFACE_NORMAL.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
