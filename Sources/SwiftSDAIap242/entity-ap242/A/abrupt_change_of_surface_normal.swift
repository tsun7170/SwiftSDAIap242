/* file: abrupt_change_of_surface_normal.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- abrupt_change_of_surface_normal (line:6305 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _abrupt_change_of_surface_normal : SDAI.PartialEntity {
...
```
*/
  public final class eABRUPT_CHANGE_OF_SURFACE_NORMAL : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eABRUPT_CHANGE_OF_SURFACE_NORMAL`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "ABRUPT_CHANGE_OF_SURFACE_NORMAL", type: self, explicitAttributeCount: 2)
      ...
      entityDef.addAttribute(name: "TEST_POINT_DISTANCE_TOLERANCE", keyPath: \eABRUPT_CHANGE_OF_SURFACE_NORMAL.TEST_POINT_DISTANCE_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eABRUPT_CHANGE_OF_SURFACE_NORMAL.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eABRUPT_CHANGE_OF_SURFACE_NORMAL.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "SMALL_VECTOR_TOLERANCE", keyPath: \eABRUPT_CHANGE_OF_SURFACE_NORMAL.SMALL_VECTOR_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
