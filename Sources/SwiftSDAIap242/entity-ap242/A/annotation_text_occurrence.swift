/* file: annotation_text_occurrence.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- annotation_text_occurrence (line:7006 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _annotation_text_occurrence : SDAI.PartialEntity {
...
```
*/
  public final class eANNOTATION_TEXT_OCCURRENCE : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eANNOTATION_TEXT_OCCURRENCE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "ANNOTATION_TEXT_OCCURRENCE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ITEM", keyPath: \eANNOTATION_TEXT_OCCURRENCE.ITEM, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "STYLES", keyPath: \eANNOTATION_TEXT_OCCURRENCE.STYLES, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eANNOTATION_TEXT_OCCURRENCE.NAME, 
