/* file: applied_classification_assignment.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- applied_classification_assignment (line:7180 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _applied_classification_assignment : SDAI.PartialEntity {
...
```
*/
  public final class eAPPLIED_CLASSIFICATION_ASSIGNMENT : SDAI.EntityReference {
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``eAPPLIED_CLASSIFICATION_ASSIGNMENT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "APPLIED_CLASSIFICATION_ASSIGNMENT", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "ROLE", keyPath: \eAPPLIED_CLASSIFICATION_ASSIGNMENT.ROLE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eAPPLIED_CLASSIFICATION_ASSIGNMENT.ITEMS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_CLASS", keyPath: \eAPPLIED_CLASSIFICATION_ASSIGNMENT.ASSIGNED_CLASS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
