/* file: application_context.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _application_context : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //internal var _context_elements: SDAI.SET<eAPPLICATION_CONTEXT_ELEMENT> 	(SEE CORRESPONDING ENTITY REFERENCE DEFINITION)
...
```
*/
  public final class eAPPLICATION_CONTEXT : SDAI.EntityReference, @unchecked Sendable {
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"CONTEXT_ELEMENTS") {
        return cached.value as! SDAI.SET<eAPPLICATION_CONTEXT_ELEMENT>/*[1:nil]*/ 
      }
      let swiftValue = SDAI.SET<eAPPLICATION_CONTEXT_ELEMENT>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \eAPPLICATION_CONTEXT_ELEMENT.FRAME_OF_REFERENCE) )
      let value = SDAI.SET<eAPPLICATION_CONTEXT_ELEMENT>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
