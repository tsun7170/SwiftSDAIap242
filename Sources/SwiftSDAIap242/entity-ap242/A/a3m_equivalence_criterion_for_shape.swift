/* file: a3m_equivalence_criterion_for_shape.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
  public final class eA3M_EQUIVALENCE_CRITERION_FOR_SHAPE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var ACCURACY_TYPES: SDAI.LIST<nA3MS_ACCURACY_TYPE_NAME>/*[0:?]*/  {
      get {
    ...
    /// __EXPLICIT REDEF(DYNAMIC)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_FOR_SHAPE`` )
    public var DETECTED_DIFFERENCE_TYPES: SDAI.LIST<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>/*[1:?]*/  {
      get {
    ...
    /// __EXPLICIT REDEF(DYNAMIC)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_FOR_SHAPE`` )
    public var COMPARED_ELEMENT_TYPES: SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>/*[1:?]*/  {
      get {
    ...
    /// __EXPLICIT REDEF(DYNAMIC)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_FOR_SHAPE`` )
    public var COMPARING_ELEMENT_TYPES: SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>/*[1:?]*/  {
      get {
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _comparing_element_types: SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>[1:?] 	//EXPLICIT REDEFINITION(eA3M_EQUIVALENCE_CRITERION) */

      /* override var _compared_element_types: SDAI.LIST<nA3MS_ELEMENT_TYPE_NAME>[1:?] 	//EXPLICIT REDEFINITION(eA3M_EQUIVALENCE_CRITERION) */

      /* override var _measured_data_type: nA3MS_MEASURED_DATA_TYPE_NAME	//EXPLICIT REDEFINITION(eA3M_EQUIVALENCE_CRITERION) */

      /* override var _detected_difference_types: SDAI.LIST<nA3MS_DETECTED_DIFFERENCE_TYPE_NAME>[1:?] 	//EXPLICIT REDEFINITION(eA3M_EQUIVALENCE_CRITERION) */

      /* override var _accuracy_types: SDAI.LIST<nA3MS_ACCURACY_TYPE_NAME>[0:?] 	//EXPLICIT REDEFINITION(eA3M_EQUIVALENCE_CRITERION) */
