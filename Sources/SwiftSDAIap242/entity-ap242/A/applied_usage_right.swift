/* file: applied_usage_right.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- applied_usage_right (line:7348 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _applied_usage_right : SDAI.PartialEntity {
...
```
*/
  public final class eAPPLIED_USAGE_RIGHT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eAPPLIED_USAGE_RIGHT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "APPLIED_USAGE_RIGHT", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "ROLE", keyPath: \eAPPLIED_USAGE_RIGHT.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eAPPLIED_USAGE_RIGHT.ITEMS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_ACTION", keyPath: \eAPPLIED_USAGE_RIGHT.ASSIGNED_ACTION, 
