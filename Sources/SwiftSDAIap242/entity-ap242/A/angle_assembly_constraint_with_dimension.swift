/* file: angle_assembly_constraint_with_dimension.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- angle_assembly_constraint_with_dimension (line:6821 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(11)	angle_geometric_constraint
  ...
  SUPER- ENTITY(12)	agc_with_dimension
    ATTR:  angle_value,	TYPE: plane_angle_measure -- EXPLICIT


  ENTITY(SELF)	angle_assembly_constraint_with_dimension
    (no local attributes)
...
- SUPERTYPES:
	...
	11.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANGLE_GEOMETRIC_CONSTRAINT``
	12.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAGC_WITH_DIMENSION``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION/PartialEntity``
*/
  public final class eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.PartialEntity
    ...
    public let super_eANGLE_GEOMETRIC_CONSTRAINT: eANGLE_GEOMETRIC_CONSTRAINT 	// [11]
    public let super_eAGC_WITH_DIMENSION: eAGC_WITH_DIMENSION 	// [12]
    public var super_eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION: eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION { return self } 	// [13]
    ...
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANGLE_GEOMETRIC_CONSTRAINT`` )
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAGC_WITH_DIMENSION`` )
    public var ANGLE_VALUE: tPLANE_ANGLE_MEASURE {
      get {
        let originalValue = super_eAGC_WITH_DIMENSION.partialEntity._angle_value
        let value = SDAI.UNWRAP( tPLANE_ANGLE_MEASURE( originalValue ) )
        return value
      }
      set(newValue) {
        let partial = super_eAGC_WITH_DIMENSION.partialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.PartialEntity.self) else { return nil }
      ...
      guard let super11 = complexEntity?.entityReference(eANGLE_GEOMETRIC_CONSTRAINT.self) else { return nil }
      self.super_eANGLE_GEOMETRIC_CONSTRAINT = super11

      guard let super12 = complexEntity?.entityReference(eAGC_WITH_DIMENSION.self) else { return nil }
      self.super_eAGC_WITH_DIMENSION = super12
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "TRANSFORMATION_OPERATOR", 
        keyPath: \eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.TRANSFORMATION_OPERATOR, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", 
        keyPath: \eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", 
        keyPath: \eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.REFERENCE_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ANGLE_VALUE", 
        keyPath: \eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.ANGLE_VALUE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "REP_1", 
        keyPath: \eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.REP_1, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_2", 
        keyPath: \eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.REP_2, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DIM", 
        keyPath: \eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.DIM, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.self
      }
