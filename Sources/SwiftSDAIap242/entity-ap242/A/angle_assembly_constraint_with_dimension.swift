/* file: angle_assembly_constraint_with_dimension.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _angle_assembly_constraint_with_dimension : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_angle_assembly_constraint_with_dimension``
*/
  public final class eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _angle_assembly_constraint_with_dimension.self
    }
    /// partial entity reference
    public let partialEntity: _angle_assembly_constraint_with_dimension
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_angle_assembly_constraint_with_dimension.self) else { return nil }
