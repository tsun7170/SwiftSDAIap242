/* file: angle_assembly_constraint_with_dimension.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- angle_assembly_constraint_with_dimension (line:6814 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _angle_assembly_constraint_with_dimension : SDAI.PartialEntity {
...
```
*/
  public final class eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION : SDAI.EntityReference {
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUPER( ``eAGC_WITH_DIMENSION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "ANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "TRANSFORMATION_OPERATOR", keyPath: \eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.TRANSFORMATION_OPERATOR, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", keyPath: \eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", keyPath: \eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.REFERENCE_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ANGLE_VALUE", keyPath: \eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.ANGLE_VALUE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "REP_1", keyPath: \eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.REP_1, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_2", keyPath: \eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.REP_2, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DIM", keyPath: \eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.DIM, 
