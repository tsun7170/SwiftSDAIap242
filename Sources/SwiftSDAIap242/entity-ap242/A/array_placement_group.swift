/* file: array_placement_group.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- array_placement_group (line:7426 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _array_placement_group : SDAI.PartialEntity {
...
```
*/
  public final class eARRAY_PLACEMENT_GROUP : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "ARRAY_PLACEMENT_GROUP", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "RELATING_PRODUCT_DEFINITION", keyPath: \eARRAY_PLACEMENT_GROUP.RELATING_PRODUCT_DEFINITION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "FRAME_OF_REFERENCE", keyPath: \eARRAY_PLACEMENT_GROUP.FRAME_OF_REFERENCE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DEFINITION", keyPath: \eARRAY_PLACEMENT_GROUP.DEFINITION, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "RELATED_PRODUCT_DEFINITION", keyPath: \eARRAY_PLACEMENT_GROUP.RELATED_PRODUCT_DEFINITION, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "FORMATION", keyPath: \eARRAY_PLACEMENT_GROUP.FORMATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
