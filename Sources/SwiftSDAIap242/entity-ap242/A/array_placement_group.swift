/* file: array_placement_group.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- array_placement_group (line:7419 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	array_placement_group
    (no local attributes)

  SUB- ENTITY(9)	linear_array_placement_group_component
    (no local attributes)

  SUB- ENTITY(10)	rectangular_array_placement_group_component
    (no local attributes)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eARRAY_PLACEMENT_GROUP/PartialEntity``
*/
  public final class eARRAY_PLACEMENT_GROUP : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eARRAY_PLACEMENT_GROUP>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eARRAY_PLACEMENT_GROUP.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eARRAY_PLACEMENT_GROUP.PartialEntity
    ...
    public var super_eARRAY_PLACEMENT_GROUP: eARRAY_PLACEMENT_GROUP { return self } 	// [8]

    //MARK: SUBTYPES
    public var sub_eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT: eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT? {	// [9]
      return self.complexEntity.entityReference(eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT.self)
    }

    public var sub_eRECTANGULAR_ARRAY_PLACEMENT_GROUP_COMPONENT: eRECTANGULAR_ARRAY_PLACEMENT_GROUP_COMPONENT? {	// [10]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eARRAY_PLACEMENT_GROUP.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "RELATING_PRODUCT_DEFINITION", 
        keyPath: \eARRAY_PLACEMENT_GROUP.RELATING_PRODUCT_DEFINITION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "FRAME_OF_REFERENCE", 
        keyPath: \eARRAY_PLACEMENT_GROUP.FRAME_OF_REFERENCE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DEFINITION", 
        keyPath: \eARRAY_PLACEMENT_GROUP.DEFINITION, 
      ...
      entityDef.addAttribute(name: "RELATED_PRODUCT_DEFINITION", 
        keyPath: \eARRAY_PLACEMENT_GROUP.RELATED_PRODUCT_DEFINITION, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "FORMATION", 
        keyPath: \eARRAY_PLACEMENT_GROUP.FORMATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
