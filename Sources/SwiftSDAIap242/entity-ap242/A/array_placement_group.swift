/* file: array_placement_group.swift 	 generated: Thu Dec 25 18:13:23 2025 */
...
*/
  ...
  public final class _array_placement_group : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_array_placement_group``
*/
  public final class eARRAY_PLACEMENT_GROUP : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _array_placement_group.self
    }
    /// partial entity reference
    public let partialEntity: _array_placement_group
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_array_placement_group.self) else { return nil }
