/* file: assembly_shape_constraint.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- assembly_shape_constraint (line:7524 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _assembly_shape_constraint : SDAI.PartialEntity {
...
```
*/
  public final class eASSEMBLY_SHAPE_CONSTRAINT : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "ASSEMBLY_SHAPE_CONSTRAINT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "PRODUCT_DEFINITIONAL", keyPath: \eASSEMBLY_SHAPE_CONSTRAINT.PRODUCT_DEFINITIONAL, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eASSEMBLY_SHAPE_CONSTRAINT.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OF_SHAPE", keyPath: \eASSEMBLY_SHAPE_CONSTRAINT.OF_SHAPE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \eASSEMBLY_SHAPE_CONSTRAINT.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eASSEMBLY_SHAPE_CONSTRAINT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
