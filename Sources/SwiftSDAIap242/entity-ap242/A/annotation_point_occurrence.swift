/* file: annotation_point_occurrence.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _annotation_point_occurrence : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _item: ePOINT	//EXPLICIT REDEFINITION(eSTYLED_ITEM) */
...
```
*/
  public final class eANNOTATION_POINT_OCCURRENCE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var ITEM: ePOINT {
      get {
        return SDAI.UNWRAP( ePOINT( super_eSTYLED_ITEM.partialEntity._item ) )
      }
      set(newValue) {
