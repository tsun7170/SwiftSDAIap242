/* file: assigned_requirement.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- assigned_requirement (line:7534 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _assigned_requirement : SDAI.PartialEntity {
...
```
*/
  public final class eASSIGNED_REQUIREMENT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eASSIGNED_REQUIREMENT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "ASSIGNED_REQUIREMENT", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "ROLE", keyPath: \eASSIGNED_REQUIREMENT.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \eASSIGNED_REQUIREMENT.ITEMS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_GROUP", keyPath: \eASSIGNED_REQUIREMENT.ASSIGNED_GROUP, 
