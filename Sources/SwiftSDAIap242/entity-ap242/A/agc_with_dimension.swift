/* file: agc_with_dimension.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- agc_with_dimension (line:6745 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUPERTYPES:
	...
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANGLE_GEOMETRIC_CONSTRAINT``

- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANGLE_ASSEMBLY_CONSTRAINT_WITH_DIMENSION``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAGC_WITH_DIMENSION/PartialEntity``
*/
  public final class eAGC_WITH_DIMENSION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eAGC_WITH_DIMENSION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eAGC_WITH_DIMENSION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eAGC_WITH_DIMENSION.PartialEntity
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAGC_WITH_DIMENSION`` )
    public var ANGLE_VALUE: tPLANE_ANGLE_MEASURE {
      get {
        let originalValue = self.partialEntity._angle_value
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eAGC_WITH_DIMENSION.PartialEntity.self) else { return nil }
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAGC_WITH_DIMENSION``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( ANGLE_VALUE: original._angle_value )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]ANGLE_VALUE for partial entity(\(Self.entityName)) constructor"); return nil }
