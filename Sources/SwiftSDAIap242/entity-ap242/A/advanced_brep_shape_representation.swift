/* file: advanced_brep_shape_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _advanced_brep_shape_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eADVANCED_BREP_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eADVANCED_BREP_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: eADVANCED_BREP_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ MSB in 
          ...
          let _TEMP2 = _TEMP1?.QUERY{ CSH in 
              ...
              let _TEMP3 = _TEMP2?.QUERY{ FCS in 
                  ...
                  let _TEMP1 = SDAI.TYPEOF(FCS, IS: eADVANCED_FACE.self)
                  let _TEMP2 =  !_TEMP1
                  return _TEMP2 }
              let _TEMP4 = SDAI.SIZEOF(_TEMP3)
    ...
    public static func WHERE_wr4(SELF: eADVANCED_BREP_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr5(SELF: eADVANCED_BREP_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr6(SELF: eADVANCED_BREP_SHAPE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class eADVANCED_BREP_SHAPE_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _advanced_brep_shape_representation.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _advanced_brep_shape_representation.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _advanced_brep_shape_representation.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _advanced_brep_shape_representation.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _advanced_brep_shape_representation.WHERE_wr5(SELF: instance)
      result[prefix2 + " .WHERE_wr6"] = _advanced_brep_shape_representation.WHERE_wr6(SELF: instance)
      return result
    }
