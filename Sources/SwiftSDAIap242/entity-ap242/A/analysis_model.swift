/* file: analysis_model.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _analysis_model : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _context_of_items: eANALYSIS_REPRESENTATION_CONTEXT	//EXPLICIT REDEFINITION(eREPRESENTATION) */
...
```
*/
  public final class eANALYSIS_MODEL : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var CONTEXT_OF_ITEMS: eANALYSIS_REPRESENTATION_CONTEXT {
      get {
        if let resolved = _representation._context_of_items__provider(complex: self.complexEntity) {
          let value = SDAI.UNWRAP( eANALYSIS_REPRESENTATION_CONTEXT(resolved._context_of_items__getter(
            complex: self.complexEntity)) )
          return value
        }
        else {
          return SDAI.UNWRAP( eANALYSIS_REPRESENTATION_CONTEXT(super_eREPRESENTATION.partialEntity
            ._context_of_items) )
        }
      }
      set(newValue) {
