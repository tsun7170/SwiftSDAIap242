/* file: analysis_model.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _analysis_model : SDAI.PartialEntity, SDAI.InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_analysis_model``
*/
  public final class eANALYSIS_MODEL : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _analysis_model.self
    }
    /// partial entity reference
    public let partialEntity: _analysis_model
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_analysis_model.self) else { return nil }
