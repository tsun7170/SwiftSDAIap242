/* file: analysis_model.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- analysis_model (line:6808 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANALYSIS_MODEL/PartialEntity``
*/
  public final class eANALYSIS_MODEL : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eANALYSIS_MODEL>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eANALYSIS_MODEL.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eANALYSIS_MODEL.PartialEntity

    //MARK: SUPERTYPES
    public let super_eREPRESENTATION: eREPRESENTATION 	// [1]
    public var super_eANALYSIS_MODEL: eANALYSIS_MODEL { return self } 	// [2]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANALYSIS_MODEL`` )
    public var CONTEXT_OF_ITEMS: eANALYSIS_REPRESENTATION_CONTEXT.PRef {
      get {
        if let resolved = eREPRESENTATION.PartialEntity._context_of_items__provider(complex: self.complexEntity) {
          ...
          let value = SDAI.UNWRAP( eANALYSIS_REPRESENTATION_CONTEXT.PRef( originalValue ) )
          return value
        }
        else {
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eANALYSIS_MODEL.PartialEntity.self) else { return nil }
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANALYSIS_MODEL``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eANALYSIS_MODEL.self
      }

      //ATTRIBUTES
      /* override var _context_of_items: eANALYSIS_REPRESENTATION_CONTEXT.PRef	//EXPLICIT REDEFINITION(eREPRESENTATION) */
