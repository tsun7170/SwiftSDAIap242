/* file: analysis_model.swift 	 generated: Wed Jan 21 18:03:37 2026 */
    ...
    public var CONTEXT_OF_ITEMS: eANALYSIS_REPRESENTATION_CONTEXT.PRef {
      get {
        if let resolved = eREPRESENTATION.PartialEntity._context_of_items__provider(complex: self.complexEntity) {
          let value = SDAI.UNWRAP( eANALYSIS_REPRESENTATION_CONTEXT.PRef(resolved._context_of_items__getter(
            complex: self.complexEntity)) )
          return value
        }
        else {
          return SDAI.UNWRAP( eANALYSIS_REPRESENTATION_CONTEXT.PRef(super_eREPRESENTATION.partialEntity
            ._context_of_items) )
        }
      }
      set(newValue) {
