/* file: a3m_equivalence_criterion_for_assembly.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- a3m_equivalence_criterion_for_assembly (line:6056 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _a3m_equivalence_criterion_for_assembly : SDAI.PartialEntity {
...
```
*/
  public final class eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "A3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ACCURACY_TYPES", keyPath: \eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.ACCURACY_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", keyPath: \eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.DETECTED_DIFFERENCE_TYPES, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "SHAPE_CRITERIA", keyPath: \eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.SHAPE_CRITERIA, 
        kind: .inverse, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSESSMENT_THRESHOLD_2", keyPath: \eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.ASSESSMENT_THRESHOLD_2, 
        kind: .inverse, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", keyPath: \eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.COMPARED_ELEMENT_TYPES, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", keyPath: \eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.MEASURED_DATA_TYPE, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", keyPath: \eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.COMPARING_ELEMENT_TYPES, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
