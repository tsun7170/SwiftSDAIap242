/* file: a3m_equivalence_criterion_for_assembly.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- a3m_equivalence_criterion_for_assembly (line:6063 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	a3m_equivalence_criterion_for_assembly
  ...
  SUB- ENTITY(6)	different_length_of_assembly_constraint
  ...
  SUB- ENTITY(7)	different_angle_of_assembly_constraint
    REDCR: assessment_specification,	TYPE: a3m_equivalence_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: a3m_equivalence_criterion
  ...
  SUB- ENTITY(8)	different_assembly_constraint_type
  ...
  SUB- ENTITY(9)	different_component_type
    REDCR: assessment_specification,	TYPE: a3m_equivalence_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: a3m_equivalence_criterion
  ...
  SUB- ENTITY(10)	different_placement_of_component
    REDCR: assessment_specification,	TYPE: a3m_equivalence_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: a3m_equivalence_criterion
  ...
  SUB- ENTITY(11)	a3m_equivalence_criterion_of_detailed_assembly_data_content
  ...
  SUB- ENTITY(12)	different_assembly_centroid_using_notional_solid
    REDCR: assessment_specification,	TYPE: a3m_equivalence_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: a3m_equivalence_criterion
  ...
  SUB- ENTITY(13)	different_assembly_centroid
    REDCR: assessment_specification,	TYPE: a3m_equivalence_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: a3m_equivalence_criterion
  ...
  SUB- ENTITY(14)	different_assembly_volume
    REDCR: assessment_specification,	TYPE: a3m_equivalence_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: a3m_equivalence_criterion
  ...
  SUB- ENTITY(15)	different_number_of_components
    REDCR: assessment_specification,	TYPE: a3m_equivalence_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: a3m_equivalence_criterion
  ...
  SUB- ENTITY(16)	a3m_equivalence_criterion_of_representative_assembly_property_value
    REDCR: comparing_element_types,	TYPE: LIST [1 : 1] OF a3ma_element_type_name -- DERIVED (DYNAMIC)
      := [etna_product_definition_or_reference]
      -- OVERRIDING ENTITY: a3m_equivalence_criterion
  ...
  SUB- ENTITY(17)	different_component_shape
    REDCR: comparing_element_types,	TYPE: LIST [1 : 1] OF a3ma_element_type_name -- DERIVED (DYNAMIC)
  ...
  SUB- ENTITY(18)	a3m_equivalence_criterion_of_component_property_difference
    REDCR: assessment_specification,	TYPE: a3m_equivalence_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: a3m_equivalence_criterion
  ...
  SUB- ENTITY(19)	mismatch_of_component
    REDCR: assessment_specification,	TYPE: a3m_equivalence_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: a3m_equivalence_criterion
  ...
  SUB- ENTITY(20)	missing_assembly_constraint
    REDCR: assessment_specification,	TYPE: a3m_equivalence_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: a3m_equivalence_criterion
  ...
  SUB- ENTITY(21)	missing_component
    REDCR: assessment_specification,	TYPE: a3m_equivalence_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: a3m_equivalence_criterion
  ...
  SUB- ENTITY(22)	different_component_identification_via_multi_level_reference
    REDCR: assessment_specification,	TYPE: a3m_equivalence_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: a3m_equivalence_criterion
  ...
  SUB- ENTITY(23)	a3m_equivalence_criterion_of_assembly_data_structure
    REDCR: comparing_element_types,	TYPE: LIST [1 : 1] OF a3ma_element_type_name -- DERIVED (DYNAMIC)
      := [etna_product_definition_or_reference]
      -- OVERRIDING ENTITY: a3m_equivalence_criterion
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_ANGLE_OF_ASSEMBLY_CONSTRAINT``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_ASSEMBLY_CONSTRAINT_TYPE``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_COMPONENT_TYPE``
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_PLACEMENT_OF_COMPONENT``
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT``
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_ASSEMBLY_CENTROID_USING_NOTIONAL_SOLID``
	8.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_ASSEMBLY_CENTROID``
	9.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_ASSEMBLY_VOLUME``
	10.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_NUMBER_OF_COMPONENTS``
	11.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_REPRESENTATIVE_ASSEMBLY_PROPERTY_VALUE``
	12.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_COMPONENT_SHAPE``
	13.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE``
	14.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISMATCH_OF_COMPONENT``
	15.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISSING_ASSEMBLY_CONSTRAINT``
	16.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISSING_COMPONENT``
	17.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_COMPONENT_IDENTIFICATION_VIA_MULTI_LEVEL_REFERENCE``
	18.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY/PartialEntity``
*/
  public final class eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.PartialEntity
    ...
    public var super_eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY: eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY { return self } 	// [5]

    //MARK: SUBTYPES
    public var sub_eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT: eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT? {	// [6]
      return self.complexEntity.entityReference(eDIFFERENT_LENGTH_OF_ASSEMBLY_CONSTRAINT.self)
    }

    public var sub_eDIFFERENT_ANGLE_OF_ASSEMBLY_CONSTRAINT: eDIFFERENT_ANGLE_OF_ASSEMBLY_CONSTRAINT? {	// [7]
      return self.complexEntity.entityReference(eDIFFERENT_ANGLE_OF_ASSEMBLY_CONSTRAINT.self)
    }

    public var sub_eDIFFERENT_ASSEMBLY_CONSTRAINT_TYPE: eDIFFERENT_ASSEMBLY_CONSTRAINT_TYPE? {	// [8]
      return self.complexEntity.entityReference(eDIFFERENT_ASSEMBLY_CONSTRAINT_TYPE.self)
    }

    public var sub_eDIFFERENT_COMPONENT_TYPE: eDIFFERENT_COMPONENT_TYPE? {	// [9]
      return self.complexEntity.entityReference(eDIFFERENT_COMPONENT_TYPE.self)
    }

    public var sub_eDIFFERENT_PLACEMENT_OF_COMPONENT: eDIFFERENT_PLACEMENT_OF_COMPONENT? {	// [10]
      return self.complexEntity.entityReference(eDIFFERENT_PLACEMENT_OF_COMPONENT.self)
    }

    public var sub_eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT: eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT? {	// [11]
      return self.complexEntity.entityReference(eA3M_EQUIVALENCE_CRITERION_OF_DETAILED_ASSEMBLY_DATA_CONTENT.self)
    }

    public var sub_eDIFFERENT_ASSEMBLY_CENTROID_USING_NOTIONAL_SOLID: eDIFFERENT_ASSEMBLY_CENTROID_USING_NOTIONAL_SOLID? {	// [12]
      return self.complexEntity.entityReference(eDIFFERENT_ASSEMBLY_CENTROID_USING_NOTIONAL_SOLID.self)
    }

    public var sub_eDIFFERENT_ASSEMBLY_CENTROID: eDIFFERENT_ASSEMBLY_CENTROID? {	// [13]
      return self.complexEntity.entityReference(eDIFFERENT_ASSEMBLY_CENTROID.self)
    }

    public var sub_eDIFFERENT_ASSEMBLY_VOLUME: eDIFFERENT_ASSEMBLY_VOLUME? {	// [14]
      return self.complexEntity.entityReference(eDIFFERENT_ASSEMBLY_VOLUME.self)
    }

    public var sub_eDIFFERENT_NUMBER_OF_COMPONENTS: eDIFFERENT_NUMBER_OF_COMPONENTS? {	// [15]
      return self.complexEntity.entityReference(eDIFFERENT_NUMBER_OF_COMPONENTS.self)
    }

    public var sub_eA3M_EQUIVALENCE_CRITERION_OF_REPRESENTATIVE_ASSEMBLY_PROPERTY_VALUE: eA3M_EQUIVALENCE_CRITERION_OF_REPRESENTATIVE_ASSEMBLY_PROPERTY_VALUE? {	// [16]
      return self.complexEntity.entityReference(eA3M_EQUIVALENCE_CRITERION_OF_REPRESENTATIVE_ASSEMBLY_PROPERTY_VALUE.self)
    }

    public var sub_eDIFFERENT_COMPONENT_SHAPE: eDIFFERENT_COMPONENT_SHAPE? {	// [17]
      return self.complexEntity.entityReference(eDIFFERENT_COMPONENT_SHAPE.self)
    }

    public var sub_eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE: eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE? {	// [18]
      return self.complexEntity.entityReference(eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE.self)
    }

    public var sub_eMISMATCH_OF_COMPONENT: eMISMATCH_OF_COMPONENT? {	// [19]
      return self.complexEntity.entityReference(eMISMATCH_OF_COMPONENT.self)
    }

    public var sub_eMISSING_ASSEMBLY_CONSTRAINT: eMISSING_ASSEMBLY_CONSTRAINT? {	// [20]
      return self.complexEntity.entityReference(eMISSING_ASSEMBLY_CONSTRAINT.self)
    }

    public var sub_eMISSING_COMPONENT: eMISSING_COMPONENT? {	// [21]
      return self.complexEntity.entityReference(eMISSING_COMPONENT.self)
    }

    public var sub_eDIFFERENT_COMPONENT_IDENTIFICATION_VIA_MULTI_LEVEL_REFERENCE: eDIFFERENT_COMPONENT_IDENTIFICATION_VIA_MULTI_LEVEL_REFERENCE? {	// [22]
      return self.complexEntity.entityReference(eDIFFERENT_COMPONENT_IDENTIFICATION_VIA_MULTI_LEVEL_REFERENCE.self)
    }

    public var sub_eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE: eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE? {	// [23]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY`` )
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY`` )
    public var DETECTED_DIFFERENCE_TYPES: SDAI.LIST<nA3MA_DETECTED_DIFFERENCE_TYPE_NAME>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        if let resolved = eA3M_EQUIVALENCE_CRITERION.PartialEntity._detected_difference_types__provider(complex: self.complexEntity) {
          ...
          let value =           SDAI.LIST<nA3MA_DETECTED_DIFFERENCE_TYPE_NAME>(
    ...
    /// __EXPLICIT REDEF(DYNAMIC)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY`` )
    public var COMPARED_ELEMENT_TYPES: SDAI.LIST<nA3MA_ELEMENT_TYPE_NAME>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        if let resolved = eA3M_EQUIVALENCE_CRITERION.PartialEntity._compared_element_types__provider(complex: self.complexEntity) {
          ...
          let SELF = super_eA3M_EQUIVALENCE_CRITERION; SDAI.TOUCH(let:SELF)
          let value =           SDAI.LIST<nA3MA_ELEMENT_TYPE_NAME>(
            bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?),
            originalValue)
          return SDAI.UNWRAP(value)
        }
    ...
    public var MEASURED_DATA_TYPE: nA3MA_MEASURED_DATA_TYPE_NAME {
      get {
        if let resolved = eA3M_EQUIVALENCE_CRITERION.PartialEntity._measured_data_type__provider(complex: self.complexEntity) {
          ...
          let value = SDAI.UNWRAP( nA3MA_MEASURED_DATA_TYPE_NAME( originalValue ) )
          return value
        }
        else {
    ...
    /// __EXPLICIT REDEF(DYNAMIC)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY`` )
    public var COMPARING_ELEMENT_TYPES: SDAI.LIST<nA3MA_ELEMENT_TYPE_NAME>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "A3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY", 
      ...
      entityDef.addAttribute(name: "ACCURACY_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.ACCURACY_TYPES, 
      ...
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.DETECTED_DIFFERENCE_TYPES, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "SHAPE_CRITERIA", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.SHAPE_CRITERIA, 
        kind: .inverse, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSESSMENT_THRESHOLD_2", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.ASSESSMENT_THRESHOLD_2, 
        kind: .inverse, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.COMPARED_ELEMENT_TYPES, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.MEASURED_DATA_TYPE, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.COMPARING_ELEMENT_TYPES, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.self
      }

      //ATTRIBUTES
      /* override var _comparing_element_types: SDAI.LIST<nA3MA_ELEMENT_TYPE_NAME>[1:(nil as SDAI.INTEGER?)] 	//EXPLICIT REDEFINITION(eA3M_EQUIVALENCE_CRITERION) */

      /* override var _compared_element_types: SDAI.LIST<nA3MA_ELEMENT_TYPE_NAME>[1:(nil as SDAI.INTEGER?)] 	//EXPLICIT REDEFINITION(eA3M_EQUIVALENCE_CRITERION) */

      /* override var _measured_data_type: nA3MA_MEASURED_DATA_TYPE_NAME	//EXPLICIT REDEFINITION(eA3M_EQUIVALENCE_CRITERION) */

      /* override var _detected_difference_types: SDAI.LIST<nA3MA_DETECTED_DIFFERENCE_TYPE_NAME>[1:(nil as 
      ...
      internal func _accuracy_types__getter(complex: SDAI.ComplexEntity) -> SDAI.LIST<nA3M_ACCURACY_TYPE_NAME>
        /*[0:(nil as SDAI.INTEGER?)]*/  {
        let SELF = complex.entityReference( eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.self )!
        return SDAI.UNWRAP( SDAI.LIST<nA3M_ACCURACY_TYPE_NAME>(SELF.ACCURACY_TYPES) )
      }
      /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _accuracy_types__getter(SELF: eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.PRef) -> SDAI.LIST<
        nA3MA_ACCURACY_TYPE_NAME>/*[0:0]*/  {

        let _TEMP1 /* SDAI.AGGREGATE<runtime> */ = SDAI.LIST<nA3MA_ACCURACY_TYPE_NAME>(
          bound1: SDAI.UNWRAP(SDAI.INTEGER(0)), bound2: SDAI.INTEGER(0), SDAI.EMPTY_AGGREGATE)
        let value = _TEMP1
        return SDAI.UNWRAP( value )
      }
      ...
      public static func WHERE_wr1(SELF: eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = A3MA_VALIDATE_ACCURACY_TYPES( 
            EI: sACCURACY_ASSOCIATED_TARGET_SELECT(/*eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.PRef*/SELF), 
            CR: SELF )
        return _TEMP1
      }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
  .eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY.PartialEntity :
