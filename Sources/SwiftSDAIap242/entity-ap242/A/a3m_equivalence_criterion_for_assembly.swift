/* file: a3m_equivalence_criterion_for_assembly.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _a3m_equivalence_criterion_for_assembly : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _accuracy_types__getter(SELF: eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY) -> SDAI.LIST<
      nA3MA_ACCURACY_TYPE_NAME>/*[0:0]*/  {

      let _TEMP1 = SDAI.LIST<nA3MA_ACCURACY_TYPE_NAME>(bound1: SDAI.UNWRAP(SDAI.INTEGER(0)), bound2: SDAI.INTEGER(
        0), SDAI.EMPTY_AGGREGATE)
      let value = _TEMP1
    ...
    public static func WHERE_wr1(SELF: eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = A3MA_VALIDATE_ACCURACY_TYPES(
        EI: sACCURACY_ASSOCIATED_TARGET_SELECT(/*eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY*/SELF), 
        CR: SELF)
      return _TEMP1
    }
...
```
*/
  public final class eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _a3m_equivalence_criterion_for_assembly.WHERE_wr1(SELF: instance)
      return result
    }
