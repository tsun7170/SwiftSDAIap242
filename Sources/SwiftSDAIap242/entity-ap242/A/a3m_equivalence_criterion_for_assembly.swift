/* file: a3m_equivalence_criterion_for_assembly.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _a3m_equivalence_criterion_for_assembly : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_a3m_equivalence_criterion_for_assembly``
*/
  public final class eA3M_EQUIVALENCE_CRITERION_FOR_ASSEMBLY : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _a3m_equivalence_criterion_for_assembly.self
    }
    /// partial entity reference
    public let partialEntity: _a3m_equivalence_criterion_for_assembly
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_a3m_equivalence_criterion_for_assembly.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _a3m_equivalence_criterion_for_assembly.WHERE_wr1(SELF: instance.pRef)
      return result
    }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF._a3m_equivalence_criterion_for_assembly :
