/* file: assembly_group_component.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- assembly_group_component (line:7502 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	assembly_group_component
    (no local attributes)

  SUB- ENTITY(8)	linear_array_placement_group_component
    (no local attributes)

  SUB- ENTITY(9)	rectangular_array_placement_group_component
    (no local attributes)

  SUB- ENTITY(10)	array_placement_group
    (no local attributes)

  SUB- ENTITY(11)	interfaced_group_component
    (no local attributes)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRECTANGULAR_ARRAY_PLACEMENT_GROUP_COMPONENT``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eARRAY_PLACEMENT_GROUP``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACED_GROUP_COMPONENT``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eASSEMBLY_GROUP_COMPONENT/PartialEntity``
*/
  public final class eASSEMBLY_GROUP_COMPONENT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eASSEMBLY_GROUP_COMPONENT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eASSEMBLY_GROUP_COMPONENT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eASSEMBLY_GROUP_COMPONENT.PartialEntity
    ...
    public var super_eASSEMBLY_GROUP_COMPONENT: eASSEMBLY_GROUP_COMPONENT { return self } 	// [7]

    //MARK: SUBTYPES
    public var sub_eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT: eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT? {	// [8]
      return self.complexEntity.entityReference(eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT.self)
    }

    public var sub_eRECTANGULAR_ARRAY_PLACEMENT_GROUP_COMPONENT: eRECTANGULAR_ARRAY_PLACEMENT_GROUP_COMPONENT? {	// [9]
      return self.complexEntity.entityReference(eRECTANGULAR_ARRAY_PLACEMENT_GROUP_COMPONENT.self)
    }

    public var sub_eARRAY_PLACEMENT_GROUP: eARRAY_PLACEMENT_GROUP? {	// [10]
      return self.complexEntity.entityReference(eARRAY_PLACEMENT_GROUP.self)
    }

    public var sub_eINTERFACED_GROUP_COMPONENT: eINTERFACED_GROUP_COMPONENT? {	// [11]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eASSEMBLY_GROUP_COMPONENT.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "RELATING_PRODUCT_DEFINITION", 
        keyPath: \eASSEMBLY_GROUP_COMPONENT.RELATING_PRODUCT_DEFINITION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "FRAME_OF_REFERENCE", 
        keyPath: \eASSEMBLY_GROUP_COMPONENT.FRAME_OF_REFERENCE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DEFINITION", 
        keyPath: \eASSEMBLY_GROUP_COMPONENT.DEFINITION, 
      ...
      entityDef.addAttribute(name: "RELATED_PRODUCT_DEFINITION", 
        keyPath: \eASSEMBLY_GROUP_COMPONENT.RELATED_PRODUCT_DEFINITION, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "FORMATION", 
        keyPath: \eASSEMBLY_GROUP_COMPONENT.FORMATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
