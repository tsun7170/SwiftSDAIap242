/* file: assembly_shape_joint_item_relationship.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- assembly_shape_joint_item_relationship (line:7523 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _assembly_shape_joint_item_relationship : SDAI.PartialEntity {
...
```
*/
  public final class eASSEMBLY_SHAPE_JOINT_ITEM_RELATIONSHIP : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eASSEMBLY_SHAPE_JOINT_ITEM_RELATIONSHIP`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "ASSEMBLY_SHAPE_JOINT_ITEM_RELATIONSHIP", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eASSEMBLY_SHAPE_JOINT_ITEM_RELATIONSHIP.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ID", keyPath: \eASSEMBLY_SHAPE_JOINT_ITEM_RELATIONSHIP.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATED_SHAPE_ASPECT", keyPath: \eASSEMBLY_SHAPE_JOINT_ITEM_RELATIONSHIP.RELATED_SHAPE_ASPECT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eASSEMBLY_SHAPE_JOINT_ITEM_RELATIONSHIP.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATING_SHAPE_ASPECT", keyPath: \eASSEMBLY_SHAPE_JOINT_ITEM_RELATIONSHIP.RELATING_SHAPE_ASPECT, 
