/* file: a3ms_equivalence_inspection_result.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY a3ms_equivalence_inspection_result
    ...
    WHERE
      ...
      wr4: ( SIZEOF( QUERY ( re <* bag_to_set( USEDIN( SELF, 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               ...
               = 0 );
  END_ENTITY; -- a3ms_equivalence_inspection_result (line:6294 file:ap242ed2_mim_lf_v1.101.TY.exp)
