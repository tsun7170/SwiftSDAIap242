/* file: action.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
```
*/
  public final class eACTION : SDAI.EntityReference, @unchecked Sendable {
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"PROPERTIES") {
        return cached.value as! (SDAI.SET<ePROCESS_PROPERTY_ASSOCIATION>/*[1:nil]*/ )? 
      }
      let swiftValue = SDAI.SET<ePROCESS_PROPERTY_ASSOCIATION>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \ePROCESS_PROPERTY_ASSOCIATION.PROCESS) )
      let value = SDAI.SET<ePROCESS_PROPERTY_ASSOCIATION>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
