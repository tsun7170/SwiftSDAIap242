/* file: annotation_placeholder_occurrence.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _annotation_placeholder_occurrence : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //internal private(set) weak var _the_callout: eDRAUGHTING_CALLOUT? 	(SEE CORRESPONDING ENTITY REFERENCE DEFINITION)

    // INVERSE AGGREGATE ATTRIBUTE
    // observing _draughting_model_item_association_with_placeholder ._annotation_placeholder
    //internal var _the_draughting_model_item_association_with_placeholders: SDAI.SET<eDRAUGHTING_MODEL_ITEM_ASSOCIATION_WITH_PLACEHOLDER> 	(SEE CORRESPONDING ENTITY REFERENCE DEFINITION)
...
```
*/
  public final class eANNOTATION_PLACEHOLDER_OCCURRENCE : SDAI.EntityReference, @unchecked Sendable {
