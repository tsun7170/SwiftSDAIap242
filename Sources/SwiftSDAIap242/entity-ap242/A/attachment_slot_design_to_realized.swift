/* file: attachment_slot_design_to_realized.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _attachment_slot_design_to_realized : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _relating_product_definition_formation: eATTACHMENT_SLOT_DESIGN	//EXPLICIT REDEFINITION(ePRODUCT_DEFINITION_FORMATION_RELATIONSHIP) */
    ...
    public static func WHERE_wr1(SELF: eATTACHMENT_SLOT_DESIGN_TO_REALIZED?) -> SDAI.LOGICAL {
...
```
*/
  public final class eATTACHMENT_SLOT_DESIGN_TO_REALIZED : SDAI.EntityReference, @unchecked Sendable {
    ...
    /// __EXPLICIT REDEF__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eATTACHMENT_SLOT_DESIGN_TO_REALIZED`` )
    public var RELATING_PRODUCT_DEFINITION_FORMATION: eATTACHMENT_SLOT_DESIGN {
      get {
        return SDAI.UNWRAP( eATTACHMENT_SLOT_DESIGN( super_ePRODUCT_DEFINITION_FORMATION_RELATIONSHIP
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _attachment_slot_design_to_realized.WHERE_wr1(SELF: instance)
      return result
    }
