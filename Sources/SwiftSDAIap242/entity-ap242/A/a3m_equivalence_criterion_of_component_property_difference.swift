/* file: a3m_equivalence_criterion_of_component_property_difference.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- a3m_equivalence_criterion_of_component_property_difference (line:6102 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_COMPONENT_SHAPE``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE/PartialEntity``
*/
  public final class eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE.PartialEntity
    ...
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "A3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE", 
      ...
      entityDef.addAttribute(name: "ACCURACY_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE.ACCURACY_TYPES, 
      ...
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE.DETECTED_DIFFERENCE_TYPES, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "SHAPE_CRITERIA", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE.SHAPE_CRITERIA, 
        kind: .inverse, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE.COMPARED_ELEMENT_TYPES, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE.MEASURED_DATA_TYPE, 
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE.COMPARING_ELEMENT_TYPES, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: false)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      @_documentation(visibility:public)
      internal func _measured_data_type__getter(SELF: eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE.PRef) -> 
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
  .eA3M_EQUIVALENCE_CRITERION_OF_COMPONENT_PROPERTY_DIFFERENCE.PartialEntity :
