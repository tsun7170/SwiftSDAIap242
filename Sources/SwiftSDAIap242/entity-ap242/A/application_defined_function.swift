/* file: application_defined_function.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _application_defined_function : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eAPPLICATION_DEFINED_FUNCTION.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP1 /* SDAI.BOOLEAN? */ = EXPRESSION_IS_CONSTANT( eGENERIC_EXPRESSION.PRef(/*sTUPLE_SPACE*/SELF.EXPLICIT_DOMAIN) )
      return SDAI.LOGICAL(_TEMP1)
    }
    public static func WHERE_wr2(SELF: eAPPLICATION_DEFINED_FUNCTION.PRef?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 /* SDAI.BOOLEAN? */ = EXPRESSION_IS_CONSTANT( eGENERIC_EXPRESSION.PRef(/*sTUPLE_SPACE*/SELF.EXPLICIT_RANGE) )
      return SDAI.LOGICAL(_TEMP1)
    }
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_application_defined_function``
*/
  public final class eAPPLICATION_DEFINED_FUNCTION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _application_defined_function.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _application_defined_function.WHERE_wr2(SELF: instance.pRef)
      return result
    }
