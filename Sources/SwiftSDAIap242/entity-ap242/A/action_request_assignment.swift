/* file: action_request_assignment.swift 	 generated: Mon Jan  3 16:32:52 2022 */
  ...
  ENTITY action_request_assignment
    ...
    WHERE
      wr1: ( SIZEOF( USEDIN( SELF, 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ROLE_ASSOCIATION.'
               + 'ITEM_WITH_ROLE'  ) ) <= 1 );
  END_ENTITY; -- action_request_assignment (line:6472 file:ap242ed2_mim_lf_v1.101.TY.exp)
