/* file: a3m_equivalence_criterion_of_assembly_data_structure.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY a3m_equivalence_criterion_of_assembly_data_structure
    ...
    DERIVE
      ...
      SELF\a3m_equivalence_criterion.compared_element_types : LIST [1 : 1] OF a3ma_element_type_name := [
                                          etna_product_definition_or_reference];
  END_ENTITY; -- a3m_equivalence_criterion_of_assembly_data_structure (line:6100 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE : SDAI.EntityReference {
    ...
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "A3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ACCURACY_TYPES", keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.ACCURACY_TYPES, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.DETECTED_DIFFERENCE_TYPES, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.COMPARED_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.MEASURED_DATA_TYPE, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.COMPARING_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
