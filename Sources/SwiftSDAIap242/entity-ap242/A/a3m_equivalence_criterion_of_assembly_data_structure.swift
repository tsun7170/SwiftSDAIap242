/* file: a3m_equivalence_criterion_of_assembly_data_structure.swift 	 generated: Thu Mar  5 17:54:18 2026 */
  ...
  ENTITY a3m_equivalence_criterion_of_assembly_data_structure
    ...
    DERIVE
      ...
      SELF\a3m_equivalence_criterion.compared_element_types : LIST [1 : 1] OF a3ma_element_type_name := [
                                          etna_product_definition_or_reference];
  END_ENTITY; -- a3m_equivalence_criterion_of_assembly_data_structure (line:6093 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	a3m_equivalence_criterion_of_assembly_data_structure
  ...
  SUB- ENTITY(7)	mismatch_of_component
  ...
  SUB- ENTITY(8)	missing_assembly_constraint
    REDCR: assessment_specification,	TYPE: a3m_equivalence_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: a3m_equivalence_criterion
  ...
  SUB- ENTITY(9)	missing_component
    REDCR: assessment_specification,	TYPE: a3m_equivalence_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: a3m_equivalence_criterion
  ...
  SUB- ENTITY(10)	different_component_identification_via_multi_level_reference
    REDCR: assessment_specification,	TYPE: a3m_equivalence_assessment_by_logical_test -- EXPLICIT
      -- OVERRIDING ENTITY: a3m_equivalence_criterion
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISMATCH_OF_COMPONENT``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISSING_ASSEMBLY_CONSTRAINT``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMISSING_COMPONENT``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIFFERENT_COMPONENT_IDENTIFICATION_VIA_MULTI_LEVEL_REFERENCE``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE/PartialEntity``
*/
  public final class eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.PartialEntity
    ...
    public var super_eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE: eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE { return self } 	// [6]

    //MARK: SUBTYPES
    public var sub_eMISMATCH_OF_COMPONENT: eMISMATCH_OF_COMPONENT? {	// [7]
      return self.complexEntity.entityReference(eMISMATCH_OF_COMPONENT.self)
    }

    public var sub_eMISSING_ASSEMBLY_CONSTRAINT: eMISSING_ASSEMBLY_CONSTRAINT? {	// [8]
      return self.complexEntity.entityReference(eMISSING_ASSEMBLY_CONSTRAINT.self)
    }

    public var sub_eMISSING_COMPONENT: eMISSING_COMPONENT? {	// [9]
      return self.complexEntity.entityReference(eMISSING_COMPONENT.self)
    }

    public var sub_eDIFFERENT_COMPONENT_IDENTIFICATION_VIA_MULTI_LEVEL_REFERENCE: eDIFFERENT_COMPONENT_IDENTIFICATION_VIA_MULTI_LEVEL_REFERENCE? {	// [10]
    ...
    /// __EXPLICIT REDEF(DERIVE)__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "A3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE", 
      ...
      entityDef.add(supertype: eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "ACCURACY_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.ACCURACY_TYPES, 
      ...
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.DETECTED_DIFFERENCE_TYPES, 
      ...
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.COMPARED_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.MEASURED_DATA_TYPE, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.COMPARING_ELEMENT_TYPES, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.self
      }
      ...
      internal func _comparing_element_types__getter(complex: SDAI.ComplexEntity) -> SDAI.LIST<
        ...
        let SELF = complex.entityReference( eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.self )!
        return SDAI.UNWRAP( SDAI.LIST<nA3M_ELEMENT_TYPE_NAME>(SELF.COMPARING_ELEMENT_TYPES) )
      }
      /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _comparing_element_types__getter(SELF: eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.PRef) -> 
      ...
      /// - gut of derived attribute logic
      @_documentation(visibility:public)
      internal func _compared_element_types__getter(SELF: eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.PRef) -> 
        SDAI.LIST<nA3MA_ELEMENT_TYPE_NAME>/*[1:1]*/  {
        //
        let _TEMP1 /* SDAI.AGGREGATE<nA3M_ELEMENT_TYPE_NAME> */ = SDAI.LIST<nA3MA_ELEMENT_TYPE_NAME>(
          bound1:SDAI.UNWRAP(1), bound2:1,  ([ SDAI.AIE(nA3MA_ELEMENT_TYPE_NAME(/*nA3M_ELEMENT_TYPE_NAME*/
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
  .eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE.PartialEntity :
