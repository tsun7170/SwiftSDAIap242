/* file: a3m_equivalence_criterion_of_assembly_data_structure.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _a3m_equivalence_criterion_of_assembly_data_structure : SDAI.PartialEntity, @unchecked Sendable {
    ...
    internal func _comparing_element_types__getter(SELF: eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE) -> 
    ...
    /// DERIVE ATTRIBUTE REDEFINITION(origin: eA3M_EQUIVALENCE_CRITERION)
    /// - gut of derived attribute logic
    internal func _compared_element_types__getter(SELF: eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE) -> 
      SDAI.LIST<nA3MA_ELEMENT_TYPE_NAME>/*[1:1]*/  {
...
```
*/
  public final class eA3M_EQUIVALENCE_CRITERION_OF_ASSEMBLY_DATA_STRUCTURE : SDAI.EntityReference, @unchecked Sendable {
