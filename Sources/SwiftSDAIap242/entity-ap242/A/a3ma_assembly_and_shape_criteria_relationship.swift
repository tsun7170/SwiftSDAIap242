/* file: a3ma_assembly_and_shape_criteria_relationship.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- a3ma_assembly_and_shape_criteria_relationship (line:6208 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class eA3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eA3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "A3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eA3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATED_REPRESENTATION_ITEM", keyPath: \eA3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP.RELATED_REPRESENTATION_ITEM, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eA3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATING_REPRESENTATION_ITEM", keyPath: \eA3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP.RELATING_REPRESENTATION_ITEM, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
