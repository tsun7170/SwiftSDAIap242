/* file: a3ma_assembly_and_shape_criteria_relationship.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _a3ma_assembly_and_shape_criteria_relationship : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _relating_representation_item: eDIFFERENT_COMPONENT_SHAPE	//EXPLICIT REDEFINITION(eREPRESENTATION_ITEM_RELATIONSHIP) //OBSERVED */

    /* override var _related_representation_item: eA3M_EQUIVALENCE_CRITERION_FOR_SHAPE	//EXPLICIT REDEFINITION(eREPRESENTATION_ITEM_RELATIONSHIP) */
...
```
*/
  public final class eA3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var RELATED_REPRESENTATION_ITEM: eA3M_EQUIVALENCE_CRITERION_FOR_SHAPE {
      get {
        return SDAI.UNWRAP( eA3M_EQUIVALENCE_CRITERION_FOR_SHAPE( super_eREPRESENTATION_ITEM_RELATIONSHIP
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3MA_ASSEMBLY_AND_SHAPE_CRITERIA_RELATIONSHIP`` )
    public var RELATING_REPRESENTATION_ITEM: eDIFFERENT_COMPONENT_SHAPE {
      get {
        return SDAI.UNWRAP( eDIFFERENT_COMPONENT_SHAPE( super_eREPRESENTATION_ITEM_RELATIONSHIP.partialEntity
