/* file: a3m_equivalence_criterion_with_specified_elements.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- a3m_equivalence_criterion_with_specified_elements (line:6164 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS/PartialEntity``
*/
  public final class eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS`` )
    public var COMPARING_SPECIFIED_ELEMENTS: SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>/*[1:(nil as 
      SDAI.INTEGER?)]*/  {
      get {
        let originalValue = self.partialEntity._comparing_specified_elements
        let value = SDAI.UNWRAP( SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS`` )
    public var COMPARED_SPECIFIED_ELEMENTS: SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = self.partialEntity._compared_specified_elements
        let value = SDAI.UNWRAP( SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "A3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS", 
      ...
      entityDef.addAttribute(name: "ACCURACY_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.ACCURACY_TYPES, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DETECTED_DIFFERENCE_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.DETECTED_DIFFERENCE_TYPES, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_SPECIFIED_ELEMENTS", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.COMPARING_SPECIFIED_ELEMENTS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "COMPARED_SPECIFIED_ELEMENTS", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.COMPARED_SPECIFIED_ELEMENTS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "COMPARED_ELEMENT_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.COMPARED_ELEMENT_TYPES, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "MEASURED_DATA_TYPE", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.MEASURED_DATA_TYPE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "COMPARING_ELEMENT_TYPES", 
        keyPath: \eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS.COMPARING_ELEMENT_TYPES, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION_WITH_SPECIFIED_ELEMENTS``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public internal(set) var _comparing_specified_elements: SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>
        /*[1:(nil as SDAI.INTEGER?)]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(
        COMPARING_SPECIFIED_ELEMENTS: SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>/*[1:(nil as SDAI.INTEGER?)]*/ , 
        COMPARED_SPECIFIED_ELEMENTS: SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>/*[1:(nil as SDAI.INTEGER?)]*/ 
      ) {

        self._comparing_specified_elements = 
        SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>(
          from: COMPARING_SPECIFIED_ELEMENTS.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
        self._compared_specified_elements = 
        SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>(
          from: COMPARED_SPECIFIED_ELEMENTS.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( COMPARING_SPECIFIED_ELEMENTS: original._comparing_specified_elements, COMPARED_SPECIFIED_ELEMENTS: original._compared_specified_elements )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]COMPARING_SPECIFIED_ELEMENTS for partial entity(\(Self.entityName)) constructor"); return nil }
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [1]COMPARED_SPECIFIED_ELEMENTS for partial entity(\(Self.entityName)) constructor"); return nil }
