/* file: a3m_equivalence_criterion_with_specified_elements.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public init(
        COMPARING_SPECIFIED_ELEMENTS: SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>/*[1:?]*/ , 
        COMPARED_SPECIFIED_ELEMENTS: SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>/*[1:?]*/ 
      ) {

        self._comparing_specified_elements = 
        SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>(from: COMPARING_SPECIFIED_ELEMENTS.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
        self._compared_specified_elements = 
        SDAI.SET<sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>(from: COMPARED_SPECIFIED_ELEMENTS.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
