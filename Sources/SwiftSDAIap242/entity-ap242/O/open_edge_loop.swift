/* file: open_edge_loop.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _open_edge_loop : SDAI.PartialEntity, SDAI.InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_open_edge_loop``
*/
  public final class eOPEN_EDGE_LOOP : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _open_edge_loop.self
    }
    /// partial entity reference
    public let partialEntity: _open_edge_loop
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_open_edge_loop.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _open_edge_loop.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _open_edge_loop.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _open_edge_loop.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _open_edge_loop.WHERE_wr4(SELF: instance.pRef)
      return result
    }
