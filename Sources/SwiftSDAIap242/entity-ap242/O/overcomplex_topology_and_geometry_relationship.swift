/* file: overcomplex_topology_and_geometry_relationship.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- overcomplex_topology_and_geometry_relationship (line:23560 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eUNUSED_PATCHES``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEDGE_WITH_EXCESSIVE_SEGMENTS``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFACE_SURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eOVERCOMPLEX_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP/PartialEntity``
*/
  public final class eOVERCOMPLEX_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eOVERCOMPLEX_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eOVERCOMPLEX_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eOVERCOMPLEX_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.PartialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eOVERCOMPLEX_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "OVERCOMPLEX_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP", 
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eOVERCOMPLEX_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eOVERCOMPLEX_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eOVERCOMPLEX_TOPOLOGY_AND_GEOMETRY_RELATIONSHIP``
*/
