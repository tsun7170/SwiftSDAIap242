/* file: overlapping_geometry.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- overlapping_geometry (line:23566 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARTLY_OVERLAPPING_CURVES``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARTLY_OVERLAPPING_SURFACES``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eOVERLAPPING_GEOMETRY/PartialEntity``
*/
  public final class eOVERLAPPING_GEOMETRY : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eOVERLAPPING_GEOMETRY>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eOVERLAPPING_GEOMETRY.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eOVERLAPPING_GEOMETRY.PartialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eOVERLAPPING_GEOMETRY.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eOVERLAPPING_GEOMETRY.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eOVERLAPPING_GEOMETRY.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eOVERLAPPING_GEOMETRY``
*/
