/* file: open_closed_shell.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- open_closed_shell (line:22554 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _open_closed_shell : SDAI.PartialEntity {
...
```
*/
  public final class eOPEN_CLOSED_SHELL : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``eOPEN_CLOSED_SHELL`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "OPEN_CLOSED_SHELL", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \eOPEN_CLOSED_SHELL.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \eOPEN_CLOSED_SHELL.NAME, 
