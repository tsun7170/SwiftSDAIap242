/* file: open_closed_shell.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eOPEN_CLOSED_SHELL : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eOPEN_CLOSED_SHELL.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eOPEN_CLOSED_SHELL.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eOPEN_CLOSED_SHELL.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eOPEN_CLOSED_SHELL.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      return result
    }
