/* file: open_closed_shell.swift 	 generated: Mon Dec 15 17:41:04 2025 */
...
*/
  ...
  public final class _open_closed_shell : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_open_closed_shell``
*/
  public final class eOPEN_CLOSED_SHELL : SDAI.EntityReference, SDAIDualModeReference, @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _open_closed_shell.self
    }
    /// partial entity reference
    public let partialEntity: _open_closed_shell
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_open_closed_shell.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _open_closed_shell.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _open_closed_shell.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _open_closed_shell.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _open_closed_shell.WHERE_wr4(SELF: instance.pRef)
      return result
    }
