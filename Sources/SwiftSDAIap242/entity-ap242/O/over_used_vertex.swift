/* file: over_used_vertex.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _over_used_vertex : SDAI.PartialEntity, SDAI.InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_over_used_vertex``
*/
  public final class eOVER_USED_VERTEX : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _over_used_vertex.self
    }
    /// partial entity reference
    public let partialEntity: _over_used_vertex
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_over_used_vertex.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _over_used_vertex.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _over_used_vertex.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _over_used_vertex.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _over_used_vertex.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _over_used_vertex.WHERE_wr5(SELF: instance.pRef)
      return result
    }
