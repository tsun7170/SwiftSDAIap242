/* file: over_used_vertex.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class eOVER_USED_VERTEX : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = eOVER_USED_VERTEX.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = eOVER_USED_VERTEX.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = eOVER_USED_VERTEX.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = eOVER_USED_VERTEX.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = eOVER_USED_VERTEX.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
