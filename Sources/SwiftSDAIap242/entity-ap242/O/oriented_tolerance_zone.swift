/* file: oriented_tolerance_zone.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _oriented_tolerance_zone : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eORIENTED_TOLERANCE_ZONE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = nORIENTED_TOLERANCE_ZONE_TYPE.ANGULAR
      let _TEMP2 = SDAI.FORCE_OPTIONAL(SELF.ORIENTATION) .!=. SDAI.FORCE_OPTIONAL(_TEMP1)
      let _TEMP3 = SDAI.EXISTS(SELF.ANGLE)
      let _TEMP4 = _TEMP2 .!=. _TEMP3
      return _TEMP4
    }

    //EXPRESS IMPLICIT PARTIAL ENTITY CONSTRUCTOR
    public init(ORIENTATION: nORIENTED_TOLERANCE_ZONE_TYPE, ANGLE: ePLANE_ANGLE_MEASURE_WITH_UNIT? ) {
    ...
    public required convenience init?(parameters: [P21Decode.ExchangeStructure.Parameter], exchangeStructure: P21Decode.ExchangeStructure) {
      ...
      guard case .success(let p1) = exchangeStructure.recoverOptionalParameter(as: 
        ePLANE_ANGLE_MEASURE_WITH_UNIT.self, from: parameters[1])
...
```
*/
  public final class eORIENTED_TOLERANCE_ZONE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _oriented_tolerance_zone.WHERE_wr1(SELF: instance)
      return result
    }
