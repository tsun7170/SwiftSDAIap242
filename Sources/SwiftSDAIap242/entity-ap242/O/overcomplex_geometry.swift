/* file: overcomplex_geometry.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- overcomplex_geometry (line:23552 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	overcomplex_geometry
    (no local attributes)

  SUB- ENTITY(8)	excessively_high_degree_curve
  ...
  SUB- ENTITY(9)	excessively_high_degree_surface
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(10)	surface_with_excessive_patches_in_one_direction
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(11)	high_degree_linear_curve
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion
  ...
  SUB- ENTITY(12)	high_degree_planar_surface
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion
  ...
  SUB- ENTITY(13)	curve_with_excessive_segments
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion


  SUB- ENTITY(14)	high_degree_axi_symmetric_surface
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion
  ...
  SUB- ENTITY(15)	high_degree_conic
    REDCR: assessment_specification,	TYPE: shape_data_quality_assessment_by_numerical_test -- EXPLICIT
      -- OVERRIDING ENTITY: shape_data_quality_criterion
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXCESSIVELY_HIGH_DEGREE_CURVE``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXCESSIVELY_HIGH_DEGREE_SURFACE``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eHIGH_DEGREE_LINEAR_CURVE``
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eHIGH_DEGREE_PLANAR_SURFACE``
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_WITH_EXCESSIVE_SEGMENTS``
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE``
	8.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eHIGH_DEGREE_CONIC``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eOVERCOMPLEX_GEOMETRY/PartialEntity``
*/
  public final class eOVERCOMPLEX_GEOMETRY : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<eOVERCOMPLEX_GEOMETRY>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      eOVERCOMPLEX_GEOMETRY.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: eOVERCOMPLEX_GEOMETRY.PartialEntity
    ...
    public var super_eOVERCOMPLEX_GEOMETRY: eOVERCOMPLEX_GEOMETRY { return self } 	// [7]

    //MARK: SUBTYPES
    public var sub_eEXCESSIVELY_HIGH_DEGREE_CURVE: eEXCESSIVELY_HIGH_DEGREE_CURVE? {	// [8]
      return self.complexEntity.entityReference(eEXCESSIVELY_HIGH_DEGREE_CURVE.self)
    }

    public var sub_eEXCESSIVELY_HIGH_DEGREE_SURFACE: eEXCESSIVELY_HIGH_DEGREE_SURFACE? {	// [9]
      return self.complexEntity.entityReference(eEXCESSIVELY_HIGH_DEGREE_SURFACE.self)
    }

    public var sub_eSURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION: eSURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION? {	// [10]
      return self.complexEntity.entityReference(eSURFACE_WITH_EXCESSIVE_PATCHES_IN_ONE_DIRECTION.self)
    }

    public var sub_eHIGH_DEGREE_LINEAR_CURVE: eHIGH_DEGREE_LINEAR_CURVE? {	// [11]
      return self.complexEntity.entityReference(eHIGH_DEGREE_LINEAR_CURVE.self)
    }

    public var sub_eHIGH_DEGREE_PLANAR_SURFACE: eHIGH_DEGREE_PLANAR_SURFACE? {	// [12]
      return self.complexEntity.entityReference(eHIGH_DEGREE_PLANAR_SURFACE.self)
    }

    public var sub_eCURVE_WITH_EXCESSIVE_SEGMENTS: eCURVE_WITH_EXCESSIVE_SEGMENTS? {	// [13]
      return self.complexEntity.entityReference(eCURVE_WITH_EXCESSIVE_SEGMENTS.self)
    }

    public var sub_eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE: eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE? {	// [14]
      return self.complexEntity.entityReference(eHIGH_DEGREE_AXI_SYMMETRIC_SURFACE.self)
    }

    public var sub_eHIGH_DEGREE_CONIC: eHIGH_DEGREE_CONIC? {	// [15]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(eOVERCOMPLEX_GEOMETRY.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \eOVERCOMPLEX_GEOMETRY.ASSESSMENT_SPECIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \eOVERCOMPLEX_GEOMETRY.NAME, 
