/* file: overcomplex_geometry.swift 	 generated: Thu Dec 25 18:13:23 2025 */
...
*/
  ...
  public final class _overcomplex_geometry : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_overcomplex_geometry``
*/
  public final class eOVERCOMPLEX_GEOMETRY : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _overcomplex_geometry.self
    }
    /// partial entity reference
    public let partialEntity: _overcomplex_geometry
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_overcomplex_geometry.self) else { return nil }
