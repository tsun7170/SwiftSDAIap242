/* file: outside_profile.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY outside_profile
    ...
    WHERE
      ...
      wr12: ( SIZEOF( QUERY ( pdr <* get_property_definition_representations( SELF ) | ( ( 
                ...
                >= 0 );
  END_ENTITY; -- outside_profile (line:22980 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _outside_profile : SDAI.PartialEntity {
...
```
*/
  public final class eOUTSIDE_PROFILE : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "OUTSIDE_PROFILE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \eOUTSIDE_PROFILE.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \eOUTSIDE_PROFILE.NAME, 
