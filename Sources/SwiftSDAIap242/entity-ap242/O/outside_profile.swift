/* file: outside_profile.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _outside_profile : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: eOUTSIDE_PROFILE?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: eOUTSIDE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ PDS in 
          ...
          let _TEMP2 = _TEMP1.QUERY{ SA_OCC in 
              ...
              let _TEMP2 = ([SDAI.AIE(SDAI.STRING("boundary occurrence")), 
    ...
    public static func WHERE_wr3(SELF: eOUTSIDE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr4(SELF: eOUTSIDE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ PDS in 
          ...
          let _TEMP2 = _TEMP1.QUERY{ SA_OCC in 
              ...
              let _TEMP1 = /*runtime*/SA_OCC.DESCRIPTION
              let _TEMP2 = ([SDAI.AIE(SDAI.STRING("complex boundary occurrence")), 
                SDAI.AIE(SDAI.STRING("partial circular boundary occurrence")), 
                SDAI.AIE(SDAI.STRING("closed circular boundary occurrence")), 
                SDAI.AIE(SDAI.STRING("open rectangular boundary occurrence")), 
                SDAI.AIE(SDAI.STRING("closed rectangular boundary occurrence"))] 
      ...
      let _TEMP9 = _TEMP8.QUERY{ PDS in 
          ...
          let _TEMP2 = _TEMP1.QUERY{ SA_OCC in 
              ...
              let _TEMP3 = _TEMP2.QUERY{ SDR in 
                  ...
                  let _TEMP1 = SDAI.TYPEOF(SDR.RELATING_SHAPE_ASPECT, IS: ePROFILE_FLOOR.self)
    ...
    public static func WHERE_wr5(SELF: eOUTSIDE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ PDS in 
          ...
          let _TEMP2 = _TEMP1.QUERY{ SA_OCC in 
              ...
              let _TEMP1 = /*runtime*/SA_OCC.DESCRIPTION
              let _TEMP2 = ([SDAI.AIE(SDAI.STRING("outside boundary")), 
      ...
      let _TEMP9 = _TEMP8.QUERY{ PDS in 
          ...
          let _TEMP2 = _TEMP1.QUERY{ SA_OCC in 
              ...
              let _TEMP3 = _TEMP2.QUERY{ SDR in 
                  ...
                  let _TEMP5 = SDAI.SIZEOF(_TEMP4)
                  let _TEMP6 = _TEMP5 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
                  let _TEMP7 = /*runtime*/SDR.NAME
                  let _TEMP8 = SDAI.FORCE_OPTIONAL(/*runtime*/_TEMP7) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING(
                    "profile swept shape"))
                  let _TEMP9 = _TEMP6 && _TEMP8
                  let _TEMP10 = /*runtime*/SDR.RELATING_SHAPE_ASPECT
                  let _TEMP11 = /*runtime*/SDAI.FORCE_OPTIONAL(_TEMP10)?.DESCRIPTION
                  let _TEMP12 = SDAI.FORCE_OPTIONAL(/*runtime*/_TEMP11) .==. SDAI.FORCE_OPTIONAL(SDAI.STRING(
                    "linear"))
    ...
    public static func WHERE_wr6(SELF: eOUTSIDE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr7(SELF: eOUTSIDE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP9 = _TEMP8.QUERY{ PDS in 
          ...
          let _TEMP2 = _TEMP1.QUERY{ SA_OCC in 
              ...
              let _TEMP3 = _TEMP2.QUERY{ SDR in 
                  ...
                  let _TEMP1 = SDAI.TYPEOF(SDR.RELATING_SHAPE_ASPECT, IS: ePARTIAL_CIRCULAR_PROFILE.self)
                  return _TEMP1 }
              let _TEMP4 = SDAI.SIZEOF(_TEMP3)
              let _TEMP5 = _TEMP4 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
              return _TEMP5 }
    ...
    public static func WHERE_wr8(SELF: eOUTSIDE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr9(SELF: eOUTSIDE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr10(SELF: eOUTSIDE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr11(SELF: eOUTSIDE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr12(SELF: eOUTSIDE_PROFILE?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = GET_PROPERTY_DEFINITION_REPRESENTATIONS(sCHARACTERIZED_DEFINITION(/*eOUTSIDE_PROFILE*/SELF))
      let _TEMP2 = _TEMP1?.QUERY{ PDR in 
...
```
*/
  public final class eOUTSIDE_PROFILE : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _outside_profile.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _outside_profile.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _outside_profile.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _outside_profile.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _outside_profile.WHERE_wr5(SELF: instance)
      result[prefix2 + " .WHERE_wr6"] = _outside_profile.WHERE_wr6(SELF: instance)
      result[prefix2 + " .WHERE_wr7"] = _outside_profile.WHERE_wr7(SELF: instance)
      result[prefix2 + " .WHERE_wr8"] = _outside_profile.WHERE_wr8(SELF: instance)
      result[prefix2 + " .WHERE_wr9"] = _outside_profile.WHERE_wr9(SELF: instance)
      result[prefix2 + " .WHERE_wr10"] = _outside_profile.WHERE_wr10(SELF: instance)
      result[prefix2 + " .WHERE_wr11"] = _outside_profile.WHERE_wr11(SELF: instance)
      result[prefix2 + " .WHERE_wr12"] = _outside_profile.WHERE_wr12(SELF: instance)
      return result
    }
