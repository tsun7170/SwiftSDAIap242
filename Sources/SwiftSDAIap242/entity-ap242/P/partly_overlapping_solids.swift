/* file: partly_overlapping_solids.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _partly_overlapping_solids : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_partly_overlapping_solids``
*/
  public final class ePARTLY_OVERLAPPING_SOLIDS : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _partly_overlapping_solids.self
    }
    /// partial entity reference
    public let partialEntity: _partly_overlapping_solids
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_partly_overlapping_solids.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _partly_overlapping_solids.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _partly_overlapping_solids.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _partly_overlapping_solids.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _partly_overlapping_solids.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = _partly_overlapping_solids.WHERE_wr5(SELF: instance.pRef)
      return result
    }
