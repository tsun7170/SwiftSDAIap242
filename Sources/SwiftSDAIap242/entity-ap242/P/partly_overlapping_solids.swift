/* file: partly_overlapping_solids.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- partly_overlapping_solids (line:23672 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _partly_overlapping_solids : SDAI.PartialEntity {
...
```
*/
  public final class ePARTLY_OVERLAPPING_SOLIDS : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``ePARTLY_OVERLAPPING_SOLIDS`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "PARTLY_OVERLAPPING_SOLIDS", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "INTERFERENCE_TOLERANCE", keyPath: \ePARTLY_OVERLAPPING_SOLIDS.INTERFERENCE_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \ePARTLY_OVERLAPPING_SOLIDS.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \ePARTLY_OVERLAPPING_SOLIDS.NAME, 
