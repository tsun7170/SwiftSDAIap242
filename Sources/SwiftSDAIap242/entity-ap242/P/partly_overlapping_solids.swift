/* file: partly_overlapping_solids.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  ENTITY partly_overlapping_solids
    ...
    WHERE
      wr1: ( ( 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.SHAPE_DATA_QUALITY_LOWER_VALUE_LIMIT' IN 
               ...
               'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.AREA_MEASURE'  IN value_limit_type( SELF\
      ...
      wr3: validate_inspected_elements_type( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               + 'MANIFOLD_SOLID_BREP' , 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.MANIFOLD_SOLID_BREP'] );
      wr4: validate_locations_of_extreme_value_type( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               + 'SUBFACE' , 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.SUBFACE'] );
      wr5: validate_accuracy_types( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.AREA_MEASURE'] );
  END_ENTITY; -- partly_overlapping_solids (line:23867 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(6)	inapt_manifold_solid_brep
    (no local attributes)

  ENTITY(SELF)	partly_overlapping_solids
...
- SUPERTYPES:
	...
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINAPT_MANIFOLD_SOLID_BREP``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARTLY_OVERLAPPING_SOLIDS/PartialEntity``
*/
  public final class ePARTLY_OVERLAPPING_SOLIDS : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<ePARTLY_OVERLAPPING_SOLIDS>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePARTLY_OVERLAPPING_SOLIDS.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePARTLY_OVERLAPPING_SOLIDS.PartialEntity
    ...
    public let super_eINAPT_MANIFOLD_SOLID_BREP: eINAPT_MANIFOLD_SOLID_BREP 	// [6]
    public var super_ePARTLY_OVERLAPPING_SOLIDS: ePARTLY_OVERLAPPING_SOLIDS { return self } 	// [7]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARTLY_OVERLAPPING_SOLIDS`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePARTLY_OVERLAPPING_SOLIDS.PartialEntity.self) else { return nil }
      ...
      guard let super6 = complexEntity?.entityReference(eINAPT_MANIFOLD_SOLID_BREP.self) else { return nil }
      self.super_eINAPT_MANIFOLD_SOLID_BREP = super6
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = ePARTLY_OVERLAPPING_SOLIDS.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = ePARTLY_OVERLAPPING_SOLIDS.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = ePARTLY_OVERLAPPING_SOLIDS.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = ePARTLY_OVERLAPPING_SOLIDS.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = ePARTLY_OVERLAPPING_SOLIDS.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "PARTLY_OVERLAPPING_SOLIDS", 
      ...
      entityDef.add(supertype: eINAPT_MANIFOLD_SOLID_BREP.self)
      entityDef.add(supertype: ePARTLY_OVERLAPPING_SOLIDS.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "INTERFERENCE_TOLERANCE", 
        keyPath: \ePARTLY_OVERLAPPING_SOLIDS.INTERFERENCE_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \ePARTLY_OVERLAPPING_SOLIDS.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \ePARTLY_OVERLAPPING_SOLIDS.NAME, 
...
```express
    ...
    ENTITY partly_overlapping_solids
      ...
      WHERE
        ...
        wr2: validate_measured_data_type( SELF, 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.AREA_MEASURE' );
        wr3: validate_inspected_elements_type( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
                 + 'MANIFOLD_SOLID_BREP' , 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
                 + 'MANIFOLD_SOLID_BREP' ] );
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARTLY_OVERLAPPING_SOLIDS``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        ePARTLY_OVERLAPPING_SOLIDS.self
      }
      ...
      public static func WHERE_wr1(SELF: ePARTLY_OVERLAPPING_SOLIDS.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: ePARTLY_OVERLAPPING_SOLIDS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*ePARTLY_OVERLAPPING_SOLIDS.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.AREA_MEASURE") )
        return _TEMP1
      }
      public static func WHERE_wr3(SELF: ePARTLY_OVERLAPPING_SOLIDS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr4(SELF: ePARTLY_OVERLAPPING_SOLIDS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
            SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.SUBFACE")), 
            SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.SUBFACE")) ] 
            as [SDAI.AggregationInitializerElement<SDAI.STRING>]) )
      ...
      public static func WHERE_wr5(SELF: ePARTLY_OVERLAPPING_SOLIDS.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
            SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.AREA_MEASURE")) ] 
            as [SDAI.AggregationInitializerElement<SDAI.STRING>]) )
