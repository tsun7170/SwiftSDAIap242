/* file: product_group_attribute_set.swift 	 generated: Sun Jan 18 16:59:32 2026 */
    ...
    public var ASSIGNED_GROUP: ePRODUCT_GROUP.PRef {
      get {
        if let resolved = eGROUP_ASSIGNMENT.PartialEntity._assigned_group__provider(complex: self.complexEntity) {
          let value = SDAI.UNWRAP( ePRODUCT_GROUP.PRef(resolved._assigned_group__getter(
            complex: self.complexEntity)) )
          return value
        }
        else {
          return SDAI.UNWRAP( ePRODUCT_GROUP.PRef(super_eGROUP_ASSIGNMENT.partialEntity._assigned_group) )
        }
      }
      set(newValue) {
