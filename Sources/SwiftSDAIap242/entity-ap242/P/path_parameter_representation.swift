/* file: path_parameter_representation.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class ePATH_PARAMETER_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var ITEMS: SDAI.SET<eBOUNDED_CURVE.PRef>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eBOUNDED_CURVE.PRef>( super_eREPRESENTATION.partialEntity._items ) )
      }
      set(newValue) {
    ...
    public var CONTEXT_OF_ITEMS: ePATH_PARAMETER_REPRESENTATION_CONTEXT.PRef {
      get {
        if let resolved = eREPRESENTATION.PartialEntity._context_of_items__provider(complex: self.complexEntity) {
          let value = SDAI.UNWRAP( ePATH_PARAMETER_REPRESENTATION_CONTEXT.PRef(resolved
            ._context_of_items__getter(complex: self.complexEntity)) )
          return value
        }
        else {
          return SDAI.UNWRAP( ePATH_PARAMETER_REPRESENTATION_CONTEXT.PRef(super_eREPRESENTATION.partialEntity
            ._context_of_items) )
        }
      }
      set(newValue) {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = ePATH_PARAMETER_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      /* override var _items: SDAI.SET<eBOUNDED_CURVE.PRef>[1:nil] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
