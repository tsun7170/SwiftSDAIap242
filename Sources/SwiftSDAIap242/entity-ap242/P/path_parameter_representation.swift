/* file: path_parameter_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _path_parameter_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _context_of_items: ePATH_PARAMETER_REPRESENTATION_CONTEXT	//EXPLICIT REDEFINITION(eREPRESENTATION) */

    /* override var _items: SDAI.SET<eBOUNDED_CURVE>[1:nil] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
    ...
    public static func WHERE_wr1(SELF: ePATH_PARAMETER_REPRESENTATION?) -> SDAI.LOGICAL {
...
```
*/
  public final class ePATH_PARAMETER_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var ITEMS: SDAI.SET<eBOUNDED_CURVE>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eBOUNDED_CURVE>( super_eREPRESENTATION.partialEntity._items ) )
      }
      set(newValue) {
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePATH_PARAMETER_REPRESENTATION`` )
    public var CONTEXT_OF_ITEMS: ePATH_PARAMETER_REPRESENTATION_CONTEXT {
      get {
        if let resolved = _representation._context_of_items__provider(complex: self.complexEntity) {
          let value = SDAI.UNWRAP( ePATH_PARAMETER_REPRESENTATION_CONTEXT(resolved._context_of_items__getter(
            complex: self.complexEntity)) )
          return value
        }
        else {
          return SDAI.UNWRAP( ePATH_PARAMETER_REPRESENTATION_CONTEXT(super_eREPRESENTATION.partialEntity
            ._context_of_items) )
        }
      }
      set(newValue) {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _path_parameter_representation.WHERE_wr1(SELF: instance)
      return result
    }
