/* file: path_parameter_representation.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY path_parameter_representation
    ...
    WHERE
      wr1: ( SELF\representation.context_of_items\geometric_representation_context.coordinate_space_dimension 
               = 2 );
  END_ENTITY; -- path_parameter_representation (line:23922 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _path_parameter_representation : SDAI.PartialEntity {
...
```
*/
  public final class ePATH_PARAMETER_REPRESENTATION : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``ePATH_PARAMETER_REPRESENTATION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "PATH_PARAMETER_REPRESENTATION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \ePATH_PARAMETER_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \ePATH_PARAMETER_REPRESENTATION.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \ePATH_PARAMETER_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \ePATH_PARAMETER_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \ePATH_PARAMETER_REPRESENTATION.NAME, 
