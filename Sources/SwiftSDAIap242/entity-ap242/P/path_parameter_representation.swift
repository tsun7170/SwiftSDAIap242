/* file: path_parameter_representation.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  ENTITY path_parameter_representation
    ...
    WHERE
      wr1: ( SELF\representation.context_of_items\geometric_representation_context.coordinate_space_dimension 
               = 2 );
  END_ENTITY; -- path_parameter_representation (line:24103 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(2)	definitional_representation
    (no local attributes)

  ENTITY(SELF)	path_parameter_representation
...
- SUPERTYPES:
	...
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDEFINITIONAL_REPRESENTATION``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePATH_PARAMETER_REPRESENTATION/PartialEntity``
*/
  public final class ePATH_PARAMETER_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<ePATH_PARAMETER_REPRESENTATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePATH_PARAMETER_REPRESENTATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePATH_PARAMETER_REPRESENTATION.PartialEntity

    //MARK: SUPERTYPES
    public let super_eREPRESENTATION: eREPRESENTATION 	// [1]
    public let super_eDEFINITIONAL_REPRESENTATION: eDEFINITIONAL_REPRESENTATION 	// [2]
    public var super_ePATH_PARAMETER_REPRESENTATION: ePATH_PARAMETER_REPRESENTATION { return self } 	// [3]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePATH_PARAMETER_REPRESENTATION`` )
    public var ITEMS: SDAI.SET<eBOUNDED_CURVE.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePATH_PARAMETER_REPRESENTATION`` )
    public var CONTEXT_OF_ITEMS: ePATH_PARAMETER_REPRESENTATION_CONTEXT.PRef {
      get {
        if let resolved = eREPRESENTATION.PartialEntity._context_of_items__provider(complex: self.complexEntity) {
          ...
          let value = SDAI.UNWRAP( ePATH_PARAMETER_REPRESENTATION_CONTEXT.PRef( originalValue ) )
          return value
        }
        else {
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePATH_PARAMETER_REPRESENTATION.PartialEntity.self) else { return nil }
      ...
      guard let super2 = complexEntity?.entityReference(eDEFINITIONAL_REPRESENTATION.self) else { return nil }
      self.super_eDEFINITIONAL_REPRESENTATION = super2
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = ePATH_PARAMETER_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "PATH_PARAMETER_REPRESENTATION", 
        type: self, explicitAttributeCount: 0)

      //MARK: SUPERTYPE REGISTRATIONS
      entityDef.add(supertype: eREPRESENTATION.self)
      entityDef.add(supertype: eDEFINITIONAL_REPRESENTATION.self)
      entityDef.add(supertype: ePATH_PARAMETER_REPRESENTATION.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \ePATH_PARAMETER_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \ePATH_PARAMETER_REPRESENTATION.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \ePATH_PARAMETER_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \ePATH_PARAMETER_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \ePATH_PARAMETER_REPRESENTATION.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePATH_PARAMETER_REPRESENTATION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        ePATH_PARAMETER_REPRESENTATION.self
      }

      //ATTRIBUTES
      /* override var _context_of_items: ePATH_PARAMETER_REPRESENTATION_CONTEXT.PRef	//EXPLICIT REDEFINITION(eREPRESENTATION) */

      /* override var _items: SDAI.SET<eBOUNDED_CURVE.PRef>[1:(nil as SDAI.INTEGER?)] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
      ...
      public static func WHERE_wr1(SELF: ePATH_PARAMETER_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
