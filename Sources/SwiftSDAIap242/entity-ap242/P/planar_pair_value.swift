/* file: planar_pair_value.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- planar_pair_value (line:24750 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLANAR_PAIR_VALUE/PartialEntity``
*/
  public final class ePLANAR_PAIR_VALUE : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<ePLANAR_PAIR_VALUE>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePLANAR_PAIR_VALUE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePLANAR_PAIR_VALUE.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLANAR_PAIR_VALUE`` )
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLANAR_PAIR_VALUE`` )
    public var APPLIES_TO_PAIR: ePLANAR_PAIR.PRef {
      get {
        let originalValue = super_ePAIR_VALUE.partialEntity._applies_to_pair
        let value = SDAI.UNWRAP( ePLANAR_PAIR.PRef( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePLANAR_PAIR_VALUE.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "ACTUAL_TRANSLATION_Y", 
        keyPath: \ePLANAR_PAIR_VALUE.ACTUAL_TRANSLATION_Y, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ACTUAL_TRANSLATION_X", 
        keyPath: \ePLANAR_PAIR_VALUE.ACTUAL_TRANSLATION_X, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "APPLIES_TO_PAIR", 
        keyPath: \ePLANAR_PAIR_VALUE.APPLIES_TO_PAIR, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ACTUAL_ROTATION", 
        keyPath: \ePLANAR_PAIR_VALUE.ACTUAL_ROTATION, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \ePLANAR_PAIR_VALUE.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", 
        keyPath: \ePLANAR_PAIR_VALUE.DIM, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLANAR_PAIR_VALUE``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _applies_to_pair: ePLANAR_PAIR.PRef	//EXPLICIT REDEFINITION(ePAIR_VALUE) */
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( ACTUAL_ROTATION: original._actual_rotation, ACTUAL_TRANSLATION_X: original._actual_translation_x, ACTUAL_TRANSLATION_Y: original._actual_translation_y )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [1]ACTUAL_TRANSLATION_X for partial entity(\(Self.entityName)) constructor"); return nil }

        guard case .success(let p2) = exchangeStructure.recoverRequiredParameter(as: tLENGTH_MEASURE.self, from: parameters[2])
        else { exchangeStructure.add(errorContext: "while recovering parameter [2]ACTUAL_TRANSLATION_Y for partial entity(\(Self.entityName)) constructor"); return nil }
