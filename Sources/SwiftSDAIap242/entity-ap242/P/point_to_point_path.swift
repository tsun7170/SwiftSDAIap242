/* file: point_to_point_path.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- point_to_point_path (line:25361 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _point_to_point_path : SDAI.PartialEntity {
...
```
*/
  public final class ePOINT_TO_POINT_PATH : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``ePOINT_TO_POINT_PATH`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "POINT_TO_POINT_PATH", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "USERS", keyPath: \ePOINT_TO_POINT_PATH.USERS, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "T_END", keyPath: \ePOINT_TO_POINT_PATH.T_END, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "TRANSITION", keyPath: \ePOINT_TO_POINT_PATH.TRANSITION, 
        kind: .derivedRedeclaring, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "PLACEMENT_END", keyPath: \ePOINT_TO_POINT_PATH.PLACEMENT_END, 
