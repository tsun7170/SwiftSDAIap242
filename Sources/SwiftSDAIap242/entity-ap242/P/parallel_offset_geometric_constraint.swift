/* file: parallel_offset_geometric_constraint.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: ePARALLEL_OFFSET_GEOMETRIC_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP5 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:?] ? */ = _TEMP4?.CONSTRAINED_ELEMENTS
        let _TEMP6 /* eEXPLICIT_CONSTRAINT.PRef? */ = SELF.GROUP_REF(eEXPLICIT_CONSTRAINT.self)
        let _TEMP7 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[0:?] ? */ = _TEMP6?.REFERENCE_ELEMENTS
      ...
      public static func WHERE_wr2(SELF: ePARALLEL_OFFSET_GEOMETRIC_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP3 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:?] ? */ = _TEMP2?.CONSTRAINED_ELEMENTS
        let _TEMP4 /* eEXPLICIT_CONSTRAINT.PRef? */ = SELF.GROUP_REF(eEXPLICIT_CONSTRAINT.self)
        let _TEMP5 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[0:?] ? */ = _TEMP4?.REFERENCE_ELEMENTS
