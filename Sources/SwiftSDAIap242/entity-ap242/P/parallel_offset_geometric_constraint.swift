/* file: parallel_offset_geometric_constraint.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
*/
  public final class ePARALLEL_OFFSET_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var OFFSET_TYPE: nPARALLEL_OFFSET_TYPE {
      get {
        let originalValue = self.partialEntity._offset_type
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = ePARALLEL_OFFSET_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = ePARALLEL_OFFSET_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: ePARALLEL_OFFSET_GEOMETRIC_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP5 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP4?.CONSTRAINED_ELEMENTS
        let _TEMP6 /* eEXPLICIT_CONSTRAINT.PRef? */ = SELF.GROUP_REF(eEXPLICIT_CONSTRAINT.self)
        let _TEMP7 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[0:(nil as SDAI.INTEGER?)] ? */ = _TEMP6?.REFERENCE_ELEMENTS
      ...
      public static func WHERE_wr2(SELF: ePARALLEL_OFFSET_GEOMETRIC_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP3 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP2?.CONSTRAINED_ELEMENTS
        let _TEMP4 /* eEXPLICIT_CONSTRAINT.PRef? */ = SELF.GROUP_REF(eEXPLICIT_CONSTRAINT.self)
        let _TEMP5 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[0:(nil as SDAI.INTEGER?)] ? */ = _TEMP4?.REFERENCE_ELEMENTS
