/* file: product_process_plan.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY product_process_plan
    ...
    WHERE
      ...
      wr3: ( SIZEOF( QUERY ( ppa <* USEDIN( SELF, 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               ...
               defined_product ) ) ) ) ) ) = 0 );
  END_ENTITY; -- product_process_plan (line:26374 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _product_process_plan : SDAI.PartialEntity {
...
```
*/
  public final class ePRODUCT_PROCESS_PLAN : SDAI.EntityReference {
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUPER( ``ePRODUCT_DEFINITION_PROCESS`` )
    ...
    public var PRODUCT_DEFINITIONS: SDAI.SET<ePROCESS_PRODUCT_ASSOCIATION>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( super_ePRODUCT_DEFINITION_PROCESS.partialEntity._product_definitions )
      }
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "PRODUCT_PROCESS_PLAN", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \ePRODUCT_PROCESS_PLAN.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CHOSEN_METHOD", keyPath: \ePRODUCT_PROCESS_PLAN.CHOSEN_METHOD, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "IDENTIFICATION", keyPath: \ePRODUCT_PROCESS_PLAN.IDENTIFICATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "PRODUCT_DEFINITIONS", keyPath: \ePRODUCT_PROCESS_PLAN.PRODUCT_DEFINITIONS, 
        kind: .inverse, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \ePRODUCT_PROCESS_PLAN.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \ePRODUCT_PROCESS_PLAN.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
