/* file: product_process_plan.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _product_process_plan : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: ePRODUCT_PROCESS_PLAN?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: ePRODUCT_PROCESS_PLAN?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr3(SELF: ePRODUCT_PROCESS_PLAN?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.USEDIN(T: SELF, ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
        .ePROCESS_PRODUCT_ASSOCIATION.PROCESS)
      let _TEMP2 = _TEMP1.QUERY{ PPA in 

          let _TEMP1 = /*runtime*/PPA.NAME
          let _TEMP2 = SDAI.FORCE_OPTIONAL(/*runtime*/_TEMP1) .!=. SDAI.FORCE_OPTIONAL(SDAI.STRING(
            "produced output"))
          let _TEMP3 = SDAI.TYPEOF(PPA.DEFINED_PRODUCT, IS: ePRODUCT_DEFINITION.self)
          let _TEMP4 =  !_TEMP3
...
```
*/
  public final class ePRODUCT_PROCESS_PLAN : SDAI.EntityReference, @unchecked Sendable {
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"PRODUCT_DEFINITIONS") {
        return cached.value as! SDAI.SET<ePROCESS_PRODUCT_ASSOCIATION>/*[1:nil]*/ 
      }
      let swiftValue = SDAI.SET<ePROCESS_PRODUCT_ASSOCIATION>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \ePROCESS_PRODUCT_ASSOCIATION.PROCESS) )
      let value = SDAI.SET<ePROCESS_PRODUCT_ASSOCIATION>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _product_process_plan.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _product_process_plan.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _product_process_plan.WHERE_wr3(SELF: instance)
      return result
    }
