/* file: perpendicular_assembly_constraint.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- perpendicular_assembly_constraint (line:24511 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUPERTYPES:
	...
	11.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePERPENDICULAR_GEOMETRIC_CONSTRAINT``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePERPENDICULAR_ASSEMBLY_CONSTRAINT/PartialEntity``
*/
  public final class ePERPENDICULAR_ASSEMBLY_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<ePERPENDICULAR_ASSEMBLY_CONSTRAINT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePERPENDICULAR_ASSEMBLY_CONSTRAINT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePERPENDICULAR_ASSEMBLY_CONSTRAINT.PartialEntity
    ...
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePERPENDICULAR_GEOMETRIC_CONSTRAINT`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePERPENDICULAR_ASSEMBLY_CONSTRAINT.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "TRANSFORMATION_OPERATOR", 
        keyPath: \ePERPENDICULAR_ASSEMBLY_CONSTRAINT.TRANSFORMATION_OPERATOR, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", 
        keyPath: \ePERPENDICULAR_ASSEMBLY_CONSTRAINT.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", 
        keyPath: \ePERPENDICULAR_ASSEMBLY_CONSTRAINT.REFERENCE_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_1", 
        keyPath: \ePERPENDICULAR_ASSEMBLY_CONSTRAINT.REP_1, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_2", 
        keyPath: \ePERPENDICULAR_ASSEMBLY_CONSTRAINT.REP_2, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DIM", 
        keyPath: \ePERPENDICULAR_ASSEMBLY_CONSTRAINT.DIM, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePERPENDICULAR_ASSEMBLY_CONSTRAINT``
*/
