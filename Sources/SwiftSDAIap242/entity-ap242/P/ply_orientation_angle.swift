/* file: ply_orientation_angle.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class ePLY_ORIENTATION_ANGLE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var REP_1: eREINFORCEMENT_ORIENTATION_BASIS.PRef {
      get {
        return SDAI.UNWRAP( eREINFORCEMENT_ORIENTATION_BASIS.PRef( super_eREPRESENTATION_RELATIONSHIP
    ...
    public var REP_2: ePLY_ANGLE_REPRESENTATION.PRef {
      get {
        return SDAI.UNWRAP( ePLY_ANGLE_REPRESENTATION.PRef( super_eREPRESENTATION_RELATIONSHIP.partialEntity
          ._rep_2 ) )
      }
      set(newValue) {
        let partial = super_eREPRESENTATION_RELATIONSHIP.partialEntity
