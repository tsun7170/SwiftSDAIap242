/* file: procedural_representation.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- procedural_representation (line:26031 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROCEDURAL_SHAPE_REPRESENTATION``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROCEDURAL_REPRESENTATION/PartialEntity``
*/
  public final class ePROCEDURAL_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<ePROCEDURAL_REPRESENTATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePROCEDURAL_REPRESENTATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePROCEDURAL_REPRESENTATION.PartialEntity

    //MARK: SUPERTYPES
    public let super_eREPRESENTATION: eREPRESENTATION 	// [1]
    public var super_ePROCEDURAL_REPRESENTATION: ePROCEDURAL_REPRESENTATION { return self } 	// [2]

    //MARK: SUBTYPES
    public var sub_ePROCEDURAL_SHAPE_REPRESENTATION: ePROCEDURAL_SHAPE_REPRESENTATION? {	// [3]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROCEDURAL_REPRESENTATION`` )
    public var ITEMS: SDAI.SET<ePROCEDURAL_REPRESENTATION_SEQUENCE.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = super_eREPRESENTATION.partialEntity._items
        let SELF = super_eREPRESENTATION; SDAI.TOUCH(let:SELF)
        let value =         SDAI.SET<ePROCEDURAL_REPRESENTATION_SEQUENCE.PRef>(
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePROCEDURAL_REPRESENTATION.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \ePROCEDURAL_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \ePROCEDURAL_REPRESENTATION.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \ePROCEDURAL_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \ePROCEDURAL_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \ePROCEDURAL_REPRESENTATION.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROCEDURAL_REPRESENTATION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        ePROCEDURAL_REPRESENTATION.self
      }

      //ATTRIBUTES
      /* override var _items: SDAI.SET<ePROCEDURAL_REPRESENTATION_SEQUENCE.PRef>[1:(nil as SDAI.INTEGER?)] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
