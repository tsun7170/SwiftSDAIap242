/* file: primitive_2d_with_inner_boundary.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _primitive_2d_with_inner_boundary : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
    ...
    public static func WHERE_wr3(SELF: ePRIMITIVE_2D_WITH_INNER_BOUNDARY.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP1 /* SDAI.BOOLEAN? */ = OPEN_PATH_BASED_INNER_BOUNDARY( SDAI.SET<ePRIMITIVE_2D.PRef>(/*
          sCOMPOUND_INNER_AREA_BOUNDARY*/SELF.INNER_BOUNDARY) )
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_primitive_2d_with_inner_boundary``
*/
  public final class ePRIMITIVE_2D_WITH_INNER_BOUNDARY : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _primitive_2d_with_inner_boundary.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _primitive_2d_with_inner_boundary.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _primitive_2d_with_inner_boundary.WHERE_wr3(SELF: instance.pRef)
      return result
    }
