/* file: prescribed_path.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _prescribed_path : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /// EXPLICIT ATTRIBUTE 
    public internal(set) var _controlling_joints: (SDAI.SET<eKINEMATIC_JOINT>/*[1:6]*/ )?  // PLAIN EXPLICIT ATTRIBUTE
    ...
    public init(CONTROLLING_JOINTS: (SDAI.SET<eKINEMATIC_JOINT>/*[1:6]*/ )? ) {
    ...
    public required convenience init?(parameters: [P21Decode.ExchangeStructure.Parameter], exchangeStructure: P21Decode.ExchangeStructure) {
      ...
      guard case .success(let p0) = exchangeStructure.recoverOptionalParameter(as: SDAI.SET<eKINEMATIC_JOINT>.self, from: parameters[0])
...
```
*/
  public final class ePRESCRIBED_PATH : SDAI.EntityReference, @unchecked Sendable {
