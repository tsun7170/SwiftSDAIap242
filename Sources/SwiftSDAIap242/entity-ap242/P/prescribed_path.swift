/* file: prescribed_path.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _prescribed_path : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_prescribed_path``
*/
  public final class ePRESCRIBED_PATH : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _prescribed_path.self
    }
    /// partial entity reference
    public let partialEntity: _prescribed_path
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_prescribed_path.self) else { return nil }
