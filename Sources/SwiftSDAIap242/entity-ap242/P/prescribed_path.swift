/* file: prescribed_path.swift 	 generated: Tue Jan 20 19:20:51 2026 */
...
*/
  public final class ePRESCRIBED_PATH : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public var CONTROLLING_JOINTS: (SDAI.SET<eKINEMATIC_JOINT.PRef>/*[1:6]*/ )?  {
      get {
        return self.partialEntity._controlling_joints
      }
      set(newValue) {
        let partial = self.partialEntity
        partial._controlling_joints = newValue
      }
    }
    ...
    public var ITEMS: SDAI.SET<eKINEMATIC_PATH.PRef>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eKINEMATIC_PATH.PRef>( super_eREPRESENTATION.partialEntity._items ) )
      }
      set(newValue) {
    ...
    public var CONTEXT_OF_ITEMS: eGEOMETRIC_REPRESENTATION_CONTEXT_WITH_PARAMETER.PRef {
      get {
        if let resolved = eREPRESENTATION.PartialEntity._context_of_items__provider(complex: self.complexEntity) {
          let value = SDAI.UNWRAP( eGEOMETRIC_REPRESENTATION_CONTEXT_WITH_PARAMETER.PRef(resolved
            ._context_of_items__getter(complex: self.complexEntity)) )
          return value
        }
        else {
          return SDAI.UNWRAP( eGEOMETRIC_REPRESENTATION_CONTEXT_WITH_PARAMETER.PRef(super_eREPRESENTATION
