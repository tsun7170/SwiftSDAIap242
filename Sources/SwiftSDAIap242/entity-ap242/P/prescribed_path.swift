/* file: prescribed_path.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- prescribed_path (line:25837 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	prescribed_path
    ATTR:  controlling_joints,	TYPE: OPTIONAL SET [1 : 6] OF kinematic_joint -- EXPLICIT
...
- SUPERTYPES:
	...
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLINK_MOTION_REPRESENTATION_ALONG_PATH``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESCRIBED_PATH/PartialEntity``
*/
  public final class ePRESCRIBED_PATH : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<ePRESCRIBED_PATH>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePRESCRIBED_PATH.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePRESCRIBED_PATH.PartialEntity
    ...
    public var super_ePRESCRIBED_PATH: ePRESCRIBED_PATH { return self } 	// [3]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESCRIBED_PATH`` )
    public var CONTROLLING_JOINTS: (SDAI.SET<eKINEMATIC_JOINT.PRef>/*[1:6]*/ )?  {
      get {
        let originalValue = self.partialEntity._controlling_joints
        let value = SDAI.SET<eKINEMATIC_JOINT.PRef>( originalValue )
        return value
      }
      set(newValue) {
        let partial = self.partialEntity
        let SELF = self; SDAI.TOUCH(let:SELF)
        partial._controlling_joints = SDAI.SET<eKINEMATIC_JOINT.PRef>(
          bound1:SDAI.UNWRAP(1), bound2:6,
          newValue)
      }
    }

    /// __EXPLICIT REDEF__ attribute
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLINK_MOTION_REPRESENTATION_ALONG_PATH`` )
    public var ITEMS: SDAI.SET<eKINEMATIC_PATH.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        ...
        let value =         SDAI.SET<eKINEMATIC_PATH.PRef>(
    ...
    public var CONTEXT_OF_ITEMS: eGEOMETRIC_REPRESENTATION_CONTEXT_WITH_PARAMETER.PRef {
      get {
        if let resolved = eREPRESENTATION.PartialEntity._context_of_items__provider(complex: self.complexEntity) {
          ...
          let value = SDAI.UNWRAP( eGEOMETRIC_REPRESENTATION_CONTEXT_WITH_PARAMETER.PRef( originalValue ) )
          return value
        }
        else {
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePRESCRIBED_PATH.PartialEntity.self) else { return nil }
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESCRIBED_PATH``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        ePRESCRIBED_PATH.self
      }

      //ATTRIBUTES
      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _controlling_joints: (SDAI.SET<eKINEMATIC_JOINT.PRef>/*[1:6]*/ )?  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(CONTROLLING_JOINTS: (SDAI.SET<eKINEMATIC_JOINT.PRef>/*[1:6]*/ )? ) {

        if let CONTROLLING_JOINTS {
          self._controlling_joints = 
          SDAI.SET<eKINEMATIC_JOINT.PRef>(
            from: CONTROLLING_JOINTS.asSwiftType, 
            bound1:SDAI.UNWRAP(1), bound2:6)
        }
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( CONTROLLING_JOINTS: original._controlling_joints )
      }
      ...
      public required convenience init?(
        ...
        guard case .success(let p0) = exchangeStructure.recoverOptionalParameter(as: SDAI.SET<
          eKINEMATIC_JOINT.PRef>.self, from: parameters[0])
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]CONTROLLING_JOINTS for partial entity(\(Self.entityName)) constructor"); return nil }
