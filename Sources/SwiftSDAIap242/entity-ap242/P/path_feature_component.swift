/* file: path_feature_component.swift 	 generated: Sun Oct 31 15:32:10 2021 */
  ...
  ENTITY path_feature_component
    ...
    WHERE
      ...
      wr13: ( ( NOT ( SELF.description = 'complex' ) ) OR ( SIZEOF( QUERY ( pd <* USEDIN( SELF, 
                ...
                = 1 ) ) ) ) = 0 ) );
  END_ENTITY; -- path_feature_component (line:23727 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _path_feature_component : SDAI.PartialEntity {
...
```
*/
  public final class ePATH_FEATURE_COMPONENT : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "PATH_FEATURE_COMPONENT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "PRODUCT_DEFINITIONAL", keyPath: \ePATH_FEATURE_COMPONENT.PRODUCT_DEFINITIONAL, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \ePATH_FEATURE_COMPONENT.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "OF_SHAPE", keyPath: \ePATH_FEATURE_COMPONENT.OF_SHAPE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \ePATH_FEATURE_COMPONENT.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \ePATH_FEATURE_COMPONENT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
