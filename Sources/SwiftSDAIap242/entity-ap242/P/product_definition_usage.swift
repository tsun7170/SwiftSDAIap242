/* file: product_definition_usage.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_USAGE/PartialEntity``
*/
  public final class ePRODUCT_DEFINITION_USAGE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePRODUCT_DEFINITION_USAGE.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePRODUCT_DEFINITION_USAGE.PartialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePRODUCT_DEFINITION_USAGE.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = ePRODUCT_DEFINITION_USAGE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addUniquenessRule(label:"UNIQUE_ur1", rule: ePRODUCT_DEFINITION_USAGE.PartialEntity.UNIQUE_ur1)
