/* file: product_definition_usage.swift 	 generated: Thu Mar  5 17:54:18 2026 */
    ...
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: ePRODUCT_DEFINITION_USAGE.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP3 /* SDAI.AGGREGATE<sPRODUCT_DEFINITION_OR_REFERENCE> */ = SDAI.SET<
          ...
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?),  ([ SDAI.AIE(_TEMP2) ] 
            as [SDAI.AggregationInitializerElement<sPRODUCT_DEFINITION_OR_REFERENCE>]) )
