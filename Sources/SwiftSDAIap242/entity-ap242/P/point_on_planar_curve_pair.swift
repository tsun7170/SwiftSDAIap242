/* file: point_on_planar_curve_pair.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY point_on_planar_curve_pair
    ...
    WHERE
      ...
      wr2: ( SIZEOF( QUERY ( lr <* SELF\kinematic_pair.associated_link_representations_1 | ( NOT ( 
               ...
               = 0 );
  END_ENTITY; -- point_on_planar_curve_pair (line:25244 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _point_on_planar_curve_pair : SDAI.PartialEntity {
...
```
*/
  public final class ePOINT_ON_PLANAR_CURVE_PAIR : SDAI.EntityReference {
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``ePOINT_ON_PLANAR_CURVE_PAIR`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "POINT_ON_PLANAR_CURVE_PAIR", type: self, explicitAttributeCount: 2)
      ...
      entityDef.addAttribute(name: "LOWER_LIMIT_PITCH", keyPath: \ePOINT_ON_PLANAR_CURVE_PAIR.LOWER_LIMIT_PITCH, 
        kind: .explicitOptional, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RANGE_ON_PAIR_CURVE", keyPath: \ePOINT_ON_PLANAR_CURVE_PAIR.RANGE_ON_PAIR_CURVE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \ePOINT_ON_PLANAR_CURVE_PAIR.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "LINK_REPRESENTATION_ASSOCIATIONS", keyPath: \ePOINT_ON_PLANAR_CURVE_PAIR.LINK_REPRESENTATION_ASSOCIATIONS, 
        kind: .inverse, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ORIENTATION", keyPath: \ePOINT_ON_PLANAR_CURVE_PAIR.ORIENTATION, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "TRANSFORM_ITEM_1", keyPath: \ePOINT_ON_PLANAR_CURVE_PAIR.TRANSFORM_ITEM_1, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "TRANSFORM_ITEM_2", keyPath: \ePOINT_ON_PLANAR_CURVE_PAIR.TRANSFORM_ITEM_2, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "UPPER_LIMIT_ROLL", keyPath: \ePOINT_ON_PLANAR_CURVE_PAIR.UPPER_LIMIT_ROLL, 
        kind: .explicitOptional, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "LOWER_LIMIT_YAW", keyPath: \ePOINT_ON_PLANAR_CURVE_PAIR.LOWER_LIMIT_YAW, 
        kind: .explicitOptional, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "PAIR_CURVE", keyPath: \ePOINT_ON_PLANAR_CURVE_PAIR.PAIR_CURVE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "JOINT", keyPath: \ePOINT_ON_PLANAR_CURVE_PAIR.JOINT, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "UPPER_LIMIT_PITCH", keyPath: \ePOINT_ON_PLANAR_CURVE_PAIR.UPPER_LIMIT_PITCH, 
        kind: .explicitOptional, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "UPPER_LIMIT_YAW", keyPath: \ePOINT_ON_PLANAR_CURVE_PAIR.UPPER_LIMIT_YAW, 
        kind: .explicitOptional, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSOCIATED_LINK_REPRESENTATIONS_1", keyPath: \ePOINT_ON_PLANAR_CURVE_PAIR.ASSOCIATED_LINK_REPRESENTATIONS_1, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSOCIATED_LINK_REPRESENTATIONS_2", keyPath: \ePOINT_ON_PLANAR_CURVE_PAIR.ASSOCIATED_LINK_REPRESENTATIONS_2, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "LOWER_LIMIT_ROLL", keyPath: \ePOINT_ON_PLANAR_CURVE_PAIR.LOWER_LIMIT_ROLL, 
        kind: .explicitOptional, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", keyPath: \ePOINT_ON_PLANAR_CURVE_PAIR.DIM, 
