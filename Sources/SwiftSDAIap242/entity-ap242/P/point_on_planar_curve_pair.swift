/* file: point_on_planar_curve_pair.swift 	 generated: Sun Oct 31 15:32:10 2021 */
  ...
  ENTITY point_on_planar_curve_pair
    ...
    WHERE
      ...
      wr2: ( SIZEOF( QUERY ( lr <* SELF\kinematic_pair.associated_link_representations_1 | ( NOT ( 
               ...
               = 0 );
  END_ENTITY; -- point_on_planar_curve_pair (line:25230 file:ap242ed2_mim_lf_v1.101.TY.exp)
