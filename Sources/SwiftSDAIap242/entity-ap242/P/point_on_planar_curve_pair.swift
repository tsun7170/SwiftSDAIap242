/* file: point_on_planar_curve_pair.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _point_on_planar_curve_pair : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /// EXPLICIT ATTRIBUTE 
    public internal(set) var _pair_curve: eCURVE // PLAIN EXPLICIT ATTRIBUTE
    ...
    public static func WHERE_wr1(SELF: ePOINT_ON_PLANAR_CURVE_PAIR?) -> SDAI.LOGICAL {
      ...
      let _TEMP3 = _TEMP2?.QUERY{ R in 
          ...
          let _TEMP1 = R.ITEMS
          let _TEMP2 = SDAI.aggregate(_TEMP1, contains: sKINEMATIC_LINK_REPRESENTATION_ITEMS(/*eCURVE*/SELF.PAIR_CURVE))
          let _TEMP3 =  !_TEMP2
          return _TEMP3 }
    ...
    public static func WHERE_wr2(SELF: ePOINT_ON_PLANAR_CURVE_PAIR?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public init(PAIR_CURVE: eCURVE, ORIENTATION: SDAI.BOOLEAN) {
...
```
*/
  public final class ePOINT_ON_PLANAR_CURVE_PAIR : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _point_on_planar_curve_pair.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _point_on_planar_curve_pair.WHERE_wr2(SELF: instance)
      return result
    }
