/* file: point_on_planar_curve_pair.swift 	 generated: Mon Jan  3 16:32:52 2022 */
  ...
  ENTITY point_on_planar_curve_pair
    ...
    WHERE
      ...
      wr2: ( SIZEOF( QUERY ( lr <* SELF\kinematic_pair.associated_link_representations_1 | ( NOT ( 
               ...
               = 0 );
  END_ENTITY; -- point_on_planar_curve_pair (line:25245 file:ap242ed2_mim_lf_v1.101.TY.exp)
