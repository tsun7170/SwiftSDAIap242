/* file: physical_element_usage.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _physical_element_usage : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_physical_element_usage``
*/
  public final class ePHYSICAL_ELEMENT_USAGE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _physical_element_usage.self
    }
    /// partial entity reference
    public let partialEntity: _physical_element_usage
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_physical_element_usage.self) else { return nil }
