/* file: pmi_requirement_item_association.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _pmi_requirement_item_association : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public required convenience init?(
      ...
      guard case .success(let p0) = exchangeStructure.recoverRequiredParameter(as: eCHARACTERIZED_OBJECT.PRef.self, from: parameters[0])
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_pmi_requirement_item_association``
*/
