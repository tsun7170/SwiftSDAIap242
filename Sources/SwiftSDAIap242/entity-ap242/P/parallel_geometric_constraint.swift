/* file: parallel_geometric_constraint.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- parallel_geometric_constraint (line:23643 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	...
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARALLEL_ASSEMBLY_CONSTRAINT``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePGC_WITH_DIMENSION``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARALLEL_GEOMETRIC_CONSTRAINT/PartialEntity``
*/
  public final class ePARALLEL_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<ePARALLEL_GEOMETRIC_CONSTRAINT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePARALLEL_GEOMETRIC_CONSTRAINT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePARALLEL_GEOMETRIC_CONSTRAINT.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARALLEL_GEOMETRIC_CONSTRAINT`` )
    ...
    public var DISTANCE_VALUE: tNON_NEGATIVE_LENGTH_MEASURE?  {
      get {
        let originalValue = sub_ePGC_WITH_DIMENSION?.partialEntity._distance_value
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePARALLEL_GEOMETRIC_CONSTRAINT.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \ePARALLEL_GEOMETRIC_CONSTRAINT.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", 
        keyPath: \ePARALLEL_GEOMETRIC_CONSTRAINT.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", 
        keyPath: \ePARALLEL_GEOMETRIC_CONSTRAINT.REFERENCE_ELEMENTS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DISTANCE_VALUE", 
        keyPath: \ePARALLEL_GEOMETRIC_CONSTRAINT.DISTANCE_VALUE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \ePARALLEL_GEOMETRIC_CONSTRAINT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NEGATIVE_DIRECTION", 
        keyPath: \ePARALLEL_GEOMETRIC_CONSTRAINT.NEGATIVE_DIRECTION, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", 
        keyPath: \ePARALLEL_GEOMETRIC_CONSTRAINT.DIM, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARALLEL_GEOMETRIC_CONSTRAINT``
*/
