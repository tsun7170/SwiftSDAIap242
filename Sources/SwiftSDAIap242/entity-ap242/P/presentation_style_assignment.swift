/* file: presentation_style_assignment.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- presentation_style_assignment (line:25712 file:ap242ed2_mim_lf_v1.101.TY.exp)
    ...
    public static func WHERE_wr1(SELF: ePRESENTATION_STYLE_ASSIGNMENT?) -> SDAI.LOGICAL {
      ...
      let _TEMP1 = SELF.STYLES.QUERY{ STYLE1 in 
          ...
          let _TEMP2 = _TEMP1?.QUERY{ STYLE2 in 
              ...
              let _TEMP6 = SDAI.FORCE_OPTIONAL(_TEMP4) * _TEMP5
