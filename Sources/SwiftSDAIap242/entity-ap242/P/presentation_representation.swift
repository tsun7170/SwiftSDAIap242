/* file: presentation_representation.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  ENTITY presentation_representation
    ...
    WHERE
      ...
      wr2: ( ( 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PRESENTATION_AREA' IN TYPEOF( SELF ) ) OR ( 
               ...
               > 0 ) ) ) > 0 ) ) ) > 0 ) );
  END_ENTITY; -- presentation_representation (line:25859 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMECHANICAL_DESIGN_SHADED_PRESENTATION_AREA``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDRAWING_SHEET_REVISION``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESENTATION_AREA``
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePICTURE_REPRESENTATION``
	6.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESENTATION_VIEW``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESENTATION_REPRESENTATION/PartialEntity``
*/
  public final class ePRESENTATION_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<ePRESENTATION_REPRESENTATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePRESENTATION_REPRESENTATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePRESENTATION_REPRESENTATION.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESENTATION_REPRESENTATION`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePRESENTATION_REPRESENTATION.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = ePRESENTATION_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = ePRESENTATION_REPRESENTATION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
    ...
    ENTITY presentation_representation
      ...
      WHERE
        ...
        wr2: ( ( 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PRESENTATION_AREA' IN TYPEOF( SELF ) ) OR 
                 ...
                 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PRESENTATION_REPRESENTATION'  IN TYPEOF( 
                 prr\representation_relationship.rep_1 ) ) ) ) > 0 ) OR ( SIZEOF( QUERY ( rm <* USEDIN( SELF, 
                 ...
                 + 'MAPPED_ITEM.MAPPING_SOURCE'  ) | ( SIZEOF( QUERY ( rep <* using_representations( mi ) | 
                 ( 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PRESENTATION_REPRESENTATION' IN TYPEOF( 
                 rep ) ) ) ) > 0 ) ) ) > 0 ) ) ) > 0 ) );
    END_ENTITY; -- presentation_representation (line:25859 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESENTATION_REPRESENTATION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: ePRESENTATION_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP3 /* eGEOMETRIC_REPRESENTATION_CONTEXT.PRef? */ = _TEMP2?.GROUP_REF(
          eGEOMETRIC_REPRESENTATION_CONTEXT.self)
        let _TEMP4 /* tDIMENSION_COUNT? */ = _TEMP3?.COORDINATE_SPACE_DIMENSION
        let _TEMP5 /* SDAI.LOGICAL */ = _TEMP4 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(2))
        return _TEMP5
      }
      public static func WHERE_wr2(SELF: ePRESENTATION_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: ePRESENTATION_AREA.self )
        ...
        let _TEMP3 /* SDAI.BAG<SDAI.GENERIC_ENTITY> */ = _TEMP2
          .QUERY{ PRR in 
            ...
            let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( (PRR.GROUP_REF(eREPRESENTATION_RELATIONSHIP.self))?.REP_1, 
        ...
        let _TEMP8 /* SDAI.BAG<SDAI.GENERIC_ENTITY> */ = _TEMP7
          .QUERY{ RM in 
            ...
            let _TEMP1 /* SDAI.BAG<SDAI.GENERIC_ENTITY> */ = SDAI.USEDIN(T: RM, 
            ...
            let _TEMP2 /* SDAI.BAG<SDAI.GENERIC_ENTITY> */ = _TEMP1
              .QUERY{ MI in 
                ...
                let _TEMP1 /* SDAI.SET<eREPRESENTATION.PRef>? */ = USING_REPRESENTATIONS( 
                    sFOUNDED_ITEM_SELECT(/*SDAI.GENERIC_ENTITY*/MI) )
                let _TEMP2 /* SDAI.SET<eREPRESENTATION.PRef>? */ = _TEMP1?
                  .QUERY{ REP in 
                    // QUERY BODY

                    let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( REP, IS: ePRESENTATION_REPRESENTATION.self )
                    return _TEMP1
                    // END QUERY BODY
                  }
