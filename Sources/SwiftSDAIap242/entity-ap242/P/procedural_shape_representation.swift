/* file: procedural_shape_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _procedural_shape_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _items: SDAI.SET<ePROCEDURAL_SHAPE_REPRESENTATION_SEQUENCE>[1:nil] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
...
```
*/
  public final class ePROCEDURAL_SHAPE_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var ITEMS: SDAI.SET<ePROCEDURAL_SHAPE_REPRESENTATION_SEQUENCE>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<ePROCEDURAL_SHAPE_REPRESENTATION_SEQUENCE>( super_eREPRESENTATION
