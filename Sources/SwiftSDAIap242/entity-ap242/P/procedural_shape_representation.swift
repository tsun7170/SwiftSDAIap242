/* file: procedural_shape_representation.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- procedural_shape_representation (line:26045 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(2)	procedural_representation
    REDCR: items,	TYPE: SET [1 : ?] OF procedural_representation_sequence -- EXPLICIT
      -- OVERRIDING ENTITY: representation


  SUPER- ENTITY(3)	shape_representation
    (no local attributes)

  ENTITY(SELF)	procedural_shape_representation
...
- SUPERTYPES:
	...
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROCEDURAL_REPRESENTATION``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_REPRESENTATION``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROCEDURAL_SHAPE_REPRESENTATION/PartialEntity``
*/
  public final class ePROCEDURAL_SHAPE_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<ePROCEDURAL_SHAPE_REPRESENTATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePROCEDURAL_SHAPE_REPRESENTATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePROCEDURAL_SHAPE_REPRESENTATION.PartialEntity

    //MARK: SUPERTYPES
    public let super_eREPRESENTATION: eREPRESENTATION 	// [1]
    public let super_ePROCEDURAL_REPRESENTATION: ePROCEDURAL_REPRESENTATION 	// [2]
    public let super_eSHAPE_REPRESENTATION: eSHAPE_REPRESENTATION 	// [3]
    public var super_ePROCEDURAL_SHAPE_REPRESENTATION: ePROCEDURAL_SHAPE_REPRESENTATION { return self } 	// [4]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROCEDURAL_SHAPE_REPRESENTATION`` )
    public var ITEMS: SDAI.SET<ePROCEDURAL_SHAPE_REPRESENTATION_SEQUENCE.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = super_eREPRESENTATION.partialEntity._items
        let SELF = super_eREPRESENTATION; SDAI.TOUCH(let:SELF)
        let value =         SDAI.SET<ePROCEDURAL_SHAPE_REPRESENTATION_SEQUENCE.PRef>(
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePROCEDURAL_SHAPE_REPRESENTATION.PartialEntity.self) else { return nil }
      ...
      guard let super2 = complexEntity?.entityReference(ePROCEDURAL_REPRESENTATION.self) else { return nil }
      self.super_ePROCEDURAL_REPRESENTATION = super2

      guard let super3 = complexEntity?.entityReference(eSHAPE_REPRESENTATION.self) else { return nil }
      self.super_eSHAPE_REPRESENTATION = super3
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: ePROCEDURAL_REPRESENTATION.self)
      entityDef.add(supertype: eSHAPE_REPRESENTATION.self)
      entityDef.add(supertype: ePROCEDURAL_SHAPE_REPRESENTATION.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \ePROCEDURAL_SHAPE_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \ePROCEDURAL_SHAPE_REPRESENTATION.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \ePROCEDURAL_SHAPE_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \ePROCEDURAL_SHAPE_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \ePROCEDURAL_SHAPE_REPRESENTATION.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROCEDURAL_SHAPE_REPRESENTATION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        ePROCEDURAL_SHAPE_REPRESENTATION.self
      }

      //ATTRIBUTES
      /* override var _items: SDAI.SET<ePROCEDURAL_SHAPE_REPRESENTATION_SEQUENCE.PRef>[1:(nil as SDAI.INTEGER?)] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
