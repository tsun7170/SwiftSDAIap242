/* file: product_definition_occurrence.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _product_definition_occurrence : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //internal var _assembly_usages: SDAI.SET<eASSEMBLY_COMPONENT_USAGE> 	(SEE CORRESPONDING ENTITY REFERENCE DEFINITION)

    // INVERSE AGGREGATE ATTRIBUTE
    // observing _product_definition_specified_occurrence ._occurrence_usage
    //internal var _child_occurrences: SDAI.SET<ePRODUCT_DEFINITION_SPECIFIED_OCCURRENCE> 	(SEE CORRESPONDING ENTITY REFERENCE DEFINITION)
...
```
*/
  public final class ePRODUCT_DEFINITION_OCCURRENCE : SDAI.EntityReference, @unchecked Sendable {
