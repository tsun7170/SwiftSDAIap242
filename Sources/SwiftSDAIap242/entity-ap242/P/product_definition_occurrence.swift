/* file: product_definition_occurrence.swift 	 generated: Tue Oct 14 17:54:07 2025 */
...
/*
  ...
  END_ENTITY; -- product_definition_occurrence (line:26120 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  public final class ePRODUCT_DEFINITION_OCCURRENCE : SDAI.EntityReference, SDAIDualModeReference, 
    ...
    get {
      ...
      let swiftValue = SDAI.SET<ePRODUCT_DEFINITION_SPECIFIED_OCCURRENCE.PRef>/*[0:nil]*/ .SwiftType( self.referencingEntities(for: \ePRODUCT_DEFINITION_SPECIFIED_OCCURRENCE.OCCURRENCE_USAGE) )
      let value = SDAI.SET<ePRODUCT_DEFINITION_SPECIFIED_OCCURRENCE.PRef>/*[0:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
    ...
    get {
      ...
      let swiftValue = SDAI.SET<eASSEMBLY_COMPONENT_USAGE.PRef>/*[0:nil]*/ .SwiftType( self.referencingEntities(for: \eASSEMBLY_COMPONENT_USAGE.RELATED_PRODUCT_DEFINITION) )
      let value = SDAI.SET<eASSEMBLY_COMPONENT_USAGE.PRef>/*[0:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
        SDAI.INTEGER(0)), bound2: (nil as SDAI.INTEGER?))
