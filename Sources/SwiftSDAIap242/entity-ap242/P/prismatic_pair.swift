/* file: prismatic_pair.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class ePRISMATIC_PAIR : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public var UPPER_LIMIT_ACTUAL_TRANSLATION: tLENGTH_MEASURE?  {
      get {
        return sub_ePRISMATIC_PAIR_WITH_RANGE?.partialEntity._upper_limit_actual_translation
      }
      set(newValue) {
        guard let partial = sub_ePRISMATIC_PAIR_WITH_RANGE?.super_ePRISMATIC_PAIR_WITH_RANGE.partialEntity
          else { return }
    ...
    public var LOWER_LIMIT_ACTUAL_TRANSLATION: tLENGTH_MEASURE?  {
      get {
        return sub_ePRISMATIC_PAIR_WITH_RANGE?.partialEntity._lower_limit_actual_translation
      }
      set(newValue) {
        guard let partial = sub_ePRISMATIC_PAIR_WITH_RANGE?.super_ePRISMATIC_PAIR_WITH_RANGE.partialEntity
          else { return }
