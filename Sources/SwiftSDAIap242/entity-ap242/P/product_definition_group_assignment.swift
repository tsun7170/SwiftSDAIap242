/* file: product_definition_group_assignment.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- product_definition_group_assignment (line:26096 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _product_definition_group_assignment : SDAI.PartialEntity {
...
```
*/
  public final class ePRODUCT_DEFINITION_GROUP_ASSIGNMENT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``ePRODUCT_DEFINITION_GROUP_ASSIGNMENT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "PRODUCT_DEFINITION_GROUP_ASSIGNMENT", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "ROLE", keyPath: \ePRODUCT_DEFINITION_GROUP_ASSIGNMENT.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \ePRODUCT_DEFINITION_GROUP_ASSIGNMENT.ITEMS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_GROUP", keyPath: \ePRODUCT_DEFINITION_GROUP_ASSIGNMENT.ASSIGNED_GROUP, 
