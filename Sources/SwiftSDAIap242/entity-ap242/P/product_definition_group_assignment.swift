/* file: product_definition_group_assignment.swift 	 generated: Sun Jan 18 16:59:32 2026 */
    ...
    public var ASSIGNED_GROUP: ePRODUCT_DEFINITION_ELEMENT_RELATIONSHIP.PRef {
      get {
        if let resolved = eGROUP_ASSIGNMENT.PartialEntity._assigned_group__provider(complex: self.complexEntity) {
          let value = SDAI.UNWRAP( ePRODUCT_DEFINITION_ELEMENT_RELATIONSHIP.PRef(resolved
            ._assigned_group__getter(complex: self.complexEntity)) )
          return value
        }
        else {
          return SDAI.UNWRAP( ePRODUCT_DEFINITION_ELEMENT_RELATIONSHIP.PRef(super_eGROUP_ASSIGNMENT
            .partialEntity._assigned_group) )
        }
      }
      set(newValue) {
