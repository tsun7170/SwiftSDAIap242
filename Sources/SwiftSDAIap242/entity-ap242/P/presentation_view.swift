/* file: presentation_view.swift 	 generated: Mon Dec 15 17:41:04 2025 */
...
*/
  ...
  public final class _presentation_view : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_presentation_view``
*/
  public final class ePRESENTATION_VIEW : SDAI.EntityReference, SDAIDualModeReference, @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _presentation_view.self
    }
    /// partial entity reference
    public let partialEntity: _presentation_view
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_presentation_view.self) else { return nil }
