/* file: presentation_view.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- presentation_view (line:25945 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	presentation_view
    (no local attributes)

  SUB- ENTITY(4)	picture_representation
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePICTURE_REPRESENTATION``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESENTATION_VIEW/PartialEntity``
*/
  public final class ePRESENTATION_VIEW : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<ePRESENTATION_VIEW>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePRESENTATION_VIEW.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePRESENTATION_VIEW.PartialEntity
    ...
    public var super_ePRESENTATION_VIEW: ePRESENTATION_VIEW { return self } 	// [3]

    //MARK: SUBTYPES
    public var sub_ePICTURE_REPRESENTATION: ePICTURE_REPRESENTATION? {	// [4]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePRESENTATION_VIEW.PartialEntity.self) else { return nil }
