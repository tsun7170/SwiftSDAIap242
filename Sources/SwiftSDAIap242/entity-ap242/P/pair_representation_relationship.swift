/* file: pair_representation_relationship.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _pair_representation_relationship : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: ePAIR_REPRESENTATION_RELATIONSHIP.PRef?) -> SDAI.LOGICAL {
      ...
      let _TEMP4 /* SDAI.LOGICAL */ = SDAI.aggregate( _TEMP3, contains: sKINEMATIC_LINK_REPRESENTATION_ITEMS(/*
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_pair_representation_relationship``
*/
  public final class ePAIR_REPRESENTATION_RELATIONSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _pair_representation_relationship.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _pair_representation_relationship.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = _pair_representation_relationship.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = _pair_representation_relationship.WHERE_wr4(SELF: instance.pRef)
      return result
    }
