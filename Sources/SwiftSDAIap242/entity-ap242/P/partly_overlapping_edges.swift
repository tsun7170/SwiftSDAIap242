/* file: partly_overlapping_edges.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  ENTITY partly_overlapping_edges
    ...
    WHERE
      ...
      wr3: validate_inspected_elements_type( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               + 'EDGE_CURVE' , 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.EDGE_CURVE'] );
      wr4: validate_locations_of_extreme_value_type( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               + 'SUBEDGE' , 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.SUBEDGE'] );
      wr5: validate_accuracy_types( SELF, [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.LENGTH_MEASURE'] );
  END_ENTITY; -- partly_overlapping_edges (line:23829 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(7)	topology_related_to_overlapping_geometry
    (no local attributes)

  ENTITY(SELF)	partly_overlapping_edges
...
- SUPERTYPES:
	...
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTOPOLOGY_RELATED_TO_OVERLAPPING_GEOMETRY``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARTLY_OVERLAPPING_EDGES/PartialEntity``
*/
  public final class ePARTLY_OVERLAPPING_EDGES : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<ePARTLY_OVERLAPPING_EDGES>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePARTLY_OVERLAPPING_EDGES.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePARTLY_OVERLAPPING_EDGES.PartialEntity
    ...
    public let super_eTOPOLOGY_RELATED_TO_OVERLAPPING_GEOMETRY: eTOPOLOGY_RELATED_TO_OVERLAPPING_GEOMETRY 	// [7]
    public var super_ePARTLY_OVERLAPPING_EDGES: ePARTLY_OVERLAPPING_EDGES { return self } 	// [8]

    //MARK: SUBTYPES

    //MARK: ATTRIBUTES
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARTLY_OVERLAPPING_EDGES`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePARTLY_OVERLAPPING_EDGES.PartialEntity.self) else { return nil }
      ...
      guard let super7 = complexEntity?.entityReference(eTOPOLOGY_RELATED_TO_OVERLAPPING_GEOMETRY.self) else { return nil }
      self.super_eTOPOLOGY_RELATED_TO_OVERLAPPING_GEOMETRY = super7
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = ePARTLY_OVERLAPPING_EDGES.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = ePARTLY_OVERLAPPING_EDGES.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix + " .WHERE_wr3"] = ePARTLY_OVERLAPPING_EDGES.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix + " .WHERE_wr4"] = ePARTLY_OVERLAPPING_EDGES.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix + " .WHERE_wr5"] = ePARTLY_OVERLAPPING_EDGES.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: ePARTLY_OVERLAPPING_EDGES.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "INTERFERENCE_TOLERANCE", 
        keyPath: \ePARTLY_OVERLAPPING_EDGES.INTERFERENCE_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", 
        keyPath: \ePARTLY_OVERLAPPING_EDGES.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \ePARTLY_OVERLAPPING_EDGES.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARTLY_OVERLAPPING_EDGES``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        ePARTLY_OVERLAPPING_EDGES.self
      }
      ...
      public static func WHERE_wr1(SELF: ePARTLY_OVERLAPPING_EDGES.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: ePARTLY_OVERLAPPING_EDGES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.LOGICAL */ = VALIDATE_MEASURED_DATA_TYPE( 
            EI: eSHAPE_DATA_QUALITY_CRITERION.PRef(/*ePARTLY_OVERLAPPING_EDGES.PRef*/SELF), 
            TYPE_STRING: SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.LENGTH_MEASURE") )
        return _TEMP1
      }
      public static func WHERE_wr3(SELF: ePARTLY_OVERLAPPING_EDGES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public static func WHERE_wr4(SELF: ePARTLY_OVERLAPPING_EDGES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.AGGREGATE<SDAI.STRING> */ = SDAI.BAG<SDAI.STRING>( ([ 
            SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.SUBEDGE")), 
            SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.SUBEDGE")) ] 
            as [SDAI.AggregationInitializerElement<SDAI.STRING>]) )
      ...
      public static func WHERE_wr5(SELF: ePARTLY_OVERLAPPING_EDGES.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      public init(INTERFERENCE_TOLERANCE: tLENGTH_MEASURE) {
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( INTERFERENCE_TOLERANCE: original._interference_tolerance )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]INTERFERENCE_TOLERANCE for partial entity(\(Self.entityName)) constructor"); return nil }

        self.init( INTERFERENCE_TOLERANCE: p0 )
      }
    }
  }
}
