/* file: partly_overlapping_edges.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- partly_overlapping_edges (line:23648 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _partly_overlapping_edges : SDAI.PartialEntity {
...
```
*/
  public final class ePARTLY_OVERLAPPING_EDGES : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``ePARTLY_OVERLAPPING_EDGES`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "PARTLY_OVERLAPPING_EDGES", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "INTERFERENCE_TOLERANCE", keyPath: \ePARTLY_OVERLAPPING_EDGES.INTERFERENCE_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \ePARTLY_OVERLAPPING_EDGES.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \ePARTLY_OVERLAPPING_EDGES.NAME, 
