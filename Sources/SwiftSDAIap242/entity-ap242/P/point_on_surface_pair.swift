/* file: point_on_surface_pair.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _point_on_surface_pair : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_point_on_surface_pair``
*/
  public final class ePOINT_ON_SURFACE_PAIR : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _point_on_surface_pair.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _point_on_surface_pair.WHERE_wr2(SELF: instance.pRef)
      return result
    }
