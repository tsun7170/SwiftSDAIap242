/* file: product_definition_occurrence_reference_with_local_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
```
*/
  public final class ePRODUCT_DEFINITION_OCCURRENCE_REFERENCE_WITH_LOCAL_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    get {
      ...
      let swiftValue = SDAI.SET<ePRODUCT_DEFINITION_SPECIFIED_OCCURRENCE>/*[0:nil]*/ .SwiftType( self.referencingEntities(for: \ePRODUCT_DEFINITION_SPECIFIED_OCCURRENCE.OCCURRENCE_USAGE) )
      let value = SDAI.SET<ePRODUCT_DEFINITION_SPECIFIED_OCCURRENCE>/*[0:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"ASSEMBLY_USAGES") {
        return cached.value as! SDAI.SET<eASSEMBLY_COMPONENT_USAGE>/*[0:nil]*/ 
      }
      let swiftValue = SDAI.SET<eASSEMBLY_COMPONENT_USAGE>/*[0:nil]*/ .SwiftType( self.referencingEntities(for: \eASSEMBLY_COMPONENT_USAGE.RELATED_PRODUCT_DEFINITION) )
      let value = SDAI.SET<eASSEMBLY_COMPONENT_USAGE>/*[0:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(SDAI.INTEGER(0)), bound2: (nil as 
        SDAI.INTEGER?))
