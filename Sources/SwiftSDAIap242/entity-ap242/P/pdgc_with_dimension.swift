/* file: pdgc_with_dimension.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- pdgc_with_dimension (line:24502 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(7)	point_distance_geometric_constraint
  ...
  ENTITY(SELF)	pdgc_with_dimension
...
- SUPERTYPES:
	...
	7.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePDGC_WITH_DIMENSION/PartialEntity``
*/
  public final class ePDGC_WITH_DIMENSION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<ePDGC_WITH_DIMENSION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePDGC_WITH_DIMENSION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePDGC_WITH_DIMENSION.PartialEntity
    ...
    public let super_ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT: ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT 	// [7]
    public var super_ePDGC_WITH_DIMENSION: ePDGC_WITH_DIMENSION { return self } 	// [8]
    ...
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT`` )
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePDGC_WITH_DIMENSION`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePDGC_WITH_DIMENSION.PartialEntity.self) else { return nil }
      ...
      guard let super7 = complexEntity?.entityReference(ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT.self) else { return nil }
      self.super_ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT = super7
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePDGC_WITH_DIMENSION``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        ePDGC_WITH_DIMENSION.self
      }
