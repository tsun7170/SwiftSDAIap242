/* file: pdgc_with_dimension.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- pdgc_with_dimension (line:24307 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _pdgc_with_dimension : SDAI.PartialEntity {
...
```
*/
  public final class ePDGC_WITH_DIMENSION : SDAI.EntityReference {
    ...
    /// - origin: SUPER( ``ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT`` )
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SELF( ``ePDGC_WITH_DIMENSION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "PDGC_WITH_DIMENSION", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \ePDGC_WITH_DIMENSION.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", keyPath: \ePDGC_WITH_DIMENSION.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", keyPath: \ePDGC_WITH_DIMENSION.REFERENCE_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DISTANCE_VALUE", keyPath: \ePDGC_WITH_DIMENSION.DISTANCE_VALUE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \ePDGC_WITH_DIMENSION.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", keyPath: \ePDGC_WITH_DIMENSION.DIM, 
