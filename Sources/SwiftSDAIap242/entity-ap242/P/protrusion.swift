/* file: protrusion.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _protrusion : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: ePROTRUSION?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: ePROTRUSION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ PDS in 
          ...
          let _TEMP2 = _TEMP1.QUERY{ SA_OCC in 
              ...
              let _TEMP5 = _TEMP4.QUERY{ SDR in 
                  ...
                  let _TEMP1 = /*runtime*/SDR.RELATING_SHAPE_ASPECT
    ...
    public static func WHERE_wr3(SELF: ePROTRUSION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = GET_PROPERTY_DEFINITION_REPRESENTATIONS(sCHARACTERIZED_DEFINITION(/*ePROTRUSION*/SELF))
      let _TEMP2 = _TEMP1?.QUERY{ PDR in 
...
```
*/
  public final class ePROTRUSION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _protrusion.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _protrusion.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _protrusion.WHERE_wr3(SELF: instance)
      return result
    }
