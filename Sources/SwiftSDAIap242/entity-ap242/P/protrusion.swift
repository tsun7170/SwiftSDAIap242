/* file: protrusion.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY protrusion
    ...
    WHERE
      ...
      wr3: ( SIZEOF( QUERY ( pdr <* get_property_definition_representations( SELF ) | ( ( 
               ...
               >= 0 );
  END_ENTITY; -- protrusion (line:26638 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _protrusion : SDAI.PartialEntity {
...
```
*/
  public final class ePROTRUSION : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "PROTRUSION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \ePROTRUSION.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \ePROTRUSION.NAME, 
