/* file: product_identification.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _product_identification : SDAI.PartialEntity, SDAI.InitializableByVoid
    , @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_product_identification``
*/
  public final class ePRODUCT_IDENTIFICATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _product_identification.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _product_identification.WHERE_wr2(SELF: instance.pRef)
      return result
    }
