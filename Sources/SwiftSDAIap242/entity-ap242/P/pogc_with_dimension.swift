/* file: pogc_with_dimension.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _pogc_with_dimension : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: ePOGC_WITH_DIMENSION?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: ePOGC_WITH_DIMENSION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SDAI.FORCE_OPTIONAL(SELF.OFFSET_DIRECTION_CONSTRAINED) .==. SDAI.FORCE_OPTIONAL(SDAI.LOGICAL(
        SDAI.TRUE))
      let _TEMP2 =  !_TEMP1
      let _TEMP3 = SDAI.FORCE_OPTIONAL(SELF.OFFSET_TYPE) .==. SDAI.FORCE_OPTIONAL(CURVE_2D_OFFSET)
      let _TEMP4 = SDAI.FORCE_OPTIONAL(SELF.OFFSET_TYPE) .==. SDAI.FORCE_OPTIONAL(SURFACE_OFFSET)
    ...
    public init(OFFSET_VALUE: tPOSITIVE_LENGTH_MEASURE, OFFSET_DIRECTION_CONSTRAINED: SDAI.BOOLEAN) {
...
```
*/
  public final class ePOGC_WITH_DIMENSION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _pogc_with_dimension.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _pogc_with_dimension.WHERE_wr2(SELF: instance)
      return result
    }
