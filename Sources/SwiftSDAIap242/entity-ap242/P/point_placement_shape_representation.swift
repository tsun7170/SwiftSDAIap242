/* file: point_placement_shape_representation.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
  public final class ePOINT_PLACEMENT_SHAPE_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var ITEMS: SDAI.SET<sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM>/*[1:?]*/  {
      get {
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _items: SDAI.SET<sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM>[1:?] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
      ...
      public static func WHERE_wr1(SELF: ePOINT_PLACEMENT_SHAPE_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        ...
        //
        let _TEMP1 /* SDAI.SET<sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM>[1:?] ? */ = SELF.ITEMS
        let _TEMP2 /* SDAI.SET<sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM>[1:?] ? */ = _TEMP1?
          .QUERY{ I in 
            // QUERY BODY
            //
