/* file: point_placement_shape_representation.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- point_placement_shape_representation (line:25329 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _point_placement_shape_representation : SDAI.PartialEntity {
...
```
*/
  public final class ePOINT_PLACEMENT_SHAPE_REPRESENTATION : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``ePOINT_PLACEMENT_SHAPE_REPRESENTATION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "POINT_PLACEMENT_SHAPE_REPRESENTATION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \ePOINT_PLACEMENT_SHAPE_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \ePOINT_PLACEMENT_SHAPE_REPRESENTATION.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \ePOINT_PLACEMENT_SHAPE_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \ePOINT_PLACEMENT_SHAPE_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \ePOINT_PLACEMENT_SHAPE_REPRESENTATION.NAME, 
