/* file: point_placement_shape_representation.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  ENTITY point_placement_shape_representation
    ...
    WHERE
      wr1: ( SIZEOF( QUERY ( i <* SELF.items | ( SIZEOF( [ 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               + 'COMPOUND_REPRESENTATION_ITEM' , 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               + 'MAPPED_ITEM' ] * TYPEOF( i ) ) = 1 ) ) ) > 0 );
  END_ENTITY; -- point_placement_shape_representation (line:25524 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	point_placement_shape_representation
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT_PLACEMENT_SHAPE_REPRESENTATION/PartialEntity``
*/
  public final class ePOINT_PLACEMENT_SHAPE_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<ePOINT_PLACEMENT_SHAPE_REPRESENTATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePOINT_PLACEMENT_SHAPE_REPRESENTATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePOINT_PLACEMENT_SHAPE_REPRESENTATION.PartialEntity

    //MARK: SUPERTYPES
    public let super_eREPRESENTATION: eREPRESENTATION 	// [1]
    public let super_eSHAPE_REPRESENTATION: eSHAPE_REPRESENTATION 	// [2]
    public var super_ePOINT_PLACEMENT_SHAPE_REPRESENTATION: ePOINT_PLACEMENT_SHAPE_REPRESENTATION { return self } 	// [3]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT_PLACEMENT_SHAPE_REPRESENTATION`` )
    public var ITEMS: SDAI.SET<sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        let originalValue = super_eREPRESENTATION.partialEntity._items
        let SELF = super_eREPRESENTATION; SDAI.TOUCH(let:SELF)
        let value =         SDAI.SET<sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM>(
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePOINT_PLACEMENT_SHAPE_REPRESENTATION.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = ePOINT_PLACEMENT_SHAPE_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "POINT_PLACEMENT_SHAPE_REPRESENTATION", 
      ...
      entityDef.add(supertype: ePOINT_PLACEMENT_SHAPE_REPRESENTATION.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \ePOINT_PLACEMENT_SHAPE_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \ePOINT_PLACEMENT_SHAPE_REPRESENTATION.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \ePOINT_PLACEMENT_SHAPE_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \ePOINT_PLACEMENT_SHAPE_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \ePOINT_PLACEMENT_SHAPE_REPRESENTATION.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT_PLACEMENT_SHAPE_REPRESENTATION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        ePOINT_PLACEMENT_SHAPE_REPRESENTATION.self
      }

      //ATTRIBUTES
      /* override var _items: SDAI.SET<sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM>[1:(nil as SDAI.INTEGER?)] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
      ...
      public static func WHERE_wr1(SELF: ePOINT_PLACEMENT_SHAPE_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }

        let _TEMP1 /* SDAI.SET<sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM>[1:(nil as SDAI.INTEGER?)] ? */ = 
          SELF.ITEMS
        let _TEMP2 /* SDAI.SET<sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM>[1:(nil as SDAI.INTEGER?)] ? */ = 
          _TEMP1?
          .QUERY{ I in 
            // QUERY BODY
