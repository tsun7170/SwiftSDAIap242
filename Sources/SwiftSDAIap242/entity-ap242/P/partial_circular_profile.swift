/* file: partial_circular_profile.swift 	 generated: Sun Oct 31 15:32:10 2021 */
  ...
  ENTITY partial_circular_profile
    ...
    WHERE
      ...
      wr7: ( SIZEOF( QUERY ( pd <* USEDIN( SELF, 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               ...
               <= 1 ) ) ) ) = 0 );
  END_ENTITY; -- partial_circular_profile (line:23494 file:ap242ed2_mim_lf_v1.101.TY.exp)
