/* file: product_group_attribute_assignment.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- product_group_attribute_assignment (line:26297 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _product_group_attribute_assignment : SDAI.PartialEntity {
...
```
*/
  public final class ePRODUCT_GROUP_ATTRIBUTE_ASSIGNMENT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``ePRODUCT_GROUP_ATTRIBUTE_ASSIGNMENT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "PRODUCT_GROUP_ATTRIBUTE_ASSIGNMENT", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "ROLE", keyPath: \ePRODUCT_GROUP_ATTRIBUTE_ASSIGNMENT.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ATTRIBUTES", keyPath: \ePRODUCT_GROUP_ATTRIBUTE_ASSIGNMENT.ATTRIBUTES, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_GROUP", keyPath: \ePRODUCT_GROUP_ATTRIBUTE_ASSIGNMENT.ASSIGNED_GROUP, 
