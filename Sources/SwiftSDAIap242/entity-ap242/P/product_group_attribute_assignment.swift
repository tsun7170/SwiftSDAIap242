/* file: product_group_attribute_assignment.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _product_group_attribute_assignment : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _assigned_group: ePRODUCT_GROUP_ATTRIBUTES	//EXPLICIT REDEFINITION(eGROUP_ASSIGNMENT) */
...
```
*/
  public final class ePRODUCT_GROUP_ATTRIBUTE_ASSIGNMENT : SDAI.EntityReference, @unchecked Sendable {
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_GROUP_ATTRIBUTE_ASSIGNMENT`` )
    public var ASSIGNED_GROUP: ePRODUCT_GROUP_ATTRIBUTES {
      get {
        if let resolved = _group_assignment._assigned_group__provider(complex: self.complexEntity) {
          let value = SDAI.UNWRAP( ePRODUCT_GROUP_ATTRIBUTES(resolved._assigned_group__getter(
            complex: self.complexEntity)) )
          return value
        }
        else {
          return SDAI.UNWRAP( ePRODUCT_GROUP_ATTRIBUTES(super_eGROUP_ASSIGNMENT.partialEntity
            ._assigned_group) )
        }
      }
      set(newValue) {
