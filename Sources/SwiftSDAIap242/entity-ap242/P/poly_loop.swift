/* file: poly_loop.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- poly_loop (line:25399 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _poly_loop : SDAI.PartialEntity {
...
```
*/
  public final class ePOLY_LOOP : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "POLY_LOOP", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "PERMANENT_AGGREGATE_ID", keyPath: \ePOLY_LOOP.PERMANENT_AGGREGATE_ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "PERMANENT_ID", keyPath: \ePOLY_LOOP.PERMANENT_ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \ePOLY_LOOP.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "POLYGON", keyPath: \ePOLY_LOOP.POLYGON, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DIM", keyPath: \ePOLY_LOOP.DIM, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
