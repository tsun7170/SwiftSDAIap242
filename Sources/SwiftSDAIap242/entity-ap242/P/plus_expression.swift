/* file: plus_expression.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _plus_expression : SDAI.PartialEntity, SDAI.InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_plus_expression``
*/
  public final class ePLUS_EXPRESSION : SDAI.EntityReference, SDAI.DualModeReference, @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _plus_expression.self
    }
    /// partial entity reference
    public let partialEntity: _plus_expression
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_plus_expression.self) else { return nil }
