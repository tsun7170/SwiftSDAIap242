/* file: ply_angle_representation.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- ply_angle_representation (line:24827 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	ply_angle_representation
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLY_ANGLE_REPRESENTATION/PartialEntity``
*/
  public final class ePLY_ANGLE_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<ePLY_ANGLE_REPRESENTATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePLY_ANGLE_REPRESENTATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePLY_ANGLE_REPRESENTATION.PartialEntity

    //MARK: SUPERTYPES
    public let super_eREPRESENTATION: eREPRESENTATION 	// [1]
    public var super_ePLY_ANGLE_REPRESENTATION: ePLY_ANGLE_REPRESENTATION { return self } 	// [2]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLY_ANGLE_REPRESENTATION`` )
    public var ITEMS: SDAI.SET<eMEASURE_REPRESENTATION_ITEM.PRef>/*[1:1]*/  {
      get {
        let originalValue = super_eREPRESENTATION.partialEntity._items
        let SELF = super_eREPRESENTATION; SDAI.TOUCH(let:SELF)
        let value = SDAI.SET<eMEASURE_REPRESENTATION_ITEM.PRef>(
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePLY_ANGLE_REPRESENTATION.PartialEntity.self) else { return nil }
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLY_ANGLE_REPRESENTATION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        ePLY_ANGLE_REPRESENTATION.self
      }

      //ATTRIBUTES
      /* override var _items: SDAI.SET<eMEASURE_REPRESENTATION_ITEM.PRef>[1:1] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
