/* file: ply_angle_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _ply_angle_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _items: SDAI.SET<eMEASURE_REPRESENTATION_ITEM>[1:1] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
...
```
*/
  public final class ePLY_ANGLE_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var ITEMS: SDAI.SET<eMEASURE_REPRESENTATION_ITEM>/*[1:1]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<eMEASURE_REPRESENTATION_ITEM>( super_eREPRESENTATION.partialEntity
          ._items ) )
      }
      set(newValue) {
