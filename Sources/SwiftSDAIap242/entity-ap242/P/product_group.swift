/* file: product_group.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  ENTITY product_group
    SUBTYPE OF ( group );
  END_ENTITY; -- product_group (line:26293 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _product_group : SDAI.PartialEntity {
...
```
*/
  public final class ePRODUCT_GROUP : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "PRODUCT_GROUP", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \ePRODUCT_GROUP.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ID", keyPath: \ePRODUCT_GROUP.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \ePRODUCT_GROUP.NAME, 
