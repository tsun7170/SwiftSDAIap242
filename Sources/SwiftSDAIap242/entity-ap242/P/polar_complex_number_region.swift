/* file: polar_complex_number_region.swift 	 generated: Tue Nov 16 05:35:44 2021 */
  ...
  ENTITY polar_complex_number_region
    ...
    WHERE
      ...
      wr6: ( ( real_min( distance_constraint ) > 0 ) OR max_exists( distance_constraint ) OR ( ( 
               ...
               .max_closure = open ) );
  END_ENTITY; -- polar_complex_number_region (line:25387 file:ap242ed2_mim_lf_v1.101.TY.exp)
