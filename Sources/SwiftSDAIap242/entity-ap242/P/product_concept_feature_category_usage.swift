/* file: product_concept_feature_category_usage.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public final class ePRODUCT_CONCEPT_FEATURE_CATEGORY_USAGE : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var ASSIGNED_GROUP: ePRODUCT_CONCEPT_FEATURE_CATEGORY.PRef {
      get {
        if let resolved = eGROUP_ASSIGNMENT.PartialEntity._assigned_group__provider(complex: self.complexEntity) {
          let value = SDAI.UNWRAP( ePRODUCT_CONCEPT_FEATURE_CATEGORY.PRef(resolved._assigned_group__getter(
            complex: self.complexEntity)) )
          return value
        }
        else {
          return SDAI.UNWRAP( ePRODUCT_CONCEPT_FEATURE_CATEGORY.PRef(super_eGROUP_ASSIGNMENT.partialEntity
            ._assigned_group) )
        }
      }
      set(newValue) {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = ePRODUCT_CONCEPT_FEATURE_CATEGORY_USAGE.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
