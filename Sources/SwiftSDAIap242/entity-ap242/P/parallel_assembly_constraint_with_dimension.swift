/* file: parallel_assembly_constraint_with_dimension.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var DISTANCE_VALUE: tNON_NEGATIVE_LENGTH_MEASURE {
      get {
        return SDAI.UNWRAP( super_ePGC_WITH_DIMENSION.partialEntity._distance_value )
      }
      set(newValue) {
    ...
    public var NEGATIVE_DIRECTION: SDAI.BOOLEAN {
      get {
        return SDAI.UNWRAP( super_ePGC_WITH_DIMENSION.partialEntity._negative_direction )
      }
      set(newValue) {
        let partial = super_ePGC_WITH_DIMENSION.partialEntity
