/* file: parallel_assembly_constraint_with_dimension.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- parallel_assembly_constraint_with_dimension (line:23428 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
```
*/
  public final class ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION : SDAI.EntityReference {
    ...
    /// - origin: SUPER( ``ePARALLEL_GEOMETRIC_CONSTRAINT`` )
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUPER( ``ePGC_WITH_DIMENSION`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "PARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "TRANSFORMATION_OPERATOR", keyPath: \ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.TRANSFORMATION_OPERATOR, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", keyPath: \ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", keyPath: \ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.REFERENCE_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DISTANCE_VALUE", keyPath: \ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.DISTANCE_VALUE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "REP_1", keyPath: \ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.REP_1, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_2", keyPath: \ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.REP_2, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NEGATIVE_DIRECTION", keyPath: \ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.NEGATIVE_DIRECTION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", keyPath: \ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.DIM, 
