/* file: parallel_assembly_constraint_with_dimension.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- parallel_assembly_constraint_with_dimension (line:23623 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  SUPER- ENTITY(11)	parallel_geometric_constraint
  ...
  SUPER- ENTITY(12)	parallel_assembly_constraint
    (no local attributes)

  SUPER- ENTITY(13)	pgc_with_dimension
    ATTR:  distance_value,	TYPE: non_negative_length_measure -- EXPLICIT

    ATTR:  negative_direction,	TYPE: BOOLEAN -- EXPLICIT


  ENTITY(SELF)	parallel_assembly_constraint_with_dimension
    (no local attributes)
...
- SUPERTYPES:
	...
	11.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARALLEL_GEOMETRIC_CONSTRAINT``
	12.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARALLEL_ASSEMBLY_CONSTRAINT``
	13.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePGC_WITH_DIMENSION``

- SUBTYPES:

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION/PartialEntity``
*/
  public final class ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.PartialEntity
    ...
    public let super_ePARALLEL_GEOMETRIC_CONSTRAINT: ePARALLEL_GEOMETRIC_CONSTRAINT 	// [11]
    public let super_ePARALLEL_ASSEMBLY_CONSTRAINT: ePARALLEL_ASSEMBLY_CONSTRAINT 	// [12]
    public let super_ePGC_WITH_DIMENSION: ePGC_WITH_DIMENSION 	// [13]
    public var super_ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION: ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION { return self } 	// [14]
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUPER( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePGC_WITH_DIMENSION`` )
    public var DISTANCE_VALUE: tNON_NEGATIVE_LENGTH_MEASURE {
      get {
        let originalValue = super_ePGC_WITH_DIMENSION.partialEntity._distance_value
        let value = SDAI.UNWRAP( tNON_NEGATIVE_LENGTH_MEASURE( originalValue ) )
        return value
      }
      set(newValue) {
        let partial = super_ePGC_WITH_DIMENSION.partialEntity
    ...
    public var NEGATIVE_DIRECTION: SDAI.BOOLEAN {
      get {
        let originalValue = super_ePGC_WITH_DIMENSION.partialEntity._negative_direction
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.PartialEntity.self) else { return nil }
      ...
      guard let super11 = complexEntity?.entityReference(ePARALLEL_GEOMETRIC_CONSTRAINT.self) else { return nil }
      self.super_ePARALLEL_GEOMETRIC_CONSTRAINT = super11

      guard let super12 = complexEntity?.entityReference(ePARALLEL_ASSEMBLY_CONSTRAINT.self) else { return nil }
      self.super_ePARALLEL_ASSEMBLY_CONSTRAINT = super12

      guard let super13 = complexEntity?.entityReference(ePGC_WITH_DIMENSION.self) else { return nil }
      self.super_ePGC_WITH_DIMENSION = super13
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: ePARALLEL_ASSEMBLY_CONSTRAINT.self)
      entityDef.add(supertype: ePGC_WITH_DIMENSION.self)
      entityDef.add(supertype: ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "TRANSFORMATION_OPERATOR", 
        keyPath: \ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.TRANSFORMATION_OPERATOR, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", 
        keyPath: \ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", 
        keyPath: \ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.REFERENCE_ELEMENTS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DISTANCE_VALUE", 
        keyPath: \ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.DISTANCE_VALUE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "REP_1", 
        keyPath: \ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.REP_1, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REP_2", 
        keyPath: \ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.REP_2, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NEGATIVE_DIRECTION", 
        keyPath: \ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.NEGATIVE_DIRECTION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", 
        keyPath: \ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.DIM, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        ePARALLEL_ASSEMBLY_CONSTRAINT_WITH_DIMENSION.self
      }
