/* file: pocket.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY pocket
    ...
    WHERE
      ...
      wr17: ( ( NOT ( SELF\characterized_object.description IN [ 'closed rectangular', 'open rectangular'] ) ) 
                ...
                TYPEOF( fcr.related_shape_aspect.of_shape.definition ) ) AND ( fcr.related_shape_aspect.
                description IN [ 'angle taper', 'directed taper'] ) ) ) ) >= 1 ) ) ) ) <= 1 ) ) ) ) = 0 ) );
  END_ENTITY; -- pocket (line:24663 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _pocket : SDAI.PartialEntity {
          ...
          let _TEMP3 = _TEMP2?.QUERY{ CSA in 
              ...
              let _TEMP6 = /*runtime*/SDAI.FORCE_OPTIONAL(_TEMP5)?
                .QUERY{ SAR in 
                  ...
                  let _TEMP5 = SDAI.FORCE_OPTIONAL(_TEMP2) * _TEMP4
                  let _TEMP6 = SDAI.SIZEOF(_TEMP5)
                  let _TEMP7 = _TEMP6 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
...
```
*/
  public final class ePOCKET : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "POCKET", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \ePOCKET.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", keyPath: \ePOCKET.NAME, 
