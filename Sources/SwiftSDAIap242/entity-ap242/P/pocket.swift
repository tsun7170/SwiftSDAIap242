/* file: pocket.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _pocket : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: ePOCKET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.GROUP_REF(eCHARACTERIZED_OBJECT.self)
      let _TEMP2 = _TEMP1?.DESCRIPTION
      let _TEMP3 = ([SDAI.AIE(SDAI.STRING("closed rectangular")), 
    ...
    public static func WHERE_wr2(SELF: ePOCKET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ PDS in 
          ...
          let _TEMP2 = _TEMP1.QUERY{ SA_OCC in 
              ...
              let _TEMP4 = _TEMP3.QUERY{ SAR in 
                  ...
                  let _TEMP6 = SDAI.TYPEOF(SAR, IS: eSHAPE_DEFINING_RELATIONSHIP.self)
    ...
    public static func WHERE_wr3(SELF: ePOCKET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = GET_PROPERTY_DEFINITION_REPRESENTATIONS(sCHARACTERIZED_DEFINITION(/*ePOCKET*/SELF))
    ...
    public static func WHERE_wr4(SELF: ePOCKET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr5(SELF: ePOCKET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr6(SELF: ePOCKET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr7(SELF: ePOCKET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr8(SELF: ePOCKET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.GROUP_REF(eCHARACTERIZED_OBJECT.self)
      let _TEMP2 = _TEMP1?.DESCRIPTION
      let _TEMP3 = _TEMP2 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("closed rectangular"))
      let _TEMP4 =  !_TEMP3
    ...
    public static func WHERE_wr9(SELF: ePOCKET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.GROUP_REF(eCHARACTERIZED_OBJECT.self)
      let _TEMP2 = _TEMP1?.DESCRIPTION
      let _TEMP3 = _TEMP2 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("open rectangular"))
      let _TEMP4 =  !_TEMP3
      let _TEMP5 = SDAI.USEDIN(T: SELF, ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
        .ePROPERTY_DEFINITION.DEFINITION)
      let _TEMP6 = _TEMP5.QUERY{ PD in 
      ...
      let _TEMP7 = _TEMP6.QUERY{ PDS in 
          ...
          let _TEMP2 = _TEMP1.QUERY{ SA_OCC in 
              ...
              let _TEMP5 = _TEMP4.QUERY{ SDR in 
                  ...
                  let _TEMP1 = SDAI.TYPEOF(SDR.RELATING_SHAPE_ASPECT, IS: eSQUARE_U_PROFILE.self)
                  return _TEMP1 }
              let _TEMP6 = SDAI.SIZEOF(_TEMP5)
              let _TEMP7 = _TEMP6 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
              let _TEMP8 = _TEMP2 && _TEMP7
    ...
    public static func WHERE_wr10(SELF: ePOCKET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP3 = _TEMP2.QUERY{ PDS in 
          ...
          let _TEMP2 = _TEMP1.QUERY{ SA_OCC in 
              ...
              let _TEMP5 = _TEMP4.QUERY{ SDR in 
                  ...
                  let _TEMP1 = SDAI.TYPEOF(SDR.RELATING_SHAPE_ASPECT, IS: ePOCKET_BOTTOM.self)
    ...
    public static func WHERE_wr11(SELF: ePOCKET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr12(SELF: ePOCKET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.GROUP_REF(eCHARACTERIZED_OBJECT.self)
      let _TEMP2 = _TEMP1?.DESCRIPTION
      let _TEMP3 = _TEMP2 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("circular cutout"))
      let _TEMP4 =  !_TEMP3
      let _TEMP5 = SDAI.USEDIN(T: SELF, ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
        .ePROPERTY_DEFINITION.DEFINITION)
      let _TEMP6 = _TEMP5.QUERY{ PD in 
    ...
    public static func WHERE_wr13(SELF: ePOCKET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.GROUP_REF(eCHARACTERIZED_OBJECT.self)
      let _TEMP2 = _TEMP1?.DESCRIPTION
      let _TEMP3 = ([SDAI.AIE(SDAI.STRING("circular cutout")), 
          ...
          let _TEMP2 = _TEMP1.QUERY{ SA_OCC in 
              ...
              let _TEMP5 = _TEMP4.QUERY{ SDR in 
                  ...
                  let _TEMP2 = SDAI.TYPEOF(SDAI.FORCE_OPTIONAL(SDAI.FORCE_OPTIONAL(SDR.RELATED_SHAPE_ASPECT)?
                    .OF_SHAPE)?.DEFINITION, IS: ePOCKET.self)
                  let _TEMP3 = _TEMP1 && _TEMP2
                  let _TEMP4 = /*runtime*/SDR.RELATING_SHAPE_ASPECT
                  let _TEMP5 = /*runtime*/SDAI.FORCE_OPTIONAL(_TEMP4)?.DESCRIPTION
    ...
    public static func WHERE_wr14(SELF: ePOCKET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.GROUP_REF(eCHARACTERIZED_OBJECT.self)
      let _TEMP2 = _TEMP1?.DESCRIPTION
      let _TEMP3 = _TEMP2 .==. SDAI.FORCE_OPTIONAL(SDAI.STRING("recess"))
      let _TEMP4 =  !_TEMP3
      let _TEMP5 = SDAI.USEDIN(T: SELF, ROLE: \AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF
        .ePROPERTY_DEFINITION.DEFINITION)
      let _TEMP6 = _TEMP5.QUERY{ PD in 
      ...
      let _TEMP7 = _TEMP6.QUERY{ PDS in 
          ...
          let _TEMP2 = _TEMP1.QUERY{ SA_OCC in 
              ...
              let _TEMP5 = _TEMP4.QUERY{ SDR in 
                  ...
                  let _TEMP4 = /*runtime*/SDR.RELATING_SHAPE_ASPECT
                  let _TEMP5 = /*runtime*/SDAI.FORCE_OPTIONAL(_TEMP4)?.DESCRIPTION
                  let _TEMP6 = ([SDAI.AIE(SDAI.STRING("planar")), 
    ...
    public static func WHERE_wr15(SELF: ePOCKET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr16(SELF: ePOCKET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
    ...
    public static func WHERE_wr17(SELF: ePOCKET?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
...
```
*/
  public final class ePOCKET : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _pocket.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _pocket.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _pocket.WHERE_wr3(SELF: instance)
      result[prefix2 + " .WHERE_wr4"] = _pocket.WHERE_wr4(SELF: instance)
      result[prefix2 + " .WHERE_wr5"] = _pocket.WHERE_wr5(SELF: instance)
      result[prefix2 + " .WHERE_wr6"] = _pocket.WHERE_wr6(SELF: instance)
      result[prefix2 + " .WHERE_wr7"] = _pocket.WHERE_wr7(SELF: instance)
      result[prefix2 + " .WHERE_wr8"] = _pocket.WHERE_wr8(SELF: instance)
      result[prefix2 + " .WHERE_wr9"] = _pocket.WHERE_wr9(SELF: instance)
      result[prefix2 + " .WHERE_wr10"] = _pocket.WHERE_wr10(SELF: instance)
      result[prefix2 + " .WHERE_wr11"] = _pocket.WHERE_wr11(SELF: instance)
      result[prefix2 + " .WHERE_wr12"] = _pocket.WHERE_wr12(SELF: instance)
      result[prefix2 + " .WHERE_wr13"] = _pocket.WHERE_wr13(SELF: instance)
      result[prefix2 + " .WHERE_wr14"] = _pocket.WHERE_wr14(SELF: instance)
      result[prefix2 + " .WHERE_wr15"] = _pocket.WHERE_wr15(SELF: instance)
      result[prefix2 + " .WHERE_wr16"] = _pocket.WHERE_wr16(SELF: instance)
      result[prefix2 + " .WHERE_wr17"] = _pocket.WHERE_wr17(SELF: instance)
      return result
    }
