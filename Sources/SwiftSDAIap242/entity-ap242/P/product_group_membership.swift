/* file: product_group_membership.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_ENTITY; -- product_group_membership (line:26498 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_GROUP_MEMBERSHIP/PartialEntity``
*/
  public final class ePRODUCT_GROUP_MEMBERSHIP : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<ePRODUCT_GROUP_MEMBERSHIP>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePRODUCT_GROUP_MEMBERSHIP.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePRODUCT_GROUP_MEMBERSHIP.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_GROUP_MEMBERSHIP`` )
    public var MEMBER: sPRODUCT_SELECT {
      get {
        let originalValue = self.partialEntity._member
        let value = SDAI.UNWRAP( sPRODUCT_SELECT( originalValue ) )
        return value
      }
      set(newValue) {
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePRODUCT_GROUP_MEMBERSHIP.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \ePRODUCT_GROUP_MEMBERSHIP.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ROLE", 
        keyPath: \ePRODUCT_GROUP_MEMBERSHIP.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "MEMBER", 
        keyPath: \ePRODUCT_GROUP_MEMBERSHIP.MEMBER, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_GROUP", 
        keyPath: \ePRODUCT_GROUP_MEMBERSHIP.ASSIGNED_GROUP, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \ePRODUCT_GROUP_MEMBERSHIP.NAME, 
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_GROUP_MEMBERSHIP``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( MEMBER: original._member )
      }
      ...
      public required convenience init?(
        ...
        else { exchangeStructure.add(errorContext: "while recovering parameter [0]MEMBER for partial entity(\(Self.entityName)) constructor"); return nil }
