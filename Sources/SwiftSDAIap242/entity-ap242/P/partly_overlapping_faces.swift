/* file: partly_overlapping_faces.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public final class ePARTLY_OVERLAPPING_FACES : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = ePARTLY_OVERLAPPING_FACES.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = ePARTLY_OVERLAPPING_FACES.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr3"] = ePARTLY_OVERLAPPING_FACES.PartialEntity.WHERE_wr3(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr4"] = ePARTLY_OVERLAPPING_FACES.PartialEntity.WHERE_wr4(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr5"] = ePARTLY_OVERLAPPING_FACES.PartialEntity.WHERE_wr5(SELF: instance.pRef)
      return result
    }
