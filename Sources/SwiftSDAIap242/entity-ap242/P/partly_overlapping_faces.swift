/* file: partly_overlapping_faces.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- partly_overlapping_faces (line:23653 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _partly_overlapping_faces : SDAI.PartialEntity {
...
```
*/
  public final class ePARTLY_OVERLAPPING_FACES : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``ePARTLY_OVERLAPPING_FACES`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "PARTLY_OVERLAPPING_FACES", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "INTERFERENCE_TOLERANCE", keyPath: \ePARTLY_OVERLAPPING_FACES.INTERFERENCE_TOLERANCE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ASSESSMENT_SPECIFICATION", keyPath: \ePARTLY_OVERLAPPING_FACES.ASSESSMENT_SPECIFICATION, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \ePARTLY_OVERLAPPING_FACES.NAME, 
