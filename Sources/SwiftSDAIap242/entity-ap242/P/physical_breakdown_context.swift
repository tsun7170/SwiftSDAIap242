/* file: physical_breakdown_context.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- physical_breakdown_context (line:24448 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _physical_breakdown_context : SDAI.PartialEntity {
...
```
*/
  public final class ePHYSICAL_BREAKDOWN_CONTEXT : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "PHYSICAL_BREAKDOWN_CONTEXT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \ePHYSICAL_BREAKDOWN_CONTEXT.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATING_PRODUCT_DEFINITION", keyPath: \ePHYSICAL_BREAKDOWN_CONTEXT.RELATING_PRODUCT_DEFINITION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \ePHYSICAL_BREAKDOWN_CONTEXT.ID, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "RELATED_PRODUCT_DEFINITION", keyPath: \ePHYSICAL_BREAKDOWN_CONTEXT.RELATED_PRODUCT_DEFINITION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \ePHYSICAL_BREAKDOWN_CONTEXT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
