/* file: physical_component.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- physical_component (line:24633 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	physical_component
    (no local attributes)

  SUB- ENTITY(8)	interface_component
    (no local attributes)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePHYSICAL_COMPONENT/PartialEntity``
*/
  public final class ePHYSICAL_COMPONENT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<ePHYSICAL_COMPONENT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePHYSICAL_COMPONENT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePHYSICAL_COMPONENT.PartialEntity
    ...
    public var super_ePHYSICAL_COMPONENT: ePHYSICAL_COMPONENT { return self } 	// [7]

    //MARK: SUBTYPES
    public var sub_eINTERFACE_COMPONENT: eINTERFACE_COMPONENT? {	// [8]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePHYSICAL_COMPONENT.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addAttribute(name: "RELATING_PRODUCT_DEFINITION", 
        keyPath: \ePHYSICAL_COMPONENT.RELATING_PRODUCT_DEFINITION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "FRAME_OF_REFERENCE", 
        keyPath: \ePHYSICAL_COMPONENT.FRAME_OF_REFERENCE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DEFINITION", 
        keyPath: \ePHYSICAL_COMPONENT.DEFINITION, 
      ...
      entityDef.addAttribute(name: "RELATED_PRODUCT_DEFINITION", 
        keyPath: \ePHYSICAL_COMPONENT.RELATED_PRODUCT_DEFINITION, 
        kind: .derivedRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "FORMATION", 
        keyPath: \ePHYSICAL_COMPONENT.FORMATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
