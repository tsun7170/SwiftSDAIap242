/* file: physical_component.swift 	 generated: Mon Dec 15 17:41:04 2025 */
...
*/
  ...
  public final class _physical_component : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_physical_component``
*/
  public final class ePHYSICAL_COMPONENT : SDAI.EntityReference, SDAIDualModeReference, 
    @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _physical_component.self
    }
    /// partial entity reference
    public let partialEntity: _physical_component
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_physical_component.self) else { return nil }
