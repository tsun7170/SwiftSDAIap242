/* file: projection_curve.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- projection_curve (line:26568 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _projection_curve : SDAI.PartialEntity {
...
```
*/
  public final class ePROJECTION_CURVE : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "PROJECTION_CURVE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "ITEM", keyPath: \ePROJECTION_CURVE.ITEM, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "STYLES", keyPath: \ePROJECTION_CURVE.STYLES, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \ePROJECTION_CURVE.NAME, 
