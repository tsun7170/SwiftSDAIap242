/* file: product_definition.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public final class ePRODUCT_DEFINITION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var RELATING_PRODUCT_DEFINITION: eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT.PRef?  {
      get {
        if let resolved = ePRODUCT_DEFINITION_RELATIONSHIP.PartialEntity._relating_product_definition__provider(complex: self.complexEntity) {
          let value = eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT.PRef(resolved
            ._relating_product_definition__getter(complex: self.complexEntity))
          return value
        }
        else {
          return eLINEAR_ARRAY_PLACEMENT_GROUP_COMPONENT.PRef(sub_eLINEAR_ARRAY_COMPONENT_DEFINITION_LINK?.super_ePRODUCT_DEFINITION_RELATIONSHIP
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = ePRODUCT_DEFINITION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
