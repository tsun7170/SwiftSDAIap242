/* file: product_definition_formation.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_FORMATION/PartialEntity``
*/
  public final class ePRODUCT_DEFINITION_FORMATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePRODUCT_DEFINITION_FORMATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePRODUCT_DEFINITION_FORMATION.PartialEntity
    ...
    public var STATUS: SDAI.STRING?  {
      get {
        let originalValue = sub_eFINAL_SOLUTION?.partialEntity._status
        let value = SDAI.STRING( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_eFINAL_SOLUTION?.partialEntity
          else { return }
        partial._status = SDAI.UNWRAP(SDAI.STRING(
          newValue))
      }
    }
    ...
    public var MAKE_OR_BUY: nSOURCE?  {
      get {
        let originalValue = sub_ePRODUCT_DEFINITION_FORMATION_WITH_SPECIFIED_SOURCE?.partialEntity
          ._make_or_buy
        let value = nSOURCE( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_ePRODUCT_DEFINITION_FORMATION_WITH_SPECIFIED_SOURCE?.partialEntity
          else { return }
    ...
    get {
      let value = sub_eFINAL_SOLUTION?.SPECIFICATION
      return value
    }
    }
    ...
    public var OF_PRODUCT: ePRODUCT.PRef {
      get {
        let originalValue = self.partialEntity._of_product
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePRODUCT_DEFINITION_FORMATION.PartialEntity.self) else { return nil }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.addUniquenessRule(label:"UNIQUE_ur1", rule: ePRODUCT_DEFINITION_FORMATION.PartialEntity.UNIQUE_ur1)
