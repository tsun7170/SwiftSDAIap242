/* file: product_definition_formation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
```
*/
  public final class ePRODUCT_DEFINITION_FORMATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"SPECIFICATION") {
        return cached.value as! (SDAI.SET<ePRODUCT_DEFINITION>/*[1:nil]*/ )? 
      }
      let swiftValue = SDAI.SET<ePRODUCT_DEFINITION>/*[1:nil]*/ .SwiftType( self.referencingEntities(for: \ePRODUCT_DEFINITION.FORMATION) )
      let value = SDAI.SET<ePRODUCT_DEFINITION>/*[1:nil]*/ (from: swiftValue, bound1: SDAI.UNWRAP(SDAI.INTEGER(1)), bound2: (nil as 
        SDAI.INTEGER?))
