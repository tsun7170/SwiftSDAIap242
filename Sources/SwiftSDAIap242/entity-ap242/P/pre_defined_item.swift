/* file: pre_defined_item.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  ENTITY pre_defined_item;
      name  : label;
  END_ENTITY; -- pre_defined_item (line:25723 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRE_DEFINED_ITEM/PartialEntity``
*/
  public final class ePRE_DEFINED_ITEM : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePRE_DEFINED_ITEM.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePRE_DEFINED_ITEM.PartialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePRE_DEFINED_ITEM.PartialEntity.self) else { return nil }
