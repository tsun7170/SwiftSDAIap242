/* file: perpendicular_geometric_constraint.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY perpendicular_geometric_constraint
    ...
    WHERE
      ...
      wr3: ( ( NOT ( ( SIZEOF( SELF\explicit_constraint.reference_elements ) = 0 ) AND ( SIZEOF( SELF\
               ...
               = 3 ) ) ) );
  END_ENTITY; -- perpendicular_geometric_constraint (line:24320 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _perpendicular_geometric_constraint : SDAI.PartialEntity {
...
```
*/
  public final class ePERPENDICULAR_GEOMETRIC_CONSTRAINT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``ePERPENDICULAR_GEOMETRIC_CONSTRAINT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "PERPENDICULAR_GEOMETRIC_CONSTRAINT", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \ePERPENDICULAR_GEOMETRIC_CONSTRAINT.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", keyPath: \ePERPENDICULAR_GEOMETRIC_CONSTRAINT.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", keyPath: \ePERPENDICULAR_GEOMETRIC_CONSTRAINT.REFERENCE_ELEMENTS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \ePERPENDICULAR_GEOMETRIC_CONSTRAINT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", keyPath: \ePERPENDICULAR_GEOMETRIC_CONSTRAINT.DIM, 
