/* file: perpendicular_geometric_constraint.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _perpendicular_geometric_constraint : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: ePERPENDICULAR_GEOMETRIC_CONSTRAINT?) -> SDAI.LOGICAL {
      ...
      let _TEMP10 = _TEMP9?.QUERY{ Q in 

          let _TEMP1 = SDAI.TYPEOF(Q, IS: eLINE.self)
          return _TEMP1 }
      let _TEMP11 = SDAI.SIZEOF(_TEMP10)
      let _TEMP12 = SELF.GROUP_REF(eEXPLICIT_CONSTRAINT.self)
      let _TEMP13 = _TEMP12?.REFERENCE_ELEMENTS
      let _TEMP14 = SELF.GROUP_REF(eEXPLICIT_CONSTRAINT.self)
      let _TEMP15 = _TEMP14?.CONSTRAINED_ELEMENTS
      let _TEMP16 = _TEMP13 + _TEMP15
      let _TEMP17 = SDAI.SIZEOF(_TEMP16)
      let _TEMP18 = _TEMP11 .==. _TEMP17
      let _TEMP19 = SELF.GROUP_REF(eEXPLICIT_CONSTRAINT.self)
      let _TEMP20 = _TEMP19?.CONSTRAINED_ELEMENTS
      let _TEMP21 = SELF.GROUP_REF(eEXPLICIT_CONSTRAINT.self)
      let _TEMP22 = _TEMP21?.REFERENCE_ELEMENTS
      let _TEMP23 = _TEMP20 + _TEMP22
      let _TEMP24 = _TEMP23?.QUERY{ Q in 

          let _TEMP1 = SDAI.TYPEOF(Q, IS: ePLANE.self)
          return _TEMP1 }
      let _TEMP25 = SDAI.SIZEOF(_TEMP24)
      let _TEMP26 = SELF.GROUP_REF(eEXPLICIT_CONSTRAINT.self)
      let _TEMP27 = _TEMP26?.REFERENCE_ELEMENTS
      let _TEMP28 = SELF.GROUP_REF(eEXPLICIT_CONSTRAINT.self)
      let _TEMP29 = _TEMP28?.CONSTRAINED_ELEMENTS
      let _TEMP30 = _TEMP27 + _TEMP29
      let _TEMP31 = SDAI.SIZEOF(_TEMP30)
      let _TEMP32 = _TEMP25 .==. _TEMP31
      let _TEMP33 = _TEMP18 .!=. _TEMP32
      let _TEMP34 =  !_TEMP33
      let _TEMP35 = _TEMP4 && _TEMP34
      let _TEMP36 =  !_TEMP35
      return _TEMP36
    }
    public static func WHERE_wr2(SELF: ePERPENDICULAR_GEOMETRIC_CONSTRAINT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP8 = ([SDAI.AIE(SDAI.INTEGER(2)), 
        SDAI.AIE(SDAI.INTEGER(3))] as [SDAI.AggregationInitializerElement<SDAI.INTEGER>])
      let _TEMP9 = SDAI.aggregate(_TEMP8, contains: _TEMP7)
      let _TEMP10 = _TEMP4 || _TEMP9
      return _TEMP10
    }
    public static func WHERE_wr3(SELF: ePERPENDICULAR_GEOMETRIC_CONSTRAINT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP10 =  !_TEMP9
      let _TEMP11 = SELF.GROUP_REF(eEXPLICIT_CONSTRAINT.self)
      let _TEMP12 = _TEMP11?.CONSTRAINED_ELEMENTS
      let _TEMP13 = _TEMP12?.QUERY{ Q in 

          let _TEMP1 = SDAI.TYPEOF(Q, IS: eLINE.self)
          return _TEMP1 }
      let _TEMP14 = SDAI.SIZEOF(_TEMP13)
      let _TEMP15 = _TEMP14 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(3))
      let _TEMP16 = SELF.GROUP_REF(eEXPLICIT_CONSTRAINT.self)
      let _TEMP17 = _TEMP16?.CONSTRAINED_ELEMENTS
      let _TEMP18 = _TEMP17?.QUERY{ Q in 

          let _TEMP1 = SDAI.TYPEOF(Q, IS: ePLANE.self)
          return _TEMP1 }
      let _TEMP19 = SDAI.SIZEOF(_TEMP18)
      let _TEMP20 = _TEMP19 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(3))
      let _TEMP21 = _TEMP15 .!=. _TEMP20
      let _TEMP22 =  !_TEMP21
      let _TEMP23 = _TEMP10 && _TEMP22
      return _TEMP23
    }
...
```
*/
  public final class ePERPENDICULAR_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _perpendicular_geometric_constraint.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _perpendicular_geometric_constraint.WHERE_wr2(SELF: instance)
      result[prefix2 + " .WHERE_wr3"] = _perpendicular_geometric_constraint.WHERE_wr3(SELF: instance)
      return result
    }
