/* file: property_definition.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROPERTY_DEFINITION/PartialEntity``
*/
  public final class ePROPERTY_DEFINITION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePROPERTY_DEFINITION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePROPERTY_DEFINITION.PartialEntity
    ...
    get {
      let value = sub_ePRODUCT_DEFINITION_KINEMATICS?.REPRESENTATION_RELATION
      return value
    }
    }
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePROPERTY_DEFINITION.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = ePROPERTY_DEFINITION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      internal static func _definition__provider(complex: SDAI.ComplexEntity) -> ePROPERTY_DEFINITION__DEFINITION__provider? {
        let resolved = complex.resolvePartialEntityInstance(from: [
          eMATED_PART_RELATIONSHIP.PartialEntity.typeIdentity, eASSEMBLY_COMPONENT.PartialEntity.typeIdentity
          ])
      ...
      final public override class func fixupPartialComplexEntityAttributes(partialComplex: SDAI.ComplexEntity, baseComplex: SDAI.ComplexEntity) {
        guard let pe = partialComplex.partialEntityInstance(ePROPERTY_DEFINITION.PartialEntity.self) else { return }
      ...
      public required convenience init?(
        ...
        guard case .success(let p2) = exchangeStructure.recoverOmittableParameter(as: 
          sCHARACTERIZED_DEFINITION.self, from: parameters[2])
