/* file: percentage_laminate_table.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_ENTITY; -- percentage_laminate_table (line:24312 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _percentage_laminate_table : SDAI.PartialEntity {
...
```
*/
  public final class ePERCENTAGE_LAMINATE_TABLE : SDAI.EntityReference {
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "PERCENTAGE_LAMINATE_TABLE", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \ePERCENTAGE_LAMINATE_TABLE.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ID", keyPath: \ePERCENTAGE_LAMINATE_TABLE.ID, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "FRAME_OF_REFERENCE", keyPath: \ePERCENTAGE_LAMINATE_TABLE.FRAME_OF_REFERENCE, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \ePERCENTAGE_LAMINATE_TABLE.NAME, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "FORMATION", keyPath: \ePERCENTAGE_LAMINATE_TABLE.FORMATION, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
