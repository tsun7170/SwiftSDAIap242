/* file: plane_angle_and_length_pair.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  ...
  END_ENTITY; -- plane_angle_and_length_pair (line:24591 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _plane_angle_and_length_pair : SDAI.PartialEntity {
...
```
*/
  public final class ePLANE_ANGLE_AND_LENGTH_PAIR : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``ePLANE_ANGLE_AND_LENGTH_PAIR`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "PLANE_ANGLE_AND_LENGTH_PAIR", type: self, explicitAttributeCount: 2)
      ...
      entityDef.addAttribute(name: "USERS", keyPath: \ePLANE_ANGLE_AND_LENGTH_PAIR.USERS, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "LENGTH_VALUE", keyPath: \ePLANE_ANGLE_AND_LENGTH_PAIR.LENGTH_VALUE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "PLANE_ANGLE_VALUE", keyPath: \ePLANE_ANGLE_AND_LENGTH_PAIR.PLANE_ANGLE_VALUE, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: false)
