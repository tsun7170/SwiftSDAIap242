/* file: pgc_with_dimension.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _pgc_with_dimension : SDAI.PartialEntity, @unchecked Sendable {
    ...
    public static func WHERE_wr1(SELF: ePGC_WITH_DIMENSION?) -> SDAI.LOGICAL {
    ...
    public static func WHERE_wr2(SELF: ePGC_WITH_DIMENSION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP6 = _TEMP5?.QUERY{ Q in 
          ...
          let _TEMP2 = ([SDAI.AIE(SDAI.STRING("AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.DIRECTION")), 
    ...
    public init(DISTANCE_VALUE: tNON_NEGATIVE_LENGTH_MEASURE, NEGATIVE_DIRECTION: SDAI.BOOLEAN) {
...
```
*/
  public final class ePGC_WITH_DIMENSION : SDAI.EntityReference, @unchecked Sendable {
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _pgc_with_dimension.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _pgc_with_dimension.WHERE_wr2(SELF: instance)
      return result
    }
