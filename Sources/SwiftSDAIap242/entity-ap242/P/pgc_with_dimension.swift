/* file: pgc_with_dimension.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _pgc_with_dimension : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_pgc_with_dimension``
*/
  public final class ePGC_WITH_DIMENSION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _pgc_with_dimension.self
    }
    /// partial entity reference
    public let partialEntity: _pgc_with_dimension
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_pgc_with_dimension.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _pgc_with_dimension.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = _pgc_with_dimension.WHERE_wr2(SELF: instance.pRef)
      return result
    }
