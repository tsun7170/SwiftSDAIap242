/* file: pgc_with_dimension.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public final class ePGC_WITH_DIMENSION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var NEGATIVE_DIRECTION: SDAI.BOOLEAN {
      get {
        return SDAI.UNWRAP( self.partialEntity._negative_direction )
      }
      set(newValue) {
        let partial = self.partialEntity
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = ePGC_WITH_DIMENSION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = ePGC_WITH_DIMENSION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      public static func WHERE_wr2(SELF: ePGC_WITH_DIMENSION.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP4 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:nil] ? */ = _TEMP3?.CONSTRAINED_ELEMENTS
