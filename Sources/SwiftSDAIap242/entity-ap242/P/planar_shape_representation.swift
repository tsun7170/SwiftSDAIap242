/* file: planar_shape_representation.swift 	 generated: Tue Oct 14 17:54:07 2025 */
  ...
  ENTITY planar_shape_representation
    ...
    WHERE
      ...
      wr2: ( SIZEOF( QUERY ( it <* SELF.items | ( 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PLANE' IN 
               TYPEOF( it ) ) ) ) = 1 );
  END_ENTITY; -- planar_shape_representation (line:24589 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  ...
  public final class _planar_shape_representation : SDAI.PartialEntity, @unchecked Sendable {
