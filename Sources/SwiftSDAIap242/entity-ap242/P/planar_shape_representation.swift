/* file: planar_shape_representation.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  ENTITY planar_shape_representation
    ...
    WHERE
      ...
      wr2: ( SIZEOF( QUERY ( it <* SELF.items | ( 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PLANE' IN 
               TYPEOF( it ) ) ) ) = 1 );
  END_ENTITY; -- planar_shape_representation (line:24775 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLANAR_SHAPE_REPRESENTATION/PartialEntity``
*/
  public final class ePLANAR_SHAPE_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<ePLANAR_SHAPE_REPRESENTATION>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePLANAR_SHAPE_REPRESENTATION.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePLANAR_SHAPE_REPRESENTATION.PartialEntity
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePLANAR_SHAPE_REPRESENTATION.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = ePLANAR_SHAPE_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix + " .WHERE_wr2"] = ePLANAR_SHAPE_REPRESENTATION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition.Prototype( 
        name: "PLANAR_SHAPE_REPRESENTATION", 
      ...
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \ePLANAR_SHAPE_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", 
        keyPath: \ePLANAR_SHAPE_REPRESENTATION.ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", 
        keyPath: \ePLANAR_SHAPE_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", 
        keyPath: \ePLANAR_SHAPE_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \ePLANAR_SHAPE_REPRESENTATION.NAME, 
...
```express
    ...
    ENTITY planar_shape_representation
      ...
      WHERE
        wr1: ( SIZEOF( SELF.items ) = 1 );
        wr2: ( SIZEOF( QUERY ( it <* SELF.items | ( 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PLANE' 
                 IN TYPEOF( it ) ) ) ) = 1 );
    END_ENTITY; -- planar_shape_representation (line:24775 file:ap242ed2_mim_lf_v1.101_TY.exp)

```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLANAR_SHAPE_REPRESENTATION``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      public static func WHERE_wr1(SELF: ePLANAR_SHAPE_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
      ...
      public static func WHERE_wr2(SELF: ePLANAR_SHAPE_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        guard let SELF = SELF else { return SDAI.UNKNOWN }
        ...
        let _TEMP2 /* SDAI.SET<eREPRESENTATION_ITEM.PRef>[1:(nil as SDAI.INTEGER?)] ? */ = _TEMP1?
          .QUERY{ IT in 
            ...
            let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( IT, IS: ePLANE.self )
            return _TEMP1
            // END QUERY BODY
          }
