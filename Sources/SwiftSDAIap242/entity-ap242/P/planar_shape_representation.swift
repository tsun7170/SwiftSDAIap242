/* file: planar_shape_representation.swift 	 generated: Mon Jan  3 16:32:52 2022 */
  ...
  ENTITY planar_shape_representation
    ...
    WHERE
      ...
      wr2: ( SIZEOF( QUERY ( it <* SELF.items | ( 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PLANE' IN 
               TYPEOF( it ) ) ) ) = 1 );
  END_ENTITY; -- planar_shape_representation (line:24595 file:ap242ed2_mim_lf_v1.101.TY.exp)
