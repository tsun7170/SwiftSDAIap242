/* file: presentation_area.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  ENTITY presentation_area
    ...
    WHERE
      wr1: ( ( SIZEOF( QUERY ( ais <* USEDIN( SELF, 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
               ...
               'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PRESENTATION_SIZE.UNIT'  ) ) = 1 ) ) ) > 0 ) 
               OR ( SIZEOF( USEDIN( SELF, 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PRESENTATION_SIZE.'
               + 'UNIT'  ) ) = 1 ) );
  END_ENTITY; -- presentation_area (line:25842 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	presentation_area
    (no local attributes)

  SUB- ENTITY(4)	mechanical_design_shaded_presentation_area
    REDCR: items,	TYPE: SET [1 : ?] OF mechanical_design_shaded_presentation_area_items -- EXPLICIT
      -- OVERRIDING ENTITY: representation


  SUB- ENTITY(5)	mechanical_design_geometric_presentation_area
    REDCR: items,	TYPE: SET [1 : ?] OF mechanical_design_geometric_presentation_area_items -- EXPLICIT
      -- OVERRIDING ENTITY: representation


  SUB- ENTITY(6)	drawing_sheet_revision
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESENTATION_AREA/PartialEntity``
*/
  public final class ePRESENTATION_AREA : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<ePRESENTATION_AREA>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePRESENTATION_AREA.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePRESENTATION_AREA.PartialEntity
    ...
    public var super_ePRESENTATION_AREA: ePRESENTATION_AREA { return self } 	// [3]

    //MARK: SUBTYPES
    public var sub_eMECHANICAL_DESIGN_SHADED_PRESENTATION_AREA: eMECHANICAL_DESIGN_SHADED_PRESENTATION_AREA? {	// [4]
      return self.complexEntity.entityReference(eMECHANICAL_DESIGN_SHADED_PRESENTATION_AREA.self)
    }

    public var sub_eMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA: eMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA? {	// [5]
      return self.complexEntity.entityReference(eMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA.self)
    }

    public var sub_eDRAWING_SHEET_REVISION: eDRAWING_SHEET_REVISION? {	// [6]
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePRESENTATION_AREA.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = ePRESENTATION_AREA.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    ENTITY presentation_area
      ...
      WHERE
        wr1: ( ( SIZEOF( QUERY ( ais <* USEDIN( SELF, 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
                 + 'AREA_IN_SET.AREA'  ) | ( SIZEOF( USEDIN( ais, 
                 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PRESENTATION_SIZE.UNIT'  ) ) = 1 ) ) ) > 0 ) 
                 OR ( SIZEOF( USEDIN( SELF, 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.'
                 + 'PRESENTATION_SIZE.UNIT'  ) ) = 1 ) );
    END_ENTITY; -- presentation_area (line:25842 file:ap242ed2_mim_lf_v1.101_TY.exp)

```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESENTATION_AREA``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        ePRESENTATION_AREA.self
      }
      ...
      public override var typeMembers: Set<SDAI.STRING> {
        ...
        members.insert(SDAI.STRING(sAREA_OR_VIEW.typeName)) // -> Self
      ...
      public static func WHERE_wr1(SELF: ePRESENTATION_AREA.PRef?) -> SDAI.LOGICAL {
