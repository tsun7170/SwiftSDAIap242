/* file: presentation_area.swift 	 generated: Thu Dec 25 18:13:23 2025 */
...
*/
  ...
  public final class _presentation_area : SDAI.PartialEntity, InitializableByVoid, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_presentation_area``
*/
  public final class ePRESENTATION_AREA : SDAI.EntityReference, SDAIDualModeReference, @unchecked Sendable {
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _presentation_area.self
    }
    /// partial entity reference
    public let partialEntity: _presentation_area
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_presentation_area.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _presentation_area.WHERE_wr1(SELF: instance.pRef)
      return result
    }
