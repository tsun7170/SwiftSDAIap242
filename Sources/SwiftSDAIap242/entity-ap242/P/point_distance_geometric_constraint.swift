/* file: point_distance_geometric_constraint.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _point_distance_geometric_constraint : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //ATTRIBUTES
    /* override var _constrained_elements: SDAI.SET<ePOINT>[1:nil] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */
    ...
    public static func WHERE_wr1(SELF: ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT?) -> SDAI.LOGICAL {
      ...
      let _TEMP5 = SDAI.TYPEOF(SELF, IS: ePDGC_WITH_DIMENSION.self)
...
```
*/
  public final class ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, @unchecked Sendable {
    ...
    public var CONSTRAINED_ELEMENTS: SDAI.SET<ePOINT>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<ePOINT>( super_eEXPLICIT_CONSTRAINT.partialEntity
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _point_distance_geometric_constraint.WHERE_wr1(SELF: instance)
      return result
    }
