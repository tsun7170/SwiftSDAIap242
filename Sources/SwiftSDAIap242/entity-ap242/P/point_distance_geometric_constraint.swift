/* file: point_distance_geometric_constraint.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- point_distance_geometric_constraint (line:25380 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ENTITY(SELF)	point_distance_geometric_constraint
  ...
  SUB- ENTITY(8)	pdgc_with_dimension
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePDGC_WITH_DIMENSION``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT/PartialEntity``
*/
  public final class ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT.PartialEntity
    ...
    public var super_ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT: ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT { return self } 	// [7]

    //MARK: SUBTYPES
    public var sub_ePDGC_WITH_DIMENSION: ePDGC_WITH_DIMENSION? {	// [8]
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT`` )
    public var CONSTRAINED_ELEMENTS: SDAI.SET<ePOINT.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  {
      get {
        ...
        let value =         SDAI.SET<ePOINT.PRef>(
    ...
    /// __EXPLICIT__ attribute
    /// - origin: SUB( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePDGC_WITH_DIMENSION`` )
    public var DISTANCE_VALUE: tNON_NEGATIVE_LENGTH_MEASURE?  {
      get {
        let originalValue = sub_ePDGC_WITH_DIMENSION?.partialEntity._distance_value
        let value = tNON_NEGATIVE_LENGTH_MEASURE( originalValue )
        return value
      }
      set(newValue) {
        guard let partial = 
          sub_ePDGC_WITH_DIMENSION?.partialEntity
          else { return }
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT.PartialEntity.self) else { return nil }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      result[prefix + " .WHERE_wr1"] = ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      ...
      entityDef.add(supertype: ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT.self)

      //MARK: ATTRIBUTE REGISTRATIONS
      entityDef.addAttribute(name: "DESCRIPTION", 
        keyPath: \ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT.DESCRIPTION, 
        kind: .explicitOptional, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONSTRAINED_ELEMENTS", 
        keyPath: \ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT.CONSTRAINED_ELEMENTS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "REFERENCE_ELEMENTS", 
        keyPath: \ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT.REFERENCE_ELEMENTS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "DISTANCE_VALUE", 
        keyPath: \ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT.DISTANCE_VALUE, 
        kind: .explicit, source: .subEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "NAME", 
        keyPath: \ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT.NAME, 
        kind: .explicit, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "DIM", 
        keyPath: \ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT.DIM, 
...
```express
    ...
    ENTITY point_distance_geometric_constraint
      ...
      WHERE
        wr1: ( ( SIZEOF( SELF\explicit_constraint.reference_elements ) > 0 ) OR ( ( 
                 'AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PDGC_WITH_DIMENSION'  IN TYPEOF( SELF ) ) 
                 AND ( SIZEOF( SELF\explicit_constraint.constrained_elements ) = 2 ) ) );
    END_ENTITY; -- point_distance_geometric_constraint (line:25380 file:ap242ed2_mim_lf_v1.101_TY.exp)

```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT``
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      public override class var entityReferenceType: SDAI.EntityReference.Type {
        ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT.self
      }

      //ATTRIBUTES
      /* override var _constrained_elements: SDAI.SET<ePOINT.PRef>[1:(nil as SDAI.INTEGER?)] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */
      ...
      public static func WHERE_wr1(SELF: ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP5 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: ePDGC_WITH_DIMENSION.self )
