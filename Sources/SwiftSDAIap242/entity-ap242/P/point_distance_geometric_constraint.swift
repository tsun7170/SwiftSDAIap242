/* file: point_distance_geometric_constraint.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var CONSTRAINED_ELEMENTS: SDAI.SET<ePOINT.PRef>/*[1:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<ePOINT.PRef>( super_eEXPLICIT_CONSTRAINT.partialEntity
    ...
    public var DISTANCE_VALUE: tNON_NEGATIVE_LENGTH_MEASURE?  {
      get {
        return sub_ePDGC_WITH_DIMENSION?.partialEntity._distance_value
      }
      set(newValue) {
        guard let partial = sub_ePDGC_WITH_DIMENSION?.super_ePDGC_WITH_DIMENSION.partialEntity
          else { return }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = ePOINT_DISTANCE_GEOMETRIC_CONSTRAINT.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _constrained_elements: SDAI.SET<ePOINT.PRef>[1:nil] 	//EXPLICIT REDEFINITION(eEXPLICIT_CONSTRAINT) */
