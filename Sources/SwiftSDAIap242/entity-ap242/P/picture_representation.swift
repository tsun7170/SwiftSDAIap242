/* file: picture_representation.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public final class ePICTURE_REPRESENTATION : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public var ITEMS: SDAI.SET<sPICTURE_REPRESENTATION_ITEM_SELECT>/*[2:nil]*/  {
      get {
        return SDAI.UNWRAP( SDAI.SET<sPICTURE_REPRESENTATION_ITEM_SELECT>( super_eREPRESENTATION
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = ePICTURE_REPRESENTATION.PartialEntity.WHERE_wr1(SELF: instance.pRef)
      result[prefix2 + " .WHERE_wr2"] = ePICTURE_REPRESENTATION.PartialEntity.WHERE_wr2(SELF: instance.pRef)
      return result
    }
...
*/
    public final class PartialEntity : SDAI.PartialEntity, SDAI.Initializable.ByVoid, @unchecked Sendable {
      ...
      //ATTRIBUTES
      /* override var _items: SDAI.SET<sPICTURE_REPRESENTATION_ITEM_SELECT>[2:nil] 	//EXPLICIT REDEFINITION(eREPRESENTATION) */
      ...
      public static func WHERE_wr1(SELF: ePICTURE_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP1 /* SDAI.SET<sPICTURE_REPRESENTATION_ITEM_SELECT>[2:nil] ? */ = SELF.ITEMS?
          .QUERY{ ITEM in 
            // QUERY BODY
      ...
      public static func WHERE_wr2(SELF: ePICTURE_REPRESENTATION.PRef?) -> SDAI.LOGICAL {
        ...
        let _TEMP1 /* SDAI.SET<sPICTURE_REPRESENTATION_ITEM_SELECT>[2:nil] ? */ = SELF.ITEMS
        let _TEMP2 /* SDAI.SET<sPICTURE_REPRESENTATION_ITEM_SELECT>[2:nil] ? */ = _TEMP1?
          .QUERY{ ITEM in 
            // QUERY BODY
        ...
        let _TEMP3 /* SDAI.SET<sPICTURE_REPRESENTATION_ITEM_SELECT>[2:nil] ? */ = _TEMP2?
          .QUERY{ SE in 
            // QUERY BODY
