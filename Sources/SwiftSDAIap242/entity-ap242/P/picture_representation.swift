/* file: picture_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
//MARK: - Partial Entity
  public final class _picture_representation : SDAI.PartialEntity, @unchecked Sendable {
    ...
    //internal private(set) weak var _size: ePRESENTATION_SIZE? 	(SEE CORRESPONDING ENTITY REFERENCE DEFINITION)
    ...
    public static func WHERE_wr1(SELF: ePICTURE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }

      let _TEMP1 = SELF.ITEMS.QUERY{ ITEM in 

          let _TEMP1 = SDAI.TYPEOF(ITEM, IS: eSTYLED_ITEM.self)
          return _TEMP1 }
      let _TEMP2 = SDAI.SIZEOF(_TEMP1)
      let _TEMP3 = _TEMP2 .==. SDAI.FORCE_OPTIONAL(SDAI.INTEGER(1))
      return _TEMP3
    }
    public static func WHERE_wr2(SELF: ePICTURE_REPRESENTATION?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      ...
      let _TEMP2 = _TEMP1.QUERY{ ITEM in 
          ...
          let _TEMP1 = SDAI.TYPEOF(ITEM, IS: eSTYLED_ITEM.self)
          return _TEMP1 }
      let _TEMP3 = _TEMP2.QUERY{ SE in 

          let _TEMP1 = SDAI.TYPEOF(SE.GROUP_REF(eSTYLED_ITEM.self)?.ITEM, 
...
```
*/
  public final class ePICTURE_REPRESENTATION : SDAI.EntityReference, @unchecked Sendable {
    ...
    get {
      if let cached = cachedValue(derivedAttributeName:"SIZE") {
        return cached.value as! ePRESENTATION_SIZE? 
      }
    ...
    public override class func validateWhereRules(instance:SDAI.EntityReference?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      result[prefix2 + " .WHERE_wr1"] = _picture_representation.WHERE_wr1(SELF: instance)
      result[prefix2 + " .WHERE_wr2"] = _picture_representation.WHERE_wr2(SELF: instance)
      return result
    }
