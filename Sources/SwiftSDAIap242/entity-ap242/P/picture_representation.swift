/* file: picture_representation.swift 	 generated: Sat Aug 14 13:46:02 2021 */
  ...
  ENTITY picture_representation
    ...
    WHERE
      ...
      wr2: ( SIZEOF( QUERY ( se <* QUERY ( item <* SELF.items | ( 
               ...
               styled_item.item ) ) ) ) ) = 0 );
  END_ENTITY; -- picture_representation (line:24459 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _picture_representation : SDAI.PartialEntity {
    ...
    internal private(set) weak var _size: ePRESENTATION_SIZE?
    /// INVERSE SIMPLE ATTR SUPPORT(ADDER)
    internal func _size__observeAddedReference(in complex: SDAI.ComplexEntity) {
      guard let newSource = complex.entityReference(ePRESENTATION_SIZE.self) else { return }
      self._size = newSource
    }
    /// INVERSE SIMPLE ATTR SUPPORT(REMOVER)
    internal func _size__observeRemovedReference(in complex: SDAI.ComplexEntity) {
      guard let _ = complex.entityReference(ePRESENTATION_SIZE.self) else { return }
      self._size = nil
    }
    /// INVERSE SIMPLE ATTR SUPPORT(LEAVING REFERENCE OWNER)
    internal func _size__observe(leavingReferencerOwner complex: SDAI.ComplexEntity) {
      guard let _ = complex.entityReference(ePRESENTATION_SIZE.self) else { return }
      self._size = nil
    }
...
```
*/
  public final class ePICTURE_REPRESENTATION : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``ePICTURE_REPRESENTATION`` )
    ...
    public var SIZE: ePRESENTATION_SIZE?  {
      get {
        return self.partialEntity._size
      }
    }
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "PICTURE_REPRESENTATION", type: self, explicitAttributeCount: 0)
      ...
      entityDef.addAttribute(name: "DESCRIPTION", keyPath: \ePICTURE_REPRESENTATION.DESCRIPTION, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "ITEMS", keyPath: \ePICTURE_REPRESENTATION.ITEMS, 
        kind: .explicitRedeclaring, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "SIZE", keyPath: \ePICTURE_REPRESENTATION.SIZE, 
        kind: .inverse, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ID", keyPath: \ePICTURE_REPRESENTATION.ID, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: false)
      entityDef.addAttribute(name: "CONTEXT_OF_ITEMS", keyPath: \ePICTURE_REPRESENTATION.CONTEXT_OF_ITEMS, 
        kind: .explicitRedeclaring, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "NAME", keyPath: \ePICTURE_REPRESENTATION.NAME, 
