/* file: picture_representation.swift 	 generated: Tue Oct 14 17:54:07 2025 */
  ...
  ENTITY picture_representation
    ...
    WHERE
      ...
      wr2: ( SIZEOF( QUERY ( se <* QUERY ( item <* SELF.items | ( 
               ...
               styled_item.item ) ) ) ) ) = 0 );
  END_ENTITY; -- picture_representation (line:24468 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  ...
  public final class _picture_representation : SDAI.PartialEntity, @unchecked Sendable {
