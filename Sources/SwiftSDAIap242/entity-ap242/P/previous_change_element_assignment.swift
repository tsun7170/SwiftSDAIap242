/* file: previous_change_element_assignment.swift 	 generated: Sun Jan 18 16:59:32 2026 */
    ...
    public var ASSIGNED_GROUP: sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT {
      get {
        if let resolved = eGROUP_ASSIGNMENT.PartialEntity._assigned_group__provider(complex: self.complexEntity) {
          let value = SDAI.UNWRAP( sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT(resolved._assigned_group__getter(
            complex: self.complexEntity)) )
          return value
        }
        else {
          return SDAI.UNWRAP( sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT(super_eGROUP_ASSIGNMENT.partialEntity
            ._assigned_group) )
        }
      }
      set(newValue) {
