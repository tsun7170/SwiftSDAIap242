/* file: previous_change_element_assignment.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  ...
  public final class _previous_change_element_assignment : SDAI.PartialEntity, @unchecked Sendable {
...
- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/_previous_change_element_assignment``
*/
  public final class ePREVIOUS_CHANGE_ELEMENT_ASSIGNMENT : SDAI.EntityReference, SDAI.DualModeReference, 
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      _previous_change_element_assignment.self
    }
    /// partial entity reference
    public let partialEntity: _previous_change_element_assignment
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(_previous_change_element_assignment.self) else { return nil }
