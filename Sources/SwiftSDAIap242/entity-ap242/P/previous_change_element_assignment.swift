/* file: previous_change_element_assignment.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_ENTITY; -- previous_change_element_assignment (line:25789 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
//MARK: - Partial Entity
  public final class _previous_change_element_assignment : SDAI.PartialEntity {
...
```
*/
  public final class ePREVIOUS_CHANGE_ELEMENT_ASSIGNMENT : SDAI.EntityReference {
    ...
    /// - origin: SELF( ``ePREVIOUS_CHANGE_ELEMENT_ASSIGNMENT`` )
    ...
    private static func createEntityDefinition() -> SDAIDictionarySchema.EntityDefinition {
      let entityDef = SDAIDictionarySchema.EntityDefinition(name: "PREVIOUS_CHANGE_ELEMENT_ASSIGNMENT", type: self, explicitAttributeCount: 1)
      ...
      entityDef.addAttribute(name: "ROLE", keyPath: \ePREVIOUS_CHANGE_ELEMENT_ASSIGNMENT.ROLE, 
        kind: .derived, source: .superEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ITEMS", keyPath: \ePREVIOUS_CHANGE_ELEMENT_ASSIGNMENT.ITEMS, 
        kind: .explicit, source: .thisEntity, mayYieldEntityReference: true)
      entityDef.addAttribute(name: "ASSIGNED_GROUP", keyPath: \ePREVIOUS_CHANGE_ELEMENT_ASSIGNMENT.ASSIGNED_GROUP, 
