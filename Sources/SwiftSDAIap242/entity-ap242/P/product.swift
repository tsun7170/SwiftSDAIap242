/* file: product.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_ENTITY; -- product (line:26103 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
- SUBTYPES:
	1.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eADDITIVE_MANUFACTURING_SETUP``
	2.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eENVELOPE``
	3.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTRUCTURED_MESSAGE``
	4.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOLLECTION``
	5.	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_RESOURCE``

- PARTIAL ENTITY:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT/PartialEntity``
*/
  public final class ePRODUCT : SDAI.EntityReference, SDAI.DualModeReference, SDAI.SimpleEntityType, 
    @unchecked Sendable {
    /// persistent entity reference type
    public typealias PRef = SDAI.PersistentEntityReference<ePRODUCT>
    ...
    public override class var partialEntityType: SDAI.PartialEntity.Type {
      ePRODUCT.PartialEntity.self
    }
    /// partial entity reference
    public let partialEntity: ePRODUCT.PartialEntity
    ...
    /// - origin: SELF( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT`` )
    ...
    public required init?(complex complexEntity: SDAI.ComplexEntity?) {
      guard let partial = complexEntity?.partialEntityInstance(ePRODUCT.PartialEntity.self) else { return nil }
...
```
- ENTITY reference:
	+	``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT``
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _frame_of_reference: SDAI.SET<ePRODUCT_CONTEXT.PRef>/*[1:(nil as SDAI.INTEGER?)]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(
        ...
        NAME: tLABEL, 
        DESCRIPTION: tTEXT? , 
        FRAME_OF_REFERENCE: SDAI.SET<ePRODUCT_CONTEXT.PRef>/*[1:(nil as SDAI.INTEGER?)]*/ 
      ) {
        ...
        SDAI.SET<ePRODUCT_CONTEXT.PRef>(
          from: FRAME_OF_REFERENCE.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
      ...
      public required convenience init(from original:SDAI.PartialEntity) {
        ...
        self.init( ID: original._id, NAME: original._name, DESCRIPTION: original._description, FRAME_OF_REFERENCE: original._frame_of_reference )
      }
      ...
      public required convenience init?(
        ...
        guard case .success(let p3) = exchangeStructure.recoverRequiredParameter(as: SDAI.SET<
          ePRODUCT_CONTEXT.PRef>.self, from: parameters[3])
