/* file: product.swift 	 generated: Tue Jan 20 19:20:51 2026 */
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _frame_of_reference: SDAI.SET<ePRODUCT_CONTEXT.PRef>/*[1:nil]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(
        ...
        NAME: tLABEL, 
        DESCRIPTION: tTEXT? , 
        FRAME_OF_REFERENCE: SDAI.SET<ePRODUCT_CONTEXT.PRef>/*[1:nil]*/ 
      ) {
