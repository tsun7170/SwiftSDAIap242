/* file: product.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
    public final class PartialEntity : SDAI.PartialEntity, @unchecked Sendable {
      ...
      /// EXPLICIT ATTRIBUTE 
      @_documentation(visibility:public)
      public internal(set) var _frame_of_reference: SDAI.SET<ePRODUCT_CONTEXT.PRef>/*[1:?]*/  // PLAIN EXPLICIT ATTRIBUTE
      ...
      public init(
        ...
        NAME: tLABEL, 
        DESCRIPTION: tTEXT? , 
        FRAME_OF_REFERENCE: SDAI.SET<ePRODUCT_CONTEXT.PRef>/*[1:?]*/ 
      ) {
        ...
        SDAI.SET<ePRODUCT_CONTEXT.PRef>(from: FRAME_OF_REFERENCE.asSwiftType, 
          bound1:SDAI.UNWRAP(1), bound2:(nil as SDAI.INTEGER?))
