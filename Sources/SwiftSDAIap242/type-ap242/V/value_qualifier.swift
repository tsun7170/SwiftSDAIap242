/* file: value_qualifier.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- value_qualifier (line:5964 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sVALUE_QUALIFIER : SDAI.Value, TypeHierarchy.sVALUE_QUALIFIER__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMATHS_VALUE_PRECISION_QUALIFIER`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sVALUE_QUALIFIER``
    ...
    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eVALUE_FORMAT_TYPE_QUALIFIER`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sVALUE_QUALIFIER``
    @_documentation(visibility:public)
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      switch self {
      case ._MATHS_VALUE_PRECISION_QUALIFIER(let entity): return entity.persistentEntityReferences
      ...
      case ._VALUE_FORMAT_TYPE_QUALIFIER(let entity): return entity.persistentEntityReferences
      }
    }
...
public protocol sVALUE_QUALIFIER__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sVALUE_QUALIFIER__Subtype: sVALUE_QUALIFIER__TypeBehavior, SDAI.DefinedType
where Supertype: sVALUE_QUALIFIER__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sVALUE_QUALIFIER__Subtype {
  //MARK: CONSTRUCTORS
