/* file: vector_or_direction.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
```
*/
  public enum sVECTOR_OR_DIRECTION : SDAI.Value, TypeHierarchy.sVECTOR_OR_DIRECTION__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIRECTION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sVECTOR_OR_DIRECTION``
...
public protocol sVECTOR_OR_DIRECTION__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sVECTOR_OR_DIRECTION__Subtype: sVECTOR_OR_DIRECTION__TypeBehavior, SDAI.DefinedType
where Supertype: sVECTOR_OR_DIRECTION__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sVECTOR_OR_DIRECTION__Subtype {
  //MARK: CONSTRUCTORS
