/* file: vector_or_direction.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
/*
  TYPE vector_or_direction = SELECT
    ( direction (*ENTITY*),
     vector (*ENTITY*) );
  END_TYPE; -- vector_or_direction (line:5972 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sVECTOR_OR_DIRECTION : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sVECTOR_OR_DIRECTION__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIRECTION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sVECTOR_OR_DIRECTION``
    @_documentation(visibility:public)
    case _DIRECTION(eDIRECTION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eVECTOR`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sVECTOR_OR_DIRECTION``
    @_documentation(visibility:public)
    ...
    public static let bareTypeName: String = "VECTOR_OR_DIRECTION"
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sVECTOR_OR_DIRECTION``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sVECTOR_OR_DIRECTION__type: SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sVECTOR_OR_DIRECTION__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sVECTOR_OR_DIRECTION__type, SDAI.DefinedType
