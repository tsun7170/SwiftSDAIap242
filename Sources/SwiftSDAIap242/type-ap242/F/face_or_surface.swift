/* file: face_or_surface.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sFACE_OR_SURFACE : SDAI.Value, TypeHierarchy.sFACE_OR_SURFACE__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFACE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sFACE_OR_SURFACE``
...
public protocol sFACE_OR_SURFACE__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sFACE_OR_SURFACE__Subtype: sFACE_OR_SURFACE__TypeBehavior, SDAI.DefinedType
where Supertype: sFACE_OR_SURFACE__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sFACE_OR_SURFACE__Subtype {
  //MARK: CONSTRUCTORS
