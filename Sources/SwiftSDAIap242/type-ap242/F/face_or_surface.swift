/* file: face_or_surface.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sFACE_OR_SURFACE : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sFACE_OR_SURFACE__type {
    ...
    /// SELECT case ``eFACE`` (ENTITY) in ``sFACE_OR_SURFACE``
    case _FACE(eFACE)	// (ENTITY)

    /// SELECT case ``eSURFACE`` (ENTITY) in ``sFACE_OR_SURFACE``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eFACE.self) {self = ._FACE(base) }
    ...
    /// attribute of SELECT type ``sFACE_OR_SURFACE``
