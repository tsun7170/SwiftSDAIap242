/* file: font_select.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  TYPE font_select = SELECT
    ( externally_defined_text_font (*ENTITY*),
     ...
     text_font (*ENTITY*) );
  END_TYPE; -- font_select (line:3178 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sFONT_SELECT : SDAI.Value, TypeHierarchy.sFONT_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTERNALLY_DEFINED_TEXT_FONT`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sFONT_SELECT``
    @_documentation(visibility:public)
    case _EXTERNALLY_DEFINED_TEXT_FONT(eEXTERNALLY_DEFINED_TEXT_FONT.PRef)	// (ENTITY)

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRE_DEFINED_TEXT_FONT`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sFONT_SELECT``
    @_documentation(visibility:public)
    case _PRE_DEFINED_TEXT_FONT(ePRE_DEFINED_TEXT_FONT.PRef)	// (ENTITY)

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTEXT_FONT`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sFONT_SELECT``
    @_documentation(visibility:public)
    case _TEXT_FONT(eTEXT_FONT.PRef)	// (ENTITY)
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eEXTERNALLY_DEFINED_TEXT_FONT.self) {self = ._EXTERNALLY_DEFINED_TEXT_FONT(base.pRef) }
      else if let base = complex.entityReference(ePRE_DEFINED_TEXT_FONT.self) {self = ._PRE_DEFINED_TEXT_FONT(base.pRef) }
      else if let base = complex.entityReference(eTEXT_FONT.self) {self = ._TEXT_FONT(base.pRef) }
      else { return nil }
    }
    ...
    public init?<G: SDAI.GenericType>(fromGeneric generic: G?) {
      ...
      else if let base = eEXTERNALLY_DEFINED_TEXT_FONT.PRef.convert(fromGeneric: select) {
        self = ._EXTERNALLY_DEFINED_TEXT_FONT(base)
      }
      else if let base = ePRE_DEFINED_TEXT_FONT.PRef.convert(fromGeneric: select) {
        self = ._PRE_DEFINED_TEXT_FONT(base)
      }
      else if let base = eTEXT_FONT.PRef.convert(fromGeneric: select) {
    ...
    public static let bareTypeName: String = "FONT_SELECT"
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sFONT_SELECT``
    public var super_ePRE_DEFINED_TEXT_FONT: ePRE_DEFINED_TEXT_FONT.PRef {
      switch self {
      case ._PRE_DEFINED_TEXT_FONT(let entity): return entity
      default: return ePRE_DEFINED_TEXT_FONT.PRef(nil)
      }
    }
    ...
    public var super_ePRE_DEFINED_ITEM: ePRE_DEFINED_ITEM.PRef {
      switch self {
      case ._PRE_DEFINED_TEXT_FONT(let entity): return ePRE_DEFINED_ITEM.PRef(entity.eval?.super_ePRE_DEFINED_ITEM)
    ...
    public var super_eEXTERNALLY_DEFINED_ITEM: eEXTERNALLY_DEFINED_ITEM.PRef {
      switch self {
      case ._EXTERNALLY_DEFINED_TEXT_FONT(let entity): return eEXTERNALLY_DEFINED_ITEM.PRef(entity.eval?.super_eEXTERNALLY_DEFINED_ITEM)
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sFONT_SELECT``
    public var super_eEXTERNALLY_DEFINED_TEXT_FONT: eEXTERNALLY_DEFINED_TEXT_FONT.PRef {
      switch self {
      case ._EXTERNALLY_DEFINED_TEXT_FONT(let entity): return entity
      default: return eEXTERNALLY_DEFINED_TEXT_FONT.PRef(nil)
      }
    }
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sFONT_SELECT``
    public var super_eTEXT_FONT: eTEXT_FONT.PRef {
      switch self {
      case ._TEXT_FONT(let entity): return entity
      default: return eTEXT_FONT.PRef(nil)
      }
    }
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sFONT_SELECT``
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTERNALLY_DEFINED_TEXT_FONT`` )
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sFONT_SELECT``
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTEXT_FONT`` )
    ...
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sFONT_SELECT``
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTEXT_FONT`` )
    public var GLYPHS: (SDAI.SET<eCHARACTER_GLYPH_FONT_USAGE.PRef>/*[1:?]*/ )?  {
      switch self {
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sFONT_SELECT``
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRE_DEFINED_TEXT_FONT`` )
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTEXT_FONT`` )
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.FONT_SELECT"
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      switch self {
      case ._EXTERNALLY_DEFINED_TEXT_FONT(let entity): return entity.persistentEntityReferences
      case ._PRE_DEFINED_TEXT_FONT(let entity): return entity.persistentEntityReferences
      case ._TEXT_FONT(let entity): return entity.persistentEntityReferences
      }
    }
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._EXTERNALLY_DEFINED_TEXT_FONT(let entity): 
        ...
        result = eEXTERNALLY_DEFINED_TEXT_FONT.validateWhereRules(instance: entity.eval, 
        prefix:prefix + "\\\(entity)")
      case ._PRE_DEFINED_TEXT_FONT(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = ePRE_DEFINED_TEXT_FONT.validateWhereRules(instance: entity.eval, 
        prefix:prefix + "\\\(entity)")
      case ._TEXT_FONT(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eTEXT_FONT.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case nil: break
      }
...
public protocol sFONT_SELECT__TypeBehavior: SDAI.SelectType {
  //MARK: GROUP REFERENCES
  var super_ePRE_DEFINED_TEXT_FONT: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ePRE_DEFINED_TEXT_FONT.PRef { get }
  ...
  var super_eEXTERNALLY_DEFINED_TEXT_FONT: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eEXTERNALLY_DEFINED_TEXT_FONT.PRef { get }
  var super_eTEXT_FONT: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eTEXT_FONT.PRef { get }
  ...
  var GLYPHS: (SDAI.SET<AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eCHARACTER_GLYPH_FONT_USAGE.PRef>/*[1:?]*/ )?  { get }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sFONT_SELECT__Subtype: sFONT_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sFONT_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sFONT_SELECT__Subtype {
  //MARK: CONSTRUCTORS
  ...
  //MARK: GROUP REFERENCES
  var super_ePRE_DEFINED_TEXT_FONT: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ePRE_DEFINED_TEXT_FONT.PRef { rep.super_ePRE_DEFINED_TEXT_FONT }
  var super_ePRE_DEFINED_ITEM: 
  ...
  var super_eEXTERNALLY_DEFINED_TEXT_FONT: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eEXTERNALLY_DEFINED_TEXT_FONT.PRef { rep.super_eEXTERNALLY_DEFINED_TEXT_FONT }
  var super_eTEXT_FONT: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eTEXT_FONT.PRef { rep.super_eTEXT_FONT }
  ...
  var GLYPHS: (SDAI.SET<AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eCHARACTER_GLYPH_FONT_USAGE.PRef>/*[1:?]*/ )?  { rep.GLYPHS }
