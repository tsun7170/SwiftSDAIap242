/* file: font_select.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sFONT_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sFONT_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTERNALLY_DEFINED_TEXT_FONT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sFONT_SELECT``
    @_documentation(visibility:public)
    case _EXTERNALLY_DEFINED_TEXT_FONT(eEXTERNALLY_DEFINED_TEXT_FONT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRE_DEFINED_TEXT_FONT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sFONT_SELECT``
    @_documentation(visibility:public)
    case _PRE_DEFINED_TEXT_FONT(ePRE_DEFINED_TEXT_FONT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTEXT_FONT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sFONT_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sFONT_SELECT``
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      case ._TEXT_FONT(let entity): result = eTEXT_FONT.validateWhereRules(instance: entity.eval, 
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sFONT_SELECT__type: SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sFONT_SELECT__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sFONT_SELECT__type, SDAI.DefinedType
