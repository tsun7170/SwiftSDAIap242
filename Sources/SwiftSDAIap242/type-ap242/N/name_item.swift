/* file: name_item.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sNAME_ITEM : SDAI.Value, TypeHierarchy.sNAME_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_ACTION_ASSIGNMENT`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sNAME_ITEM``
    ...
    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTERNAL_CLASS_LIBRARY`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sNAME_ITEM``
    @_documentation(visibility:public)
...
public protocol sNAME_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sNAME_ITEM__Subtype: sNAME_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sNAME_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sNAME_ITEM__Subtype {
  //MARK: CONSTRUCTORS
