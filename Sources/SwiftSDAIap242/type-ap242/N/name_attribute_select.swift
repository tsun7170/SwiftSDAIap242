/* file: name_attribute_select.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
/*
  ...
  END_TYPE; -- name_attribute_select (line:4477 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sNAME_ATTRIBUTE_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sNAME_ATTRIBUTE_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_REQUEST_SOLUTION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sNAME_ATTRIBUTE_SELECT``
    @_documentation(visibility:public)
    case _ACTION_REQUEST_SOLUTION(eACTION_REQUEST_SOLUTION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eADDRESS`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sNAME_ATTRIBUTE_SELECT``
    @_documentation(visibility:public)
    case _ADDRESS(eADDRESS.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONFIGURATION_DESIGN`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sNAME_ATTRIBUTE_SELECT``
    @_documentation(visibility:public)
    case _CONFIGURATION_DESIGN(eCONFIGURATION_DESIGN.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONTEXT_DEPENDENT_SHAPE_REPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sNAME_ATTRIBUTE_SELECT``
    @_documentation(visibility:public)
    case _CONTEXT_DEPENDENT_SHAPE_REPRESENTATION(eCONTEXT_DEPENDENT_SHAPE_REPRESENTATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDERIVED_UNIT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sNAME_ATTRIBUTE_SELECT``
    @_documentation(visibility:public)
    case _DERIVED_UNIT(eDERIVED_UNIT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEFFECTIVITY`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sNAME_ATTRIBUTE_SELECT``
    @_documentation(visibility:public)
    case _EFFECTIVITY(eEFFECTIVITY.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePERSON_AND_ORGANIZATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sNAME_ATTRIBUTE_SELECT``
    @_documentation(visibility:public)
    case _PERSON_AND_ORGANIZATION(ePERSON_AND_ORGANIZATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sNAME_ATTRIBUTE_SELECT``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION(ePRODUCT_DEFINITION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_SUBSTITUTE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sNAME_ATTRIBUTE_SELECT``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION_SUBSTITUTE(ePRODUCT_DEFINITION_SUBSTITUTE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROPERTY_DEFINITION_REPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sNAME_ATTRIBUTE_SELECT``
    @_documentation(visibility:public)
    ...
    public static let bareTypeName: String = "NAME_ATTRIBUTE_SELECT"
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sNAME_ATTRIBUTE_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sNAME_ATTRIBUTE_SELECT__type: 
  SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sNAME_ATTRIBUTE_SELECT__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sNAME_ATTRIBUTE_SELECT__type, SDAI.DefinedType
