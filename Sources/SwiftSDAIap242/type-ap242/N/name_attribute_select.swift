/* file: name_attribute_select.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
```
*/
  public enum sNAME_ATTRIBUTE_SELECT : SDAI.Value, TypeHierarchy.sNAME_ATTRIBUTE_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_REQUEST_SOLUTION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sNAME_ATTRIBUTE_SELECT``
...
public protocol sNAME_ATTRIBUTE_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sNAME_ATTRIBUTE_SELECT__Subtype: sNAME_ATTRIBUTE_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sNAME_ATTRIBUTE_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sNAME_ATTRIBUTE_SELECT__Subtype {
  //MARK: CONSTRUCTORS
