/* file: non_negative_length_measure.swift 	 generated: Mon Jan  3 16:32:52 2022 */
...
/*
  ...
  WHERE
    wr1: ( SELF >= 0 );
  END_TYPE; -- non_negative_length_measure (line:4507 file:ap242ed2_mim_lf_v1.101.TY.exp)
