/* file: non_negative_length_measure.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  WHERE
    wr1: ( SELF >= 0 );
  END_TYPE; -- non_negative_length_measure (line:4492 file:ap242ed2_mim_lf_v1.101.TY.exp)
