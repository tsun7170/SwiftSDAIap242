/* file: direction_count_select.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sDIRECTION_COUNT_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDIRECTION_COUNT_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tU_DIRECTION_COUNT`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDIRECTION_COUNT_SELECT``
    @_documentation(visibility:public)
    case _U_DIRECTION_COUNT(tU_DIRECTION_COUNT)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tV_DIRECTION_COUNT`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDIRECTION_COUNT_SELECT``
    @_documentation(visibility:public)
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDIRECTION_COUNT_SELECT__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDIRECTION_COUNT_SELECT__type, SDAI.DefinedType
