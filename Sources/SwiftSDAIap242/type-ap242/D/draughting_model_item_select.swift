/* file: draughting_model_item_select.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sDRAUGHTING_MODEL_ITEM_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDRAUGHTING_MODEL_ITEM_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIS2_PLACEMENT`` (SELECT) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDRAUGHTING_MODEL_ITEM_SELECT``
    @_documentation(visibility:public)
    case _AXIS2_PLACEMENT(sAXIS2_PLACEMENT)	// (SELECT)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCAMERA_MODEL`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDRAUGHTING_MODEL_ITEM_SELECT``
    @_documentation(visibility:public)
    case _CAMERA_MODEL(eCAMERA_MODEL.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDRAUGHTING_CALLOUT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDRAUGHTING_MODEL_ITEM_SELECT``
    @_documentation(visibility:public)
    case _DRAUGHTING_CALLOUT(eDRAUGHTING_CALLOUT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMAPPED_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDRAUGHTING_MODEL_ITEM_SELECT``
    @_documentation(visibility:public)
    case _MAPPED_ITEM(eMAPPED_ITEM.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTYLED_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDRAUGHTING_MODEL_ITEM_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDRAUGHTING_MODEL_ITEM_SELECT``
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      case ._CAMERA_MODEL(let entity): result = eCAMERA_MODEL.validateWhereRules(instance: entity.eval, 
        prefix:prefix + "\\CAMERA_MODEL")
      case ._DRAUGHTING_CALLOUT(let entity): 
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDRAUGHTING_MODEL_ITEM_SELECT__type: 
  SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDRAUGHTING_MODEL_ITEM_SELECT__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDRAUGHTING_MODEL_ITEM_SELECT__type, SDAI.DefinedType
where Supertype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDRAUGHTING_MODEL_ITEM_SELECT__type
{}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDRAUGHTING_MODEL_ITEM_SELECT__subtype {
  //MARK: CONSTRUCTORS
