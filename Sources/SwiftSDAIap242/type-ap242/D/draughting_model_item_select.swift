/* file: draughting_model_item_select.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sDRAUGHTING_MODEL_ITEM_SELECT : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDRAUGHTING_MODEL_ITEM_SELECT__type {
    ...
    /// SELECT case ``sAXIS2_PLACEMENT`` (SELECT) in ``sDRAUGHTING_MODEL_ITEM_SELECT``
    case _AXIS2_PLACEMENT(sAXIS2_PLACEMENT)	// (SELECT)

    /// SELECT case ``eCAMERA_MODEL`` (ENTITY) in ``sDRAUGHTING_MODEL_ITEM_SELECT``
    case _CAMERA_MODEL(eCAMERA_MODEL)	// (ENTITY)

    /// SELECT case ``eDRAUGHTING_CALLOUT`` (ENTITY) in ``sDRAUGHTING_MODEL_ITEM_SELECT``
    case _DRAUGHTING_CALLOUT(eDRAUGHTING_CALLOUT)	// (ENTITY)

    /// SELECT case ``eMAPPED_ITEM`` (ENTITY) in ``sDRAUGHTING_MODEL_ITEM_SELECT``
    case _MAPPED_ITEM(eMAPPED_ITEM)	// (ENTITY)

    /// SELECT case ``eSTYLED_ITEM`` (ENTITY) in ``sDRAUGHTING_MODEL_ITEM_SELECT``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      else if let base = complex.entityReference(eCAMERA_MODEL.self) {self = ._CAMERA_MODEL(base) }
    ...
    public init?<G: SDAIGenericType>(fromGeneric generic: G?) {
      ...
      else if let base = eCAMERA_MODEL.convert(fromGeneric: select) {
    ...
    public var super_eREPRESENTATION_ITEM: eREPRESENTATION_ITEM? {
      ...
      case ._CAMERA_MODEL(let entity): return entity.super_eREPRESENTATION_ITEM
    ...
    public var super_eGEOMETRIC_REPRESENTATION_ITEM: eGEOMETRIC_REPRESENTATION_ITEM? {
      ...
      case ._CAMERA_MODEL(let entity): return entity.super_eGEOMETRIC_REPRESENTATION_ITEM
    ...
    /// attribute of SELECT type ``sDRAUGHTING_MODEL_ITEM_SELECT``
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      case ._CAMERA_MODEL(let selectValue): result = eCAMERA_MODEL.validateWhereRules(instance:selectValue, 
