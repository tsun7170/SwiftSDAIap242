/* file: datum_reference_modifier.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sDATUM_REFERENCE_MODIFIER : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDATUM_REFERENCE_MODIFIER__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATUM_REFERENCE_MODIFIER_WITH_VALUE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATUM_REFERENCE_MODIFIER``
    @_documentation(visibility:public)
    case _DATUM_REFERENCE_MODIFIER_WITH_VALUE(eDATUM_REFERENCE_MODIFIER_WITH_VALUE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/nSIMPLE_DATUM_REFERENCE_MODIFIER`` (ENUM) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATUM_REFERENCE_MODIFIER``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATUM_REFERENCE_MODIFIER``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDATUM_REFERENCE_MODIFIER__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDATUM_REFERENCE_MODIFIER__type, SDAI.DefinedType
