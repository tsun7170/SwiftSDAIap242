/* file: datum_reference_modifier.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_TYPE; -- datum_reference_modifier (line:2104 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  CASE: datum_reference_modifier_with_value (*ENTITY*):
  ATTR:  modifier_value: length_measure_with_unit
  ATTR:  modifier_type: datum_reference_modifier_type

  CASE: simple_datum_reference_modifier (*ENUM*): simple_datum_reference_modifier
...
```
*/
  public enum sDATUM_REFERENCE_MODIFIER : SDAI.Value, TypeHierarchy.sDATUM_REFERENCE_MODIFIER__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATUM_REFERENCE_MODIFIER_WITH_VALUE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATUM_REFERENCE_MODIFIER``
    @_documentation(visibility:public)
    case _DATUM_REFERENCE_MODIFIER_WITH_VALUE(eDATUM_REFERENCE_MODIFIER_WITH_VALUE.PRef)	// (ENTITY)

    /// SELECT case (ENUM)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/nSIMPLE_DATUM_REFERENCE_MODIFIER`` (ENUM)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATUM_REFERENCE_MODIFIER``
    @_documentation(visibility:public)
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eDATUM_REFERENCE_MODIFIER_WITH_VALUE.self) {self = ._DATUM_REFERENCE_MODIFIER_WITH_VALUE(base.pRef) }
      else { return nil }
    }
    ...
    public init?<G: SDAI.GenericType>(fromGeneric generic: G?) {
      ...
      else if let base = eDATUM_REFERENCE_MODIFIER_WITH_VALUE.PRef.convert(fromGeneric: select) {
    ...
    public static let bareTypeName: String = "DATUM_REFERENCE_MODIFIER"
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATUM_REFERENCE_MODIFIER``
    public var super_eDATUM_REFERENCE_MODIFIER_WITH_VALUE: eDATUM_REFERENCE_MODIFIER_WITH_VALUE.PRef {
      switch self {
      case ._DATUM_REFERENCE_MODIFIER_WITH_VALUE(let entity): return entity
      default: return eDATUM_REFERENCE_MODIFIER_WITH_VALUE.PRef(nil)
      }
    }
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATUM_REFERENCE_MODIFIER``
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATUM_REFERENCE_MODIFIER_WITH_VALUE`` )
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      switch self {
      case ._DATUM_REFERENCE_MODIFIER_WITH_VALUE(let entity): return entity.persistentEntityReferences
      case ._SIMPLE_DATUM_REFERENCE_MODIFIER: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      }
    }
    ...
    public func isHolding(entityReference: SDAI.EntityReference) -> Bool {
      ...
      case ._SIMPLE_DATUM_REFERENCE_MODIFIER: return false
      }
    }
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._DATUM_REFERENCE_MODIFIER_WITH_VALUE(let entity): 
        ...
        result = eDATUM_REFERENCE_MODIFIER_WITH_VALUE.validateWhereRules(instance: entity.eval, 
...
public protocol sDATUM_REFERENCE_MODIFIER__TypeBehavior: SDAI.SelectType {
  ...
  var super_eDATUM_REFERENCE_MODIFIER_WITH_VALUE: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDATUM_REFERENCE_MODIFIER_WITH_VALUE.PRef { get }

  //MARK: ENTITY ATTRIBUTE REFERENCES
  var MODIFIER_VALUE: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eLENGTH_MEASURE_WITH_UNIT.PRef?  { get }
  var MODIFIER_TYPE: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.nDATUM_REFERENCE_MODIFIER_TYPE?  { get }
}
}

extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sDATUM_REFERENCE_MODIFIER__Subtype: 
  sDATUM_REFERENCE_MODIFIER__TypeBehavior, SDAI.DefinedType
where Supertype: sDATUM_REFERENCE_MODIFIER__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sDATUM_REFERENCE_MODIFIER__Subtype {
  //MARK: CONSTRUCTORS
  ...
  var super_eDATUM_REFERENCE_MODIFIER_WITH_VALUE: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDATUM_REFERENCE_MODIFIER_WITH_VALUE.PRef { rep.super_eDATUM_REFERENCE_MODIFIER_WITH_VALUE }

  //MARK: ENTITY ATTRIBUTE REFERENCES
  var MODIFIER_VALUE: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eLENGTH_MEASURE_WITH_UNIT.PRef?  { rep.MODIFIER_VALUE }
