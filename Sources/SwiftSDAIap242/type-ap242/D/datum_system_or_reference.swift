/* file: datum_system_or_reference.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  public enum sDATUM_SYSTEM_OR_REFERENCE : SDAI.Value, TypeHierarchy.sDATUM_SYSTEM_OR_REFERENCE__TypeBehavior {
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._DATUM_REFERENCE(let entity): 
        ...
        result = eDATUM_REFERENCE.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._DATUM_SYSTEM(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eDATUM_SYSTEM.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case nil: break
      }
