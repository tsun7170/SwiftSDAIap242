/* file: datum_system_or_reference.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sDATUM_SYSTEM_OR_REFERENCE : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDATUM_SYSTEM_OR_REFERENCE__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATUM_REFERENCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATUM_SYSTEM_OR_REFERENCE``
    @_documentation(visibility:public)
    case _DATUM_REFERENCE(eDATUM_REFERENCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATUM_SYSTEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATUM_SYSTEM_OR_REFERENCE``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATUM_SYSTEM_OR_REFERENCE``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDATUM_SYSTEM_OR_REFERENCE__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDATUM_SYSTEM_OR_REFERENCE__type, SDAI.DefinedType
