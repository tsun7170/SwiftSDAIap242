/* file: date_time_item.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  TYPE date_time_item = SELECT
    ( approval_person_organization (*ENTITY*),
     ...
     start_work (*ENTITY*) );
  END_TYPE; -- date_time_item (line:2067 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  public enum sDATE_TIME_ITEM : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDATE_TIME_ITEM__type {
    ...
    /// SELECT case ``eAPPROVAL_PERSON_ORGANIZATION`` (ENTITY) in ``sDATE_TIME_ITEM``
    case _APPROVAL_PERSON_ORGANIZATION(eAPPROVAL_PERSON_ORGANIZATION)	// (ENTITY)

    /// SELECT case ``eCERTIFICATION`` (ENTITY) in ``sDATE_TIME_ITEM``
    case _CERTIFICATION(eCERTIFICATION)	// (ENTITY)

    /// SELECT case ``eCHANGE`` (ENTITY) in ``sDATE_TIME_ITEM``
    case _CHANGE(eCHANGE)	// (ENTITY)

    /// SELECT case ``eCHANGE_REQUEST`` (ENTITY) in ``sDATE_TIME_ITEM``
    case _CHANGE_REQUEST(eCHANGE_REQUEST)	// (ENTITY)

    /// SELECT case ``eCONTRACT`` (ENTITY) in ``sDATE_TIME_ITEM``
    case _CONTRACT(eCONTRACT)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION`` (ENTITY) in ``sDATE_TIME_ITEM``
    case _PRODUCT_DEFINITION(ePRODUCT_DEFINITION)	// (ENTITY)

    /// SELECT case ``eSECURITY_CLASSIFICATION`` (ENTITY) in ``sDATE_TIME_ITEM``
    case _SECURITY_CLASSIFICATION(eSECURITY_CLASSIFICATION)	// (ENTITY)

    /// SELECT case ``eSTART_REQUEST`` (ENTITY) in ``sDATE_TIME_ITEM``
    case _START_REQUEST(eSTART_REQUEST)	// (ENTITY)

    /// SELECT case ``eSTART_WORK`` (ENTITY) in ``sDATE_TIME_ITEM``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eAPPROVAL_PERSON_ORGANIZATION.self) {self = ._APPROVAL_PERSON_ORGANIZATION(base) }
    ...
    public static var bareTypeName: String = "DATE_TIME_ITEM"
    ...
    /// attribute of SELECT type ``sDATE_TIME_ITEM``
    ...
    public static var typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.DATE_TIME_ITEM"
