/* file: date_and_time_item.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sDATE_AND_TIME_ITEM : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDATE_AND_TIME_ITEM__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _ACTION(eACTION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_DIRECTIVE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _ACTION_DIRECTIVE(eACTION_DIRECTIVE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_METHOD`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _ACTION_METHOD(eACTION_METHOD.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_PROPERTY`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _ACTION_PROPERTY(eACTION_PROPERTY.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_RELATIONSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _ACTION_RELATIONSHIP(eACTION_RELATIONSHIP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_REQUEST_SOLUTION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _ACTION_REQUEST_SOLUTION(eACTION_REQUEST_SOLUTION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eALTERNATE_PRODUCT_RELATIONSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _ALTERNATE_PRODUCT_RELATIONSHIP(eALTERNATE_PRODUCT_RELATIONSHIP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANALYSIS_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _ANALYSIS_ASSIGNMENT(eANALYSIS_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_ACTION_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_ACTION_ASSIGNMENT(eAPPLIED_ACTION_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_ACTION_METHOD_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_ACTION_METHOD_ASSIGNMENT(eAPPLIED_ACTION_METHOD_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_CERTIFICATION_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_CERTIFICATION_ASSIGNMENT(eAPPLIED_CERTIFICATION_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_CLASSIFICATION_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_CLASSIFICATION_ASSIGNMENT(eAPPLIED_CLASSIFICATION_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_CONTRACT_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_CONTRACT_ASSIGNMENT(eAPPLIED_CONTRACT_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_DOCUMENT_REFERENCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_DOCUMENT_REFERENCE(eAPPLIED_DOCUMENT_REFERENCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_DOCUMENT_USAGE_CONSTRAINT_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_DOCUMENT_USAGE_CONSTRAINT_ASSIGNMENT(
      eAPPLIED_DOCUMENT_USAGE_CONSTRAINT_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_EFFECTIVITY_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_EFFECTIVITY_ASSIGNMENT(eAPPLIED_EFFECTIVITY_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_EVENT_OCCURRENCE_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_EVENT_OCCURRENCE_ASSIGNMENT(eAPPLIED_EVENT_OCCURRENCE_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_IDENTIFICATION_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_IDENTIFICATION_ASSIGNMENT(eAPPLIED_IDENTIFICATION_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_ORGANIZATIONAL_PROJECT_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_ORGANIZATIONAL_PROJECT_ASSIGNMENT(
      eAPPLIED_ORGANIZATIONAL_PROJECT_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_ORGANIZATION_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_ORGANIZATION_ASSIGNMENT(eAPPLIED_ORGANIZATION_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_PERSON_AND_ORGANIZATION_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_PERSON_AND_ORGANIZATION_ASSIGNMENT(
      eAPPLIED_PERSON_AND_ORGANIZATION_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_SECURITY_CLASSIFICATION_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_SECURITY_CLASSIFICATION_ASSIGNMENT(
      eAPPLIED_SECURITY_CLASSIFICATION_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_USAGE_RIGHT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_USAGE_RIGHT(eAPPLIED_USAGE_RIGHT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPROVAL`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _APPROVAL(eAPPROVAL.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPROVAL_PERSON_ORGANIZATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _APPROVAL_PERSON_ORGANIZATION(eAPPROVAL_PERSON_ORGANIZATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPROVAL_STATUS`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _APPROVAL_STATUS(eAPPROVAL_STATUS.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eASCRIBABLE_STATE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _ASCRIBABLE_STATE(eASCRIBABLE_STATE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eASSEMBLY_COMPONENT_USAGE_SUBSTITUTE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _ASSEMBLY_COMPONENT_USAGE_SUBSTITUTE(eASSEMBLY_COMPONENT_USAGE_SUBSTITUTE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCERTIFICATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _CERTIFICATION(eCERTIFICATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCLASS`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _CLASS(eCLASS.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCLASS_SYSTEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _CLASS_SYSTEM(eCLASS_SYSTEM.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONFIGURATION_DESIGN`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _CONFIGURATION_DESIGN(eCONFIGURATION_DESIGN.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONFIGURATION_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _CONFIGURATION_ITEM(eCONFIGURATION_ITEM.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONFIGURED_EFFECTIVITY_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _CONFIGURED_EFFECTIVITY_ASSIGNMENT(eCONFIGURED_EFFECTIVITY_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONTRACT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _CONTRACT(eCONTRACT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_EQUIVALENCE_DEFINITION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _DATA_EQUIVALENCE_DEFINITION(eDATA_EQUIVALENCE_DEFINITION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_QUALITY_DEFINITION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _DATA_QUALITY_DEFINITION(eDATA_QUALITY_DEFINITION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATE_AND_TIME_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _DATE_AND_TIME_ASSIGNMENT(eDATE_AND_TIME_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATE_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _DATE_ASSIGNMENT(eDATE_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIRECTED_ACTION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _DIRECTED_ACTION(eDIRECTED_ACTION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDOCUMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _DOCUMENT(eDOCUMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDOCUMENT_FILE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _DOCUMENT_FILE(eDOCUMENT_FILE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDRAUGHTING_MODEL`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _DRAUGHTING_MODEL(eDRAUGHTING_MODEL.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDRAWING_REVISION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _DRAWING_REVISION(eDRAWING_REVISION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEFFECTIVITY`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _EFFECTIVITY(eEFFECTIVITY.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eENVELOPE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _ENVELOPE(eENVELOPE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEVENT_OCCURRENCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _EVENT_OCCURRENCE(eEVENT_OCCURRENCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEVIDENCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _EVIDENCE(eEVIDENCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXECUTED_ACTION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _EXECUTED_ACTION(eEXECUTED_ACTION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGENERAL_PROPERTY`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _GENERAL_PROPERTY(eGENERAL_PROPERTY.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGENERAL_PROPERTY_RELATIONSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _GENERAL_PROPERTY_RELATIONSHIP(eGENERAL_PROPERTY_RELATIONSHIP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINFORMATION_USAGE_RIGHT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _INFORMATION_USAGE_RIGHT(eINFORMATION_USAGE_RIGHT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACE_CONNECTION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _INTERFACE_CONNECTION(eINTERFACE_CONNECTION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACE_CONNECTOR_AS_PLANNED`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _INTERFACE_CONNECTOR_AS_PLANNED(eINTERFACE_CONNECTOR_AS_PLANNED.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACE_CONNECTOR_AS_REALIZED`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _INTERFACE_CONNECTOR_AS_REALIZED(eINTERFACE_CONNECTOR_AS_REALIZED.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACE_CONNECTOR_DESIGN_TO_PLANNED`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _INTERFACE_CONNECTOR_DESIGN_TO_PLANNED(eINTERFACE_CONNECTOR_DESIGN_TO_PLANNED.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACE_CONNECTOR_DESIGN_TO_REALIZED`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _INTERFACE_CONNECTOR_DESIGN_TO_REALIZED(eINTERFACE_CONNECTOR_DESIGN_TO_REALIZED.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACE_CONNECTOR_OCCURRENCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _INTERFACE_CONNECTOR_OCCURRENCE(eINTERFACE_CONNECTOR_OCCURRENCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACE_CONNECTOR_PLANNED_TO_REALIZED`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _INTERFACE_CONNECTOR_PLANNED_TO_REALIZED(eINTERFACE_CONNECTOR_PLANNED_TO_REALIZED.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACE_DEFINITION_CONNECTION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _INTERFACE_DEFINITION_CONNECTION(eINTERFACE_DEFINITION_CONNECTION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACE_DEFINITION_FOR`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _INTERFACE_DEFINITION_FOR(eINTERFACE_DEFINITION_FOR.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMATERIAL_DESIGNATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _MATERIAL_DESIGNATION(eMATERIAL_DESIGNATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_REPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    ...
    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eORGANIZATIONAL_ADDRESS`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _ORGANIZATIONAL_ADDRESS(eORGANIZATIONAL_ADDRESS.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eORGANIZATIONAL_PROJECT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _ORGANIZATIONAL_PROJECT(eORGANIZATIONAL_PROJECT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eORGANIZATION_RELATIONSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _ORGANIZATION_RELATIONSHIP(eORGANIZATION_RELATIONSHIP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePERSON`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _PERSON(ePERSON.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePERSON_AND_ORGANIZATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _PERSON_AND_ORGANIZATION(ePERSON_AND_ORGANIZATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESENTATION_AREA`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _PRESENTATION_AREA(ePRESENTATION_AREA.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT(ePRODUCT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_CONCEPT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_CONCEPT(ePRODUCT_CONCEPT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_CONCEPT_FEATURE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_CONCEPT_FEATURE(ePRODUCT_CONCEPT_FEATURE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_CONCEPT_FEATURE_ASSOCIATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_CONCEPT_FEATURE_ASSOCIATION(ePRODUCT_CONCEPT_FEATURE_ASSOCIATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_CONCEPT_FEATURE_CATEGORY`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_CONCEPT_FEATURE_CATEGORY(ePRODUCT_CONCEPT_FEATURE_CATEGORY.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_CONCEPT_FEATURE_CATEGORY_USAGE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_CONCEPT_FEATURE_CATEGORY_USAGE(ePRODUCT_CONCEPT_FEATURE_CATEGORY_USAGE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION(ePRODUCT_DEFINITION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_CONTEXT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION_CONTEXT(ePRODUCT_DEFINITION_CONTEXT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_FORMATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION_FORMATION(ePRODUCT_DEFINITION_FORMATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_FORMATION_RELATIONSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION_FORMATION_RELATIONSHIP(
      ePRODUCT_DEFINITION_FORMATION_RELATIONSHIP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_RELATIONSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION_RELATIONSHIP(ePRODUCT_DEFINITION_RELATIONSHIP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_SUBSTITUTE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION_SUBSTITUTE(ePRODUCT_DEFINITION_SUBSTITUTE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_GROUP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_GROUP(ePRODUCT_GROUP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_GROUP_MEMBERSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_GROUP_MEMBERSHIP(ePRODUCT_GROUP_MEMBERSHIP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_GROUP_RELATIONSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_GROUP_RELATIONSHIP(ePRODUCT_GROUP_RELATIONSHIP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_IDENTIFICATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_IDENTIFICATION(ePRODUCT_IDENTIFICATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROPERTY_DEFINITION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _PROPERTY_DEFINITION(ePROPERTY_DEFINITION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROPERTY_DEFINITION_REPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _PROPERTY_DEFINITION_REPRESENTATION(ePROPERTY_DEFINITION_REPRESENTATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _REPRESENTATION(eREPRESENTATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREQUIREMENT_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _REQUIREMENT_ASSIGNMENT(eREQUIREMENT_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREQUIREMENT_FOR_ACTION_RESOURCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _REQUIREMENT_FOR_ACTION_RESOURCE(eREQUIREMENT_FOR_ACTION_RESOURCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREQUIREMENT_SOURCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _REQUIREMENT_SOURCE(eREQUIREMENT_SOURCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRESOURCE_PROPERTY`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _RESOURCE_PROPERTY(eRESOURCE_PROPERTY.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRULE_ACTION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _RULE_ACTION(eRULE_ACTION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSECURITY_CLASSIFICATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _SECURITY_CLASSIFICATION(eSECURITY_CLASSIFICATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSECURITY_CLASSIFICATION_LEVEL`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _SECURITY_CLASSIFICATION_LEVEL(eSECURITY_CLASSIFICATION_LEVEL.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_REPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _SHAPE_REPRESENTATION(eSHAPE_REPRESENTATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTATE_OBSERVED`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _STATE_OBSERVED(eSTATE_OBSERVED.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTATE_OBSERVED_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _STATE_OBSERVED_ASSIGNMENT(eSTATE_OBSERVED_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTATE_OBSERVED_RELATIONSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _STATE_OBSERVED_RELATIONSHIP(eSTATE_OBSERVED_RELATIONSHIP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTATE_TYPE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _STATE_TYPE(eSTATE_TYPE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTATE_TYPE_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _STATE_TYPE_ASSIGNMENT(eSTATE_TYPE_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTATE_TYPE_RELATIONSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _STATE_TYPE_RELATIONSHIP(eSTATE_TYPE_RELATIONSHIP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTRUCTURED_MESSAGE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _STRUCTURED_MESSAGE(eSTRUCTURED_MESSAGE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eVALIDATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _VALIDATION(eVALIDATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eVERIFICATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _VERIFICATION(eVERIFICATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eVERIFICATION_RELATIONSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    case _VERIFICATION_RELATIONSHIP(eVERIFICATION_RELATIONSHIP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eVERSIONED_ACTION_REQUEST`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_AND_TIME_ITEM``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDATE_AND_TIME_ITEM__type: SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDATE_AND_TIME_ITEM__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDATE_AND_TIME_ITEM__type, SDAI.DefinedType
