/* file: date_and_time_item.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
*/
  public enum sDATE_AND_TIME_ITEM : SDAI.Value, TypeHierarchy.sDATE_AND_TIME_ITEM__TypeBehavior {
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._DIRECTED_ACTION(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eDIRECTED_ACTION.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._DOCUMENT(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eDOCUMENT.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._DOCUMENT_FILE(let entity): 
        if !entity.shouldPropagateValidation { break }
      ...
      case ._RULE_ACTION(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eRULE_ACTION.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._SECURITY_CLASSIFICATION(let entity): 
        if !entity.shouldPropagateValidation { break }
