/* file: draughting_subfigure_representation_item.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sDRAUGHTING_SUBFIGURE_REPRESENTATION_ITEM : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDRAUGHTING_SUBFIGURE_REPRESENTATION_ITEM__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANNOTATION_OCCURRENCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDRAUGHTING_SUBFIGURE_REPRESENTATION_ITEM``
    @_documentation(visibility:public)
    case _ANNOTATION_OCCURRENCE(eANNOTATION_OCCURRENCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIS2_PLACEMENT`` (SELECT) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDRAUGHTING_SUBFIGURE_REPRESENTATION_ITEM``
    @_documentation(visibility:public)
    case _AXIS2_PLACEMENT(sAXIS2_PLACEMENT)	// (SELECT)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDRAUGHTING_CALLOUT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDRAUGHTING_SUBFIGURE_REPRESENTATION_ITEM``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDRAUGHTING_SUBFIGURE_REPRESENTATION_ITEM``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDRAUGHTING_SUBFIGURE_REPRESENTATION_ITEM__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDRAUGHTING_SUBFIGURE_REPRESENTATION_ITEM__type, SDAI.DefinedType
