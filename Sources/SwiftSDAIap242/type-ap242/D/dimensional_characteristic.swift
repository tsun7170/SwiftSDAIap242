/* file: dimensional_characteristic.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sDIMENSIONAL_CHARACTERISTIC : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDIMENSIONAL_CHARACTERISTIC__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIMENSIONAL_LOCATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDIMENSIONAL_CHARACTERISTIC``
    @_documentation(visibility:public)
    case _DIMENSIONAL_LOCATION(eDIMENSIONAL_LOCATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIMENSIONAL_SIZE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDIMENSIONAL_CHARACTERISTIC``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDIMENSIONAL_CHARACTERISTIC``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDIMENSIONAL_CHARACTERISTIC__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDIMENSIONAL_CHARACTERISTIC__type, SDAI.DefinedType
