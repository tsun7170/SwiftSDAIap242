/* file: dimensional_characteristic.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_TYPE; -- dimensional_characteristic (line:2348 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sDIMENSIONAL_CHARACTERISTIC : SDAI.Value, TypeHierarchy.sDIMENSIONAL_CHARACTERISTIC__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIMENSIONAL_LOCATION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDIMENSIONAL_CHARACTERISTIC``
    ...
    public static let bareTypeName: String = "DIMENSIONAL_CHARACTERISTIC"
...
public protocol sDIMENSIONAL_CHARACTERISTIC__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sDIMENSIONAL_CHARACTERISTIC__Subtype: 
  sDIMENSIONAL_CHARACTERISTIC__TypeBehavior, SDAI.DefinedType
where Supertype: sDIMENSIONAL_CHARACTERISTIC__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sDIMENSIONAL_CHARACTERISTIC__Subtype {
  //MARK: CONSTRUCTORS
