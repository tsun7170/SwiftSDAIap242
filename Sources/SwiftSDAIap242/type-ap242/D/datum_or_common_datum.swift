/* file: datum_or_common_datum.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sDATUM_OR_COMMON_DATUM : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDATUM_OR_COMMON_DATUM__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tCOMMON_DATUM_LIST`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATUM_OR_COMMON_DATUM``
    @_documentation(visibility:public)
    case _COMMON_DATUM_LIST(tCOMMON_DATUM_LIST)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATUM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATUM_OR_COMMON_DATUM``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATUM_OR_COMMON_DATUM``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDATUM_OR_COMMON_DATUM__type: 
  SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDATUM_OR_COMMON_DATUM__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDATUM_OR_COMMON_DATUM__type, SDAI.DefinedType
