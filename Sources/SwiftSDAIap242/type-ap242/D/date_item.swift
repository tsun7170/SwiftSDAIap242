/* file: date_item.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sDATE_ITEM : SDAI.Value, TypeHierarchy.sDATE_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDATE_ITEM``
...
public protocol sDATE_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sDATE_ITEM__Subtype: sDATE_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sDATE_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sDATE_ITEM__Subtype {
  //MARK: CONSTRUCTORS
