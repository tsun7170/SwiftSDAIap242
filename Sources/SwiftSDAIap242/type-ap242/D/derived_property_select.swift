/* file: derived_property_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sDERIVED_PROPERTY_SELECT : SDAI.Value, TypeHierarchy.sDERIVED_PROPERTY_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_PROPERTY`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDERIVED_PROPERTY_SELECT``
...
public protocol sDERIVED_PROPERTY_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sDERIVED_PROPERTY_SELECT__Subtype: sDERIVED_PROPERTY_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sDERIVED_PROPERTY_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sDERIVED_PROPERTY_SELECT__Subtype {
  //MARK: CONSTRUCTORS
