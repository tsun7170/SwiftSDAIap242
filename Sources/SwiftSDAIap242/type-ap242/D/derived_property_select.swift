/* file: derived_property_select.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
/*
  ...
  END_TYPE; -- derived_property_select (line:2146 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sDERIVED_PROPERTY_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDERIVED_PROPERTY_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_PROPERTY`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDERIVED_PROPERTY_SELECT``
    @_documentation(visibility:public)
    case _ACTION_PROPERTY(eACTION_PROPERTY.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIMENSIONAL_LOCATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDERIVED_PROPERTY_SELECT``
    @_documentation(visibility:public)
    case _DIMENSIONAL_LOCATION(eDIMENSIONAL_LOCATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIMENSIONAL_SIZE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDERIVED_PROPERTY_SELECT``
    @_documentation(visibility:public)
    case _DIMENSIONAL_SIZE(eDIMENSIONAL_SIZE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGEOMETRIC_TOLERANCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDERIVED_PROPERTY_SELECT``
    @_documentation(visibility:public)
    case _GEOMETRIC_TOLERANCE(eGEOMETRIC_TOLERANCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROPERTY_DEFINITION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDERIVED_PROPERTY_SELECT``
    @_documentation(visibility:public)
    case _PROPERTY_DEFINITION(ePROPERTY_DEFINITION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRESOURCE_PROPERTY`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDERIVED_PROPERTY_SELECT``
    @_documentation(visibility:public)
    ...
    public static let bareTypeName: String = "DERIVED_PROPERTY_SELECT"
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDERIVED_PROPERTY_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDERIVED_PROPERTY_SELECT__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDERIVED_PROPERTY_SELECT__type, SDAI.DefinedType
