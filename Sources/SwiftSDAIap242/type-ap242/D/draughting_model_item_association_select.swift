/* file: draughting_model_item_association_select.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sDRAUGHTING_MODEL_ITEM_ASSOCIATION_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDRAUGHTING_MODEL_ITEM_ASSOCIATION_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANNOTATION_OCCURRENCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDRAUGHTING_MODEL_ITEM_ASSOCIATION_SELECT``
    @_documentation(visibility:public)
    case _ANNOTATION_OCCURRENCE(eANNOTATION_OCCURRENCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDRAUGHTING_CALLOUT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDRAUGHTING_MODEL_ITEM_ASSOCIATION_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDRAUGHTING_MODEL_ITEM_ASSOCIATION_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDRAUGHTING_MODEL_ITEM_ASSOCIATION_SELECT__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sDRAUGHTING_MODEL_ITEM_ASSOCIATION_SELECT__type, SDAI.DefinedType
