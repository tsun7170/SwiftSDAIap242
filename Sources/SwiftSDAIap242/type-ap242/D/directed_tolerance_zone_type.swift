/* file: directed_tolerance_zone_type.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  TYPE directed_tolerance_zone_type = ENUMERATION OF
    ( perpendicular,
     parallel,
     including );
  END_TYPE; -- directed_tolerance_zone_type (line:2353 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum nDIRECTED_TOLERANCE_ZONE_TYPE : SDAI.ENUMERATION, SDAI.Value, 
    TypeHierarchy.nDIRECTED_TOLERANCE_ZONE_TYPE__TypeBehavior {
    /// ENUMERATION case
    ///
    /// - defined in: ``nDIRECTED_TOLERANCE_ZONE_TYPE``
    case PERPENDICULAR
    /// ENUMERATION case
    ///
    /// - defined in: ``nDIRECTED_TOLERANCE_ZONE_TYPE``
    ...
    public static let bareTypeName: String = "DIRECTED_TOLERANCE_ZONE_TYPE"
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nDIRECTED_TOLERANCE_ZONE_TYPE__TypeBehavior: SDAI.EnumerationType {}
}

extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nDIRECTED_TOLERANCE_ZONE_TYPE__Subtype: 
  nDIRECTED_TOLERANCE_ZONE_TYPE__TypeBehavior, SDAI.DefinedType
where Supertype: nDIRECTED_TOLERANCE_ZONE_TYPE__TypeBehavior
{}
}
