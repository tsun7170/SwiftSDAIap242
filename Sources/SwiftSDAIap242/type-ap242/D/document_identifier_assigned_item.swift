/* file: document_identifier_assigned_item.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  TYPE document_identifier_assigned_item = SELECT
    ( document (*ENTITY*) );
  END_TYPE; -- document_identifier_assigned_item (line:2364 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sDOCUMENT_IDENTIFIER_ASSIGNED_ITEM : SDAI.Value, TypeHierarchy.sDOCUMENT_IDENTIFIER_ASSIGNED_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDOCUMENT`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sDOCUMENT_IDENTIFIER_ASSIGNED_ITEM``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eDOCUMENT.self) {self = ._DOCUMENT(base.pRef) }
      else { return nil }
    }
    ...
    public static let bareTypeName: String = "DOCUMENT_IDENTIFIER_ASSIGNED_ITEM"
...
public protocol sDOCUMENT_IDENTIFIER_ASSIGNED_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sDOCUMENT_IDENTIFIER_ASSIGNED_ITEM__Subtype: 
  sDOCUMENT_IDENTIFIER_ASSIGNED_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sDOCUMENT_IDENTIFIER_ASSIGNED_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sDOCUMENT_IDENTIFIER_ASSIGNED_ITEM__Subtype {
  //MARK: CONSTRUCTORS
