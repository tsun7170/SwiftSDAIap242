/* file: text_or_character.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
```
*/
  public enum sTEXT_OR_CHARACTER : SDAI.Value, TypeHierarchy.sTEXT_OR_CHARACTER__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANNOTATION_TEXT`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTEXT_OR_CHARACTER``
...
public protocol sTEXT_OR_CHARACTER__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sTEXT_OR_CHARACTER__Subtype: sTEXT_OR_CHARACTER__TypeBehavior, SDAI.DefinedType
where Supertype: sTEXT_OR_CHARACTER__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sTEXT_OR_CHARACTER__Subtype {
  //MARK: CONSTRUCTORS
