/* file: tolerance_method_definition.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- tolerance_method_definition (line:5858 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sTOLERANCE_METHOD_DEFINITION : SDAI.Value, TypeHierarchy.sTOLERANCE_METHOD_DEFINITION__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLIMITS_AND_FITS`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTOLERANCE_METHOD_DEFINITION``
    ...
    public static let bareTypeName: String = "TOLERANCE_METHOD_DEFINITION"
...
public protocol sTOLERANCE_METHOD_DEFINITION__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sTOLERANCE_METHOD_DEFINITION__Subtype: 
  sTOLERANCE_METHOD_DEFINITION__TypeBehavior, SDAI.DefinedType
where Supertype: sTOLERANCE_METHOD_DEFINITION__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sTOLERANCE_METHOD_DEFINITION__Subtype {
  //MARK: CONSTRUCTORS
