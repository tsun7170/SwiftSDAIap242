/* file: tolerance_method_definition.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sTOLERANCE_METHOD_DEFINITION : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTOLERANCE_METHOD_DEFINITION__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLIMITS_AND_FITS`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTOLERANCE_METHOD_DEFINITION``
    @_documentation(visibility:public)
    case _LIMITS_AND_FITS(eLIMITS_AND_FITS.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTOLERANCE_VALUE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTOLERANCE_METHOD_DEFINITION``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTOLERANCE_METHOD_DEFINITION``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTOLERANCE_METHOD_DEFINITION__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTOLERANCE_METHOD_DEFINITION__type, SDAI.DefinedType
