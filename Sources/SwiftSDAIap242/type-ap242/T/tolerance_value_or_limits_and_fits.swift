/* file: tolerance_value_or_limits_and_fits.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
/*
  ...
  END_TYPE; -- tolerance_value_or_limits_and_fits (line:5863 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  CASE: limits_and_fits (*ENTITY*):
  ATTR:  form_variance: label
  ATTR:  grade: label
  ATTR:  source: text
  ATTR:  zone_variance: label

  CASE: tolerance_value (*ENTITY*):
...
```
*/
  public enum sTOLERANCE_VALUE_OR_LIMITS_AND_FITS : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTOLERANCE_VALUE_OR_LIMITS_AND_FITS__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLIMITS_AND_FITS`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTOLERANCE_VALUE_OR_LIMITS_AND_FITS``
    @_documentation(visibility:public)
    case _LIMITS_AND_FITS(eLIMITS_AND_FITS.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTOLERANCE_VALUE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTOLERANCE_VALUE_OR_LIMITS_AND_FITS``
    @_documentation(visibility:public)
    case _TOLERANCE_VALUE(eTOLERANCE_VALUE.PRef)	// (ENTITY)
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eLIMITS_AND_FITS.self) {self = ._LIMITS_AND_FITS(base.pRef) }
      else if let base = complex.entityReference(eTOLERANCE_VALUE.self) {self = ._TOLERANCE_VALUE(base.pRef) }
      else { return nil }
    }
    ...
    public init?<G: SDAI.GenericType>(fromGeneric generic: G?) {
      ...
      else if let base = eLIMITS_AND_FITS.PRef.convert(fromGeneric: select) {
        self = ._LIMITS_AND_FITS(base)
      }
      else if let base = eTOLERANCE_VALUE.PRef.convert(fromGeneric: select) {
    ...
    public static let bareTypeName: String = "TOLERANCE_VALUE_OR_LIMITS_AND_FITS"
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTOLERANCE_VALUE_OR_LIMITS_AND_FITS``
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTOLERANCE_VALUE`` )
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTOLERANCE_VALUE_OR_LIMITS_AND_FITS``
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLIMITS_AND_FITS`` )
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      switch self {
      case ._LIMITS_AND_FITS(let entity): return entity.persistentEntityReferences
      case ._TOLERANCE_VALUE(let entity): return entity.persistentEntityReferences
      }
    }
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      switch instance {
      case ._LIMITS_AND_FITS(let entity): 
        result = eLIMITS_AND_FITS.validateWhereRules(instance: entity.eval, 
        prefix:prefix + "\\LIMITS_AND_FITS")
      case ._TOLERANCE_VALUE(let entity): 
        result = eTOLERANCE_VALUE.validateWhereRules(instance: entity.eval, 
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTOLERANCE_VALUE_OR_LIMITS_AND_FITS__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTOLERANCE_VALUE_OR_LIMITS_AND_FITS__type, SDAI.DefinedType
