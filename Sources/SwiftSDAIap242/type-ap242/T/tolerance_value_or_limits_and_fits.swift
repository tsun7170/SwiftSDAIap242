/* file: tolerance_value_or_limits_and_fits.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sTOLERANCE_VALUE_OR_LIMITS_AND_FITS : SDAI.Value, TypeHierarchy.sTOLERANCE_VALUE_OR_LIMITS_AND_FITS__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLIMITS_AND_FITS`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTOLERANCE_VALUE_OR_LIMITS_AND_FITS``
    @_documentation(visibility:public)
    case _LIMITS_AND_FITS(eLIMITS_AND_FITS.PRef)	// (ENTITY)

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTOLERANCE_VALUE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTOLERANCE_VALUE_OR_LIMITS_AND_FITS``
    @_documentation(visibility:public)
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._LIMITS_AND_FITS(let entity): 
        ...
        result = eLIMITS_AND_FITS.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._TOLERANCE_VALUE(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eTOLERANCE_VALUE.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case nil: break
      }
...
public protocol sTOLERANCE_VALUE_OR_LIMITS_AND_FITS__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sTOLERANCE_VALUE_OR_LIMITS_AND_FITS__Subtype: 
  sTOLERANCE_VALUE_OR_LIMITS_AND_FITS__TypeBehavior, SDAI.DefinedType
where Supertype: sTOLERANCE_VALUE_OR_LIMITS_AND_FITS__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sTOLERANCE_VALUE_OR_LIMITS_AND_FITS__Subtype {
  //MARK: CONSTRUCTORS
