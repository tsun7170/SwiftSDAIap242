/* file: tessellation_accuracy_parameter_item.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sTESSELLATION_ACCURACY_PARAMETER_ITEM : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTESSELLATION_ACCURACY_PARAMETER_ITEM__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tANGULAR_DEVIATION`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTESSELLATION_ACCURACY_PARAMETER_ITEM``
    @_documentation(visibility:public)
    case _ANGULAR_DEVIATION(tANGULAR_DEVIATION)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tCHORDAL_DEVIATION`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTESSELLATION_ACCURACY_PARAMETER_ITEM``
    @_documentation(visibility:public)
    case _CHORDAL_DEVIATION(tCHORDAL_DEVIATION)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tLENGTH_TO_HEIGHT_RATIO`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTESSELLATION_ACCURACY_PARAMETER_ITEM``
    @_documentation(visibility:public)
    case _LENGTH_TO_HEIGHT_RATIO(tLENGTH_TO_HEIGHT_RATIO)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tMAXIMUM_EDGE_LENGTH`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTESSELLATION_ACCURACY_PARAMETER_ITEM``
    @_documentation(visibility:public)
    case _MAXIMUM_EDGE_LENGTH(tMAXIMUM_EDGE_LENGTH)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tTESSELLATED_FACET_LONG_SHORT_EDGE_RATIO`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTESSELLATION_ACCURACY_PARAMETER_ITEM``
    @_documentation(visibility:public)
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTESSELLATION_ACCURACY_PARAMETER_ITEM__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTESSELLATION_ACCURACY_PARAMETER_ITEM__type, SDAI.DefinedType
