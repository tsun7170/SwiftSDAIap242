/* file: target_annotated_3d_model_select.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_TYPE; -- target_annotated_3d_model_select (line:5723 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sTARGET_ANNOTATED_3D_MODEL_SELECT : SDAI.Value, TypeHierarchy.sTARGET_ANNOTATED_3D_MODEL_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_REPRESENTATION_RELATIONSHIP`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTARGET_ANNOTATED_3D_MODEL_SELECT``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eSHAPE_REPRESENTATION_RELATIONSHIP.self) {self = ._SHAPE_REPRESENTATION_RELATIONSHIP(base.pRef) }
      else { return nil }
    }
    ...
    public static let bareTypeName: String = "TARGET_ANNOTATED_3D_MODEL_SELECT"
...
public protocol sTARGET_ANNOTATED_3D_MODEL_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sTARGET_ANNOTATED_3D_MODEL_SELECT__Subtype: 
  sTARGET_ANNOTATED_3D_MODEL_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sTARGET_ANNOTATED_3D_MODEL_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sTARGET_ANNOTATED_3D_MODEL_SELECT__Subtype {
  //MARK: CONSTRUCTORS
