/* file: trimming_select.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_TYPE; -- trimming_select (line:5910 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sTRIMMING_SELECT : SDAI.Value, TypeHierarchy.sTRIMMING_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCARTESIAN_POINT`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTRIMMING_SELECT``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eCARTESIAN_POINT.self) {self = ._CARTESIAN_POINT(base.pRef) }
      else { return nil }
    }
    ...
    public static let bareTypeName: String = "TRIMMING_SELECT"
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TRIMMING_SELECT"
...
public protocol sTRIMMING_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sTRIMMING_SELECT__Subtype: sTRIMMING_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sTRIMMING_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sTRIMMING_SELECT__Subtype {
  //MARK: CONSTRUCTORS
