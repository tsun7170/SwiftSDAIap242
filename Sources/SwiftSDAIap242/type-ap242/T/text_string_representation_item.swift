/* file: text_string_representation_item.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sTEXT_STRING_REPRESENTATION_ITEM : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTEXT_STRING_REPRESENTATION_ITEM__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANNOTATION_TEXT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTEXT_STRING_REPRESENTATION_ITEM``
    @_documentation(visibility:public)
    case _ANNOTATION_TEXT(eANNOTATION_TEXT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANNOTATION_TEXT_CHARACTER`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTEXT_STRING_REPRESENTATION_ITEM``
    @_documentation(visibility:public)
    case _ANNOTATION_TEXT_CHARACTER(eANNOTATION_TEXT_CHARACTER.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIS2_PLACEMENT`` (SELECT) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTEXT_STRING_REPRESENTATION_ITEM``
    @_documentation(visibility:public)
    case _AXIS2_PLACEMENT(sAXIS2_PLACEMENT)	// (SELECT)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPOSITE_TEXT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTEXT_STRING_REPRESENTATION_ITEM``
    @_documentation(visibility:public)
    case _COMPOSITE_TEXT(eCOMPOSITE_TEXT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDEFINED_CHARACTER_GLYPH`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTEXT_STRING_REPRESENTATION_ITEM``
    @_documentation(visibility:public)
    case _DEFINED_CHARACTER_GLYPH(eDEFINED_CHARACTER_GLYPH.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTEXT_LITERAL`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTEXT_STRING_REPRESENTATION_ITEM``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTEXT_STRING_REPRESENTATION_ITEM``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTEXT_STRING_REPRESENTATION_ITEM__type: 
  SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTEXT_STRING_REPRESENTATION_ITEM__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTEXT_STRING_REPRESENTATION_ITEM__type, SDAI.DefinedType
where Supertype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTEXT_STRING_REPRESENTATION_ITEM__type
{}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTEXT_STRING_REPRESENTATION_ITEM__subtype {
  //MARK: CONSTRUCTORS
