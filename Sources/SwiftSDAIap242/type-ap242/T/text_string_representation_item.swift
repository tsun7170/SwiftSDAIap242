/* file: text_string_representation_item.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
public protocol sTEXT_STRING_REPRESENTATION_ITEM__TypeBehavior: SDAI.SelectType {
  ...
  var ASSOCIATED_CURVES: (SDAI.SET<AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eCURVE.PRef>/*[1:(nil as 
    SDAI.INTEGER?)]*/ )?  { get }
}
}
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sTEXT_STRING_REPRESENTATION_ITEM__Subtype {
  ...
  var ASSOCIATED_CURVES: (SDAI.SET<AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eCURVE.PRef>/*[1:(nil as 
    SDAI.INTEGER?)]*/ )?  { rep.ASSOCIATED_CURVES }
}
