/* file: tessellated_surface_item.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public enum sTESSELLATED_SURFACE_ITEM : SDAI.Value, TypeHierarchy.sTESSELLATED_SURFACE_ITEM__TypeBehavior {
    ...
    public var ITEMS: (SDAI.SET<eTESSELLATED_STRUCTURED_ITEM.PRef>/*[1:nil]*/ )?  {
      switch self {
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      switch instance {
      case ._TESSELLATED_FACE(let entity): 
        result = eTESSELLATED_FACE.validateWhereRules(instance: entity.eval, 
        prefix:prefix + "\\TESSELLATED_FACE")
      case ._TESSELLATED_SHELL(let entity): 
        result = eTESSELLATED_SHELL.validateWhereRules(instance: entity.eval, 
        prefix:prefix + "\\TESSELLATED_SHELL")
      case ._TESSELLATED_SOLID(let entity): 
        result = eTESSELLATED_SOLID.validateWhereRules(instance: entity.eval, 
