/* file: tessellated_surface_item.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sTESSELLATED_SURFACE_ITEM : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTESSELLATED_SURFACE_ITEM__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTESSELLATED_FACE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTESSELLATED_SURFACE_ITEM``
    @_documentation(visibility:public)
    case _TESSELLATED_FACE(eTESSELLATED_FACE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTESSELLATED_SHELL`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTESSELLATED_SURFACE_ITEM``
    @_documentation(visibility:public)
    case _TESSELLATED_SHELL(eTESSELLATED_SHELL.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTESSELLATED_SOLID`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTESSELLATED_SURFACE_ITEM``
    @_documentation(visibility:public)
    case _TESSELLATED_SOLID(eTESSELLATED_SOLID.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTESSELLATED_SURFACE_SET`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTESSELLATED_SURFACE_ITEM``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTESSELLATED_SURFACE_ITEM``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTESSELLATED_SURFACE_ITEM__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTESSELLATED_SURFACE_ITEM__type, SDAI.DefinedType
