/* file: transformation.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sTRANSFORMATION : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTRANSFORMATION__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFUNCTIONALLY_DEFINED_TRANSFORMATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTRANSFORMATION``
    @_documentation(visibility:public)
    case _FUNCTIONALLY_DEFINED_TRANSFORMATION(eFUNCTIONALLY_DEFINED_TRANSFORMATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eITEM_DEFINED_TRANSFORMATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTRANSFORMATION``
    @_documentation(visibility:public)
    case _ITEM_DEFINED_TRANSFORMATION(eITEM_DEFINED_TRANSFORMATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tLIST_ITEM_DEFINED_TRANSFORMATION`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTRANSFORMATION``
    @_documentation(visibility:public)
    case _LIST_ITEM_DEFINED_TRANSFORMATION(tLIST_ITEM_DEFINED_TRANSFORMATION)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tSET_ITEM_DEFINED_TRANSFORMATION`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTRANSFORMATION``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTRANSFORMATION``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTRANSFORMATION__type: SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTRANSFORMATION__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTRANSFORMATION__type, SDAI.DefinedType
