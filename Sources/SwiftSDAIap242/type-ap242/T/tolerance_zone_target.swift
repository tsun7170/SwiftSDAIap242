/* file: tolerance_zone_target.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sTOLERANCE_ZONE_TARGET : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTOLERANCE_ZONE_TARGET__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIMENSIONAL_LOCATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTOLERANCE_ZONE_TARGET``
    @_documentation(visibility:public)
    case _DIMENSIONAL_LOCATION(eDIMENSIONAL_LOCATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIMENSIONAL_SIZE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTOLERANCE_ZONE_TARGET``
    @_documentation(visibility:public)
    case _DIMENSIONAL_SIZE(eDIMENSIONAL_SIZE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGENERAL_DATUM_REFERENCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTOLERANCE_ZONE_TARGET``
    @_documentation(visibility:public)
    case _GENERAL_DATUM_REFERENCE(eGENERAL_DATUM_REFERENCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGEOMETRIC_TOLERANCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTOLERANCE_ZONE_TARGET``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTOLERANCE_ZONE_TARGET``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTOLERANCE_ZONE_TARGET__type: 
  SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTOLERANCE_ZONE_TARGET__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sTOLERANCE_ZONE_TARGET__type, SDAI.DefinedType
