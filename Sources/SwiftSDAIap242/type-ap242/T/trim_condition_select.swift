/* file: trim_condition_select.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
  public enum sTRIM_CONDITION_SELECT : SDAI.Value, TypeHierarchy.sTRIM_CONDITION_SELECT__TypeBehavior {
    ...
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sTRIM_CONDITION_SELECT``
    /// - origin: SELECT( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGENERALIZED_SURFACE_SELECT`` )
    public var SCALING_FACTORS: (SDAI.LIST<SDAI.REAL>/*[4:?]*/ )?  {
      switch self {
...
public protocol sTRIM_CONDITION_SELECT__TypeBehavior: SDAI.SelectType {
  ...
  var SCALING_FACTORS: (SDAI.LIST<SDAI.REAL>/*[4:?]*/ )?  { get }
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sTRIM_CONDITION_SELECT__Subtype {
  ...
  var SCALING_FACTORS: (SDAI.LIST<SDAI.REAL>/*[4:?]*/ )?  { rep.SCALING_FACTORS }
