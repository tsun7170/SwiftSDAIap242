/* file: text_path.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  TYPE text_path = ENUMERATION OF
    ( left,
     ...
     up,
     down );
  END_TYPE; -- text_path (line:5767 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum nTEXT_PATH : SDAI.ENUMERATION, SDAI.Value, TypeHierarchy.nTEXT_PATH__TypeBehavior {
    /// ENUMERATION case
    ///
    /// - defined in: ``nTEXT_PATH``
    case LEFT
    /// ENUMERATION case
    ///
    /// - defined in: ``nTEXT_PATH``
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TEXT_PATH"
    ...
    public static let bareTypeName: String = "TEXT_PATH"
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nTEXT_PATH__TypeBehavior: SDAI.EnumerationType {}
}

extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nTEXT_PATH__Subtype: nTEXT_PATH__TypeBehavior, SDAI.DefinedType
where Supertype: nTEXT_PATH__TypeBehavior
{}
}
