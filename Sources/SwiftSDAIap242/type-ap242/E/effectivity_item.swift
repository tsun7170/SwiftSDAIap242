/* file: effectivity_item.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_TYPE; -- effectivity_item (line:2626 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  public enum sEFFECTIVITY_ITEM : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sEFFECTIVITY_ITEM__type {
    ...
    /// SELECT case ``eACTION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _ACTION(eACTION)	// (ENTITY)

    /// SELECT case ``eACTION_DIRECTIVE`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _ACTION_DIRECTIVE(eACTION_DIRECTIVE)	// (ENTITY)

    /// SELECT case ``eACTION_DIRECTIVE_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _ACTION_DIRECTIVE_RELATIONSHIP(eACTION_DIRECTIVE_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eACTION_METHOD`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _ACTION_METHOD(eACTION_METHOD)	// (ENTITY)

    /// SELECT case ``eACTION_METHOD_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _ACTION_METHOD_RELATIONSHIP(eACTION_METHOD_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eACTION_PROPERTY`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _ACTION_PROPERTY(eACTION_PROPERTY)	// (ENTITY)

    /// SELECT case ``eACTION_PROPERTY_REPRESENTATION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _ACTION_PROPERTY_REPRESENTATION(eACTION_PROPERTY_REPRESENTATION)	// (ENTITY)

    /// SELECT case ``eACTION_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _ACTION_RELATIONSHIP(eACTION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eALTERNATIVE_SOLUTION_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _ALTERNATIVE_SOLUTION_RELATIONSHIP(eALTERNATIVE_SOLUTION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eAPPLIED_ACTION_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_ACTION_ASSIGNMENT(eAPPLIED_ACTION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_ACTION_METHOD_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_ACTION_METHOD_ASSIGNMENT(eAPPLIED_ACTION_METHOD_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_ACTION_REQUEST_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_ACTION_REQUEST_ASSIGNMENT(eAPPLIED_ACTION_REQUEST_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_APPROVAL_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_APPROVAL_ASSIGNMENT(eAPPLIED_APPROVAL_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_CERTIFICATION_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_CERTIFICATION_ASSIGNMENT(eAPPLIED_CERTIFICATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_CLASSIFICATION_ASSIGNMENT_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_CLASSIFICATION_ASSIGNMENT_RELATIONSHIP(
      eAPPLIED_CLASSIFICATION_ASSIGNMENT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eAPPLIED_CONTRACT_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_CONTRACT_ASSIGNMENT(eAPPLIED_CONTRACT_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_DESCRIPTION_TEXT_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_DESCRIPTION_TEXT_ASSIGNMENT(eAPPLIED_DESCRIPTION_TEXT_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_DESCRIPTION_TEXT_ASSIGNMENT_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_DESCRIPTION_TEXT_ASSIGNMENT_RELATIONSHIP(
      eAPPLIED_DESCRIPTION_TEXT_ASSIGNMENT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eAPPLIED_DOCUMENT_REFERENCE`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_DOCUMENT_REFERENCE(eAPPLIED_DOCUMENT_REFERENCE)	// (ENTITY)

    /// SELECT case ``eAPPLIED_DOCUMENT_USAGE_CONSTRAINT_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_DOCUMENT_USAGE_CONSTRAINT_ASSIGNMENT(
      eAPPLIED_DOCUMENT_USAGE_CONSTRAINT_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_EFFECTIVITY_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_EFFECTIVITY_ASSIGNMENT(eAPPLIED_EFFECTIVITY_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_EVENT_OCCURRENCE_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_EVENT_OCCURRENCE_ASSIGNMENT(eAPPLIED_EVENT_OCCURRENCE_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_EXTERNAL_IDENTIFICATION_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_EXTERNAL_IDENTIFICATION_ASSIGNMENT(
      eAPPLIED_EXTERNAL_IDENTIFICATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_EXTERNAL_IDENTIFICATION_ASSIGNMENT_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    ...
    /// SELECT case ``eAPPLIED_IDENTIFICATION_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_IDENTIFICATION_ASSIGNMENT(eAPPLIED_IDENTIFICATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_INEFFECTIVITY_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_INEFFECTIVITY_ASSIGNMENT(eAPPLIED_INEFFECTIVITY_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_ORGANIZATIONAL_PROJECT_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_ORGANIZATIONAL_PROJECT_ASSIGNMENT(eAPPLIED_ORGANIZATIONAL_PROJECT_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_ORGANIZATION_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_ORGANIZATION_ASSIGNMENT(eAPPLIED_ORGANIZATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_PERSON_AND_ORGANIZATION_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_PERSON_AND_ORGANIZATION_ASSIGNMENT(
      eAPPLIED_PERSON_AND_ORGANIZATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_SECURITY_CLASSIFICATION_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_SECURITY_CLASSIFICATION_ASSIGNMENT(
      eAPPLIED_SECURITY_CLASSIFICATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_TIME_INTERVAL_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_TIME_INTERVAL_ASSIGNMENT(eAPPLIED_TIME_INTERVAL_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_USAGE_RIGHT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPLIED_USAGE_RIGHT(eAPPLIED_USAGE_RIGHT)	// (ENTITY)

    /// SELECT case ``eAPPROVAL_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _APPROVAL_RELATIONSHIP(eAPPROVAL_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eASSEMBLY_COMPONENT_USAGE_SUBSTITUTE`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _ASSEMBLY_COMPONENT_USAGE_SUBSTITUTE(eASSEMBLY_COMPONENT_USAGE_SUBSTITUTE)	// (ENTITY)

    /// SELECT case ``eASSIGNMENT_OBJECT_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _ASSIGNMENT_OBJECT_RELATIONSHIP(eASSIGNMENT_OBJECT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eBREAKDOWN_OF`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _BREAKDOWN_OF(eBREAKDOWN_OF)	// (ENTITY)

    /// SELECT case ``eCLASS`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _CLASS(eCLASS)	// (ENTITY)

    /// SELECT case ``eCLASS_SYSTEM`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _CLASS_SYSTEM(eCLASS_SYSTEM)	// (ENTITY)

    /// SELECT case ``eCONDITION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _CONDITION(eCONDITION)	// (ENTITY)

    /// SELECT case ``eCONDITIONAL_EFFECTIVITY`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _CONDITIONAL_EFFECTIVITY(eCONDITIONAL_EFFECTIVITY)	// (ENTITY)

    /// SELECT case ``eCONFIGURATION_DESIGN`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _CONFIGURATION_DESIGN(eCONFIGURATION_DESIGN)	// (ENTITY)

    /// SELECT case ``eCONFIGURATION_ITEM`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _CONFIGURATION_ITEM(eCONFIGURATION_ITEM)	// (ENTITY)

    /// SELECT case ``eCONFIGURATION_ITEM_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _CONFIGURATION_ITEM_RELATIONSHIP(eCONFIGURATION_ITEM_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eCONFIGURED_EFFECTIVITY_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _CONFIGURED_EFFECTIVITY_ASSIGNMENT(eCONFIGURED_EFFECTIVITY_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eCONTRACT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _CONTRACT(eCONTRACT)	// (ENTITY)

    /// SELECT case ``eDATE_AND_TIME_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _DATE_AND_TIME_ASSIGNMENT(eDATE_AND_TIME_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eDATE_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _DATE_ASSIGNMENT(eDATE_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eDIRECTED_ACTION_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _DIRECTED_ACTION_ASSIGNMENT(eDIRECTED_ACTION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eDOCUMENT_FILE`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _DOCUMENT_FILE(eDOCUMENT_FILE)	// (ENTITY)

    /// SELECT case ``eDOCUMENT_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _DOCUMENT_RELATIONSHIP(eDOCUMENT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eDRAUGHTING_MODEL`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _DRAUGHTING_MODEL(eDRAUGHTING_MODEL)	// (ENTITY)

    /// SELECT case ``eDRAWING_REVISION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _DRAWING_REVISION(eDRAWING_REVISION)	// (ENTITY)

    /// SELECT case ``eEFFECTIVITY_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _EFFECTIVITY_RELATIONSHIP(eEFFECTIVITY_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eEVENT_OCCURRENCE_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _EVENT_OCCURRENCE_RELATIONSHIP(eEVENT_OCCURRENCE_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eEVIDENCE`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _EVIDENCE(eEVIDENCE)	// (ENTITY)

    /// SELECT case ``eEXCLUSIVE_PRODUCT_CONCEPT_FEATURE_CATEGORY`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _EXCLUSIVE_PRODUCT_CONCEPT_FEATURE_CATEGORY(
      eEXCLUSIVE_PRODUCT_CONCEPT_FEATURE_CATEGORY)	// (ENTITY)

    /// SELECT case ``eEXECUTED_ACTION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _EXECUTED_ACTION(eEXECUTED_ACTION)	// (ENTITY)

    /// SELECT case ``eEXTERNALLY_DEFINED_GENERAL_PROPERTY`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _EXTERNALLY_DEFINED_GENERAL_PROPERTY(eEXTERNALLY_DEFINED_GENERAL_PROPERTY)	// (ENTITY)

    /// SELECT case ``eFROZEN_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _FROZEN_ASSIGNMENT(eFROZEN_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eGENERAL_PROPERTY`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _GENERAL_PROPERTY(eGENERAL_PROPERTY)	// (ENTITY)

    /// SELECT case ``eGENERAL_PROPERTY_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _GENERAL_PROPERTY_RELATIONSHIP(eGENERAL_PROPERTY_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eGENERIC_PROPERTY_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _GENERIC_PROPERTY_RELATIONSHIP(eGENERIC_PROPERTY_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eGROUP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _GROUP(eGROUP)	// (ENTITY)

    /// SELECT case ``eIDENTIFICATION_ASSIGNMENT_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _IDENTIFICATION_ASSIGNMENT_RELATIONSHIP(eIDENTIFICATION_ASSIGNMENT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eINCLUSION_PRODUCT_CONCEPT_FEATURE`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _INCLUSION_PRODUCT_CONCEPT_FEATURE(eINCLUSION_PRODUCT_CONCEPT_FEATURE)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _INTERFACE_CONNECTION(eINTERFACE_CONNECTION)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTOR_DESIGN_TO_PLANNED`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _INTERFACE_CONNECTOR_DESIGN_TO_PLANNED(eINTERFACE_CONNECTOR_DESIGN_TO_PLANNED)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTOR_DESIGN_TO_REALIZED`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _INTERFACE_CONNECTOR_DESIGN_TO_REALIZED(eINTERFACE_CONNECTOR_DESIGN_TO_REALIZED)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTOR_OCCURRENCE`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _INTERFACE_CONNECTOR_OCCURRENCE(eINTERFACE_CONNECTOR_OCCURRENCE)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTOR_PLANNED_TO_REALIZED`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _INTERFACE_CONNECTOR_PLANNED_TO_REALIZED(eINTERFACE_CONNECTOR_PLANNED_TO_REALIZED)	// (ENTITY)

    /// SELECT case ``eINTERFACE_DEFINITION_FOR`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _INTERFACE_DEFINITION_FOR(eINTERFACE_DEFINITION_FOR)	// (ENTITY)

    /// SELECT case ``eIN_ZONE`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _IN_ZONE(eIN_ZONE)	// (ENTITY)

    /// SELECT case ``eLINK_MOTION_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _LINK_MOTION_RELATIONSHIP(eLINK_MOTION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eMATERIAL_DESIGNATION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _MATERIAL_DESIGNATION(eMATERIAL_DESIGNATION)	// (ENTITY)

    /// SELECT case ``eMATERIAL_DESIGNATION_CHARACTERIZATION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _MATERIAL_DESIGNATION_CHARACTERIZATION(eMATERIAL_DESIGNATION_CHARACTERIZATION)	// (ENTITY)

    /// SELECT case ``eMEASURE_REPRESENTATION_ITEM`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _MEASURE_REPRESENTATION_ITEM(eMEASURE_REPRESENTATION_ITEM)	// (ENTITY)

    /// SELECT case ``eMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_REPRESENTATION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    ...
    /// SELECT case ``eMULTI_LANGUAGE_ATTRIBUTE_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _MULTI_LANGUAGE_ATTRIBUTE_ASSIGNMENT(eMULTI_LANGUAGE_ATTRIBUTE_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eORGANIZATION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _ORGANIZATION(eORGANIZATION)	// (ENTITY)

    /// SELECT case ``eORGANIZATIONAL_ADDRESS`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _ORGANIZATIONAL_ADDRESS(eORGANIZATIONAL_ADDRESS)	// (ENTITY)

    /// SELECT case ``eORGANIZATIONAL_PROJECT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _ORGANIZATIONAL_PROJECT(eORGANIZATIONAL_PROJECT)	// (ENTITY)

    /// SELECT case ``eORGANIZATIONAL_PROJECT_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _ORGANIZATIONAL_PROJECT_RELATIONSHIP(eORGANIZATIONAL_PROJECT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eORGANIZATION_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _ORGANIZATION_RELATIONSHIP(eORGANIZATION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePACKAGE_PRODUCT_CONCEPT_FEATURE`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PACKAGE_PRODUCT_CONCEPT_FEATURE(ePACKAGE_PRODUCT_CONCEPT_FEATURE)	// (ENTITY)

    /// SELECT case ``ePERSON_AND_ORGANIZATION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PERSON_AND_ORGANIZATION(ePERSON_AND_ORGANIZATION)	// (ENTITY)

    /// SELECT case ``ePERSON_AND_ORGANIZATION_ADDRESS`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PERSON_AND_ORGANIZATION_ADDRESS(ePERSON_AND_ORGANIZATION_ADDRESS)	// (ENTITY)

    /// SELECT case ``ePRESENTATION_AREA`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRESENTATION_AREA(ePRESENTATION_AREA)	// (ENTITY)

    /// SELECT case ``ePROCESS_OPERATION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PROCESS_OPERATION(ePROCESS_OPERATION)	// (ENTITY)

    /// SELECT case ``ePROCESS_PLAN`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PROCESS_PLAN(ePROCESS_PLAN)	// (ENTITY)

    /// SELECT case ``ePRODUCT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT(ePRODUCT)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CLASS`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_CLASS(ePRODUCT_CLASS)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_CONCEPT(ePRODUCT_CONCEPT)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT_FEATURE`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_CONCEPT_FEATURE(ePRODUCT_CONCEPT_FEATURE)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT_FEATURE_ASSOCIATION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_CONCEPT_FEATURE_ASSOCIATION(ePRODUCT_CONCEPT_FEATURE_ASSOCIATION)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT_FEATURE_CATEGORY`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_CONCEPT_FEATURE_CATEGORY(ePRODUCT_CONCEPT_FEATURE_CATEGORY)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT_FEATURE_CATEGORY_USAGE`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_CONCEPT_FEATURE_CATEGORY_USAGE(ePRODUCT_CONCEPT_FEATURE_CATEGORY_USAGE)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_CONCEPT_RELATIONSHIP(ePRODUCT_CONCEPT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_DEFINITION(ePRODUCT_DEFINITION)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_FORMATION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_DEFINITION_FORMATION(ePRODUCT_DEFINITION_FORMATION)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_FORMATION_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_DEFINITION_FORMATION_RELATIONSHIP(ePRODUCT_DEFINITION_FORMATION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_DEFINITION_RELATIONSHIP(ePRODUCT_DEFINITION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_SUBSTITUTE`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_DEFINITION_SUBSTITUTE(ePRODUCT_DEFINITION_SUBSTITUTE)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_USAGE`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_DEFINITION_USAGE(ePRODUCT_DEFINITION_USAGE)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_USAGE_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_DEFINITION_USAGE_RELATIONSHIP(ePRODUCT_DEFINITION_USAGE_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DESIGN_TO_INDIVIDUAL`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_DESIGN_TO_INDIVIDUAL(ePRODUCT_DESIGN_TO_INDIVIDUAL)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DESIGN_VERSION_TO_INDIVIDUAL`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_DESIGN_VERSION_TO_INDIVIDUAL(ePRODUCT_DESIGN_VERSION_TO_INDIVIDUAL)	// (ENTITY)

    /// SELECT case ``ePRODUCT_GROUP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_GROUP(ePRODUCT_GROUP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_GROUP_MEMBERSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_GROUP_MEMBERSHIP(ePRODUCT_GROUP_MEMBERSHIP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_GROUP_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_GROUP_RELATIONSHIP(ePRODUCT_GROUP_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_IDENTIFICATION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_IDENTIFICATION(ePRODUCT_IDENTIFICATION)	// (ENTITY)

    /// SELECT case ``ePRODUCT_PROCESS_PLAN`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_PROCESS_PLAN(ePRODUCT_PROCESS_PLAN)	// (ENTITY)

    /// SELECT case ``ePRODUCT_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PRODUCT_RELATIONSHIP(ePRODUCT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePROPERTY_DEFINITION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PROPERTY_DEFINITION(ePROPERTY_DEFINITION)	// (ENTITY)

    /// SELECT case ``ePROPERTY_DEFINITION_REPRESENTATION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _PROPERTY_DEFINITION_REPRESENTATION(ePROPERTY_DEFINITION_REPRESENTATION)	// (ENTITY)

    /// SELECT case ``eREPRESENTATION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _REPRESENTATION(eREPRESENTATION)	// (ENTITY)

    /// SELECT case ``eREPRESENTATION_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _REPRESENTATION_RELATIONSHIP(eREPRESENTATION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eREQUIREMENT_ASSIGNMENT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _REQUIREMENT_ASSIGNMENT(eREQUIREMENT_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eREQUIREMENT_FOR_ACTION_RESOURCE`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _REQUIREMENT_FOR_ACTION_RESOURCE(eREQUIREMENT_FOR_ACTION_RESOURCE)	// (ENTITY)

    /// SELECT case ``eREQUIREMENT_SOURCE`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _REQUIREMENT_SOURCE(eREQUIREMENT_SOURCE)	// (ENTITY)

    /// SELECT case ``eRESOURCE_PROPERTY`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _RESOURCE_PROPERTY(eRESOURCE_PROPERTY)	// (ENTITY)

    /// SELECT case ``eSECURITY_CLASSIFICATION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _SECURITY_CLASSIFICATION(eSECURITY_CLASSIFICATION)	// (ENTITY)

    /// SELECT case ``eSHAPE_ASPECT`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _SHAPE_ASPECT(eSHAPE_ASPECT)	// (ENTITY)

    /// SELECT case ``eSHAPE_ASPECT_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _SHAPE_ASPECT_RELATIONSHIP(eSHAPE_ASPECT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eSHAPE_REPRESENTATION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _SHAPE_REPRESENTATION(eSHAPE_REPRESENTATION)	// (ENTITY)

    /// SELECT case ``eSTRUCTURED_MESSAGE`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _STRUCTURED_MESSAGE(eSTRUCTURED_MESSAGE)	// (ENTITY)

    /// SELECT case ``eTIME_INTERVAL_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _TIME_INTERVAL_RELATIONSHIP(eTIME_INTERVAL_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eUSAGE_ASSOCIATION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _USAGE_ASSOCIATION(eUSAGE_ASSOCIATION)	// (ENTITY)

    /// SELECT case ``eVALIDATION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _VALIDATION(eVALIDATION)	// (ENTITY)

    /// SELECT case ``eVALUE_REPRESENTATION_ITEM`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _VALUE_REPRESENTATION_ITEM(eVALUE_REPRESENTATION_ITEM)	// (ENTITY)

    /// SELECT case ``eVERIFICATION`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _VERIFICATION(eVERIFICATION)	// (ENTITY)

    /// SELECT case ``eVERIFICATION_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    case _VERIFICATION_RELATIONSHIP(eVERIFICATION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eVERSIONED_ACTION_REQUEST_RELATIONSHIP`` (ENTITY) in ``sEFFECTIVITY_ITEM``
    ...
    public static var bareTypeName: String = "EFFECTIVITY_ITEM"
    ...
    /// attribute of SELECT type ``sEFFECTIVITY_ITEM``
    ...
    public static var typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.EFFECTIVITY_ITEM"
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sEFFECTIVITY_ITEM__type: SDAISelectType {
  ...
  var CONFIGURATION: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eCONFIGURATION_ITEM?  { get }
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sEFFECTIVITY_ITEM__subtype {
  ...
  var CONFIGURATION: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eCONFIGURATION_ITEM?  { rep.CONFIGURATION }
