/* file: equivalence_detected_difference_select.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT`` (SELECT) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT``
    @_documentation(visibility:public)
    case _A3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT(sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT)	// (SELECT)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tAREA_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT``
    @_documentation(visibility:public)
    case _AREA_MEASURE(tAREA_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eASSEMBLY_COMPONENT_USAGE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT``
    @_documentation(visibility:public)
    case _ASSEMBLY_COMPONENT_USAGE(eASSEMBLY_COMPONENT_USAGE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBINARY_ASSEMBLY_CONSTRAINT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT``
    @_documentation(visibility:public)
    case _BINARY_ASSEMBLY_CONSTRAINT(eBINARY_ASSEMBLY_CONSTRAINT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCARTESIAN_POINT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT``
    @_documentation(visibility:public)
    case _CARTESIAN_POINT(eCARTESIAN_POINT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONNECTED_FACE_SET`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT``
    @_documentation(visibility:public)
    case _CONNECTED_FACE_SET(eCONNECTED_FACE_SET.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONTEXT_DEPENDENT_SHAPE_REPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT``
    @_documentation(visibility:public)
    case _CONTEXT_DEPENDENT_SHAPE_REPRESENTATION(eCONTEXT_DEPENDENT_SHAPE_REPRESENTATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tCOUNT_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT``
    @_documentation(visibility:public)
    case _COUNT_MEASURE(tCOUNT_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEDGE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT``
    @_documentation(visibility:public)
    case _EDGE(eEDGE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFACE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT``
    @_documentation(visibility:public)
    case _FACE(eFACE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tLENGTH_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT``
    @_documentation(visibility:public)
    case _LENGTH_MEASURE(tLENGTH_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTI_LEVEL_REFERENCE_DESIGNATOR`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT``
    @_documentation(visibility:public)
    case _MULTI_LEVEL_REFERENCE_DESIGNATOR(eMULTI_LEVEL_REFERENCE_DESIGNATOR.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT_ON_CURVE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT``
    @_documentation(visibility:public)
    case _POINT_ON_CURVE(ePOINT_ON_CURVE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT_ON_SURFACE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT``
    @_documentation(visibility:public)
    case _POINT_ON_SURFACE(ePOINT_ON_SURFACE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tVOLUME_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT__type, SDAI.DefinedType
