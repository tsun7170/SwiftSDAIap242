/* file: equivalence_detected_difference_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
*/
  public enum sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT : SDAI.Value, TypeHierarchy.sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT__TypeBehavior {
    ...
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT``
    /// - origin: SELECT( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sA3MS_INSPECTED_EQUIVALENCE_ELEMENT_SELECT`` )
    public var NORMALS: (SDAI.LIST<SDAI.LIST<SDAI.REAL>/*[3:3]*/ >/*[1:(nil as SDAI.INTEGER?)]*/ )?  {
      switch self {
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._CARTESIAN_POINT(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eCARTESIAN_POINT.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._CONNECTED_FACE_SET(let entity): 
        if !entity.shouldPropagateValidation { break }
      ...
      case ._POINT_ON_SURFACE(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = ePOINT_ON_SURFACE.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
...
public protocol sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT__TypeBehavior: SDAI.SelectType {
  ...
  var NORMALS: (SDAI.LIST<SDAI.LIST<SDAI.REAL>/*[3:3]*/ >/*[1:(nil as SDAI.INTEGER?)]*/ )?  { get }
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sEQUIVALENCE_DETECTED_DIFFERENCE_SELECT__Subtype {
  ...
  var NORMALS: (SDAI.LIST<SDAI.LIST<SDAI.REAL>/*[3:3]*/ >/*[1:(nil as SDAI.INTEGER?)]*/ )?  { rep.NORMALS }
