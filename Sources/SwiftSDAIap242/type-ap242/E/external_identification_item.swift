/* file: external_identification_item.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sEXTERNAL_IDENTIFICATION_ITEM : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sEXTERNAL_IDENTIFICATION_ITEM__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_DIRECTIVE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _ACTION_DIRECTIVE(eACTION_DIRECTIVE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_METHOD`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _ACTION_METHOD(eACTION_METHOD.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_METHOD_RELATIONSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _ACTION_METHOD_RELATIONSHIP(eACTION_METHOD_RELATIONSHIP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_RELATIONSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _ACTION_RELATIONSHIP(eACTION_RELATIONSHIP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_REQUEST_STATUS`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _ACTION_REQUEST_STATUS(eACTION_REQUEST_STATUS.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eADDRESS`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _ADDRESS(eADDRESS.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANALYSIS_MODEL`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _ANALYSIS_MODEL(eANALYSIS_MODEL.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANALYSIS_REPRESENTATION_CONTEXT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _ANALYSIS_REPRESENTATION_CONTEXT(eANALYSIS_REPRESENTATION_CONTEXT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_ACTION_METHOD_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_ACTION_METHOD_ASSIGNMENT(eAPPLIED_ACTION_METHOD_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_CLASSIFICATION_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_CLASSIFICATION_ASSIGNMENT(eAPPLIED_CLASSIFICATION_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_EXTERNAL_IDENTIFICATION_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_EXTERNAL_IDENTIFICATION_ASSIGNMENT(
      eAPPLIED_EXTERNAL_IDENTIFICATION_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_ORGANIZATION_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_ORGANIZATION_ASSIGNMENT(eAPPLIED_ORGANIZATION_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_PERSON_AND_ORGANIZATION_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_PERSON_AND_ORGANIZATION_ASSIGNMENT(
      eAPPLIED_PERSON_AND_ORGANIZATION_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPROVAL`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _APPROVAL(eAPPROVAL.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPROVAL_PERSON_ORGANIZATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _APPROVAL_PERSON_ORGANIZATION(eAPPROVAL_PERSON_ORGANIZATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPROVAL_STATUS`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _APPROVAL_STATUS(eAPPROVAL_STATUS.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eASSEMBLY_BOND_DEFINITION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _ASSEMBLY_BOND_DEFINITION(eASSEMBLY_BOND_DEFINITION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eASSEMBLY_JOINT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _ASSEMBLY_JOINT(eASSEMBLY_JOINT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eASSEMBLY_COMPONENT_USAGE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _ASSEMBLY_COMPONENT_USAGE(eASSEMBLY_COMPONENT_USAGE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBREAKDOWN_CONTEXT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _BREAKDOWN_CONTEXT(eBREAKDOWN_CONTEXT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCERTIFICATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _CERTIFICATION(eCERTIFICATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCLASS`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _CLASS(eCLASS.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPOSITE_CURVE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _COMPOSITE_CURVE(eCOMPOSITE_CURVE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONDITION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _CONDITION(eCONDITION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONFIGURATION_EFFECTIVITY`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _CONFIGURATION_EFFECTIVITY(eCONFIGURATION_EFFECTIVITY.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONTRACT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _CONTRACT(eCONTRACT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _CURVE(eCURVE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATE_AND_TIME_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _DATE_AND_TIME_ASSIGNMENT(eDATE_AND_TIME_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATE_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _DATE_ASSIGNMENT(eDATE_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDERIVED_UNIT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _DERIVED_UNIT(eDERIVED_UNIT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDOCUMENT_FILE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _DOCUMENT_FILE(eDOCUMENT_FILE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEFFECTIVITY`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _EFFECTIVITY(eEFFECTIVITY.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEVALUATED_CHARACTERISTIC_OF_PRODUCT_AS_INDIVIDUAL_TEST_RESULT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    ...
    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEVENT_OCCURRENCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _EVENT_OCCURRENCE(eEVENT_OCCURRENCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEVIDENCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _EVIDENCE(eEVIDENCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXCLUSIVE_PRODUCT_CONCEPT_FEATURE_CATEGORY`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _EXCLUSIVE_PRODUCT_CONCEPT_FEATURE_CATEGORY(
      eEXCLUSIVE_PRODUCT_CONCEPT_FEATURE_CATEGORY.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXECUTED_ACTION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _EXECUTED_ACTION(eEXECUTED_ACTION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTERNALLY_DEFINED_CLASS`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _EXTERNALLY_DEFINED_CLASS(eEXTERNALLY_DEFINED_CLASS.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTERNALLY_DEFINED_CONTEXT_DEPENDENT_UNIT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _EXTERNALLY_DEFINED_CONTEXT_DEPENDENT_UNIT(
      eEXTERNALLY_DEFINED_CONTEXT_DEPENDENT_UNIT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTERNALLY_DEFINED_CONVERSION_BASED_UNIT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _EXTERNALLY_DEFINED_CONVERSION_BASED_UNIT(
      eEXTERNALLY_DEFINED_CONVERSION_BASED_UNIT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTERNALLY_DEFINED_GENERAL_PROPERTY`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _EXTERNALLY_DEFINED_GENERAL_PROPERTY(eEXTERNALLY_DEFINED_GENERAL_PROPERTY.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTERNALLY_DEFINED_PICTURE_REPRESENTATION_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _EXTERNALLY_DEFINED_PICTURE_REPRESENTATION_ITEM(
      eEXTERNALLY_DEFINED_PICTURE_REPRESENTATION_ITEM.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTERNALLY_DEFINED_REPRESENTATION_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _EXTERNALLY_DEFINED_REPRESENTATION_ITEM(eEXTERNALLY_DEFINED_REPRESENTATION_ITEM.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTERNAL_SOURCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _EXTERNAL_SOURCE(eEXTERNAL_SOURCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGENERAL_PROPERTY`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _GENERAL_PROPERTY(eGENERAL_PROPERTY.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGENERIC_PRODUCT_DEFINITION_REFERENCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _GENERIC_PRODUCT_DEFINITION_REFERENCE(eGENERIC_PRODUCT_DEFINITION_REFERENCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGROUP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _GROUP(eGROUP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINFORMATION_RIGHT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _INFORMATION_RIGHT(eINFORMATION_RIGHT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINFORMATION_USAGE_RIGHT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _INFORMATION_USAGE_RIGHT(eINFORMATION_USAGE_RIGHT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACE_CONNECTION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _INTERFACE_CONNECTION(eINTERFACE_CONNECTION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACE_CONNECTOR_DEFINITION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _INTERFACE_CONNECTOR_DEFINITION(eINTERFACE_CONNECTOR_DEFINITION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACE_CONNECTOR_OCCURRENCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _INTERFACE_CONNECTOR_OCCURRENCE(eINTERFACE_CONNECTOR_OCCURRENCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACE_CONNECTOR_VERSION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _INTERFACE_CONNECTOR_VERSION(eINTERFACE_CONNECTOR_VERSION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACE_DEFINITION_CONNECTION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _INTERFACE_DEFINITION_CONNECTION(eINTERFACE_DEFINITION_CONNECTION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACE_DEFINITION_FOR`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _INTERFACE_DEFINITION_FOR(eINTERFACE_DEFINITION_FOR.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACE_SPECIFICATION_DEFINITION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _INTERFACE_SPECIFICATION_DEFINITION(eINTERFACE_SPECIFICATION_DEFINITION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACE_SPECIFICATION_VERSION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _INTERFACE_SPECIFICATION_VERSION(eINTERFACE_SPECIFICATION_VERSION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLOOP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _LOOP(eLOOP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMATERIAL_DESIGNATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _MATERIAL_DESIGNATION(eMATERIAL_DESIGNATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNAMED_UNIT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _NAMED_UNIT(eNAMED_UNIT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eORGANIZATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _ORGANIZATION(eORGANIZATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eORGANIZATIONAL_ADDRESS`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _ORGANIZATIONAL_ADDRESS(eORGANIZATIONAL_ADDRESS.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eORGANIZATIONAL_PROJECT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _ORGANIZATIONAL_PROJECT(eORGANIZATIONAL_PROJECT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eORIENTED_SURFACE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _ORIENTED_SURFACE(eORIENTED_SURFACE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePACKAGE_PRODUCT_CONCEPT_FEATURE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _PACKAGE_PRODUCT_CONCEPT_FEATURE(ePACKAGE_PRODUCT_CONCEPT_FEATURE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePERSON`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _PERSON(ePERSON.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePERSON_AND_ORGANIZATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _PERSON_AND_ORGANIZATION(ePERSON_AND_ORGANIZATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT_ON_CURVE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _POINT_ON_CURVE(ePOINT_ON_CURVE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRECISION_QUALIFIER`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _PRECISION_QUALIFIER(ePRECISION_QUALIFIER.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROCESS_OPERATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _PROCESS_OPERATION(ePROCESS_OPERATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROCESS_PLAN`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _PROCESS_PLAN(ePROCESS_PLAN.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT(ePRODUCT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_CONCEPT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_CONCEPT(ePRODUCT_CONCEPT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_CONCEPT_CONTEXT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_CONCEPT_CONTEXT(ePRODUCT_CONCEPT_CONTEXT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_CONCEPT_FEATURE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_CONCEPT_FEATURE(ePRODUCT_CONCEPT_FEATURE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_CONCEPT_FEATURE_CATEGORY`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_CONCEPT_FEATURE_CATEGORY(ePRODUCT_CONCEPT_FEATURE_CATEGORY.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION(ePRODUCT_DEFINITION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_CONTEXT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION_CONTEXT(ePRODUCT_DEFINITION_CONTEXT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_FORMATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION_FORMATION(ePRODUCT_DEFINITION_FORMATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_OCCURRENCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION_OCCURRENCE(ePRODUCT_DEFINITION_OCCURRENCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_OCCURRENCE_REFERENCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION_OCCURRENCE_REFERENCE(ePRODUCT_DEFINITION_OCCURRENCE_REFERENCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_GROUP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_GROUP(ePRODUCT_GROUP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_IDENTIFICATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_IDENTIFICATION(ePRODUCT_IDENTIFICATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_PROCESS_PLAN`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_PROCESS_PLAN(ePRODUCT_PROCESS_PLAN.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_SPECIFICATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_SPECIFICATION(ePRODUCT_SPECIFICATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROPERTY_DEFINITION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _PROPERTY_DEFINITION(ePROPERTY_DEFINITION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _REPRESENTATION(eREPRESENTATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREPRESENTATION_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _REPRESENTATION_ITEM(eREPRESENTATION_ITEM.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREQUIREMENT_SOURCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _REQUIREMENT_SOURCE(eREQUIREMENT_SOURCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSATISFIES_REQUIREMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _SATISFIES_REQUIREMENT(eSATISFIES_REQUIREMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSECURITY_CLASSIFICATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _SECURITY_CLASSIFICATION(eSECURITY_CLASSIFICATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_REPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _SHAPE_REPRESENTATION(eSHAPE_REPRESENTATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTATE_OBSERVED`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _STATE_OBSERVED(eSTATE_OBSERVED.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTATE_TYPE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _STATE_TYPE(eSTATE_TYPE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTRUCTURED_MESSAGE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _STRUCTURED_MESSAGE(eSTRUCTURED_MESSAGE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _SURFACE(eSURFACE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTIME_INTERVAL`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _TIME_INTERVAL(eTIME_INTERVAL.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTRIMMED_CURVE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _TRIMMED_CURVE(eTRIMMED_CURVE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTYPE_QUALIFIER`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _TYPE_QUALIFIER(eTYPE_QUALIFIER.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eUNCERTAINTY_QUALIFIER`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _UNCERTAINTY_QUALIFIER(eUNCERTAINTY_QUALIFIER.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eVALIDATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _VALIDATION(eVALIDATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eVERIFICATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _VERIFICATION(eVERIFICATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eVERSIONED_ACTION_REQUEST`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    case _VERSIONED_ACTION_REQUEST(eVERSIONED_ACTION_REQUEST.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eVERTEX_POINT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXTERNAL_IDENTIFICATION_ITEM``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sEXTERNAL_IDENTIFICATION_ITEM__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sEXTERNAL_IDENTIFICATION_ITEM__type, SDAI.DefinedType
