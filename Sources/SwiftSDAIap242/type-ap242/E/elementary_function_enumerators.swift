/* file: elementary_function_enumerators.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  TYPE elementary_function_enumerators = ENUMERATION OF
    ( ef_and,
     ...
     ef_ensemble,
     ef_member_of );
  END_TYPE; -- elementary_function_enumerators (line:2765 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum nELEMENTARY_FUNCTION_ENUMERATORS : SDAI.ENUMERATION, SDAI.Value, 
    TypeHierarchy.nELEMENTARY_FUNCTION_ENUMERATORS__TypeBehavior {
    /// ENUMERATION case
    ///
    /// - defined in: ``nELEMENTARY_FUNCTION_ENUMERATORS``
    case EF_AND
    /// ENUMERATION case
    ///
    /// - defined in: ``nELEMENTARY_FUNCTION_ENUMERATORS``
    ...
    public static let bareTypeName: String = "ELEMENTARY_FUNCTION_ENUMERATORS"
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nELEMENTARY_FUNCTION_ENUMERATORS__TypeBehavior: SDAI.EnumerationType {}
}

extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nELEMENTARY_FUNCTION_ENUMERATORS__Subtype: 
  nELEMENTARY_FUNCTION_ENUMERATORS__TypeBehavior, SDAI.DefinedType
where Supertype: nELEMENTARY_FUNCTION_ENUMERATORS__TypeBehavior
{}
}
