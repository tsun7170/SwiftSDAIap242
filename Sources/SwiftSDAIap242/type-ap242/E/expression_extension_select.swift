/* file: expression_extension_select.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sEXPRESSION_EXTENSION_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sEXPRESSION_EXTENSION_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXPRESSION_EXTENSION_NUMERIC`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXPRESSION_EXTENSION_SELECT``
    @_documentation(visibility:public)
    case _EXPRESSION_EXTENSION_NUMERIC(eEXPRESSION_EXTENSION_NUMERIC.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXPRESSION_EXTENSION_STRING`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXPRESSION_EXTENSION_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEXPRESSION_EXTENSION_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sEXPRESSION_EXTENSION_SELECT__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sEXPRESSION_EXTENSION_SELECT__type, SDAI.DefinedType
