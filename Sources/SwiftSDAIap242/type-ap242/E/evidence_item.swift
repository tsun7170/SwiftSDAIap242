/* file: evidence_item.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  TYPE evidence_item = SELECT
    ( action_property (*ENTITY*),
     ...
     verification (*ENTITY*) );
  END_TYPE; -- evidence_item (line:2996 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sEVIDENCE_ITEM : SDAI.Value, TypeHierarchy.sEVIDENCE_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_PROPERTY`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEVIDENCE_ITEM``
    ...
    public static let bareTypeName: String = "EVIDENCE_ITEM"
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.EVIDENCE_ITEM"
...
public protocol sEVIDENCE_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sEVIDENCE_ITEM__Subtype: sEVIDENCE_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sEVIDENCE_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sEVIDENCE_ITEM__Subtype {
  //MARK: CONSTRUCTORS
