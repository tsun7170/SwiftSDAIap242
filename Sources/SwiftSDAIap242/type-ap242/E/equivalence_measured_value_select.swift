/* file: equivalence_measured_value_select.swift 	 generated: Thu Mar  5 17:54:18 2026 */
  ...
  public enum sEQUIVALENCE_MEASURED_VALUE_SELECT : SDAI.Value, TypeHierarchy.sEQUIVALENCE_MEASURED_VALUE_SELECT__TypeBehavior {
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._A3MA_LENGTH_MEASURE_AND_CONTEXT_DEPENDENT_MEASURE_PAIR(let entity): 
        ...
        result = eA3MA_LENGTH_MEASURE_AND_CONTEXT_DEPENDENT_MEASURE_PAIR.validateWhereRules(instance: entity.eval, 
