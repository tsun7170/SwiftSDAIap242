/* file: equivalence_measured_value_select.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sEQUIVALENCE_MEASURED_VALUE_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sEQUIVALENCE_MEASURED_VALUE_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3MA_LENGTH_MEASURE_AND_CONTEXT_DEPENDENT_MEASURE_PAIR`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_MEASURED_VALUE_SELECT``
    ...
    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tAREA_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_MEASURED_VALUE_SELECT``
    @_documentation(visibility:public)
    case _AREA_MEASURE(tAREA_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tBOOLEAN_VALUE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_MEASURED_VALUE_SELECT``
    @_documentation(visibility:public)
    case _BOOLEAN_VALUE(tBOOLEAN_VALUE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tCONTEXT_DEPENDENT_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_MEASURED_VALUE_SELECT``
    @_documentation(visibility:public)
    case _CONTEXT_DEPENDENT_MEASURE(tCONTEXT_DEPENDENT_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tLENGTH_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_MEASURED_VALUE_SELECT``
    @_documentation(visibility:public)
    case _LENGTH_MEASURE(tLENGTH_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tPLANE_ANGLE_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_MEASURED_VALUE_SELECT``
    @_documentation(visibility:public)
    case _PLANE_ANGLE_MEASURE(tPLANE_ANGLE_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tVOLUME_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_MEASURED_VALUE_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_MEASURED_VALUE_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sEQUIVALENCE_MEASURED_VALUE_SELECT__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sEQUIVALENCE_MEASURED_VALUE_SELECT__type, SDAI.DefinedType
