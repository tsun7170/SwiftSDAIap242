/* file: equivalence_product_data_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- equivalence_product_data_select (line:2945 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sEQUIVALENCE_PRODUCT_DATA_SELECT : SDAI.Value, TypeHierarchy.sEQUIVALENCE_PRODUCT_DATA_SELECT__TypeBehavior {

    /// SELECT case (SELECT)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRODUCT_DEFINITION_OR_REFERENCE`` (SELECT)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_PRODUCT_DATA_SELECT``
    ...
    public static let bareTypeName: String = "EQUIVALENCE_PRODUCT_DATA_SELECT"
...
public protocol sEQUIVALENCE_PRODUCT_DATA_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sEQUIVALENCE_PRODUCT_DATA_SELECT__Subtype: 
  sEQUIVALENCE_PRODUCT_DATA_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sEQUIVALENCE_PRODUCT_DATA_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sEQUIVALENCE_PRODUCT_DATA_SELECT__Subtype {
  //MARK: CONSTRUCTORS
