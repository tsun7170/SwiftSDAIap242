/* file: equivalence_product_data_select.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sEQUIVALENCE_PRODUCT_DATA_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sEQUIVALENCE_PRODUCT_DATA_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRODUCT_DEFINITION_OR_REFERENCE`` (SELECT) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_PRODUCT_DATA_SELECT``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION_OR_REFERENCE(sPRODUCT_DEFINITION_OR_REFERENCE)	// (SELECT)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_RELATIONSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_PRODUCT_DATA_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sEQUIVALENCE_PRODUCT_DATA_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sEQUIVALENCE_PRODUCT_DATA_SELECT__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sEQUIVALENCE_PRODUCT_DATA_SELECT__type, SDAI.DefinedType
