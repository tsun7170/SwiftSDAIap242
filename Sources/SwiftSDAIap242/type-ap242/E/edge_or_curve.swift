/* file: edge_or_curve.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sEDGE_OR_CURVE : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sEDGE_OR_CURVE__type {
    ...
    /// SELECT case ``eCURVE`` (ENTITY) in ``sEDGE_OR_CURVE``
    case _CURVE(eCURVE)	// (ENTITY)

    /// SELECT case ``eEDGE`` (ENTITY) in ``sEDGE_OR_CURVE``
    ...
    /// attribute of SELECT type ``sEDGE_OR_CURVE``
