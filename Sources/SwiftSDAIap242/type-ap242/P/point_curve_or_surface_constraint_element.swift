/* file: point_curve_or_surface_constraint_element.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  TYPE point_curve_or_surface_constraint_element = SELECT
    ( curve (*ENTITY*),
     point (*ENTITY*),
     surface (*ENTITY*) );
  END_TYPE; -- point_curve_or_surface_constraint_element (line:4824 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sPOINT_CURVE_OR_SURFACE_CONSTRAINT_ELEMENT : SDAI.Value, TypeHierarchy.sPOINT_CURVE_OR_SURFACE_CONSTRAINT_ELEMENT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPOINT_CURVE_OR_SURFACE_CONSTRAINT_ELEMENT``
    ...
    public static let bareTypeName: String = "POINT_CURVE_OR_SURFACE_CONSTRAINT_ELEMENT"
    ...
    public static let typeName: String = 
      "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.POINT_CURVE_OR_SURFACE_CONSTRAINT_ELEMENT"
...
public protocol sPOINT_CURVE_OR_SURFACE_CONSTRAINT_ELEMENT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sPOINT_CURVE_OR_SURFACE_CONSTRAINT_ELEMENT__Subtype: 
  sPOINT_CURVE_OR_SURFACE_CONSTRAINT_ELEMENT__TypeBehavior, SDAI.DefinedType
where Supertype: sPOINT_CURVE_OR_SURFACE_CONSTRAINT_ELEMENT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sPOINT_CURVE_OR_SURFACE_CONSTRAINT_ELEMENT__Subtype {
  //MARK: CONSTRUCTORS
