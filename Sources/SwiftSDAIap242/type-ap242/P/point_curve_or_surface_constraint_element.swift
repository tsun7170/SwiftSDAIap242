/* file: point_curve_or_surface_constraint_element.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sPOINT_CURVE_OR_SURFACE_CONSTRAINT_ELEMENT : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPOINT_CURVE_OR_SURFACE_CONSTRAINT_ELEMENT__type {
    ...
    /// SELECT case ``eCURVE`` (ENTITY) in ``sPOINT_CURVE_OR_SURFACE_CONSTRAINT_ELEMENT``
    case _CURVE(eCURVE)	// (ENTITY)

    /// SELECT case ``ePOINT`` (ENTITY) in ``sPOINT_CURVE_OR_SURFACE_CONSTRAINT_ELEMENT``
    case _POINT(ePOINT)	// (ENTITY)

    /// SELECT case ``eSURFACE`` (ENTITY) in ``sPOINT_CURVE_OR_SURFACE_CONSTRAINT_ELEMENT``
    ...
    /// attribute of SELECT type ``sPOINT_CURVE_OR_SURFACE_CONSTRAINT_ELEMENT``
