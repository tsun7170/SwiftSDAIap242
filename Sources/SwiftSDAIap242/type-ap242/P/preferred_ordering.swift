/* file: preferred_ordering.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  TYPE preferred_ordering = ENUMERATION OF
    ( extremity_order,
     detected_order );
  END_TYPE; -- preferred_ordering (line:4861 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum nPREFERRED_ORDERING : SDAI.ENUMERATION, SDAI.Value, 
    TypeHierarchy.nPREFERRED_ORDERING__TypeBehavior {
    /// ENUMERATION case
    ///
    /// - defined in: ``nPREFERRED_ORDERING``
    ...
    public static let bareTypeName: String = "PREFERRED_ORDERING"
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nPREFERRED_ORDERING__TypeBehavior: SDAI.EnumerationType {}
}

extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nPREFERRED_ORDERING__Subtype: nPREFERRED_ORDERING__TypeBehavior, SDAI.DefinedType
where Supertype: nPREFERRED_ORDERING__TypeBehavior
{}
}
