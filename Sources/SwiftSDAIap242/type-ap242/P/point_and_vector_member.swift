/* file: point_and_vector_member.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
/*
  TYPE point_and_vector_member = SELECT
    ( direction (*ENTITY*),
     point (*ENTITY*) );
  END_TYPE; -- point_and_vector_member (line:4808 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sPOINT_AND_VECTOR_MEMBER : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPOINT_AND_VECTOR_MEMBER__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIRECTION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPOINT_AND_VECTOR_MEMBER``
    @_documentation(visibility:public)
    case _DIRECTION(eDIRECTION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPOINT_AND_VECTOR_MEMBER``
    @_documentation(visibility:public)
    ...
    public static let bareTypeName: String = "POINT_AND_VECTOR_MEMBER"
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPOINT_AND_VECTOR_MEMBER``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPOINT_AND_VECTOR_MEMBER__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPOINT_AND_VECTOR_MEMBER__type, SDAI.DefinedType
