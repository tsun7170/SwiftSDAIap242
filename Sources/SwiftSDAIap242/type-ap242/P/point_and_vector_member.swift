/* file: point_and_vector_member.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
```
*/
  public enum sPOINT_AND_VECTOR_MEMBER : SDAI.Value, TypeHierarchy.sPOINT_AND_VECTOR_MEMBER__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIRECTION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPOINT_AND_VECTOR_MEMBER``
...
public protocol sPOINT_AND_VECTOR_MEMBER__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sPOINT_AND_VECTOR_MEMBER__Subtype: sPOINT_AND_VECTOR_MEMBER__TypeBehavior, SDAI.DefinedType
where Supertype: sPOINT_AND_VECTOR_MEMBER__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sPOINT_AND_VECTOR_MEMBER__Subtype {
  //MARK: CONSTRUCTORS
