/* file: property_variable_rep_select.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sPROPERTY_VARIABLE_REP_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPROPERTY_VARIABLE_REP_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIMENSIONAL_SIZE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROPERTY_VARIABLE_REP_SELECT``
    @_documentation(visibility:public)
    case _DIMENSIONAL_SIZE(eDIMENSIONAL_SIZE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROPERTY_VARIABLE_REP_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROPERTY_VARIABLE_REP_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPROPERTY_VARIABLE_REP_SELECT__type: 
  SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPROPERTY_VARIABLE_REP_SELECT__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPROPERTY_VARIABLE_REP_SELECT__type, SDAI.DefinedType
where Supertype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPROPERTY_VARIABLE_REP_SELECT__type
{}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPROPERTY_VARIABLE_REP_SELECT__subtype {
  //MARK: CONSTRUCTORS
