/* file: property_variable_rep_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- property_variable_rep_select (line:5007 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sPROPERTY_VARIABLE_REP_SELECT : SDAI.Value, TypeHierarchy.sPROPERTY_VARIABLE_REP_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIMENSIONAL_SIZE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROPERTY_VARIABLE_REP_SELECT``
    ...
    public static let bareTypeName: String = "PROPERTY_VARIABLE_REP_SELECT"
    ...
    public static let typeName: String = 
      "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PROPERTY_VARIABLE_REP_SELECT"
...
public protocol sPROPERTY_VARIABLE_REP_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sPROPERTY_VARIABLE_REP_SELECT__Subtype: 
  sPROPERTY_VARIABLE_REP_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sPROPERTY_VARIABLE_REP_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sPROPERTY_VARIABLE_REP_SELECT__Subtype {
  //MARK: CONSTRUCTORS
