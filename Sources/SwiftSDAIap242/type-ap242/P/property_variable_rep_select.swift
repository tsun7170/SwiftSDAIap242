/* file: property_variable_rep_select.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sPROPERTY_VARIABLE_REP_SELECT : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPROPERTY_VARIABLE_REP_SELECT__type {
    ...
    /// SELECT case ``eDIMENSIONAL_SIZE`` (ENTITY) in ``sPROPERTY_VARIABLE_REP_SELECT``
    case _DIMENSIONAL_SIZE(eDIMENSIONAL_SIZE)	// (ENTITY)

    /// SELECT case ``eREPRESENTATION`` (ENTITY) in ``sPROPERTY_VARIABLE_REP_SELECT``
    ...
    /// attribute of SELECT type ``sPROPERTY_VARIABLE_REP_SELECT``
