/* file: property_or_shape_select.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sPROPERTY_OR_SHAPE_SELECT : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPROPERTY_OR_SHAPE_SELECT__type {
    ...
    /// SELECT case ``ePROPERTY_DEFINITION`` (ENTITY) in ``sPROPERTY_OR_SHAPE_SELECT``
    case _PROPERTY_DEFINITION(ePROPERTY_DEFINITION)	// (ENTITY)

    /// SELECT case ``sSHAPE_DEFINITION`` (SELECT) in ``sPROPERTY_OR_SHAPE_SELECT``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(ePROPERTY_DEFINITION.self) {self = ._PROPERTY_DEFINITION(base) }
    ...
    /// attribute of SELECT type ``sPROPERTY_OR_SHAPE_SELECT``
