/* file: plane_or_planar_box.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sPLANE_OR_PLANAR_BOX : SDAI.Value, TypeHierarchy.sPLANE_OR_PLANAR_BOX__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLANAR_BOX`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPLANE_OR_PLANAR_BOX``
...
public protocol sPLANE_OR_PLANAR_BOX__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sPLANE_OR_PLANAR_BOX__Subtype: sPLANE_OR_PLANAR_BOX__TypeBehavior, SDAI.DefinedType
where Supertype: sPLANE_OR_PLANAR_BOX__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sPLANE_OR_PLANAR_BOX__Subtype {
  //MARK: CONSTRUCTORS
