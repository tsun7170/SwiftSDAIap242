/* file: presentation_size_assignment_select.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sPRESENTATION_SIZE_ASSIGNMENT_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPRESENTATION_SIZE_ASSIGNMENT_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAREA_IN_SET`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRESENTATION_SIZE_ASSIGNMENT_SELECT``
    @_documentation(visibility:public)
    case _AREA_IN_SET(eAREA_IN_SET.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESENTATION_AREA`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRESENTATION_SIZE_ASSIGNMENT_SELECT``
    @_documentation(visibility:public)
    case _PRESENTATION_AREA(ePRESENTATION_AREA.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESENTATION_VIEW`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRESENTATION_SIZE_ASSIGNMENT_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRESENTATION_SIZE_ASSIGNMENT_SELECT``
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      switch instance {
      case ._AREA_IN_SET(let entity): result = eAREA_IN_SET.validateWhereRules(instance: entity.eval, 
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPRESENTATION_SIZE_ASSIGNMENT_SELECT__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPRESENTATION_SIZE_ASSIGNMENT_SELECT__type, SDAI.DefinedType
