/* file: product_definition_or_product_definition_relationship.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sPRODUCT_DEFINITION_OR_PRODUCT_DEFINITION_RELATIONSHIP : SDAIValue, 
    ...
    /// SELECT case ``eINTERFACE_CONNECTOR_OCCURRENCE`` (ENTITY) in ``sPRODUCT_DEFINITION_OR_PRODUCT_DEFINITION_RELATIONSHIP``
    case _INTERFACE_CONNECTOR_OCCURRENCE(eINTERFACE_CONNECTOR_OCCURRENCE)	// (ENTITY)

    /// SELECT case ``ePRODUCT`` (ENTITY) in ``sPRODUCT_DEFINITION_OR_PRODUCT_DEFINITION_RELATIONSHIP``
    case _PRODUCT(ePRODUCT)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION`` (ENTITY) in ``sPRODUCT_DEFINITION_OR_PRODUCT_DEFINITION_RELATIONSHIP``
    case _PRODUCT_DEFINITION(ePRODUCT_DEFINITION)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_USAGE`` (ENTITY) in ``sPRODUCT_DEFINITION_OR_PRODUCT_DEFINITION_RELATIONSHIP``
    case _PRODUCT_DEFINITION_USAGE(ePRODUCT_DEFINITION_USAGE)	// (ENTITY)

    /// SELECT case ``ePRODUCT_GROUP`` (ENTITY) in ``sPRODUCT_DEFINITION_OR_PRODUCT_DEFINITION_RELATIONSHIP``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eINTERFACE_CONNECTOR_OCCURRENCE.self) {self = ._INTERFACE_CONNECTOR_OCCURRENCE(base) }
    ...
    /// attribute of SELECT type ``sPRODUCT_DEFINITION_OR_PRODUCT_DEFINITION_RELATIONSHIP``
