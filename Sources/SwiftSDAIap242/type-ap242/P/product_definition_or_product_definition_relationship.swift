/* file: product_definition_or_product_definition_relationship.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
*/
  public enum sPRODUCT_DEFINITION_OR_PRODUCT_DEFINITION_RELATIONSHIP : SDAI.Value, 
    TypeHierarchy.sPRODUCT_DEFINITION_OR_PRODUCT_DEFINITION_RELATIONSHIP__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINTERFACE_CONNECTOR_OCCURRENCE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRODUCT_DEFINITION_OR_PRODUCT_DEFINITION_RELATIONSHIP``
...
public protocol sPRODUCT_DEFINITION_OR_PRODUCT_DEFINITION_RELATIONSHIP__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sPRODUCT_DEFINITION_OR_PRODUCT_DEFINITION_RELATIONSHIP__Subtype: 
  sPRODUCT_DEFINITION_OR_PRODUCT_DEFINITION_RELATIONSHIP__TypeBehavior, SDAI.DefinedType
where Supertype: sPRODUCT_DEFINITION_OR_PRODUCT_DEFINITION_RELATIONSHIP__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sPRODUCT_DEFINITION_OR_PRODUCT_DEFINITION_RELATIONSHIP__Subtype {
  //MARK: CONSTRUCTORS
