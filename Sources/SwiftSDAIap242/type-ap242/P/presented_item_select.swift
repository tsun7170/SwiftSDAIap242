/* file: presented_item_select.swift 	 generated: Thu Dec 25 18:13:23 2025 */
...
*/
  public enum sPRESENTED_ITEM_SELECT : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPRESENTED_ITEM_SELECT__type {
    ...
    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRESENTED_ITEM_SELECT``
    @_documentation(visibility:public)
    case _ACTION(eACTION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_METHOD`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRESENTED_ITEM_SELECT``
    @_documentation(visibility:public)
    case _ACTION_METHOD(eACTION_METHOD.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_RELATIONSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRESENTED_ITEM_SELECT``
    @_documentation(visibility:public)
    case _ACTION_RELATIONSHIP(eACTION_RELATIONSHIP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_CONCEPT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRESENTED_ITEM_SELECT``
    @_documentation(visibility:public)
    case _PRODUCT_CONCEPT(ePRODUCT_CONCEPT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_CONCEPT_FEATURE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRESENTED_ITEM_SELECT``
    @_documentation(visibility:public)
    case _PRODUCT_CONCEPT_FEATURE(ePRODUCT_CONCEPT_FEATURE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_CONCEPT_FEATURE_CATEGORY`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRESENTED_ITEM_SELECT``
    @_documentation(visibility:public)
    case _PRODUCT_CONCEPT_FEATURE_CATEGORY(ePRODUCT_CONCEPT_FEATURE_CATEGORY.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRESENTED_ITEM_SELECT``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION(ePRODUCT_DEFINITION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_FORMATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRESENTED_ITEM_SELECT``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION_FORMATION(ePRODUCT_DEFINITION_FORMATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_RELATIONSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRESENTED_ITEM_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRESENTED_ITEM_SELECT``
