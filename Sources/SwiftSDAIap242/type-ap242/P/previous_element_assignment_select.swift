/* file: previous_element_assignment_select.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDELETE_ELEMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT``
    @_documentation(visibility:public)
    case _DELETE_ELEMENT(eDELETE_ELEMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMODIFY_ELEMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT__type, SDAI.DefinedType
