/* file: previous_element_assignment_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- previous_element_assignment_select (line:4920 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT : SDAI.Value, TypeHierarchy.sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDELETE_ELEMENT`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT``
    @_documentation(visibility:public)
    case _DELETE_ELEMENT(eDELETE_ELEMENT.PRef)	// (ENTITY)
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eDELETE_ELEMENT.self) {self = ._DELETE_ELEMENT(base.pRef) }
    ...
    public init?<G: SDAI.GenericType>(fromGeneric generic: G?) {
      ...
      else if let base = eDELETE_ELEMENT.PRef.convert(fromGeneric: select) {
    ...
    public static let bareTypeName: String = "PREVIOUS_ELEMENT_ASSIGNMENT_SELECT"
    ...
    public var super_eGROUP: eGROUP.PRef {
      switch self {
      case ._DELETE_ELEMENT(let entity): return eGROUP.PRef(entity.eval?.super_eGROUP)
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT``
    public var super_eDELETE_ELEMENT: eDELETE_ELEMENT.PRef {
      switch self {
      case ._DELETE_ELEMENT(let entity): return entity
      default: return eDELETE_ELEMENT.PRef(nil)
      }
    }
    ...
    public var super_eCHANGE_ELEMENT: eCHANGE_ELEMENT.PRef {
      switch self {
      case ._DELETE_ELEMENT(let entity): return eCHANGE_ELEMENT.PRef(entity.eval?.super_eCHANGE_ELEMENT)
    ...
    public var super_eCHARACTERIZED_OBJECT: eCHARACTERIZED_OBJECT.PRef {
      switch self {
      case ._DELETE_ELEMENT(let entity): return eCHARACTERIZED_OBJECT.PRef(entity.eval?.super_eCHARACTERIZED_OBJECT)
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT``
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDELETE_ELEMENT`` )
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      switch self {
      case ._DELETE_ELEMENT(let entity): return entity.persistentEntityReferences
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._DELETE_ELEMENT(let entity): 
        ...
        result = eDELETE_ELEMENT.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._MODIFY_ELEMENT(let entity): 
        if !entity.shouldPropagateValidation { break }
...
public protocol sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT__TypeBehavior: SDAI.SelectType {
  //MARK: GROUP REFERENCES
  var super_eGROUP: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eGROUP.PRef { get }
  var super_eDELETE_ELEMENT: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDELETE_ELEMENT.PRef { get }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT__Subtype: 
  sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sPREVIOUS_ELEMENT_ASSIGNMENT_SELECT__Subtype {
  //MARK: CONSTRUCTORS
  ...
  var super_eDELETE_ELEMENT: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDELETE_ELEMENT.PRef { rep.super_eDELETE_ELEMENT }
