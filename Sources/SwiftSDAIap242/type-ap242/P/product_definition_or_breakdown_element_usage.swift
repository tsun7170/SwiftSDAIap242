/* file: product_definition_or_breakdown_element_usage.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
*/
  public enum sPRODUCT_DEFINITION_OR_BREAKDOWN_ELEMENT_USAGE : SDAI.Value, 
    TypeHierarchy.sPRODUCT_DEFINITION_OR_BREAKDOWN_ELEMENT_USAGE__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRODUCT_DEFINITION_OR_BREAKDOWN_ELEMENT_USAGE``
...
public protocol sPRODUCT_DEFINITION_OR_BREAKDOWN_ELEMENT_USAGE__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sPRODUCT_DEFINITION_OR_BREAKDOWN_ELEMENT_USAGE__Subtype: 
  sPRODUCT_DEFINITION_OR_BREAKDOWN_ELEMENT_USAGE__TypeBehavior, SDAI.DefinedType
where Supertype: sPRODUCT_DEFINITION_OR_BREAKDOWN_ELEMENT_USAGE__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sPRODUCT_DEFINITION_OR_BREAKDOWN_ELEMENT_USAGE__Subtype {
  //MARK: CONSTRUCTORS
