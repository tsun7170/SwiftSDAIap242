/* file: product_definition_or_breakdown_element_usage.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
/*
  ...
  END_TYPE; -- product_definition_or_breakdown_element_usage (line:4935 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sPRODUCT_DEFINITION_OR_BREAKDOWN_ELEMENT_USAGE : SDAI.Value, 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPRODUCT_DEFINITION_OR_BREAKDOWN_ELEMENT_USAGE__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRODUCT_DEFINITION_OR_BREAKDOWN_ELEMENT_USAGE``
    @_documentation(visibility:public)
    case _PRODUCT(ePRODUCT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRODUCT_DEFINITION_OR_BREAKDOWN_ELEMENT_USAGE``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION(ePRODUCT_DEFINITION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_FORMATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRODUCT_DEFINITION_OR_BREAKDOWN_ELEMENT_USAGE``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION_FORMATION(ePRODUCT_DEFINITION_FORMATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_USAGE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRODUCT_DEFINITION_OR_BREAKDOWN_ELEMENT_USAGE``
    @_documentation(visibility:public)
    ...
    public static let bareTypeName: String = "PRODUCT_DEFINITION_OR_BREAKDOWN_ELEMENT_USAGE"
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRODUCT_DEFINITION_OR_BREAKDOWN_ELEMENT_USAGE``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPRODUCT_DEFINITION_OR_BREAKDOWN_ELEMENT_USAGE__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPRODUCT_DEFINITION_OR_BREAKDOWN_ELEMENT_USAGE__type, SDAI.DefinedType
