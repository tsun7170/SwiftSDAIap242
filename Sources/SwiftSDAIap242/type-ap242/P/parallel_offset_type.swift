/* file: parallel_offset_type.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  TYPE parallel_offset_type = ENUMERATION OF
    ( curve_2d_offset,
     curve_3d_offset,
     surface_offset );
  END_TYPE; -- parallel_offset_type (line:4656 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum nPARALLEL_OFFSET_TYPE : SDAI.ENUMERATION, SDAI.Value, 
    TypeHierarchy.nPARALLEL_OFFSET_TYPE__TypeBehavior {
    /// ENUMERATION case
    ///
    /// - defined in: ``nPARALLEL_OFFSET_TYPE``
    ...
    public static let bareTypeName: String = "PARALLEL_OFFSET_TYPE"
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nPARALLEL_OFFSET_TYPE__TypeBehavior: SDAI.EnumerationType {}
}

extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nPARALLEL_OFFSET_TYPE__Subtype: nPARALLEL_OFFSET_TYPE__TypeBehavior, SDAI.DefinedType
where Supertype: nPARALLEL_OFFSET_TYPE__TypeBehavior
{}
}
