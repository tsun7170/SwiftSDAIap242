/* file: product_definition_occurrence_or_reference.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- product_definition_occurrence_or_reference (line:4925 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sPRODUCT_DEFINITION_OCCURRENCE_OR_REFERENCE : SDAI.Value, TypeHierarchy.sPRODUCT_DEFINITION_OCCURRENCE_OR_REFERENCE__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_OCCURRENCE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRODUCT_DEFINITION_OCCURRENCE_OR_REFERENCE``
...
public protocol sPRODUCT_DEFINITION_OCCURRENCE_OR_REFERENCE__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sPRODUCT_DEFINITION_OCCURRENCE_OR_REFERENCE__Subtype: 
  sPRODUCT_DEFINITION_OCCURRENCE_OR_REFERENCE__TypeBehavior, SDAI.DefinedType
where Supertype: sPRODUCT_DEFINITION_OCCURRENCE_OR_REFERENCE__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sPRODUCT_DEFINITION_OCCURRENCE_OR_REFERENCE__Subtype {
  //MARK: CONSTRUCTORS
