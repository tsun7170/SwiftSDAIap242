/* file: person_and_organization_item.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_TYPE; -- person_and_organization_item (line:4666 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  public enum sPERSON_AND_ORGANIZATION_ITEM : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPERSON_AND_ORGANIZATION_ITEM__type {
    ...
    /// SELECT case ``eACTION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _ACTION(eACTION)	// (ENTITY)

    /// SELECT case ``eACTION_DIRECTIVE`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _ACTION_DIRECTIVE(eACTION_DIRECTIVE)	// (ENTITY)

    /// SELECT case ``eACTION_METHOD`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _ACTION_METHOD(eACTION_METHOD)	// (ENTITY)

    /// SELECT case ``eACTION_PROPERTY`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _ACTION_PROPERTY(eACTION_PROPERTY)	// (ENTITY)

    /// SELECT case ``eACTION_RELATIONSHIP`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _ACTION_RELATIONSHIP(eACTION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eACTION_REQUEST_SOLUTION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _ACTION_REQUEST_SOLUTION(eACTION_REQUEST_SOLUTION)	// (ENTITY)

    /// SELECT case ``eALTERNATE_PRODUCT_RELATIONSHIP`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _ALTERNATE_PRODUCT_RELATIONSHIP(eALTERNATE_PRODUCT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eAPPLIED_ACTION_ASSIGNMENT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _APPLIED_ACTION_ASSIGNMENT(eAPPLIED_ACTION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_ACTION_METHOD_ASSIGNMENT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _APPLIED_ACTION_METHOD_ASSIGNMENT(eAPPLIED_ACTION_METHOD_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_CERTIFICATION_ASSIGNMENT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _APPLIED_CERTIFICATION_ASSIGNMENT(eAPPLIED_CERTIFICATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_CLASSIFICATION_ASSIGNMENT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _APPLIED_CLASSIFICATION_ASSIGNMENT(eAPPLIED_CLASSIFICATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_CONTRACT_ASSIGNMENT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _APPLIED_CONTRACT_ASSIGNMENT(eAPPLIED_CONTRACT_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_DOCUMENT_REFERENCE`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _APPLIED_DOCUMENT_REFERENCE(eAPPLIED_DOCUMENT_REFERENCE)	// (ENTITY)

    /// SELECT case ``eAPPLIED_DOCUMENT_USAGE_CONSTRAINT_ASSIGNMENT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _APPLIED_DOCUMENT_USAGE_CONSTRAINT_ASSIGNMENT(
      eAPPLIED_DOCUMENT_USAGE_CONSTRAINT_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_EFFECTIVITY_ASSIGNMENT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _APPLIED_EFFECTIVITY_ASSIGNMENT(eAPPLIED_EFFECTIVITY_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_EVENT_OCCURRENCE_ASSIGNMENT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _APPLIED_EVENT_OCCURRENCE_ASSIGNMENT(eAPPLIED_EVENT_OCCURRENCE_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_IDENTIFICATION_ASSIGNMENT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _APPLIED_IDENTIFICATION_ASSIGNMENT(eAPPLIED_IDENTIFICATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_ORGANIZATIONAL_PROJECT_ASSIGNMENT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _APPLIED_ORGANIZATIONAL_PROJECT_ASSIGNMENT(eAPPLIED_ORGANIZATIONAL_PROJECT_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_ORGANIZATION_ASSIGNMENT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _APPLIED_ORGANIZATION_ASSIGNMENT(eAPPLIED_ORGANIZATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_PERSON_AND_ORGANIZATION_ASSIGNMENT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _APPLIED_PERSON_AND_ORGANIZATION_ASSIGNMENT(
      eAPPLIED_PERSON_AND_ORGANIZATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_SECURITY_CLASSIFICATION_ASSIGNMENT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _APPLIED_SECURITY_CLASSIFICATION_ASSIGNMENT(
      eAPPLIED_SECURITY_CLASSIFICATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPROVAL`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _APPROVAL(eAPPROVAL)	// (ENTITY)

    /// SELECT case ``eAPPROVAL_STATUS`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _APPROVAL_STATUS(eAPPROVAL_STATUS)	// (ENTITY)

    /// SELECT case ``eASCRIBABLE_STATE`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _ASCRIBABLE_STATE(eASCRIBABLE_STATE)	// (ENTITY)

    /// SELECT case ``eASSEMBLY_COMPONENT_USAGE_SUBSTITUTE`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _ASSEMBLY_COMPONENT_USAGE_SUBSTITUTE(eASSEMBLY_COMPONENT_USAGE_SUBSTITUTE)	// (ENTITY)

    /// SELECT case ``eCERTIFICATION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _CERTIFICATION(eCERTIFICATION)	// (ENTITY)

    /// SELECT case ``eCLASS`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _CLASS(eCLASS)	// (ENTITY)

    /// SELECT case ``eCLASS_SYSTEM`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _CLASS_SYSTEM(eCLASS_SYSTEM)	// (ENTITY)

    /// SELECT case ``eCONFIGURATION_DESIGN`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _CONFIGURATION_DESIGN(eCONFIGURATION_DESIGN)	// (ENTITY)

    /// SELECT case ``eCONFIGURATION_EFFECTIVITY`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _CONFIGURATION_EFFECTIVITY(eCONFIGURATION_EFFECTIVITY)	// (ENTITY)

    /// SELECT case ``eCONFIGURATION_ITEM`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _CONFIGURATION_ITEM(eCONFIGURATION_ITEM)	// (ENTITY)

    /// SELECT case ``eCONFIGURED_EFFECTIVITY_ASSIGNMENT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _CONFIGURED_EFFECTIVITY_ASSIGNMENT(eCONFIGURED_EFFECTIVITY_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eCONTRACT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _CONTRACT(eCONTRACT)	// (ENTITY)

    /// SELECT case ``eDATA_EQUIVALENCE_DEFINITION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _DATA_EQUIVALENCE_DEFINITION(eDATA_EQUIVALENCE_DEFINITION)	// (ENTITY)

    /// SELECT case ``eDATA_QUALITY_DEFINITION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _DATA_QUALITY_DEFINITION(eDATA_QUALITY_DEFINITION)	// (ENTITY)

    /// SELECT case ``eDATE_AND_TIME_ASSIGNMENT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _DATE_AND_TIME_ASSIGNMENT(eDATE_AND_TIME_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eDATE_ASSIGNMENT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _DATE_ASSIGNMENT(eDATE_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eDOCUMENT_FILE`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _DOCUMENT_FILE(eDOCUMENT_FILE)	// (ENTITY)

    /// SELECT case ``eDOCUMENT_TYPE`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _DOCUMENT_TYPE(eDOCUMENT_TYPE)	// (ENTITY)

    /// SELECT case ``eDRAUGHTING_MODEL`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _DRAUGHTING_MODEL(eDRAUGHTING_MODEL)	// (ENTITY)

    /// SELECT case ``eDRAWING_REVISION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _DRAWING_REVISION(eDRAWING_REVISION)	// (ENTITY)

    /// SELECT case ``eEFFECTIVITY`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _EFFECTIVITY(eEFFECTIVITY)	// (ENTITY)

    /// SELECT case ``eENVELOPE`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _ENVELOPE(eENVELOPE)	// (ENTITY)

    /// SELECT case ``eEVENT_OCCURRENCE`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _EVENT_OCCURRENCE(eEVENT_OCCURRENCE)	// (ENTITY)

    /// SELECT case ``eEVIDENCE`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _EVIDENCE(eEVIDENCE)	// (ENTITY)

    /// SELECT case ``eEXECUTED_ACTION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _EXECUTED_ACTION(eEXECUTED_ACTION)	// (ENTITY)

    /// SELECT case ``eGENERAL_PROPERTY`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _GENERAL_PROPERTY(eGENERAL_PROPERTY)	// (ENTITY)

    /// SELECT case ``eGENERAL_PROPERTY_RELATIONSHIP`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _GENERAL_PROPERTY_RELATIONSHIP(eGENERAL_PROPERTY_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eINFORMATION_USAGE_RIGHT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _INFORMATION_USAGE_RIGHT(eINFORMATION_USAGE_RIGHT)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _INTERFACE_CONNECTION(eINTERFACE_CONNECTION)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTOR_AS_PLANNED`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _INTERFACE_CONNECTOR_AS_PLANNED(eINTERFACE_CONNECTOR_AS_PLANNED)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTOR_AS_REALIZED`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _INTERFACE_CONNECTOR_AS_REALIZED(eINTERFACE_CONNECTOR_AS_REALIZED)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTOR_OCCURRENCE`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _INTERFACE_CONNECTOR_OCCURRENCE(eINTERFACE_CONNECTOR_OCCURRENCE)	// (ENTITY)

    /// SELECT case ``eINTERFACE_DEFINITION_CONNECTION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _INTERFACE_DEFINITION_CONNECTION(eINTERFACE_DEFINITION_CONNECTION)	// (ENTITY)

    /// SELECT case ``eINTERFACE_DEFINITION_FOR`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _INTERFACE_DEFINITION_FOR(eINTERFACE_DEFINITION_FOR)	// (ENTITY)

    /// SELECT case ``eMATERIAL_DESIGNATION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _MATERIAL_DESIGNATION(eMATERIAL_DESIGNATION)	// (ENTITY)

    /// SELECT case ``eMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_REPRESENTATION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    ...
    /// SELECT case ``eORGANIZATION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _ORGANIZATION(eORGANIZATION)	// (ENTITY)

    /// SELECT case ``eORGANIZATIONAL_ADDRESS`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _ORGANIZATIONAL_ADDRESS(eORGANIZATIONAL_ADDRESS)	// (ENTITY)

    /// SELECT case ``eORGANIZATIONAL_PROJECT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _ORGANIZATIONAL_PROJECT(eORGANIZATIONAL_PROJECT)	// (ENTITY)

    /// SELECT case ``eORGANIZATION_RELATIONSHIP`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _ORGANIZATION_RELATIONSHIP(eORGANIZATION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePERSON_AND_ORGANIZATION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _PERSON_AND_ORGANIZATION(ePERSON_AND_ORGANIZATION)	// (ENTITY)

    /// SELECT case ``ePRESENTATION_AREA`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _PRESENTATION_AREA(ePRESENTATION_AREA)	// (ENTITY)

    /// SELECT case ``ePRODUCT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _PRODUCT(ePRODUCT)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _PRODUCT_CONCEPT(ePRODUCT_CONCEPT)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT_FEATURE`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _PRODUCT_CONCEPT_FEATURE(ePRODUCT_CONCEPT_FEATURE)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT_FEATURE_ASSOCIATION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _PRODUCT_CONCEPT_FEATURE_ASSOCIATION(ePRODUCT_CONCEPT_FEATURE_ASSOCIATION)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT_FEATURE_CATEGORY`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _PRODUCT_CONCEPT_FEATURE_CATEGORY(ePRODUCT_CONCEPT_FEATURE_CATEGORY)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT_FEATURE_CATEGORY_USAGE`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _PRODUCT_CONCEPT_FEATURE_CATEGORY_USAGE(ePRODUCT_CONCEPT_FEATURE_CATEGORY_USAGE)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _PRODUCT_DEFINITION(ePRODUCT_DEFINITION)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_CONTEXT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _PRODUCT_DEFINITION_CONTEXT(ePRODUCT_DEFINITION_CONTEXT)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_FORMATION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _PRODUCT_DEFINITION_FORMATION(ePRODUCT_DEFINITION_FORMATION)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_FORMATION_RELATIONSHIP`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _PRODUCT_DEFINITION_FORMATION_RELATIONSHIP(ePRODUCT_DEFINITION_FORMATION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_RELATIONSHIP`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _PRODUCT_DEFINITION_RELATIONSHIP(ePRODUCT_DEFINITION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_SUBSTITUTE`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _PRODUCT_DEFINITION_SUBSTITUTE(ePRODUCT_DEFINITION_SUBSTITUTE)	// (ENTITY)

    /// SELECT case ``ePRODUCT_GROUP`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _PRODUCT_GROUP(ePRODUCT_GROUP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_GROUP_MEMBERSHIP`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _PRODUCT_GROUP_MEMBERSHIP(ePRODUCT_GROUP_MEMBERSHIP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_GROUP_RELATIONSHIP`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _PRODUCT_GROUP_RELATIONSHIP(ePRODUCT_GROUP_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePROPERTY_DEFINITION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _PROPERTY_DEFINITION(ePROPERTY_DEFINITION)	// (ENTITY)

    /// SELECT case ``ePROPERTY_DEFINITION_REPRESENTATION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _PROPERTY_DEFINITION_REPRESENTATION(ePROPERTY_DEFINITION_REPRESENTATION)	// (ENTITY)

    /// SELECT case ``eREPRESENTATION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _REPRESENTATION(eREPRESENTATION)	// (ENTITY)

    /// SELECT case ``eREQUIREMENT_ASSIGNMENT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _REQUIREMENT_ASSIGNMENT(eREQUIREMENT_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eREQUIREMENT_FOR_ACTION_RESOURCE`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _REQUIREMENT_FOR_ACTION_RESOURCE(eREQUIREMENT_FOR_ACTION_RESOURCE)	// (ENTITY)

    /// SELECT case ``eREQUIREMENT_SOURCE`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _REQUIREMENT_SOURCE(eREQUIREMENT_SOURCE)	// (ENTITY)

    /// SELECT case ``eRESOURCE_PROPERTY`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _RESOURCE_PROPERTY(eRESOURCE_PROPERTY)	// (ENTITY)

    /// SELECT case ``eRULE_ACTION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _RULE_ACTION(eRULE_ACTION)	// (ENTITY)

    /// SELECT case ``eSECURITY_CLASSIFICATION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _SECURITY_CLASSIFICATION(eSECURITY_CLASSIFICATION)	// (ENTITY)

    /// SELECT case ``eSECURITY_CLASSIFICATION_LEVEL`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _SECURITY_CLASSIFICATION_LEVEL(eSECURITY_CLASSIFICATION_LEVEL)	// (ENTITY)

    /// SELECT case ``eSHAPE_REPRESENTATION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _SHAPE_REPRESENTATION(eSHAPE_REPRESENTATION)	// (ENTITY)

    /// SELECT case ``eSTATE_OBSERVED`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _STATE_OBSERVED(eSTATE_OBSERVED)	// (ENTITY)

    /// SELECT case ``eSTATE_OBSERVED_ASSIGNMENT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _STATE_OBSERVED_ASSIGNMENT(eSTATE_OBSERVED_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eSTATE_OBSERVED_RELATIONSHIP`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _STATE_OBSERVED_RELATIONSHIP(eSTATE_OBSERVED_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eSTATE_TYPE`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _STATE_TYPE(eSTATE_TYPE)	// (ENTITY)

    /// SELECT case ``eSTATE_TYPE_ASSIGNMENT`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _STATE_TYPE_ASSIGNMENT(eSTATE_TYPE_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eSTATE_TYPE_RELATIONSHIP`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _STATE_TYPE_RELATIONSHIP(eSTATE_TYPE_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eSTRUCTURED_MESSAGE`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _STRUCTURED_MESSAGE(eSTRUCTURED_MESSAGE)	// (ENTITY)

    /// SELECT case ``eVALIDATION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _VALIDATION(eVALIDATION)	// (ENTITY)

    /// SELECT case ``eVERIFICATION`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    case _VERIFICATION(eVERIFICATION)	// (ENTITY)

    /// SELECT case ``eVERSIONED_ACTION_REQUEST`` (ENTITY) in ``sPERSON_AND_ORGANIZATION_ITEM``
    ...
    public static var bareTypeName: String = "PERSON_AND_ORGANIZATION_ITEM"
    ...
    /// attribute of SELECT type ``sPERSON_AND_ORGANIZATION_ITEM``
