/* file: product_definition_or_assembly_relationship.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
/*
  ...
  END_TYPE; -- product_definition_or_assembly_relationship (line:4930 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sPRODUCT_DEFINITION_OR_ASSEMBLY_RELATIONSHIP : SDAI.Value, 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPRODUCT_DEFINITION_OR_ASSEMBLY_RELATIONSHIP__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eASSEMBLY_COMPONENT_USAGE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRODUCT_DEFINITION_OR_ASSEMBLY_RELATIONSHIP``
    @_documentation(visibility:public)
    case _ASSEMBLY_COMPONENT_USAGE(eASSEMBLY_COMPONENT_USAGE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRODUCT_DEFINITION_OR_ASSEMBLY_RELATIONSHIP``
    @_documentation(visibility:public)
    ...
    public static let bareTypeName: String = "PRODUCT_DEFINITION_OR_ASSEMBLY_RELATIONSHIP"
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRODUCT_DEFINITION_OR_ASSEMBLY_RELATIONSHIP``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPRODUCT_DEFINITION_OR_ASSEMBLY_RELATIONSHIP__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPRODUCT_DEFINITION_OR_ASSEMBLY_RELATIONSHIP__type, SDAI.DefinedType
