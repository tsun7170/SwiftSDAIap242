/* file: pcurve_or_surface.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  TYPE pcurve_or_surface = SELECT
    ( pcurve (*ENTITY*),
     surface (*ENTITY*) );
  END_TYPE; -- pcurve_or_surface (line:4670 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sPCURVE_OR_SURFACE : SDAI.Value, TypeHierarchy.sPCURVE_OR_SURFACE__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePCURVE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPCURVE_OR_SURFACE``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(ePCURVE.self) {self = ._PCURVE(base.pRef) }
    ...
    public static let bareTypeName: String = "PCURVE_OR_SURFACE"
    ...
    public var BASIS_SURFACE: eSURFACE.PRef?  {
      switch self {
      case ._PCURVE(let entity): return entity.BASIS_SURFACE
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.PCURVE_OR_SURFACE"
...
public protocol sPCURVE_OR_SURFACE__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sPCURVE_OR_SURFACE__Subtype: sPCURVE_OR_SURFACE__TypeBehavior, SDAI.DefinedType
where Supertype: sPCURVE_OR_SURFACE__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sPCURVE_OR_SURFACE__Subtype {
  //MARK: CONSTRUCTORS
