/* file: pcurve_or_surface.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sPCURVE_OR_SURFACE : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPCURVE_OR_SURFACE__type {
    ...
    /// SELECT case ``ePCURVE`` (ENTITY) in ``sPCURVE_OR_SURFACE``
    case _PCURVE(ePCURVE)	// (ENTITY)

    /// SELECT case ``eSURFACE`` (ENTITY) in ``sPCURVE_OR_SURFACE``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(ePCURVE.self) {self = ._PCURVE(base) }
    ...
    /// attribute of SELECT type ``sPCURVE_OR_SURFACE``
