/* file: planar_curve_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sPLANAR_CURVE_SELECT : SDAI.Value, TypeHierarchy.sPLANAR_CURVE_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLINE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPLANAR_CURVE_SELECT``
    @_documentation(visibility:public)
    case _LINE(eLINE.PRef)	// (ENTITY)

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONIC`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPLANAR_CURVE_SELECT``
    @_documentation(visibility:public)
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._CONIC(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eCONIC.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._TRIMMED_CURVE(let entity): 
        if !entity.shouldPropagateValidation { break }
...
public protocol sPLANAR_CURVE_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sPLANAR_CURVE_SELECT__Subtype: sPLANAR_CURVE_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sPLANAR_CURVE_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sPLANAR_CURVE_SELECT__Subtype {
  //MARK: CONSTRUCTORS
