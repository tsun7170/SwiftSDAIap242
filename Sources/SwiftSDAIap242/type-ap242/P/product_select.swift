/* file: product_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sPRODUCT_SELECT : SDAI.Value, TypeHierarchy.sPRODUCT_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRODUCT_SELECT``
...
public protocol sPRODUCT_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sPRODUCT_SELECT__Subtype: sPRODUCT_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sPRODUCT_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sPRODUCT_SELECT__Subtype {
  //MARK: CONSTRUCTORS
