/* file: point_placement_shape_representation_item.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM__type {
    ...
    /// SELECT case ``eAXIS2_PLACEMENT_3D`` (ENTITY) in ``sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM``
    case _AXIS2_PLACEMENT_3D(eAXIS2_PLACEMENT_3D)	// (ENTITY)

    /// SELECT case ``eCOMPOUND_REPRESENTATION_ITEM`` (ENTITY) in ``sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM``
    case _COMPOUND_REPRESENTATION_ITEM(eCOMPOUND_REPRESENTATION_ITEM)	// (ENTITY)

    /// SELECT case ``eMAPPED_ITEM`` (ENTITY) in ``sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      else if let base = complex.entityReference(eCOMPOUND_REPRESENTATION_ITEM.self) {self = ._COMPOUND_REPRESENTATION_ITEM(base) }
    ...
    /// attribute of SELECT type ``sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM``
