/* file: point_placement_shape_representation_item.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAXIS2_PLACEMENT_3D`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM``
    @_documentation(visibility:public)
    case _AXIS2_PLACEMENT_3D(eAXIS2_PLACEMENT_3D.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPOUND_REPRESENTATION_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM``
    @_documentation(visibility:public)
    case _COMPOUND_REPRESENTATION_ITEM(eCOMPOUND_REPRESENTATION_ITEM.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMAPPED_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM__type: 
  SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM__type, SDAI.DefinedType
where Supertype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM__type
{}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPOINT_PLACEMENT_SHAPE_REPRESENTATION_ITEM__subtype {
  //MARK: CONSTRUCTORS
