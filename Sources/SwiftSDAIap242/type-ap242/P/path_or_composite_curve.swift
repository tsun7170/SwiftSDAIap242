/* file: path_or_composite_curve.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sPATH_OR_COMPOSITE_CURVE : SDAI.Value, TypeHierarchy.sPATH_OR_COMPOSITE_CURVE__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPOSITE_CURVE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPATH_OR_COMPOSITE_CURVE``
...
public protocol sPATH_OR_COMPOSITE_CURVE__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sPATH_OR_COMPOSITE_CURVE__Subtype: sPATH_OR_COMPOSITE_CURVE__TypeBehavior, SDAI.DefinedType
where Supertype: sPATH_OR_COMPOSITE_CURVE__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sPATH_OR_COMPOSITE_CURVE__Subtype {
  //MARK: CONSTRUCTORS
