/* file: project_item.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sPROJECT_ITEM : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPROJECT_ITEM__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_METHOD`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    case _ACTION_METHOD(eACTION_METHOD.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_METHOD_RELATIONSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    case _ACTION_METHOD_RELATIONSHIP(eACTION_METHOD_RELATIONSHIP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_ACTION_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_ACTION_ASSIGNMENT(eAPPLIED_ACTION_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_ACTION_METHOD_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_ACTION_METHOD_ASSIGNMENT(eAPPLIED_ACTION_METHOD_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eASSEMBLY_COMPONENT_USAGE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    case _ASSEMBLY_COMPONENT_USAGE(eASSEMBLY_COMPONENT_USAGE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONFIGURATION_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    case _CONFIGURATION_ITEM(eCONFIGURATION_ITEM.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXECUTED_ACTION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    case _EXECUTED_ACTION(eEXECUTED_ACTION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMEASURE_REPRESENTATION_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    case _MEASURE_REPRESENTATION_ITEM(eMEASURE_REPRESENTATION_ITEM.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT(ePRODUCT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_CONCEPT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_CONCEPT(ePRODUCT_CONCEPT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION(ePRODUCT_DEFINITION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_FORMATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION_FORMATION(ePRODUCT_DEFINITION_FORMATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_OCCURRENCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION_OCCURRENCE(ePRODUCT_DEFINITION_OCCURRENCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_OCCURRENCE_REFERENCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION_OCCURRENCE_REFERENCE(ePRODUCT_DEFINITION_OCCURRENCE_REFERENCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_GROUP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_GROUP(ePRODUCT_GROUP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_GROUP_MEMBERSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_GROUP_MEMBERSHIP(ePRODUCT_GROUP_MEMBERSHIP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_GROUP_RELATIONSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_GROUP_RELATIONSHIP(ePRODUCT_GROUP_RELATIONSHIP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_IDENTIFICATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_IDENTIFICATION(ePRODUCT_IDENTIFICATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROPERTY_DEFINITION_REPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    case _PROPERTY_DEFINITION_REPRESENTATION(ePROPERTY_DEFINITION_REPRESENTATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    case _REPRESENTATION(eREPRESENTATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREPRESENTATION_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    case _REPRESENTATION_ITEM(eREPRESENTATION_ITEM.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eVALUE_REPRESENTATION_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPROJECT_ITEM``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPROJECT_ITEM__type: SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPROJECT_ITEM__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPROJECT_ITEM__type, SDAI.DefinedType
