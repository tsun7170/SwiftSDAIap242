/* file: picture_representation_item_select.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sPICTURE_REPRESENTATION_ITEM_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPICTURE_REPRESENTATION_ITEM_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAXIS2_PLACEMENT_2D`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPICTURE_REPRESENTATION_ITEM_SELECT``
    @_documentation(visibility:public)
    case _AXIS2_PLACEMENT_2D(eAXIS2_PLACEMENT_2D.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLANAR_BOX`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPICTURE_REPRESENTATION_ITEM_SELECT``
    @_documentation(visibility:public)
    case _PLANAR_BOX(ePLANAR_BOX.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTYLED_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPICTURE_REPRESENTATION_ITEM_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPICTURE_REPRESENTATION_ITEM_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPICTURE_REPRESENTATION_ITEM_SELECT__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPICTURE_REPRESENTATION_ITEM_SELECT__type, SDAI.DefinedType
