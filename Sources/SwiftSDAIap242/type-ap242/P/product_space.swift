/* file: product_space.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sPRODUCT_SPACE : SDAI.Value, TypeHierarchy.sPRODUCT_SPACE__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLISTED_PRODUCT_SPACE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRODUCT_SPACE``
    @_documentation(visibility:public)
    case _LISTED_PRODUCT_SPACE(eLISTED_PRODUCT_SPACE.PRef)	// (ENTITY)

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eUNIFORM_PRODUCT_SPACE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRODUCT_SPACE``
    @_documentation(visibility:public)
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      switch self {
      case ._LISTED_PRODUCT_SPACE(let entity): return entity.persistentEntityReferences
      case ._UNIFORM_PRODUCT_SPACE(let entity): return entity.persistentEntityReferences
      }
    }
...
public protocol sPRODUCT_SPACE__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sPRODUCT_SPACE__Subtype: sPRODUCT_SPACE__TypeBehavior, SDAI.DefinedType
where Supertype: sPRODUCT_SPACE__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sPRODUCT_SPACE__Subtype {
  //MARK: CONSTRUCTORS
