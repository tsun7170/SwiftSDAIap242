/* file: person_organization_select.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sPERSON_ORGANIZATION_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPERSON_ORGANIZATION_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eORGANIZATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPERSON_ORGANIZATION_SELECT``
    @_documentation(visibility:public)
    case _ORGANIZATION(eORGANIZATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePERSON`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPERSON_ORGANIZATION_SELECT``
    @_documentation(visibility:public)
    case _PERSON(ePERSON.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePERSON_AND_ORGANIZATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPERSON_ORGANIZATION_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPERSON_ORGANIZATION_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPERSON_ORGANIZATION_SELECT__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sPERSON_ORGANIZATION_SELECT__type, SDAI.DefinedType
