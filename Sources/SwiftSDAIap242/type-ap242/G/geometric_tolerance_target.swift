/* file: geometric_tolerance_target.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
/*
  TYPE geometric_tolerance_target = SELECT
    ( dimensional_location (*ENTITY*),
     ...
     shape_aspect (*ENTITY*) );
  END_TYPE; -- geometric_tolerance_target (line:3400 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sGEOMETRIC_TOLERANCE_TARGET : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sGEOMETRIC_TOLERANCE_TARGET__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIMENSIONAL_LOCATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGEOMETRIC_TOLERANCE_TARGET``
    @_documentation(visibility:public)
    case _DIMENSIONAL_LOCATION(eDIMENSIONAL_LOCATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIMENSIONAL_SIZE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGEOMETRIC_TOLERANCE_TARGET``
    @_documentation(visibility:public)
    case _DIMENSIONAL_SIZE(eDIMENSIONAL_SIZE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_SHAPE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGEOMETRIC_TOLERANCE_TARGET``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION_SHAPE(ePRODUCT_DEFINITION_SHAPE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_ASPECT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGEOMETRIC_TOLERANCE_TARGET``
    @_documentation(visibility:public)
    ...
    public static let bareTypeName: String = "GEOMETRIC_TOLERANCE_TARGET"
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGEOMETRIC_TOLERANCE_TARGET``
    ...
    public static let typeName: String = 
      "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.GEOMETRIC_TOLERANCE_TARGET"
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sGEOMETRIC_TOLERANCE_TARGET__type: 
  SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sGEOMETRIC_TOLERANCE_TARGET__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sGEOMETRIC_TOLERANCE_TARGET__type, SDAI.DefinedType
where Supertype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sGEOMETRIC_TOLERANCE_TARGET__type
{}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sGEOMETRIC_TOLERANCE_TARGET__subtype {
  //MARK: CONSTRUCTORS
