/* file: geometric_tolerance_target.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sGEOMETRIC_TOLERANCE_TARGET : SDAI.Value, TypeHierarchy.sGEOMETRIC_TOLERANCE_TARGET__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIMENSIONAL_LOCATION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGEOMETRIC_TOLERANCE_TARGET``
...
public protocol sGEOMETRIC_TOLERANCE_TARGET__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sGEOMETRIC_TOLERANCE_TARGET__Subtype: 
  sGEOMETRIC_TOLERANCE_TARGET__TypeBehavior, SDAI.DefinedType
where Supertype: sGEOMETRIC_TOLERANCE_TARGET__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sGEOMETRIC_TOLERANCE_TARGET__Subtype {
  //MARK: CONSTRUCTORS
