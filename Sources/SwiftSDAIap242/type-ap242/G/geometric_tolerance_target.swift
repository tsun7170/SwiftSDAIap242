/* file: geometric_tolerance_target.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sGEOMETRIC_TOLERANCE_TARGET : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sGEOMETRIC_TOLERANCE_TARGET__type {
    ...
    /// SELECT case ``eDIMENSIONAL_LOCATION`` (ENTITY) in ``sGEOMETRIC_TOLERANCE_TARGET``
    case _DIMENSIONAL_LOCATION(eDIMENSIONAL_LOCATION)	// (ENTITY)

    /// SELECT case ``eDIMENSIONAL_SIZE`` (ENTITY) in ``sGEOMETRIC_TOLERANCE_TARGET``
    case _DIMENSIONAL_SIZE(eDIMENSIONAL_SIZE)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_SHAPE`` (ENTITY) in ``sGEOMETRIC_TOLERANCE_TARGET``
    case _PRODUCT_DEFINITION_SHAPE(ePRODUCT_DEFINITION_SHAPE)	// (ENTITY)

    /// SELECT case ``eSHAPE_ASPECT`` (ENTITY) in ``sGEOMETRIC_TOLERANCE_TARGET``
    ...
    /// attribute of SELECT type ``sGEOMETRIC_TOLERANCE_TARGET``
