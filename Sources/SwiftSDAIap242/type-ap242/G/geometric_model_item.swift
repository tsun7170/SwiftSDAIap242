/* file: geometric_model_item.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  ...
  END_TYPE; -- geometric_model_item (line:3334 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  public enum sGEOMETRIC_MODEL_ITEM : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sGEOMETRIC_MODEL_ITEM__type {
    ...
    /// SELECT case ``eCONNECTED_FACE_SET`` (ENTITY) in ``sGEOMETRIC_MODEL_ITEM``
    case _CONNECTED_FACE_SET(eCONNECTED_FACE_SET)	// (ENTITY)

    /// SELECT case ``eEDGE_LOOP`` (ENTITY) in ``sGEOMETRIC_MODEL_ITEM``
    case _EDGE_LOOP(eEDGE_LOOP)	// (ENTITY)

    /// SELECT case ``eGEOMETRIC_REPRESENTATION_ITEM`` (ENTITY) in ``sGEOMETRIC_MODEL_ITEM``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eCONNECTED_FACE_SET.self) {self = ._CONNECTED_FACE_SET(base) }
    ...
    public static var bareTypeName: String = "GEOMETRIC_MODEL_ITEM"
    ...
    /// attribute of SELECT type ``sGEOMETRIC_MODEL_ITEM``
