/* file: general_organizational_data_select.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_TYPE; -- general_organizational_data_select (line:3200 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  public enum sGENERAL_ORGANIZATIONAL_DATA_SELECT : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sGENERAL_ORGANIZATIONAL_DATA_SELECT__type {
    ...
    /// SELECT case ``eACTION_DIRECTIVE`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _ACTION_DIRECTIVE(eACTION_DIRECTIVE)	// (ENTITY)

    /// SELECT case ``eACTION_METHOD`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _ACTION_METHOD(eACTION_METHOD)	// (ENTITY)

    /// SELECT case ``eACTION_METHOD_RELATIONSHIP`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _ACTION_METHOD_RELATIONSHIP(eACTION_METHOD_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eACTION_PROPERTY`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _ACTION_PROPERTY(eACTION_PROPERTY)	// (ENTITY)

    /// SELECT case ``eACTION_PROPERTY_REPRESENTATION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _ACTION_PROPERTY_REPRESENTATION(eACTION_PROPERTY_REPRESENTATION)	// (ENTITY)

    /// SELECT case ``eACTION_RELATIONSHIP`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _ACTION_RELATIONSHIP(eACTION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eACTION_REQUEST_SOLUTION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _ACTION_REQUEST_SOLUTION(eACTION_REQUEST_SOLUTION)	// (ENTITY)

    /// SELECT case ``eALTERNATE_PRODUCT_RELATIONSHIP`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _ALTERNATE_PRODUCT_RELATIONSHIP(eALTERNATE_PRODUCT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eALTERNATIVE_SOLUTION_RELATIONSHIP`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _ALTERNATIVE_SOLUTION_RELATIONSHIP(eALTERNATIVE_SOLUTION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eAPPLIED_ACTION_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_ACTION_ASSIGNMENT(eAPPLIED_ACTION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_ACTION_METHOD_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_ACTION_METHOD_ASSIGNMENT(eAPPLIED_ACTION_METHOD_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_ACTION_REQUEST_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_ACTION_REQUEST_ASSIGNMENT(eAPPLIED_ACTION_REQUEST_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_APPROVAL_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_APPROVAL_ASSIGNMENT(eAPPLIED_APPROVAL_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_CERTIFICATION_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_CERTIFICATION_ASSIGNMENT(eAPPLIED_CERTIFICATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_CLASSIFICATION_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_CLASSIFICATION_ASSIGNMENT(eAPPLIED_CLASSIFICATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_CONTRACT_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_CONTRACT_ASSIGNMENT(eAPPLIED_CONTRACT_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_DESCRIPTION_TEXT_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_DESCRIPTION_TEXT_ASSIGNMENT(eAPPLIED_DESCRIPTION_TEXT_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_DESCRIPTION_TEXT_ASSIGNMENT_RELATIONSHIP`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_DESCRIPTION_TEXT_ASSIGNMENT_RELATIONSHIP(
      eAPPLIED_DESCRIPTION_TEXT_ASSIGNMENT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eAPPLIED_DOCUMENT_REFERENCE`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_DOCUMENT_REFERENCE(eAPPLIED_DOCUMENT_REFERENCE)	// (ENTITY)

    /// SELECT case ``eAPPLIED_DOCUMENT_USAGE_CONSTRAINT_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_DOCUMENT_USAGE_CONSTRAINT_ASSIGNMENT(
      eAPPLIED_DOCUMENT_USAGE_CONSTRAINT_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_EFFECTIVITY_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_EFFECTIVITY_ASSIGNMENT(eAPPLIED_EFFECTIVITY_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_EVENT_OCCURRENCE_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_EVENT_OCCURRENCE_ASSIGNMENT(eAPPLIED_EVENT_OCCURRENCE_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_EXTERNAL_IDENTIFICATION_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_EXTERNAL_IDENTIFICATION_ASSIGNMENT(
      eAPPLIED_EXTERNAL_IDENTIFICATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_IDENTIFICATION_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_IDENTIFICATION_ASSIGNMENT(eAPPLIED_IDENTIFICATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_INEFFECTIVITY_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_INEFFECTIVITY_ASSIGNMENT(eAPPLIED_INEFFECTIVITY_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_ORGANIZATIONAL_PROJECT_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_ORGANIZATIONAL_PROJECT_ASSIGNMENT(eAPPLIED_ORGANIZATIONAL_PROJECT_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_ORGANIZATION_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_ORGANIZATION_ASSIGNMENT(eAPPLIED_ORGANIZATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_PERSON_AND_ORGANIZATION_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_PERSON_AND_ORGANIZATION_ASSIGNMENT(
      eAPPLIED_PERSON_AND_ORGANIZATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_SECURITY_CLASSIFICATION_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_SECURITY_CLASSIFICATION_ASSIGNMENT(
      eAPPLIED_SECURITY_CLASSIFICATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_TIME_INTERVAL_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_TIME_INTERVAL_ASSIGNMENT(eAPPLIED_TIME_INTERVAL_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_USAGE_RIGHT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPLIED_USAGE_RIGHT(eAPPLIED_USAGE_RIGHT)	// (ENTITY)

    /// SELECT case ``eAPPROVAL`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPROVAL(eAPPROVAL)	// (ENTITY)

    /// SELECT case ``eAPPROVAL_PERSON_ORGANIZATION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPROVAL_PERSON_ORGANIZATION(eAPPROVAL_PERSON_ORGANIZATION)	// (ENTITY)

    /// SELECT case ``eAPPROVAL_RELATIONSHIP`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPROVAL_RELATIONSHIP(eAPPROVAL_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eAPPROVAL_STATUS`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _APPROVAL_STATUS(eAPPROVAL_STATUS)	// (ENTITY)

    /// SELECT case ``eASSEMBLY_COMPONENT_USAGE`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _ASSEMBLY_COMPONENT_USAGE(eASSEMBLY_COMPONENT_USAGE)	// (ENTITY)

    /// SELECT case ``eASSEMBLY_COMPONENT_USAGE_SUBSTITUTE`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _ASSEMBLY_COMPONENT_USAGE_SUBSTITUTE(eASSEMBLY_COMPONENT_USAGE_SUBSTITUTE)	// (ENTITY)

    /// SELECT case ``eBREAKDOWN_ELEMENT_GROUP_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _BREAKDOWN_ELEMENT_GROUP_ASSIGNMENT(eBREAKDOWN_ELEMENT_GROUP_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eBREAKDOWN_ELEMENT_REALIZATION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _BREAKDOWN_ELEMENT_REALIZATION(eBREAKDOWN_ELEMENT_REALIZATION)	// (ENTITY)

    /// SELECT case ``eBREAKDOWN_OF`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _BREAKDOWN_OF(eBREAKDOWN_OF)	// (ENTITY)

    /// SELECT case ``eCERTIFICATION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _CERTIFICATION(eCERTIFICATION)	// (ENTITY)

    /// SELECT case ``eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _CHARACTERIZED_PRODUCT_CONCEPT_FEATURE(eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE)	// (ENTITY)

    /// SELECT case ``eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _CHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY(
      eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY)	// (ENTITY)

    /// SELECT case ``eCLASS`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _CLASS(eCLASS)	// (ENTITY)

    /// SELECT case ``eCLASS_SYSTEM`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _CLASS_SYSTEM(eCLASS_SYSTEM)	// (ENTITY)

    /// SELECT case ``eCONDITION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _CONDITION(eCONDITION)	// (ENTITY)

    /// SELECT case ``eCONDITIONAL_CONCEPT_FEATURE`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _CONDITIONAL_CONCEPT_FEATURE(eCONDITIONAL_CONCEPT_FEATURE)	// (ENTITY)

    /// SELECT case ``eCONDITIONAL_EFFECTIVITY`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _CONDITIONAL_EFFECTIVITY(eCONDITIONAL_EFFECTIVITY)	// (ENTITY)

    /// SELECT case ``eCONFIGURATION_DESIGN`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _CONFIGURATION_DESIGN(eCONFIGURATION_DESIGN)	// (ENTITY)

    /// SELECT case ``eCONFIGURATION_EFFECTIVITY`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _CONFIGURATION_EFFECTIVITY(eCONFIGURATION_EFFECTIVITY)	// (ENTITY)

    /// SELECT case ``eCONFIGURATION_ITEM`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _CONFIGURATION_ITEM(eCONFIGURATION_ITEM)	// (ENTITY)

    /// SELECT case ``eCONFIGURED_EFFECTIVITY_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _CONFIGURED_EFFECTIVITY_ASSIGNMENT(eCONFIGURED_EFFECTIVITY_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eCONTRACT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _CONTRACT(eCONTRACT)	// (ENTITY)

    /// SELECT case ``eDATE_AND_TIME_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _DATE_AND_TIME_ASSIGNMENT(eDATE_AND_TIME_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eDATE_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _DATE_ASSIGNMENT(eDATE_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eDIRECTED_ACTION_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _DIRECTED_ACTION_ASSIGNMENT(eDIRECTED_ACTION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eDOCUMENT_FILE`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _DOCUMENT_FILE(eDOCUMENT_FILE)	// (ENTITY)

    /// SELECT case ``eDRAWING_REVISION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _DRAWING_REVISION(eDRAWING_REVISION)	// (ENTITY)

    /// SELECT case ``eDRAWING_SHEET_REVISION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _DRAWING_SHEET_REVISION(eDRAWING_SHEET_REVISION)	// (ENTITY)

    /// SELECT case ``eEFFECTIVITY`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _EFFECTIVITY(eEFFECTIVITY)	// (ENTITY)

    /// SELECT case ``eEVALUATED_CHARACTERISTIC_OF_PRODUCT_AS_INDIVIDUAL_TEST_RESULT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    ...
    /// SELECT case ``eEXCLUSIVE_PRODUCT_CONCEPT_FEATURE_CATEGORY`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _EXCLUSIVE_PRODUCT_CONCEPT_FEATURE_CATEGORY(
      eEXCLUSIVE_PRODUCT_CONCEPT_FEATURE_CATEGORY)	// (ENTITY)

    /// SELECT case ``eEXECUTED_ACTION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _EXECUTED_ACTION(eEXECUTED_ACTION)	// (ENTITY)

    /// SELECT case ``eFROZEN_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _FROZEN_ASSIGNMENT(eFROZEN_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eGENERAL_PROPERTY`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _GENERAL_PROPERTY(eGENERAL_PROPERTY)	// (ENTITY)

    /// SELECT case ``eGENERAL_PROPERTY_RELATIONSHIP`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _GENERAL_PROPERTY_RELATIONSHIP(eGENERAL_PROPERTY_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eGROUP`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _GROUP(eGROUP)	// (ENTITY)

    /// SELECT case ``eGROUP_RELATIONSHIP`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _GROUP_RELATIONSHIP(eGROUP_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eIDENTIFICATION_ASSIGNMENT_RELATIONSHIP`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _IDENTIFICATION_ASSIGNMENT_RELATIONSHIP(eIDENTIFICATION_ASSIGNMENT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eINCLUSION_PRODUCT_CONCEPT_FEATURE`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _INCLUSION_PRODUCT_CONCEPT_FEATURE(eINCLUSION_PRODUCT_CONCEPT_FEATURE)	// (ENTITY)

    /// SELECT case ``eINFORMATION_USAGE_RIGHT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _INFORMATION_USAGE_RIGHT(eINFORMATION_USAGE_RIGHT)	// (ENTITY)

    /// SELECT case ``eMATERIAL_DESIGNATION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _MATERIAL_DESIGNATION(eMATERIAL_DESIGNATION)	// (ENTITY)

    /// SELECT case ``eMATERIAL_DESIGNATION_CHARACTERIZATION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _MATERIAL_DESIGNATION_CHARACTERIZATION(eMATERIAL_DESIGNATION_CHARACTERIZATION)	// (ENTITY)

    /// SELECT case ``eMEASURE_REPRESENTATION_ITEM`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _MEASURE_REPRESENTATION_ITEM(eMEASURE_REPRESENTATION_ITEM)	// (ENTITY)

    /// SELECT case ``eORGANIZATION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _ORGANIZATION(eORGANIZATION)	// (ENTITY)

    /// SELECT case ``eORGANIZATIONAL_ADDRESS`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _ORGANIZATIONAL_ADDRESS(eORGANIZATIONAL_ADDRESS)	// (ENTITY)

    /// SELECT case ``eORGANIZATIONAL_PROJECT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _ORGANIZATIONAL_PROJECT(eORGANIZATIONAL_PROJECT)	// (ENTITY)

    /// SELECT case ``eORGANIZATION_RELATIONSHIP`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _ORGANIZATION_RELATIONSHIP(eORGANIZATION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePACKAGE_PRODUCT_CONCEPT_FEATURE`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PACKAGE_PRODUCT_CONCEPT_FEATURE(ePACKAGE_PRODUCT_CONCEPT_FEATURE)	// (ENTITY)

    /// SELECT case ``ePERSON`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PERSON(ePERSON)	// (ENTITY)

    /// SELECT case ``ePERSON_AND_ORGANIZATION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PERSON_AND_ORGANIZATION(ePERSON_AND_ORGANIZATION)	// (ENTITY)

    /// SELECT case ``ePERSON_AND_ORGANIZATION_ADDRESS`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PERSON_AND_ORGANIZATION_ADDRESS(ePERSON_AND_ORGANIZATION_ADDRESS)	// (ENTITY)

    /// SELECT case ``ePRESENTATION_AREA`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PRESENTATION_AREA(ePRESENTATION_AREA)	// (ENTITY)

    /// SELECT case ``ePROCESS_OPERATION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PROCESS_OPERATION(ePROCESS_OPERATION)	// (ENTITY)

    /// SELECT case ``ePROCESS_PLAN`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PROCESS_PLAN(ePROCESS_PLAN)	// (ENTITY)

    /// SELECT case ``ePRODUCT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PRODUCT(ePRODUCT)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CLASS`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PRODUCT_CLASS(ePRODUCT_CLASS)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PRODUCT_CONCEPT(ePRODUCT_CONCEPT)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT_FEATURE`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PRODUCT_CONCEPT_FEATURE(ePRODUCT_CONCEPT_FEATURE)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT_FEATURE_ASSOCIATION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PRODUCT_CONCEPT_FEATURE_ASSOCIATION(ePRODUCT_CONCEPT_FEATURE_ASSOCIATION)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT_FEATURE_CATEGORY`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PRODUCT_CONCEPT_FEATURE_CATEGORY(ePRODUCT_CONCEPT_FEATURE_CATEGORY)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT_FEATURE_CATEGORY_USAGE`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PRODUCT_CONCEPT_FEATURE_CATEGORY_USAGE(ePRODUCT_CONCEPT_FEATURE_CATEGORY_USAGE)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PRODUCT_DEFINITION(ePRODUCT_DEFINITION)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_FORMATION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PRODUCT_DEFINITION_FORMATION(ePRODUCT_DEFINITION_FORMATION)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_FORMATION_RELATIONSHIP`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PRODUCT_DEFINITION_FORMATION_RELATIONSHIP(ePRODUCT_DEFINITION_FORMATION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_GROUP_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PRODUCT_DEFINITION_GROUP_ASSIGNMENT(ePRODUCT_DEFINITION_GROUP_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_OCCURRENCE`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PRODUCT_DEFINITION_OCCURRENCE(ePRODUCT_DEFINITION_OCCURRENCE)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_OCCURRENCE_REFERENCE`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PRODUCT_DEFINITION_OCCURRENCE_REFERENCE(ePRODUCT_DEFINITION_OCCURRENCE_REFERENCE)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_RELATIONSHIP`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PRODUCT_DEFINITION_RELATIONSHIP(ePRODUCT_DEFINITION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_SUBSTITUTE`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PRODUCT_DEFINITION_SUBSTITUTE(ePRODUCT_DEFINITION_SUBSTITUTE)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_USAGE`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PRODUCT_DEFINITION_USAGE(ePRODUCT_DEFINITION_USAGE)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DESIGN_TO_INDIVIDUAL`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PRODUCT_DESIGN_TO_INDIVIDUAL(ePRODUCT_DESIGN_TO_INDIVIDUAL)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DESIGN_VERSION_TO_INDIVIDUAL`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PRODUCT_DESIGN_VERSION_TO_INDIVIDUAL(ePRODUCT_DESIGN_VERSION_TO_INDIVIDUAL)	// (ENTITY)

    /// SELECT case ``ePRODUCT_PROCESS_PLAN`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PRODUCT_PROCESS_PLAN(ePRODUCT_PROCESS_PLAN)	// (ENTITY)

    /// SELECT case ``ePRODUCT_RELATIONSHIP`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PRODUCT_RELATIONSHIP(ePRODUCT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePROPERTY_DEFINITION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PROPERTY_DEFINITION(ePROPERTY_DEFINITION)	// (ENTITY)

    /// SELECT case ``ePROPERTY_DEFINITION_REPRESENTATION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _PROPERTY_DEFINITION_REPRESENTATION(ePROPERTY_DEFINITION_REPRESENTATION)	// (ENTITY)

    /// SELECT case ``eREPRESENTATION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _REPRESENTATION(eREPRESENTATION)	// (ENTITY)

    /// SELECT case ``eREPRESENTATION_ITEM`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _REPRESENTATION_ITEM(eREPRESENTATION_ITEM)	// (ENTITY)

    /// SELECT case ``eREPRESENTATION_RELATIONSHIP`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _REPRESENTATION_RELATIONSHIP(eREPRESENTATION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eREQUIREMENT_ASSIGNMENT`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _REQUIREMENT_ASSIGNMENT(eREQUIREMENT_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eREQUIREMENT_FOR_ACTION_RESOURCE`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _REQUIREMENT_FOR_ACTION_RESOURCE(eREQUIREMENT_FOR_ACTION_RESOURCE)	// (ENTITY)

    /// SELECT case ``eREQUIREMENT_SOURCE`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _REQUIREMENT_SOURCE(eREQUIREMENT_SOURCE)	// (ENTITY)

    /// SELECT case ``eREQUIREMENT_VIEW_DEFINITION_RELATIONSHIP`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _REQUIREMENT_VIEW_DEFINITION_RELATIONSHIP(eREQUIREMENT_VIEW_DEFINITION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eSECURITY_CLASSIFICATION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _SECURITY_CLASSIFICATION(eSECURITY_CLASSIFICATION)	// (ENTITY)

    /// SELECT case ``eSHAPE_REPRESENTATION`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _SHAPE_REPRESENTATION(eSHAPE_REPRESENTATION)	// (ENTITY)

    /// SELECT case ``eVALUE_REPRESENTATION_ITEM`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    case _VALUE_REPRESENTATION_ITEM(eVALUE_REPRESENTATION_ITEM)	// (ENTITY)

    /// SELECT case ``eVERSIONED_ACTION_REQUEST`` (ENTITY) in ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      else if let base = complex.entityReference(eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE.self) {self = ._CHARACTERIZED_PRODUCT_CONCEPT_FEATURE(base) }
      else if let base = complex.entityReference(eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY.self) {self = ._CHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY(base) }
      ...
      else if let base = complex.entityReference(eCONDITIONAL_CONCEPT_FEATURE.self) {self = ._CONDITIONAL_CONCEPT_FEATURE(base) }
      ...
      else if let base = complex.entityReference(eDRAWING_SHEET_REVISION.self) {self = ._DRAWING_SHEET_REVISION(base) }
    ...
    public init?<G: SDAIGenericType>(fromGeneric generic: G?) {
      ...
      else if let base = eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE.convert(fromGeneric: select) {
        self = ._CHARACTERIZED_PRODUCT_CONCEPT_FEATURE(base)
      }
      else if let base = eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY.convert(fromGeneric: select) {
      ...
      else if let base = eCONDITIONAL_CONCEPT_FEATURE.convert(fromGeneric: select) {
      ...
      else if let base = eDRAWING_SHEET_REVISION.convert(fromGeneric: select) {
    ...
    public static var bareTypeName: String = "GENERAL_ORGANIZATIONAL_DATA_SELECT"
    ...
    public var super_eREPRESENTATION: eREPRESENTATION? {
      switch self {
      case ._DRAWING_SHEET_REVISION(let entity): return entity.super_eREPRESENTATION
      case ._EVALUATED_CHARACTERISTIC_OF_PRODUCT_AS_INDIVIDUAL_TEST_RESULT(let entity): return entity
    ...
    public var super_eGROUP: eGROUP? {
      ...
      case ._CHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY(let entity): return entity.super_eGROUP
    ...
    public var super_ePRESENTATION_REPRESENTATION: ePRESENTATION_REPRESENTATION? {
      switch self {
      case ._DRAWING_SHEET_REVISION(let entity): return entity.super_ePRESENTATION_REPRESENTATION
    ...
    public var super_ePRODUCT_CONCEPT_FEATURE: ePRODUCT_CONCEPT_FEATURE? {
      switch self {
      case ._CHARACTERIZED_PRODUCT_CONCEPT_FEATURE(let entity): return entity.super_ePRODUCT_CONCEPT_FEATURE
      case ._CONDITIONAL_CONCEPT_FEATURE(let entity): return entity.super_ePRODUCT_CONCEPT_FEATURE
    ...
    public var super_ePRESENTATION_AREA: ePRESENTATION_AREA? {
      switch self {
      case ._DRAWING_SHEET_REVISION(let entity): return entity.super_ePRESENTATION_AREA
    ...
    public var super_eCHARACTERIZED_OBJECT: eCHARACTERIZED_OBJECT? {
      ...
      case ._CHARACTERIZED_PRODUCT_CONCEPT_FEATURE(let entity): return entity.super_eCHARACTERIZED_OBJECT
      case ._CHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY(let entity): return entity
        .super_eCHARACTERIZED_OBJECT
    ...
    /// attribute of SELECT type ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    ...
    /// attribute of SELECT type ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    /// - origin: ENTITY( ``eDRAWING_REVISION`` )
    /// - origin: ENTITY( ``eDRAWING_SHEET_REVISION`` )
    ...
    /// attribute of SELECT type ``sGENERAL_ORGANIZATIONAL_DATA_SELECT``
    /// - origin: ENTITY( ``eCONDITIONAL_CONCEPT_FEATURE`` )
    ...
    /// - origin: ENTITY( ``eBREAKDOWN_OF`` )
    /// - origin: ENTITY( ``eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE`` )
    /// - origin: ENTITY( ``eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY`` )
    ...
    public var CONTEXT_OF_ITEMS: eREPRESENTATION_CONTEXT?  {
      switch self {
      case ._DRAWING_SHEET_REVISION(let entity): return eREPRESENTATION_CONTEXT(entity.CONTEXT_OF_ITEMS)
    ...
    public var NAME: tLABEL?  {
      ...
      case ._CHARACTERIZED_PRODUCT_CONCEPT_FEATURE/*(let entity)*/: return nil // AMBIGUOUS ATTRIBUTE for eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE
      case ._CHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY/*(let entity)*/: return nil // AMBIGUOUS ATTRIBUTE for eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY
    ...
    public mutating func configure(with observer: SDAI.EntityReferenceObserver) {
      ...
      case ._CHARACTERIZED_PRODUCT_CONCEPT_FEATURE(let entity): 
        entity.configure(with: observer)
        self = ._CHARACTERIZED_PRODUCT_CONCEPT_FEATURE(entity)
      case ._CHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY(let entity): 
        entity.configure(with: observer)
        self = ._CHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY(entity)
      ...
      case ._CONDITIONAL_CONCEPT_FEATURE(let entity): 
        entity.configure(with: observer)
        self = ._CONDITIONAL_CONCEPT_FEATURE(entity)
      ...
      case ._DRAWING_SHEET_REVISION(let entity): 
        entity.configure(with: observer)
        self = ._DRAWING_SHEET_REVISION(entity)
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      case ._CHARACTERIZED_PRODUCT_CONCEPT_FEATURE(let selectValue): 
        result = eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE.validateWhereRules(instance:selectValue, 
        prefix:prefix + "\\CHARACTERIZED_PRODUCT_CONCEPT_FEATURE")
      case ._CHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY(let selectValue): 
        result = eCHARACTERIZED_PRODUCT_CONCEPT_FEATURE_CATEGORY.validateWhereRules(instance:selectValue, 
      ...
      case ._CONDITIONAL_CONCEPT_FEATURE(let selectValue): 
        result = eCONDITIONAL_CONCEPT_FEATURE.validateWhereRules(instance:selectValue, 
      ...
      case ._DRAWING_SHEET_REVISION(let selectValue): 
        result = eDRAWING_SHEET_REVISION.validateWhereRules(instance:selectValue, 
