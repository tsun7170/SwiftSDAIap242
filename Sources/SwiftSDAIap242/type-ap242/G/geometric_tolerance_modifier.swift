/* file: geometric_tolerance_modifier.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  TYPE geometric_tolerance_modifier = ENUMERATION OF
    ( any_cross_section,
     ...
     united_feature,
     valley_depth );
  END_TYPE; -- geometric_tolerance_modifier (line:3363 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum nGEOMETRIC_TOLERANCE_MODIFIER : SDAI.ENUMERATION, SDAI.Value, 
    TypeHierarchy.nGEOMETRIC_TOLERANCE_MODIFIER__TypeBehavior {
    /// ENUMERATION case
    ///
    /// - defined in: ``nGEOMETRIC_TOLERANCE_MODIFIER``
    ...
    public static let bareTypeName: String = "GEOMETRIC_TOLERANCE_MODIFIER"
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nGEOMETRIC_TOLERANCE_MODIFIER__TypeBehavior: SDAI.EnumerationType {}
}

extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nGEOMETRIC_TOLERANCE_MODIFIER__Subtype: 
  nGEOMETRIC_TOLERANCE_MODIFIER__TypeBehavior, SDAI.DefinedType
where Supertype: nGEOMETRIC_TOLERANCE_MODIFIER__TypeBehavior
{}
}
