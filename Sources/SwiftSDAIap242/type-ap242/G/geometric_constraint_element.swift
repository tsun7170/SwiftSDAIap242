/* file: geometric_constraint_element.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  TYPE geometric_constraint_element = SELECT
    ( curve (*ENTITY*),
     ...
     surface (*ENTITY*),
     vector (*ENTITY*) );
  END_TYPE; -- geometric_constraint_element (line:3330 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  ATTR:  orientation: BOOLEAN (AMBIGUOUS (SELECT LEVEL))
  ...
  CASE: vector (*ENTITY*):
  ATTR:  orientation: direction (AMBIGUOUS (SELECT LEVEL))
...
```
*/
  public enum sGEOMETRIC_CONSTRAINT_ELEMENT : SDAI.Value, TypeHierarchy.sGEOMETRIC_CONSTRAINT_ELEMENT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGEOMETRIC_CONSTRAINT_ELEMENT``
    ...
    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eVECTOR`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGEOMETRIC_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    ...
    public static let bareTypeName: String = "GEOMETRIC_CONSTRAINT_ELEMENT"
    ...
    //MARK: var ORIENTATION: (AMBIGUOUS SOURCE; ATTRIBUTE ACCESS SUPPRESSED)
    ...
    public static let typeName: String = 
      "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.GEOMETRIC_CONSTRAINT_ELEMENT"
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      ...
      case ._VECTOR(let entity): return entity.persistentEntityReferences
      }
    }
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._VECTOR(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eVECTOR.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case nil: break
      }
...
public protocol sGEOMETRIC_CONSTRAINT_ELEMENT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sGEOMETRIC_CONSTRAINT_ELEMENT__Subtype: 
  sGEOMETRIC_CONSTRAINT_ELEMENT__TypeBehavior, SDAI.DefinedType
where Supertype: sGEOMETRIC_CONSTRAINT_ELEMENT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sGEOMETRIC_CONSTRAINT_ELEMENT__Subtype {
  //MARK: CONSTRUCTORS
