/* file: geometric_constraint_element.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sGEOMETRIC_CONSTRAINT_ELEMENT : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sGEOMETRIC_CONSTRAINT_ELEMENT__type {
    ...
    /// SELECT case ``eCURVE`` (ENTITY) in ``sGEOMETRIC_CONSTRAINT_ELEMENT``
    case _CURVE(eCURVE)	// (ENTITY)

    /// SELECT case ``eDIRECTION`` (ENTITY) in ``sGEOMETRIC_CONSTRAINT_ELEMENT``
    case _DIRECTION(eDIRECTION)	// (ENTITY)

    /// SELECT case ``ePOINT`` (ENTITY) in ``sGEOMETRIC_CONSTRAINT_ELEMENT``
    case _POINT(ePOINT)	// (ENTITY)

    /// SELECT case ``eSURFACE`` (ENTITY) in ``sGEOMETRIC_CONSTRAINT_ELEMENT``
    case _SURFACE(eSURFACE)	// (ENTITY)

    /// SELECT case ``eVECTOR`` (ENTITY) in ``sGEOMETRIC_CONSTRAINT_ELEMENT``
    ...
    /// attribute of SELECT type ``sGEOMETRIC_CONSTRAINT_ELEMENT``
    ...
    //MARK: var ORIENTATION: (AMBIGUOUS)
