/* file: geometric_item_specific_usage_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- geometric_item_specific_usage_select (line:3338 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT : SDAI.Value, TypeHierarchy.sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_ASPECT`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eSHAPE_ASPECT.self) {self = ._SHAPE_ASPECT(base.pRef) }
    ...
    public static let bareTypeName: String = "GEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT"
    ...
    public static let typeName: String = 
      "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.GEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT"
...
public protocol sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT__Subtype: 
  sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT__Subtype {
  //MARK: CONSTRUCTORS
