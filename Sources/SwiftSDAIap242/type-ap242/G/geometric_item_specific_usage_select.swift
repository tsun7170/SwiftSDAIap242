/* file: geometric_item_specific_usage_select.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT__type {
    ...
    /// SELECT case ``eSHAPE_ASPECT`` (ENTITY) in ``sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT``
    case _SHAPE_ASPECT(eSHAPE_ASPECT)	// (ENTITY)

    /// SELECT case ``eSHAPE_ASPECT_RELATIONSHIP`` (ENTITY) in ``sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT``
    ...
    /// attribute of SELECT type ``sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT``
