/* file: geometric_item_specific_usage_select.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_ASPECT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT``
    @_documentation(visibility:public)
    case _SHAPE_ASPECT(eSHAPE_ASPECT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_ASPECT_RELATIONSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT__type: 
  SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT__type, SDAI.DefinedType
where Supertype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT__type
{}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sGEOMETRIC_ITEM_SPECIFIC_USAGE_SELECT__subtype {
  //MARK: CONSTRUCTORS
