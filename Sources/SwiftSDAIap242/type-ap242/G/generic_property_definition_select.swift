/* file: generic_property_definition_select.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sGENERIC_PROPERTY_DEFINITION_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sGENERIC_PROPERTY_DEFINITION_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_PROPERTY`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGENERIC_PROPERTY_DEFINITION_SELECT``
    @_documentation(visibility:public)
    case _ACTION_PROPERTY(eACTION_PROPERTY.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIMENSIONAL_LOCATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGENERIC_PROPERTY_DEFINITION_SELECT``
    @_documentation(visibility:public)
    case _DIMENSIONAL_LOCATION(eDIMENSIONAL_LOCATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIMENSIONAL_SIZE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGENERIC_PROPERTY_DEFINITION_SELECT``
    @_documentation(visibility:public)
    case _DIMENSIONAL_SIZE(eDIMENSIONAL_SIZE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROPERTY_DEFINITION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGENERIC_PROPERTY_DEFINITION_SELECT``
    @_documentation(visibility:public)
    case _PROPERTY_DEFINITION(ePROPERTY_DEFINITION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRESOURCE_PROPERTY`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGENERIC_PROPERTY_DEFINITION_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGENERIC_PROPERTY_DEFINITION_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sGENERIC_PROPERTY_DEFINITION_SELECT__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sGENERIC_PROPERTY_DEFINITION_SELECT__type, SDAI.DefinedType
