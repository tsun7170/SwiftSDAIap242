/* file: gps_filtration_type.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- gps_filtration_type (line:3411 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  CASE: geometric_tolerance_modifier (*ENUM*): geometric_tolerance_modifier
...
```
*/
  public enum sGPS_FILTRATION_TYPE : SDAI.Value, TypeHierarchy.sGPS_FILTRATION_TYPE__TypeBehavior {

    /// SELECT case (ENUM)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/nGEOMETRIC_TOLERANCE_MODIFIER`` (ENUM)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGPS_FILTRATION_TYPE``
    ...
    public static let bareTypeName: String = "GPS_FILTRATION_TYPE"
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      switch self {
      case ._GEOMETRIC_TOLERANCE_MODIFIER: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      }
    }

    public func isHolding(entityReference: SDAI.EntityReference) -> Bool {
      switch self {
      case ._GEOMETRIC_TOLERANCE_MODIFIER: return false
      }
    }
...
public protocol sGPS_FILTRATION_TYPE__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sGPS_FILTRATION_TYPE__Subtype: sGPS_FILTRATION_TYPE__TypeBehavior, SDAI.DefinedType
where Supertype: sGPS_FILTRATION_TYPE__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sGPS_FILTRATION_TYPE__Subtype {
  //MARK: CONSTRUCTORS
