/* file: geometric_set_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  TYPE geometric_set_select = SELECT
    ( annotation_text (*ENTITY*),
     ...
     point (*ENTITY*),
     surface (*ENTITY*) );
  END_TYPE; -- geometric_set_select (line:3349 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sGEOMETRIC_SET_SELECT : SDAI.Value, TypeHierarchy.sGEOMETRIC_SET_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANNOTATION_TEXT`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sGEOMETRIC_SET_SELECT``
    ...
    public static let bareTypeName: String = "GEOMETRIC_SET_SELECT"
...
public protocol sGEOMETRIC_SET_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sGEOMETRIC_SET_SELECT__Subtype: sGEOMETRIC_SET_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sGEOMETRIC_SET_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sGEOMETRIC_SET_SELECT__Subtype {
  //MARK: CONSTRUCTORS
