/* file: basis_11_direction_member.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sBASIS_11_DIRECTION_MEMBER : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sBASIS_11_DIRECTION_MEMBER__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCARTESIAN_11`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sBASIS_11_DIRECTION_MEMBER``
    @_documentation(visibility:public)
    case _CARTESIAN_11(eCARTESIAN_11.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_11`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sBASIS_11_DIRECTION_MEMBER``
    @_documentation(visibility:public)
    case _CURVE_11(eCURVE_11.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCYLINDRICAL_11`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sBASIS_11_DIRECTION_MEMBER``
    @_documentation(visibility:public)
    case _CYLINDRICAL_11(eCYLINDRICAL_11.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT_ARRAY`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sBASIS_11_DIRECTION_MEMBER``
    @_documentation(visibility:public)
    case _POINT_ARRAY(ePOINT_ARRAY.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOLAR_11`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sBASIS_11_DIRECTION_MEMBER``
    @_documentation(visibility:public)
    case _POLAR_11(ePOLAR_11.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eUSER_DEFINED_11`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sBASIS_11_DIRECTION_MEMBER``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sBASIS_11_DIRECTION_MEMBER``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sBASIS_11_DIRECTION_MEMBER__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sBASIS_11_DIRECTION_MEMBER__type, SDAI.DefinedType
