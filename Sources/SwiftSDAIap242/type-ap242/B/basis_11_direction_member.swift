/* file: basis_11_direction_member.swift 	 generated: Thu Mar  5 17:54:18 2026 */
  ...
  public enum sBASIS_11_DIRECTION_MEMBER : SDAI.Value, TypeHierarchy.sBASIS_11_DIRECTION_MEMBER__TypeBehavior {
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._CARTESIAN_11(let entity): 
        ...
        result = eCARTESIAN_11.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._CURVE_11(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eCURVE_11.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._CYLINDRICAL_11(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eCYLINDRICAL_11.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._POINT_ARRAY(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = ePOINT_ARRAY.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._POLAR_11(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = ePOLAR_11.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._USER_DEFINED_11(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eUSER_DEFINED_11.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case nil: break
      }
