/* file: blend_radius_variation_type.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  TYPE blend_radius_variation_type = ENUMERATION OF
    ( linear_blend,
     cubic_blend,
     unspecified_blend );
  END_TYPE; -- blend_radius_variation_type (line:1159 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum nBLEND_RADIUS_VARIATION_TYPE : SDAI.ENUMERATION, SDAI.Value, 
    TypeHierarchy.nBLEND_RADIUS_VARIATION_TYPE__TypeBehavior {
    /// ENUMERATION case
    ///
    /// - defined in: ``nBLEND_RADIUS_VARIATION_TYPE``
    case LINEAR_BLEND
    /// ENUMERATION case
    ///
    /// - defined in: ``nBLEND_RADIUS_VARIATION_TYPE``
    ...
    public static let bareTypeName: String = "BLEND_RADIUS_VARIATION_TYPE"
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nBLEND_RADIUS_VARIATION_TYPE__TypeBehavior: SDAI.EnumerationType {}
}

extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nBLEND_RADIUS_VARIATION_TYPE__Subtype: 
  nBLEND_RADIUS_VARIATION_TYPE__TypeBehavior, SDAI.DefinedType
where Supertype: nBLEND_RADIUS_VARIATION_TYPE__TypeBehavior
{}
}
