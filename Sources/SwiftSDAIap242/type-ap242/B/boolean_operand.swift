/* file: boolean_operand.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sBOOLEAN_OPERAND : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sBOOLEAN_OPERAND__type {
    ...
    /// SELECT case ``eBOOLEAN_RESULT`` (ENTITY) in ``sBOOLEAN_OPERAND``
    case _BOOLEAN_RESULT(eBOOLEAN_RESULT)	// (ENTITY)

    /// SELECT case ``sCSG_PRIMITIVE`` (SELECT) in ``sBOOLEAN_OPERAND``
    case _CSG_PRIMITIVE(sCSG_PRIMITIVE)	// (SELECT)

    /// SELECT case ``eHALF_SPACE_2D`` (ENTITY) in ``sBOOLEAN_OPERAND``
    case _HALF_SPACE_2D(eHALF_SPACE_2D)	// (ENTITY)

    /// SELECT case ``eHALF_SPACE_SOLID`` (ENTITY) in ``sBOOLEAN_OPERAND``
    case _HALF_SPACE_SOLID(eHALF_SPACE_SOLID)	// (ENTITY)

    /// SELECT case ``eSOLID_MODEL`` (ENTITY) in ``sBOOLEAN_OPERAND``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      else if let base = complex.entityReference(eHALF_SPACE_2D.self) {self = ._HALF_SPACE_2D(base) }
      else if let base = complex.entityReference(eHALF_SPACE_SOLID.self) {self = ._HALF_SPACE_SOLID(base) }
    ...
    public init?<G: SDAIGenericType>(fromGeneric generic: G?) {
      ...
      else if let base = eHALF_SPACE_2D.convert(fromGeneric: select) {
        self = ._HALF_SPACE_2D(base)
      }
      else if let base = eHALF_SPACE_SOLID.convert(fromGeneric: select) {
    ...
    public var super_ePRIMITIVE_2D: ePRIMITIVE_2D? {
      ...
      case ._HALF_SPACE_2D(let entity): return entity.super_ePRIMITIVE_2D
      default: return nil
      }
    }
    ...
    public var super_eREPRESENTATION_ITEM: eREPRESENTATION_ITEM? {
      ...
      case ._HALF_SPACE_2D(let entity): return entity.super_eREPRESENTATION_ITEM
      case ._HALF_SPACE_SOLID(let entity): return entity.super_eREPRESENTATION_ITEM
    ...
    public var super_eHALF_SPACE_SOLID: eHALF_SPACE_SOLID? {
      switch self {
    ...
    public var super_eGEOMETRIC_REPRESENTATION_ITEM: eGEOMETRIC_REPRESENTATION_ITEM? {
      ...
      case ._HALF_SPACE_2D(let entity): return entity.super_eGEOMETRIC_REPRESENTATION_ITEM
      case ._HALF_SPACE_SOLID(let entity): return entity.super_eGEOMETRIC_REPRESENTATION_ITEM
    ...
    /// attribute of SELECT type ``sBOOLEAN_OPERAND``
    ...
    /// attribute of SELECT type ``sBOOLEAN_OPERAND``
    /// - origin: ENTITY( ``eHALF_SPACE_SOLID`` )
    ...
    public var BASE_CURVE: eCURVE?  {
      switch self {
      case ._CSG_PRIMITIVE(let select): return eCURVE(select.BASE_CURVE)
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      case ._HALF_SPACE_2D(let selectValue): 
        result = eHALF_SPACE_2D.validateWhereRules(instance:selectValue, prefix:prefix + "\\HALF_SPACE_2D")
      case ._HALF_SPACE_SOLID(let selectValue): 
        result = eHALF_SPACE_SOLID.validateWhereRules(instance:selectValue, 
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sBOOLEAN_OPERAND__type: SDAISelectType {
  ...
  var super_eHALF_SPACE_SOLID: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eHALF_SPACE_SOLID? { get }
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sBOOLEAN_OPERAND__subtype {
  ...
  var super_eHALF_SPACE_SOLID: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eHALF_SPACE_SOLID? { rep.super_eHALF_SPACE_SOLID }
