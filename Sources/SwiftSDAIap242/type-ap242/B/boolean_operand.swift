/* file: boolean_operand.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  TYPE boolean_operand = SELECT
    ( boolean_result (*ENTITY*),
     ...
     solid_model (*ENTITY*) );
  END_TYPE; -- boolean_operand (line:1156 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  public enum sBOOLEAN_OPERAND : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sBOOLEAN_OPERAND__type {
    ...
    public static var bareTypeName: String = "BOOLEAN_OPERAND"
    ...
    public static var typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BOOLEAN_OPERAND"
    ...
    public mutating func configure(with observer: SDAI.EntityReferenceObserver) {
      ...
      case ._HALF_SPACE_2D(let entity): 
        entity.configure(with: observer)
        self = ._HALF_SPACE_2D(entity)
      case ._HALF_SPACE_SOLID(let entity): 
        entity.configure(with: observer)
        self = ._HALF_SPACE_SOLID(entity)
