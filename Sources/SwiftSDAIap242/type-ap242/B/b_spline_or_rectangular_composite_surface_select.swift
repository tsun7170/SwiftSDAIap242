/* file: b_spline_or_rectangular_composite_surface_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
*/
  public enum sB_SPLINE_OR_RECTANGULAR_COMPOSITE_SURFACE_SELECT : SDAI.Value, 
    TypeHierarchy.sB_SPLINE_OR_RECTANGULAR_COMPOSITE_SURFACE_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eB_SPLINE_SURFACE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sB_SPLINE_OR_RECTANGULAR_COMPOSITE_SURFACE_SELECT``
    @_documentation(visibility:public)
    case _B_SPLINE_SURFACE(eB_SPLINE_SURFACE.PRef)	// (ENTITY)

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRECTANGULAR_COMPOSITE_SURFACE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sB_SPLINE_OR_RECTANGULAR_COMPOSITE_SURFACE_SELECT``
    @_documentation(visibility:public)
...
public protocol sB_SPLINE_OR_RECTANGULAR_COMPOSITE_SURFACE_SELECT__TypeBehavior: SDAI.SelectType {
  ...
  var WEIGHTS_DATA: (SDAI.LIST<SDAI.LIST<SDAI.REAL>/*[2:(nil as SDAI.INTEGER?)]*/ >/*[2:(nil as SDAI.INTEGER?)]*/ )?  { get }
  var CONTROL_POINTS_LIST: (SDAI.LIST<SDAI.LIST<
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eCARTESIAN_POINT.PRef>/*[2:(nil as SDAI.INTEGER?)]*/ >/*[
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sB_SPLINE_OR_RECTANGULAR_COMPOSITE_SURFACE_SELECT__Subtype: 
  sB_SPLINE_OR_RECTANGULAR_COMPOSITE_SURFACE_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sB_SPLINE_OR_RECTANGULAR_COMPOSITE_SURFACE_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sB_SPLINE_OR_RECTANGULAR_COMPOSITE_SURFACE_SELECT__Subtype {
  //MARK: CONSTRUCTORS
  ...
  var WEIGHTS_DATA: (SDAI.LIST<SDAI.LIST<SDAI.REAL>/*[2:(nil as SDAI.INTEGER?)]*/ >/*[2:(nil as SDAI.INTEGER?)]*/ )?  { rep.WEIGHTS_DATA }
  var CONTROL_POINTS_LIST: (SDAI.LIST<SDAI.LIST<
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eCARTESIAN_POINT.PRef>/*[2:(nil as SDAI.INTEGER?)]*/ >/*[
