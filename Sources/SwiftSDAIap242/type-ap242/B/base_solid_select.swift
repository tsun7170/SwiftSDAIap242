/* file: base_solid_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- base_solid_select (line:1136 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sBASE_SOLID_SELECT : SDAI.Value, TypeHierarchy.sBASE_SOLID_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSOLID_MODEL`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sBASE_SOLID_SELECT``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eSOLID_MODEL.self) {self = ._SOLID_MODEL(base.pRef) }
      else if let base = sCSG_PRIMITIVE(possiblyFrom: complex) {
        self = ._CSG_PRIMITIVE(base)
      }
      else if let base = complex.entityReference(eBOOLEAN_RESULT.self) {self = ._BOOLEAN_RESULT(base.pRef) }
      else { return nil }
    }
    ...
    public static let bareTypeName: String = "BASE_SOLID_SELECT"
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.BASE_SOLID_SELECT"
    ...
    public static func WHERE_wr1(SELF: sBASE_SOLID_SELECT?) -> SDAI.LOGICAL {
      ...
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: ePRIMITIVE_2D.self )
...
public protocol sBASE_SOLID_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sBASE_SOLID_SELECT__Subtype: sBASE_SOLID_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sBASE_SOLID_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sBASE_SOLID_SELECT__Subtype {
  //MARK: CONSTRUCTORS
