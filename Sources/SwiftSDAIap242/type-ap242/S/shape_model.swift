/* file: shape_model.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- shape_model (line:5353 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sSHAPE_MODEL : SDAI.Value, TypeHierarchy.sSHAPE_MODEL__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONSTRUCTIVE_GEOMETRY_REPRESENTATION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSHAPE_MODEL``
    ...
    public static let bareTypeName: String = "SHAPE_MODEL"
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.SHAPE_MODEL"
...
public protocol sSHAPE_MODEL__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sSHAPE_MODEL__Subtype: sSHAPE_MODEL__TypeBehavior, SDAI.DefinedType
where Supertype: sSHAPE_MODEL__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sSHAPE_MODEL__Subtype {
  //MARK: CONSTRUCTORS
