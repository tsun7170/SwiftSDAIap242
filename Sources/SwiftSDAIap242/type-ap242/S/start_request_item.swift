/* file: start_request_item.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_TYPE; -- start_request_item (line:5516 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sSTART_REQUEST_ITEM : SDAI.Value, TypeHierarchy.sSTART_REQUEST_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_FORMATION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSTART_REQUEST_ITEM``
    ...
    public static let bareTypeName: String = "START_REQUEST_ITEM"
...
public protocol sSTART_REQUEST_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sSTART_REQUEST_ITEM__Subtype: sSTART_REQUEST_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sSTART_REQUEST_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sSTART_REQUEST_ITEM__Subtype {
  //MARK: CONSTRUCTORS
