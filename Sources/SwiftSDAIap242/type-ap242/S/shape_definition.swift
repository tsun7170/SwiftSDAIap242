/* file: shape_definition.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sSHAPE_DEFINITION : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSHAPE_DEFINITION__type {
    ...
    /// SELECT case ``ePRODUCT_DEFINITION_SHAPE`` (ENTITY) in ``sSHAPE_DEFINITION``
    case _PRODUCT_DEFINITION_SHAPE(ePRODUCT_DEFINITION_SHAPE)	// (ENTITY)

    /// SELECT case ``eSHAPE_ASPECT`` (ENTITY) in ``sSHAPE_DEFINITION``
    case _SHAPE_ASPECT(eSHAPE_ASPECT)	// (ENTITY)

    /// SELECT case ``eSHAPE_ASPECT_RELATIONSHIP`` (ENTITY) in ``sSHAPE_DEFINITION``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(ePRODUCT_DEFINITION_SHAPE.self) {self = ._PRODUCT_DEFINITION_SHAPE(base) }
    ...
    /// attribute of SELECT type ``sSHAPE_DEFINITION``
