/* file: sketch_element_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- sketch_element_select (line:5464 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sSKETCH_ELEMENT_SELECT : SDAI.Value, TypeHierarchy.sSKETCH_ELEMENT_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSKETCH_ELEMENT_SELECT``
    ...
    public static let bareTypeName: String = "SKETCH_ELEMENT_SELECT"
...
public protocol sSKETCH_ELEMENT_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sSKETCH_ELEMENT_SELECT__Subtype: sSKETCH_ELEMENT_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sSKETCH_ELEMENT_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sSKETCH_ELEMENT_SELECT__Subtype {
  //MARK: CONSTRUCTORS
