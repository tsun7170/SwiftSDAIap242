/* file: sketch_element_select.swift 	 generated: Thu Dec 25 18:13:23 2025 */
...
*/
  public enum sSKETCH_ELEMENT_SELECT : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSKETCH_ELEMENT_SELECT__type {
    ...
    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSKETCH_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _CURVE(eCURVE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSKETCH_ELEMENT_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSKETCH_ELEMENT_SELECT``
