/* file: state_type_of_item.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sSTATE_TYPE_OF_ITEM : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSTATE_TYPE_OF_ITEM__type {
    ...
    /// SELECT case ``eACTION_METHOD`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _ACTION_METHOD(eACTION_METHOD)	// (ENTITY)

    /// SELECT case ``eALTERNATE_PRODUCT_RELATIONSHIP`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _ALTERNATE_PRODUCT_RELATIONSHIP(eALTERNATE_PRODUCT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eAPPLIED_ACTION_METHOD_ASSIGNMENT`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _APPLIED_ACTION_METHOD_ASSIGNMENT(eAPPLIED_ACTION_METHOD_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_EXTERNAL_IDENTIFICATION_ASSIGNMENT`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _APPLIED_EXTERNAL_IDENTIFICATION_ASSIGNMENT(
      eAPPLIED_EXTERNAL_IDENTIFICATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPROVAL`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _APPROVAL(eAPPROVAL)	// (ENTITY)

    /// SELECT case ``eASSEMBLY_COMPONENT_USAGE`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _ASSEMBLY_COMPONENT_USAGE(eASSEMBLY_COMPONENT_USAGE)	// (ENTITY)

    /// SELECT case ``eASSEMBLY_COMPONENT_USAGE_SUBSTITUTE`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _ASSEMBLY_COMPONENT_USAGE_SUBSTITUTE(eASSEMBLY_COMPONENT_USAGE_SUBSTITUTE)	// (ENTITY)

    /// SELECT case ``eATTACHMENT_SLOT_DESIGN_TO_PLANNED`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _ATTACHMENT_SLOT_DESIGN_TO_PLANNED(eATTACHMENT_SLOT_DESIGN_TO_PLANNED)	// (ENTITY)

    /// SELECT case ``eATTACHMENT_SLOT_DESIGN_TO_REALIZED`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _ATTACHMENT_SLOT_DESIGN_TO_REALIZED(eATTACHMENT_SLOT_DESIGN_TO_REALIZED)	// (ENTITY)

    /// SELECT case ``eATTACHMENT_SLOT_ON_PRODUCT`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _ATTACHMENT_SLOT_ON_PRODUCT(eATTACHMENT_SLOT_ON_PRODUCT)	// (ENTITY)

    /// SELECT case ``eATTACHMENT_SLOT_PLANNED_TO_REALIZED`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _ATTACHMENT_SLOT_PLANNED_TO_REALIZED(eATTACHMENT_SLOT_PLANNED_TO_REALIZED)	// (ENTITY)

    /// SELECT case ``eBREAKDOWN_ELEMENT_GROUP_ASSIGNMENT`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _BREAKDOWN_ELEMENT_GROUP_ASSIGNMENT(eBREAKDOWN_ELEMENT_GROUP_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eBREAKDOWN_ELEMENT_USAGE`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _BREAKDOWN_ELEMENT_USAGE(eBREAKDOWN_ELEMENT_USAGE)	// (ENTITY)

    /// SELECT case ``eCERTIFICATION`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _CERTIFICATION(eCERTIFICATION)	// (ENTITY)

    /// SELECT case ``eCONFIGURATION_ITEM`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _CONFIGURATION_ITEM(eCONFIGURATION_ITEM)	// (ENTITY)

    /// SELECT case ``eCONTRACT`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _CONTRACT(eCONTRACT)	// (ENTITY)

    /// SELECT case ``eDOCUMENT_FILE`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _DOCUMENT_FILE(eDOCUMENT_FILE)	// (ENTITY)

    /// SELECT case ``eEVIDENCE`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _EVIDENCE(eEVIDENCE)	// (ENTITY)

    /// SELECT case ``eFINAL_SOLUTION`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _FINAL_SOLUTION(eFINAL_SOLUTION)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTION`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _INTERFACE_CONNECTION(eINTERFACE_CONNECTION)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTOR_AS_PLANNED`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _INTERFACE_CONNECTOR_AS_PLANNED(eINTERFACE_CONNECTOR_AS_PLANNED)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTOR_AS_REALIZED`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _INTERFACE_CONNECTOR_AS_REALIZED(eINTERFACE_CONNECTOR_AS_REALIZED)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTOR_DEFINITION`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _INTERFACE_CONNECTOR_DEFINITION(eINTERFACE_CONNECTOR_DEFINITION)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTOR_DESIGN`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _INTERFACE_CONNECTOR_DESIGN(eINTERFACE_CONNECTOR_DESIGN)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTOR_OCCURRENCE`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _INTERFACE_CONNECTOR_OCCURRENCE(eINTERFACE_CONNECTOR_OCCURRENCE)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTOR_VERSION`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _INTERFACE_CONNECTOR_VERSION(eINTERFACE_CONNECTOR_VERSION)	// (ENTITY)

    /// SELECT case ``eINTERFACE_DEFINITION_CONNECTION`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _INTERFACE_DEFINITION_CONNECTION(eINTERFACE_DEFINITION_CONNECTION)	// (ENTITY)

    /// SELECT case ``eINTERFACE_SPECIFICATION_DEFINITION`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _INTERFACE_SPECIFICATION_DEFINITION(eINTERFACE_SPECIFICATION_DEFINITION)	// (ENTITY)

    /// SELECT case ``eINTERFACE_SPECIFICATION_VERSION`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _INTERFACE_SPECIFICATION_VERSION(eINTERFACE_SPECIFICATION_VERSION)	// (ENTITY)

    /// SELECT case ``eORGANIZATION`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _ORGANIZATION(eORGANIZATION)	// (ENTITY)

    /// SELECT case ``eORGANIZATIONAL_PROJECT`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _ORGANIZATIONAL_PROJECT(eORGANIZATIONAL_PROJECT)	// (ENTITY)

    /// SELECT case ``ePERSON_AND_ORGANIZATION`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _PERSON_AND_ORGANIZATION(ePERSON_AND_ORGANIZATION)	// (ENTITY)

    /// SELECT case ``ePRODUCT`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _PRODUCT(ePRODUCT)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CATEGORY`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _PRODUCT_CATEGORY(ePRODUCT_CATEGORY)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _PRODUCT_CONCEPT(ePRODUCT_CONCEPT)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _PRODUCT_DEFINITION(ePRODUCT_DEFINITION)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_FORMATION`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _PRODUCT_DEFINITION_FORMATION(ePRODUCT_DEFINITION_FORMATION)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_GROUP_ASSIGNMENT`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _PRODUCT_DEFINITION_GROUP_ASSIGNMENT(ePRODUCT_DEFINITION_GROUP_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_RELATIONSHIP`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _PRODUCT_DEFINITION_RELATIONSHIP(ePRODUCT_DEFINITION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_GROUP`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _PRODUCT_GROUP(ePRODUCT_GROUP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_IN_ATTACHMENT_SLOT`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _PRODUCT_IN_ATTACHMENT_SLOT(ePRODUCT_IN_ATTACHMENT_SLOT)	// (ENTITY)

    /// SELECT case ``eSECURITY_CLASSIFICATION`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _SECURITY_CLASSIFICATION(eSECURITY_CLASSIFICATION)	// (ENTITY)

    /// SELECT case ``eVALIDATION`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    case _VALIDATION(eVALIDATION)	// (ENTITY)

    /// SELECT case ``eVERIFICATION`` (ENTITY) in ``sSTATE_TYPE_OF_ITEM``
    ...
    /// attribute of SELECT type ``sSTATE_TYPE_OF_ITEM``
