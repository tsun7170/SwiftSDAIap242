/* file: surface_style_element_select.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sSURFACE_STYLE_ELEMENT_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSURFACE_STYLE_ELEMENT_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE_STYLE_BOUNDARY`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_STYLE_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _SURFACE_STYLE_BOUNDARY(eSURFACE_STYLE_BOUNDARY.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE_STYLE_CONTROL_GRID`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_STYLE_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _SURFACE_STYLE_CONTROL_GRID(eSURFACE_STYLE_CONTROL_GRID.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE_STYLE_FILL_AREA`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_STYLE_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _SURFACE_STYLE_FILL_AREA(eSURFACE_STYLE_FILL_AREA.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE_STYLE_PARAMETER_LINE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_STYLE_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _SURFACE_STYLE_PARAMETER_LINE(eSURFACE_STYLE_PARAMETER_LINE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE_STYLE_RENDERING`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_STYLE_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _SURFACE_STYLE_RENDERING(eSURFACE_STYLE_RENDERING.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE_STYLE_SEGMENTATION_CURVE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_STYLE_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _SURFACE_STYLE_SEGMENTATION_CURVE(eSURFACE_STYLE_SEGMENTATION_CURVE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE_STYLE_SILHOUETTE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_STYLE_ELEMENT_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_STYLE_ELEMENT_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSURFACE_STYLE_ELEMENT_SELECT__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSURFACE_STYLE_ELEMENT_SELECT__type, SDAI.DefinedType
