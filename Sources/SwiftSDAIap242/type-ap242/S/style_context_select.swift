/* file: style_context_select.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
  public enum sSTYLE_CONTEXT_SELECT : SDAI.Value, TypeHierarchy.sSTYLE_CONTEXT_SELECT__TypeBehavior {
    ...
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGROUP`` )
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREPRESENTATION`` )
    public var ITEMS: (SDAI.SET<SDAI.GENERIC_ENTITY>/*[0:?]*/ )?  {
      switch self {
...
public protocol sSTYLE_CONTEXT_SELECT__TypeBehavior: SDAI.SelectType {
  ...
  var ITEMS: (SDAI.SET<SDAI.GENERIC_ENTITY>/*[0:?]*/ )?  { get }
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sSTYLE_CONTEXT_SELECT__Subtype {
  ...
  var ITEMS: (SDAI.SET<SDAI.GENERIC_ENTITY>/*[0:?]*/ )?  { rep.ITEMS }
