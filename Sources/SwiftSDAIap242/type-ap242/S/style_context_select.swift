/* file: style_context_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- style_context_select (line:5625 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sSTYLE_CONTEXT_SELECT : SDAI.Value, TypeHierarchy.sSTYLE_CONTEXT_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONTEXT_DEPENDENT_SHAPE_REPRESENTATION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSTYLE_CONTEXT_SELECT``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eCONTEXT_DEPENDENT_SHAPE_REPRESENTATION.self) {self = ._CONTEXT_DEPENDENT_SHAPE_REPRESENTATION(base.pRef) }
    ...
    public static let bareTypeName: String = "STYLE_CONTEXT_SELECT"
    ...
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGROUP`` )
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREPRESENTATION`` )
    public var ITEMS: (SDAI.SET<SDAI.GENERIC_ENTITY>/*[0:(nil as SDAI.INTEGER?)]*/ )?  {
      switch self {
...
public protocol sSTYLE_CONTEXT_SELECT__TypeBehavior: SDAI.SelectType {
  ...
  var ITEMS: (SDAI.SET<SDAI.GENERIC_ENTITY>/*[0:(nil as SDAI.INTEGER?)]*/ )?  { get }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sSTYLE_CONTEXT_SELECT__Subtype: sSTYLE_CONTEXT_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sSTYLE_CONTEXT_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sSTYLE_CONTEXT_SELECT__Subtype {
  //MARK: CONSTRUCTORS
  ...
  var ITEMS: (SDAI.SET<SDAI.GENERIC_ENTITY>/*[0:(nil as SDAI.INTEGER?)]*/ )?  { rep.ITEMS }
