/* file: shape_dimension_representation_item.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
/*
  TYPE shape_dimension_representation_item = SELECT
    ( compound_representation_item (*ENTITY*),
     ...
     placement (*ENTITY*) );
  END_TYPE; -- shape_dimension_representation_item (line:5346 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sSHAPE_DIMENSION_REPRESENTATION_ITEM : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSHAPE_DIMENSION_REPRESENTATION_ITEM__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPOUND_REPRESENTATION_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSHAPE_DIMENSION_REPRESENTATION_ITEM``
    @_documentation(visibility:public)
    case _COMPOUND_REPRESENTATION_ITEM(eCOMPOUND_REPRESENTATION_ITEM.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDESCRIPTIVE_REPRESENTATION_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSHAPE_DIMENSION_REPRESENTATION_ITEM``
    @_documentation(visibility:public)
    case _DESCRIPTIVE_REPRESENTATION_ITEM(eDESCRIPTIVE_REPRESENTATION_ITEM.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMEASURE_REPRESENTATION_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSHAPE_DIMENSION_REPRESENTATION_ITEM``
    @_documentation(visibility:public)
    case _MEASURE_REPRESENTATION_ITEM(eMEASURE_REPRESENTATION_ITEM.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLACEMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSHAPE_DIMENSION_REPRESENTATION_ITEM``
    @_documentation(visibility:public)
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eCOMPOUND_REPRESENTATION_ITEM.self) {self = ._COMPOUND_REPRESENTATION_ITEM(base.pRef) }
    ...
    public static let bareTypeName: String = "SHAPE_DIMENSION_REPRESENTATION_ITEM"
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSHAPE_DIMENSION_REPRESENTATION_ITEM``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSHAPE_DIMENSION_REPRESENTATION_ITEM__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSHAPE_DIMENSION_REPRESENTATION_ITEM__type, SDAI.DefinedType
