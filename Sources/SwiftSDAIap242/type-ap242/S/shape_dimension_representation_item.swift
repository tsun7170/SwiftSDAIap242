/* file: shape_dimension_representation_item.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
```
*/
  public enum sSHAPE_DIMENSION_REPRESENTATION_ITEM : SDAI.Value, TypeHierarchy.sSHAPE_DIMENSION_REPRESENTATION_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPOUND_REPRESENTATION_ITEM`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSHAPE_DIMENSION_REPRESENTATION_ITEM``
...
public protocol sSHAPE_DIMENSION_REPRESENTATION_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sSHAPE_DIMENSION_REPRESENTATION_ITEM__Subtype: 
  sSHAPE_DIMENSION_REPRESENTATION_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sSHAPE_DIMENSION_REPRESENTATION_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sSHAPE_DIMENSION_REPRESENTATION_ITEM__Subtype {
  //MARK: CONSTRUCTORS
