/* file: spatial_rotation.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sSPATIAL_ROTATION : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSPATIAL_ROTATION__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eROTATION_ABOUT_DIRECTION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSPATIAL_ROTATION``
    @_documentation(visibility:public)
    case _ROTATION_ABOUT_DIRECTION(eROTATION_ABOUT_DIRECTION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tYPR_ROTATION`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSPATIAL_ROTATION``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSPATIAL_ROTATION``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSPATIAL_ROTATION__type: SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSPATIAL_ROTATION__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSPATIAL_ROTATION__type, SDAI.DefinedType
