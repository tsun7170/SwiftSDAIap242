/* file: spatial_rotation.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
  public enum sSPATIAL_ROTATION : SDAI.Value, TypeHierarchy.sSPATIAL_ROTATION__TypeBehavior {
    ...
    /// SELECT case (TYPE)
      ...
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSPATIAL_ROTATION``
      /// - may yield: aggregate[``tPLANE_ANGLE_MEASURE``]
    @_documentation(visibility:public)
    ...
    public typealias ELEMENT = tPLANE_ANGLE_MEASURE
    public var hiBound: Int? {
      switch self {
      case ._YPR_ROTATION(let selection): return selection.hiBound
      default: return nil
      }
    }
    public var hiIndex: Int {
      switch self {
      case ._YPR_ROTATION(let selection): return selection.hiIndex
      default: return 0
      }
    }
    public var loBound: Int {
      switch self {
      case ._YPR_ROTATION(let selection): return selection.loBound
      default: return 0
      }
    }
    public var loIndex: Int {
      switch self {
      case ._YPR_ROTATION(let selection): return selection.loIndex
      default: return 0
      }
    }
    public var size: Int {
      switch self {
      case ._YPR_ROTATION(let selection): return selection.size
      default: return 0
      }
    }
    public var isEmpty: Bool {
      switch self {
      case ._YPR_ROTATION(let selection): return selection.isEmpty
      default: return true
      }
    }
    ...
    public subscript(index: Int?) -> ELEMENT? {
      switch self {
      case ._YPR_ROTATION(let selection): return selection[index]
      default: return nil
      }
    }
    ...
    public func makeIterator() -> AnyIterator<ELEMENT?> {
      switch self {
      case ._YPR_ROTATION(let selection): 
    ...
    public func CONTAINS(elem: ELEMENT?) -> SDAI.LOGICAL {
      switch self {
      case ._YPR_ROTATION(let selection): return selection.CONTAINS(elem)
      default: return SDAI.FALSE
      }
    }

    public typealias RESULT_AGGREGATE = SDAI.ARRAY_OPTIONAL<ELEMENT>
...
public protocol sSPATIAL_ROTATION__TypeBehavior: SDAI.SelectType, SDAI.AggregationType
  where ELEMENT == AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tPLANE_ANGLE_MEASURE {
