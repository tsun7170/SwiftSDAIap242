/* file: swept_surface_or_solid.swift 	 generated: Wed Jan 21 18:03:37 2026 */
...
*/
  public enum sSWEPT_SURFACE_OR_SOLID : SDAI.Value, TypeHierarchy.sSWEPT_SURFACE_OR_SOLID__TypeBehavior {
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      switch instance {
      case ._SWEPT_AREA_SOLID(let entity): 
        result = eSWEPT_AREA_SOLID.validateWhereRules(instance: entity.eval, 
        prefix:prefix + "\\SWEPT_AREA_SOLID")
      case ._SWEPT_FACE_SOLID(let entity): 
        result = eSWEPT_FACE_SOLID.validateWhereRules(instance: entity.eval, 
        prefix:prefix + "\\SWEPT_FACE_SOLID")
      case ._SWEPT_SURFACE(let entity): result = eSWEPT_SURFACE.validateWhereRules(instance: entity.eval, 
        prefix:prefix + "\\SWEPT_SURFACE")
      case nil: break
      }
