/* file: swept_surface_or_solid.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- swept_surface_or_solid (line:5700 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sSWEPT_SURFACE_OR_SOLID : SDAI.Value, TypeHierarchy.sSWEPT_SURFACE_OR_SOLID__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSWEPT_AREA_SOLID`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSWEPT_SURFACE_OR_SOLID``
    @_documentation(visibility:public)
    case _SWEPT_AREA_SOLID(eSWEPT_AREA_SOLID.PRef)	// (ENTITY)

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSWEPT_FACE_SOLID`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSWEPT_SURFACE_OR_SOLID``
    @_documentation(visibility:public)
    case _SWEPT_FACE_SOLID(eSWEPT_FACE_SOLID.PRef)	// (ENTITY)
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eSWEPT_AREA_SOLID.self) {self = ._SWEPT_AREA_SOLID(base.pRef) }
      else if let base = complex.entityReference(eSWEPT_FACE_SOLID.self) {self = ._SWEPT_FACE_SOLID(base.pRef) }
    ...
    public init?<G: SDAI.GenericType>(fromGeneric generic: G?) {
      ...
      else if let base = eSWEPT_AREA_SOLID.PRef.convert(fromGeneric: select) {
        self = ._SWEPT_AREA_SOLID(base)
      }
      else if let base = eSWEPT_FACE_SOLID.PRef.convert(fromGeneric: select) {
    ...
    public static let bareTypeName: String = "SWEPT_SURFACE_OR_SOLID"
    ...
    public var super_eSOLID_MODEL: eSOLID_MODEL.PRef {
      switch self {
      case ._SWEPT_AREA_SOLID(let entity): return eSOLID_MODEL.PRef(entity.eval?.super_eSOLID_MODEL)
      case ._SWEPT_FACE_SOLID(let entity): return eSOLID_MODEL.PRef(entity.eval?.super_eSOLID_MODEL)
    ...
    public var super_eREPRESENTATION_ITEM: eREPRESENTATION_ITEM.PRef {
      switch self {
      case ._SWEPT_AREA_SOLID(let entity): return eREPRESENTATION_ITEM.PRef(entity.eval?.super_eREPRESENTATION_ITEM)
      case ._SWEPT_FACE_SOLID(let entity): return eREPRESENTATION_ITEM.PRef(entity.eval?.super_eREPRESENTATION_ITEM)
    ...
    public var super_eGEOMETRIC_REPRESENTATION_ITEM: eGEOMETRIC_REPRESENTATION_ITEM.PRef {
      switch self {
      case ._SWEPT_AREA_SOLID(let entity): return eGEOMETRIC_REPRESENTATION_ITEM.PRef(entity.eval?.super_eGEOMETRIC_REPRESENTATION_ITEM)
      case ._SWEPT_FACE_SOLID(let entity): return eGEOMETRIC_REPRESENTATION_ITEM.PRef(entity.eval?.super_eGEOMETRIC_REPRESENTATION_ITEM)
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSWEPT_SURFACE_OR_SOLID``
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSWEPT_AREA_SOLID`` )
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSWEPT_SURFACE`` )
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSWEPT_SURFACE_OR_SOLID``
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSWEPT_FACE_SOLID`` )
    ...
    public var DIRECTRIX: eCURVE.PRef?  {
      ...
      case ._SWEPT_SURFACE/*(let entity)*/: return nil // AMBIGUOUS ATTRIBUTE for eSWEPT_SURFACE.PRef
      default: return nil
      }
    }
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      switch self {
      case ._SWEPT_AREA_SOLID(let entity): return entity.persistentEntityReferences
      case ._SWEPT_FACE_SOLID(let entity): return entity.persistentEntityReferences
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._SWEPT_AREA_SOLID(let entity): 
        ...
        result = eSWEPT_AREA_SOLID.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._SWEPT_FACE_SOLID(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eSWEPT_FACE_SOLID.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._SWEPT_SURFACE(let entity): 
        if !entity.shouldPropagateValidation { break }
...
public protocol sSWEPT_SURFACE_OR_SOLID__TypeBehavior: SDAI.SelectType {
  ...
  var DIRECTRIX: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eCURVE.PRef?  { get }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sSWEPT_SURFACE_OR_SOLID__Subtype: sSWEPT_SURFACE_OR_SOLID__TypeBehavior, SDAI.DefinedType
where Supertype: sSWEPT_SURFACE_OR_SOLID__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sSWEPT_SURFACE_OR_SOLID__Subtype {
  //MARK: CONSTRUCTORS
  ...
  var DIRECTRIX: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eCURVE.PRef?  { rep.DIRECTRIX }
