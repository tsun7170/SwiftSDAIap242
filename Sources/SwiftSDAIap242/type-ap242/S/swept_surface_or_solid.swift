/* file: swept_surface_or_solid.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sSWEPT_SURFACE_OR_SOLID : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSWEPT_SURFACE_OR_SOLID__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSWEPT_AREA_SOLID`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSWEPT_SURFACE_OR_SOLID``
    @_documentation(visibility:public)
    case _SWEPT_AREA_SOLID(eSWEPT_AREA_SOLID.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSWEPT_FACE_SOLID`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSWEPT_SURFACE_OR_SOLID``
    @_documentation(visibility:public)
    case _SWEPT_FACE_SOLID(eSWEPT_FACE_SOLID.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSWEPT_SURFACE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSWEPT_SURFACE_OR_SOLID``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSWEPT_SURFACE_OR_SOLID``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSWEPT_SURFACE_OR_SOLID__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSWEPT_SURFACE_OR_SOLID__type, SDAI.DefinedType
