/* file: spherical_pair_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- spherical_pair_select (line:5506 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  CASE: spherical_pair_with_pin (*ENTITY*):
  ATTR:  description: text
  ATTR:  r_y: BOOLEAN *** Multiple Select Case Sources ***
  ATTR:  r_x: BOOLEAN *** Multiple Select Case Sources ***
  ATTR:  r_z: BOOLEAN *** Multiple Select Case Sources ***
...
```
*/
  public enum sSPHERICAL_PAIR_SELECT : SDAI.Value, TypeHierarchy.sSPHERICAL_PAIR_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSPHERICAL_PAIR`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSPHERICAL_PAIR_SELECT``
    @_documentation(visibility:public)
    case _SPHERICAL_PAIR(eSPHERICAL_PAIR.PRef)	// (ENTITY)

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSPHERICAL_PAIR_WITH_PIN`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSPHERICAL_PAIR_SELECT``
    @_documentation(visibility:public)
    case _SPHERICAL_PAIR_WITH_PIN(eSPHERICAL_PAIR_WITH_PIN.PRef)	// (ENTITY)
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eSPHERICAL_PAIR.self) {self = ._SPHERICAL_PAIR(base.pRef) }
      else if let base = complex.entityReference(eSPHERICAL_PAIR_WITH_PIN.self) {self = ._SPHERICAL_PAIR_WITH_PIN(base.pRef) }
      else { return nil }
    }
    ...
    public init?<G: SDAI.GenericType>(fromGeneric generic: G?) {
      ...
      else if let base = eSPHERICAL_PAIR.PRef.convert(fromGeneric: select) {
        self = ._SPHERICAL_PAIR(base)
      }
      else if let base = eSPHERICAL_PAIR_WITH_PIN.PRef.convert(fromGeneric: select) {
    ...
    public static let bareTypeName: String = "SPHERICAL_PAIR_SELECT"
    ...
    public var super_eITEM_DEFINED_TRANSFORMATION: eITEM_DEFINED_TRANSFORMATION.PRef {
      switch self {
      case ._SPHERICAL_PAIR(let entity): return eITEM_DEFINED_TRANSFORMATION.PRef(entity.eval?.super_eITEM_DEFINED_TRANSFORMATION)
      case ._SPHERICAL_PAIR_WITH_PIN(let entity): return eITEM_DEFINED_TRANSFORMATION.PRef(entity.eval?.super_eITEM_DEFINED_TRANSFORMATION)
      }
    }
    ...
    public var super_eREPRESENTATION_ITEM: eREPRESENTATION_ITEM.PRef {
      switch self {
      case ._SPHERICAL_PAIR(let entity): return eREPRESENTATION_ITEM.PRef(entity.eval?.super_eREPRESENTATION_ITEM)
      case ._SPHERICAL_PAIR_WITH_PIN(let entity): return eREPRESENTATION_ITEM.PRef(entity.eval?.super_eREPRESENTATION_ITEM)
      }
    }
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSPHERICAL_PAIR_SELECT``
    public var super_eSPHERICAL_PAIR: eSPHERICAL_PAIR.PRef {
      switch self {
      case ._SPHERICAL_PAIR(let entity): return entity
      default: return eSPHERICAL_PAIR.PRef(nil)
      }
    }
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSPHERICAL_PAIR_SELECT``
    public var super_eKINEMATIC_PAIR: eKINEMATIC_PAIR.PRef {
      switch self {
      case ._SPHERICAL_PAIR(let entity): return eKINEMATIC_PAIR.PRef(entity.eval?.super_eKINEMATIC_PAIR)
      case ._SPHERICAL_PAIR_WITH_PIN(let entity): return eKINEMATIC_PAIR.PRef(entity.eval?.super_eKINEMATIC_PAIR)
      }
    }
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSPHERICAL_PAIR_SELECT``
    public var super_eLOW_ORDER_KINEMATIC_PAIR: eLOW_ORDER_KINEMATIC_PAIR.PRef {
      switch self {
      case ._SPHERICAL_PAIR(let entity): return eLOW_ORDER_KINEMATIC_PAIR.PRef(entity.eval?.super_eLOW_ORDER_KINEMATIC_PAIR)
      case ._SPHERICAL_PAIR_WITH_PIN(let entity): return eLOW_ORDER_KINEMATIC_PAIR.PRef(entity.eval?.super_eLOW_ORDER_KINEMATIC_PAIR)
      }
    }
    ...
    public var super_eGEOMETRIC_REPRESENTATION_ITEM: eGEOMETRIC_REPRESENTATION_ITEM.PRef {
      switch self {
      case ._SPHERICAL_PAIR(let entity): return eGEOMETRIC_REPRESENTATION_ITEM.PRef(entity.eval?.super_eGEOMETRIC_REPRESENTATION_ITEM)
      case ._SPHERICAL_PAIR_WITH_PIN(let entity): return eGEOMETRIC_REPRESENTATION_ITEM.PRef(entity.eval?.super_eGEOMETRIC_REPRESENTATION_ITEM)
      }
    }
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSPHERICAL_PAIR_SELECT``
    public var super_eSPHERICAL_PAIR_WITH_PIN: eSPHERICAL_PAIR_WITH_PIN.PRef {
      switch self {
      case ._SPHERICAL_PAIR_WITH_PIN(let entity): return entity
      default: return eSPHERICAL_PAIR_WITH_PIN.PRef(nil)
      }
    }
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSPHERICAL_PAIR_SELECT``
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSPHERICAL_PAIR`` )
    ...
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSPHERICAL_PAIR_SELECT``
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSPHERICAL_PAIR`` )
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSPHERICAL_PAIR_WITH_PIN`` )
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      switch self {
      case ._SPHERICAL_PAIR(let entity): return entity.persistentEntityReferences
      case ._SPHERICAL_PAIR_WITH_PIN(let entity): return entity.persistentEntityReferences
      }
    }
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._SPHERICAL_PAIR(let entity): 
        ...
        result = eSPHERICAL_PAIR.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._SPHERICAL_PAIR_WITH_PIN(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eSPHERICAL_PAIR_WITH_PIN.validateWhereRules(instance: entity.eval, 
...
public protocol sSPHERICAL_PAIR_SELECT__TypeBehavior: SDAI.SelectType {
  ...
  var super_eSPHERICAL_PAIR: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eSPHERICAL_PAIR.PRef { get }
  var super_eKINEMATIC_PAIR: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eKINEMATIC_PAIR.PRef { get }
  var super_eLOW_ORDER_KINEMATIC_PAIR: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eLOW_ORDER_KINEMATIC_PAIR.PRef { get }
  ...
  var super_eSPHERICAL_PAIR_WITH_PIN: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eSPHERICAL_PAIR_WITH_PIN.PRef { get }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sSPHERICAL_PAIR_SELECT__Subtype: sSPHERICAL_PAIR_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sSPHERICAL_PAIR_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sSPHERICAL_PAIR_SELECT__Subtype {
  //MARK: CONSTRUCTORS
  ...
  var super_eSPHERICAL_PAIR: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eSPHERICAL_PAIR.PRef { rep.super_eSPHERICAL_PAIR }
  var super_eKINEMATIC_PAIR: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eKINEMATIC_PAIR.PRef { rep.super_eKINEMATIC_PAIR }
  var super_eLOW_ORDER_KINEMATIC_PAIR: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eLOW_ORDER_KINEMATIC_PAIR.PRef { rep.super_eLOW_ORDER_KINEMATIC_PAIR }
  ...
  var super_eSPHERICAL_PAIR_WITH_PIN: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eSPHERICAL_PAIR_WITH_PIN.PRef { rep.super_eSPHERICAL_PAIR_WITH_PIN }
