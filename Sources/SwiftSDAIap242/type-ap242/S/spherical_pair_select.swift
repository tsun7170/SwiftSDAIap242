/* file: spherical_pair_select.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sSPHERICAL_PAIR_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSPHERICAL_PAIR_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSPHERICAL_PAIR`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSPHERICAL_PAIR_SELECT``
    @_documentation(visibility:public)
    case _SPHERICAL_PAIR(eSPHERICAL_PAIR.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSPHERICAL_PAIR_WITH_PIN`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSPHERICAL_PAIR_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSPHERICAL_PAIR_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSPHERICAL_PAIR_SELECT__type: 
  SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSPHERICAL_PAIR_SELECT__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSPHERICAL_PAIR_SELECT__type, SDAI.DefinedType
