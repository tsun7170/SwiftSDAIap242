/* file: shape_aspect_or_characterized_object.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  TYPE shape_aspect_or_characterized_object = SELECT
    ( characterized_object (*ENTITY*),
     shape_aspect (*ENTITY*) );
  END_TYPE; -- shape_aspect_or_characterized_object (line:5325 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sSHAPE_ASPECT_OR_CHARACTERIZED_OBJECT : SDAI.Value, TypeHierarchy.sSHAPE_ASPECT_OR_CHARACTERIZED_OBJECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCHARACTERIZED_OBJECT`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSHAPE_ASPECT_OR_CHARACTERIZED_OBJECT``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eCHARACTERIZED_OBJECT.self) {self = ._CHARACTERIZED_OBJECT(base.pRef) }
    ...
    public static let bareTypeName: String = "SHAPE_ASPECT_OR_CHARACTERIZED_OBJECT"
...
public protocol sSHAPE_ASPECT_OR_CHARACTERIZED_OBJECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sSHAPE_ASPECT_OR_CHARACTERIZED_OBJECT__Subtype: 
  sSHAPE_ASPECT_OR_CHARACTERIZED_OBJECT__TypeBehavior, SDAI.DefinedType
where Supertype: sSHAPE_ASPECT_OR_CHARACTERIZED_OBJECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sSHAPE_ASPECT_OR_CHARACTERIZED_OBJECT__Subtype {
  //MARK: CONSTRUCTORS
