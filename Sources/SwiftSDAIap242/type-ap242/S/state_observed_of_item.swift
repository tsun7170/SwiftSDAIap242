/* file: state_observed_of_item.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sSTATE_OBSERVED_OF_ITEM : SDAI.Value, TypeHierarchy.sSTATE_OBSERVED_OF_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eALTERNATE_PRODUCT_RELATIONSHIP`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSTATE_OBSERVED_OF_ITEM``
...
public protocol sSTATE_OBSERVED_OF_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sSTATE_OBSERVED_OF_ITEM__Subtype: sSTATE_OBSERVED_OF_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sSTATE_OBSERVED_OF_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sSTATE_OBSERVED_OF_ITEM__Subtype {
  //MARK: CONSTRUCTORS
