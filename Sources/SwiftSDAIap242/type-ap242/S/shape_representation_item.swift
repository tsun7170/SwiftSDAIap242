/* file: shape_representation_item.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sSHAPE_REPRESENTATION_ITEM : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSHAPE_REPRESENTATION_ITEM__type {
    ...
    /// SELECT case ``eGEOMETRIC_REPRESENTATION_ITEM`` (ENTITY) in ``sSHAPE_REPRESENTATION_ITEM``
    case _GEOMETRIC_REPRESENTATION_ITEM(eGEOMETRIC_REPRESENTATION_ITEM)	// (ENTITY)

    /// SELECT case ``eTOPOLOGICAL_REPRESENTATION_ITEM`` (ENTITY) in ``sSHAPE_REPRESENTATION_ITEM``
    ...
    /// attribute of SELECT type ``sSHAPE_REPRESENTATION_ITEM``
