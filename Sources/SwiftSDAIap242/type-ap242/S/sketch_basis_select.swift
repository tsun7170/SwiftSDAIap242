/* file: sketch_basis_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sSKETCH_BASIS_SELECT : SDAI.Value, TypeHierarchy.sSKETCH_BASIS_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_BOUNDED_SURFACE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSKETCH_BASIS_SELECT``
    ...
    /// SELECT case (SELECT)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPLANAR_CURVE_SELECT`` (SELECT)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSKETCH_BASIS_SELECT``
    @_documentation(visibility:public)
...
public protocol sSKETCH_BASIS_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sSKETCH_BASIS_SELECT__Subtype: sSKETCH_BASIS_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sSKETCH_BASIS_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sSKETCH_BASIS_SELECT__Subtype {
  //MARK: CONSTRUCTORS
