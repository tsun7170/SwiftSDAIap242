/* file: shape_representation_with_parameters_items.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
```
*/
  public enum sSHAPE_REPRESENTATION_WITH_PARAMETERS_ITEMS : SDAI.Value, TypeHierarchy.sSHAPE_REPRESENTATION_WITH_PARAMETERS_ITEMS__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDESCRIPTIVE_REPRESENTATION_ITEM`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSHAPE_REPRESENTATION_WITH_PARAMETERS_ITEMS``
...
public protocol sSHAPE_REPRESENTATION_WITH_PARAMETERS_ITEMS__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sSHAPE_REPRESENTATION_WITH_PARAMETERS_ITEMS__Subtype: 
  sSHAPE_REPRESENTATION_WITH_PARAMETERS_ITEMS__TypeBehavior, SDAI.DefinedType
where Supertype: sSHAPE_REPRESENTATION_WITH_PARAMETERS_ITEMS__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sSHAPE_REPRESENTATION_WITH_PARAMETERS_ITEMS__Subtype {
  //MARK: CONSTRUCTORS
