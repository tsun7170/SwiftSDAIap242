/* file: sketch_type_select.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sSKETCH_TYPE_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSKETCH_TYPE_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNEUTRAL_SKETCH_REPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSKETCH_TYPE_SELECT``
    @_documentation(visibility:public)
    case _NEUTRAL_SKETCH_REPRESENTATION(eNEUTRAL_SKETCH_REPRESENTATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOSITIONED_SKETCH`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSKETCH_TYPE_SELECT``
    @_documentation(visibility:public)
    case _POSITIONED_SKETCH(ePOSITIONED_SKETCH.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSUBSKETCH`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSKETCH_TYPE_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSKETCH_TYPE_SELECT``
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      case ._POSITIONED_SKETCH(let entity): 
        result = ePOSITIONED_SKETCH.validateWhereRules(instance: entity.eval, 
        prefix:prefix + "\\POSITIONED_SKETCH")
      case ._SUBSKETCH(let entity): result = eSUBSKETCH.validateWhereRules(instance: entity.eval, 
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSKETCH_TYPE_SELECT__type: SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSKETCH_TYPE_SELECT__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSKETCH_TYPE_SELECT__type, SDAI.DefinedType
