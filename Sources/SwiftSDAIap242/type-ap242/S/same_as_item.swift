/* file: same_as_item.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sSAME_AS_ITEM : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSAME_AS_ITEM__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eADDRESS`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _ADDRESS(eADDRESS.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPLIED_EXTERNAL_IDENTIFICATION_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _APPLIED_EXTERNAL_IDENTIFICATION_ASSIGNMENT(
      eAPPLIED_EXTERNAL_IDENTIFICATION_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPROVAL`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _APPROVAL(eAPPROVAL.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAPPROVAL_STATUS`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _APPROVAL_STATUS(eAPPROVAL_STATUS.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eATTRIBUTE_LANGUAGE_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _ATTRIBUTE_LANGUAGE_ASSIGNMENT(eATTRIBUTE_LANGUAGE_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCALENDAR_DATE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _CALENDAR_DATE(eCALENDAR_DATE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCERTIFICATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _CERTIFICATION(eCERTIFICATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONTRACT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _CONTRACT(eCONTRACT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOORDINATED_UNIVERSAL_TIME_OFFSET`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _COORDINATED_UNIVERSAL_TIME_OFFSET(eCOORDINATED_UNIVERSAL_TIME_OFFSET.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATE_AND_TIME`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _DATE_AND_TIME(eDATE_AND_TIME.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDERIVED_UNIT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _DERIVED_UNIT(eDERIVED_UNIT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDERIVED_UNIT_ELEMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _DERIVED_UNIT_ELEMENT(eDERIVED_UNIT_ELEMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEVENT_OCCURRENCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _EVENT_OCCURRENCE(eEVENT_OCCURRENCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTERNAL_SOURCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _EXTERNAL_SOURCE(eEXTERNAL_SOURCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGENERAL_PROPERTY`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _GENERAL_PROPERTY(eGENERAL_PROPERTY.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINFORMATION_RIGHT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _INFORMATION_RIGHT(eINFORMATION_RIGHT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eINFORMATION_USAGE_RIGHT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _INFORMATION_USAGE_RIGHT(eINFORMATION_USAGE_RIGHT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLANGUAGE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _LANGUAGE(eLANGUAGE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLOCAL_TIME`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _LOCAL_TIME(eLOCAL_TIME.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMEASURE_WITH_UNIT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _MEASURE_WITH_UNIT(eMEASURE_WITH_UNIT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNAMED_UNIT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _NAMED_UNIT(eNAMED_UNIT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eORGANIZATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _ORGANIZATION(eORGANIZATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePERSON`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _PERSON(ePERSON.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_CONTEXT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION_CONTEXT(ePRODUCT_DEFINITION_CONTEXT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREPRESENTATION_CONTEXT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _REPRESENTATION_CONTEXT(eREPRESENTATION_CONTEXT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREQUIREMENT_SOURCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _REQUIREMENT_SOURCE(eREQUIREMENT_SOURCE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSECURITY_CLASSIFICATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _SECURITY_CLASSIFICATION(eSECURITY_CLASSIFICATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTIME_INTERVAL`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    case _TIME_INTERVAL(eTIME_INTERVAL.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eUSAGE_ASSOCIATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSAME_AS_ITEM``
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      case ._CALENDAR_DATE(let entity): result = eCALENDAR_DATE.validateWhereRules(instance: entity.eval, 
        prefix:prefix + "\\CALENDAR_DATE")
      ...
      case ._LOCAL_TIME(let entity): result = eLOCAL_TIME.validateWhereRules(instance: entity.eval, 
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSAME_AS_ITEM__type: SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSAME_AS_ITEM__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSAME_AS_ITEM__type, SDAI.DefinedType
