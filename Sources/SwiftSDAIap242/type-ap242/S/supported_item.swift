/* file: supported_item.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- supported_item (line:5656 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sSUPPORTED_ITEM : SDAI.Value, TypeHierarchy.sSUPPORTED_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSUPPORTED_ITEM``
    ...
    public static let bareTypeName: String = "SUPPORTED_ITEM"
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.SUPPORTED_ITEM"
...
public protocol sSUPPORTED_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sSUPPORTED_ITEM__Subtype: sSUPPORTED_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sSUPPORTED_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sSUPPORTED_ITEM__Subtype {
  //MARK: CONSTRUCTORS
