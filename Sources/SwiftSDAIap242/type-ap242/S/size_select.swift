/* file: size_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sSIZE_SELECT : SDAI.Value, TypeHierarchy.sSIZE_SELECT__TypeBehavior {

    /// SELECT case (TYPE)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tDESCRIPTIVE_MEASURE`` (TYPE)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSIZE_SELECT``
...
public protocol sSIZE_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sSIZE_SELECT__Subtype: sSIZE_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sSIZE_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sSIZE_SELECT__Subtype {
  //MARK: CONSTRUCTORS
