/* file: specified_item.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- specified_item (line:5502 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sSPECIFIED_ITEM : SDAI.Value, TypeHierarchy.sSPECIFIED_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDRAWING_REVISION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSPECIFIED_ITEM``
    ...
    public static let bareTypeName: String = "SPECIFIED_ITEM"
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.SPECIFIED_ITEM"
...
public protocol sSPECIFIED_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sSPECIFIED_ITEM__Subtype: sSPECIFIED_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sSPECIFIED_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sSPECIFIED_ITEM__Subtype {
  //MARK: CONSTRUCTORS
