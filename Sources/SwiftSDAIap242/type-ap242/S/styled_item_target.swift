/* file: styled_item_target.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sSTYLED_ITEM_TARGET : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSTYLED_ITEM_TARGET__type {
    ...
    /// SELECT case ``eGEOMETRIC_REPRESENTATION_ITEM`` (ENTITY) in ``sSTYLED_ITEM_TARGET``
    case _GEOMETRIC_REPRESENTATION_ITEM(eGEOMETRIC_REPRESENTATION_ITEM)	// (ENTITY)

    /// SELECT case ``eMAPPED_ITEM`` (ENTITY) in ``sSTYLED_ITEM_TARGET``
    case _MAPPED_ITEM(eMAPPED_ITEM)	// (ENTITY)

    /// SELECT case ``sREPRESENTATION_OR_REPRESENTATION_REFERENCE`` (SELECT) in ``sSTYLED_ITEM_TARGET``
    case _REPRESENTATION_OR_REPRESENTATION_REFERENCE(
      sREPRESENTATION_OR_REPRESENTATION_REFERENCE)	// (SELECT)

    /// SELECT case ``eTOPOLOGICAL_REPRESENTATION_ITEM`` (ENTITY) in ``sSTYLED_ITEM_TARGET``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eGEOMETRIC_REPRESENTATION_ITEM.self) {self = ._GEOMETRIC_REPRESENTATION_ITEM(base) }
    ...
    /// attribute of SELECT type ``sSTYLED_ITEM_TARGET``
    ...
    /// attribute of SELECT type ``sSTYLED_ITEM_TARGET``
    /// - origin: SELECT( ``sREPRESENTATION_OR_REPRESENTATION_REFERENCE`` )
    ...
    public var CONTEXT_OF_ITEMS: eREPRESENTATION_CONTEXT?  {
      switch self {
      case ._REPRESENTATION_OR_REPRESENTATION_REFERENCE(let select): return eREPRESENTATION_CONTEXT(
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSTYLED_ITEM_TARGET__type: SDAISelectType {
  ...
  var ITEM: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eGEOMETRIC_SET?  { get }
  ...
  var CONSTRAINED_ELEMENTS: (SDAI.SET<
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eGEOMETRIC_REPRESENTATION_ITEM>/*[1:nil]*/ )?  { get }
  ...
  var REFERENCE_ELEMENTS: (SDAI.SET<
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eGEOMETRIC_REPRESENTATION_ITEM>/*[0:nil]*/ )?  { get }
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSTYLED_ITEM_TARGET__subtype {
  ...
  var ITEM: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eGEOMETRIC_SET?  { rep.ITEM }
  ...
  var CONSTRAINED_ELEMENTS: (SDAI.SET<
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eGEOMETRIC_REPRESENTATION_ITEM>/*[1:nil]*/ )?  { rep.CONSTRAINED_ELEMENTS }
  ...
  var REFERENCE_ELEMENTS: (SDAI.SET<
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eGEOMETRIC_REPRESENTATION_ITEM>/*[0:nil]*/ )?  { rep.REFERENCE_ELEMENTS }
