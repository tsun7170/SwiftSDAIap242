/* file: surface_or_solid_model.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- surface_or_solid_model (line:5674 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sSURFACE_OR_SOLID_MODEL : SDAI.Value, TypeHierarchy.sSURFACE_OR_SOLID_MODEL__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSOLID_MODEL`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_OR_SOLID_MODEL``
    @_documentation(visibility:public)
    case _SOLID_MODEL(eSOLID_MODEL.PRef)	// (ENTITY)

    /// SELECT case (SELECT)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_MODEL`` (SELECT)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_OR_SOLID_MODEL``
    @_documentation(visibility:public)
    ...
    public static let bareTypeName: String = "SURFACE_OR_SOLID_MODEL"
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_OR_SOLID_MODEL``
    /// - origin: SELECT( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_MODEL`` )
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      ...
      case ._SURFACE_MODEL(let select): return select.persistentEntityReferences
      }
    }
    ...
    public func isHolding(entityReference: SDAI.EntityReference) -> Bool {
      ...
      case ._SURFACE_MODEL(let select): 
...
public protocol sSURFACE_OR_SOLID_MODEL__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sSURFACE_OR_SOLID_MODEL__Subtype: sSURFACE_OR_SOLID_MODEL__TypeBehavior, SDAI.DefinedType
where Supertype: sSURFACE_OR_SOLID_MODEL__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sSURFACE_OR_SOLID_MODEL__Subtype {
  //MARK: CONSTRUCTORS
