/* file: surface_or_solid_model.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sSURFACE_OR_SOLID_MODEL : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSURFACE_OR_SOLID_MODEL__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSOLID_MODEL`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_OR_SOLID_MODEL``
    @_documentation(visibility:public)
    case _SOLID_MODEL(eSOLID_MODEL.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_MODEL`` (SELECT) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_OR_SOLID_MODEL``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sSURFACE_OR_SOLID_MODEL``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSURFACE_OR_SOLID_MODEL__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sSURFACE_OR_SOLID_MODEL__type, SDAI.DefinedType
