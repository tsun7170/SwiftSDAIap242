/* file: link_or_shape_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sLINK_OR_SHAPE_REPRESENTATION : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sLINK_OR_SHAPE_REPRESENTATION__type {
    ...
    /// SELECT case ``eKINEMATIC_LINK_REPRESENTATION`` (ENTITY) in ``sLINK_OR_SHAPE_REPRESENTATION``
    case _KINEMATIC_LINK_REPRESENTATION(eKINEMATIC_LINK_REPRESENTATION)	// (ENTITY)

    /// SELECT case ``eSHAPE_REPRESENTATION`` (ENTITY) in ``sLINK_OR_SHAPE_REPRESENTATION``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eKINEMATIC_LINK_REPRESENTATION.self) {self = ._KINEMATIC_LINK_REPRESENTATION(base) }
    ...
    public init?<G: SDAIGenericType>(fromGeneric generic: G?) {
      ...
      else if let base = eKINEMATIC_LINK_REPRESENTATION.convert(fromGeneric: select) {
    ...
    public var super_eREPRESENTATION: eREPRESENTATION? {
      switch self {
      case ._KINEMATIC_LINK_REPRESENTATION(let entity): return entity.super_eREPRESENTATION
    ...
    public var super_eKINEMATIC_LINK_REPRESENTATION: eKINEMATIC_LINK_REPRESENTATION? {
      switch self {
    ...
    /// attribute of SELECT type ``sLINK_OR_SHAPE_REPRESENTATION``
    /// - origin: ENTITY( ``eKINEMATIC_LINK_REPRESENTATION`` )
    ...
    public var ITEMS: (SDAI.SET<eREPRESENTATION_ITEM>/*[1:nil]*/ )?  {
      switch self {
      case ._KINEMATIC_LINK_REPRESENTATION(let entity): return SDAI.SET<eREPRESENTATION_ITEM>(entity.ITEMS)
    ...
    public var CONTEXT_OF_ITEMS: eREPRESENTATION_CONTEXT?  {
      switch self {
      case ._KINEMATIC_LINK_REPRESENTATION(let entity): return eREPRESENTATION_CONTEXT(
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      switch instance {
      case ._KINEMATIC_LINK_REPRESENTATION(let selectValue): 
        result = eKINEMATIC_LINK_REPRESENTATION.validateWhereRules(instance:selectValue, 
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sLINK_OR_SHAPE_REPRESENTATION__type: 
  ...
  var super_eKINEMATIC_LINK_REPRESENTATION: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eKINEMATIC_LINK_REPRESENTATION? { get }
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sLINK_OR_SHAPE_REPRESENTATION__subtype {
  ...
  var super_eKINEMATIC_LINK_REPRESENTATION: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eKINEMATIC_LINK_REPRESENTATION? { rep.super_eKINEMATIC_LINK_REPRESENTATION }
