/* file: layered_item.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sLAYERED_ITEM : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sLAYERED_ITEM__type {
    ...
    /// SELECT case ``ePRESENTATION_REPRESENTATION`` (ENTITY) in ``sLAYERED_ITEM``
    case _PRESENTATION_REPRESENTATION(ePRESENTATION_REPRESENTATION)	// (ENTITY)

    /// SELECT case ``eREPRESENTATION_ITEM`` (ENTITY) in ``sLAYERED_ITEM``
    ...
    /// attribute of SELECT type ``sLAYERED_ITEM``
