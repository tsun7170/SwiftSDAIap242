/* file: lower_upper.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
```
*/
  public enum nLOWER_UPPER : SDAI.ENUMERATION, SDAI.Value, TypeHierarchy.nLOWER_UPPER__TypeBehavior {
    /// ENUMERATION case
    ///
    /// - defined in: ``nLOWER_UPPER``
    case LOWER
    /// ENUMERATION case
    ///
    /// - defined in: ``nLOWER_UPPER``
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nLOWER_UPPER__TypeBehavior: SDAI.EnumerationType {}
}

extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nLOWER_UPPER__Subtype: nLOWER_UPPER__TypeBehavior, SDAI.DefinedType
where Supertype: nLOWER_UPPER__TypeBehavior
{}
}
