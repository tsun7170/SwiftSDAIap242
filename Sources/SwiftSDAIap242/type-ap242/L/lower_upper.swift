/* file: lower_upper.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
/*
  TYPE lower_upper = ENUMERATION OF
    ( lower,
     upper );
  END_TYPE; -- lower_upper (line:4041 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum nLOWER_UPPER : SDAI.ENUMERATION, SDAI.Value, 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__nLOWER_UPPER__type {
    /// ENUMERATION case in ``nLOWER_UPPER``
    case LOWER
    /// ENUMERATION case in ``nLOWER_UPPER``
    case UPPER
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.LOWER_UPPER"
    ...
    public static let bareTypeName: String = "LOWER_UPPER"
  ...
  /// promoted ENUMERATION case in ``nLOWER_UPPER``
  public static let LOWER = nLOWER_UPPER.LOWER
  /// promoted ENUMERATION case in ``nLOWER_UPPER``
  public static let UPPER = nLOWER_UPPER.UPPER
}


//MARK: - ENUMERATION TYPE HIERARCHY
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__nLOWER_UPPER__type: SDAI.EnumerationType 
  {}

public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__nLOWER_UPPER__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__nLOWER_UPPER__type, SDAI.DefinedType
where Supertype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__nLOWER_UPPER__type
{}
