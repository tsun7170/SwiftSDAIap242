/* file: limit_condition.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_TYPE; -- limit_condition (line:3954 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum nLIMIT_CONDITION : SDAI.ENUMERATION, SDAI.Value, 
    TypeHierarchy.nLIMIT_CONDITION__TypeBehavior {
    /// ENUMERATION case
    ///
    /// - defined in: ``nLIMIT_CONDITION``
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.LIMIT_CONDITION"
    ...
    public static let bareTypeName: String = "LIMIT_CONDITION"
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nLIMIT_CONDITION__TypeBehavior: SDAI.EnumerationType {}
}

extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nLIMIT_CONDITION__Subtype: nLIMIT_CONDITION__TypeBehavior, SDAI.DefinedType
where Supertype: nLIMIT_CONDITION__TypeBehavior
{}
}
