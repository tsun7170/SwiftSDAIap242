/* file: length_or_plane_angle_measure_with_unit_select.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
*/
  public enum sLENGTH_OR_PLANE_ANGLE_MEASURE_WITH_UNIT_SELECT : SDAI.Value, 
    ...
    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLENGTH_MEASURE_WITH_UNIT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sLENGTH_OR_PLANE_ANGLE_MEASURE_WITH_UNIT_SELECT``
    @_documentation(visibility:public)
    case _LENGTH_MEASURE_WITH_UNIT(eLENGTH_MEASURE_WITH_UNIT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLANE_ANGLE_MEASURE_WITH_UNIT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sLENGTH_OR_PLANE_ANGLE_MEASURE_WITH_UNIT_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sLENGTH_OR_PLANE_ANGLE_MEASURE_WITH_UNIT_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sLENGTH_OR_PLANE_ANGLE_MEASURE_WITH_UNIT_SELECT__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sLENGTH_OR_PLANE_ANGLE_MEASURE_WITH_UNIT_SELECT__type, SDAI.DefinedType
