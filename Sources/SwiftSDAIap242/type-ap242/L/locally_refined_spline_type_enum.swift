/* file: locally_refined_spline_type_enum.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  TYPE locally_refined_spline_type_enum = ENUMERATION OF
    ( analysis_suitable_t_spline,
     ...
     standard_t_spline );
  END_TYPE; -- locally_refined_spline_type_enum (line:3987 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum nLOCALLY_REFINED_SPLINE_TYPE_ENUM : SDAI.ENUMERATION, SDAI.Value, 
    TypeHierarchy.nLOCALLY_REFINED_SPLINE_TYPE_ENUM__TypeBehavior {
    /// ENUMERATION case
    ///
    /// - defined in: ``nLOCALLY_REFINED_SPLINE_TYPE_ENUM``
    ...
    public static let bareTypeName: String = "LOCALLY_REFINED_SPLINE_TYPE_ENUM"
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nLOCALLY_REFINED_SPLINE_TYPE_ENUM__TypeBehavior: SDAI.EnumerationType {}
}

extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nLOCALLY_REFINED_SPLINE_TYPE_ENUM__Subtype: 
  nLOCALLY_REFINED_SPLINE_TYPE_ENUM__TypeBehavior, SDAI.DefinedType
where Supertype: nLOCALLY_REFINED_SPLINE_TYPE_ENUM__TypeBehavior
{}
}
