/* file: location_item.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sLOCATION_ITEM : SDAI.Value, TypeHierarchy.sLOCATION_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eASSEMBLY_COMPONENT_USAGE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sLOCATION_ITEM``
    ...
    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eORGANIZATION_TYPE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sLOCATION_ITEM``
    @_documentation(visibility:public)
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._ORGANIZATION_TYPE(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eORGANIZATION_TYPE.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._PERSON(let entity): 
        if !entity.shouldPropagateValidation { break }
...
public protocol sLOCATION_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sLOCATION_ITEM__Subtype: sLOCATION_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sLOCATION_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sLOCATION_ITEM__Subtype {
  //MARK: CONSTRUCTORS
