/* file: linear_geometry_constraint_element.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
```
*/
  public enum sLINEAR_GEOMETRY_CONSTRAINT_ELEMENT : SDAI.Value, TypeHierarchy.sLINEAR_GEOMETRY_CONSTRAINT_ELEMENT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIRECTION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sLINEAR_GEOMETRY_CONSTRAINT_ELEMENT``
...
public protocol sLINEAR_GEOMETRY_CONSTRAINT_ELEMENT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sLINEAR_GEOMETRY_CONSTRAINT_ELEMENT__Subtype: 
  sLINEAR_GEOMETRY_CONSTRAINT_ELEMENT__TypeBehavior, SDAI.DefinedType
where Supertype: sLINEAR_GEOMETRY_CONSTRAINT_ELEMENT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sLINEAR_GEOMETRY_CONSTRAINT_ELEMENT__Subtype {
  //MARK: CONSTRUCTORS
