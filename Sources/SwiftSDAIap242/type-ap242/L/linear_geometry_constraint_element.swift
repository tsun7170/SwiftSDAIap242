/* file: linear_geometry_constraint_element.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  TYPE linear_geometry_constraint_element = SELECT
    ( direction (*ENTITY*),
     ...
     plane (*ENTITY*),
     vector (*ENTITY*) );
  END_TYPE; -- linear_geometry_constraint_element (line:3965 file:ap242ed2_mim_lf_v1.101.TY.exp)
