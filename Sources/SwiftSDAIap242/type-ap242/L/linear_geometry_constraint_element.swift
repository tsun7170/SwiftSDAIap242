/* file: linear_geometry_constraint_element.swift 	 generated: Mon Jan  3 16:32:52 2022 */
...
/*
  TYPE linear_geometry_constraint_element = SELECT
    ( direction (*ENTITY*),
     ...
     plane (*ENTITY*),
     vector (*ENTITY*) );
  END_TYPE; -- linear_geometry_constraint_element (line:3966 file:ap242ed2_mim_lf_v1.101.TY.exp)
