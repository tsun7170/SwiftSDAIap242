/* file: unit.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
/*
  TYPE unit = SELECT
    ( derived_unit (*ENTITY*),
     named_unit (*ENTITY*) );
  END_TYPE; -- unit (line:5930 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sUNIT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sUNIT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDERIVED_UNIT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sUNIT``
    @_documentation(visibility:public)
    case _DERIVED_UNIT(eDERIVED_UNIT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNAMED_UNIT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sUNIT``
    @_documentation(visibility:public)
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eDERIVED_UNIT.self) {self = ._DERIVED_UNIT(base.pRef) }
    ...
    public static let bareTypeName: String = "UNIT"
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sUNIT``
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.UNIT"
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sUNIT__type: SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sUNIT__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sUNIT__type, SDAI.DefinedType
