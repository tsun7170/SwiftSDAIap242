/* file: unit.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
```
*/
  public enum sUNIT : SDAI.Value, TypeHierarchy.sUNIT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDERIVED_UNIT`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sUNIT``
...
public protocol sUNIT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sUNIT__Subtype: sUNIT__TypeBehavior, SDAI.DefinedType
where Supertype: sUNIT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sUNIT__Subtype {
  //MARK: CONSTRUCTORS
