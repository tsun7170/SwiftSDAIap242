/* file: used_equivalence_representation_select.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sUSED_EQUIVALENCE_REPRESENTATION_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sUSED_EQUIVALENCE_REPRESENTATION_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sUSED_EQUIVALENCE_REPRESENTATION_SELECT``
    @_documentation(visibility:public)
    case _DATA_EQUIVALENCE_CRITERIA_REPRESENTATION(
      eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sUSED_EQUIVALENCE_REPRESENTATION_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sUSED_EQUIVALENCE_REPRESENTATION_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sUSED_EQUIVALENCE_REPRESENTATION_SELECT__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sUSED_EQUIVALENCE_REPRESENTATION_SELECT__type, SDAI.DefinedType
