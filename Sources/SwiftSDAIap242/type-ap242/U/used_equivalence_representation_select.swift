/* file: used_equivalence_representation_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
*/
  public enum sUSED_EQUIVALENCE_REPRESENTATION_SELECT : SDAI.Value, TypeHierarchy.sUSED_EQUIVALENCE_REPRESENTATION_SELECT__TypeBehavior {
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._DATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.validateWhereRules(instance: entity.eval, 
        prefix:prefix + "\\\(entity)")
      case nil: break
      }
