/* file: kinematic_link_representation_items.swift 	 generated: Sat Aug 14 13:46:02 2021 */
...
/*
  TYPE kinematic_link_representation_items = SELECT
    ( curve (*ENTITY*),
     ...
     surface (*ENTITY*) );
  END_TYPE; -- kinematic_link_representation_items (line:3901 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  public enum sKINEMATIC_LINK_REPRESENTATION_ITEMS : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sKINEMATIC_LINK_REPRESENTATION_ITEMS__type {
    ...
    public static var bareTypeName: String = "KINEMATIC_LINK_REPRESENTATION_ITEMS"
    ...
    public mutating func configure(with observer: SDAI.EntityReferenceObserver) {
      ...
      case ._POINT(let entity): 
        entity.configure(with: observer)
        self = ._POINT(entity)
      case ._RIGID_PLACEMENT(var select): 
        select.configure(with: observer)
        self = ._RIGID_PLACEMENT(select)
