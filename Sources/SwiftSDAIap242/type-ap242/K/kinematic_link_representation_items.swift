/* file: kinematic_link_representation_items.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sKINEMATIC_LINK_REPRESENTATION_ITEMS : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sKINEMATIC_LINK_REPRESENTATION_ITEMS__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sKINEMATIC_LINK_REPRESENTATION_ITEMS``
    @_documentation(visibility:public)
    case _CURVE(eCURVE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sKINEMATIC_LINK_REPRESENTATION_ITEMS``
    @_documentation(visibility:public)
    case _POINT(ePOINT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sRIGID_PLACEMENT`` (SELECT) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sKINEMATIC_LINK_REPRESENTATION_ITEMS``
    @_documentation(visibility:public)
    case _RIGID_PLACEMENT(sRIGID_PLACEMENT)	// (SELECT)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sKINEMATIC_LINK_REPRESENTATION_ITEMS``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sKINEMATIC_LINK_REPRESENTATION_ITEMS``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sKINEMATIC_LINK_REPRESENTATION_ITEMS__type: 
  SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sKINEMATIC_LINK_REPRESENTATION_ITEMS__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sKINEMATIC_LINK_REPRESENTATION_ITEMS__type, SDAI.DefinedType
where Supertype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sKINEMATIC_LINK_REPRESENTATION_ITEMS__type
{}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sKINEMATIC_LINK_REPRESENTATION_ITEMS__subtype {
  //MARK: CONSTRUCTORS
