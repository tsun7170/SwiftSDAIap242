/* file: kinematic_link_representation_items.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sKINEMATIC_LINK_REPRESENTATION_ITEMS : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sKINEMATIC_LINK_REPRESENTATION_ITEMS__type {
    ...
    /// SELECT case ``eCURVE`` (ENTITY) in ``sKINEMATIC_LINK_REPRESENTATION_ITEMS``
    case _CURVE(eCURVE)	// (ENTITY)

    /// SELECT case ``ePOINT`` (ENTITY) in ``sKINEMATIC_LINK_REPRESENTATION_ITEMS``
    case _POINT(ePOINT)	// (ENTITY)

    /// SELECT case ``sRIGID_PLACEMENT`` (SELECT) in ``sKINEMATIC_LINK_REPRESENTATION_ITEMS``
    case _RIGID_PLACEMENT(sRIGID_PLACEMENT)	// (SELECT)

    /// SELECT case ``eSURFACE`` (ENTITY) in ``sKINEMATIC_LINK_REPRESENTATION_ITEMS``
    ...
    /// attribute of SELECT type ``sKINEMATIC_LINK_REPRESENTATION_ITEMS``
    ...
    /// attribute of SELECT type ``sKINEMATIC_LINK_REPRESENTATION_ITEMS``
    /// - origin: SELECT( ``sRIGID_PLACEMENT`` )
