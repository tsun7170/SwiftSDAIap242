/* file: inspected_equivalence_element_select.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sINSPECTED_EQUIVALENCE_ELEMENT_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sINSPECTED_EQUIVALENCE_ELEMENT_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONNECTED_EDGE_SET`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_EQUIVALENCE_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _CONNECTED_EDGE_SET(eCONNECTED_EDGE_SET.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONNECTED_FACE_SET`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_EQUIVALENCE_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _CONNECTED_FACE_SET(eCONNECTED_FACE_SET.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXTERNALLY_DEFINED_REPRESENTATION_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_EQUIVALENCE_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _EXTERNALLY_DEFINED_REPRESENTATION_ITEM(eEXTERNALLY_DEFINED_REPRESENTATION_ITEM.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMANIFOLD_SOLID_BREP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_EQUIVALENCE_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _MANIFOLD_SOLID_BREP(eMANIFOLD_SOLID_BREP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT_CLOUD_DATASET`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_EQUIVALENCE_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _POINT_CLOUD_DATASET(ePOINT_CLOUD_DATASET.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sPRODUCT_DEFINITION_OR_REFERENCE`` (SELECT) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_EQUIVALENCE_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION_OR_REFERENCE(sPRODUCT_DEFINITION_OR_REFERENCE)	// (SELECT)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_REPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_EQUIVALENCE_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _SHAPE_REPRESENTATION(eSHAPE_REPRESENTATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHELL_BASED_SURFACE_MODEL`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_EQUIVALENCE_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _SHELL_BASED_SURFACE_MODEL(eSHELL_BASED_SURFACE_MODEL.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHELL_BASED_WIREFRAME_MODEL`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_EQUIVALENCE_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _SHELL_BASED_WIREFRAME_MODEL(eSHELL_BASED_WIREFRAME_MODEL.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eVERTEX_POINT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_EQUIVALENCE_ELEMENT_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_EQUIVALENCE_ELEMENT_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sINSPECTED_EQUIVALENCE_ELEMENT_SELECT__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sINSPECTED_EQUIVALENCE_ELEMENT_SELECT__type, SDAI.DefinedType
