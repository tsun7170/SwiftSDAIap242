/* file: inspected_shape_element_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- inspected_shape_element_select (line:3818 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public struct sINSPECTED_SHAPE_ELEMENT_SELECT: TypeHierarchy.sINSPECTED_SHAPE_ELEMENT_SELECT__TypeBehavior {
    ...
    public static let bareTypeName: String = "INSPECTED_SHAPE_ELEMENT_SELECT"
    ...
    public static func WHERE_wr1(SELF: sINSPECTED_SHAPE_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      ...
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: eASSEMBLY_COMPONENT_USAGE.self )
    ...
    public static func WHERE_wr3(SELF: sINSPECTED_SHAPE_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      ...
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: eCARTESIAN_TRANSFORMATION_OPERATOR_3D.self )
      let _TEMP2 /* SDAI.LOGICAL */ =  !_TEMP1
      return _TEMP2
    }
    public static func WHERE_wr4(SELF: sINSPECTED_SHAPE_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      ...
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: eGLOBAL_UNCERTAINTY_ASSIGNED_CONTEXT.self )
      let _TEMP2 /* SDAI.LOGICAL */ =  !_TEMP1
      return _TEMP2
    }
    public static func WHERE_wr5(SELF: sINSPECTED_SHAPE_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      ...
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: eGLOBAL_UNIT_ASSIGNED_CONTEXT.self )
      let _TEMP2 /* SDAI.LOGICAL */ =  !_TEMP1
      return _TEMP2
    }
    ...
    public static func WHERE_wr7(SELF: sINSPECTED_SHAPE_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      ...
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: ePRESENTATION_LAYER_ASSIGNMENT.self )
      let _TEMP2 /* SDAI.LOGICAL */ =  !_TEMP1
      return _TEMP2
    }
    ...
    public static func WHERE_wr9(SELF: sINSPECTED_SHAPE_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      ...
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: eSTYLED_ITEM.self )
      let _TEMP2 /* SDAI.LOGICAL */ =  !_TEMP1
      return _TEMP2
    }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sINSPECTED_SHAPE_ELEMENT_SELECT__TypeBehavior: sINSPECTED_ELEMENT_SELECT__Subtype {}
}

extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sINSPECTED_SHAPE_ELEMENT_SELECT__Subtype: sINSPECTED_SHAPE_ELEMENT_SELECT__TypeBehavior
{}
}
