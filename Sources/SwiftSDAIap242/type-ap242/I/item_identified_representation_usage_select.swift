/* file: item_identified_representation_usage_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- item_identified_representation_usage_select (line:3899 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT : SDAI.Value, 
    TypeHierarchy.sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT__TypeBehavior {

    /// SELECT case (TYPE)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tLIST_REPRESENTATION_ITEM`` (TYPE)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT``
    ...
    /// SELECT case (TYPE)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tSET_REPRESENTATION_ITEM`` (TYPE)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT``
    @_documentation(visibility:public)
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eREPRESENTATION_ITEM.self) {self = ._REPRESENTATION_ITEM(base.pRef) }
      else { return nil }
    }
    ...
    public static let bareTypeName: String = "ITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT"
    ...
    public static let typeName: String = 
      "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT"
...
public protocol sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT__Subtype: 
  sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT__Subtype {
  //MARK: CONSTRUCTORS
