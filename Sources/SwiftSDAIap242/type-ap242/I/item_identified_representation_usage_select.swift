/* file: item_identified_representation_usage_select.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT__type {
    ...
    /// SELECT case ``tLIST_REPRESENTATION_ITEM`` (TYPE) in ``sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT``
    case _LIST_REPRESENTATION_ITEM(tLIST_REPRESENTATION_ITEM)	// (TYPE)

    /// SELECT case ``eREPRESENTATION_ITEM`` (ENTITY) in ``sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT``
    case _REPRESENTATION_ITEM(eREPRESENTATION_ITEM)	// (ENTITY)

    /// SELECT case ``tSET_REPRESENTATION_ITEM`` (TYPE) in ``sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eREPRESENTATION_ITEM.self) {self = ._REPRESENTATION_ITEM(base) }
      else { return nil }
    }
    ...
    /// attribute of SELECT type ``sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT``
