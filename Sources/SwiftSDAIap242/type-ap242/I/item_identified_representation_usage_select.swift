/* file: item_identified_representation_usage_select.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  public enum sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT : SDAI.Value, 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tLIST_REPRESENTATION_ITEM`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT``
    @_documentation(visibility:public)
    case _LIST_REPRESENTATION_ITEM(tLIST_REPRESENTATION_ITEM)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREPRESENTATION_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT``
    @_documentation(visibility:public)
    case _REPRESENTATION_ITEM(eREPRESENTATION_ITEM.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tSET_REPRESENTATION_ITEM`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT__type: 
  SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT__type, SDAI.DefinedType
where Supertype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT__type
{}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sITEM_IDENTIFIED_REPRESENTATION_USAGE_SELECT__subtype {
  //MARK: CONSTRUCTORS
