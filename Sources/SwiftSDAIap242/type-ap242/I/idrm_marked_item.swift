/* file: idrm_marked_item.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- idrm_marked_item (line:3747 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sIDRM_MARKED_ITEM : SDAI.Value, TypeHierarchy.sIDRM_MARKED_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDOCUMENT_FILE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sIDRM_MARKED_ITEM``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eDOCUMENT_FILE.self) {self = ._DOCUMENT_FILE(base.pRef) }
    ...
    public static let bareTypeName: String = "IDRM_MARKED_ITEM"
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.IDRM_MARKED_ITEM"
...
public protocol sIDRM_MARKED_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sIDRM_MARKED_ITEM__Subtype: sIDRM_MARKED_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sIDRM_MARKED_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sIDRM_MARKED_ITEM__Subtype {
  //MARK: CONSTRUCTORS
