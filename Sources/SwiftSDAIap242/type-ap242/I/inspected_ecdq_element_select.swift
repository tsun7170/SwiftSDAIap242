/* file: inspected_ecdq_element_select.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_TYPE; -- inspected_ecdq_element_select (line:3761 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public struct sINSPECTED_ECDQ_ELEMENT_SELECT: TypeHierarchy.sINSPECTED_ECDQ_ELEMENT_SELECT__TypeBehavior {
    ...
    public static let bareTypeName: String = "INSPECTED_ECDQ_ELEMENT_SELECT"
    ...
    public static func WHERE_wr1(SELF: sINSPECTED_ECDQ_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      ...
      //
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: sB_SPLINE_OR_COMPOSITE_CURVE_SELECT.self )
    ...
    public static func WHERE_wr2(SELF: sINSPECTED_ECDQ_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      ...
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, 
        IS: sB_SPLINE_OR_RECTANGULAR_COMPOSITE_SURFACE_SELECT.self )
      let _TEMP2 /* SDAI.LOGICAL */ =  !_TEMP1
      return _TEMP2
    }
    public static func WHERE_wr3(SELF: sINSPECTED_ECDQ_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      //
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: sCLOSED_OR_OPEN_SHELL_SELECT.self )
      let _TEMP2 /* SDAI.LOGICAL */ =  !_TEMP1
      return _TEMP2
    }
    public static func WHERE_wr4(SELF: sINSPECTED_ECDQ_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      //
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: eCONNECTED_FACE_SET.self )
      let _TEMP2 /* SDAI.LOGICAL */ =  !_TEMP1
      return _TEMP2
    }
    ...
    public static func WHERE_wr6(SELF: sINSPECTED_ECDQ_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      //
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: eDIRECTION.self )
      let _TEMP2 /* SDAI.LOGICAL */ =  !_TEMP1
      return _TEMP2
    }
    public static func WHERE_wr7(SELF: sINSPECTED_ECDQ_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      //
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: eEDGE_CURVE.self )
      let _TEMP2 /* SDAI.LOGICAL */ =  !_TEMP1
      return _TEMP2
    }
    ...
    public static func WHERE_wr9(SELF: sINSPECTED_ECDQ_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      //
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: eFACE_SURFACE.self )
      let _TEMP2 /* SDAI.LOGICAL */ =  !_TEMP1
      return _TEMP2
    }
    public static func WHERE_wr10(SELF: sINSPECTED_ECDQ_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      //
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: eMANIFOLD_SOLID_BREP.self )
      let _TEMP2 /* SDAI.LOGICAL */ =  !_TEMP1
      return _TEMP2
    }
    public static func WHERE_wr11(SELF: sINSPECTED_ECDQ_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      //
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: ePLACEMENT.self )
      let _TEMP2 /* SDAI.LOGICAL */ =  !_TEMP1
      return _TEMP2
    }
    public static func WHERE_wr12(SELF: sINSPECTED_ECDQ_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      //
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: ePOINT.self )
      let _TEMP2 /* SDAI.LOGICAL */ =  !_TEMP1
      return _TEMP2
    }
    public static func WHERE_wr13(SELF: sINSPECTED_ECDQ_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      //
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: eSURFACE.self )
      let _TEMP2 /* SDAI.LOGICAL */ =  !_TEMP1
      return _TEMP2
    }
    public static func WHERE_wr14(SELF: sINSPECTED_ECDQ_ELEMENT_SELECT?) -> SDAI.LOGICAL {
      guard let SELF = SELF else { return SDAI.UNKNOWN }
      //
      let _TEMP1 /* SDAI.LOGICAL */ = SDAI.TYPEOF( SELF, IS: eVERTEX_POINT.self )
      let _TEMP2 /* SDAI.LOGICAL */ =  !_TEMP1
      return _TEMP2
    }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sINSPECTED_ECDQ_ELEMENT_SELECT__TypeBehavior: sINSPECTED_ELEMENT_SELECT__Subtype {}
}

extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sINSPECTED_ECDQ_ELEMENT_SELECT__Subtype: sINSPECTED_ECDQ_ELEMENT_SELECT__TypeBehavior
{}
}
