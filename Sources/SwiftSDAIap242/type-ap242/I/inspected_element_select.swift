/* file: inspected_element_select.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sINSPECTED_ELEMENT_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sINSPECTED_ELEMENT_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eASSEMBLY_COMPONENT_USAGE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _ASSEMBLY_COMPONENT_USAGE(eASSEMBLY_COMPONENT_USAGE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAXIS2_PLACEMENT_3D`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _AXIS2_PLACEMENT_3D(eAXIS2_PLACEMENT_3D.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sB_SPLINE_OR_COMPOSITE_CURVE_SELECT`` (SELECT) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _B_SPLINE_OR_COMPOSITE_CURVE_SELECT(sB_SPLINE_OR_COMPOSITE_CURVE_SELECT)	// (SELECT)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sB_SPLINE_OR_RECTANGULAR_COMPOSITE_SURFACE_SELECT`` (SELECT) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _B_SPLINE_OR_RECTANGULAR_COMPOSITE_SURFACE_SELECT(
      sB_SPLINE_OR_RECTANGULAR_COMPOSITE_SURFACE_SELECT)	// (SELECT)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCARTESIAN_TRANSFORMATION_OPERATOR_3D`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _CARTESIAN_TRANSFORMATION_OPERATOR_3D(eCARTESIAN_TRANSFORMATION_OPERATOR_3D.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCLOSED_OR_OPEN_SHELL_SELECT`` (SELECT) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _CLOSED_OR_OPEN_SHELL_SELECT(sCLOSED_OR_OPEN_SHELL_SELECT)	// (SELECT)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONNECTED_FACE_SET`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _CONNECTED_FACE_SET(eCONNECTED_FACE_SET.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _CURVE(eCURVE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIRECTION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _DIRECTION(eDIRECTION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEDGE_CURVE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _EDGE_CURVE(eEDGE_CURVE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEDGE_LOOP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _EDGE_LOOP(eEDGE_LOOP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFACE_SURFACE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _FACE_SURFACE(eFACE_SURFACE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGLOBAL_UNCERTAINTY_ASSIGNED_CONTEXT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _GLOBAL_UNCERTAINTY_ASSIGNED_CONTEXT(eGLOBAL_UNCERTAINTY_ASSIGNED_CONTEXT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGLOBAL_UNIT_ASSIGNED_CONTEXT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _GLOBAL_UNIT_ASSIGNED_CONTEXT(eGLOBAL_UNIT_ASSIGNED_CONTEXT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGROUP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _GROUP(eGROUP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMANIFOLD_SOLID_BREP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _MANIFOLD_SOLID_BREP(eMANIFOLD_SOLID_BREP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLACEMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _PLACEMENT(ePLACEMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _POINT(ePOINT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESENTATION_LAYER_ASSIGNMENT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _PRESENTATION_LAYER_ASSIGNMENT(ePRESENTATION_LAYER_ASSIGNMENT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREPRESENTATION_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _REPRESENTATION_ITEM(eREPRESENTATION_ITEM.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTYLED_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _STYLED_ITEM(eSTYLED_ITEM.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    case _SURFACE(eSURFACE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eVERTEX_POINT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSPECTED_ELEMENT_SELECT``
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      case ._EDGE_CURVE(let entity): result = eEDGE_CURVE.validateWhereRules(instance: entity.eval, 
        prefix:prefix + "\\EDGE_CURVE")
      case ._EDGE_LOOP(let entity): result = eEDGE_LOOP.validateWhereRules(instance: entity.eval, 
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sINSPECTED_ELEMENT_SELECT__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sINSPECTED_ELEMENT_SELECT__type, SDAI.DefinedType
