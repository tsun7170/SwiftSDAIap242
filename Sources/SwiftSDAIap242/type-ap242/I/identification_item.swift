/* file: identification_item.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_TYPE; -- identification_item (line:3575 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  public enum sIDENTIFICATION_ITEM : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sIDENTIFICATION_ITEM__type {
    ...
    /// SELECT case ``eACTION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ACTION(eACTION)	// (ENTITY)

    /// SELECT case ``eACTION_DIRECTIVE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ACTION_DIRECTIVE(eACTION_DIRECTIVE)	// (ENTITY)

    /// SELECT case ``eACTION_DIRECTIVE_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ACTION_DIRECTIVE_RELATIONSHIP(eACTION_DIRECTIVE_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eACTION_METHOD`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ACTION_METHOD(eACTION_METHOD)	// (ENTITY)

    /// SELECT case ``eACTION_METHOD_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ACTION_METHOD_RELATIONSHIP(eACTION_METHOD_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eACTION_PROPERTY`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ACTION_PROPERTY(eACTION_PROPERTY)	// (ENTITY)

    /// SELECT case ``eACTION_PROPERTY_REPRESENTATION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ACTION_PROPERTY_REPRESENTATION(eACTION_PROPERTY_REPRESENTATION)	// (ENTITY)

    /// SELECT case ``eACTION_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ACTION_RELATIONSHIP(eACTION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eADDRESS`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ADDRESS(eADDRESS)	// (ENTITY)

    /// SELECT case ``eALTERNATE_PRODUCT_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ALTERNATE_PRODUCT_RELATIONSHIP(eALTERNATE_PRODUCT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eALTERNATIVE_SOLUTION_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ALTERNATIVE_SOLUTION_RELATIONSHIP(eALTERNATIVE_SOLUTION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eANALYSIS_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ANALYSIS_ASSIGNMENT(eANALYSIS_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eANALYSIS_REPRESENTATION_CONTEXT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ANALYSIS_REPRESENTATION_CONTEXT(eANALYSIS_REPRESENTATION_CONTEXT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_ACTION_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_ACTION_ASSIGNMENT(eAPPLIED_ACTION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_ACTION_METHOD_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_ACTION_METHOD_ASSIGNMENT(eAPPLIED_ACTION_METHOD_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_ACTION_REQUEST_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_ACTION_REQUEST_ASSIGNMENT(eAPPLIED_ACTION_REQUEST_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_APPROVAL_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_APPROVAL_ASSIGNMENT(eAPPLIED_APPROVAL_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_CERTIFICATION_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_CERTIFICATION_ASSIGNMENT(eAPPLIED_CERTIFICATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_CLASSIFICATION_ASSIGNMENT_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_CLASSIFICATION_ASSIGNMENT_RELATIONSHIP(
      eAPPLIED_CLASSIFICATION_ASSIGNMENT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eAPPLIED_CONTRACT_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_CONTRACT_ASSIGNMENT(eAPPLIED_CONTRACT_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_DESCRIPTION_TEXT_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_DESCRIPTION_TEXT_ASSIGNMENT(eAPPLIED_DESCRIPTION_TEXT_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_DESCRIPTION_TEXT_ASSIGNMENT_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_DESCRIPTION_TEXT_ASSIGNMENT_RELATIONSHIP(
      eAPPLIED_DESCRIPTION_TEXT_ASSIGNMENT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eAPPLIED_DOCUMENT_REFERENCE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_DOCUMENT_REFERENCE(eAPPLIED_DOCUMENT_REFERENCE)	// (ENTITY)

    /// SELECT case ``eAPPLIED_DOCUMENT_USAGE_CONSTRAINT_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_DOCUMENT_USAGE_CONSTRAINT_ASSIGNMENT(
      eAPPLIED_DOCUMENT_USAGE_CONSTRAINT_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_EFFECTIVITY_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_EFFECTIVITY_ASSIGNMENT(eAPPLIED_EFFECTIVITY_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_EVENT_OCCURRENCE_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_EVENT_OCCURRENCE_ASSIGNMENT(eAPPLIED_EVENT_OCCURRENCE_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_EXTERNAL_IDENTIFICATION_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_EXTERNAL_IDENTIFICATION_ASSIGNMENT(
      eAPPLIED_EXTERNAL_IDENTIFICATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_EXTERNAL_IDENTIFICATION_ASSIGNMENT_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    ...
    /// SELECT case ``eAPPLIED_IDENTIFICATION_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_IDENTIFICATION_ASSIGNMENT(eAPPLIED_IDENTIFICATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_INEFFECTIVITY_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_INEFFECTIVITY_ASSIGNMENT(eAPPLIED_INEFFECTIVITY_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_ORGANIZATIONAL_PROJECT_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_ORGANIZATIONAL_PROJECT_ASSIGNMENT(eAPPLIED_ORGANIZATIONAL_PROJECT_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_ORGANIZATION_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_ORGANIZATION_ASSIGNMENT(eAPPLIED_ORGANIZATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_PERSON_AND_ORGANIZATION_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_PERSON_AND_ORGANIZATION_ASSIGNMENT(
      eAPPLIED_PERSON_AND_ORGANIZATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_SECURITY_CLASSIFICATION_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_SECURITY_CLASSIFICATION_ASSIGNMENT(
      eAPPLIED_SECURITY_CLASSIFICATION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_TIME_INTERVAL_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_TIME_INTERVAL_ASSIGNMENT(eAPPLIED_TIME_INTERVAL_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_USAGE_RIGHT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPLIED_USAGE_RIGHT(eAPPLIED_USAGE_RIGHT)	// (ENTITY)

    /// SELECT case ``eAPPROVAL`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPROVAL(eAPPROVAL)	// (ENTITY)

    /// SELECT case ``eAPPROVAL_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPROVAL_RELATIONSHIP(eAPPROVAL_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eAPPROVAL_STATUS`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _APPROVAL_STATUS(eAPPROVAL_STATUS)	// (ENTITY)

    /// SELECT case ``eASCRIBABLE_STATE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ASCRIBABLE_STATE(eASCRIBABLE_STATE)	// (ENTITY)

    /// SELECT case ``eASCRIBABLE_STATE_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ASCRIBABLE_STATE_RELATIONSHIP(eASCRIBABLE_STATE_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eASSEMBLY_COMPONENT_USAGE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ASSEMBLY_COMPONENT_USAGE(eASSEMBLY_COMPONENT_USAGE)	// (ENTITY)

    /// SELECT case ``eASSEMBLY_COMPONENT_USAGE_SUBSTITUTE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ASSEMBLY_COMPONENT_USAGE_SUBSTITUTE(eASSEMBLY_COMPONENT_USAGE_SUBSTITUTE)	// (ENTITY)

    /// SELECT case ``eASSIGNMENT_OBJECT_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ASSIGNMENT_OBJECT_RELATIONSHIP(eASSIGNMENT_OBJECT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eBREAKDOWN_ELEMENT_REALIZATION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _BREAKDOWN_ELEMENT_REALIZATION(eBREAKDOWN_ELEMENT_REALIZATION)	// (ENTITY)

    /// SELECT case ``eBREAKDOWN_OF`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _BREAKDOWN_OF(eBREAKDOWN_OF)	// (ENTITY)

    /// SELECT case ``eCERTIFICATION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _CERTIFICATION(eCERTIFICATION)	// (ENTITY)

    /// SELECT case ``eCHANGE_GROUP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _CHANGE_GROUP(eCHANGE_GROUP)	// (ENTITY)

    /// SELECT case ``eCHARACTERIZED_CLASS`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _CHARACTERIZED_CLASS(eCHARACTERIZED_CLASS)	// (ENTITY)

    /// SELECT case ``eCLASS`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _CLASS(eCLASS)	// (ENTITY)

    /// SELECT case ``eCLASS_SYSTEM`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _CLASS_SYSTEM(eCLASS_SYSTEM)	// (ENTITY)

    /// SELECT case ``eCONFIGURATION_EFFECTIVITY`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _CONFIGURATION_EFFECTIVITY(eCONFIGURATION_EFFECTIVITY)	// (ENTITY)

    /// SELECT case ``eCONFIGURATION_ITEM`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _CONFIGURATION_ITEM(eCONFIGURATION_ITEM)	// (ENTITY)

    /// SELECT case ``eCONFIGURATION_ITEM_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _CONFIGURATION_ITEM_RELATIONSHIP(eCONFIGURATION_ITEM_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eCONTRACT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _CONTRACT(eCONTRACT)	// (ENTITY)

    /// SELECT case ``eCONTRACT_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _CONTRACT_RELATIONSHIP(eCONTRACT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eDATE_AND_TIME_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _DATE_AND_TIME_ASSIGNMENT(eDATE_AND_TIME_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eDATE_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _DATE_ASSIGNMENT(eDATE_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eDEGENERATE_PCURVE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _DEGENERATE_PCURVE(eDEGENERATE_PCURVE)	// (ENTITY)

    /// SELECT case ``eDIMENSIONAL_SIZE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _DIMENSIONAL_SIZE(eDIMENSIONAL_SIZE)	// (ENTITY)

    /// SELECT case ``eDIMENSIONAL_SIZE_WITH_PATH`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _DIMENSIONAL_SIZE_WITH_PATH(eDIMENSIONAL_SIZE_WITH_PATH)	// (ENTITY)

    /// SELECT case ``eDIRECTED_ACTION_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _DIRECTED_ACTION_ASSIGNMENT(eDIRECTED_ACTION_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eDOCUMENT_FILE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _DOCUMENT_FILE(eDOCUMENT_FILE)	// (ENTITY)

    /// SELECT case ``eDOCUMENT_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _DOCUMENT_RELATIONSHIP(eDOCUMENT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eDOCUMENT_TYPE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _DOCUMENT_TYPE(eDOCUMENT_TYPE)	// (ENTITY)

    /// SELECT case ``eDRAUGHTING_MODEL`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _DRAUGHTING_MODEL(eDRAUGHTING_MODEL)	// (ENTITY)

    /// SELECT case ``eEFFECTIVITY`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _EFFECTIVITY(eEFFECTIVITY)	// (ENTITY)

    /// SELECT case ``eEFFECTIVITY_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _EFFECTIVITY_RELATIONSHIP(eEFFECTIVITY_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eENVELOPE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ENVELOPE(eENVELOPE)	// (ENTITY)

    /// SELECT case ``eENVELOPE_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ENVELOPE_RELATIONSHIP(eENVELOPE_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eEVALUATED_CHARACTERISTIC`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _EVALUATED_CHARACTERISTIC(eEVALUATED_CHARACTERISTIC)	// (ENTITY)

    /// SELECT case ``eEVENT_OCCURRENCE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _EVENT_OCCURRENCE(eEVENT_OCCURRENCE)	// (ENTITY)

    /// SELECT case ``eEVENT_OCCURRENCE_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _EVENT_OCCURRENCE_RELATIONSHIP(eEVENT_OCCURRENCE_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eEVIDENCE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _EVIDENCE(eEVIDENCE)	// (ENTITY)

    /// SELECT case ``eEXCLUSIVE_PRODUCT_CONCEPT_FEATURE_CATEGORY`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _EXCLUSIVE_PRODUCT_CONCEPT_FEATURE_CATEGORY(
      eEXCLUSIVE_PRODUCT_CONCEPT_FEATURE_CATEGORY)	// (ENTITY)

    /// SELECT case ``eEXECUTED_ACTION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _EXECUTED_ACTION(eEXECUTED_ACTION)	// (ENTITY)

    /// SELECT case ``eGENERAL_PROPERTY`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _GENERAL_PROPERTY(eGENERAL_PROPERTY)	// (ENTITY)

    /// SELECT case ``eGENERAL_PROPERTY_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _GENERAL_PROPERTY_RELATIONSHIP(eGENERAL_PROPERTY_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eGENERIC_PROPERTY_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _GENERIC_PROPERTY_RELATIONSHIP(eGENERIC_PROPERTY_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eGROUP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _GROUP(eGROUP)	// (ENTITY)

    /// SELECT case ``eGROUP_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _GROUP_RELATIONSHIP(eGROUP_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eIDENTIFICATION_ASSIGNMENT_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _IDENTIFICATION_ASSIGNMENT_RELATIONSHIP(eIDENTIFICATION_ASSIGNMENT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eINFORMATION_RIGHT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _INFORMATION_RIGHT(eINFORMATION_RIGHT)	// (ENTITY)

    /// SELECT case ``eINFORMATION_USAGE_RIGHT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _INFORMATION_USAGE_RIGHT(eINFORMATION_USAGE_RIGHT)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _INTERFACE_CONNECTION(eINTERFACE_CONNECTION)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTOR_AS_PLANNED`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _INTERFACE_CONNECTOR_AS_PLANNED(eINTERFACE_CONNECTOR_AS_PLANNED)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTOR_AS_REALIZED`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _INTERFACE_CONNECTOR_AS_REALIZED(eINTERFACE_CONNECTOR_AS_REALIZED)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTOR_DEFINITION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _INTERFACE_CONNECTOR_DEFINITION(eINTERFACE_CONNECTOR_DEFINITION)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTOR_DESIGN`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _INTERFACE_CONNECTOR_DESIGN(eINTERFACE_CONNECTOR_DESIGN)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTOR_OCCURRENCE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _INTERFACE_CONNECTOR_OCCURRENCE(eINTERFACE_CONNECTOR_OCCURRENCE)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTOR_VERSION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _INTERFACE_CONNECTOR_VERSION(eINTERFACE_CONNECTOR_VERSION)	// (ENTITY)

    /// SELECT case ``eINTERFACE_DEFINITION_CONNECTION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _INTERFACE_DEFINITION_CONNECTION(eINTERFACE_DEFINITION_CONNECTION)	// (ENTITY)

    /// SELECT case ``eINTERFACE_DEFINITION_FOR`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _INTERFACE_DEFINITION_FOR(eINTERFACE_DEFINITION_FOR)	// (ENTITY)

    /// SELECT case ``eINTERFACE_SPECIFICATION_DEFINITION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _INTERFACE_SPECIFICATION_DEFINITION(eINTERFACE_SPECIFICATION_DEFINITION)	// (ENTITY)

    /// SELECT case ``eINTERFACE_SPECIFICATION_VERSION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _INTERFACE_SPECIFICATION_VERSION(eINTERFACE_SPECIFICATION_VERSION)	// (ENTITY)

    /// SELECT case ``eLINK_MOTION_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _LINK_MOTION_RELATIONSHIP(eLINK_MOTION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eMATERIAL_DESIGNATION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _MATERIAL_DESIGNATION(eMATERIAL_DESIGNATION)	// (ENTITY)

    /// SELECT case ``eMATERIAL_DESIGNATION_CHARACTERIZATION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _MATERIAL_DESIGNATION_CHARACTERIZATION(eMATERIAL_DESIGNATION_CHARACTERIZATION)	// (ENTITY)

    /// SELECT case ``eMEASURE_REPRESENTATION_ITEM`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _MEASURE_REPRESENTATION_ITEM(eMEASURE_REPRESENTATION_ITEM)	// (ENTITY)

    /// SELECT case ``eMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_REPRESENTATION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    ...
    /// SELECT case ``eMESSAGE_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _MESSAGE_RELATIONSHIP(eMESSAGE_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eORGANIZATION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ORGANIZATION(eORGANIZATION)	// (ENTITY)

    /// SELECT case ``eORGANIZATIONAL_ADDRESS`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ORGANIZATIONAL_ADDRESS(eORGANIZATIONAL_ADDRESS)	// (ENTITY)

    /// SELECT case ``eORGANIZATIONAL_PROJECT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ORGANIZATIONAL_PROJECT(eORGANIZATIONAL_PROJECT)	// (ENTITY)

    /// SELECT case ``eORGANIZATIONAL_PROJECT_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ORGANIZATIONAL_PROJECT_RELATIONSHIP(eORGANIZATIONAL_PROJECT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eORGANIZATION_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _ORGANIZATION_RELATIONSHIP(eORGANIZATION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePACKAGE_PRODUCT_CONCEPT_FEATURE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PACKAGE_PRODUCT_CONCEPT_FEATURE(ePACKAGE_PRODUCT_CONCEPT_FEATURE)	// (ENTITY)

    /// SELECT case ``ePERSON`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PERSON(ePERSON)	// (ENTITY)

    /// SELECT case ``ePERSON_AND_ORGANIZATION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PERSON_AND_ORGANIZATION(ePERSON_AND_ORGANIZATION)	// (ENTITY)

    /// SELECT case ``ePERSON_AND_ORGANIZATION_ADDRESS`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PERSON_AND_ORGANIZATION_ADDRESS(ePERSON_AND_ORGANIZATION_ADDRESS)	// (ENTITY)

    /// SELECT case ``ePOINT_ON_SURFACE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _POINT_ON_SURFACE(ePOINT_ON_SURFACE)	// (ENTITY)

    /// SELECT case ``ePRESENTATION_AREA`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRESENTATION_AREA(ePRESENTATION_AREA)	// (ENTITY)

    /// SELECT case ``ePROCESS_OPERATION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PROCESS_OPERATION(ePROCESS_OPERATION)	// (ENTITY)

    /// SELECT case ``ePROCESS_PLAN`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PROCESS_PLAN(ePROCESS_PLAN)	// (ENTITY)

    /// SELECT case ``ePRODUCT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT(ePRODUCT)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CATEGORY`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT_CATEGORY(ePRODUCT_CATEGORY)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CLASS`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT_CLASS(ePRODUCT_CLASS)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT_CONCEPT(ePRODUCT_CONCEPT)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT_CONTEXT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT_CONCEPT_CONTEXT(ePRODUCT_CONCEPT_CONTEXT)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT_FEATURE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT_CONCEPT_FEATURE(ePRODUCT_CONCEPT_FEATURE)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT_FEATURE_CATEGORY`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT_CONCEPT_FEATURE_CATEGORY(ePRODUCT_CONCEPT_FEATURE_CATEGORY)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CONCEPT_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT_CONCEPT_RELATIONSHIP(ePRODUCT_CONCEPT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT_DEFINITION(ePRODUCT_DEFINITION)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_FORMATION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT_DEFINITION_FORMATION(ePRODUCT_DEFINITION_FORMATION)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_FORMATION_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT_DEFINITION_FORMATION_RELATIONSHIP(ePRODUCT_DEFINITION_FORMATION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_OCCURRENCE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT_DEFINITION_OCCURRENCE(ePRODUCT_DEFINITION_OCCURRENCE)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_OCCURRENCE_REFERENCE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT_DEFINITION_OCCURRENCE_REFERENCE(ePRODUCT_DEFINITION_OCCURRENCE_REFERENCE)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT_DEFINITION_RELATIONSHIP(ePRODUCT_DEFINITION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_USAGE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT_DEFINITION_USAGE(ePRODUCT_DEFINITION_USAGE)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_USAGE_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT_DEFINITION_USAGE_RELATIONSHIP(ePRODUCT_DEFINITION_USAGE_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_GROUP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT_GROUP(ePRODUCT_GROUP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_GROUP_MEMBERSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT_GROUP_MEMBERSHIP(ePRODUCT_GROUP_MEMBERSHIP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_GROUP_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT_GROUP_RELATIONSHIP(ePRODUCT_GROUP_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_IDENTIFICATION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT_IDENTIFICATION(ePRODUCT_IDENTIFICATION)	// (ENTITY)

    /// SELECT case ``ePRODUCT_PROCESS_PLAN`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT_PROCESS_PLAN(ePRODUCT_PROCESS_PLAN)	// (ENTITY)

    /// SELECT case ``ePRODUCT_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PRODUCT_RELATIONSHIP(ePRODUCT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePROPERTY_DEFINITION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PROPERTY_DEFINITION(ePROPERTY_DEFINITION)	// (ENTITY)

    /// SELECT case ``ePROPERTY_DEFINITION_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PROPERTY_DEFINITION_RELATIONSHIP(ePROPERTY_DEFINITION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePROPERTY_DEFINITION_REPRESENTATION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _PROPERTY_DEFINITION_REPRESENTATION(ePROPERTY_DEFINITION_REPRESENTATION)	// (ENTITY)

    /// SELECT case ``eREPRESENTATION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _REPRESENTATION(eREPRESENTATION)	// (ENTITY)

    /// SELECT case ``eREPRESENTATION_CONTEXT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _REPRESENTATION_CONTEXT(eREPRESENTATION_CONTEXT)	// (ENTITY)

    /// SELECT case ``eREPRESENTATION_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _REPRESENTATION_RELATIONSHIP(eREPRESENTATION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eREQUIREMENT_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _REQUIREMENT_ASSIGNMENT(eREQUIREMENT_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eREQUIREMENT_FOR_ACTION_RESOURCE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _REQUIREMENT_FOR_ACTION_RESOURCE(eREQUIREMENT_FOR_ACTION_RESOURCE)	// (ENTITY)

    /// SELECT case ``eREQUIREMENT_SOURCE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _REQUIREMENT_SOURCE(eREQUIREMENT_SOURCE)	// (ENTITY)

    /// SELECT case ``eRETENTION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _RETENTION(eRETENTION)	// (ENTITY)

    /// SELECT case ``eRULE_SET`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _RULE_SET(eRULE_SET)	// (ENTITY)

    /// SELECT case ``eSATISFIES_REQUIREMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _SATISFIES_REQUIREMENT(eSATISFIES_REQUIREMENT)	// (ENTITY)

    /// SELECT case ``eSECURITY_CLASSIFICATION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _SECURITY_CLASSIFICATION(eSECURITY_CLASSIFICATION)	// (ENTITY)

    /// SELECT case ``eSECURITY_CLASSIFICATION_LEVEL`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _SECURITY_CLASSIFICATION_LEVEL(eSECURITY_CLASSIFICATION_LEVEL)	// (ENTITY)

    /// SELECT case ``eSHAPE_ASPECT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _SHAPE_ASPECT(eSHAPE_ASPECT)	// (ENTITY)

    /// SELECT case ``eSHAPE_ASPECT_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _SHAPE_ASPECT_RELATIONSHIP(eSHAPE_ASPECT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eSHAPE_FEATURE_DEFINITION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _SHAPE_FEATURE_DEFINITION(eSHAPE_FEATURE_DEFINITION)	// (ENTITY)

    /// SELECT case ``eSHAPE_FEATURE_DEFINITION_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _SHAPE_FEATURE_DEFINITION_RELATIONSHIP(eSHAPE_FEATURE_DEFINITION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eSHAPE_REPRESENTATION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _SHAPE_REPRESENTATION(eSHAPE_REPRESENTATION)	// (ENTITY)

    /// SELECT case ``eSTATE_DEFINITION_TO_STATE_ASSIGNMENT_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _STATE_DEFINITION_TO_STATE_ASSIGNMENT_RELATIONSHIP(
      eSTATE_DEFINITION_TO_STATE_ASSIGNMENT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eSTATE_OBSERVED`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _STATE_OBSERVED(eSTATE_OBSERVED)	// (ENTITY)

    /// SELECT case ``eSTATE_OBSERVED_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _STATE_OBSERVED_ASSIGNMENT(eSTATE_OBSERVED_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eSTATE_OBSERVED_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _STATE_OBSERVED_RELATIONSHIP(eSTATE_OBSERVED_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eSTATE_TYPE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _STATE_TYPE(eSTATE_TYPE)	// (ENTITY)

    /// SELECT case ``eSTATE_TYPE_ASSIGNMENT`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _STATE_TYPE_ASSIGNMENT(eSTATE_TYPE_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eSTATE_TYPE_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _STATE_TYPE_RELATIONSHIP(eSTATE_TYPE_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eSTRUCTURED_MESSAGE`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _STRUCTURED_MESSAGE(eSTRUCTURED_MESSAGE)	// (ENTITY)

    /// SELECT case ``eTIME_INTERVAL`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _TIME_INTERVAL(eTIME_INTERVAL)	// (ENTITY)

    /// SELECT case ``eTIME_INTERVAL_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _TIME_INTERVAL_RELATIONSHIP(eTIME_INTERVAL_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eUSAGE_ASSOCIATION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _USAGE_ASSOCIATION(eUSAGE_ASSOCIATION)	// (ENTITY)

    /// SELECT case ``eVALIDATION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _VALIDATION(eVALIDATION)	// (ENTITY)

    /// SELECT case ``eVERIFICATION`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _VERIFICATION(eVERIFICATION)	// (ENTITY)

    /// SELECT case ``eVERIFICATION_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _VERIFICATION_RELATIONSHIP(eVERIFICATION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eVERSIONED_ACTION_REQUEST`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    case _VERSIONED_ACTION_REQUEST(eVERSIONED_ACTION_REQUEST)	// (ENTITY)

    /// SELECT case ``eVERSIONED_ACTION_REQUEST_RELATIONSHIP`` (ENTITY) in ``sIDENTIFICATION_ITEM``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      else if let base = complex.entityReference(eDEGENERATE_PCURVE.self) {self = ._DEGENERATE_PCURVE(base) }
      else if let base = complex.entityReference(eDIMENSIONAL_SIZE.self) {self = ._DIMENSIONAL_SIZE(base) }
      else if let base = complex.entityReference(eDIMENSIONAL_SIZE_WITH_PATH.self) {self = ._DIMENSIONAL_SIZE_WITH_PATH(base) }
      ...
      else if let base = complex.entityReference(eRULE_SET.self) {self = ._RULE_SET(base) }
      ...
      else if let base = complex.entityReference(eSHAPE_FEATURE_DEFINITION.self) {self = ._SHAPE_FEATURE_DEFINITION(base) }
    ...
    public init?<G: SDAIGenericType>(fromGeneric generic: G?) {
      ...
      else if let base = eDEGENERATE_PCURVE.convert(fromGeneric: select) {
        self = ._DEGENERATE_PCURVE(base)
      }
      else if let base = eDIMENSIONAL_SIZE.convert(fromGeneric: select) {
        self = ._DIMENSIONAL_SIZE(base)
      }
      else if let base = eDIMENSIONAL_SIZE_WITH_PATH.convert(fromGeneric: select) {
      ...
      else if let base = eRULE_SET.convert(fromGeneric: select) {
        self = ._RULE_SET(base)
      }
      ...
      else if let base = eSHAPE_FEATURE_DEFINITION.convert(fromGeneric: select) {
    ...
    public static var bareTypeName: String = "IDENTIFICATION_ITEM"
    ...
    public var super_eDIMENSIONAL_SIZE: eDIMENSIONAL_SIZE? {
      ...
      case ._DIMENSIONAL_SIZE_WITH_PATH(let entity): return entity.super_eDIMENSIONAL_SIZE
      default: return nil
      }
    }
    ...
    public var super_eFEATURE_DEFINITION: eFEATURE_DEFINITION? {
      switch self {
      case ._SHAPE_FEATURE_DEFINITION(let entity): return entity.super_eFEATURE_DEFINITION
      default: return nil
      }
    }
    ...
    public var super_ePRODUCT_DEFINITION: ePRODUCT_DEFINITION? {
      ...
      case ._RULE_SET(let entity): return entity.super_ePRODUCT_DEFINITION
      default: return nil
      }
    }
    ...
    public var super_eREPRESENTATION_ITEM: eREPRESENTATION_ITEM? {
      switch self {
      case ._DEGENERATE_PCURVE(let entity): return entity.super_eREPRESENTATION_ITEM
    ...
    public var super_ePOINT: ePOINT? {
      switch self {
      case ._DEGENERATE_PCURVE(let entity): return entity.super_ePOINT
    ...
    public var super_eGEOMETRIC_REPRESENTATION_ITEM: eGEOMETRIC_REPRESENTATION_ITEM? {
      switch self {
      case ._DEGENERATE_PCURVE(let entity): return entity.super_eGEOMETRIC_REPRESENTATION_ITEM
    ...
    public var super_eRULE_SOFTWARE_DEFINITION: eRULE_SOFTWARE_DEFINITION? {
      switch self {
      case ._RULE_SET(let entity): return entity.super_eRULE_SOFTWARE_DEFINITION
      default: return nil
      }
    }
    ...
    public var super_eCHARACTERIZED_OBJECT: eCHARACTERIZED_OBJECT? {
      ...
      case ._SHAPE_FEATURE_DEFINITION(let entity): return entity.super_eCHARACTERIZED_OBJECT
    ...
    /// attribute of SELECT type ``sIDENTIFICATION_ITEM``
    ...
    /// attribute of SELECT type ``sIDENTIFICATION_ITEM``
    /// - origin: ENTITY( ``eDEGENERATE_PCURVE`` )
    ...
    /// - origin: ENTITY( ``eDIMENSIONAL_SIZE_WITH_PATH`` )
    ...
    /// - origin: ENTITY( ``eSHAPE_ASPECT`` )
    /// - origin: ENTITY( ``eSHAPE_ASPECT_RELATIONSHIP`` )
    /// - origin: ENTITY( ``eSHAPE_FEATURE_DEFINITION`` )
    /// - origin: ENTITY( ``eSHAPE_REPRESENTATION`` )
    /// - origin: ENTITY( ``eSTATE_DEFINITION_TO_STATE_ASSIGNMENT_RELATIONSHIP`` )
    ...
    public mutating func configure(with observer: SDAI.EntityReferenceObserver) {
      ...
      case ._SHAPE_FEATURE_DEFINITION(let entity): 
        entity.configure(with: observer)
        self = ._SHAPE_FEATURE_DEFINITION(entity)
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      case ._DEGENERATE_PCURVE(let selectValue): 
        result = eDEGENERATE_PCURVE.validateWhereRules(instance:selectValue, 
      ...
      case ._DIMENSIONAL_SIZE_WITH_PATH(let selectValue): 
        result = eDIMENSIONAL_SIZE_WITH_PATH.validateWhereRules(instance:selectValue, 
      ...
      case ._RULE_SET(let selectValue): result = eRULE_SET.validateWhereRules(instance:selectValue, 
      ...
      case ._SHAPE_FEATURE_DEFINITION(let selectValue): 
        result = eSHAPE_FEATURE_DEFINITION.validateWhereRules(instance:selectValue, 
