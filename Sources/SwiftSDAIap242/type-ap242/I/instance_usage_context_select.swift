/* file: instance_usage_context_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- instance_usage_context_select (line:3831 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  CASE: process_product_association (*ENTITY*):
...
```
*/
  public enum sINSTANCE_USAGE_CONTEXT_SELECT : SDAI.Value, TypeHierarchy.sINSTANCE_USAGE_CONTEXT_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROCESS_PRODUCT_ASSOCIATION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSTANCE_USAGE_CONTEXT_SELECT``
    @_documentation(visibility:public)
    case _PROCESS_PRODUCT_ASSOCIATION(ePROCESS_PRODUCT_ASSOCIATION.PRef)	// (ENTITY)
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(ePROCESS_PRODUCT_ASSOCIATION.self) {self = ._PROCESS_PRODUCT_ASSOCIATION(base.pRef) }
    ...
    public init?<G: SDAI.GenericType>(fromGeneric generic: G?) {
      ...
      else if let base = ePROCESS_PRODUCT_ASSOCIATION.PRef.convert(fromGeneric: select) {
    ...
    public static let bareTypeName: String = "INSTANCE_USAGE_CONTEXT_SELECT"
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSTANCE_USAGE_CONTEXT_SELECT``
    public var super_ePROCESS_PRODUCT_ASSOCIATION: ePROCESS_PRODUCT_ASSOCIATION.PRef {
      switch self {
      case ._PROCESS_PRODUCT_ASSOCIATION(let entity): return entity
      default: return ePROCESS_PRODUCT_ASSOCIATION.PRef(nil)
      }
    }
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINSTANCE_USAGE_CONTEXT_SELECT``
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROCESS_PRODUCT_ASSOCIATION`` )
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      switch self {
      case ._PROCESS_PRODUCT_ASSOCIATION(let entity): return entity.persistentEntityReferences
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._PROCESS_PRODUCT_ASSOCIATION(let entity): 
        ...
        result = ePROCESS_PRODUCT_ASSOCIATION.validateWhereRules(instance: entity.eval, 
...
public protocol sINSTANCE_USAGE_CONTEXT_SELECT__TypeBehavior: SDAI.SelectType {
  ...
  var super_ePROCESS_PRODUCT_ASSOCIATION: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ePROCESS_PRODUCT_ASSOCIATION.PRef { get }
  ...
  var PROCESS: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ePRODUCT_DEFINITION_PROCESS.PRef?  { get }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sINSTANCE_USAGE_CONTEXT_SELECT__Subtype: 
  sINSTANCE_USAGE_CONTEXT_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sINSTANCE_USAGE_CONTEXT_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sINSTANCE_USAGE_CONTEXT_SELECT__Subtype {
  //MARK: CONSTRUCTORS
  ...
  var super_ePROCESS_PRODUCT_ASSOCIATION: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ePROCESS_PRODUCT_ASSOCIATION.PRef { rep.super_ePROCESS_PRODUCT_ASSOCIATION }
  ...
  var PROCESS: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ePRODUCT_DEFINITION_PROCESS.PRef?  { rep.PROCESS }
  var RELATING_PRODUCT_DEFINITION: 
