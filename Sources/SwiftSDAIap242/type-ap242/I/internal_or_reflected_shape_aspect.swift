/* file: internal_or_reflected_shape_aspect.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sINTERNAL_OR_REFLECTED_SHAPE_ASPECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sINTERNAL_OR_REFLECTED_SHAPE_ASPECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tIDENTIFIER`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINTERNAL_OR_REFLECTED_SHAPE_ASPECT``
    @_documentation(visibility:public)
    case _IDENTIFIER(tIDENTIFIER)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSHAPE_ASPECT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINTERNAL_OR_REFLECTED_SHAPE_ASPECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINTERNAL_OR_REFLECTED_SHAPE_ASPECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sINTERNAL_OR_REFLECTED_SHAPE_ASPECT__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sINTERNAL_OR_REFLECTED_SHAPE_ASPECT__type, SDAI.DefinedType
