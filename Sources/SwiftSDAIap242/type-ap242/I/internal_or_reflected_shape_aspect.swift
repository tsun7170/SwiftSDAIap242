/* file: internal_or_reflected_shape_aspect.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  TYPE internal_or_reflected_shape_aspect = SELECT
    ( identifier (*TYPE*),
     shape_aspect (*ENTITY*) );
  END_TYPE; -- internal_or_reflected_shape_aspect (line:3838 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sINTERNAL_OR_REFLECTED_SHAPE_ASPECT : SDAI.Value, TypeHierarchy.sINTERNAL_OR_REFLECTED_SHAPE_ASPECT__TypeBehavior {

    /// SELECT case (TYPE)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tIDENTIFIER`` (TYPE)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sINTERNAL_OR_REFLECTED_SHAPE_ASPECT``
    ...
    public static let bareTypeName: String = "INTERNAL_OR_REFLECTED_SHAPE_ASPECT"
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      switch self {
      case ._IDENTIFIER: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
...
public protocol sINTERNAL_OR_REFLECTED_SHAPE_ASPECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sINTERNAL_OR_REFLECTED_SHAPE_ASPECT__Subtype: 
  sINTERNAL_OR_REFLECTED_SHAPE_ASPECT__TypeBehavior, SDAI.DefinedType
where Supertype: sINTERNAL_OR_REFLECTED_SHAPE_ASPECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sINTERNAL_OR_REFLECTED_SHAPE_ASPECT__Subtype {
  //MARK: CONSTRUCTORS
