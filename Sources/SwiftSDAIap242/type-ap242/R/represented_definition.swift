/* file: represented_definition.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sREPRESENTED_DEFINITION : SDAI.Value, TypeHierarchy.sREPRESENTED_DEFINITION__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eGENERAL_PROPERTY`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sREPRESENTED_DEFINITION``
...
public protocol sREPRESENTED_DEFINITION__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sREPRESENTED_DEFINITION__Subtype: sREPRESENTED_DEFINITION__TypeBehavior, SDAI.DefinedType
where Supertype: sREPRESENTED_DEFINITION__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sREPRESENTED_DEFINITION__Subtype {
  //MARK: CONSTRUCTORS
