/* file: repackage_options.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  TYPE repackage_options = ENUMERATION OF
    ( ro_nochange,
     ro_wrap_as_tuple,
     ro_unwrap_tuple );
  END_TYPE; -- repackage_options (line:5043 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum nREPACKAGE_OPTIONS : SDAI.ENUMERATION, SDAI.Value, 
    TypeHierarchy.nREPACKAGE_OPTIONS__TypeBehavior {
    /// ENUMERATION case
    ///
    /// - defined in: ``nREPACKAGE_OPTIONS``
    case RO_NOCHANGE
    /// ENUMERATION case
    ///
    /// - defined in: ``nREPACKAGE_OPTIONS``
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.REPACKAGE_OPTIONS"
    ...
    public static let bareTypeName: String = "REPACKAGE_OPTIONS"
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nREPACKAGE_OPTIONS__TypeBehavior: SDAI.EnumerationType {}
}

extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nREPACKAGE_OPTIONS__Subtype: nREPACKAGE_OPTIONS__TypeBehavior, SDAI.DefinedType
where Supertype: nREPACKAGE_OPTIONS__TypeBehavior
{}
}
