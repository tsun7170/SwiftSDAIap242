/* file: requirement_assigned_item.swift 	 generated: Tue Nov 16 05:35:44 2021 */
...
/*
  ...
  END_TYPE; -- requirement_assigned_item (line:5078 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  public enum sREQUIREMENT_ASSIGNED_ITEM : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sREQUIREMENT_ASSIGNED_ITEM__type {
    ...
    /// SELECT case ``eACTION_METHOD`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _ACTION_METHOD(eACTION_METHOD)	// (ENTITY)

    /// SELECT case ``eALTERNATE_PRODUCT_RELATIONSHIP`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _ALTERNATE_PRODUCT_RELATIONSHIP(eALTERNATE_PRODUCT_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``eAPPLIED_ACTION_METHOD_ASSIGNMENT`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _APPLIED_ACTION_METHOD_ASSIGNMENT(eAPPLIED_ACTION_METHOD_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_STATE_OBSERVED_ASSIGNMENT`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _APPLIED_STATE_OBSERVED_ASSIGNMENT(eAPPLIED_STATE_OBSERVED_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eAPPLIED_STATE_TYPE_ASSIGNMENT`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _APPLIED_STATE_TYPE_ASSIGNMENT(eAPPLIED_STATE_TYPE_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``eASSEMBLY_COMPONENT_USAGE`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _ASSEMBLY_COMPONENT_USAGE(eASSEMBLY_COMPONENT_USAGE)	// (ENTITY)

    /// SELECT case ``eASSEMBLY_COMPONENT_USAGE_SUBSTITUTE`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _ASSEMBLY_COMPONENT_USAGE_SUBSTITUTE(eASSEMBLY_COMPONENT_USAGE_SUBSTITUTE)	// (ENTITY)

    /// SELECT case ``eCHARACTERIZED_OBJECT`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _CHARACTERIZED_OBJECT(eCHARACTERIZED_OBJECT)	// (ENTITY)

    /// SELECT case ``eCONFIGURATION_ITEM`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _CONFIGURATION_ITEM(eCONFIGURATION_ITEM)	// (ENTITY)

    /// SELECT case ``eDESCRIPTIVE_REPRESENTATION_ITEM`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _DESCRIPTIVE_REPRESENTATION_ITEM(eDESCRIPTIVE_REPRESENTATION_ITEM)	// (ENTITY)

    /// SELECT case ``eDIMENSIONAL_LOCATION`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _DIMENSIONAL_LOCATION(eDIMENSIONAL_LOCATION)	// (ENTITY)

    /// SELECT case ``eDIMENSIONAL_SIZE`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _DIMENSIONAL_SIZE(eDIMENSIONAL_SIZE)	// (ENTITY)

    /// SELECT case ``eGEOMETRIC_TOLERANCE`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _GEOMETRIC_TOLERANCE(eGEOMETRIC_TOLERANCE)	// (ENTITY)

    /// SELECT case ``eINTERFACE_CONNECTOR_OCCURRENCE`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _INTERFACE_CONNECTOR_OCCURRENCE(eINTERFACE_CONNECTOR_OCCURRENCE)	// (ENTITY)

    /// SELECT case ``eORGANIZATIONAL_PROJECT`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _ORGANIZATIONAL_PROJECT(eORGANIZATIONAL_PROJECT)	// (ENTITY)

    /// SELECT case ``ePRODUCT`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _PRODUCT(ePRODUCT)	// (ENTITY)

    /// SELECT case ``ePRODUCT_CLASS`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _PRODUCT_CLASS(ePRODUCT_CLASS)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _PRODUCT_DEFINITION(ePRODUCT_DEFINITION)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_FORMATION`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _PRODUCT_DEFINITION_FORMATION(ePRODUCT_DEFINITION_FORMATION)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_GROUP_ASSIGNMENT`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _PRODUCT_DEFINITION_GROUP_ASSIGNMENT(ePRODUCT_DEFINITION_GROUP_ASSIGNMENT)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_RELATIONSHIP`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _PRODUCT_DEFINITION_RELATIONSHIP(ePRODUCT_DEFINITION_RELATIONSHIP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_GROUP`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _PRODUCT_GROUP(ePRODUCT_GROUP)	// (ENTITY)

    /// SELECT case ``ePRODUCT_GROUP_MEMBERSHIP`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _PRODUCT_GROUP_MEMBERSHIP(ePRODUCT_GROUP_MEMBERSHIP)	// (ENTITY)

    /// SELECT case ``eQUANTIFIED_ASSEMBLY_COMPONENT_USAGE`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _QUANTIFIED_ASSEMBLY_COMPONENT_USAGE(eQUANTIFIED_ASSEMBLY_COMPONENT_USAGE)	// (ENTITY)

    /// SELECT case ``eREPRESENTATION`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _REPRESENTATION(eREPRESENTATION)	// (ENTITY)

    /// SELECT case ``eSHAPE_ASPECT`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _SHAPE_ASPECT(eSHAPE_ASPECT)	// (ENTITY)

    /// SELECT case ``eSTATE_OBSERVED`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _STATE_OBSERVED(eSTATE_OBSERVED)	// (ENTITY)

    /// SELECT case ``eSTATE_TYPE`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _STATE_TYPE(eSTATE_TYPE)	// (ENTITY)

    /// SELECT case ``eVALIDATION`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _VALIDATION(eVALIDATION)	// (ENTITY)

    /// SELECT case ``eVERIFICATION`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    case _VERIFICATION(eVERIFICATION)	// (ENTITY)

    /// SELECT case ``eVERSIONED_ACTION_REQUEST`` (ENTITY) in ``sREQUIREMENT_ASSIGNED_ITEM``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      else if let base = complex.entityReference(eQUANTIFIED_ASSEMBLY_COMPONENT_USAGE.self) {self = ._QUANTIFIED_ASSEMBLY_COMPONENT_USAGE(base) }
    ...
    public init?<G: SDAIGenericType>(fromGeneric generic: G?) {
      ...
      else if let base = eQUANTIFIED_ASSEMBLY_COMPONENT_USAGE.convert(fromGeneric: select) {
    ...
    public static var bareTypeName: String = "REQUIREMENT_ASSIGNED_ITEM"
    ...
    public var super_ePRODUCT_DEFINITION_USAGE: ePRODUCT_DEFINITION_USAGE? {
      ...
      case ._QUANTIFIED_ASSEMBLY_COMPONENT_USAGE(let entity): return entity.super_ePRODUCT_DEFINITION_USAGE
      default: return nil
      }
    }
    ...
    public var super_eASSEMBLY_COMPONENT_USAGE: eASSEMBLY_COMPONENT_USAGE? {
      ...
      case ._QUANTIFIED_ASSEMBLY_COMPONENT_USAGE(let entity): return entity.super_eASSEMBLY_COMPONENT_USAGE
      default: return nil
      }
    }
    ...
    /// attribute of SELECT type ``sREQUIREMENT_ASSIGNED_ITEM``
    ...
    /// - origin: ENTITY( ``eQUANTIFIED_ASSEMBLY_COMPONENT_USAGE`` )
    ...
    public mutating func configure(with observer: SDAI.EntityReferenceObserver) {
      ...
      case ._QUANTIFIED_ASSEMBLY_COMPONENT_USAGE(let entity): 
        entity.configure(with: observer)
        self = ._QUANTIFIED_ASSEMBLY_COMPONENT_USAGE(entity)
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      case ._QUANTIFIED_ASSEMBLY_COMPONENT_USAGE(let selectValue): 
        result = eQUANTIFIED_ASSEMBLY_COMPONENT_USAGE.validateWhereRules(instance:selectValue, 
