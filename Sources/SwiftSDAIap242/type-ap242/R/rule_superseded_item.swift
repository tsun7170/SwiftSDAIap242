/* file: rule_superseded_item.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_TYPE; -- rule_superseded_item (line:5177 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sRULE_SUPERSEDED_ITEM : SDAI.Value, TypeHierarchy.sRULE_SUPERSEDED_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_FORMATION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sRULE_SUPERSEDED_ITEM``
    ...
    public static let bareTypeName: String = "RULE_SUPERSEDED_ITEM"
...
public protocol sRULE_SUPERSEDED_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sRULE_SUPERSEDED_ITEM__Subtype: sRULE_SUPERSEDED_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sRULE_SUPERSEDED_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sRULE_SUPERSEDED_ITEM__Subtype {
  //MARK: CONSTRUCTORS
