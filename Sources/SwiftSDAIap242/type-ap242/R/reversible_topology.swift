/* file: reversible_topology.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
*/
  public enum sREVERSIBLE_TOPOLOGY : SDAI.Value, TypeHierarchy.sREVERSIBLE_TOPOLOGY__TypeBehavior {
    ...
    /// SELECT case (TYPE)
      ...
      /// - may yield: aggregate[``sREVERSIBLE_TOPOLOGY_ITEM``]
    ...
    public typealias ELEMENT = sREVERSIBLE_TOPOLOGY_ITEM
    public var hiBound: Int? {
      switch self {
      case ._LIST_OF_REVERSIBLE_TOPOLOGY_ITEM(let selection): return selection.hiBound
      case ._SET_OF_REVERSIBLE_TOPOLOGY_ITEM(let selection): return selection.hiBound
      default: return nil
      }
    }
    public var hiIndex: Int {
      switch self {
      case ._LIST_OF_REVERSIBLE_TOPOLOGY_ITEM(let selection): return selection.hiIndex
      case ._SET_OF_REVERSIBLE_TOPOLOGY_ITEM(let selection): return selection.hiIndex
      default: return 0
      }
    }
    public var loBound: Int {
      switch self {
      case ._LIST_OF_REVERSIBLE_TOPOLOGY_ITEM(let selection): return selection.loBound
      case ._SET_OF_REVERSIBLE_TOPOLOGY_ITEM(let selection): return selection.loBound
      default: return 0
      }
    }
    public var loIndex: Int {
      switch self {
      case ._LIST_OF_REVERSIBLE_TOPOLOGY_ITEM(let selection): return selection.loIndex
      case ._SET_OF_REVERSIBLE_TOPOLOGY_ITEM(let selection): return selection.loIndex
      default: return 0
      }
    }
    public var size: Int {
      switch self {
      case ._LIST_OF_REVERSIBLE_TOPOLOGY_ITEM(let selection): return selection.size
      case ._SET_OF_REVERSIBLE_TOPOLOGY_ITEM(let selection): return selection.size
      default: return 0
      }
    }
    public var isEmpty: Bool {
      switch self {
      case ._LIST_OF_REVERSIBLE_TOPOLOGY_ITEM(let selection): return selection.isEmpty
      case ._SET_OF_REVERSIBLE_TOPOLOGY_ITEM(let selection): return selection.isEmpty
      default: return true
      }
    }
    ...
    public subscript(index: Int?) -> ELEMENT? {
      switch self {
      case ._LIST_OF_REVERSIBLE_TOPOLOGY_ITEM(let selection): return selection[index]
      case ._SET_OF_REVERSIBLE_TOPOLOGY_ITEM(let selection): return selection[index]
      default: return nil
      }
    }
    ...
    public func makeIterator() -> AnyIterator<ELEMENT?> {
      switch self {
      case ._LIST_OF_REVERSIBLE_TOPOLOGY_ITEM(let selection): 
        return AnyIterator<ELEMENT?>(selection.lazy.map({SDAI.FORCE_OPTIONAL($0)}).makeIterator())
      case ._SET_OF_REVERSIBLE_TOPOLOGY_ITEM(let selection): 
        return AnyIterator<ELEMENT?>(selection.lazy.map({SDAI.FORCE_OPTIONAL($0)}).makeIterator())
    ...
    public func CONTAINS(elem: ELEMENT?) -> SDAI.LOGICAL {
      switch self {
      case ._LIST_OF_REVERSIBLE_TOPOLOGY_ITEM(let selection): return selection.CONTAINS(elem)
      case ._SET_OF_REVERSIBLE_TOPOLOGY_ITEM(let selection): return selection.CONTAINS(elem)
...
public protocol sREVERSIBLE_TOPOLOGY__TypeBehavior: SDAI.SelectType, SDAI.AggregationType
  where ELEMENT == AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.sREVERSIBLE_TOPOLOGY_ITEM {
