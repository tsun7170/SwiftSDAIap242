/* file: reversible_topology.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sREVERSIBLE_TOPOLOGY : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sREVERSIBLE_TOPOLOGY__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tLIST_OF_REVERSIBLE_TOPOLOGY_ITEM`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sREVERSIBLE_TOPOLOGY``
    @_documentation(visibility:public)
    case _LIST_OF_REVERSIBLE_TOPOLOGY_ITEM(tLIST_OF_REVERSIBLE_TOPOLOGY_ITEM)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sREVERSIBLE_TOPOLOGY_ITEM`` (SELECT) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sREVERSIBLE_TOPOLOGY``
    @_documentation(visibility:public)
    case _REVERSIBLE_TOPOLOGY_ITEM(sREVERSIBLE_TOPOLOGY_ITEM)	// (SELECT)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tSET_OF_REVERSIBLE_TOPOLOGY_ITEM`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sREVERSIBLE_TOPOLOGY``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sREVERSIBLE_TOPOLOGY``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sREVERSIBLE_TOPOLOGY__type: SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sREVERSIBLE_TOPOLOGY__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sREVERSIBLE_TOPOLOGY__type, SDAI.DefinedType
