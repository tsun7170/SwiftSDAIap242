/* file: representation_proxy_select.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sREPRESENTATION_PROXY_SELECT : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sREPRESENTATION_PROXY_SELECT__type {
    ...
    /// SELECT case ``ePRODUCT_DEFINITION_FORMATION`` (ENTITY) in ``sREPRESENTATION_PROXY_SELECT``
    ...
    /// attribute of SELECT type ``sREPRESENTATION_PROXY_SELECT``
