/* file: radial_geometry_constraint_element.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT : SDAI.Value, TypeHierarchy.sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCIRCLE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT``
...
public protocol sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT__Subtype: 
  sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT__TypeBehavior, SDAI.DefinedType
where Supertype: sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT__Subtype {
  //MARK: CONSTRUCTORS
