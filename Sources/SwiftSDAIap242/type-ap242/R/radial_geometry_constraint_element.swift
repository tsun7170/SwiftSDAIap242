/* file: radial_geometry_constraint_element.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
/*
  ...
  END_TYPE; -- radial_geometry_constraint_element (line:5012 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCIRCLE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    case _CIRCLE(eCIRCLE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONICAL_SURFACE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    case _CONICAL_SURFACE(eCONICAL_SURFACE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCYLINDRICAL_SURFACE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    case _CYLINDRICAL_SURFACE(eCYLINDRICAL_SURFACE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRIGHT_CIRCULAR_CONE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    case _RIGHT_CIRCULAR_CONE(eRIGHT_CIRCULAR_CONE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRIGHT_CIRCULAR_CYLINDER`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    case _RIGHT_CIRCULAR_CYLINDER(eRIGHT_CIRCULAR_CYLINDER.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSPHERE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    case _SPHERE(eSPHERE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSPHERICAL_SURFACE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    ...
    public static let bareTypeName: String = "RADIAL_GEOMETRY_CONSTRAINT_ELEMENT"
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sRADIAL_GEOMETRY_CONSTRAINT_ELEMENT__type, SDAI.DefinedType
