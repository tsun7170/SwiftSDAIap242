/* file: real_interval.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sREAL_INTERVAL : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sREAL_INTERVAL__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREAL_INTERVAL_FROM_MIN`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sREAL_INTERVAL``
    @_documentation(visibility:public)
    case _REAL_INTERVAL_FROM_MIN(eREAL_INTERVAL_FROM_MIN.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREAL_INTERVAL_TO_MAX`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sREAL_INTERVAL``
    @_documentation(visibility:public)
    case _REAL_INTERVAL_TO_MAX(eREAL_INTERVAL_TO_MAX.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eFINITE_REAL_INTERVAL`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sREAL_INTERVAL``
    @_documentation(visibility:public)
    case _FINITE_REAL_INTERVAL(eFINITE_REAL_INTERVAL.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eELEMENTARY_SPACE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sREAL_INTERVAL``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sREAL_INTERVAL``
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      case ._ELEMENTARY_SPACE(let entity): 
        result = eELEMENTARY_SPACE.validateWhereRules(instance: entity.eval, 
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sREAL_INTERVAL__type: SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sREAL_INTERVAL__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sREAL_INTERVAL__type, SDAI.DefinedType
