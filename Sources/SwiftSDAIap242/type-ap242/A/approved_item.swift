/* file: approved_item.swift 	 generated: Sun Oct 31 15:32:10 2021 */
...
/*
  TYPE approved_item = SELECT
    ( certification (*ENTITY*),
     ...
     start_work (*ENTITY*) );
  END_TYPE; -- approved_item (line:776 file:ap242ed2_mim_lf_v1.101.TY.exp)
...
*/
  public enum sAPPROVED_ITEM : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sAPPROVED_ITEM__type {
    ...
    /// SELECT case ``eCERTIFICATION`` (ENTITY) in ``sAPPROVED_ITEM``
    case _CERTIFICATION(eCERTIFICATION)	// (ENTITY)

    /// SELECT case ``eCHANGE`` (ENTITY) in ``sAPPROVED_ITEM``
    case _CHANGE(eCHANGE)	// (ENTITY)

    /// SELECT case ``eCHANGE_REQUEST`` (ENTITY) in ``sAPPROVED_ITEM``
    case _CHANGE_REQUEST(eCHANGE_REQUEST)	// (ENTITY)

    /// SELECT case ``eCONFIGURATION_EFFECTIVITY`` (ENTITY) in ``sAPPROVED_ITEM``
    case _CONFIGURATION_EFFECTIVITY(eCONFIGURATION_EFFECTIVITY)	// (ENTITY)

    /// SELECT case ``eCONFIGURATION_ITEM`` (ENTITY) in ``sAPPROVED_ITEM``
    case _CONFIGURATION_ITEM(eCONFIGURATION_ITEM)	// (ENTITY)

    /// SELECT case ``eCONTRACT`` (ENTITY) in ``sAPPROVED_ITEM``
    case _CONTRACT(eCONTRACT)	// (ENTITY)

    /// SELECT case ``ePRODUCT`` (ENTITY) in ``sAPPROVED_ITEM``
    case _PRODUCT(ePRODUCT)	// (ENTITY)

    /// SELECT case ``eSECURITY_CLASSIFICATION`` (ENTITY) in ``sAPPROVED_ITEM``
    case _SECURITY_CLASSIFICATION(eSECURITY_CLASSIFICATION)	// (ENTITY)

    /// SELECT case ``eSTART_REQUEST`` (ENTITY) in ``sAPPROVED_ITEM``
    case _START_REQUEST(eSTART_REQUEST)	// (ENTITY)

    /// SELECT case ``eSTART_WORK`` (ENTITY) in ``sAPPROVED_ITEM``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eCERTIFICATION.self) {self = ._CERTIFICATION(base) }
      else if let base = complex.entityReference(eCHANGE.self) {self = ._CHANGE(base) }
    ...
    public static var bareTypeName: String = "APPROVED_ITEM"
    ...
    /// attribute of SELECT type ``sAPPROVED_ITEM``
    ...
    public static var typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.APPROVED_ITEM"
