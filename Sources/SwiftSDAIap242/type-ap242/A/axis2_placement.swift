/* file: axis2_placement.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_TYPE; -- axis2_placement (line:1098 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sAXIS2_PLACEMENT : SDAI.Value, TypeHierarchy.sAXIS2_PLACEMENT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAXIS2_PLACEMENT_2D`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIS2_PLACEMENT``
    ...
    public static let bareTypeName: String = "AXIS2_PLACEMENT"
    ...
    public var P: (SDAI.LIST<eDIRECTION.PRef>/*[2:3]*/ )?  {
      switch self {
      case ._AXIS2_PLACEMENT_2D(let entity): return SDAI.LIST<eDIRECTION.PRef>(entity.P)
      case ._AXIS2_PLACEMENT_3D(let entity): return SDAI.LIST<eDIRECTION.PRef>(entity.P)
      }
    }
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.AXIS2_PLACEMENT"
...
public protocol sAXIS2_PLACEMENT__TypeBehavior: SDAI.SelectType {
  ...
  //MARK: ENTITY ATTRIBUTE REFERENCES
  var P: (SDAI.LIST<AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDIRECTION.PRef>/*[2:3]*/ )?  { get }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sAXIS2_PLACEMENT__Subtype: sAXIS2_PLACEMENT__TypeBehavior, SDAI.DefinedType
where Supertype: sAXIS2_PLACEMENT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sAXIS2_PLACEMENT__Subtype {
  //MARK: CONSTRUCTORS
  ...
  //MARK: ENTITY ATTRIBUTE REFERENCES
  var P: (SDAI.LIST<AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDIRECTION.PRef>/*[2:3]*/ )?  { rep.P }
