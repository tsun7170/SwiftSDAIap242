/* file: annotation_text_occurrence_item.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
```
*/
  public enum sANNOTATION_TEXT_OCCURRENCE_ITEM : SDAI.Value, TypeHierarchy.sANNOTATION_TEXT_OCCURRENCE_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANNOTATION_TEXT`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sANNOTATION_TEXT_OCCURRENCE_ITEM``
...
public protocol sANNOTATION_TEXT_OCCURRENCE_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sANNOTATION_TEXT_OCCURRENCE_ITEM__Subtype: 
  sANNOTATION_TEXT_OCCURRENCE_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sANNOTATION_TEXT_OCCURRENCE_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sANNOTATION_TEXT_OCCURRENCE_ITEM__Subtype {
  //MARK: CONSTRUCTORS
