/* file: annotation_text_occurrence_item.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
/*
  TYPE annotation_text_occurrence_item = SELECT
    ( annotation_text (*ENTITY*),
     ...
     text_literal (*ENTITY*) );
  END_TYPE; -- annotation_text_occurrence_item (line:647 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sANNOTATION_TEXT_OCCURRENCE_ITEM : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sANNOTATION_TEXT_OCCURRENCE_ITEM__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANNOTATION_TEXT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sANNOTATION_TEXT_OCCURRENCE_ITEM``
    @_documentation(visibility:public)
    case _ANNOTATION_TEXT(eANNOTATION_TEXT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANNOTATION_TEXT_CHARACTER`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sANNOTATION_TEXT_OCCURRENCE_ITEM``
    @_documentation(visibility:public)
    case _ANNOTATION_TEXT_CHARACTER(eANNOTATION_TEXT_CHARACTER.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCOMPOSITE_TEXT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sANNOTATION_TEXT_OCCURRENCE_ITEM``
    @_documentation(visibility:public)
    case _COMPOSITE_TEXT(eCOMPOSITE_TEXT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDEFINED_CHARACTER_GLYPH`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sANNOTATION_TEXT_OCCURRENCE_ITEM``
    @_documentation(visibility:public)
    case _DEFINED_CHARACTER_GLYPH(eDEFINED_CHARACTER_GLYPH.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTEXT_LITERAL`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sANNOTATION_TEXT_OCCURRENCE_ITEM``
    @_documentation(visibility:public)
    ...
    public static let bareTypeName: String = "ANNOTATION_TEXT_OCCURRENCE_ITEM"
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sANNOTATION_TEXT_OCCURRENCE_ITEM``
    ...
    public static let typeName: String = 
      "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ANNOTATION_TEXT_OCCURRENCE_ITEM"
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sANNOTATION_TEXT_OCCURRENCE_ITEM__type: 
  SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sANNOTATION_TEXT_OCCURRENCE_ITEM__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sANNOTATION_TEXT_OCCURRENCE_ITEM__type, SDAI.DefinedType
where Supertype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sANNOTATION_TEXT_OCCURRENCE_ITEM__type
{}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sANNOTATION_TEXT_OCCURRENCE_ITEM__subtype {
  //MARK: CONSTRUCTORS
