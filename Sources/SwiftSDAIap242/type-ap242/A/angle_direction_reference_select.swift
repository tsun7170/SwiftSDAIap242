/* file: angle_direction_reference_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sANGLE_DIRECTION_REFERENCE_SELECT : SDAI.Value, TypeHierarchy.sANGLE_DIRECTION_REFERENCE_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sANGLE_DIRECTION_REFERENCE_SELECT``
    ...
    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT_PATH`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sANGLE_DIRECTION_REFERENCE_SELECT``
    @_documentation(visibility:public)
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      ...
      case ._POINT_PATH(let entity): return entity.persistentEntityReferences
      }
    }
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._POINT_PATH(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = ePOINT_PATH.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case nil: break
      }
...
public protocol sANGLE_DIRECTION_REFERENCE_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sANGLE_DIRECTION_REFERENCE_SELECT__Subtype: 
  sANGLE_DIRECTION_REFERENCE_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sANGLE_DIRECTION_REFERENCE_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sANGLE_DIRECTION_REFERENCE_SELECT__Subtype {
  //MARK: CONSTRUCTORS
