/* file: angle_direction_reference_select.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sANGLE_DIRECTION_REFERENCE_SELECT : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sANGLE_DIRECTION_REFERENCE_SELECT__type {
    ...
    /// SELECT case ``eCURVE`` (ENTITY) in ``sANGLE_DIRECTION_REFERENCE_SELECT``
    case _CURVE(eCURVE)	// (ENTITY)

    /// SELECT case ``eDIRECTION`` (ENTITY) in ``sANGLE_DIRECTION_REFERENCE_SELECT``
    case _DIRECTION(eDIRECTION)	// (ENTITY)

    /// SELECT case ``ePOINT_PATH`` (ENTITY) in ``sANGLE_DIRECTION_REFERENCE_SELECT``
    case _POINT_PATH(ePOINT_PATH)	// (ENTITY)
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      else if let base = complex.entityReference(ePOINT_PATH.self) {self = ._POINT_PATH(base) }
      else { return nil }
    }
    ...
    public init?<G: SDAIGenericType>(fromGeneric generic: G?) {
      ...
      else if let base = ePOINT_PATH.convert(fromGeneric: select) {
    ...
    public var super_eREPRESENTATION_ITEM: eREPRESENTATION_ITEM? {
      ...
      case ._POINT_PATH(let entity): return entity.super_eREPRESENTATION_ITEM
      }
    }
    ...
    public var super_eGEOMETRIC_REPRESENTATION_ITEM: eGEOMETRIC_REPRESENTATION_ITEM? {
      ...
      case ._POINT_PATH(let entity): return entity.super_eGEOMETRIC_REPRESENTATION_ITEM
      }
    }

    public var super_eCOMPOUND_REPRESENTATION_ITEM: eCOMPOUND_REPRESENTATION_ITEM? {
      switch self {
      case ._POINT_PATH(let entity): return entity.super_eCOMPOUND_REPRESENTATION_ITEM
      default: return nil
      }
    }
    ...
    /// attribute of SELECT type ``sANGLE_DIRECTION_REFERENCE_SELECT``
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      case ._POINT_PATH(let selectValue): result = ePOINT_PATH.validateWhereRules(instance:selectValue, 
