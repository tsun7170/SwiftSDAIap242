/* file: area_or_view.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sAREA_OR_VIEW : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sAREA_OR_VIEW__type {
    ...
    /// SELECT case ``ePRESENTATION_AREA`` (ENTITY) in ``sAREA_OR_VIEW``
    case _PRESENTATION_AREA(ePRESENTATION_AREA)	// (ENTITY)

    /// SELECT case ``ePRESENTATION_VIEW`` (ENTITY) in ``sAREA_OR_VIEW``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(ePRESENTATION_AREA.self) {self = ._PRESENTATION_AREA(base) }
    ...
    /// attribute of SELECT type ``sAREA_OR_VIEW``
