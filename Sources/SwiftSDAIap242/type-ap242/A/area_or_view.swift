/* file: area_or_view.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
/*
  ...
  END_TYPE; -- area_or_view (line:801 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sAREA_OR_VIEW : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sAREA_OR_VIEW__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESENTATION_AREA`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAREA_OR_VIEW``
    @_documentation(visibility:public)
    case _PRESENTATION_AREA(ePRESENTATION_AREA.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESENTATION_VIEW`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAREA_OR_VIEW``
    @_documentation(visibility:public)
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(ePRESENTATION_AREA.self) {self = ._PRESENTATION_AREA(base.pRef) }
    ...
    public static let bareTypeName: String = "AREA_OR_VIEW"
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAREA_OR_VIEW``
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.AREA_OR_VIEW"
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sAREA_OR_VIEW__type: SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sAREA_OR_VIEW__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sAREA_OR_VIEW__type, SDAI.DefinedType
where Supertype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sAREA_OR_VIEW__type
{}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sAREA_OR_VIEW__subtype {
  //MARK: CONSTRUCTORS
