/* file: area_or_view.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sAREA_OR_VIEW : SDAI.Value, TypeHierarchy.sAREA_OR_VIEW__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRESENTATION_AREA`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAREA_OR_VIEW``
...
public protocol sAREA_OR_VIEW__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sAREA_OR_VIEW__Subtype: sAREA_OR_VIEW__TypeBehavior, SDAI.DefinedType
where Supertype: sAREA_OR_VIEW__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sAREA_OR_VIEW__Subtype {
  //MARK: CONSTRUCTORS
