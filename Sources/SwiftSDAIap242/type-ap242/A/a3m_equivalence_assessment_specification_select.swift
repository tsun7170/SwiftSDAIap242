/* file: a3m_equivalence_assessment_specification_select.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
*/
  public enum sA3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT : SDAI.Value, 
    ...
    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sA3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT``
    @_documentation(visibility:public)
    case _A3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST(
      eA3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sA3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sA3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sA3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sA3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT__type, SDAI.DefinedType
