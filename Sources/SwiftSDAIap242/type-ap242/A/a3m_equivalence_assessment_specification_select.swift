/* file: a3m_equivalence_assessment_specification_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- a3m_equivalence_assessment_specification_select (line:191 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  CASE: a3m_equivalence_assessment_by_logical_test (*ENTITY*):
  ATTR:  description: text
  ATTR:  id: identifier
  ATTR:  name: label

  CASE: a3m_equivalence_assessment_by_numerical_test (*ENTITY*):
  ATTR:  description: text
...
```
*/
  public enum sA3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT : SDAI.Value, 
    TypeHierarchy.sA3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sA3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT``
    @_documentation(visibility:public)
    case _A3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST(
      eA3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST.PRef)	// (ENTITY)

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sA3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT``
    @_documentation(visibility:public)
    case _A3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST(
      eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST.PRef)	// (ENTITY)
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eA3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST.self) {self = ._A3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST(base.pRef) }
      else if let base = complex.entityReference(eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST.self) {self = ._A3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST(base.pRef) }
      else { return nil }
    }
    ...
    public init?<G: SDAI.GenericType>(fromGeneric generic: G?) {
      ...
      else if let base = eA3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST.PRef.convert(fromGeneric: select) {
        self = ._A3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST(base)
      }
      else if let base = eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST.PRef.convert(fromGeneric: select) {
    ...
    public static let bareTypeName: String = "A3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT"
    ...
    public var super_eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST: 
      eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST.PRef {
      switch self {
      case ._A3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST(let entity): return entity
      default: return eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST.PRef(nil)
      }
    }
    ...
    public var super_eA3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST: 
      eA3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST.PRef {
      switch self {
      case ._A3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST(let entity): return entity
      default: return eA3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST.PRef(nil)
      }
    }
    ...
    public var super_eDATA_EQUIVALENCE_ASSESSMENT_SPECIFICATION: 
      eDATA_EQUIVALENCE_ASSESSMENT_SPECIFICATION.PRef {
      switch self {
      case ._A3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST(let entity): return eDATA_EQUIVALENCE_ASSESSMENT_SPECIFICATION.PRef(entity.eval?.super_eDATA_EQUIVALENCE_ASSESSMENT_SPECIFICATION)
      case ._A3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST(let entity): return eDATA_EQUIVALENCE_ASSESSMENT_SPECIFICATION.PRef(entity.eval?.super_eDATA_EQUIVALENCE_ASSESSMENT_SPECIFICATION)
      }
    }
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sA3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT``
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST`` )
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST`` )
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      switch self {
      case ._A3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST(let entity): return entity.persistentEntityReferences
      case ._A3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST(let entity): return entity.persistentEntityReferences
      }
    }
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._A3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST(let entity): 
        ...
        result = eA3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST.validateWhereRules(instance: entity.eval, 
        prefix:prefix + "\\\(entity)")
      case ._A3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST.validateWhereRules(instance: entity.eval, 
        prefix:prefix + "\\\(entity)")
      case nil: break
      }
...
public protocol sA3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT__TypeBehavior: SDAI.SelectType {
  //MARK: GROUP REFERENCES
  var super_eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST.PRef { get }
  var super_eA3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eA3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST.PRef { get }
  var super_eDATA_EQUIVALENCE_ASSESSMENT_SPECIFICATION: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDATA_EQUIVALENCE_ASSESSMENT_SPECIFICATION.PRef { get }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sA3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT__Subtype: 
  sA3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sA3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sA3M_EQUIVALENCE_ASSESSMENT_SPECIFICATION_SELECT__Subtype {
  //MARK: CONSTRUCTORS
  ...
  //MARK: GROUP REFERENCES
  var super_eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST.PRef { rep.super_eA3M_EQUIVALENCE_ASSESSMENT_BY_NUMERICAL_TEST }
  var super_eA3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eA3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST.PRef { rep.super_eA3M_EQUIVALENCE_ASSESSMENT_BY_LOGICAL_TEST }
  var super_eDATA_EQUIVALENCE_ASSESSMENT_SPECIFICATION: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDATA_EQUIVALENCE_ASSESSMENT_SPECIFICATION.PRef { rep.super_eDATA_EQUIVALENCE_ASSESSMENT_SPECIFICATION }
