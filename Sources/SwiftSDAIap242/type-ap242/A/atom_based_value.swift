/* file: atom_based_value.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  TYPE atom_based_value = SELECT
    ( atom_based_tuple (*TYPE*),
     maths_atom (*SELECT*) );
  END_TYPE; -- atom_based_value (line:852 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  CASE: atom_based_tuple (*TYPE*): atom_based_tuple

  CASE: maths_atom (*SELECT*):
...
```
*/
  public enum sATOM_BASED_VALUE : SDAI.Value, TypeHierarchy.sATOM_BASED_VALUE__TypeBehavior {

    /// SELECT case (TYPE)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tATOM_BASED_TUPLE`` (TYPE)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sATOM_BASED_VALUE``
    ...
    /// SELECT case (SELECT)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_ATOM`` (SELECT)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sATOM_BASED_VALUE``
    @_documentation(visibility:public)
    ...
    public static let bareTypeName: String = "ATOM_BASED_VALUE"
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ATOM_BASED_VALUE"
    public var asFundamentalType: FundamentalType { return self }

    //MARK: SDAI.EntityReferenceYielding
    public var entityReferences: AnySequence<SDAI.EntityReference> {
      switch self {
      case ._ATOM_BASED_TUPLE(let aggregate): return aggregate.entityReferences
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      switch self {
      case ._ATOM_BASED_TUPLE(let aggregate): return aggregate.persistentEntityReferences
      case ._MATHS_ATOM(let select): return select.persistentEntityReferences
      }
    }

    public func isHolding(entityReference: SDAI.EntityReference) -> Bool {
      switch self {
      case ._ATOM_BASED_TUPLE(let aggregate): 
        return aggregate.isHolding(entityReference: entityReference)
      case ._MATHS_ATOM(let select): 
    ...
    public typealias ELEMENT = sATOM_BASED_VALUE
    public var hiBound: Int? {
      switch self {
      case ._ATOM_BASED_TUPLE(let selection): return selection.hiBound
      default: return nil
      }
    }
    public var hiIndex: Int {
      switch self {
      case ._ATOM_BASED_TUPLE(let selection): return selection.hiIndex
      default: return 0
      }
    }
    public var loBound: Int {
      switch self {
      case ._ATOM_BASED_TUPLE(let selection): return selection.loBound
      default: return 0
      }
    }
    public var loIndex: Int {
      switch self {
      case ._ATOM_BASED_TUPLE(let selection): return selection.loIndex
      default: return 0
      }
    }
    public var size: Int {
      switch self {
      case ._ATOM_BASED_TUPLE(let selection): return selection.size
      default: return 0
      }
    }
    public var isEmpty: Bool {
      switch self {
      case ._ATOM_BASED_TUPLE(let selection): return selection.isEmpty
      default: return true
      }
    }
    ...
    public subscript(index: Int?) -> ELEMENT? {
      switch self {
      case ._ATOM_BASED_TUPLE(let selection): return selection[index]
      default: return nil
      }
    }
    ...
    public func makeIterator() -> AnyIterator<ELEMENT?> {
      switch self {
      case ._ATOM_BASED_TUPLE(let selection): 
    ...
    public func CONTAINS(elem: ELEMENT?) -> SDAI.LOGICAL {
      switch self {
      case ._ATOM_BASED_TUPLE(let selection): return selection.CONTAINS(elem)
...
public protocol sATOM_BASED_VALUE__TypeBehavior: SDAI.SelectType, SDAI.AggregationType
  where ELEMENT == AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.sATOM_BASED_VALUE {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sATOM_BASED_VALUE__Subtype: sATOM_BASED_VALUE__TypeBehavior, SDAI.DefinedType
where Supertype: sATOM_BASED_VALUE__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sATOM_BASED_VALUE__Subtype {
  //MARK: CONSTRUCTORS
