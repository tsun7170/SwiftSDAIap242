/* file: atom_based_value.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sATOM_BASED_VALUE : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sATOM_BASED_VALUE__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tATOM_BASED_TUPLE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sATOM_BASED_VALUE``
    @_documentation(visibility:public)
    case _ATOM_BASED_TUPLE(tATOM_BASED_TUPLE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_ATOM`` (SELECT) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sATOM_BASED_VALUE``
    @_documentation(visibility:public)
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sATOM_BASED_VALUE__type: SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sATOM_BASED_VALUE__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sATOM_BASED_VALUE__type, SDAI.DefinedType
