/* file: annotation_plane_element.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sANNOTATION_PLANE_ELEMENT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sANNOTATION_PLANE_ELEMENT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDRAUGHTING_CALLOUT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sANNOTATION_PLANE_ELEMENT``
    @_documentation(visibility:public)
    case _DRAUGHTING_CALLOUT(eDRAUGHTING_CALLOUT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSTYLED_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sANNOTATION_PLANE_ELEMENT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sANNOTATION_PLANE_ELEMENT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sANNOTATION_PLANE_ELEMENT__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sANNOTATION_PLANE_ELEMENT__type, SDAI.DefinedType
