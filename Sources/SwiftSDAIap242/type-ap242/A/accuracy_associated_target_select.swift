/* file: accuracy_associated_target_select.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sACCURACY_ASSOCIATED_TARGET_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sACCURACY_ASSOCIATED_TARGET_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERIA_REPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sACCURACY_ASSOCIATED_TARGET_SELECT``
    @_documentation(visibility:public)
    case _A3M_EQUIVALENCE_CRITERIA_REPRESENTATION(eA3M_EQUIVALENCE_CRITERIA_REPRESENTATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sACCURACY_ASSOCIATED_TARGET_SELECT``
    @_documentation(visibility:public)
    case _A3M_EQUIVALENCE_CRITERION(eA3M_EQUIVALENCE_CRITERION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sACCURACY_ASSOCIATED_TARGET_SELECT``
    @_documentation(visibility:public)
    case _A3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION(
      eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_EQUIVALENCE_INSPECTION_RESULT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sACCURACY_ASSOCIATED_TARGET_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sACCURACY_ASSOCIATED_TARGET_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sACCURACY_ASSOCIATED_TARGET_SELECT__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sACCURACY_ASSOCIATED_TARGET_SELECT__type, SDAI.DefinedType
