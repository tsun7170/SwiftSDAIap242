/* file: accuracy_associated_target_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- accuracy_associated_target_select (line:245 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  CASE: a3m_equivalence_criteria_representation (*ENTITY*):
  ...
  CASE: a3m_equivalence_criterion (*ENTITY*):
  ...
  CASE: a3m_equivalence_inspection_result_representation (*ENTITY*):
  ...
  CASE: data_equivalence_inspection_result (*ENTITY*):
...
```
*/
  public enum sACCURACY_ASSOCIATED_TARGET_SELECT : SDAI.Value, TypeHierarchy.sACCURACY_ASSOCIATED_TARGET_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERIA_REPRESENTATION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sACCURACY_ASSOCIATED_TARGET_SELECT``
    @_documentation(visibility:public)
    case _A3M_EQUIVALENCE_CRITERIA_REPRESENTATION(eA3M_EQUIVALENCE_CRITERIA_REPRESENTATION.PRef)	// (ENTITY)

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sACCURACY_ASSOCIATED_TARGET_SELECT``
    @_documentation(visibility:public)
    case _A3M_EQUIVALENCE_CRITERION(eA3M_EQUIVALENCE_CRITERION.PRef)	// (ENTITY)

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sACCURACY_ASSOCIATED_TARGET_SELECT``
    @_documentation(visibility:public)
    case _A3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION(
      eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.PRef)	// (ENTITY)

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_EQUIVALENCE_INSPECTION_RESULT`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sACCURACY_ASSOCIATED_TARGET_SELECT``
    @_documentation(visibility:public)
    case _DATA_EQUIVALENCE_INSPECTION_RESULT(eDATA_EQUIVALENCE_INSPECTION_RESULT.PRef)	// (ENTITY)
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eA3M_EQUIVALENCE_CRITERIA_REPRESENTATION.self) {self = ._A3M_EQUIVALENCE_CRITERIA_REPRESENTATION(base.pRef) }
      else if let base = complex.entityReference(eA3M_EQUIVALENCE_CRITERION.self) {self = ._A3M_EQUIVALENCE_CRITERION(base.pRef) }
      else if let base = complex.entityReference(eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.self) {self = ._A3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION(base.pRef) }
      else if let base = complex.entityReference(eDATA_EQUIVALENCE_INSPECTION_RESULT.self) {self = ._DATA_EQUIVALENCE_INSPECTION_RESULT(base.pRef) }
      else { return nil }
    }
    ...
    public init?<G: SDAI.GenericType>(fromGeneric generic: G?) {
      ...
      else if let base = eA3M_EQUIVALENCE_CRITERIA_REPRESENTATION.PRef.convert(fromGeneric: select) {
        self = ._A3M_EQUIVALENCE_CRITERIA_REPRESENTATION(base)
      }
      else if let base = eA3M_EQUIVALENCE_CRITERION.PRef.convert(fromGeneric: select) {
        self = ._A3M_EQUIVALENCE_CRITERION(base)
      }
      else if let base = eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.PRef.convert(fromGeneric: select) {
        self = ._A3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION(base)
      }
      else if let base = eDATA_EQUIVALENCE_INSPECTION_RESULT.PRef.convert(fromGeneric: select) {
    ...
    public static let bareTypeName: String = "ACCURACY_ASSOCIATED_TARGET_SELECT"
    ...
    public var super_eREPRESENTATION: eREPRESENTATION.PRef {
      switch self {
      case ._A3M_EQUIVALENCE_CRITERIA_REPRESENTATION(let entity): return eREPRESENTATION.PRef(entity.eval?.super_eREPRESENTATION)
      case ._A3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION(let entity): return eREPRESENTATION.PRef(entity.eval?.super_eREPRESENTATION)
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sACCURACY_ASSOCIATED_TARGET_SELECT``
    public var super_eDATA_EQUIVALENCE_CRITERION: eDATA_EQUIVALENCE_CRITERION.PRef {
      switch self {
      case ._A3M_EQUIVALENCE_CRITERION(let entity): return eDATA_EQUIVALENCE_CRITERION.PRef(entity.eval?.super_eDATA_EQUIVALENCE_CRITERION)
      default: return eDATA_EQUIVALENCE_CRITERION.PRef(nil)
      }
    }
    ...
    public var super_eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION: 
      eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.PRef {
      switch self {
      case ._A3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION(let entity): return entity
      default: return eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.PRef(nil)
      }
    }
    ...
    public var super_eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION: 
      ...
      switch self {
      case ._A3M_EQUIVALENCE_CRITERIA_REPRESENTATION(let entity): return eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION.PRef(entity.eval?.super_eDATA_EQUIVALENCE_CRITERIA_REPRESENTATION)
    ...
    public var super_eREPRESENTATION_ITEM: eREPRESENTATION_ITEM.PRef {
      switch self {
      case ._A3M_EQUIVALENCE_CRITERION(let entity): return eREPRESENTATION_ITEM.PRef(entity.eval?.super_eREPRESENTATION_ITEM)
      case ._DATA_EQUIVALENCE_INSPECTION_RESULT(let entity): return eREPRESENTATION_ITEM.PRef(entity.eval?.super_eREPRESENTATION_ITEM)
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sACCURACY_ASSOCIATED_TARGET_SELECT``
    public var super_eA3M_EQUIVALENCE_CRITERIA_REPRESENTATION: 
      eA3M_EQUIVALENCE_CRITERIA_REPRESENTATION.PRef {
      switch self {
      case ._A3M_EQUIVALENCE_CRITERIA_REPRESENTATION(let entity): return entity
      default: return eA3M_EQUIVALENCE_CRITERIA_REPRESENTATION.PRef(nil)
      }
    }
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sACCURACY_ASSOCIATED_TARGET_SELECT``
    public var super_eDATA_EQUIVALENCE_INSPECTION_RESULT: eDATA_EQUIVALENCE_INSPECTION_RESULT.PRef {
      switch self {
      case ._DATA_EQUIVALENCE_INSPECTION_RESULT(let entity): return entity
      default: return eDATA_EQUIVALENCE_INSPECTION_RESULT.PRef(nil)
      }
    }
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sACCURACY_ASSOCIATED_TARGET_SELECT``
    public var super_eA3M_EQUIVALENCE_CRITERION: eA3M_EQUIVALENCE_CRITERION.PRef {
      switch self {
      case ._A3M_EQUIVALENCE_CRITERION(let entity): return entity
      default: return eA3M_EQUIVALENCE_CRITERION.PRef(nil)
      }
    }
    ...
    public var super_eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION: 
      ...
      switch self {
      case ._A3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION(let entity): return eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.PRef(entity.eval?.super_eDATA_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION)
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sACCURACY_ASSOCIATED_TARGET_SELECT``
    public var super_eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT: 
      eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.PRef {
      switch self {
      case ._A3M_EQUIVALENCE_CRITERION(let entity): return eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.PRef(entity.eval?.super_eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT)
      default: return eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.PRef(nil)
      }
    }
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sACCURACY_ASSOCIATED_TARGET_SELECT``
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION`` )
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sACCURACY_ASSOCIATED_TARGET_SELECT``
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERIA_REPRESENTATION`` )
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION`` )
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sACCURACY_ASSOCIATED_TARGET_SELECT``
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eA3M_EQUIVALENCE_CRITERION`` )
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sACCURACY_ASSOCIATED_TARGET_SELECT``
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDATA_EQUIVALENCE_INSPECTION_RESULT`` )
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      switch self {
      case ._A3M_EQUIVALENCE_CRITERIA_REPRESENTATION(let entity): return entity.persistentEntityReferences
      case ._A3M_EQUIVALENCE_CRITERION(let entity): return entity.persistentEntityReferences
      case ._A3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION(let entity): return entity.persistentEntityReferences
      case ._DATA_EQUIVALENCE_INSPECTION_RESULT(let entity): return entity.persistentEntityReferences
      }
    }
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._A3M_EQUIVALENCE_CRITERIA_REPRESENTATION(let entity): 
        ...
        result = eA3M_EQUIVALENCE_CRITERIA_REPRESENTATION.validateWhereRules(instance: entity.eval, 
        prefix:prefix + "\\\(entity)")
      case ._A3M_EQUIVALENCE_CRITERION(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eA3M_EQUIVALENCE_CRITERION.validateWhereRules(instance: entity.eval, 
        prefix:prefix + "\\\(entity)")
      case ._A3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.validateWhereRules(instance: entity.eval, 
        prefix:prefix + "\\\(entity)")
      case ._DATA_EQUIVALENCE_INSPECTION_RESULT(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eDATA_EQUIVALENCE_INSPECTION_RESULT.validateWhereRules(instance: entity.eval, 
        prefix:prefix + "\\\(entity)")
      case nil: break
      }
...
public protocol sACCURACY_ASSOCIATED_TARGET_SELECT__TypeBehavior: SDAI.SelectType {
  ...
  var super_eDATA_EQUIVALENCE_CRITERION: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDATA_EQUIVALENCE_CRITERION.PRef { get }
  var super_eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.PRef { get }
  ...
  var super_eA3M_EQUIVALENCE_CRITERIA_REPRESENTATION: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eA3M_EQUIVALENCE_CRITERIA_REPRESENTATION.PRef { get }
  var super_eDATA_EQUIVALENCE_INSPECTION_RESULT: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDATA_EQUIVALENCE_INSPECTION_RESULT.PRef { get }
  var super_eA3M_EQUIVALENCE_CRITERION: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eA3M_EQUIVALENCE_CRITERION.PRef { get }
  ...
  var super_eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.PRef { get }
  ...
  var COMPARED_SPECIFIED_ELEMENTS: (SDAI.SET<
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.sINSPECTED_EQUIVALENCE_ELEMENT_SELECT>/*[1:(nil as SDAI.INTEGER?)]*/ )?  { get }
  var CRITERION_INSPECTED: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDATA_EQUIVALENCE_CRITERION.PRef?  { get }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sACCURACY_ASSOCIATED_TARGET_SELECT__Subtype: 
  sACCURACY_ASSOCIATED_TARGET_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sACCURACY_ASSOCIATED_TARGET_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sACCURACY_ASSOCIATED_TARGET_SELECT__Subtype {
  //MARK: CONSTRUCTORS
  ...
  var super_eDATA_EQUIVALENCE_CRITERION: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDATA_EQUIVALENCE_CRITERION.PRef { rep.super_eDATA_EQUIVALENCE_CRITERION }
  var super_eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION.PRef { rep.super_eA3M_EQUIVALENCE_INSPECTION_RESULT_REPRESENTATION }
  ...
  var super_eA3M_EQUIVALENCE_CRITERIA_REPRESENTATION: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eA3M_EQUIVALENCE_CRITERIA_REPRESENTATION.PRef { rep.super_eA3M_EQUIVALENCE_CRITERIA_REPRESENTATION }
  var super_eDATA_EQUIVALENCE_INSPECTION_RESULT: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDATA_EQUIVALENCE_INSPECTION_RESULT.PRef { rep.super_eDATA_EQUIVALENCE_INSPECTION_RESULT }
  var super_eA3M_EQUIVALENCE_CRITERION: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eA3M_EQUIVALENCE_CRITERION.PRef { rep.super_eA3M_EQUIVALENCE_CRITERION }
  ...
  var super_eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT.PRef { rep.super_eDATA_EQUIVALENCE_INSPECTION_REQUIREMENT }
  ...
  var CRITERION_INSPECTED: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eDATA_EQUIVALENCE_CRITERION.PRef?  { rep.CRITERION_INSPECTED }
