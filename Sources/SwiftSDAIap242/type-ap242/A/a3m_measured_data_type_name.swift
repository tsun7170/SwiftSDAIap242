/* file: a3m_measured_data_type_name.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  TYPE a3m_measured_data_type_name = ENUMERATION OF
    ( mdna_boolean_value,
     ...
     mdns_volume_measure );
  END_TYPE; -- a3m_measured_data_type_name (line:196 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum nA3M_MEASURED_DATA_TYPE_NAME : SDAI.ENUMERATION, SDAI.Value, 
    TypeHierarchy.nA3M_MEASURED_DATA_TYPE_NAME__TypeBehavior {
    /// ENUMERATION case
    ///
    /// - defined in: ``nA3M_MEASURED_DATA_TYPE_NAME``
    ...
    public static let bareTypeName: String = "A3M_MEASURED_DATA_TYPE_NAME"
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nA3M_MEASURED_DATA_TYPE_NAME__TypeBehavior: SDAI.EnumerationType {}
}

extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nA3M_MEASURED_DATA_TYPE_NAME__Subtype: 
  nA3M_MEASURED_DATA_TYPE_NAME__TypeBehavior, SDAI.DefinedType
where Supertype: nA3M_MEASURED_DATA_TYPE_NAME__TypeBehavior
{}
}
