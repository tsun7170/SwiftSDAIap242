/* file: annotation_placeholder_occurrence_role.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  TYPE annotation_placeholder_occurrence_role = ENUMERATION OF
    ( annotation_text,
     gps_data );
  END_TYPE; -- annotation_placeholder_occurrence_role (line:625 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum nANNOTATION_PLACEHOLDER_OCCURRENCE_ROLE : SDAI.ENUMERATION, SDAI.Value, 
    TypeHierarchy.nANNOTATION_PLACEHOLDER_OCCURRENCE_ROLE__TypeBehavior {
    /// ENUMERATION case
    ///
    /// - defined in: ``nANNOTATION_PLACEHOLDER_OCCURRENCE_ROLE``
    ...
    public static let bareTypeName: String = "ANNOTATION_PLACEHOLDER_OCCURRENCE_ROLE"
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nANNOTATION_PLACEHOLDER_OCCURRENCE_ROLE__TypeBehavior: SDAI.EnumerationType {}
}

extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nANNOTATION_PLACEHOLDER_OCCURRENCE_ROLE__Subtype: 
  nANNOTATION_PLACEHOLDER_OCCURRENCE_ROLE__TypeBehavior, SDAI.DefinedType
where Supertype: nANNOTATION_PLACEHOLDER_OCCURRENCE_ROLE__TypeBehavior
{}
}
