/* file: axial_geometry_constraint_element.swift 	 generated: Fri Feb  6 16:23:46 2026 */
  ...
  public enum sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT : SDAI.Value, TypeHierarchy.sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT__TypeBehavior {
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._CIRCLE(let entity): 
        ...
        result = eCIRCLE.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._CONICAL_SURFACE(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eCONICAL_SURFACE.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._CYLINDRICAL_SURFACE(let entity): 
        if !entity.shouldPropagateValidation { break }
      ...
      case ._LINE(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eLINE.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._PLANE(let entity): 
        if !entity.shouldPropagateValidation { break }
      ...
      case ._SPHERE(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eSPHERE.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._SPHERICAL_SURFACE(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eSPHERICAL_SURFACE.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._SURFACE_OF_REVOLUTION(let entity): 
        if !entity.shouldPropagateValidation { break }
      ...
      case ._TOROIDAL_SURFACE(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eTOROIDAL_SURFACE.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._TORUS(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eTORUS.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case nil: break
      }
