/* file: axial_geometry_constraint_element.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCIRCLE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    case _CIRCLE(eCIRCLE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCONICAL_SURFACE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    case _CONICAL_SURFACE(eCONICAL_SURFACE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCYLINDRICAL_SURFACE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    case _CYLINDRICAL_SURFACE(eCYLINDRICAL_SURFACE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eLINE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    case _LINE(eLINE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLANE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    case _PLANE(ePLANE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePOINT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    case _POINT(ePOINT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREVOLVED_AREA_SOLID`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    case _REVOLVED_AREA_SOLID(eREVOLVED_AREA_SOLID.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREVOLVED_FACE_SOLID`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    case _REVOLVED_FACE_SOLID(eREVOLVED_FACE_SOLID.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRIGHT_CIRCULAR_CONE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    case _RIGHT_CIRCULAR_CONE(eRIGHT_CIRCULAR_CONE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRIGHT_CIRCULAR_CYLINDER`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    case _RIGHT_CIRCULAR_CYLINDER(eRIGHT_CIRCULAR_CYLINDER.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSPHERE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    case _SPHERE(eSPHERE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSPHERICAL_SURFACE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    case _SPHERICAL_SURFACE(eSPHERICAL_SURFACE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSURFACE_OF_REVOLUTION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    case _SURFACE_OF_REVOLUTION(eSURFACE_OF_REVOLUTION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTOROIDAL_SURFACE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    case _TOROIDAL_SURFACE(eTOROIDAL_SURFACE.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eTORUS`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sAXIAL_GEOMETRY_CONSTRAINT_ELEMENT__type, SDAI.DefinedType
