/* file: assignment_object_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sASSIGNMENT_OBJECT_SELECT : SDAI.Value, TypeHierarchy.sASSIGNMENT_OBJECT_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_PROPERTY`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sASSIGNMENT_OBJECT_SELECT``
...
public protocol sASSIGNMENT_OBJECT_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sASSIGNMENT_OBJECT_SELECT__Subtype: 
  sASSIGNMENT_OBJECT_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sASSIGNMENT_OBJECT_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sASSIGNMENT_OBJECT_SELECT__Subtype {
  //MARK: CONSTRUCTORS
