/* file: ahead_or_behind.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  TYPE ahead_or_behind = ENUMERATION OF
    ( ahead,
     exact,
     behind );
  END_TYPE; -- ahead_or_behind (line:565 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum nAHEAD_OR_BEHIND : SDAI.ENUMERATION, SDAI.Value, 
    TypeHierarchy.nAHEAD_OR_BEHIND__TypeBehavior {
    /// ENUMERATION case
    ///
    /// - defined in: ``nAHEAD_OR_BEHIND``
    case AHEAD
    /// ENUMERATION case
    ///
    /// - defined in: ``nAHEAD_OR_BEHIND``
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.AHEAD_OR_BEHIND"
    ...
    public static let bareTypeName: String = "AHEAD_OR_BEHIND"
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nAHEAD_OR_BEHIND__TypeBehavior: SDAI.EnumerationType {}
}

extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nAHEAD_OR_BEHIND__Subtype: nAHEAD_OR_BEHIND__TypeBehavior, SDAI.DefinedType
where Supertype: nAHEAD_OR_BEHIND__TypeBehavior
{}
}
