/* file: maths_function_select.swift 	 generated: Thu Dec 25 18:13:23 2025 */
...
*/
  public enum sMATHS_FUNCTION_SELECT : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMATHS_FUNCTION_SELECT__type {
    ...
    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/nELEMENTARY_FUNCTION_ENUMERATORS`` (ENUM) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_FUNCTION_SELECT``
    @_documentation(visibility:public)
    case _ELEMENTARY_FUNCTION_ENUMERATORS(nELEMENTARY_FUNCTION_ENUMERATORS)	// (ENUM)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMATHS_FUNCTION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_FUNCTION_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_FUNCTION_SELECT``
