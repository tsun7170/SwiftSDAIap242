/* file: maths_space_or_function.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  TYPE maths_space_or_function = SELECT
    ( maths_function (*ENTITY*),
     maths_space (*ENTITY*) );
  END_TYPE; -- maths_space_or_function (line:4156 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sMATHS_SPACE_OR_FUNCTION : SDAI.Value, TypeHierarchy.sMATHS_SPACE_OR_FUNCTION__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMATHS_FUNCTION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_SPACE_OR_FUNCTION``
    @_documentation(visibility:public)
    case _MATHS_FUNCTION(eMATHS_FUNCTION.PRef)	// (ENTITY)

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMATHS_SPACE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_SPACE_OR_FUNCTION``
    @_documentation(visibility:public)
    case _MATHS_SPACE(eMATHS_SPACE.PRef)	// (ENTITY)
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      else if let base = complex.entityReference(eMATHS_SPACE.self) {self = ._MATHS_SPACE(base.pRef) }
      else { return nil }
    }
    ...
    public init?<G: SDAI.GenericType>(fromGeneric generic: G?) {
      ...
      else if let base = eMATHS_SPACE.PRef.convert(fromGeneric: select) {
    ...
    public static let bareTypeName: String = "MATHS_SPACE_OR_FUNCTION"
    ...
    public var super_eMATHS_SPACE: eMATHS_SPACE.PRef {
      ...
      default: return eMATHS_SPACE.PRef(nil)
      }
    }
    ...
    public var super_eGENERIC_EXPRESSION: eGENERIC_EXPRESSION.PRef {
      ...
      case ._MATHS_SPACE(let entity): return eGENERIC_EXPRESSION.PRef(entity.eval?.super_eGENERIC_EXPRESSION)
      }
    }
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_SPACE_OR_FUNCTION``
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMATHS_SPACE`` )
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      ...
      case ._MATHS_SPACE(let entity): return entity.persistentEntityReferences
      }
    }
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._MATHS_FUNCTION(let entity): 
        ...
        result = eMATHS_FUNCTION.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._MATHS_SPACE(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eMATHS_SPACE.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case nil: break
      }
...
public protocol sMATHS_SPACE_OR_FUNCTION__TypeBehavior: SDAI.SelectType {
  ...
  var D_VARIABLES: (SDAI.LIST<AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tINPUT_SELECTOR>/*[1:?]*/ )?  { get }
  var OPERANDS: (SDAI.LIST<AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eMATHS_FUNCTION.PRef>/*[2:?]*/ )?  { get }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sMATHS_SPACE_OR_FUNCTION__Subtype: sMATHS_SPACE_OR_FUNCTION__TypeBehavior, SDAI.DefinedType
where Supertype: sMATHS_SPACE_OR_FUNCTION__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sMATHS_SPACE_OR_FUNCTION__Subtype {
  //MARK: CONSTRUCTORS
  ...
  var D_VARIABLES: (SDAI.LIST<AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.tINPUT_SELECTOR>/*[1:?]*/ )?  { rep.D_VARIABLES }
  var OPERANDS: (SDAI.LIST<AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eMATHS_FUNCTION.PRef>/*[2:?]*/ )?  { rep.OPERANDS }
