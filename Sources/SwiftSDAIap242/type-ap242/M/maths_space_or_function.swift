/* file: maths_space_or_function.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sMATHS_SPACE_OR_FUNCTION : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMATHS_SPACE_OR_FUNCTION__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMATHS_FUNCTION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_SPACE_OR_FUNCTION``
    @_documentation(visibility:public)
    case _MATHS_FUNCTION(eMATHS_FUNCTION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMATHS_SPACE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_SPACE_OR_FUNCTION``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_SPACE_OR_FUNCTION``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMATHS_SPACE_OR_FUNCTION__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMATHS_SPACE_OR_FUNCTION__type, SDAI.DefinedType
