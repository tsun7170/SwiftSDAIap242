/* file: measure_value.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
/*
  TYPE measure_value = SELECT
    ( absorbed_dose_measure (*TYPE*),
     ...
     volume_measure (*TYPE*) );
  END_TYPE; -- measure_value (line:4179 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  CASE: absorbed_dose_measure (*TYPE*): absorbed_dose_measure

  CASE: acceleration_measure (*TYPE*): acceleration_measure

  CASE: amount_of_substance_measure (*TYPE*): amount_of_substance_measure

  CASE: area_measure (*TYPE*): area_measure

  CASE: capacitance_measure (*TYPE*): capacitance_measure

  CASE: celsius_temperature_measure (*TYPE*): celsius_temperature_measure

  CASE: conductance_measure (*TYPE*): conductance_measure
  ...
  CASE: dose_equivalent_measure (*TYPE*): dose_equivalent_measure

  CASE: electric_charge_measure (*TYPE*): electric_charge_measure

  CASE: electric_current_measure (*TYPE*): electric_current_measure

  CASE: electric_potential_measure (*TYPE*): electric_potential_measure

  CASE: energy_measure (*TYPE*): energy_measure

  CASE: force_measure (*TYPE*): force_measure

  CASE: frequency_measure (*TYPE*): frequency_measure

  CASE: illuminance_measure (*TYPE*): illuminance_measure

  CASE: inductance_measure (*TYPE*): inductance_measure

  CASE: length_measure (*TYPE*): length_measure

  CASE: luminous_flux_measure (*TYPE*): luminous_flux_measure

  CASE: luminous_intensity_measure (*TYPE*): luminous_intensity_measure

  CASE: magnetic_flux_density_measure (*TYPE*): magnetic_flux_density_measure

  CASE: magnetic_flux_measure (*TYPE*): magnetic_flux_measure

  CASE: mass_measure (*TYPE*): mass_measure

  CASE: non_negative_length_measure (*TYPE*): non_negative_length_measure

  CASE: numeric_measure (*TYPE*): numeric_measure

  CASE: parameter_value (*TYPE*): parameter_value
  ...
  CASE: positive_ratio_measure (*TYPE*): positive_ratio_measure

  CASE: power_measure (*TYPE*): power_measure

  CASE: pressure_measure (*TYPE*): pressure_measure

  CASE: radioactivity_measure (*TYPE*): radioactivity_measure

  CASE: ratio_measure (*TYPE*): ratio_measure

  CASE: resistance_measure (*TYPE*): resistance_measure

  CASE: solid_angle_measure (*TYPE*): solid_angle_measure

  CASE: thermodynamic_temperature_measure (*TYPE*): thermodynamic_temperature_measure

  CASE: time_measure (*TYPE*): time_measure

  CASE: velocity_measure (*TYPE*): velocity_measure
...
```
*/
  public enum sMEASURE_VALUE : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMEASURE_VALUE__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tABSORBED_DOSE_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _ABSORBED_DOSE_MEASURE(tABSORBED_DOSE_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tACCELERATION_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _ACCELERATION_MEASURE(tACCELERATION_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tAMOUNT_OF_SUBSTANCE_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _AMOUNT_OF_SUBSTANCE_MEASURE(tAMOUNT_OF_SUBSTANCE_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tAREA_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _AREA_MEASURE(tAREA_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tCAPACITANCE_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _CAPACITANCE_MEASURE(tCAPACITANCE_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tCELSIUS_TEMPERATURE_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _CELSIUS_TEMPERATURE_MEASURE(tCELSIUS_TEMPERATURE_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tCONDUCTANCE_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _CONDUCTANCE_MEASURE(tCONDUCTANCE_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tCONTEXT_DEPENDENT_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _CONTEXT_DEPENDENT_MEASURE(tCONTEXT_DEPENDENT_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tCOUNT_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _COUNT_MEASURE(tCOUNT_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tDESCRIPTIVE_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _DESCRIPTIVE_MEASURE(tDESCRIPTIVE_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tDOSE_EQUIVALENT_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _DOSE_EQUIVALENT_MEASURE(tDOSE_EQUIVALENT_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tELECTRIC_CHARGE_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _ELECTRIC_CHARGE_MEASURE(tELECTRIC_CHARGE_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tELECTRIC_CURRENT_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _ELECTRIC_CURRENT_MEASURE(tELECTRIC_CURRENT_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tELECTRIC_POTENTIAL_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _ELECTRIC_POTENTIAL_MEASURE(tELECTRIC_POTENTIAL_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tENERGY_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _ENERGY_MEASURE(tENERGY_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tFORCE_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _FORCE_MEASURE(tFORCE_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tFREQUENCY_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _FREQUENCY_MEASURE(tFREQUENCY_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tILLUMINANCE_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _ILLUMINANCE_MEASURE(tILLUMINANCE_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tINDUCTANCE_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _INDUCTANCE_MEASURE(tINDUCTANCE_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tLENGTH_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _LENGTH_MEASURE(tLENGTH_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tLUMINOUS_FLUX_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _LUMINOUS_FLUX_MEASURE(tLUMINOUS_FLUX_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tLUMINOUS_INTENSITY_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _LUMINOUS_INTENSITY_MEASURE(tLUMINOUS_INTENSITY_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tMAGNETIC_FLUX_DENSITY_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _MAGNETIC_FLUX_DENSITY_MEASURE(tMAGNETIC_FLUX_DENSITY_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tMAGNETIC_FLUX_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _MAGNETIC_FLUX_MEASURE(tMAGNETIC_FLUX_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tMASS_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _MASS_MEASURE(tMASS_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tNON_NEGATIVE_LENGTH_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _NON_NEGATIVE_LENGTH_MEASURE(tNON_NEGATIVE_LENGTH_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tNUMERIC_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _NUMERIC_MEASURE(tNUMERIC_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tPARAMETER_VALUE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _PARAMETER_VALUE(tPARAMETER_VALUE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tPLANE_ANGLE_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _PLANE_ANGLE_MEASURE(tPLANE_ANGLE_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tPOSITIVE_LENGTH_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _POSITIVE_LENGTH_MEASURE(tPOSITIVE_LENGTH_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tPOSITIVE_PLANE_ANGLE_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _POSITIVE_PLANE_ANGLE_MEASURE(tPOSITIVE_PLANE_ANGLE_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tPOSITIVE_RATIO_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _POSITIVE_RATIO_MEASURE(tPOSITIVE_RATIO_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tPOWER_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _POWER_MEASURE(tPOWER_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tPRESSURE_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _PRESSURE_MEASURE(tPRESSURE_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tRADIOACTIVITY_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _RADIOACTIVITY_MEASURE(tRADIOACTIVITY_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tRATIO_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _RATIO_MEASURE(tRATIO_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tRESISTANCE_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _RESISTANCE_MEASURE(tRESISTANCE_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tSOLID_ANGLE_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _SOLID_ANGLE_MEASURE(tSOLID_ANGLE_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tTHERMODYNAMIC_TEMPERATURE_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _THERMODYNAMIC_TEMPERATURE_MEASURE(tTHERMODYNAMIC_TEMPERATURE_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tTIME_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _TIME_MEASURE(tTIME_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tVELOCITY_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    case _VELOCITY_MEASURE(tVELOCITY_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tVOLUME_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE``
    @_documentation(visibility:public)
    ...
    public static let bareTypeName: String = "MEASURE_VALUE"
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.MEASURE_VALUE"
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      switch self {
      case ._ABSORBED_DOSE_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._ACCELERATION_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._AMOUNT_OF_SUBSTANCE_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      ...
      case ._CAPACITANCE_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._CELSIUS_TEMPERATURE_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._CONDUCTANCE_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      ...
      case ._DOSE_EQUIVALENT_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._ELECTRIC_CHARGE_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._ELECTRIC_CURRENT_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._ELECTRIC_POTENTIAL_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._ENERGY_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._FORCE_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._FREQUENCY_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._ILLUMINANCE_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._INDUCTANCE_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      ...
      case ._LUMINOUS_FLUX_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._LUMINOUS_INTENSITY_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._MAGNETIC_FLUX_DENSITY_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._MAGNETIC_FLUX_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._MASS_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._NON_NEGATIVE_LENGTH_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._NUMERIC_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._PARAMETER_VALUE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      ...
      case ._POSITIVE_RATIO_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._POWER_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._PRESSURE_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._RADIOACTIVITY_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      ...
      case ._RESISTANCE_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._SOLID_ANGLE_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._THERMODYNAMIC_TEMPERATURE_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._TIME_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._VELOCITY_MEASURE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
    ...
    public func isHolding(entityReference: SDAI.EntityReference) -> Bool {
      switch self {
      case ._ABSORBED_DOSE_MEASURE: return false
      case ._ACCELERATION_MEASURE: return false
      case ._AMOUNT_OF_SUBSTANCE_MEASURE: return false
      case ._AREA_MEASURE: return false
      case ._CAPACITANCE_MEASURE: return false
      case ._CELSIUS_TEMPERATURE_MEASURE: return false
      case ._CONDUCTANCE_MEASURE: return false
      case ._CONTEXT_DEPENDENT_MEASURE: return false
      case ._COUNT_MEASURE: return false
      case ._DESCRIPTIVE_MEASURE: return false
      case ._DOSE_EQUIVALENT_MEASURE: return false
      case ._ELECTRIC_CHARGE_MEASURE: return false
      case ._ELECTRIC_CURRENT_MEASURE: return false
      case ._ELECTRIC_POTENTIAL_MEASURE: return false
      case ._ENERGY_MEASURE: return false
      case ._FORCE_MEASURE: return false
      case ._FREQUENCY_MEASURE: return false
      case ._ILLUMINANCE_MEASURE: return false
      case ._INDUCTANCE_MEASURE: return false
      case ._LENGTH_MEASURE: return false
      case ._LUMINOUS_FLUX_MEASURE: return false
      case ._LUMINOUS_INTENSITY_MEASURE: return false
      case ._MAGNETIC_FLUX_DENSITY_MEASURE: return false
      case ._MAGNETIC_FLUX_MEASURE: return false
      case ._MASS_MEASURE: return false
      case ._NON_NEGATIVE_LENGTH_MEASURE: return false
      case ._NUMERIC_MEASURE: return false
      case ._PARAMETER_VALUE: return false
      ...
      case ._POSITIVE_RATIO_MEASURE: return false
      case ._POWER_MEASURE: return false
      case ._PRESSURE_MEASURE: return false
      case ._RADIOACTIVITY_MEASURE: return false
      case ._RATIO_MEASURE: return false
      case ._RESISTANCE_MEASURE: return false
      case ._SOLID_ANGLE_MEASURE: return false
      case ._THERMODYNAMIC_TEMPERATURE_MEASURE: return false
      case ._TIME_MEASURE: return false
      case ._VELOCITY_MEASURE: return false
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMEASURE_VALUE__type: SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMEASURE_VALUE__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMEASURE_VALUE__type, SDAI.DefinedType
