/* file: maths_enum_atom.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
/*
  TYPE maths_enum_atom = SELECT
    ( elementary_function_enumerators (*ENUM*),
     ...
     symmetry_type (*ENUM*) );
  END_TYPE; -- maths_enum_atom (line:4111 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  CASE: elementary_space_enumerators (*ENUM*): elementary_space_enumerators

  CASE: extension_options (*ENUM*): extension_options

  CASE: lower_upper (*ENUM*): lower_upper

  CASE: open_closed (*ENUM*): open_closed

  CASE: ordering_type (*ENUM*): ordering_type

  CASE: repackage_options (*ENUM*): repackage_options

  CASE: space_constraint_type (*ENUM*): space_constraint_type

  CASE: symmetry_type (*ENUM*): symmetry_type
...
```
*/
  public enum sMATHS_ENUM_ATOM : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMATHS_ENUM_ATOM__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/nELEMENTARY_FUNCTION_ENUMERATORS`` (ENUM) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_ENUM_ATOM``
    @_documentation(visibility:public)
    case _ELEMENTARY_FUNCTION_ENUMERATORS(nELEMENTARY_FUNCTION_ENUMERATORS)	// (ENUM)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/nELEMENTARY_SPACE_ENUMERATORS`` (ENUM) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_ENUM_ATOM``
    @_documentation(visibility:public)
    case _ELEMENTARY_SPACE_ENUMERATORS(nELEMENTARY_SPACE_ENUMERATORS)	// (ENUM)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/nEXTENSION_OPTIONS`` (ENUM) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_ENUM_ATOM``
    @_documentation(visibility:public)
    case _EXTENSION_OPTIONS(nEXTENSION_OPTIONS)	// (ENUM)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/nLOWER_UPPER`` (ENUM) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_ENUM_ATOM``
    @_documentation(visibility:public)
    case _LOWER_UPPER(nLOWER_UPPER)	// (ENUM)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/nOPEN_CLOSED`` (ENUM) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_ENUM_ATOM``
    @_documentation(visibility:public)
    case _OPEN_CLOSED(nOPEN_CLOSED)	// (ENUM)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/nORDERING_TYPE`` (ENUM) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_ENUM_ATOM``
    @_documentation(visibility:public)
    case _ORDERING_TYPE(nORDERING_TYPE)	// (ENUM)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/nREPACKAGE_OPTIONS`` (ENUM) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_ENUM_ATOM``
    @_documentation(visibility:public)
    case _REPACKAGE_OPTIONS(nREPACKAGE_OPTIONS)	// (ENUM)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/nSPACE_CONSTRAINT_TYPE`` (ENUM) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_ENUM_ATOM``
    @_documentation(visibility:public)
    case _SPACE_CONSTRAINT_TYPE(nSPACE_CONSTRAINT_TYPE)	// (ENUM)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/nSYMMETRY_TYPE`` (ENUM) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMATHS_ENUM_ATOM``
    @_documentation(visibility:public)
    ...
    public static let bareTypeName: String = "MATHS_ENUM_ATOM"
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.MATHS_ENUM_ATOM"
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      ...
      case ._ELEMENTARY_SPACE_ENUMERATORS: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._EXTENSION_OPTIONS: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._LOWER_UPPER: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._OPEN_CLOSED: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._ORDERING_TYPE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._REPACKAGE_OPTIONS: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._SPACE_CONSTRAINT_TYPE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._SYMMETRY_TYPE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      }
    }
    ...
    public func isHolding(entityReference: SDAI.EntityReference) -> Bool {
      ...
      case ._ELEMENTARY_SPACE_ENUMERATORS: return false
      case ._EXTENSION_OPTIONS: return false
      case ._LOWER_UPPER: return false
      case ._OPEN_CLOSED: return false
      case ._ORDERING_TYPE: return false
      case ._REPACKAGE_OPTIONS: return false
      case ._SPACE_CONSTRAINT_TYPE: return false
      case ._SYMMETRY_TYPE: return false
      }
    }
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMATHS_ENUM_ATOM__type: SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMATHS_ENUM_ATOM__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMATHS_ENUM_ATOM__type, SDAI.DefinedType
