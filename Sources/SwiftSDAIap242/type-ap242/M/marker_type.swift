/* file: marker_type.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  TYPE marker_type = ENUMERATION OF
    ( dot,
     ...
     square,
     triangle );
  END_TYPE; -- marker_type (line:4087 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum nMARKER_TYPE : SDAI.ENUMERATION, SDAI.Value, TypeHierarchy.nMARKER_TYPE__TypeBehavior {
    /// ENUMERATION case
    ///
    /// - defined in: ``nMARKER_TYPE``
    case DOT
    /// ENUMERATION case
    ///
    /// - defined in: ``nMARKER_TYPE``
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.MARKER_TYPE"
    ...
    public static let bareTypeName: String = "MARKER_TYPE"
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nMARKER_TYPE__TypeBehavior: SDAI.EnumerationType {}
}

extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol nMARKER_TYPE__Subtype: nMARKER_TYPE__TypeBehavior, SDAI.DefinedType
where Supertype: nMARKER_TYPE__TypeBehavior
{}
}
