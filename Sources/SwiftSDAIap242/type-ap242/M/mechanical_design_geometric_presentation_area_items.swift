/* file: mechanical_design_geometric_presentation_area_items.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
/*
  TYPE mechanical_design_geometric_presentation_area_items = SELECT
    ( axis2_placement (*SELECT*),
     mapped_item (*ENTITY*) );
  END_TYPE; -- mechanical_design_geometric_presentation_area_items (line:4239 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS : SDAI.Value, 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIS2_PLACEMENT`` (SELECT) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS``
    @_documentation(visibility:public)
    case _AXIS2_PLACEMENT(sAXIS2_PLACEMENT)	// (SELECT)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMAPPED_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS``
    @_documentation(visibility:public)
    ...
    public static let bareTypeName: String = "MECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS"
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS``
    ...
    public static let typeName: String = 
      "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.MECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS"
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS__type: 
  SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS__type, SDAI.DefinedType
where Supertype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS__type
{}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS__subtype {
  //MARK: CONSTRUCTORS
