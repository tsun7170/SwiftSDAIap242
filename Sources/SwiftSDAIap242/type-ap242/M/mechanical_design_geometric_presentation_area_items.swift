/* file: mechanical_design_geometric_presentation_area_items.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
*/
  public enum sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS : SDAI.Value, 
    TypeHierarchy.sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS__TypeBehavior {

    /// SELECT case (SELECT)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sAXIS2_PLACEMENT`` (SELECT)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS``
...
public protocol sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS__Subtype: 
  sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS__TypeBehavior, SDAI.DefinedType
where Supertype: sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS__Subtype {
  //MARK: CONSTRUCTORS
