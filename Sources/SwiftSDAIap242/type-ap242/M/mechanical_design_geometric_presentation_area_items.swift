/* file: mechanical_design_geometric_presentation_area_items.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS : SDAIValue, 
    ...
    /// SELECT case ``sAXIS2_PLACEMENT`` (SELECT) in ``sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS``
    case _AXIS2_PLACEMENT(sAXIS2_PLACEMENT)	// (SELECT)

    /// SELECT case ``eMAPPED_ITEM`` (ENTITY) in ``sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS``
    ...
    /// attribute of SELECT type ``sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_AREA_ITEMS``
