/* file: multi_or_next_assembly_usage_occurrence.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sMULTI_OR_NEXT_ASSEMBLY_USAGE_OCCURRENCE : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMULTI_OR_NEXT_ASSEMBLY_USAGE_OCCURRENCE__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMULTI_LEVEL_REFERENCE_DESIGNATOR`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMULTI_OR_NEXT_ASSEMBLY_USAGE_OCCURRENCE``
    @_documentation(visibility:public)
    case _MULTI_LEVEL_REFERENCE_DESIGNATOR(eMULTI_LEVEL_REFERENCE_DESIGNATOR.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eNEXT_ASSEMBLY_USAGE_OCCURRENCE`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMULTI_OR_NEXT_ASSEMBLY_USAGE_OCCURRENCE``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMULTI_OR_NEXT_ASSEMBLY_USAGE_OCCURRENCE``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMULTI_OR_NEXT_ASSEMBLY_USAGE_OCCURRENCE__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMULTI_OR_NEXT_ASSEMBLY_USAGE_OCCURRENCE__type, SDAI.DefinedType
