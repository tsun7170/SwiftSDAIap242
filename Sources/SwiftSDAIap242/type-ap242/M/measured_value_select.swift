/* file: measured_value_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- measured_value_select (line:4224 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  ...
  CASE: measure_value (*SELECT*):

  CASE: plane_angle_and_length_pair (*ENTITY*):
  ...
  CASE: plane_angle_and_ratio_pair (*ENTITY*):
  ATTR:  users: SET [0 : ?] OF founded_item_select
  ATTR:  plane_angle_value: plane_angle_measure *** Multiple Select Case Sources ***
...
```
*/
  public enum sMEASURED_VALUE_SELECT : SDAI.Value, TypeHierarchy.sMEASURED_VALUE_SELECT__TypeBehavior {

    /// SELECT case (TYPE)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tBOOLEAN_VALUE`` (TYPE)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURED_VALUE_SELECT``
    @_documentation(visibility:public)
    case _BOOLEAN_VALUE(tBOOLEAN_VALUE)	// (TYPE)

    /// SELECT case (SELECT)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE`` (SELECT)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURED_VALUE_SELECT``
    @_documentation(visibility:public)
    ...
    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLANE_ANGLE_AND_LENGTH_PAIR`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURED_VALUE_SELECT``
    @_documentation(visibility:public)
    case _PLANE_ANGLE_AND_LENGTH_PAIR(ePLANE_ANGLE_AND_LENGTH_PAIR.PRef)	// (ENTITY)

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLANE_ANGLE_AND_RATIO_PAIR`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURED_VALUE_SELECT``
    @_documentation(visibility:public)
    case _PLANE_ANGLE_AND_RATIO_PAIR(ePLANE_ANGLE_AND_RATIO_PAIR.PRef)	// (ENTITY)
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      else if let base = complex.entityReference(ePLANE_ANGLE_AND_LENGTH_PAIR.self) {self = ._PLANE_ANGLE_AND_LENGTH_PAIR(base.pRef) }
      else if let base = complex.entityReference(ePLANE_ANGLE_AND_RATIO_PAIR.self) {self = ._PLANE_ANGLE_AND_RATIO_PAIR(base.pRef) }
      else { return nil }
    }
    ...
    public init?<G: SDAI.GenericType>(fromGeneric generic: G?) {
      ...
      else if let base = ePLANE_ANGLE_AND_LENGTH_PAIR.PRef.convert(fromGeneric: select) {
        self = ._PLANE_ANGLE_AND_LENGTH_PAIR(base)
      }
      else if let base = ePLANE_ANGLE_AND_RATIO_PAIR.PRef.convert(fromGeneric: select) {
    ...
    public static let bareTypeName: String = "MEASURED_VALUE_SELECT"
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURED_VALUE_SELECT``
    public var super_ePLANE_ANGLE_AND_RATIO_PAIR: ePLANE_ANGLE_AND_RATIO_PAIR.PRef {
      switch self {
      case ._PLANE_ANGLE_AND_RATIO_PAIR(let entity): return entity
      default: return ePLANE_ANGLE_AND_RATIO_PAIR.PRef(nil)
      }
    }
    ...
    public var super_eFOUNDED_ITEM: eFOUNDED_ITEM.PRef {
      switch self {
      case ._PLANE_ANGLE_AND_LENGTH_PAIR(let entity): return eFOUNDED_ITEM.PRef(entity.eval?.super_eFOUNDED_ITEM)
      case ._PLANE_ANGLE_AND_RATIO_PAIR(let entity): return eFOUNDED_ITEM.PRef(entity.eval?.super_eFOUNDED_ITEM)
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURED_VALUE_SELECT``
    public var super_ePLANE_ANGLE_AND_LENGTH_PAIR: ePLANE_ANGLE_AND_LENGTH_PAIR.PRef {
      switch self {
      case ._PLANE_ANGLE_AND_LENGTH_PAIR(let entity): return entity
      default: return ePLANE_ANGLE_AND_LENGTH_PAIR.PRef(nil)
      }
    }
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURED_VALUE_SELECT``
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLANE_ANGLE_AND_LENGTH_PAIR`` )
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLANE_ANGLE_AND_RATIO_PAIR`` )
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      ...
      case ._MEASURE_VALUE(let select): return select.persistentEntityReferences
      case ._PLANE_ANGLE_AND_LENGTH_PAIR(let entity): return entity.persistentEntityReferences
      case ._PLANE_ANGLE_AND_RATIO_PAIR(let entity): return entity.persistentEntityReferences
      }
    }
    ...
    public func isHolding(entityReference: SDAI.EntityReference) -> Bool {
      ...
      case ._MEASURE_VALUE(let select): 
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._PLANE_ANGLE_AND_LENGTH_PAIR(let entity): 
        ...
        result = ePLANE_ANGLE_AND_LENGTH_PAIR.validateWhereRules(instance: entity.eval, 
        prefix:prefix + "\\\(entity)")
      case ._PLANE_ANGLE_AND_RATIO_PAIR(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = ePLANE_ANGLE_AND_RATIO_PAIR.validateWhereRules(instance: entity.eval, 
        prefix:prefix + "\\\(entity)")
      case nil: break
      }
...
public protocol sMEASURED_VALUE_SELECT__TypeBehavior: SDAI.SelectType {
  ...
  var super_ePLANE_ANGLE_AND_RATIO_PAIR: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ePLANE_ANGLE_AND_RATIO_PAIR.PRef { get }
  ...
  var super_ePLANE_ANGLE_AND_LENGTH_PAIR: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ePLANE_ANGLE_AND_LENGTH_PAIR.PRef { get }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sMEASURED_VALUE_SELECT__Subtype: sMEASURED_VALUE_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sMEASURED_VALUE_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sMEASURED_VALUE_SELECT__Subtype {
  //MARK: CONSTRUCTORS
  ...
  var super_ePLANE_ANGLE_AND_RATIO_PAIR: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ePLANE_ANGLE_AND_RATIO_PAIR.PRef { rep.super_ePLANE_ANGLE_AND_RATIO_PAIR }
  var super_eFOUNDED_ITEM: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eFOUNDED_ITEM.PRef { rep.super_eFOUNDED_ITEM }
  var super_ePLANE_ANGLE_AND_LENGTH_PAIR: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ePLANE_ANGLE_AND_LENGTH_PAIR.PRef { rep.super_ePLANE_ANGLE_AND_LENGTH_PAIR }
