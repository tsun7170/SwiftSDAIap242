/* file: measured_value_select.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sMEASURED_VALUE_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMEASURED_VALUE_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tBOOLEAN_VALUE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURED_VALUE_SELECT``
    @_documentation(visibility:public)
    case _BOOLEAN_VALUE(tBOOLEAN_VALUE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURE_VALUE`` (SELECT) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURED_VALUE_SELECT``
    @_documentation(visibility:public)
    case _MEASURE_VALUE(sMEASURE_VALUE)	// (SELECT)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLANE_ANGLE_AND_LENGTH_PAIR`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURED_VALUE_SELECT``
    @_documentation(visibility:public)
    case _PLANE_ANGLE_AND_LENGTH_PAIR(ePLANE_ANGLE_AND_LENGTH_PAIR.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePLANE_ANGLE_AND_RATIO_PAIR`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURED_VALUE_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMEASURED_VALUE_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMEASURED_VALUE_SELECT__type: 
  SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMEASURED_VALUE_SELECT__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMEASURED_VALUE_SELECT__type, SDAI.DefinedType
