/* file: mechanical_design_geometric_presentation_representation_items.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_REPRESENTATION_ITEMS : SDAIValue, 
    ...
    /// SELECT case ``sAXIS2_PLACEMENT`` (SELECT) in ``sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_REPRESENTATION_ITEMS``
    case _AXIS2_PLACEMENT(sAXIS2_PLACEMENT)	// (SELECT)

    /// SELECT case ``eCAMERA_MODEL_D3`` (ENTITY) in ``sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_REPRESENTATION_ITEMS``
    case _CAMERA_MODEL_D3(eCAMERA_MODEL_D3)	// (ENTITY)

    /// SELECT case ``eMAPPED_ITEM`` (ENTITY) in ``sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_REPRESENTATION_ITEMS``
    case _MAPPED_ITEM(eMAPPED_ITEM)	// (ENTITY)

    /// SELECT case ``eSTYLED_ITEM`` (ENTITY) in ``sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_REPRESENTATION_ITEMS``
    ...
    /// attribute of SELECT type ``sMECHANICAL_DESIGN_GEOMETRIC_PRESENTATION_REPRESENTATION_ITEMS``
