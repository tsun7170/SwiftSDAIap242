/* file: marker_select.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sMARKER_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMARKER_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/nMARKER_TYPE`` (ENUM) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMARKER_SELECT``
    @_documentation(visibility:public)
    case _MARKER_TYPE(nMARKER_TYPE)	// (ENUM)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRE_DEFINED_MARKER`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMARKER_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMARKER_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMARKER_SELECT__type: SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMARKER_SELECT__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sMARKER_SELECT__type, SDAI.DefinedType
