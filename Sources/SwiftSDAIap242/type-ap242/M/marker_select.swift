/* file: marker_select.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_TYPE; -- marker_select (line:4082 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
/*
  CASE: marker_type (*ENUM*): marker_type

  CASE: pre_defined_marker (*ENTITY*):
  ATTR:  name: label
...
```
*/
  public enum sMARKER_SELECT : SDAI.Value, TypeHierarchy.sMARKER_SELECT__TypeBehavior {

    /// SELECT case (ENUM)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/nMARKER_TYPE`` (ENUM)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMARKER_SELECT``
    @_documentation(visibility:public)
    case _MARKER_TYPE(nMARKER_TYPE)	// (ENUM)

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRE_DEFINED_MARKER`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMARKER_SELECT``
    @_documentation(visibility:public)
    case _PRE_DEFINED_MARKER(ePRE_DEFINED_MARKER.PRef)	// (ENTITY)
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(ePRE_DEFINED_MARKER.self) {self = ._PRE_DEFINED_MARKER(base.pRef) }
      else { return nil }
    }
    ...
    public init?<G: SDAI.GenericType>(fromGeneric generic: G?) {
      ...
      else if let base = ePRE_DEFINED_MARKER.PRef.convert(fromGeneric: select) {
    ...
    public static let bareTypeName: String = "MARKER_SELECT"
    ...
    public var super_ePRE_DEFINED_ITEM: ePRE_DEFINED_ITEM.PRef {
      switch self {
      case ._PRE_DEFINED_MARKER(let entity): return ePRE_DEFINED_ITEM.PRef(entity.eval?.super_ePRE_DEFINED_ITEM)
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMARKER_SELECT``
    public var super_ePRE_DEFINED_MARKER: ePRE_DEFINED_MARKER.PRef {
      switch self {
      case ._PRE_DEFINED_MARKER(let entity): return entity
      default: return ePRE_DEFINED_MARKER.PRef(nil)
      }
    }
    ...
    ///
    /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sMARKER_SELECT``
    /// - origin: ENTITY( ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRE_DEFINED_MARKER`` )
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.MARKER_SELECT"
    ...
    public var persistentEntityReferences: AnySequence<SDAI.GenericPersistentEntityReference> {
      switch self {
      case ._MARKER_TYPE: return AnySequence<SDAI.GenericPersistentEntityReference>(EmptyCollection<SDAI.GenericPersistentEntityReference>())
      case ._PRE_DEFINED_MARKER(let entity): return entity.persistentEntityReferences
      }
    }

    public func isHolding(entityReference: SDAI.EntityReference) -> Bool {
      switch self {
      case ._MARKER_TYPE: return false
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._PRE_DEFINED_MARKER(let entity): 
        ...
        result = ePRE_DEFINED_MARKER.validateWhereRules(instance: entity.eval, 
...
public protocol sMARKER_SELECT__TypeBehavior: SDAI.SelectType {
  ...
  var super_ePRE_DEFINED_MARKER: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ePRE_DEFINED_MARKER.PRef { get }
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sMARKER_SELECT__Subtype: sMARKER_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sMARKER_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sMARKER_SELECT__Subtype {
  //MARK: CONSTRUCTORS
  ...
  var super_ePRE_DEFINED_MARKER: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.ePRE_DEFINED_MARKER.PRef { rep.super_ePRE_DEFINED_MARKER }
