/* file: ordering_type.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum nORDERING_TYPE : SDAI.ENUMERATION, SDAI.Value, 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__nORDERING_TYPE__type {
    /// ENUMERATION case in ``nORDERING_TYPE``
    case BY_ROWS
    /// ENUMERATION case in ``nORDERING_TYPE``
    case BY_COLUMNS
  ...
  /// promoted ENUMERATION case in ``nORDERING_TYPE``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__nORDERING_TYPE__type: SDAI.EnumerationType 
  {}

public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__nORDERING_TYPE__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__nORDERING_TYPE__type, SDAI.DefinedType
where Supertype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__nORDERING_TYPE__type
{}
