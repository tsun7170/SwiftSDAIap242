/* file: organization_item.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sORGANIZATION_ITEM : SDAI.Value, TypeHierarchy.sORGANIZATION_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sORGANIZATION_ITEM``
    ...
    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDOCUMENT_TYPE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sORGANIZATION_ITEM``
    @_documentation(visibility:public)
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._DOCUMENT_TYPE(let entity): 
        if !entity.shouldPropagateValidation { break }
        result = eDOCUMENT_TYPE.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
      case ._DRAUGHTING_MODEL(let entity): 
        if !entity.shouldPropagateValidation { break }
...
public protocol sORGANIZATION_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sORGANIZATION_ITEM__Subtype: sORGANIZATION_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sORGANIZATION_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sORGANIZATION_ITEM__Subtype {
  //MARK: CONSTRUCTORS
