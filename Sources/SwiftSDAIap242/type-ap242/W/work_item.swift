/* file: work_item.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sWORK_ITEM : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sWORK_ITEM__type {
    ...
    /// SELECT case ``ePRODUCT_DEFINITION_FORMATION`` (ENTITY) in ``sWORK_ITEM``
    ...
    /// attribute of SELECT type ``sWORK_ITEM``
