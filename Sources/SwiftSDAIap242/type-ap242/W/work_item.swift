/* file: work_item.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_TYPE; -- work_item (line:5988 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sWORK_ITEM : SDAI.Value, TypeHierarchy.sWORK_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_FORMATION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sWORK_ITEM``
    ...
    public static let bareTypeName: String = "WORK_ITEM"
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.WORK_ITEM"
...
public protocol sWORK_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sWORK_ITEM__Subtype: sWORK_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sWORK_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sWORK_ITEM__Subtype {
  //MARK: CONSTRUCTORS
