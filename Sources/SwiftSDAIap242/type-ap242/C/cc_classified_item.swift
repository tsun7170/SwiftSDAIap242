/* file: cc_classified_item.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sCC_CLASSIFIED_ITEM : SDAI.Value, TypeHierarchy.sCC_CLASSIFIED_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eASSEMBLY_COMPONENT_USAGE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCC_CLASSIFIED_ITEM``
...
public protocol sCC_CLASSIFIED_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sCC_CLASSIFIED_ITEM__Subtype: sCC_CLASSIFIED_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sCC_CLASSIFIED_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sCC_CLASSIFIED_ITEM__Subtype {
  //MARK: CONSTRUCTORS
