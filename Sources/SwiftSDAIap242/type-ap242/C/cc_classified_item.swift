/* file: cc_classified_item.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sCC_CLASSIFIED_ITEM : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCC_CLASSIFIED_ITEM__type {
    ...
    /// SELECT case ``eASSEMBLY_COMPONENT_USAGE`` (ENTITY) in ``sCC_CLASSIFIED_ITEM``
    case _ASSEMBLY_COMPONENT_USAGE(eASSEMBLY_COMPONENT_USAGE)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_FORMATION`` (ENTITY) in ``sCC_CLASSIFIED_ITEM``
    ...
    /// attribute of SELECT type ``sCC_CLASSIFIED_ITEM``
