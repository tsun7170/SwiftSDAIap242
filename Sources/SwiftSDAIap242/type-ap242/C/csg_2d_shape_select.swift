/* file: csg_2d_shape_select.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sCSG_2D_SHAPE_SELECT : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCSG_2D_SHAPE_SELECT__type {
    ...
    /// SELECT case ``eAXIS2_PLACEMENT_2D`` (ENTITY) in ``sCSG_2D_SHAPE_SELECT``
    case _AXIS2_PLACEMENT_2D(eAXIS2_PLACEMENT_2D)	// (ENTITY)

    /// SELECT case ``eCSG_SOLID_2D`` (ENTITY) in ``sCSG_2D_SHAPE_SELECT``
    case _CSG_SOLID_2D(eCSG_SOLID_2D)	// (ENTITY)

    /// SELECT case ``eMAPPED_ITEM`` (ENTITY) in ``sCSG_2D_SHAPE_SELECT``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      else if let base = complex.entityReference(eCSG_SOLID_2D.self) {self = ._CSG_SOLID_2D(base) }
    ...
    public init?<G: SDAIGenericType>(fromGeneric generic: G?) {
      ...
      else if let base = eCSG_SOLID_2D.convert(fromGeneric: select) {
    ...
    public var super_eSOLID_MODEL: eSOLID_MODEL? {
      switch self {
      case ._CSG_SOLID_2D(let entity): return entity.super_eSOLID_MODEL
      default: return nil
      }
    }
    ...
    public var super_eREPRESENTATION_ITEM: eREPRESENTATION_ITEM? {
      ...
      case ._CSG_SOLID_2D(let entity): return entity.super_eREPRESENTATION_ITEM
    ...
    public var super_eGEOMETRIC_REPRESENTATION_ITEM: eGEOMETRIC_REPRESENTATION_ITEM? {
      ...
      case ._CSG_SOLID_2D(let entity): return entity.super_eGEOMETRIC_REPRESENTATION_ITEM
      default: return nil
      }
    }
    ...
    public var super_eCSG_SOLID: eCSG_SOLID? {
      switch self {
      case ._CSG_SOLID_2D(let entity): return entity.super_eCSG_SOLID
      default: return nil
      }
    }
    ...
    /// attribute of SELECT type ``sCSG_2D_SHAPE_SELECT``
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      case ._CSG_SOLID_2D(let selectValue): result = eCSG_SOLID_2D.validateWhereRules(instance:selectValue, 
