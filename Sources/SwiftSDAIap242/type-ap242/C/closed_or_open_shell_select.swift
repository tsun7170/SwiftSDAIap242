/* file: closed_or_open_shell_select.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sCLOSED_OR_OPEN_SHELL_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCLOSED_OR_OPEN_SHELL_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCLOSED_SHELL`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCLOSED_OR_OPEN_SHELL_SELECT``
    @_documentation(visibility:public)
    case _CLOSED_SHELL(eCLOSED_SHELL.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eOPEN_SHELL`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCLOSED_OR_OPEN_SHELL_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCLOSED_OR_OPEN_SHELL_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCLOSED_OR_OPEN_SHELL_SELECT__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCLOSED_OR_OPEN_SHELL_SELECT__type, SDAI.DefinedType
