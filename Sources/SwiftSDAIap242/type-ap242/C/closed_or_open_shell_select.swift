/* file: closed_or_open_shell_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  TYPE closed_or_open_shell_select = SELECT
    ( closed_shell (*ENTITY*),
     open_shell (*ENTITY*) );
  END_TYPE; -- closed_or_open_shell_select (line:1664 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sCLOSED_OR_OPEN_SHELL_SELECT : SDAI.Value, TypeHierarchy.sCLOSED_OR_OPEN_SHELL_SELECT__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCLOSED_SHELL`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCLOSED_OR_OPEN_SHELL_SELECT``
    ...
    public static let bareTypeName: String = "CLOSED_OR_OPEN_SHELL_SELECT"
...
public protocol sCLOSED_OR_OPEN_SHELL_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sCLOSED_OR_OPEN_SHELL_SELECT__Subtype: 
  sCLOSED_OR_OPEN_SHELL_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sCLOSED_OR_OPEN_SHELL_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sCLOSED_OR_OPEN_SHELL_SELECT__Subtype {
  //MARK: CONSTRUCTORS
