/* file: curve_font_or_scaled_curve_font_select.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sCURVE_FONT_OR_SCALED_CURVE_FONT_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCURVE_FONT_OR_SCALED_CURVE_FONT_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCURVE_STYLE_FONT_AND_SCALING`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCURVE_FONT_OR_SCALED_CURVE_FONT_SELECT``
    @_documentation(visibility:public)
    case _CURVE_STYLE_FONT_AND_SCALING(eCURVE_STYLE_FONT_AND_SCALING.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCURVE_STYLE_FONT_SELECT`` (SELECT) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCURVE_FONT_OR_SCALED_CURVE_FONT_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCURVE_FONT_OR_SCALED_CURVE_FONT_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCURVE_FONT_OR_SCALED_CURVE_FONT_SELECT__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCURVE_FONT_OR_SCALED_CURVE_FONT_SELECT__type, SDAI.DefinedType
