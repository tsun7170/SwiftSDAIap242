/* file: csg_select_2d.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sCSG_SELECT_2D : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCSG_SELECT_2D__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBOOLEAN_RESULT_2D`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCSG_SELECT_2D``
    @_documentation(visibility:public)
    case _BOOLEAN_RESULT_2D(eBOOLEAN_RESULT_2D.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sBOUNDED_PRIMITIVE_2D`` (SELECT) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCSG_SELECT_2D``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCSG_SELECT_2D``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCSG_SELECT_2D__type: SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCSG_SELECT_2D__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCSG_SELECT_2D__type, SDAI.DefinedType
