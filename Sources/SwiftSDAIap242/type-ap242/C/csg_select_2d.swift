/* file: csg_select_2d.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- csg_select_2d (line:1805 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sCSG_SELECT_2D : SDAI.Value, TypeHierarchy.sCSG_SELECT_2D__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eBOOLEAN_RESULT_2D`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCSG_SELECT_2D``
    ...
    public static let bareTypeName: String = "CSG_SELECT_2D"
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.CSG_SELECT_2D"
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> SDAI.WhereRuleValidationRecords {
      ...
      case ._BOOLEAN_RESULT_2D(let entity): 
        ...
        result = eBOOLEAN_RESULT_2D.validateWhereRules(instance: entity.eval, prefix:prefix + "\\\(entity)")
...
public protocol sCSG_SELECT_2D__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sCSG_SELECT_2D__Subtype: sCSG_SELECT_2D__TypeBehavior, SDAI.DefinedType
where Supertype: sCSG_SELECT_2D__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sCSG_SELECT_2D__Subtype {
  //MARK: CONSTRUCTORS
