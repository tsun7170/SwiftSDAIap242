/* file: configured_effectivity_context_item.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sCONFIGURED_EFFECTIVITY_CONTEXT_ITEM : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCONFIGURED_EFFECTIVITY_CONTEXT_ITEM__type {
    ...
    /// SELECT case ``ePRODUCT_CONCEPT_FEATURE_ASSOCIATION`` (ENTITY) in ``sCONFIGURED_EFFECTIVITY_CONTEXT_ITEM``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(ePRODUCT_CONCEPT_FEATURE_ASSOCIATION.self) {self = ._PRODUCT_CONCEPT_FEATURE_ASSOCIATION(base) }
      else { return nil }
    }
    ...
    /// attribute of SELECT type ``sCONFIGURED_EFFECTIVITY_CONTEXT_ITEM``
