/* file: current_element_assignment_select.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sCURRENT_ELEMENT_ASSIGNMENT_SELECT : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCURRENT_ELEMENT_ASSIGNMENT_SELECT__type {
    ...
    /// SELECT case ``eADD_ELEMENT`` (ENTITY) in ``sCURRENT_ELEMENT_ASSIGNMENT_SELECT``
    case _ADD_ELEMENT(eADD_ELEMENT)	// (ENTITY)

    /// SELECT case ``eMODIFY_ELEMENT`` (ENTITY) in ``sCURRENT_ELEMENT_ASSIGNMENT_SELECT``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(eADD_ELEMENT.self) {self = ._ADD_ELEMENT(base) }
    ...
    public init?<G: SDAIGenericType>(fromGeneric generic: G?) {
      ...
      else if let base = eADD_ELEMENT.convert(fromGeneric: select) {
    ...
    public var super_eGROUP: eGROUP? {
      switch self {
      case ._ADD_ELEMENT(let entity): return entity.super_eGROUP
      case ._MODIFY_ELEMENT(let entity): return entity.super_eGROUP
      }
    }

    public var super_eADD_ELEMENT: eADD_ELEMENT? {
      switch self {
    ...
    public var super_eCHANGE_ELEMENT: eCHANGE_ELEMENT? {
      switch self {
      case ._ADD_ELEMENT(let entity): return entity.super_eCHANGE_ELEMENT
    ...
    public var super_eCHARACTERIZED_OBJECT: eCHARACTERIZED_OBJECT? {
      switch self {
      case ._ADD_ELEMENT(let entity): return entity.super_eCHARACTERIZED_OBJECT
    ...
    /// attribute of SELECT type ``sCURRENT_ELEMENT_ASSIGNMENT_SELECT``
    /// - origin: ENTITY( ``eADD_ELEMENT`` )
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      switch instance {
      case ._ADD_ELEMENT(let selectValue): result = eADD_ELEMENT.validateWhereRules(instance:selectValue, 
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCURRENT_ELEMENT_ASSIGNMENT_SELECT__type: 
  ...
  var super_eADD_ELEMENT: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eADD_ELEMENT? { get }
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCURRENT_ELEMENT_ASSIGNMENT_SELECT__subtype {
  ...
  var super_eADD_ELEMENT: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eADD_ELEMENT? { rep.super_eADD_ELEMENT }
