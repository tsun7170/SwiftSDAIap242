/* file: configured_effectivity_item.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
/*
  ...
  END_TYPE; -- configured_effectivity_item (line:1701 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sCONFIGURED_EFFECTIVITY_ITEM : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCONFIGURED_EFFECTIVITY_ITEM__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_RELATIONSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCONFIGURED_EFFECTIVITY_ITEM``
    @_documentation(visibility:public)
    case _ACTION_RELATIONSHIP(eACTION_RELATIONSHIP.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROCESS_PLAN`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCONFIGURED_EFFECTIVITY_ITEM``
    @_documentation(visibility:public)
    case _PROCESS_PLAN(ePROCESS_PLAN.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCONFIGURED_EFFECTIVITY_ITEM``
    @_documentation(visibility:public)
    case _PRODUCT_DEFINITION(ePRODUCT_DEFINITION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_PROCESS_PLAN`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCONFIGURED_EFFECTIVITY_ITEM``
    @_documentation(visibility:public)
    ...
    public static let bareTypeName: String = "CONFIGURED_EFFECTIVITY_ITEM"
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCONFIGURED_EFFECTIVITY_ITEM``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCONFIGURED_EFFECTIVITY_ITEM__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCONFIGURED_EFFECTIVITY_ITEM__type, SDAI.DefinedType
