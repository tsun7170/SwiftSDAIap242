/* file: configured_effectivity_item.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sCONFIGURED_EFFECTIVITY_ITEM : SDAI.Value, TypeHierarchy.sCONFIGURED_EFFECTIVITY_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_RELATIONSHIP`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCONFIGURED_EFFECTIVITY_ITEM``
...
public protocol sCONFIGURED_EFFECTIVITY_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sCONFIGURED_EFFECTIVITY_ITEM__Subtype: 
  sCONFIGURED_EFFECTIVITY_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sCONFIGURED_EFFECTIVITY_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sCONFIGURED_EFFECTIVITY_ITEM__Subtype {
  //MARK: CONSTRUCTORS
