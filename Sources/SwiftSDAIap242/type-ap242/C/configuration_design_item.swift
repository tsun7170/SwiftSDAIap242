/* file: configuration_design_item.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sCONFIGURATION_DESIGN_ITEM : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCONFIGURATION_DESIGN_ITEM__type {
    ...
    /// SELECT case ``ePRODUCT_DEFINITION`` (ENTITY) in ``sCONFIGURATION_DESIGN_ITEM``
    case _PRODUCT_DEFINITION(ePRODUCT_DEFINITION)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_FORMATION`` (ENTITY) in ``sCONFIGURATION_DESIGN_ITEM``
    case _PRODUCT_DEFINITION_FORMATION(ePRODUCT_DEFINITION_FORMATION)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_OCCURRENCE`` (ENTITY) in ``sCONFIGURATION_DESIGN_ITEM``
    ...
    /// attribute of SELECT type ``sCONFIGURATION_DESIGN_ITEM``
