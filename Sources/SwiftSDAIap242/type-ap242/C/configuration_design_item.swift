/* file: configuration_design_item.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sCONFIGURATION_DESIGN_ITEM : SDAI.Value, TypeHierarchy.sCONFIGURATION_DESIGN_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCONFIGURATION_DESIGN_ITEM``
...
public protocol sCONFIGURATION_DESIGN_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sCONFIGURATION_DESIGN_ITEM__Subtype: 
  sCONFIGURATION_DESIGN_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sCONFIGURATION_DESIGN_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sCONFIGURATION_DESIGN_ITEM__Subtype {
  //MARK: CONSTRUCTORS
