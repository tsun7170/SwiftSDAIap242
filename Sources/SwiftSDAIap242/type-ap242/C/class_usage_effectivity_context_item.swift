/* file: class_usage_effectivity_context_item.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sCLASS_USAGE_EFFECTIVITY_CONTEXT_ITEM : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCLASS_USAGE_EFFECTIVITY_CONTEXT_ITEM__type {
    ...
    /// SELECT case ``ePRODUCT_DEFINITION`` (ENTITY) in ``sCLASS_USAGE_EFFECTIVITY_CONTEXT_ITEM``
    ...
    /// attribute of SELECT type ``sCLASS_USAGE_EFFECTIVITY_CONTEXT_ITEM``
