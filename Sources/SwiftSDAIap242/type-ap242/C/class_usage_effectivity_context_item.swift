/* file: class_usage_effectivity_context_item.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_TYPE; -- class_usage_effectivity_context_item (line:1461 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sCLASS_USAGE_EFFECTIVITY_CONTEXT_ITEM : SDAI.Value, TypeHierarchy.sCLASS_USAGE_EFFECTIVITY_CONTEXT_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCLASS_USAGE_EFFECTIVITY_CONTEXT_ITEM``
    ...
    public static let bareTypeName: String = "CLASS_USAGE_EFFECTIVITY_CONTEXT_ITEM"
    ...
    public static let typeName: String = 
      "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.CLASS_USAGE_EFFECTIVITY_CONTEXT_ITEM"
...
public protocol sCLASS_USAGE_EFFECTIVITY_CONTEXT_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sCLASS_USAGE_EFFECTIVITY_CONTEXT_ITEM__Subtype: 
  sCLASS_USAGE_EFFECTIVITY_CONTEXT_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sCLASS_USAGE_EFFECTIVITY_CONTEXT_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sCLASS_USAGE_EFFECTIVITY_CONTEXT_ITEM__Subtype {
  //MARK: CONSTRUCTORS
