/* file: constructive_geometry_representation_or_shape_representation.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sCONSTRUCTIVE_GEOMETRY_REPRESENTATION_OR_SHAPE_REPRESENTATION : SDAIValue, 
    ...
    /// SELECT case ``eCONSTRUCTIVE_GEOMETRY_REPRESENTATION`` (ENTITY) in ``sCONSTRUCTIVE_GEOMETRY_REPRESENTATION_OR_SHAPE_REPRESENTATION``
    case _CONSTRUCTIVE_GEOMETRY_REPRESENTATION(eCONSTRUCTIVE_GEOMETRY_REPRESENTATION)	// (ENTITY)

    /// SELECT case ``eSHAPE_REPRESENTATION`` (ENTITY) in ``sCONSTRUCTIVE_GEOMETRY_REPRESENTATION_OR_SHAPE_REPRESENTATION``
    ...
    /// attribute of SELECT type ``sCONSTRUCTIVE_GEOMETRY_REPRESENTATION_OR_SHAPE_REPRESENTATION``
