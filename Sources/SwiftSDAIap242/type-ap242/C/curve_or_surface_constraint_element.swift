/* file: curve_or_surface_constraint_element.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sCURVE_OR_SURFACE_CONSTRAINT_ELEMENT : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCURVE_OR_SURFACE_CONSTRAINT_ELEMENT__type {
    ...
    /// SELECT case ``eCURVE`` (ENTITY) in ``sCURVE_OR_SURFACE_CONSTRAINT_ELEMENT``
    case _CURVE(eCURVE)	// (ENTITY)

    /// SELECT case ``eSURFACE`` (ENTITY) in ``sCURVE_OR_SURFACE_CONSTRAINT_ELEMENT``
    ...
    /// attribute of SELECT type ``sCURVE_OR_SURFACE_CONSTRAINT_ELEMENT``
