/* file: constraint_group_member.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sCONSTRAINT_GROUP_MEMBER : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCONSTRAINT_GROUP_MEMBER__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eEXPLICIT_CONSTRAINT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCONSTRAINT_GROUP_MEMBER``
    @_documentation(visibility:public)
    case _EXPLICIT_CONSTRAINT(eEXPLICIT_CONSTRAINT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eSIMULTANEOUS_CONSTRAINT_GROUP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCONSTRAINT_GROUP_MEMBER``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCONSTRAINT_GROUP_MEMBER``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCONSTRAINT_GROUP_MEMBER__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCONSTRAINT_GROUP_MEMBER__type, SDAI.DefinedType
