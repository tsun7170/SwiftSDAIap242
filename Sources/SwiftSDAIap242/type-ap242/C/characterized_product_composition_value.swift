/* file: characterized_product_composition_value.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_TYPE; -- characterized_product_composition_value (line:1434 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sCHARACTERIZED_PRODUCT_COMPOSITION_VALUE : SDAI.Value, TypeHierarchy.sCHARACTERIZED_PRODUCT_COMPOSITION_VALUE__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMEASURE_WITH_UNIT`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCHARACTERIZED_PRODUCT_COMPOSITION_VALUE``
    ...
    public static let bareTypeName: String = "CHARACTERIZED_PRODUCT_COMPOSITION_VALUE"
...
public protocol sCHARACTERIZED_PRODUCT_COMPOSITION_VALUE__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sCHARACTERIZED_PRODUCT_COMPOSITION_VALUE__Subtype: 
  sCHARACTERIZED_PRODUCT_COMPOSITION_VALUE__TypeBehavior, SDAI.DefinedType
where Supertype: sCHARACTERIZED_PRODUCT_COMPOSITION_VALUE__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sCHARACTERIZED_PRODUCT_COMPOSITION_VALUE__Subtype {
  //MARK: CONSTRUCTORS
