/* file: chained_representation_link.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sCHAINED_REPRESENTATION_LINK : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCHAINED_REPRESENTATION_LINK__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMAPPED_ITEM`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCHAINED_REPRESENTATION_LINK``
    @_documentation(visibility:public)
    case _MAPPED_ITEM(eMAPPED_ITEM.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREPRESENTATION_CONTEXT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCHAINED_REPRESENTATION_LINK``
    @_documentation(visibility:public)
    case _REPRESENTATION_CONTEXT(eREPRESENTATION_CONTEXT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eREPRESENTATION_RELATIONSHIP`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCHAINED_REPRESENTATION_LINK``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCHAINED_REPRESENTATION_LINK``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCHAINED_REPRESENTATION_LINK__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCHAINED_REPRESENTATION_LINK__type, SDAI.DefinedType
