/* file: character_spacing_select.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sCHARACTER_SPACING_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCHARACTER_SPACING_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tDESCRIPTIVE_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCHARACTER_SPACING_SELECT``
    @_documentation(visibility:public)
    case _DESCRIPTIVE_MEASURE(tDESCRIPTIVE_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tLENGTH_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCHARACTER_SPACING_SELECT``
    @_documentation(visibility:public)
    case _LENGTH_MEASURE(tLENGTH_MEASURE)	// (TYPE)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eMEASURE_WITH_UNIT`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCHARACTER_SPACING_SELECT``
    @_documentation(visibility:public)
    case _MEASURE_WITH_UNIT(eMEASURE_WITH_UNIT.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tRATIO_MEASURE`` (TYPE) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCHARACTER_SPACING_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCHARACTER_SPACING_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCHARACTER_SPACING_SELECT__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCHARACTER_SPACING_SELECT__type, SDAI.DefinedType
