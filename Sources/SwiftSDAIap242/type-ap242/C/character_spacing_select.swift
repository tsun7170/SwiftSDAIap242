/* file: character_spacing_select.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  TYPE character_spacing_select = SELECT
    ( descriptive_measure (*TYPE*),
     ...
     ratio_measure (*TYPE*) );
  END_TYPE; -- character_spacing_select (line:1396 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sCHARACTER_SPACING_SELECT : SDAI.Value, TypeHierarchy.sCHARACTER_SPACING_SELECT__TypeBehavior {

    /// SELECT case (TYPE)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/tDESCRIPTIVE_MEASURE`` (TYPE)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCHARACTER_SPACING_SELECT``
    ...
    public static let bareTypeName: String = "CHARACTER_SPACING_SELECT"
...
public protocol sCHARACTER_SPACING_SELECT__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sCHARACTER_SPACING_SELECT__Subtype: 
  sCHARACTER_SPACING_SELECT__TypeBehavior, SDAI.DefinedType
where Supertype: sCHARACTER_SPACING_SELECT__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sCHARACTER_SPACING_SELECT__Subtype {
  //MARK: CONSTRUCTORS
