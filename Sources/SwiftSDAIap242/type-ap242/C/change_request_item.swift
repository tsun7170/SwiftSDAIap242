/* file: change_request_item.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_TYPE; -- change_request_item (line:1392 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sCHANGE_REQUEST_ITEM : SDAI.Value, TypeHierarchy.sCHANGE_REQUEST_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_FORMATION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCHANGE_REQUEST_ITEM``
    ...
    public static let bareTypeName: String = "CHANGE_REQUEST_ITEM"
    ...
    public static let typeName: String = 
      "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.CHANGE_REQUEST_ITEM"
...
public protocol sCHANGE_REQUEST_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sCHANGE_REQUEST_ITEM__Subtype: sCHANGE_REQUEST_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sCHANGE_REQUEST_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sCHANGE_REQUEST_ITEM__Subtype {
  //MARK: CONSTRUCTORS
