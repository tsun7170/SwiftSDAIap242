/* file: change_request_item.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sCHANGE_REQUEST_ITEM : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCHANGE_REQUEST_ITEM__type {
    ...
    /// SELECT case ``ePRODUCT_DEFINITION_FORMATION`` (ENTITY) in ``sCHANGE_REQUEST_ITEM``
    ...
    /// attribute of SELECT type ``sCHANGE_REQUEST_ITEM``
