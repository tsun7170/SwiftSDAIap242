/* file: curve_or_annotation_curve_occurrence.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  TYPE curve_or_annotation_curve_occurrence = SELECT
    ( annotation_curve_occurrence (*ENTITY*),
     curve (*ENTITY*) );
  END_TYPE; -- curve_or_annotation_curve_occurrence (line:1826 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sCURVE_OR_ANNOTATION_CURVE_OCCURRENCE : SDAI.Value, TypeHierarchy.sCURVE_OR_ANNOTATION_CURVE_OCCURRENCE__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eANNOTATION_CURVE_OCCURRENCE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCURVE_OR_ANNOTATION_CURVE_OCCURRENCE``
    ...
    public static let bareTypeName: String = "CURVE_OR_ANNOTATION_CURVE_OCCURRENCE"
...
public protocol sCURVE_OR_ANNOTATION_CURVE_OCCURRENCE__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sCURVE_OR_ANNOTATION_CURVE_OCCURRENCE__Subtype: 
  sCURVE_OR_ANNOTATION_CURVE_OCCURRENCE__TypeBehavior, SDAI.DefinedType
where Supertype: sCURVE_OR_ANNOTATION_CURVE_OCCURRENCE__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sCURVE_OR_ANNOTATION_CURVE_OCCURRENCE__Subtype {
  //MARK: CONSTRUCTORS
