/* file: contracted_item.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
/*
  ...
  END_TYPE; -- contracted_item (line:1767 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sCONTRACTED_ITEM : SDAI.Value, TypeHierarchy.sCONTRACTED_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_FORMATION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCONTRACTED_ITEM``
    ...
    public static let bareTypeName: String = "CONTRACTED_ITEM"
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.CONTRACTED_ITEM"
...
public protocol sCONTRACTED_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sCONTRACTED_ITEM__Subtype: sCONTRACTED_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sCONTRACTED_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sCONTRACTED_ITEM__Subtype {
  //MARK: CONSTRUCTORS
