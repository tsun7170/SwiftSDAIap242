/* file: classified_item.swift 	 generated: Thu Mar  5 17:54:18 2026 */
...
```
*/
  public enum sCLASSIFIED_ITEM : SDAI.Value, TypeHierarchy.sCLASSIFIED_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCLASSIFIED_ITEM``
...
public protocol sCLASSIFIED_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sCLASSIFIED_ITEM__Subtype: sCLASSIFIED_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sCLASSIFIED_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sCLASSIFIED_ITEM__Subtype {
  //MARK: CONSTRUCTORS
