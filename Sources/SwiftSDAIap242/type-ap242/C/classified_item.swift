/* file: classified_item.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sCLASSIFIED_ITEM : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCLASSIFIED_ITEM__type {
    ...
    /// SELECT case ``ePRODUCT`` (ENTITY) in ``sCLASSIFIED_ITEM``
    case _PRODUCT(ePRODUCT)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION`` (ENTITY) in ``sCLASSIFIED_ITEM``
    case _PRODUCT_DEFINITION(ePRODUCT_DEFINITION)	// (ENTITY)

    /// SELECT case ``ePRODUCT_DEFINITION_FORMATION`` (ENTITY) in ``sCLASSIFIED_ITEM``
    ...
    /// attribute of SELECT type ``sCLASSIFIED_ITEM``
