/* file: contract_item.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sCONTRACT_ITEM : SDAI.Value, TypeHierarchy.sCONTRACT_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_DIRECTIVE`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCONTRACT_ITEM``
...
public protocol sCONTRACT_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sCONTRACT_ITEM__Subtype: sCONTRACT_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sCONTRACT_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sCONTRACT_ITEM__Subtype {
  //MARK: CONSTRUCTORS
