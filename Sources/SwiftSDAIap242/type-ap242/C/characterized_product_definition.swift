/* file: characterized_product_definition.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sCHARACTERIZED_PRODUCT_DEFINITION : SDAI.Value, TypeHierarchy.sCHARACTERIZED_PRODUCT_DEFINITION__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCHARACTERIZED_PRODUCT_DEFINITION``
    ...
    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION_RELATIONSHIP_RELATIONSHIP`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCHARACTERIZED_PRODUCT_DEFINITION``
    @_documentation(visibility:public)
...
public protocol sCHARACTERIZED_PRODUCT_DEFINITION__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sCHARACTERIZED_PRODUCT_DEFINITION__Subtype: 
  sCHARACTERIZED_PRODUCT_DEFINITION__TypeBehavior, SDAI.DefinedType
where Supertype: sCHARACTERIZED_PRODUCT_DEFINITION__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sCHARACTERIZED_PRODUCT_DEFINITION__Subtype {
  //MARK: CONSTRUCTORS
