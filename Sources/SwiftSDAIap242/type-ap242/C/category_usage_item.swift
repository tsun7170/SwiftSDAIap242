/* file: category_usage_item.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  ...
  END_TYPE; -- category_usage_item (line:1228 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sCATEGORY_USAGE_ITEM : SDAI.Value, TypeHierarchy.sCATEGORY_USAGE_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_CLASS`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCATEGORY_USAGE_ITEM``
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      if let base = complex.entityReference(ePRODUCT_CLASS.self) {self = ._PRODUCT_CLASS(base.pRef) }
      else { return nil }
    }
    ...
    public static let bareTypeName: String = "CATEGORY_USAGE_ITEM"
...
public protocol sCATEGORY_USAGE_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sCATEGORY_USAGE_ITEM__Subtype: sCATEGORY_USAGE_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sCATEGORY_USAGE_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sCATEGORY_USAGE_ITEM__Subtype {
  //MARK: CONSTRUCTORS
