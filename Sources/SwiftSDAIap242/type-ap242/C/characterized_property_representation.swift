/* file: characterized_property_representation.swift 	 generated: Sun Jan 18 16:59:32 2026 */
...
```
*/
  public enum sCHARACTERIZED_PROPERTY_REPRESENTATION : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCHARACTERIZED_PROPERTY_REPRESENTATION__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION_PROPERTY_REPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCHARACTERIZED_PROPERTY_REPRESENTATION``
    @_documentation(visibility:public)
    case _ACTION_PROPERTY_REPRESENTATION(eACTION_PROPERTY_REPRESENTATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eDIMENSIONAL_CHARACTERISTIC_REPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCHARACTERIZED_PROPERTY_REPRESENTATION``
    @_documentation(visibility:public)
    case _DIMENSIONAL_CHARACTERISTIC_REPRESENTATION(
      eDIMENSIONAL_CHARACTERISTIC_REPRESENTATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePROPERTY_DEFINITION_REPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCHARACTERIZED_PROPERTY_REPRESENTATION``
    @_documentation(visibility:public)
    case _PROPERTY_DEFINITION_REPRESENTATION(ePROPERTY_DEFINITION_REPRESENTATION.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eRESOURCE_PROPERTY_REPRESENTATION`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCHARACTERIZED_PROPERTY_REPRESENTATION``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCHARACTERIZED_PROPERTY_REPRESENTATION``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCHARACTERIZED_PROPERTY_REPRESENTATION__subtype: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCHARACTERIZED_PROPERTY_REPRESENTATION__type, SDAI.DefinedType
