/* file: curve_or_curve_set.swift 	 generated: Fri Sep 26 17:24:11 2025 */
...
*/
  public enum sCURVE_OR_CURVE_SET : SDAIValue, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCURVE_OR_CURVE_SET__type {
    ...
    /// SELECT case ``eCURVE`` (ENTITY) in ``sCURVE_OR_CURVE_SET``
    case _CURVE(eCURVE)	// (ENTITY)

    /// SELECT case ``eGEOMETRIC_CURVE_SET`` (ENTITY) in ``sCURVE_OR_CURVE_SET``
    case _GEOMETRIC_CURVE_SET(eGEOMETRIC_CURVE_SET)	// (ENTITY)
    ...
    public init?(possiblyFrom complex: SDAI.ComplexEntity?) {
      ...
      else if let base = complex.entityReference(eGEOMETRIC_CURVE_SET.self) {self = ._GEOMETRIC_CURVE_SET(base) }
      else { return nil }
    }
    ...
    public init?<G: SDAIGenericType>(fromGeneric generic: G?) {
      ...
      else if let base = eGEOMETRIC_CURVE_SET.convert(fromGeneric: select) {
    ...
    public var super_eGEOMETRIC_SET: eGEOMETRIC_SET? {
      switch self {
      case ._GEOMETRIC_CURVE_SET(let entity): return entity.super_eGEOMETRIC_SET
      default: return nil
      }
    }
    ...
    public var super_eREPRESENTATION_ITEM: eREPRESENTATION_ITEM? {
      ...
      case ._GEOMETRIC_CURVE_SET(let entity): return entity.super_eREPRESENTATION_ITEM
      }
    }
    ...
    public var super_eGEOMETRIC_CURVE_SET: eGEOMETRIC_CURVE_SET? {
      switch self {
    ...
    public var super_eGEOMETRIC_REPRESENTATION_ITEM: eGEOMETRIC_REPRESENTATION_ITEM? {
      ...
      case ._GEOMETRIC_CURVE_SET(let entity): return entity.super_eGEOMETRIC_REPRESENTATION_ITEM
      }
    }


    //MARK: - ENTITY ATTRIBUTE REFERENCES
    /// attribute of SELECT type ``sCURVE_OR_CURVE_SET``
    /// - origin: ENTITY( ``eGEOMETRIC_CURVE_SET`` )
    ...
    public static func validateWhereRules(instance:Self?, prefix:SDAI.WhereLabel) -> [SDAI.WhereLabel:SDAI.LOGICAL] {
      ...
      case ._CURVE(let selectValue): result = eCURVE.validateWhereRules(instance:selectValue, 
        prefix:prefix + "\\CURVE")
      case ._GEOMETRIC_CURVE_SET(let selectValue): 
        result = eGEOMETRIC_CURVE_SET.validateWhereRules(instance:selectValue, 
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCURVE_OR_CURVE_SET__type: SDAISelectType {
  ...
  var super_eGEOMETRIC_SET: AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eGEOMETRIC_SET? { get }
  ...
  var super_eGEOMETRIC_CURVE_SET: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eGEOMETRIC_CURVE_SET? { get }
...
public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCURVE_OR_CURVE_SET__subtype {
  ...
  var super_eGEOMETRIC_SET: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eGEOMETRIC_SET? { rep.super_eGEOMETRIC_SET }
  var super_eREPRESENTATION_ITEM: 
  ...
  var super_eGEOMETRIC_CURVE_SET: 
    AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.eGEOMETRIC_CURVE_SET? { rep.super_eGEOMETRIC_CURVE_SET }
