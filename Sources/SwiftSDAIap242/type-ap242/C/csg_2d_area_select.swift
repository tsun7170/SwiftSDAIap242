/* file: csg_2d_area_select.swift 	 generated: Mon Jan 12 18:18:08 2026 */
...
```
*/
  public enum sCSG_2D_AREA_SELECT : SDAI.Value, AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCSG_2D_AREA_SELECT__type {

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eAXIS2_PLACEMENT_2D`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCSG_2D_AREA_SELECT``
    @_documentation(visibility:public)
    case _AXIS2_PLACEMENT_2D(eAXIS2_PLACEMENT_2D.PRef)	// (ENTITY)

    /// SELECT case ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eCSG_PRIMITIVE_SOLID_2D`` (ENTITY) in ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCSG_2D_AREA_SELECT``
    @_documentation(visibility:public)
    ...
    /// attribute of SELECT type ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCSG_2D_AREA_SELECT``
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCSG_2D_AREA_SELECT__type: SDAI.SelectType {
...
public protocol AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCSG_2D_AREA_SELECT__subtype: 
  AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF__sCSG_2D_AREA_SELECT__type, SDAI.DefinedType
