/* file: cc_specified_item.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
/*
  TYPE cc_specified_item = SELECT
    ( product_definition (*ENTITY*),
     shape_aspect (*ENTITY*) );
  END_TYPE; -- cc_specified_item (line:1250 file:ap242ed2_mim_lf_v1.101_TY.exp)
...
```
*/
  public enum sCC_SPECIFIED_ITEM : SDAI.Value, TypeHierarchy.sCC_SPECIFIED_ITEM__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/ePRODUCT_DEFINITION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCC_SPECIFIED_ITEM``
    ...
    public static let bareTypeName: String = "CC_SPECIFIED_ITEM"
    ...
    public static let typeName: String = "AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.CC_SPECIFIED_ITEM"
...
public protocol sCC_SPECIFIED_ITEM__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sCC_SPECIFIED_ITEM__Subtype: sCC_SPECIFIED_ITEM__TypeBehavior, SDAI.DefinedType
where Supertype: sCC_SPECIFIED_ITEM__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sCC_SPECIFIED_ITEM__Subtype {
  //MARK: CONSTRUCTORS
