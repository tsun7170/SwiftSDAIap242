/* file: characterized_action_definition.swift 	 generated: Fri Feb  6 16:23:46 2026 */
...
```
*/
  public enum sCHARACTERIZED_ACTION_DEFINITION : SDAI.Value, TypeHierarchy.sCHARACTERIZED_ACTION_DEFINITION__TypeBehavior {

    /// SELECT case (ENTITY)
      ///
      /// - target: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/eACTION`` (ENTITY)
      /// - defined in: ``AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF/sCHARACTERIZED_ACTION_DEFINITION``
...
public protocol sCHARACTERIZED_ACTION_DEFINITION__TypeBehavior: SDAI.SelectType {
...
extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy {
 public protocol sCHARACTERIZED_ACTION_DEFINITION__Subtype: 
  sCHARACTERIZED_ACTION_DEFINITION__TypeBehavior, SDAI.DefinedType
where Supertype: sCHARACTERIZED_ACTION_DEFINITION__TypeBehavior
{}
}

public extension AP242_MANAGED_MODEL_BASED_3D_ENGINEERING_MIM_LF.TypeHierarchy.sCHARACTERIZED_ACTION_DEFINITION__Subtype {
  //MARK: CONSTRUCTORS
